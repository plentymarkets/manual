...
|**Version**
|Contains information about the <<start/plentymarkets-account/service-center/version-upgrade#, **plentymarkets version**  >> that you are using.

|**Contract**
|Contains information about your <<start/plentymarkets-account/service-center/contract#, **contract**  >>. Click on **System configurator** to make changes to your contract. Click on **Cancel contract** to initiate the cancellation process.

|**Domain**
|Create and link <<start/plentymarkets-account/service-center/domain#, **domains**  >> and subdomains.

|**Client (store)**
|Contains information about your <<start/plentymarkets-account/service-center/client-store#, **clients (stores)**  >>.

|**Cache**
|Deactivate the <<start/plentymarkets-account/service-center/cache#, **cache**  >> temporarily and/or activate a permanent SSL redirect.
|====
