...
image::start/assets/EN-Start-Tasks-01.png[]
...
|**Description**
| Enter a description to specify what exactly is included in the task. For further information about the editor, refer to the **<<cms/web-design/tools/editor#, Editor  >>** page of the manual.
|====
...
image::start/assets/EN-Start-Tasks-02.png[]
