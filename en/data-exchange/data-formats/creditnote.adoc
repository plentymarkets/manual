...
The data format **CreditNote** is used to export credit notes, e.g. for statistical purposes. Create and export the data format in the **Data exchange » Export » Dynamic export** menu. The **<<data-exchange/exporting-data#, Exporting data  >>** page of the manual describes how you export the data format.
