...
For further information about using the data format **Stock** refer to the **<<data-exchange/exporting-data#90, Exchanging stock data >>** chapter on the **Exporting data** page of the manual.
...
|**ItemMarking1**
|Flag 1 of the item
|Activate the filter and select the operator and the value from the drop-down menu.
...
|**PriceUnit**
|The item's standard unit. For further information, refer to <<data-exchange/data-formats/item#, **Data format Item**  >> page of the manual.
|
...
You can limit the data export to a specific type of stock. To do so, go to **Data exchange » Export » Dynamic export** and click on the **Fields** tab. Use the drop-down menus on the right and select options for **Stock**, **Item bundle** and **Supplier**.
