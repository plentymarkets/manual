...
The data format **EbayPartsFitment** is used to link an eBay listing with the data from a **<<multi-channel/ebay#160, parts compatibility listing >>**. Each of the three eBay platforms **Germany**, **UK** and **USA** has its own data format: **EbayPartsFitmentDE**, **EbayPartsFitmentUK** and **EbayPartsFitmentCOM**.
...
The data format **EbayPartsFitmentDE** is used to link an eBay listing with the data from a **<<multi-channel/ebay#160, parts compatibility listing >>** for eBay Germany. Table 1 explains the data fields for the data format link:http://pages.ebay.de/help/sell/contextual/master-vehicle-list-manually.html[**EbayPartsFitmentDE**, window="_blank"]. The data fields are listed in alphabetical order.
...
The data format **EbayPartsFitmentUK** is used to link an eBay listing with the data from a **<<multi-channel/ebay#160, parts compatibility listing >>** for eBay UK. Table 2 explains the data fields for the data format link:http://pages.ebay.co.uk/help/sell/contextual/master-vehicle-list-manually.html[**EbayPartsFitmentUK**, window="_blank"]. The data fields are listed in alphabetical order.
...
The data format **EbayPartsFitmentCOM** is used to link an eBay listing with the data from a **<<multi-channel/ebay#160, parts compatibility listing >>** for eBay USA. Table 3 explains the data fields for the data format link:http://pages.ebay.com/motors/compatibility/download.html[**EbayPartsFitmentCOM**, window="_blank"]. The data fields are listed in alphabetical order.
...
The data fields that are listed in table 4 are available for <<data-exchange/importing-data#25, **data synchronisation** >> for all three data formats. For mandatory synchronisation fields, select the option **Synchronisation** as **Import procedure**. Mandatory synchronisation fields are marked with an **M**.
