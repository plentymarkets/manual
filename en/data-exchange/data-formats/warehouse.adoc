...
For further information about configuring the warehouse, refer to the **<</#, Racks >>** page of the manual.
...
The following data field is available for <<data-exchange/importing-data#25., **data synchronisation** >>. This data field is a mandatory synchronisation field. For mandatory synchronisation fields, select the option **Synchronisation** as **Import procedure**.
