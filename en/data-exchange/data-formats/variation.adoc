...
====
It is not possible to use the data format **Variation** for creating new categories. With the data format **Variation**, you can only create new category links within the variation. Use the data format **<<data-exchange/data-formats/category#, Category  >>** instead to create new categories.
====
...
|**UnitID**
|ID of the unit; ID lists are found in the menu **Settings » Item » Units**.
|
...
|**VariationAttributes**
|List of the attributes that are linked to the variation; ID list can be found in the menu **Settings » Item » Attributes**
|
