...
====
It is not possible to use the data format **Item** for creating new categories. With the data format **Item**, you can only create new category links within the item. Use the data format **<<data-exchange/data-formats/category#, Category  >>** instead to create new categories.
====
...
|Amazon product type; for possible values, see <<data-exchange/data-formats/item#50, **amazon_product_type value table** >>.
...
|Items available via WebAPI; data interface for exchanging data with **<<data-exchange/exporting-data#30, price search engines >>** +
**0** = No +
**1** = Yes
|Activate the filter and select the value from the drop-down menu.
...
|Market Yatego; items available for **<<multi-channel/yatego#, Yatego  >>** export +
**0** = No +
**1** = Yes
|Activate the filter and select the value from the drop-down menu.
