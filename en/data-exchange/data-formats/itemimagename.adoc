...
Deletes the image names completely and irreversibly when the value 1 is entered. For further information, refer to the **link::/[Filter]** page of the manual.
|
...
The data fields that are listed in the following table are available for link::/[**data synchronization**]. The mandatory synchronization fields have to be selected in order for the synchronization to take place.
