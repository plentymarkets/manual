...
The following data field is available for <<data-exchange/importing-data#25., **data synchronisation** >>. For this mandatory synchronisation field, select the option **Synchronisation** as **Import procedure**.
