...
Use the data format **ItemWarehouse** to export, edit and import your link::/[**warehouse configuration**].
...
|**Marking**
|Flag
|Select the flag from the drop-down menu.
...
|**WarehouseID**
|Warehouse ID
|Select the warehouse from the drop-down menu.
|====
...
The **data fields** that are listed in the following tables are available for link::/[**data synchronization**].
