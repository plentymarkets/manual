...
====
Depending on the booked edition (BASIC, CLASSIC, FLEX, PLUS, ENTERPRISE), the availability of our support options may vary. For further information on the plentymarkets editions, take a look at link:https://https://www.plentymarkets.com/product/editions/[this page^]{nbsp}icon:external-link[].
====
...
[#30]
= Setup team (chargeable; from Classic edition)
...
[#40]
= Partner agencies (chargeable; all editions)
...
[#50]
= Support hotline (chargeable; from Classic edition)

include::../business-decisions/your-contract.adoc[tag=support-hotline]

[#60]
= Service (partially chargeable; all editions)
