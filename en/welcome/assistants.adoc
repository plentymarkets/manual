...
|*Klarna*
|Set up the plugin with the assistant in your system to offer your customers the various Klarna payment methods. To do so, download the plugin from the link:https://marketplace.plentymarkets.com/en/mollie_6272[plentyMarketplace^] and install it in a plugin set.
