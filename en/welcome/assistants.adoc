...
| *Debit*
|Set up the plugin in your system in order to offer the payment method *Debit*. The plugin must be installed in a plugin set. Buy it on link:https://marketplace.plentymarkets.com/en/plugins/payment/debit_6362[plentyMarketplace^]{nbsp}icon:external-link[] and install it in a plugin set.

| *PayPal*
|Set up the plugin in order to offer the different PayPal payment methods in your online store. The plugin must be installed in a plugin set. Buy it on link:https://marketplace.plentymarkets.com/en/plugins/payment/paypal_4690[plentyMarketplace^]{nbsp}icon:external-link[] and install it in a plugin set.

| *PayPal Dispute*
|Set up the plugin in order to integrate the PayPal Dispute service directly into your plentymarkets system. The plugin must be installed in a plugin set. Buy it on link:https://marketplace.plentymarkets.com/en/paypaldispute_6582[plentyMarketplace^]{nbsp}icon:external-link[] and install it in a plugin set.
