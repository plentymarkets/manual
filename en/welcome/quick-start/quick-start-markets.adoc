...
====
Visit link:https://marketplace.plentymarkets.com/en/plugins/sales/marketplaces[plentyMarketplace^]{nbsp}icon:external-link[] to discover more markets and link:https://marketplace.plentymarkets.com/en/plugins/sales/price-comparisons[price search engines^]{nbsp}icon:external-link[]. Go to the *Description* tab to access comprehensive setup instructions and other important information.
====
