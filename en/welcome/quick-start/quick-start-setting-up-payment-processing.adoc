...
Download the payment plugins from the link:https://marketplace.plentymarkets.com/en/plugins/payment[plentyMarketplace^]. Find information and explanations how to set up the payment methods developed by plentymarkets on the manual page <<payment/payment-plugins#, Payment Plugins>>. There, you also find the information whether the setup of the integration is done with an assistant. +
