...
In this section of the quick start you find basic information about how to integrate payment methods into your online store and about the required basic settings that are needed to correctly process payments in your plentymarkets system.
