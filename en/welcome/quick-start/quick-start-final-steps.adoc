...
// * [ ] integrated Amazon?
* [ ] integrated link:https://knowledge.plentymarkets.com/en/welcome/quick-start/quick-start-ebay[eBay^]{nbsp}icon:external-link[]?
* [ ] set up your link:https://knowledge.plentymarkets.com/en/welcome/quick-start/quick-start-online-store[online store^]{nbsp}icon:external-link[]?
