...
. From the drop-down list, select the option *Feedback CSS (Ceres) (Feedback)*.
...
This concludes the setup. Now customers can rate items after purchasing them. In the next chapter, we will return to one of the default plugins: Ceres. You can use this plugin to change the design of your webshop.
