...
ElasticSync is available in the *Data » Import* menu to exchange data between your plentymarkets system and eBay. Use the <<data/importing-data/sync-types/elasticsync-market-listing, market listing>> sync type to import listing data into plentymarkets.
