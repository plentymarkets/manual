...
In this part of the quick start, you find explanations about general settings such as saving company data and bank details as well as explanations about setting up the email despatch and email templates. Furthermore, we explain on this page how you order a domain and an SSL certificate for your webshop.
...
Use customer classes to categorise your customer base according to specific criteria. You can determine the minimum order quantities, grant discounts and decide whether the prices in your webshop are displayed as gross or net prices.
...
|Select which methods of payment are permitted for the customer class. These methods of payment will later be available in your webshop. By default, all available methods of payment are allowed.

| *Display of the prices in the webshop*
|Select whether the prices are displayed as gross or net prices in the webshop.
...
| *webshop: Confirmation of store order*
...
In this chapter, we explain how you customise an email template based on the email template *webshop: confirmation of store order*.

[.instruction]
Customising the email template:

. Go to *Setup » Client » [Select client] » Email » Templates*.
. Open the *General email templates* folder and click on *webshop: Confirmation of store order*. +
...
After you have adjusted and saved the email template *webshop: Confirmation of store order*, this template will automatically be sent to your customers when they place an order in your webshop. This is because this template is already linked with the event *New order via webshop* in the *Setup » Client » [Select client] » Email » Automatic* menu.
...
====
All emails that you send to your customers should contain the template function *{%Link_Checkout()%}*. This function replaces the link to the *My account* area of your webshop. Your customers can then click on the link to update their data, see the order history, add further items to the order or track the order status.
====
...
The right specifies whether the document should be visible to *Employees* or *Customers* only or to all visitors of your webshop (= *Public*).
...
An SSL certificate is used to encrypt your website and provides a secure connection to your webshop. Your customers can see when you are using an SSL certificate as your website will be accessed via _https_.
...
* [ ] Did you order a domain for your webshop?
