...
. Carry out the settings. Note the explanations in <<#table-quick-start-create-customer-class>>.
...
. If required, change the settings. Note the explanations in <<#table-set-up-email-templates>>.
...
If you already have a domain with another provider and want to relocate the domain, proceed as described on the <<business-decisions/system-administration/system-relocation#, System relocation>> page.
