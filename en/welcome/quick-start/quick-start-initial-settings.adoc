...
If you already have a domain with another provider and want to relocate the domain, proceed as described in the <<business-decisions/system-administration/domains#250, Relocating a domain>> chapter.
...
* <<business-decisions/system-administration/domains#, Managing domain data>>
* <<business-decisions/system-administration/domains#, Managing the SSL certificate>>
* <<business-decisions/your-contract#, Changing your contract>>
