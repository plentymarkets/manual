...
If you already have a domain with another provider and want to relocate the domain, proceed as described in the <<business-decisions/system-administration/system-relocation#, System relocation>> chapter.
