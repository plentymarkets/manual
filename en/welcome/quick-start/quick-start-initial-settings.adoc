...
:keywords: master data, bank data, bank details, email, emails, login details, access data, email template, email templates, templates, template variable
...
. Carry out the settings. Note <<table-quick-start-create-customer-class>>.
...
You can adapt all email templates to your individual needs. Go to the chapter <<welcome/quick-start/quick-start-initial-settings#600, Example: Customising the email template>> further down on this page of the manual, you find an example how to customise the email template *Online store: confirmation of store order*.
...
Do you want to set up new domains or subdomains? Do you need to order a new SSL certificate? Should the cache be deactivated temporarily? Such tasks are usually completed by a _system administrator_. The <<business-decisions/system-administration/domains#, Domains>> page of the manual serves as a reference for system administrators and helps them manage the domains in plentymarkets using an assistant.

If you already have a domain with another provider and want to relocate the domain, proceed as described in the <<business-decisions/system-administration/domains#500, System relocation>> chapter.
...
* <<business-decisions/system-administration/domains#ssl-zertifikat, SSL certificate>>
* <<business-decisions/your-contract#, Your contract with plentymarkets>>

TIP: Continue to <<welcome/quick-start/quick-start-stock-management#, Setting up a warehouse and a supplier>>
