...
For further information about template variables, refer to the chapters <<welcome/quick-start/quick-start-initial-settings#600, Example: Customising the email template>> and <<welcome/quick-start/quick-start-initial-settings#700, Inserting template variables and template functions>> further down on this page of the manual.
...
You can adapt all email templates to your individual needs. Further down on this page of the manual in the chapter <<welcome/quick-start/quick-start-initial-settings#600, Example: Customising the email template>>, you find an example how you adjust the email template *Online store: confirmation of store order*.
...
[TIP]
====
There are many more email templates that are already available in your plentymarkets system. Adjust these email templates, if required, and link them with an event in the *Setup » Client* » _Select client_ » *Email » Automatic* menu or set up an event procedure. For further information, refer to the quick start page <<welcome/quick-start/quick-start-automating-processes#, Automating processes>>.
====
