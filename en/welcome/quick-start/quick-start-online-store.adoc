...
Set up a default country of delivery, a default shipping method, a default shipping profile and a default payment method. These are preselected for non-registered visitors of your webshop. You can only use *plugin payment methods* in your Ceres webshop, which you can download from the link:https://marketplace.plentymarkets.com/plugins/payment[plentyMarketplace^]{nbsp}icon:external-link[].
