...
IMPORTANT: Have you already set up your online store? Not yet? Return to <<welcome/quick-start/quick-start-online-store#, setting up the Ceres online store>>.
...
TIP: Continue with <<welcome/quick-start/quick-start-adding-plugins-to-the-system#, Adding plugins to the system>>.
