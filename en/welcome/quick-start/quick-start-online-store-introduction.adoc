= Setting up the webshop: Introduction
:lang: en
...
After creating your items and possibly setting up an interface to eBay in the previous chapters, we will now incorporate various payment methods in your webshop as well as how to change its design. plentymarkets provides these functionalities, as well as others, via plugins.
