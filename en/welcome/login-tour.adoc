...
The main navigation bar is up top. But there’s much more behind all the menus. You’ll notice that drop-downs appear when you move your mouse over the various menus.
...
. Add `uiAction=`.
. Add the key for the UI actions and the parameter with the corresponding ID. Note <<tabelle-keys-ui-actions-parameter>>.
