...
:description: Set up your preferred shortcuts and your personal signature and customise your own user account in the plentymarkets system.
:position: 40
:url: welcome/customise-system
:id: 49S4GON
:author: denise-breidenbach

//add this url weiterleitung /en/basics/working-with-plentymarkets/customise-user-account/;/en/welcome/customise-system/;301;L
...
*_Note:_* The sales statistics offers a broad snapshot of your current sales. The *plentymarkets Logo (Start) » Statistics* menu allows you to perform more detailed and accurate statistical analyses.
