...
//add this url weiterleitung /en/basics/working-with-plentymarkets/tasks-and-calendars/;/en/welcome/general-functions/tasks-and-calendars/;301;L

On this page of the manual, you learn how to manage <<#100, tasks>> and <<#600, calendars>>.
