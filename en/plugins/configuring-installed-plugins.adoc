...
include::./_textblocks/explanations/container-verknuepfung-en_gb.adoc[]
You can find all container links in the *CMS » Container links* menu. To see which containers to link, check the instructions of the respective plugin.

Some plugins come with predefined container links. These are so-called standard container links. To select standard container links, proceed as follows:
