...
For further information on the plugin JSON, see our link:https://developers.plentymarkets.com/marketplace/plugin-requirements#marketplace-pluginjson[developers page^]. .
====