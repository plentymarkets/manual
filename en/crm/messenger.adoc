...
If users of the type *Back end* should be able to work with the messenger, you have to assign rights to those users. Moreover, you have to create tags in order that these are available for the messenger.
