...
** *Detail view*: When you open a company, its details are displayed in the main window on the right. The detail view of a company is divided into the areas *Details*, *Linked contacts* and, if chosen, *Supplier details*.
