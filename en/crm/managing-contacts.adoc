...
. In the *Authorisations* section, activate the rights as listed in <<table-rights-address-layout>>.
...
. Carry out the settings in the *New contact* section. Pay attention to the information given in <<table-create-contact>>.
...
====
Go to *Setup » Settings » Data » Cleanup* and determine the time period after which unused addresses are automatically deleted from your plentymarkets system. Unused addresses are those addresses that do not have any relation to a contact, an order, a POS and a warehouse.

For further information about data cleanup, refer to the <<data/data-cleanup#, Carrying out data cleanup>> page of the manual.
====
...
. Go to *Setup » Settings » User » Rights » User*.
. Use the search function and open the user that should be edited.
. In the *Authorisations* section, activate the rights as listed in <<table-rights-messenger>>.
. *Save* (icon:save[role="green"]) the settings.
...
|*Setup > Property > Create property*
|Authorises the back end user to create properties.

|*Setup > Tag > Show tag*
|Authorises the back end user to see tags.

|*Setup > Tag > Create tag*
...
====
The properties can be added and displayed in the plentymarkets back end only. That means that it is not possible for the contact to save data in your online store, e.g. during the order process or when they register in your online store. This functionality is currently being developed.
...
Import or update the data of your contacts including address options, contact options and company data via the ElasticSync plugin. Check the <<data/importing-data/ElasticSync#, Importing data with ElasticSync>> page of the manual for general information about ElasticSync.
