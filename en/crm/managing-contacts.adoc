...
*Regular account* = The contact newly registered in your online store or the data record was manually created in the back end. +
*Guest account* = The contact has registered and ordered as a guest in your Callisto online store.
