...
If you want that the user to create company data records, for example, go to the *CRM > Accounts* area and activate the options *Show account* and *Create account*.
====
...
. Carry out the settings in the *New contact* area. Pay attention to the information given in <<#table-create-contact>>.
. Assign one or multiple tags in the *Assigned tags* area. Pay attention to the information given in the <<crm/managing-contacts#150, Creating tags>> chapter.
...
. In the *Contact options* area , select the type and sub-type from the drop-down list and enter the value. Pay attention to the information given in <<#table-create-contact>>. +
...
→ The *New address* area  is hidden and you can add the address at a later point in time.
. Carry out the settings. Pay attention to the information given in <<#table-create-contact>> in the *Address* area.
. *Save* (icon:save[role="green"]) the settings. +
...
First of all, you have to create the tags in the *Setup » Settings » Tags* menu and activate the option *Contacts* in the Availability area. How to create tags is described on the <<basics/working-with-plentymarkets/tags#, Tags>> page of the manual.
...
. In the *Assigned tags* area, enter the tag name.
. Click on the tag name in the list.
. *Save* (icon:save[role="green"]) the settings. +
→ The tag is assigned to the contact and displayed in the *Assigned tags* area.
...
. Go to *CRM » Contacts*.
. Select one or more tags from the *Tags* drop-down list in the *Filter* area.
. Click on *Search* (icon:search[role="blue"]). +
→ The contacts that correspond to the search criteria entered are displayed.
...
. Click in the line of the contact. +
→ The detail view of the contact opens.
. Enter the name of the company, town, street or country in the entry field of the *Company* area. +
...
. Click in the line of the contact. +
→ The detail view of the contact opens.
. In the *Company* area, click on *Add new company*. +
...
. Carry out the changes. Pay attention to the information given in <<#table-create-contact>> in the *Address* area.
. *Save* (icon:save[role="green"]) the settings. +
...
. Carry out the settings in the *New address* area. Pay attention to the information given in <<#table-add-address>>.
. In the *Address options* area, select the type from the drop-down list and enter the value. Pay attention to the information given in <<#table-add-address>>. +
...
* Data is deleted: Contact options, address options, addresses, address relations, order relations, company (account) relations, bank details
====
