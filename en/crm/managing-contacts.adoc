...
First of all, you have to create the tags in the *Setup » Settings » Tags* menu and activate the option *Contacts* in the Availability section. How to create tags is described on the <<welcome/general-functions/tags#, Tags>> page of the manual.
...
Refer to the <<welcome/general-functions/properties#, Properties>> page of the manual to learn how to create properties and property groups.

[#970]
=== Linking properties with the contact

After you created properties in the *Setup » Settings » Properties » Configuration* menu as described on the <<welcome/general-functions/properties#, Properties>> page of the manual, you can link the properties with the contact. Proceed as described below.
...
How to create tags is described on the <<welcome/general-functions/tags#, Tags>> page of the manual.
...
Create customer-specific statistics in the *Statistics* section. This allows you to analyse data related to the contact and display this data as a statistic. For example, you could create a statistic that displays the contact's total revenue development during a particular time period. You can also edit existing statistics in this section. For further information, refer to the <<business-decisions/business-intelligence/statistics#70, Customer statistics>> chapter.
...
Depending on which type of statistic you selected, you find further information in the following chapters of the <<business-decisions/business-intelligence/statistics#, Managing statistics>> page of the manual:

* <<business-decisions/business-intelligence/statistics#20, Total revenue development>>
* <<business-decisions/business-intelligence/statistics#100, Revenue by category>>
* <<business-decisions/business-intelligence/statistics#20, revenue by order referrer>>

For further information about how to edit statistics, for example, refer to the <<business-decisions/business-intelligence/statistics#, Managing statistics>> page of the manual.
