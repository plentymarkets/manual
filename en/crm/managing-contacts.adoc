...
The revenues of the contact are displayed in detail above the table. Apart from *Balance* also information about invoices and credit notes. Note also the explanations given in <<tabelle-betraege-kontakt>>.
