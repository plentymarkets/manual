...
. Carry out the settings in the *Details* section. Pay attention to the information given in <<table-create-contact>>.
...
→ You directly access the *New order* view in the *Orders » Edit orders* menu. +
...
→ You directly access the *New ticket* view in the *CRM » Ticket system* menu. The contact ID is already pre-filled. +
...
In order that the login URL is created, both the email address in the *Contact options* section of the *CRM » Contacts » Open contact* menu and the password in the *CRM » Contacts » Open contact » View: Access data* must be saved. The login URL is generated after the data has been saved. Make sure to use a secure password. Otherwise an error message is displayed.
