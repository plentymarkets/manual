...
[IMPORTANT]
If a contact ordered as a guest in your plentyShop (Ceres), _no_ contact ID will be created for this guest order (GDPR conformity). Only the address data from the order will be saved. You can recognise a guest order by the check mark (icon:check[]) in the *Guest* column in the overview of the *CRM » Quick search* menu.
...
| *Required*
|Activate this option to make sure that the property is a mandatory input. Mandatory fields are displayed in bold in the detail view of the contact in the *Properties* area and in the order process in the plentyShop.

| *Order process*
|Activate this option to make sure that the property is displayed in the order process in the plentyShop.

| *Customer registration*
|Activate this option to make sure that the property is displayed in the customer registration in the plentyShop.
