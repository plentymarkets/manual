...
Import or update the data of your contacts including address options, contact options and account data via the ElasticSync plugin. Check the <</data/importing-data/ElasticSync#, Using the import tool>> page of the manual for general information about importing data.
