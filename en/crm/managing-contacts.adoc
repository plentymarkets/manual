...
. Hide the *Accounts* area.
. Expand the *property* area.
. Activate the *show* option.
. Expand the *propertyOption* area.
. Activate the *show* option.
. *Save* the settings.
...
====
Export the data of your contacts via the elastic export. Installing the plugins link:https://marketplace.plentymarkets.com/en/plugins/integration/ElasticSync_4750[ElasticSync^] and link:https://marketplace.plentymarkets.com/en/plugins/markets/ElasticExport_4763[Elastic Export^] as well as deploying them in the plugin set is required. Both plugins are available in the link:https://marketplace.plentymarkets.com/en/[plentyMarketplace^].
...
Note that the data of the already existing company data record is overwritten.
...
====
In the *CRM » Quick search* menu, you can download all data that is saved for a contact or an address by clicking on *Download all data of a contact*.

For further information which data can be downloaded, refer to the this link:https://forum.plentymarkets.com/t/dsgvo-button-fuer-den-datenexport-zu-einem-kunden-integriert/486915[changelog^] thread. This changelog is regularly updated.
====
