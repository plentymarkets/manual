...
. Carry out the desired settings. Note the explanations on the <<orders/managing-orders#, Managing orders>> page of the manual.
. *Save* (icon:save[role="green"]) the settings.
