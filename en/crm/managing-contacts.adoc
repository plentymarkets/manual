...
2+|*History*2+|The explanations about the history are described in the <<crm/managing-contacts#500, Displaying the history>> chapter.
...
[#1706]== Downloading all data of a contact
...
[#1707]== Anonymising a data record
