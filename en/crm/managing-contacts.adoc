...
.Filter settings
====
When you open the area *Account balance* in a contact data record, totals are displayed above the table. _Note:_ When you set <<#table-filter-account-data, filters>> to search for specific information, the amounts will adapt according to the chosen filters.
====
...
When your contact entered the incorrect password in your online store 4 times in succession, the login is blocked for the contact for 24 hours. By clicking on *Unblock login*, you unblock the login and your contact is able to log into your online store again as usual.
