...
====
This page of the manual describes all settings that are available in the *CRM » Contacts* menu in the Terra back end using the centralised login. The <<crm/managing-customer-data#, Managing customer data>> page of the manual that describes the settings in the *CRM » Edit customers* and *System » CRM* menus are simultaneously available. Once the new *CRM » Contacts* menu has completely replaced the old *CRM » Edit customers* menu, the *CRM » Edit customers* menu as well as the *Managing customer data* page of the manual will be removed.
====
...
Various filter options are available for the export. You can export, for example, only contacts that you have rated with 3 stars or only contacts that are assigned to a certain owner. More detailed information will be added soon.
...
|*Type*
|Select the type. The *Customer*, *Sales representative*, *Supplier*, *Partners*, *Manufacturers* and *Interested party* types can be selected by default. Create further types in the <<crm/managing-customer-data#300, System » CRM » Types>> menu. +
...
You can create tags for your contacts, assign them to contacts and filter by tags in the contact overview.
...
If you edit company data that is already saved, the data of the existing company data record is overwritten.
...
|*Type*
|Select the type from the drop-down list. +
Available types: VAT number, External address ID, Entry certificate, Telephone, Email, Post number, Personal ID, BBFC, Birthday, Title.
...
Via the change history you can track which user has changed data of a contact data record in your system. Furthermore, it is displayed if your customer has made changes in the My account area of your online store.
