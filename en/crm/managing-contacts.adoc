...
This page of the manual describes all settings that are available in the *CRM » Contacts* menu in the Terra back end using the centralised login as well as the settings that are carried out in the *System » System settings » CRM* menu.

Go to the *System » System settings » CRM* menu to carry out preparatory settings such as creating customer classes and types. Go to *CRM » Contacts* to create and edit data records for your contacts and manage all relevant information there such as addresses, orders, scheduled orders, tickets, notes, account balance, bank details and documents.

[#10]
== Carrying out the preparatory settings

Go to the *System » System settings » CRM* menu to carry out the preparatory settings such as creating <<crm/managing-contacts#15, customer classes>> and <<crm/managing-contacts#20, types>>. Furthermore, you set up <<crm/managing-contacts#25, discounts>> for your customers.

[#13]
=== Setting up the address layout for delivery notes

In the *System » System settings » CRM » Address layout* menu, you can individually set up address layout for your countries of delivery for the order document *Delivery note*. The address layouts for the countries of delivery German, France and the United Kingdom are already available in your plentymarkets system by default. You can edit these 3 address layouts if you have the corresponding rights to do this.

[.subhead]
Setting the visibility of the address layout for variable users

In order that the *System » System settings » CRM » Address layout* menu is visible for users with the user class *Variable*, the menu must be activated in the user account.

[.instruction]
Setting the visibility of the address layout for variable users:

. Go to *System » System settings » Settings » User » Account*.
...
→ The *System » System settings » CRM » Address layout* menu is visible for the variable user.

[TIP]
.Variable users: REST API rights to create, delete and update address layouts
====
In order that variable users can create, update and delete address layouts in the *System » System settings » CRM » Address layout* menu, the right must be set in the user account in the *Rights » REST API* area.
====

[.instruction]
Setting up the address layout for delivery notes:

. Go to *System » System settings » CRM » Address layout*.
. Click on *New*.
...
In order that the address layouts are automatically displayed on delivery notes, you have to carry out a setting in the delivery note. Your plentymarkets system automatically checks the country of delivery saved in the order and displays the delivery note in the layout listed in the *System » System settings » CRM » Address layout* menu. Proceed as described below.

. Go to *System » System settings » Client » Select client » Locations » Select location » Documents » Delivery note*.
. Activate the option *New address layout* in the area *Basic settings:{nbsp}Delivery note*. +
→ The option above *Structure of the invoice/delivery address* is hidden and the delivery notes are displayed in the address layouts listed in the *System » System settings » CRM » Address layout* menu.
. *Save* (icon:save[role="green"]) the settings.
...
Go to *System » System settings » CRM » Customer classes* to create new customer classes. The customer classes that you created in this menu are available in the contact data records in the *CRM » Contacts* menu.
...
You can link sales prices with customer classes. Go to *System » System settings » Items » Sales prices* and select one of the customer classes that you created under the setting *Class*. For further information, refer to the <<item/managing-items#870, Managing sales prices>> chapter on the <<item/managing-items#, Managing items>> page of the manual.
...
====
Instead of configuring the settings in this menu, it is also possible to directly save a global discount for a payment method. An example is a discount in percent for the payment method *Cash in advance*. For further information, refer to the <<payment/managing-payment-methods#, Managing payment methods>> page of the manual. You are not able to completely customise the settings if you save a discount directly for a payment method. It is only possible to completely customise the settings when using the option *Discount based on the method of payment* in the *System » System settings » CRM » Customer classes* menu.
====
...
Only those clients are displayed that have a name entered for them in the *System » System settings » Client » Select client » Settings* menu.

|*Language*
|Select the language for the contact. If you have created a template in the *System » System settings » Client » Select client » Email » Templates* menu in the same language that you have selected here, email templates are sent to the contact in this language.

|*Type*
|Select the type. The *Customer*, *Sales representative*, *Supplier*, *Partners*, *Manufacturers* and *Interested party* types can be selected by default. Create further types in the <<crm/managing-contacts#20, System » System settings » CRM » Types>> menu. +
...
|*Owner*
|Select the owner for the contact. If you do not want to select an owner, select the empty option. Only owners for whom the *Customer* option has been activated can be selected from the drop-down list. Go to *System » System settings » Settings » User » Account » Open user » Tab: Owner* to activate owners.
...
Necessary settings: +
Setting 1: Go to *System » System settings » Orders » Payment » Payment methods* to activate the payment method. This makes it possible to select the payment method in an order. +
...
2+|*Assigned tags*
2+|Click into the field in order to show all tags that are available for the area *Contacts* and that you have created beforehand in the *System » System settings » Settings » Tags* menu. +
...
*_Important:_* The value date in the contact details can only be selected for companies, but not for private persons. It is, however, possible to save a value for the payment due date in the invoice. To do so, go to *System » System settings » Client » Select client » Locations » Select location » Documents » Invoice*.
...
*_Important:_* The early payment discount in the contact details can only be selected for companies, but not for private persons. It is, however, possible to save a value for the payment due date in the invoice. To do so, go to *System » System settings » Client » Select client » Locations » Select location » Documents » Invoice*.
...
First of all, you have to create the tags in the *System » System settings » Settings » Tags* menu and activate the option *Contacts* in the *Availability* section. How to create tags is described on the <<basics/working-with-plentymarkets/tags#, Tags>> page of the manual.

[#151]
==== Assigning tags

After you have created the tags in the *System » System settings » Settings » Tags* menu and activated the option *Contacts* in the Availability section, proceed as described in the following to assign one or multiple tags to a contact.
...
.Tags for contacts
====
Only those tags can be selected in the contact data record that were created in the *System » System settings » Settings » Tags* menu for the area *Contacts*.
====
...
. Click in the line of the contact. +
→ The detail view of the contact opens. +
*_Or:_* Open certain areas of the context menu such as *New order* or *New note* with a right click.
...
*_Important:_* Variable users can only select those clients that they have a right to access. Variable users are given rights within the <<basics/admin-tasks/manage-users#90, Right>> tab in the *System » System settings » Settings » User » Accounts* menu.
...
→ *_Or:_* Enter the name of the company in the suggestion list and click on *Save*.
...
====
Go to *System » System settings » Settings » Data » Cleansing* and determine the time period after which unused addresses are automatically deleted from your plentymarkets system. Unused addresses are those addresses that do not have any relation to a contact, an order, a POS and a warehouse.
...
*_Important:_* The address label template must have been <<fulfilment/generating-documents#address-label-template, created>> in the *System » System settings » Orders » Documents » Address label* menu beforehand. Whether the primary invoice address or the primary delivery address of the contact is printed, depends on the setting in the address label template.


|*Send email template*
|Sends the template selected from the drop-down list to all activated contacts. +
*_Important:_* The email template must have been <<crm/sending-emails#1200, created>> in the *System » System settings » Client » Select client » Email » Templates* menu beforehand.

|*Add to newsletter folder*
|Copies the email addresses of the activated contacts to the email folder selected from the drop-down list. The email addresses are listed in the *System » System settings » CRM » Newsletter » plentymarkets » Email folder* menu.
...
Properties are frequently occurring information that you can use in different areas of plentymarkets. Properties are centrally managed in the *System » System settings » Settings » Properties » Configuration* menu.
...
You can, however, already create properties in the *System » System settings » Settings » Properties » Configuration* menu and also add values for the properties.

*_Important:_* A migration is planned for the properties that you created in the past in the *System » System settings » CRM » Properties (deprecated)* menu. That means that you do not have to transfer these properties to the new *System » System settings » Settings » Properties » Configuration* menu. Please keep an eye on the link:https://forum.plentymarkets.com/c/changelog[Changelog^] category of the plentymarkets forum where we will inform you about the time when the migration takes place.
...
Go to *System » System settings » Settings » Properties » Configuration* to create properties that you will later use for characterising your contacts.
...
Properties are centrally managed in the *System » System settings » Settings » Properties » Configuration* menu. Change the settings that are described in <<table-create-property>> in this menu.
...
Properties are centrally managed in the *System » System settings » Settings » Properties » Configuration* menu. After opening the menu, start the search to display the properties. In order to search for specific properties, enter a search term in the search fields. The drop-down lists help you search for properties that share specific criteria. You can combine as many search filters as you like.
