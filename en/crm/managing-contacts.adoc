...
You can link sales prices with customer classes. Go to *Setup » Items » Sales prices* and select one of the customer classes that you created under the setting *Class*. For further information, refer to the <<item/settings/prices#100, Sales prices and price calculation>> page of the manual.
...
Further information on sales prices can be found on the <<item/settings/prices#100, Sales prices and price calculation>> page of the manual.
...
| *Rating*
|Rate the contact for internal use. Select 5 red stars for the worst and 5 yellow stars for the best rating.
