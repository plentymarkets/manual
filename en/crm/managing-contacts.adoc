...
|Date on which payment is due for the order To have a payment due date displayed here, the <<orders/managing-orders#intable-payment-terms-order, payment terms>> of the corresponding order have to be filled in and an invoice has to have been created first. +
This is a default column.
