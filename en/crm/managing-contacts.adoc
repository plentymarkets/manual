...
. Carry out the additional settings. Note <<#table-create-property>>.
. *Save* (icon:save[role="green"]) the settings. +
...
. Go to *Setup » Settings » Properties » Configuration*.
. In the *Filter* view, enter the search term in the search field or set the filter options in the drop-down lists. Note <<#table-filter-properties>>.
. Click on *Search* (icon:search[role="blue"]). +
...
The *Setup » Settings » Properties » Configuration* menu contains all properties that you have created so far. Here you can change the settings described in <<#table-create-property>>.
...
. Edit the settings. Note <<#table-edit-property>>.
. *Save* (icon:save[role="green"]) the settings.
...
. Carry out the settings. Note <<#table-create-property-group>>.
. *Save* (icon:save[role="green"]) the settings. +
