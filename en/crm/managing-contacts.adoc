...
|*Type* |Select the type, e.g. email, telephone or website, from the drop-down list.
...
2+|*History*
2+|The explanations about the history are described in the <<crm/managing-contacts#500, Displaying the history>> chapter.
...
.Settings in the *CRM » Contacts » Open contact » View: Account* menu
[cols="1,3"]
|====
|Setting |Explanation
...
.Filter settings in the *CRM » Contacts » Open contact » View: Account* menu
[cols="1,3"]
|====
|Setting |Explanation
...
.Settings in the *CRM » Contacts » Open contact » View: Bank details* menu
[cols="1,3"]
|====
|Setting |Explanation
