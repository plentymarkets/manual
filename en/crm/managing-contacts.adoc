...
In the following sub-chapters, you learn, for example, how to create new contacts and accounts, link contacts to an account, search for existing contacts using the filter settings as well as edit and delete existing contacts. On this page of the manual, the "account" refers to the "company".
...
Check mark placed = The contact can pay using this payment method, even if you do not offer this payment method globally. +
...
In this case, you have, however, the possibility to anonymise the data record. For further information, refer to the <<crm/managing-contacts#1707, Anonymising a data record>> chapter.
====
...
. Carry out the changes. Note the explanations in <<#table-add-address>> in the <<crm/managing-contacts#700, Adding an address>> chapter as well as the explanations about the toolbar in <<#table-edit-address>>.
. *Save* (icon:save[role="green"]) the settings.
...
Use filters to display the account balance data of your contact.
...
. Click in the line of the contact. +
→ The detail view of the contact opens.
. Click on *Account balance* on the left side in the context menu. +
→ All data that is available for the account of the contact is displayed.
...
Checking the VAT number in the plentymarkets back end is not possible. However, you can download a plugin from the plentyMarketplace, e.g. the plugin link:https://marketplace.plentymarkets.com/en/plugins/integration/vatidcheck_6023[VAT ID Check^]{nbsp}icon:external-link[] to check the VAT numbers.
