...
You can delete individual contacts. All addresses that are assigned to the contact are deleted if they are not linked to an order. A contact data record cannot be deleted when it is linked to an order or a ticket.
...
Properties are frequently occurring information that you can use to further characterise your contacts.

For example, you can save in every contact data record how the contact wants to be contacted by you and if they want to have your new product catalogue.

[#960]
=== Creating properties

Go to *Setup » Settings » Properties » Configuration* and create properties. Afterwards, link them with the contact. You can also create property groups to get a better overview in case you are working with various properties.

Refer to the <<basics/working-with-plentymarkets/properties#, Properties>> page of the manual to learn how to create properties and property groups.

[#970]
=== Linking properties with the contact

After you created properties in the *Setup » Settings » Properties » Configuration* menu as described on the <<basics/working-with-plentymarkets/properties#, Properties>> page of the manual, you can link the properties with the contact. Proceed as described below.
