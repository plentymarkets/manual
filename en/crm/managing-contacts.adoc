...
Checkbox not activated = The contact cannot pay using this payment method. +
Checkbox activated = The contact can pay using this payment method, even if you do not offer this payment method globally. +
...
In order that the login URL is automatically created, both the email address in the *Contact options* section of the *CRM » Contacts* » _Open contact_ menu and the password in the *CRM » Contacts* » _Open contact_ » *View: Login details* have to be saved. The login URL is generated after the data has been saved. Make sure to use a secure password. Otherwise an error message is displayed.
