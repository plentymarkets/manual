...
====
In the *CRM » Quick search* menu, you can download all data that is saved for a contact or an address by clicking on *Download all data of a contact*. The currently available machine-parsable format is .json.
====
