...
. Carry out the desired settings in the *Address details* and *Contact details* areas. Note also <<#table-edit-contact>>.
. *Save* (icon:save[role="green"]) the settings. +
...
. Carry out the desired settings. Note <<#table-edit-contact>> in the *Account* area.
. *Save* (icon:save[role="green"]) the settings. +
...
. Carry out the desired changes. Note <<#table-edit-contact>> in the *Account* area.
. *Save* (icon:save[role="green"]) the settings. +
...
. Carry out the desired settings in the *New address* area. Note <<#table-add-address>>.
...
. Carry out the desired changes. Note <<#table-add-address>> in the <<crm/managing-contacts#700, Adding an address>> chapter as well as the explanations about the toolbar in <<#table-edit-address>>.
. *Save* (icon:save[role="green"]) the settings.
...
. Carry out the desired changes. Note <<image-messenger-edit-message>> and <<#table-new-message-messenger>>.
...
→ All data that is available for the account of the contact is displayed.
. Carry out the desired settings in the *Filter* area. Note <<#table-filter-account-data>>.
. Click on *Search* (icon:search[role="blue"]).
