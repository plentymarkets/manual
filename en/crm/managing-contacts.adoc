...
--
If you click on a contact data record in the overview of the *CRM » Contacts* menu in order to display or edit the contact, the detail view of the contact opens. Via the context menu in the left section of the contact, you can access views such as *Addresses* or *New address*.
...
When more than one view of the contact data record is open, an arrow is displayed in the view above. Click on the arrow to quickly and easily switch between the open views. Click on icon:times[] to close the contact and remove it from the list.
...
For further information about data cleansing, refer to the <<data/data-cleansing#, Carrying out data cleansing>> page of the manual.
====
...
Refer to the <<crm/managing-contacts#150, Creating tags>> chapter to learn how to create tags.
...
.Settings in the *Account* section of the contact data record in the *CRM » Contacts* menu
[cols="1,3"]
|====
|Setting |Explanation
...
.Filter settings in the *Account* section of the contact data record in the *CRM » Contacts* menu
[cols="1,3"]
|====
|Setting |Explanation
...
.Settings in the *Bank details* section of the contact data record in the *CRM » Contacts* menu
[cols="1,3"]
|====
|Setting |Explanation
...
→ The detail view of the contact opens.
. Click on *Bank details* on the left side in the context menu.
. Click on *Edit* (icon:pencil[role="yellow-background"]) in the card of the bank details that you want to edit. +
