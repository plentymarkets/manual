...
If you select one or more documents by activating *Select all*, the buttons *Preview*, *Download* and *Delete* are activated in the toolbar. If no document is selected, these buttons are deactivated. The functions are also available for each individual document. +
