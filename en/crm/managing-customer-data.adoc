...
// div class="plentyInfoBox plentyIsInfo"><div class="plentyInfoBoxHeader">Freitextfelder zu Eigenschaften migrieren</div> <div class="plentyInfoBoxContent"><p>Die Funktion der Eigenschaften ersetzt seit plentymarkets Version 5.1 die Funktion der Freitextfelder im Menü <strong>System » Kunden</strong>. Sie können Ihre Freitextfelder zu Eigenschaften migrieren. Dies erfolgt im Menü <a href="{% Link(916) %}"><strong>System » Einstellungen » Migration</strong></a>. Wenn Sie Freitextfelder migrieren möchten, erstellen Sie entsprechende Eigenschaften in diesem Menü.</p></div></div
