...
You can link sales prices with customer classes. Go to *System » Item » Sales prices* and select one of the customer classes that you created under the setting *Class*. For further information, refer to the <<item/managing-items#870, *Managing sales prices*>> chapter on the <<item/managing-items#, *Managing items*>> page of the manual.
...
|*Country*
|Select a country from the drop-down menu. This country will e.g. be used for the invoice address. The standard setting is based on which country you selected for the option *Default location* in the *System » Client » Open client » Settings* menu.
...
|*Group forum*
|Select a user group for the forum. User groups are created in the <<omni-channel/online-store/setting-up-clients/modules#forum, *System » Client » Open client » Modules » Forum*>> menu.
...
*_Important_*: The payment due date in the customer data record can only be selected for companies, but not for private persons. It is, however, possible, to save a value for the payment due date in the invoice. To do so, go to *System » Client » Open client » Locations » Open location » Documents » Invoice*.
...
*_Important_*: The value date in the customer data record can only be selected for companies, but not for private persons. It is, however, possible, to save a value date in the invoice. To do so, go to *System » Client » Open client » Locations » Open location » Documents » Invoice*.
...
*_Important_*: The early payment discount in the customer data record can only be selected for companies, but not for private persons. It is, however, possible, to save a value for the early payment discount in the invoice. To do so, go to *System » Client » Open client » Locations » Open location » Documents » Invoice*.
