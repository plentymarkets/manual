...
Go to *System » System settings » Client » Select client » Email » Newsletter*. Enter the login details to use the newsletter service that is integrated in plentymarkets.
