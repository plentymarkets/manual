...
This page of the manual describes which settings you need to carry out to send newsletters with plentymarkets. Send your newsletters e.g. with the <<crm/sending-newsletters#100, integrated newsletter service>>, <<crm/sending-newsletters#1700, CleverReach>> or link:https://marketplace.plentymarkets.com/plugins/integration/Newsletter2Go_5436[Newsletter2Go^].

[WARNING]
.Newsletter2Go interface no longer available as of March 1, 2019 - use the plugin free of charge
====
The interface to the old Newsletter2Go system that is integrated in plentymarkets will expire on March 1, 2019. Use the Newsletter2Go plugin instead that you can download free of charge in the link:https://marketplace.plentymarkets.com/plugins/integration/Newsletter2Go_5436[plentyMarketplace^]. +

On March 1, 2019, the *System » System settings » Client » Select client » Services » Newsletter2Go* menu will also be removed from the plentymarkets back end. Further information about the download file can be found in this link:https://forum.plentymarkets.com/t/ankuendigung-integrierte-newsletter2go-schnittstelle-laeuft-aus/523797[Changelog^] thread in the plentymarkets forum.
====
...
The *System » System settings » Client » Select client » Services » Newsletter2Go* menu will also be removed from the plentymarkets back end in March. Further information about the download file can be found in this link:https://forum.plentymarkets.com/t/ankuendigung-integrierte-newsletter2go-schnittstelle-laeuft-aus/523797[Changelog^] thread in the plentymarkets forum.
====

Proceed as described below to send newsletters to your customers with link:https://www.newsletter2go.co.uk/[Newsletter2Go^]. Please note that you require the SOAP module in order to use the Newsletter2Go service. The SOAP module allows for correct data retrieval.


[#2200]
=== Registering with Newsletter2Go

Register for free in order to use Newsletter2Go in plentymarkets. To do so, go to the link:https://www.newsletter2go.co.uk/help/[Newsletter2Go website^]. For further information about the settings in Newsletter2Go, refer to the link:https://www.newsletter2go.de/hilfe/[Newsletter2Go help^].

[#2300]
=== Creating a user

Go to <<basics/admin-tasks/manage-users#10, Settings » Basic settings » User » Accounts>> to create a new user for Newsletter2Go. You need this user for the Newsletter2Go interface. When creating the user with the user class *Newsletter2Go*, all rights required for the SOAP API are automatically saved. These rights include for example the setting *Customer* for the recipient's synchronisation as well as the setting *Item* for the item transfer.

[.instruction]
Creating a user:

. Open the menu *System » System settings » Settings » User » Accounts*.
. Click on *New*.
. Enter the *User name*.
. Enter the *Actual name*.
. Select *Newsletter2Go* from the *User class* drop-down list.
. Enter the *password*.
. *Save* the settings.
...
====
You can send your Newsletter2Go newsletters from an link:https://www.newsletter2go.com/features/newsletter-dispatch-dedicated-ips/[exclusive, dedicated IP address]. To use this service, you need to access the Service centre in the *Start » Service centre* menu and save the Newsletter2Go <<basics/admin-tasks/plentymarkets-account#domain-nameserver, name server>> for the sub-domains. You receive the necessary information regarding sub-domains and name server from Newsletter2Go.
====
