...
Additionally the *IP address* and used *confirmation URL* is saved with the confirmation. These data can be gotten via a link:https://developers.plentymarkets.com/rest-doc/newsletter/details#list-a-recipient[REST-Call^] but is not shown in the backend.
