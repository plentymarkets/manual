...
Add the ShopBuilder widget *Newsletter* to your Ceres online store to provide the newsletter registration for your customers. With this widget, select the email folder that is automatically linked with the email address of a person once this person subscribed to your newsletter in your online store.
