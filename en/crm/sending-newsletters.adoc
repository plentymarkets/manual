...
:keywords: double opt-in, double-opt, double opt-in function, double oppt, email template, e-mail template, newsletter, newsletter template, visibility newsletter, email folder, e-mail folder, newsletter login details, newsletter access data, CleverReach,
...
→ The email template is created and saved in one of the 3 folders, depending on the selected setting in the *Owner* drop-down list. Pay attention to the information about *Owner* in <<#table-create-email-template>>.
