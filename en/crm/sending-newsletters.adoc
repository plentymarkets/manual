...
In order that the recipient can unsubscribe from the newsletter, you have to insert the unsubscribe link into the newsletter template in the *CRM » Newsletter* menu.
