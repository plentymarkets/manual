...
This page of the manual describes which settings you need to carry out to send newsletters with plentymarkets. Send your newsletters e.g. with <<crm/sending-newsletters#1700, CleverReach>> or link:https://marketplace.plentymarkets.com/plugins/integration/Newsletter2Go_5436[Newsletter2Go^].
