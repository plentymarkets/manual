...
The *IP address* and the used *confirmation URL* of a confirmation are saved to the database. These data can be called up via a link:https://developers.plentymarkets.com/rest-doc/newsletter/details#list-a-recipient[REST-Call^] but is not shown in the backend.
