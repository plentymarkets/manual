...
. Carry out the desired settings in the *Copy all customer data into email folder(s)* section. Note <<#table-copy-customer-data>>.
...
. Go to *Setup » CRM » Newsletter » plentymarkets » Email filter*.
. Carry out the desired settings in the *Customer filter* section. Note <<#table-filter-customer-data>>.
