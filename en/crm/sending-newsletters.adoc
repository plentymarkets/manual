...
====
Please note that you cannot use the newsletter service that is integrated in plentymarkets in compliance with GDPR. Therefore, plentymarkets recommends using the following plugins:

The following newsletter plugins can be downloaded free of charge from the plentyMarketplace:

* link:https://marketplace.plentymarkets.com/en/plugins/integration/Newsletter2Go_5436[Newsletter2Go^]
* link:https://marketplace.plentymarkets.com/en/plugins/integration/MailInOne_5260[Mail-In-One^]
* link:https://marketplace.plentymarkets.com/en/plugins/integration/Simplyletter_5104[Simplyletter^]

The user guide in the *Description* tab of the plugin describes how to install the plugin and which settings need to be carried out.
...
You can import or export email addresses. You can export all of the email addresses by going to <<basics/data-exchange/export-import/exporting-data#, Data » Dynamic export>> and using the <<basics/data-exchange/export-import/data-formats/customernewsletter#, CustomerNewsletter>> data format. You can import new email addresses by going to <<basics/data-exchange/export-import/importing-data#, Data » Dynamic import>>.
