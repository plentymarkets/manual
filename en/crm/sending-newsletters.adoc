...
This page of the manual describes which settings you need to carry out to send newsletters with plentymarkets. Send your newsletters e.g. with the <<crm/sending-newsletters#100, integrated newsletter service>>, via the integrated interface <<crm/sending-newsletters#1700, CleverReach>>, the  link:https://marketplace.plentymarkets.com/plugins/integration/Newsletter2Go_5436[Newsletter2Go^] plugin or other email marketing and newsletter plugins available in the link:https://marketplace.plentymarkets.com/en/plugins/integration[plentyMarketplace^].
