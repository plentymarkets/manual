...
→ Click on *New message*. → The stop watch in the top right corner starts automatically once you open the data record.  Click on *Billable* icon:pay_cash[set=plenty] icon:toggle-off[role="red"] to bill the time. +
