...
====
The <<crm/managing-contacts#350, Old online shop:{nbsp}Converting a guest account into a regular account>> chapter on the <<crm/managing-contacts#, Contacts>> page describes how to convert Callisto guest orders into regular accounts. It is not possible via the contact data record to convert plentyShop guest orders into regular accounts.
