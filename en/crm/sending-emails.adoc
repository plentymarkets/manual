...
login details, HTML design, info service, email template, e-mail template, email, e-mail, template variable, template variables, template functions, automatic email, event procedure
...
Users of the type *Back end* can only access limited areas and menus in the plentymarkets back end. Thus, their access to the system is limited. If users of this type should be able to carry out certain settings in the email area, a user of the type *Admin* has to assign the rights listed in <<#table-email-user-rights>> to those users.
...
. In the *Authorisations* area, activate the rights as listed in <<#table-email-user-rights>>.
. *Save* (icon:save[role="green"]) the settings.

[[table-email-user-rights]]
.Assigning user rights for the email area
[cols="1,3"]
|====
|Setting |Explanation

| *CRM > Email > Edit automatic email*
|Authorises the back end user to edit the automatic email despatch.

| *CRM > Email > Edit HTML design*
|Authorises the back end user to edit the HTML design.

| *CRM > Email > Edit info service*
|Authorises the back end user to edit the info service.

| *CRM > Email > Edit newsletter*
|Authorises the back end user to edit newsletters.

| *CRM > Email > Edit signature*
|Authorises the back end user to edit the email signature.

| *CRM > Email > Edit template*
|Authorises the back end user to edit email templates.

| *CRM > Email > Edit access data*
|Authorises the back end user to edit the email server’s login details.
...
. Select an email template from the drop-down list in the line of the event. Pay attention to the explanations given in <<#table-events-automatic-emails>>.
. *Save* (icon:save[role="green"]) the settings.
...
In the checkout area, you are able to view and make changes to your personal data as well as view our bank details. When making a bank transfer, always specify the designated use that is saved in this area.
