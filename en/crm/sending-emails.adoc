...
In order to send emails, user data has to be saved in the <<business-decisions/user-accounts-access#10, Setup » Settings » User » Accounts>> menu. This data can be obtained from your provider and corresponds to the data that is saved in your email program.
