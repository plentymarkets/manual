...
image::crm/assets/crm-available-template-variables-item-list-part1.png[width=640, height=360]
...
image::crm/assets/crm-available-template-variables-item-list-part2.png[width=640, height=360]
