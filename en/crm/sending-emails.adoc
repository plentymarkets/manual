...
The ID is assigned by the system. The IDs are saved in the *Setup » Orders » Shipping » Settings* menu in the *Shipping service provider* tab.
...
The ID is assigned by the system. The IDs are listed in the *Setup » Orders » Payment » Payment methods* menu.

| `$ShippingProfileID`
|ID of the shipping profile. +
The ID is assigned by the system. The IDs are listed in the *Setup » Orders » Shipping » Settings* menu in the *Shipping profiles* tab.
...
| `$ReferrerID`
|ID of the referrer. +
The ID is assigned by the system. The IDs are listed in the *Setup » Orders » Referrers* menu.
...
| `$WarehouseID`
|ID of the warehouse. +
The ID is assigned by the system and cannot be changed. The ID is saved in the *Setup » Stock » Warehouse* » _Open warehouse_ » *Settings* menu.

| `$WebstoreID`
|ID of the client. +
The ID is assigned by the system and cannot be changed. The ID is saved in the *Setup » Client* » _Select client_ » *Settings* menu.
...
|Text of the item availability net stock. +
This is not a global template variable, but a variable that is set per order item. It can only be used in the *Item list* tab of the email template.

| `$ItemAvailabilityID`
|ID of the item availability net stock. +
This is not a global template variable, but a variable that is set per order item. It can only be used in the *Item list* tab of the email template.

| `$ItemAvailabilityPhysicalStockLabel`
|Text of the item availability physical stock. +
This is not a global template variable, but a variable that is set per order item. It can only be used in the *Item list* tab of the email template.

| `$ItemAvailabilityPhysicalStockId`
|ID of the item availability physical stock. +
This is not a global template variable, but a variable that is set per order item. It can only be used in the *Item list* tab of the email template.
