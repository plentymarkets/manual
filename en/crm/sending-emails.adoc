...
====
To see a CMS syntax overview that you can still use in the "old" email templates, refer to this <<online-store/online-store/cms-syntax#, section of the manual>>.
==== 
