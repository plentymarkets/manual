...
In the *System » Client » Open client » Email » Access data* menu, you save the access data of a mailbox so that plentymarkets emails such as order or shipping confirmations can be sent from this email address.
...
Set up SSL encryption for protected data transfer between your email programs and your mailbox. Table 2 explains the settings for SSL encryption in the *System » Client » Open client » Email » Access data* menu.
...
plentymarkets also provides STARTTLS in order to ensure compatibility with older email programs. Table 3 explains the settings for STARTTLS encryption in the *System » Client » Open client » Email » Access data* menu.
...
Table 4 explains the settings for unencrypted communication in the *System » Client » Open client » Email » Access data* menu.
...
Go to *System » Client » Open client » Email » Signature* to save the signature. The signature will then be automatically inserted into an email template.
...
. Go to *System » Client » Open client » Email » Signature*.
...
. Go to *System » Client » Open client » Email » HTML design*.
...
Go to *System » Client » Open client » Email » Templates* to create new email templates. The folder *General email templates* already contains preconfigured email templates. You can of course make changes to these templates.
...
.Settings in the *System » Client » Open client » Email » Templates* menu
[cols="a,a"]
|====
|Setting |Explanation
...
|*Use design*
|Activate if the content of the email should be sent with the design that was saved under *System » Client » Open client » Email » HTML design*. If the option is not activated, then only the content of the email template will be used.
...
Open an email template in the *System » Client » Open client » Email » Templates* menu to display a list of all template variables and template functions that are available for your email templates.
...
You can edit general email templates, your own email templates and email templates of other users. Go to *System » Client » Open client » Email » Templates* to edit email templates.
...
Click on *Edit email template*. This will open the email template in the *System » Client » Open client » Email » Templates* menu. You can <<crm/sending-emails#1700, *edit*>> the email template there.

Table 7 lists explanations of some of the events.

.Explanations of some events in the *System » Client » Open client » Email » Automatic email* menu
[cols="a,a"]
|====
|Setting |Explanation
