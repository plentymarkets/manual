...
Go to *System » Client » Select client » Email » Signature* to save the signature. The signature will then be automatically inserted into an email template.
...
|*Use design*
|Activate if the content of the email should be sent with the design that was saved under *System » Client » Select client » Email » HTML design*. If the option is not activated, then only the content of the email template will be used.
...
Click on *Edit email template*. This will open the email template in the *System » Client » Select client » Email » Templates* menu. You can <<crm/sending-emails#1700, edit>> the email template there.

Table 7 lists explanations of some of the events.

.Explanations of some events in the *System » Client » Select client » Email » Automatic email* menu
[cols="a,a"]
|====
|Setting |Explanation
