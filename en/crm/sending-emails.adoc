...
Click on *Edit email template*. This opens the email template in the *System » Client » Select client » Email » Templates* menu. You can <<crm/sending-emails#1700, edit>> the email template there.
