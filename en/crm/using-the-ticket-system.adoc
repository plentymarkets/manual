...
Sending automatic email templates for service units in the *System » Client » Select client » Email » Automatic* menu will still apply for events that have been created in the contact data record.
...
For further information, refer to the <<basics/statistics#80, Tickets>> page of the manual. It is also described how to create and analyse statistics.
