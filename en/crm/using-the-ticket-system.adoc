...
| `$SignatureText`
|The following only applies if email templates are manually sent: Displays the complimentary close and the signature that were saved in the settings of the user account.
...
A ticket is made up of several messages and comments. The comments can only be read internally. In addition, you can add files and tasks to a ticket. One ticket can have several children and these children can have children themselves.
