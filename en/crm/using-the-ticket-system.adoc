...
Sending automatic email templates for service units in the *System » Client » Select client » Email » Automatic* menu will still apply for events that have been created in the contact and/or via the customer card.
...
. Select the filters. Pay attention to the explanations in the <<basics/working-with-plentymarkets/tasks-and-calendars#400, Searching for tasks>> chapter on the <<basics/working-with-plentymarkets/tasks-and-calendars#, Managing tasks and calendars>> page of the manual.
. Click on *Search*.
...
Your customers can create tickets in the *My account* area of your online store. They can send messages there and see answers to the ticket. If an event procedure is used to send the customer an email and this email contains the template variable *$TicketURL*, then the customer will be able to click on this link to directly open up the ticket in *My account* area. He or she will be able to answer the message there.
