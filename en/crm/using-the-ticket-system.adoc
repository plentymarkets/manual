...
. Carry out the desired settings. For further information, refer to the explanations on the <<crm/sending-emails#, Emails>> page of the manual in the <<crm/sending-emails#1200, Creating an email template>> chapter.
...
. Carry out the desired settings. Pay attention to the explanations in the <<welcome/general-functions/tasks-and-calendars#300, Creating a task>> chapter on the <<welcome/general-functions/tasks-and-calendars#, Tasks and calendars>> page of the manual.
. *Save* (icon:save[role="green"]) the settings. +
...
. Carry out the desired settings. Pay attention to the explanations in the <<welcome/general-functions/tasks-and-calendars#400, Searching for tasks>> chapter on the <<welcome/general-functions/tasks-and-calendars#, Tasks and calendars>> page of the manual.
. Click on *Search* (icon:search[role="blue"]).
...
. Carry out the desired settings. Note the information about *filters* in <<#table-search-ticket>> in the <<crm/using-the-ticket-system#3400, Searching for tickets>> chapter.
. *Save* (icon:save[role="green"]) the settings.
