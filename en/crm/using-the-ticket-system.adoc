...
| *Create card*
|Creates a new card for the board selected in the drop-down list. It is also possible to add a prefix to the card. Create <<welcome/customise-system#370, boards>> in the *plentymarkets logo (Start) » Boards* menu.
