...
.Observe test mode
====
After you have carried out all tests, you have deactivate the test mode in the *System » Client » Select client » Email » Access data* menu. If you do not deactivate the test mode, tickets will only be sent to the email address that is saved in the *System » CRM » Ticket system » Email accounts* menu.
====
...
|*Role*
|Select the owner's role from the drop-down menu. You can select the <<crm/using-the-ticket-system#700, roles>> that you set up in the *System » CRM » Ticket system » Settings » Tab: Roles* menu. +
...
|*Type*
|Select a type from the drop-down menu. You can select the types that you created in the *System » CRM » Ticket system » Settings » Tab: Types & Status* menu. +
This is a mandatory field. If no type has been selected, the ticket cannot be created.

|*Status*
|Select the status from the drop-down menu. Only when a type has been selected before is the drop-down menu activated. You can select the statuses that you created in the *System » CRM » Ticket system » Settings » Tab: Types & Status* menu. +
...
. Select the <<crm/using-the-ticket-system#3100, template>> that you have previously created in the *System » CRM » Ticket system » Templates* menu from the drop-down menu.
...
====
If you set up multiple <<crm/using-the-ticket-system#2100, email accounts>> under *System » CRM » Ticket system » Email accounts*, then the email account that was set up first will be used for sending answers to form tickets.
====
...
Go to *System » CRM » Ticket system » Procedures* and set up procedures that will be carried out automatically by your plentymarkets system at a certain time. For example, you could set up a procedure to automatically delete tickets if they were not edited within a certain amount of time and if they have a specific status.
...
|*Role*
|Select one or more roles or all options from the drop-down menu. Go to <<crm/using-the-ticket-system#700, System » CRM » Ticket system » Settings>> to create roles.
...
After you saved the <<crm/using-the-ticket-system#5300, ticket card template>> in the *System » CRM » Ticket system » Ticket cards*, it will be available in the *CRM » Ticket system » Tab: Tickets* menu in the drop-down menu *Print ticket* of the *Group function*. Proceed as follows to export your tickets in a PDF file.
