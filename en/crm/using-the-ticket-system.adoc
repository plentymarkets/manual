...
Go to *System » Settings » User » Account » Open user » Tab: Owner* to activate owners. Activate the *Ticket* option for each user who should be available as an owner in the ticket system. For further information, refer to the <<basics/admin-tasks/manage-users#40, Managing user accounts>> page of the manual.
...
|*Role*
|Select the role of the owner from the drop-down list. You can select the <<crm/using-the-ticket-system#700, roles>> that you set up in the *System » CRM » Ticket system » Settings » Tab: Roles* menu. +
...
Use this menu to create as many procedures as you like and select filters and a time for theses procedures. For further information about setting up the procedure manager, refer to the <<basics/automation/procedure-manager#, Procedure manager>> page of the manual.
...
|*Customer class*
|Select a customer class to only search for tickets that belong to customers with this customer class. Go to <<crm/managing-contacts#15, System » CRM » Classes>> to create further classes.
...
Go to *System » CRM » Ticket system » Ticket cards* to create a print template that is used to generate your tickets as PDF files which you can file or print. Setting up ticket cards can basically be compared to the procedure of setting up <<fulfilment/generating-documents#400, label templates>>.
