...
. Carry out the settings. Pay attention to the information about *filters* given in <<tabelle-ticket-suchen>> in the <<crm/using-the-ticket-system#3400, Searching for tickets>> chapter.
. *Save* (icon:save[role="green"]) the settings.
