...
Go to *Setup » Settings » User » Account » Open user » Tab: Owner* to activate owners. Activate the *Ticket* option for each user who should be available as an owner in the ticket system. For further information, refer to the <<basics/admin-tasks/manage-users#40, Managing user accounts>> page of the manual.

[#500]
=== Assigning rights

You need to assign a right to users of the *Variable* user class. By doing so, they are able to use the ticket system. Go to *Setup » Settings » User » Account » Open user » Tab: Right » Tab: Menu* to enable him or her to use the ticket system. Activate the *Ticket system* option in the *Customers* area. For further information, refer to the <<basics/admin-tasks/manage-users#90, Managing user accounts>> page of the manual.
...
.Observe test mode
====
After you have carried out all tests, you have deactivate the test mode in the *Setup » Client » Select client » Email » Login details* menu. If you do not deactivate the test mode, tickets are only sent to the email address that is saved in the *Setup » CRM » Ticket system » Email accounts* menu.
====
...
. Go to *Setup » CRM » Ticket system » Settings » Tab: Roles*.
. Click on *Add*. +
...
. Go to *Setup » CRM » Ticket system » Settings » Tab: Types & Status*.
. Click on *New type*. +
...
. Go to *Setup » CRM » Ticket system » Settings » Tab: Status groups*.
...
. Go to *Setup » CRM » Ticket system » Settings » Tab: Topics*.
. Click on *Add*.
...
|*Role*
|Select the role of the owner from the drop-down list. You can select the <<crm/using-the-ticket-system#700, roles>> that you set up in the *Setup » CRM » Ticket system » Settings » Tab: Roles* menu. +
...
|*Type*
|Select the type from the drop-down list. You can select the types that you created in the *Setup » CRM » Ticket system » Settings » Tab: Types & Status* menu. +
This is a mandatory field. If no type has been selected, the ticket cannot be created.

|*Status*
|Select the status from the drop-down list. Only when a type has been selected before is the drop-down list activated. You can select the statuses that you created in the *Setup » CRM » Ticket system » Settings » Tab: Types & Status* menu. +
...
|*Hide / Show tags*
|Displays or hides tags. If *Show list of tags* is activated, the area *Tags* is displayed on the right side of the ticket. Further <<basics/working-with-plentymarkets/tags#, tags>> that were created before in the *Setup » Settings » Tags* menu can be added here. You can save as many tags for the ticket as needed.
|====
...
|*Type*
|Select a ticket type to create a template for this type. Ticket types are created in the <<crm/using-the-ticket-system#800, Setup » CRM » Ticket system » Settings » Tab: Types & Status>> menu.

|*Status*
|Select a ticket status to create a template for this status. Ticket statuses are created in the <<crm/using-the-ticket-system#900, Setup » CRM » Ticket system » Settings » Tab: Types & Status>> menu.
...
|*Customer class*
|Select a customer class to only search for tickets that belong to customers with this customer class. Go to <<crm/managing-contacts#15, Setup » CRM » Classes>> to create further classes.
...
|*Role*
|Select one or multiple roles or all options from the drop-down list. Go to <<crm/using-the-ticket-system#700, Setup » CRM » Ticket system » Settings>> to create roles.
...
The procedure manager in the *Setup » CRM » Ticket system » Procedures* can be used to remind you of the ticket. An example how to set up a procedure and select filters and the time can be found in this <<crm/using-the-ticket-system#3000, chapter>>.

|*Tags*
|Click into the field. Select one or more tags to only search for tickets that contain these tags. First tags must be created in the *Setup » Settings » Tags* menu.
|====
...
|*Type*
|Displays the type. Ticket types are created in the <<crm/using-the-ticket-system#800, Setup » CRM » Ticket system » Settings » Tab: Types & Status>> menu.

|*Status*
|Displays the current status. Ticket statuses are created in the <<crm/using-the-ticket-system#900, Setup » CRM » Ticket system » Settings » Tab: Types & Status>> menu.

|*Folder*
|Displays the folder. Folders are created in the <<crm/using-the-ticket-system#4500, Setup » CRM » Ticket system » Tab: Folder>> menu.
...
Go to *Setup » CRM » Ticket system » Ticket cards* to create a print template that is used to generate your tickets as PDF files which you can file or print. Setting up ticket cards can basically be compared to the procedure of setting up <<fulfilment/generating-documents#address-label-template, label templates>>.
...
After you saved the <<crm/using-the-ticket-system#5300, ticket card template>> in the *Setup » CRM » Ticket system » Ticket cards*, it is available in the *CRM » Ticket system » Tab: Tickets* menu in the drop-down list *Print ticket* of the *Group function*. Proceed as follows to export your tickets in a PDF file.
