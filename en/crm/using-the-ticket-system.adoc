...
Depending on which plentymarkets tariff you use, you may have to book the ticket system before you are able to use it. You find an overview on the plentymarkets tariffs on this link:https://www.plentymarkets.co.uk/prices[page^]{nbsp}icon:external-link[].
...
Go to *Setup » Settings » User » Account* » _Open user_ and activate the owners in the *Owner* tab. Activate the *Ticket* option for each user who should be available as an owner in the ticket system. For further information, refer to the <<business-decisions/user-accounts-access#40, Managing user accounts>> page of the manual.
...
2+| *Account* (icon:exclamation-triangle[role="red"] *_Note:_* The setting in this section is mandatory.)

| *Email*
|Enter the email address that should be used for the ticket system. This is a mandatory field.

2+| *Retrieval* (icon:exclamation-triangle[role="red"] *_Note:_* All settings in this section are mandatory.)
...
2+| *Despatch* (icon:exclamation-triangle[role="red"] *_Note:_* All settings in this section are mandatory.)
...
| *Tags*
|Click to add tags. You can select the tags that you set up in the *Setup » Settings » Tags* menu. For further information, refer to the <<welcome/general-functions/tags#, Tags>> page of the manual.
...
| *Hide / Show tags*
|Shows or hides tags. If *Show tags* is activated, the area *Tags* is displayed on the right side of the ticket. Further <<welcome/general-functions/tags#, tags>> that were created before in the *Setup » Settings » Tags* menu can be added here. You can save as many tags for the ticket as needed.

| *Create card*
|Creates a new card for the board selected in the drop-down list. It is also possible to add a prefix to the card. Create <<welcome/general-functions/boards#, boards>> in the *plentymarkets logo (Start) » Boards* menu.
...
image::crm/assets/crm-ticket-system-event-procedure-automatic-reply-customer.png[width=640, height=360]
...
| *Tags*
|Select tags to create a template with these tags. Go to <<welcome/general-functions/tags#, Setup » Settings » Tags>> to create tags.
...
If you activated the option *Attachment* via the <<welcome/customise-system#160, Customising the layout>> in the *CRM » Ticket system* menu in the *Tickets* tab, you can directly see in the ticket overview the tickets that have an attachment.
...
. Carry out the settings. Pay attention to the explanations in the <<welcome/general-functions/tasks-and-calendars#300, Creating a task>> chapter on the <<welcome/general-functions/tasks-and-calendars#, Tasks and calendars>> page of the manual.
. *Save* (icon:save[role="green"]) the settings. +
...
. Carry out the settings. Pay attention to the explanations in the <<welcome/general-functions/tasks-and-calendars#400, Searching for tasks>> chapter on the <<welcome/general-functions/tasks-and-calendars#, Tasks and calendars>> page of the manual.
. Click on *Search* (icon:search[role="blue"]).
...
For further information, refer to the <<business-decisions/business-intelligence/statistics#, Statistics>> page of the manual. It is also described there how to create and analyse statistics.
