...
. Go to *System » System settings » CRM » Ticket System » System settings » Email accounts*.
...
. Go to *System » System settings » CRM » Ticket System » System settings » Settings » Tab: Roles*.
. Click on *Add*. +
...
. Go to *System » System settings » CRM » Ticket System » System settings » Settings » Tab: Types & Status*.
. Click on *New type*. +
...
Go to *System » System settings » CRM » Ticket System » System settings » Settings » Tab: Status groups* to create different status groups. Status groups help you keep track of your tickets within the ticket system. For example, if you created 10 statuses to help you follow a task from start to finish and these statuses are only relevant to one department within your company, you may find it helpful to combine these statuses into one status group.
...
. Go to *System » System settings » CRM » Ticket System » System settings » Settings » Tab: Status groups*.
...
.Settings in the *CRM » Ticket System » System settings » Tab: New ticket* menu
[cols="1,3"]
|====
|Setting |Explanation

|*Role*
|Select the role of the owner from the drop-down list. You can select the <<crm/using-the-ticket-system#700, roles>> that you set up in the *System » System settings » CRM » Ticket System » System settings » Settings » Tab: Roles* menu. +
...
|*Type*
|Select the type from the drop-down list. You can select the types that you created in the *System » System settings » CRM » Ticket System » System settings » Settings » Tab: Types & Status* menu. +
This is a mandatory field. If no type has been selected, the ticket cannot be created.

|*Status*
|Select the status from the drop-down list. Only when a type has been selected before is the drop-down list activated. You can select the statuses that you created in the *System » System settings » CRM » Ticket System » System settings » Settings » Tab: Types & Status* menu. +
...
.Toolbar in the *CRM » Ticket System » System settings » Open ticket* menu
[cols="1,3"]
|====
|Setting |Explanation
...
. Select the <<crm/using-the-ticket-system#3100, template>> that you have previously created in the *System » System settings » CRM » Ticket System » System settings » Templates* menu from the drop-down list.
...
====
If you set up multiple <<crm/using-the-ticket-system#2100, email accounts>> under *System » System settings » CRM » Ticket System » System settings » Email accounts*, the email account that was set up first is used for sending answers to form tickets.
====
...
====
In the *System » System settings » CRM » Ticket System » System settings » Events* menu, it is possible to add the event *New event* and the filters *Service type*, *Bill* and *Duration*. This allows you to differentiate in more detail and thus to also send different email templates.
...
*_Important:_* This function was deactivated for the ticket system. This is why you have to set up a new event procedure in the *System » System settings » CRM » Ticket System » System settings » Events* menu.
====
...
--
. Go to *System » System settings » CRM » Ticket System » System settings » Events*.
...
Go to *System » System settings » CRM » Ticket System » System settings » Procedures* and set up procedures that are carried out automatically by your plentymarkets system at a certain time. For example, you could set up a procedure to automatically delete tickets if they were not edited within a certain amount of time and if they have a specific status.
...
. Go to *System » System settings » CRM » Ticket System » System settings » Procedures*.
...
Go to *System » System settings » CRM » Ticket System » System settings » Templates* to create templates for your tickets. Templates help you work with the ticket system more efficiently. Furthermore, you can decide which user roles the ticket templates should be available for. They can be used for specific roles or for all roles. This helps you keep track of even a large number of templates.

[.instruction]
Creating a general ticket template:

. Go to *System » System settings » CRM » Ticket System » System settings » Templates*.
...
|*Type*
|Select a ticket type to create a template for this type. Ticket types are created in the <<crm/using-the-ticket-system#800, System » System settings » CRM » Ticket System » System settings » Settings » Tab: Types & Status>> menu.

|*Status*
|Select a ticket status to create a template for this status. Ticket statuses are created in the <<crm/using-the-ticket-system#900, System » System settings » CRM » Ticket System » System settings » Settings » Tab: Types & Status>> menu.
...
Above the ticket overview in the *CRM » Ticket System » System settings » Tab: Tickets* menu, you can create a new ticket manually or from a template. You can also select personal templates or use the group function. <<table-ticket-overview>> explains the settings that you can carry out in the *Tickets* tab.

[[table-ticket-overview]]
.Settings in the *CRM » Ticket System » System settings » Tab: Tickets* menu
[cols="1,3"]
|====
|Setting |Explanation
...
[[table-search-ticket]]
.Search options in the *CRM » Ticket System » System settings » Tab: Tickets* menu
[cols="1,3"]
|====
|Setting |Explanation
...
Go to *System » System settings » CRM » Ticket System » System settings » Settings* to edit existing <<crm/using-the-ticket-system#800, types>> and <<crm/using-the-ticket-system#900, statuses>> or to create new ones.

|*Status group*
|Select one, multiple or all options from the drop-down list. +
Go to *System » System settings » CRM » Ticket System » System settings » Settings* to edit existing <<crm/using-the-ticket-system#1000, status groups>> and to create new ones.
...
|*Role*
|Select one or multiple roles or all options from the drop-down list. Go to <<crm/using-the-ticket-system#700, System » System settings » CRM » Ticket System » System settings » Settings>> to create roles.
...
The procedure manager in the *System » System settings » CRM » Ticket System » System settings » Procedures* can be used to remind you of the ticket. An example how to set up a procedure and select filters and the time can be found in this <<crm/using-the-ticket-system#3000, chapter>>.
...
You can see all the settings of your ticket at a glance in the *CRM » Ticket System » System settings » Open ticket » Tab: Ticket* menu. You can also change some of the settings here. <<table-edit-ticket>> explains the setting options for your tickets.

[[table-edit-ticket]]
.Settings in the *CRM » Ticket System » System settings » Open ticket » Tab: Ticket* menu
[cols="1,3"]
|====
|Setting |Explanation
...
|*Type*
|Displays the type. Ticket types are created in the <<crm/using-the-ticket-system#800, System » System settings » CRM » Ticket System » System settings » Settings » Tab: Types & Status>> menu.

|*Status*
|Displays the current status. Ticket statuses are created in the <<crm/using-the-ticket-system#900, System » System settings » CRM » Ticket System » System settings » Settings » Tab: Types & Status>> menu.

|*Folder*
|Displays the folder. Folders are created in the <<crm/using-the-ticket-system#4500, CRM » Ticket System » System settings » Tab: Folder>> menu.
...
The menu *CRM » Ticket System » System settings » Open ticket » Tab: Customer* contains the customer data as it is also found in the <<crm/crm/managing-contacts#300, CRM » Contacts » Open contact>> menu. You can also edit the customer data record here. This tab is only visible if the ticket is linked to a customer.

[#3800]
=== Displaying orders

Go to *CRM » Ticket System » System settings » Open ticket » Tab: Search orders* to see the customer's orders. You can search for orders and edit them in this menu. This tab is only visible if the ticket is linked to a customer.

[#3900]
=== Showing the attachment

Go to *CRM » Ticket System » System settings » Open ticket » Tab: Attachment* to see all file attachments that were uploaded to this tab. Both your customers and staff members can attach documents to tickets and have permanent access to them. The number of attachments is displayed in parentheses in the tab's title. Once the first file has been successfully uploaded, a table is displayed. The table lists the file name, the name of the employee or customer who uploaded the file as well as the visibility and the date.
...
If you activated the option *Attachment* via the <<basics/working-with-plentymarkets/general-functions#50, Customising the layout>> in the *CRM » Ticket System » System settings » Tab: Tickets* menu, you can directly see in the ticket overview the tickets that have an attachment.
...
. Go to *CRM » Ticket System » System settings » Open ticket » Tab: Tasks*.
...
. Go to *CRM » Ticket System » System settings » Open ticket » Tab: Children*.
...
====
Create a child ticket in the *Children* tab of the *CRM » Ticket System » System settings » Open ticket » Tab: Children* menu. Click on *New ticket*. Carry out the settings as desired. This new ticket is automatically assigned to the main ticket and can be found in it's *Children* tab.
====
...
Go to *System » System settings » CRM » Ticket System » System settings » Ticket cards* to create a print template that is used to generate your tickets as PDF files which you can file or print. Setting up ticket cards can basically be compared to the procedure of setting up <<fulfilment/generating-documents#400, label templates>>.
...
. Go to *System » System settings » CRM » Ticket System » System settings » Ticket cards*.
...
After you saved the <<crm/using-the-ticket-system#5300, ticket card template>> in the *System » System settings » CRM » Ticket System » System settings » Ticket cards*, it is available in the *CRM » Ticket System » System settings » Tab: Tickets* menu in the drop-down list *Print ticket* of the *Group function*. Proceed as follows to export your tickets in a PDF file.
