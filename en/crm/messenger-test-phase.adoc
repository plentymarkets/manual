...
Select also in this step an email template for the email despatch. Be sure to have the email template created in the <<crm/emailbuilder-test-phase#, EmailBuilder>> in advance. Note that the template you select here should contain Messenger variables. 
...
* Minutes of the message
* Billable minutes of the message
