...
2+| *Account* +
Click in the *Company* field to search for <<#crm/companies, existing company data records>> that you have already created in the *CRM » Companies* menu. Enter at least 3 letters of the name, town, street or country of the company. +
...
|If you have already allowed the two payment methods *Invoice* and *Debit* in the <<#create-customer-class, customer class>>, you _don’t_ need to carry out any settings here. Because: The settings in the customer class have priority over the settings in the contact data record. +
