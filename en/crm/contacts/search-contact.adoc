...
For further information, refer to the <<orders/managing-orders#260, Managing orders>> page of the manual.
...
For further information, refer to the <<orders/subscription#200, Subscription>> page.
...
** Deletes the contact after you have confirmed your decision.
