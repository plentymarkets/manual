...
You can adjust the CSS styling for this widget according to your needs in the *Custom styles* field. You can find some common examples how to adjust the CSS styling in the <<#widget-custom-style-examples, Examples: Adjusting custom styles in widget>>. +
...
You can find more examples about how to adjust the CSS styling in the <<#widget-custom-style-examples, Examples: Adjusting custom styles in widget>> chapter.
