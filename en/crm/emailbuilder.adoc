...
| *Image*
| Use this widget to upload images such as your company logo to show it in your email templates. Click on icon:settings[set=material] to open the settings. You can adjust the width and height of the image, upload the image, enter an alternative text and adjust the styling in CSS format. 
