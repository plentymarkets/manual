...
|Here, you can adjust the CSS styling of your templates. You can find some common examples how to adjust the CSS styling in the <<#widget-custom-style-examples, Examples: Adjusting custom styles in widget>>.
...
Click on icon:settings[set=material] to open the settings. You can adjust the CSS styling for this widget according to your needs in the *Custom styles* field. You can find some common examples in the <<#widget-custom-style-examples, Examples: Adjusting custom styles in widget>>.
...
Click on icon:settings[set=material] to open the settings. You can adjust the CSS styling for this widget according to your needs in the *Custom styles* field. You can find some common examples in the <<#widget-custom-style-examples, Examples: Adjusting custom styles in widget>>. Click on *Close settings* (icon:times[]) to close the settings. Click on *Delete widget* (icon:delete[set=material]) to remove the widget.
...
You can adjust the CSS styling for this widget according to your needs in the *Custom styles* field. You can find some common examples in the <<#widget-custom-style-examples, Examples: Adjusting custom styles in widget>>. +
Click on *Close settings* (icon:times[]) to close the settings. Click on *Delete widget* (icon:delete[set=material]) to remove the widget.
...
You can find more examples in the <<#widget-custom-style-examples, Examples: Adjusting custom styles in widget>> chapter.
...
[discrete]
==== Examples: Adjusting custom styles in widget

You can adjust the CSS styling according to your needs for every <<#insert-widget, widget>> in the EmailBuilder. In the following list, you can find some common examples.

[TIP]
If you want to save multiple CSS stylings, enter all values one behind the other, separated by a semicolon.
...
Further information can be found link:https://www.w3schools.com/css/default.asp[here^]{nbsp}icon:external-link[], for example.
