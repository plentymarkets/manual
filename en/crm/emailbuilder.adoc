...
[source,plenty]
----
include::assets/emailbuilder-code-example-shipping-profile.html[]
...
[source,plenty]
----
include::assets/emailbuilder-code-example-bank-details.html[]
...
[source,plenty]
----
include::assets/emailbuilder-code-example-order-items.html[]
