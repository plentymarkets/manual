...
image::crm/assets/emailbuilder-folder-structure-with-default-templates.png[width=640, height=360]
...
|This drop-down list provides all attachments that you uploaded before in the *CMS » Documents* menu. These are, for example, installation guides or product data sheets. You can upload up to 3 static attachments here.

| *Select dynamic attachments*
|This drop-down list provides all <<orders/order-documents#100, location-based documents>> that you set up in the *Setup » Client » [Select client] » Locations » [Select location] » Documents*. You can upload up to 3 dynamic attachments here. eingerichtet hast.
