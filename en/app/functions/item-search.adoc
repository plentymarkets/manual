...
|*Item label*
|Do you want to use the plentymarkets app to print item labels? Choose the item label that you’ve designed for this purpose. +
...
* use templates to design your labels
