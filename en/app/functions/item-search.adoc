...
:keywords: App, plentymarkets app, item data, app item search, item search, searching for items, customising the item search, label printing, printing labels, printer, order search, searching for orders, customising the order search, filter, item filter,item filters, filter app
