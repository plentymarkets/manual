...
:author: team-mobile
:keywords: key figures, key performance indicators, items sold, revenue, display revenue, display first orders, dashboard
:position: 10
...
. Tap on the newly created field to carry out the settings described in <<table-app-key-figures-settings>> to specify the range of data used for displaying the key figure.
