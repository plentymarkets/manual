...
This page of the manual guides you through the process step by step. It teaches you how to set up and use these functions.
...
====
Check the <<welcome/quick-start/quick-start-system-requirements#, system requirements>> page of the manual to see current hardware recommendations for booking in items using the plentymarkets app.
====
...
. *_Optional:_* Assign additional individual rights. Note <<table-app-rights-for-incoming-items>>.
. *Save* the settings.
...
. Carry out the settings. Note <<table-app-settings-for-incoming-items>>. +
...
.Hardware for the plentymarkets app
====
Check the <<welcome/quick-start/quick-start-system-requirements#, system requirements>> page of the manual to see current hardware recommendations for redistributing stock using the plentymarkets app.
====
