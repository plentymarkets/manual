...
|*Template*
|What should your <<app/functions/warehouse-management/reshelving#500, list of items>> look like? The plentymarkets app comes with a default template, which is appropriate for most reshelving processes. However, you can create additional templates in the menu *System » System settings » plenty app » Mobile pick list*. Once you've created a template, you'll be able to select it from the drop-down list here. +
