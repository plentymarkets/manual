...
====
Check the <<welcome/quick-start/quick-start-system-requirements#, system requirements>> page of the manual to see current hardware recommendations for stocktaking using the plentymarkets app.
====
...
. In the *Authorization* column, activate the right *Stock » Warehouses » Warehouse location » Show*.
. *Save* the settings.
