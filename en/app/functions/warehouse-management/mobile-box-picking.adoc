...
*_Tip:_* You can customise the <<stock-management/setting-up-a-warehouse#200, warehouses>> in this drop-down list. This is done in the menu _System » System settings » Stock » Warehouse_.
