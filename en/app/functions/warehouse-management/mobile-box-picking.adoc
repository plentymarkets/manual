...
====
*Admin* <<basics/admin-tasks/manage-users#10, users>> are allowed to work with any function. You won't need to make any changes to their account settings. On the other hand, *Backend* and *REST-API* accounts don't automatically have rights.
====
