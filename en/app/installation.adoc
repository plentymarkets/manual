...
If you don’t know the URL, then you can find this information under *System » System settings » Client » Select client » Settings*. The URL is listed in the *Domain* field.
