...
:author: team-mobile
:keywords: plentymarkets App, download app, hardware, company data, manage company data, managing company data, mobile inventory, mobile inventory management system, POS, plentymarkets POS, plentyPOS, point of sale, POS system, app PIN, online mode, offline mode, customise app, customising the app, plentyBase, plentyBase installation file
:position: 10
:icons: font
...
In addition, the plentymarkets app allows you to perform stock management tasks and to use the point of sale system plentyPOS. We recommend that you book a link:https://www.plentypos.de/[hardware package^]{nbsp}icon:external-link[] if you want to use these additional functions.
...
The app will only work if you’ve link:https://www.plentymarkets.co.uk/free-trial/[booked a plentymarkets ERP system^]{nbsp}icon:external-link[]. In other words, users will log in with the same access data as they use for the plentymarkets system.
...
Your link:https://www.plentymarkets.co.uk/prices/[plentymarkets rate^]{nbsp}icon:external-link[] specifies how many users can log into plentymarkets at the same time. This limit applies to your plentymarkets back end and to the plentymarkets app.
...
The plentymarkets app will only work if you’ve link:https://www.plentymarkets.co.uk/free-trial/[booked a plentymarkets ERP system^]{nbsp}icon:external-link[]. In other words, you’ll log in with the access data that you use for your plentymarkets system.
...
====
Alternatively, tap on the user icon icon:user[role="blue"] and then on the logout icon icon:sign-out[role="red"]. Note <<table-app-logout>>.
====
...
. Decide what this information should look like and where it should appear. Note <<table-template-information>>.
. *Save* (icon:save[role="green"]) the settings.
...
| *Description*
|Enter a title for this piece of information. The title is displayed directly above its corresponding information. If you don’t enter any text into this field, then the information will be displayed without a title. +
...
plentyBase is a tool that makes it possible for your own computer to communicate with plentymarkets.
...
. Install plentyBase onto your computer. Configure the settings as described in the link:https://marketplace.plentymarkets.com/en/plugins/integration/plentybase_5053#40.[plentyBase documentation^]{nbsp}icon:external-link[]. +
...
. Configure the settings as described in the link:https://marketplace.plentymarkets.com/en/plugins/integration/plentybase_5053#140.[plentyBase documentation^]{nbsp}icon:external-link[].
. Tap on the check mark (icon:check[role="blue"]) in the upper right corner to confirm the change.

[#2100]
== Updating the app

Are you looking forward to an upcoming feature? We’re happy to keep you in the loop about changes to the software! Each version of the app gets its own version number. You can see a record of changes in our changelog. link:https://forum.plentymarkets.com/c/changelog/changelog-app[Subscribe to the changelog^]{nbsp}icon:external-link[] and always stay up to date.
...
Enter the domain without https:// or http://. If you don’t know the URL, then you can find this information under *Setup » Settings » API » Data*. The URL is listed in the *Host* field. If the problem continues to exist, link:https://forum.plentymarkets.com/c/app-pos[ask the app team for help in the forum^]{nbsp}icon:external-link[]. +
+
*Correct example*\: your-store.co.uk +
*Incorrect example*\: \\https://your-store.co.uk +
*Incorrect example*\: your-store.co.uk/ +
