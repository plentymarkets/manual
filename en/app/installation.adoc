...
In addition, the plentymarkets app allows you to perform stock management tasks and to use the point of sale system plentyPOS. We recommend that you book a link:https://www.plentypos.de/[hardware package^] if you want to use these additional functions.
