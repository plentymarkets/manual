...
:keywords: plentymarkets App, download app, hardware, company data, manage company data, managing company data, mobile inventory, mobile inventory management system, POS, plentymarkets POS, point of sale, POS system, app PIN, online mode, offline mode, customise app, customising the app, plentyBase, plentyBase installation file
:position: 10
:icons: font
...
The app will only work if you’ve link:https://www.plentymarkets.co.uk/free-trial/[booked a plentymarkets ERP system^]. In other words, users will log in with the same access data as they use for the plentymarkets system.
...
* link:https://marketplace.plentymarkets.com/en/plugins/integration/plentybaseitemcachepos_6313[Continue ringing up customers with plentymarkets POS, even if your Internet connection is lost^]
...
. Install plentyBase onto your computer. Configure the settings as described in the link:https://marketplace.plentymarkets.com/en/plugins/integration/plentybase_5053#40.[plentyBase documentation^]. +
...
. Configure the settings as described in the link:https://marketplace.plentymarkets.com/en/plugins/integration/plentybase_5053#140.[plentyBase documentation^].
...
Enter the domain without https:// or http://. If you don’t know the URL, then you can find this information under *Setup » Settings » API » Data*. The URL is listed in the *Host* field. If the problem continues to exist, link:https://forum.plentymarkets.com/c/app-pos[ask the app team for help in the forum^]. +
+
*Correct example*\: your-store.co.uk +
*Incorrect example*\: \\https://your-store.co.uk +
*Incorrect example*\: your-store.co.uk/ +
