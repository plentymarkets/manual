...
Your link:https://www.plentymarkets.co.uk/prices/[plentymarkets edition^]{nbsp}icon:external-link[] specifies how many users can log into plentymarkets at the same time. This limit applies to your plentymarkets back end and to the plentymarkets app.
...
| *User*
|Which user account do you want to log in with? Enter the <<business-decisions/user-accounts-access#30, user name>> for this account.
...
| *Password*
|Enter the <<business-decisions/user-accounts-access#30, password>> for this account.
|====
