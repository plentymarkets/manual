...
The app will only work if you’ve link:https://www.plentymarkets.com/[booked a plentymarkets ERP system^]{nbsp}icon:external-link[]. In other words, users will log in with the same access data as they use for the plentymarkets system.
...
Your link:https://www.plentymarkets.com/product/pricing/[plentymarkets edition^]{nbsp}icon:external-link[] specifies how many users can log into plentymarkets at the same time. This limit applies to your plentymarkets back end and to the plentymarkets app.
