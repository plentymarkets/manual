...
If a *<<basics/admin-tasks/plentymarkets-account#ssl-certificate, SSL certificate>>* was set up, the client (store)'s URL will be displayed with *https* instead of *http*. +
