...
*__Important__*: If you use this setting you also need to go to *<<payment/managing-payment-methods#, System » Orders » Payment » Payment methods>>* and select the option *Show bank details* (place check mark) in the payment methods *Invoice* and *Cash in advance*.
...
__*Important:*__VAT rates have to be saved for the standard country of delivery. This is done in the *<<orders/aaccounting#, System » Client » Select client » Locations » Select location » Accounting>>* menu. +
