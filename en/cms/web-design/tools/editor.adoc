...
image::cms/web-design/tools/assets/EN-CMS-Web-Design-Tools-Editor-01.png[]

__Image 1: **editor** user interface__

For further information about creating and configuring **categories**, refer to the **<<item/categories#, Categories  >>** page of the manual
...
image::cms/web-design/tools/assets/EN-CMS-Web-Design-Tools-Editor-02.png[]
...
image::cms/web-design/tools/assets/EN-CMS-Web-Design-Tools-Editor-03.png[]
...
+
image::cms/web-design/tools/assets/DE-CMS-Webdesign-Werkzeuge-Editor-04-SI.png[]
+
...
+
image::cms/web-design/tools/assets/DE-CMS-Webdesign-Werkzeuge-Editor-05-SI.png[]
+
...
**Tip:** Alternatively, use HTML code to insert a table into the **source code** or the <<cms/web-design/tools/syntax-editor#, **syntax editor**  >>.
...
+
image::cms/web-design/tools/assets/DE-CMS-Webdesign-Werkzeuge-Editor-06-SI.png[]
+
...
image::cms/web-design/tools/assets/EN-CMS-Web-Design-Tools-Editor-07.png[]
