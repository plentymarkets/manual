...
image::cms/web-design/tools/assets/EN-CMS-Web-Design-Tools-Syntax-Editor01-SI.png[]
...
image::cms/web-design/tools/assets/EN-CMS-Web-Design-Tools-Syntax-Editor02-SI.png[]
...
image::cms/web-design/tools/assets/EN-CMS-Web-Design-Tools-Syntax-Editor03-SI.png[]
...
Emmet translates syntax similar to CSS into HTML code. You can use it to quickly generate simple or complex HTML structures. You may need to learn the <<cms/web-design/basic-information-about-syntax#, **syntax**  >> first. Users who are familiar with <<cms/web-design/editing-the-web-design/css#, **CSS**  >> or <<cms/web-design/basic-information-about-syntax/jquery#, **jQuery**  >> should not have any trouble learning Emmet. If you regularly write large quantities of HTML, then it is worthwhile to consider using Emmet.
...
Along with the shortcut keys listed here, plentymarkets also offers other useful shortcut keys that can be set up for each user. For further information, refer to the <<working-with-plentymarkets/manage-users#, **Managing user accounts**  >> page of the manual.
