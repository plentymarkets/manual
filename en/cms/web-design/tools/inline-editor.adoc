...
image::cms/web-design/tools/assets/EN-CMS-Web-design-Tools-Inline-editor-01-SI.png[]
...
.  Click on the following icon while editing a category or a design in the backend: image::cms/web-design/tools/assets/DE-Inline-Editor-Icon-SI.png[]
+
...
image::cms/web-design/tools/assets/EN-CMS-Web-design-Tools-Inline-editor-02-SI.png[]
...
**Important**: Placing a check mark does not change the design __**permanently**__. For further information about changing the **standard design**, refer to the <<cms/web-design/editing-the-web-design#4, **Editing the web design** >> page of the manual.
...
|**SetCategoryId**
| Displays the content of the open category within a different section of the online store. For further information, refer to the **<<cms-syntax/web-design/pagedesign/setcategoryid#, SetCategoryId  >>** page of the manual.
...
image::cms/web-design/tools/assets/EN-CMS-Web-design-Tools-Inline-editor-03-SI.png[]
...
image::cms/web-design/tools/assets/EN-CMS-Web-design-Tools-Inline-editor-04-SI.png[]
...
|**Apply template**
| Applies the template to another language. For further information, refer to the **<<cms/web-design/user-interface#2-3, User interface >>** page of the manual.
...
image::cms/web-design/tools/assets/EN-CMS-Web-design-Tools-Inline-editor-05-SI.png[]
