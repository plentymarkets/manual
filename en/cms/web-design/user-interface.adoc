...
image::cms/web-design/assets/EN-CMS-Web-Design-User-Interface-01.png[]
...
|The following information provides a quick overview of the management functions. These functions are explained in more detail on the <<cms/web-design/editing-the-web-design#, **Editing the web design**  >> page of the manual. +
...
|**5**
|**Search function**
|Finds templates with the **<<cms/web-design/user-interface#2-1, search function >>**.
...
**Template variables and functions** = Opens an overview of <<cms-syntax/basics/template-variables#, **template variables**  >> and <<cms-syntax/basics/template-functions#, **template functions**  >>. +
**Apply template** = Applies the content of the particular **<<cms/web-design/user-interface#2-2, template to a different language >>**. +
...
image::cms/web-design/assets/EN-CMS-Web-Design-User-Interface-02.png[]
...
.Variable search
====
There is also a search function for **<<cms-syntax/basics/template-variables#, template variables  >>** and <<cms-syntax/basics/template-functions#, **template functions**  >>.
====
...
image::cms/web-design/assets/EN-CMS-Web-Design-User-Interface-03.png[]
