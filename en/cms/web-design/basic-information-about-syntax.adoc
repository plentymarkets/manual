...
Pay attention to the following explanations of pages within this chapter and refer to the <<cms/web-design/editing-the-web-design#, **Editing the web design**  >> page, which includes additional information about designing your online store.
...
jQuery is a fast and concise JavaScript Library that simplifies HTML document traversing, event handling, animating, and Ajax interactions for rapid web development. For further information, refer to the <<cms/web-design/basic-information-about-syntax/jquery#, **jQuery**  >> page of the manual.
