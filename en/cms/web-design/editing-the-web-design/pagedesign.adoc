...
The template is automatically loaded when the **<<cms/blog-weblog#, blog  >>** area is accessed.

=== PageDesignForum

The template is automatically loaded when the <<client-store/standard/modules/forum#, **forum**  >> area is accessed.
