...
image::cms/assets/EN-CMS-Blog-01.png[]
...
The language is a mandatory entry and has to be selected before the category. Languages that can be selected are created under **<<client-store/standard/modules/blog-weblog#, Settings » Client (store) » Standard » Modules » Blog  >>**. Blog entries can also be filtered by language.

|**Category**
|Select a category for the blog entry.  +
The category is mandatory. Blog categories are created under **<<client-store/standard/modules/blog-weblog#, Settings » Client (store) » Standard » Modules » Blog  >>**. +
...
image::cms/assets/EN-CMS-Blog-02.png[]
...
image::cms/assets/EN-CMS-Blog-03.png[]
...
image::cms/assets/EN-CMS-Blog-04.png[]
...
image::cms/assets/EN-CMS-Blog-05.png[]
...
image::cms/assets/EN-CMS-Blog-06.png[]
