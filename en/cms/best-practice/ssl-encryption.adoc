...
If having a __**secure connection**__ is important to you, then you will surely be interested in using __**<<start/plentymarkets-account/service-center/ssl-certificate#, SSL  >> encryption**__ for your website. Pay attention to the following information and carry out the steps completely. Make sure that your entire website is correctly encrypted to avoid causing confusion among visitors to your website or online store.
...
====
You need to delete your system's sitemap file after installing the <<start/plentymarkets-account/service-center/ssl-certificate#, **SSL certificate**  >>. This ensures that the sitemap file will be updated with the new encrypted URLs. The sitemap is updated daily in plentymarkets. This process takes place at night.
====
