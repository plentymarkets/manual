...
image::cms/assets/EN-CMS-FAQ01-SI.png[]
...
image::cms/assets/EN-CMS-FAQ02-SI.png[]
...
In order for the FAQs to be displayed, insert the **$Container_MiscFAQsList** template variable into the corresponding design **<<cms/web-design/editing-the-web-design/misc#, template  >>** or e.g. into a category page.
