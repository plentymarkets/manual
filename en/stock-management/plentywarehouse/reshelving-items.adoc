...
:position: 40
:id: A5QIHYV
:url: stock-management/plentywarehouse/reshelving-items

include::_textblocks/note-requirements.adoc[]
include::_textblocks/note-open-beta.adoc[]

The plentyWarehouse app includes a function for reshelving items. You can find information about it on this page. First, you'll read a short description of the function to help you understand the concept. Then you’ll learn about the <<app/functions/warehouse-management/reshelving#200, settings>>, which need to be carried out once in advance. These settings go into effect when you begin using the function.
...
. Tap on *Reshelving*  (image:stock-management/plentywarehouse/assets/icon_reshelving.png[width=14, height=14]).
...
|Where are your items located before they are reshelved? Tap on the desired <<stock-management/setting-up-a-warehouse#intable-purpose, storage location purposes>> to include them in or exclude them from the reshelving function. +
...
*Suggested storage locations* = Storage locations that are <<stock-management/new-incoming-items#200, linked to a variation>>. +
...
| *Purpose*
|Use this option to exclude storage locations with specific <<stock-management/setting-up-a-warehouse#intable-purpose, purposes>> from the list of suggested storage locations. +
...
→ plentymarkets changes the item’s storage location. A <<stock-management/managing-stocks#1100, stock movement>> is automatically created in your plentymarkets system. +
