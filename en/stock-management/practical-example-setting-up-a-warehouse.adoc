...
:keywords: Best Practices, Practical example, Setting up a warehouse, dimension, dimensions, storage building, rack, shelf, shelves, storage location, pick path, optimise pick path, label, storage location label, warehouse structure, plan warehouse structure, planning warehouse structure, warehouse setup, pick path example, example of pick path, storage location name
:position: 85
:id: Y67WMM2
...
image::stock-management/assets/label.png[]
