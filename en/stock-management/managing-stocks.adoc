...
If you work with plentymarkets, you also can redistribute stock using the plentymarkets app. Users with the user classes **Variable** and **Logistics** must be assigned the necessary rights. The rebooking templates and app settings allow you to personalise redistribution to suit your warehouse processes.
