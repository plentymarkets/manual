...
The system can reserver stock for listings and orders if you manage your stock in plentymarkets.
...
You can set up barcodes in the <<item/managing-items#630, System » Item » Barcode>> menu and then you need to <<item/managing-items#250, link the barcode with your variation>>.
...
→ You can select storage locations that are in use for this variation from the drop-down menu. Click on **Search** to add a new storage location.
...
====
Check the <<basics/first-steps/system-requirements#_managing_stock_with_the_plentymarkets_app, system requirements>> page of the manual to see current hardware recommendations for rebooking items using the plentymarkets app.
====
...
. Go to **System » plenty App » Rebooking**.
...
|**Show net stock**
|Activate to show the net stock at the source storage location when rebooking items using the app. +
Deactivated = Only the physical stock of the item at the source storage location is shown when rebooking items using the app. +
Activated = Both the physical stock and the net stock of the item at the source storage location is shown when rebooking items using the app.
...
====
The quantities entered will be reset, when you switch a page. This is why you need to click on reorder before you switch the page. As long as the reorder is still open further variations will simply be added to the reorder.
====
...
. If a suggestion does not seem right to you, you can simply enter the **quantity** that you wish to order.
...
[#1200]
== Depending automatic processes on stock
