...
====
When you switch a page, the quantities entered will be reset. This is why you need to click on reorder before you switch the page. As long as the reorder is still open, further variations will simply be added to the reorder.
====
...
For further info on the order status see <<order-processing/orders/managing-orders#1200, here>>.
====
...
You can export or import stock data and this way you can let your system know about the latest stocktaking that you carried out. The data format <<basics/data-exchange/export-import/data-formats/stock#, Stock>> contains the relevant stock data from your system. Data formats that might generally be useful when working with stock are:

* <<basics/data-exchange/export-import/data-formats/stock#, Stock>>,
* <<basics/data-exchange/export-import/data-formats/variationsupplier#, VariationSupplier>>,
* <<basics/data-exchange/export-import/data-formats/variationwarehouse#, VariationWarehouse>> and
* <<basics/data-exchange/export-import/data-formats/warehouse#, Warehouse>>
