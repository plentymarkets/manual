...
All data formats available in plentymarkets as well as a general description on how to export or import data from or into plentymarkets can be found in the <<data#, data exchange>> chapter of the manual.
