...
All data formats available in plentymarkets as well as a general description on how to export or import data from or into plenymarkets can be found in the **<<basics/data-exchange#, data exchange>>** chapter of the manuel.
