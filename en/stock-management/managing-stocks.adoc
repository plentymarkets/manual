...
icon:map-signs[] *_Or_*: Click on *Add import* in order to add an import of the type Item, Stock or Incoming items. For further information, refer to the <<data/importing-data/ElasticSync#1210, import tool>> page.
