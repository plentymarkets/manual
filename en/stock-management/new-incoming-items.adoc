...
Suppliers are created in the same way as <<crm/managing-customer-data#800, customers>> and then assigned the customer type Supplier.
...
Add an individual variation as described below. Information such as the purchase price and the storage location are not mandatory. If you do not want to enter these entries, then simply skip the corresponding steps in the description.
