...
|Enter the number of days that your supplier usually needs to deliver reordered variations. The delivery time can influence the quantity suggested for an reorder and the day that an reorder will be delivered. You can define whether or not the delivery time will influence the suggested quantity. The settings are in the **System » System settings » Stock » Reorder management » Settings** menu. The delivery time is here considered replacement time.
...
The *purchase price* setting can be found in the *System » System settings » Stock » Stock » Incoming items* menu. The option that you need to select is *Save live average purchase price in the variation data*. The other options available in the dropdown are explained in the <<table-transfer-of-purchase-price-and-storage-location>>
...
Go to *System » System settings » Stock » Stock » Incoming items* to activate the warehouses that will be used for calculating the moving average purchase price.
...
. Go to **System » System settings » Stock » Stock » Incoming items**.
...
. Go to **System » System settings » Stock » New incoming items**.
...
However, it is not enough to assign a price in the **System » System settings » Stock » New incoming items** menu in order to display a sales price in a variation. You also need to assign a sales price to a variation. Sales prices are created in the **System » System settings » Item » Sales prices** menu. How to create sales prices and how to assign them to variations is described in detail on the <<item/managing-items#, Managing items>> page of the manual. On this page you will also learn how to calculate prices for customer classes and so on.
...
In addition, at least one owner must be activated as <<basics/admin-tasks/manage-users#40, owner of incoming items>> so that the incoming items can be assigned to an owner.
...
. Select an owner.  +
→ If you were activated as an <<basics/admin-tasks/manage-users#40, owner of incoming items>>, then you will be selected by default since you are currently logged in.
...
. Open the menu *System » System settings » Settings » User*.
. Open the account.
...
The many ways to book stock into your system are e.g. Rest, dynamic import, the variation menu or the **Incoming items** menu. However, no matter how the stock was booked into your system all incoming items data records are listed in the **Stock » Incoming items** menu. The search is by month.
