...
In addition, at least one owner must be activated as <<business-decisions/user-accounts-access#40, owner of incoming items>> so that the incoming items can be assigned to an owner.
...
. Select an owner.  +
→ If you were activated as an <<business-decisions/user-accounts-access#40, owner of incoming items>>, then you will be selected by default since you are currently logged in.
...
You can also book in stock using the plentymarkets app. Refer to the <<app/functions/warehouse-management/receiving-rebooking#, Receiving goods and replenishing stock>> page of the manual to learn how it's done and which settings you'll need to configure in advance.
