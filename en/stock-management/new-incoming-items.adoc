...
However, it is not enough to assign a price in the **Settings » Stock » Neuer incoming items** menu in order to display a sales price in a variation. You also need to assign a sales price to a variation. Sales prices are created in the **System » Item » Sales prices** menu. How to create sales prices and how to assign them to variations is described in detail on the **<<item/managing-items#, Managing items>>** page of the manual. On this page you will also learn how to calculate prices for customer classes and so on.
