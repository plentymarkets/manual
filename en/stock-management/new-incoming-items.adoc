...
The values entered here are considered for markets such as <<multi-channel/neckermann-at#, **Neckermann**  >>, <<multi-channel/otto#, **Otto**  >> and <<multi-channel/plus-gartenxxl#, **Plus.de**  >>. The buffer entered here takes priority over the buffer values entered for the particular market.
...
Furthermore, at least one user must be activated as an **<<working-with-plentymarkets/manage-users#40, owner of incoming items >>**. This ensures that the incoming items can be assigned to a specific person.
...
. Select an owner.  +
→ If you were activated as an **<<working-with-plentymarkets/manage-users#40, owner of incoming items >>**, then you will be cted by default since you are currently logged in.
...
If you pay for the incoming items in a currency other than your **<<payment/currencies#30, standard currency >>**, then the **<<payment/currencies#20, exchange rate >>** will be entered automatically.
