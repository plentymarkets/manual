...
. Open the menu **System » Stock » Stock » Incoming items**.
...
In plentymarkets 7, you can book in stock using the plentymarkets app. Note that the user needs to have the right to book in stock. In addition, users can be granted the right to edit the purchase price when booking in items. Alternatively, either the **Net purchase price** saved in the **Settings** tab of the variation or the average net purchase price is inserted.

[TIP]
.Hardware for plentymarkets app
====
Check the **<<basics/first-steps/system-requirements#_managing_stock_with_the_plentymarkets_app, system requirements>>** page of the manual to see current hardware recommendations for booking in items using the plentymarkets app.
====
...
. If necessary, assign additional individual rights. Pay attention to the information given in table 6.
. **Save** the settings.
...
. Go to **Stock » New incoming items**.
. Select the desired search settings. Pay attention to the information given in table 8.
. Click on **Search**.
