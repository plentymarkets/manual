...
The many ways to book stock into your system are e.g. Rest, ElasticSync, the variation menu or the **Incoming items** menu. However, no matter how the stock was booked into your system all incoming items data records are listed in the **Stock » Incoming items** menu. The search is by month.
