...
The values entered here are considered for markets such as <<markets/neckermann/neckermann-at-setup#, Neckermann>>, <<markets/otto#, Otto>> and <<markets/plus-gartenxxl#, Plus.de>>. The buffer entered here takes priority over the buffer values entered for the particular market.
