...
Deactivated = Only the physical stock of the item at the storage is shown when booking in items using the app. +
Activated = Both the physical stock and the net stock of the item at the storage is shown when booking in items using the app.
|====
