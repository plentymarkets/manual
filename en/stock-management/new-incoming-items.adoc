...
The values entered here are considered for markets such as <<markets/amazon/amazon-setup#, Amazon>>, <<ebay/ebay-setup#, eBay>>, and <<markets/shopgate#, Shogate>>. The buffer entered here takes priority over the buffer values entered for the particular market.
