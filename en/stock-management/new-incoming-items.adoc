...
|Enter the number of days that your supplier usually needs to deliver reordered variations. The delivery time can influence the quantity suggested for an reorder and the day that an reorder will be delivered. You can define whether or not the delivery time will influence the suggested quantity. The settings are in the **Setup » Stock » Reorder management » Settings** menu. The delivery time is here considered replacement time.
