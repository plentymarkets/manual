...
* <<stock-management/plentywarehouse/items-and-storage-locations#100, Item search>>
* <<stock-management/plentywarehouse/items-and-storage-locations#400, Inspecting storage locations>>
* <<stock-management/plentywarehouse/redistributing-items#, Redistributing items>>
* <<stock-management/plentywarehouse/reshelving-items#, Reshelving items>>
* <<stock-management/plentywarehouse/carrying-out-stocktaking#, Taking stock>>
* <<stock-management/plentywarehouse/printing-labels#, Printing labels for items and storage locations>>
...
The <<stock-management/plentywarehouse/installation-and-initial-setup#, installation and initial setup>> page of the manual offers you detailed information on your first app login, finding your way around the plentyWarehouse app and carrying out the basic settings required before productive use of the app.