...
:keywords: goods issue, outgoing stock, outgoing items, stock management, book items out, book stock out, deliver variations, stock withdrawals, cancellation, return, warranty, warranties, manual booking, book outgoing items, outgoing items booked, procedure, status change, status 7, reverse outgoing items, book outgoing items automatically, booking outgoing items automatically, event procedure, package number, return reason, reason for return, book outgoing items manually, manually book outgoing items, invoice
:position: 80
:id: JTRIWSB
...
Ideally, you created and printed a **<<orders/order-documents/pick-list#, pick list>>** for the final order processing, you marked all of the orders that are already finished in this list and you stuck small barcode slips of the shipping labels next to the corresponding order.
...
How to create a return and how to book in returned variations is explained in detail on the **<<orders/managing-orders#400, Return>>** page of the manual.
...
How to create a warranty is explained more in detail on the **<<orders/managing-orders#600, warranty>>** page of the manual.
