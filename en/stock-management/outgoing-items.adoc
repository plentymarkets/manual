...
Ideally, you created and printed a **<<order-processing/orders/fulfillment/pick-list#, pick list  >>** for the final order processing, you marked all of the orders that are already finished in this list and you stuck small barcode slips of the shipping labels next to the corresponding order.
...
How to create a return and how to book in returned variations is explained in detail on the **<<order-processing/orders/editing-sales-orders/return#, Return  >>** page of the manual.
...
How to create a warranty is explained more in detail on the **<<order-processing/orders/editing-sales-orders/warranty#, Warranty  >>** page of the manual.
