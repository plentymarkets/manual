...
In the first step, go to **Data exchange » Export » Dynamic export** and use the data format **Stock** to export your current stock.
...
. Go to <<basics/data-exchange/exporting-data#, **Data exchange » Export » Dynamic export**  >>.
. Open the submenu for the data format <<basics/data-exchange/data-formats/stock#, **Stock**  >> or set this **<<basics/data-exchange/data-formats#2-2, data format >>** up if the submenu is not yet available.
...
====
The **WarehouseID** filter let's you define from which warehouse the stock will be exported. The **WarehouseID** data field simply contains the ID of a warehouse. The **WarehouseID** data field does not influence the content of the export.
====
...
. Go to <<basics/data-exchange/importing-data#, **Data exchange » Import » Dynamic import**  >>.
...
You can see detailed information about the data import in the **Data exchange » Import » Dynamic import » Submenu: Processing status** menu.
...
. Go to **Settings » Stock » Warehouse » Select warehouse » Submenu: Settings**
