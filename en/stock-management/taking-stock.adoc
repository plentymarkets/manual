...
. Go to <<data-exchange/exporting-data#, **Data exchange » Export » Dynamic export**  >>.
. Open the submenu for the data format <<data-exchange/data-formats/stock#, **Stock**  >> or set this **<<data-exchange/data-formats#2-2, data format >>** up if the submenu is not yet available.
