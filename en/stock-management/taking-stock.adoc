...
[TIP]
.Use the data format Stock
====
To check all stock discrepancies resulting from stocktaking at once, export your stock data using the data format <<basics/data-exchange/data-formats/stock#, Stock>> before and after the stocktaking process.
====
...
====
You can speed up stocktaking by *<<warenwirtschaft/lager-einrichten#800, labelling your storage locations>>*. During stocktaking, you can just scan the storage location's label.
====
