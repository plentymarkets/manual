...
:keywords: Redistribution, warehouse redistribution, storage location, storage locations, delivery note, PO delivery note, create PO delivery note, automatically create PO delivery note, document template, status, order status, owner, tag, tags, default status, default owner, messenger, redistribution id, order item, order items, book items out, booking items out, book variations in, booking variations in, unlock redistribution, search redistribution, automate redistributions, automating redistributions
:position: 50
:id: A5QIHYW
...
Tags are keywords that you create centrally before you can use them to mark data in different areas of your plentymarkets system. If you want to use tags with redistributions, you need to create those tags beforehand in the *Setup » Settings » Tags* menu. To do so, follow the instructions on the <<basics/working-with-plentymarkets/tags#, Tags>> page of the manual.
...
. Go to *Setup » Stock » Reorder management » Redistribution » Settings*.
...
. Go to *Setup » Stock » Reorder management » Redistribution » Documents » PO delivery note*.
...
You can also upload other documents belonging to a redistribution in the *Documents* section.
...
Files can be uploaded as pdfs, but also as csv, zip, doc, docx, xls, xlsx. Files with a size up tp 20 megabyte can be uploaded.
