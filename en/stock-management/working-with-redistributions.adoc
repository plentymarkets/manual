...
For further information about the messenger, refer to the chapter <<crm/managing-contacts#1390, Managing messages with the messenger>> on the <<crm/managing-contacts#, Contacts>> page of the manual.
