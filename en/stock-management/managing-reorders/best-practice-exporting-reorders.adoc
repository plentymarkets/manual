...
:keywords: Reorders, exporting reorder data, Elastic Export, FormatDesigner, export, data, reorder data, Format-Designer, format, orderItem, assignment, orderItemProperty, OrderItemProperty.value, warehouse, external item ID, order item filters, export files, supplier
