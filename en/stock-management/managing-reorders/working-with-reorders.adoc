...
| *Tags*
| Select a <<stock-management/managing-reorders/working-with-reorders#130, tag>> to search for reorders to which this tag was assigned. You can select several tags. This is an "or" search. This means that all reorders with at least one of the selected tags assigned are shown in the search results if you select more than one tag.
