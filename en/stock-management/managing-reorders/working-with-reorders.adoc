...
For further information about the messenger, refer to the chapter <<crm/managing-contacts#1390, Managing messages with the messenger>> on the <<crm/managing-contacts#, Managing contacts>> page of the manual.
...
| *Sender*
|If you selected the order type *Reorder*, you can choose one from the suppliers you listed in your plentymarkets system as the sender. Select one of the suppliers if you want to search for reorders you ordered from this supplier.

| *Recipient*
|If you selected the order type *Reorder*, you can choose one from the warehouses you listed in your plentymarkets system as the receiver. Select one of the warehouses if you want to search for reorders for this warehouse. +
