...
Tags are keywords that you create centrally before you can use them to mark data in different areas of your plentymarkets system. If you want to use tags with reorders, you need to create those tags beforehand in the *Setup » Settings » Tags* menu. To do so, follow the instructions on the <<welcome/general-functions/tags#, Managing tags>> page of the manual.
...
For general information on assigning user rights, refer to the <<business-decisions/user-accounts-access#105, Managing user accounts>> page of the manual.
...
You can cancel a reorder in the detail view, for example when variations included in the reorder will not be delivered anymore. Go to the *Stock » Reorder management » Purchase order* menu, open the required reorder and click on *Cancel open quantities* in the order items area. Those order items which were not delivered yet are taken out of the Supply. After you have done this, you have to finish the reorder by clicking on *Finish reorder* in the details of the reorder. By doing this, the open order items of the reorder are no longer in the Supply, the reorder will also no longer be listed in the backlog list and is thus completed.
