...
The overview table in the *Stock » Reorder management » Purchase order* menu as well as the tables in an opened reorder are customisable. This means that you can decide which information is displayed in the table rows. To do so, proceed as follows.
