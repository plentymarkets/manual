...
You can cancel a reorder in the detail view, for example when variations included in the reorder will not be delivered anymore.

[.instruction]
Proceed as follows:

. Go to the *Stock » Reorder management » Purchase order* menu.
. Select the required reorder and open the detail view.
. Click on *Cancel open quantities* in the order items area. +
→ Those order items which were not delivered yet are taken out of the Supply.
. Next, you have to finish the reorder by clicking on *Finish reorder* in the details of the reorder. +
