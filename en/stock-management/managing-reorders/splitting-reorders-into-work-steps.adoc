...
Go to <<crm/using-the-ticket-system#, System » Customers » Ticket system>> to set up the function for retrieving emails as well as to create ticket types and statuses.
