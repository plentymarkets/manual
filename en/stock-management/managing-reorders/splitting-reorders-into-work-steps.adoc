...
. Go to **Settings » Stock » Reorder management » Templates**.
...
|**Role**
|Select the role of the owner. Go to **Settings » Customers » Ticket system » Basic settings** to create roles for the ticket system. These are not the same as user roles.

|**Type**
|Select a type. Go to **Settings » Customers » Ticket system » Basic settings** to create ticket types.

|**Status**
|Select a status. Go to **Settings » Customers » Ticket system » Basic settings** to create statuses for tickets. You need to create ticket statuses for each ticket type. Therefore each type can have different statuses.
...
You only need to enter the <<working-with-plentymarkets/manage-users#30., email address >> in the user account.
...
. Select a **Ticket template** from the drop-down menu.
...
Go to <<crm/using-the-ticket-system#, Settings » Customers » Ticket system   >> to set up the function for retrieving emails as well as to create ticket types and statuses.
