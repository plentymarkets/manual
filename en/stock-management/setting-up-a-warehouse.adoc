...
This is a selection of countries of delivery as defined in <<fulfilment/preparing-the-shipment#100, System » System settings » Orders » Shipping » Settings » Countries of delivery>>.
...
The availability symbols are displayed according to the settings made in the section *Online store icon* in the menu *System » System settings » Item » Availability*.
...
. Go to *System » System settings » Stock » Warehouse » Select a warehouse » Submenu: Box storage racks*.
...
. Go to *System » System settings » Stock » Warehouse » Select a warehouse » Submenu: Label*.
...
Go to *System » System settings » Properties » Configuration* to create properties that you will later use for characterising your storage locations.
...
For the section storage location, only the types None and Selection are suitable. +
...
. Go to *System » System settings » Settings » Stock » Warehouse*. +
. Select a warehouse.
. Click on *Storage locations*. +
→ The overview opens.
