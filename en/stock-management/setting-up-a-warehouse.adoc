...
Here, you can select the countries that were set up as countries of delivery under **<<order-processing/fulfilment/preparing-the-shipment#, Settings » Orders » Shipping » Shipping options » Tab: Countries of delivery>>**.
