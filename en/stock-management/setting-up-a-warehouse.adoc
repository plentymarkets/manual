...
* Every storage location should be given a **label** with a barcode. This will ensure that you are able to make use of the **<<tools/plentymarkets-client#, plentymarkets Client  >>** tool.
...
|Select **Yes** if you are working with **<<orders/editing-sales-orders/delivery-order#, delivery orders  >>**.
