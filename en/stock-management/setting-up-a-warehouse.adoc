...
The stock has to be recalculated after all changes. This recalculation is carried out in the menu <<stock-management/managing-stocks#, Stock » Stocks>> by clicking on *Recalculate stocks*. +
...
. To the right, you can adjust the name and the position. Moreover, for new levels and new storage locations, you can determine in front of or behind which element it is inserted.
...
. Go to *System » System settings » Stock » Warehouse » Select warehouse » Submenu: Settings Label*.
...
That way, you can look for small, medium or large storage locations and all item IDs can be linked to it. In order to create a property, proceed as follows.

[.instruction]
Creating a property:

. Go to *System » System settings » Properties » Configuration*. +
...
*_Note:_* The description of the system language is displayed by default. After the property has been created, you can save the description in any language.
...
Properties are centrally managed in the *System » System settings » Properties » Configuration* menu. Change the settings that are described in <<table-create-property>> in this menu.
