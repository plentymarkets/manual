...
Properties are frequently occurring information that you can use to further characterise your storage locations. For example, you can use properties to specify which storage locations are appropriate for items requiring refrigeration.
To learn how to group properties and work with property groups, refer to the <<basics/working-with-plentymarkets/properties#, Properties>> manual page.
...
include::_textblocks/instructions/creating-properties.adoc[]

[#1000]
=== Editing storage location properties

include::_textblocks/instructions/editing-properties.adoc[]

[#1100]
=== Linking properties with storage locations

You can link up to three properties with a storage location.

[.instruction]
Linking properties with storage locations:

. Go to *Setup » Settings » Stock » Warehouse* » _select storage location_.
. Click on *Storage locations*. +
→ The overview opens.
. Select a storage location that you want to link with the properties.
...
include::_textblocks/instructions/searching-for-properties.adoc[]
...
include::_textblocks/instructions/deleting-properties.adoc[]

[#1400]
==== Deleting multiple properties

include::_textblocks/instructions/deleting-multiple-properties.adoc[]
