...
This is a selection of countries of delivery as defined in <<fulfilment/preparing-the-shipment#100, System » Orders » Shipping » Settings » Countries of delivery>>.
...
|Here, you select the order referrers for which the warehouse should be preferred. If an order comes in via one of the selected referrers, this warehouse is selected during the process of automatic warehouse assignment. *_Important:_* Those settings have priority over the settings made for the option *Automatic warehouse selection* in the *<<orders/basic-settings#, System » Orders » Settings>>* menu.
