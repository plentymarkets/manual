...
* Every storage location should be given a **label** with a barcode.
...
|Deletes all of the stock and stock movements from a warehouse. Use this function carefully. How to procede best when you want to take stock is described on the **<<stock-management/taking-stock#, Carrying out stocktaking>>** page of this manuel.
...
. Select the option **New rack** from the drop-down list.
. Click on **Open**. +
...
. **Save** the settings. +
→ The rack will now be listed in the drop-down list. The racks are sorted by ID.
...
. Go to **System » Stock » Warehouse » Select warehouse » Submenu: Racks**.
. Select a rack from the drop-down list. +
