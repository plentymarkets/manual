...
* Every storage location should be given a **label** with a barcode. This will ensure that you are able to make use of the **<<basics/plentymarkets-client#, plentymarkets Client  >>** tool.
...
→ starting with the lowest zone, position or level
...
→ The warehouse will now be listed under **Settings » Stock » Warehouse**. The warehouses are displayed in alphabetical order.
...
. Go to **Settings » Stock » Warehouse » Select warehouse » Settings**.
...
|Select **Yes** if you are working with **<<order-processing/orders/editing-sales-orders/delivery-order#, delivery orders  >>**.

|**Location**
|The location of the warehouse.  +
Here, you can select the countries that were set up as countries of delivery under link::/[**Settings » Orders » Shipping » Shipping options » Tab: Countries of delivery**].
...
The symbols displayed directly depend on the symbols in **Settings » Item » Item availability** menu. Only symbols that you saved an **Online store icon** for will be available here.
...
. Go to **Settings » Stock » Warehouse » Select warehouse » Submenu: Racks**.
...
Box storage racks can be used interims storage for multi order picking. Box storage racks can only be used when working with **link::/[processes]**.
...
. Go to **Settings » Stock » Warehouse » Select warehouse » Submenu: box storage racks**.
...
. Go to **Settings » Stock » Warehouse » Select warehouse » Submenu: Label**
