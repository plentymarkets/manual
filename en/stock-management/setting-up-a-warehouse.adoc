...
Here, you can select the countries that were set up as countries of delivery under <</#, **Settings » Orders » Shipping » Shipping options » Tab: Countries of delivery** >>.
...
Box storage racks can be used interims storage for multi order picking. Box storage racks can only be used when working with **<</#, processes >>**.
