...
For further information, refer to the **<<orders/settings/documents#, Documents  >>** page of the manual.
====
...
Click on the preview **eye** to download the PDF document for the <<orders/settings/documents/reorder#, **reorder**  >> any time. When making changes to the reorder's template or PDF template, click on the reload icon to update the PDF document.  +
