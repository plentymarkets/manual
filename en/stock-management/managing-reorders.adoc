...
. Go to **System » System settings » Stock » Reorder management » Settings**.
...
. Go to **System » System settings » Stock » Reorder management » Order status**.
...
. Go to **System » System settings » Orders » Documents » Reorder**.
...
--
. Go to **System » System settings » Stock » Reorder management » Events**.
...
. Select a **Warehouse**.
. Select a **Currency**. +
→ The exchange rate from the **System » System settings » Orders » Payment » Currencies** menu will be applied automatically.
. **Save** the settings. +
...
For further information, refer to the **<<orders/order-documents#, Documents>>** page of the manual.
====
...
The status names can be changed in the **System » System settings » Stock » Reorder management » Order status** menu.
...
. Go to **System » System settings » Stock » Reorder management » Delete orders**.
