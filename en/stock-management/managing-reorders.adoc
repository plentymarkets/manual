...
. Go to **Settings » Stock » Reorder management » Basic settings**.
...
. Go to **Settings » Stock » Reorder management » Order status**.
. Click on the **New language** tab.
. Select German or English from the drop-down menu.
. **Save** the settings. +
...
. Go to **Settings » Orders » Documents » Reorder**.
...
--
. Go to **Settings » Stock » Reorder management » Event procedures**.
...
. Select a **Warehouse**.
. Select a **Currency**. +
→ The exchange rate from the **Settings » Orders » Payment » Currencies** menu will be applied automatically.
. **Save** the settings. +
...
Click on the preview **eye** to download the PDF document for the <<order-processing/orders/settings/documents/reorder#, **reorder**>> any time. When making changes to the reorder's template or PDF template, click on the reload icon to update the PDF document.  +
...
The status names can be changed in the **Settings » Stock » Reorder management » Order status** menu.
...
. Go to **Settings » Stock » Reorder management » Delete orders**.
