= Best Practices: Correcting/Transferring/Deleting stock
:lang: en
...
For further information about setting up warehouses and storage locations, please refer to the manual page <<stock-management/setting-up-a-warehouse#, warehouse>> and the subordinate pages.
...
How the general procedure of importing and exporting data works is explained in the manual under <<data/export-import/exporting-data#, exporting data>> and <<data/export-import/importing-data#, importing data>>.
The other available data formats are listed <<data/export-import/data-formats#, here>>.
