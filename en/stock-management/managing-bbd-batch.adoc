...
Users of the type *Back end* can only access limited areas and menus in the plentymarkets back end. Thus, their access to the system is limited. If users of the type *Back end* should be able to see BBD and batches, a user of the type *Admin* has to assign the right listed in the following to those users.
...
. In the *Authorisations* area, activate the option *Stock > Warehouse location management > Show*.
