...
* Is this your first time working with catalogues? Then <<en/data/exporting-data/managing-catalogues, read up on the catalogue basics first>>. For further information about the plentymarkets data fields that can be linked, refer to the <<data/exporting-data/managing-catalogues#_mapping_data_sources, Mapping data fields>> chapter.
...
. This MOIN is imported to your plentymarkets system and saved to the variation data. Go to *Item » Edit item » [Open item] » [Open variation] » Tab: Settings » Area: ASIN/ePID* to find it.
