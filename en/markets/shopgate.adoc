...
Depending on the payment method, Shopgate will generate and send the invoice so that you do not have to send an invoice to the customer. You can check this in your Shopgate orders or create an <<event-procedures#100, event procedure>> to automate this.
