...
. Go to *System » System settings » Markets » Shopgate*.
...
*Client (store) item* = Only exports those items that were made <<Setting the item availability, available>> for an online store.
...
With the help of <<online-store/online-store#forwarding, mobile forwarding>> you can select whether customers should be forwarded to Shopgate when opening the store in a mobile browser. If you do not activate this setting, customers will not be forwarded.

[.instruction]
Setting up forwarding:

. Go to *System » System settings » Client » Select client » Online store » Forwarding*.
. Carry out the settings. Pay attention to the explanations given in <<forwarding-options-mobile-devices>>.
. *Save* (icon:save[role="green"]) the settings.

[[forwarding-options-mobile-devices]]
...
In order to link items, properties etc. with Shopgate, you have to activate the order referrer Shopgate in the menu *System » System settings » Orders » Order referrer*.
...
Items have to be available for Shopgate. This is done in the *Availability* tab of an item within the *Item » Edit item » Tab: Variation ID* menu. In addition, you can select whether all items or only selected items should be transferred. This can be done in the menu *System » System settings » Markets » Shopgate*.
...
. Carry out the optional settings as desired. Pay attention to the explanations given in <<settings-shopgate>>.
. *Save* (icon:save[role="green"]) the settings. +
...
* Select *Client (store) item* as the *Export type* in the menu *System » System settings » Markets » Shopgate*.
...
Add SKUs for specific referrers in the *Item » Edit item » Open item » Tab: Variation ID* menu.
...
. Carry out the settings. Pay attention to the information given in <<payment-method-shopgate>>.
...
Depending on the payment method, Shopgate will generate and send the invoice so that you do not have to send an invoice to the customer. You can check this in your Shopgate orders or create an <<automation/event-procedures#, event procedure>> to automate this.
...
. Carry out further settings. Pay attention to the explanations given in <<event-procedure-cancellations-shopgate>>.
. Place a check mark next to the option *Active*.
. *Save* (icon:save[role="green"]) the settings. +
...
. *Save* (icon:save[role="green"]) the settings. +
→ The event is created.
. Carry out further settings. Pay attention to the explanations given in <<event-procedure-returns-shopgate>>.
. Place a check mark next to the option *Active*.
. *Save* (icon:save[role="green"]) the settings. +
→ The event procedure is saved.
--
