...
You need to activate all variations that you want to sell on Shopgate. This is done in the *Availability* tab of a variation within the *Item » Edit item »* _Open item_ *» Tab: Variation ID* menu. In addition, you can select whether all items or only selected items should be transferred. This is done in the *Setup » Markets » Shopgate* menu.
