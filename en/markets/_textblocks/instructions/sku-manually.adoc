If necessary, save market specific SKU for those variations that you want to sell on the market.
...
*_Tip:_* Find the marketplace account ID in the following menu:
...
*_Tip:_* Find the plenty ID in the following menu:
