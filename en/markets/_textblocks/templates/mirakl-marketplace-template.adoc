...
include::../instructions/variation-availability.adoc[]
...
| For each shipping profile in plentymarkets, enter the corresponding abbreviation of the shipping service provider. To find the abbreviations, go to *Information » Carriers* in Mirakl.
...
include::../instructions/catalogue-assistant-config.adoc[]
...
include::../instructions/catalogue-map-data-fields.adoc[]
...
include::../instructions/catalogue-activation.adoc[]
...
[[#{marketplace}-event-procedure-order-confirmation]]
