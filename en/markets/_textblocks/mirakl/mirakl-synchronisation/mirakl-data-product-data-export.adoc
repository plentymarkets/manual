...
// * If *SKU* is selected, the SKU from the marketplace has to be defined as the marketplace SKU at the variation.
// * If *EAN* is selected, the EAN of the variation has to be defined as the marketplace SKU at the variation.
// * If *ISBN* is selected, the ISBN of the variation has to be defined as the marketplace SKU at the variation.
...
* The value that is transferred as Product ID in the product data transfer has to correspond to the value of the *product-id* in the offer data transfer.
* The value that is transferred as Product ID in the product data transfer is defined in the catalogue.
...
This results in the following mappings for the product data transfer:

* In the catalogue, only the Variation ID is mapped to the data fields *Product-ID (of the seller)* or *Seller Product ID*. During the first product data transfer of this variation, the Variation ID is automatically saved as Marketplace SKU on the respective variation. However, this only applies if no other value was defined beforehand.
...
. Create a property of the type *Short text*.
...
In this chapter, you will learn how to transfer order data to the marketplace and which requirements have to be met. The data comes from the *{assistant-name}* assistant which you already completed.


=== Requirements for transferring order data
