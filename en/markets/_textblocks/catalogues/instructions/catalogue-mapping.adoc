...
// *_Tip:_* Need more informationen on the plentymarkets data fields? Check out the manual page for the default catalogue format <<data/exporting-data/catalogue-item#, Item (new)>>.
