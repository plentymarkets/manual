////
[.collapseBox]
.Overview for first-time users: catalogue menu
--
...
You can choose from the following mappings which are described in the info boxes below:
  ...
  * *1:n mapping = Map 1 marketplace data field to several plentymarkets data fields*
  * *Own value mapping*
...
[.collapseBox]
.*1:1 mapping:*Map 1 marketplace data field to 1 plentymarkets data field
--
...
[.collapseBox]
.*1:1 mapping with fallback data fields:* Map 1 marketplace data field to 1 plentymarkets data field
--
...
[.collapseBox]
.*1:n mapping:* Map several plentymarkets data fields to 1 marketplace data field
--
...
[.collapseBox]
.*Own value mapping:* Map the same value for all variations to 1 marketplace data field
--
