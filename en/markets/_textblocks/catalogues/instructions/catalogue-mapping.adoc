...
[.collapseBox]
.*1 mapping* 1 marketplace data field, 1 plentymarkets data field
--
...
[.collapseBox]
.*1 mapping with a fallback data field* 1 marketplace data field, 1 plentymarkets data field with alternatives
--
