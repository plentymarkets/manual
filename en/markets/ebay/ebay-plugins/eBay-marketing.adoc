...
Users with *Backend* access require the following rights for menu visibilities and REST-API:

==== Required rights for menu visibilities
...
. In the areas *Authorisations* and *Menu visibilities*, activate the required rights.
. *Save* the settings.
