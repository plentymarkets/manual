...
Users with *Backend* access require the rights listed in <<#plugin-ebay-marketing-rights>>.
...
. In the areas *Authorisations* and *Menu visibilities*, activate the rights listed in <<#plugin-ebay-marketing-rights>>.
. *Save* the settings.
