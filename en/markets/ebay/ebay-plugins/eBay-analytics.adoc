...
Users with *Backend* access need the rights listed in <<#plugin-ebay-analytics-rights>>.
...
. In the areas *Authorisations* and *Menu visibilities*, activate the rights listed in <<#plugin-ebay-analytics-rights>>.
. *Save* the settings.
