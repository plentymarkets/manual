...
| Submit a <<Setting up Second Chance Offers (SCO), Second Chance Offer>> to a defeated bidder. Defeated bidders than automatically receive an offer of the same item for their highest bids.
