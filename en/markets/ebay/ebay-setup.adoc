...
The *Listings » Listing processes* menu contains an overview of all listing processes that will be carried out in the future. Listing processes include all automatic processes which are carried out for listings, such as starting, updating, relisting, and ending listings. This menu displays all listings that you have started, updated, relisted or ended individually or via group function. The menu also contains information about when the process was started and when it is estimated to be finished.
