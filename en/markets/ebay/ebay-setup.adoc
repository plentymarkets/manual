...
|*PayPal account*
| Select a PayPal account. Only those PayPal accounts that were set up in the <<payment/paypal#, System » Orders » Payment » Methods » PayPal>> menu are displayed here.
