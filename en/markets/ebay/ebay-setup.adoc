...
. *Save* the settings.
.  Carry out the settings as described in <<automatic-feedback>> below.
...
. *Save* the settings.
.  Carry out the settings as described in <<automatic-ebay-messages>> below.
.  Place a check mark next to the option *Active*.
. *Save* the settings.
--
...
. *Save* the settings.
.  Carry out the settings as described in <<accepting-returns>> below.
.  Place a check mark next to the option *Active*.
. *Save* the settings.
--
...
. *Save* the settings.
.  Carry out the settings as described in <<return-own-label>> below.
.  Place a check mark next to the option *Active*.
. *Save* the settings.
--
...
. *Save* the settings.
.  Carry out the settings as described in <<rejecting-returns>> below.
.  Place a check mark next to the option *Active*.
. *Save* the settings.
--
...
. *Save* the settings.
.  Carry out the settings as described in <<partial-refund>> below.
.  Place a check mark next to the option *Active*.
. *Save* the settings.
--
...
. *Save* the settings.
.  Carry out the settings as described in <<event-procedure-own-label>> below.
.  Place a check mark next to the option *Active*.
. *Save* the settings.
--
...
. *Save* the settings.
.  Carry out the settings as described in <<event-procedure-marking-returns>> below.
.  Place a check mark next to the option *Active*.
. *Save* the settings.
--
...
. *Save* the settings.
.  Carry out the settings as described in <<event-procedure-sent-returns>> below.
.  Place a check mark next to the option *Active*.
. *Save* the settings.
--
...
. *Save* the settings.
.  Carry out the settings as described in <<marking-paid-orders>> below.
.  Place a check mark next to the option *Active*.
. *Save* the settings.
--
...
. *Save* the settings.
.  Carry out the settings as described in <<automatically-rejecting-purchase-cancellations>> below.
.  Place a check mark next to the option *Active*.
. *Save* the settings.
--
...
. *Save* the settings.
.  Carry out the settings as described in <<message-accepted-purchase-cancellation>> below.
.  Place a check mark next to the option *Active*.
. *Save* the settings.
--
...
. *Save* the settings.
.  Carry out the settings as described in <<message-rejected-purchase-cancellation>> below.
.  Place a check mark next to the option *Active*.
. *Save* the settings.
--
...
. *Save* the settings.
.  Carry out the settings as described in <<starting-purchase-cancellations-ebay>> below.
.  Place a check mark next to the option *Active*.
. *Save* the settings.
--
