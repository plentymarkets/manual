...
The *Listings » Listing processes* menu contains an overview of all listing processes that will be carried out in the future. You can open market listings directly from this overview to edit or check them. Moreover, you can use the group function to delete planned listing processes and thus prevent processes from being started. +
...
. Select *Delete*.
. Click on *Execute* to delete the selected processes and thus cancel them from being started.
