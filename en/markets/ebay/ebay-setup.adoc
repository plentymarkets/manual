...
* *No* (recommended)= No gallery image is transferred to eBay. +
...
*_Or:_* Set up an <<automation/event-procedures#, event procedure>> to automatically post feedback on eBay.
...
| *Additional options*
a| Select additional options, e.g. *Free shipping* or *Express shipping*. +
...
a| Activate to exclude certain purchasers. +
...
| *Store visibility*
a| Select one of the following options for the visibility of listings in the online store: +
