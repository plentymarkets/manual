...
====
Consider your setting for the option *Status of cancelled orders* in the *Setup » Orders » Settings* menu when setting up purchase cancellations. The *Status of cancelled orders* must match the statuses selected below. Otherwise, it might happen that the stock stays reserved. +
