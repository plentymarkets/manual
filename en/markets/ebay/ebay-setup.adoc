...
:keywords: eBay, market, marketplace, listing, listings, market listing, active listings, eBay listing, layout template, Multi-Channel, Multichannel, Multi-Channel eBay, eBay Plus, ePID, eBay token, eBay shop categories, Second Chance Offer, SCO, eBay platform, automatic stock update, relist
...
The *Listings » Listing processes* menu contains an overview of all listing processes that will be carried out in the future.
...
You can open market listings directly from this overview to edit or check them. Moreover, you can use the group function to delete planned listing processes and thus prevent processes from being started.
...
|*Date specification*
|Select a date to only display processes from this day or period. +
...
Use the group function to cancel multiple listing processes at once. First, select the processes that you would like to delete by placing a check mark next to them.

[.instruction]
Deleting listing processes with the group function:

. Go to *Listings » Listing processes*.
. Place a check mark next to the processes that should be deleted.
