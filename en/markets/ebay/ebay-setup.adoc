...
+
--
If you selected the option *Yes* for the setting *Use variation number as SKU*, you can add SKUs manually. To do so, go to *Item » Edit item » [Open item] » Tab: Variations » [Open variation] » Tab: Settings* menu if needed.
