...
+
--
If you selected the option *Yes* for the setting *Use variation number as SKU*, you can add SKUs manually. To do so, go to *Item » Edit item » [Open item] » Tab: Variations » [Open variation] » Tab: Settings* if needed.
...
type = *unit* or *value* +
*_Examples:_* +
*GetItemPropertyByName('abstract_motives', 'value')* = The unit type of the property with the back end name "abstract_motives" +
...
. *_Optional:_* If you want to create a *subdirectory*, use the *Directory* option to select which *main directory* it should be in.
. *Save* (icon:save[role="green"]) the settings.
...
You can open the item and the market listing directly from the overview to edit or check the settings. Moreover, you can use the group function to delete planned listing processes and thus prevent processes from being started.
...
. *Exclude* any *countries of delivery* that you do not want to ship to.
. *Save* (icon:save[role="green"]) the settings.
