...
Variation availabilities are organised in the *Setup » Item » Availability* menu and set in the *availability* area of the *Item » Edit item » Open item » Tab: Variation ID » Tab: Settings* menu of each item.
|====
...
. In the *Referrer* area, place a check mark next to the desired eBay country platform.
. In the *eBay accounts* area, place a check mark next to the desired eBay account.
. *Save* (icon:save[role="green"]) the settings.
...
====
Go to *Setup » Markets » eBay » Data exchange » Tab: Other*. Click on *Start* in the *Synchronise special sales* area to start the synchronisation.
====
