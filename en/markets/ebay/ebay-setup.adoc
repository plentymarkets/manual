...
This chapter teaches you how to set up *terms of payment*, *shipping conditions*, *return policies*, *WEEE take back policies* and *product compliance* information for your eBay listings. Moreover, you learn how to create *shipping profiles*. +
These settings must be carried out for every eBay account and every platform individually.

[IMPORTANT]
.Opt in to *Business policies* program on eBay
====
...
* If you opted in to the program on eBay, the toggle button is green and the text “You are opted in for eBay business policies.” is shown.
* If you have not yet opted in on eBay, the toggle button is red and the text “You are not opted in for eBay business policies. Opt in to eBay business policies.” is shown. Click on the link to opt in to the *Business policies* program on eBay.
====
...
You can set up the WEEE take back policy either on eBay or in the *Setup » Markets » eBay » Business policies » Tab: eBay WEEE take back* menu in plentymarkets. The return policy saved on eBay is overwritten when entering the return policy in plentymarkets. You can set up a maximum of three WEEE take back policies.
...
. Go to *Setup » Markets » eBay » Business policies » Tab: eBay WEEE take back » Tab: New*.
. Carry out the settings according to <<#ebay-weee-take-back>>.
. Save (icon:save[set=plenty]) the settings.

[[ebay-weee-take-back]]
.Settings for *eBay WEEE take back*
[cols="1,3a"]
|====
| Setting | Explanation
...
| *Description*
| Enter a description that should be displayed in the WEEE take back field on eBay. This field must be filled if free take back of old electrical devices is possible.
...
[#product-compliance]
==== Defining product compliance policies

In the product compliance policy you provide buyers with important product information. This information varies depending on the product type. For example, if you sell batteries, you can enter specific information about the batteries in the product compliance policy, if necessary.

You can set up the product compliance policies on eBay or in plentymarkets in the *Setup » Markets » eBay » Business policies » Tab: eBay Product compliance* menu. The product compliance policy saved on eBay is overwritten when entering the product compliance policy in plentymarkets. You can set up a maximum of ten policies for product compliance.

Product compliance policies can only be set up for these eBay platforms:
...
. Go to *Setup » Markets » eBay » Business policies » Tab: eBay Product compliance » Tab: New*.
...
| *Description*
| Enter a description that should be displayed in the Product compliance field on eBay. Enter details about the product compliance.
...
| *eBay WEEE take back*
| Select the terms for the shipping profile in the *eBay WEEE take back* tab.

| *eBay Product Compliance*
| Select the terms for the shipping profile in the *eBay Product compliance* tab.
