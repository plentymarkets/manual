...
|*Parts compatibility listing*
| Add a parts compatibilit listing. You must have selected a platform. Create a parts compatibility listing in the <<Setting up parts compatibility listings, System » Markets » eBay » Parts compatibility listing>> menu.
