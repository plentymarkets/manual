...
* <<#500, _Alternative 1:_ Item export with the Elastic Export _(deprecated)_>>
* <<#catalogue-export, _Alternative 2:_ Item export with catalogue formats _(recommended)_>>
