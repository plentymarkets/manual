...
In order to link items, properties etc. with Check24, you have to activate the order referrer Check24 in the *System » System settings » Orders » Order referrer* menu.
...
[.instruction]
Activating the Check24 payment method:
