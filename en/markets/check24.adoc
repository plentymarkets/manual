...
////
[#200]
== Information about data exchange intervals
...
* <<#500, _Alternative 1:_ Item export with the Elastic Export (deprecated)>>
* <<#catalogue-export, _Alternative 2:_ Item export with catalogue formats (test phase)>>

[#500]
=== _Alternative 1:_ Elastic Export (deprecated)
