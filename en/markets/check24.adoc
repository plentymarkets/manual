...
You need to activate any variations that you want to sell on Check24. This is done in the *Availability* tab of a variation within the *Item » Edit item » Open item » Tab: Variation ID* menu.
