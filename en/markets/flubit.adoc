...
Activate the <<en/order-processing/payment/managing-payment-methods#, payment method>> *Flubit* as described below.
...
Set up an <<en/basics/automation/event-procedures#, event procedure>> to automatically send shipping confirmations to Flubit when the outgoing items are booked.
...
Set up an <<en/basics/automation/event-procedures#, event procedure>> to automatically inform Flubit about returns.
