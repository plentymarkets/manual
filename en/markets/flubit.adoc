...
:keywords: Flubit, market, marketplace, marketplace Flubit, setting up Flubit, Flubit setup, multichannel, multi-channel, multi channel, Flabit
...
In order to link items, properties etc. with Flubit, you have to activate the order referrer Flubit in the *Setup » Orders » Order referrer* menu.

[.instruction]
Activating the order referrer for Flubit:

. Go to *Setup » Orders » Order referrer*.
. Place a check mark next to *Flubit*.
. *Save* (icon:save[role="green"]) the settings.
...
[TIP]
.Selling all variations of an item on Flubit
====
If you want to sell all variations of an item on Flubit, carry out the settings below for the item's main variation. All other variations of the item then inherit the settings of the main variation.
====

[.instruction]
Activating the variation availability for Flubit:

. Go to *Item » Edit item » Open item » Tab: Variation ID » Tab: Settings*.
. Open the variation that you want to sell on Flubit.
...
. *Save* (icon:save[role="green"]) the settings. +
→ The event is created.
. Carry out the settings as described in <<event-procedure-cancellation-flubit>>.
. Place a check mark next to the option *Active*.
. *Save* (icon:save[role="green"]) the settings. +
→ The event procedure is saved.
--
...
. *Save* (icon:save[role="green"]) the settings. +
→ The event is created.
. Carry out the settings as described in <<event-procedure-returns-flubit>>.
. Place a check mark next to the option *Active*.
. *Save* (icon:save[role="green"]) the settings. +
→ The event procedure is saved.
--
