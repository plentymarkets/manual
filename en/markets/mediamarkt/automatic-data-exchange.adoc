= Automatic product and order data exchange
:lang: en
...
| *Brand*
a| Create a property of type *Short text* for this marketplace data field. Create a property value for each type of unit that you use for your products. Be sure to enter the code, not the label. +
...
Ask your Mediamarkt contact person for more information about the valid attribute values.
...
== Transferring product and order data
