...
. *Save* the settings.
.  Carry out the settings as described in <<automatic-shipping-confirmation>> below.
.  Place a check mark next to the option *Active*.
. *Save* the settings.
--
...
. *Save* the settings.
.  Carry out the settings as described in <<automatic-payment-confirmation>> below.
.  Place a check mark next to the option *Active*.
. *Save* the settings.
--
