...
. Go to *Setup » Markets » Hood*.
. Click on *Update* (icon:undo[]) in the *Store categories* section. +
...
The following table explains the template variables and functions in the *Layout templates* section in alphabetical order:
