...
You need to activate all variations that you want to sell on Rakuten. This is done in the *Availability* tab of a variation within the *Item » Edit item » [Open item] » Tab: Variation ID* menu.
