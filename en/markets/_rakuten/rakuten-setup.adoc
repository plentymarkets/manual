...
You need to activate all variations that you want to sell on Rakuten. This is done in the *Availability* tab of a variation within the *Item » Edit item » [Open item] » [Open variation]* menu.
...
Add SKUs manually for specific referrers in the *Item » Edit item » [Open item] » [Open variation] » Tab: Settings » Tab: Availability* menu if needed.
