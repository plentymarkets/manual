...
. Map the marketplace data field *Material 1* to the plentymarkets data field *Material 1*.
...
. Map the marketplace data field *Lining 1* to the plentymarkets data field *Lining 1*.
