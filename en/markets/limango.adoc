...
. *Product:* A specific colour version of the product
. *Variation:* Equivalent to the size / EAN / SKU

If the product is only available in a single version, then the product group equals the variant.
