...
*Weight* +
etc.)
a| Only specify measurements for products with no size variations, i.e. for single size products such as furniture. Why? The measurements can only be shown in the limango shop on the product level, not on the variation/size level.
...
The shipping costs are defined in your contract with limango and then saved by limango. As such, you need to contact your limango partner manager if you want to change the shipping costs. As such, there are no settings for the shipping costs in plentymarkets.
