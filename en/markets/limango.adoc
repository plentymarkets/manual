...
Set up an <<automation/event-procedures#, event procedure>> to automatically send a shipping confirmation to notify limango when outgoing items have been booked for an order.
