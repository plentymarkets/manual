...
<<#14001, How to upload a PDF template for delivery notes>>
<<#14001, How to enter return instructions for limango delivery notes>>
...
--
include::markets/_textblocks/explanations/limango-delivery-note-text.adoc[]
--
