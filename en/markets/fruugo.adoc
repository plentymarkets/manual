...
. Go to *System » System settings » Markets » Fruugo*.
. Carry out the settings. Pay attention to the explanations given in table <<basic-settings-fruugo>>.
. *Save* the settings.
...
Fruugo requires a list of shipping costs from each seller. This list cannot be transferred via the API. Therefore, upload a file which includes shipping information directly on Fruugo. Further information and a file template are available link:https://sell.fruugo.com/en/discover/shipping[here^].
...
. Carry out further settings. Pay attention to the explanations given in <<event-procedure-order-confirmation-fruugo>> below.
. Place a check mark next to the option *Active*.
. *Save* the settings. +
...
. *Save* the settings. +
→ The event is created.
. Carry out further settings. Pay attention to the explanations given in <<event-procedure-cancellation-fruugo>>.
. Place a check mark next to the option *Active*.
. *Save* the settings. +
→ The event procedure is saved.
--
...
. *Save* the settings. +
→ The event is created.
. Carry out further settings. Pay attention to the explanations given in <<event-procedure-returns-fruugo>>.
. Place a check mark next to the option *Active*.
. *Save* the settings. +
→ The event procedure is saved.
--
