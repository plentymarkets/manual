...
In order to link items, properties etc. with Fruugo, you have to activate the order referrer Fruugo in the menu *System » Orders » Order referrer*.
...
Activate the <<en/order-processing/payment/managing-payment-methods#, payment method>> *Fruugo* as described below.
...
For further information, refer to the <<en/order-processing/payment#, Payment methods>> page of the manual.

[#700]
== Automatically sending order confirmations

Set up an <<en/basics/automation/event-procedures#, event procedure>> to automatically send an order confirmation to Fruugo.
...
Set up an <<en/basics/automation/event-procedures#, event procedure>> to automatically send a shipping confirmation to Fruugo when the outgoing items have been booked.
...
Set up an <<en/basics/automation/event-procedures#, event procedure>> to automatically inform Fruugo of cancellations.
...
Set up an <<en/basics/automation/event-procedures#, event procedure>> to automatically inform Fruugo about returns.
