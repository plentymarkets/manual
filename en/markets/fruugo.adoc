...
:keywords: Fruugo, market, marketplace, marketplace Fruugo, setting up Fruugo, Fruugo setup, multichannel, multi-channel, multi channel, Froogo, Frugo
...
. Open the variation that you want to sell on Fruugo.
...
. *Save* (icon:save[role="green"]) the settings. +
→ The event is created.
. Carry out the settings as described in <<event-procedure-cancellations-fruugo>>.
. Place a check mark next to the option *Active*.
. *Save* (icon:save[role="green"]) the settings. +
→ The event procedure is saved.
--
