...
After you have created a catalogue, link the market's data fields with item data saved in plentymarkets. For further information about the plentymarkets data sources that can be linked, refer to <<data/exporting-data/managing-catalogues#_mapping_data_sources, Mapping data sources>>.
...
→ The plentymarkets data sources are displayed on the right-hand side.
