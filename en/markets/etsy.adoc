...
[IMPORTANT]
.Renewal options at Etsy
====
Prior to setting up Etsy in plentymarkets, you have to set the option *Renewal options* to *Manual* in the *Shop-Manager » Listings »* _Open listing_ menu at Etsy. Otherwise, the Etsy plugin will not work correctly.
====
...
. In the *Processes* section, activate the *Item export*, *Stock update*, and *Order import*.
. *Save* (icon:save[role="green"]) the settings.

[.subhead]
Setting up export languages

In the *Export languages* section, you carry out settings for export languages. The *Shop language* is exported by default. Other languages are used for translations of your offers.
...
In order to link items, properties etc. with Etsy, you have to activate the order referrer Etsy in the *Setup » Orders » Order referrer* menu.
...
Items have to be available for Etsy. This is done in the *Availability* tab of an item within the *Item » Edit item » Open item » Tab: Variation ID* menu.
...
If you already sell on Etsy, save Etsy listing IDs as SKUs for the referrer *Etsy* in the *Item » Edit item » Open item » Tab: Variation ID » Tab: Settings »Tab: Availability* menu. By doing so, items will be assigned to the items already listed on Etsy during the item export. This is to prevent overselling. +
...
[NOTE]
.Visibility of the *Data » Catalogs* menu
====
...
. Enter a name.
. Select the *event* listed in <<etsy-payment-confirmation>>.
. *Save* (icon:save[role="green"]) the settings. +
→ The event is created.
. Carry out the settings as described in <<etsy-payment-confirmation>>.
...
→ The *Create new event procedure* window opens.
. Enter a name.
. Select the *event* listed in <<etsy-shipping-confirmation>>.
. *Save* (icon:save[role="green"]) the settings. +
→ The event is created.
. Carry out the settings as described in <<etsy-shipping-confirmation>>.
. Place a check mark next to the option *Active*.
. *Save* (icon:save[role="green"]) the settings. +
→ The event procedure is saved.
--
