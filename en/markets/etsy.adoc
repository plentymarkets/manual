...
[#550]
== _Optional:_ Saving existing Etsy listing IDs

If you already sell on Etsy, save Etsy listing IDs as SKUs for the referrer *Etsy*. By doing so, items will be assigned to the items already listed on Etsy during the item export. This is to prevent overselling. +
