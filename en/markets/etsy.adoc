...
*_Troubleshooting:_* Are you redirected to the start page of your plentyShop? Then your plentyShop is probably locked. Go to *Setup » Client » Standard » Online store » Lock store* to unlock the store. Once the authentication is completed, go back and relock the store.
