...
====
Prior to setting up Etsy in plentymarkets, you have to set the setting *Renewal options* to *Manual* in the *Shop-Manager » Listings » [Open listing]* menu at Etsy. Otherwise, the Etsy plugin will not work correctly.
====
