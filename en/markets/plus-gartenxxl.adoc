...
Check Netto's product checklist prior to listing items on Netto/GartenXXL.de/GartenXXL.at. The requirements apply to Netto catalogue fields, not the settings in plentymarkets. +
