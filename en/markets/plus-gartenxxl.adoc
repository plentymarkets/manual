...
* <<#catalogue-export, _Alternative 2:_ Item export with catalogue formats (test phase)>>

[#old-export]
=== _Alternative 1:_ Old item data export

This chapter describes how to export your item data to {market} using the old export. If you are in the process of setting up the item data export, we recommend that your use the <<#catalogue-export, catalogues>> for the export.
...
[#catalogue-export]
=== _Alternative 2:_ Catalogue export (test phase)
