...
Download the PDF template for link:https://cdn02.plentymarkets.com/pmsbpnokwu6a/frontend/ElasticSync_BestPractice/netto_pdf_Lieferscheinrohling.pdf[Netto Marken-Discount^]{nbsp}icon:external-link[]. +
*_Important:_* Note that the correct company name for drop shipments is "Netto Digital - NeS GmbH".
