...
link:https://cdn02.plentymarkets.com/pmsbpnokwu6a/frontend/ElasticSync_BestPractice/Checkliste_Produktpflege_Netto.pdf[Product checklist]
...
You need to activate all variations that you want to sell on Netto Marken-Discount. This is done in the *Availability* tab of a variation within the *Item » Edit item » Open item » Tab: Variation ID* menu.
...
. Place a check mark next to the order referrers *Plus.de* and *Netto*. +
. *Save* (icon:save[role="green"]) the settings.

[#365]
== Setting the Show unit price-option

It is mandatory to specify whether items that you would like to sell on Netto have a unit price. Go to *Item » Edit item » Open item » Tab: Variation ID » Tab: Settings* and activate the *Show unit price* option to indicate that an item needs to have a unit price.

[.instruction]
Activating the Show unit price-option:

. Go to *Item » Edit item » Open item » Tab: Variation ID » Tab: Settings*.
. Place a check mark next to the *Show unit price* option in the *Dimensions* section. +
...
. Enter a name.
. Select the *event* listed in <<event-procedure-shipping-confirmation-netto>>.
. *Save* (icon:save[role="green"]) the settings. +
→ The event is created.
. Carry out further settings. Pay attention to the explanations given in <<event-procedure-shipping-confirmation-netto>>.
. Place a check mark next to the option *Active*.
. *Save* (icon:save[role="green"]) the settings. +
...
→ The *Create new event procedure* window opens.
. Enter a name.
. Select the *event* listed in <<event-procedure-cancellation-netto>>.
. *Save* (icon:save[role="green"]) the settings. +
→ The event is created.
. Carry out further settings. Pay attention to the explanations given in <<event-procedure-cancellation-netto>>.
. Place a check mark next to the option *Active*.
. *Save* (icon:save[role="green"]) the settings. +
→ The event procedure is saved.
--
...
→ The *Create new event procedure* window opens.
. Enter a name.
. Select the *event* listed in <<event-procedure-returns-netto>>.
. *Save* (icon:save[role="green"]) the settings. +
→ The event is created.
. Carry out further settings. Pay attention to the explanations given in <<event-procedure-returns-netto>>.
. Place a check mark next to the option *Active*.
. *Save* (icon:save[role="green"]) the settings. +
→ The event procedure is saved.
--
...
Download the PDF template for link:https://cdn02.plentymarkets.com/pmsbpnokwu6a/frontend/pdf-template_netto_simple.pdf[Netto Marken-Discount^] here.
