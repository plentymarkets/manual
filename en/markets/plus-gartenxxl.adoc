...
[.subhead]
Requirements for items at Netto/GartenXXL.de/GartenXXL.at

Check Netto's product checklist prior to listing items on Netto/GartenXXL.de/GartenXXL.at. This list is provided by Netto eStores and refers to Netto's product data terminology. +
...
→ The market is added.
. *Save* (icon:save[role="green"]) the settings. +
→ The item is available on Netto.
...
. Enter the category ID that best matches your online store categories in the *Netto category link*/*GartenXXL.de category link*/*GartenXXL.at category link* columns. +
...
. Select the property *Item category link for Netto Marken-Discount* / *Item category link for GartenXXL.de* / *Item category link for GartenXXL.at* from the *Netto eStores property* drop-down list.
. *Save* (icon:save[role="green"]) the settings.
...
Download the PDF templates for link:https://cdn02.plentymarkets.com/pmsbpnokwu6a/frontend/pdf-template_netto_simple.pdf[Netto Marken-Discount^], link:https://cdn02.plentymarkets.com/pmsbpnokwu6a/frontend/pdf-template_gartenXXL_de_simple.pdf[GartenXXL.de^], and link:https://cdn02.plentymarkets.com/pmsbpnokwu6a/frontend/pdf-template_gartenXXL_de_simple.pdf[GartenXXL.at^] here.
...
. Select the *Netto*/*GartenXXL.de*/*GartenXXL.at* option from the *Payment method* drop-down list.
