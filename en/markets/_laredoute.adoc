...
. Go to *System » System settings » Markets » La Redoute » Settings*.
...
In order to link items, properties etc. with La Redoute, you have to activate the order referrer La Redoute in the menu *System » System settings » Orders » Order referrer*.
...
. Go to *System » System settings » Markets » La Redoute » Item property import*.
...
. Go to *System » System settings » Markets » La Redoute » Category link*.
