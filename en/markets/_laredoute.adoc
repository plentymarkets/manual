...
Add SKUs manually for specific referrers in the menu <<item/managing-items#180, Item » Edit item » Open item » Tab: Variation ID » Tab: Availability>> if needed.
