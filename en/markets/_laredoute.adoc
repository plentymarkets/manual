...
. Enter a name.
. Select the *event* listed in <<shipping-confirmations-laredoute>>.
. *Save* the settings.
. Carry out the settings. Pay attention to the explanations given in <<shipping-confirmations-laredoute>>.
. Place a check mark next to the option *Active*.
. *Save* the settings.
--
...
→ The *Create new event procedure* window opens.
. Enter a name.
. Select the *event* listed in <<returns-laredoute>>.
. *Save* the settings.
. Carry out the settings. Pay attention to the explanations given in <<returns-laredoute>>.
. Place a check mark next to the option *Active*.
. *Save* the settings.
--
