...
You need to activate all variations that you want to sell on La Redoute. This is done in the *Availability* tab of a variation within the *Item » Edit item » [Open item] » [Open variation]* menu.
