= Setting up fulfilment for Amazon
:lang: en
...
MFN is short for Merchant Fulfillment Network. That means: You process your Amazon orders and pack and ship the goods. Our <<markets/amazon/best-practices-amazon-mfn-order-import#, Best practice: MFN order import>> tells you more.
