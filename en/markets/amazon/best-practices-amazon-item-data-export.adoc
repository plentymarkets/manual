= Best practice: Item data export
:lang: en
...
In order to test if you carried out all necessary settings and if the item is exported properly, open the *System » System settings » Markets » Amazon » Data exchange » Data export* menu and click on *Load file*. Afterwards, check if the item is contained in the CSV file that was created.
