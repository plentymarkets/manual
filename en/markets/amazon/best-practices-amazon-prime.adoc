...
You can enter the dimensions within the shipping package or import them from the corresponding item settings (in plentymarkets for each variation in the *Settings* tab, in plentymarkets 6 in the *Base* tab in the *Length/Width/Height* fields).
