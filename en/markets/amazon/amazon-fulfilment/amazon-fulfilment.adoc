...
MFN is short for Merchant Fulfillment Network. That means: You process your Amazon orders and pack and ship the orders. Our <<markets/amazon/best-practices-amazon-mfn-order-import#, Best practice: MFN order import>> tells you more.
