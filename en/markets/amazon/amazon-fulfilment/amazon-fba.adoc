...
*_Note:_* The FBA reports contain orders from 00:00 AM on the start date to 00:00 AM on the end date (time zone of plentymarkets system). As such, the reporst do not contain any orders of the selected end date.
