...
*_Note:_* Amazon only generates the reports once per day.
...
*_Note:_* The FBA reports contain orders from midnight on the start date to midnight on the end date. As such, they do not contain any orders of the selected end date.
