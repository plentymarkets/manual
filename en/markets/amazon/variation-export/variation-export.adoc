...
*_Tip:_* Properties created in the assistant are automatically added to the property group *Amazon catalog* of the *Setup » Settings » Properties » Groups* menu. Check this group to see which new properties you need to link to your variations.
