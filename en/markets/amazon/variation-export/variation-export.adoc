...
TIP: If you have created a catalogue for Amazon already, sources are shown as suggestions in every catalogue after that. For each field, the source that you mapped to this field most often is suggested.
