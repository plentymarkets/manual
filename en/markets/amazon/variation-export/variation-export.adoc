...
*_Note:_* If Amazon releases a new version of the flatfile, a new catalogue needs to be created. The good news is: You can <<data/exporting-data/marketplace-export#190, copy and edit>> the catalogue with the old flatfile version with a few convenient clicks.
...
* Before you create your first Amazon catalogue, familiarise yourself with <<data/exporting-data/marketplace-export#, how catalogues are used in plentymarkets>>.
