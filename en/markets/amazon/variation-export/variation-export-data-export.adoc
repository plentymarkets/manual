...
* Have you set up Amazon in plentymarkets? (<<markets/amazon/amazon-setup#, How it’s done>>)
* Have you prepared your variations? (<<markets/amazon/preparing-variations#, How it’s done>>)
...
*_Note:_* Even if only a maximum of 5,000 variations can be exported at once, an export file might include more than 5,000 data records. This is because the parents of variations are also included in the export file.
