...
When you activate Amazon VCS in your plentymarkets system, plentymarkets automatically generates Amazon invoices and transfers them to Amazon. Activate Amazon VCS in plentymarkets in the *Initial settings* section of the *System » Markets » Amazon » Select an Amazon account » Tab: Settings* menu.
...
Create the event procedures that are necessary for the fulfilment process. Such event procedures have invoices generated and sent to your customers with the help of automatic emails, and have the order then switch to another status. +
 For further information, refer to the <<en/basics/automation/event-procedures#, Event procedures>> and <<fulfilment#, Fulfilment>> pages of the manual.
====
