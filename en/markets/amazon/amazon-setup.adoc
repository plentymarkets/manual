...
====
Durchlaufe zunächst den *Amazon ASIN-Import*-Assistenten im Menü *System » Assistenten*, um passende ASINs zu deinen Varianten in dein plentymarkets System zu importieren. Mit dem Assistenten legst du zudem fest, wie und ob importierte ASINs mit Varianten verknüpft werden sollen.
====
...
In dieser Spalte können ASINs verknüpft werden. Um eine ASIN mit einer Variante zu verknüpfen, Häkchen neben der ASIN setzen, die verknüpft werden soll und auf *Speichern* klicken. +
Wenn für diese Amazon-Plattform mehrere passende ASINs zu der Variante gefunden wurden, werden die gefundenen ASINs in einer Dropdown-Liste angezeigt. Es können eine, mehrere, oder alle ASINs mit der Variante verknüpft werden. Um eine oder mehrere ASINs zu verknüpfen, ein Häkchen bei den gewünschten ASINs setzen und auf *Speichern* klicken.

|*Vorschau*
|Öffnet eine Vorschau der Amazon-Artikelseite.
...
ASINs werden im Menü *System » Systemeinstellungen » Märkte » Amazon » ASIN-Verknüpfung* mit Varianten verknüpft.

[.instruction]
ASIN mit Variante verknüpfen:

. Öffne das Menü *System » Systemeinstellungen » Märkte » Amazon » ASIN-Verknüpfung*.
. Setze in der Zeile der Variante im Feld *ASIN* ein Häkchen bei einer oder mehreren ASINs, die mit der Variante verknüpft werden sollen. +
