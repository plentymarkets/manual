...
*Example:* If you have 20,000 Amazon variations and want to export all of them, then enter 1-5000 in the *from* and *to* fields. The first 5,000 Amazon variations will then be exported. Next, enter 5,000-10,000, then 10,000-15,000 etc. +
