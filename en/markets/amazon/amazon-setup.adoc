...
* <<#500, In the assistant Base settings - Amazon>>
* <<-660, In the setup menu>>
...
| *Tag IDs*
|Enter one or more tag IDs. Separate multiple IDs using commas. Only items that are linked to at least one of the selected tags are exported.
