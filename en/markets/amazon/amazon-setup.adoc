...
Information on how to prepare your variations for exporting them to Amazon have moved. You can now find this information on the <<markets/amazon/preparing-variations#, Preparing variations>> page of the manual.
