...
*Important:* Select this option if you do _not_ use Amazon VCS _or_ if use Amazon VCS and would like to upload your own invoice documents to Amazon without having Amazon calculate the sales tax. Create an event procedure to upload your invoices automatically to Amazon.
