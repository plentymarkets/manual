...
*Important:* Select this option if you use Amazon VCS and if you would like to upload your own invoice documents to Amazon without having Amazon calculate the sales tax. Create an event procedure to upload your invoices automatically to Amazon.
