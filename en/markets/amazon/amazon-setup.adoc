...
*Note:* Even if you only have 20,000 Amazon variations, an export file might include more than 20,000 data sets. This is because the parents of variations are also included in the export file.
