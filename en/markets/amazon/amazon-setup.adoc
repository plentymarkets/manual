...
You can upload the invoice documents that were created in plentymarkets to Amazon (Amazon Invoice Document Uploader - IDU) if you do not use Amazon VCS.  To upload your invoices to Amazon without sales tax calculation, create an event procedure in the *System » System settings » Orders » Events* menu.
