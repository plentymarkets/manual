...
====
Also read the <<markets/amazon/best-practices-amazon-vcs, best practice for Amazon VCS>> which contains further information about the setup of Amazon's invoice service VCS in plentymarkets.
====
...
The menu <<data/api-log#, Data » API log>> menu contains a history of processes that run via the Amazon interface. The following formats are available for Amazon:
