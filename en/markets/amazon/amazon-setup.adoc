...
====
Use the *Amazon Basic settings* assistant in the *Setup » Assistants » Omni-Channel* menu to set up your Amazon account in plentymarkets quickly and easily. Moreover, you carry out settings for the data transfer and for Amazon MFN and Amazon FBA with this assistant.
====
...
Amazon invoice numbers and credit notes are imported into plentymarkets.
|====
...
You need to activate all variations that you want to sell on Amazon country platforms. This is done in the *Availability* tab of a variation within the *Item » Edit item » Open item » Tab: Variation ID* menu.

[TIP]
.Selling all variations of an item on Amazon country platforms
====
If you want to sell all variations of an item on Amazon country platforms, carry out the settings below for the item's main variation. All other variations of the item then inherit the settings of the main variation.
====

[.instruction]
Activating the variation availability for Amazon country plattforms:
...
. In the same list, select the Amazon country platform(s) on which the variation should be available.
. Click on *Add* (icon:plus-square[role="green"]). +
→ The market is added.
. *Save* (icon:save[role="green"]) the settings.
...
.Setting the variation availability for Amazon
[cols="1,3"]
|====
| Setting | Explanation
...
Use the group function in the *Setup » Markets » Amazon » ASIN matching* menu in order to manually link multiple ASINs at once.
...
Link variation properties that you have created in the *Setup » Settings » Properties » Configuration* and added to a variation with Amazon in the *Setup » Settings » Properties » Configuration » _Open property_ » Tab: Amazon* menu.
...
*Note:* Even if only a maximum of 5,000 variations can be exported at once, an export file might include more than 20,000 data sets. This is because the parents of variations are also included in the export file.
...
[IMPORTANT]
.First Activate Amazon VCS in the Seller Central
====
Amazon VCS has to be activated and enabled in Amazon Seller Central first before you can activate the service in your plentymarkets system. +
When you activate Amazon VCS in the Seller Central, a date is displayed which indicates when Amazon will enable the service for you. Only activate VCS in plentymarkets on the date indicated by Amazon.
====
...
|*VCS Amazon*
|*Condition:* Amazon VCS is used. +
Amazon invoices are generated by Amazon. Amazon invoice numbers and credit notes are imported into plentymarkets. +
*Important:* If you activate this option, then Amazon invoices *cannot* be created manually or with an event procedure any longer.
|====
...
. Open the item.
. Click on the *Multi-Channel* tab.
. Carry out the settings in the *Amazon* area. Pay attention to the explanations given in <<item-availability-amazon>> in the <<Setting the variation availability, Setting the variation availability>> chapter.
. *Save* (icon:save[role="green"]) the settings.
