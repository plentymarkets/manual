...
. In the *Availability* section, activate the option *Active*.
. Click on the *Availability* tab.
. In the *Markets* section, click in the selection field. +
...
. In the *Export settings* section, activate *Stock update* and *Price update* for the *Additional SKU* option, depending on which options you want to activate. *ALL* activates both the stock update and the price update.
. *Save* (icon:save[role="green"]) the settings.
...
. Place check marks in the rows of the variations that should be edited with the group function.
...
* Activate the item in the *Item » Edit item » Open item » Tab: Variation ID* menu. To do so, open the *Settings* tab and activate the *Active* option in the *Availability* section. Then click on the *Availability* tab and activate the options *Web API* and the desired *Amazon referrer* in the *Markets* drop-down list.
...
[.indented]
* Activate the item in the *Item » Edit item » Open item » Tab: Variation ID » Tab: Availability* menu. To do so, open the *Settings* tab and activate the *Active* option in the *Availability* section. Then click on the *Availability* tab and activate the options *Web API* and the desired *Amazon referrer* in the *Markets* drop-down list.
