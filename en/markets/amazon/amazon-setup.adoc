...
====
Note that you can only upload an invoice to Amazon after a shipping confirmation was sent to Amazon. As shipping confirmations are sent once per hour, it can take up to an hour before the shipment is confirmed at Amazon.
====
