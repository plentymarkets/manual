...
[.indented]
* Activate the *sales price*: Make sure that the item’s sales price is activated for the Amazon account and the Amazon referrer. This is done in the *Setup » Item » Sales prices* menu.
