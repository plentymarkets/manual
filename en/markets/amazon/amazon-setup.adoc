...
Wenn du Amazon VCS bei Amazon aktivierst, wird dir ein Datum angezeigt, an dem Amazon den Service für dich freischaltet. Aktiviere VCS erst an dem dort angegebenen Datum in deinem plentymarkets System.
====
