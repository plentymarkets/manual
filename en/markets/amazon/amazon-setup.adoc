...
*Example:* If you have 20,000 Amazon variations and want to export all of them, then enter 1-5,000 in the *from* and *to* fields. The first 5,000 Amazon variations will then be exported. Next, enter 5,000-10,000, then enter 10,000-15,000 etc. +
*Note:* Even if you only have 20,000 Amazon variations, the export file might include more than 20,000 data sets. This is because the parents of variations are also included in the export file.
