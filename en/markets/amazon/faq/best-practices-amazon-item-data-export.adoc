...
:keywords: Amazon, item, export, CSV file, Amazon item export, data export
:position: 200
...
====
In order to export item data to Amazon, you can use the *automatic export* which takes place at night. You can also use the *manual export*. To do so, go to *Setup » Markets » Amazon » Data exchange » Data export*.
