...
:position: 400
:url: markets/amazon/best-practices-amazon-manual-order-generation-fba
:id: UKCQIBV
...
1. Log into the link:https://sellercentral.amazon.de/[Amazon Seller Central for Europe^]{nbsp}icon:external-link[] and go to *Reports » Fulfilment by Amazon*.

2. Go to *Customer concessions » Returns*.

3. A FBA returns report can be generated here.
*_Important:_* Select the *TXT format* and not CSV format (new Amazon option). CSV reports cannot be imported.
