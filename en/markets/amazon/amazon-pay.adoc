...
:position:
:url: markets/amazon/setting-up-amazon-pay
:id: 5MHIPVQ
...
You need a plugin to set up Amazon Pay in your online store. Visit the link:https://en/marketplace.plentymarkets.com/plugins/payment/AmazonLoginAndPay_5072[plentyMarketplace^]{nbsp}icon:external-link[] to get information on this plugin.
