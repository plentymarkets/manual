...
In this chapter, you will learn how to define sales prices, RRPs, and special offers for Amazon. In addition, it describes how you need to export the information that Amazon expects as a basis for calculating the unit price.
