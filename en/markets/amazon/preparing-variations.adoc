...
→ Only use this name for the property. Otherwise, the special offer price will not be exported to Amazon.
...
====
TIP: Characteristics are an old features. We recommend that you do not create new characteristics. Use the <<#1390, properties>> instead.
====
