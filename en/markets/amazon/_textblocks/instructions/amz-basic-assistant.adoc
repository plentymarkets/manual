...
* If the authorization was successfully completed, a new tab with the message "The authorization of plentymarkets for the seller ID [Seller ID] has been successfully completed. You can now close this window and go back to the plentymarkets assistant." opens. +
→ You can close this tab and go back to the assistant in plentymarkets.

* If the authorization could not be completed and an error occurred, a new tab with the message "The authorization of plentymarkets for the seller ID [Seller ID] failed. The following error occurred: [error message]." opens. +
→ Repeat this step of the assistant if the authorization could not be completed.

*_Note:_* If the authorization was successfully completed, the seller ID of your Amazon seller account will be displayed in this step of the Amazon assistant. If the authorization failed, *N/A* will be displayed instead.
--
