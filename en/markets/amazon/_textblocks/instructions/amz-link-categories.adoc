...
The category links are only taken into consideration for the default categories, which were selected for an item under *Item » Edit item »* _Open item_ *» Tab: Categories*.
