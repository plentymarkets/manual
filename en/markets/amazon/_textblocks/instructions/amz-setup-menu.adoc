...
*_Important:_* If you have already started selling your items on Amazon and now you want to start selling them with plentymarkets, you have to assign already existing SKUs in the *Item » Edit item » [Open item] » Tab: Variation ID » Tab: Settings » Tab: Availability* menu.
...
| *Credit note import*
a| Select whether Amazon credit notes for MFN and FBA orders should be imported into your plentymarkets system. +
*_Note:_* This setting applies to both own shipping (MFN) and to shipping by Amazon (FBA).
