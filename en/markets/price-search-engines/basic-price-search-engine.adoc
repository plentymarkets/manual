...
Unlike with other marketplace formats, you cannot just activate the catalogue to start the export to a price search engine. Instead, you need to save the URL of the catalogue export for the price search engine.
