...
This project is licensed under the GNU AFFERO GENERAL PUBLIC LICENSE - find further information in the link:https://github.com/plentymarkets/plugin-elastic-export-basic-price-search-engine/blob/master/LICENSE.md[LICENSE.md^].
