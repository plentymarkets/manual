...
====
In order to be able to export item data to Shopping.com, the plugins link:https://marketplace.plentymarkets.com/en/plugins/channels/preisportale/elasticexportshoppingcom_4755[Shopping.com^] and link:https://marketplace.plentymarkets.com/en/plugins/sales/marktplaetze/elasticexport_4763[Elastic export^] are required. You can download the plugins in the link:https://marketplace.plentymarkets.com/en[plentyMarketplace^].
====

[#100]
== Registering with Shopping.com

Shopping.com is an international product and price comparison service. In order to set up the Shopping.com plugin in plentymarkets, you have to register with link:https://shopping.com/[Shopping.com^] first.
