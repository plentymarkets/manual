...
| *Product URL*
|Choose the URL that you wish to transfer to Geizhals.de. You can choose between the item’s URL and the variation’s URL. URLs of variations can only be transferred in combination with the plentyShop LTS store.
