...
[#old-export]
== _Alternative 1 (deprecated):_ Export format GeizhalsDE-Plugin
...
Exporting using catalogue formats provides you with a long-term and flexible way to export your item data to {market}.
