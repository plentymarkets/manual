...
. Carry out the desired settings. Pay attention to the explanations given in <<settings-billiger-de>>.
. *Save* (icon:save[role="green"]) the settings. +
→ The export format *BilligerDE-Plugin* is given an ID and it appears in the overview within the *Exports* tab.

<<settings-billiger-de>> lists details for settings, format settings and recommended item filters for the format *BilligerDE-Plugin*.
