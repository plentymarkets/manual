...
In order to link items, properties etc. with Mercateo, you have to activate the order referrer Mercateo in the *System » System settings » Orders » Order referrer* menu.
...
The images are displayed along with the corresponding item ID and time of export. It is not possible to export an image more than once. However, if you would like to update an image, e.g. after changes have been made to it, then click on *Delete* in the *Release item image* column. Then export this image again in the *Item images export* section of the *System » System settings » Markets » Mercateo » Data export* menu.
