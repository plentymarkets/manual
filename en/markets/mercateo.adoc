...
The images are displayed along with the corresponding item ID and time of export. It is not possible to export an image more than once. However, if you would like to update an image, e.g. after changes have been made to it, then click on *Delete* in the *Release item image* column. Then export this image again in the *Item images export* section of the *Setup » Markets » Mercateo » Data export* menu.
