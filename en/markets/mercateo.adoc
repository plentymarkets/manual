...
. Go to *System » System settings » Markets » Mercateo » Settings*.
...
In order to link items, properties etc. with Mercateo, you have to activate the order referrer Mercateo in the menu *System » System settings » Orders » Order referrer*.
...
In the *System » System settings » Markets » Mercateo » Data export* menu, you can export your items and item images to Mercateo.

[.instruction]
Exporting items:

.  Go to *System » System settings » Markets » Mercateo » Data export*.
...
An overview of exported images is displayed in the *System » System settings » Markets » Mercateo » Export history* menu. The images are displayed on different pages. 25 images can be displayed per page.

[.instruction]
Selecting a page:

.  Go to *System » System settings » Markets » Mercateo » Export history*.
