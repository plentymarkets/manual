...
In order to link items, properties etc. with Rakuten you have to activate the order referrer Rakuten in the menu *Setup » Orders » Order referrer*.
...
. Open the menu *Setup » Item » Sales price » Open sales price » Tab: Settings*.
