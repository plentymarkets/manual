...
The values for the delivery periods are also available in Rakuten’s link:https://infos.rakuten.de/academy/das-haendlerkonto-1/produkte/csv-import[interface documentation^]{nbsp}icon:external-link[]. Please note that this documentation is currently only available in German.
