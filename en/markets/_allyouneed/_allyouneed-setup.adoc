...
.  Go to *System » System settings » Markets » Allyouneed » Settings*.
...
|*Item availability*
| Select the availability. The items with the selected availability are transferred. Set up the options for item availability in the <<item/managing-items#190, System » System settings » Item » Availability>> menu.
...
Pay attention to the tax rates settings in the <<orders/accounting#, System » System settings » Client » Select client » Locations » Select locations » Accounting>> menu.
...
In order to link items, properties etc. with Allyouneed you have to activate the order referrer Allyouneed in the menu *System » System settings » Orders » Order referrer*.
...
.  Go to *System » System settings » Markets » Allyouneed » Category link*.
