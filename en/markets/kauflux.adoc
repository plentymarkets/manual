...
| *Add item filters*
a|Select the items you wish to export and transfer. There are no filters set by default. Select an item filter from the drop-down list and click *Add*. It is possible to add multiple item filters from the drop-down list one after the other. +
