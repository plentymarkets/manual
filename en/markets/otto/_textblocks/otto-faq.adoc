...
First, work through the <<#2200, _checklist:_ Requirements for exporting variations>>.
...
[#1309]
[.collapseBox]
.missing requirements: *mediaAssets.IMAGE* _or_ *mediaAssets*
--
...
[#13024]
[.collapseBox]
.missing requirements: *pricing.standardPrice.amount* _or_ *pricing.standardPrice.currency*
--
...
[#13025]
[.collapseBox]
.missing requirements: *sku-validation-error, validation error found* _or_ *Duplicate entry. Combination of the fields variationId, marketId and accountId must be unique.*
--
...
[#1307]
[.collapseBox]
.*Code: 200009 - ATTRIBUTE_CHANGE_DENIED* _or_ *title: Der Wert dieses Feldes kann nicht geändert werden. (title: The value of this field cannot be changed.)*
--
