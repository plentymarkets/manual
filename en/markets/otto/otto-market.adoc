...
'''
*Create property* = Creates a property and maps this property to the data field. This automatically created property will be saved in the <<item/settings/properties#500, Setup » Settings » Properties » Configuration>> menu.
...
| The variation must be linked to the property *OTTO category group*.
...
| The net stock of the variation must be positive.
...
| As a minimum, plentymarkets data fields must be mapped to all mandatory fields of the marketplace. The mandatory fields are different for different OTTO category groups. All mandatory fields in the catalogue are marked with an asterisk (*).
