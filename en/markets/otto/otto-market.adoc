...
To ensure that the tracking number is already transferred before the order is confirmed at OTTO market, you have to create two event procedures: 1. *Generate DHL Retoure Online label* and 2. *Auftragsbestätigung an OTTO melden* (Send order confirmation to OTTO).
...
|*Event*
|*Status change: Select a status before shipping*
|
