...
====
In order to generate a DHL return label, you need to have finished setting up *DHL Retoure Online* in the *Setup » Orders » Shipping » Shipping Service Provider » DHL Retoure Online* menu. Among other things, you need to have saved your DHL access data consisting of user name and password. Note that DHL Retoure Online will switch to a new process in the future. For further information, refer to the link:https://forum.plentymarkets.com/t/umstellung-dhl-retoure-online-auf-neues-verfahren/575687[plentymarkets forum^].
====
