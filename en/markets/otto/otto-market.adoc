...
| *_Note:_* The procedure *Send return to OTTO* triggers a credit note and the buyer receives a refund. The credit note document created by OTTO is automatically attached to the order of the type *Credit note*.
|====
