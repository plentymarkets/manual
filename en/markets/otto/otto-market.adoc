...
*_Note:_* Orders that are cancelled by OTTO Market are imported with the status *[8] Cancelled*. Select a different status to make sure that you do not notify OTTO Market of a cancellation they triggered.
