...
ifdef::mediamarkt[]
The parameters valid for market attributes are displayed in parentheses behind the attribute. Contact the market’s contact persons to ask for the codes which must be sent to the market.
endif::mediamarkt[]
