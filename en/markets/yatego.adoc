...
*_Note:_* This function is only still supported for customers who already use the free text field functions in the Yatego settings. New customers are requested to use the following two options.
...
You need to activate all variations that you want to sell on Yatego. This is done in the *Availability* tab of a variation within the *Item » Edit item »* _Open item_ *» Tab: Variation ID* menu.
