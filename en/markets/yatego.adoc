...
====
If the item export is set up for another client (online store), enter the access data from the main system (URL with ceritifcate and *web token* from the plentymarkets API data) (WebToken = not *plentyToken*). +
