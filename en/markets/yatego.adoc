...
:keywords: Yatego, market, marketplace, marketplace Yatego, setting up Yatego, Yatego setup, multichannel, multi-channel, multi channel, market place
...
You need to activate all variations that you want to sell on Yatego. This is done in the *Availability* tab of a variation within the *Item » Edit item » Open item » Tab: Variation ID* menu.

[TIP]
.Selling all variations of an item on Yatego
====
If you want to sell all variations of an item on Yatego, carry out the settings below for the item's main variation. All other variations of the item then inherit the settings of the main variation.
====

[.instruction]
Activating the variation availability for Yatego:

. Go to *Item » Edit item » Open item » Tab: Variation ID » Tab: Settings*.
. Open the variation that you want to sell on Yatego.
...
[.indented]
The stock limitation is set in the *Item » Edit item » Open item » Tab: Variation ID » Tab: Settings » Section *Visibility* menu. Variations for which the option *Limitation* is set to *None* or *Do not administer stock for this variation* are also transferred to Yatego. plentymarkets sends a value of -1 for these variations, so that Yatego knows that these variations can be bought without limitation.
