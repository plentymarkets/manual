...
====
To book an SSL certificate, go to *Setup » Client »* _Open client_ *» SSL*. In the row *Order new SSL for domain: [domain name]*, click on the down arrow to the right.
====
...
[.indented]
Yatego sends a link for the orders, which directly connects to the item on the Yatego platform. Usually, this link doesn't work, because Yatego adds "yatego.com" to the name of the online store. Delete "yatego.com" from the link and then it will work correctly. +
