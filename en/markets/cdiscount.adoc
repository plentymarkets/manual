...
The options that can be selected here are the settings for Configuration 1 and Configuration 2 that are configured in the <<fulfilment/preparing-the-shipment#1700, System » Orders » Shipping » Settings » Tab: Calculate shipping costs>> menu.
