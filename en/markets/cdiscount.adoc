...
====
If a Cdiscount order has more than one order item and the customer returns only one order item, Cdiscount will always refund the total sum of the order. This is due to a limitation on Cdiscount. +
*_Example:_*
