...
The options that can be selected here are the settings for Configuration 1 and Configuration 2 that are set up in the *Setup » Orders » Shipping » Settings » Tab: Calculate shipping costs* menu.
...
====
If *Request product creation* is activated in the *Setup » Markets » Cdiscount.com » Tab: Settings* menu, an SKU is generated which matches the variation ID for each variation during the export that takes place at night.
====
...
====
Link the properties *Gender*, *Main colour*, *Note*, *Comment*, *Marketing description*, *Audience*, and *Sport* in the <<item/managing-items#480, Setup » Item » Properties>> menu in order to transfer your item catalogue to Cdiscount via a CSV file.
====
