...
*Product export cron*, +
*Stock export cron*
| Activate the crons that are required for the automatic data exchange with the myToys interface. For further information, refer to <<mytoys-data-exchange-setup>>.
