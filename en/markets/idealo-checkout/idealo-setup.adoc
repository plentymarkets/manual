...
In order to link items, properties etc. with idealo, you have to activate the order referrer *idealo* in the menu *System » System settings » Orders » Order referrer* menu. +
