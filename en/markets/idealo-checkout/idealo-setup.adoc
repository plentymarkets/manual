...
| The URL is required so that customers can be redirected from the price search engine to your plentyShop. Variation URLs can only be transferred if you use the Ceres plentyShop.
Item URL
Variation URL
...
| *Product URL*
|Select the URL that you wish to transfer to the price search engine. You can either send the item’s URL and the variation’s URL. URLs of variations can only be transferred in combination with the Ceres plentyShop.
...
[IMPORTANT]
.Payment method *idealo Checkout* only
====
