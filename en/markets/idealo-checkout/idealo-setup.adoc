...
|For the API key, enter the token for Merchant Order API v2. Go to the idealo Business Portal and generate the API key. The API client access data is required to allow plentymarkets access to your idealo account so that the data exchange can be activated.
