...
- *Item availability:* In addition to the option *idealo*, also activate the <<Setting the variation availability, availability>> *idealo Checkout* in the *Item » Edit item » Open item » Tab: Variation ID » Tab: Availability* menu in the *Markets* section.
...
You need to activate all variations that you want to sell on idealo. This is done in the *Availability* tab of a variation within the *Item » Edit item » Open item » Tab: Variation ID* menu.
...
→ The market is added.
. *Save* (icon:save[role="green"]) the settings. +
*_Note:_* If you want to use idealo Checkout, also activate the option *idealo Checkout* in the *Markets* section.
...
|*article_no*
|The *Variation number* within *Item » Edit item » Open item » Open variation » Settings » Basic settings*.

|*producer*
|The *Name of the manufacturer* of the item. The *external name* within *Setup » Item » Manufacturer* will be preferred, if existing.

|*model*
|The *Model* within *Items » Edit items » Open item » Open variation » Settings » Basic settings*.
...
|*fedas*
|The *Amazon product type* within *Items » Edit item » Open item » Multi-Channel » Amazon*.
...
|*weight*
|The gross weight in gram within *Items » Edit item » Open item » Open variation » Settings » Measurements*.
...
|*checkoutApproved*
|Is *true* if the order referrer *idealo Direktkauf* within *Items » Edit item » Open item » Open variation » Availability » Markets* is set or a characteristic of type *No* and the link to the idealo Checkout characteristic *CheckoutApproved* is configured.
...
. Enter a name.
. Select the event listed in <<order-confirmation-idealo>>.
. *Save* (icon:save[role="green"]) the settings. +
→ The event is created.
. Carry out further settings. Pay attention to the explanations given in <<order-confirmation-idealo>>.
. Place a check mark next to the option *Active*.
. *Save* (icon:save[role="green"]) the settings. +
...
→ The *Create new event procedure* window opens.
. Enter a name.
. Select the event listed in <<shipping-confirmation-idealo>>.
. *Save* (icon:save[role="green"]) the settings. +
→ The event is created.
. Carry out further settings. Pay attention to the explanations given in <<shipping-confirmation-idealo>>.
. Place a check mark next to the option *Active*.
. *Save* (icon:save[role="green"]) the settings. +
→ The event procedure is saved.
--
...
→ The *Create new event procedure* window opens.
. Enter a name.
. Select the *event* listed in <<returns-idealo>>.
. *Save* (icon:save[role="green"]) the settings. +
→ The event is created.
. Carry out further settings. Pay attention to the explanations given in <<returns-idealo>>.
. Place a check mark next to the option *Active*.
. *Save* (icon:save[role="green"]) the settings. +
→ The event procedure is saved.
--
...
→ The *Create new event procedure* window opens.
. Enter a name.
. Select the event listed in <<cancellations-idealo>>.
. *Save* (icon:save[role="green"]) the settings. +
→ The event is created.
. Carry out further settings. Pay attention to the explanations given in <<cancellations-idealo>>.
. Place a check mark next to the option *Active*.
. *Save* (icon:save[role="green"]) the settings. +
→ The event procedure is saved.
--
...
The *Data » Log* menu contains a history of processes that run via the idealo interface. *ElasticExportIdealoDE* is available for idealo.

[.instruction]
Viewing the log:

. Go to *Data » Log*.
. Select *ElasticExportIdealoDE* from the *Identifier* drop-down list.
...
. In the *Procedures* section, activate the option *Update timestamp for market exports*.
