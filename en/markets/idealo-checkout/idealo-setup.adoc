...
- *Item availability:* In addition to the option *idealo*, also activate the <<Setting the variation availability, availability>> *idealo Checkout* in the *Item » Edit item » Open item » Tab: Variation ID » Tab: Availability* menu in the *Markets* area.
