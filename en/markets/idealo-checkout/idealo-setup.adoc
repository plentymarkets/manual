...
| The URL is required so that customers can be redirected from the price search engine to your plentyShop. Variation URLs can only be transferred if you use the Ceres shop.
Item URL
Variation URL
