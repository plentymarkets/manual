...
:keywords: Neckermann.at, marketplace, market, Neckermann setup, setting up Neckermann, Neckermann Austria, Neckermann, Neckermann Enterprise, Neckermann.at Enterprise, Neckermann Österreich Enterprise, Neckermann-Komponenten, Neckermann components
...
In order to link items, properties etc. with Neckermann.at, you have to activate the order referrer *Neckermann.at Enterprise* in the *Setup » Orders » Order referrer* menu.
...
. Open the CSV file.
. Click on *Import*. +
→ After having imported the brand IDs, you can find the Neckermann ID of a manufacturer in the *Setup » Item » Manufacturers* menu.
