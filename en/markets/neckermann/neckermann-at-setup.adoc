...
Brand IDs for Neckermann.at can be imported via the import tool or they can be entered manually. +

To import brand IDs for Neckerman via the import tool, create an import of the type <<data/importing-data/sync-types/elasticSync-manufacturer#, Manufacturer>>. After you have created the import, you have to set the import options for the import, set the matching, and create the mappings.
