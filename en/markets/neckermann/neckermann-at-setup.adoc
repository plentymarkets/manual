...
*Example*: For an item with a stock of 50 and a stock buffer of 10, the value 40 is transferred as stock. For further information, refer to the <<stock-management/managing-stocks#, Managing stock>> page.
