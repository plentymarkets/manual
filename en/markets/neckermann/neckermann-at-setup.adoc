...
Neckermann provides you with a file which contains the categories that have to be assigned to your plentymarkets categories. The categories are then linked and further items from the linked category are assigned automatically.
