...
|*Referrer*
|Select *PIXmania*. For further information about the order referrer, refer to the <<Defining a sales price, Defining a sales price>> chapter.
...
_Table 1: Basic settings for the market PIXmania_
...
For further information, refer to the <<basics/working-with-plentymarkets/statistics/managing-statistics#, Managing statistics>> page of the manual. For an example for flat rate and percentage costs, refer to the <<payment/managing-payment-methods#20, Setting up a payment method>> chapter on the <<payment/managing-payment-methods#, Managing payment methods>> page.
|====
