...
|*Availability 1 - 5*
|Enter the delivery time in days for each option into the *Domestic* and *Foreign* country fields. Only the days that are entered here are transferred to PIXmania as a delivery period. 0 is not allowed as a number of days. You have to enter a natural number. Set up the options for item availability in the *System » System settings » Item » Availability* menu.
|====
...
In order to link items, properties etc. with PIXmania, you have to activate the order referrer PIXmania in the *System » System settings » Orders » Order referrer* menu.
