...
How you hide your bank details on real.de invoices depends on how you show your bank details in the first place. <<#hide-bank-details>> describes the different methods.
