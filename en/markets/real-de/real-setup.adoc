...
.Status and filters for the event procedure
====
The statuses and filters in <<#ea-rechnungen-upload-real>> only serve as an example for creating an event procedure. Select filters and statuses for the event procedure which best suit your work flow.
====
