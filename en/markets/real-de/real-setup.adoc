...
|Match plentymarkets item availabilities with a minimum and maximum delivery time in days. +
Enter the minimum and maximum delivery time in days into the *Minimum delivery time (in working days)* and *Maximum delivery time (in working days)* fields that match the plentymarkets item availability. +
...
Items have to be available for real.de. This is done in the *Availability* tab of an item within the *Item » Edit item » Open item » Tab: Variation ID* menu.
