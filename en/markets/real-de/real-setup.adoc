...
For further information about linking properties with real.de, refer to the <<markets/real-de/best-practices-real-linking-properties#, Linking properties to attributes>> best practice.
