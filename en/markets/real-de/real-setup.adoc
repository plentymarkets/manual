...
In order to link items, characteristics etc. with real.de, you have to activate the order referrer real.de in the *Setup » Orders » Order referrer* menu.
...
. Go to *Setup » Item » Barcode »* _Open barcode_.
. Activate the referrer *real.de*.
. *Save* (icon:save[role="green"]) the settings.
...
| *Event*
|Select an event, e.g. *Order change: Status change*, *Documents: Invoice generated*
|
