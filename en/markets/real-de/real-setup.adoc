...
*Tip:* If you have not fully set up the interface to real.de but want to take a look at the item file preview, then you have to activate the interface temporarily. Otherwise, the item file preview will be empty. In order to view the item file preview when the interface is not active, activate the interface and click on *Item file preview* (icon:eye[role="blue"]). Deactivate the interface immediately afterwards by selecting *No* for the *Activate interface to real.de* and saving the settings. This way you can prevent items from being transferred too soon.
...
In order to link items, properties etc. with real.de, you have to activate the order referrer real.de in the *Setup » Orders » Order referrer* menu.
...
====
If you want to sell all variations of an item on real.de, carry out the settings below for the item's main variation. All other variations of the item then inherit the settings of the main variation.
====

[.instruction]
Activating the variation availability for real.de:
...
In order for your items to be available on the market real.de, the following requirements must also be fulfilled:
...
For further information about linking properties with real.de, refer to the <<markets/real-de/best-practices-real-linking-properties#, Linking properties to attributes>> best practice page.
...
. Click on the *DE > real.de Payment* folder. +
→ The settings for the real.de payment method are displayed.
. Carry out the settings. Pay attention to the explanations given in <<settings-payment-method-real>>.
. Place a check mark next to the option *Active*.
. *Save* (icon:save[role="green"]) the settings.

[[settings-payment-method-real]]
...
. In the *Optional elements below stock unit table* section, enter the note given above for the *Payment instruction* option for the payment method *real.de Payment*.
. *Save* (icon:save[role="green"]) the settings. +
...
====
If you have entered your bank data in the *Setup » Client » Standard » Locations » Germany (standard) » Documents » Invoice » Tab: Template* menu for the *Payment instruction* option, then you do not need to carry out any further settings. If you use this method, your bank data is not displayed on real.de invoices.
====
...
. Enter a name.
. Select the *event* listed in <<event-procedure-invoices-real>>.
. *Save* (icon:save[role="green"]) the settings. +
→ The event is created.
. Carry out the further settings. Pay attention to the explanations given in <<event-procedure-invoices-real>>.
. Place a check mark next to the option *Active*.
. *Save* (icon:save[role="green"]) the settings. +
...
. *Save* (icon:save[role="green"]) the settings. +
→ The event is created.
. Carry out further settings. Pay attention to the explanations given in <<event-procedure-cancellations-real>>.
. Select a reason. +
. Place a check mark next to the option *Active*.
. *Save* (icon:save[role="green"]) the settings. +
→ The event procedure is saved.
