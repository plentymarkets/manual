...
Enter the minimum and maximum delivery time in working days into the *Minimum delivery time (in working days)* and *Maximum delivery time (in working days)* fields that match the plentymarkets item availability. real specifies Monday to Friday as working days. +
