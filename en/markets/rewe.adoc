...
By default, the stock information for each variation is exported based on the option you selected for the *Limitation* setting. However, you can also ignore this setting and instead export the actual net stock for all variations to REWE.
...
[#1700]
== Deactivating the creation of contacts
