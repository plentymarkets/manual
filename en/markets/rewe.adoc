...
'''
*SKU* = From the drop-down list, select the data field that contains the SKU. +
...
* *_Alternative 1:_* Attribute that changes the look of the variations
* *_Alternative 2:_* Property that changes the look of the variations
