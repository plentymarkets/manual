...
.Linking values
====
In the data fields in the lower area of the catalogue template, you have to link values specified by REWE to plentymarkets data sources. For those fields, the names given by REWE are exported to the marketplace.
====
