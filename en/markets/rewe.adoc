...
'''
*Select data field* = A data field that already exists in plentymarkets will be exported to REWE. Select the data field from the drop-down list *Data field*. +
...
'''
*Create property* = Creates a <<item/settings/properties#500, property>> and maps this property to the data field. Properties make it possible to export values for data fields that have no corresponding item data saved in plentymarkets, such as *Durchmesser* (diameter).
...
→ The catalogue opens.
. Select a plentymarkets data field for the REWE catalogue field *Produktbeschreibung* (product description) from the drop-down list, for example *Item text > Name 1, Name 2, Name 3* that should be displayed on REWE as the product description.
