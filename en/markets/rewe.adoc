...
By default, the stock information for each variation is exported based on the option you selected for the *Limitation* setting. In plugin version 1.18.0 and higher, you can also ignore this setting and instead export the actual net stock for all variations to REWE.
