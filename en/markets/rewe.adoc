...
====
The settings for the commission for REWE are optional. If you do not set a commission, orders will be imported into plentymarkets with the sales prices of the end customer.
====
