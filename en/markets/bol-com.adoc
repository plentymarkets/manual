...
Next create <<item/managing-items#480, properties>> and link these to the bol.com properties. Matching properties to a bol.com category can be found within the bol.com data model file. Download the bol.com data model file link:https://developers.bol.com/datamodel/[here^]{nbsp}icon:external-link[].
