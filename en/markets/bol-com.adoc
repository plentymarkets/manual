...
Next, create <<item/settings/properties#100, characteristics>> and link these characteristics to the bol.com characteristics. Matching characteristics to a bol.com category can be found within the bol.com data model file. Download the bol.com data model file link:https://developers.bol.com/datamodel/[here^]{nbsp}icon:external-link[] .
