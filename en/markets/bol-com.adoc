...
====
If you want to sell all variations of an item on bol.com, carry out the settings below for the item's main variation. All other variations of the item then inherit the settings of the main variation.
====

[.instruction]
Activating the variation availability for bol.com:
...
The file for the format *BolItemExport* must be saved in the */SQUARE/feed* folder. +
The file for the format *BolOfferExport* must be saved in the */inbound* folder.
...
. Carry out the settings as described in <<event-procedure-shipping-confirmation-bol>>.
. Place a check mark next to the option *Active*.
. *Save* (icon:save[role="green"]) the settings. +
...
. *Save* (icon:save[role="green"]) the settings. +
→ The event is created.
. Carry out the settings as described in <<event-procedure-return-status-bol>>.
. Place a check mark next to the option *Active*.
. *Save* (icon:save[role="green"]) the settings. +
→ The event procedure is saved.
--
...
. *Save* (icon:save[role="green"]) the settings. +
→ The event is created.
. Carry out the settings as described in <<event-procedure-cancellations-bol>>.
. Place a check mark next to the option *Active*.
. *Save* (icon:save[role="green"]) the settings. +
→ The event procedure is saved.
--
...
The *Data » API log* menu contains a history of processes that run via the bol.com interface.
