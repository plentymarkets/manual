...
*Note:* At the moment, you have to use the API key for version 2.0.
...
In order to link items, properties etc. with bol.com, you have to activate the order referrer bol.com in the *Setup » Orders » Order referrer* menu.
...
Set up an <<automation/event-procedures#, event procedure>> to automatically inform bol.com of cancellations. Whenever you are dealing with cancellations, you need to send bol.com a reason for the cancellation. Go to *Setup » Orders » Order status* and create additional order statuses as needed. The following cancellation reasons can be transferred to bol.com:
