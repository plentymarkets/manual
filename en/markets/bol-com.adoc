...
All error messages that are caused by an error in our process or an invalid API request can also be searched using the references types *variationId* and *sku* and the corresponding reference values.
