...
In order to link items, properties etc. with Zalando, you have to activate the order referrer Zalando in the menu *Setup » Orders » Order referrer*.
...
In the menu *Setup » Markets » Zalando » Settings » Tab: Silhouettes*, you convert Zalando silhouettes to item properties. Silhouettes are transferred during the initial setup of Zalando.
...
|*Property ID*
|Enter the ID of the online store property. You find the property ID in the *Setup » Item » Properties* menu.
