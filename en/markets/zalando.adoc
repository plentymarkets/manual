...
a| This option is currently not in use.
...
// *_Tip:_* Warnings are shown in the *Data » Log* menu.
...
* Activated_ (icon:toggle-on[role="green"]) = Data is exchanged with Zalando.
