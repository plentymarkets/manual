...
When an order status changes, this information is not transferred to Zalando with event procedures, but transferred automatically via an interface. The following statuses are sent to Zalando: shipping confirmation, cancellation, and return.
