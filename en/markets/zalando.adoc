...
. Go to *System » System settings » Markets » Zalando » Settings*. +
...
In order to link items, properties etc. with Zalando, you have to activate the order referrer Zalando in the menu *System » System settings » Orders » Order referrer*.
...
. Go to *System » System settings » Markets » Zalando » Category link*.
...
In the menu *System » System settings » Markets » Zalando » Settings » Tab: Silhouettes*, you convert Zalando silhouettes to item properties. Silhouettes are transferred during the initial setup of Zalando.
...
|*Property ID*
|Enter the ID of the online store property. You find the property ID in the *System » System settings » Item » Properties* menu.
...
*selection* = Enter the option’s selection ID from the drop-down list. You find the selection ID for the properties of the type *Selection*. in the *System » System settings » Item » Properties* menu under *Selection ID*.
...
For further information, refer to the <<basics/working-with-plentymarkets/statistics/managing-statistics#, Manging statistics>> page of the manual. For an example of flat rate and percentage costs, refer to the <<payment/managing-payment-methods#20, Managing payment methods>> page of the manual.
|====
...
In the *System » System settings » Markets » Zalando » Settings » Tab: processing reports* menu, you can retrieve processing reports as well as the export log for Zalando.
