...
:keywords: Zalando, market, marketplace, marketplace Zalando, setting up Zalando, Zalando setup, multichannel, multi-channel, multi channel
...
. Carry out the desired settings. Pay attention to the explanations given in <<#basic-settings-zalando>>.
...
In order to link items, properties etc. with Zalando, you have to activate the order referrer Zalando in the *Setup » Orders » Order referrer* menu.

[.instruction]
Activating the order referrer for Zalando:

. Go to *Setup » Orders » Order referrer*.
. Activate the referrer *Zalando*.
. *Save* (icon:save[role="green"]) the settings.
...
[TIP]
.Selling all variations of an item on Zalando
====
If you want to sell all variations of an item on Zalando, carry out the settings below for the item's main variation. All other variations of the item then inherit the settings of the main variation.
====

[.instruction]
Activating the variation availability for Zalando:

. Go to *Item » Edit item » Open item » Tab: Variation ID » Tab: Settings*.
. Open the variation that you want to sell on Zalando.
...
In the *Setup » Markets » Zalando » Settings » Tab: Silhouettes* menu, you convert Zalando silhouettes to item properties. Silhouettes are transferred when Zalando is first set up.
...
. Open the file.
. Carry out the settings. Pay attention to the explanations given in <<#zalando-properties>>.
. *Save* (icon:save[role="green"]) the settings.
...
| *Characteristics ID*
|Enter the ID of the online store property. The property ID can be found in the *Setup » Item » Characteristics* menu.
...
*selection* = Enter the option’s selection ID from the drop-down list. You find the selection ID for the properties of the type *Selection* in the *Setup » Item » Properties* menu under *Selection ID*.
...
You can link the exported Zalando properties to the items in your plentymarkets system. To do so, use the <<data/export-import/importing-data#, data format>> with the *dynamic import*.
...
Activate the <<payment/managing-payment-methods#, payment method>> *Zalando Payment* as described below.
...
→ The *Settings* tab opens.
. Carry out the settings. Pay attention to the explanations given in <<#settings-payment-method-zalando>>.
. Place a check mark next to the option *Active*.
. *Save* (icon:save[role="green"]) the settings.

[[settings-payment-method-zalando]]
...
When an order status changes, this information is not transferred to Zalando with event procedures, but retrieved automatically via an interface. The following statuses are transferred to Zalando: shipping confirmation, cancellation, and return.
