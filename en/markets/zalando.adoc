...
. *_Optional:_* Carry out additional settings. Pay attention to the explanations given in table 5 in chapter <<item/managing-items#80, Activating characteristics>> of the Manually creating items page.
. *Save* (icon:save[role="green"]) the settings.
