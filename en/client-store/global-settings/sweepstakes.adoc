...
image::client-store/global-settings/assets/EN-Einstellungen-Mandant-Global-Gewinnspiel-01.png[]
...
If you leave this field empty, the **Send** button will be displayed by default. This button is saved in the <<cms/web-design/editing-the-web-design/buttons#, **CMS » Web design » Buttons**  >> menu. You can also adapt the button there if needed.
|====
...
image::client-store/global-settings/assets/EN-Einstellungen-Mandant-Global-Gewinnspiel-02.png[]
...
image::client-store/global-settings/assets/EN-Einstellungen-Mandant-Global-Gewinnspiel-03.png[]
...
image::client-store/global-settings/assets/EN-Einstellungen-Mandant-Global-Gewinnspiel-04.png[]
