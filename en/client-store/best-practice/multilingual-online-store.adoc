...
image::client-store/best-practice/assets/EN-Settings-Client-Best-Practice-Multilingual-Store-01-SI.png[]
...
image::client-store/best-practice/assets/EN-Settings-Client-Best-Practice-Multilingual-Store-02-SI.png[]
...
image::client-store/best-practice/assets/EN-Settings-Client-Best-Practice-Multilingual-Store-03-SI.png[]
...
image::client-store/best-practice/assets/EN-Settings-Client-Best-Practice-Multilingual-Store-04-SI.png[]
...
image::client-store/best-practice/assets/EN-Settings-Client-Best-Practice-Multilingual-Store-05-SI.png[]
...
image::client-store/best-practice/assets/EN-Settings-Client-Best-Practice-Multilingual-Store-06-SI.png[]
...
image::client-store/best-practice/assets/EN-Settings-Client-Best-Practice-Multilingual-Store-07-SI.png[]
...
Create event procedures to automatically send your e-mail templates when specific events occur. For further information about __**automatically sending e-mails**__, refer to the **<<crm/sending-emails#700., Automatic e-mail >>** and the **<<orders/settings/event-procedures#, Event procedures  >>** pages of the manual.
...
image::client-store/best-practice/assets/EN-Settings-Client-Best-Practice-Multilingual-Store-08-SI.png[]
...
Alternatively, you can copy the settings that were saved for a different language and/or document template and then edit them afterwards. This is useful if you already have a document template that was completely set up in one language. It ensures that the template will be set up the same way for the next language. For further information about these documents and their settings, refer to the **<<orders/settings/documents#, Documents  >>** page of the manual.
...
image::client-store/best-practice/assets/EN-Settings-Client-Best-Practice-Multilingual-Store-09-SI.png[]

__Image 9: **language link** in the online store__

Click on the link to switch the language. For further information about __**switching the language in the online store**__, refer to the **<<working-with-plentymarkets/basic-settings/language#, Language settings  >>** page of the manual.
