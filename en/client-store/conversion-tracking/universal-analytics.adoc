...
Additionally, section 3 teaches you how to collect data about your sales. Please note that you need to set up the **<<cms/web-design/editing-the-web-design/order-process/individual-order-process#, individual order process  >>** in order to use conversion tracking with Universal Analytics.
...
====
If you use an <<start/plentymarkets-account/service-center/ssl-certificate#, **SSL certificate**  >> for your website, then select **https** in Google Analytics.
====
