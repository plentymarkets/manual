...
The **Transfer** tab allows you to apply default settings to your template. For example, you may want to give your template the default settings if it does not yet contain any settings or you can use the default settings to reset your template. For further information, refer to the **Documents** page of the manual. Specifically, refer to the <<orders/settings/documents#140., **Applying settings** >> chapter.

===  Setting up a template

You need to set up a template first before you can create invoices. For further information, refer to the **Documents** page of the manual. Specifically, refer to the <<orders/settings/documents#40., **Configuring a document template** >> chapter.
...
The **Transfer** tab allows you to copy the settings in the invoice's **Template** tab and then apply these settings to a different document, e.g. to a delivery note. For further information, refer to the **Documents** page of the manual. Specifically, refer to the <<orders/settings/documents#140., **Applying settings** >> chapter.
...
image::client-store/standard/documents/assets/EN-Settings-Orders-Documents-Invoice-01.png[]
...
Set up an **<<orders/settings/event-procedures#, event procedure  >>** to automatically generate invoices.

image::client-store/standard/documents/assets/EN-Settings-Orders-Documents-Invoice-02.png[]
