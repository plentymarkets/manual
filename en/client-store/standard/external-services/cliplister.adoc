...
This page contains information about the Cliplister video settings that are available for your individual clients (stores). Before carrying out the configuration, you have to activate Cliplister in the menu **<<client-store/global-settings/external-services/cliplister#, Settings » Client (store) » Global settings » Services » Cliplister  >>**.
...
image::client-store/standard/external-services/assets/EN-Settings-Client-Standard-Services-Cliplister-01-SI.png[]
...
image::client-store/standard/external-services/assets/EN-Settings-Client-Standard-Services-Cliplister-02-SI.png[]
...
image::client-store/standard/external-services/assets/EN-Settings-Client-Standard-Services-Cliplister-03-SI.png[]
...
. In addition, you can use the template function **CliplisterClipExists()** in order to find out if a video is available ahead of time and to put **<<cms-syntax/basics/if#, IF-ELSE logic  >>** into effect.
. Click on the **save icon** to save the settings.
