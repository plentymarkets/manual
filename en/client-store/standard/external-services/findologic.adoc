...
image::client-store/standard/external-services/assets/EN-Settings-Client-Standard-External-Findologic-01-SI.png[]
...
**image::client-store/standard/external-services/assets/EN-Settings-Client-Standard-External-Findologic-02-SI.png[]**
