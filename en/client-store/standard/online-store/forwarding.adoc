...
|**Forwarding**
|This function makes it possible to display your online store on mobile devices, e.g. with **<<multi-channel/shopgate#, Shopgate  >>** or a similar provider. Select **Active** to begin forwarding to the specified URLs.
