...
====
Go to **CMS » Web design** and use the <<cms/web-design/editing-the-web-design#4-4, **Apply design** >> icon to copy a design from one particular language into another. In doing so, a design that you use in one language can create templates for several languages. The text will then need to be modified for the new languages. The layout determines the appearance of the **online store**, the **order process** and the **my account** area within the store. For further information, refer to the **<<working-with-plentymarkets/basic-settings/language#, Language settings  >>** page of the manual.
====
...
image::client-store/standard/online-store/assets/EN-Settings-Client-Standard-Store-Multilingualism-01-SI.png[]
...
image::client-store/standard/online-store/assets/EN-Settings-Client-Standard-Store-Multilingualism-02-SI.png[]
...
If you created language versions for items and categories, then you can easily switch the language in the store by selecting a different language. This is assuming that you have created a <<cms/web-design/editing-the-web-design#4-4, **design** >> for the respective language.
...
image::client-store/standard/online-store/assets/EN-Settings-Client-Standard-Store-Multilingualism-03-SI.png[]
...
For further information about the menus that need to be configured when setting up your multilingual store, refer to the **<<client-store/best-practice/multilingual-online-store#, Multilingual online store  >>** page of the manual.
