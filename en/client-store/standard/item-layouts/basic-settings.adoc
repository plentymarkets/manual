...
__**Tip**__: You can modify the error message text **Invalid selection** in the <<client-store/global-settings/language-packages#, **Settings » Client (store) » Global Settings » Language packages**  >>. Open the drop-down list **Notes** and edit the note **No. 42**.
...
Use CSS to modify how the features described here are displayed. For further information and a code example, refer to the <<cms-syntax/case-examples/displaying-item-variants-dynamically#4-6, **Displaying item variations dynamically** >> best practice page of the manual.
