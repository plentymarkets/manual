...
Use the **<<orders/editing-sales-orders/changing-a-sales-order#14, group function >>****Group orders** to manually combine orders after they have passed this status.
