...
The menu only contains those countries that were set to **Active** under link::/[**Settings » Orders » Shipping » Shipping options » Tab: Countries of delivery**].
...
. Open every item that should be sold as digital media and save the property in the link::/[**Properties**] tab.
