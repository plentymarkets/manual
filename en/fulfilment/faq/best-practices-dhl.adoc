...
The new password has to be saved also in the plentymarkets back end:

* for the DHL Shipping plugin the *DHL Shipping (Versenden): Basic settings* assistant

* for the interface integration DHL Intraship/Versenden in the *Setup » Orders » Shipping » Shipping service provider » DHL Intraship/Versenden* menu
...
* for the DHL Shipping plugin in the *DHL Shipping (Versenden): Basic settings* assistant in the *Billing numbers* step
...
Because plentymarkets still uses the DHL Intraship interface and our registered orders might be transferred to the business customer portal – according to the settings in the customer’s account – customers of the business customer portal receive the message that the registration could not be mapped.
...
.Recipient data in the *Setup » Orders » Shipping » Service providers » DHL Intraship/Versenden*
...
If you still use the interface and DHL Intraship, registering orders with your DHL Intraship login details is still possible and the above mentioned error message will not be displayed.
