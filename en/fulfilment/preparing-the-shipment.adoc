...
:position: 10
:url: fulfillment/preparing-the-shipment
...
Go to *System » System settings » Item » Settings* and select the property that you have just created for the option *Item property for visual age check*. *Save* the settings.
