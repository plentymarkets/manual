...
====
When you defined a default shipping profile in the *Setup » Client* » _Select client_ » *Orders* menu, the button to delete this shipping profile from the shipping profile overview in the *Setup » Orders » Shipping » Settings » Tab: Shipping profiles* menu is disabled. Thus, it is not possible to delete the shipping profile that is saved as default shipping profile.
====
...
If you select the setting *Maximum (cubic metres)* under *Limitation type*, the value here must be entered in m.
...
|Activate in order to use the SFTP directory structure of DHL Freight.
|====
...
[TIP]
.Assistant for easy setup of DHL Retoure Online
====
Buy the *DHL Retoure Online* plugin free of charge on plentyMarketplace and install it in a plugin set. The *DHL Retoure Online* assistant is visible in the *Setup » Assistants* menu.
====
