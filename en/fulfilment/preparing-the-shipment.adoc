...
. Go to *System » System settings » Orders » Shipping » Settings » Tab: Countries of delivery » Tab: Overview*.
...
.Overview of the countries of delivery in the *System » System settings » Orders » Shipping » Settings » Tab: Countries of delivery* menu
[cols="1,3"]
|====
|Setting |Explanation
...
*Supplier is active* = Countries of delivery with this setting cannot be selected as the *Standard country of delivery* in the <<omni-channel/online-store/setting-up-clients/order-process#, System » System settings » Client » Select client » Order process » Settings>> menu.

|*Warehouse*
|Select which warehouse the country of delivery should be assigned to. This warehouse is automatically selected for orders from this country. Select *ALL* if the country of delivery should be assigned to all of the warehouses. In this case, the warehouse with the lowest ID is automatically selected for the orders. Also pay attention to the <<orders/managing-orders#, warehouse settings>> in the *System » System settings » Orders » Settings* menu.
...
. Go to *System » System settings » Orders » Shipping » Settings » Tab: Countries of delivery » Tab: Filter*.
...
. Go to *System » System settings » Orders » Shipping » Shipping service provider*.
...
.Overview in the *System » System settings » Orders » Shipping » Settings » Tab: Shipping service provider* menu
[cols="1,3"]
|====
|Setting |Explanation
...
Set up the shipping costs for orders placed on eBay in the *System » System settings » Listings » Checkout* menu. To do so, select *Transfer from eBay* or *Have it calculated by plentymarkets* under the option *Shipping costs for new orders coming from eBay*.
...
====
If you activated several eBay accounts in your plentymarkets system, you can define an individual shipping profile for each eBay account. Use the option *eBay account* in the *System » System settings » Orders » Shipping » Settings » Tab: Shipping profiles » Tab: Base* menu to select one of the different accounts.
====
...
Adapt the error code also in the *System » System settings » Client » Global » Language packages* in the *Error messages* area, if necessary.
====
...
====
Not every shipping service provider includes additional shipping services. If available and once you saved and reloaded the table of shipping charges, the shipping services are displayed in the table of shipping charges. They are displayed underneath the name of the service provider. Go to *System » System settings » Orders » Shipping » Settings » Tab: Shipping profiles*. Click on the *Table of shipping charges* tab and expand the region. The shipping services are displayed in the lower portion of the table of shipping charges.
====
...
. Go to *System » System settings » Orders » Shipping » Settings » Tab: Calculate shipping costs*.
...
. Go to *System » System settings » Orders » Shipping » Shipping packages*.
...
. Go to *System » System settings » Orders » Shipping » Shipping service provider » DHL Easylog*.
...
. Go to *System » System settings » Orders » Shipping » Shipping service provider » DHL Freight*.
...
. Go to *System » System settings » Orders » Shipping » Shipping service provider » DHL Intraship/Versenden*.
...
====
In order to combine the generation of export documents with the booking of outgoing items, set up an event procedure. To do so, go to *System » System settings » Orders » Events*. For further information, refer to the <<automation/event-procedures#, event procedures>> page of the manual.
====
...
Go to *System » System settings » Item » Properties* and create a property of the type *Selection*. Save values for the different age restrictions. For example, create the values *A16* and *A18*. Enter a name for the property, e.g. visual age check.
...
Go to *System » System settings » Item » Settings* and select the property that you have just created for the option *Item property for visual age check*. *Save* (icon:save[role="green"]) the settings.
...
. Go to *System » System settings » Orders » Shipping » Settings*.
...
. Go to *System » System settings » Orders » Shipping » Shipping service provider » DHL Retoure enclosed return labels*.
...
You need to have a warehouse in order to save the information about returns that you receive from DHL. There are various types of warehouses in plentymarkets. The warehouse type *Repair* is especially well-suited for returns. The setting *Warehouse assigned for repair* in the *System » System settings » Stock » Warehouse » Select warehouse » Settings* menu allows you to assign repair warehouses to main warehouses of the type *Sales warehouse*. When a return label is generated later, the corresponding sales or repair warehouse is used depending on which warehouse matches the order.

If you have not yet created a warehouse, create a warehouse or a sales and repair warehouse in the *System » System settings » Stock » Warehouse* menu. How to create a warehouse is described on the <<stock-management/setting-up-a-warehouse#, Setting up a warehouse>> page of the manual.
...
. Go to *System » System settings » Orders » Shipping » Shipping service provider » DHL Retoure Online*.
...
. Go to *System » System settings » Client » Select client » My account » Settings*.
...
.Allowing creation of returns in the *System » System settings » Client » Select client » My account » Settings*
[cols="1,3"]
|====
|Setting |Explanation
...
====
You can automatically send the return label to your customers. To do so, set up an event procedure and select the event *Return label saved*. Furthermore, you have to set up an email template in the *System » System settings » Client » Select client » Email » Templates* menu and select the option *Return* from the drop-down list *PDF attachment*.
====
...
. Go to *System » System settings » Orders » Shipping » Shipping service provider » DHL Supply Chain*.
...
. Go to *System » System settings » Orders » Shipping » Shipping service provider » DHL UK*.
...
. Go to *System » System settings » Orders » Shipping » Shipping service provider » DPD Cloud Webservice*.
...
. Go to *System » System settings » Orders » Shipping » Shipping service provider » DPD DELISprint*.
...
. Go to *System » System settings » Orders » Shipping » Shipping service provider » EasyPAK*.
...
. Go to *System » System settings » Item » Properties » Tab: New property*.
...
. Go to *System » System settings » Orders » Shipping » Shipping service provider » Hermes 2-Mann-Handling (two-man handling)*.
...
. Go to *System » System settings » Orders » Shipping » Shipping service provider » Hermes ProfiPaketService (professional parcel service)*.
...
. Go to *System » System settings » Orders » Shipping » Shipping service provider » MyDPD Business / iloxx*.
...
. Go to *System » System settings » Orders » Shipping » Shipping service provider » NetDespatch*.
...
. Go to *System » System settings » Orders » Shipping » Shipping service provider » Parcelforce Worldwide*.
...
. Go to *System » System settings » Orders » Shipping » Shipping service provider » PARCEL.ONE*.
...
. Go to *System » System settings » Orders » Shipping » Shipping service provider » Swiss Post*.
...
. Go to *System » System settings » Orders » Shipping » Shipping service provider » UPS*.
...
DHL runs a network of Packstations that are accessible any time of the day. Customers can choose to activate or enter a DHL Packstation or DHL post office as the delivery address. Carry out the settings for the DHL Packstation in the *System » System settings » Client » Select client » Order process » DHL Packstation* menu.
...
. Go to *System » System settings » Client » Select client » Order process » DHL Packstation*.
...
Go to *System » System settings » Orders » Order status* and set up two <<orders/managing-orders#1200, order statuses>> for the orders transferred to DHL Fulfillment. Below are two examples:
...
If you want returns from DHL Fulfillment to be imported into your plentymarkets system, you need to create reasons for the returns. Go to <<orders/managing-orders#400, System » System settings » Orders » Order types » Return>> to create reasons for returns. Afterwards, link the reasons that you created with the reasons given by DHL Fulfillment in the *System » System settings » Orders » Shipping » Fulfilment service provider » DHL Fulfillment* menu.
...
. Go to *System » System settings » Orders » Shipping » Fulfilment » DHL Fulfillment*.
...
|*Reasons for return*
|Link the reasons for return that you created under <<orders/managing-orders#400, System » System settings » Orders » Order types » Return>> with the reasons given by DHL Fulfillment.
|====
...
====
Go to *System » System settings » Item » Properties* and create a property of the type with the property type *None*:
...
After you created the properties, <<item/managing-items#80, activate>> these properties for the item within the item's *Properties* tab. Finally, go to *System » System settings » Orders » Shipping » Fulfilment » DHL Fulfillment* and use the drop-down lists to select the properties that you created.
...
Afterwards, create the fulfilment service provider in the *System » System settings » Orders » Shipping » Settings » Tab: Shipping service provider* menu. Select *Miscellaneous* from the *Shipping service provider* drop-down list. Further information can be found in the chapter <<fulfilment/preparing-the-shipment#800, Creating a shipping service provider>>.

Afterwards, create the shipping profile in the *System » System settings » Orders » Shipping » Settings » Tab: Shipping profiles* menu. Carry out the settings as described in the chapter <<fulfilment/preparing-the-shipment#1000, Creating a shipping profile>>.
...
. Go to *System » System settings » Orders » Shipping » Fulfilment » IDS Logistik*.
...
. Go to *System » System settings » Orders » Shipping » Fulfilment » iLopack*.
