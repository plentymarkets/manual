...
In order to use DHL Postfinder, you have to carry out settings in multiple menus. These settings are summarised on this <<online-store/online-store/cms#web-design-editing-the-web-design-order-process-dhl-postfinder, page of the manual>> page of the manual.
