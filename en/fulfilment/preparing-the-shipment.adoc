...
+
--
The plugin *DHL Retoure Online* is available free of charge in the link:https://marketplace.plentymarkets.com/en/plugins/integration/dhlretoureonline_6714[plentyMarketplace^]. Install the plugin in a plugin set. The *DHL Retoure Online* assistant is visible in the *Setup » Assistants » Plugins* menu in the relevant plugin set. For further information, refer to the <<fulfilment/shipping-service-provider-plugins/plugin-dhl-retoure-online#, DHL Retoure Online>> page.
...
For further information, refer to the <<fulfilment/shipping-service-provider-plugins/plugin-dhl-shipping-versenden#, DHL Shipping (Versenden)>> page. The plugin *DHL Shipping (Versenden)* is available in the link:https://marketplace.plentymarkets.com/en/plugins/integration/DHLShipping_4871[plentyMarketplace^].
...
include::../_includes/textblocks/instructions/api-log-filters.adoc[]
