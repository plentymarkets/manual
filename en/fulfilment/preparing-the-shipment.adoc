...
====
Hermes switches off the ProfiPaketService interface by 31 March 2020. Therefore, use *Hermes Shipping Interface* instead. Download the plugin free of charge on link:https://marketplace.plentymarkets.com/en/plugins/integration/hermesshippinginterface_5437[plentyMarketplace^].
====
