...
|The order number is exported in a CSV file from the <<fulfilment/generating-documents#200, list of delivery addresses>>. It includes the following parameters: +
