...
======
Purchase the *DHL Retoure Online* plugin free of charge on link:https://marketplace.plentymarkets.com/en/plugins/integration/dhlretoureonline_6714[plentyMarketplace^] and install it in a plugin set. The *DHL Retoure Online* assistant is visible in the *Setup » Assistants* menu in the *Integration* section.
======
