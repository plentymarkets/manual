...
*Supplier is active* = Countries of delivery with this setting cannot be selected as the <<omni-channel/online-store/setting-up-clients/order-process#, Standard country of delivery>> in the *Setup » Client » Select client » Order process » Settings* menu.
...
====
Hermes switches off the ProfiPaketService interface by 31 March2020. Therefore, use *Hermes Shipping Interface* instead. Download the plugin free of charge on link:https://marketplace.plentymarkets.com/en/plugins/integration/hermesshippinginterface_5437[plentyMarketplace^]{nbsp}icon:external-link[].
====
