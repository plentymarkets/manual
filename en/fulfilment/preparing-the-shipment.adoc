...
*_Important:_* Installing the cash on delivery plugin is required. The plugin can be found in thelink:https://marketplace.plentymarkets.com/en/plugins/payment/cashondelivery_5255[plentyMarketplace^].
