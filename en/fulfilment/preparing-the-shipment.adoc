...
. Carry out the desired settings in the *Overview* area. Note <<#table-overview-countries-of-delivery>>.
...
. Carry out the desired settings in the *Filter* area. Note <<#table-filter-countries-of-delivery>>.
. Click on *Search*. +
...
| *Split URLs*
|Activate the option if you want that the tracking URLs are split. In this case, a separate URL is used for each tracking number. +
...
| *Separator*
|If you want to use one URL for all tracking numbers, insert a desired separator in this field. +
...
. Go to *Setup » Orders » Shipping » Settings*.
. Click on the *Shipping service provider* tab.
. Carry out the desired settings in the *Filter* area. Note <<#table-filter-shipping-service-provider>>.
. Click on *Search*. +
...
Use the *Table of shipping charges* tab to enter shipping costs for a shipping profile. Save shipping charges for every region that you want to use with the shipping profile. Select the calculation type and the shipping charge. You see additional settings for specific service providers once you have saved and reloaded the table of shipping charges. First carry out the general settings. Note <<#table-table-of-shipping-charges-shipping-profile>>.
...
. Carry out the desired settings. Note <<#table-table-of-shipping-charges-shipping-profile>>.
. *Save* (icon:save[role="green"]) the settings.
...
For further information about log entries, refer to the <<data/datalog#, Data log>> page.
...
. Click on the *Table of shipping charges* tab.
. Expand the region (icon:angle-down[]).
. Carry out the desired settings in the *DHL Easylog* area. Note <<#table-shipping-services-dhl-easylog>>.
. *Save* (icon:save[role="green"]) the settings.
...
. Click on the *Table of shipping charges* tab.
. Expand the region (icon:angle-down[]).
. Carry out the desired settings in the *DHL Freight* area. Note <<#table-shipping-services-dhl-freight>>.
. *Save* (icon:save[role="green"]) the settings.
...
. Carry out the desired settings. Note <<#table-interface-dhl-intraship-versenden>>.
. *Save* (icon:save[role="green"]) the settings.
...
. Click on the *Table of shipping charges* tab.
. Expand the region (icon:angle-down[]).
. Carry out the desired settings in the *DHL Intraship/Versenden* area. Note <<#table-shipping-services-dhl-intraship-versenden>>.
. *Save* (icon:save[role="green"]) the settings.
...
. Carry out the desired settings. Note <<#table-dhl-export-documents>>.
...
. Carry out the desired settings. Note <<#table-dhl-packstation>>.
. *Save* (icon:save[role="green"]) the settings.
...
. Carry out the desired settings. Note <<#table-interface-dhl-enclosed-return-labels>>.
. *Save* (icon:save[role="green"]) the settings.
...
. Click on the *Table of shipping charges* tab.
. Expand the region (icon:angle-down[]).
. Carry out the desired settings in the *DHL UK* area. Note <<#table-shipping-services-dhl-uk>>.
. *Save* (icon:save[role="green"]) the settings.
...
Note the information about the shipments that you later register for DPD Cloud Webservice (My DPDBusiness) via the <<fulfilment/shipping-centre#register-shipping-order, shipping centre>>. Go to *Data » Log* to view this information. For further information about log entries, refer to the <<data/datalog#, Data log>> page.
...
. Click on the *Table of shipping charges* tab.
. Expand the region (icon:angle-down[]).
. Carry out the desired settings in the *PAT Easypak* area. Note <<#table-shipping-services-easypak>>.
. *Save* (icon:save[role="green"]) the settings.
...
. Click on the *Table of shipping charges* tab.
. Expand the region (icon:angle-down[]).
. Carry out the desired settings in the *Hermes (two-man handling)* area. Note <<#table-shipping-services-hermes-2mannhandling>>.
. *Save* (icon:save[role="green"]) the settings.
...
. Click on the *Table of shipping charges* tab.
. Expand the region (icon:angle-down[]).
. Carry out the desired settings in the *NetDespatch* area. Note <<#table-shipping-services-netdespatch-ukmail>>.
. *Save* (icon:save[role="green"]) the settings.
...
. Click on the *Table of shipping charges* tab.
. Expand the region (icon:angle-down[]).
. Carry out the desired settings in the *Parcelforce Worldwide* area. Note <<#table-shipping-services-parcelforce-worldwide>>.
. *Save* (icon:save[role="green"]) the settings.
...
. Click on the *Table of shipping charges* tab.
. Expand the region (icon:angle-down[]).
. Carry out the desired settings in the *PARCEL.ONE* area. Note <<#table-shipping-services-parcel-one>>.
. *Save* (icon:save[role="green"]) the settings.
...
. Click on the *Table of shipping charges* tab.
. Expand the region (icon:angle-down[]).
. Carry out the desired settings in the *UPS Service* area. Note <<#table-shipping-services-ups>>.
. *Save* (icon:save[role="green"]) the settings.
...
Registering the shipment with DHL Fulfillment takes place automatically via the interface. The *Data » Log* menu contains information about shipments that were registered with DHL Fulfillment. For further information about log entries, refer to the <<data/datalog#, Data log>> page.
...
The *Data » Log* menu contains information about shipments that were registered with DHL Fulfillment. For further information about log entries, refer to the <<data/datalog#, Data log>> page of the manual.
====
