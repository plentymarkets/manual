...
. Carry out the settings in the *Overview* area as desired. Note the explanations in <<#table-overview-countries-of-delivery>>.
...
. Carry out the settings in the *Filter* area as desired. Note the information given in <<#table-filter-countries-of-delivery>>.
. Click on *Search*. +
...
. Carry out the settings. Note the explanations in <<#table-create-shipping-service-provider>>.
. *Save* (icon:save[role="green"]) the settings.
...
. Go to *Setup » Orders » Shipping » Settings*.
. Click on the *Shipping service provider* tab.
. Carry out the settings in the *Filter* area as desired. Note the explanations in <<#table-filter-shipping-service-provider>>.
. Click on *Search*. +
...
. Carry out the settings. Note the explanations in <<#table-basic-settings-shipping-profile>>.
. *Save* (icon:save[role="green"]) the settings. +
...
|Place a check mark to activate the extra shipping charges that are saved in the item data record. Up to 2 extra shipping charges can be saved for the item's main variation in the *Shipping* area. *Extra shipping charge 1* is added to the shipping costs for the first item. *Extra shipping charge 2* is added to the shipping costs for all additional items. Extra shipping charges are useful for large or bulky items that are particularly expensive to ship. +
...
The error message as well as the translation of error code 53 can be adjusted for the Ceres plugin. To do so, go to *CMS » Multilingualism*, expand the *Notifications* area and enter the translation in the line *notificationsCalculatedShippingFailed*.
...
Use the *Table of shipping charges* tab to enter shipping costs for a shipping profile. Save shipping charges for every region that you want to use with the shipping profile. Select the calculation type and the shipping charge. You see additional settings for specific service providers once you have saved and reloaded the table of shipping charges. First carry out the general settings. Note the explanations in <<#table-table-of-shipping-charges-shipping-profile>>.
...
. Carry out the settings. Note the explanations in <<#table-table-of-shipping-charges-shipping-profile>>.
. *Save* (icon:save[role="green"]) the settings.
...
*_Note:_* This function can be used from Ceres version 4.0.0.
...
====
The volume is only calculated correctly if you saved the item's length, width and height within the main variation's *Settings* tab in the <<item/managing-items#270, Dimensions>> area in the _Item » Edit item_ » *Open item* menu. It is not possible to calculate the volume if these entries are missing. Therefore, it is not possible to calculate the shipping costs based on the volume either.
====
...
[TIP]
.Example: Defined shipping packages and individual packaging
====
...
Flexible packaging: In order to ship e.g. furniture, the seller uses packaging material that is individually cut to match the size of the item to be shipped. These materials can be corrugated card board, foil etc. The volume is calculated based on the item data.
====
...
. Carry out the settings. Note the explanations in <<#table-create-shipping-package>>.
. *Save* (icon:save[role="green"]) the settings.
...
|<<fulfilment/preparing-the-shipment#2900, DHL Shipping (Versenden) and DHL Intraship/Versenden>>
|For sellers within Germany. Shipping: international.
...
. Carry out the settings. Note the explanations in <<#table-interface-dhl-easylog>>.
. *Save* (icon:save[role="green"]) the settings.
...
. Click on the *Table of shipping charges* tab.
. Expand the region (icon:angle-down[]).
. Carry out the settings in the *DHL Easylog* area. Note the explanations in <<#table-shipping-services-dhl-easylog>>.
. *Save* (icon:save[role="green"]) the settings.
...
. Carry out the settings. Note the explanations in <<#table-interface-dhl-freight>>.
. *Save* (icon:save[role="green"]) the settings.
...
. Click on the *Table of shipping charges* tab.
. Expand the region (icon:angle-down[]).
. Carry out the settings in the *DHL Freight* area. Note the explanations in <<#table-shipping-services-dhl-freight>>.
. *Save* (icon:save[role="green"]) the settings.
...
[#2900]
=== DHL Shipping (Versenden) and DHL Intraship/Versenden

In order to get further information about how to set up the DHL Shipping (Versenden) plugin, click on *Plugin*. To see further details about the old interface DHL Intraship/Versenden, click on *Old integration*.
...
If you use the DHL Shipping plugin, export documents are automatically available in the shipping centre next to the shipping label when you register the shipping order.
--
...
. Carry out the settings. Note the explanations in <<table-interface-dhl-intraship-versenden>>.
. *Save* (icon:save[role="green"]) the settings.
...
*_Important:_* Note the explanations in the box below the table. +
...
.DHL billing number
======
The 2 middle characters of the billing number *Process* stand for the following DHL products: DHL Paket (01), Regionalpaket AT (02), DHL Europaket (54), DHL Paket International (53), DHL Domestic Express (71) and DHL Officepack (72). +
...
. Click on the *Table of shipping charges* tab.
. Expand the region (icon:angle-down[]).
. Carry out the settings in the *DHL Intraship/Versenden* area. Note the explanations in <<#table-shipping-services-dhl-intraship-versenden>>.
. *Save* (icon:save[role="green"]) the settings.
...
Export shipments may contain a maximum of 5 stock units. The following data for each variation is reported: Weight, customs tariff number, manufacturer country, item name, value of items and quantity.
...
. Carry out the settings. Note the explanations in <<#table-dhl-export-documents>>.
...
Go to *Setup » Item » Characteristics* and create a characteristic of the type *Selection*. Save values for the different age restrictions. For example, create the values *A16* and *A18*. Enter a name for the property, e.g. visual age check.
...
Go to *Setup » Item » Characteristics* and select the characteristic that you have just created for the option *Item characteristic for visual age check*. *Save* (icon:save[role="green"]) the settings.
...
. Carry out the settings. Note the explanations in <<#table-interface-dhl-enclosed-return-labels>>.
. *Save* (icon:save[role="green"]) the settings.
...
======
Buy the *DHL Retoure Online* free of charge on link:https://marketplace.plentymarkets.com/en/plugins/integration/dhlretoureonline_6714[plentyMarketplace^]{nbsp}icon:external-link[] and install it in a plugin set. The *DHL Retoure Online* assistant is visible in the *Setup » Assistants* menu in the *Integrations* area.
======
...
. Carry out the settings. Note the explanations in <<#table-dhl-retoure-online>>.
. *Save* (icon:save[role="green"]) the settings.
...
. Select one of the options from the *Return* drop-down list. Note the explanations in <<#table-allow-to-create-returns>>.
. *Save* (icon:save[role="green"]) the settings.
...
. Carry out the settings. Note the explanations in <<#table-interface-dhl-supply-chain>>.
. *Save* (icon:save[role="green"]) the settings.
...
. Carry out the settings. Note the explanations in <<#table-interface-dhl-uk>>.
. *Save* (icon:save[role="green"]) the settings.
...
. Click on the *Table of shipping charges* tab.
. Expand the region (icon:angle-down[]).
. Carry out the settings in the *DHL UK* area. Note the explanations in <<#table-shipping-services-dhl-uk>>.
. *Save* (icon:save[role="green"]) the settings.
...
. Carry out the settings. Note the explanations in <<#table-interface-dpd-cloud-webservice>>.
. *Save* (icon:save[role="green"]) the settings.
...
. Carry out the settings. Note the explanations in <<#table-interface-dpd-delisprint>>.
. *Save* (icon:save[role="green"]) the settings.
...
. Carry out the settings. Note the explanations in <<#table-interface-easypak>>.
. *Save* (icon:save[role="green"]) the settings.
...
. Click on the *Table of shipping charges* tab.
. Expand the region (icon:angle-down[]).
. Carry out the settings in the *PAT Easypak* area. Note the explanations in <<#table-shipping-services-easypak>>.
. *Save* (icon:save[role="green"]) the settings.
...
. Carry out the settings. Note the explanations in <<#table-gls-germany>>.
. *Save* (icon:save[role="green"]) the settings.
...
. Activate the option *Order characteristic*.
...
. Carry out the settings. Note the explanations in <<#table-interface-hermes-2mannhandling>>.
. *Save* (icon:save[role="green"]) the settings.
...
. Click on the *Table of shipping charges* tab.
. Expand the region (icon:angle-down[]).
. Carry out the settings in the *Hermes (two-man handling)* area. Note the explanations in <<#table-shipping-services-hermes-2mannhandling>>.
. *Save* (icon:save[role="green"]) the settings.
...
. Carry out the settings. Note the explanations in <<#table-interface-hermes-profipaketservice>>.
. *Save* (icon:save[role="green"]) the settings.
...
. Carry out the settings. Note the explanations in <<#table-interface-netdespatch-ukmail>>.
. *Save* (icon:save[role="green"]) the settings.
...
. Click on the *Table of shipping charges* tab.
. Expand the region (icon:angle-down[]).
. Carry out the settings in the *NetDespatch* area. Note the explanations in <<#table-shipping-services-netdespatch-ukmail>>.
. *Save* (icon:save[role="green"]) the settings.
...
. Click on the *Table of shipping charges* tab.
. Expand the region (icon:angle-down[]).
. Carry out the settings in the *Parcelforce Worldwide* area. Note the explanations in <<#table-shipping-services-parcelforce-worldwide>>.
. *Save* (icon:save[role="green"]) the settings.
...
. Click on the *Table of shipping charges* tab.
. Expand the region (icon:angle-down[]).
. Carry out the settings in the *PARCEL.ONE* area. Note the explanations in <<#table-shipping-services-parcel-one>>.
. *Save* (icon:save[role="green"]) the settings.
...
. Carry out the settings. Note the explanations in<<#table-interface-swiss-post>>.
. *Save* (icon:save[role="green"]) the settings.
...
. Click on the *Table of shipping charges* tab.
. Expand the region (icon:angle-down[]).
. Carry out the settings. Note the explanations in <<#table-shipping-services-swiss-post>>.
. *Save* (icon:save[role="green"]) the settings.
...
. Carry out the settings. Note the explanations in <<#table-interface-ups>>.
. *Save* (icon:save[role="green"]) the settings.
...
. Click on the *Table of shipping charges* tab.
. Expand the region (icon:angle-down[]).
. Carry out the settings in the *UPS Service* area. Note the explanations in <<#table-shipping-services-ups>>.
. *Save* (icon:save[role="green"]) the settings.
...
. Carry out the settings. Note the explanations in <<#table-dhl-packstation>>.
. *Save* (icon:save[role="green"]) the settings.
...
Set up link:https://www.dhl.de/en/geschaeftskunden/paket/leistungen-und-services/fulfillment.html[DHL Fulfilment^]{nbsp}icon:external-link[] in your plentymarkets system. Proceed as described below.
...
. Carry out the settings. Note the explanations in <<#table-interface-dhl-fulfillment>>.
. *Save* (icon:save[role="green"]) the settings.
...
Go to *Settings » Item » Characteristics* and create a property of the type Selection. "Transfer item characteristics such as "Fragile" or "Original packaging" to DHL Fulfillment if you want items to be handled or shipped in a certain way. For further information, refer to the <<item/settings/properties#300, Characteristics and properties>> page. The following characteristics can be transferred to DHL Fulfillment:
...
. Carry out the settings. Note the explanations in <<#table-interface-ids-logistik>>.
. *Save* (icon:save[role="green"]) the settings.
...
. Carry out the settings. Note the explanations in <<#table-interface-ilopack>>.
. *Save* (icon:save[role="green"]) the settings.
...
. Carry out the settings. Note the explanations in <<#table-data-transfer-ilopack>>.
