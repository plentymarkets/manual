...
:keywords: shipping service provider, fulfilment service provider, fulfillment, fulfilment, shipping countries, shipping country, country of delivery, countries of delivery, region, regions, shipping profile, shipping profiles, table of shipping charges, shipping packages, shipping package, shipping costs, DHL packstation, DHL postfinder, tracking URL, c.b.c. logistics, cbc logistics, PARCEL.ONE, easylog, DHL Freight, Versenden, DHL Versenden, DHL Retoure, DHL Retoure Online, enclosed return labels, Supply Chain, DHL UK, DPD, DELISprint, EasyPak, GLS Germany, Hermes ProfiPaketService, Hermes 2-Mann-Handling, DPD Business, iloxx, UK Mail, NetDespatch, Swiss Post, DHL Fulfillment, IDS Logistik, iLOPACK, export documents, CN23, CP71
...
====
Via the interface to the DHL business customer portal, you can use the function *Versenden* (shipping). The plugin *DHL Shipping (Versenden)* is available in the link:https://marketplace.plentymarkets.com/en/plugins/integration/DHLShipping_4871[plentyMarketplace^].
...
Carry out the settings in the link:https://www.dhl-geschaeftskundenportal.de/webcenter/portal/gkpExternal/gkpPortalMainNav/homeExt?_afrLoop=11817963540301763&_adf.ctrl-state=meh62flsr_38#\![DHL business customer portal^].
...
====
Buy the *DHL Retoure Online* free of charge on link:https://marketplace.plentymarkets.com/en/plugins/integration/dhlretoureonline_6714[plentyMarketplace^] and install it in a plugin set. The *DHL Retoure Online* assistant is visible in the *Setup » Assistants* menu.
====
...
Create properties in the *Settings » Item » Properties* menu and transfer item properties such as "Fragile" or "Original packaging" to DHL Fulfillment if you want the items to be handled or shipped in a certain way. How to create a property is described on the <<item/managing-items#, Managing items>> page of the manual. The following properties can be transferred to DHL Fulfillment:
...
For further information, refer to the <<item/managing-items#, Managing items>> page of the manual.
====
