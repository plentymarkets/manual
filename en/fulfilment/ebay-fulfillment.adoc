...
image::fulfilment/assets/eBay-Fulfillment-settings-plugin.png[width=640, height=360]
...
. The option *Automatic assignment to the eBay Fulfillment warehouse* is deactivated by default. If a new eBay order is imported in your plentymarkets system, it is checked - when the option is activated - whether stock is available in the eBay Fulfillment warehouse. If stock is available, the eBay Fulfillment warehouse is automatically assigned for the order items. +
*_Note:_* Place the checkmark if you want the eBay Fulfillment warehouse to be automatically assigned.
