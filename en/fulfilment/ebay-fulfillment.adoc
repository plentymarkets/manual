...
Make sure that a shipping service provider and a shipping profile have been set up for all shipping service providers used for the eBay Fulfillment program. Currently, the eBay Fulfillment program can be carried out with Hermes, UPS and Deutsche Post DHL.

[IMPORTANT]
.Create a shipping profile and a shipping service provider
====
For each new fulfilment service provider, a new shipping service provider as well as a new shipping profile must be available. Currently, the eBay Fulfillment program can be carried out with Hermes, UPS and Deutsche Post DHL.
====
...
. Select the shipping profile from the list (see <<image-link-shipping-profiles>>).
