...
[[image-start-image]]
image::fulfilment/assets/Fiege-MegaCenter-Erfurt4.jpg[width=640, height=360]=640, height=360]
...
image::fulfilment/assets/eBay-Fulfillment-order-referrers-warehouse.png[width=640, height=360]=640, height=360]
...
. Open the menu *Setup » Orders » Order referrer* in your plentymarkets back end.
. Click on *New status*.
. In the field *New status*, enter the number, e.g. *5.4*.3*.
...
image::fulfilment/assets/eBay-Fulfillment-label-template.png[width=640, height=360]=640, height=360]
...
Log in to your PayPal account and check whether the time zone is correctly set. To do so, open this link:https://www.paypal.com/businessprofile/mysettings[PayPal link^]. The time zone should display *(CET01:00) Central European Time (Berlin, Paris, Rome)*.

[#760]
==== Immediate Payment Notifications

Log into your PayPal account and use this link:https://www.paypal.com/cgi-bin/customerprofileweb?cmd=_profile-ipn-notify[Link^] to check if Immediate Payment Notifications are activated. If the function is activated, enter the URL of your plentymarkets system there.
