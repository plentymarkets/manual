...
In plentymarkets back end, in the *Setup » Orders » Shipping » Options » Tab: Shipping service provider* menu, the shipping service provider, e.g. Hermes, must be created and its tracking URL saved.
