...
In order to set up the interface for CLC in your plentymarkets system, you have to be registered with link:https://www.tietjegroup.com/en/kontakt/[CLC^]{nbsp}icon:external-link[]. Simply write an email to mailto:email[kontakt@tietjegroup.com].
