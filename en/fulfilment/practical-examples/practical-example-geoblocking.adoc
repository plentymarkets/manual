...
Adjusting the error messages for plentyShops is done in the *CMS » Multilingualism* menu in the *Ceres » Notifications* area. The corresponding key is called `notificationsCalculateShippingFailed`.
