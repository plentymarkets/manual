...
2. Do not offer any shipping method (error message in the online store)
...
It is also possible not to add these countries to any region. In this case, an error message will occur in the online store.
...
====
For Ceres: Adjust the error messages in the *CMS » Multilingualism* menu in the *Ceres » Notifications* area. The key is called `notificationsCalculateShippingFailed`. +
For Callisto: Adjust the error messages in the *Setup » Client » Global » Language packages* menu.
====

Adjusting the error messages for Ceres online stores is done in the *CMS » Multilingualism* menu in the *Ceres » Notifications* area. The corresponding key is called `notificationsCalculateShippingFailed`.
...
.Ceres: Adjusting the error message in the multilingualism menu
