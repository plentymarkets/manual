...
Once you have successfully installed the plugin and deployed it in a plugin set, the two assistants *DHL Shipping (Versenden): Basic settings* and *DHL Shipping (Versenden): Settings combination* are available in the *Setup » Assistants* menu in the *Integration* area. Complete these two assistants to easily set up DHL Shipping (Versenden) in your plentymarkets system.
...
== Setting up the DHL Shipping plugin via the assistants
...
====
You find a detailed description of the individual steps within the two DHL assistants on the <<fulfilment/shipping-service-provider-plugins/plugin-dhl-shipping-versenden#, DHL Shipping (Versenden)>> page of the manual.
====
...
For further information, refer to the <<plugins/updating-installed-plugins#, Updating installed plugins>> page of the manual.
