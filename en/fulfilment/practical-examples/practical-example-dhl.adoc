...
After you have purchased the plugin, you have to install it in your plentymarkets system. After the purchase, you will find the plugin in the *Plugins » Plugin set overview* menu. How to install the plugin in a plugin set and how to switch it to live is described on the <<plugins/installing-added-plugins#, Installing added plugins>> page.

Once you have installed the plugin and saved and deployed it in a plugin set, the assistants *DHL Shipping (Versenden): Basic settings* and *DHL Shipping (Versenden): Settings combination* are available in the *Setup » Assistants* menu in the *Integration* area. Complete both assistants to easily set up DHL Shipping (Versenden) in your plentymarkets system.
...
|Postident
|Activate this option, if PostIdent is required. Forexample, in case of items that can only be purchased from age 18.
...
|Listing type
|Possible options: *All* = All listing types *Auction* = Only auctions *Fixed price/Shop item* = Only fixed price or shop item (shop item only for Hood)
...
After you have finished setting up the shipping profile and linking it to the item, you can now finally set up the DHL Shipping plugin with the help of the two assistants *DHL Shipping (Versenden): Basic settings* and *DHL Shipping (Versenden): Settings combination*. You find the assistants in the *Setup » Assistants* menu in the *Integration* area.

[IMPORTANT]
.Detailed description
====
For a detailed description on the individual steps in both DHL assistants, refer to the <<fulfilment/shipping-service-provider-plugins/plugin-dhl-shipping-versenden#, DHL Shipping (Versenden)>> page.
====
