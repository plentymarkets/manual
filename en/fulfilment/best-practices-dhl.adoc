...
:position: 40
:url: fulfilment/best-practices-dhl
:id: URSDY8P
...
.Region that is not used in the table of shipping charges of the shipping profile
image::fulfilment/assets/fulfilment/assets/DHL-table-of-shipping-charges-region.png[width=640, height=360]
