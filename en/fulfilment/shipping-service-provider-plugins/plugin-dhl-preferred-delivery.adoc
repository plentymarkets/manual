...
Afterwards, you have to activate the services in the *DHL Shipping: Settings combination* assistant. For further information, refer to the <<fulfilment/shipping-service-provider-plugins/plugin-dhl-shipping-versenden#dhl-assistant-settings-combination, DHL Shipping (Versenden)>> page.
