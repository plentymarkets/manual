...
Once you have <<plugins/installing-added-plugins#installing-plugins, installed the plugin>> and <<plugins/installing-added-plugins#linking-plugin-sets, saved and deployed it in a plugin set>>, the assistants *DHL Shipping (Versenden): Basic settings* and *DHL Shipping (Versenden): Settings combination* are available in the *Setup » Assistants* menu in the *Integration* area.
...
Many items are too small to send them in parcels or packages. If you send many of those items, the Warenpost might be a convenient solution for you.
...
The Warenpost can only be used for deliveries within Germany.
