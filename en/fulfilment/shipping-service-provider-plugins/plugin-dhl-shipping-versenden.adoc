...
→ icon:exclamation-triangle[role="red"] *_Important:_* Not all functions and settings have been transferred from the shipping profile to the *Shipping settings* assistant yet. Note the explanations in the <<fulfilment/shipping-service-provider-plugins/dhl-shipping-versenden#assistant-shipping-settings, Completing the *Shipping settings* assistant>> chapter.
