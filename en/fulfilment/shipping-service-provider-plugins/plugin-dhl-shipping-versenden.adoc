...
====
The DHL Wunschpaket services *Preferred day*, *Preferred location* and *Preferred neighbour* are only available in this area once you have downloaded the DHL Wunschpaket plugin in the link:https://marketplace.plentymarkets.com/en/plugins/integration/dhlwunschpaket_5435[plentyMarketplace^]{nbsp}icon:external-link[] and installed the plugin in a plugin set. +
