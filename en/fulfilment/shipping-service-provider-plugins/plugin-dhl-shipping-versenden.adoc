...
As soon as you have <<plugins/installing-added-plugins#installing-plugins, installed>> the plugin in a plugin set, the *DHL Shipping (Versenden): Basic settings* and the *DHL Shipping (Versenden): Settings combination* assistants are available in the *Setup » Assistants » Plugins* menu in the relevant plugin set.
