...
→ In this assistant, you link the settings that you saved in the *DHL Shipping (Versenden): Basic settings* assistant and select the product and the appropriate services.
====
