...
Do you want your company logo to be displayed on the shipping labels? To do so, select the option *Use shipper reference from DHL business customer portal*. DHL will then use the address data that you saved in the DHL business customer portal as well as the company logo that you need to upload there. Only the shipper reference will be transferred to DHL, but no other shipper data from plentymarkets. 
