...
** Open the section *Ship > Basic settings > General settings* and set up the printer settings for your shipping labels. You can activate that the label size 100 x 70 mm is used for Warenpost. Note that for this label size, it is not possible to print the additional name information. Sender name 2, sender name 3 and recipient name 3 cannot be printed on the label.
** You can also use the common label in the format 100 x 200 mm for Warenpost.
