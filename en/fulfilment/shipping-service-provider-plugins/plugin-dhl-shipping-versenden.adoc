...
As soon as you have <<plugins/installing-added-plugins#installing-plugins, installed>> the plugin in a plugin set, the *DHL Shipping: Basic settings* and the *DHL Shipping: Settings combination* assistants are available in the *Setup » Assistants » Plugins* menu in the relevant plugin set. The *Shipping settings* assistant is available in your plentymarkets system by default. You can find it in the *Setup » Assistants » Integration* menu.
...
The following table lists all products and services that are currently available via the *DHL Shipping (Versenden)* plugin.
...
image::fulfilment/assets/dhl-shipping-warenpost-shipping-package-volume.png[width=640, height=360]
