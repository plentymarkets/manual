...
If you ship your parcels to non-EU countries, activate (icon:toggle-on[role="green"]) the option *Export delivery*. Two additional fields appear where you can select the postage and the type of shipment for export deliveries.
