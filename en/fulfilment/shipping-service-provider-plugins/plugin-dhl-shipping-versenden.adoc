...
Do you want your company logo to be displayed on the shipping labels? If yes, enter your sender reference in the corresponding field and upload your company logo in the DHL business customer portal in the sender address.

*_Note:_* If you activate the *Show polling data* area at the bottom, the *Account reference* and *Sender reference* fields are visible. Entering the account reference and the sender reference in this area is only necessary if you register your shipments via the _polling format_. The account reference and the sender reference are not relevant for the transmission via the interface.
