...
* `1234567890` is the customer number (EKP)
* `53` is the product DHL Paket international
...
* Return immediately, 2nd attempt of delivery, Verpackungsrücknahme, Unzustellbarkeitsnachricht (when selecting DHL Paket National, product 01) +
* immediate, after deadline abandonment (when selecting DHL Paket International, product 53) +
