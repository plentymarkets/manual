...
Furthermore, you can determine in this step whether your customers can use a finder in your online shop to select the address of a packstation or a post office as delivery address and whether you want to transfer a minimum package weight to DHL to register the order.
