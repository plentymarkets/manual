...
Once you have installed the plugin and saved and deployed the plugin set as described in the expandable section *First steps and requirements* above, the plugin is visible in the *Setup » Orders » Shipping* menu.
