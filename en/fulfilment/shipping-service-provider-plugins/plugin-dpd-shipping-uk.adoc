...
Once you have <<plugins/installing-added-plugins#installing-plugins, installed the plugin>> and <<plugins/installing-added-plugins#linking-plugin-sets, saved and deployed the plugin set>>, , the plugin is visible in the *Setup » Orders » Shipping* menu.
