...
You also require the plugins link:https://marketplace.plentymarkets.com/en/plugins/integration/DHLShipping_4871[DHL Shipping (Versenden)^]{nbsp}icon:external-link[], link:https://marketplace.plentymarkets.com/en/plugins/templates/Ceres_4697[Ceres^]{nbsp}icon:external-link[]
 and link:https://marketplace.plentymarkets.com/en/plugins/templates/IO_4696[IO^]{nbsp}icon:external-link[].
====
...
In order that you can offer your customers the DHL Wunschpaket services in your plentyShop, the following requirements have to be met.
...
== Setting the visibility of the DHL Wunschpaket services in the plentyShop

In order that your customers can select the DHL Wunschpaket services during the order process in your plentyShop, you have to activate some options in the plugin’s *Container links* area.
