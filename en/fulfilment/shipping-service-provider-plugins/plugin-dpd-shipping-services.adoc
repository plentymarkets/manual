...
In this step, set whether you want to offer your customers the Parcelshop finder in your plentyShop.
...
[.instruction]
Displaying the DPD Parcelshop Finder in the checkout of your plentyShop:
