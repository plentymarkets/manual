...
In this step, set whether you want to offer your customers the Parcelshop finder in your Ceres online store.
...
In order that the Parcelshop finder works, it is also required that you enter your Google Maps API key.
...
If you ship internationally, enter in this step also the content of the shipment, select one of the international commercial terms (Incoterms) and determine which customs documents are to be sent.

If you want to send hazardous goods, enter a description here and select the type of packaging.
...
Go to the plugin’s *Container links* area and activate the following options to allow your customers to use the DPD Parcelshop Finder in the Ceres checkout.
...
. Select from the drop-down list *Ceres* on the right the option *Script loader: After scripts loaded*.
...
In order that the _Ident check_ service is available for your customers in the online store, you have to activate the following options in the plugin’s *Container links* menu.
...
. Select from the drop-down list *Ceres* on the right the option *Template: Styles*.
