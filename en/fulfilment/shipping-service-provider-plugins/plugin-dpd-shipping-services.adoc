...
Click on the button icon:toggle-off[role="red"] *Do you want to add further login details?* to add further login details.
...
Click on the button icon:toggle-off[role="red"] *Do you want to add another shipper address?* to add further shipper addresses. You can add up to 20 shipper addresses.
