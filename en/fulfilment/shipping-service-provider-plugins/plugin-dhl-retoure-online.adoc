...
In this step, determine how long the labels are available for download to your customers in your online store. _Assigned_ labels are those that have already been assigned to a return.
