...
* <<#download-shipping-labels, Downloading the shipping labels>>
...
* <<#download-export-labels, Downloading the export labels>>

[#display-order]
=== Displaying an order

If you open an order, you will see the following 4 areas in the detail view:
...
If the order has been successfully registered, the shipping label is visible in the *Packages* area. Click on *Download shipping labels* (icon:order_open[set=plenty]) to save the label(s) to your computer and print them.
