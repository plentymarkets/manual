...
If the return has been successfully registered, the return label is available in the *Returns* area of the order. Click on *Return label* (icon:order_open[set=plenty]) to save the label on your computer and print it afterwards.
