...
| *Payment method*
|Select a payment method or the option *All* to search for payments with this method. +
*_Note:_* The drop-down list shows all payment methods that are activated in your system. Go to Setup » Orders » Payment » Payment methods to see whether a payment method is activated.
