...
*_Note:_* The colour that you saved in the *Setup » Orders » Status* menu for the corresponding statuses will be shown in the overview in front of the order status. _Examples:_ icon:circle[role="red"] or icon:circle[role="green"].

| *Payment method*
|Select a payment method or the option *All* to search for orders with this payment method. +
*_Note:_* The drop-down list shows all payment methods that are active in your system. Go to *Setup » Orders » Payment » Methods* to see whether a payment method is activated.
