...
[WARNING]
.Difference between cancelling and resetting an order
======
...
→ A window opens and you need to confirm your decision. Note the reference in the box <<#difference-reset-cancel, Difference between cancelling and resetting an order>> at the beginning of this chapter.
...
→ A window opens and you need to confirm your decision. Note the reference in the box <<#difference-cancel-reset, Difference between cancelling and resetting an order>> at the beginning of this chapter.
. Confirm your decision by clicking on *Reset order*. +
→ The order is reset.
