...
|Outbound order undeliverable
|If the outbound order with this status is in your plentymarkets system, the outbound order could not be delivered. +
A reason for that might be an incorrect address.
