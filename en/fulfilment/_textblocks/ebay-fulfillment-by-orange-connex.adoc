...
A reason for that might be:

* the name of the street has too many characters

Log into the Orange Connex portal and correct the error to ensure that the order can be transmitted correctly.
