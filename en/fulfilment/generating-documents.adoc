...
| *Customer properties*
|Enter coordinates to position the customer properties. Select the <<crm/managing-contacts#950, property>> from the drop-down list. The text that was saved in the *CRM » Contacts* » _Open contact_ » *View: Properties* menu is displayed on the address labels.
