...
image::fulfillment/assets/DHL_Shipping_Plugin_kaufen.png[]
...
image::fulfillment/assets/DHL_Shipping_Plugin_installieren2.png[]
...
image::fulfillment/assets/DHL_Shipping_Plugin_bereitstellen_und_speichern.png[]
...
image::fulfilment/assets/DHL_Plugin_bereitstellen_error.png[]

.Plugin log
image::fulfillment/assets/DHL_Shipping_Plugin_Log_error.png[]
...
.Activating countries of delivery
image::fulfillment/assets/Lieferlaender_aktivieren.png[]
...
.Setting up regions
image::fulfillment/assets/Regionen_einrichten.png[]
...
.Creating a shipping service provider
image::fulfillment/assets/Versanddienstleister_erstellen.png[]
...
image::fulfillment/assets/Portotabelle_Berechnungstypen.png[]
...
.Plugin mode
image::fulfillment/assets/Plugin_Modus.png[]
