...
:position: 50
:url: fulfilment/best-practices-ups
:id: 6TD0IZW
...
[#50]
== How can I retrieve the API log?
...
_Translation: The region is not used in the shipping profile. Enter and save the price in order to use the region. Save and reload the table of shipping charges to create shipping service provider-specific settings._
