...
Create a new order status or select an existing order status for the following four reactions:
...
. Click on *Add*.
. Select the options *Belgium*, *Bulgaria*, *Germany*, *France*, *Greece*, *Ireland*, *Italy*, *Croatia*, *Luxembourg*, *Malta*, *Netherlands*, *Austria*, *Portugal*, *Romania*, *Slovakia*, *Slovenia*, *Spain*, *Czech Republic*, *Hungary*, *United Kingdom and Northern Ireland*, *Cyprus*.
