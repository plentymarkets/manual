...
You can find general information about imports via the import tool on the manual page <<data/importing-data/ElasticSync#, Using the import tool>>. The <<data/importing-data/sync-types/elasticSync-assignment-taric-code#, import types>> for importing taric codes can be found under *Assignment taric codes* .
