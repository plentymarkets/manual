...
|*Schwellenwert in Landeswährung (netto)*
|Für Lieferungen aus einem anderen Land nach Großbritannien kann hier ein Schwellenwert eingetragen werden. Der Schwellenwert gibt an, bis zu welchem Betrag (netto) der Auftrag in brutto und mit dem hinterlegten Steuersatz berechnet wird. Der hier eingetragene Schwellenwert bezieht sich auf den Nettowarenwert eines Auftrags, Versandkosten zählen nicht mit rein. Beachte also, dass der eingegebene Betrag netto ist. +
_Der Schwellenwert darf nicht für Lieferungen innerhalb Großbritanniens eingetragen werden._
