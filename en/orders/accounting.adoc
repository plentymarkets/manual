...
. Select a location under *System » System settings » Client (store) » Select store » Locations » Select location » Accounting*. +
→ The *Basic settings* tab will open.
...
. Go to **System » System settings » Item » Settings** and select the property for the option **Item property for identifying digital items**.
