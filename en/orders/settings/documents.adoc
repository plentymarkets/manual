...
|The wildcard characters will be replaced by the actual values that are saved in the <</#, **customer data** >>. Pay attention to the example for terms of payment on the <<orders/settings/documents#30., **New customer** >> page of the manual. +
