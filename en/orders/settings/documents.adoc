...
* **<<client-store/standard/documents/invoice#, Invoice  >>**
* <<client-store/standard/documents/adjustment-form#, **Adjustment form**  >>
* **Multi-invoice**
* **Delivery note**
* **Credit note**
* **Multi credit note**
...
* **Return label**
* <<client-store/standard/documents/entry-certificate#, **Entry certificate (Gelangensbestätigung)**  >>
...
* <<orders/settings/documents/reorder#, **Reorder**  >>
* link::/[**Address label**]
* <<orders/settings/documents/pick-list#, **Pick list**  >>
* <<orders/settings/documents/warehouse-pick-list#, **Warehouse pick list**  >>
* <<orders/settings/documents/packing-list#, **Packing list**  >>
...
When opening a template a few settings are already set by default. You can edit these settings and carry out additional settings. If no settings are filled in by default, you can **<<orders/settings/documents#150, apply settings from a default document template >>**. Furthermore, you can add notes that will be automatically included based on certain options and settings made. Create separate documents for each language. The language is selected at the top of the document menu.

image::orders/settings/assets/EN-Settings-Orders-Documents-01.png[]
...
For further information about generating the actual documents, e.g. an invoice, refer to the **<<orders/fulfillment#, Fulfilment  >>** page of the manual.
...
The margins are important for the automatic page break and the positioning of body text. They are also important for positioning the <<orders/settings/documents#170, **PDF templates** >>.
...
The document format is defined by the PDF template. The standard format for e.g. invoices is DIN A4 if no PDF template with another format is linked to the document template. For further information, refer to the <<orders/settings/documents#170, **PDF templates** >> chapter.
...
|**Referrer**
|The order's **<<orders/settings/order-referrer#, referrer  >>**, e.g. online store, eBay, API
...
image::orders/settings/assets/EN-Settings-Orders-Documents-02.png[]
...
image::orders/settings/assets/EN-Settings-Orders-Documents-03.png[]
...
image::orders/settings/assets/EN-Settings-Orders-Documents-04.png[]

__Image 4: barcode settings; optional elements__

image::orders/settings/assets/EN-Settings-Orders-Documents-05.png[]
...
image::orders/settings/assets/EN-Settings-Orders-Documents-06.png[]
...
image::orders/settings/assets/EN-Settings-Orders-Documents-07.png[]
...
image::orders/settings/assets/EN-Settings-Orders-Documents-08.png[]
...
image::orders/settings/assets/EN-Settings-Orders-Documents-09.png[]
...
image::orders/settings/assets/EN-Settings-Orders-Documents-10.png[]
...
image::orders/settings/assets/EN-Settings-Orders-Documents-11.png[ ]
...
image::orders/settings/assets/EN-Settings-Orders-Documents-12.png[ ]
...
The example below shows you how to specify numbering for <<client-store/standard/documents/invoice#, **invoices**  >>. Proceed the same way for other documents as well.

image::orders/settings/assets/EN-Settings-Orders-Documents-13.png[ ]
...
Once you have generated document templates, you can go to **<<orders/settings/event-procedures#, Settings » Orders » Event procedures  >>** and set automatic procedures. One option that you may find useful is to have variations booked out when invoices are printed. You can also define additional procedures here, e.g. automatically sending emails.
...
In order for these settings to take effect and to be displayed on the documents, you need to go to **<<client-store/standard/accounting#, Settings » Client (store) » Standard » Accounting » Tab: VAT rates  >>** and set the **margin scheme** to one of the four tax rates.
include::{includedir}/presets/draft-sina.adoc[]

image::orders/settings/assets/EN-Settings-Orders-Documents-14.png[ ]

__Image 14: carrying out the settings for margin scheme__

image::orders/settings/assets/EN-Settings-Orders-Documents-15.png[ ]
