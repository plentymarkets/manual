...
This page of the manual provides you with information about the settings, filters and procedures for event procedures. For further information about the menu structure, refer to the <<orders/settings/event-procedures#, **Event procedures**  >> page of the manual.
...
Once you have **<<orders/settings/event-procedures/new-event-procedure#, created  >>** an event procedure, the name and event will be displayed in the **settings** area and can be changed there.
...
image::orders/settings/event-procedures/assets/EN-Settings-Orders-Event-Procedures-Configuration-01.png[]

__Image 1: **filter** section__

==== Filter type: Order

The following filters can be used to select specific **<<orders/editing-sales-orders/changing-a-sales-order#, order  >>** characteristics:
...
For further information, refer to the <<orders/settings/event-procedures/configuration#1.3.1, **example configuration** >> in section 1.3.1.
...
For further information, refer to the <<orders/settings/event-procedures/configuration#1.3.3, **example configuration** >> in section 1.3.3.
...
**Amazon Prime** = Filters <<multi-channel/amazon#420, **Amazon Prime** >> orders. +
...
For further information, refer to the <<orders/settings/event-procedures/configuration#1.3.2, **example configuration** >> in section 1.3.2.
...
image::orders/settings/event-procedures/assets/EN-Settings-Orders-Event-Procedures-Configuration-02.png[]
...
image::orders/settings/event-procedures/assets/EN-Settings-Orders-Event-Procedures-Configuration-03.png[]
...
image::orders/settings/event-procedures/assets/EN-Settings-Orders-Event-Procedures-Configuration-04.png[]
...
image::orders/settings/event-procedures/assets/EN-Settings-Orders-Event-Procedures-Configuration-05.png[]
...
image::orders/settings/event-procedures/assets/EN-Settings-Orders-Event-Procedures-Configuration-06.png[]
...
|**Use order template**
|Go to <<orders/settings/sales-order-template#, **Settings » Orders » Order template**  >> to create order templates.

|**Generate delivery orders**
|Automatic generation of delivery orders when the specified event occurs. +
**Important**: This option will only be displayed if the <<orders/editing-sales-orders/delivery-order#, **warehouse configuration**  >> that is necessary for delivery orders has been set up correctly.
...
|Deletes an invoice that has the payment method **Klarna** when a cancellation occurs. For further information regarding this and other event procedures, refer to the <<orders/settings/event-procedures/configuration#5-3, **Klarna** >> page of the manual.

|**Notify Cdiscount of order changes**
|This procedure is used to notify the market <<orders/settings/event-procedures/configuration#7-2, **Cdiscount** >> of any order status changes.

|**Send "Order complete" to DaWanda**
|A procedure to inform the market DaWanda about completed orders. For further information regarding this and other event procedures, refer to the <<orders/settings/event-procedures/configuration#EAgreenBox, **DaWanda** >> page of the manual.
|====

__Table 7: overview procedure type: **Orders**__

Note the information regarding **<<orders/editing-sales-orders/delivery-order#, delivery orders  >>** if you want to change the status of main orders using event procedures for delivery orders.

==== Procedure type: Documents

In order for a document to be generated, i.e. to receive the desired configuration and the correct layout, it has to be configured in the corresponding menu and a template has to be saved. For further information, refer to the **<<orders/settings/documents#, Documents  >>** page of the manual.
...
|Automatic generation of an <<client-store/standard/documents/adjustment-form#, **adjustment form**  >> when the specified event occurs. +
...
image::orders/settings/event-procedures/assets/EN-Settings-Orders-Event-Procedures-Configuration-07.png[]
...
image::orders/settings/event-procedures/assets/EN-Settings-Orders-Event-Procedures-Configuration-08.png[]
...
image::orders/settings/event-procedures/assets/EN-Settings-Orders-Event-Procedures-Configuration-09.png[]
