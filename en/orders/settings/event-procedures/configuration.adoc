...
The following filters can be used to select specific **<</#, items >>** included in the orders:
...
The following filters can be used to select specific **<</#, customer data >>** included in the orders:
...
For further information, refer to the **<</#, New customer >>** page of the manual.
...
|Permission will be sent to **<</#, FBA >>** so that items are actually shipped by FBA.
...
For further information, refer to the <</#, **payment method** >> page of the manual.
|====
