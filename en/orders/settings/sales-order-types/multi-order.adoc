...
Go to **Settings » Orders » Order types » Multi-order** to configure the basic settings for **<<orders/multi-orders#, multi-orders  >>**. The settings in this menu are the basic settings for all multi-orders. For example, you can specify which order types and order statuses should be available for multi-orders.
