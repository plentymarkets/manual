...
Use the menu **System » System settings » Orders » Documents » Pick list** to determine which item data should be displayed on your pick lists, such as **Item ID**, **Manufacturers** or **Item price**. +
...
. Go to *System » System settings » Orders » Documents » Pick list*.
...
Free text fields have to be defined beforehand in the menu *System » System settings » Items » Free text fields*. After defining the free text fields, link them to their corresponding items and enter values vor the fields. This is done in the *Fields* tab of an item. +
...
[NOTE]
====
The link **Change PDF pick list** takes you to the settings in the menu **System » System settings » Orders » Documents » Pick list**, in which the document settings and the PDF template for the pick list are configured. The link **Change CSV pick list** takes you to a separate menu in which you can set up the columns that are displayed on a pick list generated in CSV format.
====
