...
Use the options **Show** or **Do not show** in the menu **System » System settings » Orders » Documents » Packing list** to determine which item data should be displayed on your packing lists, such as **Item ID**, **Quantity** or **Item image**. +
...
====
In plentymarkets, the following data is displayed by default on the packing list. Thus, it is not affected by the settings carried out in the menu **System » System settings » Orders » Documents » Packing list**:
...
. Go to **System » System settings » Orders » Documents » Packing list**.
...
After having carried out the settings according to <<table-options-packing-list>> , you can determine which orders should be included in the packing list in the menu **Orders » Fulfilment**. In this menu, a **Search filter** allows you to select the orders and to determine how they are sorted on the packing list.
...
[WARNING]
====
The link **Change packing list** takes you to the settings in the menu **System » System settings » Orders » Documents » Packing list**, in which the document settings and the PDF template for the packing list are configured.
