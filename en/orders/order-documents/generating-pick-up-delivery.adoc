...
:id: H3CIPCV
:keywords: pick-up delivery, pick-up, pick-up/delivery note, delivery note, shipping, order, order documents, working with documents working with orders, order process, order workflow, delivery, document template, template, client, location, order, number, document number, receipt, document type, document, PDF, PDF template, PDF file
...
Before generating the document pick-up delivery, you have to set up a document template. Go to *Setup » Client » _Select client_ » Locations » _Select location_ » Documents » Pick-up/Delivery note* to set up the template. +
