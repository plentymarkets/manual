...
Before generating invoices, you have to set up a document template. This is done in the menu **System » System settings » Client » Select client » Locations » Select location » Documents**. +
