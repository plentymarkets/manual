...
:id: I75PCMI
:keywords: Invoice, Generating invoices, PDF template, Fulfilment, Fulfillment, Order documents, Order processing, file, PDF, fulfillment, fullfilment, location, document, document number, delivery country, data, template, document template, client, limit, invoice date, billing, payment due date, payment date, outgoing items
...
Before generating invoices, you have to set up a document template. Go to *Setup » Client » _Select client_ » Locations » _Select location_ » Invoice* to set up these documents. +
