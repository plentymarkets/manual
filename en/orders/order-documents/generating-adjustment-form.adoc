...
:id: U8ZHVGR
:keywords: adjustment form, generating adjustment form, creating adjustment form, order documents, order processing, document template, template, client, location, credit order, credit note order, receipt, number, document number, document type, document, PDF, PDF-file, PDF file
...
Before generating adjustment forms, you have to set up a document template. Go to *Setup » Client » _Select client_ » Locations » _Select location_ » Documents » Adjustment form* to set up the template. +
