...
:id: BMIJQGV
:keywords: offer, offers, generate offer, order document, document template, template, document, client, location, document number, receipt, document type, PDF, PDF template, PDF file
...
Before generating offers, you have to set up a document template. Go to *Setup » Client » _Select client_ » Locations » _Select location_ » Documents » Offer* to set up the template. +
...
. Select the *event* listed in <<table-event-procedure-sending-offer-document>>.
. *Save* (icon:save[role="green"]) the settings.
. Carry out further settings as described in <<table-event-procedure-sending-offer-document>>.
. Place a check mark next to the option *Active*.
. *Save* (icon:save[role="green"]) the settings.
--

[[table-event-procedure-sending-offer-document]]
.Setting up event action “Sending offer document as PDF”
[cols="1,3,3"]
|====
