...
:position: 80
:url: orders/order-documents/generating-en-entry-certificate-gelangensbestaetigung
...
Before generating entry certificates, you have to set up a document template. This is done in the menu **System » System settings » Client » Select client » Locations » Select location » Documents**. +
