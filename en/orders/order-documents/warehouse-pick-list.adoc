...
The link *Change warehouse pick list* in the warehouse pick list menu takes you to the settings in the menu *System » Orders » Documents » <<orders/order-documents/warehouse-pick-list#, warehouse pick list>>*, in which the document settings and the PDF template for the warehouse pick list are configured.
