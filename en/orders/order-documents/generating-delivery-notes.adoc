...
Before generating delivery notes, you have to set up a document template. This is done in the menu *Setup » Client » _Select client_ » Locations » _Select location_ » Documents » Delivery note*. +
