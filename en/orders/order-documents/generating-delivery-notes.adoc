...
:id: 7W56HLU
:keywords: Delivery note, Generating delivery notes, Delivery, PDF template, Fulfilment, Order Documents, Order processing, fulfillment, file, document, receipt, receipts, incoming items, order date, list of items, quantity, quantities, client, location, number, document number, delivery, deliveries, shipping date, limit
...
Before generating delivery notes, you have to set up a document template. This is done in the menu **Setup » Client » Select client » Locations » Select location » Documents**. +
