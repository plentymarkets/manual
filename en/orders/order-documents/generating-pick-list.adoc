...
| *Sorting*
|In the drop-down list, select the method for sorting the items on the pick list. The options *Item ID*, *Item number*, *Storage location position* and *Standard category’s name from the main store (first level only)* are available.
