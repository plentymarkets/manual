...
**Important:** Variable users can only select those clients that they have a right to access. Variable users are given rights under <</#, **Settings » Basic settings » User » Accounts » Tab: Right** >>.
|====
...
This tab includes the same menus that are available when you access data for a particular customer within the <</#, **Customers** >> menu. Changes that you make here will also go into effect for the particular customer within the **Customers** menu.
