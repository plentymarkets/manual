...
====
Note thate the Scheduler is only for the Callisto webshop. To bet more information about the new subscription function for manual orders, go to <<orders/subscription#, manual page Subscription>>.
====
