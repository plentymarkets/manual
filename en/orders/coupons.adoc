...
| [#intable-coupon-type]*Coupon type*
...
Use the import tool in the *Data » Import* menu to import <<data/importing-data/sync-types/elasticSync-coupon-codes#, coupon codes>>. This allows you to import large quantities of coupon codes at once rather than to enter them manually one after the other. To do so, crate an import of the type *Coupon code*.
