...
[TIP]
To save an individual text, the customer has to change the item in the *My account* area of the online shop by clicking on *Change*. Write a short note in the description of the coupon item to inform your customers. +
...
. Open the *Order history* in the *My account* area of the plentyShop.
