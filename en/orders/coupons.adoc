...
[#generate-coupon]
=== Generating coupons (from Ceres version 5)
...
Note that you can use this function starting from link:https://marketplace.plentymarkets.com/en/ceres_4697[Ceres^]{nbsp}icon:external-link[] version *5*.
...
. Log into the Ceres online store.
. Open the *Order history* in the *My account* area of the Ceres online store.
