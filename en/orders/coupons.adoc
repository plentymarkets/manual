...
Use the data format **<<basics/data-exchange/export-import/data-formats/campaigncoupon#, CampaignCoupon>>** to quickly **<<basics/data-exchange/export-import/exporting-data#, export>>**, edit and **<<basics/data-exchange/export-import/importing-data#, import>>** coupon codes.
