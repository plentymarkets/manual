...
Check the <</#, **access data** >> if the email was not sent correctly. Go to <<data-exchange/api-log#, **Data exchange » API log**  >> and use the **E-Mail** process to see the corresponding error messages.
...
The **Customer** tab displays information about the <</#, **customer** >>. You can edit this information directly without having to switch to the customer's data record.
