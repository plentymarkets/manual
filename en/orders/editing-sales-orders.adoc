...
image::orders/assets/EN-Orders-Editing-Orders-Changing-Order-01.png[]
...
image::orders/assets/EN-Orders-Editing-Orders-Changing-Order-02.png[]
...
- If the user is not <<orders/editing-sales-orders#90, **authorised** >> to delete orders +
...
image::orders/assets/EN-Orders-Editing-Orders-Changing-Order-03.png[]
...
Check the link::/[**access data**] if the email was not sent correctly. Go to <<data-exchange/api-log#, **Data exchange » API log**  >> and use the **E-Mail** process to see the corresponding error messages.
...
image::orders/assets/EN-Orders-Editing-Orders-Changing-Order-04.png[]

__Image 4: the **Payment** tab of an order__

For further information about manually booking payments, refer to the <<orders/editing-sales-orders#100, **Editing payments** >> page of the manual.

[#70]
== Tab: Receipts

You can create receipts in the **Receipts** tab, e.g. an order confirmation, a delivery note or an invoice. The documents are created with the help of document templates that are saved under **<<orders/settings/documents#, Settings » Orders » Documents  >>**. Check to make sure that you created the document templates before you create receipts. Check this as well if you receive an error message.
...
image::orders/assets/EN-Orders-Editing-Orders-Changing-Order-05.png[]
...
image::orders/assets/EN-Orders-Editing-Orders-Changing-Order-06.png[]
...
image::orders/assets/EN-Orders-Editing-Orders-Changing-Order-07.png[]
...
image::orders/assets/EN-Orders-Editing-Orders-Changing-Order-08.png[]
...
image::orders/assets/EN-Orders-Editing-Orders-Changing-Order-09.png[]
...
image::orders/assets/EN-Orders-Editing-Orders-Changing-Order-10.png[]
...
<<orders/settings/sales-order-types/delivery-orders#, **Delivery orders**  >> are created in the **Delivery** tab. There you can see the order's stock units, which were not yet carried over into delivery orders.

image::orders/assets/EN-Orders-Editing-Orders-Changing-Order-11.png[]
...
====
The group function can only be used for the orders that are displayed in the overview. Up to a maximum of 400 orders. Use the dynamic <<data-exchange#, **data exchange**  >> if you want to edit a larger number of orders or if you want to edit all orders at the same time.
====

image::orders/assets/EN-Orders-Editing-Orders-Changing-Order-12.png[]
