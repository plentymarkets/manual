...
| Select from the drop-down list what happens with the original order after it is <<orders/managing-orders#intable-splitting-orders, split>> into 2 new orders. +
