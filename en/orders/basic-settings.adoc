...
|Select which status should automatically be set for *<<order-processing/orders/managing-orders#850, multi credit notes>>*.
...
Variable users also need to be given the right to edit orders. Go to *System » Settings » User » Accounts* and open the particular user account. Then click on *<<basics/working-with-plentymarkets/manage-users#90, Tab: Right » Tab: Menu » Area: Orders>>*.
