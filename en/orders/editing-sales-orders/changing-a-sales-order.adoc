...
If a package number was saved, then the **preview icon** can be used for tracking the package. However, this can only be done if a corresponding tracking code was saved under <</#, **Settings » Orders » Shipping » Shipping options » Tab: Shipping service provider** >>. Otherwise the preview icon will not be visible.
|====
