...
Go to <<orders/settings/sales-order-types/return#, **Settings » Orders » Order types » Return**  >> and edit the basic settings for returns before creating an actual return. The reasons for return and the item status for returned items are configured there. You have to create these reasons and statuses so that they can be used when configuring a return. Go to <<orders/settings/basic-settings#, **Settings » Orders » Basic settings**  >> and check the standard status of returns. Change this setting if necessary.
...
image::orders/editing-sales-orders/assets/EN-Orders-Edit-Orders-Return-01.png[]
...
. Go to **<<orders/editing-sales-orders#, Orders » Edit orders  >>**.
...
image::orders/editing-sales-orders/assets/EN-Orders-Edit-Orders-Return-02.png[]
...
|**Status**
|The standard status as defined in the **<<orders/settings/basic-settings#, Basic settings  >>** menu. This status can be changed if needed.

|**Reason for return**
|Select the reason for return. +
For further information about configuring the reasons for returns, refer to the **<<orders/settings/sales-order-types/return#, Return  >>** page of the manual.
...
image::orders/editing-sales-orders/assets/EN-Orders-Edit-Orders-Return-03.png[]
...
For further information about the **item status**, refer to the **<<orders/settings/sales-order-types/return#, Return  >>** page of the manual.
...
The document **Return label** can be created for returns. You have to create the document template **Return label** before you will be able to generate return labels. Go to <<orders/settings/documents#, **Settings » Orders » Documents**  >> to set up this document template.
...
image::orders/editing-sales-orders/assets/EN-Orders-Edit-Orders-Return-04.png[]
...
image::orders/editing-sales-orders/assets/EN-Orders-Edit-Orders-Return-05.png[]
