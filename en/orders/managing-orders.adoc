...
. Select the option *New delivery address* from the dropdown-list *Delivery address*. +
→ The overlay *New delivery address* opens.
. Select if this is a *Primary* address.
. Enter the data. Note <<table-new-delivery-address>>.
. Save (icon:save[role="green"]) the new address.
