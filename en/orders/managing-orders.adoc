...
_Note_ that created documents cannot be deleted. For some receipts, for example invoices or dunning letters, reversal documents can be created. But all documents are stored in the *Receipts* tab once they are created. +
