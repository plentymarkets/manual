...
Moreover, you can enter on or more coupon codes in the *Coupon codes* field to redeem these with this order. Enter a coupon code and press _enter_. It is immediately checked if the coupon is redeemable. Redeemable coupons turn green and display the value of the coupon. Irredeemable coupon codes turn red and display *Not redeemable* instead of the entered code. Repeat this with more coupon codes, if needed. +
