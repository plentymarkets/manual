...
When you set the table once, these settings are saved. The table remains like this even when you finalised this order and are creating a new one. Changes to the layout can be made at any time. A list of the available columns can be found in <<table-overview-item-search>>.
