...
Below the order details, a table with the added order items is displayed. In addition to the information given in the previous adding items view, the prices and the VAT rate are shown. The prices can be edited as long as the order is not completed.
