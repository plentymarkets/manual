...
|*Type of shopping cart used in order creation*
|Select which type of shopping cart you want to use in the order creation. The side cart is selected by default. +
*Side cart* = The shopping cart is displayed as an overlay on the right when you open ist. +
*Shopping cart table* = The shopping cart is displayed as a table underneath the item table.
