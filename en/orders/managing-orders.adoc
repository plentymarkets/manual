...
In the order details, the *Shipping method* and the *Shipping costs* can be adapted if required. Apart from the addresses, the currency and the warehouse setting, the order details are editable.
...
Moreover, you can adapt the *Description* in this table. The adapted item description is only taken over for this individual order. This means that the changed description is added to the order data and also the order documents of this particular order. Apart from this order, the item description already saved in the system persists. There is a restriction for the *Description* of 1.500 characters.
