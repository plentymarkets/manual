...
By default, *None* is selected. If you select an order template as default and this template is then deleted at any time, *None* will be set again for this setting.
