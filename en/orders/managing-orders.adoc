...
This chapter describes how to create an order or an offer in the contact overview in the *CRM » Contacts* menu. This is a new user interface which will be a _beta_ integration at first. All other ways to create orders remain unaffected by this and can still be used.
