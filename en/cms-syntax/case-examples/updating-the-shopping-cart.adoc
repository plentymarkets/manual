...
* **<<cms-syntax/case-examples/updating-the-shopping-cart#checkout/basketitemslist, POST /rest/checkout/basketitemslist/ >>**
* **<<cms-syntax/case-examples/updating-the-shopping-cart#checkout/basketitemslist, GET /rest/checkout/basketitemslist/ >>**
* **<<cms-syntax/case-examples/updating-the-shopping-cart#itemview/container_itemviewbasketpreviewlist, GET /rest/itemview/container_itemviewbasketpreviewlist/ >>**
