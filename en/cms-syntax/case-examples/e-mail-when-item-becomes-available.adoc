...
First, create an **<<cms-syntax/email/email#, e-mail template  >>**. Once the item is back in stock, this e-mail will be sent to all of the customers who saved their e-mail addresses. Below, you will find a list of template variables and template functions that can be used for this e-mail template. We also provide you with an example text, which you can customize as needed.
...
.  Create a new **<<cms-syntax/email/email#, e-mail template  >>** in HTML format.
