...
image::cms-syntax/case-examples/assets/EN-CMS-Displaying-Item-Variants-Dynamically-01.png[]
...
====
Go to **<<client-store/standard/item-layouts/basic-settings#, Settings » Client (store) » Standard » Item layouts » Basic settings  >>** in order to deactivate the display of surcharges. Choose the setting **Do not show** for the option **Attribute surcharge**.
====
...
Now activate the **<<client-store/standard/item-layouts/basic-settings#, client check  >>** in order to display the attribute images dynamically.
...
image::cms-syntax/case-examples/assets/EN-CMS-Displaying-Item-Variants-Dynamically-02.png[]
...
Go to **CMS » Web design » Layout » CSS » CSSContent** and insert the following <<cms/web-design/editing-the-web-design/css#, **CSS code**  >> at the end of any previously existing code. Be sure to save a copy of the previously existing code before you insert the following code.
