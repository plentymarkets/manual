...
[source,plenty]
----
include::assets/EX-EN-operator-var-one-line.html[]
...
[source,plenty]
----
include::assets/EX-EN-operator-var-multi-line.html[]
...
[source,plenty]
----
include::assets/EX-EN-operator-logical.html[]
...
[source,plenty]
----
include::assets/EX-EN-operator-concatenate.html[]

----
== Operator precedence

The operator precedence determines how an operator connects two expressions. Thus, the result of the expression __1 + 5 * 3__ equals __16__ and not __18__ because the multiplication operator (*) precedes the addition operator (+). You can use brackets to influence operator precedence. Thus, __(1 + 5) * 3__ equals __18__. If operators have equal priority, associativity from left to right is used.
