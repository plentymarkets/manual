...
for loops can be applied by defining a counter variable and a number range. Alternatively, an iteration can be performed through an **<<cms-syntax/basics/types#6, array >>**.
