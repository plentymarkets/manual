...
. Go to *Setup » Settings » User » Rights » User » _select user_ » tab: Views*. +
*_Tip:_* You can also directly access the rights management from the editing mode of a view. To do so, click on *Rights management » User rights* underneath the settings. +
→ The overview opens.
...
. Go to *Setup » Settings » User » Rights » Roles*. +
*_Tip:_* You can also directly access the rights management from the editing mode of a view. To do so, click on *Rights management » Role rights* underneath the settings. +
→ The overview opens.
