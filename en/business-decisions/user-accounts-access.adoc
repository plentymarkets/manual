...
| *Back end*
|Access with individual rights for <<business-decisions/user-accounts-access#100, menus>> and <<business-decisions/user-accounts-access#110, functions>> that can be assigned in the *Rights* tab.

| *REST API*
|Access for <<business-decisions/user-accounts-access#120, REST calls>> that can be assigned in the user account. REST calls are activated individually. REST calls are not assigned to user accounts by default. +
