...
In the menu *Setup » Settings » User » Security*, you manage the criteria for new passwords entered by users. Proceed as follows to activate the criteria.
...
. Carry out the additional settings. Pay attention to the information given in <<table-email-addressses>>.
. Click on *Create mailbox*. +
