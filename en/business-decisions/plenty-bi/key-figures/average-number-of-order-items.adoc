...
In addition, select a <<business-decisions/business-intelligence/plenty-bi/key-figures/average-number-of-order-items#100, dimension>> to determine how the result is grouped.
Set <<business-decisions/business-intelligence/plenty-bi/key-figures/average-number-of-order-items#200, filters>> to specify the criteria for the calculation of the average number of order items.
