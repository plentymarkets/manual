...
* determine the number of logged changes in the <<data/change-history#200, live search>> or <<data/change-history#1000, archive>>.
* see how often someone requested an <<data/change-history#1000, archive file>> for a fee.
