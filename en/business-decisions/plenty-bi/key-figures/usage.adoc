...
So you can use the key figure without having first booked a plentyBI tariff.

However, note that _other functions and key figures_ cost money in the plentyBI tool.
Simply choose the right plentyBI-tariff with the help of the plentymarkets configurator.
