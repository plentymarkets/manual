...
In addition, select a <<business-decisions/plenty-bi/key-figures/orders#100, dimension>> to determine how the result is grouped.
Set <<business-decisions/plenty-bi/key-figures/orders#200, filters>> to specify the criteria for the calculation of the orders.
