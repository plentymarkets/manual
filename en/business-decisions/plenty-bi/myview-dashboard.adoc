...
| *Title*
| Enter an appropriate title for the tile. The title is displayed as name on the tile. Click on (icon:eye[role="lightGrey"]) if no title should be displayed on the tile.
...
| *Title*
| Enter an appropriate title. The title will be displayed as the name within the row. Click on (icon:eye[role="lightGrey"]) if no title should be displayed on the tile.
...
| *Title*
| Enter an appropriate title. The title is displayed as name on the gauge chart. Click on (icon:eye[role="lightGrey"]) if no title should be displayed on the tile.
