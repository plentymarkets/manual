...
====
As a logged in user, you can easily see which dashboard views you can access and quickly switch between them. In the *plentymarkets logo (Start) » Dashboard (Beta)* menu, click on the menu icon icon:bars[role="darkGrey"]. A list of dashboard views that have been made visible to you opens. Click on a dashboard view to open it. The currently opened dashboard view is displayed in blue on the list.
====
...
| *Shortcut type*
|Select what should happen when clicking on the button. At the moment, only the option *Open link* is available.

| *Link*
|Enter a link that should be opened when clicking on the button. There are 2 possibilities for entering links: +
