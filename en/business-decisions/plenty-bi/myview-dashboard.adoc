...
====
To create key figures, you need to book a corresponding plentyBI edition. Go to *plentymarkets logo (Start) » My account » Contracts*. Different plentyBI editions with varying scopes are available in the *Book plentyBI edition* section. In addition, edition information is displayed for each key figure in the *Setup » plentyBI » Key figures* menu.
====
