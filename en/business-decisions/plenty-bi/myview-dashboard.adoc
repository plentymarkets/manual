...
====
The *Global time interval* element can only be added to a dashboard once. Thus, we recommend that you place the element in a position that is easy to see. In most cases, placing the element at the very top of the dashboard, above all other elements, is the best solution.
====
