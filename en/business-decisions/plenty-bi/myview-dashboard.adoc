...
| Select the key figure you want to create. For further information, refer to the <<business-decisions/plenty-bi/key-figures#, Key figures>> page of the manual.
...
====
For a post to be displayed on your dashboard, the creator of the post needs to use the *important* tag or pin it globally within the forum. If there are other modules that you would like to stay up-to-date with, make sure to subscribe to the respective category in the forum as well.
====