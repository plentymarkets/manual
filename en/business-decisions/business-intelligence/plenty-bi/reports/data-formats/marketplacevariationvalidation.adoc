...
:keywords: marketplaceVariationValidation, variationValidation, Report, raw data
:position: 300
:url: business-decisions/business-intelligence/reports/data-formats/marketplacevariationvalidation
:id: 63SM45X
:author: team-multi-channel

:dataFormat: pass:quotes[*marketplaceVariationValidation*]
...
:specifications: <<tabelle-spezifikationen-marketplaceVariationValidation>>
:dataColumns: <<tabelle-datenspalten-marketplaceVariationValidation>>
...
[[table-specifications-marketplaceVariationValidation]]
.Technical specifications of the format *marketplaceVariationValidation*
[cols=4]
|====
...
File name: *marketplaceVariationValidation-xxx.csv.gz*
...
[[table-data-columns-marketplaceVariationValidation]]
.Data columns of the format *marketplaceVariationValidation*
[cols="1,3,3,3"]
|====
