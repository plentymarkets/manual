...
:keywords: variationValidation, report, raw data
:position: 300
:url: business-decisions/business-intelligence/reports/data-formats/variationvalidation
:id: 63SM45X
:author: team-multi-channel

:dataFormat: pass:quotes[*variationValidation*]
:daten: information on variations that do not comply with the rules of specific markets. You can export the results of the validation
:specifications: <<tabelle-spezifikationen-variationvalidation>>
:dataColumns: <<tabelle-datenspalten-variationvalidation>>
