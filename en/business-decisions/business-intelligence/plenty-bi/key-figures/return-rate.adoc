...
:position: 70
:url: business-decisions/business-intelligence/plenty-bi/key-figures/return-rate
:id: O7KBCB0
...
plentymarkets calculates the key figure *Return rate* by dividing the number of credit notes and returns by the number of all the order types except credit notes and returns.
...
By choosing a <<business-decisions/business-intelligence/plenty-bi/key-figures/return-rate#100, calculation type>>, you decide whether to calculate the return rate or the return rate amount.
In addition, select a <<business-decisions/business-intelligence/plenty-bi/key-figures/return-rate#200, dimension>> to determine how the result is grouped.
Set <<business-decisions/business-intelligence/plenty-bi/key-figures/return-rate#300, filters>> to specify the criteria for the calculation of the return rate.
...
:key-figure: Return rate
:this-means: This way, you can see at a glance how the return rate is broken down by invoice country. A further differentiation is made according to the creation date of the orders.
...
:key-figure: Return rate
:this-means: This way, you can see at a glance how the return rate is broken down by delivery country. A further differentiation is made according to the creation date of the orders.
...
:key-figure: Return rate
:this-means: This way, you can see at a glance how the return rate is broken down by order referrer. A further differentiation is made according to the creation date of the orders.
...
:key-figure: Return rate
:this-means: This way, you can see at a glance how the return rate is broken down by item category. A further differentiation is made according to the creation date of the orders.
...
:key-figure: Return rate
:this-means: This way, you can see at a glance how the return rate is broken down by warehouse. A further differentiation is made according to the creation date of the orders.
...
:key-figure: Return rate
:this-means: This way, you can see at a glance how the return rate is broken down by client. A further differentiation is made according to the creation date of the orders.
...
:key-figure: Return rate
:this-means: This way, you can see at a glance how the return rate is broken down by manufacturer. A further differentiation is made according to the creation date of the orders.
...
:key-figure: Return rate
:this-means: This way, you can see at a glance how the return rate is broken down by return reasons. A further differentiation is made according to the creation date of the orders.
...
:key-figure: Return rate
:this-means: This way, you can see at a glance how the return rate is broken down by payment method. A further differentiation is made according to the creation date of the orders.
...
:key-figure: Return rate
:this-means: This way, you can see at a glance how the return rate is broken down by order referrer. A further differentiation is made according to the date on which a payment was assigned to the order.

include::../../../_textblocks/plentyBI-dimensions/order-referrer-payment-date.adoc[]

=== Warehouse, payment date

:kennzahl: Return rate
:this-means: This way, you can see at a glance how the return rate is broken down by warehouse. A further differentiation is made according to the date on which a payment was assigned to the order.
...
:key-figure: Return rate
:this-means: This way, you can see at a glance how the return rate is broken down by client. A further differentiation is made according to the date on which a payment was assigned to the order.
...
:key-figure: Return rate
:this-means: This way, you can see at a glance how the return rate is broken down by order referrer. A further differentiation is made according to the date on which the order items of an order were shipped.
...
:key-figure: Return rate
:this-means: This way, you can see at a glance how the return rate is broken down by warehouse. A further differentiation is made according to the date on which the order items of an order were shipped.
...
:key-figure: Return rate
:this-means: This way, you can see at a glance hhow the return rate is broken down by client. A further differentiation is made according to the date on which the order items of an order were shipped.
...
:commas: Use commas to separate values when you enter more than one.
...
:commas: Use commas to separate item IDs when you enter more than one.
...
:commas: Use commas to separate the accounts when you enter more than one.
