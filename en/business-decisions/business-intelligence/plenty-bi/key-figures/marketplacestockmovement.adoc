...
:keywords: marketplaceStockInformation, Business Intelligence, statistics, key figure, key figures, dashboard, raw data, report, reports, KPI, KPIs, Key Performance Indicator
:position: 400
:url: business-decisions/business-intelligence/plenty-bi/key-figures/marketplacestockinformation
:id: PN8W53U
