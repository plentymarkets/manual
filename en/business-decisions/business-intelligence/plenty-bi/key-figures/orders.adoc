...
:position: 200
:url: business-decisions/business-intelligence/plenty-bi/key-figures/orders
:id: D2IR751
...
plentymarkets calculates the key figure *Orders* by summing up the orders: +
_∑ Orders = Quantity of orders_ +
In addition, select a <<business-decisions/business-intelligence/plenty-bi/key-figures/orders#100, dimension>> to determine how the result is grouped.
Set <<business-decisions/business-intelligence/plenty-bi/key-figures/orders#200, filters>> to specify the criteria for the calculation of the orders.
...
:key-figure: The key figure Orders
:this-means: This way, you can see at a glance how many orders are generated broken down by delivery country. A further differentiation is made according to the creation date of the orders.
...
:kennzahl: The key figure Orders
...
:key-figure: The key figure Orders
:this-means: This way, you can see at a glance how many orders are generated broken down by order referrer. A further differentiation is made according to the date on which the order items of an order were shipped.
...
:key-figure: The key figure Orders
:this-means: This way, you can see at a glance how many orders are generated broken down by warehouse. A further differentiation is made according to the date on which the order items of an order were shipped.
...
:key-figure: The key figure Orders
:this-means: This way, you can see at a glance how many orders are generated broken down by client. A further differentiation is made according to the date on which the order items of an order were shipped.
