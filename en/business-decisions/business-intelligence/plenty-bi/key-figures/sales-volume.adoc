...
:position: 20
:url: business-decisions/business-intelligence/plenty-bi/key-figures/sales-volume
:id: MSSWL41
...
By choosing a <<business-decisions/business-intelligence/plenty-bi/key-figures/sales-volume#100, calculation type>>, you decide whether to calculate with gross sales volume or the net sales volume.
In addition, select a <<business-decisions/business-intelligence/plenty-bi/key-figures/sales-volume#200, dimension>> to determine how the result is grouped.
Set <<business-decisions/business-intelligence/plenty-bi/key-figures/sales-volume#300, filters>> to specify the criteria for the calculation of the sales volume.
...
:key-figure: Sales volume
:this-means: This way, you can see at a glance how many items are sold broken down by which payment method. A further differentiation is made according to the creation date of the orders.
