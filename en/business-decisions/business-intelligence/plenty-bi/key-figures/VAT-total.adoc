...
:position: 90
:url: business-decisions/business-intelligence/plenty-bi/key-figures/VAT-total
:id: W464CF4
...
In addition, select a <<business-decisions/business-intelligence/plenty-bi/key-figures/VAT-total#100, dimension>> to determine how the result is grouped.
Set <<business-decisions/business-intelligence/plenty-bi/key-figures/VAT-total#200, filters>> to specify the criteria for the calculation of the VAT total.
