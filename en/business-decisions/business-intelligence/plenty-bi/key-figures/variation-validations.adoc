...
:keywords: variationValidation, Business Intelligence, statistics, key figure, key figures, dashboard, raw data, report, reports, KPI, KPIs, Key Performance Indicator
:position: 1000
:url: business-decisions/business-intelligence/plenty-bi/key-figures/variationvalidations
:id: DACE7WJ
:author: team-multi-channel

:key-figure: variation validations

The key figure *{key-figure}* allows you to check if the variation data of a catalogue complies to the rules of specific markets.

You can currently validate if the variations complies to the rules of the following markets:
...
[IMPORTANT]
.The variation validation is new!
====
Variation validation is a new feature. We are working on offering you a wider range of functionality for the validation.
====
...
include::../../../_textblocks/plentyBI-filters/key.adoc[]
...
* <<business-decisions/business-intelligence/reports/data-formats/variationvalidation#, variationValidation>>
