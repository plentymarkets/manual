...
:position: 300
:url: business-decisions/business-intelligence/plenty-bi/key-figures/orders-live
:id: DXR4I10
...
In addition, select a <<business-decisions/business-intelligence/plenty-bi/key-figures/orders-live#200, dimension>> to determine how the result is grouped.
Set <<business-decisions/business-intelligence/plenty-bi/key-figures/orders-live#300, filters>> to specify the criteria for the calculation of the orders.
