...
:keywords: marketplaceVariationValidation, variationValidation, Business Intelligence, statistics, key figure, key figures, dashboard, raw data, report, reports, KPI, KPIs, Key Performance Indicator
:position: 100
:url: business-decisions/business-intelligence/plenty-bi/key-figures/marketplacevariationvalidations
:id: DACE7WJ
...
:kommas: Use commas to enter more than one value.
