...
:position: 10
:url: business-decisions/business-intelligence/plenty-bi/key-figures/average-number-of-order-items
:id: E5VUVYW
...
This result is then divided by the quantity of the orders: +
_(∑ Order items) : Order quantity = ø Number of order items_ +
In addition, select a <<business-decisions/business-intelligence/plenty-bi/key-figures/revenue#200, dimension>> to determine how the result is grouped.
Set <<business-decisions/business-intelligence/plenty-bi/key-figures/revenue#300, filters>> to specify the criteria for the calculation of the average nu,ber of order items.
...
:key-figure: The average number of order items
:this-means: This way, you can see at a glance how many order items are sold on average by which order referrer. A further differentiation is made according to the creation date of the orders.
...
:key-figure: The average number of order items
:this-means: This way, you can see at a glance how many order items are sold on average by which item category. A further differentiation is made according to the creation date of the orders.
...
:key-figure: The average number of order items
:this-means: This way, you can see at a glance how many order items are sold on average by which warehouse. A further differentiation is made according to the creation date of the orders.
...
:key-figure: The average number of order items
:this-means: This way, you can see at a glance how many order items are sold on average by which client. A further differentiation is made according to the creation date of the orders.

include::../../../_textblocks/plentyBI-dimensions/client-creation-date.adoc[]

=== Manufacturer, creation date

:key-figure: The average number of order itemse
:this-means: This way, you can see at a glance how many order items are sold on average by which manufacturer. A further differentiation is made according to the creation date of the orders.
...
:key-figure: The average number of order items
:this-means: This way, you can see at a glance how many order items are sold on average grouped by return reasons. A further differentiation is made according to the creation date of the orders.
...
:key-figure: The average number of order items
:this-means: This way, you can see at a glance how many order items are sold on average by which payment method. A further differentiation is made according to the creation date of the orders.
...
:key-figure: The average number of order items
:this-means: This way, you can see at a glance how many order items are sold on average by which order referrer. A further differentiation is made according to the date on which a payment was assigned to the order.

include::../../../_textblocks/plentyBI-dimensions/order-referrer-payment-date.adoc[]

=== Warehouse, payment date

:kennzahl: The average number of order items
:this-means: This way, you can see at a glance how many order items are sold on average by which warehouse. A further differentiation is made according to the date on which a payment was assigned to the order.
...
:key-figure: The average number of order items
:this-means: This way, you can see at a glance how many order items are sold on average by which client. A further differentiation is made according to the date on which a payment was assigned to the order.
...
:key-figure: The average number of order items
:this-means: This way, you can see at a glance how many order items are sold on average by which order referrer. A further differentiation is made according to the date on which the order items of an order were shipped.
