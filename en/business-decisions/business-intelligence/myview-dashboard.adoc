...
* <<business-decisions/business-intelligence/plenty-bi/key-figures/marketplace-stock-movements#, Marketplace stock movements>>
...
| Resets the dasboard to the state that was last saved.
