...
:position: 20
:url: business-decisions/business-intelligence/statistics
:id: MSLDK1U
:author: none

//add this url weiterleitung /en/basics/working-with-plentymarkets/statistics/managing-statistics/;/en/business-decisions/business-intelligence/statistics/;301;L
...
Statistics are grouped in tabs in the **plentymarkets Logo (Start) » Statistics** menu. You can create up to 4 statistics per tab. Note that clicking on the tab's **X** deletes the tab instead of merely closing it. Proceed as described below to create a statistic. Table 10 shows the available options in the Tab view.

[.instruction]
Creating a statistic:

. Go to **plentymarkets Logo (Start) » Statistic**.
. Select the **tab**.
