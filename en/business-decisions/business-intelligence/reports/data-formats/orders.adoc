...
:position: 130
:url: business-decisions/business-intelligence/reports/data-formats/orders
:id: KGCWSW7
...
|order status
|Status of the order in decimal format. Depending on the statuses set up in the system, numbers with up to 4 decimal places are exported. You find the IDs of the standard statuses on the <<data/internal-IDs#120, Internal Ids in plentymarkets>> page of the manual.
...
101 = ricardo +
102 = real.de +
You find further possible values for order referrers on the <<data/internal-IDs#90, Internal IDs in plentymarkets>> page of the manual.
