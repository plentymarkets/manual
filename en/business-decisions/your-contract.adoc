...
It makes sense to change your contract e.g. if you generate more orders than are included in your current r. It is possible to book a higher rate at any time. If you book a lower rate, the change will go into effect once the regular duration of your current contract has ended.
