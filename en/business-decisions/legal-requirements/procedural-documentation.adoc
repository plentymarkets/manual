...
Download the current version of the technical system documentation of plentymarkets link:https://cdn02.plentymarkets.com/pmsbpnokwu6a/frontend/plentymarkets_Rechtliches/Verfahrensdokumentation_V7.1.pdf[here^] (German only). Older versions can be accessed link:https://github.com/plentymarkets/template-procedure-document/releases[here^]{nbsp}icon:external-link[] (German only).
