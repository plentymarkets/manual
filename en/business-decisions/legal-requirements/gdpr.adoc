...
//add this url weiterleitung /en/basics/legal-requirements/gdpr/;/en/business-decisions/legal-requirements/gdpr/;301;L
...
On Thursday, 24th of May, 2018, plentymarkets is updated in order to manage the conclusion of contracts for processing according to article 28 § 3 of the General Data Protection Regulation (GDPR) in a digital fashion. The contract is concluded digitally in the *My Account* area of link:https://marketplace.plentymarkets.com/en[plentyMarketplace^]{nbsp}icon:external-link[].
...
After the contract has been concluded, you can download a version of the contract including the name of the signatory and the date of the contract conclusion. Simply access the *Contracts* area again and click on *Vertragsdokument signiert herunterladen*.

Please keep this document for the purpose of contractual documentation.

For further information, please refer to this link:https://forum.plentymarkets.com/t/vertragsanlage-zur-auftragsverarbeitung-i-s-d-art-28-abs-3-datenschutz-grundverordnung-dsgvo/483954[forum thread^]{nbsp}icon:external-link[].
...
For further information, please refer to this link:https://forum.plentymarkets.com/t/dsgvo-aenderungshistorie-fuer-kontaktdaten-integriert/486705[forum thread^]{nbsp}icon:external-link[].
...
For further information, please refer to this link:https://forum.plentymarkets.com/t/dsgvo-uebertragung-von-e-mail-adresse-und-telefonnummer-an-versanddienstleister/486536[forum thread^]{nbsp}icon:external-link[]. At the bottom of the thread, you will find a link to expand the English version.
