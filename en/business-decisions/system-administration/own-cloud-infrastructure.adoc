...
This option is available to sellers with an *ENTERPRISE rate*.
...
////
[.collapseBox]
.*How long can I postpone new updates?*
--
...
Your system will be updated automatically after 4 weeks.
So if you use a version that’s more than 4 weeks old, your system will be updated automatically.
You will be informed about the automatic update in advance.
