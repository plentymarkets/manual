...
//add this url weiterleitung /en/basics/admin-tasks/plentymarkets-status/;/en/business-decisions/system-administration/plentymarkets-status/;301;L
...
How to unsubscribe from plentymarkets status is described in the <<basics/admin-tasks/plentymarkets-status#unsubscribe-from-plentymarkets-status, Unsubscribing from plentymarkets status>> chapter.
...
. Click on *plentymarkets status*. +
→ The view *Subscribe to plentymarkets status* opens.
. Deactivate the button icon:toggle-off[role="green"]. +
...
====
When you changed your email address in the user account, it is necessary that you <<basics/admin-tasks/plentymarkets-status#unsubscribe-from-plentymarkets-status, unsubscribe>> from plentymarkets status and then <<basics/admin-tasks/plentymarkets-status#subscribe-to-plentymarkets-status, subscribe>> again. +
