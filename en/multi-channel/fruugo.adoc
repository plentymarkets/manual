...
For further information, refer to the **<<start/statistics#, Statistics  >>** and **<<start/statistics/general-statistics/item/tops-flops#, Tops/Flops  >>** pages of the manual. For an example for flat rate and percentage costs, refer to the **<<multi-channel/fruugo#20, Basic settings >>** page of the manual.
|====
...
For further information, refer to the **<<multi-channel/fruugo#40, Payment methods and customer classes >>** chapter of the manual.
====
...
Set up an **<<orders/settings/event-procedures#, event procedure  >>** to automatically send an order confirmation to Fruugo.
...
Set up an **<<orders/settings/event-procedures#, event procedure  >>** to automatically send a shipping confirmation to Fruugo when the outgoing items are booked.
...
Set up an **<<orders/settings/event-procedures#, event procedure  >>** to automatically inform Fruugo of cancellations.
...
Set up an **<<orders/settings/event-procedures#, event procedure  >>** to automatically inform Fruugo about returns.
...
The menu **<<data-exchange/api-log#, Data exchange » API log  >>** contains a history of processes that run via the Fruugo interface. The following formats are available for Fruugo:
