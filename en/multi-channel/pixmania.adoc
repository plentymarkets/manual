...
|**Referrer**
|Select **PIXmania**. For further information about the order referrer, refer to the chapter <<multi-channel/pixmania#40, **Defining a price column** >>.
...
For further information, refer to the **<<start/statistics#, Statistics  >>** and **<<start/statistics/general-statistics/item/tops-flops#, Tops/Flops  >>** pages of the manual. For an example for flat rate and percentage costs, refer to the **<<multi-channel/pixmania#20, Basic settings >>** page of the manual.
|====
...
For further information, refer to the **<<multi-channel/pixmania#40, Payment methods and customer classes >>** chapter of the manual.
====
