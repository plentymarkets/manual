...
For further information, refer to the **<<start/statistics#, Statistics  >>** and **<<start/statistics/general-statistics/item/tops-flops#, Tops/Flops  >>** pages of the manual. For an example for flat rate and percentage costs, refer to the **<<multi-channel/real-de#20, Basic settings >>** page of the manual.
|====
...
For further information, refer to the **<<multi-channel/real-de#40, Payment methods and customer classes >>** chapter of the manual.
====
...
====
Invoices are transferred from real.de into your plentymarkets system. As such, it is not possible to use your system to generate your own invoices. This means that - in contrast to other markets - you cannot manage any invoicing processes via <<orders/settings/event-procedures#, **event procedures**  >>.
====
