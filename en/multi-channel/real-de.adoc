...
|Items for which **no limitation** has been selected in the **<</#, Stock >>** tab of an item will be offered on real.de with the quantity entered here. As soon as an item has been sold, the quantity saved here will be newly transmitted for sale at the next full hour.
...
* If you are working with item variations, then click on the <</#, **Stock** >> tab of the item and make sure that the limitation is not set to **No limitation**.sein.
