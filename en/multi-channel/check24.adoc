...
You need to register with **link:http://info.fruugo.com/merchants/pages/start_selling.asp[Check24, window="_blank"]** before setting up Check24 in plentymarkets.
...
. Go to **Settings » Markets »  Check24 » Basic settings**.
. Activte the automatic data exchange.
. Enter the Check24 user name.
. Enter the Check24 password.
. **Save** the settings.
...
Items have to be available for Check24. This is done in the **Availability** tab of an item within the link::/[**Item » Edit item » Tab: Variation ID**] menu.
...
The menu **Data exchange » API log » Tab: API log** contains a history of processes that run via the Check24 interface. The **Check24OrderImportAdapter** format is available for Check24.
