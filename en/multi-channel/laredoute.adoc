...
Items have to be available for La Redoute. This is done in the **Availability** tab of an item within the <</#, **Item » Edit item » Tab: Variation ID** >> menu.
...
Link your <</#, **properties** >> with the La Redoute properties. Properties have to be created in French for this. You will receive an XLS file from La Redoute, which contains the properties. Use this file to create a CSV file for importing properties.
...
<</#, **Attributes** >> also have to be linked before your items can be transferred to La Redoute. An item will only be displayed on La Redoute if all of its attributes were linked.
...
As a final step, link your <</#, **manufacturers** >>. You will receive a file from La Redoute, which contains the manufacturer IDs.
...
If you want to irreversibly delete an <</#, **item** >> offered on La Redoute from your plentymarkets system, then you will first need to delete this item from the La Redoute catalogue.
