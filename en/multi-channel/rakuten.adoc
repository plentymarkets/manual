...
**Activate** = Order confirmations are transferred to the customer. The email template saved under <</#, **Settings » Client (store) » Standard » Email » Automatic email** >> will be sent to the customer.
...
Items have to be available for Rakuten.de. This is done in the **Availability** tab of an item within the <</#, **Item » Edit item » Tab: Variation ID** >> menu.
...
The energy label is saved in the item's <</#, **Images** >> tab. To do so, proceed as follows.
...
Items have to be available for Rakuten.co.uk. This is done in the **Availability** tab of an item within the <</#, **Item » Edit item » Tab: Variation ID** >> menu.
