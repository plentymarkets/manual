...
**Example**: For an item with a stock of 50 and a stock buffer of 10, the value 40 will be transferred as stock. For further information, refer to the **<</#, Stock >>** page of the manual.
