...
|Enter the image position of the item image if the energy label is saved as an item image instead of as a property. For further information about the energy label, refer to the <<multi-channel/neckermann-at#150, **Providing information on the energy efficiency** >> chapter.
...
If you have created <<item/managing-items#390, **attributes** >> in your plentymarkets system, you will have to link these attributes with Neckermann. To do so, you have to import the <<multi-channel/neckermann-at#50, **Neckermann components** >> first. Proceed as described below to link the attribute Colour with Neckermann. Link further attributes in the same way.
...
For further information, refer to the **<<start/statistics#, Statistics  >>** and **<<start/statistics/general-statistics/item/tops-flops#, Tops/Flops  >>** pages of the manual. For an example for flat rate and percentage costs, refer to the **<<multi-channel/neckermann-at#20, Basic settings >>** page of the manual.
|====
...
For further information, refer to the **<<multi-channel/neckermann-at#40, Payment methods and customer classes >>** chapter of the manual.
====
