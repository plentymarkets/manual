...
The language versions will be assigned to the countries of delivery depending on the languages that were set for each country under <</#, **Settings » Orders » Shipping » Shipping options » Tab: Countries of delivery** >>.
...
Use this menu to specify domestic and international shipping conditions. In addition to the region of delivery, select specific <<fulfilment/preparing-the-shipment#1000., **shipping profiles** >> or service providers for international shipping. Go to **<</#, Settings » Orders » Shipping » Shipping options » Tab: Countries of delivery >>** and check your language settings for the countries that you want to ship your eBay items to. For further information, refer to eBay's **link:http://pages.ebay.co.uk/help/sell/shipping-globally.html[Using the Global Shipping Programme, window="_blank"]** page.
...
|**Stock dependence**
| Select the **<</#, stock dependence >>** of the listing. Select one of the following options:  +
...
|**Stock dependence**
| Select the **<</#, stock dependence >>** of the listing.
