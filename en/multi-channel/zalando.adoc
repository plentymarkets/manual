...
You can link the exported Zalando properties with the items in your plentymarkets system. This is done by means of the **<<data-exchange/data-formats/itemproperties#, data format  >>** via the **link::/[dynamic import]**.
...
For further information, refer to the **<<start/statistics#, Statistics  >>** and **<<start/statistics/general-statistics/item/tops-flops#, Tops/Flops  >>** pages of the manual. For an example for flat rate and percentage costs, refer to the **<<multi-channel/zalando#20, Basic settings >>** page of the manual.
|====
...
For further information, refer to the **<<multi-channel/zalando#40, Payment methods and customer classes >>** chapter of the manual.
====
