...
Items have to be available for Zalando. This is done in the **Availability** tab of an item within the <</#, **Item » Edit item » Tab: Variation ID** >> menu.
...
You can link the exported Zalando properties with the items in your plentymarkets system. This is done by means of the **<<data-exchange/data-formats/itemproperties#, data format  >>** via the **<</#, dynamic import >>**.
