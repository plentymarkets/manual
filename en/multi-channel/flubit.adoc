...
This item description will be transferred to Flubit. The item description has to be available in **<<client-store/standard/online-store/multilingualism#40, English >>**. Otherwise the item will not be exported.
...
* The item description is available in **<<client-store/standard/online-store/multilingualism#40, English >>**.
* The item is visible
...
Set up an **<<orders/settings/event-procedures#, event procedure  >>** to automatically send shipping confirmations to Flubit when the outgoing items are booked.
...
Set up an **<<orders/settings/event-procedures#, event procedure  >>** to automatically inform Flubit of cancellations. Whenever you are dealing with cancellations, you need to send Flubit a reason for the cancellation. Go to **<<orders/settings/order-status#, Settings » Orders » Order status  >>** and create additional order statuses as needed. The following cancellation reasons can be transferred to Flubit:
...
Set up an **<<orders/settings/event-procedures#, event procedure  >>** to automatically inform Flubit about returns.
...
The menu **<<data-exchange/api-log#, Data exchange » API log  >>**, tab **Flubit** contains a history of processes that run via the Flubit interface. The following formats are available for Flubit:
