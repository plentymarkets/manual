...
:author: team-mobile
:keywords: App, plentymarkets app, hardware, app log in, app login, app access, app installation, install app, installing the app, customise app, app customisation, customising the app, plentyPOS, plentymarkets POS, POS, POS system, point of sale
:position: 115
:url: app
:nav-alias: Overview
...
What do you want to use the app for? <<app/installation#100, Which hardware you need>> depends on what you want to do with the app. For example, if you want to scan barcodes and accept credit card payments, then you’ll need more hardware than if you only want to track sales figures.
...
The plentymarkets app will only work if you’ve link:https://www.plentymarkets.co.uk/free-trial/[booked a plentymarkets ERP system^]{nbsp}icon:external-link[]. In other words, you’ll <<app/installation#1200, log into the app with the same access data>> that you use for your plentymarkets system.

If you want other employees to use the app too, then you’ll need to give them access data. <<app/installation#600, Decide which areas of the app>> your employees should have access to.

[#500]
=== Customise the app

Do you want to control, e.g. which information is displayed first, second, third, etc and which font size is used to display information in the app? Or do you want to use colours that match your own corporate design instead of the default background? <<app/installation#1800, Customise the app>> and set it up the way you want.
