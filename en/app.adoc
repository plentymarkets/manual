...
The plentymarkets app will only work if you’ve link:https://www.plentymarkets.co.uk/free-trial/[booked a plentymarkets ERP system^]. In other words, you’ll <<app/installation#1200, log into the app with the same access data>> that you use for your plentymarkets system.
