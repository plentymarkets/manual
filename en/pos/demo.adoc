...
:author: team-mobile
:keywords: App, demo, demo mode, plentyPOS, plenty POS, POS test, POS demo, test POS, testing POS, try POS, trying POS, app test, testing app, test app
...
Just like any other item, you can add coupons to the POS shopping cart by <<pos/demo#600, scanning the barcode>>, by <<pos/demo#700, choosing it from the list of favourites>> or by <<pos/demo#800, manually entering its item number>>.
...
--
Do you run a webshop as well as a brick and mortar store? If so, then you can allow customers to buy items online and pick them up personally in your local store.
