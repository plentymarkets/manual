...
:author: team-mobile
:keywords: App, demo, demo mode, plentyPOS, POS test, POS demo, test POS, testing POS, try POS, trying POS, app test, testing app, test app
...
====
We’re happy to <<app/installation#400, recommend hardware for plentyPOS>>. In general, Android devices with OS version 4.2.2 and higher are supported. iOS devices with OS version 8 and higher are supported.
====
...
.*Selling gift cards*
--
Pre-paid gift cards are a popular gift idea. With plentyPOS, you can sell gift cards and accept them as a payment method. Try it out with an example gift card!
...
The demo mode includes a fictional gift card that you can try out. link:https://cdn02.plentymarkets.com/pmsbpnokwu6a/frontend/POS_Demo-Mode_data.pdf[Download the PDF file^]{nbsp}icon:external-link[] and scan the barcode for the example gift card. Alternatively, manually add the “gift card” item (ID 1076) to the shopping cart.
...
. link:https://cdn02.plentymarkets.com/pmsbpnokwu6a/frontend/POS_Demo-Mode_data.pdf[Download the PDF file containing demo gift cards^]{nbsp}icon:external-link[].
...
Do you have further questions about plentyPOS or about our rates? We’re happy to assist you! Contact our link:https://www.plentymarkets.co.uk/company/contact/[sales team^]{nbsp}icon:external-link[] any time.
