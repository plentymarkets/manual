...
Do you want to activate the shipping profile for a large number of items at the same time? To do so, use the <<item/managing-items#155, item group function>>.
