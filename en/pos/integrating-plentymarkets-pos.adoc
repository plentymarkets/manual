...
:author: team-mobile
:keywords: plentyPOS, set up POS, POS setup,POS user, POS payment method, POS booking account, POS pickup, prices POS orders, rounding behaviour POS orders, POS order, dummy item, miscellaneous item, POS coupon, POS return, link POS, send receipt, print receipt, customer card, loyalty card, cash journal, change POS order, delete POS, unlink POS
:position: 10
