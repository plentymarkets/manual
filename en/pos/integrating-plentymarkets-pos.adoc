...
| **TSE unit**
| Allows POS users to open the menu *TSE unit* in the plentymarkets app. This menu displays <<pos/pos-legal-compliance#900, status information on the TSE unit>>. POS users with this right are also authorised to create <<pos/pos-legal-compliance#700, TSE exports>>.
...
**__Note:__** For this right to come into effect, open the menu *Setup » Settings » User » Rights » User* and activate the right *Stock » Warehouses » Warehouse location » Show*.
...
=== Renaming plentyPOS payment methods

If necessary, you can assigned individual back end names to the default payment methods **4 » Pay upon pickup** and **11 » Cash sale/cash card** described <<#710, above>>.

To rename the payment methods, you need the following plugin:

* link:https://marketplace.plentymarkets.com/en/pospaymentmethodrenaming_6813[plentyPOS payment methods^]{nbsp}icon:external-link[]
