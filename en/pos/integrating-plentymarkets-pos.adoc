...
. Click on **New**. +
→ The **New** tab opens.
. Carry out the settings as desired. Pay attention to the information provided in <<table-POS-sales-price>>.
. **Save** the settings.
...
. Carry out the settings as desired. Pay attention to the information provided in <<table-POS-default-customer>>.
. **Save** the settings.
...
. **Save** the settings. +
→ The item is created and opened for editing.
. Carry out the additional settings. Note <<tabelle-POS-verkaufsgutscheine-artikeleinstellungen>>.
. **Save** the settings. +
...
. **Save** the settings.
. Carry out the settings as desired. Pay attention to the information provided in <<table-POS-event-procedure-outgoing-items>>.
. Place a check mark next to the option **Active**.
. **Save** the settings.
--
...
. **Save** the settings.
. Carry out the settings as desired. Pay attention to the information provided in <<table-POS-event-procedure-send-receipt>>.
. Place a check mark next to the option **Active**.
. **Save** the settings.
--
