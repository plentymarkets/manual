...
To give new POS users access to plentyPOS, create a <<basics/admin-tasks/manage-users#, user account>> of the user class **Backend** in the plentymarkets back end. To do so, proceed as described below.
...
. In the *Rights* area, activate the rights listed in <<table-POS-REST-rights>>.
. *Save* the settings.
...
. Carry out the desired settings. Note <<table-POS-payment-methods>>.
...
. Carry out the desired settings. Note <<table-POS-shipping-provider-pickup>>.
. **Save** the settings.
...
. Go to **Setup » Orders » Shipping » Tab: Shipping profiles**.
. Click on **New**.
...
. Click on **New**. +
→ The **New** tab opens.
. Carry out the desired settings. Note <<table-POS-sales-price>>.
. **Save** the settings.
...
. Carry out the desired settings. Note <<table-POS-default-customer>>.
. **Save** the settings.
...
. Carry out the desired settings. Note <<table-POS-gift-card-campaigns>>.
. **Save** the settings. +
...
[NOTE]
.Take note of the creation date
====
...
. **Save** the settings. +
→ The item is created and opened for editing.
. Carry out the additional settings according to <<tabelle-POS-verkaufsgutscheine-artikeleinstellungen>>.
. **Save** the settings. +
...
. Go to *Orders » Coupons*.
. Click on *New campaign*.
. Carry out the desired settings. Note <<table-POS-refund-campaign>>.
. *Save* the settings. +
→ The new campaign is created and appears in the overview.
...
. **Save** the settings.
. Carry out the settings as according to <<table-POS-event-procedure-outgoing-items>>.
. Place a check mark next to the option **Active**.
. **Save** the settings.
--
...
. Carry out the desired settings. Note <<table-POS-link-device>>.
. **Save** the settings. +
...
. Open the plentymarkets app.
. Go to *plentymarkets App » Settings » POS*.
. Carry out the desired settings in the *Printers* area. Note <<table-POS-printers>>.
. **Save** the settings.
...
[#400]
== Searching for POS transactions in the cash journal
