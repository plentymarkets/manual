...
Some card terminals can be linked to plentyPOS by provisioning plugins in the plentymarkets back end. plentyPOS currently support the following card terminals:
...
|**Order referrer**
|Select plentyPOS as the order referrer.
...
|**Referrer**
|Activate one or several plentyPOS referrers. The sales price is activated for the activated referrers.
|====
...
Click & Collect means the process of ordering items online and picking them up at the store. In plentymarkets, such an order is loaded into plentyPOS and completed at the POS. As such, the following scenarios are possible at the POS:
