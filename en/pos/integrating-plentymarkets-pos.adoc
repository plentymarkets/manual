...
The point of sale system plentymarkets POS is an optional component of the plentymarkets app. However, there are additional hardware requirements for using plentymarkets POS. For further information about the system requirements for the plentymarkets app and plentymarkets POS, refer to the <<quick-start/system-requirements#50, System requirements>> page of the manual.
...
|**Image**
|Activate the option and select a PNG file to display on the receipts generated by the POS. The file must have been uploaded to the **CMS » Webspace** menu.
...
|**Country**
|Select the country in which the POS is to be used from the dropdown list. Default setting is based on the option **Where is the company based (for financial accounting purposes)** in the <<quick-start/master-data#, System » Settings » Master data>> menu.
...
For further information about creating label templates and printing the labels in the item search of the plentymarkets app, refer to <<item/managing-items#760, Setting up labels>>.
