...
====
.Book a POS
To use plentymarkets POS, you need to link:https://www.plentymarkets.com/product/pricing/[book one or more POS in plentymarkets^]. Visit our link:https://www.plentymarkets.com/product/modules/point-of-sale/[plentyPOS product page^]{nbsp}icon:external-link[] to get further information on prices and terms and conditions.
====
