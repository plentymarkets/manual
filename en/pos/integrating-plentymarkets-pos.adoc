...
. Carry out the settings. Pay attention to the explanations given in <<tabelle-POS-zahlungsarten>>.
...
*_Note:_* Only select countries of delivery if the payment method is also used in an online store.
...
. Carry out the settings. Pay attention to the explanations given in <<tabelle-POS-versanddienstleister-selbstabholung>>.
. **Save** the settings.
...
. Carry out the settings. Pay attention to the explanations given in <<tabelle-POS-versandprofil-selbstabholung>>.
. **Save** the settings. +
...
. Go to *Orders » Coupons*.
. Click on *New campaign*.
. Carry out the settings. Pay attention to the explanations given in <<tabelle-POS-retourenkampagne>>.
. *Save* the settings. +
→ The new campaign is created and appears in the overview.
...
. Carry out the settings. Pay attention to the explanations given in <<tabelle-POS-geraet-koppeln>>.
. **Save** the settings. +
