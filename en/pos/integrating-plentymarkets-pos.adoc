...
→ The plugin description teaches you how to configure <<automation/processes/installing-plentybase#, plentyBase>>. +
...
→ Find out how to save the plentyBase connection data in the <<automation/processes/installing-plentybase#, plugin description>>.
...
→ Find out how to save the plentyBase connection data in the plugin description of the plugin <<automation/processes/installing-plentybase#, plentyBase>>. +
