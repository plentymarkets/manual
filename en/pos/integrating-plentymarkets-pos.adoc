...
The mobile POS solution plentymarkets POS allows you to integrate your brick and mortar store seamlessly both with your online presence and your plentymarkets system. The point of sale system plentymarkets POS is provided as a component of the <<app/installation#, plentymarkets app>>.
...
The point of sale system plentymarkets POS is provided as a component of the <<app/installation#, plentymarkets app>>. Take a look at our documentation and learn:

* Which <<app/installation#400, hardware requirements>> apply to plentymarkets POS.
...
To use plentymarkets POS, you need to link:https://www.plentymarkets.co.uk/prices/[book one or more POS in plentymarkets^]. Visit our link:https://www.plentymarkets.co.uk/product/pos-product/[plentymarkets POS product page^] to get further information on prices and terms and conditions.
...
Now, carry out the additional settings in the **Basic settings** tab of the POS and save these settings. Note <<tabelle-POS-grundeinstellungen>>.
...
*_Tip:_* Click **Generate key** to generate a random key. +
...
. Carry out the settings. Note <<tabelle-POS-belegvorlage>>.
. **Save** the settings. +
...
→ If the option *Automatic printing* is activated in the plentymarkets app under *Settings » POS*, the gift card receipt is printed after the POS receipt is printed. +
→ If the option *Automatic printing* is not activated in the plentymarkets app under *Settings » POS*, the POS user can print the gift card receipt manually after completing the order. +
...
To give new POS users access to plentymarkets POS, create a <<basics/admin-tasks/manage-users#, user account>> of the user class **Backend** in the plentymarkets back end. To do so, proceed as described below.
...
Now assign rights for the communication between plentymarkets POS and the plentymarkets back end via the REST API.
...
. Click on the **Mobile** tab.
. Activate the POS functions that the POS user should have access to. Note <<tabelle-POS-berechtigungen>>.
. **Save** the settings.
...
|**POS**
|Grants POS users access to plentymarkets POS.
...
. Carry out the settings. Pay attention to the information given in <<tabelle-POS-zahlungsarten>>.
...
. Carry out the settings. Pay attention to the information given in <<tabelle-POS-versanddienstleister-selbstabholung>>.
. **Save** the settings.
...
. Carry out the settings. Pay attention to the information given in <<tabelle-POS-versandprofil-selbstabholung>>.
. **Save** the settings. +
...
. Click on **New**. +
→ The **New** tab opens.
. Carry out the settings as desired. Pay attention to the information provided in <<tabelle-POS-verkaufspreis>>.
. **Save** the settings.
...
**RRP** = Activate if the sales price is a recommended retail price (RRP). If the RRP and another sales price are linked with a variation, the RRP is displayed in the online store as red strike-through text next to the sales price. +
...
. Carry out the settings as desired. Pay attention to the information provided in <<tabelle-POS-standardkunde>>.
. **Save** the settings.
...
The required settings are described in <<tabelle-POS-dummy-artikel>>. The subheadings indicate the menu in which the settings are carried out.
...
. Carry out the settings. Note <<tabelle-POS-gutscheinkampagnen>>.
. **Save** the settings. +
...
. Go to *Orders » Coupons*.
. Click on *New campaign*.
. Carry out the settings. Note <<tabelle-POS-retourenkampagne>>.
. *Save* the settings. +
→ The new campaign is created and appears in the overview.
...
. *Save* the settings. +
→ The item is created and opened for editing.
. Carry out the additional settings. Note <<tabelle-POS-retourengutscheine-artikeleinstellungen>>.
. *Save* the settings.
...
* Online orders can only be paid for at the POS using coupons from app version 1.9.2. However, gift cards can only be used if no payment has been made for the order and no invoice document has been created yet.
...
Click & Collect means the process of ordering items online and picking them up at the store. In plentymarkets, such an order is loaded into plentymarkets POS and completed at the POS. As such, the following scenarios are possible at the POS:
...
. **Save** the settings.
. Carry out the settings as desired. Pay attention to the information provided in <<tabelle-POS-ereignisaktion-warenausgang-buchen>>.
. Place a check mark next to the option **Active**.
. **Save** the settings.
--
...
. Carry out the settings. Note <<tabelle-POS-geraet-koppeln>>.
. **Save** the settings. +
...
. **Save** the settings.
. Carry out the settings as desired. Pay attention to the information provided in <<tabelle-POS-ereignisaktion-beleg-senden>>.
. Place a check mark next to the option **Active**.
. **Save** the settings.
--
...
. Select filters. Pay attention to the information given in <<tabelle-POS-kassenjournal-menue>>.
. Click on **Search**. +
...
* The POS identification number of the plentymarkets POS. Go to **System » Client » Standard » POS » Open POS » Tab: Basic settings** to find the **POS identification number**.
...
*_Tip:_* The file name contains the export range, for example the file depExport9-1-2017-9-2-2017.json contains data from the 9th of January to the 9thofFebruary 2017.
