...
| *Default customer*
|Select the <<pos/integrating-plentymarkets-pos#95, default customer>>, which you created for POS orders and which you want to assign to orders generated with this POS.
