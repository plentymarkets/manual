...
:author: team-mobile
plentymarkets POS, plentyPOS, plenty POS, point of sale, POS system, points of sale, IDEA export, IDEA, GoBD, cash journal, POS journal, RKSV, DEP export, mobile POS, smartphone POS, plentyPOS, POS system, IDEA export, IDEA, GoBD, cash journal, mobile POS, smartphone POS, security device, POS Austria, POS legal, RKSV conformity, QR code, loyalty card, loyalty cards, barcode card, barcode cards, unlink POS, unlink plentyPOS, unlink device, unlink devices
:position: 10
...
. Open the plugin set in which you have installed the plugin.
...
| **Country**
|Select the country in which the POS is to be used from the dropdown list. The default setting is based on the option **Where is the company based (for financial accounting purposes)** in the <<quick-start/quick-start-initial-settings#100, Setup » Settings » Master data>> menu.
