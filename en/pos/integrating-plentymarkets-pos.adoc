...
. Carry out the settings according to <<tale-POS-default-customer>>.
. **Save** the settings.
...
→ The POS is deleted. +
__Note:If the POS is located in Austria and the signature unit is activated, an <<pos/integrating-plentymarkets-pos#920, end receipt>> must be created in the app. This deletes the POS automatically.