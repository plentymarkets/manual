...
|**Header**
|If the component is selected, the field's content is displayed as a header on all receipts issued by the POS. By default, the header contains the information saved in the **System » System settings » Settings » Master data** menu. Make changes as needed.
...
2+|*System » System settings » Settings » User » Accounts » Open account » Tab: Mobile » POS functions*
