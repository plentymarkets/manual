...
* <<orders/coupons#20, Create a campaign>> for gift cards and coupons. Use the option *Coupon variety* to specifiy whether it is a gift card or a promotional coupon.
* <<orders/coupons#130, Link the gift card to the campaign>>.
...
*_Recommendation:_* Configure plentyBase to run automatically when the computer is started up.
* Has the printer been <<basics/working-with-plentymarkets/general-functions#95, saved and configured>> in the plentymarkets back end?
