...
Many companies sell items in an webshop as well as in a retail outlet. This allows customers to place an order in the webshop and pick up the items they ordered in the retail outlet. They can either pay online or pay at the time of pickup. Thus, the following scenarios are possible:
