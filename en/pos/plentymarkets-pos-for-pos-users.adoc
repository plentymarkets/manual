...
====
Z reports are saved in the plentymarkets back end. Go to <<orders/document-archive#_searching_for_pdf_documents_in_the_archive, Orders » Document archive>> and filter by document type *Z report*. You can download the report as a PDF file from the *File* column.
====
