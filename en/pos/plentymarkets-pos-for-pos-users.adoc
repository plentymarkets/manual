...
====
For technical reasons, the return amount can only be paid out to customers in cash or as a gift card.
====
...
====
Z reports are saved in the plentymarkets back end. Go to <<orders/document-archive#_document_archive#, Orders » Document archive>>. Filter by the document type *Z report*. You can download the report as a PDF file from the *File* column.
====
