...
====
Variations for which order properties have been saved cannot be sold via plentyPOS. Starting from version 1.11.8 of the plentymarkets app, an error message is displayed when you try adding such variations to the shopping cart at the POS. 
