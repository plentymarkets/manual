...
[#150]
== Further information on online orders
...
Online orders are processed differently in plentyPOS depending on when and how customers pay for the order.
