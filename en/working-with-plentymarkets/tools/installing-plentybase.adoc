...
If plentyBase is installed on the computer, these tasks can be performed in the Terra version of the plentymarkets back end. As an alternative to plentyBase, you can install the <<tools/plentymarkets-client#, **plentymarkets Client**  >> for these tasks. Find out how to install and use plentyBase here.
...
plentyBase
// außerdem
requires the same general <<working-with-plentymarkets/system-requirements#, **system requirements**  >> as plentymarkets.
...
* <<working-with-plentymarkets/tools/installing-plentybase#30., **Install plentyBase** >> on a computer in the network.
...
. If you did not enter the default port during installation on the host computer, enter <<working-with-plentymarkets/tools/installing-plentybase#40., **the port of the host computer** >> in the plentymarkets back end.
