...
For further information, refer to the **<<payment/managing-bank-details#200., SEPA payments >>** page of the manual.
...
image::working-with-plentymarkets/basic-settings/assets/EN-Settings-Basic-Settings-Migration01-SI.png[]
...
image::working-with-plentymarkets/basic-settings/assets/EN-Settings-Basic-Settings-Migration02-SI.png[]
