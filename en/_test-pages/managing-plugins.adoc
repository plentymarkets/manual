...
As an alternative to the plentyMarketplace, you can add your own plugins to the inbox of your plentymarkets system. Proceed as described below to copy a plugin repository managed via <<_test-pages/managing-plugins#90, **Git versioning**>> to the plentymarkets Inbox and manage it in the plentymarkets back end.
...
|**Deploying plugins in Stage**
|Checks all plugins marked as active and deploys them in the preview mode **Stage**. In this mode, a preview of the active plugins is deployed to allow you to test their functionality. Changes made after the last deployment are highlighted in yellow. +
...
|**Settings**
|<<_test-pages/managing-plugins#45, **Connection settings**>> of the repository
