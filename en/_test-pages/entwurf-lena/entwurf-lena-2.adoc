...
|For example, if working with **<<order-processing/orders/editing-sales-orders/delivery-order#, delivery orders  >>**, then this option should be set to **Yes** for their creation.
