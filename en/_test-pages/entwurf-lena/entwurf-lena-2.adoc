...
|For example, if working with **<<order-processing/orders/managing-sales-orders#delivery-order, delivery orders  >>**, then this option should be set to **Yes** for their creation.
