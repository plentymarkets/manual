...
**System » System settings » Stock » Warehouse » Select warehouse » Submenu: Settings**
...
Here, you can select the countries that were set up as countries of delivery under link::/[**System » System settings » Orders » Shipping » Settings » Tab: Countries of delivery**].
