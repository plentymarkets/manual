...
Depending on which sales strategy you choose, orders from different **<<omni-channel/order-referrer#, Referrers>>** will be transferred to your plentymarkets system once this has been set up. Apart from your own online store, these referrers will primarily be the different markets that you configured in the **<<omni-channel/multi-channel#, Settings » Markets>>** menu of your plentymarkets system.
