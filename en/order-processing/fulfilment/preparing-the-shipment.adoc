...
. Click on the *Table of shipping charges* tab.
. Expand the region.
. Carry out the settings in the *DHL Easylog* area. Pay attention to the information given in table 12.
. *Save* the settings.
...
Proceed as follows to set up the interface to link:https://www.dhl.de/en/logistik/frachttransport/land-schienentransport.html*DHL Freight*^] in plentymarkets.
...
. Click on the *Table of shipping charges* tab.
. Expand the region.
. Carry out the settings in the *DHL Freight* area. Pay attention to the information given in table 14.
. *Save* the settings.
...
====
Via the interface to the DHL business customer portal, you can use the function *Versenden* (shipping). The *DHL Shipping (Versenden)* plugin is available in the link:https://marketplace.plentymarkets.com/plugins/integration/DHLShipping_4871plentyMarketplace^].
...
. Click on the *Table of shipping charges* tab.
. Expand the region.
. Carry out the settings in the *DHL Intraship/Versenden* area. Pay attention to the information given in table 16.
. *Save* the settings.
...
. Carry out the settings. Pay attention to the information given in table 17.
...
Carry out the settings in the link:https://www.dhl-geschaeftskundenportal.de/webcenter/portal/gkpExternal/gkpPortalMainNav/homeExt?_afrLoop=5521250977867307&_adf.ctrl-state=3k92t7n7e_33#!*DHL business customer portal*^].
...
Proceed as follows to set up the interface to link:https://www.dhl.de/content/dam/dhlde/downloads/pdf/Retoureonline/dhl-retoure-label-wird-beigelegt-infoblatt-en-042016.pdf[*DHL RETOURE with enclosed return labels*^] in plentymarkets.

[.instruction]
Setting up the interface:

. Go to *System » Orders » Shipping » Shipping service provider » DHL Retoure enclosed return labels*.
. Carry out the settings. Pay attention to the information given in table 18.
. *Save* the settings.
...
. Enter a name.
. Select the *event* listed in table 19.
. *Save* the settings.
. Carry out the settings. Pay attention to the information given in table 19.
...
Proceed as follows to set up the interface to link:https://www.dhl.de/content/dam/dhlde/downloads/pdf/Retoureonline/dhl-retoure-online-infoblatt-en-072015.pdf[*DHL Retoure Online*^] in plentymarkets.

[.instruction]
Setting up the interface:

. Go to *System » Orders » Shipping » Shipping service provider » DHL Retoure Online*.
. Carry out the settings. Pay attention to the information given in table 20.
. *Save* the settings.
...
. Select one of the options from the *Return* drop-down menu. Pay attention to the information given in table 21.
. *Save* the settings.
...
. Carry out the settings. Pay attention to the information given in table 22.
. *Save* the settings.
...
. Click on the *Table of shipping charges* tab.
. Expand the region.
. Carry out the settings in the *DHL UK* area. Pay attention to the information given in table 24.
. *Save* the settings.
...
. Carry out the settings. Pay attention to the information given in table 25.
. *Save* the settings.
...
Now carry out the shipping service provider-specific settings for the shipping services in the table of shipping charges.
 These services are only visible in the table of shipping charges after you have saved the settings in the shipping profile.
...
Before setting up the interface to DPD DELISprint in plentymarkets, register with link:https://www.dpd.com/ch_en/home/esolutions/clientloesungen/delisprint_6*DPD*^]. DPD customers can use the DPD DELISprint program to easily create DPD parcel labels.
...
. Carry out the settings. Pay attention to the information given in table 26.
. *Save* the settings.
...
. Carry out the settings. Pay attention to the information given in table 27.
. *Save* the settings.
...
. Click on the *Table of shipping charges* tab.
. Expand the region.
. Carry out the settings in the *PAT Easypak* area. Pay attention to the information given in table 28.
. *Save* the settings.
...
. Carry out the settings. Pay attention to the information given in table 29.
. *Save* the settings.
...
While placing their orders, customers should be able to request that their items are assembled for them. You can offer customers such a service with link:https://www.hermesworld.com/en/about-us/hermes-group/hermes-einrichtungs-service/[*Hermes (two-man handling)*^]. In order to use this service, create an order property. Create an order property with the options *Yes* and *No*. Depending on which *property type* you select, you will be able to configure the options that your customers will later select in your online store.
...
. Carry out the settings. Pay attention to the information given in table 30.
. *Save* the settings.
...
. Click on the *Table of shipping charges* tab.
. Expand the region.
. Carry out the settings in the *Hermes (two-man handling)* area. Pay attention to the information given in table 31.
. *Save* the settings.
...
. Carry out the settings. Pay attention to the information given in table 32.
. *Save* the settings.
...
|Confirm the Hermes terms and conditions and the notice about the limitation placed on the value of a package by placing the check marks. +
  The Hermes service will not be available for you without this confirmation. Click on the link to see the terms and conditions.
...
Proceed as follows to set up the interface to link:https://www.dpd.com/de_en*MyDPD Business / iloxx*^] in plentymarkets.
...
Proceed as follows to set up *link:http://www.royalmail.com/[Royal Mail*^] and *link:https://www.ukmail.com/[UK Mail*^] via the integrated *link:https://www.netdespatch.com/[NetDespatch*^] interface in your plentymarkets system.
...
. Carry out the settings. Pay attention to the information given in table 33.
. *Save* the settings.
...
. Click on the *Table of shipping charges* tab.
. Expand the region.
. Carry out the settings in the *NetDespatch* area. Pay attention to the information given in table 34.
. *Save* the settings.
...
. Carry out the settings. Pay attention to the information given in table 35.
. *Save* the settings.
...
. Click on the *Table of shipping charges* tab.
. Expand the region.
. Carry out the settings in the *NetDespatch* area. Pay attention to the information given in table 36.
. *Save* the settings.
...
. Click on the *Table of shipping charges* tab.
. Expand the region.
. Carry out the settings in the *Parcelforce Worldwide* area. Pay attention to the information given in table 37.
. *Save* the settings.
...
Before setting up the interface to link:https://www.post.ch/en/business/a-z-of-subjects/swiss-post-gls*Swiss Post*^] in plentymarkets, register with Swiss Post.
...
. Carry out the settings. Pay attention to the information given in table 38.
. *Save* the settings.
...
. Click on the *Table of shipping charges* tab.
. Expand the region.
. Carry out the settings. Pay attention to the information given in table 39.
. *Save* the settings.
...
Proceed as follows to set up the interface to link:https://www.ups.com/one-to-one/register?sysid=myups&loc=en_DE&WT.svl=Footer*UPS*^] in plentymarkets.

[.instruction]
Setting up the interface:

. Go to *System » Orders » Shipping » Shipping service provider » UPS*.
. Carry out the settings. Pay attention to the information given in table 40.
. *Save* the settings.
...
. Click on the *Table of shipping charges* tab.
. Expand the region.
. Carry out the settings in the *UPS Service* area. Pay attention to the information given in table 41.
. *Save* the settings.
...
This chapter describes how to set up link:https://www.dhl.de/en/geschaeftskunden/paket/ab-200-pakete/fulfillment.html*DHL Fulfillment*^] in plentymarkets. Set up special warehouses, order statuses and reasons for return before you set up the interface.
...
[TIP]
.Sending letters with DHL Fulfillment
====
...
Afterwards, you select the shipping services in the table of shipping charges. These services are only visible in the table of shipping charges after you have saved the settings in the shipping profile. Make sure that the shipping profile is <<order-processing/fulfilment/preparing-the-shipment#1800, *activated*>> for the item.
====
...
. Carry out the settings. Pay attention to the information given in table 44.
. *Save* the settings.
...
. Carry out the settings. Pay attention to the information given in table 45.
. *Save* the settings.
...
. Carry out the settings. Pay attention to the information given in table 46.
. *Save* the settings.
...
. Carry out the settings. Pay attention to the information given in table 47.
