...
====
Via the interface to the DHL business customer portal, you can use the function *Versenden* (shipping). The *DHL Shipping (Versenden)* plugin is available in the link:https://marketplace.plentymarkets.com/plugins/integration/DHLShipping_4871[*plentyMarketplace*, window="_blank"].
