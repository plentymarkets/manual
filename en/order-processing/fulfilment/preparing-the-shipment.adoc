...
[[table-shipping-services-dhl-enclosed-return-labels]]
...
. Carry out the settings. Pay attention to the information given in <<table-interface-dhl-easypak>>.
. *Save* the settings.
...
. Click on the *Table of shipping charges* tab.
. Expand the region.
. Carry out the settings in the *PAT Easypak* area. Pay attention to the information given in <<table-shipping-services-dhl-easypak>>.
. *Save* the settings.
...
Proceed as described below to set up the interface to linkhttps://www.ups.com/doapp/SignUp?loc=en_US&returnto=https%3A%2F%2Fwww.ups.com%2Fus%2Fen%2Fhelp-center%2Fget-started-with-ups.page[UPS^] in plentymarkets.
