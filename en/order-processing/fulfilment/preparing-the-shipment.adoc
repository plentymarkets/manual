...
====
If you are using the DHL Shipping plugin, export documents will automatically be available in the shipping centre next to the shipping label when you register the shipping order. This function will be available as of version 1.3. You can download the DHL Shipping plugin free of charge from the link:https://marketplace.plentymarkets.com/plugins/integration/DHLShipping_4871[*plentyMarketplace*, window="_blank"].
====
...
Proceed as follows to set up the interface to link:https://www.post.at/en/business.php[*EasyPAK*, window="_blank"] in plentymarkets.
