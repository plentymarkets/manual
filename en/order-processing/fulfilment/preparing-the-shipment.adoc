...
Then create the fulfilment service provider in the *Settings » Orders » Shipping » Shipping options » Tab: Shipping service provider* menu. Select *Others* from the *Shipping service provider* drop-down menu. Further information can be found in the chapter <<order-processing/fulfilment/preparing-the-shipment#800, *Creating a shipping service provider*>>.
