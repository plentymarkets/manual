...
This calculation type treats shipping costs as total prices. In other words, regardless of how many items a customer purchases, they only pay the shipping costs entered here.
...
====
Defined shipping packages: A seller ships his/her items in two different cardboard box sizes. Therefore, they need to set up two shipping packages. The volume of these packages results from the dimensions entered and saved. +
