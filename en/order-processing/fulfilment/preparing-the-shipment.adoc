...
Proceed as follows to set up the interface to link:http://www.parcelforce.com/[**Parcelforce Worldwide**, window="_blank"] in plentymarkets.

[.instruction]
Setting up the interface:

. Go to *Settings » Orders » Shipping » Shipping service provider » Parcelforce Worldwide*.
