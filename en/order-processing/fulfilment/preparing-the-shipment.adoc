...
*_Important:_* In order to transfer the alternative value, the option *Transfer alternative* must be selected in the drop-down list *Transfer email and telephone number*.
