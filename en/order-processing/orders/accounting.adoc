...
If you are about to or already have passed a delivery threshold you need to open your existing location and set up a <<processing-orders/orders/accounting#550,new VAT configuration>> for that country within the location. Do not create a new location if for countries where you pass the delivery threshold.
...
image::processing-orders/orders/assets/defaultVatRatesAndLocations.png[]
