...
. Go to **System » Client » Open client » Locations » Open location » Accounting**.  +
...
. Select a location under *System » Client » Open client » Locations » Open location » Accounting*. +
→ The *Basic settings* tab will open.
