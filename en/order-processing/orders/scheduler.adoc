...
.Tip
====
Go to **Start » Service Center » Tab: Contract** to __**book**__ the module.
====
...
. Go to **<<omni-channel/online-store/setting-up-clients/my-account#, System » Client » Open client » My Account » Settings>>**.
