...
image::order-processing/orders/assets/EN-Settings-Orders-Scheduler-01.png[]
...
. Go to **<<omni-channel/online-store/setting-up-clients/my-account#, Settings » Client (store) » Standard » My Account » Basic settings  >>**.
...
. Click on the **<<order-processing/orders/scheduler#, Other » Other >>** tab.
...
image::order-processing/orders/assets/EN-Settings-Orders-Scheduler-02.png[]
...
image::order-processing/orders/assets/EN-Orders-Scheduler-Scheduled-Orders-01.png[]
...
image::order-processing/orders/assets/EN-Orders-Scheduler-Scheduled-Orders-02.png[]
+
__Image 2: **last run** column contains information__

An order will be created in the **Orders** menu (image 3).

image::order-processing/orders/assets/EN-Orders-Scheduler-Scheduled-Orders-03.png[]
...
The client that is selected determines which **<<order-processing/orders/_accounting#, VAT rates  >>** will be available in the **Item** tab (see below).
...
image::order-processing/orders/assets/EN-ENG-Auftraege-Scheduler-Durchlauf01-SI.png[]
