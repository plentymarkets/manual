...
**Important:** Variable users can only select those clients that they have a right to access. Variable users are given rights under **<<basics/working-with-plentymarkets/manage-users#, Settings » Basic settings » User » Accounts » Tab: Right>>**.
|====
