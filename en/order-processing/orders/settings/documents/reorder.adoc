...
You have to set up a template before you can print reorders. For further information, refer to the **Documents** page of the manual. Specifically, refer to the <<order-processing/orders/settings/documents#40, **Configuring document templates** >> chapter.
...
The **Transfer** tab allows you to copy the settings in the adjustment form's **Template** tab and then apply these settings to a different document, e.g. to a delivery note. For further information, refer to the **Documents** page of the manual. Specifically, refer to the <<order-processing/orders/settings/documents#140, **Copying settings** >> chapter.
...
You have different options for creating a reorder. One way is to create reorders in the menu link::/[**Stock » Reorder management » Reorders**].

image::order-processing/orders/settings/documents/assets/EN-Settings-Orders-Documents-Reorder-01.png[]
