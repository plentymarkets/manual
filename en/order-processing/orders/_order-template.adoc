...
In the menu **System » Orders » Order template**, you can create order templates for one or more items. You can then activate these templates, e.g. by selecting **Use order template** within an event procedure.
