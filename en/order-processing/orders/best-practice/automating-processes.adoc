...
. Go to **<<order-processing/orders/settings/event-procedures#, Settings » Orders » Event procedures  >>**.
...
image::order-processing/orders/best-practice/assets/ENG-BestPrac-Auftraege-Vorgaenge-automatisieren-01.png[]
...
Create the procedure type **<<order-processing/orders/settings/documents#, Documents  >> &gt; Invoice**. If needed, activate the options **Payment due** and **Early payment discount**. Carry out the desired settings. Enter a **comment** if needed. +
...
image::order-processing/orders/best-practice/assets/ENG-BestPrac-Auftraege-Vorgaenge-automatisieren-02.png[]
