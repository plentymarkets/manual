...
Go to **System » Client » Open client » Locations » Open location » Accounting** to carry out important VAT settings. Decide whether VAT should be displayed on your invoices and how it should be displayed. Save VAT rates for your countries of delivery. Furthermore, save posting keys, debtor accounts and revenue accounts.
...
. Go to **System » Client » Open client » Locations » Open location » Accounting » Tab: Basic settings**.
...
. Go to **System » Client » Open client » Locations » Open location » Accounting » Tab: VAT rates**.
...
. Go to **System » Client » Open client » Locations » Open location » Accounting » Tab: Accounts**.
...
. Go to **System » Client » Open client » Locations » Open location » Accounting**. Select the location that includes the settings you want to transfer.
...
plentymarkets makes it possible to transfer all postings from invoices of outgoing items and from credit notes to a DATEV compliant accounting program (DATEV interface). In order to keep the rest of the processing as simple and efficient as possible, plentymarkets directly assigns the desired booking keys, debtor accounts and revenue accounts. The settings saved under **System » Client » Open client » Locations » Open location » Accounting » Tab: Accounts** form the basis for this.
