...
[#300]
== Generating several delivery notes

If you wish to generate several delivery notes at a time, use the search filter in the **Orders » Fulfilment** menu to determine the orders for which delivery notes should be generated. In addition, a status change can take place after the delivery notes have been generated.
