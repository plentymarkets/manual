...
You can carry out individual settings for most of the fields described in <<table-options-warehouse-pick-list>> concerning the parameters **width**, font size and font weight that allow you to choose an individual layout for the warehouse pick list. Use the **Preview** button to check the results of the settings while preparing the PDF template.
To display the fields on the warehouse pick list in the order of your choice, assign the position numbers 1 to 14 from the respective drop-down menu to them. Select the option *Pos* for fields that should not be displayed on the warehouse pick list.
...
image::order-processing/orders/order-documents/assets/EN-Settings-Orders-Documents-Warehousee-Pick-List-01.png[]
...
|**Free text**
|Select one of the **Free text fields 1-20** from the drop-down menu. +
...
[[table-fulfilment-options-warehouse-pick-llst]]
