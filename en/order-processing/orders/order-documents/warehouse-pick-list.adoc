...
Free text fields have to be defined beforehand in the menu **<<items/managing-items#70, System » Item » Free text fields>>**. After defining the free text fields, link them to their corresponding items and enter values for the fields. Use the menu <<items/managing-items#170, **Item » Edit item » Default Item » Fields**>>.
...
For more detailed information on document templates, refer to the **<<order-processing/orders/order-documents#, Documents>>** manual page.
...
The link **Change warehouse pick list** in the warehouse pick list menu takes you to the settings in the menu **System » Orders » Documents » <<order-processing/orders/order-documents/warehouse-pick-list#, warehouse pick list>>**, in which the document settings and the PDF template for the warehouse pick list are configured.
