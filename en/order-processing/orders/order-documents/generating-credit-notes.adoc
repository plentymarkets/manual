...
====
Carry out the desired default settings once in the menu **System » Aufträge » Einstellungen** and save them before generating credit notes. This is required for the correct application of your desired default settings for the **Standard status for credit notes** and the inclusion of shipping costs in credit notes. For more information on carrying out standard settings for orders, refer to the <<order-processing/orders/basic-settings#, Basic settings>> page of the manual.
====
