...
You can manually generate a single credit note in the corresponding credit note order, if necessary. For further information and instructions on generating credit note orders, refer to the <<order-processing/orders/managing-orders#credit-note#, Generating a credit note>> chapter of the manual.
...
[#400]
== Generating several credit notes

If you wish to generate several credit notes at a time, use the search filter in the **Orders » Fulfilment** menu to determine the orders for which credit notes should be generated. In addition, a status change can take place after the credit notes have been generated.
