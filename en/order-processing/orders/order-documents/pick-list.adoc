...
.Options in the *Pick list* menu¤image::order-processing/orders/order-documents/assets/EN-Settings-Orders-Documents-Pick-List-01.png
...
.Options in the *Pick list* submenu¤[cols="1,3"]
|====
|Setting |Explanation
