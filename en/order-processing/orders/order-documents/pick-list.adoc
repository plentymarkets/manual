...
[#100]
== General information about pick lists

You can use plentymarkets to generate pick lists as PDF or CSV files, for example if you want to print them or import them into another software. On your pick list, you can display barcodes which allow you to scan items directly on the pick list.
