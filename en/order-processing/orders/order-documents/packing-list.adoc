...
|**Order properties**
|Select whether order properties should be displayed or **not**. For further information about order properties, refer to the **<<item/managing-items#480, Properties>>** page of the manual.
...
|**BBF**
|Select if the best before date should be displayed on the packing list.

|**Batch**
|Select if the batch number should be displayed on the packing list.
|====
