...
image::order-processing/orders/settings/documents/assets/EN-Settings-Orders-Documents-Packing-List-01.png[]
...
image::order-processing/orders/settings/documents/assets/EN-Settings-Orders-Documents-Packing-List-02.png[]
...
image::order-processing/orders/settings/documents/assets/EN-Settings-Orders-Documents-Packing-List-03.png[]
...
For further information about generating packing lists, refer to the **<<order-processing/orders/fulfillment/packing-list#, Packing list  >>** page of the manual.
...
image::order-processing/orders/fulfillment/assets/EN-ENG-Packliste01-SI.png[]
