...
[#100]
== General information about the packing list
...
.Options in the *Packing list* menu¤image::order-processing/orders/order-documents/assets/EN-Settings-Orders-Documents-Packing-List-01.png[]
