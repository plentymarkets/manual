...
In the **Name** column, you can enter different names for these statuses or add further statuses. These statuses is displayed in your plentymarkets system. If the text in the **Name** column is left empty or deleted, then the corresponding order status will not be displayed in your system.
