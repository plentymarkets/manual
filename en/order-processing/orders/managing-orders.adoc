...
Go to <<omni-channel/online-store/setting-up-clients/order-process#, **System » Client » Open client » Order process » Settings**>> to activate or deactivate the **Purchaser's IP address** option.
...
. Go to **System » Client » Open client » Locations » Open location » Documents » Refund reversal**.
