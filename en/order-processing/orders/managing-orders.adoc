...
[#830]
=== Creating one multi-order per customer
...
Use the event procedures available in your plentymarkets system to automatise the generation of multi-invoices. Proceed as follows to set up the event procedure:
