...
All of the credit notes for a customer class will be saved together in a multi credit note. Depending on the workflow in your own company, it may be a good idea to create special <<crm/managing-contacts#15, customer classes>> for multi credit notes.
