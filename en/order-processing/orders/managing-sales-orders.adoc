...
Orders are retrieved from different referrers and collected in the order overview listed under **Orders » Edit orders**. Here, they are managed using a **<<order-processing/orders/settings/order-status#, status system  >>**. You can use the order search to list all of your orders or to find very specific orders. Use the filters to search for orders that fulfill specific criteria.
...
image::order-processing/orders/editing-sales-orders/assets/EN-SearchingOrders-01.png[]
...
image::order-processing/orders/editing-sales-orders/assets/EN-SearchingOrders-02.png[]
...
image::order-processing/orders/editing-sales-orders/assets/EN-SearchingOrders-03.png[]
...
image::order-processing/orders/editing-sales-orders/assets/EN-SearchingOrders-04.png[]
...
Use the **Document** filter to search for orders for which a <<order-processing/orders/settings/documents#, **document**  >> of a certain type has already been created. The following two options are available:
...
image::order-processing/orders/editing-sales-orders/assets/EN-SearchingOrders-05.png[]
...
image::order-processing/orders/editing-sales-orders/assets/EN-SearchingOrders-06.png[]
...
image::order-processing/orders/editing-sales-orders/assets/EN-SearchingOrders-07.png[]
...
image::order-processing/orders/editing-sales-orders/assets/EN-SearchingOrders-08.png[]

__Image 8: information in the order overview__

You can see quick information about an order by looking at its title in the overview. You can see the <<order-processing/orders/settings/order-status#, **status**  >> and logos that show the link::/[**shipping service provider**] and the link::/[**payment method**] (image 8, arrow). You may see other icons there as well depending on the configuration and the procedures that were carried out.

image::order-processing/orders/editing-sales-orders/assets/EN-SearchingOrders-09.png[]
...
|image::order-processing/orders/editing-sales-orders/assets/AuftragsStatus.png[]
...
|image::order-processing/orders/editing-sales-orders/assets/VersanddienstleisterDPD.png[]

|Shipping service provider, in the icon example **DPD**

|image::order-processing/orders/editing-sales-orders/assets/Packstation.png[]
...
|image::order-processing/orders/editing-sales-orders/assets/Selbstabholer.png[]

|Self pickup

|image::order-processing/orders/editing-sales-orders/assets/Schnellversand.png[]

|Shipping method or service offered by a shipping service provider, for example **express shipping**

|image::order-processing/orders/editing-sales-orders/assets/ZahlungsartPayPal.png[]

|Payment method, example icon is **PayPal**

|image::order-processing/orders/editing-sales-orders/assets/WarenausgangGebucht.png[]

|Outgoing items booked (image 9)

|image::order-processing/orders/editing-sales-orders/assets/Mahnstufe.png[]

|Dunning level, example icon is **dunning level 2**

|image::order-processing/orders/editing-sales-orders/assets/Markierung.png[]

|Flag

|image::order-processing/orders/editing-sales-orders/assets/Lieferland.png[]

|Country of delivery

|image::order-processing/orders/editing-sales-orders/assets/Waehrung.png[]

|Currency

|image::order-processing/orders/editing-sales-orders/assets/Zahlungsstatus.png[]
...
__**image::order-processing/orders/editing-sales-orders/assets/EN-SearchingOrders-10.png[]**__
...
|image::order-processing/orders/editing-sales-orders/assets/Auftragsbestaetigung.png[]

|**Create order confirmation**

|image::order-processing/orders/editing-sales-orders/assets/RechnungErstellen.png[]

|**Generate invoice**

|image::order-processing/orders/editing-sales-orders/assets/ZahlungseingangDirektBuchen.png[]

|**Book incoming payment directly**

|image::order-processing/orders/editing-sales-orders/assets/LieferscheinErstellen.png[]

|**Create delivery note**

|image::order-processing/orders/editing-sales-orders/assets/WarenausgangBuchen.png[]

|**Book outgoing items**

|image::order-processing/orders/editing-sales-orders/assets/Tracking-URL.png[]

|**Display the tracking URL:** Tracking of packages for sent orders

|image::order-processing/orders/editing-sales-orders/assets/Auftragsnotiz-anlegen.png[]

|**Add order note** to orders that do not yet have a note.

|image::order-processing/orders/editing-sales-orders/assets/Kundennotiz.png[]
...
|image::order-processing/orders/editing-sales-orders/assets/Auftragsnotiz.png[]

|**Customer notes**. Displays the text that was saved in the order under **Customer notes**.

|image::order-processing/orders/editing-sales-orders/assets/EMail.png[]

|The customer's email address: Send an email to the customer of the order.

|image::order-processing/orders/editing-sales-orders/assets/EMailService.png[]

|Open the **Email service** tab

|image::order-processing/orders/editing-sales-orders/assets/VorgaengeAnzeigen.png[]

|**Show existing processes** Shows e.g. a list of returns and credit notes including date and value.

|image::order-processing/orders/editing-sales-orders/assets/WarenbestandErmitteln.png[]

|**Calculate stock** Opens the stock overview. +
**<<order-processing/orders/editing-sales-orders/tab-search#160, Create reorders by clicking on the shopping cart icon >>**.

|image::order-processing/orders/editing-sales-orders/assets/ArtikellisteSchliessen.png[]
image::order-processing/orders/editing-sales-orders/assets/ArtikellisteOeffnen.png[]

|Open or close the **item list** in an order

|image::order-processing/orders/editing-sales-orders/assets/NachbestellungAnzeigen.png[]
...
image::order-processing/orders/editing-sales-orders/assets/EN-SearchingOrders-11.png[]
...
image::order-processing/orders/editing-sales-orders/assets/EN-SearchingOrders-12.png[]
...
Before you create your first credit note, go to **<<order-processing/orders/settings/basic-settings#, Settings » Orders » Basic settings  >>** and check the standard status for credit notes. Change this setting if necessary and then save your settings.

[IMPORTANT]
.Save the basic settings
====
The basic settings in the **<<order-processing/orders/settings/basic-settings#, Settings » Orders » Basic settings  >>** menu have to be saved once when the system is first set up. The settings will not go into effect until they have been saved. As such, you should click on the save icon even if you have not made any changes.
====
...
image::order-processing/orders/editing-sales-orders/assets/EN-Editing-Orders-Credit-Note-01.png[]
...
image::order-processing/orders/editing-sales-orders/assets/EN-Editing-Orders-Credit-Note-02.png[]
...
image::order-processing/orders/editing-sales-orders/assets/EN-Editing-Orders-Credit-Note-03.png[]
...
All of the credit notes for a customer class will be saved together in a multi credit note. Depending on the workflow in your own company, it may be a good idea to create special link::/[**customer classes**] for multi credit notes.
...
You have to create the document template **Credit note** before you will be able to generate receipts for credit notes. Go to **<<order-processing/orders/settings/documents#, Settings » Orders » Documents  >>** to set up this document template.
...
image::order-processing/orders/editing-sales-orders/assets/EN-Editing-Orders-Credit-Note-04.png[]
...
image::order-processing/orders/editing-sales-orders/assets/EN-Editing-Orders-Credit-Note-05.png[]
...
image::order-processing/orders/editing-sales-orders/assets/EN-Editing-Orders-Credit-Note-06.png[]
...
Click on the **Payment** tab to see all payments and partial payments that belong to the order. Use the filters to search for specific payments of the order. In the **Payments** tab you can see the total invoice amount, the amount paid and the amount that is still pending. These numbers give you an overview. You can use the **Book payment** icon to <<order-processing/orders/editing-sales-orders/credit-note#4-2, **manually** >> book refunds in this tab.
...
image::order-processing/orders/editing-sales-orders/assets/EN-Editing-Orders-Credit-Note-07.png[]
...
You can enter up to 20 reasons for returns. These reasons can then be selected in a return's <<order-processing/orders/editing-sales-orders/return#, **Settings**  >> tab.

image::order-processing/orders/settings/sales-order-types/assets/EN-Settings-Order-Types-Return-01.png[]
...
image::order-processing/orders/settings/sales-order-types/assets/EN-Settings-Order-Types-Return-02.png[]
...
If you want to reimburse the item's costs, create a **credit note** in the system. For further information, refer to the **<<order-processing/orders/editing-sales-orders/credit-note#, Credit note  >>** page of the manual. +

In case of exchange or repair, create a **warranty**. Go to <<order-processing/orders/settings/basic-settings#, **Settings » Orders » Basic settings**  >> to select whether the **shipping costs** should be covered in the warranty.
...
image::order-processing/orders/editing-sales-orders/assets/EN-Orders-Edit-Warranty-01.png[]
...
image::order-processing/orders/editing-sales-orders/assets/EN-Orders-Edit-Warranty-02.png[]
...
image::order-processing/orders/editing-sales-orders/assets/EN-Orders-Edit-Warranty-03.png[]
...
image::order-processing/orders/editing-sales-orders/assets/EN-Orders-Edit-Warranty-04.png[]
...
image::order-processing/orders/settings/sales-order-types/assets/EN-ENG-Einstell-Auftraege-Typen-Lieferauftrag01-SI.png[]
...
image::order-processing/orders/editing-sales-orders/assets/EN-ENG-Auftraege-Lieferauftrag01-SI.png[]
...
image::order-processing/orders/editing-sales-orders/assets/EN-ENG-Auftraege-Lieferauftrag02-SI.png[]
...
For further information, refer to the **Settings » Orders » <<order-processing/orders/settings/basic-settings#, Basic settings  >>** page of the manual.
...
image::order-processing/orders/editing-sales-orders/assets/EN-ENG-Auftraege-Lieferauftrag03-SI.png[]
...
image::order-processing/orders/editing-sales-orders/assets/EN-ENG-Auftraege-Lieferauftrag04-SI.png[]
...
image::order-processing/orders/editing-sales-orders/assets/EN-ENG-Auftraege-Lieferauftrag05-SI.png[]
...
image::order-processing/orders/editing-sales-orders/assets/EN-ENG-Auftraege-Lieferauftrag06-SI.png[]
...
image::order-processing/orders/editing-sales-orders/assets/EN-ENG-Auftraege-Lieferauftrag07-SI.png[]
...
image::order-processing/orders/editing-sales-orders/assets/EN-ENG-Auftraege-Lieferauftrag08-SI.png[]
...
image::order-processing/orders/editing-sales-orders/assets/EN-ENG-Auftraege-Lieferauftrag09-SI.png[]
...
image::order-processing/orders/editing-sales-orders/assets/EN-ENG-Auftraege-Lieferauftrag10-SI.png[]
...
.Default settings for editing orders (variable user)
====
In order for __**variable users**__ to be able to open orders, go to <<order-processing/orders/settings/basic-settings#, **Settings » Orders » Basic settings**  >> and save default statuses for **returns** and **credit notes**. No status is saved here as the default setting.
...
Variable users can only create **returns**, **warranties** and **repairs** if they are also authorized to work with the standard statuses that are saved for these types of orders under <<order-processing/orders/settings/basic-settings#, **Settings » Orders » Basic settings**  >>. Variable users are given the right to work with statuses in their **user profile** under **link::/[Tab: Right » Tab: Visibility]**.
====
...
image::order-processing/orders/editing-sales-orders/assets/EN-Orders-Edit-New-Order-01.png[]
...
image::order-processing/orders/editing-sales-orders/assets/EN-Orders-Edit-New-Order-02.png[]
...
image::order-processing/orders/editing-sales-orders/assets/EN-Orders-Edit-New-Order-03.png[]
...
image::order-processing/orders/editing-sales-orders/assets/EN-Orders-Edit-New-Order-04.png[]
...
If you want to determine certain settings for new orders, e.g. to automatically include certain items in new orders, create an <<order-processing/orders/settings/sales-order-template#, **order template**  >>.
...
image::order-processing/orders/editing-sales-orders/assets/EN-Orders-Edit-New-Order-05.png[]
...
====
If you use an <<order-processing/orders/settings/sales-order-template#, **order template**  >> that contains items, first select the order template from the **Use template** drop-down menu within the **Order data** section of the new order. Then save the new order. You will be able to add further items to the order once you have saved the order for the first time.
====

image::order-processing/orders/editing-sales-orders/assets/EN-Orders-Edit-New-Order-06.png[]
...
Now continue editing the order as described on the <<order-processing/orders/editing-sales-orders/changing-a-sales-order#, **Changing an order**  >> page of the manual.

[IMPORTANT]
.E-mailing
====
No automatic e-mail, e.g. order confirmation, is sent to the customer for manually created orders. This is because the system can not know when the settings were carried out for this order. Therefore, email templates have to be sent manually. This is done in the order's <<order-processing/orders/editing-sales-orders/changing-a-sales-order#5, **Email** >> tab.
====

=== Splitting up orders

Go to <<order-processing/orders/editing-sales-orders/changing-a-sales-order#3, **Orders » Edit orders » Open order » Tab: Overview** >> to split orders. An order can only be **__split__** if the following conditions are met:
