...
A message is displayed once your customer has finished placing an order. Then, the customer is forwarded to the *Order history* where he or she must click on *Pay now* in the *Payment method* area. Afterwards, the customer is forwarded to ConCardis and has to enter the credit card data (<<image-concardis-entry-mask>>).
