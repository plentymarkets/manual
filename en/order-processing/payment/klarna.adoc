...
*_Important:_* In plentymarkets, Klarna is available for the <<order-processing/fulfilment/preparing-the-shipment#100, countries of delivery>> Germany, Austria, the Netherlands, Denmark, Finland, Norway and Sweden. This means that only customers based in these countries can pay orders using Klarna.
