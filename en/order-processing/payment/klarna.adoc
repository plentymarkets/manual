...
Go to **<<omni-channel/online-store/setting-up-clients/online-store#, Settings » Client (store) » Standard » Online store » Basic settings>>** and make sure that you have selected the option **Enable login for every store** in the line **Login**. This makes it possible to support several clients.
