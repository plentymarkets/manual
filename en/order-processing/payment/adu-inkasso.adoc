...
Set up **link:http://www.adu-inkasso.de/en/home/[ADU-Inkasso, window="_blank"]** (Allgemeiner Debitoren- und Inkassodienst GmbH) in plentymarkets to manage outstanding debts by transferring the data automatically to ADU-Inkasso with the help of a specific sales order status. The current processing status of outstanding debts is visible in the back end. Learn how to set up the interface to ADU-Inkasso in your plentymarkets system.

[#10]
== Registering with ADU-Inkasso

Register with link:https://www.auskunft.inkassounternehmen.de/?action=register[**ADU-Inkasso**, window="_blank"] (German only) in order to use its services. You will receive your access data to the ADU-Inkasso online portal once you have registered and signed a contract.
...
* Enter access data
* Enter PlentyID and SOAP-WSDL. This information can be found in the **Settings » Basic settings » API » Data** menu.
* Save login data

Once you have activated the interface, you can select an **<<order-processing/orders/settings/order-status#, order status  >>** to display the corresponding debts in the online portal. Furthermore, you can specify whether debts should be transferred to ADU-Inkasso automatically or manually. For further information, refer to the **link:http://www.adu-inkasso.de/fileadmin/user_upload/Beschreibung_plentymarkets.pdf[Interface description, window="_blank"]** page (German only) of ADU-Inkasso.
