...
You need to confirm UPG that you have sent the items to your customer before you will receive the customers payment from UPG. Set up an <<order-processing/orders/settings/event-procedures#, **event procedure**  >> to automatically send shipping confirmations when the outgoing items are booked.
...
Set up an <<order-processing/orders/settings/event-procedures#, **event procedure**  >> to automatically inform UPG of cancellations.
