...
.SSL certificate
====
Use the URL with http instead of https if you do not use SSL encryption in your online store. We recommend that you use an <<basics/working-with-plentymarkets/plentymarkets-account#ssl-certificate, **SSL certificate**>>.
====
