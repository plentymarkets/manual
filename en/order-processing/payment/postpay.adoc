...
If you already have an **link:https://de.allyouneed.com/de/customerlogin.html[Allyouneed.com^]** seller contract, you do not need to register again. You can directly begin to **<<order-processing/payment/postpay#30, set up POSTPAY>>**.
