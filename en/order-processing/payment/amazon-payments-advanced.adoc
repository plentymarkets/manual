...
Your online store needs to have an **<<basics/working-with-plentymarkets/plentymarkets-account#ssl-certificate, SSL certificate  >>** in order for you to be able to use Amazon Payments Advanced. Several elements of this payment method are also included in the **CMS**. This makes it necessary to <<omni-channel/online-store/cms#web-design-editing-the-web-design, **publish the design**  >> after configurations or changes have been carried out.
...
Set up an <<basics/automation/event-procedures#, **event procedure**  >> to automatically inform Amazon of cancellations.
