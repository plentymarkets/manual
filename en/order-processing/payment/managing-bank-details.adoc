...
====
The EBICS integration in plentymarkets is now available as a link:https://marketplace.plentymarkets.com/plugins/payment/Ebics_5098[*plugin in the plentyMarketplace*, window="_blank"]. In the user guide, you can find all information on how to use the new integration in your system.
====
...
Go to **Settings » Orders » Documents** and click on the **SEPA direct debit mandate** submenu. There is a template for configuring the SEPA direct debit mandate. For further information about documents, refer to the **<<order-processing/orders/order-documents#, Document templates>>** page of the manual.
...
Use the plentymarkets Client to set up processes to automate your SEPA payments. Go to **Settings » Processes** and use the procedures <<basics/automation/processes/procedures#400, **SEPA Pain001**>> and <<basics/automation/processes/procedures#410, **SEPA Pain008**>>.
