...
====
The EBICS integration in plentymarkets is now available as a link:https://marketplace.plentymarkets.com/plugins/payment/Ebics_5098[*plugin in the plentyMarketplace*^]. In the user guide, you can find all information on how to use the new plugin in your system.
====
