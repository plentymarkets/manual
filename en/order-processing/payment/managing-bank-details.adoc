...
*_Important_*: Click on *Save* every time that data is changed. This will transfer the data to the EBICS tool.

|*Retrieve status*
|Generate an entry in the *API log*. This entry provides information about the current status of the account.  +
*_Important_*: A <<order-processing/payment/managing-bank-details#4, SOAP account>> must be created before the status can be retrieved.
...
*_Important_*: Consult your bank before carrying out this function. It can be used if your bank wants you to transfer HPB, HIA or INI.
...
*_Important_*: The keys are only generated and the retrievals are carried out if the account is activated.
...
*_Important_*: You have to activate the statement of account in order for interim transaction reports to be confirmed. For further information, refer to <<order-processing/payment/managing-bank-details#190, Retrieval times>>.
