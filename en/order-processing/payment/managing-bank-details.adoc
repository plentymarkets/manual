...
|*Open log*
|Open the API log and display the EBICS process overview. To access the log, select the option *electronic banking* from the *API name* drop-down list and click on *Search*.
