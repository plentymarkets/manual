...
. Go to *System » Orders » Payment » EBICS*.
...
. Carry out the settings as desired. Pay attention to the information given in <<table-ebics-basic-settings>>.
. *Save* the settings.
...
The email template is sent by clicking on the *Group function* button under *CRM » Edit customer*.
...
Use the plentymarkets Client to set up processes to automate your SEPA payments. Go to *System » Processes* and use the procedures <<basics/automation/processes/procedures#400, SEPA Pain001>> and <<basics/automation/processes/procedures#410, SEPA Pain008>>.
