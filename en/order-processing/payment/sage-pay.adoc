...
Set up an <<basics/automation/event-procedures#, **event procedure**  >> to automatically inform Sage Pay of cancellations.
...
If you already received a payment and you want to refund a customer, set up an <<basics/automation/event-procedures#, **event procedure**  >> to automatically send credit notes to Sage Pay.
