...
**link:https://www.arvato.com/finance/en.html[arvato Financial Solutions, window="_blank"]** is a financial solutions provider with sector-specific solutions in the areas **<<order-processing/payment/_arvato#10, debt collection>>** and **<<order-processing/payment/_arvato#40, credit rating>>**. On this page, you will find detailed information setting up arvato and arvato infoscore in plentymarkets.
