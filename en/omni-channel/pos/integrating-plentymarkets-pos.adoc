...
Table 2 describes the menu bar of a POS.
...
**Account » Order summary » Show order summary**. +
...
Z2 receipts are signed control receipts with an amount of zero (0,00). The RKSV requires you to create a Z2 receipt at the end of each month. The Z2 report for the month of December also serves as an end of year report. You need to print and archive this yearly receipt every year and scan it with the BMF receipt validation app.
