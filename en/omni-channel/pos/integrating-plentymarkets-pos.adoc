...
a|
* Ingenico iPP480 with printer (operating mode **ZVT**, connection type **TCP/IP**) - requires the link:https://marketplace.plentymarkets.com/en/plugins/payment/ingenicozvt_5140[Ingenico ZVT plugin, window="_blank"]
* SumUp Air - requires the link:https://marketplace.plentymarkets.com/en/plugins/payment/sumup_5141[SumUp plugin, window="_blank"] +
...
Once you have booked a POS, you configure it in the plentymarkets back end. You assign a POS to a client by creating and configuring a POS in the **System » Client » Open client » POS** menu. To do so, proceed as described below.
...
. Go to **System » Client » Open client » POS**.
. Click on **New POS**. +
...
====
For the payment method **11 » Cash sale/cash card**, also go to **System » Client » Open client » POS » Open POS » Tab: Payment method** and select **Unconnected device** in the **POS terminal** section.
====
...
* link:https://marketplace.plentymarkets.com/en/plugins/payment/ingenicozvt_5140[Ingenico devices via ZVT interface, window="_blank"]
* link:https://marketplace.plentymarkets.com/en/plugins/payment/sumup_5141[SumUp Air, window="_blank"]
...
|System » Client » Open client » POS » Open POS » Tab: Receipt
|List identical order items
a|
* Individually
* In aggregate
...
. **Save** the settings.
. Go to **System » Client » Open client » POS » Open POS » Basic settings**.
...
2+|*System » Client » Open client » POS » Open POS*
...
Administratively, it is easiest if POS users automatically generate a coupon code when they sell a gift card in plentymarkets POS. The coupon code and its associated value are imported into the campaign linked to the item when the POS order is uploaded. The coupon code is printed on the receipt. In addition, POS users can write the coupon code on a decorative gift card.
