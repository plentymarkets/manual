...
|*Activate quantity input before item scan*
|Activate to allow POS users to enter a quantity before scanning an item. +
Not activated = Scanned items are added to a POS order with a quantity of 1. +
Activated = POS users can enter the quantity before scanning an item. If no quantity is entered before scanning, the scanned item is added to a POS order with a quantity of 1.

|*Activate fast entry of exact amount*
|Activate to confirm receipt of exact amounts without entering the amount received. +
Not activated = POS users always enter the received amount. +
Activated = POS users can tap *Payment received* without entering the received amount first when they receive exact change.

|*Confirm exact amount before completing order* +
(only available if *Activate fast entry of exact amount* is activated)
|Activate to force POS users to confirm receipt of exact amount before completing the order. +
Not activated = The order amount is automatically copied as the paid amount when POS users tap *Payment received* without entering an amount first. +
Activated = A confirmation window opens when POS users tap *Payment received* without entering an amount first. The order total is only inserted as the received amount after the POS user confirms that the customer paid the exact amount.
...
Campaign » Code » Show*
*_Note:_* Coupon rights are only required if you sell gift cards.
|====
