...
.Activate rights
====
For POS users with a variable user class, you need to activate the rights **Create code** and **Show code**. These rights are set in the *System » User » Open user » Tab: Right » Tab: REST-API* menu.
====
