...
. Carry out the settings as desired. Note <<table-POS-receipt-template>>.
. **Save** the settings. +
...
. Carry out the settings as desired. Pay attention to the information given in <<table-POS-shipping-provider-pickup>>.
. **Save** the settings.
...
. Carry out the settings as desired. Pay attention to the information given in <<table-POS-shipping-profile-pickup>>.
. **Save** the settings. +
...
. Carry out the settings as desired. Note <<table-POS-link-mobile-device>>.
. **Save** the settings. +
