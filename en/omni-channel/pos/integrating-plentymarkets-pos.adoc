...
|**Country**
|Select the country in which the POS is to be used from the dropdown list. Default setting is based on the option **Where is the company based (for financial accounting purposes)** in the **<<basics/working-with-plentymarkets/basic-settings/master-data#, Settings » Basic settings » Master data  >>** menu.
