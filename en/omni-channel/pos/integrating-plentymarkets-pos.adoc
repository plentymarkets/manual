...
====
To synchronise POS orders and z reports with the plentymarkets back end, the date and time of the device must be set correctly. As such, we recommend that you let the device set the date and time automatically.
====
