...
|**Operating systems**
a|
* Android devices with OS version 4.2.2 and higher, ARM processor and link:https://cdn.discourse.org/plentymarkets/uploads/default/original/3X/5/b/5b3b12c7adea2b46e1fb4ae4d1b42bc4e8e37fd8.png[device classes^] Small, Normal, Large and X-Large. You can find out the DPI of your mobile device link:http://dpi.lv/[here^].
...
**__Note:__** In Germany and other countries, saving the address is a mandatory legal requirement. Contact your tax consultant for legal advice. Your tax consultant can advise you on the correct location details. +
...
|**Clients (stores)**
|This option is only displayed if at least one client (store) is set up. Select client(s) or **ALL** if you want to use the shipping profile for all online stores.
...
==== Automatically generating gift card gift card at POS
