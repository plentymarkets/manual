...
|**Default customer**
|Select the <<omni-channel/pos/entwurf-kathrin-mobile#90, **Default customer created for POS orders** >> to which you want to assign orders generated with this POS.
