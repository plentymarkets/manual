...
If the plugin plentyPOS Invoice is provisioned in the plentymarkets back end, you can also sell items on account. However, because you cannot save new customer data in plentyPOS, only existing customers can be issued invoices.
...
. Select <<135, the customer>>. +
*_Important:_* Ensure that the customers really is the person saved in the customer data. +
