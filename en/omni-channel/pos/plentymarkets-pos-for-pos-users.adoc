...
* Open the original order and link the return to this original main order (version 1.9 and higher).
* If the main order is unknown or cannot be opened, create a return without a main order.

=== Booking a return by linking it to the main order (version 1.9 and higher)
