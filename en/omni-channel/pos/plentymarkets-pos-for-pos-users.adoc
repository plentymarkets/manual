...
.Cancelling an order
====
You can cancel a POS order directly after you accepted and booked the payment. To do so, tap **Cancel order** in the **Order created** view. Go to <<omni-channel/pos/plentymarkets-pos-for-pos-users#173, **POS beta » Cancel order**>> to cancel orders created for this POS since the last Z report.
====
