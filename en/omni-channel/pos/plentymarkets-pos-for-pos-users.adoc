...
. Tap **Save till count**. +
→ A till count report is created and saved in the **Orders » Document archive**.
...
→ A deposit or withdrawal is created for the discrepancy with the reason **Till count discrepancy** and saved in the **Orders » Document archive » POS receipt**. +
