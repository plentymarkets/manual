...
*_Tipp:_* If no currency symbol is shown in the field for entering the amount received, you can enter the item quantity and then scan the item. The item is placed in the POS shopping cart with the quantity you entered. This feature must be activated by an administrator for the POS.
...
After you have added all items of a customer to the POS shopping cart and applied any gift cards and/or discounts, you complete the order by booking the payment. Customers can always pay cash. Depending on your store, they might also be able to pay using a debit card or a gift card.
...
*_Tipp:_* If you receive the correct change and can tap the button *Payment received*, you can tap this button without entering the amount. The order total is then inserted as the received amount. This feature must be activated by an administrator for the POS.
