...
Every gift card is equivalent to a unique coupon code. This coupon code is shown on the receipt when you sell a gift card. Customers can redeem a coupon code only if it exists in the system at the time the coupon is redeemed. Depending on the workflow in your store, you either generate an automatic code when you sell a gift card or you receive a list of coupon codes from your employer. These codes either exist in the system already or you save them during the transaction. Your employer will advise you on your store's workflow for selling gift cards.

[.instruction]
Selling a gift card and generating a coupon code automatically:

. Add the gift card to the POS shopping cart.
. Select the quantity.
→ The **Select coupon** window is displayed.
. Tap **Generate**. +
**__Tip:__** You are not prompted to enter a coupon code if you enter a quantity of more than one gift card.
...
[.instruction]
Selling a gift card and entering an existing coupon code:

. Add the gift card to the POS shopping cart.
. Select the quantity 1. +
**__Tip:__** Coupon codes are generated automatically if you select a quantity of more than one gift card.
→ The **Select coupon** window opens.
. Tap on the **Coupon code** field and enter the code.
. Tap **Existing**. +
...
[.instruction]
Selling a gift card and saving a coupon code in the system:
...
. Tap on the **Coupon code** field and enter the code.
. Tap **Generate**. +
→ The **Enter coupon value** window opens.
...
A till count documents the cash on hand of a till, i.e. the amount of cash in coins and notes, at a specific point in time. For till counts, the cash on hand present in the till is physically counted. The result of this count is documented in a count log. Currently, you can only enter Euro denominations.
