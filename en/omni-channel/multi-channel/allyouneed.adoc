...
Pay attention to the tax rates settings in the <<omni-channel/online-store/standard/accounting#, **Settings » Client (store) » Standard » Accounting**  >> menu.
...
Activate the **link::/[payment method]****Allyouneed Payments** as described below.
