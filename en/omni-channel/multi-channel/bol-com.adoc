...
*Password*, +
*Path*
|Enter parameter. The access data including the password and user name are provided by bol.com. The standard FTP port is *21*. The file name for BolOfferExport has the structure &lt;SellerID&gt;.csv. The file name for BolItemExport has the structure &lt;SellerID&gt;.txt. The file has to be saved in the folder */SQUARE/feed*.
