...
First register with **link:https://www.ricardo.ch/registration/schritt1[ricardo.ch^]**. After you have finished registration, use the access data to set up your ricardo.ch account in plentymarkets. Please note that the ricardo.ch website is currently only available in German and French.
...
The setting **Synchronise offer templates** allows you to synchronise your ricardo.ch link:http://www.ricardo.ch/verkauferportal/de-ch/ratgeber/beitr%C3%A4genachverkaufsphasen/einstellen/angebotsvorlageninmyricardo.aspx[**offer templates**^] with plentymarkets. The offer templates will then be available for your ricardo.ch listings in the **Listings » Edit listings** menu. You will find them in the **Market** tab in the **Link to template** drop-down menu.
