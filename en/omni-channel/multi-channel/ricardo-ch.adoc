...
**transmit UPC** = The Universal Product Code will be transferred. In order to use this option, an EAN has to be selected for the setting **<<item/managing-items#250, UPC from EAN field>>**. +
