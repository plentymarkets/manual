...
Go to **System » Listings** to carry out the settings for all listings regardless of the market. In order to create listings in plentymarkets, you must have carried out the following settings and finished creating your **<<item#, items>>**.
...
.Use if-logic
====
You can use the <<omni-channel/online-store/setting-up-clients/cms-syntax#basics-if, **if/else logic**>> for layout templates. They function the same way that the logic works in the **<<omni-channel/online-store/setting-up-clients/cms#web-design, plentymarkets web design>>** area.
====
...
In plentymarkets, there are multiple ways to automatically start listings or restart listings once they were already started. Use the listing scheduler to specify **starting times** for listings. Go to <<omni-channel/multi-channel/ricardo-ch#120, **System » Listings » Scheduler**>> to set up the listing scheduler.
...
[.indented]
**A1**: In the ricardo options, you selected **According to the description** for this listing's guarantee, payment conditions or delivery conditions. However, you haven't saved these general conditions yet. To do so, go to **System » Markets » ricardo » Settings** and save the conditions in the submenus **Terms of guarantee**, **Payment conditions** and **Delivery conditions**.[.instruction]
I am unable to select payment methods in the ricardo settings of a listing.

[.indented]
Go to **System » Markets » ricardo » Accounts** and update the options for the ricardo markets in the **Update options** area.[.instruction]
