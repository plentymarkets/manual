...
====
You can top up your ricardo.ch credit balance directly on ricardo.ch. You need to have credit in order to **<<omni-channel/multi-channel/ricardo-ch#360, start >>** listings.
====
...
Set up an **<<order-processing/orders/settings/event-procedures#, event procedure  >>** to automatically send feedback to ricardo.ch.
...
deactivated = The listing will only be listed if there is sufficient stock available. In this case, sufficient means that stock is larger than the <<omni-channel/multi-channel/ricardo-ch#250, **maximum quantity for sale** >> selected in the listing.
...
|**Listing template**
| Select a **<<omni-channel/multi-channel/ricardo-ch#410, Listing template >>**.
|====
...
For further information about the settings of a market listing, refer to the <<omni-channel/multi-channel/ricardo-ch#230, **Editing listings** >> chapter.
...
. <<omni-channel/multi-channel/ricardo-ch#320, **Filter** >> the items.
.  Activate the option **Create listing** in the **Procedures** area. +
→ Irrelevant settings will be greyed out.
.  Click on **Apply** to create the listings.
...
|**Listing scheduler**
| Select a listing scheduler for the market listing. Select a <<omni-channel/multi-channel/ricardo-ch#120, **listing scheduler** >> in the **Activate listing scheduler** window.

|**Start**
| Start market listing. Select a starting time in the **Start market listing** window.

|**Listing template**
| Apply a listing template to the market listing. Select a <<omni-channel/multi-channel/ricardo-ch#410, **listing template** >> in the **Apply listing template** window.
...
|**Warehouse**
| Select a warehouse or **use the basic setting** that was selected for the **Warehouse selection** option in the <<omni-channel/multi-channel/ricardo-ch#100, **Stock** >> menu.
...
|**Warranty**
| Select **No warranty** or **According to the description**. Enter a descriptive text under <<omni-channel/multi-channel/ricardo-ch#60, **terms of guarantee** >>.

|**Payment conditions**
| Select **According to the description**, **upon pick-up** or **in advance**. Enter a descriptive text under <<omni-channel/multi-channel/ricardo-ch#60, **payment conditions** >>. As an alternative, the customer pays upon pick-up of the item or before receiving the item.
...
|**Delivery conditions**
| Select the delivery conditions. Enter a descriptive text for the option **According to the description** under <<omni-channel/multi-channel/ricardo-ch#60, **delivery conditions** >>.
...
|**Transfer as item number**
| Select which number should be transferred as the **<<omni-channel/multi-channel/ricardo-ch#200, item number >>**.
...
For further information about the settings of a listing, refer to the <<omni-channel/multi-channel/ricardo-ch#230, **Editing listings** >> chapter.
...
.  Go to **Listings » Batch processing » Listings**.
. <<omni-channel/multi-channel/ricardo-ch#320, Filter >> the listings.
.  Activate the option **Copy listings** in the **Procedures** area.
.  Click on **Execute** to copy the listings.
...
|**Stock dependence**
| Select a **<<omni-channel/multi-channel/ricardo-ch#200, stock dependence >>** or **ALL** to only display listings with the selected stock dependence.
...
In plentymarkets, there are multiple ways to automatically start listings or restart listings once they were already started. Use the listing scheduler to specify **starting times** for listings. Go to <<omni-channel/multi-channel/ricardo-ch#120, **Settings » Listings » Listing scheduler** >> to set up the listing scheduler.
...
.  Go to **Listings » Active listings**.
.  Open a market listing.
.  Click on the <<omni-channel/multi-channel/ricardo-ch#250, **Base** >> tab and activate the **Endless lister**. +
...
.  Click on **Group function**.  +
→ The **Group function** window will open.
.  Carry out the settings as desired. Pay attention to the information given in table 14 in the <<omni-channel/multi-channel/ricardo-ch#230, **Editing listings** >> chapter.
...
All active listings are displayed in an overview in the **Listings » Active Listings** menu. Use the filters for <<omni-channel/multi-channel/ricardo-ch#330, **settings** >>, <<omni-channel/multi-channel/ricardo-ch#340, **categories** >> or <<omni-channel/multi-channel/ricardo-ch#350, **directories** >> to narrow down the listings that are displayed. In addition to the filters described in table 16, the following options are available:
