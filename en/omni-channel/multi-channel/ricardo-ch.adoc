...
Set up an <<basics/automation/event-procedures, event procedure>> to automatically send feedback to ricardo.ch.
...
Go to *System » Listings* to carry out the settings for all listings regardless of the market. In order to create listings in plentymarkets, you must carry out the following settings and have created your <<item/introducing-items, items>>.
...
In plentymarkets, there are multiple ways to automatically start listings or restart listings once they have already been started. Use the listing scheduler to specify *starting times* for listings. Go to <<omni-channel/multi-channel/ricardo-ch#3800, System » Listings » Scheduler>> to set up the listing scheduler.
