...
Go to *System » Markets » ricardo » Accounts* to activate new accounts for ricardo.ch. You need to have your access data consisting of the user name and password. Proceed as follows to add one or more accounts.

[.instruction]
Activating a new account:

.  Go to *System » Markets » ricardo » Accounts*.
...
====
You can top up your ricardo.ch credit balance directly on ricardo.ch. You need to have credit in order to <<en/omni-channel/multi-channel/ricardo-ch#3600, start>> listings.
====

Go to *System » Markets » ricardo » Accounts* to rename or delete accounts.
...
The setting *Update options* in the *System » Markets » ricardo » Accounts* menu allows you to update your listing settings and to fix problems, e.g. if no payment method of a ricardo.ch listing has been selected.
...
Go to *System » Markets » ricardo » Settings* to save texts for *Terms of guarantee*, *Payment conditions* and *Delivery conditions*, as well as texts for *Automatic feedback*. You can enter German and French text templates in the text fields. Expand *Other* to set which item name is to be used in the listing title or listing subtitle for the second language.
...
Set up an <<en/basics/automation/event-procedures#, event procedure>> to automatically send feedback to ricardo.ch.
...
Go to *System » Listings* to carry out the settings for all listings regardless of the market. In order to create listings in plentymarkets, you must carry out the following settings and have created your <<en/item#, items>>.
...
.  Configure the settings as described in <<settings-listings>> below.
. *Save* the settings.
...
|Select *Name 1*, *Name 2* or *Name 3*. This item name is transferred. Item names are entered in the <<en/item/managing-items#50, texts>> tab of the item.
|====
...
| Enter the JavaScript code for the content of the data fields *Gallery 1* to *3*. Enter the template variable at the desired location within the *Main frame* tab of the layout template. +
 Make sure that the images used are available via URL. To do so, upload the images on the server e.g. using <<en/basics/data-exchange/ftp-access#, FTP>> or the <<en/omni-channel/online-store/setting-up-clients/cms#image-gallery, image gallery>>.
|====
...
Now link the listings to the layout template. Use one <<en/omni-channel/multi-channel/ricardo-ch#4100, listing template>> for several listings. Individual listings are linked directly within the listing.
...
.Use if-logic
====
You can use the <<en/omni-channel/online-store/setting-up-clients/cms-syntax#basics-if, if/else logic>> for layout templates. It functions the same way that the logic works in the <<en/omni-channel/online-store/setting-up-clients/cms#web-design, plentymarkets web design>> area.
====
...
plentymarkets provides you with multiple possibilities for creating listings. Make sure that you create your <<en/item#, items>> first. Then create your listings in the item overview using batch processing or via an existing listing. Use the data format <<en/basics/data-exchange/export-import/data-formats/itemlistingmarketricardo#, ItemListingMarketRicardo>> in order to automatically create large quantities of items.
...
|*Stock dependence*
|Select the <<en/stock-management/managing-stocks#.%20stock%20dependence, stock dependence>> of the listing. Select one of the following options: +
...
|*Listing template*
|Select a <<en/omni-channel/multi-channel/ricardo-ch#4100, listing template>>.
|====
...
For further information about the settings of a market listing, refer to the <<en/omni-channel/multi-channel/ricardo-ch#2300, Editing listings>> chapter.
...
. <<en/omni-channel/multi-channel/ricardo-ch#3200, Filter>> the items.
.  Activate the option *Create listing* in the *Procedures* area. +
→ Irrelevant settings are greyed out.
.  Click on *Apply* to create the listings.
...
|*Listing scheduler*
| Select a listing scheduler for the market listing. Select a <<en/omni-channel/multi-channel/ricardo-ch#1200, listing scheduler>> in the *Activate listing scheduler* window.

|*Start*
| Start market listing. Select a starting time in the *Start market listing* window.

|*Listing template*
| Apply a listing template to the market listing. Select a <<en/omni-channel/multi-channel/ricardo-ch#4100, listing template>> in the *Apply listing template* window.
...
|*Warehouse*
| Select a warehouse or *use the basic setting* that was selected for the *Warehouse selection* option in the <<en/omni-channel/multi-channel/ricardo-ch#1000, Stock>> menu.
...
|*Warranty*
|Select *No warranty* or *According to the description*. Enter a descriptive text under <<en/omni-channel/multi-channel/ricardo-ch#600, terms of guarantee>>.

|*Conditions*
|Select *According to the description*, *upon pick-up* or *in advance*. Enter a descriptive text under <<en/omni-channel/multi-channel/ricardo-ch#600, payment conditions>>. As an alternative, the customer pays upon pick-up of the item or before receiving the item.
...
|*Delivery conditions*
| Select the delivery conditions. Enter a descriptive text for the option *According to the description* under <<en/omni-channel/multi-channel/ricardo-ch#600, delivery conditions>>.
...
|*Stock dependence*
|Select the <<en/stock-management/managing-stocks#.%20stock%20dependence, stock dependence>> of the listing.
...
For further information about the settings of a listing, refer to the <<en/omni-channel/multi-channel/ricardo-ch#2300, Editing listings>> chapter.
...
.  Go to *Listings » Batch processing » Listings*.
. <<en/omni-channel/multi-channel/ricardo-ch#3200, Filter>> the listings.
.  Activate the option *Copy listings* in the *Procedures* section.
.  Click on *Execute* to copy the listings.
...
|*Stock dependence*
| Select a <<en/omni-channel/multi-channel/ricardo-ch#1000, stock dependence>> or *ALL* to only display listings with the selected stock dependence.
...
.  Go to *Listings » Active listings*.
.  Open a market listing.
.  Click on the <<en/omni-channel/multi-channel/ricardo-ch#2500, Base>> tab and activate the *Endless lister*. +
...
.  Click on *Group function*. +
→ The *Group function* window opens.
.  Carry out the settings as desired. Pay attention to the information given in <<group-function-batch-processing>> in the <<en/omni-channel/multi-channel/ricardo-ch#2800, Editing multiple listings>> chapter.
...
All active listings are displayed in an overview in the *Listings » Active Listings* menu. Use the filters for <<en/omni-channel/multi-channel/ricardo-ch#3300, settings>>, <<en/omni-channel/multi-channel/ricardo-ch#3400, categories>> or <<en/omni-channel/multi-channel/ricardo-ch#3500, directories>> to narrow down the listings that are displayed. In addition to the filters described in <<filter-options-listings>>, the following options are available:
...
[.indented]
In the ricardo options, you selected *According to the description* for this listing's guarantee, payment conditions or delivery conditions. However, you haven't saved these general conditions yet. To do so, go to *System » Markets » ricardo » Settings* and save the conditions in the sub-menus *Terms of guarantee*, *Payment conditions* and *Delivery conditions*.

[.instruction]
I am unable to select payment methods in the ricardo settings of a listing.

[.indented]
Go to *System » Markets » ricardo » Accounts* and update the options for the ricardo markets in the *Update options* section.
...
[.indented]
Go to *System » Markets » ricardo » Accounts* and update the token.
