...
First register with *link:https://www.ricardo.ch/registration/schritt1[ricardo.ch^]. After you have finished the registration, use the access data to set up your ricardo.ch account in plentymarkets. Please note that the ricardo.ch website is currently only available in German and French.
...
Payment conditions; +
Delivery conditions*
| Enter the condition texts for ricardo.ch in German and French. The texts will be used in those *listings* for which you have selected the option *According to the description* in the drop-down lists for *Warranty*, *Payment conditions* and *Delivery conditions* in the <<en/omni-channel/multi-channel/ricardo-ch#2700, Listings » Edit listings » Tab: Market>> menu.
...
Go to *System » Listings* to carry out the settings for all listings regardless of the market. In order to create listings in plentymarkets, you must have carried out the following settings and finished creating your <<en/item#, items>>.
...
|Select *Name 1*, *Name 2* or *Name 3*. This item name is transferred. Item names are saved within the item's <<en/item/managing-items#50, Texts>> tab.
|====
...
====
HTML and CSS skills are necessary to create a layout template. We recommend that you commission a service provider to create a layout template if you are not experienced in doing so. Use the <<en/omni-channel/multi-channel/ebay/ebay-setup#3000, import function>> to import layout templates that were created externally into plentymarkets.
====
...
.  Carry out the settings as desired. Pay attention to the explanations given in tables 11 to 14.
. *Save* the settings.
...
.  Pay attention to the explanations given in table 15.
...
.  Select the filters. Pay attention to the information given in table 16.
.  Pay attention to the explanations given in table 16.
.  Click on *Execute* to apply the settings to the listings.
...
tr>
<td>
<strong>Variations</strong></td>
<td>
Search for listings with or without variations or display <strong>ALL</strong>. Select one of the stores or select the option <strong>ALL</strong>.</td>
</tr
////
...
tr>
<td>
<strong>Special sale</strong></td>
<td>
Search for listings with or without special sales or display <strong>ALL</strong>.</td>
</tr
////
...
.  Select a starting time. Pay attention to the explanations given in table 18.
...
.  Click on *Group function*. +
→ The *Group function* window opens.
.  Carry out the settings as desired. Pay attention to the information given in table 15 in the <<en/omni-channel/multi-channel/ricardo-ch#2800, Editing listings>> chapter.
...
.  Click on *Group function*. +
→ The *Group function* window opens.
.  Pay attention to the explanations given in table 20 and select the procedure.
...
Batch processing includes the same options as the group function. However, the batch processing function edits previously filtered listings. The filters used for narrowing down listings are the same as described for search filters in tables 17 and 19. The procedures are the same as described for group functions in table 20.

[.instruction]
Editing active listings with batch processing:

.  Go to *Listings » Batch processing » Active listings*.
.  Select the filters. Pay attention to the information given in tables 17 and 19.
...
[.indented]
*A1:* In the ricardo options, you selected *According to the description* for this listing's guarantee, payment conditions or delivery conditions. However, you haven't saved these general conditions yet. To do so, go to *System » Markets » ricardo » Settings* and save the conditions in the sub-menus *Terms of guarantee*, *Payment conditions* and *Delivery conditions*.[.instruction]
I am unable to select payment methods in the ricardo settings of a listing.

[.indented]
Go to *System » Markets » ricardo » Accounts* and update the options for the ricardo markets in the *Update options* section.[.instruction]
...
[.indented]
Go to *System » Markets » ricardo » Accounts* and update the token.[.instruction]
I receive the error message InvalidPromotion. What is the problem?

[.indented]
One of the additional options is invalid. Check the additional options that are selected.[.instruction]
