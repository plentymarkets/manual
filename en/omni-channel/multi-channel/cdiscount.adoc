...
You need to register with Cdiscount before setting up Cdiscount in plentymarkets. Fill out the link:https://seller.cdiscount.com/Account_creation.html[**registration form**, window="_blank"] and send your data to Cdiscount. One of the market's support employees will contact you to verify the registration.
...
. Go to **Settings » Markets » Cdiscount » Tab: Settings**.
...
In order to link items, properties etc. with Cdiscount you will have to activate the order referrer Cdiscount in the menu **Settings » Orders » Order referrer**.
...
====
If the setting **Request product creation** is activated in the menu **Settings » Markets » Cdiscount » Tab: Settings**, a SKU will be generated which matches the variation ID for each variation during the export that takes place at night.
====
...
.  Go to **Settings » Item » Barcode » Open barcode**.
.  Place a checkmark next to the referrer **Cdiscount**.
. **Save** the settings.
...
. Go to **Settings » Markets » Cdiscount » Tab: Category list**.
...
. Go to **Settings » Markets » Cdiscount » Tab: Category link**.
...
. Go to **Settings » Markets » Cdiscount » Tab: Manufacturer list**.
...
Go to **Settings » Markets » Cdiscount » Tab: Manufacturer list** and click on **Download manufacturer list as CSV file**.
...
. Go to **Settings » Markets » Cdiscount » Tab: Archive**.
...
In rare cases, the automatic item export may not work correctly. In such cases you can export your French item catalogue as a CSV file to Cdiscount. To do so, go to the <<basics/data-exchange/exporting-data#, **Data exchange » Export » Elastic export**>> menu and carry out the settings as described below. After you have carried out and saved all necessary settings as described below, copy the complete URL and send it to Cdiscount. The hourly stock synchronisation is still carried out automatically.
...
. **Save** the settings.
. Switch to the menu **Data exchange » Export » Elastic export**.
...
====
Link the properties **Gender**, **Main colour**, **Note**, **Comment**, **Marketing description**, **Audience** and **Sport** in the <<item/managing-items#480, **Settings » Item » Properties**>> menu in order to transfer your item catalogue to Cdiscount via a CSV file.
====
...
The menu **Data exchange » API log » Tab: API log** contains a history of processes that run via the Cdiscount interface. The **Cdiscount.com** format is available for Cdiscount.
