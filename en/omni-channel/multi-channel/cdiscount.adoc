...
|*Minimum price*
|Select which price should be the minimum price for an item. +
*Important:* The minimum price must not be the sales price saved for the item. In this case, no minimum price will be exported.
...
. Pay attention to the explanations given in the <<basics/data-exchange/export-import/exporting-data#30, Exporting data with the dynamic import>> page of the manual and carry out the settings.
. *Save* the settings. +
