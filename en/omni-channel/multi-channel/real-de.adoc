...
|Items for which **no limitation** has been selected in the **link::/[Stock]** tab of an item will be offered on real.de with the quantity entered here. As soon as an item has been sold, the quantity saved here will be newly transmitted for sale at the next full hour.
...
Items have to be available for real.de. This is done in the **Availability** tab of an item within the link::/[**Item » Edit item » Tab: Variation ID**] menu.
...
* If you are working with item variations, then click on the link::/[**Stock**] tab of the item and make sure that the limitation is not set to **No limitation**.sein.
...
In order to use link::/[**properties**] for the real.de market, these properties have to be linked with real.de.
...
Activate the link::/[**payment method**]**real.de Payment** as described below.
...
For further information, refer to the **<<basics/start/statistics#, Statistics  >>** and **<<basics/start/statistics/general-statistics/item/tops-flops#, Tops/Flops  >>** pages of the manual. For an example for flat rate and percentage costs, refer to the **<<omni-channel/multi-channel/real-de#20, Basic settings >>** page of the manual.
|====
...
====
Invoices are transferred from real.de into your plentymarkets system. As such, it is not possible to use your system to generate your own invoices. This means that - in contrast to other markets - you cannot manage any invoicing processes via <<order-processing/orders/settings/event-procedures#, **event procedures**  >>.
====
