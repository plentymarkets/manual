...
link:https://www.real.de.de[**real.de**, window="_blank"] is one of the largest fixed price markets in Germany. You can sell items in various product categories on real.de. real.de also processes payments for you. In other words, you are neither charged with payment costs nor do you have to worry about debt collection.

[#10]
== Registering with real.de

In order to use the real.de interface, you have to register your real.de user account as a seller account. To do this, go to the **link:https://www.real.de.[real.de website, window="_blank"]** and save your VAT number in the **Mein Konto** (My account) area. Please note that the real.de website is currently only available in German.
