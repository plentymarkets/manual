...
|*Credit note import*
| Select whether FBA credit notes should be imported into our plentymarkets system. Use this option for Amazon FBA (= Fulfillment by Amazon). For further information, refer to the chapter <<Automatically importing FBA credit notes, Automatically importing FBA credit notes>>. +
*Yes* = FBA credit notes are imported into your plentymarkets system once a day. +
...
====
Do not select an Amazon FBA referrer such as Amazon FBA Germany for the filter *Order > Referrer* if you use the automatic credit note import for FBA credit notes.
====
...
Use the credit note import for Amazon FBA in order to automatically import FBA credit notes into your plentymarkets system. FBA credit notes are then imported once a day.

[IMPORTANT]
.Do not import FBA returns as credit notes via an event procedure
====
If you activate the credit note import, FBA credit notes are automatically imported into your plentymarkets system once a day. Therefore, in this case do not use an event procedure to create credit notes from FBA returns.
====
