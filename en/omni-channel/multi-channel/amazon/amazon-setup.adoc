...
Use the credit note import in order to automatically import FBA credit notes into your plentymarkets system. FBA credit notes are then imported every four hours.
