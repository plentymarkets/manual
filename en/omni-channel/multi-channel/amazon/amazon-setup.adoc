...
*Yes* = FBA credit notes are imported into your plentymarkets system every four hours. +
...
Use the credit note import for Amazon FBA in order to automatically import FBA credit notes into your plentymarkets system. FBA credit notes are then imported every four hours.
