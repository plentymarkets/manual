...
*Yes* = Credit notes are imported into your plentymarkets system once a day. If you select *Yes*, the event procedure for automatically sending credit notes to Amazon has to be deactivated. +
