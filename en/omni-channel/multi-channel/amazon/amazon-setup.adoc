...
Link <<item/managing-items#3000, variation properties>> that you have created in the menu <<item/managing-items#3100, *System » Settings » Properties » Configuration*>> and added to a variation with Amazon in the menu *System » Settings » Properties » Configuration » Tab: Amazon*.
