...
====
You have to define a sales price with no price type. Otherwise, your items will not be exported to Amazon.
====
...
. Got to *System » Item » Sales prices » Open sales price » Tab: Settings*.
. Place a check mark next to the option *RRP* in the line *Price type*.
. Place a check mark next to the desired Amazon referrer.
. Place a check mark next to the desired Amazon account.
. Open the tab *Language*.
. Enter the desired names into the fields *Internal name* and *External name*. +
