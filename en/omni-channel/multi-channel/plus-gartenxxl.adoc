...
*Or:* Instead of linking the _Energy label* property, you can also upload the energy label file to the <<item/managing-items#660, Images>> tab of the item. To do so, proceed as follows.
