...
Items have to be available for idealo Checkout. This is done in the *Availability* tab of an item in the *<<item/managing-items#40, Item » Edit item » Tab: Variation ID>>* menu. Activate the item availability as described below.
