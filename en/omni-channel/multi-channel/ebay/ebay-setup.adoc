...
Use the holiday settings for your eBay shop to inform your customers that you are away. Texts informing your customers about your absence are displayed in your eBay shop and on your listings while you are away. Set your eBay shop into a holiday mode within the menu *System » Markets » eBay » Settings » Tab: Account settings*.
...
|*Activate*
|*Yes* = Select *Yes* to set your eBay shop into the holiday mode. This setting is effective immediately after you have saved it. An absence notice will then be displayed in your eBay shop during the duration of your absence. A text which is automatically generated by eBay and which informs your customers about your absence will be displayed at your listings. +
*No* = This setting is activated by default. No holiday notice will be displayed.

|*Absence notice*
|Enter a text into the free text field. This text will be displayed in your eBay shop when the shop is in the holiday mode. You can use html formatting to format your text.

|*Away until*
|Select a date in the format *dd.mm.yyyy.*. eBay automatically generates a text which is shown at your listings while you are away. If you have entered e.g. a wrong date, click on the *x* within the field of the date to delete the date.
|====
