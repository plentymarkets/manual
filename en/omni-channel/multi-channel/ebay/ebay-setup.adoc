...
On eBay, it is mandatory to match products from specific categories which you want to offer on eBay with ePIDs. An ePID (eBay Product ID) is an eBay-specific product identification that is provided by eBay. ePIDs are used to ensure that one product is only displayed once on eBay. When buyers click on the product, they can decide which seller they would like to buy it from. +
...
- At the moment, only products from specific eBay categories can be matched with ePIDs.
...
| *MLID*
| Enter one or more market listing IDs to search for market listings without ePID. Separate multiple market listing IDs by comma.

| *External listing ID*
| Enter one or more external listing IDs to search for listings without ePID that have this external listing ID. Separate multiple market listing IDs by comma.

| *Item ID*
| Enter one or more item IDs to search for variations without ePID that have this item ID. Separate multiple item IDs by comma.

| *Variation ID*
| Enter one or more variation IDs to search for variations without ePID that have this variation ID. Separate multiple variation IDs by comma.
