...
After changing your eBay account data or your eBay access data, synchronise your account data in the *My eBay* area.
...
*Yes* = No price synchronisation for special sales. If you select *Yes*, special sales on eBay are ended. +
...
*GetCrossSellingData(‘Bundle')* = Displays similar cross-selling items that were marked as item bundle.
...
|*Parts compatibility listing*
| Parts compatibility listing You must have selected a platform. Create a parts compatibility listing in the <<Setting up parts compatibility listings, System » Markets » eBay » Parts compatibility listing>> menu.
