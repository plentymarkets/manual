...
|*Activate*
|*Yes* = Select *Yes* to activate the holiday settings. This setting is effective immediately after you have saved it. An absence notice will then be displayed on the start page of your eBay shop during the duration of your absence. A text which is automatically generated by eBay and which informs your customers about your absence will be displayed at your listings. +
*No* = This setting is activated by default. No holiday notice will be displayed. +
Select *No* to deactivate the holiday settings.

|*Absence notice*
|Enter a text into the free text field. This text will be displayed on the start page of your eBay shop when the shop is in the holiday mode. You can use html formatting to format your text.
|====
