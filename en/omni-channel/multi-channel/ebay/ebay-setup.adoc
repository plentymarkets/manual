...
*Yes* = The variation number is transferred as the SKU. This setting is not recommended because a synchronisation is not possible when the variation number is changed but the listing is not updated. +
