...
The menu **<<basics/data-exchange/api-log#, Data » API log>>**, tab **Flubit** contains a history of processes that run via the Flubit interface. The following formats are available for Flubit:
