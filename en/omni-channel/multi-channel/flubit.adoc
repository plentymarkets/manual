...
Set up an **<<basics/automation/event-procedures#, event procedure>>** to automatically inform Flubit of cancellations. Whenever you are dealing with cancellations, you need to send Flubit a reason for the cancellation. Go to **<<order-processing/orders/managing-sales-orders#order-status, Settings » Orders » Order status>>** and create additional order statuses as needed. The following cancellation reasons can be transferred to Flubit:
