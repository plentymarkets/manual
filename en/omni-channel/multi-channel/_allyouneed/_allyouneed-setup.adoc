...
Set up an <<en/basics/automation/event-procedures, event procedure>> to automatically send returns to Allyouneed.
...
If you already received a payment and you want to refund a customer with a credit note, set up an <<en/basics/automation/event-procedures#, event procedure>> to automatically send credit notes to Allyouneed.
