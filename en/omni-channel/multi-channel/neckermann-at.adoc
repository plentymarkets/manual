...
**Item delivery time 1 - 5** = Enter the delivery time in days for each option. Set up the options for item availability in the <<item/managing-items#190, **System » Item » Availability**>> menu.
