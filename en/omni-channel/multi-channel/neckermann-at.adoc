...
If you are interested in the partner programme of link:http://www.neckermann.at/[**Neckermann Austria**^], then contact Neckermann.at directly. Please note that the neckermann.at website is currently only available in German.
...
// h2>Preisspalte festlegen</h2> <p>Gehen Sie wie im Folgenden beschrieben vor, um für die <a href="{% Link(963) %}"><strong>Auftragsherkunft</strong></a> Neckermann eine Preisspalte festzulegen. Dieser Preis wird auf Neckermann angezeigt.</p> <h5>Preisspalte für Neckermann.at festlegen:</h5> <ol> <li>Öffnen Sie das Menü <strong>System » Aufträge » Auftragsherkunft</strong>.<br /> → Neckermann.at Enterprise gehört zu den Standardherkünften.</li> <li>Wählen Sie eine <strong>Preisspalte</strong> für Neckermann.at, sofern nicht der Standardpreis verwendet werden soll.</li> <li><strong>Speichern</strong> Sie die Einstellungen.</li> </ol
