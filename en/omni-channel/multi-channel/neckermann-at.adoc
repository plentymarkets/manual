...
**Example**: For an item with a stock of 50 and a stock buffer of 10, the value 40 will be transferred as stock. For further information, refer to the **<<stock-management/managing-stocks#, Stock>>**  page of the manual.
...
Activate the **<<order-processing/payment#, payment method>>** **Neckermann Payment** as described below.
