...
Open the menu *Data » API log » Tab: API log* to view an overview of order imports that run via the Rakuten interface. The *Rakuten* format is available for Rakuten.
