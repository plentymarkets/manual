...
*Hourly (with description)* = Price changes will be synchronized automatically every hour. If you use a placeholder for prices in the description of the listing, then the price will also be changed in the listing's description. If the listings' price is tied to the item price, the price synchronisation will take place as soon as the item price is changed. If the listings' price is not tied to the item price, the price synchronisation will take place as soon as the price for the market listing is changed. +
*Hourly (without description)* = Price changes will be synchronized automatically every hour. If you use a placeholder for prices in the description of the listing, then the price will *not* be changed in the listing's description. If the listings' price is tied to the item price, the price synchronisation will take place as soon as the item price is changed. If the listings' price is not tied to the item price, the price synchronisation will take place as soon as the price for the market listing is changed. +
