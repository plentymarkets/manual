...
.  Open the *System » Markets » Neckermann » Neckermann Austria Enterprise* menu.
...
|Enter the image position of the item image if the energy label is saved as an item image instead of as a property. For further information about the energy label, refer to the <<omni-channel/multi-channel/neckermann/neckermann-at-setup#150, Providing information on the energy efficiency>> chapter.

////
<tr>
<td><b>Transfer cross-selling</b></td>
<td><strong>No</strong> = Cross-selling settings are not transferred by default.<br /><strong>Yes</strong> = Cross-selling settings are transferred.</td>
</tr>
////
...
//  and/or neckermann.at Cross-Docking
.
...
Activate the <<en/order-processing/payment/managing-payment-methods, payment method>> *Neckermann Payment* as described below.
