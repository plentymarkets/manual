...
For further information, refer to the **<<basics/start/statistics#, Statistics  >>** and **<<basics/start/statistics/general-statistics/item/tops-flops#, Tops/Flops  >>** pages of the manual. For an example for flat rate and percentage costs, refer to the **<<omni-channel/multi-channel/rakuten#20, Basic settings >>** page of the manual.
|====
...
Set up an **<<order-processing/orders/settings/event-procedures#, event procedure  >>** to automatically send shipping confirmations to Rakuten when the outgoing items are booked.
...
Set up an **<<order-processing/orders/settings/event-procedures#, event procedure  >>** to automatically send returns to Rakuten.
...
Set up an **<<order-processing/orders/settings/event-procedures#, event procedure  >>** to automatically send cancellations to Rakuten.
