...
**Activate** = Order confirmations are transferred to the customer. The email template saved under **<<crm/sending-emails#, Settings » Client (store) » Standard » Email » Automatic email>>** will be sent to the customer.
...
The energy label is saved in the item's **<<item/managing-items#660, Images>>**  tab. To do so, proceed as follows.
