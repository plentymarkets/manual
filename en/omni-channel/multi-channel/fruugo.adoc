...
Items have to be available for Fruugo. This is done in the **Availability** tab of an item within the link::/[**Item » Edit item » Tab: Variation ID**] menu.
...
Activate the **link::/[payment method]****Fruugo** as described below.
...
For further information, refer to the **<<basics/start/statistics#, Statistics  >>** and **<<basics/start/statistics/general-statistics/item/tops-flops#, Tops/Flops  >>** pages of the manual. For an example for flat rate and percentage costs, refer to the **<<omni-channel/multi-channel/fruugo#20, Basic settings >>** page of the manual.
|====
...
Set up an **<<order-processing/orders/settings/event-procedures#, event procedure  >>** to automatically send an order confirmation to Fruugo.
...
Set up an **<<order-processing/orders/settings/event-procedures#, event procedure  >>** to automatically send a shipping confirmation to Fruugo when the outgoing items are booked.
...
Set up an **<<order-processing/orders/settings/event-procedures#, event procedure  >>** to automatically inform Fruugo of cancellations.
...
Set up an **<<order-processing/orders/settings/event-procedures#, event procedure  >>** to automatically inform Fruugo about returns.
