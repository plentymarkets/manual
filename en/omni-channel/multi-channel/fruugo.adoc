...
. Go to **Settings » Markets » Fruugo » Basic settings**.
...
The menu **<<basics/data-exchange/api-log#, Data exchange » API log>>** contains a history of processes that run via the Fruugo interface. The following formats are available for Fruugo:
