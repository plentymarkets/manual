...
**link:http://info.fruugo.com/data/index.html[Fruugo, window="_blank"]** is a global market, which allows customers to shop in their own country's language and currency. Item descriptions are automatically translated into the target language and prices are converted into the local currency. This strengthens your international presence without major expenditure in terms of time or money.

[#10]
== Registering with Fruugo

You need to register with **link:http://info.fruugo.com/merchants/pages/start_selling.asp[Fruugo, window="_blank"]** before setting up Fruugo in plentymarkets.
