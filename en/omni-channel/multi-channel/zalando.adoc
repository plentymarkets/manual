...
You can link the exported Zalando properties to the items in your plentymarkets system. To do so, use the <<basics/data-exchange/export-import/importing-data#, data format>> via the dynamic import.
