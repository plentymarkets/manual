...
For further information about linking properties with real.de, refer to the Best Practice page <<omni-channel/multi-channel/real-de/best-practices#linking-properties, Linking properties to attributes>>.
