...
Activate the <<order-processing/payment/managing-payment-methods#, payment method>> *real.de Payment* as described below.
...
[Caution! Please do not send the money to our bank account. The payment must be sent to real,- Digital Payment & Technology Services GmbH. If you have paid via Klarna, you will receive a separate payment instruction from Klarna. For further information about Klarna, refer tolink:https://www.klarna.com/de/[www.klarna.de^].]
====
...
Set up an <<basics/automation/event-procedures#, event procedure>> to automatically create invoices for real.de.
...
If you create cancellations for real.de with an event procedure in plentymarkets, a credit note is created on real.de.
...
.Returns for real.de
====
Unlike other marketplaces, you cannot send returns to real.de with an event procedure via plentymarkets. Process returns for real.de directly in your real.de seller account.
====
