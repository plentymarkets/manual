...
In this chapter, you will find information about the settings and functions for the market Shopgate. To set up Shopgate in plentymarkets, proceed as follows.
...
| Select whether <<en/order-processing/orders/coupons#, coupon codes>> should be checked and accepted for campaigns with the discount type *Item discount*. +
...
Activate the <<en/order-processing/payment/managing-payment-methods#, payment method>> *Shopgate Payment* as described below.
