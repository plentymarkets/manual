...
In order to be able to use your own properties for the Hood market, these have to be linked with Hood in the **Settings » Item » Properties** menu. You can link up to 12 properties per item and use a maximum of 16 characters per name.
...
. **Save** the settings.  +
→ The property will be included in the item's list of properties on Hood.

[TIP]
.Wildcard character in layout template (eBay)
====
If the **Wildcard character in layout template (Hood)** function is activated, the property will also be displayed in the layout template of a listing provided that the wildcard character is used.
====
