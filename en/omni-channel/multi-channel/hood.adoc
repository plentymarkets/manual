...
First register with link:https://www.hood.de/kostenlos-registrieren.htm?sec=1[**Hood**^]. Create an API password, which you will need when setting up the interface to Hood in plentymarkets.
...
|**Store type**
|Displays the shop package that was booked on Hood, e.g. link:https://www.hood.de/hood-shop-einrichten.htm[**Platinum**^].
|====
...
Hood allows you to upload items and retrieve orders without an active store. You are required to have a store for some options, e.g. uploading item variations. You can link:https://www.hood.de/hood-shop-einrichten.htm[**book**^] a silver, gold or platinum store at Hood.

[#1000]
=== Uploading item variations

You need to book a store in order to upload item variations to Hood. Once you have booked a store on Hood, the items will be integrated into Hood with category links. Set up the shop categories directly on link:https://www.hood.de/tips/924/artikel-anlegen.htm[**Hood**^]. Then load the categories into plentymarkets. This will allow you to select them in the listing.
...
For further information about additional options, refer to the link:https://www.hood.de/tips/721/schritt-4-bilder-zusatzoptionen.htm[**Hood tips**^].
