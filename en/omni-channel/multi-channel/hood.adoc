...
Enter your feedback texts first. Then set up an <<basics/automation/event-procedures#, **event procedure**  >> to automatically send your feedback texts to your buyers. All buyers who gave you feedback will automatically receive a random feedback text in return.
...
Set up an <<basics/automation/event-procedures#, **event procedure**  >> to automatically send a shipping confirmation to Hood when the outgoing items are booked.
...
Set up an <<basics/automation/event-procedures#, **event procedure**  >> to automatically send payment confirmations to Hood.
