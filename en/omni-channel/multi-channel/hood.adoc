...
Go to **System » Listings** to carry out the settings for all listings regardless of the market. In order to create listings in plentymarkets, you must have carried out the following settings and finished creating your **<<item/managing-items#20, items>>**.
...
In plentymarkets, there are multiple ways to automatically start listings or restart listings once they were already started. Use the listing scheduler to specify **starting times** for listings. Go to <<omni-channel/multi-channel/hood#160, **System » Listings » Scheduler**>> to set up the listing scheduler.
