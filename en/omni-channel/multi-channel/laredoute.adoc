...
Set up an **<<order-processing/orders/settings/event-procedures#, event procedure  >>** to automatically send shipping confirmations to La Redoute. The shipping confirmation is automatically sent to La Redoute as soon as the order status changes to **[7] Outgoing items booked**. La Redoute automatically informs the purchaser of the shipment.
...
Set up an **<<order-processing/orders/settings/event-procedures#, event procedure  >>** to automatically send returns to La Redoute.
