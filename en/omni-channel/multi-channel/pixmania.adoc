...
First register with link:https://www.pixmania-pro.co.uk/secure/gb/uk/s_action/register/index.html[**PIXmania**^] in order to set up the interface to PIXmania in your plentymarkets system. You will then receive the access data that you need for the configuration in plentymarkets.
...
. Go to **Settings » Markets » PIXmania » Basic settings**.
...
|**Availability 1 - 5**
|Enter the delivery time in days for each option into the **Domestic** and **Foreign country** fields. Only the days that are entered here will be transferred to PIXmania as a delivery period. 0 is not allowed as a number of days. You have to enter a natural number. Set up the options for item availability in the **<<item/managing-items#, Settings » Item » Item availability>>** menu.
|====
...
. Open the CSV file.
. Click on **Import**.  +
→ After having imported the brand IDs, you can find the PIXmania ID of a manufacturer in the **System » Item » Manufacturers** menu.
...
. Go to **Settings » Markets » PIXmania » Category link**.
. Click on **Browse...**.
. Select the **field separator**.
. **Save** the settings. +
...
Activate the **<<order-processing/payment#, payment method>>** **PIXmania Payment** as described below.
...
In the **Settings » Markets » PIXmania » Export history** menu, you can see an overview of the export history of your PIXmania items. Export histories **in progress** as well as **completed** export histories are displayed here.
