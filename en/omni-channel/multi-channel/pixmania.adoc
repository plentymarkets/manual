...
link:http://www.pixmania.co.uk/index.html[**PIXmania**, window="_blank"] is an online market, which offers a wide range of products in the areas of consumer electronics, home and garden, toys and more. You can offer your new or even used items there and in doing so, extend your reach and generate new customers.

[#10]
== Registering with PIXmania

First register with link:https://www.pixmania-pro.co.uk/secure/gb/uk/s_action/register/index.html[**PIXmania**, window="_blank"] in order to set up the interface to PIXmania in your plentymarkets system. You will then receive the access data that you need for the configuration in plentymarkets.
...
|**Availability 1 - 5**
|Enter the delivery time in days for each option into the **Domestic** and **Foreign country** fields. Only the days that are entered here will be transferred to PIXmania as a delivery period. 0 is not allowed as a number of days. You have to enter a natural number. Set up the options for item availability in the link::/[**Settings » Item » Item availability**] menu.
|====
...
Items have to be available for PIXmania. This is done in the **Availability** tab of an item within the link::/[**Item » Edit item » Tab: Variation ID**] menu. Items for PIXmania also need to have the manufacturer and at least one item image saved for them.
...
. Open the CSV file.
. Click on **Import**.  +
→ After having imported the brand IDs, you can find the PIXmania ID of a manufacturer in the **Settings » Item » Manufacturers** menu.
...
If you have created link::/[**attributes**] in your plentymarkets system, you will have to link these attributes with PIXmania. Proceed as described below to link the attribute Colour with PIXmania. Link further attributes in the same way.
...
Activate the **link::/[payment method]****PIXmania Payment** as described below.
