...
One central system is used for processing orders. This includes the printing of invoices as well as an email service. It is possible to use different <<order-processing/orders/settings/documents#5, numbering>> systems for each client (store) and each country of delivery.
