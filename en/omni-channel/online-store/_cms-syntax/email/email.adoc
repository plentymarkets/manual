...
* $SignatureHTML — This variable contains the signature that was set for this client (store) in HTML format. This signature is saved in the System » Client » Open client » Email » Signature menu.
* $SignatureText — This variable contains the signature that was set for this client (store) in text format. This signature is saved in the System » Client » Open client » Email » Signature menu.
* $SystemPassword
* $SystemURL
* $SystemUsername
...
* $WebstoreID — This variable contains the client ID. The ID is assigned by the system. The ID is listed in the System » Client » Open client » Settings menu under Webstore ID.
* $WithdrawalFormHTML
* $WithdrawalFormText
