...
* $BasketItemAvailabilityIcon — Contains the availability icon for the item availability. An icon is saved in the **Settings » Item » Item availability** menu.
* $BasketItemAvailabilityString — Contains the name of the item availability. The names are saved in the **Settings » Item » Item availability** menu.
...
* $BasketItemReferrerID — Contains the ID of the referrer. The ID is assigned by the system. The IDs are listed in the Settings » Orders » Order referrer menu.
