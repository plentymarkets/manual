...
* <<omni-channel/online-store/cms-syntax#web-design-validator-adderror, AddError>> — Allows you to display an error message. All error messages are managed here: *System » Client » Settings » Languages*
