...
image::omni-channel/online-store/_cms-syntax/case-examples/assets/EN-CMS-Displaying-Item-Variants-Dynamically-01.png[]

__Image 1: example of dynamic item prices__
...
====
Go to **<<omni-channel/online-store/standard/item-layouts/basic-settings#, Settings » Client (store) » Standard » Item layouts » Basic settings  >>** in order to deactivate the display of surcharges. Choose the setting **Do not show** for the option **Attribute surcharge**.
====
...
Now activate the **<<omni-channel/online-store/standard/item-layouts/basic-settings#, client check  >>** in order to display the attribute images dynamically.
...
image::omni-channel/online-store/_cms-syntax/case-examples/assets/EN-CMS-Displaying-Item-Variants-Dynamically-02.png[]

__Image 2: example code for dynamic item images__
...
Go to **CMS » Web design » Layout » CSS » CSSContent** and insert the following <<omni-channel/online-store/_cms/web-design/editing-the-web-design/css#, **CSS code**  >> at the end of any previously existing code. Be sure to save a copy of the previously existing code before you insert the following code.
...
Go to **Settings » Item » Images** and save the maximum values for **<<item/managing-items#450, item attribute images >>** for the options **Maximum width (pixels) of the item attribute image** and **Maximum height (pixels) of the item attribute image**.
