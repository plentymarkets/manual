...
====
Go to **<<omni-channel/online-store/setting-up-clients/item-layouts#, Settings » Client (store) » Standard » Item layouts » Basic settings  >>** in order to deactivate the display of surcharges. Choose the setting **Do not show** for the option **Attribute surcharge**.
====
