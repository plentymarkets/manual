...
====
Go to **<<omni-channel/online-store/setting-up-clients/item-layouts#, System » Client » Open client » Item layouts » Settings>>** in order to deactivate the display of surcharges. Choose the setting **Do not show** for the option **Attribute surcharge**.
====
