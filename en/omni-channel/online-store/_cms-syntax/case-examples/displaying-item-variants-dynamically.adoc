...
Go to **CMS » Web design » Layout » CSS » CSSContent** and insert the following <<omni-channel/online-store/cms#web-design-editing-the-web-design-css, **CSS code**  >> at the end of any previously existing code. Be sure to save a copy of the previously existing code before you insert the following code.
