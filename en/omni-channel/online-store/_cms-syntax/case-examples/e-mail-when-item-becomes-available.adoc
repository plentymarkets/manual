...
.  Go to **System » Client » Open client » Email » Automatic**.
...
Activate the option **Client check** under **Attribute availability** in the menu **System » Client » Open client » Item layouts » Settings** and add the following code example to dynamically show or hide the previously created form depending on the availability of the variation.
