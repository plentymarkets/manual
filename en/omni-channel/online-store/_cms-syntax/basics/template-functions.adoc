...
<<omni-channel/online-store/cms-syntax#web-design-pagedesign, Open PageDesign  >>
=====
...
<<omni-channel/online-store/cms-syntax#web-design-navigation, Open navigation  >>
=====
====
...
<<omni-channel/online-store/cms-syntax#web-design-itemview, Open ItemView  >>
=====
...
<<omni-channel/online-store/cms-syntax#web-design-category, Open Category  >>
=====
====
== E-mail templates
