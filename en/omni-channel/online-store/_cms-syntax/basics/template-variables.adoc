...
**Global template variables** can be used in all templates. Global template variables are only available for web design and categories. You can find these variables in the __Global__ section of the template variables and functions overview.

image::omni-channel/online-store/_cms-syntax/basics/assets/EN-CMS-syntax-Template-Variables-01.png[]
...
image::omni-channel/online-store/_cms-syntax/basics/assets/EN-CMS-syntax-Template-Variables-02.png[]
...
.E-mail
=====
These template variables can only be used in e-mail templates.
