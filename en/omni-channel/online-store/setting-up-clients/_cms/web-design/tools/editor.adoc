...
.Editor availability
====
Go to *System » Settings » Editors* if you want to deactivate the editor for specific areas. If the editor is deactivated, then it will not be included in the drop-down menu in these areas.
====
