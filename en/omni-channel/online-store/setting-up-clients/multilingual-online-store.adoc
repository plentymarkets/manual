...
Click on the link to switch the language. For further information about __**switching the language in the online store**__, refer to the **<<omni-channel/online-store/extras/_language#, Language settings  >>** page of the manual.
