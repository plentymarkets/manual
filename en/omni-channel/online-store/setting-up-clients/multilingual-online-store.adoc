...
Create event procedures to automatically send your email templates when specific events occur. For further information about automatically sending emails, refer to the <<crm/sending-emails#700, Automatic email>> and the <<basics/automation/event-procedures#, Event procedures>> pages of the manual.
