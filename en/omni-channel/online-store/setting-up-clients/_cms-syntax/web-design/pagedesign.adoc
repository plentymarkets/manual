...
* <<omni-channel/online-store/setting-up-clients/cms-syntax#web-design-pagedesign-emaildirid, EMailDirID>> — Returns the drop-down menu for selecting the newsletter.
