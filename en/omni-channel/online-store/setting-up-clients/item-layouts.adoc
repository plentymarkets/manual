...
__**Tip**__: You can modify the error message text **Invalid selection** in the <<omni-channel/online-store/extras/language-packages#, **System » Client » Settings » Languages**>>. Open the drop-down list **Notes** and edit the note **No. 42**.
