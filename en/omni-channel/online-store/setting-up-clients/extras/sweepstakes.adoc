...
After the participant has registered for the sweepstakes, you can send them an email confirmation. To do so, create an *Email template* and select this E-mail template as an *automatic E-mail*.
