...
*System » Client » Select client » Online store » Multilingualism*
...
The following table explains the settings in the *System » Client » Select client » Online store » Multilingualism* menu:
...
====
In order to display the language version of a category in the online store, at least one item has to be saved for the category in the default language and the (default language) category has to have a check mark placed next to it (=activated) under *System » Client » Select client » Categories » Activate*.
====
