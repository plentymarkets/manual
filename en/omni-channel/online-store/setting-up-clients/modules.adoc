...
. Go to *System » Client » Select client » Modules » Link cloud*.
...
. Go to *System » Client » Select client » Modules » Blog*.
...
. Go to *System » Client » Select client » Modules » Forum*.
...
. Go to <<crm/sending-emails#2300, System » Client » Select client » Email » Automatic email>>.
