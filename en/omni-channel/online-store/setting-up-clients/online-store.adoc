...
Go to **<<omni-channel/online-store/standard/online-store/content-pages#, Settings » Client (store) » Standard » Online store » Pages  >>** and link the category pages so that the template functions display content. This can also be done design specifically in the **<<omni-channel/online-store/cms#web-design-editing-the-web-design, CMS » Web design » Settings » Design settings » Tab: Clients  >>** menu. +
...
====
Go to **<<omni-channel/online-store/cms#web-design-user-interface, CMS » Web design  >>** and **__publish the design__** after you have inserted template variables or template functions.
====
