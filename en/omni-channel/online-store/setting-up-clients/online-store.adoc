...
*System » Client » Select client » Online store*
...
*Important*: If you activated this function, the *404 page* that you determined in the *System » Client » Select client » Online store » Pages* menu will not be displayed.
...
*Important*: If you activated this function, the *"Item not found" page* that you determined in the *System » Client » Select client » Online store » Pages* menu will not be displayed.
|====
...
====
The links carried out in the *System » Client » Select client » Online store » Pages* menu do not apply to designs for which category links were carried out in the *CMS » Web design » Settings » Design settings » Tab: Clients* menu. Design specific category links take priority.
====
