...
One example is the <<crm/_tell-a-friend-e-mail#, **tell-a-friend e-mail**  >>. +
...
image::omni-channel/online-store/standard/online-store/assets/EN-Settings-Client-Store-Legal-Information-01.png[]
...
image::omni-channel/online-store/standard/online-store/assets/EN-Settings-Client-Store-Legal-Information-02.png[]
...
Go to **<<omni-channel/online-store/standard/online-store/content-pages#, Settings » Client (store) » Standard » Online store » Pages  >>** and link the category pages so that the template functions display content. This can also be done design specifically in the **<<omni-channel/online-store/_cms/web-design/editing-the-web-design#, CMS » Web design » Settings » Design settings » Tab: Clients  >>** menu. +
...
====
Go to **<<omni-channel/online-store/_cms/web-design/user-interface#, CMS » Web design  >>** and **__publish the design__** after you have inserted template variables or template functions.
====

== General information about the Pages menu

Link **category pages** in this menu. The pages listed here are included in nearly every **online store**. Some of the pages linked in this menu contain **<<omni-channel/online-store/standard/online-store/legal-information#, legal information  >>**. +
...
image::omni-channel/online-store/standard/online-store/assets/EN-Settings-Client-Store-Pages-01.png[]
