...
Click on the **<<omni-channel/online-store/_cms/image-gallery#, Image gallery  >>** link (image 4, blue arrow) to open the image gallery. Here you can select the images that you want to save in the area.

For further information about inserting images from the image gallery, refer to the table in the **<<omni-channel/online-store/_cms/web-design/editing-the-web-design/order-process/shopping-cart#, Shopping cart  >>** page of the manual.
