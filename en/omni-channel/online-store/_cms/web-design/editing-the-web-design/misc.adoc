...
Use this template to display a *list of FAQs* in your online store. Go to <<omni-channel/online-store/cms#faqs, CMS » FAQs>> to create and edit the FAQ entries. The template is displayed with the template variable *$Container_MiscFAQsList*.
...
|*$CountrySelect*
|Drop-down menu for selecting the country (<<image-standard-registration-form>>)
