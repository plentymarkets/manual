...
**Tip:** Alternatively, use HTML code to insert a table into the **source code** or the <<omni-channel/online-store/_cms/web-design/tools/syntax-editor#, **syntax editor**  >>.
