...
* <<omni-channel/online-store/_cms/web-design#, **Web design**  >>: Notes about editing the design in plentymarkets
* <<omni-channel/online-store/_cms/web-design/user-interface#, **User interface**  >>: Information about the **Web design** menu
* <<omni-channel/online-store/_cms/web-design/basic-information-about-syntax#, **Basic information about syntax**  >>: Information about the HTML structure, <<omni-channel/online-store/_cms/web-design/basic-information-about-syntax/displaying-lists#, **lists**  >>, <<omni-channel/online-store/_cms-syntax/basics/variables#, **template variables**  >> and **<<omni-channel/online-store/_cms-syntax/basics/template-functions#, template functions  >>**
...
Now link the category pages. The pages listed here have to be included in nearly every online store. **<<omni-channel/online-store/standard/online-store/legal-information#, Legal information  >>** is an example. Link the pages for every client and for each design separately. All pages have to linked to a category. To do so, proceed as follows.
...
====
To be able to exchange data between Dropbox and plentymarkets, your Dropbox account needs to be linked to plentymarkets in the **<<omni-channel/online-store/global-settings/external-services/dropbox#, plentymarkets » Settings » Client (store) » Global settings » Services » Dropbox  >>** menu.
====

==== Exporting a design to the Dropbox folder

Use the **Export design** function to export a design or individual templates to a folder in your Dropbox account. This folder is the one you set as the base folder in the **<<omni-channel/online-store/global-settings/external-services/dropbox#, plentymarkets » Settings » Client (store) » Global settings » Services » Dropbox  >>** menu. Proceed as described below to export designs to the base folder.
