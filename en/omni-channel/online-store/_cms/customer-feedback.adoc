...
First, set up the module in the menu <<omni-channel/online-store/extras/customer-feedback#, **System » Client (store) » Settings » Feedback**>> and activate the desired types of feedback.
