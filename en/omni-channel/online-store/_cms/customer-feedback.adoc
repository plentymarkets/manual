...
First, set up the module in the menu <<omni-channel/online-store/extras/customer-feedback#, **Settings » Client (store) » Global settings » Customer feedback**>> and activate the desired types of feedback.
...
====
Click on the **eye** symbol in the overview to make a feedback visible or invisible in the online store. If a feedback is invisible, then the eye is crossed out by a **red X**. It is possible to open an individual feedback and then change the visibility with the **Visibility** drop-down menu.
====
...
Set up Google reCAPTCHA for a form for evaluating items in your online store. First, register your online store to use link:https://www.google.com/recaptcha/admin#list[*Google reCAPTCHA*, window="_blank"]. Then, enter the website key and the secret key for your online store.
