...
You can also manage individual images using the **<<omni-channel/online-store/cms#image-gallery, Image gallery>>** menu. Alternatively, you can upload images and documents to the to the **<<item/categories/editing-categories#10, Documents>>** tab of the category where they are to be used.
