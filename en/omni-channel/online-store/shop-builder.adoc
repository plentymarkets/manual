...
. Carry out the settings. Pay attention to the information given in <<omni-channel/online-shop/ceres-einrichten#20, Setting up Ceres>>.
. *Save* the settings. +
...
. Via Drag&Drop, move the desired widget into the preview area.
. Click *Edit*. + ¤The respective editing window will open.
. Carry out the settings. Pay attention to the information given in <<table-elements-shop-builder>>.
. The settings are saved automatically.
...
Settings that have already been carried out in the Ceres configuration respectively in the multilingualism are considered.
