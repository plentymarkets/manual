...
This page serves to highlight the biggest sources of potential errors. Please take a look at the current version comparison on link:https://github.com/plentymarkets/plugin-ceres/compare/2.17.0...2.17.1[GitHub^] for a complete overview of the changes.
