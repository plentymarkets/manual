...
**plentymarkets » CMS » Web design » ItemView » Tab: Settings » Setting: ... _DefaultItemSorting**
...
The item sorting is configured using the **... _DefaultItemSorting** setting of the ItemView templates listed in section 2.2. You can change default settings in the drop-down menu. Image 1 shows an example of the item layout **ItemViewTopSellersList**.

image::omni-channel/online-store/best-practice/assets/EN-Settings-Client-Best-Practice-Item-sorting-01.png[]

__Image 1: CMS settings; item sorting__
...
__Table 1: CMS settings; item sorting__
