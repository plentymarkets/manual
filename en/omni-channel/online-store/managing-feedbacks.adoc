...
====
This page of the manual describes all settings that are available in the *CRM » Feedback ratings* menu in the Terra back end using the centralised login. The <<omni-channel/online-store/extras/customer-feedback#, *Customer feedback*>> page of the manual and the <<omni-channel/online-store/cms#customer-feedback, *Customer feedback*>> chapter that describe the settings in the *CMS » Customer feedback* and *Settings » Client (store) » Global settings » Customer feedback* menus will be simultaneously available. Once the new *CMS » Feedback ratings* menu has completely replaced the old *CMS » Customer feedback* menu, the *CMS » Customer feedback* menu as well as the *Customer feedback* page of the manual will be removed.
====

link:https://marketplace.plentymarkets.com/en/plugins/widgets/Feedback_5115[*Customer feedback*^] is a plugin for the link:https://marketplace.plentymarkets.com/en/plugins/templates/Ceres_4697[*Ceres*^] online store. Install this plugin to display customer reviews in the online store and reply to feedbacks. Release reviews submitted by your customers in the *CMS » Feedback ratings* menu. In this menu, you also reply to customer feedbacks or edit them. It is also possible to migrate existing customer reviews or delete reviews in this menu.

[#100]
== Migrating customer reviews

When switching from your old Callisto online store to the new Ceres online store, your existing customer reviews will also be available in Ceres after migrating them. To migrate existing customer reviews, proceed as follows.

[#200.instruction]
Migrating existing customer reviews:

. Go to *CMS » Feedback ratings*.
. Click on *Migrate existing feedbacks*. +
→ The existing feedbacks will be migrated.

[NOTE]
.Migration of existing customer reviews
====
During the migration process, existing customer reviews will be transferred to the new data base structure. Customer reviews will have a maximum rating of 5 in the new structure. Customer reviews using a rating scale of 10 rating points, will be converted into a maximum of 5 rating points when migrating:

* 1 to 2 stars will be converted into 1 star
* 3 to 4 stars will be converted into 2 stars
* 5 to 6 stars will be converted into 3 stars
* 7 to 8 stars will be converted into 4 stars
* 9 to 10 stars will be converted into 5 stars
...
In order to search for specific customer reviews, enter an ID in the search field or select the appropriate drop-down menu settings.

[#400.instruction]
Searching for customer reviews:

. Go to *CMS » Feedback ratings*.
. In the *Filter* view, enter the ID in the search field or set the filter options in the drop-down menus. Pay attention to the information given in table 1.
. Click on *Search*. +
...
*Yes* = Only customer reviews visible in the online store will be listed in the overview. +
*No* = Only customer reviews not visible in the online store will be listed in the overview.
...
When evaluations and comments are submitted in your online store, they are also listed in the menu *CMS » Feedback ratings*. Here you can make feedback visible or invisible and you can edit comments if they do not meet your standards for netiquette. If you want to edit a customer review, proceed as follows.
...
. *Save* the settings. +
→ The customer review will be updated in the online store.
...
. Enter a reply.
. *Save* the settings. +
→ The reply will be added and displayed in the online store.
