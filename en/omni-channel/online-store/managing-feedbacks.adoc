...
. Go to *CMS » Feedback ratings*.
. In the *Filter* view, enter the ID in the search field or set the filter options in the drop-down menus. Pay attention to the information given in <<table-filters-customer-reviews>>.
. Click on *Search*. +
