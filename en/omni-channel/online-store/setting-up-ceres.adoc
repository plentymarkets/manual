...
Carry out the SEO settings for the *contact page* as well as the pages *Cancellation rights*, *Legal disclosure*, *Privacy policy* and *Terms and conditions* the same way.
