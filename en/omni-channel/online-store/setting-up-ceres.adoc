...
. Select the option *activated* under *Returns*.
. *Save* the settings.
...
.  Enter a name.
.  Select the **event** listed in table 12.
. **Save** the settings.
.  Pay attention to the explanations given in table 12 and carry out the settings as desired.
