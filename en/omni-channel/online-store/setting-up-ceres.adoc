...
|*Primary colour*
| Select the primary colour of your online store. Enter the hex value of the colour you want to use into the input field.

|*Secondary colour*
| Select the secondary colour of your online store. Enter the hex value of the colour you want to use into the input field.
