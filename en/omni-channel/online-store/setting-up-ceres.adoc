...
|*Primary colour*
| Select the primary colour of your online store. For this, you can either use the colour picker or enter a hex value.

|*Secondary colour*
| Select the secondary colour of your online store. For this, you can either use the colour picker or enter a hex value.

|*Success colour*
| Select the colour for success notifications in your online store. For this, you can either use the colour picker or enter a hex value.

|*Information colour*
| Select the colour for information notifications in your online store. For this, you can either use the colour picker or enter a hex value.

|*Warning colour*
| Select the colour for warnings in your online store. For this, you can either use the colour picker or enter a hex value.

|*Danger colour*
| Select the colour for danger notifications in your online store. For this, you can either use the colour picker or enter a hex value.
