...
====
Only order properties of the type *Text* are available in the *Ceres* online store at the moment. Furthermore, organising order properties in property groups is not yet possible.
====
