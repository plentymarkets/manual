...
For further information on setting up pages with the Shop Builder, please refer to the Shop Builder <<omni-channel/online-store/shop-builder#10, manual page>>.
