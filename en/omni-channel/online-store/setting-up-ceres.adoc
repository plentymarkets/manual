...
link:https://marketplace.plentymarkets.com/plugins/templates/Ceres_4697[*Ceres*, window="_blank"] is the official template plugin for the default online store of plentymarkets 7. In the new online store for plentymarkets 7, design and logic are separated from each other. Two plugins are required to integrate the online store into your plentymarkets system. The *Ceres* plugin contains the new standard design of the online store and can be customised to meet your needs. The link:https://marketplace.plentymarkets.com/plugins/templates/IO_4696[*IO*, window="_blank"] plugin contains the logic part of the online store, is a general basis for all design plugins and can also be used by other plugins. In this user guide you learn how to <<#10, *set up Ceres*>> and how to <<#1000, *customise Ceres*>>.
...
====
When deploying the online store plugin *Ceres* in <<basics/first-steps/plugins#50, *Productive*>>, the old plentymarkets online store will be unavailable. *Ceres* will use the URL of the online store.
====
...
|Activate to use the Callisto route pattern for items in Ceres. This is required, for example, when using the link:https://forum.plentymarkets.com/t/howto-ceres-checkout-fuer-callisto-einrichten/69276[*Ceres checkout with Callisto*, window="_blank"].
...
|Enter the IDs of <<#75, *categories*>> of the *Content* type to be displayed in the third footer column of the online store. + *_Note:_* Multiple IDs must be separated by commas.
...
*Age rating* = Activate to display the item's age rating. + *Item ID* = Activate to display the item's ID. +
...
* Store specials: New items, special offers, etc. are displayed in Ceres with the help of tags. For further information, refer to the <<item/managing-items#150, *Adding tags to items*>> chapter.
...
*Similar* = The selected items are similar to the opened item. +*Accessory* = The selected items are accessories of the opened item. +
...
|Enter the name of the item list for the English online store. This name is optional for item lists of the *Last seen* and *Cross-selling* types.
...
. Select one, several or *ALL* containers in which you want to display your item list, e.g. *Homepage: Container 7*, *Homepage: Container 9* or *Single item: Container for item lists*.
. *Save* the settings. +
...
. Carry out the settings. Pay attention to the information given in table 7.
. *Save* the settings.
...
*_Note:_* This setting is activated by default.
...
*Note:_* Customers ordering as a guest are not affected by this setting. Guests will be directly forwarded to the order confirmation page.
...
. Carry out the settings. Pay attention to the information given in table 9.
. *Save* the settings.
...
*Not selected* = Select no value. + *Item ID ⬆* = Sort items by item ID in ascending order. +
...
*_Important_*: In order for this function to work, a position number has to be saved for each of the item variations within the variation tab. +
*Price ⬆* = Display items with the lowest price first. +
*Price ⬇* = Display items with the highest price first. +
*Newest variation* = Display the newest item variations first. +
*Oldest variation* = Display the oldest item variations first. +
...
. Carry out the settings. Pay attention to the information given in table 11.
. *Save* the settings.
...
Set up the default shipping method for your online store. This shipping method will be used for calculating the shipping costs in the shopping cart before a customer registers in your online store. Furthermore the default shipping method is preselected in the checkout. For further information about shipping methods and shipping profiles, refer to Wie Sie Versandarten und Versandprofile einrichten, erfahren Sie unter <<order-processing/fulfilment/preparing-the-shipment#1000, *Creating a shipping profile*>>.
...
Set up the default payment method for your online store. Only  link:https://marketplace.plentymarkets.com/plugins/payment[*Payment method plugins*, window="_blank"] can be used in *Ceres*. The payment method plugins will be available as default payment methods after setup.
...
. Go to *Settings » Client (store) » Standard » Online store » Legal information*.
. Expand a *language*.
...
Set up attributes and properties first and link them with your items. For further information about attributes and properties, refer to the <<item/managing-items#390, *Managing attributes*>> chapters.
...
Find detailed instructions about setting up filters in our link:https://forum.plentymarkets.com/t/howto-filter-in-ceres-einrichten/46679[*forum*, window="_blank"] (German link).
...
Find details instructions about setting up order properties in our link:https://forum.plentymarkets.com/t/howto-bestellmerkmale-in-ceres-einrichten/63155[*forum*, window="_blank"].
...
Then register your online store with link:https://www.google.com/recaptcha/admin#list[*Google reCAPTCHA*, window="_blank"] and set up Google reCAPTCHA.
...
You have the option to show the location of your shop on a Google Map. For this, you need an link:https://developers.google.com/maps/documentation/geocoding/get-api-key[*API key*] for Google Maps.
...
. Click on *Configuration* in the directory tree.
. Click on the *Global* tab.
. Carry out the settings. Pay attention to the information given in table 12.
. *Save* the settings.
...
|*Google Maps API key*
|Enter the Google Maps API key. Alternatively, enter 0 to hide the map.
...
. Click on *Configuration* in the directory tree.
. Click on the *Global* tab.
. Carry out the settings. Pay attention to the information given in table 13.
. *Save* the settings.
...
|*Opening hours*
|Enter the opening hours of a local store. The opening hours will be displayed below the contact data.
...
Set up an <<basics/automation/event-procedures#, **event procedure**>> to automatically send an order confirmation to your customers.
...
.  Enter a name.
.  Select the **event** listed in table 15.
. **Save** the settings.
.  Pay attention to the explanations given in table 15 and carry out the settings as desired.
...
|**Procedure**
|**Customer &gt; Send email**
| Select email template **Online store: Order confirmation**; +
Select **Customer**
|====
...
_Image 1: *Trusted Shops Certified Software*_

You want to certify your online store with Trusted Shops? Ceres has been pre-certified by Trusted Shops, so your certification will be handled as fast and easy as possible. Find all necessary information link:https://www.trustedshops.de/shopbetreiber/bestellen.html?shopsoftware=PLENTYMARKETS[*here*, window="_blank"].
...
*Ceres* is a public project and available on link:https://github.com/plentymarkets/plugin-ceres[*GitHub*, window="_blank"]. You can use the plugin code to create your own template plugin. Please note the following when creating your own template on the basis of *Ceres*:

* Register with link:https://github.com/join?source=header-home[*GitHub*, window="_blank"]
* Open the link:https://github.com/plentymarkets/plugin-ceres[*Ceres*, window="_blank"] project
* Create your own fork of the project
* Change the source code

For further information about changing the source code, refer to our link:https://developers.plentymarkets.com/dev-doc/template-plugins[*template guide*, window="_blank"].
...
Theme plugins are an easy way of customising the looks of *Ceres*. Various link:https://marketplace.plentymarkets.com/plugins/themes[*themes*, window="_blank"] for *Ceres* are available on plentyMarketplace. Changes made to the theme plugin have no impact on future updates of the template plugin *Ceres*.

[#1300]
=== Creating an individual theme

Learn how to create your own theme plugin and how to fully customise *Ceres* in our link:https://developers.plentymarkets.com/dev-doc/theme-plugins[*theme guide*, window="_blank"].
