...
|*B2B customer class*
|Enter the ID for the default customer class of business customers. For further information, refer to the <<crm/managing-contacts#15, Creating a customer class>> chapter of the manual.
...
|Activate to display the homepage created with the ShopBuilder. This option has to be active in order to display a homepage that is not the default Ceres homepage.
...
With the ShopBuilder, you can create and edit the homepage of your link:https://marketplace.plentymarkets.com/plugins/templates/Ceres_4697[Ceres online store^], which just requires a few steps in your terra back end.

For further information on setting up pages with the ShopBuilder, please refer to the ShopBuilder <<omni-channel/online-store/shop-builder#10, manual page>>.
...
|*Tags: Sorting*
|Select the <<#191, Sorting option>> that is selected by default for item sorting in the tag list.
...
*Random* = Display items at random.
