...
If you leave this field empty, the **Send** button will be displayed by default. This button is saved in the <<omni-channel/online-store/cms/web-design/editing-the-web-design/buttons#, **CMS » Web design » Buttons**  >> menu. You can also adapt the button there if needed.
|====
