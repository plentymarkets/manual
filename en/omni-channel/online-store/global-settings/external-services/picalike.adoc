...
**plentymarkets » Settings » Client (store) » Global settings » Services » picalike**
...
* picalike needs to have your plentymarkets system's **export URL** for the image search. Go to **Settings » Client (store) » Global settings » Services » picalike** to find the URL (image 2).
* You need the picalike **API KEY** for activation. This key is saved in the **Setup** menu of your picalike admin area (image 1).

image::omni-channel/online-store/global-settings/external-services/assets/EN-Settings-Client-Global-Services-Picalike-01-SI.png[]
...
. Go to **Settings » Client (store) » Global settings » Services » picalike**.
. Pay attention to the explanations given in the following **table** and carry out the settings as desired.
. Click on the **save icon** to save the settings.

image::omni-channel/online-store/global-settings/external-services/assets/EN-Settings-Client-Global-Services-Picalike-02-SI.png[]
...
image::omni-channel/online-store/global-settings/external-services/assets/EN-Settings-Client-Global-Services-Picalike-03-SI.png[]
