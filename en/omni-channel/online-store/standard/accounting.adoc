...
The standard VAT number is saved in the <<basics/first-steps/master-data#, **Settings » Basic settings » Master data**  >> menu. This standard VAT number is used if you do not save a country-specific VAT number in the tab **VAT rates**.
