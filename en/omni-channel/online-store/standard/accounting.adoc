...
|**Tax rate A to D in %**
|Enter the VAT rates for the country in percent. The text fields **Name** are only relevant for the accounting software <<omni-channel/online-store/standard/accounting#150, **Xero** >>.
...
The standard VAT number is saved in the <<basics/working-with-plentymarkets/basic-settings/master-data#, **Settings » Basic settings » Master data**  >> menu. This standard VAT number is used if you do not save a country-specific VAT number in the tab **VAT rates**.
