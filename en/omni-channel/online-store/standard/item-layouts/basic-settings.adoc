...
Use CSS to modify how the features described here are displayed. For further information and a code example, refer to the <<omni-channel/online-store/cms-syntax/case-examples/displaying-item-variants-dynamically#4-6, **Displaying item variations dynamically** >> best practice page of the manual.
