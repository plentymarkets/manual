...
__**Tip**__: You can modify the error message text **Invalid selection** in the <<omni-channel/online-store/global-settings/language-packages#, **Settings » Client (store) » Global Settings » Language packages**  >>. Open the drop-down list **Notes** and edit the note **No. 42**.
