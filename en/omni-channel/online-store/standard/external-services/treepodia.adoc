...
**plentymarkets » Settings » Client (store) » Standard » Services » Treepodia**
...
If you have entered a short description that is suitable for using in a video, then you can select the corresponding free text field (image 1).
...
The access data is configured in the **Settings » Client (store) » Standard » Services » Treepodia** menu.

image::omni-channel/online-store/standard/external-services/assets/EN-Client-Services-Treepodia-01.png[]

__Image 1: Treepodia; **settings**__

The following table explains the settings in the **Settings » Client (store) » Standard » Services » Treepodia** menu:
...
|**Play video**
|Here you can enter text that you want to have displayed for a **button** that **starts the video**. Enter a text, e.g. **Play video** (image 1).

|**Post video**
|Here you can enter text that you want to have displayed for a **button** that **posts the video**. Enter a text, e.g. **Share video** (image 1).

|**Post video on the following platforms**
|Here you can enter text that is displayed about the platforms that users can share the video on, e.g. **Available platforms:** (image 2).
...
Your system's robots.txt file can be found by going to **Settings » Client (store) » Standard » SEO » robots.txt**.
|====

__Table 1: Treepodia; explanation of the **settings**__

image::omni-channel/online-store/standard/external-services/assets/EN-Client-Services-Treepodia-02.png[]

__Image 2: Treepodia; example for **posting the video on the following platforms**__

=== Export settings

==== Settings

Go to **Settings » Markets » Price comparison portals » Exports** and carry out the export settings. Configure an **export format** for Treepodia there.

image::omni-channel/online-store/standard/external-services/assets/EN-Client-Services-Treepodia-03.png[]

__Image 3: Treepodia; **export settings**__

The following table explains the settings in the **Settings » Markets » Price comparison portals » Exports** menu:
...
**Tip:** Go to **Settings » Orders » Order referrer** if you would like to create additional order referrers.
...
__Table 2: Treepodia; explanation of the **export settings**__

==== Treepodia settings

Go to **Settings » Markets » Price comparison portals » Exports** to save slogans and free text fields.

image::omni-channel/online-store/standard/external-services/assets/EN-Client-Services-Treepodia-04.png[]

__Image 4: Treepodia; **slogans and free text fields**__
...
**Important:****Item data** will only be transferred to Treepodia if the interface is activated (image 1).

|**Shop slogans 1 - 4**
|The slogans should include **up to 5 words**. See image 3 for examples. +
...
__Table 3: Treepodia; **slogans and free text fields**__

==== Filter and formatting

Go to **Settings » Markets » Price comparison portals » Exports** to configure filters and formatting.

image::omni-channel/online-store/standard/external-services/assets/EN-Client-Services-Treepodia-05.png[]

__Image 5: Treepodia; additional **export settings**__
...
__Table 4: Treepodia; additional **export settings**__
...
__Table 5: Treepodia; explanation of the **template variables**__
...
* The interface has to be **activated** (image 1 and table 1).
