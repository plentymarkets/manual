...
The Händlerbund e.V. is Europe's largest online trade association and one of the leading online providers of <<omni-channel/online-store/standard/online-store/legal-information#, **German legal texts**  >>. The company is based in Leipzig. The Händlerbund has an interface for terms and conditions, called the AGB-Schnittstelle. You can use this interface to easily integrate German legal texts into your plentymarkets system. The legal texts can be updated easily, e.g. if they need to be changed because of amendments to the law.
...
Your plentymarkets system will be connected to the Händlerbund via the SOAP interface. In order for it to have access, you first need to create an individual <<basics/working-with-plentymarkets/manage-users#10, **user account** >> with access rights to the API in your system.
