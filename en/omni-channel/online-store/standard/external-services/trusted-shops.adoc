...
image::omni-channel/online-store/standard/external-services/assets/EN-Settings-Client-Standard-Services-Trusted-Shops-01.png[]
...
image::omni-channel/online-store/standard/external-services/assets/EN-Settings-Client-Standard-Services-Trusted-Shops-02.png[]
...
If a Trusted Shops ID is activated, then insert the template variables for Trusted Shops (widget and "write a reviews" icon) into the online store. For further information, refer to the **<<omni-channel/online-store/extras/_trusted-shops/seller-rating#, Seller rating  >>** page of the manual.
...
image::omni-channel/online-store/standard/external-services/assets/EN-Settings-Client-Standard-Services-Trusted-Shops-03.png[]
...
image::omni-channel/online-store/standard/external-services/assets/EN-Settings-Client-Standard-Services-Trusted-Shops-04.png[]
+
