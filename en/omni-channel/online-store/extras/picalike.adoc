...
* picalike needs to have your plentymarkets system's **export URL** for the image search. Go to **System » Client (store) » Settings » Services » picalike** to find the URL (image 2).
...
. Go to **System » Client (store) » Settings » Services » picalike**.
