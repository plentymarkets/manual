...
* picalike needs to have your plentymarkets system's *export URL* for the image search. Go to *System » Client » Settings » Services » picalike* to find the URL (<<image-settings-picalike>>).
