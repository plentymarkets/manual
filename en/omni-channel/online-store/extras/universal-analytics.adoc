...
====
If you use an <<basics/start/plentymarkets-account/service-center/ssl-certificate#, **SSL certificate**  >> for your website, then select **https** in Google Analytics.
====
