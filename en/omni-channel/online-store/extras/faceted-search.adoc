...
This function is configured in several different steps. First, facets are created. Then their settings are customized further. Finally, they are linked to the desired values. Furthermore, you need to go to **System » Client » Select client » Online store » Item search** and select the option **Faceted search**.
