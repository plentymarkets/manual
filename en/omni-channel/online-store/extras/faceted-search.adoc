...
. Go to **System » Client (store) » Settings » Services » Faceted search**.
...
|**Availability**
|Facets of the type **Availability**, e.g. "ships within 24 hours", are linked to the availabilities found under <<omni-channel/online-store/extras/faceted-search#180, **System » Item » Availability**>>.

|**Manufacturer**
|Facets of the type **Manufacturer**, e.g. "Adidas", are linked to the manufacturers found under <<omni-channel/online-store/extras/faceted-search#560, **System » Item » Manufacturers**>>.
|====
