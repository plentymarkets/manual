...
**System » Client » Select client » Services » Treepodia**
...
The access data is configured in the **System » Client » Select client » Services » Treepodia** menu.

image::omni-channel/online-store/extras/assets/EN-Client-Services-Treepodia-01.png[]

__Image 1: Treepodia; **settings**__

The following table explains the settings in the **System » Client » Select client » Services » Treepodia** menu:
...
Your system's robots.txt file can be found by going to **System » Client » Select client » SEO » robots.txt**.
|====
...
Go to **System » Markets » Price analysis » Exports** and carry out the export settings. Configure an **export format** for Treepodia there.

image::omni-channel/online-store/extras/assets/EN-Client-Services-Treepodia-03.png[]

__Image 3: Treepodia; **export settings**__

The following table explains the settings in the **System » Markets » Price analysis » Exports** menu:
...
Go to **System » Markets » Price analysis » Exports** to save slogans and free text fields.
...
Go to **System » Markets » Price analysis » Exports** to configure filters and formatting.
