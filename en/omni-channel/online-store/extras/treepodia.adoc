...
**System » Client » Open client » Services » Treepodia**
...
The access data is configured in the **System » Client » Open client » Services » Treepodia** menu.

image::omni-channel/online-store/extras/assets/EN-Client-Services-Treepodia-01.png[]

__Image 1: Treepodia; **settings**__

The following table explains the settings in the **System » Client » Open client » Services » Treepodia** menu:
...
Your system's robots.txt file can be found by going to **System » Client » Open client » SEO » robots.txt**.
|====
