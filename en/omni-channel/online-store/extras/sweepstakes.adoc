...
. Go to **System » Client (store) » Settings » Sweepstakes**.
...
You can see how many people have participated so far in the **System » Client (store) » Settings » Sweepstakes** menu and there in the **Overview** area. You can identify the winner here once the sweepstakes has ended.
