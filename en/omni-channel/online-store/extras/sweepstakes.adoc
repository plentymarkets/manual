...
. Go to <<crm/sending-emails#1200, **System » Client » Open client » Email » Templates**>>.
. Create a corresponding **E-mail template**.
. Go to <<crm/sending-emails#2300, **System » Client » Open client » Email » Automatic**>>.
...
. Go to <<crm/sending-newsletters#300, **System » CMS » Newsletter » plentymarkets » Email folder**>>.
