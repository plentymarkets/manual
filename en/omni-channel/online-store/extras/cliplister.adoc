...
**System » Client » Open client » Services » Cliplister**
...
This page contains information about the Cliplister video settings that are available for your individual clients (stores). Before carrying out the configuration, you have to activate Cliplister in the menu **<<omni-channel/online-store/extras/cliplister#, System » Client » Settings » Services » Cliplister>>**.
...
The following table explains the settings in the **System » Client » Open client » Services » Cliplister** menu:
