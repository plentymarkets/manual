...
This page contains information about the Cliplister video settings that are available for your individual clients (stores). Before carrying out the configuration, you have to activate Cliplister in the menu **<<omni-channel/online-store/extras/cliplister#, Settings » Client (store) » Global settings » Services » Cliplister  >>**.
...
image::omni-channel/online-store/extras/assets/EN-Settings-Client-Standard-Services-Cliplister-01-SI.png[]
...
image::omni-channel/online-store/extras/assets/EN-Settings-Client-Standard-Services-Cliplister-02-SI.png[]
...
image::omni-channel/online-store/extras/assets/EN-Settings-Client-Standard-Services-Cliplister-03-SI.png[]
