...
**System » Client » Open client » Services » Econda**
...
. Go to **System » Client » Open client » Services » Econda**.
...
. Go to **System » Client » Open client » External services » Econda » Tab: Settings**.
