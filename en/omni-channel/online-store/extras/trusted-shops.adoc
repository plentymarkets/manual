...
link:http://www.trustedshops.com/[*Trusted Shops*, window="_blank"] is the well-known trustmark for online stores which provides buyer protection for online customers.
...
* Futher information under link:http://www.trustedshops.co.uk/seal-of-approval/buyer-protection.html[Questions about buyer protection, window="_blank"]
...
.Tip
====
You can configure the widget's *height*, *width*, *comments* and *branding* in the link:https://www.trustedshops.com/en/shop/login.html[*Trusted Shops System*, window="_blank"].
====
