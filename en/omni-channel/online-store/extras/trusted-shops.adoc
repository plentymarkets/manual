...
. Go to *System » Client » Open client » Services » Trusted Shops*.
...
→ Create the <<crm/sending-emails#1200, *email template*>> under *System » Client » Open client » Email » Templates*.
