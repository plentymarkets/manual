...
* Futher information under link:http://www.trustedshops.co.uk/seal-of-approval/buyer-protection.html[Questions about buyer protection^]

[#30]
=== Configuring the buyer protection Trusted Shops _PLUS_ model

image::omni-channel/online-store/extras/assets/EN-Settings-Client-Standard-Services-Trusted-Shops-01.png[]

_Image 1: entering the *user name* and *password*_
...
image::omni-channel/online-store/extras/assets/EN-Settings-Client-Standard-Services-Trusted-Shops-02.png[]

_Image 2: placing the buyer protection *Trusted Shops _PLUS_* in the shopping cart_
...
_Image 3: *Trusted Rating widget* for the online store_
...
.Seller ratings
====
The seller ratings are not displayed in real time. The widget graphic is reloaded once a day (at night). The widget, as shown in image 3, will only be displayed after 60 seller ratings have been received. Before this point, the *$TrustedShopsRatingShopButton* template variable will be replaced by a "Write a review!" button (image 2).
====
...
_Image 4: example "Write a review! button_
...
. Go to <<basics/automation/procedure-manager#, *Settings » Orders » Procedure manager*>>.
. Go to the *New procedure* tab.
. Go to the *Procedure* tab within the new procedure.
. Use the *Send email template* option to select an email template from the drop-down menu. The template should invite customers to rate your store and should contain the corresponding template variable. +
→ Create the <<crm/sending-emails#1200, *email template*>> under *Settings » Client (store) » Standard » Email » Templates*.
...
image::omni-channel/online-store/extras/assets/EN-Settings-Client-Standard-Services-Trusted-Shops-03.png[]

_Image 5: HTML code of a Trusted Shops seal box from the *Trusted Shops Trustbadge generator*_
...
image::omni-channel/online-store/extras/assets/EN-Settings-Client-Standard-Services-Trusted-Shops-04.png[]
+
_Image 6: graphic path specification in the HTML code_
