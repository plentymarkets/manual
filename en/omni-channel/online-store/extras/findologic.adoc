...
image::omni-channel/online-store/extras/assets/EN-Settings-Client-Standard-External-Findologic-01-SI.png[]
...
**image::omni-channel/online-store/extras/assets/EN-Settings-Client-Standard-External-Findologic-02-SI.png[]**
