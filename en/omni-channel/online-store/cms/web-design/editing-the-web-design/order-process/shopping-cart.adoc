...
**Delivery date** +
The link **Change delivery date** is displayed in the shopping cart. The customer can click on this link and enter a delivery date. If a delivery date was already entered, then the customer will see this date here. You can edit the default texts, **Change delivery date** and **Delivery date** as desired. You can also enter a note that will be displayed. Go to **Settings » Client (store) » Standard » Order process » Basic settings** to configure the delivery date for the order process. For further information, refer to the **<<omni-channel/online-store/standard/order-process/basic-settings#, Basic settings  >>** page of the manual. This page also includes the code that is inserted into the CMS in order to display the delivery date.
...
image::omni-channel/online-store/cms/web-design/editing-the-web-design/order-process/assets/EN-CMS-Web-Design-Editing-Order-Process-Shopping-Cart01.png[]
...
image::omni-channel/online-store/cms/web-design/editing-the-web-design/order-process/assets/EN-CMS-Web-Design-Editing-Order-Process-Shopping-Cart02.png[]
