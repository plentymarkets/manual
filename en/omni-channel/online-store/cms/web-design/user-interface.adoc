...
image::omni-channel/online-store/cms/web-design/assets/EN-CMS-Web-Design-User-Interface-01.png[]
...
|**5**
|**Search function**
|Finds templates with the **<<omni-channel/online-store/cms/web-design/user-interface#2-1, search function >>**.
...
**Apply template** = Applies the content of the particular **<<omni-channel/online-store/cms/web-design/user-interface#2-2, template to a different language >>**. +
...
image::omni-channel/online-store/cms/web-design/assets/EN-CMS-Web-Design-User-Interface-02.png[]
...
image::omni-channel/online-store/cms/web-design/assets/EN-CMS-Web-Design-User-Interface-03.png[]
