...
image::omni-channel/online-store/cms/web-design/assets/EN-CMS-WebDesign-Edit-01.png[]
...
image::omni-channel/online-store/cms/web-design/assets/EN-CMS-WebDesign-Edit-02.png[]
...
image::omni-channel/online-store/cms/web-design/assets/EN-CMS-WebDesign-Edit-03.png[]
...
image::omni-channel/online-store/cms/web-design/assets/EN-CMS-WebDesign-Edit-04.png[]
...
For further information about editing templates, refer to the other pages within this chapter. For further information about applying a template to a different language version, refer to the <<omni-channel/online-store/cms/web-design/user-interface#3-2, **User interface** >> page of the manual. Specifically, refer to the **Apply template** section.
