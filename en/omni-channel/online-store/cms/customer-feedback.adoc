...
First, set up the module in the menu <<omni-channel/online-store/global-settings/customer-feedback#, **Settings » Client (store) » Global settings » Customer feedback**  >> and activate the desired types of feedback.
