...
An **<<omni-channel/online-store/cms-syntax/basics/types#6, array >>** can only consist of one dimension. The individual values of an array can be of different data types.
