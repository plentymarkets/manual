...
image::omni-channel/online-store/cms-syntax/basics/assets/EN-CMS-syntax-Template-Variables-01.png[]
...
image::omni-channel/online-store/cms-syntax/basics/assets/EN-CMS-syntax-Template-Variables-02.png[]
