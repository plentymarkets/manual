...
image::omni-channel/online-store/cms-syntax/case-examples/assets/EN-CMS-Displaying-Item-Variants-Dynamically-01.png[]
...
image::omni-channel/online-store/cms-syntax/case-examples/assets/EN-CMS-Displaying-Item-Variants-Dynamically-02.png[]
