...
:id: WA2EIQR
:keywords: event, events, procedures, order processing, automation, automated, automatic, procedure, filter, creating event procedure, selecting event procedure, filters, activate, activation, activating, procedure manager, event group, event group order generation, event group order change, event group documents, event group payment, event group purchase order, filter group, filter group order, filter group item, filter group customer, filter group shipping, filter group market, filter group purchase order, adding procedures, procedure group, procedure group item, procedure group order, procedure group documents, procedure group customer, procedure group shipping, procedure group payment methods, procedure group return, procedure group market listings, procedure group board, procedure group purchase order, procedure group plugins
...
|This filter identifies order items for which a certain <<item/managijng-items#3000, property>> has been defined in the *Setup » Settings » Properties » Configuration* menu. Within the filter, you can select a property according to which order items are filtered.
...
|*Create card*
|Once the selected event happens, a new card is <<basics/working-with-pletnymarkets/boards#30, added>> in the *plentymarkets Logo (Start) » Boards* menu. +
...
|*Delete cards*
|Once the selected event happens, selected cards are <<basics/working-with-plentymarkets/boards#40, deleted>> in the *plentymarkets Logo (Start) » Boards* menu. +
Select the *Board* and the *Column(s)* whose cards should be deleted within the procedure.

|*Move cards*
|Once the selected event happens, selected cards are <<basics/working-with-plentymarkets/boards#, moved>> in the *plentymarkets Logo (Start) » Boards* menu. +
