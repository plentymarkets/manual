...
Individual procedures are available for: *ClickandBuy*, <<payment/payment-provider/payone#, PAYONE>>, <<payment/payment-provider/postpay#, POSTPAY>>, <<payment/payment-provider/worldpay#, Worldpay>> and <<payment/payment-provider/klarna#, Klarna>>.
...
Individual procedures are available for: <<payment/payment-providers/amazon-pay#, Amazon Pay>>, <<payment/payment-providers/crefopay#, CrefoPay>>, <<payment/payment-providers/payolution#, Payolution>> and <<payment/payment-providers/klarna-checkout-uk#, Klarna UK>>.
...
Individual procedures are available for: <<payment/payment-providers/crefopay#, CrefoPay>>, <<payment/payment-providers/amazon-pay#, Amazon Pay>>, *ClickandBuy*, <<payment/payment-providers/paymorrow#, paymorrow>>, <<markets/plus-gartenxxl#, Netto eStores>>, <<payment/payment-providers/postpay#, POSTPAY>>, <<markets/rakuten/rakute-setup#, Rakuten>>, <<payment/payment-providers/worldpay#, Worldpay>>, <<payment/payment-providers/sage-pay#, SagePay>>, <<payment/payment-providers/klarna-checkout-uk#, Klarna UK>>.
...
|*Create card*
|Once the selected event happens, a <<basics/working-with-plentymarkets/boards#30, new card>> is added in the *plentymarkets logo (Start) » Boards* menu. +
...
|*Move cards*
|Once the selected event happens, selected cards are <<basics/working-with-plentymarkets/boards#40, moved>> in the *plentymarkets logo (Start) » Boards* menu. +
...
|Once the selected event happens, the *PO deliver note* document is generated for orders of the type *Reorder*.
