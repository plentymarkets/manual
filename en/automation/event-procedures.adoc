...
|The procedure sends a shipping conformation to <<markets/otto-market#500, Otto>>.

|*Auftragsstornierung an Otto melden*
|The procedure sends an order cancellation to <<markets/otto-market#500, Otto>>.

|*Retoure an Otto melden*
|The procedure sends a return to <<markets/otto-market#500, Otto>>.

|*Ablehnung der Retoure an Otto melden*
|The procedure sends a rejection of a return to <<markets/otto-market#500, Otto>>.
