...
Go to *<<orders/basic-settings#, System » Orders » Settings>>* to save the percentage for deposits on production items.
...
*Important*: This option is only displayed if the necessary <<orders/managing-orders#320, warehouse assignment>> has been set up correctly.
...
|This procedure deletes an invoice with the payment method *Klarna* when an order is cancelled. Detailed information as well as examples for further event procedures can be found on the <<payment/klarna#, Klarna>> page of the manual.
...
Individual procedures are available for: <<payment/amazon-pay#, Amazon Pay>>, <<payment/upg#, UPG>>, <<payment/klarna#, Klarna>>, <<payment/klarna-checkout-uk#, Klarna UK>>, <<payment/masterpayment#, Masterpayment>>, <<payment/payolution#, Payolution>>, <<omni-channel/multi-channel/plus-gartenxxl#, NettoeStores>>, <<payment/postpay#, POSTPAY>>, *Zentralverkauf*, <<omni-channel/multi-channel/hood#, Hood>>, <<omni-channel/multi-channel/ebay/ebay-setup#, eBay>>, <<omni-channel/multi-channel/rakuten/rakuten-setup#, Rakuten.de>>, <<omni-channel/multi-channel/fruugo#, Fruugo>>, <<omni-channel/multi-channel/flubit#, Flubit>>, <<omni-channel/multi-channel/idealo-checkout/idealo-setup#, idealo>> and <<omni-channel/multi-channel/bol-com#, bol.com>>.
...
Individual procedures are available for: *ClickandBuy*, <<payment/payone#, PAYONE>>, <<payment/postpay#, POSTPAY>>, <<payment/worldpay#, Worldpay>> and <<payment/klarna#, Klarna>>.

|*Send order to Klarna*
|An order is sent to <<payment/klarna#, Klarna>>.

|*Notify Klarna of changes to the order*
|A notification on changes to an order is sent to <<payment/klarna#, Klarna>>.
...
Individual procedures are available for: <<payment/amazon-pay#, Amazon Pay>>, <<payment/upg#, UPG>>, <<payment/payolution#, Payolution>> and <<payment/klarna-checkout-uk#, Klarna UK>>.

|*Send refund*
|A refund is sent to the payment provider. +
Individual procedures are available for: <<payment/masterpayment#, Masterpayment>>, <<payment/paypal-plus#, PayPal PLUS>> and <<payment/paypal#, PayPal>>.

|*Send cancellation*
|A cancellation is sent to the payment provider. +
Individual procedures are available for: <<payment/upg#, UPG>>, <<payment/amazon-pay#, Amazon Pay>>, *ClickandBuy*, <<payment/paymorrow#, paymorrow>>, <<omni-channel/multi-channel/plus-gartenxxl#, Netto eStores>>, <<payment/postpay#, POSTPAY>>, <<omni-channel/multi-channel/rakuten/rakuten-setup#, Rakuten.de>>, <<payment/worldpay#, Worldpay>>, <<payment/sage-pay#, SagePay>>, <<payment/klarna-checkout-uk#, Klarna UK>>.
...
Individual procedures are available for: <<payment/klarna#, Klarna>>, <<omni-channel/multi-channel/amazon/amazon-setup#, Amazon>>, <<omni-channel/multi-channel/plus-gartenxxl#, Netto eStores>>, <<payment/postpay#, POSTPAY>>, <<omni-channel/multi-channel/rakuten/rakuten-setup#, Rakuten.de>>, <<omni-channel/multi-channel/shopgate#, Shopgate>>, <<omni-channel/multi-channel/flubit#, Flubit>>, <<omni-channel/multi-channel/idealo-checkout/idealo-setup#, idealo>>, <<omni-channel/multi-channel/fruugo#, Fruugo>> and <<omni-channel/multi-channel/cdiscount#, Cdiscount>>. +
More information is available on the <<payment#, Payment method>> page of the manual.
