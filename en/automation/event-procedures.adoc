...
For more information on Amazon and ebay orders, refer to the respective manual pages on <<markets/amazon/amazon-setup#4200, Amazon>> and <<markets/ebay/ebay-setup#100, eBay>>.
