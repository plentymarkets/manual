...
Go to *System » Orders » Events* to create a new event procedure. In this menu, you can also view the already existing event procedures and <<automation/event-procedures#300, edit>> them.
...
Enter the percentage value for deposits on production items in the *<<orders/basic-settings#, System » Orders » Settings>>* menu.
...
|*Use order template*
|This procedure automatically uses a certain order template. Order templates are created in the menu *System » Orders » Order template*.
