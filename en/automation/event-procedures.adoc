...
. <<#120, Adding one or more filter(s)>>
. Determining which <<#130, Procedures>> should be carried out by the system once the chosen event takes place
. <<#200, Activating>> the event procedure

For practical examples for using event procedures, refer to the <<basics/automation/best-practices-automation#, Best practices: Event procedures and Procedure manager>> page of the manual.
...
|*Create card*
|Once the selected event happens, a new card is <<basics/working-with-plentymarkets/boards#30, added>> in the *Start » Boards* menu. +
