...
|This procedure registers the return with DHL Retoure Online. One label per order is generated, regardless of the number of packages.

| *Generate DHL Retoure Online label (1 label per package / 1 file)*
|This procedure registers the return with DHL Retoure Online. One label per package is generated. If multiple packages are available, one PDF file with all return labels is generated.

| *Generate DHL Retoure Online label (1 label per package / multiple files)*
|This procedure registers the return with DHL Retoure Online. One label per package is generated. If multiple packages are available, one PDF file per return label is generated.
