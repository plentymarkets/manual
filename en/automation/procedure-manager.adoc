...
The *Procedures* tab in the *System » System settings » Orders » Procedures* menu offers you an overview of all procedures that you have set up. In this list, you can activate, deactivate, rename or delete individual procedures, if necessary. +
