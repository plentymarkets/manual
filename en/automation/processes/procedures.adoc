...
:author: team-mobile
:keywords: Procedures, processes, control processes, controlling processes, plentyBase, plenty Base, control elements, procedure, process, control element, procedure element, sub-procedure, sub procedure, sub-procedures, sub-procedure, work step, work steps
...
| **Store**
| **Display filters** = It will be possible to search for all the pick lists that correspond to a specific webshop. +
**Do not display filters** = It will not be possible to search for pick lists that correspond to a specific webshop.
