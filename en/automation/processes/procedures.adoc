...
|**Item status**
|Select the item status that should be used by default when a return is created. Go to <<orders/managing-orders#400, System » System settings » Orders » Order types » Return>> to create item statuses for returns.
