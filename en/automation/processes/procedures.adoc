...
Use the **SEPA Pain008 procedure** to export transaction files of your <<managing-bank-details#200, SEPA direct debits>> into a ZIP file. Provide your bank with this file after you saved it with a sub-procedure.
