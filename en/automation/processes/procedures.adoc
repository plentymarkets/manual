...
|**Item status**
|Select the item status that should be used by default when a return is created. Go to <<orders/managing-orders#410, Setup » Orders » Order types » Return>> to create item statuses for returns.
