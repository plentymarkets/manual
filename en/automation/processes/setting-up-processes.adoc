...
.Install plentyBase
====
You need <<basics/admin-tasks/installing-plentybase#, plentyBase>> to create and run processes in the plentymarkets back end. You can download the installation files for plentyBase in the link:https://marketplace.plentymarkets.com/en/plugins/integration/plentyBase_5053[plentyMarketplace^].
====
