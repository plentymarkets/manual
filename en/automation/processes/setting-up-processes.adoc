...
*_Note:_* It the menu *Setup » Processes* is not shown, install the plugin link:https://marketplace.plentymarkets.com/plugins/externe-tools/plentyBase_5053/[plentyBase^].
...
====
For user accounts of the class *Variable*, the *Setup » Processes* menu is only visible if they were given the <<basics/admin-tasks/manage-users#, necessary rights>> in their user profile.
====
