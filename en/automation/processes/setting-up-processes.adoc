...
.Install plentyBase
====
You need <<automation/processes/installing-plentybase#, plentyBase>> to create and run processes in the plentymarkets back end. You can find the installation files for plentyBase in the link:https://marketplace.plentymarkets.com/en/plugins/integration/plentybase_5053[plentyMarketplace^].
====
