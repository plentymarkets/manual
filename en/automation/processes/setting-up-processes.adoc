...
[IMPORTANT]
.Visibility of the *Setup » Processes* menu
====
Admin users are automatically allowed to access the *Setup » Processes* menu and run the processes in this menu. *Back end* users need to be granted this right. Go to *Setup » Settings » User » Rights » User*. Open the user account. In the *Rights* area, activate the menu visibility *Processes*.
====
