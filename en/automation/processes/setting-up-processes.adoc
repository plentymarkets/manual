...
* Processes per <<basics/admin-tasks/manage-users#, role>>: here you can see the processes that were assigned to your role. If you were not assigned to any role, then you will not see a folder here. Go to <<basics/admin-tasks/manage-users#, System » Settings » User>> to create roles. Users who were assigned to the class <<basics/admin-tasks/manage-users#, Admin>> will be able to see the processes for all roles.
* **Global processes**: here you can see processes that are available for all users.

[IMPORTANT]
.Visibility of the menu: System » Processes
====
Variable users will only be able to see the **System » Processes** menu if they were given the right to do so in the user profile. For further information about rights, refer to the <<basics/admin-tasks/manage-users#, Managing user accounts>> page of the manual.
====
...
image::automation/processes/assets/EN-Einstell-Prozesse-Prozesse-einrichten-01-SI.png[Process menu and submenus]
...
image::automation/processes/assets/EN-Einstell-Prozesse-Prozesse-einrichten-02-SI.png[Configuration menu for a new process]
...
<<basics/admin-tasks/manage-users#, User>> = The process is only visible to a specific user. This user is selected from the **User** drop-down list below +
<<basics/admin-tasks/manage-users#, Role>> = The process is only visible to a specific **role**. This role is selected from the **Role** drop-down list below

|User
|This option can only be used if you selected **User** for the option **Visibility**. Select which user the corresponding process should be visible for. In other words, you can create processes for yourself as well as for other users. Users who were assigned to the class <<basics/admin-tasks/manage-users#, Admin>> will also be able to see the process, regardless of which setting is chosen here.
...
image::automation/processes/assets/EN-Einstell-Prozesse-Prozesse-einrichten-03-SI.png[New process in My processes menu]
...
image::automation/processes/assets/DE-Einstell-Prozesse-ProEinricht-04-SI.png[Context menu]
...
image::automation/processes/assets/EN-Einstell-Prozesse-Prozesse-einrichten-05-SI.png[Context menu]
...
image::automation/processes/assets/EN-Einstell-Prozesse-Prozesse-einrichten-06-SI.png[Icons]
...
.Context menu
image::automation/processes/assets/EN-Einstell-Prozesse-Prozesse-einrichten-07-SI.png[Context menu]

=== Adding elements

A process is always based on a <<automation/processes/work-steps#, work step>>. Additional elements can be added to the work step as desired. You can add as many work steps as you wish to a process.

You can add various **elements** to a work step. There are two types of elements: <<automation/processes/procedures#, control elements>> and <<automation/processes/procedures#, procedures>>. You can also add <<automation/processes/sub-procedures#, sub-procedures>> to a procedure. You can always add a subordinate element by pointing your cursor to the superordinate element and clicking on the **green plus icon** (see image 7).

.Example: Clicking on the **green plus icon** to add a procedure
image::automation/processes/assets/EN-Einstell-Prozesse-Prozesse-einrichten-08-SI.png[Example]
