...
:position: 10
:url: automation/processes/setting-up-procedures
...
*_Note:_* Users with <<basics/admin-tasks/manage-users#, Admin>> rights can view all processes.
...
*_Note:_* Users with <<basics/admin-tasks/manage-users#, Admin>> rights can view all processed.
...
====
For user accounts of the class *Variable*, the *System » System settings » Processes* menu is only visible if they were given the <<basics/admin-tasks/manage-users#, necessary rights>> in their user profile.
====
