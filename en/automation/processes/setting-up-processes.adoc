...
. Go to *System » System settings » Processes » New process*. +
*_Note:_* It the menu *System » System settings » Processes* is not shown, install the plugin link:https://marketplace.plentymarkets.com/plugins/externe-tools/plentyBase_5053/[plentyBase^].
...
. Go to *System » System settings » Processes » Select folder » Select process*.
...
====
For user accounts of the class *Variable*, the *System » System settings » Processes* menu is only visible if they were given the <<basics/working-with-plentymarkets/manage-users#, necessary rights>> in their user profile.
====
