...
. Click on the plentyBase logo and then on *Show plugin folder*. +
...
. For every printer, add the printer that should be addressed by this procedure.
  ...
  image:automation/processes/assets/beispiel_drucken_1-EN.png[width=640]
  .. Select the printer. +
  image:automation/processes/assets/beispiel_drucken_2-EN.png[width=640]
  .. Save (icon:save[role="darkGrey"]) the change.
. Add a storage path to each procedure used for saving.
  .. Open the sub-procedure *Save*. +
  image:automation/processes/assets/beispiel_speichern_1-EN.png[width=640]
  .. Select the storage path. +
  image:automation/processes/assets/beispiel_speichern_2-EN.png[width=640]
  .. Save (icon:save[role="darkGrey"]) the change.
. The error message can also appear with procedures of the type “In case of error”. Thus, also check if a procedure of this type has been set up for the original procedure.
  ...
  image:automation/processes/assets/beispiel_speichern_3-EN.png[width=640]
...
When carrying out the *Item processing* procedure, it may happen that no items are found. This error occurs when no sales prices are saved for the items that should be processed during item registration.
