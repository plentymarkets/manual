...
*_Note:_* Always use private messages. Never attach log files to a public post! To learn how to send private messages in the plentymarkets forum, take a look at https://forum.plentymarkets.com/t/wie-sende-ich-private-nachrichten/3024[this post^] (German only).
====
...
. *Save* the settings.
. Carry out the settings according to <<tabelle-BP-EA-lagerortsortierung>>.
...
image:automatisierung/processes/assets/accesstoken-EN.png[]
