...
By combining the **Order notes** sub-procedure with the <<automation/processes/procedures#260, Note>> procedure, you can display the information saved in the <<orders/managing-sales-orders#changing-order, Orders » Edit orders » Tab: Overview>> menu during the process so you employees can take appropriate action. +
