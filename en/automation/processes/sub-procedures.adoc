...
====
To create and run processes, you need <<automation/processes/installing-plentybase#, plentyBase>>. You can download the installation files for plentyBase in the link:https://marketplace.plentymarkets.com/en/plugins/integration/plentyBase_5053[plentyMarketplace^].
====
...
|Printer setting
|Choose one of the <<basics/admin-tasks/printer#, printer profiles>> saved in the menu **Setup » Settings » Printer**.
...
Use the **Register serial numbers** sub-procedure to register <<item/managing-items#820, serial numbers>> during the process with a barcode scanner. Decide whether you want to allow new serial numbers and whether serial numbers should be saved automatically.
