...
This page of the manual contains information about the sub-procedures you can add to the procedures of processes in the **System » System settings » Processes** menu.
...
|Printer setting
|Select one of the <<basics/admin-tasks/printer#, printer profiles>> saved in the **System » System settings » Settings » Printers** menu.
