...
[#outbound]
Outbound:: Describes the sales and distribution process that a fulfilment service provider takes over for you: They pack the items, store them temporarily and then send them to your customers.
