...
|Supplier is active
|Countries of delivery with this setting cannot be selected as the standard country of delivery in the menu *System » System settings » Client » Select client » Order process » Settings*.
|====
...
You have to group the activated countries of delivery now. You will find the shipping regions in the menu *System » System settings » Orders » Shipping » Settings » Tab: Regions*. Group the countries for which the same shipping conditions should apply to one common region.
...
Besides the countries of delivery and the corresponding regions, you also need the correct shipping service provider in order to build a bridge between the plugin and the shipping profiles. Configure the shipping service provider in the *System » System settings » Orders » Shipping » Settings » Tab: Shipping service provider* menu.
...
All menu items that you have set up so far, will "meet" in the shipping profile. To do so, go to *System » System settings » Orders » Shipping » Settings » Tab: Shipping profiles*. By clicking on the *New* button (plus symbol), you create a new shipping profile and directly access the *Base* tab. The *Table of shipping charges* tab is only available after you have saved.
...
You can save a pre-defined shipping package as standard package. A shipping package can be defined in the menu *System » System settings » Orders » Shipping » Shipping packages*. In this way, you can transfer fixed dimensions when you only use one package size for the shipment.
...
Afterwards, you switch to the *System » System settings » Orders » Shipping » DHLShipping* menu where you will find the following sub-menus.
...
* in the plugin in the *System » System settings » Orders » Shipping » DHL Shipping » Basic settings* menu

* in the interface configuration in the *System » System settings » Orders » Shipping » Shipping service provider » DHL Intraship/Versenden* menu
...
* for the DHL Shipping plugin in the menu *System » System settings » Orders » Shipping » DHL Shipping » Billing numbers*

* for the interface integration DHL Intraship / Versenden in the menu *System » System settings » Orders » Shipping » Settings » Tab: Shipping profiles* in the table of shipping charges of the corresponding region of the DHL shipping profile
...
In this case, no shipping setting could be found (*System » System settings » Orders » Shipping » DHL Shipping » Shipping settings*) that was created with the shipping profile in the order.
...
If it is not possible to select the region in the shipping profile of the shipping settings, the region in the table of shipping charges of the shipping profile must be checked. To do so, go to *System » System settings » Orders » Shipping » Settings » Tab: Shipping profiles » Open shipping profile » Tab: Table of shipping charges*. The following note *must not* be displayed:
...
Check whether the correct shipping service provider was selected in the *System » System settings » Orders » Shipping » Settings » Tab: Shipping service provider* menu. The corresponding data can only be loaded if this is the case.
...
If one of the above listed messages is displayed more than once, it indicates that missing or incorrect data might have been saved in the *System » System settings » Orders » Shipping » Service provider » DHL Intraship/Versenden* menu.

.Recipient data in the *System » System settings » Orders » Shipping » Service providers » DHL Intraship/Versenden*
...
Make sure that you select one option each in the drop-down lists *Postage for export shipping* and *Type of shipment* in the menu *System » System settings » Orders » Shipping » DHL Shipping » Shipping settings*.
