...
image::_best-practices/omni-channel/online-shop/assets/bp-ceres-filter-variations-en.png[]

== Setting up facets

In the online store our filters are realized by means of facets. Therefore we have to create a new facet and link the attribute values to it.
...
[[filter-facetten]]
.Linked facet values
image::_best-practices/omni-channel/online-shop/assets/bp-ceres-filter-facets-en.png[]
...
image::_best-practices/omni-channel/online-shop/assets/bp-ceres-filter-frontend-en.png[]
