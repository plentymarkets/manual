...
:lang: en
:keywords: Webshop, online shop, online store, shop, store, client, Standard, Ceres, Plugin, Ceres, HowTo, setup, Plugin sets, search, item, recommended, relevance, suggestions, results, Boost, item, data fields, item data, priorisation, and, or, Keywords, variation position, Name, plentyShop
:position: 120
:author: team-webshop
