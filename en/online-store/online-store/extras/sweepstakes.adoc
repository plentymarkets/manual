...
*Setup » Client » Settings » Sweepstakes*
...
. Go to *Setup » Client » Settings » Sweepstakes*.
...
. Go to <<crm/sending-emails#2300, Setup » Client » Select client » Email » Automatic>>.
...
. Go to <<crm/sending-newsletters#300, Setup » CRM » Newsletter » plentymarkets » Email folder>>.
