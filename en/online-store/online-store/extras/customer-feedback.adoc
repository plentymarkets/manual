...
It is a good idea to send customers an email and let them know that they can submit feedback. This email can automatically be sent with help of the <<basics/automation/procedure-manager#, procedure manager>>. Create an <<crm/sending-emails#1200, email template>> in advance and link this template to the procedure.
