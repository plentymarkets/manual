...
You need to link:http://www.haendlerbund.de/mitgliedschaft/details[register^]{nbsp}icon:external-link[] with the Händlerbund before you can use its services for your plentymarkets system. Please note that the services are only available in German.
...
Your plentymarkets system will be connected to the Händlerbund via the SOAP interface. In order for it to have access, you first need to create an individual <<business-decisions/user-accounts-access#10, user account>> with access rights to the API in your system.
