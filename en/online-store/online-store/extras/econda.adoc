...
:position: 70
:url: online-store/online-store/extras/econda

*System » System settings » Client » Select client » Services » Econda*
...
. Go to *System » System settings » Client » Select client » Services » Econda*.
...
→ You will only be able to select attributes here if you have already created attributes under <<item/managing-items#390, System » System settings » Item » Attributes>>.
...
. Go to *System » System settings » Client » Select client » External services » Econda » Tab: Settings*.
