...
*Setup » Client » Select client » Services » Econda*
...
. Go to *Setup » Client » Select client » Services » Econda*.
...
→ You will only be able to select attributes here if you have already created attributes under <<item/managing-items#390, Setup » Item » Attributes>>.
...
. Go to *Setup » Client » Select client » External services » Econda » Tab: Settings*.
