...
*System » System settings » Client » Select client » Services » FINDOLOGIC*
...
====
Go to *System » System settings » Settings » User* and set up a new user account for FINDOLOGIC, which has *API* set as the user class.
...
This URL can be found in the *System » System settings » Settings » API » Data* menu under *SOAP WSDL*. The WSDL is structured as follows: *http://WWW.SHOPURL.COM/plenty/api/soap/version1xx/?xml.*(*xx* = the current SOAP version)
...
. Go to *System » System settings » Client » Select client » Services » FINDOLOGIC*. +
