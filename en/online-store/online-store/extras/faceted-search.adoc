...
:position: 120
:url: online-store/online-store/extras/faceted-search
:id: MZQIPXX

*Setup » Client » Settings » Services » Faceted search*
...
This function is configured in several different steps. First, facets are created. Then their settings are customised further. Finally, they are linked to the desired values. Furthermore, you need to go to *Setup » Client » Select client » Online store » Item search* and select the option *Faceted search*.
...
|*Availability*
|Facets of the type *Availability*, e.g. "ships within 24 hours", are linked to the availabilities found under <<omni-channel/online-store/setting-up-clients/extras/faceted-search#180, Setup » Item » Availability>>.

|*Manufacturer*
|Facets of the type *Manufacturer*, e.g. "Adidas", are linked to the manufacturers found under <<omni-channel/online-store/setting-up-clients/extras/faceted-search#560, Setup » Item » Manufacturers>>.
|====
...
Go to *Setup » Client » Select client » Services » Facet links* to configure the settings. Select which store you want to link to the facets.
