...
:position: 200
:url: online-store/online-store/extras/live-shopping
:id: QBSLUDQ
...
//  plentymarkets
With live shopping, one of the items from your range of products will be offered at a discounted price each day during a specified period (e.g. from 9:00am to 6:00pm). Configure live shopping offers in the *Setup » Client » Settings » Live shopping* menu.
...
. Go to *Setup » Client » Settings » Live shopping*.
...
Live shopping offers can also be presented on external platforms such as the German site link:http://www.liveshopping-aktuell.de[liveshopping-aktuell.de^]{nbsp}icon:external-link[]. Register with the provider and save the offer's URL as follows:
