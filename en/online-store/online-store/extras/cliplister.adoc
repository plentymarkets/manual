...
*Setup » Client » Select client » Services » Cliplister*
...
This page contains information about the Cliplister video settings that are available for your individual clients (stores). Before carrying out the configuration, you have to activate Cliplister in the menu <<omni-channel/online-store/setting-up-clients/extras/cliplister#, Setup » Client » Settings » Services » Cliplister>>.
