...
:position: 220
:url: online-store/online-store/extras/protected-shops
:id: TSDD0HQ

*Setup » Client » Select client » Online store » Legal information*
...
*  Configuration of a <<business-decisions/user-accounts-access#, user>> who was given the necessary *SOAP rights*.
...
This link:https://www.plentymarkets.co.uk/tpl/download/KK_DE_Domain.pdf[document^]{nbsp}icon:external-link[] contains detailed information about carrying out the steps listed above. Please note that the document is currently only available in German.
