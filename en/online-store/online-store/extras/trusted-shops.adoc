...
. Go to *System » System settings » Client » Select client » Services » Trusted Shops*.
...
. Go to <<automation/procedure-manager#, System » System settings » Orders » Procedures>>.
...
→ Create the <<crm/sending-emails#1200, email template>> under *System » System settings » Client » Select client » Email » Templates*.
