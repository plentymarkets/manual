...
*System » System settings » Client » Settings » Services » picalike*
...
* picalike needs to have your plentymarkets system's *export URL* for the image search. Go to *System » System settings » Client » Settings » Services » picalike* to find the URL (<<image-settings-picalike>>).
...
. Go to *System » System settings » Client » Settings » Services » picalike*.
