...
* <<omni-channel/online-store/setting-up-clients/cms-syntax#web-design-checkout-container-checkoutorderparamslist, Container_CheckoutOrderParamsList>> — Returns the content of the container for selecting order properties.
...
* <<omni-channel/online-store/setting-up-clients/cms-syntax#web-design-checkout-getcheckoutbasketitemitemparamslist, GetCheckoutBasketItemItemParamsList>> — Returns a list of properties that belong to an item.
* <<omni-channel/online-store/setting-up-clients/cms-syntax#web-design-checkout-getcheckoutbasketitemorderparamslist, GetCheckoutBasketItemOrderParamsList>> — Returns the current order properties of a shopping cart item.
...
* <<omni-channel/online-store/setting-up-clients/cms-syntax#web-design-checkout-getcheckoutorderparambasketitemslist, GetCheckoutOrderParamBasketItemsList>> — The list of the individual item variations that require order properties.
* <<omni-channel/online-store/setting-up-clients/cms-syntax#web-design-checkout-getcheckoutorderparamgroupslist, GetCheckoutOrderParamGroupsList>> — The list of required property groups.
* <<omni-channel/online-store/setting-up-clients/cms-syntax#web-design-checkout-getcheckoutorderparamvalueslist, GetCheckoutOrderParamValuesList>> — The list of required properties.
...
* <<omni-channel/online-store/setting-up-clients/cms-syntax#web-design-checkout-getcheckouttotalsmarkuplist, GetCheckoutTotalsMarkupList>> — Returns the sum of the properties surcharges in the shopping cart.
