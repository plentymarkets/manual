...
Activate the option *Client check* under *Attribute availability* in the menu *System » System settings » Client » Select client » Item layouts » Settings* and add the following code example to dynamically show or hide the previously created form depending on the availability of the variation.
