...
====
Go to <<omni-channel/online-store/setting-up-clients/item-layouts#, System » System settings » Client » Select client » Item layouts » Settings>> in order to deactivate the display of surcharges. Choose the setting *Do not show* for the option *Attribute surcharge*.
====
...
Go to *System » System settings » Item » Images* and save the maximum values for <<item/managing-items#450, item attribute images>> for the options *Maximum width (pixels) of the item attribute image* and *Maximum height (pixels) of the item attribute image*.
