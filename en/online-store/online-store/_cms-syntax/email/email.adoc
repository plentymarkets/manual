...
* $BankAccount — This variable contains your bank account number as it was entered in the System » System settings » Settings » Bank menu.
* $BankCode — This variable contains your sort code as it was entered in the System » System settings » Settings » Bank menu.
* $BankIBAN — This variable contains your IBAN as it was entered in the System » System settings » Settings » Bank menu.
* $BankName — This variable contains the name of your bank as it was entered in the System » System settings » Settings » Bank menu.
* $BankOwner — This variable contains the account holder as it was entered in the System » System settings » Settings » Bank menu.
* $BankSwift — This variable contains your BIC as it was entered in the System » System settings » Settings » Bank menu.
* $BarcodeOrderID
...
* $MethodOfPaymentID — This variable contains the payment method ID. The ID is assigned by the system. The IDs are listed in the System » System settings » Orders » Payment » Payment methods menu.
* $MethodOfPaymentName — This variable contains the name of the payment method as it was entered in the System » System settings » Orders » Payment » Payment methods menu.
* $NewCustomerEmail
...
* $ReferrerID — This variable contains the referrer ID. The ID is assigned by the system. The IDs are listed in the System » System settings » Orders » Order referrer menu.
* $ReferrerName — This variable contains the name of the order referrer as it was entered in the System » System settings » Orders » Order referrer menu.
...
* $ShippingProfileID — This variable contains the shipping profile ID. The ID is assigned by the system. The IDs are listed in the System » System settings » Orders » Shipping » Shipping options » Tab: Shipping profiles menu.
* $ShippingProfileName — This variable contains the shipping profile's name.
* $ShippingServiceProviderID — This variable contains the shipping service provider's ID. The ID is assigned by the system. The IDs are listed in the System » System settings » Orders » Shipping » Shipping options » Tab: Shipping service provider menu.
* $ShippingServiceProviderName — This variable contains the shipping service provider's name.
* $SignatureHTML — This variable contains the signature that was set for this client (store) in HTML format. This signature is saved in the System » System settings » Client » Select client » Email » Signature menu.
* $SignatureText — This variable contains the signature that was set for this client (store) in text format. This signature is saved in the System » System settings » Client » Select client » Email » Signature menu.
* $SystemPassword
* $SystemURL
* $SystemUsername
...
* $ValueOfItems
* $WarehouseID — This variable contains the warehouse ID. The ID is assigned by the system. The ID is listed in the System » System settings » Stock » Warehouse » Settings menu.
* $WebstoreID — This variable contains the client ID. The ID is assigned by the system. The ID is listed in the System » System settings » Client » Select client » Settings menu under Webstore ID.
* $WithdrawalFormHTML
* $WithdrawalFormText
