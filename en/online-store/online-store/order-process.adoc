...
:position: 40
:url: online-store/online-store/order-process

*System » System settings » Client » Select client » Order process » Settings*
...
.  Go to *System » System settings » Client » Select client » Order process » Settings*.
...
Use the <<orders/managing-orders#1700, group function>> *Group orders* to manually combine orders after they have passed this status.
