...
:keywords: Online store, Client, Order process, Callisto
:position: 40
:url: online-store/online-store/order-process
:id: QXVKW5S

*Setup » Client » Select client » Order process » Settings*
...
.  Go to *Setup » Client » Select client » Order process » Settings*.
