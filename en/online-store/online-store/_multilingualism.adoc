...
:keywords: Store, Client, Multilingualism, Callisto
:position: 20

*Setup » Client » Select client » Online store » Multilingualism*
...
The following table explains the settings in the *Setup » Client » Select client » Online store » Multilingualism* menu:
...
====
In order to display the language version of a category in the online store, at least one item has to be saved for the category in the default language and the (default language) category has to have a check mark placed next to it (=activated) under *Setup » Client » Select client » Categories » Activate*.
====
...
. Select the desired flag images and click on *open*. (As an alternative, you can also drag and drop the images into the folder.) +
