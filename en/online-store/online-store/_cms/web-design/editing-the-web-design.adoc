...
====
You can also go to *System » System settings » Client » Select client » Online store » Pages* to link category pages. The links carried out there apply to all designs of a client. If you link category pages to a design as described below, then the design specific links take priority.
====
...
====
To be able to exchange data between Dropbox and plentymarkets, your Dropbox account needs to be linked to plentymarkets in the <<basics/data-exchange/dropbox#, System » System settings » Client » Settings » Services » Dropbox>> menu.
====

==== Exporting a design to the Dropbox folder

Use the *Export design* function to export a design or individual templates to a folder in your Dropbox account. This folder is the one you set as the base folder in the <<basics/data-exchange/dropbox#, System » System settings » Client » Settings » Services » Dropbox>> menu. Proceed as described below to export designs to the base folder.
