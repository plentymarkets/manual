...
Set up Google reCAPTCHA for the customer registration in your online store. First, register your online store to use link:https://www.google.com/recaptcha/admin#list[Google reCAPTCHA^]{nbsp}icon:external-link[]. Then, enter the website key and the secret key for your online store.
