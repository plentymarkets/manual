...
If having a secure connection is important to you, then you will surely be interested in using <<business-decisions/system-administration/domains#, SSL>> encryption for your website. Pay attention to the following information and carry out the steps completely. Make sure that your entire website is correctly encrypted to avoid causing confusion among visitors to your website or online store.
...
====
You need to delete your system's sitemap file after installing the <<business-decisions/system-administration/domains#, SSL certificate>>. This ensures that the sitemap file will be updated with the new encrypted URLs. The sitemap is updated daily in plentymarkets. This process takes place at night.
====
