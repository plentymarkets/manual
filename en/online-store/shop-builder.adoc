...
|*Live shopping*
|Provides a container for live shopping items. Click *Edit* to carry out the settings for the widget. Select one of 10 live shopping profiles that you create in the *System » Client » Global » Live shopping* menu from the *Live shopping selection*
