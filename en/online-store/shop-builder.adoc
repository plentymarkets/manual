...
[#10]
The ShopBuilder is plentymarkets’ modular construction kit for quickly setting up your link:https://marketplace.plentymarkets.com/plugins/templates/Ceres_4697[Ceres plentyShop^] via Drag&Drop. You require no programming skills. +
...
- The ShopBuilder requires Ceres version 2.8.1 or higher. In case you are using an older version of the plugins Ceres and IO, you can get more current versions in the link:https://marketplace.plentymarkets.com[plentyMarketplace^].
...
_Note:_ This widget is not part of the default Ceres plugin and hast to be loaded from the link:https://marketplace.plentymarkets.com/plugins/widgets/GoogleMapsWidget_5985[plentyMarketplace^]. After downloading the widget, you need to install it. The widget is available in the widget overview after its installation. +
...
|*Google API key*
|Enter the API key that is a prerequisite for using GoogleMaps. You receive the API key from link:https://cloud.google.com/maps-platform/maps/?hl=de[Google Cloud^]. The GoogleMaps API may be subject to additional costs.
