...
You need to link a few categories in a separate step with the Ceres plugin, so that these categories work properly in the online store. Proceed as follows to link the categories:
