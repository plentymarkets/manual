...
:author: team-webshop
:keywords: Online store, client, Standard, Ceres, IO, Plugin, configuration, Template, homepage, Drag and Drop, ShopBuilder, item lists, image box, carousel, widget, widgets, design, layout, inline editing,
:position: 30
:url: online-store/shop-builder
:id: UC8C8W9

[#10]
The ShopBuilder is plentymarkets’ modular construction kit for quickly setting up your link:https://marketplace.plentymarkets.com/plugins/templates/Ceres_4697[Ceres plentyShop^]{nbsp}icon:external-link[] via Drag&Drop. You require no programming skills. +
...
- The ShopBuilder requires Ceres version 2.8.1 or higher. In case you are using an older version of the plugins Ceres and IO, you can get more current versions in the link:https://marketplace.plentymarkets.com[plentyMarketplace^]{nbsp}icon:external-link[].
...
The category tree on the left side of the content manager lists the categories of the online store. Here you can create new categories as main or sub categories. In the *Edit category* window, you can carry out a number of settings, which are explained in <<table-edit-category>>. +
...
. Klick on the *delete* button. +
→ The *Delete category* window opens.
. Click on *Delete category*. +
→ The category is deleted.

[#26]
=== Linking categories with the Ceres plugin
...
.Types of content
====
You select one of 3 types when you create a new content:
...
This widget provides a text box for the title of your online store. Click *Edit* to carry out the widget settings. You can open the <<#110, *inline text editor*>> by clicking the *pen* icon on the widget. In this editor you can edit and format text directly in the widget. You can only enter plain text; if you want to enter HTML, please use the *code* widget. +
...
// This widget provides graduated prices for the single item view. Click *Edit* to carry out the widget settings. In order to use graduated prices, you need to <<item/managing-items#870, configure the prices>> of your items accordingly. +
...
This widget provides the selection of available shipping methods in the online store. This widget is limited to 1 per page. Click on the *pencil* button on the widget to open the <<#110, inline editor>> and edit the title directly in the widget. Click *Edit* to carry out the widget settings. +
...
This widget provides a checkbox with which your customers can agree to transmit their shipping information to the corresponding shipping service provider. The checkbox will only be displayed in the online store if a shipping profile is selected for which the option <<fulfilment/preparing-the-shipment#1000, Agreement upon data transfer>> is active. Click *Edit* to carry out the widget settings. +
...
This widget provides a list with links to your legal information, which you can display in the footer of your online store. Your legal information is edited and saved in the *Setup » Client » Select client » Online store » Legal information* menu. Click *Edit* to carry out the widget settings. +
...
_Note:_ This widget is not part of the default Ceres plugin and hast to be loaded from the link:https://marketplace.plentymarkets.com/plugins/widgets/GoogleMapsWidget_5985[plentyMarketplace^]{nbsp}icon:external-link[]. After downloading the widget, you need to install it. The widget is available in the widget overview after its installation. +
