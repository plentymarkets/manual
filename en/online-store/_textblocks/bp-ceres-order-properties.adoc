...
image::online-store/assets/bp-ceres-order-properties-settings.png[]
...
image::online-store/assets/bp-ceres-order-properties-item.png[]
...
image::online-store/assets/bp-ceres-order-properties-item-view.png[]
...
image::online-store/assets/bp-ceres-order-properties-shopping-cart.png[]
...
.Creating a property group
image::online-store/assets/bp-ceres-order-properties-group.png[]
...
.Creating order characteristics
image::online-store/assets/bp-ceres-order-properties-new-property.png[]
...
.Linking an order property to an item
image::online-store/assets/bp-ceres-order-properties-link.png[]
