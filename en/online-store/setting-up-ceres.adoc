...
====
When deploying the template plugins *Ceres* and *IO* in a <<plugins#70, plugin set>>, the old plentymarkets online store Callisto will be unavailable. *Ceres* will use the URL of the online store.
====
...
- assigned <<welcome/quick-start#560, position numbers>> in the *Plugin » Plugin overview* menu
...
- Saving settings in the Ceres configuration
...
. Go to the *Setup » Client » Select client» Wenshop » ShopBooster* menu.
...
In the *Deactivate invalidation*, you can suspend the invalidation of the ShopBooster until the chosen date and time. As a result, your item data will be exclusively loaded from the cache until the chosen time, without the cache being deleted or updated. Therefore, your online shop will be able to achieve better loading times. +
