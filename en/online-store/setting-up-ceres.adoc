= Setting up your Ceres online store
:lang: en
...
link:https://marketplace.plentymarkets.com/plugins/templates/Ceres_4697[Ceres] is the official template plugin for the default online store of plentymarkets 7. In the new plentymarkets 7 online store, design and logic are separated from each other. The online store is integrated into your plentymarkets system via 2 plugins.
The *Ceres* plugin contains the standard design of the online store and can be customised to meet your needs. The link:https://marketplace.plentymarkets.com/plugins/templates/IO_4696[IO^] plugin contains the logic of the online store, is a general basis for all design plugins and can also be used by other plugins.

[WARNING]
.Old online store will be unavailable
====
When deploying the template plugins *Ceres* and *IO* in a <<basics/first-steps/plugins#70, plugin set>>, the old plentymarkets online store Callisto will be unavailable. *Ceres* will use the URL of the online store.
====
...
Set up a standard country of delivery for each <<#220, activated language>> of your online store. When switching the language in a *Ceres* online store, the country of delivery will automatically adapt in the header and in the checkout. For further information aboutsetting up countries of delivery, refer to the <<order-processing/fulfillment/preparing-the-shipment#100, Setting up countries of delivery>> manual page.
...
Set up the default shipping method for your online store. This shipping method will be used for calculating the shipping costs in the shopping cart before a customer registers in your online store. The default shipping method is preselected in the checkout. For further information about shipping methods and shipping profiles, refer to the <<order-processing/fulfillment/preparing-the-shipment#1000, Creating a shipping profile>> manual chapter.
...
Set up the default payment method for your online store. Only link:https://marketplace.plentymarkets.com/plugins/payment[Payment method plugins^] can be used in *Ceres*. The payment method plugins will be available as default payment methods after the setup. Please refer to the corresponding *User guide* of the payment method plugin in the plentyMarketplace.
...
Ceres provides specific templates for your legal information. You can save and display your legal information in different languages. In the *Legal information* menu, you can save your *terms and conditions*, *cancellation rights*, the *cancellation form*, *privacy policy* and *legal disclosure* for your online store.
...
Enter the texts for the *cancellation rights*, the *cancellation form*, the *privacy policy* and the *legal disclosure* of your online store analogously in the desired languages. Alternatively, upload a PDF file for your <<#70, cancellation form>>. These texts will be displayed on the corresponding pages in *Ceres*.  +

From Ceres version 2.15 onwards, links to your legal information in the footer can be set up via the <<omni-channel/online-store/shop-builder#10, ShopBuilder>> Widget *Legal information*.


[#10]
== Setting up the Ceres plugin

After the <<#15, preparation>> for your Ceres store is done, you can begin setting up the *Ceres* plugin.
The following chapters lead through the setup of the individual tabs of the <<#20, Ceres comnfiguration>>. You access the Ceres configuration via the *Plugin overview* by clicking the *Ceres* plugin. No programming skills are necessary for the setup.
...
Here, you also set up the contact page of your online store and the contact form for customer requests.
...
|Activate to use the Callisto URL route pattern in Ceres. This is required, for example, when using the <<omni-channel/online-store/best-practices#checkout, Ceres checkout in Callisto>>. We advise you not to activate this setting if you use an unaltered Ceres online store.
...
In the *Global* tab, you also link a *Category to display shipping cost information* in the online store.+
...
*Ceres* comes with a default homepage as placeholder. +
You customise the homepage of your online store with the <<omni-channel/online-store/shop-builder#10, ShopBuilder>>. Deactivate the default homepage to replace it with the ShopBuilder homepage.
...
With the ShopBuilder, you can create and edit the homepage of your Ceres online store. This requires only a few steps in your terra back end.
...
Customise the header and the footer of your design. Display your own logo and design the footer content according to your requirements. The store features, for example, are a great way to highlight the features of your online store, such as free shipping. You can link content categories in the *Footer* tab to display aditional information in the footer of the online store.
...
|Enter the IDs of <<#30, categories>> of the type *Content* to be displayed in the first/second/third footer column of the online store. This way, additional information can be displayed in the footer of the online store. +
...
* Store specials: Lists with new items, special offers, etc. are set up in Ceres via tags. For further information about setting up tags, refer to the <<basics/working-with-plentymarkets/tags#, Tags>> page of the manual. For further information on tagging items, refer to the <<item/managing-items#150, Adding tags to items>> chapter of the manual.
...
Display item lists in a very convenient way in your online store by linking them to *template containers*. Proceed as follows to link the *item list for last seen items* in the single item view of your online store. Link other item lists in the same way.
...
|Activate to allow customers to return items in the order history of the *My account* area in the online store.
...
|This setting provides a mapping with which the availabilites set in the *System » Item » Availability* menu can be mapped onto the Schema.org availabilites. This serves to improve SEO omptimisation.

|====

In the *CMS » Multilingualism* menu, you can enter meta descriptions for the static pages of your online store. Carry out the SEO settings for the *contact page* as well as the pages *cancellation rights*, *cancellation form*, *legal disclosure*, *privacy policy* and *terms and conditions* in the same way.
...
Settings specifically targeted at plugin developers are available in the *Logging and performance* tab. Here, you can set the information to be logged during plugin development and the performance mode for the online store.
...
The following chapters cover online store-relevant settings that you cannot carry out via the Ceres configuration. This includes the <<#321, Editing of online store texts>>, the setup of <<#330, Filters>> and <<#340, Order properties>>.
...
Set up attributes and properties first and link them with your items. Set up the filters for the search and category view of the online store Ceres with the help of facets of the Attribute/property type. Set up attributes and properties first and link them with your items.
...
With order properties, you allow your customers to enter a text when ordering an item that is linked to the order property. For example, customers choose an individual text that will be printed on an item. Set up order properties first and link the properties with your items. For further information about properties, refer to the <<item/managing-items#480, Managing properties>> chapter.
...
* [] Did you deactivate the Ceres default homepage and activate the ShopBuilder homepage?
* [] Did you carry out all settings for every tab of the Ceres configuration?
* [] Did you prepare your online store texts in multiple languages (if applicable)?
...
* [] Did you unlock the online store?
* [] Did you save and deploy the plugin set after making changes to the plugins?

[#900]
== Certifying your Ceres online store with Trusted Shops
...
In addition to theme plugins, which serve to modify the design of the online store, the link:https://marketplace.plentymarkets.com/[marketplace^] offers a multitude of different plugins which can be used to tailor the functionality of the online store to your personal needs. Apart from the integration of link:https://marketplace.plentymarkets.com/plugins/markets[marketplaces^], you can find link:https://marketplace.plentymarkets.com/plugins/widgets[widgets^], such as the GoogleAnalytics and customer feedback plugins, link:https://marketplace.plentymarkets.com/plugins/payment[payment plugins^] for the implementation of additional payment methods and link:https://marketplace.plentymarkets.com/plugins/integration[integration plugins], such as the plugins of shipping providers DHL and DPD. +
