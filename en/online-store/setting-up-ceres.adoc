...
|This setting provides a mapping with which the availabilites set in the *System » System settings » Item » Availability* menu can be mapped onto the Schema.org availabilites. This serves to improve SEO omptimisation.
...
You can carry out settings pertaining to trailing slashes of the URLs of your online store in the *System » System settings » Client » Select client » SEO » URL structure* menu.

[#2041.instruction]
Editing trailing slashes:

. Go to *System » System settings » Client » Select client » SEO » URL structure » Other*.
