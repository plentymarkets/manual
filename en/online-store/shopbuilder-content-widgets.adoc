...
This plugin adds 20 additional widgets to ShopBuilder. To purchase the plugin, link:link:https://marketplace.plentymarkets.com/en/shopbuilder-content-widgets_55026[go to plentyMarketplace^].
