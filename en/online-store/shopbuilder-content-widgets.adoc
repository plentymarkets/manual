...
This plugin adds 20 additional widgets to ShopBuilder. To purchase the plugin, go to plentyMarketplace.
...
* *Row*: Content starts on the left side of the column.
* *Row-Reverse*: Content starts on the right side of the column.
* *Column*: Content starts at the top of the column.
* *Column-Reverse*: Content starts at the bottom of the column.
...
// Widget still needs to be updated
...
| *Description*
|Sets the testimonial quote.

| *Profile photo*
|Selects the image for the profile picture from the webspace. Use this option if the testimonial is from a person. Mutually exclusive with the *Logo* option.

| *Logo*
|Selects the image for the logo picture from the webspace. Use this option if the testimonial is from a non-person entity, such as a company. Mutually exclusive with the *Profile photo* option.

| *Profile name*
|Sets the name of the person or entity that gave the testimonial.

| *Job*
|Sets the job of the person that gave the testimonial.
...
[[table-logowall-simple]]
.Settings logowall simple
[cols="1,3"]
|===
|Setting |Explanation
...
* *Logo-size*: Displays the image at a size of px.
...
| *Link type*
|Determines if there is a link and whether the link is displayed as simple text or a button.
