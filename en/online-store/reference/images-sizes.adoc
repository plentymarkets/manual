...
:author: team-webshop
:keywords: Categories, images, size, sizes, format, Ceres, online store, ShopBuilder, layout, design
:description: An overview over image sizes for category images in Ceres.
:position: 20
:url: online-store/reference/image-sizes
:id: SNFFO4R

This chapter lists the recommended image sizes for category and item images for Ceres online stores. All images displayed on the homepage of the store are currently integrated via <<omni-channel/online-shop/shop-builder#, ShopBuilder>> widgets. +
