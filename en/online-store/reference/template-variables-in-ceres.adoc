...
[NOTE]
====
This page is currently being constructed. At this point, the list provided here is incomplete and will be expanded in the near future.
====
...
|$ItemParamsList
|Contains an array with properties belonging to the item. Note:
