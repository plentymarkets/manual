...
link:https://marketplace.plentymarkets.com/en/plugins/widgets/Feedback_5115[Customer feedback^] is a plugin for the link:https://marketplace.plentymarkets.com/en/plugins/templates/Ceres_4697[Ceres^]{nbsp}icon:external-link[] online store. Install this plugin to display customer reviews in the online store and reply to feedbacks. Release reviews submitted by your customers in the *CMS » Feedback ratings* menu. In this menu, you also reply to customer feedbacks or edit them. It is also possible to migrate existing customer reviews or delete reviews in this menu.
