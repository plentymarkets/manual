...
The plentymarkets online store is split into two plugins: link:https://marketplace.plentymarkets.com/plugins/templates/Ceres_4697[Ceres^]{nbsp}icon:external-link[] provides the design of the online store and can be adapted to suit your personal needs.
The plugin link:https://marketplace.plentymarkets.com/plugins/templates/IO_4696[IO^]{nbsp}icon:external-link[] containts the base PHP functions for the online store and provides the logic for all design plugins.
