...
The plentymarkets online store is split into two plugins: link:https://marketplace.plentymarkets.com/plugins/templates/Ceres_4697[Ceres^] provides the design of the online store and can be adapted to suit your personal needs.
