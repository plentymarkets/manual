...
. Go to link::/[**Settings » Markets » Price comparison portals » Exports**].
...
|**Item name**
|Select which name should be exported: **Name 1** (name), **Name 2** or **Name 3**. These names are saved in the link::/[**Texts**] tab of the item.
