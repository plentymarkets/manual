...
* Click on *Visible in online store* (icon:eye[role="blue"]) to see what the item looks like in your online store. If the symbol is crossed out, then the item is *Invisible in the online store* (icon:eye[role="blue", stack="times,lr,darkGrey"]).
