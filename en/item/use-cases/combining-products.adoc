...
*_Note:_* It's possible to sell item sets in the link:https://marketplace.plentymarkets.com/en/plugins/sales/online-shops/ceres_4697[Ceres 5]{nbsp}icon:external-link[] store. Lower versions of Ceres do not support the set function.
