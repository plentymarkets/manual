...
Starting with link:https://marketplace.plentymarkets.com/en/plugins/sales/online-shops/ceres_4697[Ceres 5], it will be possible to sell item sets in the online store. However, it will _not be possible_ to sell item sets on marketplaces like Amazon or eBay.
|Set
|====
...
[WARNING]
.Sets are still being developed
====
Starting with link:https://marketplace.plentymarkets.com/en/plugins/sales/online-shops/ceres_4697[Ceres 5], it will be possible to sell item sets in the online store.
You can already start creating item sets in the back end and becoming familiar with the concept. However, you cannot currently display item sets in the online store.
Once the set function is released, your <<#4300, currently existing sets will be migrated>>.

The set function is only intended for the online store. Even after the function has been released, it will not be possible to sell item sets on marketplaces like Amazon and eBay.
====
...
Did you create item sets before link:https://marketplace.plentymarkets.com/en/plugins/sales/online-shops/ceres_4697[Ceres 5] was released?
