...
*_Note_*: It’s possible to sell item sets in the link:https://marketplace.plentymarkets.com/en/plugins/sales/online-shops/ceres_4697[plentyShop LTS]{nbsp}icon:external-link[].
Lower versions do not support the set function.
...
[IMPORTANT]
.Set function is only intended for plentyShop LTS
====
It’s possible to sell item sets in the link:https://marketplace.plentymarkets.com/en/plugins/sales/online-shops/ceres_4697[plentyShop LTS]{nbsp}icon:external-link[].
Lower versions do not support the set function.
...
.Requirements
====
The set function is only intended for link:https://marketplace.plentymarkets.com/en/plugins/sales/online-shops/ceres_4697[plentyShop LTS]{nbsp}icon:external-link[].
Lower versions do not support the set function.
