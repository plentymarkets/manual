...
*_Note_*: It’s possible to sell item sets in the link:https://marketplace.plentymarkets.com/en/plugins/sales/online-shops/ceres_4697[Ceres 5]{nbsp}icon:external-link[] store. Lower versions of Ceres do not support the set function.
The set function is only intended for the online store. It’s not possible to sell item sets on marketplaces like Amazon and eBay.
|Set
|====
...
Have you finished configuring sets in the back end?
Congratulations!
Now you’re ready to display the sets in the front end.

[IMPORTANT]
.Requirements
====
The set function is only intended for the link:https://marketplace.plentymarkets.com/en/plugins/sales/online-shops/ceres_4697[Ceres 5]{nbsp}icon:external-link[] store.
...
[TIP]
.Only activate one content per category
====
You can create many different contents per category and then activate or deactivate them as needed.
For example, this allows you to create different pages for each season of the year.

But you can only activate one content per category.
