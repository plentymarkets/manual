...
*_Note_*: It’s possible to sell item sets in the link:https://marketplace.plentymarkets.com/en/plugins/sales/online-shops/ceres_4697[Ceres 5]{nbsp}icon:external-link[] plentyShop.
Lower versions of Ceres do not support the set function.
The set function is only intended for the plentyShop. It’s not possible to sell item sets on marketplaces like Amazon and eBay.
|Set
|====
...
<<item/managing-items#200, Activate the variation>> when you’re ready for it to be visible your online store.
====
...
[IMPORTANT]
.Set function is only intended for the Ceres 5 plentyShop
====
It’s possible to sell item sets in the link:https://marketplace.plentymarkets.com/en/plugins/sales/online-shops/ceres_4697[Ceres 5]{nbsp}icon:external-link[] plentyShop.
Lower versions of Ceres do not support the set function.
...
[#4400]
=== Displaying sets in the online store

[IMPORTANT]
.Requirements
====
The set function is only intended for the link:https://marketplace.plentymarkets.com/en/plugins/sales/online-shops/ceres_4697[Ceres 5]{nbsp}icon:external-link[] plentyShop.
Lower versions of Ceres do not support the set function.
...
image::item/use-cases/assets/content-itemset.png[]
...
You can find this information in the <<online-store/shop-builder#55, online store chapter of the manual>>.

image::item/use-cases/assets/design.png[]
...
Your customer selects all of the preferred variations in the online store and then places the entire set in the shopping cart.

image::item/use-cases/assets/set-webshop.png[]
...
[.collapseBox]
.*Can I control the order in which the components are displayed in the online shop?*
--
...
*_Workaround_*:
Add the components in whichever order they should be displayed in the online shop.
--
