...
[IMPORTANT]
.From Ceres version 5.0.40
====
link:https://marketplace.plentymarkets.com/en/ceres_4697[plentyShop Ceres]{nbsp}icon:external-link[] supports order properties starting from version 5.0.40.
Lower versions of Ceres do not support this function.
To use order properties:

. <<plugins/updating-installed-plugins#, Update the Ceres plugin>> to version 5.0.40 or higher.
