...
With plentymarkets, you can sell personalised items in your online store.
...
As the name suggests, order characteristics are a special type of <<item/settings/properties#, characteristic>>. Customers can choose them in the online store and order them along with the product.
...
* Check the result in your online store.
...
Compare both images and see how the settings are displayed in the online store.
...
[discrete]
==== What your customer sees in the store
