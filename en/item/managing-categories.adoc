...
**Yes** = If in the *Setup » Client » Open client » Online store » Forwarding* the option *Redirect for categories* is set to *Carry out content search*, the category data is searched when customers try to open an invalid category URL. +
...
You can activate and/or deactivate several or all categories of a client (store) centrally in the **Setup » Client » Select client » Categories » Activate** menu.

[.instruction]
Activating several categories of a client (store):

. Go to **Setup » Client » Select client » Categories » Activate**.
