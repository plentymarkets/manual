...
|**Image gallery**
|Opens the **<<online-store/online-store/setting-up-clients/cms#image-gallery, image gallery>>** in a new tab.
...
**Yes** = If in the *System » Client » Open client » Online store » Forwarding* the option *Redirect for categories* is set to *Carry out content search*, the category data is searched when customers try to open an invalid category URL. +
