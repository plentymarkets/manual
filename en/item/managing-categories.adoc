...
|**Full text search**
|Select if the category is to be added to the search index of the online store’s category search. The category search for the faceted search is activated using the option *Category* in the *System » Client » Open client » Extras » Faceted search » Tab: Full text search* menu. +
**Yes** = The category is added to the search index of the online store’s category search. When customers enter a search term in the online store, the category name, description 1, description 2 and the meta title of the category are searched to find this search term. +
**No** = The category is not added to the search index of the category search. +
*_Note:_* FINDOLOGIC ignores this setting.
