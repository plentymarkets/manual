...
**Yes** = The category is added to the search index of the online store’s category search. The category search searches the following category data: Category name, Description 1 and 2, Meta title. +
...
Repeat these steps for the 2nd category image and click on **Image 2** in step 5. Deselect a category image by placing a check mark for the image and clicking on **Image 1** or **Image 2** a second time.
