...
|**Full text search**
|Select if the category is to be added to the search index of the online store’s category search. Go to *System » Client » Open client » Extras » Faceted search » Tab: Full text search* and activate the option *Category* to activate the category search. +
