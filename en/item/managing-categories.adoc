...
. Go to **System » Client » Open client » Categories » Basic settings**.
...
You can activate and/or deactivate several or all categories of a client (store) centrally in the **System » Client » Open client » Categories » Activate** menu.

[.instruction]
Activating several categories of a client (store):

. Go to **System » Client » Open client » Categories » Activate**.
