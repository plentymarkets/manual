...
.Delete image cache
====
It may be necessary to clear the image cache after changing settings in the **System » Items » Images** menu. Images may be displayed with old settings because these settings are still saved in the cache. Click on **Delete image cache** if you want the changes to go into effect more quickly. +
...
Variation numbers are assigned automatically when you create **Default** items or variations. You specify the patterns of new variation numbers in the **System » Item » Basic settings** menu. Proceed as described below to specify the pattern for creating new variation numbers.

. Go to **System » Item » Basic settings**.
...
|**Variation no.**
|The variation number is assigned automatically based on the pattern saved in the **System » Items » Basic settings** menu. Variation numbers can be changed subsequently in the **settings** tab of a variation.
...
|**Variation number**
|The variation number is automatically assigned based on the pattern saved in the **System » Items » Basic settings** menu. Variation numbers can be changed subsequently in the **settings** tab of a variation.
