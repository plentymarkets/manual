...
|Enter the URL of a placeholder image. This image will be shown if item images cannot be displayed. Upload a placeholder image in the <<online-store/online-store/setting-up-clients/cms#image-gallery, Image gallery>>.

|*URL of placeholder preview image*
|Enter the URL of a placeholder image for preview images. This image will be shown if preview images cannot be displayed. Upload a placeholder image in the <<online-store/online-store/setting-up-clients/cms#image-gallery, Image gallery>>.
...
Upload images in the <<online-store/online-store/setting-up-clients/cms#image-gallery, Image gallery>>. Copy the graphic's relative URL from the image gallery and insert it into the *URL* field.
