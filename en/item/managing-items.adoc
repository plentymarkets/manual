...
====
You can create large quantities of serial numbers at once with the data format **SerialKeys** in the menu **Data » Dynamic Export**. For further information about importing serial numbers, refer to the <<basics/data-exchange/export-import/data-formats#, Data formats>> page of the manual.
====
