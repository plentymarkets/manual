...
Properties of the *Item* area are linked to variations. As such, these properties are different from the old characteristics, which are linked at the item level. You can create up to 500 variation properties and link them to variations.
...
<<<<<<< HEAD
The *System » Item » Search » Back end » Search index » Tab: Item characteristic* shows how many items with characteristics are saved in the system and how many items with characteristics are in the search index.
=======
