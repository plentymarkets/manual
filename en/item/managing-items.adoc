...
|**Variation number**
|The variation number is automatically assigned based on the pattern saved in the **System » Item » Settings** menu. Variation numbers can be changed subsequently in the **settings** tab of a variation.
...
|The <<warenwirtschaft/wareneingaenge-verwalten#250, moving average net purchase price>>. The moving average net purchase price is recalculated every time stock is booked in. The calculation takes into account the purchase prices of all stock of a variation currently in stock. +
...
. Go to **System » Client » Select client » Online store » Basic settings**.
