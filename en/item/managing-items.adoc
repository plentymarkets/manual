...
|**Class**
|Activate one, multiple or **ALL** classes. The sales price will be linked with the activated classes. The sales price only applies to customers of the class selected.
...
→ <b>+</b> = The current price is increased by the amount entered. +
→ **-** = The current price is decreased by the amount entered +
→ **/** = The current price is divided by the value entered. +
→ <b>*</b> = The current price is multiplied by the value entered. +
