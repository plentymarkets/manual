...
You can upload images for attribute values. These images will be displayed as image tiles in the online store. Specify the size of attribute images in the <<item/managing-items#670, Setup » Item » Images>> menu.
...
Properties are <<item/managing-items#3100, created>> centrally in the menu *Setup » Settings » Properties » Configuration* and then they are linked to <<item/managing-items#4800, variations>>, <<crm/managing-contacts#, contacts>> or <<stock-management/setting-up-a-warehouse#500, storage locations>>.
...
Properties are centrally managed in the *Setup » Settings » Properties » Configuration* menu. Change the settings that are described in <<table-create-property>>.
...
. Go to **Setup » Item » Price calculation**.
...
Variation numbers are assigned automatically when you create **Default** items or variations. You specify the patterns of new variation numbers in the **Setup » Item » Settings** menu. Proceed as described below to specify the pattern for creating new variation numbers.
...
|**Net purchase price**
|The net purchase price. The purchase price is calculated or managed manually depending on the settings saved in the <<stock-management/new-incoming-items#250, Setup » Stock » Stock » Incoming items>> menu. +
...
Properties are <<item/managing-items#3000, centrally managed>> in the *Setup » Settings » Properties » Configuration* menu and can be linked to variations of *Default* items. Properties of the *Item* area are linked to variations in two different tabs of a variation:
...
|Tags
|Enter a tag name to search for variations that were linked to these tags. Go to *Setup » Settings » Tags* to create tags. +
*_Tip:_* Enter the first letter of the tag and then use the auto completion feature.
