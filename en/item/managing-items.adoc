...
Create items and item variations for your products in plentymarkets. Items can be sold in your **<<omni-channel/online-store/standard/online-store#, online store  >>** and on the many **<<omni-channel/multi-channel#, markets  >>** integrated with plentymarkets.

First, you will learn how to update product information for your items. Create **<<item/managing-items#390, attributes >>**, **<<item/managing-items#480, properties >>**, **<<item/managing-items#560, manufacturers >>** and **<<item/managing-items#630, barcodes >>**. Link this information with your items. Furthermore, you find explanations and tips for structuring **<<item/managing-items#870, sales prices >>** for your items and variations. **<<item/managing-items#910, Price calculations >>** will also be explained here. Price calculations allow you to customise and graduate prices for different customer classes as well as referrers.
...
|Enter the URL of a placeholder image. This will be shown if item images cannot be displayed. Upload a placeholder image in the **<<omni-channel/online-store/_cms/image-gallery#, Image gallery  >>**.

|**URL of placeholder preview image**
|Enter the URL of a placeholder image. This will be shown if preview images cannot be displayed. Upload a placeholder image in the **<<omni-channel/online-store/_cms/image-gallery#, Image gallery  >>**.
...
Every plentymarkets system has its own **<<omni-channel/online-store/global-settings/ftp-access#, FTP server  >>**. This FTP server contains the folder **upload_article_image_XXXX** (XXXX = plentyID) to which you can upload item images. The folder is checked for changes every 60 minutes. New, correctly named images are assigned to the correct item automatically. To upload files, you need an FTP program and your FTP login details.
...
|**Page**
|Enter the page width and height in millimetres. When using **<<basics/working-with-plentymarkets/basic-settings/printer#50, label printers >>** the paper size can be the same size as the label size.
...
Upload images in the **<<omni-channel/online-store/_cms/image-gallery#, Image gallery  >>**. Copy the graphic's relative URL from the image gallery and insert it into the **URL** field.
...
Generate labels directly from the template or with the **Labels** function of an item or variation. You also can use the plentymarkets Client and the available processes to **<<basics/processes/procedures#150, generate labels >>**.
...
. Configure the settings **Prefix for new variation numbers** and **Next variation number**. Pay attention to the explanations given in table 15.
. **Save** the settings.
...
|**Condition;  +
Condition for API**
|Select the item's condition. **New** is set by default. To display the condition in the detailed view of an item in the online store, insert the template variable **$condition** into the template **<<omni-channel/online-store/_cms-syntax/web-design/itemview/container-itemviewsingleitem#, ItemViewSingleItem  >>**. The **Condition for API** setting is used for the market **<<omni-channel/multi-channel/amazon#, Amazon  >>**.
...
|**Revenue account**
|Enter the revenue account. For further information about the revenue account, refer to the **<<omni-channel/online-store/standard/accounting#90, Accounting >>** page of the manual.
...
**Special offer** = Use the **<<omni-channel/online-store/_cms-syntax/web-design/itemview/container-itemviewspecialofferslist#, ItemViewSpecialOffersList  >>** template to display a list of special offers. +
**New item** = Use the **<<omni-channel/online-store/_cms-syntax/web-design/itemview/container-itemviewlatestitemslist#, ItemViewLatestItemsList  >>** template to display a list of the latest items. +
**Top item** = Use the **<<omni-channel/online-store/_cms-syntax/web-design/itemview/container-itemviewtopsellerslist#, ItemViewTopSellersList  >>** template to display a list of the best selling items.
...
// tr> <td colspan="2" class="th">Digitale Medien</td> </tr> <tr> <td><b>Datei</b></td> <td>Auf <strong>Hinzufügen</strong> klicken, um eine Datei zu verknüpfen, die zum Download angeboten wird. Weitere Informationen zu digitalen Medien finden Sie unter <strong><a href="{% Link(3203) %}">Digitale Medien hinzufügen</a></strong>.</td> </tr
...
|**Technical data**
|Enter the item's technical data. To display the technical data in the online store, insert the template variable **$TechnicalData** and, if needed, a title into the template **<<omni-channel/online-store/_cms-syntax/web-design/itemview/container-itemviewsingleitem#, ItemViewSingleItem  >>**.
...
Free text fields can be displayed at any position in the online store using the template variables **$Free[1]** to **$Free[20]**. Learn how to use free text fields in the online store on the **<<omni-channel/online-store/_cms/web-design/editing-the-web-design/itemview/dimension-input#, Dimension input  >>** page of the manual.
...
In the **Statistics** tab, you can create different statistics for the **Default** item. These statistics e.g. let you analyse the **Default** item's revenue according to various criteria. For further information, refer to the **<<basics/start/statistics/item-statistics#, Item statistics  >>** page of the manual.

[#150]
=== Adding tags to items

If you made your **<<basics/working-with-plentymarkets/basic-settings/tags#, tags  >>** available for the **Item** menu, you can add tags to items.
...
. Pay attention to the explanations given in table 26 and carry out the settings as desired.
. **Save** the settings.
...
If a variation's availability was not activated as described, then the variation can not be ordered in the online store. The visibility of the variation in the online store depends on the type of verification selected for the attribute availability in the <<omni-channel/online-store/standard/item-layouts/basic-settings#, **Settings » Client (store) » Standard » Item layouts » Basic settings**  >>.
...
. Open the item. +
→ The **Settings** tab of the main variation will open.
. Pay attention to the explanations given in table 27 and carry out the settings in the **Availability** area.
. **Save** the settings.
...
For further information about advance orders, refer to the **<<order-processing/orders/editing-sales-orders/advance-sales-orders#, Advance orders  >>** page of the manual.
...
. Open the **Default** item. +
→ The **Settings** tab of the main variation will open.
. Pay attention to the explanations given in table 28 and carry out the settings in the **Dimensions** area.
. **Save** the settings.
...
. Open the **Default** item. +
→ The **Settings** tab of the main variation will open.
. Pay attention to the explanations given in table 29 and carry out the settings in the **Costs** area.
. **Save** the settings.
...
|**VAT**
|Select the VAT rate for the main variation. For further information about VAT rates, refer to the **<<omni-channel/online-store/standard/accounting#3, Accounting >>** page of the manual.
...
. Open the **Default** item. +
→ The **Settings** tab of the main variation will open.
. Pay attention to the explanations given in table 30 and carry out the settings in the **Shipping** area.
. **Save** the settings.
...
**Item** = Display all items in the overview. No variations will be displayed. +
...
. Click on **Copy**. +
→ The item will be copied and the copy will open in a new tab.
...
→ The **New item** tab will open.
. Select the type **Set**.
. Carry out the additional settings. Pay attention to the explanations given in table 38.
. **Save** the settings. +
...
In the **<<omni-channel/online-store/standard/online-store/basic-settings#, basic settings  >>** of the online store, you set up cross-selling. On the one hand, you select which type of cross-selling you want to use. On the other hand, you select whether or not to use **dynamic cross-selling**.

[.instruction]
Setting up cross-selling:

. Go to **Settings » Client (store) » Standard » Online store » Basic settings**.
. Carry out the cross-selling settings as desired. Pay attention to the information given in table 40.
. **Save** the settings.
...
Once you have specified which cross-selling items should be offered, decide how the cross-selling items should be displayed in the online store. Use the templates **<<omni-channel/online-store/_cms-syntax/web-design/itemview/container-itemviewcrosssellingitemslist#, ItemViewCrossSellingItemsList  >>**, **<<omni-channel/online-store/_cms-syntax/web-design/itemview/container-itemviewcrosssellingitemslist2#, ItemViewCrossSellingItemsList2  >>** and **<<omni-channel/online-store/_cms-syntax/web-design/itemview/container-itemviewcrosssellingitemslist3#, ItemViewCrossSellingItemsList3  >>** to specify how cross-selling items are displayed. For example, you can specify how many cross-selling items should be displayed for an item and how many of them should be displayed next to each other. Finally, specify where and which cross-selling items should be displayed for a main item. For this, insert a container in one of the templates for single items, e.g. **<<omni-channel/online-store/_cms-syntax/web-design/itemview/container-itemviewsingleitem#, ItemViewSingleItem  >>**.
...
The layout for cross-selling items is designed in the templates **ItemViewCrossSellingItemsList** to **ItemViewCrossSellingItemsList3**. The templates **ItemViewCrossSellingItemsList** and **ItemViewCrossSellingItemsList2** are ready to use in the plentymarkets default design Callisto Light. These cross-selling templates are displayed using the containers **<<omni-channel/online-store/_cms-syntax/web-design/itemview/container-itemviewcrosssellingitemslist#, Container_ItemViewCrossSellingItemsList  >>** or **<<omni-channel/online-store/_cms-syntax/web-design/itemview/container-itemviewcrosssellingitemslist#, Container_ItemViewCrossSellingItemsList2  >>**. In Callisto Light, these containers are already integrated within the template for single items **<<omni-channel/online-store/_cms-syntax/web-design/itemview/container-itemviewsingleitem#, ItemViewSingleItem  >>** and used as follows:

* **<<omni-channel/online-store/_cms-syntax/web-design/itemview/container-itemviewcrosssellingitemslist#, Container_ItemViewCrossSellingItemsList  >>** lists similar items {%$CrossSellingType = "Similar" %}.
* **<<omni-channel/online-store/_cms-syntax/web-design/itemview/container-itemviewcrosssellingitemslist#, Container_ItemViewCrossSellingItemsList2  >>** lists accessories {%$CrossSellingType = "Accessory" %}.
...
The template **<<omni-channel/online-store/_cms-syntax/web-design/itemview/container-itemviewitemsbypositionlist#, ItemViewItemsByPositionList  >>** displays items according to their position. The items are displayed in descending order. This template can be used to display the automatically calculated top items in your online store.

For further information about setting up the different templates in the layout, refer to the **<<omni-channel/online-store/best-practice/item-sorting#, Item sorting  >>** page of the manual.
...
. **Save** the settings.
. Pay attention to the explanations given in table 44 and carry out the settings as desired.
. Place a check mark next to the option **Active**.
. **Save** the settings.
--
...
The plentymarkets Client allows you to **<<basics/processes/procedures#420, automate the registration of serial numbers >>**.
