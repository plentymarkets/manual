...
Item bundles consist of several **Default** items. The bundle price may be lower than the sum of the individual prices. Learn how to set up item bundles in the <<item/combining-products#2000, Setting up item bundles>>.
