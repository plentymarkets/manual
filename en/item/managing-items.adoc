...
|Enter the customs tariff number. For further information, for example refer to the website link:http://auskunft.ezt-online.de/ezto/Welcome.do[EZT-Online^]{nbsp}icon:external-link[] (in German).
