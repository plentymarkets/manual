...
|**Preview text**
|Enter the preview text. The preview text is a short text which can be displayed in item lists. The text can be entered in HTML format or as plain text.
...
|**Properties**
|Activate to change the properties for those variations selected in the item overview. +
Check box to the right of **Properties** selected = Activates inheritance of the main variation's properties to those variations selected in the item overview. The property settings saved for the variation are overwritten. +
Check box to the right of **Properties** not selected = Deactivates inheritance of the main variation's properties to those variations selected in the item overview. The main variation's properties are saved for the variation. +
**__Note:__** This group function controls inheritance of all properties saved in the *Properties* and *Texts* tabs of the main variation. In other words, a variation cannot inherit just one of the main variation's properties.
|====
