...
|Shows the last variation number that was assigned to a variation. Any new variation numbers that are generated are given ascending numbers. The variation number shown is updated as soon as a new variation number was generated. In other words, you will always see the number that was last assigned to a variation. Enter a number to change the pattern for new variation numbers. The next variation number is this number plus 1.
|====
