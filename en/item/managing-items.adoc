...
**__Note:__** If **No** is selected for the setting **Automatically sort by monthly sales** in the **System » Client » Open client » Item layouts » Basic settings** menu, manually entered position numbers will be overwritten automatically.
|====
...
. Go to **System » Client » Open client » Item layouts » Item availability**.
...
. Go to **System » Client » Open client » Online store » Basic settings**.
...
. Go to **System » Client » Open client » Item layouts » Basic settings**.
