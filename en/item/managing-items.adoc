...
*Whole number* = Allows entering a whole number. +
*Decimal number* = Allows entering a number with decimal places. +
*Selection* = Allows selecting multiple options. Up to 65.535 characters can be entered for each option and each value. +
*Short text* = Allows entering a short text without formatting. Up to 65.535 characters can be entered. +
*Text* = Allows entering and formatting a longer text. Up to 65.535 characters can be entered. +
*Text* = Allows entering a date. +
...
|https://*yoursubdomain.yourstore.de*/item/images/118/full/118-chair-Rio.jpg
|====
...
* Generate labels for all order items of an order <<#3320, in the label template>>.
...
. Tap *Search*. +
→ The items are shown. +
*_Tip:_* If only one item is found, this item opens. +
