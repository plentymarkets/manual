...
|Select the market property from the drop-down list or activate the property link for a market. For further information about creating properties for markets and price comparison portals, refer to the markets' pages in the topic <<omni-channel/multi-channel#, Multi-Channel>>.
|====
