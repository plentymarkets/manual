...
Finally, learn how to create <<item/managing-items#920, item bundles>> for items and variations. How to present your products in the most favourable way using <<item/managing-items#950, cross-selling>> will also be explained.
