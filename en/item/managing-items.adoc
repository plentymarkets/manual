...
In plentymarkets 7, you use **<<item/manging-categories#, categories>>** for organising and managing your items. We recommend that you create all categories and subcategories at once. This will help you to structure and understand your product portfolio.
