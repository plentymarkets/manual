...
Create items and item variations for your products in plentymarkets. Items can be sold in your **<<client-store/standard/online-store#, online store  >>** and on the many **<<multi-channel#, markets  >>** integrated with plentymarkets.
...
In order to transfer your **Default** items to certain markets, you have to link attributes and attribute values for these markets. For further information, refer to the markets' pages in the topic **<<multi-channel#, Multi-Channel  >>**.
...
|Select the market property from the drop-down menu or activate the property link for a market. For further information about creating properties for markets and price comparison portals, refer to the markets' pages in the topic **<<multi-channel#, Multi-Channel  >>**.
|====
...
|Enter the URL of a placeholder image. This will be shown if item images cannot be displayed. Upload a placeholder image in the **<<cms/image-gallery#, Image gallery  >>**.

|**URL of placeholder preview image**
|Enter the URL of a placeholder image. This will be shown if preview images cannot be displayed. Upload a placeholder image in the **<<cms/image-gallery#, Image gallery  >>**.
...
Every plentymarkets system has its own **<<client-store/global-settings/ftp-access#, FTP server  >>**. This FTP server contains the folder **upload_article_image_XXXX** (XXXX = plentyID) to which you can upload item images. The folder is checked for changes every 60 minutes. New, correctly named images are assigned to the correct item automatically. To upload files, you need an FTP program and your FTP login details.
...
**Special offer** = Activate to mark the sales price as a special offer. Special offers are used for markets, e.g. **<<multi-channel/amazon#, Amazon  >>** and **<<multi-channel/real-de#, real.de  >>**. +
...
|**Page**
|Enter the page width and height in millimetres. When using **<<working-with-plentymarkets/basic-settings/printer#50., label printers >>** the paper size can be the same size as the label size.
...
Upload images in the **<<cms/image-gallery#, Image gallery  >>**. Copy the graphic's relative URL from the image gallery and insert it into the **URL** field.
...
Generate labels directly from the template or with the **Labels** function of an item or variation. You also can use the plentymarkets Client and the available processes to **<<processes/procedures#150., generate labels >>**.
...
|**Condition;  +
Condition for API**
|Select the item's condition. **New** is set by default. To display the condition in the detailed view of an item in the online store, insert the template variable **$condition** into the template **<<cms-syntax/web-design/itemview/container-itemviewsingleitem#, ItemViewSingleItem  >>**. The **Condition for API** setting is used for the market **<<multi-channel/amazon#, Amazon  >>**.
...
|**Revenue account**
|Enter the revenue account. For further information about the revenue account, refer to the **<<client-store/standard/accounting#90., Accounting >>** page of the manual.
...
|**Coupon**
|Select whether coupons for special offers should be **permitted** or **not permitted** for a **Default** item, or if a **Default** item is purchasable with coupons for special offers only. For further information about coupons, refer to the **<<orders/coupons#, Coupons  >>** page of the manual.

|**Subscription**
|Select whether a subscription is available for the **Default** item. Subscriptions are set up in the scheduler. The scheduler is an individual module in plentymarkets that allows an item to be shipped in regular intervals. The scheduler menu will be visible in plentymarkets after **link:https://www.plentymarkets.co.uk/prices/[booking the module]**. For further information about setting up subscriptions, refer to the **<<orders/scheduler/subscription-sales-orders#, Scheduled orders  >>** page of the manual.
...
**Special offer** = Use the **<<cms-syntax/web-design/itemview/container-itemviewspecialofferslist#, ItemViewSpecialOffersList  >>** template to display a list of special offers. +
**New item** = Use the **<<cms-syntax/web-design/itemview/container-itemviewlatestitemslist#, ItemViewLatestItemsList  >>** template to display a list of the latest items. +
**Top item** = Use the **<<cms-syntax/web-design/itemview/container-itemviewtopsellerslist#, ItemViewTopSellersList  >>** template to display a list of the best selling items.
...
In the **Multi-Channel** tab, change the settings for the markets **<<multi-channel/amazon#, Amazon  >>**, **<<multi-channel/ebay#, eBay  >>** and **<<multi-channel/neckermann-at#, Neckermann.at  >>**. Furthermore, link your categories to the categories of markets. The settings in this area are for the topic **<<multi-channel#, Multi-Channel  >>** and are described on the markets' pages.
...
|**Technical data**
|Enter the item's technical data. To display the technical data in the online store, insert the template variable **$TechnicalData** and, if needed, a title into the template **<<cms-syntax/web-design/itemview/container-itemviewsingleitem#, ItemViewSingleItem  >>**.
...
Free text fields can be displayed at any position in the online store using the template variables **$Free[1]** to **$Free[20]**. Learn how to use free text fields in the online store on the **<<cms/web-design/editing-the-web-design/itemview/dimension-input#, Dimension input  >>** page of the manual.
...
|**Availability**
|Option can only be selected for **Default** items. Activate markets to enable the image export to and the visibility for **<<multi-channel#, markets  >>**.
...
In the **Statistics** tab, you can create different statistics for the **Default** item. These statistics e.g. let you analyse the **Default** item's revenue according to various criteria. For further information, refer to the **<<start/statistics/item-statistics#, Item statistics  >>** page of the manual.

[#150]
=== Adding tags to items

If you made your **<<working-with-plentymarkets/basic-settings/tags#, tags  >>** available for the **Item** menu, you can add tags to items.
...
|**Multi-Channel**
|The settings in this area are for the topic **<<multi-channel#, Multi-Channel  >>** and are described on the markets' pages.
...
If a variation's availability was not activated as described, then the variation can not be ordered in the online store. The visibility of the variation in the online store depends on the type of verification selected for the attribute availability in the <<client-store/standard/item-layouts/basic-settings#, **Settings » Client (store) » Standard » Item layouts » Basic settings**  >>.
...
For further information about advance orders, refer to the **<<orders/editing-sales-orders/advance-sales-orders#, Advance orders  >>** page of the manual.
...
In the **Availability** tab, you activate **<<multi-channel#, markets  >>** and make changes to the SKU settings.
...
ASIN (Amazon Standard Identification Number) and ePID (eBay Product ID) are product labels of **<<multi-channel/amazon#, Amazon  >>** and **<<multi-channel/ebay#, eBay  >>**. The ASIN contains 10 characters and/or numbers. For books, the ASIN matches the ISBN. The ASIN can be found on Amazon's product page. The ePID is provided by eBay. Link ASIN and ePID with your variations.
...
|**Gross weight**
|Enter the variation's gross weight in grams or kilograms. This weight includes the packaging for variations that are packaged separately. The value entered here is used for calculating <<fulfilment/preparing-the-shipment#1900., **shipping packages** >> and weight-based **<<fulfilment/preparing-the-shipment#1700., shipping costs >>**. The gross weight is displayed in the online store with the template variable **$Weight**.
...
|**VAT**
|Select the VAT rate for the main variation. For further information about VAT rates, refer to the **<<client-store/standard/accounting#3, Accounting >>** page of the manual.
...
Values entered are valid for the markets <<multi-channel/neckermann-at#, **Neckermann.at**  >>, <<multi-channel/otto#, **OTTO**  >>, **<<multi-channel/rakuten#, Rakuten  >>**, <<multi-channel/plus-gartenxxl#, **Plus.de**  >>. The buffer entered here takes priority over the buffer values entered for the particular market.
...
|**Age rating**
|Select the age rating for the **Set** item. Select this age rating based on the variation of the set with the highest age rating. Items with an **18+** age rating must be linked to a **<<fulfilment/preparing-the-shipment#1000., shipping profile >>** for which the **PostIdent** option was activated.

|**Coupon**
|Select whether coupons should be **permitted** or **not permitted** for the set, or if the set is **purchasable with coupons only**. For further information about coupons, refer to the **<<orders/coupons#, Coupons  >>** page of the manual.

|**Shipping package**
|Use a shipping package. Shipping packages have specific dimensions. If you enter the item's dimensions in the **Settings** tab of the **Set** item, the correct shipping package will be assigned automatically. For further information about setting up shipping packages, refer to the **<<fulfilment/preparing-the-shipment#1900., Shipping packages >>** page of the manual.
...
.YOOCHOOSE
====
The external service provider <<marketing/yoochoose#, **YOOCHOOSE**  >> offers an alternative to plentymarkets cross-selling.
====
...
In the **<<client-store/standard/online-store/basic-settings#, basic settings  >>** of the online store, you set up cross-selling. On the one hand, you select which type of cross-selling you want to use. On the other hand, you select whether or not to use **dynamic cross-selling**.
...
Once you have specified which cross-selling items should be offered, decide how the cross-selling items should be displayed in the online store. Use the templates **<<cms-syntax/web-design/itemview/container-itemviewcrosssellingitemslist#, ItemViewCrossSellingItemsList  >>**, **<<cms-syntax/web-design/itemview/container-itemviewcrosssellingitemslist2#, ItemViewCrossSellingItemsList2  >>** and **<<cms-syntax/web-design/itemview/container-itemviewcrosssellingitemslist3#, ItemViewCrossSellingItemsList3  >>** to specify how cross-selling items are displayed. For example, you can specify how many cross-selling items should be displayed for an item and how many of them should be displayed next to each other. Finally, specify where and which cross-selling items should be displayed for a main item. For this, insert a container in one of the templates for single items, e.g. **<<cms-syntax/web-design/itemview/container-itemviewsingleitem#, ItemViewSingleItem  >>**.
...
The layout for cross-selling items is designed in the templates **ItemViewCrossSellingItemsList** to **ItemViewCrossSellingItemsList3**. The templates **ItemViewCrossSellingItemsList** and **ItemViewCrossSellingItemsList2** are ready to use in the plentymarkets default design Callisto Light. These cross-selling templates are displayed using the containers **<<cms-syntax/web-design/itemview/container-itemviewcrosssellingitemslist#, Container_ItemViewCrossSellingItemsList  >>** or **<<cms-syntax/web-design/itemview/container-itemviewcrosssellingitemslist#, Container_ItemViewCrossSellingItemsList2  >>**. In Callisto Light, these containers are already integrated within the template for single items **<<cms-syntax/web-design/itemview/container-itemviewsingleitem#, ItemViewSingleItem  >>** and used as follows:

* **<<cms-syntax/web-design/itemview/container-itemviewcrosssellingitemslist#, Container_ItemViewCrossSellingItemsList  >>** lists similar items {%$CrossSellingType = "Similar" %}.
* **<<cms-syntax/web-design/itemview/container-itemviewcrosssellingitemslist#, Container_ItemViewCrossSellingItemsList2  >>** lists accessories {%$CrossSellingType = "Accessory" %}.
...
The template **<<cms-syntax/web-design/itemview/container-itemviewitemsbypositionlist#, ItemViewItemsByPositionList  >>** displays items according to their position. The items are displayed in descending order. This template can be used to display the automatically calculated top items in your online store.

For further information about setting up the different templates in the layout, refer to the **<<client-store/best-practice/item-sorting#, Item sorting  >>** page of the manual.
...
====
You can create large quantities of serial numbers at once with the data format **SerialKeys** in the menu **Data exchange » Export » Dynamic Export**. For further information about importing serial numbers, refer to the **<<data-exchange/data-formats#, Data formats  >>** page of the manual.
====
...
The plentymarkets Client allows you to **<<processes/procedures#420., automate the registration of serial numbers >>**.
