...
Properties are centrally managed in the *System » Settings » Properties* menu. Change the settings that are described in <<table-create-property>> in this menu.
...
|**Sales prices**
|Link sales prices and enter values for the linked prices. Learn how to create and edit sales price in the <<item/managing-items#870, Managing manufacturers>> chapter.
|====
