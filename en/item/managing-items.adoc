...
Go to *System » Settings » Properties » Configuration* to create properties that you will later use for characterising your variations. Proceed as described below to create a property.
