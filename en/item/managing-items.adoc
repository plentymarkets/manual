...
For further information about advance orders, refer to <<orders/managing-orders#1100, Advance orders>>.
...
|**VAT**
|Select the VAT rate for the main variation. For further information about VAT rates, refer to the <<orders/accounting#300, Accounting>> page of the manual.
