...
Create items and item variations for your products in plentymarkets. Items can be sold in your <<omni-channel/online-store/setting-up-clients#, online-store>> and on the many <<markets#, markets>> integrated with plentymarkets.
...
* The subdomain must not contain *www*. * The subdomain must not exist in the Service center.
...
====
New items and changes to item data are not available in the online store and exports immediately. Find out how to check the status of item data on the <<item/checking-data-status#, Checking status of item data>> page of the manual. In the save bar of the item, click on the preview icon to preview changes to the item in the online store.
====
...
.Changes not visible immediately
====
New variations and changes to variation data are not available in the online store and exports immediately. Find out how to check the status of variation data on the <<item/checking-data-status#, Checking status of item data>> page of the manual. In the save bar of the variation, click on the preview icon to preview changes to the variation in the online store.
====
...
|Tags
|Enter a tag name to search for variations that were linked to these tags. Go to *System » Settings » Tags* to create tags. +
*_Tip:_* Enter the first letter of the tag and then use the auto completion feature.
