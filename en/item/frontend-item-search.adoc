...
Activate the new faceted search by going to *Setup » Client » Open client » Online store » Item search* and activating the option *Faceted search (Elastic Search - BETA)*. Set up the faceted search as described in the <<item/frontend-item-search#90, Setting up the faceted search>> chapter. Then proceed as described below to use the new faceted search in Callisto.
