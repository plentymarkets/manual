...
For further information about setting up the faceted search in Ceres, refer to the <<online-store/online-store/setting-up-ceres#330, Setting up Ceres>> page of the manual.
