...
Use <<data/exporting-data/marketplace-export#, catalogues>> to export variation data to markets and other sales channels. Currently, you can use catalogues to transfer data to the markets Etsy, Metro, OTTO Market and Amazon.
