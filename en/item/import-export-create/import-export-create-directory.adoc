...
image::item/import-export-create/assets/item-id.png[]
...
image::item/import-export-create/assets/upper-tab-row.png[]
...
image::item/import-export-create/assets/lower-tab-row.png[]
...
| *Position*
|
include::../_textblocks/directory/variation/settings/basic-settings/variation-position.adoc[]
...
Note that there is also the <<item/managing-items#340, Tab: Availability>>, which you’ll use to specify where the variation is available.
...
! *Visible automatically if net stock is positive*
!
include::../_textblocks/directory/variation/settings/availability/item-list/item-list-automatically-visible.adoc[]

! *Invisible automatically if net stock is 0 or negative*
!
include::../_textblocks/directory/variation/settings/availability/item-list/item-list-automatically-invisible.adoc[]
...
| *Max. order quantity*
|
include::../_textblocks/directory/variation/settings/availability/availability-max-order-quantity.adoc[]
...
Here you can link the variation to any number of <<item/settings/flags#400, tags>>.
...
====
Note that there is also the <<item/managing-items#200, Tab: Settings » Area: Availability>>, which you’ll use to specify when the variation should be visible or purchasable.
====
