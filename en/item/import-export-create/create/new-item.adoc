...
* Regularly <<item/import-export-create/create/new-item#600, preview the item>> in the online store and see where you need to add more product data or adjust the settings.
...
Are you curious what the new product looks like in your online store?
...
Variations are not visible to customers in the online store until they have been activated.
...
Work through <<item/online-store/checklist-items-visibility#, this checklist>> and make sure your item meets all of the requirements for being visible in the online store.
