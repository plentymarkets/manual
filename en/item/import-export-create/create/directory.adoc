...
The variation will be displayed in all of the selected categories in the online shop.
...
The default category is the breadcrumb path displayed in the online shop.
...
Reorder the variation to get it back in stock. Alternatively, click on the lock symbol (icon:lock[role="darkGrey"]) if you want to manually make the variation visible in the online store despite the fact that it’s not in stock.
