...
Categories of the type **Container** can only be edited with the HTML editor **Text field** and the <<omni-channel/online-store/cms/web-design/tools/syntax-editor#, **Syntax editor**  >>. This ensures that you can view and edit the formatting (CSS classes) correctly.
