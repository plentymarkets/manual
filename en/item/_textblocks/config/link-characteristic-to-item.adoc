...
====
Use the <<item/managing-items#155, item group function>> if you want to link several items at once.
====
...
*_Note:_* The characteristic type determines how you will interact with the *Default language* column and with the drop-down list of language abbreviations.
...
Therefore, you - the seller - do not need to take any further action for this field. Rather, your customers will make an entry when purchasing the item in your online store.
!===
...
*_Note:_* The entry field _only appears for order characteristics_.
|====
