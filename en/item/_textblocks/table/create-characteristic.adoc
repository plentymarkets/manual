...
*_Note:_* Once you’ve <<item/settings/properties#350, linked the characteristic to an item>>, you’ll no longer be able to change the type.
...
* <<item/settings/properties#order-characteristic, As an order characteristic>>: appropriate e.g. for offering customers <<item/use-cases/personalised-items#200, additional options and services>> while they place their orders.
...
! *Text*
!<<item/settings/properties#order-characteristic, As an order characteristic>>: allows customers, e.g. to <<item/use-cases/personalised-items#100, enter a personal text>> that should be printed on a t-shirt.

! *Selection*
!<<item/settings/properties#order-characteristic, As an order characteristic>>: allows customers, e.g. to choose whether their personal text should be printed in red, blue or black font.
...
! *File*
!<<item/settings/properties#order-characteristic, As an order characteristic>>: allows customers, e.g. to <<item/use-cases/personalised-items#100, upload an image>> that should be printed on a t-shirt.
...
|[#order-characteristic]*Order characteristic*
...
How exactly customers can personalise their orders depends on which <<item/settings/properties#characteristic-type, type of characteristic>> you chose.
