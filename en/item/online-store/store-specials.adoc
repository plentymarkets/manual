...
* <<data/importing-data/sync-types/elasticSync-item#2260, Import>>: Use the mapping field *Item / Store special*.
====
...
. Expand the area *Ceres » Store specials* (icon:chevron-down[role="darkGrey"]).
