...
* <<item/frontend-item-search#120, Specify which webshop the filters should appear in>>.
...
This name is displayed in the English language version of your webshop.
In other words, the name is visible to customers.

*_Other language versions_*: Is your store also available in other languages?
...
| *Position*
|Where should the filter appear in the webshop?
...
The position number specifies where the filter should appear in the webshop.
In other words, which filter should be displayed first, second, third, etc.
...
This is the minimum number of results that a filter value must have, in order for it to be displayed in the online shop.Filter values will automatically be invisible in the online shop if they do not return the minimum number of results.
...
This name is displayed in the English language version of your webshop. In other words, the name is visible to customers.
But what should you do if your store is also available in other languages?
In this tab, you can save names in other languages.

. Go to *Setup » Client » Settings » Services » Faceted search*.
. Open the facet and click on *Tab: Name*.
. Enter translations for every language version of your webshop.
. *Save* (icon:save[role="green"]) the settings.
...
You want customers to see _colour tiles_ in the online shop, rather than colour names.
There are two steps to the process:
...
====
<<item/frontend-item-search#120, In a later step>>, you’ll click on the option *Make images available* (icon:check-square[role="blue"]) to display the linked images in the online shop.
====
...
[#110]
== Online shop search settings

[#120]
=== Which shops should the filters appear in?

Once you’ve created the filters, you’ll need to specify which online shops they should be available in.
...
. In the list on the left, click on whichever filter should appear in the online shop.
...
Select the option *Make images available* (icon:check-square[role="blue"]) to display the images in the online shop.
...
[#150]
== Displaying filters in the online shop
...
. Click on the tile *New* (icon:plus[role="green"]). +
→ The *Create new content* window opens.
. Select the type *Category view*.
. Enter a name and choose a preset if desired.
. Save the settings. +
→ The new content will be displayed as a tile.

image::item/online-store/assets/content-category-view.png[]
...
You can change the texts in the webshop to meet your needs.
...
. Expand the area *Ceres » Item* (icon:chevron-down[role="darkGrey"]).
...
In order for the content to be displayed in the online store, it needs to be activated.
...
. Move your cursor over the content tile that should be activated.
. Click on *Activate* (icon:eye[role="blue"]). +
...
[#220]
=== Checking the result in the online store

Click on *Preview* (icon:eye[role="blue"]) and check what the search filters look like in your online shop.
Change the appearance as needed.
Are you happy with the result?
Then <<welcome/quick-start/quick-start-online-store#270, deploy the Ceres plugin>> to apply the changes.
