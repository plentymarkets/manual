...
*_Note_*: Make sure that you've also saved an <<item/settings/manufacturers#100, external name for your manufacturers>>.
...
Make sure you've saved an <<item/settings/manufacturers#100, external name for the manufacturer>>.
