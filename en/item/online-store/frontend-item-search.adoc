...
This is the minimum number of results that a filter value must have, in order for it to be displayed in the online shop.
Filter values will automatically be invisible in the online shop if they do not return the minimum number of results.
