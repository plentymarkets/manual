...
====
It's possible to customise the front end item search for your link:https://marketplace.plentymarkets.com/en/plugins/sales/online-shops/ceres_4697[Ceres 5] store.
