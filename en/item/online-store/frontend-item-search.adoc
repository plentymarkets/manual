...
[WARNING]
.Item search is still being developed
====
Starting with link:https://marketplace.plentymarkets.com/en/plugins/sales/online-shops/ceres_4697[Ceres 5], it will be possible to customise the front end item search as described in this chapter.
====
