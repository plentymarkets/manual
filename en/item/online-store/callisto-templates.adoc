...
:keywords: Webshop, Shop, Online shop, Online store, Ceres, Frontend, Front end, Item, Items, Template, Templates, Item template, Item templates, Descriptive texts, Descriptive text, Item texts, Item text, Texts, Text, Category, Categories
:position: 60
...
====
It’s technically possible to use item templates with the Ceres webshop.
...
You can use item templates to design your webshop’s product pages.
...
<<welcome/quick-start/quick-start-online-store#270, Deploy the Ceres plugin>> and check what the template looks like in your webshop.
