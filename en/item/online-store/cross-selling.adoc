...
However, you can display a list of related items on the product pages in your online store.
...
[TIP]
.Other cross-selling services
====
The external service <<online-store/online-store/extras/yoochoose#, YOOCHOOSE>> offers an alternative to plentymarkets cross-selling.
====
////
...
. Publish the cross-selling list in your <<item/online-store/cross-selling#700, Ceres webshop>>.
...
Use _ShopBuilder_ and so-called _item lists_ to display cross-selling items in your Ceres webshop.
