...
image::item/online-store/assets/cross-selling.png[]
...
* <<item/online-store/cross-selling#200, Create cross-selling links>>.
* <<item/online-store/cross-selling#700, Publish the cross-selling list in the plentyShop>>.
...
. Go to *Item » Edit item*.
. <<item/introduction/search#100, Search for>> and open the replacement part, e.g. the replacement guitar strings.
. Open the tab *Cross-selling » Add item(s)*.
. Search for items again in this tab.
...
Once you’ve <<item/online-store/cross-selling#200, created a cross-selling link>>, you’ll see it in an overview within the item data record.
...
image::item/online-store/assets/cross-selling-content.gif[]
...
image::item/online-store/assets/cross-selling-add-widget.gif[]
...
image::item/online-store/assets/cross-selling-appearance.gif[]
