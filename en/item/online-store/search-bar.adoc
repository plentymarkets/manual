...
You decide what the search bar looks like in the online store and which results it delivers.
...
If you run online stores in other languages, you can select different languages.
