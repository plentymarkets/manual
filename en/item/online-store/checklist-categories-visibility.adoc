...
:keywords: Online store, Client, Category, Categories, Visibility, Availability, Checklist, FAQ, Ceres, Callisto, Online store, Online shop, Shop, Store, Frontend, Front end, Category isn't visible, Categories aren't visible, Category not visible, Categories not visible
:position: 10
...
You’ve finished <<item/settings/categories#, creating your categories>> and now you want to see what they look like in your store. But where are they? Why aren’t they visible?
Work through this checklist and make sure your category meets all of the requirements for being visible in the online store.
...
//tag::variante[]
A category will only be visible if it’s linked to at least one <<item/online-store/checklist-items-visibility#, variation that’s visible in the online store>>.
