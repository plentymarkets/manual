...
Open the menu *System » System settings » Client » Standard Shop » Categories » Activate* and make sure you’ve activated the categories.
...
.You are required to link a category in plentymarkets 7
...
Open the menu *System » System settings » Client » Standard Shop » Categories » Settings* and specify how many category levels should be displayed in your online store.
