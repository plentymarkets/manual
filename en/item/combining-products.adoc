...
The settings of the variations are edited in the same way as <<item/managing-items#170, Default variations>>. However, note the following limitations for multipack variations:
