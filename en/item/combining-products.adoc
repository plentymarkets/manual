= Combining products: Multipacks, bundles, sets
:lang: en
...
plentymarkets offers a variety of ways of combining products to sell them as a single order item. This means that the customer adds more than one product to the shopping cart at once. <<table-combining-products>> shows the different options for grouping products.
...
For *Multipack* items, the main variation is the smallest sales unit of the product. All other variations of the item are combinations of this smallest sales unit. Stock is managed for the main variation only. In the online store, customers select the variation with the number of products they want to buy.
...
A main variation is always created when a new *Multipack* item is created. The main variation is linked to an item. It cannot be deleted. This main variation is the smallest sales unit of the product. All other variations of the item are combinations of this smallest sales unit. Stock is managed for the main variation only.
...
. Enter the content of the variation. +
*_Note:_* The content must be divisible by content of the main variation.
*_Tip:_* The units and the attributes cannot be changed because the variation consists of x times the main variation.
...
→ The components are added to the bundle and displayed in the *Bundle components* tab.
