...
:keywords: Variation number, Variation numbers, Variation nr., Variation no., Prefix for new variation numbers, Last generated variation number, Prefix, NEW-, Pattern
...
Every time you <<item/managing-items#, create a new item or variation>>, it automatically receives a variation number.
