...
It can be displayed <<item/managing-items#270, in the online store>>, on sales channels such as <<markets/amazon/preparing-variations#860, Amazon>>, <<markets/ebay/ebay-setup#4000, eBay>> or <<markets/plus-gartenxxl#365, Netto>> and <<item/settings/barcodes#900, on item labels>>.
