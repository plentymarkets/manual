...
It can be displayed <<item/managing-items#270, in the plentyShop>>, on sales channels such as <<markets/amazon/preparing-variations#860, Amazon>>, <<markets/ebay/ebay-setup#4000, eBay>>, <<markets/otto-market#1302, OTTO>> or <<markets/plus-gartenxxl#365, Netto>> and <<item/settings/barcodes#900, on item labels>>.
