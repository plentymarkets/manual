...
When the function will become available depends on whether you have a Beta, Early or Stable system.

* *Beta* = March 31st, 2021
* *Early* = April 7th, 2021
* *Stable* = April 14th, 2021
