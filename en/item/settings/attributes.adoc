...
|include::../_textblocks/table/groupable.adoc[]
|====
...
Some markets, such as <<markets/amazon/preparing-variations#1350, Amazon>> and <<markets/ebay/ebay-setup#6100, eBay>>, require you to link your own attribute values with their attribute values.
...
include::attributes.adoc[tag=attribute-name-appearance-shop]
...
include::attributes.adoc[tag=steps-attribute-value-name-translations]
...
include::attributes.adoc[tag=market-attribute-link]
