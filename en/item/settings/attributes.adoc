...
| *Position*
a|Which attribute should be displayed in the online shop first, second, third, etc?
...
* *With box* = Attributes are displayed as boxes with attribute values in the online store.
...
| *Position*
|Which attribute value should be displayed in the online shop first, second, third, etc?
Enter a position number into this field.
