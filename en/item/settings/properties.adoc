...
Use the *Properties* sync type. The fields that you can use for mapping and matching are described on the page of the manual of the sync type <<data/importing-data/sync-types/elasticSync-properties#, Properties>>.
...
Use the *Item* sync type and the mapping fields under the heading <<data/importing-data/sync-types/elasticSync-item#2410, Properties>>.
