...
* Should your customers be able to search in the online shop for products made by a specific manufacturer?
Customise the <<item/settings/manufacturers#450, online shop settings>> as needed.
...
* The external name will be visible to customers in the online shop.
It is also <<item/settings/manufacturers#450, relevant for the search function in your online shop>>.
...
[#450]
== Checking the online shop settings
