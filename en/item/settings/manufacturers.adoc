...
| *ID*
|
include::../_textblocks/settings/manufacturer/id.adoc[]

| *Name*
|
include::../_textblocks/settings/manufacturer/name.adoc[]
...
| *Position*
|
include::../_textblocks/settings/manufacturer/position.adoc[]
