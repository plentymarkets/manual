...
You can either <<item/settings/manufacturers#100, manually create>> manufacturer data records or you can <<item/settings/manufacturers#200, import>> them. You can also <<item/settings/manufacturers#300, save commissions for your manufacturers>> and specify <<item/settings/manufacturers#400, who manufacturers each of your items>>.

[#100]
== Manually creating manufacturer data records
...
[#200]
== Importing manufacturer data records
