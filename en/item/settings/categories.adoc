...
You can choose from the <<online-store/online-store/cms#_editor, Editor>>, the HTML editor *Text field* and the <<online-store/online-store/cms#_syntax_editor, Syntax editor>>.
...
|Opens the category and lets you <<item/settings/categories#500, edit it further>>.
