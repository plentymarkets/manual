...
* Click on *Save* (icon:save[role="green"]) to save your changes to the category. If you haven’t made any changes to the category, then the symbol will be greyed out. If there are any <<welcome/customise-system#70, unsaved changes>>, then the tab will be flagged with a red triangle (icon:caret-left[role="red", rotate=90]).
