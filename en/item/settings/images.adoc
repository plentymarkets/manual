...
Then follow <<item/settings/images#400, the instructions here>> instead.
====
...
Then follow <<item/settings/images#300, the instructions here>> instead.
====
...
Older plentymarkets systems have their own <<data/ftp-access#, FTP server>>.
