...
====
The DNS entries that were generated in plentymarkets need to be saved with the external domain provider within 72 hours.
...
→ The process is complete once green checkmarks are shown in the columns *SSL*, *DNS* and *Cloud status* of the *Setup » Client » Open client » CDN-Domains* menu in the plentymarkets back end.
. Once all three checkmarks are shown in the *Setup » Clients » Open client » CDN-Domains* menu, click on *Activate* in the *Status* column. +
→ The domain is activated.
