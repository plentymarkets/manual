...
* *_Keywords in the online store_*: you decide which tags should be <<welcome/general-functions/tags#intable-client, visible to customers in the online store>> and which should not.
...
include::../../welcome/general-functions/tags.adoc[tag=create-new-tags]
