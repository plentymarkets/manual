...
File for this video:
link:https://cdn02.plentymarkets.com/pmsbpnokwu6a/frontend/Pickliste__Rechnung___Versandlab.plentyprocess[Fulfillment process]{nbsp}icon:external-link[]
