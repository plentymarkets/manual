= Your plentymarkets POS system
:lang: en
include::{includedir}/_header.adoc[]
:position: 10
:url: videos/pos/introduction/plentymarkets-pos

//tag::einleitung[]
[cols="2, 1" grid=none]
|===
|The plentymarkets POS system combines the vast potential of e-commerce with a brick and mortar store. Meet three fictional sellers who use plentymarkets POS to help their businesses grow. And find out how you can book plentymarkets POS for your own company.
|
|===
//end::einleitung[]
