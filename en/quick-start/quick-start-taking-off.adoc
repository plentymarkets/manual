...
:position: 10
:url: quick-start/quick-start-taking-off
:id: 1WSFUVF
...
// * Link any Amazon account you may have
* Link any eBay account you may have
...
====
Our consultants will support you with help and advice, just link:https://www.plentymarkets.co.uk/service/system-setup/[make an appointment^]. Alternatively, you can also get in touch with one of our link:https://marketplace.plentymarkets.com/en/services/support[partners^].
====
...
TIP: Continue with the <<quick-start/quick-start-initial-settings#, initial settings>>.
