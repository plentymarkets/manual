...
====
In the *Setup » Client* » _Select client_ » *Email » Automatic* menu, you should only select email templates that you have edited and completed with your individual data.
====
