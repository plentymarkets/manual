...
IMPORTANT: Have you already created document templates for invoices and reversal documents? Not yet? Return to <<quick-start/quick-start-order-processing, preparing order processing>>.
