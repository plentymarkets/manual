...
|*Own VAT number*
|Use this field to display your company’s own VAT number on the invoice. In case you have not already done so, you must submit your VAT number beforehand in the *System » System settings » Client » Select client » Locations » Select location » Accounting*. We recommend to only use this field to display the VAT number on the *Invoice* document in case it is not already included in your company’s letterhead.
