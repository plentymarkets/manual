...
Go to *Setup » Assistants* and open the section *Basic setup*. Complete the *Basics* assistant to carry out the following settings:
...
====
Making changes to this master data will not have any effect on the customer information that is saved in your contract with plentymarkets, e.g. for billing purposes. Contract information has to be changed in the *plentymarkets logo (Start) » Service centre* menu.
====
...
For further information about template variables, refer to the chapters <<quick-start/quick-start-initial-settings#600, Example: Customising the email template>> and <<quick-start/quick-start-initial-settings#700, Inserting template variables and template functions>> further down on this page of the manual.
...
Go to *Setup » Assistants* and open the section *Basic setup*. Complete the *Email accounts* assistant to carry out the following settings:
...
You can adapt all email templates to your individual needs. Further down on this page of the manual in the chapter <<quick-start/quick-start-initial-settings#600, Example: Customising the email template>>, you find an example how you adjust the email template *Online store: confirmation of store order*.
...
→ The certificate of the domain appears.
