...
IMPORTANT: Have you already allowed pop-ups, added a bookmark for your back end login and checked the system requirements? Not yet? Return to <<quick-start/quick-start-taking-off#, Taking off>>.
