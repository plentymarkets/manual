...
* <<quick-start/quick-start-automating-processes#10, Automatic email>>
...
* <<basics/admin-tasks/plentymarkets-account#20, Changing contract information>>

TIP: Continue to <<quick-start/quick-start-stock-management#, Setting up a warehouse and a supplier>>
