...
. Go to *System » System settings » Client* » _Select client_ » *Email » Signature*.
...
. Go to *System » System settings » Client* » _Select client_ » *Email » Login details*.
...
. Go to *System » System settings » Client* » _Select client_ » *Email » Info service*.
...
plentymarkets generates all emails based on templates. For the beginning, we recommend setting up the email templates listed in <<table-email-templates>>. Go to *System » System settings » Client* » _Select client_ » *Email » Templates* to create email templates.
...
*_Important:_* An invoice template for the location *Germany* is already pre-configured. You can adapt the template to your individual needs. To do so, go to *System » System settings » Client* » _Select client_ » *Locations* » _Select location_ » *Documents » Invoice*. If an invoice already exists for the order and you have set up an event procedure, the invoice will be sent to your customer automatically since the PDF attachment *Invoice* is selected by default in the template *Order: Invoice as PDF attachment*. +
...
Save the texts for the cancellation rights and the terms and conditions in the *System » System settings » Client* » _Select client_ » *Online store » Legal information* menu. The template variables *$CancellationRightsText* and *$GeneralTermsConditionsText* are automatically replaced with the cancellation rights and the terms and conditions in the email.
|====

[TIP]
====
There are many more email templates that are already available in your plentymarkets system. Adjust these email templates, if required, and link them with an event in the *System » System settings » Client* » _Select client_ » *Email » Automatic* menu or set up an event procedure. For further information, refer to the quick start page <<quick-start/quick-start-automating-processes#, Automating processes>>.
====
...
. Go to *System » System settings » Client* » _Select client_ » *Online store » Legal information*.
...
. Go to *System » System settings » Client* » _Select client_ » *Email » Templates*.
...
*_Note:_* If no email address is entered, replies to this email template are sent to the email address that is saved in the *System » System settings » Client* » _Select client_ » *Email » Login details* menu.
...
Possible types of a PDF attachment, e.g. the invoice, are already available in your plentymarkets system. Go to *System » System settings » Client* » _Select client_ » *Locations* » _Select location_ » *Documents* to set up these documents.
...
. Go to *System » System settings » Client* » _Select client_ » *Locations* » _Select location_ » *Documents*.
...
. Click on the blue plus sign of the system (icon:plus-square[role="blue"]). +
...
. Go to *System » System settings » Client* » _Select client_ » *SSL*. +
