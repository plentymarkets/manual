...
*_Important:_* Since bank details can only be imported and saved after customers have agreed to the process, *No* is selected here by default. Before activating the option *Yes*, familiarise yourself with the current legislation as well as the existing GDPR regulations.
