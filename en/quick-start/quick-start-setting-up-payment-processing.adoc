...
:position: 110
:url: quick-start/quick-start-setting-up-payment-processes
...
. Click on the green plus icon to add a new PayPal account.
...
*_Or:_* Select the *Test environment*, which is invisible for customers, and change the setting to the *Live environment* when you finished the setup.
...
→ You are fowarded to your plentymarkets back end. There, the PayPal Quick setup opens.
. Carry out the desired settings in the PayPal Quick setup. By clicking on the info icons on the right, you can acess further information on the individual settings.
. Click on *Save*. +
...
If you do not wish to offer your customers PayPal as a payment method yet, you can easily disable the display of the payment method in the online store by deactivating the PayPal plugin. You can reactivate it and carry out the necessary steps for <<#20, setting up the plugin>> any time.

[.instruction]
Deactivating the PayPal plugin:

. Go to *Plugins » Plugin overview*. +
→ The plugin overview opens.
. Click on the blue globe icon in the *Active* column.
. Click on *Save & deploy plugin set* to apply the changes. +
→ The plugin is now deactivated.

[#40]
=== Setting up Cash in advance

With the payment method Cash in advance, your customers are asked to pay the invoice amount via bank transfer during the checkout process. You only ship the items when you have received payment for the order. As a seller, you are obligated by law to offer your customers a payment method that is free of additional charges and simple to use. For you as a seller, the Cash in advance plugin does not require you to pay any fees for using the payment method. Thus, we recommend setting up and using this payment method in any case.
...
The corresponding Cash in advance plugin is already available in your system, but not installed yet. Proceed as described below to install the Cash in advance plugin.

[.instruction]
Installing the Cash in advance plugin:

. Go to *Plugins » Plugin overview*.
. Activate the check box *Not installed* and click on *Search*. +
→ All plugins that are not yet installed are displayed as search results.
. Select the action *Install plugin* in the entry for the *Cash in advance* plugin. +
→ A window containing additional information on the plugin opens. +
. Click on *Install*. +
...
|*Show bank data*
|Activate this option to display the bank data necessary for transferring the invoice amount on the order confirmation page. This way, the bank data you have saved in the *System » System settings » Settings » Bank* are displayed.
|====
...
[.instruction]
Displaying bank data on the order confirmation page:

. Go to *CMS » Container links*.
. From the list, select the *Cash in advance bank details (PrePayment)* area.
...
. Go to *CMS » Container links*.
. Select the *Cash in advance icon (PrePayment)* area.
...
The instructions above described how to set up the payment methods PayPal and Cash in advance. Depending on your wishes and the requirements of your customers, it can make sense to offer further payment methods at a later point in time. A big selection of further plugins is available in the link:https://marketplace.plentymarkets.com/plugins/payment[Payment^] area of the plentyMarketplace.
...
For incoming orders to be processed as desired, carry out the settings concerning goodwill on payment and importing customer bank data.
...
*_Important:_* Since bank data can only be imported and saved after customers have agreed to the process, *No* is selected here by default. Before activating the option *Yes*, familiarise yourself with the current legislation as well as the existing GDPR regulations.
...
Work through the checklist in order to review your settings for preparing payment processing.
...
* [ ] Did you <<#60, select the suitable containers>> so that all information regarding the Cash in advance plugin are displayed in the online store?
