...
With this plugin, you integrate the payment method **Cash in advance** into your online store. In order to make this payment method available in your online store, you have to carry out the settings in the plentymarkets back end. In addition, check the settings for **Permitted payment methods** in the <<order-processing/payment/managing-payment-methods#30,customer classes>> and for **Blocked payment methods** in the <<fulfilment/preparing-the-shipment#1000,shipping profiles>>.
