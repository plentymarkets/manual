...
====
If your categories do not appear in the online store, have a look at our <<item/online-store/checklist-categories-visibility, check list for category visibility>>.
====
...
Open the *Setup* menu and search for the *Sales prices* assistant. Once you’ve completed the assistant, you can <<quick-start/quick-start-item-catalogue#220, link your new sales prices with all of the relevant variations>> and enter the actual prices.
...
To make importing your items easier, we have prepared an link:https://cdn02.plentymarkets.com/pmsbpnokwu6a/frontend/musterdatei_initialer_artikelimport_190226.csv[example CSV file] which contains all data fields required to important sellable items.
...
.Column titles
====
We’ve given the column titles the exact same names as the fields you enter as targets during mapping in <<data/importing-data/ElasticSync#, ElasticSync>>.
====
...
====
Do you have a specific job in mind and you can’t complete it with assistants? Or are you looking for more comprehensive import options than are included in the assistants? <<data/importing-data/ElasticSync#, ElasticSync>> is the right tool for complex and comprehensive data imports!
====
