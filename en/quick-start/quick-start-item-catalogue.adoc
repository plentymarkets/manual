...
====
New variations and changes to variation data are not available in the online store and exports immediately. For further information on how to check if the variation data is up to date, see the manual page <<item/checking-data-status#, Checking status of item data>>.
====
