...
IMPORTANT: Have you already booked stock? Not yet? Return to <<quick-start/quick-start-booking-stock#, Booking stock>>.
...
[TIP] Continue with <<quick-start/quick-start-online-store-introduction#, Setting up the online store: Introduction>>. 
