...
Set up a default country of delivery, a default shipping method, a default shipping profile and a default payment method. These are preselected for non-registered visitors of your online store. You can only use *plugin payment methods* in your Ceres online store, which you can download from the link:https://marketplace.plentymarkets.com/plugins/payment[plentyMarketplace^]{nbsp}icon:external-link[].
