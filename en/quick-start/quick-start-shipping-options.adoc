...
The DHL Shipping (Versenden) plugin is already installed and activated in your plentymarkets system in the *Plugins » Plugin overview* menu. Therefore, it is visible in the *Setup » Orders » Shipping » DHL Shipping* menu. You have to carry out some settings in this menu:
...
Please have a look at the link:https://marketplace.plentymarkets.com/en/plugins/integration/DHLShipping_4871[user guide of the DHL Shipping (Versenden) plugin^]{nbsp}icon:external-link[] in the plentyMarketplace. In the user guide, all settings are described that you need to carry out in order to send your items via the interface for DHL Shipping.
...
* [ ] DHL plugin: Did you carry out all settings in the *Setup » Orders » Shipping » DHL Shipping* menu?

[#800]
== More about shipping options

* <<crm/managing-contacts#15, Creating a customer class>>
* link:https://marketplace.plentymarkets.com/en/plugins/payment[Methods of payment^]{nbsp}icon:external-link[]
