...
IMPORTANT: Have you already set up a warehouse and created a supplier? Not yet? Return to <<quick-start/quick-start-stock-management#, Setting up a warehouse and supplier>>.
...
* <<orders/order-referrer#, Activating the order referrer>>
