...
**REST API** Class for <<test-pages/kathrin/entwurf-kathrin-5#125., **REST calls** >> that can be assigned in the user account. REST calls are activated individually. REST API calls are not assigned to users by default. [#120]
