...
|**Default customer**
|Select the <<test-pages/kathrin/entwurf-kathrin-mobile#90., **Default customer created for POS orders** >> to which you want to assign orders generated with this POS.
