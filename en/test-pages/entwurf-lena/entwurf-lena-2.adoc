...
For further information about deleting stock completely, refer to the **<</#, Stocktaking >>** page of the manual.

|**Save**
|Saves the settings.

|**Delete**
|Deletes the warehouse from the system. Before a warehouse can be deleted, all of its **<<test-pages/entwurf-lena/entwurf-lena-2#2-3-1, racks >>**, **<<test-pages/entwurf-lena/entwurf-lena-2#2-3-2, shelves >>** and **<<test-pages/entwurf-lena/entwurf-lena-2#2-3-3, storage locations >>** have to be deleted as well. No **<</#, reorders >>** may be available for the warehouse that you want to delete. +
