...
As an alternative to the plentyMarketplace, you can add your own plugins to the inbox of your plentymarkets system. Proceed as described below to copy a plugin repository managed via <<test-pages/managing-plugins#90, **Git versioning** >> to the plentymarkets Inbox and manage it in the plentymarkets back end.
...
|**Settings**
|<<test-pages/managing-plugins#45, **Connection settings** >> of the repository
