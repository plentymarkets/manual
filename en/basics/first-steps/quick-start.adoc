...
With the Shop Builder, you can create and edit the homepage of your Ceres online store, which just requires a few steps in your back end.
...
===== Editing the Shop Builder homepage

You can access the Shop Builder in the menu *CMS » Shop Builder*. In the preview area, you can add elements to the homepage to adjust it to your individual needs.
...
|*Title bar*
|This widget provides a text box. Click *Edit* to enter text and change the <<#616, colour>> of the title bar.
...
|*Image box*
|Provides a container for images. Click *Edit* to add or remove images.
...
You can edit the main colours for all pages of your online store through the Shop Builder.
...
|*Success colour*
|This attribute changes the colour of the success messages in the shop. Choose a colour from the colour picker or enter a hexadecimal value.

|*Information colour*
|This attribute changes the colour of the informations in the shop. Choose a colour from the colour picker or enter a hexadecimal value.

|*Warning colour*
|This attribute changes the colour of the warnings in the shop. Choose a colour from the colour picker or enter a hexadecimal value.

|*Danger colour*
|This attribute changes the colour of the error messages in the shop. Choose a colour from the colour picker or enter a hexadecimal value.
|====

===== Editing fonts

You can manage the fonts used in your online store in the Design menu of the Shop Builder.

[.instruction]
Editing font settings in the Shop Builder:
...
You can integrate fonts either by providing a *Font URL* or by uploading a font file. Save a font in the fields *Regular font file*, *Bold font file*, *Italic font file* and *Bold-italic* font file. These fonts will be used globally in all pages created with the Shop Builder.
