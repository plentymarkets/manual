...
====
The Shop Builder is only available from version 2.8.1 onwards of Ceres and IO. If you are using an older version, you can update the plugins in the *Plugins » Plugin overview* menu.
====
