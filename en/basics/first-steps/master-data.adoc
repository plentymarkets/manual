...
__**Important**__: If the country changes, then go to <<order-processing/orders/_accounting#2, **Settings » Client (store) » Standard » Accounting** >> and save a configuration for the new country as well.
|====
