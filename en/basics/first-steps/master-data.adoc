...
.Settings in the menu **Master data**
[cols="a,a"]
|====
| Setting | Explanation
...
__**Important**__: If the country changes, then go to <<order-processing/orders/_accounting#2, System » Client » Select client » Locations » Select location » Accounting>> and save a configuration for the new country as well.
|====
