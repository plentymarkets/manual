...
Save important information about your company in the **Settings » Basic settings » Master data** menu. Here you can save your company address and contact data as well as your VAT number.
...
__**Important**__: If the country changes, then go to <<omni-channel/online-store/standard/accounting#2, **Settings » Client (store) » Standard » Accounting** >> and save a configuration for the new country as well.
|====
...
====
Making changes to this master data will not have any effect on the customer information that is saved in your contract with plentymarkets, e.g. for billing purposes! This information can be changed in the menu **Start » plentymarkets account » Service center**.
====
