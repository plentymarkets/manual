...
Plugins can add functionality like menu items or user interfaces to the back end. You can change the plugin set for your back end by selecting a plugin set for your account.

[.instruction]
Selecting a plugin set for your account:

. In the plentyMarkets back end, click on the account symbol in the upper right corner.
. Click on *Backend Plugin set*. +
→ The *Plugin Set* window opens.
