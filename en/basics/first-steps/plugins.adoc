...
The **Plugins » Plugin overview** menu lists the plugins of the plentymarkets Inbox. Select the client for which the client-dependent plugin configurations should be displayed from the drop-down list in the upper bar. In the card view the plugins are displayed in the form of cards. A plugin card contains the following information:
...
As an alternative to the card view, you can switch to the table view. <<table-plugin-overview>> explains the information displayed in the columns of this table view.
...
The **Plugins » Plugin overview** menu serves as your inbox for plugins. From the plentymarkets Inbox, you deploy plugins in Stage and/or Productive. Stage provides a preview mode for testing plugins. The Stage mode is only available for the main client. During deployment in Stage, all plugins activated for the Stage mode are deployed. During deployment in Productive, all plugins activated for the Productive mode are deployed. Plugins deployed in Productive are visible to customers and/or users. <<table-stage-vs-productive>> illustrates the difference between Stage and Productive.

[#55]
[[table-stage-vs-productive]]
.Stage vs Productive
[cols="a,a"]
|====
|Mode |Explanation
...
Proceed as described below to deploy plugins. <<table-deploying-plugins-menu-bar>> explains the options of the menu bar you need to deploy plugins.

[.instruction]
Deploying plugins in Stage:

. Select the main client from the drop-down list.
...
→ The colour of the icon of deployed plugins changes to green in the card view.

[.instruction]
Deploying plugins in Productive:

. Select the desired client from the drop-down list.
. Go to **Plugins » Plugin overview**.
...
[[table-deploying-plugins-menu-bar]]
...
|Activate to deploy plugins in **Stage** automatically when updates made using link:plentyDrive[https://marketplace.plentymarkets.com/plugins/integration/plentyDrive_5091^] are available. Plugins must already be active in **Stage**.
|====
