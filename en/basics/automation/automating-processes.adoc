...
You can use event procedures to automatically send **__E-mail templates__** to your **__customers__** when certain events occur. Go to **System » Client » Open client » Email » Templates** to set up **E-mail templates**. You can send your customers:
