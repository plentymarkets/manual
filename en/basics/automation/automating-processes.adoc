...
The E-mail will be sent to the selected employee's E-mail address. You can only select E-mail addresses here that were previously saved in the user data in the **<<basics/working-with-plentymarkets/manage-users#, Settings » Basic settings » User » Accounts>>** menu. +
