...
Development on the plentymarkets Client has ceased. This page is relevant for existing customers only. If you are a new customer, download plentyBase instead.

////
== Download

Open the link:https://www.plentymarkets.co.uk/product/processes/plentymarkets-client/[plentymarkets Client] website.
...
* Microsoft Visual C++ 2010 Redistributable Package link:http://www.microsoft.com/en-US/download/details.aspx?id=5555[32-Bit-Version^]
* Microsoft Visual C++ 2010 Redistributable Package link:http://www.microsoft.com/en-US/download/details.aspx?id=14632[64-Bit-Version^]
...
.Checking the Microsoft add-ons under Programs
image::basics/assets/EN-Tools-Client-01.png[Checking the Microsoft add-ons under Programs]
...
.Deleting the link (example of a German operating system)
image::basics/assets/EN-Tools-Client-02.png[Deleting the link (example of a German operating system)]
...
Once the Client is installed and started, connect the Client to the desired plentymarkets system.

.Connecting the Client
image::basics/assets/EN-Tools-Client-03.png[Connecting the Client]

[.instruction]
Connecting the Client to plentymarkets:

. Click on the **URL** drop-down list in the login window.
...
Updates are made available for you immediately. When you start the client it will automatically search for updates. The update is guided by a menu and is self-explanatory.
...
.Clearing the cache in the Extras menu
image::basics/assets/EN-Tools-Client-04.png[Clearing the cache in the Extras menu]
