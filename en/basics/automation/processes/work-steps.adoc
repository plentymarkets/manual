...
|**Pending pick list**
|Pending <<order-processing/orders/settings/documents/pick-list#, **pick lists**  >> are those that have not been completely processed yet. In order for the filter to be effective, a pending pick list has to be available in general. If this is not the case, then orders will not be filtered by the specified conditions. Instead, orders will be loaded by other filters set up here only. Options:  +
...
* <<basics/automation/processes/procedures#, **Item registration**  >>
* none
...
image::basics/automation/processes/assets/EN-Settings-Processes-Work-Steps-Single-Order-Processing-02.png[]
