...
image::basics/automation/processes/assets/EN-Settings-Processes-Procedures-Troubleshooting-01.png[Troubleshooting]
...
.**Shipping center** procedure with a troubleshooting option
image::basics/automation/processes/assets/EN-Settings-Processes-Procedures-Troubleshooting--02.png[Troubleshooting]
