...
It is possible to fix errors in the client so that processes are not aborted due to one or more faulty orders. You can also save notes for faulty orders that remind you to correct these orders later. All of the other orders are processed as usual. Troubleshooting will only be carried out if it was first configured for all of the necessary the procedures.
...
The procedure **<<basics/automation/processes/procedures#430, Shipping center >>** will be used to explain how to configure the troubleshooting.
...
image::basics/automation/processes/assets/EN-Settings-Processes-Procedures-Troubleshooting-01.png[]

__Image 1: **Shipping center** procedure with a **troubleshooting** option__
...
. Select the desired **procedure** from the drop-down menu (section 3).
. **Save** the settings. +
→ The procedure will be created. Procedures that are created for troubleshooting are displayed in __**red frames**__ (image 2).
...
*  Procedure: **<<basics/automation/processes/procedures#220, Email >>**
* Sub-procedure: <<basics/automation/processes/sub-procedures#330, **Send** >>

*  Procedure: <<basics/automation/processes/procedures#170, **Order** >>
* Sub-procedure: <<basics/automation/processes/sub-procedures#290, **Change status** >>

* Sub-procedure: <<basics/automation/processes/sub-procedures#130, **Add order notes** >>
...
The sub-procedure **Change status** changes the status of the faulty order. The status will change to whatever status is selected from the drop-down menu.
...
Depending on the configuration, the sub-procedure <<basics/automation/processes/sub-procedures#130, **Add order notes** >> can be used to add an individual note to every faulty order. Alternatively, a saved note can be inserted for all of the faulty orders within a process. We also recommend that you attach the error message to the order.

image::basics/automation/processes/assets/EN-Settings-Processes-Procedures-Troubleshooting-02.png[]

__Image 2: procedures for **troubleshooting**__
