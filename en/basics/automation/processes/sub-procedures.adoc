...
By combining the **Order notes** sub-procedure with the <<basics/automation/processes/procedures#260, **Note** >> procedure, you can display the information saved in the <<order-processing/orders/managing-sales-orders#changing-order, **Orders » Edit orders » Tab: Overview** >> menu during the process so you employees can take appropriate action. +
