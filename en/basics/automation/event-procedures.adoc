...
. <<basics/automation/event-procedures#110, Choosing an *Event*>>
...
[#110]
=== Selecting an event for a new event procedure
...
[#120]
=== Adding filters to a new event procedure
...
|*Phone number exists*
|Orders are filtered according to the availability of a telephone number. The *Delivery address*, the *Invoice address* or *Both* can be searched. In addition, the results can be modified using the operator *Minimum length of number*.
...
[#130]
=== Add procedures for event procedures
...
Individual procedures are available for: <<order-processing/payment/amazon-pay#, Amazon Pay>>, <<order-processing/payment/upg#, CrefoPay>>, <<order-processing/payment/klarna#, Klarna>>, <<order-processing/payment/klarna-checkout-uk#, Klarna UK>>, <<order-processing/payment/billsafe#, BillSAFE>>, <<order-processing/payment/masterpayment#, Masterpayment>>, <<order-processing/payment/payolution#, Payolution>>, <<order-processing/payment/payone#, PAYONE>>, <<omni-channel/multi-channel/plus-gartenxxl#, Plus.de>>, <<order-processing/payment/postpay#, POSTPAY>>, *LaRedoute*, *Zentralverkauf*, <<omni-channel/multi-channel/hood#, Hood>>, <<omni-channel/multi-channel/ebay/ebay-setup#, eBay>>, <<omni-channel/multi-channel/rakuten/rakuten-setup#, Rakuten.de>>, <<omni-channel/multi-channel/fruugo#, Fruugo>>, <<omni-channel/multi-channel/flubit#, Flubit>>, <<omni-channel/multi-channel/idealo-checkout/idealo-setup#, idealo>> and <<omni-channel/multi-channel/bol-com#, bol.com>>.
...
Individual procedures are available for: <<order-processing/payment/upg#, UPG>>, <<order-processing/payment/amazon-pay#, Amazon Pay>>, *ClickandBuy*, <<order-processing/payment/paymorrow#, paymorrow>>, <<omni-channel/multi-channel/plus-gartenxxl#, Plus.de>>, <<order-processing/payment/postpay#, POSTPAY>>, <<omni-channel/multi-channel/rakuten/rakuten-setup#, Rakuten.de>>, <<order-processing/payment/worldpay#, Worldpay>>, <<order-processing/payment/sage-pay#, SagePay>>, <<order-processing/payment/klarna-checkout-uk#, Klarna UK>>.
...
Individual procedures are available for: <<order-processing/payment/klarna#, Klarna>>, <<omni-channel/multi-channel/amazon/amazon-setup#, Amazon>>, <<order-processing/payment/billsafe#, BillSAFE>>, <<omni-channel/multi-channel/allyouneed/allyouneed-setup#, Allyouneed>>, <<omni-channel/multi-channel/plus-gartenxxl#, Plus.de>>, <<order-processing/payment/postpay#, POSTPAY>>, <<omni-channel/multi-channel/rakuten/rakuten-setup#, Rakuten.de>>, *LaRedoute*, <<omni-channel/multi-channel/shopgate#, Shopgate>>, <<omni-channel/multi-channel/flubit#, Flubit>>, <<omni-channel/multi-channel/idealo-checkout/idealo-setup#, idealo>>, <<omni-channel/multi-channel/fruugo#, Fruugo>> and <<omni-channel/multi-channel/cdiscount#, Cdiscount>>. +
