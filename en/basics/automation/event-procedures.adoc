...
. <<basics/automation/event-procedures#120, Adding one or more filter(s)>>
...
*Important*: This option is only displayed if the necessary <<order-processing/orders/managing-orders#320, warehouse assignment>> has been set up correctly.
...
|This procedure informs <<omni-channel/multi-channel/cdiscount#, Cdiscount>> of status changes in orders received from the market Cdiscount.
...
Individual procedures are available for: <<order-processing/payment/amazon-pay#, Amazon Pay>>, <<order-processing/payment/upg, UPG>>, <<order-processing/payment/klarna#, Klarna>>, <<order-processing/payment/klarna-checkout-uk#, Klarna UK>>, <<order-processing/payment/masterpayment#, Masterpayment>>, <<order-processing/payment/payolution#, Payolution>>, <<omni-channel/multi-channel/plus-gartenxxl#, NettoeStores>>, <<order-processing/payment/postpay#, POSTPAY>>, *Zentralverkauf*, <<omni-channel/multi-channel/hood#, Hood>>, <<omni-channel/multi-channel/ebay/ebay-setup#, eBay>>, <<omni-channel/multi-channel/rakuten/rakuten-setup#, Rakuten.de>>, <<omni-channel/multi-channel/fruugo#, Fruugo>>, <<omni-channel/multi-channel/flubit#, Flubit>>, <<omni-channel/multi-channel/idealo-checkout/idealo-setup#, idealo>> and <<omni-channel/multi-channel/bol-com#, bol.com>>.
...
Individual procedures are available for: *ClickandBuy*, <<order-processing/payment/payone#, PAYONE>>, <<order-processing/payment/postpay#, POSTPAY>>, <<order-processing/payment/worldpay#, Worldpay>> and <<order-processing/payment/klarna#, Klarna>>.
...
Individual procedures are available for: <<order-processing/payment/klarna#, Klarna>>, <<omni-channel/multi-channel/amazon/amazon-setup#, Amazon>>, <<omni-channel/multi-channel/plus-gartenxxl#, Netto eStores>>, <<order-processing/payment/postpay#, POSTPAY>>, <<omni-channel/multi-channel/rakuten/rakuten-setup#, Rakuten.de>>, <<omni-channel/multi-channel/shopgate#, Shopgate>>, <<omni-channel/multi-channel/flubit#, Flubit>>, <<omni-channel/multi-channel/idealo-checkout/idealo-setup#, idealo>>, <<omni-channel/multi-channel/fruugo#, Fruugo>> and <<omni-channel/multi-channel/cdiscount#, Cdiscount>>. +
...
|*Move cards*
|Once the selected event happens, selected cards are <<basics/working-with-plentymarkets/boards#40, moved>> in the *Start » Boards* menu. +
