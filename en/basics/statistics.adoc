...
.Click on **Login**. +
→ The statistics will open in a new browser tab.
.Click on a month to see a detailed analysis for the period.
...
. Go to **Start » Statistic**.
. Select the **tab**.
. Click on the **green plus icon** of one of the four tab fields. +
→ The **New statistic** window will open.
. Select a statistics type.
. **Save** the settings. +
→ The statistic is created using the default settings. +
**__Tip:__** Table 10 explains the statistics view.
...
__**Tip**__: Left-click on the mouse and drag along a section of the column line combination chart to zoom in. Click **Show all** to end zooming and show the entire statistic.
...
__**Note:**__ If the data table spans several pages, the totals are calculated for the entire table and not for the page currently visible.
...
. Go to **Start » Statistic**.
. Select a **Tab**.
. Click on the **pen** of the statistic you want to adjust. +
...
__**Note**__: All types of orders are included in the statistical analysis except for cancellations. As such, **Status 8** and **Status 8.1** are excluded from the statistic.
...
**Contribution margin II** = Revenue minus taxes, purchase price and the additional costs that were selected, see <<_entwurfsseiten/kathrin/entwurf-kb-1#170, **Amounts**>>. +
...
**__Tip:__** Transportation costs, storage costs, operating costs and customs are saved in the **Settings** tab of the variation. **__Note:__** Item bundles are not taken into consideration. Fees for markets are added to the gross price (sales price). +
...
**__Tip:__** Tables offer very detailed values at a glance. However, they do not show developments over time as clearly as line, column or bar charts. +
**__Note:__** If the data table spans several pages, the totals are calculated for the entire table and not for the page currently visible.
...
**__Tip:__** Click on a pie piece to move it out of the pie. Click on each of the pie pieces to move all pie pieces out of the pie chart. Click on the pie piece again to move it back to its original position.
...
The contribution margin II is reduced by any costs activated with a check mark. +
**__Tip:__** Transportation costs, storage costs, operating costs and customs are saved in the **Settings** tab of the variation.
|====
...
. Click on the **pen** of the statistic you want to export. +
...
**__Tip:__** You can export up to 10,000 rows of data. If this amount is exceed, only the first 10,000 rows will be exported. If you want to export a full set of data, limit the data volume by applying filter options.
...
.Data fields of the CSV exports
[cols="1,2"]
|====
