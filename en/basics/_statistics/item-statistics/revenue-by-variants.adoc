...
**Item » Edit item » Tab: Statistics → Statistic: Revenue by variants**
...
This statistic provides an overview of revenue for each of the item's variants, e.g. how high the **gross revenue** or the **contribution margin** is for each variant.

== Details about the statistic

The **variants** and their corresponding **revenues** will be displayed for the selected **time span**. The particular **revenue in Euro** and the **percentage** of total revenue for all variants will be displayed as **information in a mouseover**. In this statistic you can see, e.g. which item variants are lucrative and which are not. For example, you may notice that the warehouse and operating costs of an item are too high and negatively influence the profit.

[TIP]
.Tip
====
In image 1, you can see the different **variants** and their revenues displayed in a column and line chart.
====

image::basics/statistics/item-statistics/assets/EN-ENG-Artikel-Statistik-UmsatzVarianten01-SI.png[]

__Image 1: **revenue by variants** statistic__

== Settings

The **settings** described below are available for this statistic.

image::basics/statistics/item-statistics/assets/EN-ENG-Artikel-Statistik-UmsatzVarianten02-SI.png[]

__Image 2: **revenue by variants** statistic; **settings**__
...
.**Data fields**
====
**Variation** = Variant, **QuantityOfOrders** = Quantity of sales orders, **ContributionMarginTwo** = Contribution margin II, **QuantityOfBundleItems** = Quantity of items from item bundles
====

image::basics/statistics/item-statistics/assets/EN-ENG-Artikel-Statistik-UmsatzVarianten03-SI.png[]

__Image 3: **revenue by variants** statistic; simple export__
...
image::basics/statistics/item-statistics/assets/EN-ENG-Artikel-Statistik-UmsatzVarianten04-SI.png[]

__Image 4: **revenue by variants** statistic; raw data export__
