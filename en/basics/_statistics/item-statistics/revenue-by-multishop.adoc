= Revenue by multishop
:lang: en
include::{includedir}/_header.adoc[]
:position: 50

**Item » Edit item » Tab: Statistics → Statistic: Revenue by multishop**
...
The **revenue** will be displayed for each **webshop** or **multishop** that was used during the selected **time span**. The particular **revenue in Euro** and the **percentage** of total revenue for all of the webshops or multishops that were used during the selected time span will be displayed as **information in a mouseover**. In this statistic you can see, e.g. how much **revenue** or **profit** was made from a particular webshop or multishop during the selected time period.

[TIP]
.Tip
====
In image 1, you can see that the **standard webshop** corresponds to a total revenue of **6,390.53 Euros**.
====

image::basics/statistics/item-statistics/assets/EN-ENG-Artikel-Statistik-UmsatzMultishop01-SI.png[]

__Image 1: **revenue by multishop** statistic__

== Settings

The **settings** described below are available for this statistic.

image::basics/statistics/item-statistics/assets/EN-ENG-Artikel-Statistik-UmsatzMultishop02-SI.png[]

__Image 2: **revenue by multishop** statistic; **settings**__
...
.**Data fields**
====
**Multishop** = Webshop or multishop, **QuantityOfOrders** = Quantity of sales orders, **ContributionMarginTwo** = Contribution margin II,**QuantityOfBundleItems** = Quantity of items from item bundles
====

image::basics/statistics/item-statistics/assets/EN-ENG-Artikel-Statistik-UmsatzMultishop03-SI.png[]

__Image 3: **revenue by multishop** statistic; simple export__
...
image::basics/statistics/item-statistics/assets/EN-ENG-Artikel-Statistik-UmsatzMultishop04-SI.png[]

__Image 4: **revenue by multishop** statistic; raw data export__
