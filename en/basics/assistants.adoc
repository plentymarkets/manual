...
|*DPD Shipping UK*
|Set up DPD Shipping UK in your system for shipping from the United Kingdom. The plugin must be installed in a plugin set. Buy it on link:https://marketplace.plentymarkets.com/en/plugins/integration/dpdshippinguk_5121[plentyMarketplace^] and install it in a plugin set. Alternatively, complete the *Integrations* assistant in order to automatically install the plugin.

|*Hermes DE*
|Set up Hermes DE in your system for shipping from Germany. The plugin must be installed in a plugin set. Buy it on https://marketplace.plentymarkets.com/en/plugins/integration/hermesshippinginterface_5437[plentyMarketplace^] and install it in a plugin set. Alternatively, complete the *Integrations* assistant in order to automatically install the plugin.
