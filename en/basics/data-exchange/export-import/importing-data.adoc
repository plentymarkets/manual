...
====
The import mechanisms described on this page are outdated. Use the plugin link:https://marketplace.plentymarkets.com/en/plugins/integration/ElasticSync_4750[ElasticSync^] to import data into plentymarkets.
====
...
→ Information about the matching fields can be found on the sub-pages of the <<basics/data-exchange/export-import/data-formats#, Data formats>> page of the manual.
...
You can also import the entire stock and thus overwrite the current physical stock in your plentymarkets system. To do so, use the data format <<basics/data-exchange/export-import/data-formats/stock#, Stock>>.
