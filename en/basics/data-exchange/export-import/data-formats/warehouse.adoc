...
The following data field is available for <<basics/data-exchange/export-import/importing-data#25, data synchronisation>>. This data field is a mandatory synchronisation field. For mandatory synchronisation fields, select the option **Synchronisation** as **Import procedure**.
