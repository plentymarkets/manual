...
|Activate the filter and select the customer class. In order to export data for all customer classes, do not activate the filter. Go to <<ccrm/managing-contacts#15, System » CRM » Classes>> to set up customer classes.
|====
