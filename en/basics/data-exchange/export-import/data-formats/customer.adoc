...
|Activate the filter and select the customer class from the drop-down list. In order to export data for all customer classes, do not activate the filter. Go to <<crm/managing-customer-data#100, System » CRM » Classes>> to create customer classes.
|====
...
The following data field is available for <<basics/data-exchange/export-import/importing-data#25, data synchronisation>>. For this mandatory synchronisation field, select the option **Synchronisation** as **Import procedure**.
