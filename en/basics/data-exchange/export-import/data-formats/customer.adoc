...
|The <<crm/managing-contacts#4000, customer properties>> that are saved in the system. One field is displayed per property. +
**_Example_**: The field **CustomerProperty_LastContact** will be displayed for the property **Last contact**.
|Activate the filter, select the operator and enter the value.
