...
The data format **OrderComplete** is used to export orders. This data format can only be used for the export. Create and export the data format in the **Data » Dynamic export** menu. The <<basics/data-exchange/export-import/exporting-data#,Exporting data>> page of the manual describes how you export the data format.
