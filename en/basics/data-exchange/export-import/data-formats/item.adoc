...
====
It is not possible to use the data format **Item** for creating new categories. With the data format **Item**, you can only create new category links within the item. Use the data format <<basics/data-exchange/export-import/data-formats/category#, Category>> instead to create new categories.
====
...
|Amazon product type; for possible values, see <<basics/data-exchange/export-import/data-formats/item#50, amazon_product_type value table>>.
