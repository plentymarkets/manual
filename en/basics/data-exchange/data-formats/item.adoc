...
|ID of the availability of the main variation; **Settings » Items » Item availability** menu +
Setting **Availability** in the **Settins** tab of the main variation
|
...
Setting **External variation ID No** in the **Settings** tab of the main variation
|
...
Value of the **Content** filed in the **Settins** tab of the main variation
|
...
|**VariationAttributes**
|List of the attributes that are linked to the main variation. +
