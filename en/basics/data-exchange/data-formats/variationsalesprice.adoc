...
|**SalesPriceID**
|Sales price ID
|Activate the filter and select the price from the drop-down menu.
...
|Live conversion of sales prices; is activated in the **System » Item » Sales prices** menu.
|

|**SalesPriceLang**
|Language of the sales price; is activated in the **System » Item » Sales prices » Open sales price » Tab: Language** menu.
...
__Table 1: Data fields of the data format **VariationSalesPrice**__
