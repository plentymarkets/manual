...
|**CustomerClass**
|ID of the <<crm/managing-customer-data#100, customer class>> as created in the **System » CRM » Classes** menu.
...
|Activate the filter and select the customer class from the drop-down menu. In order to export data for all customer classes, do not activate the filter. Go to <<crm/managing-customer-data#100, System » CRM » Classes>> to create customer classes.
|====
