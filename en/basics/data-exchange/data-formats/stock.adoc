...
For further information about using the data format **Stock** refer to the <<basics/data-exchange/exporting-data#90, Exchanging stock data>> chapter on the **Exporting data** page of the manual.
...
|**PriceUnit**
|The item's standard unit. For further information, refer to <<basics/data-exchange/data-formats/item#, Data format Item>> page of the manual.
|
...
You can limit the data export to a specific type of stock. To do so, go to **Data » Dynamic export** and click on the **Fields** tab. Use the drop-down menus on the right and select options for **Stock**, **Item bundle** and **Supplier**.
