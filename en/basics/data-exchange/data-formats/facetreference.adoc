...
|ReferenceValueID
|Either the attribute ID, the property ID, the manufacturer ID or the availability ID depending on the reference type
|
...
__Table 1: Data fields of the data format **FacetReference**__
