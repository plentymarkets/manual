...
The data format **OrderComplete** is used to export order. This data format can only be used for the export. Create and export the data format in the **Data exchange » Export » Dynamic export** menu. The **<<basics/data-exchange/exporting-data#, Exporting data>>** page of the manual describes how you export the data format.
...
|Debtor account in the **<<order-processing/orders/_accounting#, Accounting>>** menu
|
...
|**OrderValuta**
|Valuta is the time period starting when the invoice is created before the payment due time period begins. For further information, refer to the **<<crm/managing-customer-data#, New customer>>** page of the manual.
|
