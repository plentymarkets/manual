...
|Debtor account in the **<<omni-channel/online-store/standard/accounting#, Accounting  >>** menu
|
...
|**OrderValuta**
|Valuta is the time period starting when the invoice is created before the payment due time period begins. For further information, refer to the **link::/[New customer]** page of the manual.
|
