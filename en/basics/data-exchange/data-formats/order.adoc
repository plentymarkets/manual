...
Country IDs: **Settings » Orders » Shipping » Shipping options » Tab: Countries of delivery**
|
...
|**DeliveryEmail**
|Delivery address: E-mail address
|
...
**2** = partial payment +
**3** = overpayment
|Select the payment status from the drop-down menu.
...
|Select the order referrer from the drop-down menu.
...
The data fields that are listed in the following table are available for **link::/[data synchronization]**:
