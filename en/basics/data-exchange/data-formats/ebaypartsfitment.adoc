...
The data format **EbayPartsFitment** is used to link an eBay listing with the data from a **<<omni-channel/multi-channel/ebay#160, parts compatibility listing >>**. Each of the three eBay platforms **Germany**, **UK** and **USA** has its own data format: **EbayPartsFitmentDE**, **EbayPartsFitmentUK** and **EbayPartsFitmentCOM**.
...
The data fields that are listed in table 4 are available for <<basics/data-exchange/importing-data#25, **data synchronisation** >> for all three data formats. For mandatory synchronisation fields, select the option **Synchronisation** as **Import procedure**. Mandatory synchronisation fields are marked with an **M**.
