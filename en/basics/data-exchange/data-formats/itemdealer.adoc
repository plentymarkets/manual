...
The data fields that are listed alphabetically in the following table are available for link::/[**data synchronization**]. The mandatory fields have to be selected in order for the synchronization to take place.
