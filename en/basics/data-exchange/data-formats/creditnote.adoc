...
The data format **CreditNote** is used to export credit notes, e.g. for statistical purposes. Create and export the data format in the **Data exchange » Export » Dynamic export** menu. The **<<basics/data-exchange/exporting-data#, Exporting data  >>** page of the manual describes how you export the data format.
...
The country IDs are found under: **Settings » Orders » Shipping » Shipping options » Tab: Countries of delivery**
|
...
In the **Procedures** tab, select which procedures you want to be carried out during the data export. Activate the **LastUpdateTimestamp** procedure. Select the **set the current date** option from the drop-down menu. A timestamp will be added to credit notes during the export, indicating when the items were last changed.
