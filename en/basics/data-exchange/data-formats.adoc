...
Using these export formats, you can export item, customer, order and sales data, for example. Go to <<omni-channel/online-store/standard/accounting#, **Settings » Client (store) » Standard » Locations » Select location » Accounting**  >> and enter all of your accounting data before exporting your sales data. This has to be done in order for plentymarkets to generate the **<<omni-channel/online-store/standard/accounting#, posting keys  >>**.
...
|6 and 7
|This data format is used to export, edit and import <<order-processing/orders/editing-sales-orders/changing-a-sales-order#30, **stock units** >> of an order.
