...
On this page of the manual, you will find a list of all data formats that are available in your plentymarkets system as well as a short description. Most of these data formats can be used for both export and import. First, you create the formats in the **Data » » Dynamic export** menu. Then you export the formats to edit them. Finally, you import the formats back to your system. To do so, go to **Data » » Dynamic import**.

Using these export formats, you can export item, customer, order and sales data, for example. Go to <<order-processing/orders/_accounting#, System » Client » Select client » Locations » Select location » Accounting>> and enter all of your accounting data before exporting your sales data. This has to be done in order for plentymarkets to generate the <<order-processing/orders/_accounting#, posting keys>>.
...
|6 and 7
|This data format is used to create and edit item categories. This data format is well suited for translating <<item/managing-categories#, category>> names. +
...
|6 and 7
|This data format is used to export, edit and import customer properties. The customer characteristics are saved in the <<crm/managing-customer-data#400, System » Customers » Characteristics>> menu.

|<<basics/data-exchange/data-formats/customerpropertylink#, CustomerPropertyLink>>
|6 and 7
|This data format is used to link customer properties to certain customers. The customer properties are saved in the <<crm/managing-customer-data#400, System » Customers » Characteristics>> menu.
...
|6 and 7
|This data format is used to export, edit and import <<item/managing-items#, cross-selling items>>.
