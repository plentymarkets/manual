...
Using these export formats, you can export item, customer, order and sales data, for example. Go to <<order-processing/orders/_accounting#, **System » Client » Open client » Locations » Open location » Accounting**>> and enter all of your accounting data before exporting your sales data. This has to be done in order for plentymarkets to generate the **<<order-processing/orders/_accounting#, posting keys>>**.
