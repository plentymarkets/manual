...
|6 and 7
|This data format is used to export, edit and import customer properties. The customer characteristics are saved in the <<crm/managing-customer-data#400, System » CRM » Characteristics>> menu.

|<<basics/data-exchange/data-formats/customerpropertylink#, CustomerPropertyLink>>
|6 and 7
|This data format is used to link customer properties to certain customers. The customer properties are saved in the <<crm/managing-customer-data#400, System » CRM » Characteristics>> menu.
