...
This page of the manual describes how to import data using the plugin ElasticSync. Importing data is recommended if you want to add new items, customer data or stock etc. to your plentymarkets system and you already have this data available in digital format. ElasticSync allows to carry out data imports by creating so-called syncs. You can import your data manually or automatically. You can download the ElasticSync plugin free of charge from the link:https://marketplace.plentymarkets.com/en/plugins/integration/ElasticSync_4750[plentyMarketplace^].
...
* *Contacts, companies and addresses* = Select to import <<basics/data-exchange/export-import/importing-data#2200, contact, company and address data>>.
* *Item* = Select to import <<basics/data-exchange/export-import/importing-data/#1900, item and variation data>>.
* *Categories* = Select to import <<basics/data-exchange/export-import/iimporting-data/#2100, category data>>.
* *Attributes* = Select to import attribute data.
* *Properties* = Select to import property data.
* *Notes* = Select to import note data.
* *Order* = Select to import <<basics/data-exchange/export-import/importing-data#2000, order data>>.
* *Warehouse* = Select to import <<basics/data-exchange/export-import/importing-data#2230, storage locations>>.
