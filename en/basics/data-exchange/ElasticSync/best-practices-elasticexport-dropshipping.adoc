...
Thanks to the combination of our plugins link:https://marketplace.plentymarkets.com/plugins/markets/ElasticExport_4763[ElasticExport^] and link:https://marketplace.plentymarkets.com/plugins/integration/ElasticSync_4750[ElasticSync^] including the <<en/basics/data-exchange/ElasticSync/FormatDesigner#, FormatDesigner>>, data exchange between plentymarkets and additional systems or service providers can be easily automated.
...
image::en/basics/data-exchange/ElasticSync/assets/en-bp-elasticexport-dropshipping_01.png[]
...
image::en/basics/data-exchange/ElasticSync/assets/en-bp-elasticexport-dropshipping_02.png[]

image::en/basics/data-exchange/ElasticSync/assets/en-bp-elasticexport-dropshipping_03.png[]
