...
|allShippingProfiles
|Provides a list of ID’s of linked shipping profiles (separated by commas).
...
|allCategoryIds
|ID’s of the linked categories (separated by commas)
|====
...
<<table-fields-variation-supplier>> lists the fields available for exporting supplier data.

[[table-fields-variation-supplier]]
...
|allIds
|All property ID’s (separated by semicolons)
|====
...
<<table-fields-variation-properties>> lists the fields available for importing property links at the variation level.
...
|linkedVariations
|ID’s of the variations linked to the image (separated by commas)
...
[[table-fields-delivery-orderitem-address-option]]
.Fields for exporting delivery address options
[cols="1,3"]
|====
|Field |Explanation
