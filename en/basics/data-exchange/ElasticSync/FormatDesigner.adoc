...
|German
|ID of the order parcel service (German)

|English
|ID of the order parcel service (English)
...
|German
|Name of the order parcel service (German)

|English
|Name of the order parcel service (English)
...
<<table-fields-orderitem-amount>> lists the fields available for exporting the totality of calculated amounts belonging to the order.
...
<<table-fields-orderitem-contact>> lists the fields available for exporting contact data.
...
<<table-fields-orderitem-custom-values>> lists the fields available for exporting custom values.
