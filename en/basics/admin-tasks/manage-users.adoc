...
In the menu *System » System settings » Settings » User » Security*, you manage the criteria for new passwords entered by users. Proceed as follows to activate the criteria.

[.instruction]
Setting the password strength:

. Go to *System » System settings » Settings » User » Security*.
...
|**Variable**
|Class with individual rights for <<basics/admin-tasks/manage-users#100, menu>> and <<basics/admin-tasks/manage-users#110, functions>> that can be assigned in the **Rights** tab.
...
|**API**
|Class for <<basics/admin-tasks/manage-users#120, API calls>> that can be assigned in the user account. API calls are activated individually. REST API calls are not assigned to user accounts by default.
...
|**Roles**
|Select roles for the user account. <<basics/admin-tasks/manage-users#70, Roles>> must have already been created before they can be selected here.
...
|**Right**
|For further information about this tab, refer to the <<basics/admin-tasks/manage-users#90, Assigning rights>> chapter.
...
|Warehouse
|System » System settings » Stock » Warehouse +
Stock +
Orders » Fulfilment
...
The admin can access the Session Management in the back end via *System » System settings » Settings » User » Session management* as well as via the user icon on the top right.
