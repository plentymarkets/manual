...
If you offer items in various countries via your eBay shop and if you use link:https://knowledge.plentymarkets.com/en/omni-channel/multi-channel/ebay/ebay-setup#3050[template variables^] for properties in link:https://knowledge.plentymarkets.com/en/omni-channel/multi-channel/ebay/ebay-setup#2800[layout templates^] which are linked to listings, you must provide translations for the national languages prior to migrating to plentymarkets 7. Make sure to provide translations for every country in which you want to offer your items. Otherwise, the property will not be displayed in the description of the listing.

Translations for the property name and the property value are required if you use the template variables *{% GetItemPropertyByName() %}* and *{% GetItemPropertyById() %}* in layout templates.

[.instruction]
Providing translations for property names:
...
[.instruction]
Providing translations for property values:
