...
|The variation that is migrated first receives the item/variation number. A new, unique variation number will be generated for all of the other variations. This variation number is determined by the <<basics/admin-tasks/migration-guide#35, migration settings>> found in the menu **System » Settings » Data » Migration**. It is controlled with the setting **Duplicate number**.

|Exception 3: +
Items with multiple price sets
|One variation can be turned into several different variations. When the first price set is migrated, the variation receives the item/variation number. A new, unique variation number will be generated for all of the other variations. This variation number is determined by the <<basics/admin-tasks/migration-guide#35, migration settings>> found in the menu **System » Settings » Data » Migration**. It is controlled with the setting **Duplicate number**. +
...
<<basics/admin-tasks/migration-guide#75, Check>> which price columns were linked to currencies in the menu **System » Orders » Payment » Currencies**. Make sure that all of your items have amounts saved in these price columns. +
...
. Go to **System » Settings » Data » Migration** and configure the settings for the options **Merge Unit 1 + 2** and **Separator for merging Unit 1 + 2**.
...
Your previous prices were migrated to sales prices. Look a bit <<basics/admin-tasks/migration-guide#26, farther up>> in this migration guide if you want to find out how the data was migrated and the new prices were created. In plentymarkets 7, your sales prices are found in the menu **System » Item » Sales prices**.
...
Your previous GTIN, ISBN, etc. were migrated to barcodes. Look a bit <<basics/admin-tasks/migration-guide#25, farther up>> in this migration guide if you want to find out how the data was migrated. In plentymarkets 7, your new barcode definitions are found in the menu **System » Item » Barcode**.
