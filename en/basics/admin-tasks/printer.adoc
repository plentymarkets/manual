...
:position: 50
:url: basics/admin-tasks/printer
:id: VTQM7SL
...
plentyBase allows you to link plentymarkets to locally installed devices. In the **System » System settings » Settings » Printer** menu, you set up local printers or network printers in plentymarkets.
...
. Go to **System » System settings » Settings » Printer**.
...
**__Information about the ZPL plugin:__** For optimum print quality with the ZPL plugin on Mac OSX systems, <<basics/admin-tasks/printer#65, RAW printing>> must be enabled on your Zebra printer.
|====
...
|<<basics/admin-tasks/printer#30, Sharing printers>>
...
→ Mac OSX: Select the printer driver ZPL. Test the driver's setting for every label size individually. To use the **ZPL** printer plugin, configure your Zebra printer for <<basics/admin-tasks/printer#65, RAW printing>>.
...
. When you add a printer in the **System » System settings » Settings » Printer** menu, select the printer plugin **ZPL**.
