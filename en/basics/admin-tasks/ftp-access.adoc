...
Instead of working with an FTP program, you also can change data with our webspace tool, which you can access by going to **CMS » Webspace**. For further information about using the ajaxplorer, refer to our link:https://www.plentymarkets.eu/-plentymarkets-4-120-Nun-mit-komfortablem-Dateibrowser/b-138/[blog post] on this topic (German).
