...
Download the letest version of the technical system documentation of plentymarkets link:https://cdn02.plentymarkets.com/pmsbpnokwu6a/frontend/Verfahrensdokumentation_V6.3.pdf[here^] (German only). +
