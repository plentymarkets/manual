...
Download the letest version of the technical system documentation of plentymarkets link:https://cdn02.plentymarkets.com/pmsbpnokwu6a/frontend/plentymarkets_Rechtliches/Verfahrensdokumentation_V6.3.pdf[here^] (German only). +
