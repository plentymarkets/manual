...
* The current customer data record consisting of company, customer and address data will be split in individual components (see chapter <<basics/plentymarkets-7/changes#10, **Definition** >>).
...
image::basics/plentymarkets-7/assets/AccountContactAddress-01-de.png[]
[#10]
=== Definition
...
image::basics/plentymarkets-7/assets/AccountContactAddress-04-de.png[]

.example
image::basics/plentymarkets-7/assets/AccountContactAddress-03-de.png[]
...
.Data migration
image::basics/plentymarkets-7/assets/AccountContactAddress-02-de.png[]
