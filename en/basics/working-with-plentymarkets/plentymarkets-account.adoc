...
**MX** stands for Mail Exchange Resource Record. <<basics/start/plentymarkets-account/service-center/domain#3-5, **Mail server** >> parameters that are available for receiving and sending emails.
...
You need to have an authentication code for your domain if you switch to a different <<basics/start/plentymarkets-account/service-center/domain#3-10, **provider** >>. This auth code proves that you own the domain. You can generate the auth code in this area.
...
* Generate an <<basics/start/plentymarkets-account/service-center/domain#3-7, **auth code** >>.
...
You can check the expiration date of your SSL certificate and order a new SSL certificate in the <<basics/start/plentymarkets-account/service-center/domain#, **Domain**  >> tab of your plentymarkets Service center.
...
* <<basics/start/plentymarkets-account/service-center/contract#, **Contract**  >>: Your current tariff is displayed here but can not be changed.
* <<basics/start/plentymarkets-account/service-center/cache#, **Cache**  >>: The agency can delete the cache or temporarily deactivate the cache of your system.
...
* Your domain must be managed by plentymarkets. If this is not the case, then relocate your <<basics/start/plentymarkets-account/service-center/domain#, **main domain**  >>.
