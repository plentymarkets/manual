...
Use the *plentymarkets Logo (Start) » Tasks* menu to manage duties for all of the users in the system. For example, a task could be ""Call customer xy". You can see how much progress has been made towards completing a task. This helps you plan your business processes and improve internal processes.
...
Users of the type *Back end* can only access limited areas and menus in plentymarkets. Thus, their access to the system is limited. If you want users of this type to see the *plentymarkets Logo (Start) » Tasks* menu, an *Admin* user has to assign them rights as listed in the following.
...
. Select the filter. Pay attention to the information given in <<table-search-task>>.
...
→ All own uncompleted tasks are shown because the filter for the progress is set to *<100%* and the active user is preselected in the drop-down list *Owner* when opening the menu. +
. Click on icon:undo[role="orange"] to remove the filters.
. Select the filter. Pay attention to the information given in <<table-search-task>> in the <<basics/working-with-plentymarkets/tasks-and-calendars#400, Searching for a task>> chapter. +
→ The tasks that correspond to the search criteria entered are shown.
...
Click on *Enter ToDo* in the *My tasks* area to directly open the *plentymarkets Logo (Start) » Tasks* menu and <<basics/working-with-plentymarkets/tasks-and-calendars#300, create a new task>>.
...
Users of the type *Back end* can only access limited areas and menus in plentymarkets. Thus, their access to the system is limited. If you want users of this type to see the *plentymarkets Logo (Start) » Calendar* menu, an *Admin* user has to assign them rights as listed in the following.
