...
*_Important:_* This list only shows tags that have been created beforehand in the *System » Settings » Tags* menu. For further information, refer to the <<basics/working-with-plentymarkets#, Tags>> page of the manual.
