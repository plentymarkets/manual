...
When using boards you can visualise the workflow of a project or a working process within your company. Common boards consist of three columns: _To do_, _Doing_ and _Done_. You decide about the structure of the board and how many columns you add.
...
*_Important:_* This list only shows tags that have been created beforehand in the *System » System settings » Settings » Tags* menu. For further information, refer to the <<basics/working-with-plentymarkets#, Tags>> page of the manual.
