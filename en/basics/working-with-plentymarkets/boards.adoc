...
When opening the menu *plentymarkets Logo (Start) » Boards*, you see the number of cards and columns, the name of the board as well as the time period of the last change on every card that you created. Click on *Rename board* (icon:pencil[role="yellow-background"]) to enter a new name for the board. Click on *Delete board* (icon:minus-square[role="red"]) to delete the board.
