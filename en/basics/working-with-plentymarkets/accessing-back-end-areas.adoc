...
.Note
====
For technical reasons, *ui_action* has been replaced by *uiAction* in Terra. Moreover, it is relevant whether it is a system on https://plentymarkets-cloud-de.com or https://plentymarkets-cloud-ie.com. For the parameter keys, it is also necessary to pay attention to lower-case and upper-case letters. +
