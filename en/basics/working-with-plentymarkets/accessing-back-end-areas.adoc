...
:keywords: back end, backend, access back end, access backend, URL, key, UI action, uiaction, parameter, required parameter, Terra, variables, safe mode, open back end, open backend, back end area, backend area
:description: This manual page provides you with information on how to access specific back end areas by using URLs.
:position: 20
:url: basics/working-with-plentymarkets/accessing-back-end-areas
:id: AXIOIRN
:author: team-terra
