...
|*Message*
|Explanation of the log or, if an error occurred, of the error
|====

By clicking on a line, the detail view opens and further info regarding the log are shown. This window enables you to switch from one entry to the next and you can fold in or fold out the view.
