...
* *User manual* opens the link:https://knowledge.plentymarkets.com/en/[start page^] of the plentymarkets user manual where all functions are described. +
...
Install the link:https://marketplace.plentymarkets.com/en/plugins/integration/plentybase_5053[plentyBase plugin^] first to enable access to printers in your plentymarkets system.
