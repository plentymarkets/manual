...
image::basics/working-with-plentymarkets/assets/EN-General-functions-01.png[]
...
* **Website** +
Opens the <<basics/working-with-plentymarkets/dashboard#, **start page**  >> of your online store.
* **Customer data** +
Opens the <<crm/managing-customer-data#1200, **customer data** >> tab where you can search for customers.
* **Statistics** +
Opens the **<<basics/statistics#, statistics module  >>** that allows you to display various evaluations and analyses.
* **Support** +
...
Installs the <<basics/automation/plentymarkets-client#, **plentymarkets Client**  >> on your computer.
* **plentymarkets Forum** +
...
image::basics/working-with-plentymarkets/assets/EN-General-functions-02.png[]
...
image::basics/working-with-plentymarkets/assets/EN-General-functions-03.png[]
