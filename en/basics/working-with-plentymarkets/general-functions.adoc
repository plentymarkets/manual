...
* *Favourites* +
Click on the star symbol to display your favourites. For more information on how to add and remove favourites, see <<basics/working-with-plentymarkets/general-functions, 70# Adding and removing favourites>>.
* *User* +
...
2. Enter the e-mail address that you use for gravatar.com in the field *Email*.
3. *Save* the settings. +
