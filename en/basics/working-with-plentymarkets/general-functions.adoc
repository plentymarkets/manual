...
* *Online store* +
Click on the plenty ID in the upper right-hand side of the menu bar to open the start page of your online store.
* *Customer search* +
Go to *CRM » Quick search* to use the customer search. You have to set at least one filter to use the search function. Click on *Search* to search customers.
* **Statistics** +
The statistics module allows you to display various evaluations and analyses. Click on *plentymarkets logo » Statistics* to open the link:https://knowledge.plentymarkets.com/en/basics/statistics/[*statistics module*^] statistics module.
* *Support* +
...
- *Video tutorials* opens an overview of plentymarkets video tutorials on various functions of your system.
- *Forum* opens the start page of the plentymarkets forum which enables exchange between you and our employees.
- *Consulting* opens the plentymarkets support website where you can create tickets.
- *Developer guides* opens plentyDevelopers. Comprehensive information for developers is available here. +
*Partner services* +
- *Partner agencies* opens an overview of partner agencies and access to plentyProjects.
- *Project board* opens *plentyMarketplace » Tab: Projects*. Log in to +
...
If you use some menus very frequently, then you may want to save them to a list of favourites. This allows you to access the menus quickly. Favourites are displayed in the upper right-hand corner of the menu within the star symbol. Move the cursor over the star symbol to display your favourites.
...
. Move the cursor over the star symbol in the upper right-hand corner of the menu.
...
→ **__Note__**: In the drop-down list, click on *Delete all favourites* and confirm the pop up with *Delete* to delete all favourites.
...
Install the *plentyBase* plugin first to enable access to printers in your plentymarkets system. The plugin is available in the link:https://marketplace.plentymarkets.com/plugins/markets/[*plentyMarketplace*^].

Open the *System » Settings » Printer* menu to set up local printers or network printers in your plentymarkets system. More information on the setup and configuration of printers is available link:https://knowledge.plentymarkets.com/en/basics/working-with-plentymarkets/printer/[*here*^].
