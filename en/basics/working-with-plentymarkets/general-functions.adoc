...
* *Favourites* +
Click on the star symbol to display your favourites. For further information on how to add and remove favourites, see <<basics/working-with-plentymarkets/general-functions#80, Adding and removing favourites>>.
* *User* +
