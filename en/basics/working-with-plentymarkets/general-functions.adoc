...
* **Website** +
Opens the <<basics/start/homepage#, **start page**  >> of your online store.
* **Customer data** +
Opens the <<crm/managing-customer-data#1200, **customer data** >> tab where you can search for customers.
* **Statistics** +
Opens the **<<basics/start/statistics#, statistics module  >>** that allows you to display various evaluations and analyses.
* **Support** +
...
Installs the <<basics/plentymarkets-client#, **plentymarkets Client**  >> on your computer.
* **plentymarkets Forum** +
