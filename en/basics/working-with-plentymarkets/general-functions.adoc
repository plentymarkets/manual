...
Click on the *user name* to switch the view to the active user account. +
Click on *Logout* to log out of your plentymarkets system. +

To change the user image, it is required to be registered with link:https://de.gravatar.com/[*gravatar.com*^]. +
1. Go to *System » Settings » User » Accounts » User name » Tab: Master data*.
2. Enter the e-mail address that you use for gravatar.com into the field *Email*.
3. *Save* the settings. +
