...
Special warehouse**
// TODO: fix link
|Give rights for warehouses to the user. Only previously created warehouse types are available. For further information about warehouse types, refer to the link:/[Settings] page of the manual. +
+
+
+
...
=== What needs to be done if the maximum number of simultaneously logged in users has been reached?
...
In order to terminate one or more sessions, select the desired sessions and click on *Terminate selected sessions*.
