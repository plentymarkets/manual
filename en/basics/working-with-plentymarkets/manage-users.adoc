...
|*New app PIN*
|For users that operate the plentymarkets app, you can enter a PIN with between 4 and 12 numbers to activate this user for quick account switching. If you save a PIN, users can quickly be switched in the plentymarkets app. However, the user can also log into the plentymarkets app using their password. +
...
|Activate areas to grant the user account access rights to these areas of **plentymarkets Shipping**.
|====
