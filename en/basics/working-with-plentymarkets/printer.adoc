...
. Go to **Settings » Settings » Printer**.
...
. When you add a printer in the **System » Settings » Printer** menu, select the printer plugin **ZPL**.
