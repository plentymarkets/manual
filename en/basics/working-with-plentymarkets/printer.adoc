...
**__Information about the ZPL plugin:__** For optimum print quality with the ZPL plugin on Mac OSX systems, <<basics/working-with-plentymarkets/printer#65, **RAW printing** >> must be enabled on your Zebra printer.
|====
...
|<<basics/working-with-plentymarkets/printer#30, **Sharing printers** >>
...
→ Mac OSX: Select the printer driver ZPL. Test the driver's setting for every label size individually. To use the **ZPL** printer plugin, configure your Zebra printer for <<basics/working-with-plentymarkets/printer#65, **RAW printing** >>.
