= URLs to access specific areas of the back end
:lang: en
include::{includedir}/_header.adoc[]
:keywords: back end, access back end, URL, key, UI action, parameter, Terra, variables
:description: This manual page provides you with information how to access specific back end areas by using URLs.
:position: 90

Due to the abolition of the Classic back end, we created the possibility of accessing specific areas of the back end by using UI actions. This page lists the variables and parameters that lead to the said back end areas.
...
2+|*_Example_*: To open the variation detail view, the path would consist of the following parameters: +
