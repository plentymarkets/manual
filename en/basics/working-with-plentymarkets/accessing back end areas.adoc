...
Due to the abolition of the Classic back end, we created the possibility of accessing specific areas of the back end by using UI actions. This page lists the variables and parameters that lead to the respective back end areas.
