...
|*Alt + C*
|Opens the *CRM » Edit customers* menu.

|*Alt + T*
|Opens the *CRM » Ticket system* menu.

|*Alt + N*
|Opens the *CRM » Edit customers* menu and opens the *New customer* tab.
...
All menu paths saved as favourites in your user account settings are displayed in the *Favourites* tab. Favourites can also be deleted in this menu. Use the *Up* and *Down* arrows for sorting your favourites. This tab is only visible in your own user account. For further information about adding and deleting favourites, refer to the <<basics/working-with-plentymarkets/general-functions#80, Setting up general functions>> page of the manual.
