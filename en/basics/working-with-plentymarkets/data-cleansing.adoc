...
|Enter the number in days. After this time period has expired, unused addresses are automatically deleted from your plentymarkets system. Unused addresses are those addresses that do not have any relation. +
...
|Deletion of Data History (after days)
|Enter the number in days. After this time period has expired, the Data History Entries are automatically deleted from your plentymarkets system. The Data History logs changes made in the plentymarkets system. +
...
====
Currently, the number of data to be deleted is 5,000 data records per day. plentymarkets will monitor this behaviour and adjust this to a higher value, if necessary.
====
