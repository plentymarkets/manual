...
|Enter the number in days. After this time period has expired, unused contacts are automatically deleted from your plentymarkets system. An unused contact is a contact without incoming items, and tickets. +
|Deletion of orders (after days)
|Enter the number in days. After this time period has expired, orders are automatically deleted from your plentymarkets system. Orders and documents generated to the order will also be deleted. (minimum value: 60 days) +
...
**Exception**: The deletion of the change history will still be executed even with deactivated toggle button. The maximum value of 365 days will be used.
====
