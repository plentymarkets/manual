...
|Enter the number in days. After this time period has expired, orders are automatically deleted from your plentymarkets system. Orders and documents generated to the order will also be deleted. (minimal value: 60 days)+
