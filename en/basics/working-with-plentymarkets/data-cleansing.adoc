...
|Enter the number in days. After this time period has expired, the <<basics/gdpr#_change_history_for_contact_data, change history>> entries are automatically deleted from your plentymarkets system. The Change History logs changes made in the plentymarkets system. Maximum value: 365 days. +
