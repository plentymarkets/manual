...
*_Important:_* Addresses are only deleted if a value has been saved. If no value has been saved, unused addresses are not deleted. +
If you do not want to delete addresses after the value entered, remove the value and save this setting.
|====
