...
. Open the user with the user class *Variable* for whom you would like to visibility of the menu.
. Open the *Right* tab.
...
|Enter the number in days. After this time period has expired, orders are automatically deleted from your plentymarkets system. Orders and documents generated to the order will also be deleted. +
|Deletion of Change History (after days)
|Enter the number in days. After this time period has expired, the link:https://knowledge.plentymarkets.com/en/basics/gdpr#_change_history_for_contact_data[change history^] Entries are automatically deleted from your plentymarkets system. The Change History logs changes made in the plentymarkets system. +
