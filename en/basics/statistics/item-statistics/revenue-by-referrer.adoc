...
**Item » Edit item » Tab: Statistics → Statistic: Revenue by referrer**
...
This statistic provides an overview of the **revenue** for the sales order **referrers** during a selected **time span**.

== Details about the statistic

The **revenue** will be displayed for each **referrer** that was used during the selected **time span**. The particular **revenue in Euro** and the **percentage** of total revenue for all of the referrers will be displayed as **information in a mouseover**. In this statistic you can see, e.g. how much **revenue** or **profit** was made from a particular sales order referrer during the selected time period.

[TIP]
.Tip
====
In image 1, you can see that the referrer **manual entry** corresponds to a total revenue of **5,421.61 Euros**.
====

image::basics/statistics/item-statistics/assets/EN-ENG-Artikel-Statistik-UmsatzHerkunft01-SI.png[]

__Image 1: **revenue by referrer** statistic__

== Settings

The **settings** described below are available for this statistic.

image::basics/statistics/item-statistics/assets/EN-ENG-Artikel-Statistik-UmsatzHerkunft02-SI.png[]

__Image 2: **revenue by referrer** statistic; **settings**__
...
|**Show amounts**
|Select which **amount** should be calculated for the statistic: +
**Net revenue** = Revenue minus VAT and selected additional costs +
**Gross revenue** = Revenue including VAT and selected additional costs +
...
|
|**Item bundles** are [.underline]#not taken into consideration# for the amounts above. Fees for **markets** are added to the gross price (retail price).
...
.**Data fields**
====
**Referrer** = Referrer, **QuantityOfOrders** = Quantity of sales orders, **ContributionMarginTwo** = Contribution margin II, **QuantityOfBundleItems** = Quantity of items from item bundles
====

image::basics/statistics/item-statistics/assets/EN-ENG-Artikel-Statistik-UmsatzHerkunft03-SI.png[]

__Image 3: **revenue by referrer** statistic; simple export__
...
image::basics/statistics/item-statistics/assets/EN-ENG-Artikel-Statistik-UmsatzHerkunft04-SI.png[]

__Image 4: **revenue by referrer** statistic; raw data export__
