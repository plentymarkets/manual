...
**Item » Edit item » Tab: Statistics → Statistic: Revenue by country of delivery**
...
This statistic provides an overview of the **revenue** for the **countries of delivery** during a selected **time span**.

== Details about the statistic

The **revenue** will be displayed for each **country of delivery** that was used during the selected **time span**. The particular **revenue in Euro** and the **percentage** of total revenue for all of the countries of delivery will be displayed as **information in a mouseover**. In this statistic you can see, e.g. how much **revenue** or **profit** was made from a particular country of delivery during the selected time period.

[TIP]
.Tip
====
In image 1, you can see that the country of delivery **France** corresponds to a total revenue of **357.00 Euros**.
====

image::basics/statistics/item-statistics/assets/EN-ENG-Artikel-Statistik-UmsatzLieferland01-SI.png[]

__Image 1: **revenue by country of delivery** statistic__

== Settings

The **settings** described below are available for this statistic.

image::basics/statistics/item-statistics/assets/EN-ENG-Artikel-Statistik-UmsatzLieferland02-SI.png[]

__Image 2: **revenue by country of delivery** statistic; **settings**__
...
.**Data fields**
====
**ShippingRegion** = Country of delivery, **QuantityOfOrders** = Quantity of sales orders, **ContributionMarginTwo** = Contribution margin II, **QuantityOfBundleItems** = Quantity of items from item bundles
====

image::basics/statistics/item-statistics/assets/EN-ENG-Artikel-Statistik-UmsatzLieferland03-SI.png[]

__Image 3: **revenue by country of delivery** statistic; simple export__
...
image::basics/statistics/item-statistics/assets/EN-ENG-Artikel-Statistik-UmsatzLieferland04-SI.png[]

__Image 4: **revenue by country of delivery** statistic; raw data export__
