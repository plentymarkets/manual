...
1) <<basics/statistics/general-statistics/processes/pending-amounts#1, Info: pending amounts according to payment methods >>

2) <<basics/statistics/general-statistics/processes/pending-amounts#2, Details about the statistic >>

3) <<basics/statistics/general-statistics/processes/pending-amounts#3, Settings >>

4) <<basics/statistics/general-statistics/processes/pending-amounts#4, Data export >>
...
image::basics/statistics/general-statistics/processes/assets/EN-ENG-Statistik-OffeneZahlungen01-SI.png[]
...
image::basics/statistics/general-statistics/processes/assets/EN-ENG-Statistik-OffeneZahlungen02-SI.png[]
...
image::basics/statistics/general-statistics/processes/assets/EN-ENG-Statistik-OffeneZahlungen03-SI.png[]
...
image::basics/statistics/general-statistics/processes/assets/EN-ENG-Statistik-OffeneZahlungen04-SI.png[]
