...
1) <<basics/statistics/general-statistics/warehouse/reorder-levels#1, Info: estimated stock turnover and reorder levels >>

2) <<basics/statistics/general-statistics/warehouse/reorder-levels#2, Details about the statistic >>

3) <<basics/statistics/general-statistics/warehouse/reorder-levels#3, Settings >>

4) <<basics/statistics/general-statistics/warehouse/reorder-levels#4, Data export >>
...
image::basics/statistics/general-statistics/warehouse/assets/EN-ENG-Statistik-Meldebestaende01-SI.png[]
...
image::basics/statistics/general-statistics/warehouse/assets/EN-ENG-Statistik-Meldebestaende02-SI.png[]
...
image::basics/statistics/general-statistics/warehouse/assets/EN-Statistik-Meldebestaende-03-SI.png[]
...
image::basics/statistics/general-statistics/warehouse/assets/EN-Statistik-Meldebestaende-04-SI.png[]
