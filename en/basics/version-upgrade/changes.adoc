...
|This menu was removed. Price portals were moved to the menu **Data exchange » Export » Elastic export**. The price portal's URL will be renewed once you have migrated your data to plentymarkets 7. The old URLs will no longer work.
...
**System » Client (store) » Settings » Live shopping**
