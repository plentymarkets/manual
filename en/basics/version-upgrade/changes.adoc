...
When generating a polling file in the *Orders » Shipping centre » Tab: Polling* menu for DHL Easylog with header, the field *POOL_EMPF_STRASSE* appears twice in the CSV file. The mapping of the data must be adjusted in DHL Easylog settings.
