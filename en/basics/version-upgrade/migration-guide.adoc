...
→ If the system's main domain is hosted by an external provider, you also need to save the new IP address with your external domain provider after <<basics/working-with-plentymarkets/plentymarkets-account#relocation, relocating to the AWS cloud>>.
...
|The variation that is migrated first receives the item/variation number. A new, unique variation number will be generated for all of the other variations. This variation number is determined by the <<basics/version-upgrade/migration-guide#35, migration settings>> found in the menu **System » Settings » Data » Migration**. It is controlled with the setting **Duplicate number**.

|Exception 3: +
Items with multiple price sets
|One variation can be turned into several different variations. When the first price set is migrated, the variation receives the item/variation number. A new, unique variation number will be generated for all of the other variations. This variation number is determined by the <<basics/version-upgrade/migration-guide#35, migration settings>> found in the menu **System » Settings » Data » Migration**. It is controlled with the setting **Duplicate number**. +
...
. Create a new <<basics/data-exchange/export-import/exporting-data#, data format>> of the type <<basics/data-exchange/export-import/data-formats/item#, Item>>. +
...
Check whether you have items with multiple price sets. Then check whether any of these price sets use the same content and unit. This can be done with the data format <<basics/data-exchange/export-import/data-formats/itemprice#, ItemPrice>> in the dynamic export. To do so, proceed as follows.

[.instruction]
Checking the units:

. Go to **Data exchange » Export » Dynamic export**.
. Create a new <<basics/data-exchange/export-import/exporting-data#, data format>> of the type <<basics/data-exchange/export-import/data-formats/itemprice#, ItemPrice>>. +
...
. <<basics/data-exchange/export-import/importing-data#, Import>> the CSV file back into plentymarkets if you made any changes.
...
. <<basics/data-exchange/export-import/importing-data#, Import>> the CSV file **ItemPrice** back into plentymarkets if you made any changes.
...
. Go to **Data exchange » Export » Dynamic export**.
. Create a new <<basics/data-exchange/export-import/exporting-data#, data format>> of the type <<basics/data-exchange/export-import/data-formats/variationbarcode#, VariationBarcode>>. +
...
. <<basics/data-exchange/export-import/importing-data#, Import>> the CSV file of the **VariationBarcode** export back into plentymarkets.
