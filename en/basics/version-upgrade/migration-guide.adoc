...
|4
|**System » Client » Open client » Online store » Settings**
...
. Go to **System » Client » Open client » Online store » Currency**. Access this menu for every client that you work with.
...
====
Go to **System » Client » Open client » Online store » Currency**. You will only need to check the currency settings if you have clients where the option **Currency conversion** is set to **Use price column**.
====
...
. Go to **System » Client » Open client » Settings**.
