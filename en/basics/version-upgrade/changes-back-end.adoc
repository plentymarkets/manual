...
. Select **Terra** from the **Version** drop-down menu.
. Select the language.
...
The login page has been visually redesigned. Existing functions and input fields were not changed. The **Version** drop-down menu was added. Use this drop-down menu to switch between the new and the old back end.
...
* Drop-down menus were changed into drop-down lists, i.e. sub-menus are greyed out and the options of the sub-menu are listed below
