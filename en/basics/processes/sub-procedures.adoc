...
* Any settings that are specific to this sub-procedure and available in addition to the <<basics/processes/sub-procedures#100, **general settings** >>.
...
[.subhead]
Settings
No additional settings are required for this sub-procedure. The general settings for sub-procedures are described in <<basics/processes/sub-procedures#100, **table 1** >>.
...
[.subhead]
Settings
The following table explains the additional settings for this sub-procedure. The general settings for sub-procedures are described in <<basics/processes/sub-procedures#100, **table 1** >>.
...
* <<basics/processes/procedures#110, **Pick-up/delivery note** >>
...
* <<basics/processes/procedures#240, **Entry certificate (Gelangensbestätigung)** >>
...
* <<basics/processes/procedures#360, **Repair slip** >>
* <<basics/processes/procedures#380, **Return label** >>
* <<basics/processes/procedures#390, **Return slip** >>
...
|Printer setting
|Select one of the **<<basics/working-with-plentymarkets/basic-settings/printer#, printer profiles  >>** saved in the **Settings » Basic settings » Printers** menu.
...
By combining the **Order notes** sub-procedure with the <<basics/processes/procedures#260, **Note** >> procedure, you can display the information saved in the <<order-processing/orders/editing-sales-orders/changing-a-sales-order#3, **Orders » Edit orders » Tab: Overview** >> menu during the process so you employees can take appropriate action. +
...
By combining the **Customer notes** sub-procedure with the <<basics/processes/procedures#260, **Note** >> procedure, you can display the information saved in the **Customers » Edit customers » Tab: Notes** menu during the process so you employees can take appropriate action. +
Example:
...
* <<basics/processes/procedures#210, **Documents** >>
* <<basics/processes/procedures#220, **Email** >>
* <<basics/processes/procedures#230, **Finance export** >>
* <<basics/processes/procedures#240, **Entry certificate (Gelangensbestätigung)** >>
* <<basics/processes/procedures#250, **Credit note** >>
* <<basics/processes/procedures#270, **Adjustment form** >>
* <<basics/processes/procedures#280, **Warehouse pick list** >>
...
The **Send** sub-procedure sends the email template that was selected for the **<<basics/processes/procedures#220, email >>** procedure.
