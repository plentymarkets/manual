...
The procedure **<<basics/processes/procedures#430, Shipping center >>** will be used to explain how to configure the troubleshooting.
...
image::basics/processes/assets/EN-Settings-Processes-Procedures-Troubleshooting-01.png[]
...
*  Procedure: **<<basics/processes/procedures#220, Email >>**
* Sub-procedure: <<basics/processes/sub-procedures#330, **Send** >>

*  Procedure: <<basics/processes/procedures#170, **Order** >>
* Sub-procedure: <<basics/processes/sub-procedures#290, **Change status** >>

* Sub-procedure: <<basics/processes/sub-procedures#130, **Add order notes** >>
...
Depending on the configuration, the sub-procedure <<basics/processes/sub-procedures#130, **Add order notes** >> can be used to add an individual note to every faulty order. Alternatively, a saved note can be inserted for all of the faulty orders within a process. We also recommend that you attach the error message to the order.

image::basics/processes/assets/EN-Settings-Processes-Procedures-Troubleshooting-02.png[]
