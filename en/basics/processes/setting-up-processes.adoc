...
* **Processes per <<basics/working-with-plentymarkets/manage-users#, role  >>**: here you can see the processes that were assigned to your role. If you were not assigned to any role, then you will not see a folder here. Go to **<<basics/working-with-plentymarkets/manage-users#, Settings » Basic settings » User  >>** to create roles. Users who were assigned to the class <<basics/working-with-plentymarkets/manage-users#, **Admin**  >> will be able to see the processes for all roles.
* **Global processes**: here you can see processes that are available for all users.

[IMPORTANT]
.Visibility of the menu: Settings » Processes
====
**Variable users** will only be able to see the Settings » Processes menu if they were given the right to do so in the user profile. For further information about rights, refer to the **<<basics/working-with-plentymarkets/manage-users#, Managing user accounts  >>** page of the manual.
====
...
image::basics/processes/assets/EN-Einstell-Prozesse-Prozesse-einrichten-01-SI.png[]
...
image::basics/processes/assets/EN-Einstell-Prozesse-Prozesse-einrichten-02-SI.png[]
...
<<basics/working-with-plentymarkets/manage-users#, **User**  >> = The process is only visible to a specific user. This user is selected from the **User** drop-down menu below  +
<<basics/working-with-plentymarkets/manage-users#, **Role**  >> = The process is only visible to a specific **role**. This role is selected from the **Role** drop-down menu below
...
image::basics/processes/assets/EN-Einstell-Prozesse-Prozesse-einrichten-03-SI.png[]
...
image::basics/processes/assets/DE-Einstell-Prozesse-ProEinricht-04-SI.png[]
...
image::basics/processes/assets/EN-Einstell-Prozesse-Prozesse-einrichten-05-SI.png[]
...
image::basics/processes/assets/EN-Einstell-Prozesse-Prozesse-einrichten-06-SI.png[]
...
image::basics/processes/assets/EN-Einstell-Prozesse-Prozesse-einrichten-07-SI.png[]

__Image 7: **context menu**__

=== Adding elements

A process is always based on a <<basics/processes/work-steps#, **work step**  >>. Additional elements can be added to the work step as desired. You can add as many work steps as you wish to a process.

You can add various **elements** to a work step. There are two types of elements: <<basics/processes/procedures#, **control elements**  >> and <<basics/processes/procedures#, **procedures**  >>. You can also add <<basics/processes/sub-procedures#, **sub-procedures**  >> to a procedure. You can always add a subordinate element by pointing your cursor to the superordinate element and clicking on the **green plus icon** (see image 7).

image::basics/processes/assets/EN-Einstell-Prozesse-Prozesse-einrichten-08-SI.png[]
