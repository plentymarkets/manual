...
:keywords: ElasticSync, Import, contacts, account, companies, addresses
:position: 90
:url: data/importing-data/sync-types/elasticSync-contacts
:id: SMSK85D
:author: team-crm

This page explains the matching and mapping fields that you can use while importing contacts, accounts and addresses. This page serves purely as a reference and it assumes that you already have a basic understanding of the <<data/importing-data/ElasticSync#, import tool>>.
...
<<#table-matching-fields-contacts-accounts-addresses>> explains the fields that are available for matching contacts, account and address data. During the import, plentymarkets checks if the imported data record already exists based on the matching field.

[[table-matching-fields-contacts-accounts-addresses]]
.Matching fields for importing contact, account and address data
[cols="1,3"]
|===
|Setting |Explanation
...
This chapter explains the fields that are available for mapping contact, account and address data. Use these fields to specify which _column of your file_ corresponds to which _data field in your system_.
...
You can find the result of the import in the back end menu <<crm/managing-contacts#300, CRM » Contacts » Open contact » Area: Details » Drop-down list: Type>>.
...
You can find the result of the import in the back end menu <<crm/managing-contacts#300, CRM » Contacts » Open contact » Area: Details » Field: First name>>.
...
You can find the result of the import in the back end menu <<crm/managing-contacts#300, CRM » Contacts » Open contact » Area: Details » Field: Last name>>.
...
You can find the result of the import in the back end menu <<crm/managing-contacts#300, CRM » Contacts » Open contact » Area: Details » Drop-down list: Form of address>>.
...
You can find the result of the import in the back end menu <<crm/managing-contacts#300, CRM » Contacts » Open contact » Area: Details » Field: Title>>.
...
You can find the result of the import in the back end menu <<crm/managing-contacts#300, CRM » Contacts » Open contact » Area: Details » Field: Newsletter>>.
...
[TIP]
When customer classes are saved in the system, the field in the import file _has to be filled_ with the ID of the customer class. Otherwise, the contact cannot be imported in your plentymarkets system.
...
You can find the result of the import in the back end menu <<crm/managing-contacts#300, CRM » Contacts » Open contact » Area: Details » Drop-down list: Customer class>>.
...
You can find the result of the import in the back end menu <<crm/managing-contacts#300, CRM » Contacts » Open contact » Area: Details » Setting: Contact blocked>>.
...
You can find the result of the import in the back end menu <<crm/managing-contacts#300, CRM » Contacts » Open contact » Area: Details » Drop-down list: Rating>>.
...
You can find the result of the import in the back end menu <<crm/managing-contacts#300, CRM » Contacts » Open contact » Area: Details » Field: Debtor account>>.
...
[TIP]
If you later save templates in the language that you entered here in the *Setup » Client* » _Select client_ » *Email » Templates* menu, for example `nl`, the email templates will be sent to the contact in this language (in our example in Dutch).

[TIP]
<<data/internal-IDs#10, This page of the manual>> lists the languages abbreviations used in plentymarkets.

*_Default value:_* No default value

*_Permitted import values:_* Language abbreviations following the pattern `nl`, `de`, `ro` etc.

You can find the result of the import in the back end menu <<crm/managing-contacts#300, CRM » Contacts » Open contact » Area: Details » Drop-down list: Language>>.
...
*Default value:_* No default value
...
You can find the result of the import in the back end menu <<crm/managing-contacts#300, CRM » Contacts » Open contact » Area: Details » Drop-down list: Client>>.
...
You can find the result of the import in the back end menu <<crm/managing-contacts#300, CRM » Contacts » Open contact » Area: Details » Field: Date of birth>>.
...
This mapping field is currently without function and cannot be used to import contact data. You can, however, import a valuta value for the <<#mapping-field-account-valuta, account>>.
...
This mapping field is currently without function and cannot be used to import contact data. You can, however, import a days for early payment discount value for the <<#mapping-field-account-days-for-early-payment-discount, account>>.
...
This mapping field is currently without function and cannot be used to import contact data. You can, however, import a percentage for early payment discount value for the <<#mapping-field-account-percentage-for-early-payment-discount, account>>.
...
This mapping field is currently without function and cannot be used to import contact data. You can, however, import a payment due date value for the <<#mapping-field-account-payment-due-date, account>>.
...
[TIP]
Your plentymarkets system automatically assigns the contact ID and you cannot change the ID. This is why it is not needed that you map this field here. You can ignore this field for the import.
...
This option is available for all guest orders and marketplaces, but not for Ceres guest orders. Decide which type of access should be saved for the contact and enter the corresponding ID in your CSV file.
...
Enter the account name of the invoice address in your CSV file.
...
Enter the additional address information from the invoice address in your CSV file. ""Apartment 12a".
...
[TIP]
<<data/internal-IDs#20, This page of the manual>> lists the internal country IDs and the ISO codes used in plentymarkets.
...
You can find the result of the import in the back end menu <<crm/managing-contacts#300, CRM » Contacts » Open contact » Area: Address options>>.
...
Enter the contact person in the invoice address in your CSV file.
...
Enter the account name of the delivery address in your CSV file.
...
Enter the additional address information from the delivery address in your CSV file. ""Apartment 12a".
...
[#mapping-field-account-company-id]
==== Company ID

Enter the account’s ID in the CSV file.

*_Default value:_* No default value

*_Permitted import values:_* Numeric (internal ID)

You can find the result of the import in the back end menu <<crm/managing-contacts#300, CRM » Contacts » Open contact » Area: Account>>.

'''

[#mapping-field-account-number]
==== Number

Additional number for the account. This number is not assigned automatically. Maximum number of characters: 128. Enter the account’s number in the CSV file.
...
[#mapping-field-account-account-name]
==== Company name

icon:warning[role="red"] [red]#Required field#

Enter the account name in the CSV file.
...
[#mapping-field-account-vat-number]
==== VAT number

Enter the account’s VAT number in your CSV file.
...
[#mapping-field-account-valuta]
==== Valuta

Enter the account’s valuta in the CSV file.
...
[#mapping-field-account-days-for-early-payment-discount]
==== Early payment discount (days)

Enter the account’s days for early payment discount in the CSV file.
...
[#mapping-field-account-percentage-for-early-payment-discount]
==== Percentage of discount

Enter the account’s percentage for early payment discount in the CSV file.
...
[#mapping-field-account-payment-due-date]
==== Payment due date

Enter the account’s payment due date in the CSV file.
...
[#mapping-field-account-sales-representative-id]
==== Sales representative ID

Enter the account’s sales representative ID in the CSV file.
...
[#mapping-field-account-owner-id]
==== Owner ID

Enter the owner ID in your CSV file.
...
[#mapping-field-account-delivery-time]
==== Delivery time
...
[#mapping-field-account-minimum-order-value]
==== Minimum order value
...
[#mapping-field-account-supplier-currency]
==== Supplier currency
...
You can find the result of the import in the back end menu <<crm/managing-contacts#300, CRM » Contacts » Open contact » Area: Details » Setting: Allow debit>>.
...
You can find the result of the import in the back end menu <<crm/managing-contacts#300, CRM » Contacts » Open contact » Area: Details » Setting: Allow invoice>>.
