...
You can find the result of the import in the back end menu <<crm/managing-contacts#300, *CRM » Contacts » [Open contact] » Area: Addresses » [Open address]*>>.
...
You can find the result of the import in the back end menu <<crm/managing-contacts#300, *CRM » Contacts » [Open contact] » Area: Account » [Open account]*>>.
