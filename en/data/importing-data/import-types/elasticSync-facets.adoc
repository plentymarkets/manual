...
:keywords: ElasticSync, Import, Data import, Importing data, Sync type, Sync, Filter, Filters, Filtering, Search filter, Search filters, Facet, Facets, Faceted search, Webshop search function, Webshop search, Store search, Online store search, Search function, Search, Frontend, Front end, Webshop, Item search, Ceres, Shop, Online shop, Online store, Front end search, Frontend search, Front end item search
:position: 50
...
[[table-mapping-facets-selectiontype]]
[cols="1,1, 3"]
|====
|Permitted import values in CSV file |Result in the back end |Explanation
...
[[table-mapping-facets-delete-facet]]
[cols="1,1"]
|====
|Permitted import values in CSV file |Result in the back end
...
[[table-mapping-facets-delete-facetvalue]]
[cols="1,1"]
|====
|Permitted import values in CSV file |Result in the back end
...
[[table-mapping-facets-link-type]]
[cols="1,1"]
|====
|Permitted import values in CSV file |Result in the back end
...
[[table-mapping-facets-delete-link]]
[cols="1,1"]
|====
|Permitted import values in CSV file |Result in the back end
