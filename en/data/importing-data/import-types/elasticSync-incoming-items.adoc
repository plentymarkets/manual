...
You can find the result of the import in the back end menu <<stock-management/managing-stocks#100, Stock » Stocks » _open variation_ » tab: Stock » tab: Stock>>.
...
You can find the result of the import in the back end menu <<stock-management/setting-up-a-warehouse#1500, Stock » Incoming items » _perform search_ » _select incoming items data record_ » tab: Item>>.
...
You can find the result of the import in the back end menu <<stock-management/managing-stocks#intable-purchase-price, Stock » Incoming items » _perform search_ » _select incoming items data record_ » tab: Item>>.
...
You can find the result of the import in the back end menu *Stock » Incoming items » _perform search_*.
...
You can find the result of the import in the back end menu <<payment/currencies#10, Stock » Stocks » _open variation_ » tab: Stock » tab: Incoming items>>.
...
You can find the result of the import in the back end menu <<stock-management/managing-bbd-batch#100, Stock » Incoming items » _perform search_ » _select incoming items data record_ » tab: Item>>.
