...
Syncs of the type *Market listing* allow you to import listing data into plentymarkets. Go to *Data » Import* to create a new sync.
...
|0 +
1
a| Indicates the type of eBay best offer. +
