...
An import of the type *Assignment taric code* allows you to import data for the taric code table in the menu *Setup » Client » Settings » Taric code*. In order to provide taric codes for variations via import, go to the <<data/importing-data/sync-types/elasticSync-item#2300, import type Item>>.
