...
| *Property name*
|Which column of your CSV file contains the property name? Choose this column here. This option is useful if you want to _create new properties_.
...
| *Property group name*
|Which column of your CSV file contains the property group name? Choose this column here. This option is useful if you want to _create new property groups_.
|====
...
Do you want to sort the property into an existing group?
Enter the group’s ID in the CSV file.
...
If you want to save multiple values, then enter each value in a separate column and add this field once per value.
