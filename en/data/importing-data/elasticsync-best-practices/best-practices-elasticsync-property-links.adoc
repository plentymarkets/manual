= Best Practices: Characteristic links
:lang: en
...
To import the characteristic links, you can go to *Data » ElasticSync* and create a sync of the type *Item*. Alternatively, you can add the fields to an existing sync.
