...
To import the cross-selling links, you can go to *Data » Import* and create a sync of the type *Item*. Alternatively, you can add the fields to an existing sync.
