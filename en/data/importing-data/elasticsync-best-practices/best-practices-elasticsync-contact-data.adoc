...
We recommend entering ID 1 for the referrer, because ID 1 covers both the referrer *Online store* and all marketplaces. ID 0 (= manual entry) will not be effectve, because ElasticSync is not a manual entry in the strict sense.
====
