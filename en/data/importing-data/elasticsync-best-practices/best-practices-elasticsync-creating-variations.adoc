...
==== Example sync
You can download the complete sync as a zipped link:https://cdn02.plentymarkets.com/pmsbpnokwu6a/frontend/ElasticSync_BestPractice/BestPracticeVariations.json.zip[JSON file^] here.
