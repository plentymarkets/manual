...
Use the sync type *Parts compatibility listing* to create, update or delete parts compatibility listings or individual data sets from parts compatibility listings. This is done in the *Data » ElasticSync* menu. +

This best practice provides you with useful tips on what to keep in mind when creating or updating parts compatibility listings with the sync type *Parts compatibility listing* with ElasticSync.
...
* *Mandatory fields* for the creation of parts compatibility listings with ElasticSync:
  - Name
  - Referrer ID
  - Category ID
...
* If a data set/list entry already exists in this combination, then no new parts compatibility listing will be created and there will be no update of an existing parts compatibility listing.
...
* *Mandatoy field* for updating an existing parts compatibility listing:
