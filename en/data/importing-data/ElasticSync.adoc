...
In the *Data » Log* menu you can see success and error messages of syncs. To find messages of specific syncs, select the reference type *elasticSyncId* or *elasticSyncName* and enter the respective reference value. The concrete success or error messages can be found in the *Message* column.
