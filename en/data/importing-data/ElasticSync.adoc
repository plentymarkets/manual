...
.Info about RegEx
====
For further information on the RegEx function, see link:http://php.net/manual/en/reference.pcre.pattern.syntax.php[this^] page or link:https://regexr.com/[this^] page. On the latter, the RegEx engine setting has to be changed to PCRE, which can be done in the dropdown menu on the top right where Javascript is preset.
====
...
Several referrers can be separated by commas. +
