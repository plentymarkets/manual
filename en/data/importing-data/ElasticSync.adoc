...
.User rights for imports and mappings
[cols=”1,2”]
|====
| Setting | Explanation
...
| *Data > Sync > Update*
|Authorises back end users to update imports.
...
|Authorises back end users to see mappings.

| *Data > Sync > Mapping > Update*
|Authorises back end users to update mappings.

| *Data > Data log*
|Authorises back end users to create, delete, see or update the data log of an import.
|====
