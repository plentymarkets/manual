...
[#1510]=== Activating lines of a mapping for the import
...
[#1520]=== Replacing values with the RegEx function
...
[[table-own-assignment]].Own assignment
[cols="1,3"]
|====
|Field |Setting
...
[#1710]== Processing jobs in the queue
...
Syncs of the type *Manufacturer* allow you to import manufacturer data.
...
[#2250]=== Deleting a storage location
...
[[table-deleting-storage locations]].You can either delete all storage locations or only specific ones.
[cols="1,3"]
|====
|Setting |Explanation
...
Syncs of the type *Facets* allow you to import facet data.
