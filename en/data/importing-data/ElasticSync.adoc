...
* <<data/importing-data/sync-types/elasticSync-characteristic#, Characteristic>> = Select to import characteristics data.
...
. Click on *Matching*.
. Determine the import options. Pay attention to the information given in table <<table-sync-import-options>>.
. *Save* the settings.
...
. Fill in the fields. Pay attention to the information given in table <<table-own-assignment>>.
. *Save* the settings.
...
→ The file is added.
. Click on the gear-wheel icon *Import*. +
