...
* <<data/importing-data/sync-types/elasticSync-facets#, manufacturer#, Manufacturer>> = Select to import manufacturer data.
...
* <<data/importing-data/sync-tpes/elasticSync-warehouse#, Warehouse>> = Select to import storage locations.
* <<data/importing-data/sync-tpes/elasticSync-characteristic#, Characteristic>> = Select to import characteristic data.
* <<data/importing-data/sync-types/elasticSync-newsletter-recipient#, Newsletter recipient>> = Select to import newsletter data.
* <<data/importing-data/sync-tpes/elasticSync-notes#, Notes>> = Select to import notes.
