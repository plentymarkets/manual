...
:keywords: listing, ElasticSync, eBay, eBay property, property, ItemSpecifics, ItemListingMarketEbay
:position: 40
...
ElasticSync enables you to import the CSV file containing the new properties into plentymarkets. This is done in the *Data » Import* menu. To import the properties, create a sync of the type *Market listing*.
