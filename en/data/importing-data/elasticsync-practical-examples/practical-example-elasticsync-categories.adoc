...
:keywords: ElasticSync, Import, Category, Categories, Category import, Importing categories, Import categories, Creating categories via import, Creating categories, Create categories, New categories, New category, Importing category information, Importing category data, Best Practice, Practical example
:position: 55
