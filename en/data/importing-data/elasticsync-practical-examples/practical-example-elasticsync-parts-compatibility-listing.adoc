...
Use the sync type *Parts compatibility listing* to create, update or delete parts compatibility listings or individual data sets from parts compatibility listings. This is done in the *Data » Import* menu. +
