...
:keywords: ElasticSync, Import, Data import, Importing data, Sync type, Sync, Filter, Filters, Importing filters, Creating filters via import, Creating filters, New filter, Best Practice, Practical example, Filtering, Search filter, Search filters, Facet, Facets, Faceted search, Webshop search function, Webshop search, Store search, Online store search, Search function, Search, Frontend, Front end, Webshop, Item search, Ceres, Shop, Online shop, Online store, Front end search, Frontend search, Front end item search
:position: 45
...
//tag::syncsettings[]
<<data/importing-data/ElasticSync#1210, Create a new sync>>.
...
Start the sync and check whether the data was correctly imported into plentymarkets.
