...
:keywords: ElasticSync, import, items, best practice, automated, client, client links
:position: 90
...
To import the client availability, you can go to *Data » Import* and create a sync of the type *Item*. Alternatively, you can add the fields to an existing sync.
