...
To import and edit the ASINs and ePIDs, you can go to *Data » Import* and create a sync of the type *Item*. Alternatively, you can add the fields to an existing sync.
