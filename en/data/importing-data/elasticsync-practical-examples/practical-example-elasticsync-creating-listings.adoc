...
:keywords: listing, ElasticSync, eBay, listings, creating, eBay listings, importing listings, importing eBay listings
:position: 80
...
ElasticSync enables you to import the CSV file containing the new listings into plentymarkets. This is done in the *Data » Import* menu. To import the listings, create a sync of the type *Market listing*.
