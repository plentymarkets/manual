...
The payment method cash in advance and other transfers take the form of bank postings. With these methods, the payments are made into your account. To process them further, you have to import them to your plentymarkets system. After the import of the postings into your system, you can them assign these payments to orders, for example.

You can use the import type *Postings* to import new postings into your system. You can also use this import type to update existing postings. In this best practice, the import of new postings is explained. A basic understanding of the <<data/importing-data/ElasticSync#, import tool>> helps when creating your postings import. Nevertheless, this best practice explains step by step how you should proceed.

[#10]
== Preparing the import file

In plentymarkets, data are imported with CSV files. Therefore, you first have to prepare this CSV file. The CSV file should contain all the important information about the postings. After the import, the postings are created as payments. After import, information you enter into your CSV file are attached to the newly created payments. That’s why you should make sure your CSV file contains everything needed. The manual page <<data/importing-data/sync-types/elasticSync-bank-postings#20, Postings>> lists all data that can be imported. You can use these mapping fields as a guide while creating your CSV file. How to <<data/importing-data/elasticsync-best-practices/best-practices-elasticsync-postings#40, add the mapping>> is explained further down in this best practice.
...
image::data/importing-data/assets/bp-postings-import-csv.png[]
...
image::data/importing-data/assets/bp-postings-import-menu.png[]
...
image::data/importing-data/assets/bp-postings-import-create.png[]

3) After clicking on *Add import*, you are redirected to the basic settings of your new import. First, set the required *Basic data* on the left of the menu.

image::data/importing-data/assets/bp-postings-import-basic-data.png[]

Select the following settings for this:

* *Name*: Enter a name for your new postings import. The name in the example in the screenshot is *Best practice postings import*. Select your own import name. +
...
image::data/importing-data/assets/bp-postings-import-import-settings.png[]
...
Click on *Save import* (icon:save[role="green"]) on the left side above the *Basic data*. The import is saved and you are redirected to the further settings.
...
image::data/importing-data/assets/bp-postings-import-matching.png[]
...
1) After the matching settings, you know have to create the *Mapping*. To do so, click on *Add mapping* and enter a *Name* for the mapping.

image::data/importing-data/assets/bp-postings-import-mapping.png[]
...
image::data/importing-data/assets/bp-postings-import-test.png[]

The first 10 lines of your CSV file are processed for the test and no cache is used. After running the test, check the log for error messages by by navigating to the *Data » Log* menu or check the imported data. If there are no errors or problems, you can run the import.

image::data/importing-data/assets/bp-postings-import-run.png[]

After clicking on *Run import*, the data are imported into your system. The postings are created as payments and are available in the *Orders » Payments* menu. In this menu, you can <<payment/beta-managing-payments#, manage the payments>> and continue with your workflow.
