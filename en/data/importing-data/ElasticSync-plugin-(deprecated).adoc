...
====
The plugin will be deactivated soon. Thus, we recommend creating syncs from now on without the plugin. To find out how this works, go to <<basics/data-exchange/ElasticSync/ElasticSync#, this page>>.
====
