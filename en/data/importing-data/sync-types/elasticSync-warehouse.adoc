...
With syncs of the type *Warehouse*, you import new storage locations or update existing ones. In order to create or update storage locations via ElasticSync, a warehouse must be created. +
...
|Yes +
 No
a|Delete function for storage locations +

* Yes = Delete storage location +
* No = Do not delete storage location

3+^| *Levels of storage locations*
