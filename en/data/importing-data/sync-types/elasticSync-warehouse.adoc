...
You can find the result of the import in the back end menu: *Setup » Stock » Warehouse» _Select warehouse_ » Storage locations*.
...
Enter the position of the storage location in your CSV file. The position is for example required for the pick path.
