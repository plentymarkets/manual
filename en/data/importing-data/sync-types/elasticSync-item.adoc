...
<<table-mapping-fields-properties-items>> lists the fields available for importing characteristic links at the item level. During the import, plentymarkets checks if the imported data record already exists based on the matching field.
