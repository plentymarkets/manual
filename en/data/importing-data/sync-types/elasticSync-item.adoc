...
For selection IDs, see *System » System settings » Item » Characteristics » Open characteristic*
...
For selection IDs, see *System » System settings » Settings » Properties » Configuration » Open property » Values*
