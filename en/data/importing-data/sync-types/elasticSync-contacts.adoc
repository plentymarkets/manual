...
*_Background info:_* Every new contact automatically receives an ID, which can not be changed. The ID is used to uniquely identify the contact. Because the ID is unique, it’s a good way to check whether the imported data record already exists in plentymarkets.
...
If you want to update the data of a certain contact only, enter the contact’s ID in your CSV file.
