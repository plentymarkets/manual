...
To display the property warehouse in the UI, go to *System » System settings » Orders » Settings* and for the mapping of the warehouse, select option b). Alternatively, select option a) and click *Edit* on the items.
