...
The data format creator *Categories* exports the categories of the type *Item* saved in the system based on the rules defined in the following and saves the data on a cloud storage.
