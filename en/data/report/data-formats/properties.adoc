...
|VARCHAR
|property cast
|Section in which the property is used, as specified in the <<item/settings/properties#600, property's settings>>.

|prop_type
|VARCHAR
|property type
|Property type, as specified in the <<item/settings/properties#600, property's settings>>.
