...
The data format creator *accountContacts* exports the contacts (customer data) saved in the system based on the rules defined in the following and saves the data on a cloud storage.
