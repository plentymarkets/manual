...
<<table-data-colums-stockmanagementstockmovements>> explains the available properties and the corresponding values.

[[table-data-colums-stockmanagementstockmovements]]
