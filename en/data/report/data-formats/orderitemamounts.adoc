...
The data format creator *orderItemAmounts* exports the amounts of the order items saved in the system based on the rules defined in the following and saves the data on a cloud storage.

== Technical specifications

<<table-specifications-orderitemamounts>> explains the available properties and the corresponding values.
...
<<table-data-columns-orderitemamounts>> explains the available properties and the corresponding values.
