...
The data format creator *orderProperties* exports data on the properties of the order items available in your plentymarkets system and saves the data on a cloud storage.
