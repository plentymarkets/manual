...
The data format creator *itemVariationSuppliers* exports the links between suppliers and variations saved in the system based on the rules defined in the following and saves the data on a cloud storage.
