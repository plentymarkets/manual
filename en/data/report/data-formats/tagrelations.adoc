...
The data format creator *tagRelations* exports the tag relationships available in your plentymarkets system and saves the data on a cloud storage.

== Technical specifications

<<table-specifications-tag-relations>> explains the available properties and the corresponding values.

[[table-specifications-tag-relations]]
...
<<table-data-columns-tag-relations>> explains the data columns of the *tagRelations* format that are saved in the CSV file during the raw data export.

[[table-data-columns-tag-relations]]
