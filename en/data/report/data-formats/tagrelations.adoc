...
The data format creator *TagRelations* exports the tag relationships saved in the system and saves the data on a cloud storage.

== Technical specifications

<<table-specifications-tag-relationships>> explains the available properties and the corresponding values.
