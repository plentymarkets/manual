...
The data format creator *accounts* exports the company data saved in the system based on the rules defined in the following and saves the data on a cloud storage.
