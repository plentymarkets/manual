...
The data format creator *orderProperties* exports data on the item properties available in your plentymarkets system and saves the data on a cloud storage.
