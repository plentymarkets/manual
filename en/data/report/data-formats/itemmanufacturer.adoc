...
The data format creator *itemManufacturer* exports the manufacturer data saved in the system based on the rules defined in the following and saves the data on a cloud storage.
