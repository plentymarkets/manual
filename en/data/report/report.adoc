...
|accountContacts
|Contact +
For more information, see the <<data/report/data-formats/accountcontacts#, accountContacts>> page.

|accounts
|Company +
For more information, see the <<data/report/data-formats/accounts#, accounts>> page.

|categories
|Categories +
For more information, see the <<data/report/data-formats/categories#, categories>> page.

|feedbacks
|Feedbacks +
For more information, see the <<data/report/data-formats/feedbacks#, feedbacks>> page.

|itemManufacturer
|Manufacturer +
For more information, see the <<data/report/data-formats/itemmanufacturer#, itemManufacturer>> page.

|itemVariations
|Variation +
For more information, see the <<data/report/data-formats/itemvariations#, ItemVariations>> page.

|itemVariationSuppliers
|Links between suppliers and variations +
For more information, see the <<data/report/data-formats/itemvariationsuppliers#, itemVariationSuppliers>> page.

|orderItemAmounts
|Number of order items +
For more information, see the <<data/report/data-formats/orderitemamounts#, orderItemAmounts>> page.

|orderItemProperties
|Property of the order item +
For more information, see the <<data/report/data-formats/orderitemproperties#, orderItemProperties>> page.

|orderItems
|Order item +
For more information, see the <<data/report/data-formats/orderitems#, orderItems>> page.

|orderProperties
|Order property +
For more information, see the <<data/report/data-formats/orderproperties#, orderProperties>> page.

|orders
|Order +
For more information, see the <<data/report/data-formats/orders#, orders>> page.

|stockManagementStock
|Stock +
For more information, see the <<data/report/data-formats/stockmanagementstock#, stockManagementStock>> page.

|stockManagementStockMovements
|Stock movements +
For more information, see the <<data/report/data-formats/stockmanagementstockmovements#, stockManagementStockMovements>> page.

|stockManagementWarehouses
|Warehouses +
For more information, see the <<data/report/data-formats/stockmanagementwarehouses#, stockManagementWarehouses>> page.

|tags
|Tags +
For more information, see the <<data/report/data-formats/tags#, tags>> page.

|tagRelations
|Tag links +
For more information, see the <<data/report/data-formats/tagrelations#, tagRelations>> page.

|users
|Users +
For more information, see the <<data/report/data-formats/users#, users>> page.
