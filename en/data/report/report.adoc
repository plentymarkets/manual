...
|categories
|Categories +
For further information, refer to the sub-page <<data/report/data-formats/categories#, categories>>.

|feedbacks
|Feedbacks +
For further information, refer to the sub-page <<data/report/data-formats/feedbacks#, feedbacks>>.
...
For further information, refer to the sub-page <<data/report/data-formats/itemvariationsuppliers#, itemVariationSuppliers>>.
...
|Stock +
For further information, refer to the sub-page <<data/report/data-formats/stockmanagementstock#, stockManagementStock>>.

|stockManagementStockMovements
|Stock movements +
For further information, refer to the sub-page <<data/report/data-formats/stockmanagementstockmovements#, stockManagementStockMovements>>.

|stockManagementWarehouses
|Warehouses +
For further information, refer to the sub-page <<data/report/data-formats/stockmanagementwarehouses#, stockManagementWarehouses>>.

|tags
|Tags +
For further information, refer to the sub-page <<data/report/data-formats/tags#, tags>>.

|tagRelations
|Tag links +
For further information, refer to the sub-page <<data/report/data-formats/tagrelations#, tagRelations>>.

|====

Further data formats will be added in the future and listed in this table.
