...
:keywords: REST API, REST routes, REST route, Interface
...
//add this url weiterleitung /en/basics/admin-tasks/rest-api/;/en/data/rest-api/;301;L
...
====
* link:https://developers.plentymarkets.com/tutorials/customerdata[Create a contact and an account^]{nbsp}icon:external-link[]
