...
include::_textblocks/catalogues/instructions/catalogue-mapping.adoc[tag=complex-mappings-config]
...
include::exporting-standardformats.adoc[tag=table-format-settings]

2+| Export settings

include::exporting-standardformats.adoc[tag=table-export-settings]
|====
...
include::exporting-standardformats.adoc[tag=manage-catalogues]
