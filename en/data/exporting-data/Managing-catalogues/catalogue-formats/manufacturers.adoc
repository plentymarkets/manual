...
When creating a new catalogue, you’ll select the standard format from the first drop-down list.
Then you can select the format type *Manufacturers* from the second drop-down list.
