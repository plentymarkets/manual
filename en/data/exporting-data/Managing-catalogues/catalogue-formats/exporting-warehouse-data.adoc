...
:position: 250
:url: data/exporting-data/exporting-warehouse-data
:id: FUM682Y
:author: team-stock
...
In order to only export specific warehouse data, you can select filters and thus narrow down the data. How to add filters is described in <<data/exporting-data/managing-catalogues#257, this chapter>>.
