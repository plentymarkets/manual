...
:position: 10
:url: data/exporting-data/catalogues-item
:id: 0S1G3SE
:author: team-item
...
image::data/exporting-data/Managing-catalogues/catalogue-formats/assets/catalogue-item.png[]
...
image::data/exporting-data/Managing-catalogues/catalogue-formats/assets/asin-all.png[]
...
| *ASIN Code*
|
include::../../../../item/_textblocks/directory/variation/settings/asin-epid/asin.adoc[]
...
| *Moin*
|
include::../../../../item/_textblocks/directory/variation/settings/asin-epid/moin.adoc[]
...
This folder lists the <<item/settings/barcodes#100, barcode types>> that you’ve already configured in the menu *Setup » Item » Barcode*.
When you add a barcode type to the catalogue, <<item/settings/barcodes#300, the actual code>> that was saved for this barcode type in the variation data record will be exported.
...
image::data/exporting-data/Managing-catalogues/catalogue-formats/assets/barcode-catalogue-variation.png[]
...
Possible workaround: Export the data with the tools <<data/exporting-data/FormatDesigner/format-types/item#1200, FormatDesigner>> and <<data/exporting-data/elastic-export#700, Elastic Export>> instead.
...
image::data/exporting-data/Managing-catalogues/catalogue-formats/assets/category-defaultcategory.png[]
...
| *Category name*
|
include::../../../../item/_textblocks/settings/categories/name.adoc[]
...
| *URL name*
|
include::../../../../item/_textblocks/settings/categories/url-name.adoc[]

| *Meta title*
|
include::../../../../item/_textblocks/settings/categories/meta-title.adoc[]

| *Meta description*
|
include::../../../../item/_textblocks/settings/categories/categories-meta-description.adoc[]

| *Meta keywords*
|
include::../../../../item/_textblocks/settings/categories/categories-meta-keywords.adoc[]
...
| *Item ID*
|
include::../../../../item/_textblocks/directory/global/id.adoc[]
...
<<data/exporting-data/catalogues-item#180, Further information>>.

| *Manufacturer ID*
|
include::../../../../item/_textblocks/directory/global/manufacturer.adoc[tag=catalogue-id]

| *Manufacturer name*
|
include::../../../../item/_textblocks/directory/global/manufacturer.adoc[tag=catalogue-name]

| *External manufacturer name*
|
include::../../../../item/_textblocks/directory/global/manufacturer.adoc[tag=catalogue-external]

| *Manufacturer country ID*
|
include::../../../../item/_textblocks/directory/global/manufacturing-country.adoc[tag=catalogue-id]

| *Manufacturer country name*
|
include::../../../../item/_textblocks/directory/global/manufacturing-country.adoc[tag=catalogue-name]

| *Condition ID*
|
include::../../../../item/_textblocks/directory/global/condition.adoc[]
...
| *Name 1*
|
include::../../../../item/_textblocks/directory/texts/name1.adoc[]

| *Name 2*
|
include::../../../../item/_textblocks/directory/texts/name2.adoc[]

| *Name 3*
|
include::../../../../item/_textblocks/directory/texts/name3.adoc[]
...
| *URL path*
|
include::../../../../item/_textblocks/directory/texts/url-path.adoc[]
...
The folders here correspond to the various <<item/settings/attributes#, attributes>> that you’ve already created in the menu *Setup » Item » Attributes*.
...
The folders here correspond to the various <<stock-management/setting-up-a-warehouse#, warehouses>> that you’ve already configured in the menu *Setup » Stock » Warehouse*.
...
====
This folder corresponds to the sum of all your warehouses.
Example:
...
| *Is main variation*
|Indicates whether the variation is a <<item/introduction/structure#600, main variation>>.
...
|Specifies the ID of the corresponding <<item/introduction/structure#600, main variation>>.
...
| *Position*
|
include::../../../../item/_textblocks/directory/variation/settings/variation-basic-settings/position.adoc[]

| *Active*
|
include::../../../../item/_textblocks/directory/variation/settings/availability/active.adoc[]
...
| *Model*
|
include::../../../../item/_textblocks/directory/variation/settings/basic-settings/model.adoc[]
...
| *Stock limit*
|
include::../../../../item/_textblocks/directory/variation/settings/availability/limitation.adoc[]
...
| *Max. order quantity*
|
include::../../../../item/_textblocks/directory/variation/settings/availability/availability-max-order-quantity.adoc[]

| *Min. order quantity*
|
include::../../../../item/_textblocks/directory/variation/settings/availability/availability-min-order-quantity.adoc[]
...
| *Customs*
|
include::../../../../item/_textblocks/directory/variation/settings/costs/customs.adoc[]
...
| *VAT rate*
|
include::../../../../item/_textblocks/directory/variation/settings/costs/vat.adoc[]

| *Availability ID*
|
include::../../../../item/_textblocks/directory/variation/settings/availability/symbol.adoc[tag=catalogue-id]

| *Availability days*
|
include::../../../../item/_textblocks/directory/variation/settings/availability/symbol.adoc[tag=catalogue-days]

| *Availability name*
|
include::../../../../item/_textblocks/directory/variation/settings/availability/symbol.adoc[tag=catalogue-name]

| *Content unit ISO*
|
include::../../../../item/_textblocks/directory/variation/settings/dimensions/content-unit.adoc[tag=catalogue-iso]

*_Note_*: Use this export field together with *Content value*.

| *Content unit name*
|
include::../../../../item/_textblocks/directory/variation/settings/dimensions/content-unit.adoc[tag=catalogue-name]
...
The folders here correspond to the various <<item/settings/properties#1200, property groups>> that you’ve already created in the menu *Setup » Settings » Properties » Groups*.
Open a group’s folder and then add whichever properties have values that you want to export.

[discrete]
==== Data field level

The data fields here correspond to the various <<item/settings/properties#600, properties>> that you’ve already created in the menu *Setup » Settings » Properties » Configuration*.
...
Export the data with the tools <<data/exporting-data/FormatDesigner/format-types/item#1600, FormatDesigner>> and <<data/exporting-data/elastic-export#700, Elastic Export>> instead.
|====
...
image::data/exporting-data/Managing-catalogues/catalogue-formats/assets/property-exportkey-name.png[]
...
Images can be saved for a specific <<item/introduction/structure#, variation>> or for the entire <<item/introduction/structure#, item>>.
...
*_Possible workaround 2_*:
Export the data with the tools <<data/exporting-data/FormatDesigner/format-types/item-images#, FormatDesigner>> and <<data/exporting-data/elastic-export#700, Elastic Export>> instead.
...
This folder lists the <<item/settings/prices#, sales prices>> that you’ve already configured in the menu *Setup » Item » Sales prices*.
When you add a sales price to the catalogue, <<item/managing-items#240, the actual monetary price>>, which is saved in the variation data record, will be exported.
...
image::data/exporting-data/Managing-catalogues/catalogue-formats/assets/salesprice-catalogue-variation.png[]
...
Limits the export to items that are <<item/managing-items#350, available>> for _at least one_ of these markets.
...
*_Differentiation_*:
There is also an “and” filter. <<data/exporting-data/catalogues-item#intable-market-and, Further information>>.

--

|[#intable-tags-and]*Has Tags*
|Select one or more tags from the drop-down list.
Limits the export to items that are linked to _all_ of the selected <<item/settings/flags#600, tags>>.
...
*_Differentiation_*:
There is also an “or” filter. <<data/exporting-data/catalogues-item#intable-tags-or, Further information>>.
...
*_Differentiation_*:
There is also an “and” filter. <<data/exporting-data/catalogues-item#intable-selectionvalue-and, Further information>>.

--

| *At least one availability*
|Select one or more availability IDs from the drop-down list.
Limits the export to variations with one of these <<item/managing-items#200, availability levels>>.
...
Limits the export to items with one of these <<item/import-export-create/create/new-item#200, flags>>.
...
Limits the export to items with this <<item/managing-items#45, Amazon product type>>.
...
|Limits the export to variations that are either the <<item/introduction/structure#600, main variation>> or a sub-variation.

| *Variation has an image*
|Limits the export to variations, which have <<item/managing-items#330, an image saved>> for them.
...
Limits the export to variations that are linked to _all_ of these <<item/managing-items#300, categories>>.
...
*_Differentiation_*:
There is also an “or” filter. <<data/exporting-data/catalogues-item#intable-categories-or, Further information>>.
...
Limits the export to variations that are linked to _at least one_ of these <<item/managing-items#300, categories>>.
...
*_Differentiation_*:
There is also an “and” filter. <<data/exporting-data/catalogues-item#intable-categories-and, Further information>>.
...
Limits the export to items that were <<item/managing-items#_basic_settings, manufactured by one of these companies>>.

|[#intable-market-and]*Visible for markets*
|Select one or more marketplaces from the drop-down list.
Limits the export to items that are <<item/managing-items#350, available>> for _all_ of these markets.
...
*_Differentiation_*:
There is also an “or” filter. <<data/exporting-data/catalogues-item#intable-market-or, Further information>>.
...
! *Bundle*
!Limits the export to <<item/use-cases/combining-products#2000, item bundles>>.

! *Part of a bundle*
!Limits the export to <<item/use-cases/combining-products#2000, bundle components>>.
!===

|[#intable-client-or]*Visible for a client*
|Select one or more clients from the drop-down list.
Limits the export to variations that are available for _at least one_ of the selected <<item/managing-items#360, clients>>.
...
*_Differentiation_*:
There is also an “and” filter. <<data/exporting-data/catalogues-item#intable-client-and, Further information>>.

--

|[#intable-client-and]*Visible for clients*
|Select one or more clients from the drop-down list.
Limits the export to variations that are available for _all_ of these <<item/managing-items#360, clients>>.
...
*_Differentiation_*:
There is also an “or” filter. <<data/exporting-data/catalogues-item#intable-client-or, Further information>>.
...
*_Differentiation_*:
There is also an “or” filter. <<data/exporting-data/catalogues-item#intable-selectionvalue-or, Further information>>.

--

|[#intable-tags-or]*Has at least one tag*
|Select one or more tags from the drop-down list.
Limits the export to items that are linked to _at least one_ of the selected <<item/settings/flags#600, tags>>.
...
*_Differentiation_*:
There is also an “and” filter. <<data/exporting-data/catalogues-item#intable-tags-and, Further information>>.
...
* *_Negative example_*: You use the data fields <<data/exporting-data/catalogues-item#60, Item ID>> and <<data/exporting-data/catalogues-item#110, Variation ID>>.
...
* *_Positive example_*: You use the data fields <<data/exporting-data/catalogues-item#60, Item ID>> and <<data/exporting-data/catalogues-item#110, Variation ID>>.
You give one “Export Key” the name “VariationID” and the other “ItemID”.

image::data/exporting-data/Managing-catalogues/catalogue-formats/assets/catalogue-export-keys.png[]
...
image::data/exporting-data/Managing-catalogues/catalogue-formats/assets/comparative-value.png[]
...
image::data/exporting-data/Managing-catalogues/catalogue-formats/assets/catalogue-export.gif[]

* <<data/exporting-data/managing-catalogues#260, Further information about the export>>
* <<data/exporting-data/managing-catalogues#255, Alternative: Export a preview>>
...
*_Possible workaround 2_*:
Export the data with the tools <<data/exporting-data/FormatDesigner/format-types/item#, FormatDesigner>> and <<data/exporting-data/elastic-export#700, Elastic Export>> instead.
