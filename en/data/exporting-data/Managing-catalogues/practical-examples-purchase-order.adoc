= Practical examples for purchase order catalogues
:lang: en
...
* *Supplier > Supplier ID* link with *Supplier > Supplier address* +
This way, the ID of the supplier is exported together with the corresponding address.
* *Purchase order > Order items > Variation ID*
* *Purchase order > Order items > Quantity*
* *Purchase order > Order items > Amounts > Purchase price*
* *Purchase order > Order items > Price net*
...
- Redistribution ID: To match data later on and to extend data, if needed.
