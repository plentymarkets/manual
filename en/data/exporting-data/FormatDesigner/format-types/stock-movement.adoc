...
:keywords: FormatDesigner, Format types, Export, Data, Export data, Exporting data, Data export, Stock movements, Export stock movements, Exporting stock movements
