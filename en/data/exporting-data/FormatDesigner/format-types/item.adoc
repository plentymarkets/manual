...
|id
|ID of the ASIN. You need this ID if you want to <<data/importing-data/sync-types/elasticSync-item#2430, delete ASINs with the help of ElasticSync>>. The ID is not visible in the plentymarkets back end.

|position
|Position of the ASIN. The position is not visible in the plentymarkets back end.
