...
|id
|ID for the ASIN. You need this ID if you want to <<data/importing-data/sync-types/elasticSync-item#2430, delete ASINs with the help of ElasticSync>>. The ID is not visible in your plentymarkets system.
