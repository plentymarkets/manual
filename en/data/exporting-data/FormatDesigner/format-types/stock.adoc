...
:keywords: FormatDesigner, Format types, Export, Data, Export data, Exporting data, Data export, Stock, Export stock, Exporting stock, Export stock data, Exporting stock data, Inventory, Export item data, Exporting item data
...
|<<stock-management/managing-stocks#400, Average purchase price>>

|reordered
|<<stock-management/managing-stocks#400, Reordered quantity>>

|reservedStock
|<<stock-management/managing-stocks#400, Reserved stock>>

|stockNet
|<<stock-management/managing-stocks#400, Net stock>>

|stockPhysical
|<<stock-management/managing-stocks#400, Physical stock>>
