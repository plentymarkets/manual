...
:keywords: FormatDesigner, Format types, Export, Data, Export data, Exporting data, Data export, Facet value, Facet, Export facet values, Exporting facet values
:description: Use the facetValue format to export facet values.
:position: 90
