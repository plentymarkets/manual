...
:keywords: FormatDesigner, Format types, Export, Data, Export data, Exporting data, Data export, Facet, Facets, Export facets, Exporting facets
:description: Use the facet format to export facets.
:position: 80
