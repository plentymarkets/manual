...
:keywords: FormatDesigner, Format types, Export, Data, Export data, Exporting data, Data export, Newsletter recipient, Export newsletters, Exporting newsletters, Newsletter data, Export newsletter data, Exporting newsletter data
