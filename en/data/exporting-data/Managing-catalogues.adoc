...
[IMPORTANT]
.Start export function is no export to marketplaces
====
The function *Start export* does not carry out the automatic export, but only a manual one. In this case, your data will not be transferred to any marketplace.
====
