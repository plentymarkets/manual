...
*_Note_*: The standard formats will be transferred to the catalogue step by step. At the moment, the formats <<data/exporting-data/catalogues-manufacturers#, Manufacturers>>, *Newsletter recipients*, <<data/exporting-data/catalogues-orders#, Order>>, <<data/exporting-data/catalogues-purchase-orders#, Purchase order>>, <<data/exporting-data/catalogues-item#, Item (new)>>, <<data/exporting-data/catalogues-stock-movements#, Stock movements>>, <<data/exporting-data/catalogues-stocks#, Stocks>> and <<data/exporting-data/catalogues-warehouses#, Warehouses>> are available.
|====
 ...
 *_Note_*: At the moment, the formats <<data/exporting-data/catalogues-manufacturers#, Manufacturers>>, *Newsletter recipients*, <<data/exporting-data/catalogues-orders#, Order>>, <<data/exporting-data/catalogues-purchase-orders#, Purchase order>>, <<data/exporting-data/catalogues-item#, Item (new)>>, <<data/exporting-data/catalogues-stock-movements#, Stock movements>>, <<data/exporting-data/catalogues-stocks#, Stocks>> and <<data/exporting-data/catalogues-warehouses#, Warehouses>> are available.
