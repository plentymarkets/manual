...
The toggle button on the left side in the catalogue overview allows you to activate or deactivate a catalogue for the export. By activating the toggle button, the data are transferred to the marketplace or exported from your system on a daily basis.
====
