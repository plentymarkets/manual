...
In the *Settings* tab of a catalogue you can generate a URL for the download. This can be done by using a so-called admin link or a public link.
...
. Select a catalogue. +
→ The catalogue opens.
. Open the *Settings* tab (icon:cog[]) on the left and select the *Download* section. +
