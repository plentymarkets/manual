...
. At the top right, click on *Configure columns* (icon:cog[]). +
→ The window *Configure columns* opens.
. Select which columns you want to be displayed.
. Move (icon:drag_sort_handle[set=plenty]) the columns so they are displayed in the desired order.
. Click on *Confirm* to save your settings.

[TIP]
.Filtering by catalogue name
====
On the left of the catalogue overview, enter the name of the desired catalogue into the *Name* field and click on *Search* (icon:search[role="blue"]) or Enter to find the desired catalogue faster.
====
...
*_Optional_*: To map another data field to an existing one, click on *Add data field* (icon:link[rotate=90]) on the right. +
→ The editing mode opens.
. Next to the data field you want to select, click on the plus or select *Own value*. +
→ The data field is added to the view.
. Close the editing mode via the X or by clicking outside the window.
. On the right in the data row, click on *Settings* (icon:cog[]) to select a separator for linking the data fields. +
...
. *Save* (icon:save[role="green"]) the settings. +
→ The catalogue is created and the *Settings* tab (icon:cog[]) opens.
...
. If you selected *Own value*, enter a value into the input field below.
*_Optional_*: Click on *Add fallback data field* to select a data field that is exported in case another one is not available. You can also add more than one fallback data field. +
. *_Optional_*: To link another data field to an existing one, click on *Add data field* (icon:link[rotate=90]) on the right. +
→ The editing mode opens.
. Next to the data field you want to select, click on the plus or select *Own value*. +
→ The data field is added to the view.
. On the right in the data row, click on *Settings* (icon:cog[]) to select a separator for linking the data fields. +
...
====
You can move single data fields or whole columns as desired and thus determine the order in which the data fields are exported. If you want to move a single data field, go to the data field and drag and drop it to the desired position. However, if you want to move a whole column, click on the symbol (icon:ellipsis-v[] icon:ellipsis-v[]) on the left side and drag and drop it to the desired position.
====
...
. *_Optional_*: Click on Download (icon:download[role="purple"]) to test the catalogue export and to download the preview.
...
. Click on *Download data* (icon:download[]). +
→ The export starts. +
icon:map-signs[] *_Or_*: Open a catalogue.
. At the top, click on *Download data* (icon:download[role="purple"]). +
→ The export starts.
...
. At the top, click on *Export catalogue* (icon:download[role="purple"]). +
→ A window opens.
...
. Go to *Data » Catalogues*. +
→ The catalogue overview opens.
. At the top, click on *Import catalogue* (icon:upload[role="purple"]). +
→ A window opens.
...
. Select a catalogue. +
→ The catalogue opens.
. Open the *Settings* tab (icon:cog[]) on the left and select the *Download settings* section. +
...
. Click on the URL or copy the URL (icon:copy[]) to use it.
...
| *Admin link*
|You can only use an admin link, if you are logged in as an admin. By clicking on the icon on the right (icon:copy[]), you can copy the URL.
...
| *Public link*
|Use a public link, if you are not logged in as an admin. By clicking on the icon on the right (icon:copy[]), you can copy the URL.
|====
