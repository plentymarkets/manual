...
*_Note_*: The standard formats will be transferred to the catalogue step by step. At the moment, the formats *Manufacturers*, *Newsletter recipients*, *Stocks*, *Stock movements*, <<data/exporting-data/catalogues-orders#, Order>> and <<data/exporting-data/catalogues-purchase-orders#, Purchase order>> are available.
