...
→ All data fields that have just been added are deleted step by step. *_Note_*: This only works for data fields that have just been added, but have not been saved yet.
