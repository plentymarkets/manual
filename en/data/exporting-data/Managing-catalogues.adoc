...
*_Note_*: The standard formats will be transferred to the catalogue step by step. At the moment, only the format *Manufacturer* is available.
 ...
 *_Note_*: At the moment, only the format *Manufacturer* is available.
