...
====
By default, both mandatory fields (marked with a *) and non-mandatory fields of a catalogue are shown. In order to only see the mandatory fields, activate the toggle button at the top of the catalogue view.
====
...
. Go to *Data » Catalogues*. +
→ The catalogue overview opens.
. Select the catalogue that you want to copy.
. Click on the More options menu (icon:ellipsis-v[]).
. Click on *Copy*. +
icon:map-signs[] *_Or_*: Click on *Copy* (icon:clone[role="yellow"]). +
→ A new window opens.
...
You can also copy several catalogues at once. However, in this case, you cannot change the format of the catalogues.
...
. Go to *Data » Catalogues*. +
→ The catalogue overview opens.
. Select the catalogue that you want to delete.
. Click on the More options menu (icon:ellipsis-v[]).
. Click on *Delete*. +
→ You are asked to confirm your decision.
. Confirm the deletion. +
→ The catalogue is deleted. +
icon:map-signs[] *_Or_*: Open a catalogue and at the top right, click on *Delete* (icon:minus-square[role="red"]) in order to delete the catalogue.
