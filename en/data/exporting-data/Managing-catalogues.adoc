...
[NOTE]
.Visibility of the menu *Data » Catalogues*
====
The *Data » Catalogues* menu becomes visible when you deploy a plugin that provides a catalogue template.
====
...
Catalogues offers the following advantages:
