...
* *_You want to export item data to markets?_*
  ** To do so, you need a catalogue with marketplace formats. An introduction to marketplace formats lives on the manual page <<data/exporting-data/market-export#, Catalogues: Marketplace export>>
