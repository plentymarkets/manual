...
====
Plugins are constantly being updated and improved. Before you start creating data formats, open the menu *Plugins » Plugin overview » _Open plugin set_* and make sure you're using the latest version of the plugin.
====
