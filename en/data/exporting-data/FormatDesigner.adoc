...
<<table-fields-stock>> lists the fields available for exporting stock data. +
A stock correction is carried out during the import in such a way that the stock reflects the imported value and thus serves as stocktaking.
...
<<table-field-date>> lists the field available for exporting the current date. For more information see link:http://php.net/manual/de/function.date.php[here^].
