...
The plugin has to be installed in the linked plugin set to make it visible in the menu. It also has to be loaded with a specific priority compared to other plugins. To set the priority, open your plugin set and click on *Set priorities*. FormatDesigner needs to have a lower priority than Ceres and IO, if they're installed.
