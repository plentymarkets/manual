...
.Plugin updated?
====
The FormatDesigner is part of the ElasticSync plugin. ElasticSync is constantly updated and improved. Thus, go to *Plugins » Plugin overview » Open plugin set* and make sure that you use the latest version of ElasticSync before creating syncs or exporting formats.
====
...
ID of the variation = ID of the variation = Categories are not inherited from the main variation. +
ID of main variation = Categories are inherited from the main variation.

|marketVariationId
|Variation ID or ID of the main variation of the item. +
ID of the variation = Markets are not inherited from the main variation. +
ID of main variation = Markets are inherited from the main variation.

|clientVariationId
|Variation ID or ID of the main variation of the item. +
ID of the variation = Clients are not inherited from the main variation. +
ID of main variation = Clients are inherited from the main variation.

|salesPriceVariationId
|Variation ID or ID of the main variation of the item. +
ID of the variation = Sales prices are not inherited from the main variation. +
ID of main variation = Sales prices are inherited from the main variation.

|supplierVariationId
|Variation ID or ID of the main variation of the item. +
ID of the variation = Suppliers are not inherited from the main variation. +
ID of main variation = Suppliers are inherited from the main variation.

|warehouseVariationId
|Variation ID or ID of the main variation of the item. +
ID of the variation = Warehouses are not inherited from the main variation. +
ID of main variation = Warehouses are inherited from the main variation.

|propertyVariationId
|Variation ID or ID of the main variation of the item. +
ID of the variation = Properties are not inherited from the main variation. +
ID of main variation = Properties are inherited from the main variation.
...
|price
|Prices saved for the selected sales price
|====
...
|isPackstation
|Flag defining if a Packstation is used
...
|propertyVariationId
|Variation ID or ID of the main variation of the item. +
ID of the variation = ID of the variation = Properties are not inherited from the main variation. +
...
Use formats of the type *Contacts* to export contact data.
...
|address3
|Field address 3 (default: Additional address information)
...
<<table-fields-delivery-address-option-contacts>> lists the fields available for exporting different types of invoice address options.
