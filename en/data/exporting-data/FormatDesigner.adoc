...
<<tabelle-fields-item>> lists the fields available for exporting item data.
...
<<tabelle-fields-supplier>> lists the fields available for exporting supplier data.
...
<<table-fields-custom-values>>table-fields-custom-values lists the fields available for exporting custom values.
...
<<tabelle-felder-order-accounting-location>> explains the fields that are available for exporting category data.
...
<<tabelle-felder-order-orderparcelservicepreset>> lists the fields available for exporting preset parcel service data.
...
<<tabelle-felder-shipping-packages>> lists the fields available for exporting shipping package data.
...
<<table-fields-orderitem-delivery-adress>> lists the fields available for exporting delivery address data.
