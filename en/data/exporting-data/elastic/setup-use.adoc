...
|*Contact ID*
|By setting an operator and entering a contact ID you determine to which orders the export should be limited. It is always filtered for orders with the entered contact ID. +
...
*≤* = All orders of contacts with an ID lower than the entered one as well as the orders of the contact with this ID are exported. For example, if you enter 12, all orders of contacts with the ID 1 to and including 12 are exported. +
...
*≤* = All orders with an ID lower than the entered one as well as the orders with this ID are exported. For example, if you enter 12, all orders with the ID 1 to and including 12 are exported. +
...
The following filters are available to filter <<stock-management/managing-reorders/working-with-reorders#, reorders>> and <<stock-management/working-with-redistributions#, redistributions>> (purchase orders) before the export:
...
|*Finish date*
|Limits the export to purchase orders that were already completed on a specific date, i.e. for which a finish date was set. After adding this filter, select a specific date or a period of time by using the operators and the date picker.
...
|*Delivery date*
|Limits the export to purchase orders for which a delivery date is set in the order details. After adding this filter, select a specific date or a period of time by using the operators and the date picker.
...
|*Ordered date*
|Limits the export to purchase orders that were already initiated, i.e. for which the order initiated date was set. After adding this filter, select a specific date or a period of time by using the operators and the date picker.
...
The following filters are available to filter order items before the export:
...
*≤* = The order items of all orders with an ID lower than the entered one as well as the order items of the order with this ID are exported. For example, if you enter 12, all order items of the orders with the ID 1 to and including 12 are exported. +
...
*≤* = All order items that correspond to a variation ID lower than the entered one as well as to this ID are exported. For example, if you enter 12, all order items corresponding to variations with the IDs 1 to and including 12 are exported. +
...
The following filters are available to filter the order items of purchase orders before the export:
...
|*Delivery date*
|Limits the export to purchase order items for which a delivery date is set in the order details. After adding this filter, select a specific date or a period of time by using the operators and the date picker.
...
|*Finish date*
|Limits the export to order items of purchase orders that were already completed on a specific date, i.e. for which a finish date was set. After adding this filter, select a specific date or a period of time by using the operators and the date picker.
...
|*Ordered date*
|Limits the export to order items of purchase orders that were already initiated, i.e. for which the order initiated date was set. After adding this filter, select a specific date or a period of time by using the operators and the date picker.
