...
| *Tag (AND mode)*
|Enter one or more tag names. Items that are linked to _all_ of the selected <<item/settings/flags#400, tags>> are exported.

| *Tag (OR mode)*
|Enter one or more tag names. Items that are linked to _at least one_ of the selected <<item/settings/flags#400, tags>> are exported.
