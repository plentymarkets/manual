...
[TIP]
.Plugin set with standard client
====
Install the *Elastic export* plugin and the plugins for the export formats in a plugin set that is linked to the standard client.
====
...
|*BolItemExport*
|Items are sold on the market *bol.com*. This export format is required for your item catalogue to be exported to bol.com. For further information about setting up bol.com in plentymarkets, refer to the <<omni-channel/multi-channel/bol-com, Setting up bol.com>> page of the manual. +
The export format *BolItemExport* is included in the *ElasticExport* plugin.

|*BolOfferExport*
|Items are sold on the market *bol.com*. This export format is required for your offers to be exported to bol.com. For further information about setting up bol.com in plentymarkets, refer to the <<omni-channel/multi-channel/bol-com, Setting up bol.com>> page of the manual. +
The export format *BolOfferExport* is included in the *ElasticExport* plugin.

|*CdiscountCOM*
|Items are sold on the market link:https://marketplace.plentymarkets.com/en/plugins/channels/marketplaces/elasticexportcdiscountcom_4738[Cdiscount^]. For further information about this market, refer to the <<omni-channel/multi-channel/cdiscount, Setting up Cdiscount>> page of the manual.
...
|*KaufluxDE*
|Items are sold on the market link:https://marketplace.plentymarkets.com/en/plugins/markets/ElasticExportKaufluxDE_4737[Kauflux^]. For further information about the image gallery, refer to the <<omni-channel/multi-channel/kauflux, Setting up Kauflux>> page of the manual.
...
|*RakutenDE*
|Items are sold on the market link:https://marketplace.plentymarkets.com/en/plugins/channels/marktplaetze/elasticexportrakutende_4721[Rakuten^]. For further information about setting up Rakuten in plentymarkets, refer to the <<omni-channel/multi-channel/rakuten/rakuten-setup, Setting up Rakuten>> page of the manual.
