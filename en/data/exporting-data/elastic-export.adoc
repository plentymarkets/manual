...
*Transfer:* If you selected the option *FTP* under *Provisioning*, then select an interval for the export. If you select the setting *Schedule*, then select a time frame for the data transfer under *Schedule*.
