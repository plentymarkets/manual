...
:keywords: Export, elastic, Elastic Export, FormatDesigner, Format Designer, export format, export formats, Elastic Export plugin, price comparison, price comparison portal, Data export, Export data, Exporting data
:position: 10
...
This chapter teaches you how to create new export formats and which settings you can carry out. All data formats have to be installed from the link:https://marketplace.plentymarkets.com/en[plentyMarketplace^]{nbsp}icon:external-link[] first. Only the format *BolItemExport* is available straight away.
...
|*Format*
|Select a format for the export from the drop-down list. Only formats that were installed from the plentyMarketplace are available. Exception: The format *BolItemExport* is available straight away.
