...
* Export data from your plentymarkets system. To do so, first use the link:https://marketplace.plentymarkets.com/en/plugins/integration/formatdesigner_6483[FormatDesigner^] to create so-called data formats. In other words, you'll decide which data should be exported. Second, use the link:https://marketplace.plentymarkets.com/en/plugins/channels/marktplaetze/elasticexport_4763[Elastic Export^] to export the data formats that you have just created.
...
====
You have to install the link:https://marketplace.plentymarkets.com/en/plugins/channels/marktplaetze/elasticexport_4763[Elastic Export^] plugin in your plentymarkets system first in order to be able to use the elastic export. The plugin is available in the link:https://marketplace.plentymarkets.com/en[plentyMarketplace^].
====

[#50]
== Creating export formats for interfaces

Use the *Data » Elastic export* menu to create export formats for price search engines, price comparison portals, markets and affiliate service providers in order to export data to the interface partners. In order to use the elastic export, install the link:https://marketplace.plentymarkets.com/en/plugins/channels/marktplaetze/elasticexport_4763[Elastic export^] plugin in your plentymarkets system. The *Elastic export* plugin is available in the link:https://marketplace.plentymarkets.com/en[plentyMarketplace^]. +
...
====
Install the link:https://marketplace.plentymarkets.com/en/plugins/channels/marktplaetze/elasticexport_4763[Elastic Export^] plugin and the plugins for the export formats in a plugin set that is linked to the default client.
====
...
|*KaufluxDE*
|Items are sold on the market link:https://marketplace.plentymarkets.com/en/plugins/markets/ElasticExportKaufluxDE_4737[Kauflux^]. For further information about setting up Kauflux, refer to the <<markets/kauflux#, Setting up Kauflux>> page of the manual.
...
|*RakutenDE*
|Items are sold on the market link:https://marketplace.plentymarkets.com/en/plugins/channels/marktplaetze/elasticexportrakutende_4721[Rakuten^]. For further information about setting up Rakuten, refer to the <<markets/rakuten/rakuten-setup#, Setting up Rakuten>> page of the manual.
