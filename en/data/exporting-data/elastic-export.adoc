...
|*Generate cache file*
|Place a check mark if you want to transfer more than 9,999 data records to the interface. In order to ensure a high performance of the elastic export, do not activate this option for more than 20 export formats.
