...
|*ShippingProfiles*
|Use this format to export shipping profiles.
...
|*Marketplace account*
| Select the marketplace account from the drop-down list. The selected referrer is added to the product URL so that sales can be analysed later.
...
image::basics/data-exchange/assets/elastic-export-toolbar.png[An export format's tool bar]
