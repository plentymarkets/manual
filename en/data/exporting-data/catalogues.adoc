...
:nav-alias: Catalogues: introduction
...
* An introduction to marketplace formats lives on the manual page <<data/exporting-data/market-export#, Catalogues: Marketplace export>>.
