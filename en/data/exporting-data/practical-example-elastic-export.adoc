= Practical example: Elastic Export
:lang: en
include::{includedir}/_header.adoc[]
:keywords: elastic export, item export, elastic, item does not appear, item doesn't appear, error elastic export
:position: 20
...
This practical example deals with the question why items are not included in the elastic export. Often, this is caused by faulty settings. This practical example provides an overview of the settings that you should check in order to detect error sources quickly.
