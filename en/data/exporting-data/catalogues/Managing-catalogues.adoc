...
* *_You want to export plentymarkets data to a document?_*
  ** To do so, you need a catalogue with standard formats. Find out how to create catalogues with standard formats on the <<data/exporting-data/file-export#, Creating standard formats>> page of the manual.
