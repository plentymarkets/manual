...
* In addition to the data fields listed, you can also add your <<data/exporting-data/catalogues#164, own values>> to the export. The same value is then exported for each record.
