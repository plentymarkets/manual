...
|*Warehouse data only*
|Select this filter, if you solely want to export the warehouse data, such as the warehouse ID and the warehouse name. By using this filter, the data of all your warehouses is exported by default. In case you only want to export the data of specific warehouses, additionally select the *Warehouse* filter.
|====
