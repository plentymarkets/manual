...
In order to only export specific stock movement data, you can select filters and thus narrow down the data. How to add filters is described in <<ddata/exporting-data/file-export#filter-data, this chapter>>.
