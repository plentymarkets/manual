...
VAT rates have to be given the exact same names that Xero uses. Go to *System » System settings » Client » Select client » Locations » Select location » Accounting » Tab: VAT rates*. Enter a name behind the VAT rate.
