...
You import eBay listing in the *Data » eBay listings* menu. Both a set of item master data and a listing are created in plentymarkets. The *Processing status* area gives you access to the current status of the process during import. How to import listings is described on the <<markets/ebay/ebay-setup#, eBay>> page of the manual in the <<markets/ebay/ebay-setup#11000, Importing eBay listings>> chapter.
