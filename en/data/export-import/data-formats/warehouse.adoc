...
The data format **Warehouse** serves to export the data that is necessary for the warehouse configuration. Create and export the data format in the **Data » Dynamic export** menu. The <<data/export-import/exporting-data#, Exporting data>> page of the manual describes how you export the data format.
