...
The data format **CreditNote** is used to export credit notes, e.g. for statistical purposes. Create and export the data format in the **Data » Dynamic export** menu. The <<basics/data-exchange/export-import/exporting-data#, Exporting data>> page of the manual describes how you export the data format.
