...
|**Barcode_xxx**
|Barcode +
**__Note__**: The number of the barcode data fields that is displayed here depends on the barcode type that you selected in the **System » System settings » Item » Barcode** menu. Available barcode types: **GTIN 8**, **GTIN 13**, **GTIN 14**, **GTIN 128**, **ISBN**, **QR**, **CODE 128** und **UPC**.
|Activate the filter, select the operator and enter the value.
...
|**Barcode_xxx**
|Barcode, as created in the **System » System settings » Item » Barcode** menu
