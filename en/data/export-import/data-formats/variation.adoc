...
|**UnitID**
|ID of the unit; ID lists are found in the menu **System » System settings » Item » Units**.
|
...
|**VariationAttributes**
|List of the attributes that are linked to the variation; ID list can be found in the menu **System » System settings » Item » Attributes**
|
