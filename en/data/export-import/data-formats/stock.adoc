...
For further information about using the data format **Stock** refer to the <<basics/data-exchange/export-import/exporting-data#90, Exchanging stock data>> chapter on the **Exporting data** page of the manual.
...
|**PriceUnit**
|The item's standard unit. For further information, refer to <<basics/data-exchange/export-import/data-formats/item#, Data format Item>> page of the manual.
|
