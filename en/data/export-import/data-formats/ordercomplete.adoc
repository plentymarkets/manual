...
You can find the country IDs by going to **System » System settings » Orders » Shipping » Settings » Tab: Countries of delivery**.
|
...
|Activate the filter and select the customer class. Do not activate the filter if you want to export data for all customer classes. Go to <<crm/managing-contacts#15, System » System settings » CRM » Customer classes>> to set up customer classes.
|====
