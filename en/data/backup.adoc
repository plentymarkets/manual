...
Use the backup function in the menu **System » Settings » Data » Backup** to reset data in the database to a previous state or restore deleted data.
...
[[table-import-options]].Import options
[cols="1,2"]
|====
...
[[table-backup-types]].Backup types
[cols="1,2"]
|====
...
|**FacetDefinition**|Facets for the search in *System » Client » Settings » Services » Faceted search*.

|**Item**|Item master data, mainly in the *Global* tab

|**ItemAttribute**|Attributes of the items in **System » Item » Attributes**
