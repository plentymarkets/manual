...
Use the backup function in the menu **Setup » Settings » Data » Backup** to reset data in the database to a previous state or restore deleted data.
...
The menu **Setup » Settings » Data » Backup** offers an overview of the existing backups with the corresponding dates. They are automatically created on a daily basis.
...
|**FacetDefinition**|Facets for the search in *Setup » Client » Settings » Services » Faceted search*.

|**Item**|Item master data, mainly in the *Global* tab

|**ItemAttribute**|Attributes of the items in **Setup » Item » Attributes**
