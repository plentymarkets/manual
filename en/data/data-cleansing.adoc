...
This page of the manual describes how to delete certain data records after a certain time period has expired. You determine this time period in the *Setup » Settings » Data » Cleansing* menu.
...
====
Currently, you can automatically delete unassigned addresses, unused contacts, orders, the change history and the IP addresses attached to an order and expired, unconfirmed newsletter subscriptions. Step by step, further areas will be added to this menu.
====

[.instruction]
Entering deletion values:

. Go to *Setup » Settings » Data » Cleansing*.
