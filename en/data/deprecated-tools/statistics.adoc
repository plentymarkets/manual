...
====
The function in the *plentymarkets logo (Start) » Statistics* will not be developed further. You can still see and use the function. However, no new features or extensions will be implemented. We recommend that you use the dashboard. For further information, refer to the <<business-decisions/plenty-bi/myview-dashboard#, Dashboard>> page and the <<business-decisions/plenty-bi#, plentyBI>> section of the manual.
====
