...
* <<processes/work-steps/order-processing#, **Order processing**  >>
* <<processes/work-steps/single-sales-order-processing#, **Single order processing**  >>
* <<processes/work-steps/incoming-items#, **Incoming items**  >>

[.subhead]
Settings
The following table explains the additional settings of the control element: The general settings for control elements are described in <<processes/procedures#480, **table 1** >>. Because input from the user is required, the setting **Destination** is not available for this control element.
...
[.subhead]
Settings
No additional settings are required for this control element. The general settings for control elements are described in <<processes/procedures#480, **table 1** >>. Because the control element ends the work step, the setting **Destination** is not available.
...
[.subhead]
Settings
The following table explains the additional settings of the control element: The general settings for control elements are described in <<processes/procedures#480, **table 1** >>.
...
[.subhead]
Settings
The following table explains the additional settings of the control element: The general settings for control elements are described in <<processes/procedures#480, **table 1** >>. The setting **Destination** is not available for this control element.
...
[.subhead]
Settings
No additional settings are required for this control element. The general settings for control elements are described in <<processes/procedures#480, **table 1** >>.

Learn more about the control element **Jump** in relation to the control element <<processes/procedures#540, **Loop** >> in the following video tutorial:
...
This chapter deals with the procedures that can be configured for processes. Procedures are added to work steps. You can then add <<processes/sub-procedures#, **sub-procedures**  >> to each procedure.
...
|**In case of error**
|Select how to continue the process <<processes/troubleshooting#, **in case of errors**  >>. +
...
[.subhead]
Settings
No additional settings are required for this procedure. The general settings for procedures are described in <<processes/procedures#100, **table 6** >>.
...
[.subhead]
Settings
The following table explains the additional settings for this procedure. The general settings for procedures are described in <<processes/procedures#100, **table 6** >>.
...
[.subhead]
Settings
No additional settings are required for the procedure. The general settings for procedures are described in <<processes/procedures#100, **table 6** >>.
...
[.subhead]
Settings
The following table explains the additional settings for this procedure. The general settings for procedures are described in <<processes/procedures#100, **table 6** >>. The **In case of error** setting is not available for this procedure.
...
[.subhead]
Settings
No additional settings are required for this procedure. The general settings for procedures are described in <<processes/procedures#100, **table 6** >>. The **In case of error** setting is not available for this procedure.
...
* <<processes/sub-procedures#120, **Scan item** >>
* <<processes/sub-procedures#270, **Sounds** >>

[#170]
=== Order

Use the **Order** procedure along with a sub-procedure to <<orders/editing-sales-orders/changing-a-sales-order#, **process orders**  >>. For example, you can change the status of selected orders or scan package numbers.
...
* <<processes/sub-procedures#180, **Print** >>
* <<processes/sub-procedures#280, **Save** >>
* <<processes/sub-procedures#280, **Save to clipboard** >>
* <<processes/sub-procedures#270, **Sounds** >>
...
Use the **Reorder search** procedure to search reorders and book their incoming items using a barcode scanner within the scan reorder sub-procedure. Also pay attention to the <<processes/procedures#450, **Incoming items (reorder)** >> procedure.
...
|**Document**
|Select a document. You can select PDF files that were uploaded in the <<processes/carrying-out-processes#, **CMS » Documents**  >> menu. The option **Employees** must have been selected from the Rights drop-down list for these files.
|====
...
Use the **Finance export** procedure to create a CSV file that can be imported into several <<client-store/standard/accounting#8, **financial accounting solutions** >>. You can choose between two formats: **One data record per stock unit (default)** or **One data record per invoice and VAT rate**. The <<data-exchange/exporting-data#10, **Finance export** >> can be saved with a sub-procedure.
...
The **Credit note** procedure <<orders/fulfillment/generating-credit-notes#, **generates credit notes**  >> for selected orders in the process. They can then e.g. be printed or saved with the corresponding sub-procedure.
...
The **Adjustment form** procedure generates <<client-store/standard/documents/adjustment-form#, **adjustment forms**  >> for selected orders in the process. They can then e.g. be printed or saved with the corresponding sub-procedure.
...
The **Warehouse pick list** procedure generates <<orders/fulfillment/warehouse-pick-list#, **warehouse pick lists**  >> for selected orders in the process. They can then e.g. be printed or saved with the corresponding sub-procedure.
...
Use the **Delivery note** procedure to generate <<orders/fulfillment/generating-delivery-notes#, **delivery notes**  >> for the orders. These delivery notes can be printed or saved with a sub-procedure.
...
Use the **Dunning letter** procedure to generate <<orders/fulfillment/generating-dunning-letters#, **dunning letters**  >> for the orders. These dunning letters can be printed or saved with a sub-procedure.
...
Use the **packing list** procedure to generate a list of picked items prepared for shipping. Use it along with a sub-procedure to print or save the <<orders/fulfillment/packing-list#, **packing list**  >>.
...
Use the **Pick list** procedure along with a sub-procedure to print or save a <<orders/fulfillment/pick-list#, **pick list**  >>. The pick list is generated as part of batch picking. Orders in status **5 Cleared for shipping** and higher will be dealt with. An incoming payment has already been booked for these orders (change from status 3 to 4). In addition, the items are available (change from status 4 to 5).
...
* <<processes/sub-procedures#280, **Save** >>
* <<processes/sub-procedures#350, **Save to clipboard** >>
* <<processes/sub-procedures#245, **Save online** >>
* <<processes/sub-procedures#270, **Sounds** >>
...
With the **polling** procedure, you can create a <<fulfilment/shipping-centre#1400, **polling file** >> in CSV format that you need for particular shipping providers. You can save this file with the Save sub-procedure.
...
Use the **Invoice** procedure to generate <<orders/fulfillment/generating-invoices#, **invoices**  >> for the orders. These invoices can be printed or saved with a sub-procedure.
...
|**Item status**
|Select the item status that should be used by default when a return is created. Go to **<<orders/settings/sales-order-types/return#, Settings » Orders » Order types » Return  >>** to create item statuses for returns.

|**Item value**
|Enter a percentage. This percentage will be applied to returned items. This value will also be displayed once a return has been created. Simply open the **<<orders/editing-sales-orders/return#, return  >>** and click on the **Overview** tab. You will find the value next to the stock units.
...
|**Reason for return**
|Select a reason. Returns will receive this reason when they are first created. Go to **<<orders/settings/sales-order-types/return#, Settings » Orders » Order types » Return  >>** to create reasons for returns.
|====
...
Use the **Return label** procedure along with a sub-procedure to automatically print or save a <<orders/fulfillment/generating-a-return-label#, **return**  >> label.
...
Use the **Return slip** procedure along with a sub-procedure to print or save a return slip automatically. This return slip is attached to the item in case customers might need it for a <<orders/fulfillment/generating-a-return-label#, **return**  >>.
...
Use the **SEPA Pain008 procedure** to export transaction files of your <<payment/managing-bank-details#200, **SEPA direct debits** >> into a ZIP file. Provide your bank with this file after you saved it with a sub-procedure.
...
Use the **Serial numbers** procedure and the <<processes/sub-procedures#260, **Register serial numbers** >> sub-procedure to register items using a barcode scanner during the process. These items will then be assigned the <<item/managing-items#820, **serial numbers** >> of order items and then e.g. booked as outgoing items with another procedure.
...
The **Incoming item (reorder)** procedure books all items of a reorder at once if an order is found during the <<processes/procedures#200, **Order search** >> procedure.
...
The shortcuts that are saved here take priority over the keyboard shortcuts that are saved for the user in the <<working-with-plentymarkets/customise-user-account#50, **user settings** >>. +
