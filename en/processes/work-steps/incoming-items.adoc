...
image::processes/work-steps/assets/EN-ENG-Einstell-Prozesse-Wareneingang-01-SI.png[]
...
image::processes/work-steps/assets/EN-ENG-Einstell-Prozesse-Wareneingang-02-SI.png[]

__Image 2: work step **Incoming items**, opening the **configuration**__

For further information about carrying out this process, refer to the **<<processes/carrying-out-processes#2.4, Carrying out processes >>** page of the manual and its sub-chapter **4.2 Booking single incoming items**.
...
* **<<processes/procedures#460., Single incoming item >>**
* none
