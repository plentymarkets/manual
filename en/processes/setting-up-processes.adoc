...
* **Processes per <<working-with-plentymarkets/manage-users#, role  >>**: here you can see the processes that were assigned to your role. If you were not assigned to any role, then you will not see a folder here. Go to **<<working-with-plentymarkets/manage-users#, Settings » Basic settings » User  >>** to create roles. Users who were assigned to the class <<working-with-plentymarkets/manage-users#, **Admin**  >> will be able to see the processes for all roles.
* **Global processes**: here you can see processes that are available for all users.

[IMPORTANT]
.Visibility of the menu: Settings » Processes
====
**Variable users** will only be able to see the Settings » Processes menu if they were given the right to do so in the user profile. For further information about rights, refer to the **<<working-with-plentymarkets/manage-users#, Managing user accounts  >>** page of the manual.
====

Find out more about creating processes in the following video tutorial:

video::133321620[vimeo]
...
image::processes/assets/EN-Einstell-Prozesse-Prozesse-einrichten-01-SI.png[]

__Image 1: **process** menu and submenus__
...
image::processes/assets/EN-Einstell-Prozesse-Prozesse-einrichten-02-SI.png[]

__Image 2: configuration menu for a new process__
...
<<working-with-plentymarkets/manage-users#, **User**  >> = The process is only visible to a specific user. This user is selected from the **User** drop-down menu below  +
<<working-with-plentymarkets/manage-users#, **Role**  >> = The process is only visible to a specific **role**. This role is selected from the **Role** drop-down menu below

|User
|This option can only be used if you selected **User** for the option **Visibility**. Select which user the corresponding process should be visible for. In other words, you can create processes for yourself as well as for other users. Users who were assigned to the class <<working-with-plentymarkets/manage-users#, **Admin**  >> will also be able to see the process, regardless of which setting is chosen here.
...
__Table 1: new process; settings__

The new process will be displayed in the menu structure after you have saved the settings (image 3).

image::processes/assets/EN-Einstell-Prozesse-Prozesse-einrichten-03-SI.png[]

__Image 3: new process in the **My processes** menu__
...
image::processes/assets/DE-Einstell-Prozesse-ProEinricht-04-SI.png[]

__Image 4: context menu **Export process** and **Copy process**__
...
image::processes/assets/EN-Einstell-Prozesse-Prozesse-einrichten-05-SI.png[]

__Image 5: context menu **Import process**__
...
image::processes/assets/EN-Einstell-Prozesse-Prozesse-einrichten-06-SI.png[]

__Image 6: **Copy process** or **Export process** icons__
...
image::processes/assets/EN-Einstell-Prozesse-Prozesse-einrichten-07-SI.png[]

__Image 7: **context menu**__

=== Adding elements

A process is always based on a <<processes/work-steps#, **work step**  >>. Additional elements can be added to the work step as desired. You can add as many work steps as you wish to a process.

You can add various **elements** to a work step. There are two types of elements: <<processes/procedures#, **control elements**  >> and <<processes/procedures#, **procedures**  >>. You can also add <<processes/sub-procedures#, **sub-procedures**  >> to a procedure. You can always add a subordinate element by pointing your cursor to the superordinate element and clicking on the **green plus icon** (see image 7).

image::processes/assets/EN-Einstell-Prozesse-Prozesse-einrichten-08-SI.png[]

__Image 8: Example: clicking on the **green plus icon** to add a **procedure**__
