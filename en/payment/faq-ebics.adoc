...
You can get all the important information about the link:https://marketplace.plentymarkets.com/en/plugins/payment/ebics_5098[EBICS-Plugin^] in the plentyMarketplace.
