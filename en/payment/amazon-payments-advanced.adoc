...
Your online store needs to have an **<<start/plentymarkets-account/service-center/ssl-certificate#, SSL certificate  >>** in order for you to be able to use Amazon Payments Advanced. Several elements of this payment method are also included in the **CMS**. This makes it necessary to <<cms/web-design/editing-the-web-design#, **publish the design**  >> after configurations or changes have been carried out.
...
Set up and activate the Amazon Payments Advanced **<<payment/managing-payment-methods#20., payment method >>** in the **Settings** tab of the payment method. In addition, check the settings for **Permitted payment methods** in the **<<payment/managing-payment-methods#30., customer classes >>** and for **Blocked payment methods** in the **<<fulfilment/preparing-the-shipment#1000., shipping profiles >>**.
...
Set up an <<orders/settings/event-procedures#, **event procedure**  >> to automatically inform Amazon of cancellations.
