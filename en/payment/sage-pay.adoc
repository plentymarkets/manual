...
With the help of an event procedure you send the **<<payment/sage-pay#110, cancellation >>** to Sage Pay.
...
Set up an <<orders/settings/event-procedures#, **event procedure**  >> to automatically inform Sage Pay of cancellations.
...
If you already received a payment and you want to refund a customer, set up an <<orders/settings/event-procedures#, **event procedure**  >> to automatically send credit notes to Sage Pay.
