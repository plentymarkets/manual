...
Set up and activate the desired <<payment/managing-payment-methods#20, payment methods>> in the *System » System settings » Orders » Payment » Methods* menu in your plentymarkets system.
...
. *Save* the settings.
. Go to *System » System settings » Client » Select client » Online store » Pages*.
