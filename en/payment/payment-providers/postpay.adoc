...
If you already have an link:https://de.allyouneed.com/de/customerlogin.html[Allyouneed.com^] seller contract, you do not need to register again. You can directly begin to <<payment/postpay#30, set up POSTPAY>>.
...
Set up an <<basics/automation/event-procedures#, event procedure>> to automatically send returns to POSTPAY. For further information about creating returns, refer to the <<orders/managing-orders#400, Return>> page of the manual.
