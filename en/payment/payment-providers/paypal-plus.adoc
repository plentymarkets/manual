...
====
In order to display the bank details of PayPal PLUS correctly on your invoice, save a width of 120 millimetres for the payment instruction in the *System » System settings » Client » Select client » Locations » Select location » Documents » Invoice* menu.
====
