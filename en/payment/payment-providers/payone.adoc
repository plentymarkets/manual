...
For PAYONE, a large variety of payment methods is available. Go to <<payment/managing-payment-methods#20, System » System settings » Orders » Payment » Payment methods>> to activate the payment methods.
