...
You need to register with Wirecard before setting up link:https://www.wirecard.at/en/[Wirecard^]{nbsp}icon:external-link[] in plentymarkets. Once you have registered, you will receive the access data that you need to save in plentymarkets.
