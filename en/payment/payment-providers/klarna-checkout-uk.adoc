...
An iframe is used to integrate Klarna Checkout UK directly in plentymarkets. Thus, an <<business-decisions/system-administration/domains#, SSL certificate>> is required for using this payment method.
