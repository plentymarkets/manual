...
[#110]
To refund customers the total purchase amount, create a *Return order*. Set up an <<basics/automation/event-procedures#, event procedure>> to automatically send refunds to Klarna UK. For further information about creating returns, refer to the <<orders/managing-orders#400, Return>> page of the manual.
