...
Proceed as described below to set up the interface to heidelpay for your Callisto online store in plentymarkets. The <<payment/heidelpay#80, Options>> submenu is also used for heidelpay where you save a stylesheet (CSS) for heidelpay.
