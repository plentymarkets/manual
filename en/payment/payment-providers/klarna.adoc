...
*  If the customer <<payment/klarna#100, cancels their order>>, then give it the status *cancelled* as soon as possible so that the shopping cart value will no longer be reserved for the customer.
...
| Select the free text field that was set up for entering the <<
payment/klarna#80, social security number>>. +
