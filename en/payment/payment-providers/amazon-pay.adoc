...
Automate communication with your customers using Amazon Pay as payment methods for their orders. The following chapters list the necessary event procedures to automatically send <<payment/amazon-pay#140, shipping confirmations>>, <<payment/amazon-pay#150, cancellations>> as well as for processing <<payment/amazon-pay#160, refunds>> and reporting <<payment/amazon-pay#170, rejected payments>>.
