...
:position: 80
:url: payment/payment-providers/upg
:id: 34EYYS7
...
link:http://www.upgplc.com/[UPG^]{nbsp}icon:external-link[] is a fully integrated payment solution for e-commerce offered by Creditreform.
...
Register with UPG before you carry out the relevant settings in plentymarkets. To do so, link:http://www.upgplc.com/services/online-payments/[contact^]{nbsp}icon:external-link[] UPG.
...
You need to confirm UPG that you have sent the items to your customer before you will receive the customers payment from UPG. Set up an <<automation/event-procedures#, event procedure>> to automatically send shipping confirmations when the outgoing items are booked.
...
Set up an <<automation/event-procedures#, event procedure>> to automatically inform UPG of cancellations.
