...
:position: 170
:url: payment/payment-providers/payolution
:id: C5RTU4M
...
link:https://payolution.com/merchant/en/[Payolution^]{nbsp}icon:external-link[] offers you and your customers many advantages and possibilities with the payment methods *invoice* and *instalments*. In your plentymarkets system, the payment method invoice is called *Payolution Invoice*. Instalment purchase is called *Payolution Ins* in plentymarkets.
...
[#30]
=== SSL certificateYou need to have an <<business-decisions/system-administration/domains#, SSL certificate>> in order to correctly use the payment method.
...
Contact link:https://payolution.com/merchant/en/[Payolution^]{nbsp}icon:external-link[] to register and set up an account. You will receive the access data that you need for setting up Payolution in plentymarkets.
