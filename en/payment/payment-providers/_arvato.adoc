...
link:https://www.arvato.com/finance/en.html[arvato Financial Solutions^] is a financial solutions provider with sector-specific solutions in the areas <<payment/_arvato#10, debt collection>> and <<payment/_arvato#40, credit rating>>. On this page, you will find detailed information setting up arvato and arvato infoscore in plentymarkets.
...
. Go to *System » System settings » Orders » Debt collection » arvato*.
...
. Go to *System » System settings » Orders » Credit rating » arvato infoscore*.
