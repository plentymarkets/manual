...
The entry *PayPal import* with the PayPal icon in the navigation on the left is only displayed when the <<payment/payment-plugins/paypal#, PayPal plugin>> is installed. To use this function, you need at least version 6.0 of the PayPal plugin. +
