...
With the plugin Invoice, you integrate the payment method *Invoice* in your online shop and make it available to your customers. To do so, download the plugin Pay upon pickup from the link:https://marketplace.plentymarkets.com/en/invoice_4760[plentyMarketplace^]{nbsp}icon:external-link[]. Setup of the payment method is done with an assistant. You also have to carry out a few basic settings in your plentymarkets system so that the payment method is activated in your system. +
