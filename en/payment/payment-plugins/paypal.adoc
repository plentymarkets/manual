...
With the plugin PayPal, you integrate the PayPal payment methods in your online shop and make them available to your customers. To do so, download the PayPal plugin from the link:https://marketplace.plentymarkets.com/en/payone_5434[plentyMarketplace^]{nbsp}icon:external-link[]. Setup of the payment method is done with an assistant. You also have to carry out a few basic settings in your plentymarkets system so that the payment methods are activated in your system. +
...
| *Event*
| <strong>Select the event that will trigger a refund.</strong>
|
...
| *Procedure*
| <strong>Plugin &gt; Refunding a PayPal payment</strong>
|
