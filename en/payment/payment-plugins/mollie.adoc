...
With the plugin Mollie, you integrate the Mollie payment methods in your online shop and make them available to your customers. To do so, download the Mollie plugin from the link:https://marketplace.plentymarkets.com/en/mollie_6272[plentyMarketplace^]{nbsp}icon:external-link[]. Setup of the payment method is done with an assistant. You also have to carry out a few basic settings in your plentymarkets system so that the payment method is activated in your system. +
