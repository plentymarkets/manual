...
With the Klarna plugin, you integrate the Klarna payment methods in your online shop and make them available to your customers. To do so, download the Klarna plugin from the link:https://marketplace.plentymarkets.com/en/klarna_6731[plentyMarketplace^]{nbsp}icon:external-link[]. You also have to carry out a few basic settings in your plentymarkets system so that the payment methods are activated in your system. +
