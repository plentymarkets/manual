...
Already existing accounts can be easily <<#200, migrated>> to the plugin.

[#250]
=== Payments are not retrieved. What can I do?

Check whether the interim transaction report and the daily account statements are using the correct formatting. Formatting can be adjusted in the <<#130, account settings>>. +
