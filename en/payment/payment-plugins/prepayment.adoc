...
With the plugin Cash in advance, you integrate the payment method Cash in advance in your online shop and make them available to your customers. To do so, download the Cash in advance plugin from the https://marketplace.plentymarkets.com/en/prepayment_4758[plentyMarketplace^]{nbsp}icon:external-link[]. Setup of the payment method is done with an assistant. You also have to carry out a few basic settings in your plentymarkets system so that the payment method is activated in your system. +
...
:payment-method-name: Cash in advance
