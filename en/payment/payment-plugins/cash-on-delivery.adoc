...
:keywords: payment method, payment plugin, cash on delivery, cash-on-delivery, payment, paying, payment integration, setting up cash on delivery, setup cash on delivery, paying after delivery
