...
:keywords: payment method, payment plugin, cash on delivery, cash-on-delivery, payment, paying, payment integration
...
Activate the payment method once in your system.
