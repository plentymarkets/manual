...
With the plugin Debit, you integrate the payment method *Debit* in your online shop and make it available to your customers. To do so, download the debit plugin from the link:https://marketplace.plentymarkets.com/en/debit_6362[plentyMarketplace^]{nbsp}icon:external-link[]. Setup of the payment method is done with an assistant. You also have to carry out a few basic settings in your plentymarkets system so that the payment method is activated in your system. +
