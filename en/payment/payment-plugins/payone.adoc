...
The containers needed by default are automatically linked to your online shop during the set-up with the Payone assistant. In the Plugin settings of the Payone plugin, template containers can also be set manually, if required. To do so, proceed as follows.
