...
In case a selected payment method is rejected or doesn't work, your customers can change the payment method in the checkout. They can choose between all available payment methods except Amazon Pay.
