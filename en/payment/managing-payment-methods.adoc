...
On this page, you will find detailed information setting up payment methods. You also find an overview of all non-contract payment methods, e.g. **invoice** or **cash in advance**, as well as related information about these payment methods. Learn how to set up the interfaces for payment methods and payment providers on an individual page for each payment method and provider. Find these pages in the **<<payment#, Payment  >>** topic of the manual. Finally, you will find an overview of market payment methods. For a detailed description on how to activate market payment methods, refer to the pages of the corresponding **<<multi-channel#, markets  >>**.
...
For further information, refer to the **<<start/statistics#, Statistics  >>** and **<<start/statistics/general-statistics/item/tops-flops#, Tops/Flops  >>** pages of the manual. +
...
====
We generally recommend that you use <<start/plentymarkets-account/service-center/ssl-certificate#, **SSL encryption**  >> for your online store if you work with payment data and customer data. This is required for payment methods that work with an iframe.
====
...
|**Invoice**
|With this payment method, the customer can order an item via invoice. Payment is made after the item has been received. To pay for the item, the customer receives an **<<client-store/standard/documents/invoice#, invoice document  >>** with the bank details of the seller. Incoming payments have to be **<<payment/managing-payments#30, imported >>** and assigned to orders in the plentymarkets system. You can offer a payment method globally or for **<<crm/managing-customer-data#800, certain customers only >>**. For further information about this payment method, refer to **<<payment/managing-payment-methods#55, Carrying out settings for the purchase on invoice >>**.
...
Some payment methods require items to be shipped before the payment was received, e.g. with payment on invoice. If the **<<stock-management/managing-stocks#, stock  >>** is limited to net stock, then the system will check whether stock is available and will set the corresponding order in status 4 or 5. To solve this, go to **<<orders/settings/basic-settings#, Settings » Orders » Basic settings  >>** and select **YES** for the option **Status changes to 4 instead of 5 if stock is missing**. If there is no limitation set up for the stock, then the order will be placed directly in status 5.
...
|**Allyouneed Payments**
|Payment method for orders that are imported into your plentymarkets system from Allyouneed. Activate the **<<multi-channel/allyouneed#100, Allyouneed Payments >>** payment method.

|**Amazon**
|Payment method for orders that are imported into your plentymarkets system from Amazon. Activate the **<<multi-channel/amazon#4500, Amazon >>** payment method.

|**Cdiscount**
|Payment method for orders that are imported into your plentymarkets system from Cdiscount. Activate the **<<multi-channel/cdiscount#90, Cdiscount >>** payment method.

|**DaWanda**
|Payment method for orders that are imported into your plentymarkets system from DaWanda. Activate the **<<multi-channel/dawanda#70, DaWanda >>** payment method.

|**eBay purchase on invoice**
|Payment method for purchase on invoice on eBay. Activate the <<multi-channel/ebay#2250, **eBay purchase on invoice** >> payment method.

|**Flubit**
|Payment method for orders that are imported into your plentymarkets system from Flubit. Activate the **<<multi-channel/flubit#, Flubit  >>** payment method.

|**Fruugo**
|Payment method for orders that are imported into your plentymarkets system from Fruugo. Activate the **<<multi-channel/fruugo#60, Fruugo >>** payment method.

|**GartenXXL.de**
|Payment method for the GartenXXL.de market. Activate the <<multi-channel/plus-gartenxxl#40, **GartenXXL.de** >> payment method.

|**real.de payment**
|Payment method for the real.de market. Activate the <<multi-channel/real-de#80, **Hitmeister** >> payment method.

|**La Redoute Payment**
|Payment method for orders that are imported into your plentymarkets system from La Redoute. Activate the **<<multi-channel/laredoute#100, La Redoute Payment >>** payment method.

|**Neckermann payment**
|Payment method for the Neckermann.at market. Activate the <<multi-channel/neckermann-at#160, **Neckermann.at** >> payment method.

|**Otto payment**
|Payment method for the Otto market. Activate the <<multi-channel/otto#30, **OTTO** >> payment method.

|**PIXmania payment**
|Payment method for the PIXmania market. Activate the <<multi-channel/pixmania#80, **PIXmania** >> payment method.

|**Plus.de Payment**
|Payment method for the Plus.de market. Activate the <<multi-channel/plus-gartenxxl#40, **Plus.de** >> payment method.

|**Rakuten**
|Payment method for the Rakuten market. Activate the <<multi-channel/rakuten#150, **Rakuten** >> payment method.

|**Shopgate payment**
|Payment method for the Shopgate market. Activate the <<multi-channel/shopgate#60, **Shopgate** >> payment method.

|**Yatego invoice**
|Payment method for the Yatego market. Activate the <<multi-channel/yatego#80, **Yatego invoice** >> payment method.

|**Zalando payment**
|Payment method for the Zalando market. Activate the <<multi-channel/zalando#80, **Zalando payment** >> payment method.
|====
