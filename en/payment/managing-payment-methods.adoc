...
:id: MVDQHNC
:keywords: payment, payment method, Callisto, ceres, plugins, plentymarketplace, marketplace, plenty-marketplace, non-contract, active, inactive, customer classes, country of delivery, client, info page, priority, costs, flat rate, percentage, domestic, foreign country, surcharge, amount, total, discount, SSL, valuta, pay upon pickup, cash sale, cash card, credit card, debit, cash on delivery, invoice, cash in advance, bank details, guest accounts, rounding, rounding differences, stock, quantity, price, quantity, rounded price, transaction
:author: team-order-payment

[IMPORTANT]
.Setting up payment methods for Callisto stores
====
This page only contains instructions for setting up payment integrations for Callisto stores. For Ceres stores, payment methods are integrated via plugins. To access the available payment plugins as well as instructions on how to install them, visit the payment section in the link:https://marketplace.plentymarkets.com/en/plugins/payment[plentyMarketplace^]{nbsp}icon:external-link[].
====

On this page, you will find detailed information on how to set up payment methods. You also find an overview of all non-contract payment methods, e.g. *invoice* or *cash in advance*, as well as related information about these payment methods. Learn how to set up the interfaces for payment methods and payment providers on an individual page for each payment method and provider. Find these pages in the <<payment#, Payment>> topic of the manual. Finally, you will find an overview of market payment methods. For a detailed description on how to activate market payment methods, refer to the pages of the corresponding <<markets#, markets>>.
...
.  Carry out the settings as desired. Pay attention to the explanations given in <<table-settings-payment-method>>.
...
Click on *Upload files* and select the logo that you want to upload for the payment method. Permitted data formats: GIF, PNG, JPG. Maximum size: 100 x 25 pixels.
...
For further information, refer to the <<basics/statistics#, Statistics>>  page of the manual. +
...
|*Cash sale / cash card*
|Use the *Cash sale / cash card* payment method, e.g. with your plentyPOS system in your stationary retail store, enabling your customers to pay cash or with cash card. Incoming payments will be transmitted from the cash card terminal or the POS system to your plentymarkets back end.
...
|*Invoice*
|With this payment method, the customer can order an item via invoice. Payment is made after the item has been received. To pay for the item, the customer receives an invoice document with the bank details of the seller. Incoming payments have to be <<payment/managing-payments#30, imported>> and assigned to orders in the plentymarkets system. You can offer a payment method globally or for <<crm/managing-contacts#300, certain customers only>>.  For further information about this payment method, refer to <<payment/managing-payment-methods#55, Carrying out settings for the purchase on invoice>>.
...
.Advanced settings
====
Note that the following requirements must be met in order to use the advanced settings for purchase on invoice:

* Use of the standard design Callisto (Version 3.5 or higher)
* Use of the plentymarkets CMS tools (Version 1.0.18 or higher)
...
. Expand the client.
. Carry out the settings as desired. Pay attention to the explanations given in <<table-settings-payment-method-invoice>>.
. *Save* the settings.
...
|Enter the amount that must not be exceeded when purchasing on invoice.
...
|*Check24*
|Payment method for market Check24. Activate the <<markets/check24#, Check24>> payment method.
...
|*GartenXXL.at*
|Payment method for the GartenXXL.at market. Activate the <<markets/plus-gartenxxl#400, GartenXXL.at>> payment method.

|*GartenXXL.de*
|Payment method for the GartenXXL.de market. Activate the <<markets/plus-gartenxxl#400, GartenXXL.de>> payment method.

|*idealo Checkout*
|Payment method for the market idealo Direktkauf. Activate the <<markets/idealo-checkout/idealo-setup#650, idealo Checkout>> payment method.
...
|*OTTO Direktversand*
|Payment method for the OTTO Direktversand interface. Activate the <<markets/otto#, OTTO Direktversand>> payment method.

|*Otto Payment*
|Payment method for the OTTO Cooperation and OTTO Integration interfaces. Activate the <<markets/otto#, OTTO Payment>> payment method.

|*PIXmania Payment*
|Payment method for the PIXmania market. Activate the <<markets/pixmania#800, PIXmania>> payment method.

|*Rakuten*
|Payment method for the Rakuten market. Activate the <<markets/rakuten/rakuten-setup#1500, Rakuten>> payment method.
...
In this case, the total difference is 1 cent. If only the first item was counted, then the difference would be 2 cents. If only the second item was counted, then the difference would be 4 cents.
