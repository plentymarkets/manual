...
:id: JJC5DHB
:keywords: payments, receiving payments, payment source, incoming payments, payment provider, assigning payments, automatic assignment, amount, pay, paying, total, booking, customer bank data, bank details, transactions, bank postings, cash in advance, account, CSV, CSV format, CSV-format, bank account, default account, credit, debit, currency, exchange, rate, overpaid, overpaying, designated use, non-bookable, non bookable, non-bookable payments, interim transaction report, planned payment, EBICS, group function, removing assignments, account holder, transaction type, ID, total, paid, pending, split payment, splitting payments, partial payments, overpaid payments
...
*_Note:_* This functionality only applies to the PayPal interface for Callisto online stores in plentymarkets, *not* for the PayPal plugin!
