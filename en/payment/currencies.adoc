...
If you run your online store using the link:https://marketplace.plentymarkets.com/en/plugins/templates/Ceres_4697[Ceres plugin] in plentymarkets, the <<omni-channel/online-store/setting-up-ceres#201, Ceres online store>> page of the manual provides information on all necessary currency settings.
