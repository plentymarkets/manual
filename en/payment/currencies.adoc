...
====
This setting is not necessarily identical to the currency displayed in your online store. You can define a different standard currency for each online store and each language. Further information on these settings are provided on the manual page <<online-store/setting/setting-up-ceres#201, Carrying out currency settings>>. This page deals directly with setting up Ceres.
====
