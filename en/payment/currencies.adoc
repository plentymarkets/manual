...
Go to <<item/managing-items#870, *Setup » Item » Sales prices*>> and activate the option *Currency: Live conversion* to determine if the currency conversion in the online store is carried out automatically. +
