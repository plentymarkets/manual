...
**link:https://www.arvato.com/finance/en.html[arvato Financial Solutions, window="_blank"]** is a financial solutions provider with sector-specific solutions in the areas **<<payment/arvato#10, debt collection >>** and **<<payment/arvato#40, credit rating >>**. On this page, you will find detailed information setting up arvato and arvato infoscore in plentymarkets.
...
. Go to **Settings » Orders » Debt collection service provider » arvato**.
...
. Go to **Settings » Orders » Credit rating » arvato infoscore**.
