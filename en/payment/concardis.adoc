...
**link:https://www.concardis.com/de-en[ConCardis, window="_blank"]** is a joint venture of the German bank industry and a payment provider for cashless payment. ConCardis provides products and services in Germany, Austria, the Benelux and Switzerland and is expanding into additional European countries.
...
The ConCardis link:https://www.concardis.com/de-en/support[**customer service**, window="_blank"] provides you with further information about the services and prices offered by ConCardis. Register with ConCardis before you carry out the relevant settings in plentymarkets.
