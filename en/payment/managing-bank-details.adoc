...
Go to *System » Orders » Documents* and click on the *SEPA direct debit mandate* submenu. There is a template for configuring the SEPA direct debit mandate. For further information about documents, refer to the <<orders/order-documents#, Document templates>> page of the manual.
