...
On this page of the manual, you learn how to save your **<<payment/managing-bank-details#10, own bank details >>** and your **<<payment/managing-bank-details#63, customers' bank details >>**, how to make your bank details **<<payment/managing-bank-details#20, visible in the online store >>** and how to set up **<<payment/managing-bank-details#70, EBICS >>** and **<<payment/managing-bank-details#200, SEPA >>**.
...
image::payment/assets/EN--Bank-details-Order-process.png[]
[#50]
...
**__Important__**: This option needs to be activated before pain.008 formats can be retrieved for <<payment/managing-bank-details#250, **SEPA payments** >>.
...
When setting up your accounts for EBICS, you create one or more **<<working-with-plentymarkets/manage-users#10, users >>** for your accounts. EBICS users are called participants (German: Teilnehmer). You can create participants including different order types. One of these participants has to be saved in the plentymarkets system with the **participant ID** that you received from your bank.
...
image::payment/assets/EN-Bank-Details-EBICS-New-account.png[]
[.instruction]
Adding a new EBICS account:
...
.Domain transfer
====
Save the basic settings again after carrying out a **<<start/plentymarkets-account/service-center/domain#, domain transfer  >>**. This will update the EBICS data.
====
...
**__Important__**: A **<<payment/managing-bank-details#4, SOAP account >>** must be created before the status can be retrieved.
...
**__Important__**: You have to activate the statement of account in order for interim transaction reports to be confirmed. For further information, refer to **<<payment/managing-bank-details#190, Retrieval times >>**.
...
Go to **Settings » Orders » Documents** and click on the **SEPA direct debit mandate** submenu. There is a template for configuring the SEPA direct debit mandate. For further information about documents, refer to the **<<orders/settings/documents#, Document templates  >>** page of the manual.
...
image::payment/assets/EN-Bank-details-SEPA-Template.png[]
[.instruction]
Creating an email template:
...
The email template is sent with an **<<orders/settings/event-procedures#, event procedure  >>**. The event procedure is triggered, e.g. whenever a new order is received.
...
For further information about bank details, refer to the **<<payment/managing-bank-details#63, Saving the customer's bank details >>** chapter.
...
image::payment/assets/EN-Bank-details-SEPA-Order-history.png[]
[#270]
=== Automating SEPA payments with the Client

Use the plentymarkets Client to set up processes to automate your SEPA payments. Go to **Settings » Processes** and use the procedures <<processes/procedures#400, **SEPA Pain001** >> and <<processes/procedures#410, **SEPA Pain008** >>.
