...
Set up processes to automate your SEPA payments. Go to *System » Processes* and use the procedures <<automation/processes/procedures#400, SEPA Pain001>> and <<automation/processes/procedures#410, SEPA Pain008>>.
