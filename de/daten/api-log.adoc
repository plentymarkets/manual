...
Wenn die Prüfung fehlgeschlagen ist, enthält die Response einen Fehler. Für den Kunden werden bei einem Fehler die Einstellungen für ein negatives Bonitätsergebnis, <<payment/atriga#, rote Bonität>>, verwendet.
|====
...
In diesem Kapitel finden Sie alle Einträge, die im Zusammenhang mit der Nutzung des Abrufes der <<payment/paypal#80, PayPal-Abrechnungsberichte>> im Log aufgeführt werden können.
