...
Der Datenformat-Creator *accounts* exportiert die im System vorhandenen Firmendaten gemäß der im Folgenden definierten Regeln und speichert diese im Cloud-Speicher ab.

== Technische Spezifikationen

<<tabelle-spezifikationen-accounts>> erläutert die verfügbaren Eigenschaften und die dazugehörigen Werte.
...
<<tabelle-datenspalten-accounts>> erläutert die Datenspalten des Formats *accounts*, die beim Export der Rohdaten in der CSV-Datei gespeichert werden.
