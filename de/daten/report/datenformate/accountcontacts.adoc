...
//Rückfrage: es wird laut GoogleDoc hier gar kein Prefix erstellt, warum wird er hier angegeben?
...
//@Rückfrage: hier sollte Jan nochmal schauen, ob das sachlich richtig ist.
...
//TODO Wertebereich -5 bis plus 5
