...
Der Datenformat-Creator *orderItemProperties* exportiert Daten zu den Eigenschaften der im System vorhandenen Auftragspositionen und speichert diese im Cloud-Speicher ab.
...
<<tabelle-datenspalten-orderitem-properties>> erläutert die verfügbaren Eigenschaften und die dazugehörigen Werte.
...
1 = Variante +
2 = Artikelpaket +
3 = Einzelner Bestandteil eines Artikelpakets +
4 = Aktionsgutschein +
5 = Gutschein +
6 = Versandkosten +
7 = Aufpreis (abhängig von der Zahlungsart) +
8 = Geschenkverpackung
9 = Nicht zugeordnete Variante +
10 = Anzahlung +
11 = Auftrag (z.B. bei Sammelaufträgen)
