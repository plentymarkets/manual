...
|**FacetDefinition**
|Facetten für die Suche unter *Einrichtung » Mandant » Global » Dienste » Facettensuche*

|**Item**
|Artikelstammdaten, vorwiegend im Tab *Global*

|**ItemAttribute**
|Attribute der Artikel unter **Einrichtung » Artikel » Attribute**
...
. Gehe zu *Einrichtung » Einstellungen » Daten » Backup*.
