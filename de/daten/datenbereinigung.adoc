...
Alle Änderungen, die im Menü *Einrichtung » Einstellungen » Daten » Bereinigung* vorgenommen werden, werden im Menü *Daten » Log* für 30 Tage gespeichert. So kannst du einsehen, welches Teammitglied wann den alten Wert in den neuen Wert geändert hat.
