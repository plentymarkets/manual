...
. Aktiviere im Bereich *Berechtigungen* die Optionen *Daten > Datenbereinigung > Datenbereinigung anzeigen* und *Daten > Datenbereinigung > Datenbereinigung bearbeiten*.
