...
Mit dem Sync-Typ *Fahrzeugverwendungsliste* erstellst, aktualisierst, oder löscht du im Menü *Daten » ElasticSync* vollständige Fahrzeugverwendungslisten oder einzelne Datensätze aus den Fahrzeugverwendungslisten. +
