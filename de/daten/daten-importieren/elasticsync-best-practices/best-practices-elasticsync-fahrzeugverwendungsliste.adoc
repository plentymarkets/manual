...
Mit dem Sync-Typ *Fahrzeugverwendungsliste* erstellst, aktualisierst, oder löschst du im Menü *Daten » Import* vollständige Fahrzeugverwendungslisten oder einzelne Datensätze aus den Fahrzeugverwendungslisten. +
