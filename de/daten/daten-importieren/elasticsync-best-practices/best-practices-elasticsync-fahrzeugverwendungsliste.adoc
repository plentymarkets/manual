...
Mit dem Sync-Typ *Fahrzeugverwendungsliste* erstellst, aktualisierst, oder löschst du im Menü *Daten » ElasticSync* vollständige Fahrzeugverwendungslisten oder einzelne Datensätze aus den Fahrzeugverwendungslisten. +
...
* *Pflichtfelder* für die Erstellung einer Fahrzeugverwendungsliste mit ElasticSync:
  - Name
  - Herkunfts-ID
  - Kategorie-ID
