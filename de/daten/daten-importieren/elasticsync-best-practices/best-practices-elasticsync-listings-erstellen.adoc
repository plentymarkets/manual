...
Auf dieser Seite erklären wir dir, wie du mit ElasticSync Listings für eBay erstellen kannst. +
...
Um mit ElasticSync Listings in plentymarkets zu erstellen, benötigst du zunächst eine CSV-Datei. Dazu erstellst du mit dem dynamischen Export im Menü *Daten » Dynamischer Export* ein Datenformat des Typs *ItemListingMarketeBay*, *ItemListingMarketHood* oder *ItemListingMarketRicardo*, je nachdem, für welchen Marktplatz du die Listings erstellen möchtest.

Um ein Market-Listing inklusive Listing zu erstellen, muss die CSV-Datei mindestens folgende Felder enthalten:
...
== Listings mit ElasticSync in plentymarkets erstellen

Mit ElasticSync im Menü *Daten » ElasticSync* kannst du nun die CSV-Datei mit den neuen Listings in dein plentymarkets System importieren. Dazu erstellst du einen Sync des Typs Market-Listing.
...
. Klicke auf *Sync starten*, um die Listings in plentymarkets zu importieren.
