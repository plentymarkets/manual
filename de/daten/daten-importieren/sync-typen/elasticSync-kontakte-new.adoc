...
icon:warning[role="red"] [red]#Pflichtwert#, wenn Eigenschaften aktualisiert werden sollen
...
icon:warning[role="red"] [red]#Pflichtwert#, wenn du Eigenschaften zu einem bestimmten Kontakt aktualisieren möchtest
