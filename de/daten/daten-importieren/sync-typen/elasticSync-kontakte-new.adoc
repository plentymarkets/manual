...
// geprüft!
//darf das nicht nur möglich für alten Webshop Callisto sein? Funktioniert jedenfalls beim Testen im System 40650.
...
// geprüft! aber: siehe unten

Soll der Kontakt einer Kundenklasse zugeordnet werden?


// Stimmt der Text in der Info-Box?
...
// wo wird das angezeigt? oder ist der Mandant gemeint im Kontaktdatensatz?
...
// nochmal mit Asad sprechen, was man hier erklären muss/sollte
...
// Beschreibung fehlt noch UND man kann es auch für Ceres-Gäste machen. Hat funktioniert beim Testen
...
Das Ergebnis des Imports findest du im Backend im Menü <<crm/kontakte-verwalten#300, CRM » Kontakte » Kontakt öffnen » Bereich: xx>>.
...
// hier wird immer in die Rechnungsadresse importiert, die die höchste ID hat?
...
// hier wurde beim Import eine neue Adresse angelegt... Warum?
...
// das hat nicht funktioniert.  ich wollte in der Firma den Eigner auf ID 8 = AsadH ändern. Die Änderung wurde nicht übernommen.
