...
////
TODO: Einheitliche Weise finden, um Pflichtfelder für die Zuordnung zu dokumentieren
////
...
|*Paket-ID*
////
TODO: Weiter rumfragen, was mit dieser mysteriösen Paket-ID gemeint ist.
////
...
////
TODO: Hier müssten die Importoptionen noch beschrieben werden, da sie in derselben View auftauchen.
////
