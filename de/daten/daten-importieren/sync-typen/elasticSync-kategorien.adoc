...
Diese Seite erläutert die Abgleich- und Zuordnungsfelder, die dir beim Importieren von Kategorien zur Verfügung stehen. Diese Seite dient lediglich als Referenz und setzt voraus, dass du bereits Grundkenntnisse über das <<daten/daten-importieren/ElasticSync#, Import-Tool>> hast.
...
In diesem Kapitel werden Felder erläutert, die für die Zuordnung von Kategoriedaten zur Verfügung stehen.
...
Möchtest du die Kategorien löschen?
