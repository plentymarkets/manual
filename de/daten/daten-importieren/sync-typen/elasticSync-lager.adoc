...
Gib die Position des Lagerorts in deine CSV-Datei ein. Die Position wird beispielsweise für den Laufweg beim Picken von Ware benötigt.
...
Das Ergebnis des Imports findest du im Backend im Menü <<warenwirtschaft/lager-einrichten#intable-notizen, Einrichtung » Waren » Lager » _Lager wählen_ » Lagerorte » _Lagerort wählen_>>.
