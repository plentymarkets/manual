...
Mit einem Sync des Typs *Lager* importierst du neue Lagerorte oder aktualisierst bestehende. Um Lagerorte per ElasticSync zu erstellen oder zu aktualisieren, musst du ein Lager angelegt haben. +
...
|Yes +
 No
a|Löschfunktion für den Lagerort +

* Yes = Lagerort löschen +
* No = Lagerort nicht löschen

3+^| *Ebenen der Lagerorte*
