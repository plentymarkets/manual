...
Das Ergebnis des Imports findest du im Backend im Menü *Einstellungen » Waren » Lager » _Lager wählen_ » Lagerorte*.
...
Das Ergebnis des Imports findest du im Backend im Menü *Einrichtung » Waren » Lager » _Lager wählen_ » Lagerorte*.
...
Das Ergebnis des Imports findest du im Backend im Menü <<warenwirtschaft/lager-einrichten#intable-zweck, Einrichtung » Waren » Lager » _Lager wählen_ » Lagerorte>>.
...
Das Ergebnis des Imports findest du im Backend im Menü <<warenwirtschaft/lager-einrichten#intable-status, Einrichtung » Waren » Lager » _Lager wählen_ » Lagerorte>>.
...
Gib die Position des Lagerorts in deine CSV-Datei ein. Diese Position wird beispielsweise für den Laufweg beim Picken von Ware benötigt.
...
Gib je nach Artikelgröße den Lagerorttyp in deine CSV-Datei ein.
...
Gib Notizen zum Lagerort in deiner CSV-Datei ein.

*_Standardwert_*: Kein Standardwert

*_Zulässige Importwerte_*: Alphanumerisch

Das Ergebnis des Imports findest du im Backend im Menü <<warenwirtschaft/lager-einrichten#intable-notizen, Einrichtung » Waren » Lager » _Lager wählen_ » Lagerorte>>.
