...
|1 = unbeschränkt (mit Abgleich) +
2 = beschränkt (mit Reservierung) +
3 = beschränkt (ohne Reservierung) +
4 = unbeschränkt (ohne Abgleich)
...
|Y = Ja +
N = Nein
|Gibt an, ob der Endloslister verwendet wird.
...
|0 = deaktiviert +
1-8 = Anzahl
|eBay-Endloslister, die maximale Anzahl aktiver Listings.
