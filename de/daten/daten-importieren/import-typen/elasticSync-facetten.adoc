...
:keywords: ElasticSync, Import, Datenimport, Daten-Import, Sync-Typ, Sync, Filter, Filters, Filtern, Suchfilter, Such-Filter, Filtersuche, Filter-Suche, Facette, Facetten, Facettensuche, Webshopsuche, Suche, Frontend, Webshop, Artikelsuche, Ceres, Shop, Online-Shop, Frontend-Suche, Frontendsuche, Frontend-Artikelsuche
:position: 50
...
Wo soll der Filter im Webshop erscheinen? Also welcher Filter soll als erstes, zweites, drittes usw. angezeigt werden?
...
Hast du z.B. den Filter "Markenname", dann könntest du die einzelnen Marken alphabetisch sortieren.
