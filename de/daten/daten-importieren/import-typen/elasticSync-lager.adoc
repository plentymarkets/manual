...
Das Ergebnis des Imports findest du im Backend im Menü <<warenwirtschaft/lager-einrichten#1500, Einrichtung » Waren » Lager » _Lager wählen_ » Lagerorte>>.
...
Das Ergebnis des Imports findest du im Backend im Menü <<warenwirtschaft/lager-einrichten#100, Einrichtung » Waren » Lager » _Lager wählen_ » Lagerorte>>.
