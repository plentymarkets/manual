...
Das Ergebnis des Imports findest du im Backend im Menü *Aufträge » Aufträge bearbeiten » _Auftrag öffnen_ » Tab: Einstellungen » Feld: Status* sowie in der Auftragsübersicht.
...
Das Ergebnis des Imports findest du im Backend im Menü *Aufträge » Aufträge bearbeiten » _Auftrag öffnen_ » Tab: Einstellungen » Feld: Eigner* sowie in der Auftragsübersicht.
...
Das Ergebnis des Imports findest du im Backend in der Auftragsübesicht im Menü *Aufträge » Aufträge bearbeiten*. *GENAUER????*
...
Es wird standardmäßig davon ausgegangen, dass der Name in der Systemsprache eingegeben wird. Namen für Artikel vergibst du im Menü *Artikel » Artikel bearbeiten » _Artikel öffnen_ » Artikeltab: Texte » Feld: Name*.

*_Standardwert_*: Kein Standardwert

*_Zulässige Importwerte_*: Alphanumerisch

Das Ergebnis des Imports findest du im Backend im Menü *Aufträge » Aufträge bearbeiten » _Auftrag öffnen_ » Tab: Übersicht* in der *Artikelpositionstabelle* sowie in der Auftragsübersicht.
...
Das Ergebnis des Imports findest du im Backend im Menü *Aufträge » Aufträge bearbeiten » _Auftrag öffnen_ » Tab: Übersicht* in der Auftragsübersicht.
...
Das Ergebnis des Imports findest du im Backend im Menü *Aufträge » Aufträge bearbeiten » _Auftrag öffnen_ » Tab: Übersicht*.
...
Das Ergebnis des Imports findest du im Backend im Menü *Aufträge » Aufträge bearbeiten » _Auftrag öffnen_ » Tab: Übersicht* sowie in der Auftragsübersicht.

[#2210]
==== Varianten-ID

Gib die ID der Variante in deine CSV-Datei ein. Die ID findest du in der Übersichtstabelle im Menü *Artikel bearbeiten » Artikel*.
...
Das Ergebnis des Imports findest du im Backend im Menü *Aufträge » Aufträge bearbeiten » _Auftrag öffnen_ » Tab: Einstellungen » Feld: Währung* sowie in der Auftragsübersicht.
...
Das Ergebnis des Imports findest du im Backend im Menü *Aufträge » Aufträge bearbeiten » _Auftrag öffnen_ » Tab: Einstellungen » Feld: Umrechnungskurs*.

[#2250]
==== Einkaufspreis

Welchen Einkaufspreis hat die Auftragsposition? Gib den Preis für die Menge 1 in deine CSV-Datei ein. +
Ob du den Preis punkt- oder kommasepariert eintragen musst, hängt von deiner Einstellung im Bereich *Abgleich* des Imports ab.

*_Standardwert_*: Kein Standardwert

*_Zulässige Importwerte_*: Numerisch

Der Einkaufspreis wird nicht direkt im Auftrag angezeigt. Er ermöglicht aber das Errechnen der Gewinnspanne, die du im Menü *Aufträge » Aufträge bearbeiten » _Auftrag öffnen_ » Tab: Übersicht » Feld: Gewinnspanne netto* findest.
...
Das Ergebnis des Imports findest du im Backend in der Artikelpositionstabelle im Menü *Aufträge » Aufträge bearbeiten*. Der Gesamtwarenwert brutto wird im Menü *Aufträge » Aufträge bearbeiten » Tab: Übersicht » Feld: Warenwert netto* angezeigt.

[#2270]
==== Preisaufschlag

Hat die Auftragsposition einen Preisaufschlag? Dann gib diesen Preisaufschlag für die Menge 1 in deine CSV-Datei ein. +
Ob du den Aufschlag punkt- oder kommasepariert eintragen musst, hängt von deiner Einstellung im Bereich *Abgleich* des Imports ab.
...
Ob du den Rabatt punkt- oder kommasepariert eintragen musst, hängt von deiner Einstellung im Bereich *Abgleich* des Imports ab.
...
Ob du den prozentualen Rabatt punkt- oder kommasepariert eintragen musst, hängt von deiner Einstellung im Bereich *Abgleich* des Imports ab.
...
* AmazonInboundShipment: Sendungs-ID
* AmazonIndoundShipment: Amazon Konto-Id
* eBay Fulfillment: Outbound order number
* eBay Fulfillment: eBay fulfilled order
...
Das Ergebnis des Imports findest du im Backend im Menü *Aufträge » Aufträge bearbeiten » Tab: Übersicht » Feld: Auftragsnotiz*.
...
Durch die Eingabe der ID wird die Adresse dem Auftrag hinzugefügt oder ggf. aktualisiert. Die *ID der Adresse* findest du unter anderem im Menü *CRM » Kontake » _Kontakt öffnen_ » Bereich: Details » Feld: Adressen*.

*_Standardwert_*: Kein Standardwert

*_Zulässige Importwerte_*: Numerisch

Das Ergebnis des Imports findest du im Backend im Menü *Aufträge » Aufträge bearbeiten » _Auftrag öffnen_ » Tab: Übersicht » Feld: Rechnungsanschrift bzw. Lieferanschrift* sowie in der Auftragsübersicht.
...
* AmazonInboundShipment: Sendungs-ID
* AmazonInboundShipment: Amazon Konto-ID
* eBay Fulfillment: Outbound order number
* eBay Fulfillment: eBay fulfilled order
...
|`Konto - Sender`
|Die einzugebende Referenz-ID ist die ID eines bestehenden Kontos. Dieses Konto wird dann als Sender des Auftrages übernommen. Die ID des Kontos findest du im Backend *XXXXXXXXX*.

|`Konto - Empfänger`
|Die einzugebende Referenz-ID ist die ID eines bestehenden Kontos. Dieses Konto wird dann als Empfänger des Auftrages übernommen. Die ID des Kontos findest du im Backend *XXXXXXXXX*.

|`Lager - Sender`
|Die einzugebende Referenz-ID ist die ID eines bestehenden Lagers. Dieses Lager wird dann als Sender des Auftrages übernommen. Die ID des Lagers findest du im Backend im Menü *Einrichtung » Waren » Lager » _Lager wählen_ » Einstellungen*.

|`Lager - Empfänger`
|Die einzugebende Referenz-ID ist die ID eines bestehenden Lagers. Dieses Lager wird dann als Empfänger des Auftrages übernommen. Die ID des Lagers findest du im Backend im Menü *Einrichtung » Waren » Lager » _Lager wählen_ » Einstellungen*.
...
[#2550]
==== Umsatzsteueridentifikationsnummer CHECKCHECKCHECKCHECK
...
[#2610]
==== returnPackageNumber CHECKCHECKCHECKCHECK
...
[#2650]
==== Shipping Package Created at CHECKCHECKCHECKCHECK
...
[#2660]
==== Shipping Package Updated at CHECKCHECKCHECKCHECK
