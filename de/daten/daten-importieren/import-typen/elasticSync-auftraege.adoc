...
[[tabelle-zuordnung-auftragspositionstyp]]
[cols="1,1"]
|===
...
Das Ergebnis des Imports findest du im Backend im Menü *Aufträge » Aufträge bearbeiten » _Auftrag öffnen_ » Tab: Übersicht » Feld: Auftragsnotiz*.
...
Das Ergebnis des Imports findest du im Backend im Menü *Aufträge » Aufträge bearbeiten » _Auftrag öffnen_ » Tab: Übersicht » Felder: Rechnungsanschrift bzw. Lieferanschrift* sowie in der Auftragsübersicht.
...
[[tabelle-zuordnung-auftragsrelation]]
[cols="1,1"]
|===
...
[[tabelle-zuordnung-packstückart]]
[cols="1,1"]
|===
