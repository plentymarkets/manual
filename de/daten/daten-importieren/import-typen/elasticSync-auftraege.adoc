...
Das Ergebnis des Imports findest du im Backend im Menü *Aufträge » Aufträge bearbeiten » _Auftrag öffnen_ » Tab: Übersicht » Feld: Eingabe* sowie in der Auftragsübersicht.
