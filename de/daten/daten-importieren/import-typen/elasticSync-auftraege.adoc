...
Gilt für die Auftragsposition ein prozentualer Rabatt? Dann gib in deine CSV-Datei 1 ein, wenn ein Rabatt vorhanden ist und 0, wenn kein Rabatt vorhanden ist.
