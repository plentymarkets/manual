...
====
Auf der Best-Practice-Seite <<daten/daten-importieren/elasticsync-best-practices/best-practices-elasticsync-auftragspositionen#, Auftragspositionen>> findest du weitere Informationen zum Import und der Aktualisierung von Auftragspositionen.
====
...
|*Aufträge*
|In welcher Spalte deiner CSV-Datei werden die Auftrags-IDs aufgelistet? Wähle diese Spalte hier. Diese Option ist sinnvoll, wenn du _bestehende Aufträge aktualisieren_ möchtest.
Auftrags-ID +
Externe Auftrags-ID

|*Paket*
| Paket-ID +
Hier ist die ID des Versandpakets gemeint.

|*Auftragsposition*
| Auftragspositions-ID* +
*Externe Artikel ID +
Externe Token ID
