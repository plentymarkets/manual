...
Es wird standardmäßig davon ausgegangen, dass der Name in der Systemsprache eingegeben wird. Namen für Artikel vergibst du im Menü *Artikel » Artikel bearbeiten » Artikeltab: Texte » Feld: Name*.

*_Standardwert_*: Kein Standardwert

*_Zulässige Importwerte_*: Alphanumerisch

Das Ergebnis des Imports findest du im Backend im Menü: *Aufträge » Aufträge bearbeiten » Tab: Übersicht* in der *Artikelpositionstabelle* sowie in der Auftragsübersicht.
...
Das Ergebnis des Imports findest du im Backend im Menü: *Aufträge » Aufträge bearbeiten » Tab: Übersicht* in der Auftragsübersicht.
...
Das Ergebnis des Imports findest du im Backend im Menü: *Aufträge » Aufträge bearbeiten » Tab: Übersicht*.
...
Das Ergebnis des Imports findest du im Backend im Menü: *Aufträge » Aufträge bearbeiten » Tab: Übersicht* sowie in der Auftragsübersicht.

[#2210]
==== Varianten-ID

Gib die ID der Variante in deine CSV-Datei ein. Die ID findest du im Menü: *Artikel bearbeiten » Artikel*.
...
Das Ergebnis des Imports findest du im Backend im Menü: *Aufträge bearbeiten » Tab: Einstellungen » Feld: Währung* sowie in der Auftragsübersicht.
