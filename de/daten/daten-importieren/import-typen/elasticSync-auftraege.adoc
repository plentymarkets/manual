...
Das Ergebnis des Imports findest du im Backend im Menü *Aufträge » Aufträge bearbeiten » _Auftrag öffnen_ » Tab: Einstellungen » Feld: Herkunft* sowie in der Auftragsübersicht.
...
Das Ergebnis des Imports findest du im Backend im Menü *Aufträge » Aufträge bearbeiten » _Auftrag öffnen_ » Tab: Einstellungen » Feld: Standort* sowie in der Auftragsübersicht.
