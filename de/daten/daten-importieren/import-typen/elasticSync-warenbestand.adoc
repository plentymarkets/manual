...
Das Ergebnis des Imports findest du im Backend im Menü <<handbuchpfad#1500, backend-pfad>>.
...
Das Ergebnis des Imports findest du im Backend im Menü <<handbuchpfad#zahl, backend-pfad>>.
...
Gib das Mindesthaltbarketisdatum des Warenbestands in deine CSV-Datei ein.
