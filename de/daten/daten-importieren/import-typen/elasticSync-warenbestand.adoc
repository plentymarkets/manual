...
Das Ergebnis des Imports findest du im Backend im Menü <<warenwirtschaft/wareneingaenge-verwalten#500, Waren » Wareneingänge » _Suche ausführen_ » _Wareneingang wählen_ » Tab: Artikel>>.
