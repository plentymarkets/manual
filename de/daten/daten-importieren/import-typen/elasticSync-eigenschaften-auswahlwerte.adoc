...
#Frage#: Ist es immernoch nicht möglich, Multi-Select Eigenschaften per Import zu erstellen?
////
...
Verwende zusätzlich das Feld <<Name von Auswahlwerten / Name>>, wenn du den Namen auch in weiteren Sprachen speichern möchtest.
...
Im Gegensatz zum Feld <<Auswahlwerte / Name>> kannst du dieses Feld verwenden, um den Namen in mehreren Sprachen zu speichern.
