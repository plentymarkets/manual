...
Diese Seite erläutert die Abgleich- und Zuordnungsfelder, die dir beim Importieren von Gutschein-Codes und Kampagnendaten zur Verfügung stehen. Diese Seite dient lediglich als Referenz und setzt voraus, dass du bereits Grundkenntnisse über das <<daten/daten-importieren/ElasticSync#, Import-Tool>> hast.
...
.Abgleichfeld für den Import von Gutschein-Codes udn Kampagnendaten
[cols="1,3"]
|===
|Einstellung |Erläuterung

|Kampagnen-ID
|In welcher Spalte der CSV-Datei werden Kampagnen-IDs aufgelistet? Wähle diese Spalte hier. Diese Option ist sinnvoll, wenn du _bestehende Gutschein-Codes oder Kampagnendaten aktualisieren_ möchtest. +
...
Das Ergebnis des Imports findest du im Backend im Menü <<auftraege/gutscheine#, *Aufträge » Gutscheine* » _Kampagne öffnen_ im Tab *Codes*>>.
...
Das Ergebnis des Imports findest du im Backend im Menü <<auftraege/gutscheine#, *Aufträge » Gutscheine* in der Kampagnenübersicht>>.
...
Das Ergebnis des Imports findest du im Backend im Menü <<auftraege/gutscheine#, *Aufträge » Gutscheine* in der Kampagnenübersicht und in der Kampagne im Bereich *Gutschein*>>.
