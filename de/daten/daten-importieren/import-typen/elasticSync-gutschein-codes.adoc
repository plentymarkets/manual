...
In diesem Kapitel werden Felder erläutert, die für die Zuordnung von Gutschein-Codes und Kampagnendaten zur Verfügung stehen. Mithilfe dieser Felder legst du fest, welche _Spalte deiner Datei_ welchem _Datenfeld in deinem System_ entspricht.
