...
Das Ergebnis des Imports findest du im Backend im Menü <<auftraege/gutscheine#gutschein-codes-generieren, *Aufträge » Gutscheine* » _Kampagne öffnen_ im Tab *Codes*>>.
