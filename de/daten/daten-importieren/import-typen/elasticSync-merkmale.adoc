...
//trifft das zu?
//Eine bestehende Gruppe wird überschrieben, da das Merkmal nur zu einer Gruppe gehören kann.
//Wenn das Merkmal also bereits zu einer Gruppe gehört und du importierst eine zweite Gruppe, dann wird das Merkmal nicht mehr zur ersten Gruppe gehören.
