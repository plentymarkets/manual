...
Das Ergebnis des Imports findest du im Backend im Menü <<crm/kontakte-verwaltenintable-rechnungsadresse-lieferadresse-plz-ort, *CRM » Kontakte » [Kontakt öffnen] » Bereich: Adressen » [Adresse öffnen]*>>.
