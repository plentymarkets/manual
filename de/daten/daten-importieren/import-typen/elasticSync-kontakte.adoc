...
[TIP]
Die Kontakt-ID wird automatisch von deinem plentymarkets System vergeben wird und kann nicht geändert werden. Daher ist es nicht notwendig, hier eine Zuordnung vorzunehmen. Du kannst dieses Feld für den Import daher ignorieren.
