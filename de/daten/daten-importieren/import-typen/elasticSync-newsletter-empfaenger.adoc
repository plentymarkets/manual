...
Das Ergebnis des Imports findest du im Backend im Menü <<crm/newsletter-versenden#, *Einrichtung » CRM » Newsletter » E-Mails* » _Ordner aufklappen_>>. Dann die Suche (icon:search[role="blue"]) ausführen und den Datensatz aufklappen (icon:plus-square-o[]). Der Wert ist im Feld *Vorname* gespeichert.
