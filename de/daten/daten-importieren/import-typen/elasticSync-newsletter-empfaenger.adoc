...
[IMPORTANT]
.Wichtiger Hinweis beim Import von neuen E-Mail-Adressen
====
Zur Zeit wird bei Import von neuen Newsletter-E-Mail-Adressen der automatische Versand der Bestätigungsmails ausgelöst. Das bedeutet, dass eine E-Mail sowohl an Kontakte, die den Newsletter-Erhalt bestätigt haben als auch an Kontakte, die den Newsletter-Erhalt _nicht_ bestätigt haben, versendet wird.

Dieser Fehler ist uns bekannt und wir werden diesen in Kürze beheben. Wir empfehlen dir, für den Zeitraum des Imports die beiden Optionen *Newsletter Opt-In* und *Bestätigung Newsletter-Opt-In* im Menü *Einrichtung » Mandant » [Mandant wählen] » E-Mail » Automatischer Versand* zu deaktivieren, bis wir diesen Fehler behoben haben.
====
