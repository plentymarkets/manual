...
[#1730]
== Backups für Syncs einspielen

Wenn du Sync-Daten auf einen früheren Stand zurücksetzen oder gelöschte Sync-Daten wiederhertellen möchtest, kannst du dies über die Backup-Funktion tun.
...
. Klicke in der Zeile des Backups, dass du einspielen möchtest rechts auf *Backup einspielen* (icon:upload[role="purple"])
