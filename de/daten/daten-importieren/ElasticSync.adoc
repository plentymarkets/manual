...
* <<daten/daten-importieren/syc-typen/elasticSync-kontakte#, Kontakte, Firmen und Adressen>> = Wählen, um Kontakt-, Firmen- und Adressdaten zu importieren.
* <<daten/daten-importieren/syc-typen/elasticSync-artikel#, Artikel>> = Wählen, um Artikeldaten und Variantendaten zu importieren.
* <<daten/daten-importieren/syc-typen/elasticSync-kategorien#, Kategorien>> = Wählen, um Kategoriedaten zu importieren.
* <<daten/daten-importieren/syc-typen/elasticSync-attribute#, Attribute>> = Wählen, um Attributdaten zu importieren.
* <<daten/daten-importieren/syc-typen/elasticSync-merkmale#, Merkmale>> = Wählen, um Merkmaldaten zu importieren.
* *Notizen* = Wählen, um Notizdaten zu importieren.
* <<daten/daten-importieren/syc-typen/elasticSync-auftraege#, Aufträge>> = Wählen, um Auftragsdaten zu importieren.
* <<daten/daten-importieren/syc-typen/elasticSync-lager#, Lager>> = Wählen, um Lagerorte zu importieren.
* *Eigenschaften* = Wählen, um Eigenschaften zu importieren.
* <<daten/daten-importieren/syc-typen/elasticSync-facetten#, Facetten>> = Wählen, um Facetten zu importieren.
* <<daten/daten-importieren/syc-typen/elasticSync-hersteller#, Hersteller>> = Wählen, um Herstellerdaten zu importieren.
