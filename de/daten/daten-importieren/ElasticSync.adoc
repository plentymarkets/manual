...
.Berechtigungen für das Menü *Daten » ElasticSync* vergeben
[cols=”1,2”]
|====
...
=== Video-Tutorial zum Datenimport mit ElasticSync

Verschaffe dir einen Überblick über das Tool ElasticSync und lerne, wie du damit Daten in plentymarkets importierst, eine CSV-Datei hochlädst, deine Daten abgleichst und zuordnest sowie den Import startest.
...
=== Video-Tutorial zum einmaligen manuellen Import von Artikeln

Bist du neu bei plentymarkets und möchtest deine Artikel einmalig manuell importieren? Dann schaue dir dieses Video an und lerne, wie du Informationen wie beispielsweise Produkt- oder Kundendaten in deiner CSV-Datei manuell importierst.

video::321227748[vimeo]

=== Video-Tutorial zum automatischen Datenimport
...
=== Video-Tutorial zum Hinzufügen von zusätzlichen Informationen über den Eigenen Wert
...
Damit eine CSV- oder TXT-Datei beim Import wie gewünscht berücksichtigt wird, kann die sog. RegEx-Funktion genutzt werden. Diese sorgt dafür, dass Daten anhand von Befehlen beim Import manipuliert werden und folglich in der CSV- oder TXT-Datei keine Änderungen mehr vorgenommen werden müssen.
...
=== Video-Tutorial zur Änderung von Daten mit RegEx

Du willst eine Datei in plentymarkets importieren, musst aber zuerst noch einige Informationen ändern? Du musst die Datei nicht manuell anpassen! Nutze stattdessen die Reguläre Ausdrücke-Funktion in ElasticSync, um Informationen zu ändern.
...
=== Video-Tutorial zum Austauschen von Informationen mit der Eigenen Zuordnung

Du willst eine Datei in plentymarkets importieren, aber die Datei verwendet andere Informationen als plentymarkets? Du musst die Datei nicht manuell anpassen! Nutze stattdessen die Eigene Zuordnung-Funktion in ElasticSync, um Informationen auszutauschen.
...
====
War der Sync-Import erfolgreich, wird der Eintrag in der Spalte *Bearbeitungsstatus/Letzter Import* grün dargestellt. Sind beim Import Fehler aufgetreten, ist der Eintrag hingegen rot.
====
...
=== Video-Tutorial zum Im- und Export von Syncs
