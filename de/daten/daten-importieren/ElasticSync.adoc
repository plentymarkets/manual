...
Für den Import von Tag-Verknüpfungen stehen die in <<tabelle-zuordnungsfelder-tags>> aufgelisteten Felder zur Verfügung. Anhand des gewählten Abgleichsfelds wird geprüft, ob der importierte Datensatz in plentymarkets vorhanden ist.
