...
* <<daten/daten-importieren/syc-typen/kontakte#, Kontakte, Firmen und Adressen>> = Wählen, um Kontakt-, Firmen- und Adressdaten zu importieren.
* <<daten/daten-importieren/syc-typen/artikel#, Artikel>> = Wählen, um Artikeldaten und Variantendaten zu importieren.
* <<daten/daten-importieren/syc-typen/kategorien#, Kategorien>> = Wählen, um Kategoriedaten zu importieren.
* <<daten/daten-importieren/syc-typen/attribute#, Attribute>> = Wählen, um Attributdaten zu importieren.
* <<daten/daten-importieren/syc-typen/merkmale#, Merkmale>> = Wählen, um Merkmaldaten zu importieren.
* *Notizen* = Wählen, um Notizdaten zu importieren.
* <<daten/daten-importieren/syc-typen/auftraege#, Aufträge>> = Wählen, um Auftragsdaten zu importieren.
* <<daten/daten-importieren/syc-typen/lager#, Lager>> = Wählen, um Lagerorte zu importieren.
* *Eigenschaften* = Wählen, um Eigenschaften zu importieren.
* <<daten/daten-importieren/syc-typen/facetten#, Facetten>> = Wählen, um Facetten zu importieren.
* <<daten/daten-importieren/syc-typen/hersteller#, Hersteller>> = Wählen, um Herstellerdaten zu importieren.
