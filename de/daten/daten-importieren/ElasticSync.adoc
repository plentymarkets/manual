...
Benutzer:innen vom Typ *Backend* sehen nur bestimmte Bereiche und Menüs im plentymarkets Backend. Somit können sie nur eingeschränkt im System arbeiten. Sollen Mitarbeiter:innen mit dem Zugang *Backend* mit Importen und Zuordnungen arbeiten können, muss eine Person mit *Admin*-Zugang die in <<tabelle-berechtigungen-elasticsync>> beschriebenen Rechte für Benutzer:innen mit dem Zugang *Backend* vergeben.
...
.Berechtigungen für Importe und Zuordnungen
[cols=”1,2”]
|====
| Einstellung | Erläuterung

| *Daten > Import > Aktualisieren*
|Erlaubt Backend-Benutzer:innen, Importe zu aktualisieren.

| *Daten > Import > Anzeigen*
|Erlaubt Backend-Benutzer:innen, Importe zu sehen.

| *Daten > Import > Erstellen*
|Erlaubt Backend-Benutzer:innen, Importe zu erstellen.

| *Daten > Import > Löschen*
|Erlaubt Backend-Benutzer:innen, Importe zu löschen.

| *Daten > Import > Zuordnung > Aktualisieren*
|Erlaubt Backend-Benutzer:innen, eine Zuordnung zu aktualisieren.

| *Daten > Import > Zuordnung > Anzeigen*
|Erlaubt dem Backend-Benutzer, eine Zuordnung zu sehen.

| *Daten > Import > Zuordnung > Erstellen*
|Erlaubt Backend-Benutzer:innen, eine Zuordnung zu erstellen.

| *Daten > Import > Zuordnung > Löschen*
|Erlaubt Backend-Benutzer:innen, eine Zuordnung zu löschen.

| *Daten > Daten-Log*
|Erlaubt Backend-Benutzer:innen, den Daten-Log eines Imports zu aktualisieren, anzuzeigen, zu erstellen und zu löschen.
|====
...
→ Die Import-Übersicht wird geöffnet.
. Markiere einen oder mehrere Importe.
. Klicke auf *Export ausführen* (icon:download[role="purple"]). +
→ Der Import wird automatisch heruntergeladen.
. Klicke auf *Import ausführen* (icon:upload[role="purple"]). +
