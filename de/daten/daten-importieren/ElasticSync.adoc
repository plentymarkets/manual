...
Wenn Sie mehrere Zuordnungen in einem Sync pflegen, können Sie bestimmte Zuordnungen eines Syncs in der Übersicht der Zuordnungen über image:de/basics/datenaustausch/ElasticSync/assets/activate-mapping.png[activate-mapping, title="activate-mapping"] deaktivieren bzw. aktivieren. Neue Zuordnungen, die Sie erstellen, sind standardmäßig aktiv.
...
|ID der Eigner siehe *System » Einstellungen » Benutzer » Konten*

|Hersteller-ID
|Nummerisch (interne ID)
|Siehe *System » Artikel » Hersteller*
...
|Markierung 1
|Nummerisch (interne ID)
|ID der Markierung 1, siehe *System » Artikel » Makierungen » Tab: Markierung 1*

|Markierung 2
|Nummerisch (interne ID)
|ID der Markierung 2, siehe *System » Artikel » Makierungen » Tab: Markierung 2*
...
|Nummerisch (interne ID)
|ID des Mandanten, siehe *System » Mandant » Mandant öffnen » Einstellungen* +
...
|ID
|Nummerisch (interne ID)
|IDs siehe *System » Artikel » Merkmale*
...
|ID
|Nummerisch (interne ID)
|IDs siehe *System » Einstellungen » Eigenschaften » Konfiguration*
...
Amazon siehe *System » Märkte » Amazon » Einstellungen* +
eBay siehe *System » Märkte » eBay » Konten*
...
Für den Import von Seriennummern stehen die in <<tabelle-zuordnungsfelder-seriennummer>> aufgelisteten Felder zur Verfügung. Anhand des gewählten Abgleichsfelds wird geprüft, ob der importierte Datensatz in plentymarkets vorhanden ist.
...
Mit Syncs des Typs *Attribut* importieren Sie Attribute und Attributwerte. Die importieren Daten werden im Menü *System » Artikel » Attribute* gespeichert.
...
Mit Syncs des Typs *Merkmal* importieren Sie Merkmale. Die importieren Daten werden im Menü *System » Artikel » Merkmale* gespeichert.
...
Mit Syncs des Typs *Hersteller* importieren Sie Herstellerdaten.
...
Mit Syncs des Typs *Facetten* importieren Sie Facettendaten.
