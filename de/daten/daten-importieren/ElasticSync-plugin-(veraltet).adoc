...
====
Das Plugin wird bald abgeschaltet. Wir raten daher, Syncs von nun an ohne das Plugin zu erstellen. Wie das geht, erfahren Sie  <<daten/daten-importieren/ElasticSync#, hier>>.
====
