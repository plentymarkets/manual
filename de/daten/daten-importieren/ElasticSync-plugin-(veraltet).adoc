...
Wenn Sie mehrere Zuordnungen in einem Sync pflegen, können Sie bestimmte Zuordnungen eines Syncs in der Übersicht der Zuordnungen über image:de/basics/daten/daten-importieren/assets/activate-mapping.png[] deaktivieren bzw. aktivieren. Neue Zuordnungen, die Sie erstellen, sind standardmäßig aktiv.
