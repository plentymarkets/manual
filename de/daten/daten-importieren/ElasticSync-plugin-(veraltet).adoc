...
Mit Syncs des Typs *Attribut* importieren Sie Attribute und Attributwerte. Die importieren Daten werden im Menü *System » Systemeinstellungen » Artikel » Attribute* gespeichert.
...
Mit Syncs des Typs *Merkmal* importieren Sie Merkmale. Die importieren Daten werden im Menü *System » Systemeinstellungen » Artikel » Merkmale* gespeichert.
