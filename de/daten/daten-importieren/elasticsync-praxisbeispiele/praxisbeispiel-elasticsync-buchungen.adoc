...
Nach Klicken auf *Import ausführen* werden die Daten in dein System importiert. Die Buchungen werden als Zahlungen angelegt und sind im Menü *Aufträge » Zahlungsverkehr* verfügbar. In diesem Menü kannst du die <<payment/beta-zahlungen-verwalten#, Zahlungen verwalten>> und mit der Bearbeitung fortfahren.
