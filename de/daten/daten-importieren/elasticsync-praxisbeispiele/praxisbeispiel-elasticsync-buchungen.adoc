...
Du kannst den Import-Typ *Buchungen* nutzen, um neue Buchungen in dein System zu importieren. Du kannst den Import-Typ auch zur Aktualisierung von bereits bestehenden Buchungen nutzen. Auf dieser Seite wird der Import von neuen Buchungen erklärt. Grundkenntnisse über das <<daten/daten-importieren/ElasticSync#, Import-Tool>> sind hilfreich beim Erstellen deines Buchungs-Imports. In diesem Best Practice wird dennoch Schritt für Schritt erklärt, wie du vorgehen solltest.
