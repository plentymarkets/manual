...
Für den Import und das Bearbeiten der ASINs und ePIDs könnt Ihr unter *Daten » Import* einen eigenen Sync vom Typ *Artikel* anlegen oder auch die Felder in einen bestehenden Sync einbauen.
