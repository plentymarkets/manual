...
Für den Import der Cross-Selling-Verknüpfungen könnt Ihr unter *Daten » Import* einen eigenen Sync von Typ *Artikel* erstellen oder auch die Felder in einen bestehenden Sync einbauen.
