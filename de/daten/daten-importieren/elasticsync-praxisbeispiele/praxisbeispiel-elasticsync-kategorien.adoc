...
Die Namen der Spaltenüberschriften können frei gewählt werden. Du kannst einige oder alle der <<daten/daten-importieren/sync-typen/elasticSync-kategorien#2120, hier aufgeführten Kategorieinformationen>> hinzufügen. In diesem Beispiel habe ich mich entschieden, folgende Informationen zu ergänzen:
