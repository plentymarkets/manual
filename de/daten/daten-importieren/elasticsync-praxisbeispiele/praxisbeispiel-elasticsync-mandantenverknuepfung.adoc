...
:keywords: ElasticSync, Import, Artikel, Artikelanlage, Best Practice, automatisiert, Mandantenverknüpfung, Mandant
:position: 90
...
Für den Import der Mandantenverfügbarkeit könnt Ihr unter *Daten » Import* einen eigenen Sync vom Typ *Artikel* anlegen oder auch die Felder in einen bestehenden Sync einbauen.
