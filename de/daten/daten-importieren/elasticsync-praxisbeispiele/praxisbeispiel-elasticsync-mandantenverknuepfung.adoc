...
Für den Import der Mandantenverfügbarkeit könnt Ihr unter *Daten » Import* einen eigenen Sync vom Typ *Artikel* erstellen oder auch die Felder in einen bestehenden Sync einbauen.
