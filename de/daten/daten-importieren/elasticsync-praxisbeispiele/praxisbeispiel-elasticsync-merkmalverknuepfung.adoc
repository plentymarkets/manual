...
Für den Import der Merkmalverknüpfungen könnt Ihr unter *Daten » Import* einen eigenen Sync von Typ *Artikel* erstellen oder auch die Felder in einen bestehenden Sync einbauen.
