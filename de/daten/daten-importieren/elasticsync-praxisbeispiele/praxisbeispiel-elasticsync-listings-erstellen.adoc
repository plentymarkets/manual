...
:keywords: Listing, ElasticSync, eBay, Listings, erstellen, eBay-Listings, eBay Listings, Listings importieren, eBay-Listings importieren, eBay Listings importieren
:position: 80
...
Um mit ElasticSync Listings in plentymarkets zu erstellen, benötigst du zunächst eine CSV-Datei. Um ein Market-Listing inklusive Listing zu erstellen, muss die CSV-Datei mindestens folgende Felder enthalten:
...
Mit ElasticSync im Menü *Daten » Import* kannst du nun die CSV-Datei mit den neuen Listings in dein plentymarkets System importieren. Dazu erstellst du einen Sync des Typs Market-Listing.
