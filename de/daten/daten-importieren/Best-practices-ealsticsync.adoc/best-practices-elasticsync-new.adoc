= Best Practices: Datenimport mit dem neuen ElasticSync
:lang: de
include::{includedir}/_header.adoc[]
:keywords: ElasticSync, ElasticSync new, Datenimport, Zuordnung, Abgleich
:position: 30

Hier findest du Best Practices zum Thema Import mit dem neuen ElasticSync. Bevor du die Best Practices auf dieser Handbuchseite nutzt, um Daten auszutauschen, solltest du dich mit der generellen Funktionsweise des FormatDesigners und des Elastischen Exports vertraut machen. Lies dazu zunächst die Handbuchseiten link:https://knowledge.plentymarkets.com/daten/daten-exportieren/FormatDesigner[FormatDesigner] und link:https://knowledge.plentymarkets.com/daten/daten-exportieren/elastischer-export[Elastischer Export]. +
