...
:id: HCKHMEI
:author: team-cloud, team-webshop

//add this url weiterleitung /basics/admin-aufgaben/ftpz-zugang/;/daten/ftpz-zugang/;301;L
...
Alternativ zur Arbeitsweise mit einem FTP-Programm kannst du Daten auch über unser Webspace-Tool austaschen, das du über den Bereich *CMS » Webspace* öffnest. Eine Anleitung zur Bedienung des ajaxplorer findest du in unserem link:https://www.plentymarkets.eu/-plentymarkets-4-120-Nun-mit-komfortablem-Dateibrowser/b-138/[Blog-Eintrag]{nbsp}icon:external-link[] zum Thema.
