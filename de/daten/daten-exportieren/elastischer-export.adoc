...
* Erstelle Exportformate für Preissuchmaschinen, Preisportale, Marktplätze und Affiliate-Dienstleister, mit denen Daten an die Schnittstellen übertragen werden. Weitere Informationen dazu erhältst du im Kapitel <<Exportformate für Schnittstellen erstellen#50, Exportformate für Schnittstellen erstellen>>.
...
[#20]
=== Lizenz
Das gesamte Projekt unterliegt der GNU AFFERO GENERAL PUBLIC LICENSE – weitere Informationen findest du in der [LICENSE.md](https://github.com/plentymarkets/plenty-plugin-elastic-export/blob/master/LICENSE.md).
