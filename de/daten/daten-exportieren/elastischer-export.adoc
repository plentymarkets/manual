...
* Erstelle Exportformate für Preissuchmaschinen, Preisportale, Marktplätze und Affiliate-Dienstleister, mit denen Daten an die Schnittstellen übertragen werden. Weitere Informationen dazu erhältst du im Kapitel <<Exportformate für Schnittstellen erstellen, Exportformate für Schnittstellen erstellen>> und in den User Guides der Schnittstellen-Plugins.

[TIP]
.Plugin Elastischer Export installieren
====
Um den elastischen Export nutzen zu können, installiere zunächst das Plugin link:https://marketplace.plentymarkets.com/plugins/sales/marktplaetze/elasticexport_4763[Elastischer Export^] in deinem plentymarkets System. Das Plugin erhältst du im link:https://marketplace.plentymarkets.com/[plentyMarketplace^]{nbsp}icon:external-link[].
====
