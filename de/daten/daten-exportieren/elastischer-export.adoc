...
[TIP]
.Plugin-Set mit Hauptmandantenverknüpfung
====
Installieren Sie das Plugin *Elastischer Export* und die Plugins für die Exportformate in einem Plugin-Set mit Hauptmandantenverknüpfung.
====
...
* *Postitiver Warenbestand im gewählten Lager* = Lager aus der eingeblendeten Dropdown-Liste wählen, um nur Varianten mit positivem Warenbestand in diesem Lager zu exportieren. 
