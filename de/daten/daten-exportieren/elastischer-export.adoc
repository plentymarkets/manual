...
* *Tag (UND-Modus)* = Ein oder mehrere Tag-Namen eingeben. Artikel, die mit _allen_ der gewählten <<willkommen/allgemeine-funktionen/tags#, Tags>> verknüpft sind, werden übertragen.
* *Tag (ODER-Modus)* = Ein oder mehrere Tag-Namen eingeben. Artikel, die mit _mindestens einem_ der gewählten <<willkommen/allgemeine-funktionen/tags#, Tags>> verknüpft sind, werden übertragen.
