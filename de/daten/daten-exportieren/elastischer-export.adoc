...
====
Um den elastischen Export nutzen zu können, installiere zunächst das Plugin link:https://marketplace.plentymarkets.com/plugins/sales/marktplaetze/elasticexport_4763[Elastischer Export^] in deinem plentymarkets System. Das Plugin erhältst du im link:https://marketplace.plentymarkets.com/[plentyMarketplace^].
====
...
====
Installiere das Plugin link:https://marketplace.plentymarkets.com/plugins/channels/marktplaetze/elasticexport_4763[Elastischer Export^] und die Plugins für die Exportformate in einem Plugin-Set mit Standard-Mandantenverknüpfung.
====
