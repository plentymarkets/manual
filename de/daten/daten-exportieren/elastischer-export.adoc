...
====
Mit einem Klick auf *Reset* löschst du die Suchkriterien. Klicke anschließend erneut auf *Suchen* (icon:search[role="blue"]), damit alle bereits erstellten Exportformate wieder in der Übersicht angezeigt werden und du neue Filter einstellen kannst.
====
