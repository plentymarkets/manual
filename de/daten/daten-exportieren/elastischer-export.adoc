...
Dieses Kapitel beschreibt, wie du neue Exportformate erstellst und welche Einstellungen du vornehmen musst. Alle Formate müssen zunächst aus dem link:https://marketplace.plentymarkets.com/plugins/channels/marktplaetze[plentyMarketplace^]{nbsp}icon:external-link[] installiert werden, bevor die Formate im elastischen Export zur Verfügung stehen. Nur das Format *BolItemExport* ist sofort verfügbar.
...
| *Format*
| Format für den Export aus der Dropdown-Liste wählen. Es stehen nur aus dem plentyMarketplace installierte Formate zur Verfügung. Ausnahme: Das Format BolItemExport ist sofort verfügbar.
