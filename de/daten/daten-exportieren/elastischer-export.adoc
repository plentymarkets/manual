...
* *Tag (UND-Modus)* = Ein oder mehrere Tag-Namen eingeben. Artikel, die mit _alle_ der gewählten <<basics/arbeiten-mit-plentymarkets/tags#, Tags>> verknüpft sind, werden übertragen.
* *Tag (ODER-Modus)* = Ein oder mehrere Tag-Namen eingeben. Artikel, die mit _mindestens eins_ der gewählten <<basics/arbeiten-mit-plentymarkets/tags#, Tags>> verknüpft sind, werden übertragen.
