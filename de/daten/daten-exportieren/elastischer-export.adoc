...
* Erstelle Exportformate für Preissuchmaschinen, Preisportale, Marktplätze und angebundene Dienstleister:innen, mit denen Daten an die Schnittstellen übertragen werden. Weitere Informationen dazu erhältst du im Kapitel <<Exportformate für Schnittstellen erstellen, Exportformate für Schnittstellen erstellen>>.
...
Mit dem elastischen Export im Menü *Daten » Elastischer Export* erstellst du Exportformate für Preissuchmaschinen, Preisportale, Marktplätze und angebundene Dienstleister:innen, mit denen du Daten an die Schnittstellenpartner:innen überträgst. Um den elastischen Export nutzen zu können, muss das Plugin installiert sein. +
...
[#100]
=== Bei den Schnittstellenpartner:innen registrieren

Bevor du dein Exportformat an die Schnittstellenpartner:in übertragen kannst, musst du dich auf der Webseite der Schnittstellenpartner:innen registrieren. Die Links zu den Webseiten der Preissuchmaschinen, Preisportale, Marktplätze und angebundene Dienstleister:innen, zu denen es eine Schnittstelle über Plugins in plentymarkets gibt, findest du in <<#exportformate>>. Alle Exportformate müssen zunächst aus dem plentymarketplace installiert werden, damit die Datenformate im elastischen Export zur Verfügung stehen. Nur das Exportformat *BolItemExport* wird ohne zusätzliche Plugins aus dem Marketplace bereitgestellt.
