...
Wie genau das Zusammenspiel dieser beiden Plugins funktioniert, zeigen wir dir im Folgenden anhand eines Use Cases, mit dem du die Auftragsdatenübertragung zu einer lokalen Versanddienstleister:in ohne direkte Schnittstelle in das Drittsystem realisieren kannst.
