...
Der FormatDesigner ist Bestandteil des Plugins ElasticSync und ermöglicht es Ihnen, Formate für den Export per ElasticExport anzulegen. Alle per FormatDesigner angelegten Formate stehen Ihnen im Menü *Daten » Elastischer Export* zur Verfügung. Sie können mithilfe des FormatDesigners nicht nur CSV-Optionen und ausgewählte Datenfelder bestimmen, sondern auch numerische Datenwerte während des Exports manipulieren.

[TIP]
.Plugin aktualisiert?
====
Der FormatDesigner ist Bestandteil des Plugins ElasticSync. ElasticSync wird ständig aktualisiert und verbessert. Prüfen Sie deshalb im Menü *Plugins » Plugin-Übersicht » Plugin-Set öffnen*, dass Sie die aktuelle Version des Plugins ElasticSync verwenden, bevor Sie Syncs oder Exportformate erstellen.
====
...
|bookAccount
|Debitorenkonto des Kontakts. Das Debitorenkonto ist eine zusätzliche, separate Nummer, die in der Regel der Kundennummer oder der Debitorennummer in Ihrer Finanzbuchhaltung entspricht.
...
In <<tabelle-felder-order-orderparcelservice>> werden Felder erläutert, die für den Export von Daten zum Versanddienstleisters des Auftrags zur Verfügung stehen.
...
In <<tabelle-felder-orderitem-order-property>> werden Felder erläutert, die für den Export von verschiedenen Autragseigenschaften zur Verfügung stehen.
...
In <<tabelle-felder-orderitem-order-date>> werden Felder erläutert, die für den Export des Auftragsdatums zur Verfügung stehen.

[[tabelle-felder-orderitem-order-date]]
.Felder für Export des Auftragsdatums
[cols="1,3"]
|====
|Feld |Erläuterung
...
|voraussichtliches Versanddatum
|Voraussichtliches Versanddatum der Auftragspositionen
...
|Voraussichtliches Lieferdatum des Auftrags
...
In <<tabelle-felder-orderitem-order-amount>> werden Felder erläutert, die für den Export der allgemein berechneten Beträge eines Auftrags zur Verfügung stehen.
...
In <<tabelle-felder-order-item>> werden Felder erläutert, die für den Export von Daten zu Auftragspositionen zur Verfügung stehen.

[[tabelle-felder-order-item]]
...
In <<tabelle-felder-order-item-date>> werden Felder erläutert, die für den Export des Datums zur Verfügung stehen, das an der Auftragsposition hinterlegt ist.

[[tabelle-felder-order-item-date]]
...
In <<tabelle-felder-orderitem-billing-address>> werden Felder erläutert, die für den Export von Rechnungsadressen zu Auftragspositionen zur Verfügung stehen.

[[tabelle-felder-orderitem-billing-address]]
.Felder für den Export von Rechnungsadressen zu Auftragspositionen
[cols="1,3"]
|====
|Feld |Erläuterung
...
.Felder für Export von Rechnungsadressen-Optionen zu Auftragspositionen
[cols="1,3"]
|====
|Feld |Erläuterung
...
In <<tabelle-felder-delivery-orderitem-address-option>> werden die Typen erläutert, die für den Export von Lieferadressen-Optionen zur Verfügung stehen.

[[tabelle-felder-delivery-orderitem-address-option]]
.Felder für Export von Lieferadressen-Optionen
[cols="1,3"]
|====
|Feld |Erläuterung
...
In <<tabelle-felder-orderitem-order-document>> werden Felder erläutert, die für den Export von Daten zu Auftragsdokumenten zur Verfügung stehen.

[[tabelle-felder-orderitem-order-document]]
.Felder für den Export von Auftragsdokumenten
[cols="1,3"]
|====
|Feld |Erläuterung
...
In <<tabelle-felder-orderitem-artikel>> werden die Felder erläutert, die für den Export von Artikeldaten zur Verfügung stehen.

[[tabelle-felder-orderitem-artikel]]
.Felder für Artikelexport
[cols="1,3"]
|====
|Feld |Erläuterung
...
In <<tabelle-felder-orderitem-varianten>> werden die Felder erläutert, die für den Export von Variantendaten zur Verfügung stehen.
...
|isMain
|Gibt aus, ob es sich um die Hauptvariante handelt
...
|movingAveragePrice
|Gleitender Durchschnittseinkaufspreis
...
In <<tabelle-felder-orderitem-orderparcelservicepreset>> werden Felder erläutert, die für den Export von Daten zum Standard-Versanddienstleister zur Verfügung stehen.
...
|isParcelBox
|Flag, der definiert, ob es sich um eine Abholstation handelt
...
In <<tabelle-felder-orderitem-orderparcelservicepresetname>> werden Felder erläutert, die für den Export der Bezeichnung des Standard-Versanddienstleisters zur Verfügung stehen.
...
In <<tabelle-felder-orderitem-orderparcelservice>> werden Felder erläutert, die für den Export von Daten zum Versanddienstleisters des Auftrags zur Verfügung stehen.
...
In <<tabelle-felder-orderitem-orderparcelservicename>> werden Felder erläutert, die für den Export der Bezeichnung des Versanddienstleisters des Auftrags zur Verfügung stehen.
...
|Deutsch
|ID des Versanddienstleisters (deutsch)

|Englisch
|ID des Versanddienstleisters (englisch)
...
|Deutsch
|Name des Versanddienstleisters (deutsch)

|Englisch
|Name des Versanddienstleisters (englisch)
|====
...
Mit Formaten des Typs *Warenbestand* exportieren Sie Warenbestandsdaten.
...
Mit Formaten des Typs *Kontakte* exportieren Sie Kontaktdaten.
...
|bookAccount
|Debitorenkonto des Kontakts. Eine zusätzliche, separate Nummer, die generell der Kundennummer oder der Debitorennummer des Kontakts in Ihrer Buchhaltung entspricht.
