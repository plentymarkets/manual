...
Damit das Plugin im Menü angezeigt wird, muss es im verknüpften Plugin-Set installiert sein. In der Plugin-Übersicht sollte es außerdem oberhalb der Plugins *Ceres* und *IO* platziert sein (sofern diese aktiv sind).
