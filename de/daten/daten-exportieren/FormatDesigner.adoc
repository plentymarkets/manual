...
.Felder für Export von Newsletter-Daten
[cols="1,3"]
|====
|Feld |Erläuterung
...
|id
|ID des Newsletter-Empfängers

|folderId
|ID des Newsletter-Ordners
...
|templateLang
|Die Sprache der Newsletter-Vorlage
...
|ipAddress
|IP-Adresse, mit der der Kontakt den Newsletter-Empfang bestätigt hat
