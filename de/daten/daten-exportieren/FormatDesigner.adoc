...
In <<tabelle-felder-orderitem-orderparcelservice>> werden Felder erläutert, die für den Export von Daten zum Versanddienstleister des Auftrags zur Verfügung stehen.
