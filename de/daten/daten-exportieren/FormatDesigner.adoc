...
:keywords: Format, FormatDesigner, Format Designer, Formatdesigner, Format designen, Datenfeld, Datenfelder, Format erstellen, Format bearbeiten, Daten exportieren, Export, Datenexport, Daten-Export
:position: 30
...
Damit das Plugin im Menü angezeigt wird, muss es im verknüpften Plugin-Set installiert sein. Außerdem muss es mit einer bestimmten Priorität im Vergleich zu anderen Plugins geladen werden. Um die Priorität festzulegen, öffne dein Plugin-Set und klicke auf *Prioritäten festlegen*. FormatDesigner muss eine niedrigere Priorität erhalten als Ceres und IO, falls diese in dem Plugin-Set aktiv sind.
...
.Plugin aktualisiert?
====
Plugins werden ständig aktualisiert und verbessert. Prüfe deshalb im Menü *Plugins » Plugin-Übersicht » _Plugin-Set öffnen_*, ob du die aktuelle Version des Plugins verwendest, bevor du Datenformate erstellst.
====
