...
* *Toolbar* In der Symbolleiste kannst du für den Katalog relevante Aktionen durchführen. Speichere zum Beispiel die Zuordnungen der Datenfelder, stelle eine ältere Version des Katalogs wieder her oder blende optionale Marktplatz-Datenfelder ein oder aus.
...
* *plentymarkets Datenfelder* Im linken Bereich des Katalogs ordnest du den Marktplatz-Datenfeldern passende plentymarkets Datenfelder zu. +
...
* Welche Daten mit welchem plentymarkets Datenfeldern exportiert werden, kannst du in der Beschreibung des Standardformats <<daten/daten-exportieren/kataloge-verwalten#, Artikel (neu)>> nachlesen.
...
=== Bereit für den Wechsel? Von altem Export auf Katalogexport umsteigen
