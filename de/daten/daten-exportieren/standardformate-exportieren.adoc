...
* <<#preview, Über die Vorschaufunktion exportierst du die ersten 5 Datenzeilen, um den Export zu prüfen.>>
* <<#activate-catalogue, Über die Exporteinstellungen legst du fest, dass die Daten des Katalogs automatisch exportiert werden.>>
* <<#manual-export, Du startest den Export manuell.>>
