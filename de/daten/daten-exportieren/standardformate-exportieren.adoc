= Kataloge: Dateienexport
:lang: de
include::{includedir}/_header.adoc[]
:keywords:
:description: Standardformate für den Export von plentymarkets Daten erstellen
:position: 60
:url: daten/daten-exportieren/standardformate-exportieren
:id: Z14A1MY
:author: team-plenty-channel
:nav-alias: Standardformate nutzen
...
* *Symbolleiste* In der Symbolleiste kannst du für den Katalog relevante Aktionen durchführen. Speichere zum Beispiel die Zuordnungen der Datenfelder, stelle eine ältere Version des Katalogs wieder her oder blende optionale Marktplatz-Datenfelder ein oder aus.

* *Auswahl der plentymarkets Datenfelder*: Im Bereich links neben der Navigation findest du eine Liste aller plentymarkets Datenfelder, die exportiert werden können. Klicke auf das Plus rechts neben dem Datenfeld, um ein Datenfeld zum Export hinzuzufügen.

  ** Zusätzlich zu den Datenfeldern kannst du auch <<daten/daten-exportieren/kataloge-verwalten#164, eigene Werte>> zum Export hinzufügen. Für jeden Datensatz wird dann derselbe Wert exportiert.
  ** Nutze die Option <<daten/daten-exportieren/kataloge-verwalten#mathematische-berechnungen, Formel>>, um bestimmte Daten während des Exports zu aktualisieren. So kannst du zum Beispiel alle exportierten Artikelpreise schon beim Export bearbeiten.

* *Gewählte Datenfelder*: Links werden alle Datenfelder angezeigt, die du zum Export hinzugefügt hast.

  ** Du kannst die Datenfelder per <<daten/daten-exportieren/kataloge-verwalten#165, Drag-and-drop>> verschieben, um die Export-Reihenfolge anzupassen.
  ** Du kannst den <<daten/daten-exportieren/kataloge-verwalten#162, Export key>> anpassen. Die "Export Keys" sind die Namen der Spaltenüberschriften, die in deiner Exportdatei erscheinen werden. Jeder "Export Key" muss eindeutig sein.
  ** Du kannst <<daten/daten-exportieren/kataloge-verwalten#160, Ausweich-Datenfelder>> hinzufügen. Wenn das Datenfeld leer oder ungültig ist, wird das erste Ausweich-Datenfeld geprüft und stattdessen dieser Wert exportiert.
...
* Ergebnis 1: `artikel-export_2020_10_25.csv`

'''

* Eingabe 2: `$type_$format_$year_$month_$day`
* Ergebnis 2: `bestellung_bestellung_2020_10_25.csv`
...
Mit den Exporteinstellungen legst du fest, wo dein Export gespeichert wird.
...
icon:toggle-on[role="blue"] = Es wird ein öffentlicher Link erstellt. Nach dem ersten Export ist die Datei über diesen Link für alle verfügbar, die den Link kennen.
...
icon:toggle-on[role="blue"] = Die Download-URL wird mit einem Token versehen. Die Datei ist dann nur erreichbar, wenn der aktuelle Token bekannt ist.
...
image::daten/assets/assets/ergebnis-export-companyname.png[]
--
...
image::daten/assets/assets/ergebnis-export-street.png[]
--
...
* <<#255, Über die Vorschaufunktion exportierst du die ersten 5 Datenzeilen, um den Export zu prüfen.>>
* Über die Exporteinstellungen legst du fest, dass die Daten des Katalogs automatisch exportiert werden.
* Du startest den Export manuell.
...
* Die Vorschaufunktion ist nicht für jedes Katalog-Format verfügbar.
...
Nachdem du mindestens ein Datenfeld hinzugefügt hast, kannst du den Katalog manuell exportieren und eine Exportdatei herunterladen.
...
NOTE: Wenn du auf *Daten herunterladen* wird der Export gestartet. Es wird aber _kein_ Fenster angezeigt, über das du die Datei sofort herunterladen kannst. Wenn der Export abgeschlossen wird, kannst du die Exportdatei in den Notifications herunterladen.
...
// tag::manage-catalogues[]
[#manage-catalogues]
== Kataloge verwalten: löschen, kopieren etc.

Wie du vorhandene Kataloge verwaltest, ist auf der Handbuchseite <<kataloge-verwalten#, Kataloge verwalten>> beschrieben:

* <<kataloge-verwalten#190, Kataloge kopieren>>
* <<kataloge-verwalten#210, Kataloge löschen>>
* <<kataloge-verwalten#250, Katalog-Version wiederherstellen>>
* <<kataloge-verwalten#270, Kataloge exportieren>>
* <<kataloge-verwalten#280, Kataloge importieren>>
* <<kataloge-verwalten#catalogue-rights, Rechte für Backend-Benutzer:innen vergeben>>
* <<kataloge-verwalten#15, Spalten der Katalog-Übersicht anpassen>>

// end::manage-catalogues[]
