...
Ein Praxisbeispiel zum Export von Aufträgen und Auftragspositionen findest du auf der Handbuchseite <<daten/daten-exportieren/katalog-auftraege#, Praxisbeispiel Aufträge und Positionen>>.
...
image::daten/daten-exportieren/kataloge/katalog-formate/assets/katalog-auftraege.png[]
...
Mehr Informationen zu Datenfeldern allgemein findest du im Handbuchkapitel <<daten/daten-exportieren/dateiexport#add-fields, Datenfelder zu Export hinzufügen>>.
====
...
In der Exportdatei wird als Wert die <<daten/interne-IDs#80, ID des Auftragstyps>> ausgegeben.

| *Status*
| Exportiert den <<auftraege/auftraege-verwalten#1200, Auftragsstatus>>, in dem der Auftrag sich zum Zeitpunkt des Exports befindet. Der automatisch generierte Export key für dieses Feld ist *order.statusId*. +
In der Exportdatei wird als Wert die <<daten/interne-IDs#120, ID des Auftragsstatus>> ausgegeben.

| *Statusname*
| Exportiert den <<auftraege/auftraege-verwalten#1200, Auftragsstatus>>, in dem der Auftrag sich zum Zeitpunkt des Exports befindet. Der automatisch generierte Export key für dieses Feld ist *order.statusName*. +
...
*_Beachte_*: Du musst für jedes Datenfeld aus diesem Unterordner auswählen, ob der Betrag in deiner eingestellten <<payment/waehrungen#30, Systemwährung>> oder der Auftragswährung ausgegeben werden soll. Dies gilt auch für den Unterordner *Steuer*. Es ist sinnvoll, auch immer die Datenfelder *Währung* und *Wechselkurs* hinzuzufügen. So stellst du sicher, dass alle benötigten Werte und Informationen auf einen Blick verfügbar sind, unabhängig von der Währung.
...
*_Beachte_*: Du musst für jedes Datenfeld aus diesem Unterordner auswählen, ob der Betrag in deiner eingestellten <<payment/waehrungen#30, Systemwährung>> oder der Auftragswährung ausgegeben werden soll. In einer weiteren Dropdown-Liste musst du zudem den Steuersatz auswählen. In der Exportdatei werden dann die Werte für den ausgewählten Steuersatz ausgegeben.
...
* *Gruppiert* = Bei einem Auftrag, der aus mehreren anderen <<auftraege/auftraege-verwalten#1700, Aufträgen gruppiert>> wurde, gibt es mehrere Referenzen vom Typ *Gruppiert*. Dies sind Referenzen zu den ursprünglichen Aufträgen. Man kann also sehen, ob der aktuelle Auftrag ein Originalauftrag ist oder aus mehreren Originalaufträgen gruppiert wurde. Wurde er gruppiert, werden die Auftrags-IDs der gruppierten Aufträge exportiert. +
* *Geteilt* = Wenn ein Auftrag in zwei neue <<auftraege/auftraege-verwalten#intable-splitting-orders, Aufträge geteilt>> wird, hat jeder der neuen Aufträge eine Referenz zum Originalauftrag, aus dem er hervorgegangen ist. In diesem Fall wird die Auftrags-ID des Auftrags, aus dem heraus geteilt wurde, exportiert.
...
[#110]
==== Einstellungen
In diesem Unterordner sind Datenfelder zu den <<auftraege/buchhaltung#150, Einstellungen zum Speichern und Runden von Preisen>> gruppiert.
...
| Exportiert die <<auftraege/buchhaltung#intable-preise-runden, Rundungseinstellungen>> für den Auftrag. +
0 = Es wird nicht gerundet. +
1 = Es wird gerundet. +
Der automatisch generierte Export key für dieses Feld ist *orderConfig.roundTotalsOnly*.

| *Anzahl der Dezimalstellen*
| Exportiert die gewählte Einstellung zur <<auftraege/buchhaltung#intable-preise-nachkommastellen, Anzahl von Nachkommastellen bei Preisen>> für den Auftrag. +
...
[#130]
==== Zahlungsbedingungen
In diesem Unterordner sind Datenfelder zu den <<auftraege/auftraege-verwalten#intable-zahlungsbedingungen-auftrag, Zahlungsbedingungen>> eines Auftrags gruppiert.
...
| *Herkunfts-ID*
| Exportiert die Herkunft der Auftragsposition. Die <<daten/interne-IDs#90, Herkunft>> wird als ID exportiert. Der automatisch generierte Export key für dieses Feld ist *orderItem.referrerId*.
...
| *Typ-ID*
| Exportiert den Typ der Auftragsposition. Der <<daten/interne-IDs#100, Typ>> wird als ID exportiert. Der automatisch generierte Export key für dieses Feld ist *orderItem.typeId*.

| *Attributwerte*
| Exportiert die <<artikel/einstellungen/attribute#, Attribute>> der Auftragsposition. Der automatisch generierte Export key für dieses Feld ist *orderItem.attributeValues*.
...
*_Beachte_*: Du musst für jedes Datenfeld aus diesem Unterordner auswählen, ob der Betrag in deiner eingestellten <<payment/waehrungen#30, Systemwährung>> oder der Auftragswährung ausgegeben werden soll. Es ist sinnvoll, auch immer die Datenfelder *Währung* und *Wechselkurs* hinzuzufügen. So stellst du sicher, dass alle benötigten Werte und Informationen auf einen Blick verfügbar sind.
...
| *Packstückart*
| Exportiert die Packstückart der Versandpakete als ID. Eine Auflistung aller Packstücke mit IDs findest du im Handbuchkapitel <<daten/interne-IDs#50, Packstücke>>. Der automatisch generierte Export key für dieses Feld ist *shippingPackage.packageType*.
...
Weitere Informationen zu Versandprofilen erhältst du im Handbuchkapitel <<fulfillment/versand-vorbereiten#1000, Versandprofil erstellen>>.
...
Weitere Informationen zu Versanddienstleistern erhältst du im Handbuchkapitel <<fulfillment/versand-vorbereiten#800, Versanddienstleister erstellen>>.
...
Weitere Informationen zu Adressen erhältst du im Handbuchkapitel <<crm/kontakte-verwalten#590, Adressen verwalten>>.
...
Die IDs sind im Kapitel <<daten/interne-IDs#20, Länder>> aufgelistet.
...
Weitere Informationen zu Kontakten erhältst du im Handbuchkapitel <<crm/kontakte-verwalten#90, Kontakte und Firmen verwalten>>.
...
Informationen zu Typen erhältst du im Handbuchkapitel <<crm/kontakte-verwalten#20, Typ erstellen>>.
...
Informationen zu Kundenklassen erhältst du im Handbuchkapitel <<crm/kontakte-verwalten#15, Kundenklasse erstellen>>.
...
Informationen zu Kontakten und zum Debitorenkotno erhältst du im Handbuchkapitel <<crm/kontakte-verwalten#intable-kontakt-bearbeiten-debitorenkonto, Kontakt bearbeiten>>.
