...
|*Nur Lagerdaten*
|Wähle diesen Filter, wenn du lediglich die Lagerdaten, wie die Lager-ID und den Lagernamen, exportieren möchtest. Standardmäßig werden mit diesem Filter die Daten aller Lager exportiert. Möchtest du allerdings nur die Daten bestimmter Lager exportieren, wähle zusätzlich den Filter *Lager*.
|====
