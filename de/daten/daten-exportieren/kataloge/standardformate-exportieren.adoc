...
| *Verbindung testen*
| Teste die Exporteinstellungen, die du eingegeben hast:

* Kann eine Verbindung zu dem Server hergestellt werden?
* Kann eine Exportdatei an dem Speicherort gespeichert werden?

*_Hinweis:_* Getestet wird nur, ob mit den aktuellen Exporteinstellungen ein Dateiexport möglich ist. Die Option prüft _nicht_, ob eine Verbindung zu einem Marktplatz hergestellt werden kann.
