...
Für den Export verschiedener Daten stehen dir verschiedene Standardformate zur Verfügung. Um zum Beispiel deine Warenbestände zu exportieren, nutzt du das Standardformat <<daten/daten-exportieren/katalog-warenbestaende#, Warenbestände>>. Zum Export von Artikeldaten steht das Standardformat <<daten/daten-exportieren/katalog-artikel#, Artikel>> zur Verfügung.

Bisher kannst du aber noch nicht alle Arten von Daten über Kataloge exportieren. Bis Standardformate für alle Datenarten verfügbar sind, kannst du weiterhin den <<daten-exportieren/FormatDesigner#, Formatdesigner>> nutzen.

* Wie du Kataloge mit Standardformaten erstellst, ist auf der Seite <<daten/daten-exportieren/dateiexport#, Standardformate erstellen>> beschrieben.
