...
:keywords: FormatDesigner, Format-Typen, Export, Data, Daten, Daten-Export, Datenexport, Daten exportieren, Newsletter-Empfänger, Newsletter exportieren, Newsletter-Daten, Newsletter-Daten exportieren
