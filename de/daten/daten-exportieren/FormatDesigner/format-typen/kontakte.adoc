...
:keywords: FormatDesigner, Format-Typen, Export, Data, Daten, Daten-Export, Datenexport, Daten exportieren, Kontakte, Kontaktdaten, Adressdaten, Firmendaten, Kontakt exportieren, Kontakte exportieren, Kontaktdaten exportieren
...
In <<tabelle-felder-kontakteigenschaften-kontakte>> werden Felder erläutert, die für den Export von Kontakteigenschaften zur Verfügung stehen.

[[tabelle-felder-kontakteigenschaften-kontakte]]
