...
:keywords: FormatDesigner, Format-Typen, Export, Data, Daten, Daten-Export, Datenexport, Daten exportieren, Auftragspositionen, Auftragspositionen exportieren, Auftragsposition exportieren
...
In <<tabelle-felder-orderitem-orderitemreference>> werden Felder erläutert, die für den Export von Daten zum Versanddienstleister der Auftragsposition zur Verfügung stehen.
