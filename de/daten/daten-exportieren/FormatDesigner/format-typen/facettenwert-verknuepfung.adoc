...
:keywords: FormatDesigner, Format-Typen, Export, Data, Daten, Daten-Export, Datenexport, Daten exportieren, Facette, Facettenwert, Facettenwerte, Facettenwert-Verknüpfung, Facette exportieren, Facetten exportieren, Facettenwert exportieren, Facettenwerte exportieren
