...
|id
|ID der ASIN. Diese ID brauchst du, wenn du <<daten/daten-importieren/sync-typen/elasticSync-artikel#2430, ASINs mit Hilfe von ElasticSync löschen>> möchtest. Die ID ist im plentymarkets Backend nicht sichtbar.
