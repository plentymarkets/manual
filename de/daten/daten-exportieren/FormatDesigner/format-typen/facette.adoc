...
:keywords: FormatDesigner, Format-Typen, Export, Data, Daten, Daten-Export, Datenexport, Daten exportieren, Facette, Facetten exportieren, Facette exportieren
:description: Mit Formaten des Typs facet exportierst du Facetten.
:position: 80
...
|name
|Der Facettenname in der Systemsprache. Also der Name, der beim <<artikel/frontend-artikelsuche-verwalten#100, Anlegen der Facette>> eingetragen wurde.
|====
