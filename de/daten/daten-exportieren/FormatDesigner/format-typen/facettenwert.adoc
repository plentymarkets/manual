...
:keywords: FormatDesigner, Format-Typen, Export, Data, Daten, Daten-Export, Datenexport, Daten exportieren, Facettenwert, Facette, Facettenwert exportieren, Facettenwerte exportieren
