...
:keywords: FormatDesigner, Format-Typen, Export, Daten, Data, Daten-Export, Datenexport, Daten exportieren, Artikelbild, Artikelbilder, Artikelbilder exportieren, Artikel-Bilder exportieren
