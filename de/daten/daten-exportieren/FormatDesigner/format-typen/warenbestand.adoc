...
:keywords: FormatDesigner, Format-Typen, Export, Data, Daten, Daten-Export, Datenexport, Daten exportieren, Warenbestand, Warenbestand exportieren, Bestand exportieren, Bestandsdaten exportieren, Warenbestandsdaten exportieren, Inventur, Artikeldaten exportieren
...
In <<tabelle-felder-Manufacturer>> werden Felder erläutert, die für den Export von Herstellerdaten zur Verfügung stehen.

[[tabelle-felder-Manufacturer]]
.Felder für den Export von Herstellerdaten
[cols="1,3"]
|====
|Feld |Erläuterung

|id
|<<artikel/einstellungen/hersteller#100, ID des Artikelherstellers>>

|name
|<<artikel/einstellungen/hersteller#100, Name des Artikelherstellers>>
|====
...
|<<warenwirtschaft/warenbestaende-verwalten#400, Durchschnittlicher Einkaufspreis>>

|reordered
|<<warenwirtschaft/warenbestaende-verwalten#400, Nachbestellte Menge>>

|reservedStock
|<<warenwirtschaft/warenbestaende-verwalten#400, Reservierter Bestand>>

|stockNet
|<<warenwirtschaft/warenbestaende-verwalten#400, Netto-Bestand>>

|stockPhysical
|<<warenwirtschaft/warenbestaende-verwalten#400, Physischer Bestand>>
