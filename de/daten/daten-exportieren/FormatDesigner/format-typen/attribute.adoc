...
:keywords: FormatDesigner, Format-Typen, Export, Daten, Data, Daten-Export, Datenexport, Daten exportieren, Attribute, Attribute exportieren, Attributdaten exportieren, Attribut exportieren
