...
. Klicke neben einem Datenfeld oder *Eigener Wert* auf das Plus. +
...
. Klicke links neben einem Datenfeld oder *Eigener Wert* auf das Plus. +
→ Das Datenfeld oder das Feld für den Eigenen Wert wird in der Ansicht hinzugefügt.
. Hast du *Eigener Wert* gewählt, gib einen Wert in das Eingabefeld darunter ein.
...
Die Umschaltfläche am linken Rand in der Katalog-Übersicht ermöglicht es dir, Kataloge für den Export zu aktivieren oder zu deaktivieren.
====
