...
*_Hinweis:_* Für den Dateinamen stehen die folgenden Platzhalter zur Verfügung: $name, $type, $format, $timestamp, $datetime, $year, $month, $day, $hour, $minute, $second.
...
//|Vergib einen Nummernkreis. Dieses Feld ist nur verfügbar, wenn du den Platzhalter _Nummernkreis_ nutzt. _Das Maximum des Nummernkreises ist durch die Anzahl der Stellen limitiert._
