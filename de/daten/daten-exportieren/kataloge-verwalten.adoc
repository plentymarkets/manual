...
*_Hinweis_*: Die Standardformate werden nach und nach in den Katalog überführt. Zurzeit ist lediglich das Format *Hersteller* verfügbar.
...
====
Im Tab *Eigene Datenfelder* in der Seitennavigation kannst du deine eigenen Datenfelder hinzufügen und diese selbst benennen. Achte darauf, für jedes Datenfeld einen individuellen Namen zu vergeben. +
 ...
 *_Hinweis_*: Zurzeit ist hier nur das Format *Hersteller* verfügbar.
