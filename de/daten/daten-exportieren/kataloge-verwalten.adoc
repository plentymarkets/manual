...
Im Tab *Einstellungen* eines Katalogs kannst du eine URL für den Download des Katalogs generieren. Dies ist sowohl mit einem sog. Admin-Link als auch mit einem öffentlichen Link möglich.
...
. Wähle einen Katalog. +
→ Der Katalog wird geöffnet.
. Öffne links das Tab *Einstellungen* (icon:cog[]) und wähle dort den Bereich *Download*. +
