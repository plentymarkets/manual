...
|Vergib einen Nummernkreis. Dieses Feld ist nur verfügbar, wenn du die Wildcard _Nummernkreis_ nutzt. _Das Maximum des Nummernkreises ist durch die Anzahl der Stellen limitiert._
