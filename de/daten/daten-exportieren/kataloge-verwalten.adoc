...
→ Alle zuvor hinzugefügten Datenfelder werden Schritt für Schritt gelöscht. *_Hinweis_*: Dies funktioniert nur, wenn du gerade Datenfelder hinzugefügt und noch nicht gespeichert hast.
...
Die Umschaltfläche am linken Rand in der Übersicht der Kataloge ermöglicht es dir, einen Katalog zu aktivieren oder zu deaktivieren.
====
