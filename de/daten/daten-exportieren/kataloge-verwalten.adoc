...
icon:map-signs[] *_Oder_*: Möchtest du eine komplette Zeile löschen, klicke rechts in der Zeile auf *Datenzeile löschen* (icon:trash-o[]). +
→ Die komplette Zeile wird gelöscht. +
icon:map-signs[] *_Oder_*: Setze links einen Haken für alle Datenfelder, die du löschen möchtest.
. Klicke anschließend rechts oben auf *Gewählte Datenfelder löschen* (icon:trash-o[]). +
