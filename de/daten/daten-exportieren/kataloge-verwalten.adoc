...
====
Du kannst Datenzeilen beliebig verschieben und so die Reihenfolge bestimmen, in der die Datenfelder exportiert werden sollen. Klicke dafür auf das Icon (icon:ellipsis-v[] icon:ellipsis-v[]) am linken Rand der Datenzeile und ziehe sie mit gedrückter Maustaste an den gewünschten Ort.
====
