...
| *Ebene*
|Beschränkt den Export auf <<artikel/einstellungen/kategorien#120, Kategorien einer bestimmten Ebene>>.
...
Die folgenden Filter stehen zur Verfügung, um die Aufträge vor dem Export zu filtern:
...
Die folgenden Filter stehen zur Verfügung, um <<warenwirtschaft/nachbestellungen-verwalten/nachbestellungen-vornehmen#, Nachbestellungen>> und <<warenwirtschaft/umbuchungen-vornehmen#, Umbuchungen>> vor dem Export zu filtern:
...
|*Abschlussdatum*
|Beschränkt den Export auf Nachbestellungen und Umbuchungen, die bereits abgeschlossen wurden, d.h. für die ein Abschlussdatum gesetzt wurde. Wähle nach dem Hinzufügen dieses Filters ein bestimmtes Datum oder einen Zeitraum mit Hilfe der Operatoren und der Datumsauswahl aus.

|*Aktualisierungsdatum*
|Beschränkt den Export auf Nachbestellungen und Umbuchungen, die an einem bestimmten Datum zuletzt geändert wurden. Wähle nach dem Hinzufügen dieses Filters ein bestimmtes Datum oder einen Zeitraum mit Hilfe der Operatoren und der Datumsauswahl aus.
...
|*Bestelldatum*
|Beschränkt den Export auf Nachbestellungen und Umbuchungen, die bereits ausgelöst wurden, d.h. für die ein Bestelldatum gesetzt wurde. Wähle nach dem Hinzufügen dieses Filters ein bestimmtes Datum oder einen Zeitraum mit Hilfe der Operatoren und der Datumsauswahl aus.

|*Empfängerlager*
|Beschränkt den Export auf Nachbestellungen und Umbuchungen, für das ausgewählte Lager als Empfängerlager ausgewählt ist. Das Empfängerlager ist das Lager, in das die Auftragspositionen eingebucht werden.

|*Erstellungsdatum*
|Beschränkt den Export auf Nachbestellungen und Umbuchungen, die an einem bestimmten Datum erstellt wurden. Wähle nach dem Hinzufügen dieses Filters ein bestimmtes Datum oder einen Zeitraum mit Hilfe der Operatoren und der Datumsauswahl aus.
...
|Beschränkt den Export auf Nachbestellungen und Umbuchungen, deren Auftragspositionen bereits geliefert wurden, d.h. für die ein Lieferdatum in den Auftragsdetails gesetzt wurde. Wähle nach dem Hinzufügen dieses Filters ein bestimmtes Datum oder einen Zeitraum mit Hilfe der Operatoren und der Datumsauswahl aus.

|*Senderlager*
|Dieser Filter funktioniert nur für Umbuchungen. Beschränkt den Export auf Umbuchungen, für das ausgewählte Lager als Senderlager ausgewählt ist. Das Senderlager ist das Lager, aus dem die Auftragspositionen ausgebucht werden.

|*Auftragsstatus*
|Beschränkt den Export auf Aufträge, die sich in den ausgewählten Auftragsstatus befinden.
_Dieser Filter ist eine Pflichtangabe._
...
|Beschränkt den Export auf die Auftragspositionen der gewählten Typen.

|*Varianten-ID*
|Durch Festlegung eines Operators und Eingabe einer Varianten-ID legst du fest, auf welche Aufträge der Export beschränkt werden soll. +
*=* = Nur Aufträge die genau diese Variante enthalten werden exportiert. +
*≠* = Alle Aufträge außer die, die diese Variante enthalten, werden exportiert. +
*<* = Alle Aufträge, die Varianten mit kleinerer ID als eingegebenen enthalten, werden exportiert. +
*≤* = Alle Aufträge, die Varianten mit kleinerer ID als eingegeben sowie mit genau dieser ID enthalten, werden exportiert. Gibst du z.B. 12 ein, werden die Aufträge mit Varianten der IDs 1 bis 12, inklusive der Variante mit ID 12 exportiert. +
*>* = Alle Aufträge, die Varianten mit größerer ID als der eingegebenen enthalten, werden exportiert. +
*≥* Alle Aufträge, die Varianten mit größerer ID als eingegeben sowie mit genau dieser ID enthalten, werden exportiert. Gibst du z.B. 12 ein, werden die Aufträge mit Varianten der IDs ab 12, inklusive der Variante mit ID 12, exportiert.

|*Variantennummer*
|Beschränkt den Export auf Aufträge, die Auftragspositionen mit der eingegebenen Variantennummer enthalten.

|*Versandprofil*
|Beschränkt den Export auf Aufträge, die die ausgewählten Versandprofile enthalten.
...
Die folgenden Filter stehen zur Verfügung, um die Umbuchungen und Nachbestellungen vor dem Export zu filtern:
...
|*Auftrags-ID*
|Durch Festlegung eines Operators und Eingabe einer Auftrags-ID legst du fest, auf welche Aufträge der Export beschränkt werden soll. +
*=* = Nur dieser eine Auftrag wird exportiert. +
*≠* = Alle Aufträge außer dieses eine werden exportiert. +
*<* = Alle Aufträge mit kleinerer ID als der eingegebenen werden exportiert. +
*≤* = Alle Aufträge mit kleinerer ID als der eingegeben sowie der Auftrag mit dieser ID werden exportiert. Gibst du z.B. 12 ein, werden die Aufträge von 1 bis 12, inklusive der Auftrag mit ID 12 exportiert. +
*>* = Alle Aufträge mit größerer ID als der eingegebenen werden exportiert. +
*≥* Alle Aufträge mit größerer ID als der eingegeben sowie der Auftrag mit dieser ID werden exportiert. Gibst du z.B. 12 ein, werden die Aufträge ab ID 12, inklusive der Auftrag mit ID 12 exportiert.
...
|*Empfängerlager*
|Beschränkt den Export auf die Aufträge, die Auftragspositionen mit den gewählten Lagern beinhalten.
