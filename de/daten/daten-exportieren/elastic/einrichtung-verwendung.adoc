...
| *Tag (UND-Modus)*
|Gib ein oder mehrere Tag-Namen ein. Artikel, die mit _allen_ der gewählten <<artikel/einstellungen/markierungen#400, Tags>> verknüpft sind, werden übertragen.

| *Tag (ODER-Modus)*
|Gib ein oder mehrere Tag-Namen ein. Artikel, die mit _mindestens einem_ der gewählten <<artikel/einstellungen/markierungen#400, Tags>> verknüpft sind, werden übertragen.
