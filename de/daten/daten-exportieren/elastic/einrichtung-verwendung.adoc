...
//Weitere Informationen zu diesem Marktplatz findest du auf der Handbuchseite <<maerkte/cdiscount#, Cdiscount einrichten>>.
...
//Weitere Informationen zur Einrichtung von Kauflux findest du auf der Handbuchseite <<maerkte/kauflux#, Kauflux einrichten>>.
...
| *RakutenDE*
|Auf dem Marktplatz link:https://marketplace.plentymarkets.com/plugins/markets/elasticexportrakutende_4721/[Rakuten^]{nbsp}icon:external-link[] bietest du deine Artikel zum Verkauf an.
//Weitere Informationen zur Einrichtung von Rakuten findest du auf der Handbuchseite <<maerkte/rakuten/rakuten-einrichten#, Rakuten einrichten>>.
...
=== Neue Exportformate erstellen

Dieses Kapitel beschreibt, wie du neue Exportformate erstellst und welche Einstellungen du vornehmen musst.
...
[#400]
=== Bestehende Exportformate suchen und bearbeiten
