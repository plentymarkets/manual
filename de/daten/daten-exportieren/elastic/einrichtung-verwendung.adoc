...
|*Herkunft*
|Beschränkt den Export auf die Aufträge, die über die ausgewählten Auftragsherkünfte generiert wurden.

|*Kontakt-ID*
|Durch Festlegung eines Operators und Eingabe einer Kontakt-ID legst du fest, auf welche Aufträge der Export beschränkt werden soll. +
...
*≤* = Alle Aufträge von Kontakten mit kleinerer ID als der eingegeben sowie der Auftrag des Kontakts mit dieser ID werden exportiert. Gibst du z.B. 12 ein, werden die Aufträge der Kontakte mit der ID von 1 bis 12, inklusive der Aufträge des Kontakts mit ID 12 exportiert. +
*>* = Alle Aufträge von Kontakten mit größerer ID als der eingegebenen werden exportiert. +
*≥* Alle Aufträge von Kontakten mit größerer ID als der eingegeben sowie der Auftrag des Kontakts mit dieser ID werden exportiert. Gibst du z.B. 12 ein, werden die Aufträge der Kontakte ab ID 12, inklusive der Aufträge des Kontakts mit der ID 12 exportiert.

|*Kundenklasse*
|Beschränkt den Export auf Aufträge, die die ausgewählten Kundenklassen enthalten.

|*Lager*
|Beschränkt den Export auf Aufträge, die die ausgewählten Lager enthalten.
...
|Beschränkt den Export auf Aufträge, deren Auftragspositionen an einem bestimmten Datum zuletzt geändert wurden. Wähle nach dem Hinzufügen dieses Filters ein bestimmtes Datum oder einen Zeitraum mit Hilfe der Operatoren und der Datumsauswahl aus.
...
|*Auftragsherkunft*
|Beschränkt den Export auf die Aufträge, die über die ausgewählten Auftragsherkunft generiert wurden.
...
|Beschränkt den Export auf die Aufträge, deren Auftragspositionen über die ausgewählten Auftragsherkünfte generiert wurden.

|*Hersteller*
|Beschränkt den Export auf die Aufträge, die Auftragspositionen mit den gewählten Herstellern beinhalten.
...
|Beschränkt den Export auf die Aufträge, die Auftragspositionen mit den gewählten Typen beinhalten.
