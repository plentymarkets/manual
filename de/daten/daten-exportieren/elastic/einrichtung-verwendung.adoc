...
Unter diesem Namen wird das Exportformat in der Übersicht erscheinen.

| *Typ*
|Welche Art von Daten möchtest du exportieren?
Wähle diesen Datentyp aus der Dropdown-Liste aus.

*_Hinweis_*: <<Zusätzliche Einstellungen>> werden eingeblendet, sobald du den Typ wählst.
Welche Einstellungen erscheinen, hängt vom Typ ab.

| *Format*
|Welches Datenformat möchtest du exportieren?
Wähle dieses Datenformat aus der Dropdown-Liste aus.

*_Hinweis_*: Zum einen sind dies die <<Datenformat-Plugins>>, die du aus plentyMarketplace heruntergeladen hast.
Zum anderen sind dies die Datenformate, die du mit Hilfe von <<FormatDesigner>> selbst erstellt hast.
...
Nimm auch die Einstellungen *Server*, *Port*, *Benutzername*, *Passwort*, *Pfad*, *Übertragung* und *Zeitplan* vor:
...
Welche Filter und Formateinstellungen du vornehmen musst, hängt davon ab, <<welchen Typ du gewählt hast>>.
...
| *Preise*
a|Beschränkt den Export auf Artikel mit einem bestimmten Preis.
