...
:position: 250
:url: daten/daten-exportieren/lagerdaten-exportieren
:id: FUM682Y
:author: team-stock
...
Um nur bestimmte Lagerdaten zu exportieren, kannst du Filter wählen und somit die Daten eingrenzen. Wie du Filter hinzufügst, erfährst du in <<daten/daten-exportieren/kataloge-verwalten#257, diesem Kapitel>>.
