...
* Du kannst die Datenfelder per <<daten/daten-exportieren/kataloge-verwalten#165, Drag-and-drop>> verschieben, um die Reihenfolge der Daten im Export anzupassen.
...
*_Oder_*: Setze links einen Haken für alle mit Datenfeldern gefüllten Zeilen, die du entfernen möchtest. Klicke anschließend rechts oben auf *Gewählte Datenfelder löschen* (icon:delete[set=material]). +
