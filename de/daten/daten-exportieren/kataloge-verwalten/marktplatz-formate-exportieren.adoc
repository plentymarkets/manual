...
! In der Navigation werden auch alle Kataloge gelistet, die du in deiner aktuellen Sitzung geöffnet hast. So kannst du schnell zwischen den Katalogen wechseln, die du aktuell bearbeitest. Der gerade angezeigt Katalog wird blau dargestellt, die anderen Kataloge in grau. +
...
! Eigene Datenfelder
! Eigene Datenfelder stehen für die meisten Exporte noch nicht zur Verfügung.
!===
...
| Im linken Bereich des Katalogs ordnest du den Marktplatz-Datenfeldern passende plentymarkets Datenfelder zu. Du bist dir nicht sicher, wie das geht? Keine Panik, dazu ist diese Handbuchseite da! +
*_Tipp:_* Im Screenshot wurden schon einige Felder zugeordnet.

|====

//TODO: In der Liste noch die einzelnen Optionen aufführen?
