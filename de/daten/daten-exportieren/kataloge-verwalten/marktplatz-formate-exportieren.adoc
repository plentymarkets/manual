...
Solange du noch keine Felder zugeordnet hast, siehst du hier weit und breit nur icon:plus[role="darkGrey"] *Datenfeld hinzufügen. Das ist ganz normal und soll so sein. +
...
--
include::../../../maerkte/_textblocks/catalogues/instructions/catalogue-mapping.adoc[simple-mappings-config]
--
...
[discrete]
===== Du ordnest dem Wert eines Marktplatz-Datenfeld den Wert 1 plentymarkets Datenfeld zu

include::../../../maerkte/_textblocks/catalogues/instructions/catalogue-mapping.adoc[complex-mappings]

[.collapseBox]
.Komplexe 1:1-Zuordnung erstellen
--
include::../../../maerkte/_textblocks/catalogues/instructions/catalogue-mapping.adoc[complex-mappings-config]
--
...
--
include::../../../maerkte/_textblocks/catalogues/instructions/catalogue-mapping.adoc[fallback-mappings-config]
--
...
--
include::../../../maerkte/_textblocks/catalogues/instructions/catalogue-mapping.adoc[1-to-n-mappings-config]
--
...
--
include::../../../maerkte/_textblocks/catalogues/instructions/catalogue-mapping.adoc[own-mappings-config]
--
