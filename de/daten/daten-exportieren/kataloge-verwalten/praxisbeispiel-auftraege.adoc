...
Hier wird im Export die ID des Versanddienstleisters ausgegeben, z.B. 2 als ID für DPD...
//Check: Liste mit den IDs? Überprüfen!
* *Dokumente > Dokumenttyp*
* *Dokumente > Benutzer-ID* +
Hier wird die ID der Person angegeben, die das Dokument erstellt hat.
