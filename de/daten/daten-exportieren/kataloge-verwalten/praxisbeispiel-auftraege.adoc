...
* *Auftrag > Lieferland* +
Wähle nach Hinzufügen des Datenfeldes aus, wie das Lieferland exportiert werden soll, z.B. als ISO-Code oder als ID.
* *Auftrag > Zahlungsart*
...
- Menge = Um aufschlüsseln zu können, welche Mengen welcher Artikel (wird durch IDs abgefragt) verkauft wurden.
...
Wähle nach Hinzufügen des Datenfelds den Dokumenttyp aus. Ausgegeben werden immer die Daten für das aktuelle Dokument.
