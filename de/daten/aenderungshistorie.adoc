...
//was bedeutet den ersten Satz?
//Mit plentymarkets kannst du Unterlagen mit finanzieller oder steuerlicher Relevanz über einen langen Zeitraum aufbewahren.
Mit plentymarkets kannst du Änderungen an diversen Datensätzen nachvollziehen.
...
Mit plentymarkets kannst du den gesamten Lebensweg eines Artikels oder eines Auftrags nachvollziehen.
Dies ist im Rahmen der Aufbewahrungspflicht von besonderer Bedeutung.

##start here##
der es euch ermöglicht, plentymarkets GoBD-konform im Sinne der Zertifizieren nach IDW PS 880 zu nutzen.

Die Änderungshistorie besteht aus der live durchsuchbaren Historie und dem Archiv. Live durchsuchbar sind alle geloggten Änderungen bis zu einem Maximalalter von 6 Monaten. Nach 6 Monaten werden die Änderungen für 11 Jahre in einer Monats-CSV zusammengefasst und archiviert.
##end here##

Im Menü *Daten » Änderungshistorie* kannst du nach Änderungsaufzeichnungen suchen, die weniger als sechs Monate zurückliegen.
Danach werden die Daten in ein Archiv verschoben.
//Alternativ - Danach werden die Daten im Menü *ABC » XYZ* verschoben.
...
Änderungen können in diesem Menü lediglich abgerufen und durchsucht werden.
====
