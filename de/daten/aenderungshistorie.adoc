...
[#100]
== Änderungshistorie (ab 15.02.2021 verfügbar)
...
Du kannst die Änderungshistorie bis 15.03.2021 kostenlos testen.
Danach fallen verbrauchsabhängig die folgenden Kosten an:
...
Ja.
Du kannst deinen Verbrauch, also deine tatsächlichen Kosten, im <<business-entscheidungen/plenty-bi/myview-dashboard#, plentyBI Dashboard>> einsehen.
Du wirst die Anzahl der geloggten Änderungen tagesaktuell über eine kostenlose plentyBI Kennzahl einsehen können.
