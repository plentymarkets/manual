...
====
Nutze die obere Schaltfläche (icon:toggle-on[role="blue"]), um alle für die GoBD-Konformität notwendigen Einstellungen gleichzeitig zu aktivieren.
Diese Option aktiviert das Archiv und alle mit einem Sternchen markierten Datenfelder.
====
