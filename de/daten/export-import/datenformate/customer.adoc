...
Das Datenformat *Customer* wird verwendet, um Kundenstammdaten zu exportieren. Sie erstellen und exportieren das Datenformat im Menü *Daten » Dynamischer Export*. Wie Sie das Datenformat exportieren, ist auf der Handbuchseite <<daten/export-import/daten-exportieren#, Daten exportieren>>.
