...
:keywords: Datenformat, Dynamischer Export, Dynamischer Import, ItemImageReference
:description: Datenformat ItemImageReference
:position: 210
:url: daten/export-import/datenformate/itemimagereference
:id: TPMJ6ZL
:author: team-item

Mit dem Datenformat **ItemImageReference** exportierst, bearbeitest und importierst du die Bildverfügbarkeiten von im Tab **Bilder** eines Artikels verknüpften Artikelbildern. Du erstellst und exportierst das Datenformat im Menü **Daten » Dynamischer Export**. Importiere das Datenformat wieder im Menü **Daten » Dynamischer Import**. Wie du das Datenformat exportierst und importierst, ist auf den Handbuchseiten <<daten/export-import/daten-exportieren#, Daten exportieren>> und <<daten/export-import/daten-importieren#, Daten importieren>> beschrieben.
