...
Detaillierte Informationen zur Vorgehensweise beim Datenaustausch mit dem Datenformat **Stock** finden Sie im Kapitel <<daten/export-import/daten-exportieren#90, Warenbestände exportieren>> auf der Handbuchseite **Daten exportieren**.
