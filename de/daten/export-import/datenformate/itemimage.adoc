...
:keywords: Datenformat, Dynamischer Export, Dynamischer Import, ItemImage
:description: Datenformat ItemImage
:position: 190
:url: daten/export-import/datenformate/itemimage
:id: LQK63HJ
:author: team-item

Mit dem Datenformat **ItemImage** bearbeitest du die Optionen von im Tab **Bilder** eines Artikels verknüpften Artikelbildern. Mit diesem Datenformat exportierst, bearbeitest, importierst und löschst du Artikelbilder. Du erstellst und exportierst das Datenformat im Menü **Daten » Dynamischer Export**. Importiere das Datenformat wieder im Menü **Daten » Dynamischer Import**. Wie du das Datenformat exportierst und importierst, ist auf den Handbuchseiten <<daten/export-import/daten-exportieren#, Daten exportieren>> und <<daten/export-import/daten-importieren#, Daten importieren>> beschrieben.
