...
Das Datenformat *ItemListingMarket* wird verwendet, um neue Listings zu erstellen oder bestehende Listings zu bearbeiten. Du kannst z.B. einzelne Parameter ändern oder löschen. Du erstellst und exportierst das Datenformat im Menü *Daten » Dynamischer Export*. Importiere das Datenformat wieder im Menü *Daten » Dynamischer Import*. Wie du das Datenformat importierst und exportierst, ist auf den Handbuchseiten <<daten/export-import/daten-exportieren#, Daten exportieren>> und <<daten/export-import/daten-importieren#, Daten importieren>> beschrieben.
