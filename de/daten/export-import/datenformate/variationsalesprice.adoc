...
|Live-Umrechnung des Verkaufspreises, wie im Menü **System » Systemeinstellungen » Artikel » Verkaufspreise** aktiviert
|

|**SalesPriceLang**
|Sprache des Verkaufspreises, wie im Menü **System » Systemeinstellungen » Artikel » Verkaufspreise » Verkaufspreis öffnen » Tab: Sprache** eingegeben
