...
Das Datenformat **Warehouse** dient zum Export der Daten, die für die Lagerkonfiguration benötigt werden. Du erstellst und exportierst das Datenformat im Menü **Daten » Dynamischer Export**. Wie du das Datenformat exportierst, ist auf der Handbuchseite <<daten/export-import/daten-exportieren#, Daten exportieren>> beschrieben.
