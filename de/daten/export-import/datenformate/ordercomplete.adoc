...
Mit dem Datenformat **OrderComplete** exportieren Sie Aufträge. Dieses Datenformat steht ausschließlich für den Export zur Verfügung. Sie erstellen und exportieren das Datenformat im Menü **Daten » Dynamischer Export**. Wie Sie das Datenformat exportieren, ist auf der Handbuchseite <<daten/export-import/daten-exportieren#, Daten exportieren>> beschrieben.
...
Die IDs der Länder werden im Menü **System » Systemeinstellungen » Aufträge » Versand » Optionen » Tab: Lieferländer** angezeigt.
|
