...
Mit dem Datenformat *CustomerProperty* exportieren Sie die im Menü <<crm/kontakte-verwalten#4000, System » Systemeinstellungen » CRM » Eigenschaften>> gespeicherten Kundeneigenschaften. Sie erstellen und exportieren das Datenformat im Menü *Daten » Dynamischer Export*. Wie Sie das Datenformat exportieren, ist auf der Handbuchseite <<daten/export-import/daten-exportieren#, Daten exportieren>> beschrieben.
