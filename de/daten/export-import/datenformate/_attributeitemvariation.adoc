...
Das Datenformat **AttributeItemVariation** wird verwendet, um Artikelvarianten zu exportieren, zu bearbeiten und zu importieren. Beachten Sie auch das Kapitel <<basics/datenaustausch/export-import/daten-importieren#60, Varianten importieren>> auf der Handbuchseite **Daten importieren**.
