...
:keywords: Datenformat, Dynamischer Export, Dynamischer Import, Attribute
...
Das Datenformat **Attribute** wird für Attribute und Attributwerte verwendet. Du kannst mit diesem Datenformat keine Varianten erstellen. Du erstellst und exportierst das Datenformat im Menü **Daten » Dynamischer Export**. Importiere das Datenformat wieder im Menü **Daten » Dynamischer Import**. Wie du das Datenformat exportierst und importierst, ist auf den Handbuchseiten <<daten/export-import/daten-exportieren#, Daten exportieren>> und <<daten/export-import/daten-importieren#, Daten importieren>> beschrieben.
