...
:keywords: Datenformat, Dynamischer Export, Dynamischer Import, VariationCategories
...
Das Datenformat **VariationCategories** wird verwendet, um Kategorieverknüpfungen von Varianten zu exportieren, zu bearbeiten und zu importieren. Du kannst auch mit dem Datenformat <<daten/export-import/datenformate/variation#, Variation>> Kategorieverknüpfungen per Datenaustausch bearbeiten. Das Datenformat **VariationCategories** ist jedoch besonders geeignet, um Mehrfachverknüpfungen pro Variante vorzunehmen oder zu bearbeiten. +
