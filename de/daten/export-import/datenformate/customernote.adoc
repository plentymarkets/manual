...
Mit dem Datenformat *CustomerNote* exportieren Sie Notizen, die in Kundendaten erstellt wurden. Notizen befinden sich im gleichnamigen Tab in den Kundendaten. Sie erstellen und exportieren das Datenformat im Menü *Daten » Dynamischer Export*. Wie Sie das Datenformat exportieren, ist auf der Handbuchseite <<daten/export-import/daten-exportieren#, Daten exportieren>> beschrieben.
