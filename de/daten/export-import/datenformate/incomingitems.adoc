...
Verwenden Sie das Datenformat **IncomingItems**, um nur bestimmte Wareneingänge und keinen kompletten Warenbestand zu importieren. Wie Sie den kompletten Warenbestand importieren, ist im Kapitel <<daten/export-import/daten-importieren#120, Warenbestand importieren>> auf der Handbuchseite <<daten/export-import/daten-importieren#, Daten importieren>> beschrieben.
