...
:keywords: Datenformat, Dynamischer Export, Dynamischer Import, Category
...
Mit dem Datenformat **Category** legst du Artikelkategorien an oder bearbeitest sie. Das Datenformat ist besonders zum Übersetzen von Kategorien geeignet. Exportiere zur Übersetzung von Deutsch nach Englisch z.B. alle Kategorien in der Sprache **de**. Übersetze dann die Kategorienamen und ändere dabei den Wert in der Spalte **lang** in die gewünschte Sprache, z.B. **en**, bevor du die Datei wieder importierst. Du erstellst und exportierst das Datenformat im Menü **Daten » Dynamischer Export**. Importiere das Datenformat wieder im Menü **Daten » Dynamischer Import**. Wie du das Datenformat exportierst und importierst, ist auf den Handbuchseiten <<daten/export-import/daten-exportieren#, Daten exportieren>> und <<daten/export-import/daten-importieren#, Daten importieren>> beschrieben.
