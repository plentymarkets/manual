...
. Die Domain-Einstellungen variieren je nachdem, mit welchem Domain-Typ du gerade arbeitest. Mit anderen Worten, während du die Domain in deinem plentymarkets System konfigurierst, siehst du möglicherweise nicht jede einzelne Einstellung, die auf dieser Seite erklärt wird.
...
. <<basics/admin-aufgaben/plentymarkets-konto#50, Rufe den Domain-Assistenten auf>> und navigiere zum Schritt *Domain Typ*.
...
|Über diese Option verknüpfst du eine bestehende externe Domain mit dem plentymarkets System. Die IP-Adresse der Domain wird dann in der Domain-Übersicht angezeigt. Speichere dann die <<basics/admin-aufgaben/plentymarkets-konto#160, DNS-Daten>>, im DNS-Zonenbereich deines Hosting-Dienstleisters. Sollte eine IPv6-A-Record in deiner extern verwalteten Domain vorhanden sein, entferne dieses IPv6-A-Record.
...
. <<basics/admin-aufgaben/plentymarkets-konto#50, Rufe den Domain-Assistenten auf>> und navigiere zum Schritt *Domain benennen*.
...
. <<basics/admin-aufgaben/plentymarkets-konto#50, Rufe den Domain-Assistenten auf>> und navigiere zum Schritt *Auswahl des Mandanten*.
...
. <<basics/admin-aufgaben/plentymarkets-konto#50, Rufe den Domain-Assistenten auf>> und navigiere zum Schritt *Domain-Handle*. +
*_Hinweis_*: Dieser Schritt erscheint nur, wenn du im Schritt <<basics/admin-aufgaben/plentymarkets-konto#100, Domain Typ>> die Option *Neue, über plentysystems gehostete, Domain bestellen* gewählt hast.
...
====
Weitere Informationen zu DNS-Einstellungen findest du in <<basics/admin-aufgaben/best-practices/dns-selbsthilfe#, diesem praktischen Beispiel>>. Die Seite führt dich Schritt für Schritt durch den Prozess, deine aktuell gespeicherten DNS-Einträge zu finden und sie bei Bedarf zu ändern.
====
...
. <<basics/admin-aufgaben/plentymarkets-konto#50, Rufe den Domain-Assistenten auf>> und navigiere zum Schritt *Aktuelle DNS Einstellungen*. +
*_Hinweis_*: Dieser Schritt erscheint nur, wenn du im Schritt <<basics/admin-aufgaben/plentymarkets-konto#100, Domain Typ>> die Option *Neue, extern gehostete, Domain hinterlegen* gewählt hast.
...
. <<basics/admin-aufgaben/plentymarkets-konto#50, Rufe den Domain-Assistenten auf>> und navigiere zum Schritt *Auswahl der erweiterten Einstellungen*. +
...
image::basics/admin-aufgaben/assets/CNAME-Konfiguration.png[]
...
Wenn du ein SSL-Zertifikat für eine andere Domain einrichten möchtest, musst du <<basics/admin-aufgaben/plentymarkets-konto#210a, diese Domain zunächst als Hauptdomain festlegen>>.

.Domain-Assistent in Tabellenansicht
image::basics/admin-aufgaben/assets/hauptdomain.png[]
...
Eine externe Domain kannst du beim externen Hoster belassen und <<basics/admin-aufgaben/plentymarkets-konto#160, die DNS-Einstellungen bei diesem externen Hoster speichern>>. Das SSL-Zertifikat muss jedoch systemnah liegen, also auch wenn die Domain bei einem anderen Hoster liegt, erfolgt die Verschlüsselung erst nach der Weiterleitung über die IP-Adresse bei plentymarkets im System. Daher muss das SSL-Zertifikat bei plentymarkets gebucht werden, da plentymarkets aus Sicherheitsgründen keine externen Zertifikate zulässt.
...
* Die Domain, für die das SSL-Zertifikat bestellt werden soll, muss eine <<basics/admin-aufgaben/plentymarkets-konto#280, Primärdomain>> sein. +
...
→ Wenn die Parent-Domain aus dem Assistenten entfernt wurde, legst du die Parent-Domain neu an. Wenn diese Parent-Domain nicht auf plentymarkets zeigen soll, sondern z.B. auf Shopware, versehe die Parent-Domain mit einem externen A-Record, indem du eine <<basics/admin-aufgaben/plentymarkets-konto#210a, Systemverknüpfung erstellst>>.

==== Bei externen Domains: DNS-Einstellungen

* Die beim <<basics/admin-aufgaben/plentymarkets-konto#160, externen Provider gespeicherten DNS-Einstellungen>> müssen mit den DNS-Einstellungen im Assistenten identisch sein. +
