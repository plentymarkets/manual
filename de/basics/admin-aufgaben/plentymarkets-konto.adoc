...
Speichern Sie außerdem im Menü <<payment/bankdaten-verwalten#70, System » Aufträge » Zahlung » EBICS>> die dort bereits hinterlegten Daten erneut, um die Grundeinstellungen zu aktualisieren.
====
