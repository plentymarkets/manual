...
//Im Konfigurationsschritt *Aktuelle DNS Einstellungen* werden die DNS-Einstellungen deiner Domain angezeigt.
...
. Öffne das Menü *Einrichtung » Assistenten » Grundeinrichtung*.
. Klicke auf den Domains-Assistenten.
. Klicke auf _eine der zuvor abgeschlossenen Domains_, um den Assistenten erneut zu öffnen.
...
Im Menü *plentymarkets Logo (Start) » Mein Konto » Agentur* gibst du zertifizierten Dienstleistern Zugriff auf bestimmte Bereiche deines Systems. Du ermöglichst damit einer Design-Agentur und/oder einem Consultant folgende Arbeiten in deinem plentymarkets System:
...
//<<tabelle-konto-verbrauchsdaten>> bietet einen Überblick der in diesem Menü angezeigten Daten zu deinem Verbrauch.
////
