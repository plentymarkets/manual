...
Im Menü *plentymarkets Logo (Start) » Service-Center » Tab: Vertrag* werden Informationen zu deinem laufenden plentymarkets Vertrag angezeigt. Über dieses Menü nimmst du Änderungen an deinem Vertrag vor oder gibst eine Kündigung deines Vertrags in Auftrag.
...
//Vorsicht - diese URL nicht verändern, da der Domain-Assistent direkt auf dieser Kapitel verlinkt
