...
Im Menü *plentymarkets Logo (Start) » Service-Center* findest du Informationen und Einstellungsmöglichkeiten zu deinem plentymarkets System. Im Service-Center kannst du selbständig Änderungen vornehmen, zum Beispiel Module buchen, Domains oder Subdomains bestellen oder deinen Vertrag ändern.
