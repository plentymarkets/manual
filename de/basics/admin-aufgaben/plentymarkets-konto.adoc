...
Speichere zum Beispiel einen Nameserver für Subdomains, um Newsletter2Go-Newsletter über eine link:https://www.newsletter2go.de/features/newsletter-versand-dedizierte-ips/[dedizierte IP-Adresse^] zu versenden und so die Zustellraten weiter zu optimieren. Wenn du diesen Service von Newsletter2Go gebucht hast, gibst du als Ziel-Server den Newsletter2Go-Nameserver an. Die erforderlichen Informationen zu Subdomains und Nameserver erhältst du von Newsletter2Go.
