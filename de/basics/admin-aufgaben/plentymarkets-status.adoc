...
====
Wenn du deine E-Mail-Adresse im Benutzerkonto geändert hast, ist es notwendig, dass du plentymarkets Status wie oben beschrieben einmal <<basics/admin-aufgaben/plentymarkets-status#plentymarkets-status-abbestellen,  abbestellst>> und anschließend erneut <<basics/admin-aufgaben/plentymarkets-status#plentymarkets-status-abonnieren, abonnierst>>. +
Dieses Vorgehen ist notwendig, damit dein plentymarkets System die Änderung der E-Mail-Adresse erkennt und zukünftig die Status-E-Mails an die von dir gewünschte E-Mail-Adresse versendet werden.
====
