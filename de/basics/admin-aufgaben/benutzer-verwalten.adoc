...
Zur Session-Verwaltung gelangt der Admin im Backend über das Menü *System » Systemeinstellungen » Einstellungen » Benutzer » Session-Verwaltung* oder über das User-Icon oben rechts.
