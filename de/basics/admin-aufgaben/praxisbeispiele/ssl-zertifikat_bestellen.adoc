= Praxisbeispiel: SSL-Zertifikat bestellen
:lang: de
...
image::basics/admin-aufgaben/best-practices/assets/monatlichen_kosten.png[width=640, height=360, alt=Monatliche Kosten]
