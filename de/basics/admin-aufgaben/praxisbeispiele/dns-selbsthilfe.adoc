...
image::basics/admin-aufgaben/best-practices/assets/DNS-Einstellungen.png[width=640, height=360, alt=DNS-Einstellungen]

Gleiches gilt für alle anderen Sub-Domains.
====

== Hinterlege DNS-Einstellungen prüfen
...
+
image::basics/admin-aufgaben/best-practices/assets/dnsselbsthilfe_pic004.png[width=640, height=360, alt=A-Record ermitteln]
...
+
image::basics/admin-aufgaben/best-practices/assets/dnsselbsthilfe_pic005.png[width=640, height=360, alt=CNAME-Record ermitteln]
...
image::basics/admin-aufgaben/best-practices/assets/DNS-Einstellungen.png[width=640, height=360, alt=Beispiel DNS-Einstellungen]
