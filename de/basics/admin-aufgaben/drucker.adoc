...
. Öffne das Menü *System » Systemeinstellungen » Einstellungen » Drucker*.
...
. Nimm die Einstellungen vor. Beachte dazu die Erläuterungen in <<tabelle-druckerkonfiguration-erstellen>>.
...
[[tabelle-druckerkonfiguration-erstellen]]
.Druckerkonfiguration erstellen
[cols="1,3"]
|====
...
*_Hinweis zum ZPL-Plugin:_* Für eine optimale Nutzung des ZPL-Plugins muss der Drucker unter Mac OSX über das CUPS-Webinterface im <<basics/admin-aufgaben/drucker#65, RAW-Modus>> hinzugefügt werden.
|====
...
<<tabelle-fehlermeldungen-menue-drucker>> enthält Informationen zu Fehlercodes, die beim Einrichten des Druckers auftreten können.

[[tabelle-fehlermeldungen-menue-drucker]]
...
→ Mac OSX: Stelle den Druckertreiber ZPL ein. Teste die Treibereinstellung für jede Etikettengröße. Um das Drucker-Plugin *ZPL* zu nutzen, richte den Drucker für den <<basics/admin-aufgaben/drucker#65, RAW-Druck>> ein.
...
. Wähle im Menü *System » Systemeinstellungen » Einstellungen » Drucker* das Drucker-Plugin *ZPL*, um den Drucker hinzuzufügen.
