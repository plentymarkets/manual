...
|*DHL Wunschpaket*
|Richte die DHL Wunschpaket-Services für den Versand aus Deutschland in deinem Ceres-Webshop ein. Das Plugin muss in einem Plugin-Set installiert und bereitgestellt sein. Kaufe es dafür auf link:https://marketplace.plentymarkets.com/plugins/integration/dhlwunschpaket_5435[plentyMarketplace^] und installiere es in einem Plugin-Set.
