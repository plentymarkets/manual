...
Am Donnerstag den 24. Mai 2018 wird ein Update von plentymarkets veröffentlicht, um den Vertragsabschluss zur Auftragsverarbeitung i.S.d. Art. 28 Abs. 3 der DSGVO digital abwickeln zu können. Der Vertragsabschluss erfolgt digital im link:https://marketplace.plentymarkets.com/[plentyMarketplace^].

[.instruction]
Vertragsabschluss digital abwickeln:

. Öffne das Menü *Plugins » plentyMarketplace*.
. Klicke auf das Benutzersymbol oben rechts und dann auf *Mein Konto* (icon:user[role="darkGrey"]).
...
Weitere Informationen findest du auf der Handbuchseite <<crm/kontakte-verwalten#1707, Kontakte>>.
