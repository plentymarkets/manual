...
Der Vertragsabschluss erfolgt digital im Bereich *Verträge*. Den Menüpunkt findest du als Admin-Benutzer im Terra-Backend von plentymarkets. Unter dem ersten Menüpunkt (*plentymarkets Logo (Start)*) befindet sich dann der neue Eintrag *Verträge*.
