...
. Öffnen Sie das Menü **System » Mandant » Mandant öffnen » Webshop » Shop sperren**.
...
. Öffnen Sie das Menü **System » Mandant » Mandant öffnen » E-Mail » Zugangsdaten**.
...
. Öffnen Sie das Menü **System » Mandant » Mandant öffnen » E-Mail » Infodienst**.
...
Ein PDF-Anhang, z.B. eine Rechnung, wird im Menü **System » Mandant » Mandant öffnen » Standorte » Deutschland (Standard) » Dokumente** erzeugt. Ein Dokumentenanhang für andere Dateien ist z.B. ein Artikelprospekt oder eine Anleitung und wird im Menü **CMS » Dokumente** gespeichert.
...
. Öffnen Sie das Menü **System » Mandant » Mandant öffnen » Standorte » Standort öffnen » Dokumente**.
...
. Öffnen Sie das Menü **System » Mandant » Mandant öffnen » Bestellvorgang » Einstellungen**.
...
. Öffnen Sie das Menü **System » Mandant » Mandant öffnen » Kategorien » Einstellungen**.
...
. Öffnen Sie das Menü **System » Mandant » Mandant öffnen » SEO » URL-Aufbau » Artikel**.
...
Im Menü **<<omni-channel/online-shop/mandanten-verwalten, System » Mandant » Mandant öffnen » Einstellungen>>** geben Sie den Namen für Ihren Webshop ein. Außerdem werden hier die ID Ihres Webshops sowie weitere Grunddaten, darunter die Domain und die Sprache, angezeigt.

[#620]
==== Grundeinstellungen für Ihren Webshop vornehmen

Im Menü **<<omni-channel/online-shop/webshop-einrichten#grundeinstellungen, System » Mandant » Mandant öffnen » Webshop » Einstellungen>>** nehmen Sie Einstellungen Ihres Webshops vor.
...
Die Einstellungen im Menü <<omni-channel/online-shop/cms-syntax#fallbeispiele-seo-guide, **System » Mandant » Mandant öffnen » SEO » Metadaten**>> sind relevant für die Suchmaschinenoptimierung. Metadaten sind Informationen in Ihren Webseiten, die für Suchmaschinen eine wichtige Informationsquelle darstellen, die aber Besucher nicht (oder nur indirekt) sehen.
...
. Öffnen Sie das Menü **System » Mandant » Mandant öffnen » SEO » Metadaten**.
...
Im Menü <<omni-channel/online-shop/webshop-einrichten/bestellvorgang#, **System » Mandant » Mandant öffnen » Bestellvorgang » Einstellungen**>> individualisieren Sie den Bestellvorgang in Ihrem Webshop. Bei vielen Angaben können Sie wählen, ob diese dem Webshop-Besucher angezeigt werden sollen oder nicht.
...
. Öffnen Sie das Menü **System » Mandant » Mandant öffnen » Webshop » Multilingual**.
