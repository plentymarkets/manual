...
|Konten wählen, die genutzt werden sollen, wenn mehrere <<omni-channel/multi-channel/eBay/ebay-einrichten#30, Konten bei eBay>> bestehen (Mehrfachauswahl möglich).

|**Listing-Typ (nur für eBay)**
|<<omni-channel/multi-channel/eBay/ebay-einrichten#350, Listing-Typen>> wählen, für die das Profil gelten soll (Mehrfachauswahl möglich).
|====
