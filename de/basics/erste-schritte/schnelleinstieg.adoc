...
Die Bankdaten, die in den Einstellungen zentral gepeichert werden, sind im gesamten System verfügbar. Die Bankdaten können auch im Webshop angezeigt werden.
