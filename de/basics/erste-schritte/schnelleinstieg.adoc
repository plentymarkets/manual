...
Sie können eigene Schriftarten entweder über eine *Schrift-URL* einfügen oder als Datei hochladen. Hinterlegen Sie jeweils eine Schriftart in den Feldern *Reguläre Font-Datei*, *Bold Font-Datei* (fettgedruckte Schrift), *Italic Font-Datei* (kursivgedruckte Schrift) und *Bold-Italic Font-Datei* (kursiv- und fettgedruckte Schrift).
