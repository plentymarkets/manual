...
[TIP]
.Mandantenauswahl im Shop Builder

In der Dropdown-Liste kann ein Mandant ausgewählt werden. Die Seitenvorschau zeigt dann die für den Mandanten vorgenommenen Einstellungen an (z.B. welche Artikel sichtbar sind).
