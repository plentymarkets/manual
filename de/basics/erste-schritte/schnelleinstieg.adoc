...
Im Menü **<<omni-channel/online-shop/webshop-einrichten#grundeinstellungen, Einstellungen » Mandant (Shop) » Standard » Webshop » Grundeinstellungen>>** nehmen Sie Einstellungen Ihres Webshops vor.
...
Im Menü <<omni-channel/online-shop/webshop-einrichten/bestellvorgang#, **Einstellungen » Mandant (Shop) » Standard » Bestellvorgang » Grundeinstellungen**>> individualisieren Sie den Bestellvorgang in Ihrem Webshop. Bei vielen Angaben können Sie wählen, ob diese dem Webshop-Besucher angezeigt werden sollen oder nicht.
...
plentymarkets bietet Ihnen im Menü <<basics/automatisierung/ereignisaktionen#, **Einstellungen » Aufträge » Ereignisaktionen**>> hierfür eine wirkungsvolle Möglichkeit, da Sie viele dieser Routineaufgaben automatisch ausführen lassen und Ihren Webshop damit äußerst effizient führen können.
