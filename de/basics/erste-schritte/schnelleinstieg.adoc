...
→ Der Bereitstellungsprozess wird angestoßen. Der Vorgang kann etwas Zeit in Anspruch nehmen.
...
|Aktivieren, um die mit dem Shop Builder erstellte Startseite anzuzeigen. Diese Option muss *aktiviert* sein, um Ihre individuelle Startseite im Webshop anzuzeigen.
...
[#615]
===== Ceres-Startseite mit dem Shop Builder erstellen

Mit dem Shop Builder können Sie die Startseite Ihres Ceres Webshops mit wenigen Handgriffen in Ihrem Backend per Drag&Drop erstellen und bearbeiten.

[WARNING]
.Versionsvoraussetzungen für den Shop Builder
====
Der Shop Builder ist erst ab Version 2.8.1 von Ceres und IO verfügbar. Sollten Sie eine ältere Version benutzen, können Sie die aktuelle Version der Plugins im Menü *Plugins » Plugin Übersicht* installieren.
====

===== Ceres-Startseite mit dem Shop Builder bearbeiten

Sie erreichen den Shop Builder im Menü *CMS » Shop Builder*. Im Vorschaubereich können Sie der Startseite Elemente hinzufügen, um die Seite Ihren individuellen Bedürfnissen anzupassen.

[NOTE]
.Anzeigen der mit dem Shop Builder erstellten Startseite
====
Beachten Sie, dass die im Shop Builder erstellte Startseite erst aktiviert werden muss. Hierzu wählen Sie unter *CMS » Shop Builder » Übersicht » Einstellungen » Startseite* die Option *Shop Builder Startseite anzeigen* und deaktivieren die Option *Standardstartseite anzeigen*.
====
...
[.instruction]
Schriftarten im Shop Builder verwalten:
...
===== Seite im Shop Builder erstellen

In der Übersicht des Shop Builders gibt es die Möglichkeit, Seiten zu erstellen und diese zu benennen.
