...
[%interactive]
* [ ] Haben Sie den <<#270, Artikelkatalog>> mit allen Beschreibungstexten aufgebaut?
* [ ] Wurden die Texte für die <<#340, Artikelverfügbarkeit>> angepasst?
* [ ] Ist die <<#340, Artikelverfügbarkeit>> korrekt gesetzt?
