...
Der Schnelleinstieg ist in die Kapitel <<#10, Basiseinstellungen>>, <<#270, Webshop einrichten>> und <<#690, Automatismen einrichten>> untergliedert, die jeweils einen Teilbereich der Einrichtung Ihres Webshops abdecken. Arbeiten Sie diese Kapitel in der bestehenden Reihenfolge durch, da die Kapitel aufeinander aufbauen. Die schnelle Einrichtung eines funktionsfähigen Webshops steht im Vordergrund, weshalb nur die dafür notwendigen Funktionen beschrieben sind.
...
// TODO: Prüfen, inwiefern hier der Port 587 für Ceres hinterlegt werden muss.
...
// TODO: Prüfen, ob die Tracking-URL noch aktuell ist, da in einem neu gebuchten System folgende URL hinterlegt ist:
// http://nolp.dhl.de/nextt-online-public/set_identcodes.do?lang=de&zip=[PLZ]&idc=[PaketNr] --> Die Variablen sehen anders aus.
...
// TODO: Ist hier ein Hinweis auf Plugin-Zahlungsarten nötig?
...
❏ Sind die <<#120, E-Mail-Kontodaten>> (für Benachrichtigungen an Kunden) im System eingegeben?

❏ Wurde der <<#130, Testmodus>> aktiviert, damit alle E-Mails an den Administrator gesendet werden?

❏ Wurde der <<#140, E-Mail-Infodienst>> eingerichtet?

❏ Enthalten alle <<#150, E-Mail-Vorlagen>> die Variable *Link_Checkout()*?

❏ Sind alle <<#170, Lieferländer>> mit gleichen Portokosten zu <<#180, Regionen>> gruppiert?

❏ Sind alle <<#170, Lieferländer>> einer <<#180, Region>> zugeordnet?

❏ Wurden alle <<#190, Versanddienstleister>> inklusive Tracking-URL erstellt?

❏ Liegt für alle folgenden Optionen ein gültiges <<#200, Versandprofil>> vor?
...
❏ Haben Sie Ihre <<#210, Portotabellen>> für alle Regionen erstellt?

❏ Wurde für mindestens ein <<#200, Versandprofil>> die Option *Bei neuen Artikeln aktivieren* gewählt?

❏ Wurde mindestens eine <<#230, Zahlungsart>> für jedes Lieferland freigeschaltet?

❏ Haben Sie Kontakt zu den Zahlungsanbietern hergestellt, die Sie nutzen möchten?

❏ Haben Sie <<#250, Prioritäten>> bei Versand und Zahlung definiert?
...
Wenn Sie die Warenbestände nicht in plentymarkets führen möchten, wählen Sie im Menü *Artikel » Artikel bearbeiten* im Tab *Varianten-ID » Einstellungen* bei der Einstellung *Beschränkung* die Option *Keinen Warenbestand für diese Variante führen*. Fahren Sie dann fort mit <<#480, Artikelbilder verwalten>>.
...
. Klicken Sie auf *Neuer Wareneingang*. Achten Sie darauf, dass ein Benutzer als <<#105, Eigner>> eingestellt ist.
...
Standardzahlungsart*
|Wählen, welche Einstellungen standardmäßig angeboten werden. Diese Einstellungen wurden bereits im ersten Teil des Schnelleinstiegs vorgenommen, siehe <<#250, Prioritäten bei Zahlung und Versand>>.
...
❏ Haben Sie den <<#320, Artikelkatalog>> mit allen Beschreibungstexten aufgebaut?

❏ Wurden die Texte für die <<#410, Artikelverfügbarkeit>> angepasst?

❏ Ist die <<#410, Artikelverfügbarkeit>> korrekt gesetzt?

❏ Haben Sie alle <<#420, Preise und MwSt.-Sätze nochmals geprüft?>>

❏ Konnten Sie sinnvolle <<#500, Cross-Selling>>-Verknüpfungen unter Ihren Artikeln bilden?

❏ Haben Sie alle wichtigen Kategorien des Typs <<#530, Content>> mit Ihren Inhalten versehen?

❏ Stimmen die angegebenen <<#650, Versandinformationen und -kosten>> mit Ihren Einstellungen überein?
...
❏ Konnten Sie die grundlegende Statuslogik bei der <<#700, Auftragsbearbeitung>> nachvollziehen?

❏ Haben Sie Ihre <<#710, E-Mail-Vorlagen>> bearbeitet, die Widerrufsbelehrung eingefügt sowie Ihre Bankverbindung und Kontaktdaten korrekt eingegeben?

❏ Wurde in der *Versandbestätigung zur Bestellung* die Tracking-URL korrekt eingegeben?

❏ Haben Sie wichtige Ereignisse mithilfe von <<#720, Ereignisaktionen>> oder des <<#770, Aktionsmanagers>> automatisiert?
