...
Die <<omni-channel/online-shop/mandanten-einrichten/artikelansichten#, **Sortierung der Kategorien**  >> für die Anzeige im Webshop kann anhand von Positionen, anhand von Namen (alphabetische Sortierung) oder zufällig erfolgen.
...
Im Menü <<omni-channel/online-shop/mandanten-einrichten/bestellvorgang#, **Einstellungen » Mandant (Shop) » Standard » Bestellvorgang » Grundeinstellungen**  >> individualisieren Sie den Bestellvorgang in Ihrem Webshop. Bei vielen Angaben können Sie wählen, ob diese dem Webshop-Besucher angezeigt werden sollen oder nicht.
