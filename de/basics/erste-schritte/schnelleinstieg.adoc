...
Im Menü **<<omni-channel/online-shop/mandanten-verwalten, Einstellungen » Mandant (Shop) » Standard » Grundeinstellungen>>** geben Sie den Namen für Ihren Webshop ein. Außerdem werden hier die ID Ihres Webshops sowie weitere Grunddaten, darunter die Domain und die Sprache, angezeigt.
