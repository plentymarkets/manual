...
====
plentymarkets ist für den Browser **link:https://www.google.com/intl/de/chrome/browser/[Google Chrome, window="_blank"]** optimiert. Sie können jedoch auch über **link:https://www.mozilla.org/de/firefox/products/[Mozilla Firefox, window="_blank"]** oder **link:http://www.apple.com/de/safari/[Safari (Mac OS), window="_blank"]** darauf zugreifen. Diese Einschränkung gilt nur für den Administrationsbereich. Ihr Webshop ist natürlich von allen gängigen Browsern aus erreichbar.
====
...
Bevor Sie Änderungen an Ihrem Webshop vornehmen, sollten Sie diesen <<omni-channel/online-shop/mandanten-einrichten/webshop/webshop-sperren#, **sperren**  >> und Ihre Besucher währenddessen auf eine Seite mit einem Wartungshinweis umleiten. Nach Abschluss der Arbeiten müssen Sie Ihren Webshop wieder entsperren, sonst erhalten Sie keine Bestellungen mehr. Wir empfehlen Ihnen, nach jeder Wartung den Webshop über die Standard-URL in einem anderen Browser zu starten und bei dieser Gelegenheit alle Änderungen gründlich zu prüfen.
...
. Klicken Sie auf **Neu**. +
→ Das Fenster **<<basics/arbeiten-mit-plentymarkets/benutzer-verwalten#10, Neuen Benutzer erstellen >>** wird geöffnet (Bild 1).
...
image::basics/arbeiten-mit-plentymarkets/assets/DE-Schnelleinstieg-01.png[]

__Bild 1: Neuen Benutzer erstellen__
...
__Bild 2: Benutzer bearbeiten__
...
. Öffnen Sie das Menü **Einstellungen » Grundeinstellungen » Benutzer » Konten**.
. Öffnen Sie den Benutzer, den Sie löschen möchten (Bild 2).
...
. Öffnen Sie das Menü **Einstellungen » Mandant (Shop) » Standard » E-Mail » Zugangsdaten**.
...
. Öffnen Sie das Menü **Einstellungen » Mandant (Shop) » Standard » E-Mail » Infodienst**.
...
__Bild 3: Fenster Template-Variablen und -Funktionen__
...
. Klicken Sie in der **E-Mail-Vorlage** auf **Template-Variablen und -Funktionen** (Bild 3, roter Pfeil). +
...
__Bild 4: Übersicht der Versandprofile__
...
.Menü **Einstellungen » Aufträge » Versand » Versandoptionen » Tab: Versandprofile**
[cols="a,a"]
|====
|Einstellung |Erläuterung
...
|**Mandanten (Shops)**
|Webshops oder **<<basics/arbeiten-mit-plentymarkets/plentymarkets-konto/service-center/mandant-shop#, Mandanten  >>** wählen, für die das Versandprofil gelten soll (Mehrfachauswahl möglich).

|**Auftragsherkunft**
|**<<auftragsabwicklung/auftraege/einstellungen/auftragsherkunft#, Auftragsherkunft  >>** wählen, wenn das Versandprofil ausschließlich für bestimmte Aufträge gelten soll (Mehrfachauswahl möglich). Mindestens ein Versandprofil sollte die Auftragsherkunft **ALLE** beinhalten, damit tatsächlich für alle Aufträge mindestens ein Versandprofil zur Verfügung steht.
...
. Wählen Sie einen **Berechnungstyp**. Beachten Sie dazu die Erläuterungen in Tabelle 5.
...
Partner, die Ihnen bei der Erstellung rechtssicherer Texte behilflich sind, finden Sie unter **<<omni-channel/online-shop/standard/externe-dienste#, Dienste  >>**.

[#320]
=== Artikelkatalog aufbauen

Im Menü **<<artikel/artikel-verwalten#, Artikel » Artikel bearbeiten  >>** werden alle Artikel und Varianten aufgelistet, können gesucht und bearbeitet werden. In einem neuen plentymarkets System werden Ihnen zunächst Testartikel angezeigt. Einige Funktionen stehen Ihnen direkt in der Übersicht in der Spalte **Aktionen** zur Verfügung. Die Aktionen werden in Tabelle 8 erläutert. Die Filter zur Artikelsuche sind links angeordnet und werden unter **<<artikel/artikel-verwalten#350, Artikel und Varianten suchen >>** erläutert. Bevor Sie nun die ersten Artikel im System erstellen, sind einige vorbereitende Arbeiten nötig, darunter das Löschen der Musterartikel sowie das Erstellen von Kategorien und Attributen.
...
plentymarkets verarbeitet bis zu sechs <<artikel/kategorien/kategorien-bearbeiten#, **Navigationsebenen**  >>. Die meisten Online-Shops beschränken sich aus Gründen der Benutzerfreundlichkeit auf maximal drei Ebenen, z.B. Computer &gt; Eingabegeräte &gt; optische Mäuse.
...
Die <<omni-channel/online-shop/mandanten-einrichten/artikelansichten/grundeinstellungen#, **Sortierung der Kategorien**  >> für die Anzeige im Webshop kann anhand von Positionen, anhand von Namen (alphabetische Sortierung) oder zufällig erfolgen.
...
__Bild 6: Neuen Artikel erstellen__
...
. Nehmen Sie ggf. weitere Einstellungen vor. Beachten Sie dazu die Erläuterungen in Tabelle 9.
. **Speichern** Sie die Einstellungen. +
...
__Bild 7: Bearbeitungsfenster eines Artikels__
...
__Bild 8: Verfügbarkeit der Varianten einstellen__
...
. Öffnen Sie das Menü **Einstellungen » Waren » Lager**.
...
. Geben Sie Suchbegriffe ein und stellen Sie Filteroptionen ein. Beachten Sie dazu die Erläuterungen in Tabelle 10.
. Klicken Sie auf **Suchen**. +
...
__Bild 9: Cross-Selling-Artikel einrichten__
...
Ihr Webshop wird mit einem voll funktionsfähigen Testdesign angezeigt. Dieses Testdesign können Sie jederzeit nach Ihren eigenen Vorstellungen ändern und ergänzen. Dabei wählen Sie aus verschiedenen Standarddesigns, die im Bereich <<omni-channel/online-shop/cms#, **CMS**  >> zur Verfügung stehen. Wenn Sie Wert auf noch mehr Individualität legen, stehen Ihnen unsere **link:https://www.plentymarkets.eu/partner/zertifizierte-agenturen/[zertifizierten Dienstleister, window="_blank"]** mit Rat und Tat zur Seite.
...
Alle **<<artikel/kategorien/kategorietyp-content-bearbeiten#, Kategorien  >>** des Typs **Content** werden nach demselben Prinzip geändert. In diesem Schnelleinstieg werden Ihnen die nötigen Schritte beispielhaft anhand der **Startseite** erläutert.
...
|**{% Link(3) %}**
|URL der Kategorie (Content oder Item) mit der ID 3 (siehe <<artikel/kategorien#, **Artikel » Kategorien**  >>).
...
. Nehmen Sie die Einstellung vor. Beachten Sie dazu die Erläuterungen in Tabelle 13.
. **Speichern** Sie die Einstellungen. +
...
. Wählen Sie im Bereich **Gewählte Bereiche veröffentlichen** die Bereiche des Designs, die veröffentlicht werden sollen. Beachten Sie dazu die Erläuterungen in Tabelle 14.
...
Im Menü **<<omni-channel/online-shop/mandanten-einrichten/grundeinstellungen#, Einstellungen » Mandant (Shop) » Standard » Grundeinstellungen  >>** geben Sie den Namen für Ihren Webshop ein. Außerdem werden hier die ID Ihres Webshops sowie weitere Grunddaten, darunter die Domain und die Sprache, angezeigt.

[#620]
==== Grundeinstellungen für Ihren Webshop vornehmen

Im Menü **<<omni-channel/online-shop/mandanten-einrichten/webshop/grundeinstellungen#, Einstellungen » Mandant (Shop) » Standard » Webshop » Grundeinstellungen  >>** nehmen Sie Einstellungen Ihres Webshops vor.
...
Im Menü <<basics/arbeiten-mit-plentymarkets/grundeinstellungen/zahlenformate#, **Einstellungen » Grundeinstellungen » Zahlenformate**  >> nehmen Sie Einstellungen zu Zahlenformaten vor. Zum Beispiel werden hier die Nachkommastellen für Maße und Gewichte festgelegt. In der Grundeinstellung sind übliche Standardwerte eingegeben.
...
|Für **Mengenangaben** hier die Anzahl der möglichen Nachkommastellen wählen. Gemäß der Einstellung wird die Menge auf Dokumenten wie Rechnung und Lieferschein dargestellt.
...
|Anzahl der Nachkommastellen für Inhalte wählen. **1, 2, 3** oder **Keine Nachkommastelle** wählen.

|**Zahlenformat: Rundungsverhalten**
|Wählen, ob kaufmännisch gerundet oder immer ab- bzw. aufgerundet werden soll.
|====

[#640]
==== SEO-Metadaten eingeben

Die Einstellungen im Menü <<omni-channel/online-shop/cms-syntax/fallbeispiele/seo-guide#, **Einstellungen » Mandant (Shop) » Standard » SEO » Metadaten**  >> sind relevant für die Suchmaschinenoptimierung. Metadaten sind Informationen in Ihren Webseiten, die für Suchmaschinen eine wichtige Informationsquelle darstellen, die aber Besucher nicht (oder nur indirekt) sehen.
...
. Öffnen Sie das Menü **Einstellungen » Mandant (Shop) » Standard » SEO » Metadaten**.
. Geben Sie den **Seitentitel** und **Schlüsselwörter** ein. Beachten Sie dazu die Erläuterungen in Tabelle 17.
. **Speichern** Sie die Einstellungen.
...
Im Menü <<omni-channel/online-shop/mandanten-einrichten/bestellvorgang/grundeinstellungen#, **Einstellungen » Mandant (Shop) » Standard » Bestellvorgang » Grundeinstellungen**  >> individualisieren Sie den Bestellvorgang in Ihrem Webshop. Bei vielen Angaben können Sie wählen, ob diese dem Webshop-Besucher angezeigt werden sollen oder nicht.
...
|**Standardlieferland**
|Zur Auswahl stehen die im Menü **Einstellungen » Aufträge » Versand » Versandoptionen » Lieferländer** eingerichteten <<auftragsabwicklung/fulfillment/versand-vorbereiten#100, **Lieferländer** >>. Sie werden hier sprachabhängig zugeordnet.
...
Weitere Informationen zur Angabe von Grundpreisen in Online-Shops finden Sie beim link:https://www.haendlerbund.de/hinweisblaetter/finish/1-hinweisblaetter/114-grundpreisangabe-im-online-handel[**Händlerbund**, window="_blank"].
...
Im Bereich <<omni-channel/online-shop/mandanten-einrichten/mein-konto#, **Einstellungen » Mandant (Shop) » Standard » Mein Konto**  >> nehmen Sie in den Untermenüs <<omni-channel/online-shop/mandanten-einrichten/mein-konto/grundeinstellungen#, **Grundeinstellungen**  >> und <<omni-channel/online-shop/mandanten-einrichten/mein-konto/auftragsinformationen#, **Auftragsinformationen**  >> wichtige Einstellungen für den individuellen Kundenbereich Ihres Webshops vor.
...
In plentymarkets können Sie den Bestellvorgang, das komplette Shop-Design und die Artikelbeschreibungen in mehreren Sprachen einrichten. Im Menü **<<omni-channel/online-shop/mandanten-einrichten/_multilingualismus#, Einstellungen » Mandant (Shop) » Standard » Webshop » Multilingualismus  >>** bestimmen Sie, ob Sie alle Bereiche des Webshops oder nur den Bestellvorgang mehrsprachig einrichten wollen. Vergessen Sie nicht, diese Texte dann auch zu übersetzen und einzupflegen.

Namen und Beschreibungstexte eines Artikels erstellen und speichern Sie in verschiedenen Sprachen im Bearbeitungsmenü des Artikels im Tab <<artikel/artikel-verwalten#90, **Texte** >>. Auch **<<artikel/kategorien/kategorien-bearbeiten#, Kategorien  >>** und **<<omni-channel/online-shop/cms/webdesign#, Webshop-Design  >>** können in verschiedenen Sprachen erstellt werden. Gehen Sie wie im Folgenden beschrieben vor, um die Spracheinstellungen im Menü **Multilingualismus** vorzunehmen.
...
plentymarkets bietet Ihnen im Menü <<auftragsabwicklung/auftraege/einstellungen/ereignisaktionen#, **Einstellungen » Aufträge » Ereignisaktionen**  >> hierfür eine wirkungsvolle Möglichkeit, da Sie viele dieser Routineaufgaben automatisch ausführen lassen und Ihren Webshop damit äußerst effizient führen können.
...
Richten Sie eine <<auftragsabwicklung/auftraege/einstellungen/ereignisaktionen#, **Ereignisaktion**  >> ein, damit der Kunde seine Rechnung im PDF-Format per E-Mail erhält, sobald diese im System erzeugt wurde.
...
. Geben Sie einen Namen ein.
. Wählen Sie das **Ereignis** gemäß Tabelle 21.
. **Speichern** Sie die Einstellungen.
. Nehmen Sie die Einstellungen gemäß Tabelle 21 vor.
. Setzen Sie ein Häkchen bei **Aktiv**.
. **Speichern** Sie die Einstellungen.
--
...
Wer bereits erste Erfahrungen im E-Business gesammelt hat, kennt das folgende Problem: Statt den korrekten Betrag zu überweisen, hat der Kunde versehentlich einen zu geringen Betrag gezahlt. Man muss den Kunden dann darauf hinweisen, den Sachverhalt erklären und den zu zahlenden Restbetrag nachfordern. In plentymarkets haben Sie die Möglichkeit, solche Fälle mit einer <<auftragsabwicklung/auftraege/einstellungen/ereignisaktionen#, **Ereignisaktion**  >> ohne aufwändige Zusatzarbeit automatisiert zu bearbeiten.
...
→ Das Fenster **Neue Ereignisaktion erstellen** wird geöffnet.
. Geben Sie einen Namen ein.
. Wählen Sie das **Ereignis** gemäß Tabelle 22.
. **Speichern** Sie die Einstellungen.
...
→ Das Fenster **Neue Ereignisaktion erstellen** wird geöffnet.
. Geben Sie einen Namen ein.
. Wählen Sie das **Ereignis** gemäß Tabelle 23.
. **Speichern** Sie die Einstellungen.
...
Die folgende <<auftragsabwicklung/auftraege/einstellungen/ereignisaktionen#, **Ereignisaktion**  >> wird beim Import der Paketnummer dem Kunden eine Versandbestätigung senden, den Status der Bestellung auf 7 setzen und zusätzlich den Warenausgang im Lager buchen, damit die physischen Lagerbestände aktualisiert werden.
...
→ Das Fenster **Neue Ereignisaktion erstellen** wird geöffnet.
. Geben Sie einen Namen ein.
. Wählen Sie das **Ereignis** gemäß Tabelle 24.
. **Speichern** Sie die Einstellungen.
. Nehmen Sie die Einstellungen gemäß Tabelle 24 vor.
. Setzen Sie ein Häkchen bei **Aktiv**.
. **Speichern** Sie die Einstellungen.
--
...
Leider kommt es in der Praxis immer wieder vor, dass Kunden Waren z.B. auf Rechnung bestellen, dann aber nicht bezahlen. In diesem Fall sollten Sie den Kunden per E-Mail eine Erinnerung senden. Diese Aufgabe kann der <<auftragsabwicklung/auftraege/einstellungen/aktionsmanager#, **Aktionsmanager**  >> automatisch für Sie übernehmen.
...
. Nehmen Sie ggf. weitere Einstellungen vor. Beachten Sie dazu die Erläuterungen in Tabelle 25.
...
Abschließend müssen Sie nur noch Ihren <<omni-channel/online-shop/mandanten-einrichten/webshop/webshop-sperren#, **Webshop wieder entsperren**  >>, damit Ihre Kunden auf Ihren Webshop gelangen können. Damit Ihre Kunden auch die richtigen E-Mails erhalten, müssen Sie außerdem den <<crm/e-mails-versenden#100, **Testmodus wieder deaktivieren** >>.
