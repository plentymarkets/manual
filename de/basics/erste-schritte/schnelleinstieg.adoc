...
* das Einrichten von <<basics/automatisierung/prozesse/prozesse-einrichten#, Prozessen>>. Dieses Menü können Sie nur nutzen, wenn Sie das Tool plentyBase installiert haben, und richtet sich an fortgeschrittene plentymarkets Nutzer. Daher werden Prozesse im Schnelleinstieg nicht näher beschrieben.
