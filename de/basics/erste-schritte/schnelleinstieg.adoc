...
Die Einrichtung erfolgt in zwei Schritten. Zunächst laden Sie das Dokument im Menü <<omni-channel/online-shop/_cms/dokumente#, **CMS » Dokumente**  >> hoch. Dann verknüpfen Sie das Dokument mit einer E-Mail-Vorlage. Gehen Sie dazu wie im Folgenden beschrieben vor.
...
Die <<omni-channel/online-shop/mandanten-einrichten/_artikelansichten/grundeinstellungen#, **Sortierung der Kategorien**  >> für die Anzeige im Webshop kann anhand von Positionen, anhand von Namen (alphabetische Sortierung) oder zufällig erfolgen.
...
Um Bilder in Kategorien einzufügen, müssen Sie diese auf den Webserver laden. Bilder werden im Tab **<<artikel/kategorien/kategorien-bearbeiten#10, Dokumente >>** der aktuellen Kategorie hochgeladen. Eine weitere Möglichkeit, Bilder einzufügen, bietet das Menü <<omni-channel/online-shop/_cms/bilder-galerie#, **CMS » Bilder-Galerie**  >>. Gehen Sie wie im Folgenden beschrieben vor, um Kategoriebilder hochzuladen und festzulegen.
...
Des Weiteren können Sie in plentymarkets als Ziel eines Links neben Kategorien auch einzelne Artikel angeben, die ebenfalls über **<<omni-channel/online-shop/_cms-syntax/webdesign#, Template-Variablen und -Funktionen  >>** erreichbar sind. Die folgende Tabelle listet einige wichtige Template-Funktionen auf:
...
Wenn Sie den Aufbau der URL geändert haben, muss das Design inklusive aller Kategorien veröffentlicht werden, damit die Änderungen wirksam werden. Nach der Veröffentlichung wird das in Ihrem Webshop aktive Design im Menü **<<omni-channel/online-shop/_cms/webdesign#, CMS » Webdesign  >>** in der Kopfzeile grün angezeigt.
...
|**Blog**
|Wählen, um noch nicht veröffentlichte, z.B. über Schnittstellen oder Importformate importierte Blogs zu veröffentlichen. Änderungen an bereits veröffentlichten Blogs werden sofort übernommen, ein erneutes Veröffentlichen der Blogs ist nicht erforderlich. Blogs können alternativ auch im Menü <<omni-channel/online-shop/_cms/blog-weblog#, **CMS » Blog**  >> veröffentlicht werden.
|====

Löschen Sie nach einer Neuveröffentlichung den Datei-Cache, um die Änderungen sofort anzuzeigen. Da Sie an dieser Stelle das Design zum ersten Mal veröffentlichen, wird im Schnelleinstieg nicht beschrieben, wie Sie den Datei-Cache zurücksetzen. Weitere Informationen dazu finden Sie auf der Handbuchseite <<omni-channel/online-shop/_cms/webdesign/webdesign-bearbeiten#, **Webdesign bearbeiten**  >>.
...
Namen und Beschreibungstexte eines Artikels erstellen und speichern Sie in verschiedenen Sprachen im Bearbeitungsmenü des Artikels im Tab <<artikel/artikel-verwalten#90, **Texte** >>. Auch **<<artikel/kategorien/kategorien-bearbeiten#, Kategorien  >>** und **<<omni-channel/online-shop/_cms/webdesign#, Webshop-Design  >>** können in verschiedenen Sprachen erstellt werden. Gehen Sie wie im Folgenden beschrieben vor, um die Spracheinstellungen im Menü **Multilingualismus** vorzunehmen.
...
Abschließend müssen Sie nur noch Ihren <<omni-channel/online-shop/mandanten-einrichten/_webshop/webshop-sperren#, **Webshop wieder entsperren**  >>, damit Ihre Kunden auf Ihren Webshop gelangen können. Damit Ihre Kunden auch die richtigen E-Mails erhalten, müssen Sie außerdem den <<crm/e-mails-versenden#100, **Testmodus wieder deaktivieren** >>.
