...
Im Menü **<<omni-channel/online-shop/mandanten-verwalten, System » Mandant (Shop) » Standard » Einstellungen>>** geben Sie den Namen für Ihren Webshop ein. Außerdem werden hier die ID Ihres Webshops sowie weitere Grunddaten, darunter die Domain und die Sprache, angezeigt.

[#620]
==== Grundeinstellungen für Ihren Webshop vornehmen

Im Menü **<<omni-channel/online-shop/webshop-einrichten#grundeinstellungen, System » Mandant (Shop) » Standard » Webshop » Einstellungen>>** nehmen Sie Einstellungen Ihres Webshops vor.
