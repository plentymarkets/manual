...
Der Schnelleinstieg ist in die Kapitel <<#10, Basiseinstellungen>>, <<#250, Artikelkatalog aufbauen>>, <<#460, Webshop einrichten>> und <<#690, Automatismen einrichten>> untergliedert, die jeweils einen Teilbereich der Einrichtung Ihres Webshops abdecken. Arbeiten Sie diese Kapitel in der bestehenden Reihenfolge durch, da die Kapitel aufeinander aufbauen. Die schnelle Einrichtung eines funktionsfähigen Webshops steht im Vordergrund, weshalb nur die dafür notwendigen Funktionen beschrieben sind.
...
[%interactive]
* [ ] Wurden die Daten des <<#110, Standardbenutzers>> geändert?
* [ ] Sind die <<#140, E-Mail-Kontodaten>> (für Benachrichtigungen an Kunden) im System eingegeben?
* [ ] Wurde der <<#150, Testmodus>> aktiviert, damit alle E-Mails an den Administrator gesendet werden?
* [ ] Wurde der <<#160, E-Mail-Infodienst>> eingerichtet?
* [ ] Enthalten alle <<#170, E-Mail-Vorlagen>> die Variable *Link_Checkout()*?
* [ ] Sind alle <<#190, Lieferländer>> mit gleichen Portokosten zu <<#200, Regionen>> gruppiert?
* [ ] Sind alle <<#190, Lieferländer>> einer <<#200, Region>> zugeordnet?
* [ ] Wurden alle <<#210, Versanddienstleister>> inklusive Tracking-URL erstellt?
* [ ] Liegt für alle folgenden Optionen ein gültiges <<#220, Versandprofil>> vor?
** [ ] Für alle Regionen
** [ ] Für alle Marktplätze (Webshop, eBay, Amazon etc.)
** [ ] Für alle Warenwerte
** [ ] Für alle Artikel
* [ ] Haben Sie Ihre <<#230, Portotabellen>> für alle Regionen erstellt?
* [ ] Wurde für mindestens ein <<#220, Versandprofil>> die Option *Bei neuen Artikeln aktivieren* gewählt?
...
Nachfolgend finden Sie Informationen zu wichtigen Voraussetzungen und Vorarbeiten für die Konfiguration der Artikel.
...
// TODO: Prüfen, ob das mit den Verfügbarkeitssymbolen auch in Ceres klappt.
...
// TODO: Hinweistext auf Ebenentiefe von Ceres einfügen. Im Megamenü von Ceres kann man bis zu 4 Ebenen anzeigen.
...
// TODO: Dieses Kapitel muss dann angepasst werden bzw. verschoben werden, wenn klar ist, welche Sortierungsmöglichkeiten in Ceres zur Verfügung stehen.
...
// TODO: Hinweis auf Kategorietitel und -texte bei mehreren Mandanten.
...
// TODO: Muss diese Konfig ggf. auf Kontakte angepasst werden?
...
. Klicken Sie auf *Neuer Wareneingang*. Achten Sie darauf, dass ein Benutzer als <<#120, Eigner>> eingestellt ist.
...
// TODO: Ggf. anpassen, weil Artikel in Ceres aus SEO-Gründen auch weiterhin sichtbar sind, wenn sie keinen Bestand haben. Es wird nur der "Kaufen"-Button ausgeblendet. Es war die Idee, das Verhalten wieder umzustellen, wie in Callisto. Bei Ceres den aktuellen Stand erfragen.
...
// TODO: Prüfen, ob dieses Kapitel auch für Ceres gilt. Dort ist es im Moment noch nicht möglich Dateien im Mein-Konto-Bereich zum Download anzubieten.
...
// TODO: Hinweis auf Cross-Selling-Liste und Container-Verknüpfung in Ceres einfügen.
...
* [ ] Konnten Sie sinnvolle <<#440, Cross-Selling>>-Verknüpfungen unter Ihren Artikeln bilden?

[#460]
== Webshop einrichten

In diesem Teil des Schnelleinstiegs finden Sie Erläuterungen zu den Einstellungen, die Sie in plentymarkets zum Einrichten des Webshops vornehmen müssen, bevor Sie mit dem System arbeiten können. Erfahren Sie, wie Sie die benötigten Webshop-Plugins kaufen und installieren sowie Ihren Webshop einrichten.
...
====
Die installierten Plugins müssen in einer bestimmten Reihenfolge geladen werden, damit sämtliche Routen des Webshops korrekt aufgerufen werden. Das Plugin *IO* stellt die Logik für die Webshop-Routen zur Verfügung. Das Plugin erhält daher die höchste Positionsnummer und wird somit zuletzt geladen. Das Webshop-Plugin *Ceres* erhält eine niedrigere Position, als das Plugin *IO*. Das Plugin *Vorkasse* hat bereits die Positionsnummer *0* und damit die niedriste Position.
====
...
Wiederholen Sie Schritte 2 bis 4 für das Plugin *Ceres* und speichern Sie für *Ceres* z.B. die Positionsnummer *998*. Verknüpfen Sie anschließend die Plugins mit Ihrem Mandanten und aktivieren Sie die Plugins für den Vorschaumodus *Stage*.
...
. Klicken Sie in der Werkzeugleiste auf *In Tabellenansicht wechseln*. +
→ Die Plugins werden in der Tabellenansicht angezeigt.
. Klicken Sie in der Zeile des Plugins *IO* auf *Mandanten wählen*. +
→ Das Fenster *Mandanten wählen* wird geöffnet.
. Aktivieren Sie den Mandanten.
. *Speichern* Sie die Einstellungen. +
→ Der aktivierte Mandant wird verknüpft.
. Aktivieren Sie das Plugin *IO* in der Spalte *Aktiv* für den Modus *Stage*.
. Wiederholen Sie die Schritte 3 bis 6 für die Plugins *Ceres* und *Vorkasse*.
...
Das Standard-Template des Webshops ist nach der Bereitstellung im Vorschaumodus *Stage* verfügbar. Wechseln Sie in *Stage*, um Ihren Webshop aufzurufen.
