...
. Öffnen Sie das Menü **System » Mandant (Shop) » Standard » Webshop » Shop sperren**.
...
. Öffnen Sie das Menü **System » Mandant (Shop) » Standard » E-Mail » Zugangsdaten**.
...
. Öffnen Sie das Menü **System » Mandant (Shop) » Standard » E-Mail » Infodienst**.
...
. Öffnen Sie das Menü **System » Mandant (Shop) » Standard » E-Mail » Vorlagen**.
...
Ein PDF-Anhang, z.B. eine Rechnung, wird im Menü **System » Mandant (Shop) » Standard » Standorte » Deutschland (Standard) » Dokumente** erzeugt. Ein Dokumentenanhang für andere Dateien ist z.B. ein Artikelprospekt oder eine Anleitung und wird im Menü **CMS » Dokumente** gespeichert.
...
. Öffnen Sie das Menü **System » Mandant (Shop) » Standard » Standorte » Standort wählen » Dokumente**.
...
. Öffnen Sie das Menü **System » Mandant (Shop) » Standard » Bestellvorgang » Einstellungen**.
...
. Öffnen Sie das Menü **System » Mandant (Shop) » Standard » Kategorien » Einstellungen**.
...
. Öffnen Sie das Menü **System » Mandant (Shop) » Standard » SEO » URL-Aufbau » Artikel**.
...
. Öffnen Sie das Menü **System » Mandant (Shop) » Standard » SEO » Metadaten**.
...
Im Menü <<omni-channel/online-shop/webshop-einrichten/bestellvorgang#, **System » Mandant (Shop) » Standard » Bestellvorgang » Einstellungen**>> individualisieren Sie den Bestellvorgang in Ihrem Webshop. Bei vielen Angaben können Sie wählen, ob diese dem Webshop-Besucher angezeigt werden sollen oder nicht.
...
|**Standardlieferland**
|Zur Auswahl stehen die im Menü **System » Aufträge » Versand » Optionen » Lieferländer** eingerichteten <<auftragsabwicklung/fulfillment/versand-vorbereiten#100, **Lieferländer**>>. Sie werden hier sprachabhängig zugeordnet.
...
. Öffnen Sie das Menü **System » Mandant (Shop) » Standard » Webshop » Multilingual**.
...
plentymarkets bietet Ihnen im Menü <<basics/automatisierung/ereignisaktionen#, **System » Aufträge » Ereignisaktionen**>> hierfür eine wirkungsvolle Möglichkeit, da Sie viele dieser Routineaufgaben automatisch ausführen lassen und Ihren Webshop damit äußerst effizient führen können.
