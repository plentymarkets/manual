...
| Spechert Änderungen am Plugin-Set und stellt das Plugin-Set zur weiteren Nutzung bereit.
...
.Plugin-Position
==
Die relative Position der Plugins bestimmt, in welcher Reihenfolge sie innerhalb des Set geladen werden. Dabei gilt: Je niedriger die Position des Plugins desto früher wird es geladen. Aus diesem Grund sollte das Plugin IO die höchste Positionsnummer erhalten, das Plugin Ceres in der Regel die zweithöchste.
==
