...
Plugins können Backend-Funktionen wie Menü-Items und Benutzer-Interfaces hinzufügen. Sie können das Plugin Set ändern, das für Ihr Backend geladen wird. Um dies zu tun, müssen Sie ein Plugin Set für Ihren Benutzer wählen.
