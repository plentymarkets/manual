...
Was ist ein Plugin Set? +
Ein Plugin Set ist eine Sammlung für Plugins. +
Dieses kann ein Plugin oder mehrere Plugins enthalten. +
Es beinhaltet die Plugin Konfigurationen und den Layout Container. +
Ein Plugin Set kann für einen oder mehrere Mandanten aktiviert werden.
...
[#80]
== Nach bestimmten Plugins suchen

Um gezielt nach Plugins zu suchen, kann ein Filter gesetzt werden. Es besteht die Möglichkeit, nach Name, Herkunft, installierten bzw. nicht installierten und aktiven bzw. nicht aktiven Plugins zu filtern.
...
Klicken Sie in der *Plugins » Plugin Übersicht* auf das Plugin Set, das Sie verwalten möchten. +
 ...
 *Position*: Legen Sie fest, in welcher Reihenfolge die Plugins geladen werden sollen. Sollte ein Plugin nicht richtig funktionieren, kann es hilfreich sein, die Position auf eine höhere Zahl zu ändern. +
