...
Eine Liste der verfügbaren Aktionen finden Sie auf der Handbuchseite <<basics/automatisierung/prozesse/aktionen#, Aktionen>>.
...
Folgende Steuerelemente sind verfügbar und werden auf der Handbuchseite <<basics/automatisierung/prozesse/aktionen#_steuerelemente, Aktionen/Steuerelemente>> näher erläutert:
...
Subaktionen werden zu einer Aktion hinzugefügt. Mit Subaktionen legen Sie also fest, welche Vorgänge bei der Prozessausführung im Rahmen der Aktion automatisch stattfinden sollen.
...
Prozesse erstellen und verwalten Sie im Menü *System » Prozesse*. Gehen Sie wie unten beschrieben vor, um einen neuen Prozess zu erstellen.

[.instruction]
Prozess erstellen:

. Öffnen Sie das Menü *System » Prozesse » Neuer Prozess*. +
*_Hinweis:_* Wenn der Menüpunkt *System » Prozesse* nicht angezeigt wird, installieren Sie das Plugin link:https://marketplace.plentymarkets.com/plugins/externe-tools/plentyBase_5053/[plentyMarketplace^].
...
*Benutzer* = Der Prozess ist nur für die Person sichtbar, die im eingeblendeten Dropdown-Menü *Benutzer* gewählt wird. +
*Rolle* = Der Prozess ist nur für die *Rolle* sichtbar, die m eingeblendeten Dropdown-Menü *Rolle* gewählt wird.
...
*_Hinweis:_* Für Personen mit Rechten der Klasse <<basics/arbeiten-mit-plentymarkets/benutzer-verwalten#, Admin>> sind alle Prozesse sichtbar.
...
Nicht aktiviert = Nur Personen mit Rechten der Klasse *Admin* knnen den Prozess bearbeiten.
...
. Öffnen Sie das Menü *System » Prozesse » Ordner wählen » Prozess wählen*.
. Klicken Sie auf *Neuer Arbeitsschritt*. +
→ Das Fenster *Neuer Arbeitsschritt* wird eingeblendet.
. Wählen Sie im Dropdown-Menü den Typ *Auftragsabwicklung*.
...
*_Tipp:_* Arbeitsschritte lassen sich auch über das Kontextmenü um eine Position verschieben. Dazu mit der rechten Maustaste auf den Arbeitsschritt klicken und *Nach oben verschieben* bzw. *Nach unten verschieben* wählen.
...
2+|<<basics/automatisierung/prozesse/aktionen#400, SEPA>>
...
|<<basics/automatisierung/prozesse/aktionen#150, Adressetikett>>
a|
...
* <<basics/automatisierung/prozesse/subaktionen#240, Notiz zum Auftrag>>
* <<basics/automatisierung/prozesse/subaktionen#270, Sounds>>
...
. Klicken Sie auf *Neuer Arbeitsschritt*. +
→ Das Fenster *Neuer Arbeitsschritt* wird eingeblendet.
. Wählen Sie im Dropdown-Menü den Typ *Auftragsbearbeitung*.
. *Speichern* Sie die Einstellung. +
...
Für den Arbeitsschritt *Auftragsbearbeitung* stehen die in <<tabelle-auftragsbearbeitung-aktionen>> beschriebenen <<basics/automatisierung/prozesse/aktionen#, Aktionen>> und <<basics/automatisierung/prozesse/subaktionen#, Subaktionen>> zur Verfügung.
...
|<<basics/automatisierung/prozesse/aktionen#190, Auftragssuche>>
a|
* Keine
...
. Klicken Sie auf *Neuer Arbeitsschritt*. +
→ Das Fenster *Neuer Arbeitsschritt* wird eingeblendet.
. Wählen Sie im Dropdown-Menü den Typ *Wareneingang*.
. *Speichern* Sie die Einstellung. +
...
Gehen Sie wie unten beschrieben vor, um eine Aktion oder ein Steuerelement zu einem Arbeitsschritt hinzuzufügen. Eine Liste der verfügbaren Aktionen finden Sie auf der Handbuchseite <<basics/automatisierung/prozesse/aktionen#, Aktionen>>.
...
Die Ordnerstruktur des Menüs *Einstellungen » Prozesse* spiegelt die Sichtbarkeit und Verfügbarkeit der Prozesse für Benutzer wider. Folgende Ordner sind verfügbar.

[IMPORTANT]
.Sichtbarkeit des Menüs System » Prozesse
====
Für Benutzerkonten der Klasse Variabel ist das Menü *System » Prozesse* nur sichtbar, wenn im Benutzerprofil die <<basics/arbeiten-mit-plentymarkets/benutzer-verwalten#, Berechtigung>> dazu erteilt wurde.
====
...
|*Prozesse pro Rolle*
|Prozesse für Benutzer mit der <<basics/arbeiten-mit-plentymarkets/benutzer-verwalten#70, Rolle>> des angemeldeten Benutzers. Wenn der Benutzer keiner Rolle zugeordnet ist, wird dieser Ordner angezeigt. Personen mit der Klasse <<basics/arbeiten-mit-plentymarkets/benutzer-verwalten#10, Admin>> werden die Prozesse aller Rollen angezeigt.
...
. Öffnen Sie das Menü *Einstellungen » Prozesse*.
