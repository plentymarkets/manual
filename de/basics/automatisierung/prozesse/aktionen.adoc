...
Für die Ausführung eines Prozesses zum <<auftragsabwicklung/payment/bankdaten-verwalten#200, SEPA-Zahlungsverkehr>> ist für jede Variante ein eigener Prozess erforderlich, um beide Lastschriftarten zu erfassen. Damit die Lastschriften korrekt erfasst werden, bei den Arbeitsschritten den Filter **Art der Lastschrift** hinterlegen.
