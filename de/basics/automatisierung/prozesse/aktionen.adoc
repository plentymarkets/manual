...
Auf dieser Handbuchseite finden Sie Erläuterungen zu den Steuerelementen und Aktionen, die Sie im Menü **Einstellungen » Prozesse** zu den Arbeitsschritten von Prozessen hinzufügen können.
...
**Ja** (Standardeinstellung) = Aktion wird im Menü **plentymarkets Client » Prozesse** angezeigt. +
**Nein** = Aktion wird nicht im Menü **plentymarkets Client » Prozesse** angezeigt. Aktion läuft im Hintergrund ab.
...
[.subhead]
Einstellungen
Die folgende Tabelle erläutert die zusätzlichen Einstellungen des Steuerelements. Informationen zu den allgemeinen Einstellungen für Steuerelemente finden Sie in <<basics/automatisierung/prozesse/aktionen#480, **Tabelle 1** >>. Da das Steuerelement ein Eingreifen des Benutzers erfordert, ist die Einstellung **Anzeigen** für dieses Steuerelement nicht verfügbar.
...
Das Steuerelement **End** ist für bestimmte Aktionen zwingend erforderlich. Erfahren Sie mehr dazu im folgenden Videotutorial zum Thema **Loop**:

video::84490849[vimeo]
[#510]
=== Filter
...
[.subhead]
Einstellungen
Die folgende Tabelle erläutert die zusätzlichen Einstellungen des Steuerelements. Informationen zu den allgemeinen Einstellungen für Steuerelemente finden Sie in <<basics/automatisierung/prozesse/aktionen#480, **Tabelle 1** >>.
...
Erfahren Sie mehr über das Steuerelement **Filter** im folgenden Videotutorial:
...
[.subhead]
Einstellungen
Die folgende Tabelle erläutert die zusätzlichen Einstellungen des Steuerelements. Informationen zu den allgemeinen Einstellungen für Steuerelemente finden Sie in <<basics/automatisierung/prozesse/aktionen#480, **Tabelle 1** >>. Die Einstellung **Ziel** ist für dieses Steuerelement nicht verfügbar.
...
Erfahren Sie mehr über das Konfigurieren eines Filters im Zusammenhang mit den benötigten Steuerelementen **Filter auflösen** und **Jump** im folgenden Videotutorial:
...
Erfahren Sie mehr über das Steuerelement **Jump** in Verbindung mit dem Steuerelement <<basics/automatisierung/prozesse/aktionen#540, **Loop** >> im folgenden Videotutorial:
...
Erfahren Sie mehr über das Steuerelement **Loop** im folgenden Videotutorial:
...
[.subhead]
Einstellungen
Die folgende Tabelle erläutert die zusätzlichen Einstellungen der Aktion. Informationen zu den allgemeinen Einstellungen für Aktionen finden Sie in <<basics/automatisierung/prozesse/aktionen#100, **Tabelle 6** >>.
...
[.subhead]
Einstellungen
Die folgende Tabelle erläutert die zusätzlichen Einstellungen der Aktion. Informationen zu den allgemeinen Einstellungen für Aktionen finden Sie in <<basics/automatisierung/prozesse/aktionen#100, **Tabelle 6** >>. Die Einstellung **Im Fehlerfall** ist für diese Aktion nicht verfügbar.
...
Mit der Aktion **Auftrag** werden verschiedene Vorgänge in der <<auftragsabwicklung/auftraege/auftraege-bearbeiten/auftrag-aendern#, **Auftragsbearbeitung**  >> per Subaktion automatisch ausgeführt, z.B. wird der Status von ausgewählten Aufträgen geändert oder es werden Paketnummern erfasst.
...
Mit der Aktion **FiBu-Export** wird eine CSV-Datei erzeugt, die in diverse <<omni-channel/online-shop/mandanten-einrichten/buchhaltung#8, **Buchhaltungssysteme** >> importiert werden kann. Es stehen 2 Formate für diesen Export zur Auswahl, zum Einen **Ein Datensatz pro Artikelposition (Standard)** und zum Anderen **Ein Datensatz pro Rechnung und Umsatzsteuersatz**. Der <<basics/datenaustausch/daten-exportieren#10, **FiBu-Export** >> wird per Subaktion gespeichert.
...
Mit der Aktion **Korrekturbeleg** werden für die jeweiligen Aufträge <<omni-channel/online-shop/mandanten-einrichten/dokumente/korrekturbeleg#, **Korrekturbelege**  >> generiert, die per gewählter Subaktion z.B. automatisch gedruckt oder gespeichert werden.
...
[.subhead]
Einstellungen
Die Einstellungen, die Sie beim Erstellen der Aktion wählen, werden beim Erstellen der Retoure zu Voreinstellungen, die Sie übernehmen oder ändern können. Die folgende Tabelle erläutert die zusätzlichen Einstellungen der Aktion. Informationen zu den allgemeinen Einstellungen für Aktionen finden Sie in <<basics/automatisierung/prozesse/aktionen#100, **Tabelle 6** >>. Die Einstellung **Im Fehlerfall** ist für diese Aktion nicht verfügbar.
...
|**Artikelstatus**
|Einen Artikelstatus wählen, der im Prozess beim Anlegen der Retoure voreingestellt wird. Die Artikelstatus für Retouren werden im Menü **<<auftragsabwicklung/auftraege/einstellungen/auftragstypen/retoure#, Einstellungen » Aufträge » Auftragstypen » Retoure  >>** angelegt.

|**Artikelwert**
|Einen Prozentwert eingeben, um ihn retournierten Artikeln zuzuweisen. Nachdem eine Retoure angelegt wurde, wird der Wert auch im Tab **Übersicht** einer **<<auftragsabwicklung/auftraege/auftraege-bearbeiten/retoure#, Retoure  >>** bei der Artikelposition angezeigt.
...
|**Retourengrund**
|Grund wählen, damit Retouren beim Anlegen diesen Rückgabegrund erhalten. Retourengründe werden im Menü **<<auftragsabwicklung/auftraege/einstellungen/auftragstypen/retoure#, Einstellungen » Aufträge » Auftragstypen » Retoure  >>** erstellt.
|====
...
Erfahren Sie mehr zur Verwendung der Aktion **Seriennummern** im folgenden Videotutorial:
