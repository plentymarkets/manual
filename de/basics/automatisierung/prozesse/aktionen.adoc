...
|Gutscheineinlösungen werden in Aufträgen als separate Gutscheinpositionen mit der ID -1 dargestellt. Wählen, ob in den Aktionen *Retoure anlegen/bearbeiten* und *Artikelerfassung* Gutscheinpositionen (ID -1) angezeigt werden sollen. +
