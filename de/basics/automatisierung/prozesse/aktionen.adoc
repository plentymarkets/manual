...
Mit der Aktion **FiBu-Export** wird eine CSV-Datei erzeugt, die in diverse <<omni-channel/online-shop/standard/buchhaltung#8, **Buchhaltungssysteme** >> importiert werden kann. Es stehen 2 Formate für diesen Export zur Auswahl, zum Einen **Ein Datensatz pro Artikelposition (Standard)** und zum Anderen **Ein Datensatz pro Rechnung und Umsatzsteuersatz**. Der <<basics/datenaustausch/daten-exportieren#10, **FiBu-Export** >> wird per Subaktion gespeichert.
...
Mit der Aktion **Gutschrift** werden für die Aufträge <<auftragsabwicklung/auftraege/fulfillment/gutschriften-erzeugen#, **Gutschriften erzeugt**  >>, die per gewählter Subaktion z.B. automatisch gedruckt oder gespeichert werden.
...
Mit der Aktion **Korrekturbeleg** werden für die jeweiligen Aufträge <<omni-channel/online-shop/standard/dokumente/korrekturbeleg#, **Korrekturbelege**  >> generiert, die per gewählter Subaktion z.B. automatisch gedruckt oder gespeichert werden.
...
Mit der Aktion **Lager-Pickliste** werden für die Aufträge <<auftragsabwicklung/auftraege/fulfillment/lager-pickliste#, **Lager-Picklisten**  >> generiert, die per gewählter Subaktion z.B. automatisch gedruckt oder gespeichert werden.
...
Mit der Aktion **Lieferschein** werden automatisch <<auftragsabwicklung/auftraege/fulfillment/lieferscheine-erzeugen#, **Lieferscheine**  >> für die Aufträge generiert. Diese Lieferscheine werden per Subaktion z.B. gedruckt oder gespeichert.
...
Mit der Aktion **Mahnung** werden für die Aufträge <<auftragsabwicklung/auftraege/fulfillment/mahnungen-erzeugen#, **Mahnungen**  >> generiert. Diese Mahnungen werden per Subaktion z.B. automatisch gedruckt oder gespeichert.
...
Mit der Aktion **Packliste** wird eine Liste der für den Versand kommissionierten Artikel erzeugt. Die <<auftragsabwicklung/auftraege/fulfillment/packliste#, **Packliste**  >> wird per Subaktion z.B. gedruckt oder gespeichert.
...
Mit der Aktion **Pickliste** wird eine im Rahmen der Grobkommissionierung erzeugte <<auftragsabwicklung/auftraege/fulfillment/pickliste#, **Pickliste**  >> per Subaktion z.B. gedruckt oder gespeichert. Erfasst werden Aufträge ab dem Auftragsstatus **5 Freigabe Versand**. Bei diesen Aufträgen wurde bereits ein Zahlungseingang gebucht (Wechsel von Status 3 nach 4). Außerdem ist die Ware verfügbar (Wechsel von Status 4 nach 5).
...
Mit der Aktion **Rechnung** werden für die Aufträge <<auftragsabwicklung/auftraege/fulfillment/rechnungen-erzeugen#, **Rechnungen erzeugt**  >>. Diese Rechnungen werden per Subaktion z.B. gedruckt oder gespeichert.
...
Mit der Aktion **Retourenetikett** wird das Etikett zu einer <<auftragsabwicklung/auftraege/fulfillment/ruecksendeschein-erzeugen#, **Retoure**  >> per Subaktion automatisch z.B. gedruckt oder gespeichert.
...
Mit der Aktion **Rücksendeschein** wird ein Rücksendeschein per Subaktion automatisch z.B. gedruckt oder gespeichert. Dieser Rücksendeschein wird einem Artikel beigelegt, wenn der Kunde für eine <<auftragsabwicklung/auftraege/fulfillment/ruecksendeschein-erzeugen#, **Retoure**  >> einen Rücksendeschein benötigt.
