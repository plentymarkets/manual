...
Mit der Aktion **Wareneingang (einfach)** erfassen Sie den <<warenwirtschaft/wareneingaenge-verwalten#, Wareneingang>> einzelner Artikel und können diese Artikel direkt einem Lagerort zuweisen oder ein Etikett für den Artikel drucken lassen.
...
|*Druckerkonfiguration*
|Eine <<basics/arbeiten-mit-plentymarkets/drucker#10, Druckerkonfiguration>> aus der Dropdown-Liste wählen.
