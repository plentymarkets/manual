...
Mit der Aktion **SEPA Pain001** exportieren Sie Transaktionsdateien Ihrer <<auftragsabwicklung/payment/bankdaten-verwalten#200, SEPA-Überweisungen>> in eine ZIP-Datei. Diese ZIP-Datei speichern Sie per Subaktion, um sie Ihrer Bank zur Verfügung zu stellen.
...
Mit der Aktion **SEPA Pain008** exportieren Sie Transaktionsdateien Ihrer <<auftragsabwicklung/payment/bankdaten-verwalten#200, SEPA-Lastschriften>> in eine ZIP-Datei. Diese ZIP-Datei speichern Sie per Subaktion, um sie Ihrer Bank zur Verfügung zu stellen.
