...
|*Etiketten*
|*Palette* = Beim Einbuchen werden Etiketten nur für die Paletten erstellt. +
*Palette und Kartons* = Beim Einbuchen werden Etiketten für die Paletten und die Kartons erstellt, die sich auf der Palette befinden.
