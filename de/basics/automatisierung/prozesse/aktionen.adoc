...
Mit der Aktion **FiBu-Export** wird eine CSV-Datei erzeugt, die in diverse <<auftragsabwicklung/auftraege/_buchhaltung#8, **Buchhaltungssysteme** >> importiert werden kann. Es stehen 2 Formate für diesen Export zur Auswahl, zum Einen **Ein Datensatz pro Artikelposition (Standard)** und zum Anderen **Ein Datensatz pro Rechnung und Umsatzsteuersatz**. Der <<basics/datenaustausch/daten-exportieren#10, **FiBu-Export** >> wird per Subaktion gespeichert.
