...
Mit der Aktion **Auftrag** werden verschiedene Vorgänge in der <<auftraege/auftraege-bearbeiten/auftrag-aendern#, **Auftragsbearbeitung**  >> per Subaktion automatisch ausgeführt, z.B. wird der Status von ausgewählten Aufträgen geändert oder es werden Paketnummern erfasst.
...
Mit der Aktion **FiBu-Export** wird eine CSV-Datei erzeugt, die in diverse <<mandant-shop/standard/buchhaltung#8, **Buchhaltungssysteme** >> importiert werden kann. Es stehen 2 Formate für diesen Export zur Auswahl, zum Einen **Ein Datensatz pro Artikelposition (Standard)** und zum Anderen **Ein Datensatz pro Rechnung und Umsatzsteuersatz**. Der <<basics/datenaustausch/daten-exportieren#10, **FiBu-Export** >> wird per Subaktion gespeichert.
...
Mit der Aktion **Gutschrift** werden für die Aufträge <<auftraege/fulfillment/gutschriften-erzeugen#, **Gutschriften erzeugt**  >>, die per gewählter Subaktion z.B. automatisch gedruckt oder gespeichert werden.
...
Mit der Aktion **Korrekturbeleg** werden für die jeweiligen Aufträge <<mandant-shop/standard/dokumente/korrekturbeleg#, **Korrekturbelege**  >> generiert, die per gewählter Subaktion z.B. automatisch gedruckt oder gespeichert werden.
...
Mit der Aktion **Lager-Pickliste** werden für die Aufträge <<auftraege/fulfillment/lager-pickliste#, **Lager-Picklisten**  >> generiert, die per gewählter Subaktion z.B. automatisch gedruckt oder gespeichert werden.
...
Mit der Aktion **Lieferschein** werden automatisch <<auftraege/fulfillment/lieferscheine-erzeugen#, **Lieferscheine**  >> für die Aufträge generiert. Diese Lieferscheine werden per Subaktion z.B. gedruckt oder gespeichert.
...
Mit der Aktion **Mahnung** werden für die Aufträge <<auftraege/fulfillment/mahnungen-erzeugen#, **Mahnungen**  >> generiert. Diese Mahnungen werden per Subaktion z.B. automatisch gedruckt oder gespeichert.
...
Mit der Aktion **Packliste** wird eine Liste der für den Versand kommissionierten Artikel erzeugt. Die <<auftraege/fulfillment/packliste#, **Packliste**  >> wird per Subaktion z.B. gedruckt oder gespeichert.
...
Mit der Aktion **Pickliste** wird eine im Rahmen der Grobkommissionierung erzeugte <<auftraege/fulfillment/pickliste#, **Pickliste**  >> per Subaktion z.B. gedruckt oder gespeichert. Erfasst werden Aufträge ab dem Auftragsstatus **5 Freigabe Versand**. Bei diesen Aufträgen wurde bereits ein Zahlungseingang gebucht (Wechsel von Status 3 nach 4). Außerdem ist die Ware verfügbar (Wechsel von Status 4 nach 5).
...
Mit der Aktion **Rechnung** werden für die Aufträge <<auftraege/fulfillment/rechnungen-erzeugen#, **Rechnungen erzeugt**  >>. Diese Rechnungen werden per Subaktion z.B. gedruckt oder gespeichert.
...
|**Artikelstatus**
|Einen Artikelstatus wählen, der im Prozess beim Anlegen der Retoure voreingestellt wird. Die Artikelstatus für Retouren werden im Menü **<<auftraege/einstellungen/auftragstypen/retoure#, Einstellungen » Aufträge » Auftragstypen » Retoure  >>** angelegt.

|**Artikelwert**
|Einen Prozentwert eingeben, um ihn retournierten Artikeln zuzuweisen. Nachdem eine Retoure angelegt wurde, wird der Wert auch im Tab **Übersicht** einer **<<auftraege/auftraege-bearbeiten/retoure#, Retoure  >>** bei der Artikelposition angezeigt.
...
|**Retourengrund**
|Grund wählen, damit Retouren beim Anlegen diesen Rückgabegrund erhalten. Retourengründe werden im Menü **<<auftraege/einstellungen/auftragstypen/retoure#, Einstellungen » Aufträge » Auftragstypen » Retoure  >>** erstellt.
|====
...
Mit der Aktion **Retourenetikett** wird das Etikett zu einer <<auftraege/fulfillment/ruecksendeschein-erzeugen#, **Retoure**  >> per Subaktion automatisch z.B. gedruckt oder gespeichert.
...
Mit der Aktion **Rücksendeschein** wird ein Rücksendeschein per Subaktion automatisch z.B. gedruckt oder gespeichert. Dieser Rücksendeschein wird einem Artikel beigelegt, wenn der Kunde für eine <<auftraege/fulfillment/ruecksendeschein-erzeugen#, **Retoure**  >> einen Rücksendeschein benötigt.
...
Mit der Aktion **SEPA Pain001** exportieren Sie Transaktionsdateien Ihrer <<payment/bankdaten-verwalten#200, **SEPA-Überweisungen** >> in eine ZIP-Datei. Diese ZIP-Datei speichern Sie per Subaktion, um sie Ihrer Bank zur Verfügung zu stellen.
...
Mit der Aktion **SEPA Pain008** exportieren Sie Transaktionsdateien Ihrer <<payment/bankdaten-verwalten#200, **SEPA-Lastschriften** >> in eine ZIP-Datei. Diese ZIP-Datei speichern Sie per Subaktion, um sie Ihrer Bank zur Verfügung zu stellen.
...
Für die Ausführung eines Prozesses zum <<payment/bankdaten-verwalten#200, **SEPA-Zahlungsverkehr** >> ist für jede Variante ein eigener Prozess erforderlich, um beide Lastschriftarten zu erfassen. Damit die Lastschriften korrekt erfasst werden, bei den Arbeitsschritten den Filter **Art der Lastschrift** hinterlegen.
...
Mit der Aktion **Versand-Center** wird ein <<fulfillment/versand-center#, **Versandauftrag**  >> per Subaktion automatisch z.B. gedruckt oder gespeichert.
