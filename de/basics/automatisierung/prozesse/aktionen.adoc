...
Mit dem Steuerelement Dialog können Sie z.B. eine Abfrage erstellen, welcher Dienst eines Versanddienstleisters für Aufträge verwendet werden soll. Die verfügbaren Dienste werden dabei als Buttons angezeigt. Der Bearbeiter wählt im Prozess über den Button den gewünschten Dienst.
...
Mit der Aktion **Auftrag** werden verschiedene Vorgänge in der <<auftragsabwicklung/auftraege/auftraege-verwalten#auftrag-aendern, Auftragsbearbeitung>> per Subaktion automatisch ausgeführt, z.B. wird der Status von ausgewählten Aufträgen geändert oder es werden Paketnummern erfasst.
...
|Wählen, ob für diese Parameter ein Suchfeld bei Ausführung des Prozesses angezeigt werden soll. D.h. ob nach diesen Daten gesucht werden kann. Aufträge können dann nicht nur anhand der Auftrags-ID, sondern auch anhand der weiteren Parameter, zum Beispiel der Rechnungsnummer, gefunden werden.
...
Mit der Aktion **Gutschrift** werden für die Aufträge <<auftragsabwicklung/auftraege/auftragsdokumente/gutschriften-erzeugen#, Gutschriften erzeugt>>, die per gewählter Subaktion z.B. automatisch gedruckt oder gespeichert werden.
...
Mit der Aktion **Lager-Pickliste** werden für die Aufträge <<auftragsabwicklung/auftraege/auftragsdokumente/lager-pickliste#, Lager-Picklisten>> generiert, die per gewählter Subaktion z.B. automatisch gedruckt oder gespeichert werden.
...
Mit der Aktion **Lieferschein** werden automatisch <<auftragsabwicklung/auftraege/auftragsdokumente/lieferscheine-erzeugen#, Lieferscheine>> für die Aufträge generiert. Diese Lieferscheine werden per Subaktion z.B. gedruckt oder gespeichert.
...
Mit der Aktion **Mahnung** werden für die Aufträge <<auftragsabwicklung/auftraege/auftragsdokumente/mahnungen-erzeugen#, Mahnungen>> generiert. Diese Mahnungen werden per Subaktion z.B. automatisch gedruckt oder gespeichert.
...
Mit der Aktion **Packliste** wird eine Liste der für den Versand kommissionierten Artikel erzeugt. Die <<auftragsabwicklung/auftraege/auftragsdokumente/packliste#, Packliste>> wird per Subaktion z.B. gedruckt oder gespeichert.
...
Mit der Aktion **Pickliste** wird eine im Rahmen der Grobkommissionierung erzeugte <<auftragsabwicklung/auftraege/auftragsdokumente/pickliste#, Pickliste>> per Subaktion z.B. gedruckt oder gespeichert. Erfasst werden Aufträge ab dem Auftragsstatus **5 Freigabe Versand**. Bei diesen Aufträgen wurde bereits ein Zahlungseingang gebucht (Wechsel von Status 3 nach 4). Außerdem ist die Ware verfügbar (Wechsel von Status 4 nach 5).
...
Mit der Aktion **Rechnung** werden für die Aufträge <<auftragsabwicklung/auftraege/auftragsdokumente/rechnungen-erzeugen#, Rechnungen erzeugt>>. Diese Rechnungen werden per Subaktion z.B. gedruckt oder gespeichert.
...
Mit der Aktion **Retourenetikett** wird das Etikett zu einer <<auftragsabwicklung/auftraege/auftragsdokumente/ruecksendeschein-erzeugen#, Retoure>> per Subaktion automatisch z.B. gedruckt oder gespeichert.
...
Mit der Aktion **Rücksendeschein** wird ein Rücksendeschein per Subaktion automatisch z.B. gedruckt oder gespeichert. Dieser Rücksendeschein wird einem Artikel beigelegt, wenn der Kunde für eine <<auftragsabwicklung/auftraege/auftragsdokumente/ruecksendeschein-erzeugen#, Retoure>> einen Rücksendeschein benötigt.
...
Mit der Aktion **Versand-Center** wird ein <<auftragsabwicklung/fulfillment/versand-center#, Versandauftrag>> per Subaktion automatisch z.B. gedruckt oder gespeichert.
