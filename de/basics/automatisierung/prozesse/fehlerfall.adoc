...
image::basics/automatisierung/prozesse/assets/DE-Prozesse-Fehlerfall-01.png[]

__Bild 1: Aktion **Versand-Center** mit Option zur **Fehlerbehandlung**__
...
image::basics/automatisierung/prozesse/assets/DE-Prozesse-Fehlerfall-02.png[]

__Bild 2: Aktionen in der **Fehlerbehandlung**__
