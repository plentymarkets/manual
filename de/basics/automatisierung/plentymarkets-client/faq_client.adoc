...
image:basics/automatisierung/plentymarkets-client/assets/client-login-url.png[]
...
image::basics/automatisierung/plentymarkets-client/assets/client-englisch.png[]
...
Oder noch besser: Steige auf <<basics/automatisierung/plentybase-installieren, plentyBase>> um.
...
image::basics/automatisierung/plentymarkets-client/assets/client_start_macos.png[]
