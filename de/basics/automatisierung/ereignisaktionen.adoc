...
Einige praktische Anwendungsbeispiele für die Verwendung von Ereignisaktionen finden Sie auf der Handbuchseite <<basics/automatisierung/best-practices-automatisierung#, Best Practices: Ereignisaktionen und Aktionsmanager>>.
