...
|Mit dieser Aktion werden Statusänderungen von Aufträgen, die vom Marktplatz Cdiscount stammen, an <<omni-channel/multi-channel/cdiscount/cdiscount-einrichten#1300, Cdiscount>> gemeldet.
...
Verfügbar für: <<omni-channel/multi-channel/hood#600, Hood>>, <<omni-channel/multi-channel/ricardo-ch#700, ricardo>>, <<omni-channel/multi-channel/eBay/ebay-einrichten#1300, eBay>>.
