...
|Diese Ereignisse beziehen sich ausschließlich auf den Auftragstyp Nachbestellung. Je nach der Auswahl, die Sie hier treffen, ist das auslösende Ereignis eine vollständige oder teilweise Ein- oder Ausbuchung der nachbestellten Waren.
|====
...
|*Empfängerlager*
|Dieser Filter durchsucht Aufträge des Typs Nachbestellung anhand des Empfängerlagers, an das die Nachbestellung geliefert wird.
|====
...
Jeweils eigene Aktionen sind verfügbar für: *ClickandBuy*, <<multi-channel/allyouneed/allyouneed-einrichten#, Allyouneed>>, <<auftragsabwicklung/payment/payone#, PAYONE>>, <<auftragsabwicklung/payment/postpay#, POSTPAY>>, <<auftragsabwicklung/payment/worldpay#, Worldpay>> und <<auftragsabwicklung/payment/klarna#, Klarna>>.
...
Jeweils eigene Aktionen sind verfügbar für: <<auftragsabwicklung/payment/klarna#, Klarna>>, <<multi-channel/amazon/amazon-einrichten#, Amazon>>, <<omni-channel/multi-channel/allyouneed/allyouneed-einrichten#, Allyouneed>>, <<omni-channel/multi-channel/plus-gartenxxl#, Netto eStores>>, <<auftragsabwicklung/payment/postpay#, POSTPAY>>, <<omni-channel/multi-channel/rakuten/rakuten-einrichten#, Rakuten>>, <<omni-channel/multi-channel/shopgate#, Shopgate>>, <<omni-channel/multi-channel/flubit#, Flubit>>, <<omni-channel/multi-channel/idealo/idealo-einrichten#, idealo>>, <<omni-channel/multi-channel/fruugo#, Fruugo>> und <<omni-channel/multi-channel/cdiscount#, Cdiscount>>. +
