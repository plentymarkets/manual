...
[.linkBox]
link:https://www.plentymarkets.eu/a-2827/[Ereignisaktionen einrichten^]
...
|**Rechnung generiert**, **Lieferschein** ..., **Lieferanschriftenliste** ..., **Pickliste** ..., **Packliste** ..., **Angebot** ..., **Mahnung** ..., **Stornobeleg generiert**, **Auftragsbestätigung gesendet**, **Retourenlabel gespeichert**
|Wenn eines der Dokumente generiert wird, z.B. wenn eine PDF-Rechnung erzeugt wird oder wenn eine Rechnung existiert und **erneut erzeugt** wird. +
...
Den Prozentwert für **Anzahlungen auf Produktionsware** hinterlegen Sie im Menü <<auftragsabwicklung/auftraege/_grundeinstellungen#, System » Aufträge » Einstellungen>>.
...
[.linkBox]
link:https://www.plentymarkets.eu/a-2828/[Automatischer E-Mail-Versand mit Tracking URL^]

[.linkBox]
link:https://www.plentymarkets.eu/a-2829/[Retourenmeldung zu Amazon-FBA^]

[.linkBox]
link:https://www.plentymarkets.eu/a-2830/[Retourenabwicklung Amazon-FBA^]

[.linkBox]
link:https://www.plentymarkets.eu/a-2831/[Gratisartikel zum Auftrag hinzufügen^]

[.linkBox]
link:https://www.plentymarkets.eu/a-2832/[Auftragsabwicklung^]
...
**Amazon Prime** = Es werden nur <<omni-channel/multi-channel/amazon/amazon-einrichten#420, Amazon Prime>>-Aufträge gefiltert. +
...
Verfügbar für: **Amazon Pay**, **BillSAFE**, **DaWanda**, **eBay**, **Gimahhot**, **Hood**, **Klarna**, **LaRedoute**, **Masterpayment**, **Payolution**, **PAYONE**, **Plus.de**, **POSTPAY**, **Rakuten**, **Zentralverkauf**, **Worldpay**
|====
