...
|**Neuer Auftrag, ... Neuer unvollständiger Auftrag, ... Neuer Lieferauftrag, ... Neue Retoure, ... Neue Retoure (durch Kunde), ... Neue Gutschrift, ... Neue Reparatur, ...  Neuer Sammelauftrag, ... Neue Sammelgutschrift**
...
|**Wechsel der Auftragsart, ... Wechsel des Reparaturstatus**
...
<<tabelle-ereignisaktionen-ereignisgruppe-dokumente>> listet die *Ereignisse* auf, die als Auslöser einer Ereignisaktion bei der <<auftragsabwicklung/auftraege/auftragsdokumente/rechnungen-erzeugen#, Dokumentenerzeugung>> einstellbar sind.

[[tabelle-ereignisaktionen-ereignisgruppe-dokumente]]
[cols="1,3"]
|====
|Ereignis |Erläuterung
