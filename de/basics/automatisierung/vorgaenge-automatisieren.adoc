...
Verwenden Sie Ereignisaktionen, um Ihren **__Kunden__** zu einem bestimmten Anlass eine automatische **__E-Mail-Vorlage__** zu schicken. **E-Mail-Vorlagen** richten Sie unter **System » Mandant (Shop) » Standard » E-Mail » Vorlagen** ein. Beispielsweise können Sie Ihren Kunden:
