...
|*mediafinanz*
|Wählen Sie die Option *AKTIV*, wenn Sie den Inkassodienstleister <<auftragsabwicklung/payment/atriga#, mediafinanz>> in Ihrem plentymarkets System verwenden. Betroffene Aufträge werden dann automatisch von plentymarkets an mediafinanz gemeldet. Belassen Sie die Auswahl auf *---*, wenn Sie mediafinanz nicht nutzen.
|====
