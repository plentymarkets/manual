...
Diese Handbuchseite beschreibt den Datenimport in plentymarkets über das Plugin ElasticSync. ElasticSync erlaubt einmalige manuelle Importe und regelmäßige automatisierte Importe. Ein Import von Daten ist ratsam, wenn Sie z.B. neue Artikel, Kundendaten oder Lagerbestände in Ihr plentymarkets System einpflegen möchten und die Daten bereits digital vorliegen.
