...
*FTP* = Host, Port, Benutzername, Passwort und Dateiname werden als Einstellungen sichtbar.
    ...
    *_Hinweis:_* Wildcards in dem Feld *Dateiname* verwendet werden, indem z.B. ein Teil des Dateinamens durch ein *** ersetzt wird. Wildcards nur in Kombination mit der Option *Datei nach erfolgreichem Import in Archiv verschieben* verwenden.
