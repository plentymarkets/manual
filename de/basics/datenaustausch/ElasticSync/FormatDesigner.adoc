...
|Lager
|Lager, das der Auftragsposition zugeordnet ist

|Gewicht
|Gewicht, das an der Auftragsposition hinterlegt ist

|Breite
|Breite, die an der Auftragsposition hinterlegt ist

|Länge
|Länge, die an der Auftragsposition hinterlegt ist

|Höhe
|Höhe, die an der Auftragsposition hinterlegt ist
...
In <<tabelle-felder-orderitem-billing-address-option>> werden die Typen erläutert, die für den Export von Rechnungsadressen-Optionen zu Auftragspositionen zur Verfügung stehen.
