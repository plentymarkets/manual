= Daten mit FormatDesigner exportieren
:lang: de
...
Der FormatDesigner ermöglicht Ihnen, Formate für den Export per ElasticExport anzulegen. Alle per FormatDesigner angelegten Formate stehen Ihnen also im Menü *Daten » Elastischer Export* zur Verfügung. Sie können mithilfe des FormatDesigners nicht nur CSV-Optionen und ausgewählte Datenfelder bestimmen, sondern auch numerische Datenwerte während des Exports manipulieren.
...
[#200]
== Format vom Typ Artikel erstellen
...
|reservedListing
|Reservierungen von Listings

|reservedBundles
|Reservierungen von Artikelpaketen
...
[#1130]
== Format vom Typ Artikelbilder erstellen
...
[#440]
== Format vom Typ Attribute erstellen
...
[#450]
== Format vom Typ Kategorien erstellen
...
[#1140]
== Format vom Typ Hersteller erstellen
...
[#500]
== Format vom Typ Aufträge erstellen
...
[#700]
== Format vom Typ Auftragspositionen erstellen
...
[[tabelle-felder-orderitem-order-amount]]
.Felder für Export der Betröge zu Auftragspositionen
[cols="1,3"]
|====
|Feld |Erläuterung
...
[#1000]
== Format vom Typ Lager erstellen
