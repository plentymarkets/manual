...
Wenn Sie mehrere Zuordnungen in einem Sync pflegen können Sie bestimmte Zuordnungen eines Syncs in der Übersicht der Zuordnungen über image:de/basics/datenaustausch/ElasticSync/assets/activate-mapping.png[activate-mapping, title="activate-mapping"] deaktivieren bzw. aktivieren. Als Standard werden neue Zurodnungen im aktiv angelegt.
...
|ID
|Nummerisch (interne ID)
|IDs siehe *System » Einstellungen » Eigenschaften*
...
[#2480]
== Sync vom Typ Attribut einrichten
...
[#2510]
== Sync vom Typ Merkmal einrichten
