...
* *Kontakte, Firmen und Adressen* = Wählen, um <<basics/datenaustausch/export-import/daten-importieren#2200, Kontakt-, Firmen- und Adressdaten>> zu importieren.
* *Artikel* = Wählen, um <<basics/datenaustausch/export-import/daten-importieren#1900, Artikeldaten und Variantendaten>>  zu importieren.
* *Kategorien* = Wählen, um <<basics/datenaustausch/export-import/daten-importieren#2100, Kategoriedaten>> zu importieren.
...
* *Auftrag* = Wählen, um <<basics/datenaustausch/export-import/daten-importieren#2000, Auftragsdaten>> zu importieren.
* *Warehouse* = Wählen, um <<basics/datenaustausch/export-import/daten-importieren#2230, Lagerorte>> zu importieren.
...
|Nummerisch (interne ID); +
0 = unbekannt
|Siehe <<basics/interne-IDs#20, Länder-IDs>>
...
|Nummerisch (interne ID)
|ID der Auftragsherkunft, siehe <<basics/interne-IDs#90, IDs der Auftragsherkünfte>> +
...
|Inhalt Einheit
|Nummerisch (interne ID)
|Siehe <<basics/interne-IDs#40, IDs der Einheiten>> +
...
*_Tipp:_* Filter *Typ: Lieferant* setzen, um nur Lieferanten anzuzeigen.
