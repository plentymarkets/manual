...
Für den Import von Bestandsdaten stehen die in <<tabelle-zuordnungsfelder-bestand>> aufgelisteten Felder zur Verfügung. Anhand des gewählten Abgleichsfelds wird geprüft, ob der importierte Datensatz in plentymarkets vorhanden ist.
...
* Das Plugin Elastischer Export muss installiert und bereitgestellt sein.
