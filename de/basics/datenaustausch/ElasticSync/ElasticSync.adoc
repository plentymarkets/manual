...
|ID der Eigner siehe *System » Einstellungen » Benutzer*
...
|Sprache
|Buchstaben
|Nur bei Merkmalen des Typs *Text* oder *Kurztext* +
Codes siehe <<basics/interne-IDs#10, Sprachen>>
...
*_Tipp:_* Filter *Typ: Lieferant* setzen, um nur Kontakte des Typs Lieferant anzuzeigen.
