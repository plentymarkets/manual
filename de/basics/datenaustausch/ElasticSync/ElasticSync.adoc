...
Wenn Sie mehrere Zuordnungen in einem Sync pflegen können Sie bestimmte Zuordnungen eines Syncs in der Übersicht der Zuordnungen über image::assets/activate-mapping.png[activate-mapping, title="activate-mapping"] deaktivieren bzw. aktivieren. Als Standart werden neue Zurodnungen im aktiv angelegt.
