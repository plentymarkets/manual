...
NOTE: Für dieses Best Practice solltest mit der generellen Funktionsweise von Elastic Sync vertraut sein. Allgemeine Infos zum Plugin findest du auf der Handbuchseite <<basics/datenaustausch/ElasticSync/ElasticSync#, Daten mit ElasticSync importieren>>.
