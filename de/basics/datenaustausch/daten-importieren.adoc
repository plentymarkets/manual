...
====
Sie können Wildcards im Feld *Dateiname* verwenden, in dem Sie z.B. einen Teil des Dateinamens durch ein *** ersetzen. Verwenden Sie Wildcards mit *Datei nach erfolgreichem Import in Archiv verschieben*.
====
