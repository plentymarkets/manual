...
. Makieren Sie die gewünschte Datei im Datei-Browser und klicken Sie auf *wählen*. +
...
====
Wenn Sie Syncs aus einem anderen plentymarkets System importiert, müssen Sie Ihren Abgleich und die Zuordnung anpassen. Es können nur *.json* Dateien importiert werden.
====
...
ElasticSync kann per REST-API angesprochen werden. Folgende Rest calls können Sie verwenden:
