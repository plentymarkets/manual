...
Mit Syncs des Typs Warehouse importieren Sie neue Lagerorte oder aktualisieren bestehende Datensätze. Diese Daten sind z.B. Lagerortname, Position.

Um Lagerorte per ElasticSync zu aktualisieren, müssen die folgenden Datensätze in plentymarkets vorhanden sein:
