...
* *Artikel* = Wählen, um Artikeldaten und Variatendaten zu importieren, siehe Sync-Typ Artikel auf dieser Seite
* *Kategorien* = Wählen, um Kategriedaten zu importieren, siehe Sync-Typ Kategorien auf dieser Seite
...
* *Kontakte, Firmen und Adressen* = Wählen, um Kontakt-, Firmen- und Adressdaten zu importieren, siehe Sync-Typ Kontakte, Firmen und Adressen auf dieser Seite.
...
|Quelle
a|Zwischen FTP und HTTP wählen. +
...
. Legen Sie die Importoptionen fest. Beachten Sie dazu die Angaben in <<tabelle-Sync-Importoptionen>>.
. *Speichern* Sie die Einstellungen.
...
|Wenn keine Daten gefunden wurde
a|Wählen zwischen *Überspringen* und *Erstellen*
...
|Dezimalzahl
a|Wählen zwischen *Deutsche Schreibweise* und *Englische Schreibweise*

* *Deutsche Schreibweise* = Dezimalzahlen werden kommasepariert angegeben und ein Punkt dient als Tausendertrennzeichen
* *Englischen Schreibweise* = Dezimalzahlen werden punktsepariert angegeben und ein Komma dient als Tausendertrennzeichen

|Datumsformat
|Ein Datumsformat eingeben. Wenn die Datumsangaben in der Datei dem Standardformat Y-m-d H:i:s entsprechen, müssen Sie nichts eingeben. Andere Formate müssen eingetragen werden. Zulässig sind alle link:http://php.net/manual/de/function.date.php[php-konformen Datumsformate^].
...
In der <<tabelle-Abgleichfelder-Artikel>> werden Ihnen Felder erläutert, die für den Abgleich von Artikeldaten zur Verfügung stehen. Anhand des gewählten Feldes wird geprüft, ob der importierte Datensatz in plentymarkets vorhanden ist.
...
In der <<tabelle-Zuordnungsfelder-Artikel>> werden Ihnen Felder erläutert, die für den Abgleich von Artikeldaten zur Verfügung stehen. Anhand des gewählten Feldes wird geprüft, ob der importierte Datensatz in plentymarkets vorhanden ist.
...
Tabelle 6 listet mögliche Aktionen für Syncs des Typs Artikel und erläutert die Werte, die zum Ausführen dieser Aktionen unbedingt angegeben werden müssen.
...
In der <<tabelle-Zuordnungsfelder-Auftraege>> werden Ihnen Felder erläutert, die für den Abgleich von Kategoriedaten zur Verfügung stehen. Anhand des gewählten Feldes wird geprüft, ob der importierte Datensatz in plentymarkets vorhanden ist.
...
|Wert
|Alphanumerisch
a|Einen Eigenschaftstyp wählen und anschließend die Spalte wählen, in der die Eigenschaft enthalten ist. Standardmäßig stehen folgende Eigenschaften für Auftragspositionen zur Verfügung:
* Lager
* Gewicht
* Breite
* Länge
...
|Wert
|Alphanummerisch
a|Einen Eigenschaftstyp wählen und anschließend die Spalte wählen, in der die Eigenschaft enthalten ist. Standardmäßig stehen folgende Eigenschaften für Aufträge zur Verfügung:
* Lager
* Versandprofil
* Zahlungsart
* Zahlungsstatus
...
|Datum
|
|Einen Datumstyp wählen und anschließend die Spalte wählen, in der das Datum enthalten ist. Das Datumsformat in der Spalte muss in dem Datumsformat angegeben sein, dass Sie in den Importoptionen definiert haben.

3+|Auftragsrelation

|Referenz-ID
|
a|Eine Auftragsrelation wählen und anschließend die Spalte wählen, in der die Referenz-ID enthalten ist. Folgende Relationen stehen zur Wahl:
...
2+|Versandpaket
|Egal welche Paketinformation gewählt werden, zunächst müssen Sie ein Versandpaket wählen, mit dem diese Informationen abgestimmt werden. Versandpakete richten Sie im Menü *System » Aufträge » Versand » Versandpakete* ein.
...
In der <<tabelle-Abgleichfelder-Kategorie>> werden Ihnen Felder erläutert, die für den Abgleich von Kategoriedaten zur Verfügung stehen. Anhand des gewählten Feldes wird geprüft, ob der importierte Datensatz in plentymarkets vorhanden ist.
...
In der <<tabelle-Zuordnungsfelder-Kategorie>> werden Ihnen Felder erläutert, die für den Abgleich von Kategoriedaten zur Verfügung stehen. Anhand des gewählten Feldes wird geprüft, ob der importierte Datensatz in plentymarkets vorhanden ist.
...
=== Sync vom Typ Warehouse einrichten

Mit Syncs des Typs Warehouse importieren Sie neue Lagerorte oder aktualisieren bestehende.

Um Lagerorte per ElasticSync zu erstellen oder zu aktualisieren, müssen Sie lediglich ein Lager angelegt haben.
...
Wenn Sie weitere Informationen zu den Begrifflichkeiten Dimensionen, Ebenen und Lagerorten suchen, dann können Sie sich hier informieren: https://knowledge.plentymarkets.com/warenwirtschaft/lager-einrichten

[[tabelle-Abgleichfelder-Kategorie]]
.Abgleichfelder für Lagerortimport
[cols="2,2"]
|====
|Abgleichsfeld |Erläuterung

|WarehouseId
|Id des Lagers

|LevelName
|Name der Ebene z.B. Regal1
...
. Wählen sie aus der rechten Seite aus *Warehouse Location* die Felder *Storage Location ID*, *Storage location name* und *Position*.

==== Lagerorte erstellen

Sie können mit ElasticSync neue Lagerorte anlegen.
...
. *Speichern* Sie die Einstellungen.
. Klicken Sie auf *Zuordnung* und öffnen Sie eine entsprechende Zurodnung aus der Übersicht.
. Wählen sie aus der rechten Seite aus *Warehouse Location* die Felder *Level ID*, *Storage Location ID*, *Storage location name*, *Purpose*, *Status* und *Position*, *Type*.
. Wählen sie aus der rechten Seite aus *Warehouse Location Level* die Felder *Dimension ID*, *Level Position* und *Level name*.
