...
. Legen Sie die Importoptionen fest. Beachten Sie dazu die Angaben in Tabelle <<tabelle-Sync-Importoptionen>>.
. *Speichern* Sie die Einstellungen.
...
. Klicken Sie in der Sync-Übersicht auf den gewünschten Sync. +
→ Die Abgleichoptionen des Syncs werden angezeigt.
. Nehmen Sie die Einstellungen vor. Beachten Sie dazu die Angaben in Tabelle...
. *Speichern* Sie die Einstellungen.
...
In der Tabelle <<tabelle-Zuordnungsfelder-Auftraege>> werden Ihnen Felder erläutert, die für den Abgleich von Kategoriedaten zur Verfügung stehen. Anhand des gewählten Feldes wird geprüft, ob der importierte Datensatz in plentymarkets vorhanden ist.
...
In der Tabelle <<tabelle-Abgleichfelder-Kategorie>> werden Ihnen Felder erläutert, die für den Abgleich von Kategoriedaten zur Verfügung stehen. Anhand des gewählten Feldes wird geprüft, ob der importierte Datensatz in plentymarkets vorhanden ist.
...
In der Tabelle <<tabelle-Zuordnungsfelder-Kategorie>> werden Ihnen Felder erläutert, die für den Abgleich von Kategoriedaten zur Verfügung stehen. Anhand des gewählten Feldes wird geprüft, ob der importierte Datensatz in plentymarkets vorhanden ist.
