...
|Auswahl unter **Kundenregistrierung** der Kundeneigenschaft. +
...
|Auswahl unter **Kundensuche** der Kundeneigenschaft. +
...
|Auswahl unter **Pflichtfeld** der Kundeneigenschaft. +
...
|Auswahl unter **Bestellvorgang** der Kundeneigenschaft. +
