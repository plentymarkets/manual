...
|Filter aktivieren und Kundenklasse aus dem Dropdown-Menü wählen. Um Daten für alle Kundenklassen zu exportieren, Filter nicht aktivieren. Kundenklassen werden im Menü <<crm/kundendaten-verwalten#100, System » CRM » Kundenklassen>> erstellt.
|====
