...
Die in <<tabelle-datenformat-category-abgleich>> aufgelisteten Datenfelder stehen zum <<basics/datenaustausch/daten-importieren#10, Datenabgleich>> zur Verfügung. Bei Pflichtabgleichfeldern (P) muss für die **Importaktion** die Option **Abgleich** gewählt werden.
