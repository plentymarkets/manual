...
Die in Tabelle 4 aufgelisteten Datenfelder stehen bei allen drei Datenformaten zum <<basics/datenaustausch/daten-importieren#10, Datenabgleich>> zur Verfügung. Bei Pflichtabgleichfeldern (P) muss für die **Importaktion** die Option **Abgleich** gewählt werden.
