...
|**Barcode_xxx**
|Barcode +
**__Hinweis__**: Die Anzeige der Barcode-Datenfelder richtet sich danach, welchen Barcode-Typ Sie im Menü **System » Artikel » Barcode** gewählt haben. Verfügbare Barcode-Typen: **GTIN 8**, **GTIN 13**, **GTIN 14**, **GTIN 128**, **ISBN**, **QR**, **CODE 128** und **UPC**.
|Filter aktivieren, Operator wählen und Wert eingeben.
...
|**Barcode_xxx**
|Barcode, wie im Menü **System » Artikel » Barcode** erstellt
