...
Detaillierte Informationen zur Vorgehensweise beim Datenaustausch mit dem Datenformat **Stock** finden Sie im Kapitel <<basics/datenaustausch/daten-exportieren#90, Warenbestände exportieren>> auf der Handbuchseite **Daten exportieren**.
...
|**PriceUnit**
|Standardeinheit des Artikels; siehe Handbuchseite <<basics/datenaustausch/datenformate/item#, Datenformat Item>>.
|
...
|Filter aktivieren und Kundenklasse wählen. Um Daten für alle Kundenklassen zu exportieren, Filter nicht aktivieren. Kundenklassen werden im Menü <<crm/kundendaten-verwalten#100, System » Kunden » Kundenklassen>> angelegt.
|====
