...
Mit dem Datenformat **OrderComplete** exportieren Sie Aufträge. Dieses Datenformat steht ausschließlich für den Export zur Verfügung. Sie erstellen und exportieren das Datenformat im Menü **Daten » Dynamischer Export**. Wie Sie das Datenformat exportieren, ist auf der Handbuchseite <<basics/datenaustausch/daten-exportieren#, Daten exportieren>> beschrieben.
