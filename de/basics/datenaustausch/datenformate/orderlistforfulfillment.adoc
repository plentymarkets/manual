...
|**CustomerGroup**
|Kundenklasse
|Filter aktivieren, Operator wählen und Klasse aus dem Dropdown-Menü wählen.
...
|**OrderStatus**
|Auftragsstatus
|Filter aktivieren, Operator und Status aus dem Dropdown-Menü wählen.
...
__**image::basics/datenaustausch/datenformate/assets/DE-Datenformat-OrderListForFulfillment-01.png[]**__
