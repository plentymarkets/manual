...
Das Datenformat **Attribute** wird für Attribute und Attributwerte verwendet. Sie können mit diesem Datenformat keine Varianten erstellen. Sie erstellen und exportieren das Datenformat im Menü **Datenaustausch » Export » Dynamischer Export**. Importieren Sie das Datenformat wieder im Menü **Datenaustausch » Import » Dynamischer Import**. Wie Sie das Datenformat exportieren und importieren, ist auf den Handbuchseiten **<<basics/datenaustausch/daten-exportieren#, Daten exportieren>>** und **<<basics/datenaustausch/daten-importieren#, Daten importieren>>** beschrieben.
...
__Tab. 1: Datenfelder des Datenformats **Attribute**__
