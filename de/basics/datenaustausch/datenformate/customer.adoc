...
Das folgende Datenfeld steht zum <<basics/datenaustausch/daten-importieren#10, Datenabgleich>> zur Verfügung. Bei diesem Pflichtabgleichfeld muss für die **Importaktion** die Option **Abgleich** gewählt werden.
