...
Das Datenformat **Item** enthält alle Datenfelder für Artikeldaten, die Sie damit exportieren, bearbeiten und importieren. Sie erstellen und exportieren das Datenformat im Menü **Datenaustausch » Export » Dynamischer Export**. Importieren Sie das Datenformat wieder im Menü **Datenaustausch » Import » Dynamischer Import**. Wie Sie das Datenformat exportieren und importieren, ist auf den Handbuchseiten **<<basics/datenaustausch/daten-exportieren#, Daten exportieren  >>** und **<<basics/datenaustausch/daten-importieren#, Daten importieren  >>** beschrieben.
...
|Artikel verfügbar über WebAPI; Datenschnittstelle zum Datenaustausch mit **<<basics/datenaustausch/daten-exportieren#30, Preissuchmaschinen >>** +
**0** = Nein +
**1** = Ja
|Filter aktivieren und Wert aus dem Dropdown-Menü wählen.
...
|Marktplatz Yatego, Artikel verfügbar für **<<omni-channel/multi-channel/yatego#, Yatego  >>**-Export +
**0** = Nein +
**1** = Ja
|Filter aktivieren und Wert aus dem Dropdown-Menü wählen.
