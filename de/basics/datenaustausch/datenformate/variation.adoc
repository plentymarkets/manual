...
Mit dem Datenformat **Variation** exportieren, bearbeiten und importieren Sie Variantendaten. Sie erstellen und exportieren das Datenformat im Menü **Datenaustausch » Export » Dynamischer Export**. Importieren Sie das Datenformat wieder im Menü **Datenaustausch » Import » Dynamischer Import**. Wie Sie das Datenformat exportieren und importieren, ist auf den Handbuchseiten **<<basics/datenaustausch/daten-exportieren#, Daten exportieren>>** und **<<basics/datenaustausch/daten-importieren#, Daten importieren>>** beschrieben.
...
====
Das Erstellen von neuen Kategorien ist mit dem Datenformat **Variation** nicht möglich. Sie können mit dem Datenformat **Variation** lediglich neue Kategorieverknüpfungen an der Variante erstellen. Verwenden Sie daher das Datenformat **<<basics/datenaustausch/datenformate/category#, Category>>**, um neue Kategorien zu erstellen.
====
...
|**UnitID**
|ID der Einheit; ID-Liste im Menü **Einstellungen » Artikel » Einheiten**
|
...
|**VariationAttributes**
|Liste der Attribute, die mit der Variante verknüpft sind; ID-Liste im Menü **Einstellungen » Artikel » Attribute**
|
...
__Tab. 1: Datenfelder des Datenformats **Variation**__
