...
|*BolItemExport*
|Auf *bol.com* bieten Sie Ihre Artikel zum Verkauf an. Dieses Exportformat wird benötigt, um Ihren Artikelkatalog zu bol.com zu exportieren. Weitere Informationen zur Einrichtung von bol.com finden Sie auf der Handbuchseite <<omni-channel/multi-channel/bol-com, bol.com einrichten>>. +
Das Exportformat *BolItemExport* ist im Plugin *ElasticExport* enthalten.

|*BolOfferExport*
|Auf *bol.com* bieten Sie Ihre Artikel zum Verkauf an. Dieses Exportformat wird benötigt, um Ihre Angebote zu bol.com zu exportieren. Weitere Informationen zur Einrichtung von bol.com finden Sie auf der Handbuchseite <<omni-channel/multi-channel/bol-com, bol.com einrichten>>. +
...
|*KaufluxDE*
|Auf dem Marktplatz link:https://marketplace.plentymarkets.com/plugins/markets/elasticexportkaufluxde_4737/[Kauflux^] bieten Sie Ihre Artikel zum Verkauf an. Weitere Informationen zur Einrichtung von Kauflux finden Sie auf der Handbuchseite <<omni-channel/multi-channel/kauflux, Kauflux einrichten>>.
...
|*RakutenDE*
|Auf dem Marktplatz link:https://marketplace.plentymarkets.com/plugins/markets/elasticexportrakutende_4721/[Rakuten^] bieten Sie Ihre Artikel zum Verkauf an. Weitere Informationen zur Einrichtung von Rakuten finden Sie auf der Handbuchseite <<omni-channel/multi-channel/rakuten/rakuten-einrichten, Rakuten einrichten>>.
