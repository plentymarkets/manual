...
Eine Übersicht zu den Amazon-Produkttypen erhalten Sie http://www.plentymarkets.eu/tpl/download/plenty_article_amazon_type_view.csv[hier^]. Die Tabelle enthält die ID, den Namen des Exportformats, den Produkttyp und die Namen der Hauptkategorien und Unterkategorien in plentymarkets.
