...
Das Datenformat **ItemCategories** wird für den Export und Import von Kategorieverknüpfungen Ihrer Artikel verwendet. Sie können auch mit dem Datenformat <<basics/datenaustausch/export-import/datenformate/item#, Item>> Kategorieverknüpfungen per Datenaustausch bearbeiten. Das Datenformat **ItemCategories** ist jedoch besonders geeignet, um Mehrfachverknüpfungen pro Artikel vorzunehmen oder zu bearbeiten. +
