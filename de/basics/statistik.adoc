...
**__Tipp:__** Datentabellen bieten sehr detaillierte Werte auf einen Blick. Allerdings zeigen sie Entwicklungen nicht so deutlich auf wie z.B. Linien-, Säulen- oder Balkendiagramme. +
