...
Damit für Benutzer mit der Benutzerklasse *Variabel* das Menü *Start » Aufgaben* sichtbar ist, muss das Menü im Benutezrkonto freigeschaltet werden.

[.instruction]
Sichtbarkeit für variablen Benutzer einstellen:

. Öffnen Sie das Menü *System » Einstellungen » Benutzer » Konten*.
. Öffnen Sie den Benutzer mit der Benutzerklasse *Variabel*, für den Sie die Sichtbarket des Menüs aktivieren möchten.
...
====
Um Aufgaben einem Ticket zuzuordnen, muss die Aufgabe im <<crm/ticketsystem-nutzen#4000, Ticket>> erstellt werden. Jedes Ticket hat ein Tab *Aufgaben*, in dem eine neue Aufgabe erstellt werden kann. Im Tabtitel im Ticket wird die Anzahl der Aufgaben in Klammern angezeigt. Aufgaben, die im Ticket erstellt wurden, werden ebenfalls in der Aufgabenübersicht im Menü *Start » Kalender* angezeigt.
====
...
. Wählen Sie eigene Filter. Beachten Sie dazu die Erläuterungen in <<tabelle-aufgabe-suchen>> im Kapitel <<basics/arbeiten-mit-plentymarkets/aufgaben-und-kalender#400, Aufgaben suchen>>.
...
→ Alle eigenen unerledigten Aufgaben werden angezeigt, da beim Öffnen des Menüs standardmäßig der Filter für den Fortschritt auf *< 100%* gesetzt und in der Dropdown-Liste *Eigner* der aktive Benutzer vorausgewählt ist.
. Klicken Sie auf *Reset*, um die Filter zu entfernen.
. Wählen Sie eigene Filter. Beachten Sie dazu die Erläuterungen in <<tabelle-aufgabe-suchen>>.
. Klicken Sie auf *Suchen*. +
→ Die Aufgaben, die den eingestellten Suchkriterien entsprechen, werden angezeigt.
...
→ Der Bereich *Meine Aufgaben* wird Ihnen ab sofort auf dem Dashboard angezeigt.
...
Damit für Benutzer mit der Benutzerklasse *Variabel* das Menü *Start » Kalender* sichtbar ist, muss das Menü im Benutezrkonto freigeschaltet werden.
