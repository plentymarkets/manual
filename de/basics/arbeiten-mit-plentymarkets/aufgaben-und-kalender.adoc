...
→ *_Tipp:_* Tipp: Zeigen Sie dazu mit der Maus auf das plentymarkets Logo oben links.
...
[#800]
=== Grundeinstellungen für den Kalender vornehmen und Zugriffsrechte für Benutzer einstellen
