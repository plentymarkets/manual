...
Nutze das Menü *plentymarkets Logo (Start) » Aufgaben*, um Tätigkeiten für alle Benutzer des Systems zu verwalten, z.B. "Kunde xy anrufen". Du siehst den Fortschritt einer Aufgabe und kannst weitere Abläufe für dein Geschäft planen sowie interne Abläufe verbessern.
...
Mit einem Klick auf *ToDo eingeben* im Bereich *Meine Aufgaben* gelangst du direkt in das Menü *plentymarkets Logo (Start) » Aufgaben* und kannst dort eine neue <<basics/arbeiten-mit-plentymarkets/aufgaben-und-kalender#300, Aufgabe erstellen>>.
...
Der Kalender im Menü *plentymarkets Logo (Start) » Kalender* deines plentymarkets Systems bietet dir die Möglichkeit, Termine zu planen, um deine zeitliche Organisation und die deiner Mitarbeiter zu steuern und interne Abläufe zu verbessern.
...
Nutzer vom Typ *Backend* sehen nur bestimmte Bereiche und Menüs in plentymarkets. Somit können sie nur eingeschränkt im System arbeiten. Sollen Mitarbeiter mit diesem Nutzertyp das Menü *plentymarkets Logo (Start) » Kalender* sehen können, muss ein Nutzer vom Typ *Admin* das im folgenden beschriebene Recht für diesen Benutzer vergeben.
