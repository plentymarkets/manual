...
. Klicke auf das Konto, für das du die Sichtbarkeit des Menüs und die Berechtigungen aktivieren möchten. +
→ Die Ansicht *Rechte* wird geöffnet.
. Klappe im Bereich *Menü-Sichtbarkeiten* die Option *Start* auf.
. Aktiviere die Option *Aufgaben*. +
...
. Klicke auf *Reset*, um die Filter zu entfernen.
