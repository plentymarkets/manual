...
.CNAME speichern
image::basics/arbeiten-mit-plentymarkets/assets/DE-ServiceCenter-Domain-01.png[CNAME speichern]
...
Sie bestellen das SSL-Zertifikat für Ihre <<basics/arbeiten-mit-plentymarkets/plentymarkets-konto#domain, Hauptdomain>>, d.h. die Domain, die im Menü *Start » Service-Center » Tab: Domain* als Hauptdomain eingestellt ist (Bild 1, blauer Pfeil). Wenn Sie für eine andere Domain ein SSL-Zertifikat einrichten möchten, müssen Sie diese Domain zunächst als Hauptdomain festlegen.

.plentymarkets-Service-Center; Domains
image::basics/arbeiten-mit-plentymarkets/assets/DE-ServiceCenter-SSL-01-SI.png[plentymarkets-Service-Center; Domains]
...
image::basics/arbeiten-mit-plentymarkets/assets/DE-ServiceCenter-SSL-02-SI.png[plentymarkets-Service-Center; Restlaufzeit]
...
== Agenturen Zugang zum System geben
...
. Öffnen Sie im das Menü **Start » Service-Center » Tab: Ihre Agentur**.
...
image::basics/arbeiten-mit-plentymarkets/assets/ServiceCenter-IhreAgentur-01.png[Ansicht für die freigeschaltete Agentur]
