...
*_Tipp:_*  Um dieses Verhalten von Bots zumindest teilweise zu steuern, können Sie die <<omni-channel/online-shop/webshop-einrichten/cms-syntax#80, Sperrung von Bots>> per robots.txt-Datei veranlassen.
