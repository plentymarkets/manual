...
<<omni-channel/online-shop#, Mandant (Shop)>> sind weitere Webshops, die über den zugeordneten Hauptshop in Ihrem plentymarkets System konfigurierbar sind. Im Menü **Start » Service-Center » Tab: Mandant (Shop)** werden Ihre Mandanten (Shops) angezeigt. Bei Bedarf können Sie über dieses Menü auch Mandanten (Shops) kündigen.
...
image::basics/arbeiten-mit-plentymarkets/assets/ServiceCenter-Cache-02-SI-1.png[Funktion **Cache temporär deaktivieren**]
...
image::basics/arbeiten-mit-plentymarkets/assets/ServiceCenter-Cache-03-SI.png[ Funktion **Permanente SSL-Umleitung**]
