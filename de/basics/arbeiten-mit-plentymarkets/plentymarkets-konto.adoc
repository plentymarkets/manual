...
[.instruction]
Restlaufzeit des SSL-Zertifikats anzeigen:
...
Als Alternative zu kostenpflichtigen SSL-Zertifikaten bietet plentymarkets die Möglichkeit, SSL-Zertifikate der Zertifizierungsstelle link:https://letsencrypt.org[Let’s Encrypt^] zu nutzen. Ihr Verwaltungsaufwand ist bei einem Zertifikat von Let’s Encrypt deutlich geringer, da der Zertifizierungsprozess automatisiert und ohne manuelles Eingreifen durch die Zertifizierungsstelle abläuft. Diese Zertifikate verlängern sich außerdem automatisch und sind monatlich kündbar. Gehen Sie wie unten beschrieben vor, um ein SSL-Zertifikat von Let’s Encrypt zu aktivieren.

[IMPORTANT]
.Bereitstellungsgebühr beachten
====
SSL-Zertifikats von Let’s Encrypt sind kostenlos. Für Sie fällt bei der Nutzung eines SSL-Zertifikats von Let’s Encrypt lediglich eine monatliche Gebühr an, die plentymarkets für die Bereitstellung erhebt.
====
...
→ Die Bereitstellungsgebühr wird ihnen von plentymarkets monatlich in Rechnung gestellt.
