...
* Die Domain, für die das SSL-Zertifikat bestellt werden soll, muss eine im plentymarkets Service-Center aktivierte <<basics/arbeiten-mit-plentymarkets/plentymarkets-konto#210a, Hauptdomain>> sein. +
