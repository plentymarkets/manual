...
.CNAME eintragen
image::basics/arbeiten-mit-plentymarkets/assets/DE-ServiceCenter-Domain-01.png[CNAME eintragen]
...
image::basics/arbeiten-mit-plentymarkets/assets/DE-ServiceCenter-SSL-05-SI.png[SSL-Zertifikat; neue Gültigkeitsdaten]
...
image::basics/arbeiten-mit-plentymarkets/assets/DE-ServiceCenter-SSL-06-SI.png[SSL-Zertifikat; Zertifikat deaktivieren]
