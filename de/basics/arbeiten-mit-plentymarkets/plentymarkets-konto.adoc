...
* Die Domain, für die das SSL-Zertifikat bestellt werden soll, muss eine im plentymarkets Service-Center aktivierte <<basics/arbeiten-mit-plentymarkets#210a, Hauptdomain>> sein. +
→ Prüfen Sie die Einstellungen im plentymarkets Service-Center.

==== Bei externen Domains: DNS-Einstellungen

* Die beim <<basics/arbeiten-mit-plentymarkets/plentymarkets-konto#150, externen Provider gespeicherten DNS-Einstellungen>> müssen mit den DNS-Einstellungen im plentymarkets Service-Center identisch sein. +
