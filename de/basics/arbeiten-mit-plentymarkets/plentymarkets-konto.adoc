...
Prüfen Sie vor einer Bestellung, dass die E-Mail-Adresse **hostmaster@IhreDomain** eingerichtet ist und für diese E-Mail-Adresse keine Weiterleitung an den plentymarkets-Support eingerichtet ist. Gehen Sie dann wie unten beschrieben vor, um ein neues SSL-Zertifikat zu bestellen.
...
Wenn diese E-Mail-Adresse im System bereits vorhanden ist, prüfen Sie, ob für diese E-Mail-Adresse eine <<crm/e-mails-versenden#, Weiterleitung>> an die E-Mail-Adresse **support@plentymarkets.com** eingerichtet wurde. Deaktivieren Sie ggf. die Weiterleitung, damit Sie die E-Mails selbst empfangen.
====
