...
Bei einem Wechsel zu einem anderen <<basics/arbeiten-mit-plentymarkets/plentymarkets-konto#domain, **Provider**>> benötigen Sie für Ihre Domain einen Authentifizierungscode. Dieser Auth-Code weist Sie als Eigner der Domain aus. Den Auth-Code erzeugen Sie in diesem Bereich.
