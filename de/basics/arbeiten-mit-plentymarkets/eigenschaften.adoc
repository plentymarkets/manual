...
* <<crm/kontakte-verwalten#eigenschaften-verknuepfen, Eigenschaften mit dem Kontakt verknüpfen>>
...
Allgemeine Informationen zu Importieren von Daten in dein plentymarkets System findest du auf der Handbuchseite <<daten/daten-importieren/ElasticSync#, ElasticSync>>.
