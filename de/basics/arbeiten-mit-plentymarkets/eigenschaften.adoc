...
Im Menü *Einrichtung » Einstellungen » Eigenschaften » Konfiguration* erstellst du Eigenschaften für verschiedene Bereiche in plentymarkets.
...
Im Menü *Einrichtung » Einstellungen » Eigenschaften » Konfiguration* findest du alle Eigenschaften, die du bisher erstellt hast. Hier änderst du die in <<tabelle-eigenschaft-erstellen>> beschriebenen Einstellungen.
...
. Klicke auf *Gruppenfunktion* (icon:execute[set=plenty]). +
