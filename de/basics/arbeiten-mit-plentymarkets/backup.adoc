...
Mit der Backup-Funktion des Menüs **System » Einstellungen » Backup** setzen Sie Daten auf einen früheren Stand zurück oder stellen gelöschte Daten wieder her. Auch eine Kombination dieser Funktionen ist möglich.
...
Das Menü **System » Einstellungen » Backup** besteht aus drei Untermenüs:
...
Das Menü **System » Einstellungen » Backup » Bearbeitungsstatus** bietet eine Übersicht der durchgeführten Backups. In diesem Menü sind die Einstellungen, der Benutzer sowie Hinweise zum Backup und ggf. Fehlermeldungen einsehbar.
...
**Attribute** = Attribute, Attribut-Werte und die Sprache der Attributnamen des Menüs **System » Artikel » Attribute** +
