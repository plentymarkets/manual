...
|**IP-Beschränkung**
|IP-Adresse des Benutzerrechners eingeben, damit sich dieser nur über diese IP-Adresse in das plentymarkets System einloggt.
...
|**Gesperrt**
|Aktivieren, um den Benutzer zu sperren. Der Benutzer kann sich dann nicht mehr in das System einloggen.
|====
