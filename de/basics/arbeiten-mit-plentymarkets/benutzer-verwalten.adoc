...
Damit plentymarkets E-Mails, z.B. Auftragsbestätigungen, für Sie versenden kann, hinterlegen Sie im Menü **<<crm/e-mails-versenden#100, System » Mandant » Mandant öffnen » E-Mail » Zugangsdaten>>** die **link:https://support.mailbox.org/knowledge-base/article/einrichtung-mit-sonstigen-mailprogrammen[Zugangsdaten^]** zu dem mailbox.org-Postfach, über das Sie diese E-Mails versenden möchten.
...
System » Mandant » Mandant öffnen » Buchhaltung
|====
