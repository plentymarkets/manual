...
Sonderlager**
// TODO: fix link
|Benutzerberechtigungen für Lager erteilen. Nur erstellte Lagertypen stehen zur Verfügung. Weitere Details zu Lagertypen sind auf der Handbuchseite link:/[Einstellungen] beschrieben. +
+
+
+
...
Ordnen Sie jedem Benutzerkonto der Klasse **Variabel** nur die Berechtigungen zu, die dieser für seinen Aufgabenbereich benötigt. Dies erhöht die Sicherheit und beugt Fehlern in Ihrem plentymarkets System vor.
