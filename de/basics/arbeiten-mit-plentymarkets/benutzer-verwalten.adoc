...
|**Farbe**
|Im Bearbeitungsfenster eine Farbe durch Verschieben der Farbauswahl festlegen, einen Hexadezimalwert oder RGB-Werte eingeben. Die Farbe erleichtert die Identifikation des Benutzers in anderen Bereichen, z.B. im <<basics/arbeiten-mit-plentymarkets/kalender#, **Kalender**>>.
...
<ol>
<li>
Öffnen Sie das Menü <strong>Einstellungen » Grundeinstellungen » Benutzer » Konten</strong>.</li>
<li>
...
Damit plentymarkets E-Mails, z.B. Auftragsbestätigungen, für Sie versenden kann, hinterlegen Sie im Menü **<<crm/e-mails-versenden#100, Einstellungen » Mandant (Shop) » Standard » E-Mail » Zugangsdaten>>** die **link:https://support.mailbox.org/knowledge-base/article/einrichtung-mit-sonstigen-mailprogrammen[Zugangsdaten, window="_blank"]** zu dem mailbox.org-Postfach, über das Sie diese E-Mails versenden möchten.
...
Ab 2017 überträgt plentymarkets das Hosting von E-Mail-Konten vollständig an **link:https://mailbox.org/business/[mailbox.org, window="_blank"]**. Wenn Sie von plentymarkets gehostete E-Mail-Konten verwenden, müssen Sie Ihre Postfächer daher bis Ende 2016 zu mailbox.org migrieren. Wie Sie Ihre von plentymarkets gehosteten Postfächer zu mailbox.org migrieren, erfahren Sie auf der Handbuchseite <<basics/arbeiten-mit-plentymarkets/_mailbox-migration#, **mailbox.org-Migration**>>.
...
|**Kalender**
|Hier werden Einstellungen für den <<basics/arbeiten-mit-plentymarkets/kalender#, **Kalender**>> vorgenommen.
|====
...
. Öffnen Sie das Menü **Einstellungen » Grundeinstellungen » Benutzer » Benutzerkonten**.
...
Im Tab **SOAP API** legen Sie fest, welche Calls der **<<datenaustausch/soap-api#, SOAP API>>** der Benutzer bearbeiten darf. In der Standardeinstellung sind keine API-Berechtigungen vergeben, auch nicht für Benutzer der Klasse **API**.
...
. Öffnen Sie das Menü **Einstellungen » Grundeinstellungen » Benutzer » Rollen**.
...
Verwenden Sie Rollen z.B. auch bei **<<basics/automatisierung/prozesse/prozesse-einrichten#, Prozessen>>** im **<<basics/automatisierung/plentymarkets-client#, plentymarkets Client>>**. Rollenbezogene Prozesse erstellen und verknüpfen Sie im plentymarkets Client.

image::basics/arbeiten-mit-plentymarkets/assets/DE-Einstell-Grund-Benutzer-Rollen-03.png[]

__Bild 1: Neuen Prozess für Rolle erstellen__

[.instruction]
Rollen und Prozesse verknüpfen:

. Öffnen Sie den plentymarkets Client.
. Öffnen Sie das Menü **Einstellungen » Prozesse » Prozesse pro Rolle**.
...
. Wählen Sie eine **Rolle** aus dem Dropdown-Menü.
