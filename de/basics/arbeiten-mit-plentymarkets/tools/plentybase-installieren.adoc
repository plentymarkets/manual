...
. Wechseln Sie in das Tab **plentyBase**.
...
|**Serveradresse**
|Die hinterlegte Adresse https://local.plentybase.de nicht ändern.

|**Port**
|Der Port, der plentyBase bei der Installation zugeordnet wurde. Standardwert ist 7331. Wenn bei der Installation ein anderer Port angegeben wurde, die Nummer des angegebenen Ports eingeben. +
...
* <<basics/arbeiten-mit-plentymarkets/tools/plentybase-installieren#30, **Installieren Sie plentyBase** >> auf einem Rechner des Netzwerks.
...
. Wenn Sie bei der Installation auf dem Host-Rechner einen anderen Port als den Standard-Port gewählt haben, geben Sie <<basics/arbeiten-mit-plentymarkets/tools/plentybase-installieren#40, **den Port des Host-Rechners** >> im plentymarkets Backend ein.
