...
Des Weiteren sollten sowohl die Einstellung **Amazon-Abwicklung (FBA)** als auch die Einstellung **Versand durch Amazon (FBA)** im Menü **Artikel » Artikel bearbeiten » Artikel öffnen » Tab: Varianten-ID » Tab: Verfügbarkeit** aktiviert sind. Ist dies nicht der Fall, können keine FBA-SKUs migriert werden.
