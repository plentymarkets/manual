...
→ Wenn die Hauptdomain Ihres Systems eine externe Domain ist, müssen Sie im Rahmen eines Umzugs auf die AWS-Cloud die neue IP-Adresse beim externen Domain-Provider speichern. Weitere Informationen finden Sie im <<https://forum.plentymarkets.com/t/leitfaden-aws-umzug/75863, Leitfaden AWS-Umzug^>>.
