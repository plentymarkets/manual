...
|4
|**System » Mandant » Mandant öffnen » Webshop » Einstellungen**
...
. Öffnen Sie die Menüs **System » Mandant » Mandant öffnen » Webshop » Währung** aller Mandanten.
...
====
Die Währungseinstellungen müssen Sie nur prüfen, wenn Sie Mandanten haben, bei denen im Menü **System » Mandant » Mandant öffnen » Webshop » Währung** die Option **Währungsumrechnung** auf **Verwende Preisspalte** steht.
====
