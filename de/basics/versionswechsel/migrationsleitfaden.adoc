...
Auf dieser Handbuchseite sind Bereiche aufgeführt, die noch nicht in plentymarkets 7 migriert wurden. Wie bereits angekündigt, stehen Ihnen bei Fragen zur neuen Artikelarchitektur auch unsere Entwickler gern mit Rat und Tat zur Seite. Auch Feedback nehmen unsere Entwicklungsteams in unserem Forum gern entgegen.
