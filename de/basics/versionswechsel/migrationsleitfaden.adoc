...
|4
|**System » Mandant (Shop) » Mandant wählen » Webshop » Grundeinstellungen**
...
. Nehmen Sie im Menü **System » Einstellungen » Migration** geeignete Einstellungen für die Optionen **Zusammenführung Einheit 1 + 2** und **Trennzeichen für Zusammenführung Einheit 1 + 2** vor.
...
. Öffnen Sie die Menüs **System » Mandant (Shop) » Mandant wählen » Webshop » Währung** aller Mandanten.
...
====
Die Währungseinstellungen müssen Sie nur prüfen, wenn Sie Mandanten haben, bei denen im Menü **System » Mandant (Shop) » Mandant wählen » Webshop » Währung** die Option **Währungsumrechnung** auf **Verwende Preisspalte** steht.
====
...
. Öffnen Sie das Menü **System » Mandant (Shop)**.
. Klicken Sie auf das Plus des ersten Mandanten (Shops). +
→ Das Mandantenmenü wird eingeblendet.
. Öffnen Sie das Menü **System » Mandant (Shop) » Mandant öffnen » Grundeinstellungen** des Mandanten.
