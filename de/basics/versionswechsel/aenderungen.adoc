...
Wenn Sie ein Polling-Format im Menü *Aufträge » Versand-Center » Tab: Polling* für DHL Easylog mit Kopfzeile generieren, erscheint das Feld *POOL_EMPF_STRASSE* doppelt in der CSV-Datei. Das Mapping der Daten muss bei DHL Easylog angepasst werden.
