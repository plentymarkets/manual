...
|Dieses Menü wurde deaktiviert. Preisportale wurden in das Menü **Datenaustausch » Export » Elastischer Export** übertragen. Nach der Migration zu plentymarkets 7 wird die URL der Preisportale erneuert, wodurch die alten URLs nicht mehr funktionieren.
...
Beim Wechsel auf plentymarkets 7 und bei der Umstellung auf die Amazon Cloud muss der Code für die Länderabfrage im Klarna Checkout geändert werden. Aktualisieren Sie den <<auftragsabwicklung/payment/klarna-checkout#100, **Code für Klarna Checkout**>> in der Kategorie vom Typ **Container**.
...
Über eine Alternative zu arvato informieren wir link:https://www.plentymarkets.eu/blog/Unsere-Partnerschaft-mit-arvato-endet-ndash-die-Alternative-lautet-atriga/b-1908/[**hier**, window="_blank"].
====
