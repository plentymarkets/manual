...
**System » Systemeinstellungen » Artikel » Einheiten**

* Einheiten werden nun im Menü **System » Systemeinstellungen » Artikel » Einheiten** definiert.
* Dort können auch weitere, benutzerdefinierte Einheiten erstellt werden.

== Barcodes

**System » Systemeinstellungen » Artikel » Barcode** +
**Artikel » Artikel bearbeiten » Artikel öffnen » Variante öffnen**
...
* Der Barcode-Typ wird im Menü **System » Systemeinstellungen » Artikel » Barcode** definiert.
...
**System » Systemeinstellungen » Artikel » Verkaufspreise** +
**Artikel » Artikel bearbeiten » Artikel öffnen » Variante öffnen » Tab: Einstellungen**

* Preisspalten wurden durch Verkaufspreise ersetzt.
* Verkaufspreise werden im Menü **System » Systemeinstellungen » Artikel » Verkaufspreise** definiert.
...
**System » Systemeinstellungen » Mandant » Mandant wählen » Artikelansichten » Einstellungen**
...
**System » Systemeinstellungen » Artikel » Preiskalkulation** +
**Artikel » Artikel bearbeiten » Artikel öffnen » Variante öffnen » Tab: Einstellungen**
...
|Kundenklassen werden nun im Menü **System » Systemeinstellungen » Artikel » Verkaufspreise** Verkaufspreisen zugeordnet.

|Optionen **Rabattstaffel auf Standard-Preis** und **Rabattstaffel auf definierte Preisspalte** wurden entfernt.
|Mengenrabatte werden nun im Menü **System » Systemeinstellungen » Artikel » Verkaufspreise** definiert.

|Tab **Sichtbarkeit** wurde entfernt.
|Preissichtbarkeit für Kundenklassen wird nun im Menü **System » Systemeinstellungen » Artikel » Verkaufspreise** definiert.
|====

== Märkte

**System » Systemeinstellungen » Märkte**
...
|**System » Systemeinstellungen » Märkte » Preisportale**
...
|**System » Systemeinstellungen » Märkte » Amazon » Einstellungen » Zugangsdaten**
|Dieses Menü wurde entfernt. Die dort vorzunehmenden Einstellungen wurden in das Tab **Basiseinstellungen** übertragen.

|**System » Systemeinstellungen » Märkte » Amazon » Einstellungen » Basiseinstellungen**
...
Die Einstellung **Zuordnung anhand EAN** wurde entfernt. GTIN wurden durch Barcodes ersetzt. Barcodes werden im Menü **System » Systemeinstellungen » Artikel » Barcode** definiert.

|**System » Systemeinstellungen » Märkte » Amazon » Einstellungen » Artikeleinstellungen**
|Die Einstellungen **Preis**, **Aktionspreis**, **FBA-Preis** und **FBA-Aktionspreis** wurden entfernt. Preisspalten wurden durch Verkaufspreise ersetzt. Verkaufspreise werden im Menü **System » Systemeinstellungen » Artikel » Verkaufspreise** definiert.

|**System » Systemeinstellungen » Märkte » Amazon » Einstellungen » Repricing**
...
|**System » Systemeinstellungen » Märkte » Allyouneed » Einstellungen**
|Die Einstellung **Preisspalte** im Bereich **Grundkonfiguration** und die Einstellungen **EAN** und **ISBN der EAN vorziehen** im Bereich **Erweiterte Optionen** wurden entfernt. Preisspalten wurden durch Verkaufspreise ersetzt. Verkaufspreise werden im Menü **System » Systemeinstellungen » Artikel » Verkaufspreise** definiert. GTINs wurden durch Barcodes ersetzt. Barcodes werden im Menü **System » Systemeinstellungen » Artikel » Barcode** definiert.

2+|Cdiscount

|**System » Systemeinstellungen » Märkte » Cdiscount.com » Tab: Einstellungen**
|Die Einstellung **Artikel-EAN** wurde entfernt. GTINs wurden durch Barcodes ersetzt. Barcodes werden im Menü **System » Systemeinstellungen » Artikel » Barcode** definiert.

Die Einstellung **Varianten-EAN** wurde in **Varianten-EAN Barcode** umbenannt.

2+|eBay

|**System » Systemeinstellungen » Märkte » eBay » Einstellungen » Basiseinstellungen**
...
|**System » Systemeinstellungen » Märkte » eBay » Einstellungen » Kontoeinstellungen**
|Die Einstellung **Artikelverfügbarkeit** wurde in **Variantenverfügbarkeit** umbenannt.

Die Einstellung **Preisspalte** wurde entfernt. Preisspalten wurden durch Verkaufspreise ersetzt. Verkaufspreise werden im Menü **System » Systemeinstellungen » Artikel » Verkaufspreise** definiert. +
...
|Die Einstellungen **EAN** und **Preisspalte** wurden entfernt. EAN wurden durch Barcodes ersetzt. Barcodes werden im Menü **System » Systemeinstellungen » Artikel » Barcode** definiert. Preisspalten wurden durch Verkaufspreise ersetzt. Verkaufspreise werden im Menü **System » Systemeinstellungen » Artikel » Verkaufspreise** definiert.

2+|Gimahhot

|**System » Systemeinstellungen » Märkte » Gimahhot**
...
|**System » Systemeinstellungen » Märkte » Mercateo**
...
|**System » Systemeinstellungen » Märkte » Rakuten » Einstellungen**
...
**System » Systemeinstellungen » Mandant » Global » Live-Shopping**
...
Der plentymarkets Ticketsupport wird ab plentymarkets 7 nicht mehr unterstützt und durch das neue Forum abgelöst. Das Menü **Start » Service-Ticket** steht daher nicht mehr zur Verfügung. Details dazu finden Sie in unserem link:https://www.plentymarkets.eu/blog/News-Goodbye-Supporttickets-plentymarkets-7-neue-Teams/b-1576/[Blog].
...
Beim Wechsel auf plentymarkets 7 und bei der Umstellung auf die Amazon Cloud muss der Code für die Länderabfrage im Klarna Checkout geändert werden. Aktualisieren Sie den <<payment/zahlungsanbieter/klarna-checkout#100, Code für Klarna Checkout>> in der Kategorie vom Typ **Container**.
