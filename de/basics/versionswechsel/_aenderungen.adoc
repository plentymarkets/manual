...
[WARNING]
.SOAP API nur mit plentymarkets Classic-Tarif
====
Ab dem Wechsel auf plentymarkets ist die SOAP-API nur für Kunden mit Classic-Tarif nutzbar. Kunden mit Zero-Vertrag können die SOAP-API nicht mehr nutzen. Die REST-API steht allen plentymarkets Kunden zur Verfügung.
====
