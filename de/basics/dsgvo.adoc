...
plentymarkets möchte ausdrücklich darauf hinweisen, dass dieses Verzeichnis keinen Anspruch auf Vollständigkeit und Richtigkeit erhebt und als Vorlage zur Erstellung des eigenen Verarbeitungsverzeichnisses dient.  

Laden Sie als Unterstützung zur Erstellung Ihres eigenen Verzeichnisses der Verarbeitungstätigkeiten die Vorlage [hier] herunter. Diese Vorlage beschreibt lediglich die verarbeitenden Tätigkeiten innerhalb der Software plentymarkets.  
