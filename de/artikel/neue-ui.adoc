...
//ToDo - Positionsnummer auf 50 setzen, um wieder sichtbar zu schalten
...
Nein.
Die alte Artikel-UI wird _nicht_ in nächster Zeit abgeschaltet werden.
...
Folgende Funktionalitäten fehlen und sind _nicht_ geplant:
