...
|**Bilder-Galerie**
|Öffnet die **<<cms/bilder-galerie#, Bilder-Galerie  >>** in einem neuen Tab.

|**Template-Variablen und -Funktionen**
|Öffnet eine Übersicht der <<cms-syntax/grundlagen/template-variablen#, **Template-Variablen**  >> und <<cms-syntax/grundlagen/template-funktionen#, **Template-Funktionen**  >>, die in die Beschreibung eingefügt werden können. +
...
|**Tags**
|<<basics/arbeiten-mit-plentymarkets/grundeinstellungen/tags#, **Tags**  >> wählen, um der Kategorie Themengebiete zuzuordnen.
...
|**Canonical**
|Ggf. die URL einer Kategorie eingeben, die den gleichen Inhalt enthält, um **<<cms-syntax/fallbeispiele/seo-guide#110, Duplicate Content >>** zu verhindern.
