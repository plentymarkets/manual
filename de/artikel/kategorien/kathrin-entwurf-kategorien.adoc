...
Eine Kategorie ist erst im Webshop eines Mandanten (Shops) sichtbar, nachdem die Kategorie aktiviert wurde. Die Aktivierung nehmen Sie im Menü <</#, **Einstellungen » Mandant (Shop) » Standard » Kategorien » Aktivieren** >> vor.
