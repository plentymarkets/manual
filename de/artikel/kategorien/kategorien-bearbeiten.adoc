...
|**Tags**
|Tags, die zu der Kategorie passen, wählen. Beim Tippen werden direkt Vorschläge eingeblendet. Tags dienen dazu, der Kategorie Themengebiete zuzuordnen. Die Tags selbst werden unter <<arbeiten-mit-plentymarkets/grundeinstellungen/tags#, **Einstellungen » Grundeinstellungen » Tags**  >> angelegt.
