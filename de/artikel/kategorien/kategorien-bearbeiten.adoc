...
|**Bilder-Galerie**
|Öffnet die **<<omni-channel/online-shop/_cms/bilder-galerie#, Bilder-Galerie  >>** in einem neuen Tab. Hier werden Bilder hochgeladen. Die URL eines Bildes kann dann kopiert werden, um sie über den Editor in der Kategorieseite zu verknüpfen.
...
Über das Dropdown-Menü rechts über dem Eingabefeld wählen Sie den Editor, mit dem Sie die Beschreibung bearbeiten möchten. Zur Verfügung stehen der **<<omni-channel/online-shop/_cms/webdesign/werkzeuge/editor#, Editor  >>**, der HTML-Editor **Textfeld** und der <<omni-channel/online-shop/_cms/webdesign/werkzeuge/syntax-editor#, **Syntax-Editor**  >>. Für den Typ **Container** stehen nur der HTML-Editor **Textfeld** und der **Syntax-Editor** zur Verfügung.
