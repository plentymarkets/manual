...
Das Menü **Einstellungen » Mandant (Shop) » Standard » Kategorien » Aktivieren** bietet Ihnen die Möglichkeit, mehrere oder alle Kategorien eines Mandanten gleichzeitig zu aktivieren oder zu deaktivieren.
