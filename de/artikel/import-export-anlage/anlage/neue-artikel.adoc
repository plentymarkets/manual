...
Vielmehr empfehlen wir dir, zuerst den neuen Artikel _ohne Attribute_ anzulegen. Anschließend empfehlen wir dir, Attribute auszuwählen, während du <<die benötigten Varianten erstellst>>.
...
Varianten sind für Kunden im Webshop nicht sichtbar, bis sie aktiviert werden.
