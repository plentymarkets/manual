...
##Einleitungstext - taken more or less from chapter 2.1##
https://knowledge.plentymarkets.com/artikel/einleitung/struktur#300
##Something about how this page only serves as reference##
...
##something about artikeldaten werden in die obere Tab-Leiste verwaltet##
##Im Tab **Global** passt du die Artikeldaten an und nimmst Einstellungen für den Artikel des Typs **Standard** vor. Globale Einstellungen sind für alle Varianten des Artikels des Typs **Standard** gültig.##
...
##Beschreibungstext - was wird hier in diesem Tab gemacht und warum##

##Timestamp erwähnen##

//Hier wählst du den Zustand des Artikels des Typs **Standard** und den <<artikel/einstellungen/hersteller#, Hersteller>>. Zudem aktivierst du hier <<fulfillment/versand-vorbereiten#1000, Versandprofile>> und <<artikel/webshop/shop-aktionen#, Shop-Aktionen>> für den Artikel des Typs **Standard**.
...
//Beachte <<table-upper-row-global>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.

==== Grundeinstellungen

[[table-upper-row-global]]
//.Obere Leiste » Tab: Global » Bereich: Grundeinstellungen
[cols="1,3"]
|====
...
##something about how Varianten-Daten werden in die untere Tab-Leiste verwaltet##
...
[[table-lower-row-settings-basic-settings]]
.Untere Leiste » Tab: Einstellungen » Bereich: Grundeinstellungen
[cols="1,3"]
|====
|Einstellung |Erläuterung
