...
|
|Entspricht den Optionen in <<artikel/artikel-verwalten#45, Tab: Multi-Channel>>.
|====
////
...
<<artikel/artikel-verwalten#artikelauflistung, Untere Tab-Leiste » Tab: Einstellungen » Bereich: Verfügbarkeit>>
...
<<artikel/artikel-verwalten#beschraenkung, Untere Tab-Leiste » Tab: Einstellungen » Bereich: Verfügbarkeit>>
...
<<artikel/artikel-verwalten#webshop-verfuegbar, Untere Tab-Leiste » Tab: Einstellungen » Bereich: Verfügbarkeit>>
...
| *Artikel-ID*
|Wähle einen Operator und gib eine <<artikel/import-export-anlage/anlage/neue-artikel#id, Artikel-ID>> ein.
...
| *Variantennr.*
|Gib eine <<artikel/artikel-verwalten#variantennummer, Variantennummer>> ein.
...
| *Hersteller*
|Gib den Namen eines <<artikel/artikel-verwalten#hersteller, Herstellers>> ein.
...
| *Markierung 1*; +
*Markierung 2*
|Wähle eine oder zwei <<artikel/import-export-anlage/anlage/neue-artikel#markierung, Markierungen>>.
Artikel werden nur verarbeitet, wenn sie diese Markierung oder Kombination von Markierungen haben.

| *Zustand*
|Wähle einen <<artikel/artikel-verwalten#zustand, Zustand>>.
