...
//Folgende Informationen werden kopiert:
...
* Maße
* Kosten
a|* Es werden neue Variantennummern vergeben.
* Artikel-ID
* ##Automatisch deaktiviert - ist das die Aussage in mittlere Spalte mit Verfügbarkeit der Hauptvariante?##
|====


Nach dem Kopieren kann der neue <<artikel/artikel-verwalten#30, Artikel>> bearbeitet werden. Um einen Artikel zu kopieren, gehe wie folgt vor.
