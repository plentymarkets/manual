...
Falls du mit der aktuellen Hauptvariante nicht zufrieden bist, kannst du <<artikel/einleitung/vererbung#300, eine andere Variante zur Hauptvariante machen>>.
