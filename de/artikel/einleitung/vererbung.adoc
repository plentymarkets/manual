...
Du hast die Möglichkeit, eine andere Variante eines Artikels zur Hauptvariante zu machen. 
Die bisherige Hauptvariante wird dann der neuen Hauptvariante untergeordnet.
...
. Klicke in der unteren Symbolleiste auf *Zur Hauptvariante machen* (icon:cog[role="darkGrey"]).
