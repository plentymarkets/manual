...
* *Nein* = Die Suchergebnisse enthalten nur Artikel, die nicht Teil eines Listings oder einer Auktion sind, d.h. Artikel mit einem <<artikel/einleitung/suche#800, grauen Listing-Symbol>> (icon:listings_show[set=plenty]).
