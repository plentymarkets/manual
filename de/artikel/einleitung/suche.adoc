...
|*Artikeldaten*
|Gib Artikeldaten ein, z.B. den Namen oder Modell eines Artikels oder ein passendes Stichwort. Artikel, die mit diesen Daten übereinstimmen, werden in der Übersicht angezeigt. Du kannst selbst entscheiden, <<artikel/anwendungsfaelle/suchverhalten#200, welche Artikeldaten die Suche berücksichtigen soll>>.
...
|*Bild*
a|Möchtest du nach Artikeln suchen, für die <<artikel/artikel-verwalten#90, ein Bild gespeichert>> ist?

* *Ja* = Nach Artikeln suchen, für die ein Bild gespeichert ist.
* *Nein* = Nach Artikeln suchen, für die kein Bild gespeichert ist.
* *ALLE* = Suche nach Artikeln mit Bildern und Artikeln ohne Bilder.
