...
* Klicke auf *Artikel bearbeiten* (icon:pencil[role="yellow-background"]), um den Artikeldatensatz zu öffnen. Klicke alternativ direkt auf den Artikel in der Übersicht.
* Klicke auf *Sichtbar im Webshop* (icon:eye[role="blue"]), um die Darstellung des Artikels im Webshop zu prüfen. Wird das Symbol durchgestrichen, ist der Artikel *Unsichtbar im Webshop* (icon:eye[role="blue", stack="times, darkGrey", stackPosition="lr"]).
* Klicke auf *Listing* (icon:bars[role="yellow-background", stack="eye, yellow-background", stackPosition="lr"]), um eine Übersicht aller Listings oder Auktionen mit dieser Artikel-ID zu sehen. Wird das Symbol ausgegraut, wurden noch keine Listings für den Artikel angelegt.
* Klicke auf *Neues Listing* (icon:bars[role="green", stack="plus, darkGrey", stackPosition="lr"]), um diesen Artikel in einem <<maerkte/ebay/ebay-einrichten#3400, Listing oder Auktion auf eBay>>, <<maerkte/hood#2300, Hood>> oder <<maerkte/ricardo-ch#1900, ricardo>> zu verkaufen.
* Klicke auf *Notiz hinzufügen* (icon:calendar-minus-o[role="green", stack="plus, darkGrey", stackPosition="lr"]), um eine <<artikel/artikel-verwalten#2090, Notiz für die Variante>> zu schreiben.
