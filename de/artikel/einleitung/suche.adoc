...
* Klicke auf *Sichtbar im Webshop* (icon:eye[role="blue"]), um die Darstellung des Artikels im Webshop zu prüfen. Wird das Symbol durchgestrichen, ist der Artikel *Unsichtbar im Webshop* (icon:eye[role="blue", stack="times,lr,darkGrey"]).
