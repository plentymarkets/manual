...
[cols="1,1"]
|====
|API-Zustand-ID |Optionen in der Dropdown-Liste im Backend
...
[cols="1,1"]
|====
|API-Zustand-Namen |Optionen in der Dropdown-Liste im Backend
...
Der API-Zustand wird für den Marktplatz <<maerkte/amazon/amazon-einrichten#, Amazon>> verwendet.
