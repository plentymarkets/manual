...
Es ist aber auch möglich, Produktdaten <<artikel/import-export-anlage/anlage/neue-artikel#, manuell in plentymarkets zu erstellen>> oder Produktdaten zwischen deinem plentymarkets System und anderen, externen Systemen auszutauschen.
