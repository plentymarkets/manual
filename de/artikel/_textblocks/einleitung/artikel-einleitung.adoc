...
* in CSV-Dateien pflegen und anschließend <<daten/daten-importieren/elasticsync-best-practices/best-practices-elasticsync-variantenanlage#, importieren>>.
* aus externen Systemen mit der <<daten/rest-api#, REST-API>> importieren.
* aus deinem plentymarkets-System <<daten/daten-exportieren/FormatDesigner#, exportieren>>.
