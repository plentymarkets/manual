...
! *Text*
!<<artikel/einstellungen/eigenschaften#intable-bestellmerkmal, Als Bestellmerkmal>>: Ermöglicht es Kunden, z.B. einen persönlichen Text einzugeben, der auf ein T-Shirt gedruckt werden soll.
