...
====
Nutze das <<daten/daten-importieren/ElasticSync#sync-seriennummer, Import-Tool>>, wenn du große Mengen an Seriennummern auf einmal eingeben möchtest. Verwende dazu das <<daten/daten-importieren/sync-typen/elasticSync-artikel#sync-seriennummer, Seriennummer>> Zuordnungsfeld innerhalb des *Artikel* Sync-Typs.
====
