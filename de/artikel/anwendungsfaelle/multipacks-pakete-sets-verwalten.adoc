...
[#4400]
=== Sets im Webshop darstellen

Hast du die Sets im Backend fertig konfiguriert?
Herzlichen Glückwunsch!
Jetzt bist du bereit, die Sets im Frontend darzustellen.

[IMPORTANT]
.Voraussetzungen
====
Die Set-Funktion ist nur für den link:https://marketplace.plentymarkets.com/plugins/sales/online-shops/ceres_4697[Ceres 5]{nbsp}icon:external-link[] Webshop vorgesehen.
Niedrigere Versionen von Ceres unterstützen die Set-Funktion nicht.
...
Du entscheidest, wie deine Artikel-Sets im Webshop aussehen sollen.
Dazu erstellst du einen sogenannten <<webshop/shop-builder#30, Inhalt für die Kategorie>>.

[.instruction]
Inhalt für ein Artikel-Set erstellen:
...
Diese Informationen findest du im <<webshop/shop-builder#55, Webshop-Teil des Handbuchs>>.

image::artikel/anwendungsfaelle/assets/gestaltung.png[]
...
Dein Kunde wählt alle gewünschten Varianten im Webshop aus und legt dann das gesamte Set in den Warenkorb.

image::artikel/anwendungsfaelle/assets/set-webshop.png[]
