...
*_Hinweis_*: Es ist möglich, Artikel-Sets im link:https://marketplace.plentymarkets.com/plugins/sales/online-shops/ceres_4697[plentyShop LTS]{nbsp}icon:external-link[] zu verkaufen.
...
[IMPORTANT]
.Set-Funktion ist nur für plentyShop LTS vorgesehen
====
Es ist möglich, Artikel-Sets im link:https://marketplace.plentymarkets.com/plugins/sales/online-shops/ceres_4697[plentyShop LTS]{nbsp}icon:external-link[] zu verkaufen.
Niedrigere Versionen von plentyShop LTS unterstützen die Set-Funktion nicht.
...
.Voraussetzungen
====
Die Set-Funktion ist nur für den link:https://marketplace.plentymarkets.com/plugins/sales/online-shops/ceres_4697[plentyShop LTS]{nbsp}icon:external-link[] vorgesehen.
Niedrigere Versionen von plentyShop LTS unterstützen die Set-Funktion nicht.
