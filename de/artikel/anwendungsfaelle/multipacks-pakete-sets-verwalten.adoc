...
*_Hinweis_*: Es ist möglich, Artikel-Sets im link:https://marketplace.plentymarkets.com/plugins/sales/online-shops/ceres_4697[Ceres 5]{nbsp}icon:external-link[] plentyShop zu verkaufen.
Niedrigere Versionen von Ceres unterstützen die Set-Funktion nicht.
Die Set-Funktion ist nur für den plentyShop vorgesehen. Es ist nicht möglich, Artikel-Sets auf Märkten wie Amazon und eBay zu verkaufen.
|Set
|====
...
[IMPORTANT]
.Set-Funktion ist nur für den Ceres 5 plentyShop vorgesehen
====
Es ist möglich, Artikel-Sets im link:https://marketplace.plentymarkets.com/plugins/sales/online-shops/ceres_4697[Ceres 5]{nbsp}icon:external-link[] plentyShop zu verkaufen.
Niedrigere Versionen von Ceres unterstützen die Set-Funktion nicht.
...
.Voraussetzungen
====
Die Set-Funktion ist nur für den link:https://marketplace.plentymarkets.com/plugins/sales/online-shops/ceres_4697[Ceres 5]{nbsp}icon:external-link[] plentyShop vorgesehen.
Niedrigere Versionen von Ceres unterstützen die Set-Funktion nicht.
