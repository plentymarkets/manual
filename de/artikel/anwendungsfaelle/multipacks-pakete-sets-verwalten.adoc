...
[.collapseBox]
.*Kann ich die Reihenfolge steuern, in der die Bestandteile im Webshop angezeigt werden?*
--
...
*_Workaround_*:
Füge die Bestandteile schon in der Reihenfolge hinzu, die dann auch im Shop dargestellt werden soll.
--
