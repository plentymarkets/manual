...
*_Hinweis:_* Es ist möglich, Artikel-Sets im link:https://marketplace.plentymarkets.com/plugins/sales/online-shops/ceres_4697[Ceres 5]{nbsp}icon:external-link[] Webshop zu verkaufen. Niedrigere Versionen von Ceres unterstützen die Set-Funktion nicht.
Die Set-Funktion ist nur für den Webshop vorgesehen. Es ist nicht möglich, Artikel-Sets auf Märkten wie Amazon und eBay zu verkaufen.
|Set
|====
