...
*_Hinweis_*: Es ist möglich, Artikel-Sets im link:https://marketplace.plentymarkets.com/plugins/sales/online-shops/ceres_4697[Ceres 5]{nbsp}icon:external-link[] Webshop zu verkaufen. Niedrigere Versionen von Ceres unterstützen die Set-Funktion nicht.
