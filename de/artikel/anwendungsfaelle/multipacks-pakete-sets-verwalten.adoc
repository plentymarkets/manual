...
Ab link:https://marketplace.plentymarkets.com/plugins/sales/online-shops/ceres_4697[Ceres 5]{nbsp}icon:external-link[] wird es möglich sein, Artikel-Sets im Webshop zu verkaufen. Es wird jedoch _nicht möglich_ sein, Artikel-Sets auf Märkten wie Amazon oder eBay zu verkaufen.
|Set
|====
...
[IMPORTANT]
.Set-Funktion ist nur für den Ceres 5 Webshop vorgesehen
====
Es ist möglich, Artikel-Sets im link:https://marketplace.plentymarkets.com/plugins/sales/online-shops/ceres_4697[Ceres 5]{nbsp}icon:external-link[] Webshop zu verkaufen. Niedrigere Versionen von Ceres unterstützen die Set-Funktion nicht.

Die Set-Funktion ist nur für den Webshop vorgesehen.
...
====
Verwende die <<artikel/artikel-verwalten#155, Artikel-Gruppenfunktion oder Stapelverarbeitung>>, um den Ab-Preis für mehrere Artikel auf einmal zu aktualisieren.
...
Hast du Artikelsets schon vor der Veröffentlichung von link:https://marketplace.plentymarkets.com/plugins/sales/online-shops/ceres_4697[Ceres 5]{nbsp}icon:external-link[] erstellt?
