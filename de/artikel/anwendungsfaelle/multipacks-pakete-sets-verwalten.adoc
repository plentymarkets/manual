...
<<artikel/artikel-verwalten#200, Aktiviere die Variante>>, sobald sie in deinem Webshop veröffentlicht werden soll.
====
...
| *Name*
|Namen für das Multipack eingeben. Der Name ist eine Pflichteingabe.
