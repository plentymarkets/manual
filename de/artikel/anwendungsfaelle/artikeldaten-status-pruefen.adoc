...
→ Im Bereich *Artikeldaten in ElasticSearch* wird angezeigt, wie viel Prozent der Variantendaten aktuell sind. <<table-data-status>> erläutert die verschiedenen Status. +
