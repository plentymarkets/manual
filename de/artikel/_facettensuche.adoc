...
=== Callisto: Such-Index definieren
...
=== Callisto: Felder zum Suchindex hinzufügen
...
=== Callisto: Unscharfe Suche anpassen
...
=== Callisto: Felder für Volltextsuche aktivieren
...
=== Callisto: Facettensuche einbinden
