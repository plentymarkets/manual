...
Mit Hilfe von **Gratis-Zugaben** oder **Freiartikeln** können Sie höhere Umsätze in Ihrem Webshop generieren, denn durch solche Gesten werden Ihre Kunden motiviert, mehr und öfter bei Ihnen einzukaufen. Die grundlegende Idee ist einfach: Sie versprechen Ihren Kunden ab einem bestimmten Warenwert pro Einkauf einen bestimmten Artikel aus Ihrem Sortiment als Gratiszugabe. Statt diese Artikel nun jedem Auftrag manuell hinzuzufügen, können Sie diesen Vorgang in plentymarkets mit einer **<<basics/automatisierung/ereignisaktionen#, Ereignisaktion  >>** automatisieren.
