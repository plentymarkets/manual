...
====
Wer noch einen Schritt weiter gehen möchte, kann über **mehrere** Ereignisaktionen auch ein **gestaffeltes Bonussystem** einführen, bei dem je nach Warenwert unterschiedliche Artikel als Zugaben gewährt werden. In der ersten Aktion setzen Sie den Filter **&gt;= 100,00 EUR**[.underline]#und#**&lt; 200,00 EUR**. In der zweiten Ereignisaktion stellen Sie dann einen Warenwert **&gt;= 200 EUR** ein und fügen einen höherwertigen Artikel hinzu.
====
