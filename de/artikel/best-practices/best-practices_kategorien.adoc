...
Die Kategorien müssen im Menü *Einrichtung » Mandant » Standard Shop » Kategorien » Aktivieren* aktiviert werden.
...
.Eine Kategorieverknüpfung ist plentymarkets Pflicht
...
Die Anzeige, wie viele Ebenen angezeigt werden, muss in den Einstellungen des Menüs *Einrichtung » Mandant » Standard Shop » Kategorien » Einstellungen* definiert werden.
