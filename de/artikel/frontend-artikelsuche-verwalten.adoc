...
Die Frontend-Artikelsuche ermöglicht es Ihren Kundinnen und Kunden, Ihr Produktsortiment im Webshop zu durchsuchen. Im Template-Plugin Ceres ist für die Artikelsuche im Webshop standardmäßig die Facettensuche aktiviert. Im alten Webshop-Design Callisto wird die Facettensuche im Menü *System » Systemeinstellungen » Mandant » Mandant wählen » Webshop » Artikelsuche* aktiviert.

Auf dieser Handbuchseite erfahren Sie, wie Sie Facetten und Facettenwerte erstellen und wie Sie diese Facetten in Callisto und Ceres nutzen.

[NOTE]
.Alter Webshop: Callisto mit Standard-Suche
====
Bei Webshops mit dem alten Design Callisto, für die im Menü *System » Systemeinstellungen » Mandant » Mandant wählen » Webshop » Artikelsuche* die Option *Standard-Suche* aktiviert ist, wird für die Artikelsuche im Frontend der <<artikel/artikel-verwalten#385, Index der Backend-Artikelsuche>> verwendet.
====
...
Die Konfiguration besteht aus mehreren Schritten. Zunächst werden Facetten erstellt, anschließend durch weitere Einstellungen näher bestimmt und schließlich mit den gewünschten Werten verknüpft. Zudem muss im Menü *System » Systemeinstellungen » Mandant » Mandant wählen » Webshop » Artikelsuche* die Option *Facettensuche* eingestellt sein.
...
|*Verfügbarkeit*
|Facetten des Typs *Verfügbarkeit*, zum Beispiel "Kurzfristig lieferbar", werden mit den im Menü <<artikel/artikel-verwalten#180, System » Systemeinstellungen » Artikel » Verfügbarkeit>> erstellten Verfügbarkeiten verknüpft.

|*Hersteller*
|Facetten des Typs *Hersteller*, zum Beispiel "Adidas", werden mit den im Menü <<artikel/artikel-verwalten#560, System » Systemeinstellungen » Artikel » Hersteller>> erstellten Herstellern verknüpft.
|====
...
Im alte Design Callisto können für die Frontend-Suche verschiedene Suchen genutzt werden. Welche Suche verwendet wird, legen Sie im Menü *System » Systemeinstellungen » Mandant » Mandant wählen » Webshop » Artikelsuche* fest. Die folgenden Optionen sind verfügbar:
...
* *Findologic* +
→ Wie Sie die Artikelsuche über Findologic einrichten, erfahren Sie auf der Handbuchseite <<webshop/webshop-einrichten/extras/findologic#, Findologic>>.
* *Facettensuche* +
...
. Öffnen Sie das Menü *System » Systemeinstellungen » Artikel » Suche » Frontend » Sprachen*.
...
Wie Sie die Facettensuche in Ceres nutzen, erfahren Sie auf der Handbuchseite <<webshop/ceres-einrichten#330, Ceres einrichten>>.
