...
Die Frontend-Artikelsuche ermöglicht es, Ihr Produktsortiment im Webshop zu durchsuchen. Im Template-Plugin Ceres ist für die Artikelsuche im Webshop standardmäßig die Facettensuche aktiviert. Im alten Webshop-Design Callisto wird die Facettensuche im Menü *System » Systemeinstellungen » Mandant » Mandant wählen » Webshop » Artikelsuche* aktiviert.
