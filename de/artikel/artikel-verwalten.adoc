...
→ <b>+</b> = Der bisherige Preis wird um den eingegebenen Betrag erhöht. +
→ **-** = Der bisherige Preis wird um den eingegebenen Betrag gesenkt. +
→ **/** = Der bisherige Preis wird durch den eingegebenen Wert geteilt. +
→ <b>*</b> = Der bisherige Preis wird mit dem eingegebenen Wert multipliziert. +
...
**Quellverkaufspreis** = Den Verkaufspreis aus der Dropdown-Liste wählen, dessen Preis übernommen werden soll. +
**Zielverkaufspreis** = Den Verkaufspreis aus der Dropdown-Liste wählen, der aktualisiert werden soll. +
