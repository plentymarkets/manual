...
|Variantennummer eingeben, die als Nächstes vergeben werden soll. Alle weiteren neuen Variantennummern werden aufsteigend ab dieser Nummer generiert. Die angezeigte nächste Variantennummer wird aktualisiert, sobald eine neue Variantennummer generiert wurde. Angezeigt wird also immer die Variantennummer, die beim Erstellen der nächsten Variante vergeben wird.
|====
