...
[#385]
=== Backend-Suche einrichten

Im Menü *System » Artikel » Suche » Backend* nehmen Sie Einstellungen vor, damit Artikel bei der Artikelsuche im Menü *Artikel » Artikel bearbeiten* besser gefunden werden. Der Suchindex wird automatisch aufgebaut, wenn ein neuer Artikel erstellt wird. Wenn Sie Artikel importieren, wird der Suchindex über Nacht aktualisiert. Im Menü *System » Artikel » Suche » Backend* können Sie die Aktualisierung des Suchindex auch manuell starten. Im Tab **Artikelstamm** sehen Sie, wie viele Artikel insgesamt vom Suchindex erfasst werden. Im Tab **Artikelmerkmale** sehen Sie, wie viele Artikel mit Merkmalen vom Suchindex erfasst werden. <<tabelle-suchindex-uebersicht>> erläutert die Übersicht im Menü *Suchindex*.
...
Unabhängig davon, ob der Aufbau des Artikelsuchindexes automatisch gestartet wird oder ob Sie den Artikelsuchindex manuell neu aufbauen, werden pro Vorgang maximal 3000 Artikel zum Suchindex hinzugefügt. Über Nacht wird nur ein Vorgang durchgeführt. Wenn mehr als 3000 Artikel im System gespeichert sind, dauert es also mehrere Nächte, bis der Suchindex aktualisiert ist. Um Artikel schneller zum Index hinzuzufügen, bauen Sie den Artikelsuchindex mehrmals manuell neu auf. Gehen Sie wie unten beschrieben vor, um den Artikelsuchindex manuell zu aktualisieren.
...
→ Der Artikelsuchindex wird aktualisiert. +
*_Hinweis:_* Pro Aktualisierung werden maximal 3000 Artikel indiziert. Starten Sie mehrere Zyklen, um große Artikelmengen zum Index hinzuzufügen.

[#4600]
==== Standardindex einrichten

Mit dem Standardindex definieren Sie die Artikelparameter, die vom Suchindex erfasst werden und bei der Artikelsuche im Backend berücksichtigt werden. Gehen Sie wie unten beschrieben vor, um den Standard-Index einzurichten.
...
→ Der Merkmalsuchindex wird aktualisiert. +
*_Hinweis:_* Pro Aktualisierung werden maximal 3000 Artikel indiziert. Starten Sie mehrere Zyklen, um große Artikelmengen zum Index hinzuzufügen.
