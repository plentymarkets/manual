...
Wie Sie Artikellisten vom Typ **Cross-Selling** anlegen, erfahren Sie im Handbuch unter <<omni-channel/online-shop/ceres-einrichten#110, Artikellisten anlegen>>.
