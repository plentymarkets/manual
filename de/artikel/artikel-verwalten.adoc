...
* Sie generieren in der Etikettenvorlage Etiketten für alle Positionen eines Auftrags <<#3320, in der Vorlage>>.
...
In der Etikettenvorlage haben Sie die Möglichkeit, eine PDF-Datei mit den Etiketten für einen bestimmten Auftrag zu generieren. Gehen Sie dazu wie unten beschrieben vor.
...
Wir beschreiben hier am Beispiel **Top-Artikel**, wie Sie Shop-Aktionen in Callisto einrichten. Richten Sie andere Shop-Aktionen analog ein. Wie Sie
