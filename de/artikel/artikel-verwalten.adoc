...
=======
|Zeigt das voraussichtliche Lieferdatum von bestellten Varianten an. Weitere Informationen zu Nachbestellungen im Zulauf findest du unter <<warenwirtschaft/nachbestellungen-verwalten#, Nachbestellungen verwalten>>.
>>>>>>> master
