...
Du kannst Bilder für Attributwerte hochladen. Diese Bilder werden im Webshop als Kacheln angezeigt. Die Größe von Attributbildern legst du im Menü <<artikel/artikel-verwalten#670, Einrichtung » Artikel » Bilder>> fest.
...
Eigenschaften werden zentral im Menü *Einrichtung » Einstellungen » Eigenschaften » Konfiguration* <<artikel/artikel-verwalten#3100, erstellt>> und anschließend mit <<artikel/artikel-verwalten#4800, Varianten>>, <<crm/kontakte-verwalten#, Kontakte>> oder <<warenwirtschaft/lager-einrichten#500, Lagerorte>> verknüpft.
...
. Öffne das Menü **Einrichtung » Artikel » Barcodes**.
...
Eigenschaften werden zentral im Menü *Einrichtung » Einstellungen » Eigenschaften » Konfiguration* <<artikel/artikel-verwalten#4800, verwaltet>> und mit den Varianten von Artikeln des Typs *Standard* verknüpft. Eigenschaften des Bereichs *Artikel* werden in zwei verschiedenen Tabs mit Varianten verknüpft:
