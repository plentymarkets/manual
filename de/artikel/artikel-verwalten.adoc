...
|**Bestellmerkmal**
|Aktivieren, wenn das Merkmal im Bestellvorgang verfügbar sein soll. Der Kunde kann dann je nach **Merkmaltyp** des Bestellmerkmals z.B. einen Text oder Wert eingeben oder eine Option aus der Dropdown-Liste wählen. Das Design für Bestellmerkmale ist im CSS anpassbar. Eigenen CSS-Code für den Bestellvorgang unter **CMS » Webdesign » Layout » CSS » CSSOrder** speichern.
...
. Öffnen Sie das Menü *System » Einstellungen » Eigenschaften » Eigenschaftsgruppen*.
...
. Wählen Sie die Sprache aus der Dropdown-Liste.
