...
|**Abo-Intervall**
|Diese Option hat aktuell noch keine Funktion, sondern wurde vorbereitend für die Verwendung im Ceres-Webshop integriert. +
*_Hinweis:_* Die Einstellung eines Intervalls hat aktuell auch keine Auswirkung auf den Scheduler.
