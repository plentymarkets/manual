...
Hier eingegebene Werte gelten für die Marktplätze <<omni-channel/multi-channel/neckermann-at#, Neckermann.at>>, <<omni-channel/multi-channel/otto#, OTTO>>, <<omni-channel/multi-channel/rakuten/rakuten-einrichten#, Rakuten>>, <<omni-channel/multi-channel/plus-de/plus-gartenxxl einrichten#, Plus.de>>. Die Werte sind gegenüber den Bestandspufferwerten der Marktplätze dominant.
