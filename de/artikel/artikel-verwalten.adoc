...
Systemseitig kann derselbe Barcode mehreren Varianten zugeordnet werden. Wenn Barcodes nicht mehrmals vergeben werden sollen, nutzen Sie die Suche nach doppelten Barcodes, um doppelt Barcodes zu ermitteln und zu korrigieren. Gesucht wird nach gleichen Codes mit gleichem Barcode-Typ, die unterschiedlichen Varianten zugeordnet sind.
...
→ Die doppelten Barcodes werden angezeigt.
. xxxx
. xxxx
