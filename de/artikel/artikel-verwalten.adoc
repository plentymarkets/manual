...
* Sie generieren Etiketten für die Positionen eines Auftrags aus der Vorlage.
* Sie generieren Etiketten über die Funktion *Etiketten* eines Artikels oder einer Variante.
* Sie erstellen Prozesse, um <<basics/automatisierung/prozesse/aktionen#150, Artikeletiketten zu generieren>>.
* Sie drucken Etiketten in der Artikelsuche der plentymarkets App.

==== Etiketten für Positionen eines Auftrags generieren
