...
|**Platzhalterbild-URL**
|URL für ein Platzhalterbild eingeben, das angezeigt wird, wenn Artikelbilder nicht angezeigt werden können. Platzhalterbild in der **<<omni-channel/online-shop/_cms/bilder-galerie#, Bildergalerie  >>** hochladen.

|**Platzhaltervorschaubild-URL**
|URL für ein Platzhalterbild eingeben, das angezeigt wird, wenn Vorschaubilder nicht angezeigt werden können. Platzhalterbild in der **<<omni-channel/online-shop/_cms/bilder-galerie#, Bildergalerie  >>** hochladen.
...
Grafiken in der **<<omni-channel/online-shop/_cms/bilder-galerie#, Bildergalerie  >>** hochladen. Die relative URL der Grafik aus der Bildergalerie kopieren und in das Feld **URL** einfügen.
...
|**Zustand; +
Zustand API**
|Zustand des Artikels wählen. Standardmäßig ist **Neu** eingestellt. Um den Zustand im Webshop in der Detailansicht eines Artikels anzuzeigen, die Template-Variable **$condition** in das Template **<<omni-channel/online-shop/_cms-syntax/webdesign/itemview/container-itemviewsingleitem#, ItemViewSingleItem  >>** einfügen. Die Einstellung **Zustand API** wird für den Marktplatz **<<omni-channel/multi-channel/amazon#, Amazon  >>** verwendet.
...
**Sonderangebot** = Template **<<omni-channel/online-shop/_cms-syntax/webdesign/itemview/container-itemviewspecialofferslist#, ItemViewSpecialOffersList  >>** verwenden, um eine Liste von Sonderangeboten darzustellen. +
**Neuheit** = Template **<<omni-channel/online-shop/_cms-syntax/webdesign/itemview/container-itemviewlatestitemslist#, ItemViewLatestItemsList  >>** verwenden, um eine Liste der neuesten Artikel darzustellen. +
**Top-Artikel** = Template **<<omni-channel/online-shop/_cms-syntax/webdesign/itemview/container-itemviewtopsellerslist#, ItemViewTopSellersList  >>** verwenden, um eine Liste der meistverkauften Artikel darzustellen.
...
Die Länge des Artikelnamens ist auf 240 Zeichen begrenzt. Der Artikelname wird für den Aufbau der Artikel-URL verwendet. Weitere Informationen zur Artikel-URL finden Sie in unserem **<<omni-channel/online-shop/_cms-syntax/fallbeispiele/seo-guide#, SEO-Guide  >>**.
...
|**Technische Daten**
|Technische Daten des Artikels eingeben. Um die technischen Daten im Webshop anzuzeigen, die Template-Variable **$TechnicalData** und ggf. eine Überschrift in das Template **<<omni-channel/online-shop/_cms-syntax/webdesign/itemview/container-itemviewsingleitem#, ItemViewSingleItem  >>** einfügen.

|**URL-Pfad**
|URL-Pfad des Artikels im Webshop. Der URL-Pfad setzt sich standardmäßig aus Kategorien und Artikelname zusammen. Der Pfad wird beim Erstellen des Artikels automatisch von plentymarkets vergeben und als Teil der Artikel-URL angezeigt, wenn der Artikel im Webshop aufgerufen wird. Weitere Informationen zur Artikel-URL finden Sie in unserem **<<omni-channel/online-shop/_cms-syntax/fallbeispiele/seo-guide#, SEO-Guide  >>**.
...
Freitextfelder werden durch die Template-Variablen **$Free[1]** bis **$Free[20]** an beliebiger Stelle im Webshop angezeigt. Wie Sie Freitextfelder im Webshop verwenden, erfahren Sie auf der Handbuchseite **<<omni-channel/online-shop/_cms/webdesign/webdesign-bearbeiten/itemview/masseingabe#, Maßeingabe  >>**.
...
Die Verfügbarkeit wird standardmäßig über das Template **<<omni-channel/online-shop/_cms-syntax/webdesign/itemview/container-itemviewsingleitem#, ItemViewSingleItem  >>** im Webshop angezeigt. Über die Template-Variablen **$AvailabilityString** und **$AvailabilityIcon** werden Verfügbarkeitstext und -symbol im Webshop dargestellt. Diese Template-Variablen sind standardmäßig im Template **ItemViewSingleItem** der plentymarkets Standard-Designs enthalten.
...
Nachdem Sie die Cross-Selling-Artikel festgelegt haben, richten Sie die Anzeige der Cross-Selling-Artikel im Webshop ein. In den Templates **<<omni-channel/online-shop/_cms-syntax/webdesign/itemview/container-itemviewcrosssellingitemslist#, ItemViewCrossSellingItemsList  >>**, **<<omni-channel/online-shop/_cms-syntax/webdesign/itemview/container-itemviewcrosssellingitemslist2#, ItemViewCrossSellingItemsList2  >>** und **<<omni-channel/online-shop/_cms-syntax/webdesign/itemview/container-itemviewcrosssellingitemslist3#, ItemViewCrossSellingItemsList3  >>** gestalten Sie, wie Cross-Selling-Artikel dargestellt werden. Sie legen z.B. fest, wie viele Cross-Selling-Artikel für einen Artikel angezeigt werden und wie viele davon nebeneinander. Anschließend legen Sie fest, wo und welche Cross-Selling-Artikel bei einem Artikel angezeigt werden. Hierfür binden Sie einen Container in eines der Templates für Einzelartikel ein, z.B. **<<omni-channel/online-shop/_cms-syntax/webdesign/itemview/container-itemviewsingleitem#, ItemViewSingleItem  >>** ein.
...
Das Layout für Cross-Selling-Artikel wird in den Templates **ItemViewCrossSellingItemsList** bis **ItemViewCrossSellingItemsList3** gestaltet. Die Templates **ItemViewCrossSellingItemsList** und **ItemViewCrossSellingItemsList2** sind im plentymarkets Standarddesign Callisto Light bereits befüllt. Diese Cross-Selling-Templates werden über die Container **<<omni-channel/online-shop/_cms-syntax/webdesign/itemview/container-itemviewcrosssellingitemslist#, Container_ItemViewCrossSellingItemsList  >>** bzw. **<<omni-channel/online-shop/_cms-syntax/webdesign/itemview/container-itemviewcrosssellingitemslist#, Container_ItemViewCrossSellingItemsList2  >>** ausgegeben. In Callisto Light sind diese Container bereits in das Template für Einzelartikel **<<omni-channel/online-shop/_cms-syntax/webdesign/itemview/container-itemviewsingleitem#, ItemViewSingleItem  >>** eingebunden und wie folgt belegt:

* **<<omni-channel/online-shop/_cms-syntax/webdesign/itemview/container-itemviewcrosssellingitemslist#, Container_ItemViewCrossSellingItemsList  >>** listet ähnliche Artikel {%$CrossSellingType = "Similar" %}.
* **<<omni-channel/online-shop/_cms-syntax/webdesign/itemview/container-itemviewcrosssellingitemslist#, Container_ItemViewCrossSellingItemsList2  >>** listet Zubehörartikel {%$CrossSellingType = "Accessory" %}.
...
Die Artikelansicht **<<omni-channel/online-shop/_cms-syntax/webdesign/itemview/container-itemviewitemsbypositionlist#, ItemViewItemsByPositionList  >>** zeigt Artikel absteigend sortiert nach Position an und kann verwendet werden, um Top-Artikel im Webshop anzuzeigen.
