...
Im Menü *System » Einstellungen » Eigenschaften » Konfiguration* erstellen Sie Eigenschaften, die Sie im Anschluss für die nähere Charakterisierung Ihrer Artikel nutzen. Gehen Sie wie im Folgenden beschrieben vor, um eine Eigenschaft zu erstellen.
