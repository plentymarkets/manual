...
|**Aufpreis**
|Wert eingeben, wenn für das Merkmal ein Aufpreis berechnet werden soll. Aufpreise werden im Webshop in der Artikelansicht und im Bestellvorgang automatisch zum Artikelpreis hinzu addiert. Standardmäßig ist **0,00** eingestellt und es wird kein Aufpreis berechnet. +
...
Eigenschaften sind wiederholt auftretende Informationen, die Sie in verschiedenen Bereichen von plentymarkets verknüpfen. Eigenschaften werden zentral im Menü *System » Einstellungen » Eigenschaften* verwaltet und können in den folgenden Bereichen von plentymarkets eingesetzt werden:
...
Im Gegensatz zu Attributen sind die Eigenschaften passiv, d.h., sie dienen nicht dazu, Varianten zu erstellen. Über Eigenschaften lassen sich wiederkehrende Features einer Variante abbilden, z.B. technische Details wie Bluetooth oder WLAN. Eigenschaften sind nicht an den Warenbestand gekoppelt und in der Artikelansicht im Webshop nicht wählbar.

Eigenschaften ermöglichen es Ihnen, z.B. Serviceleistungen gegen Aufpreis anzubieten oder ein Feld einzubinden, in das Kunden Zusatzwünsche eingeben können. Über Eigenschaften verknüpfen Sie außerdem Ihre Varianten mit den Varianteneigenschaften auf einem Marktplatz. Über die Eigenschaftssuche finden Sie Artikel, die mit der gesuchten Eigenschaft verknüpft sind.

[IMPORTANT]
.Wichtige Hinweise zu den Varianteneigenschaften
====
Sie können Eigenschaften bereits im Menü *System » Einstellungen » Eigenschaften* erstellen und Werte hinzufügen. Sie können diese Varianteneigenschaften außerdem im Menü *Artikel » Artikel bearbeiten » Artikel öffnen » Eigenschaft öffnen » Tab: Eigenschaften* mit Varianten verknüpfen. Allerdings können die Varianteneigenschaften vorerst nur im plentymarkets Backend angezeigt werden. Eine Anzeige der Varianteneigenschaften im Webeshop oder eine Übertragung an Marktplätze ist zurzeit jedoch noch nicht möglich. Diese Funktionalität befindet sich derzeit in Arbeit.
====

[#3100]
=== Eigenschaft erstellen

Im Menü *System » Einstellungen » Eigenschaften* erstellen Sie Eigenschaften, die Sie im Anschluss für die nähere Charakterisierung Ihrer Artikel nutzen. Gehen Sie wie im Folgenden beschrieben vor, um eine Eigenschaft zu erstellen.
...
. Wählen Sie in dem Dropdown-Menü *Bereich* die Option *Artikel*.
...
|*Bereich*
|Bereich aus dem Dropdown-Menü wählen, in dem die Eigenschaft genutzt werden soll. +
...
|*Eigenschaftstyp*
|Typ der Eigenschaft aus dem Dropdown-Menü wählen. +
...
|*Gruppe*
|Optional eine Eigenschaftsgruppe aus dem Dropdown-Menü wählen, um die Eigenschaft dieser Gruppe zuzuordnen. +
...
|Die Werte eingeben, die in dem Dropdown-Menü dargestellt werden sollen. +
...
. Öffnen Sie das Menü *System » Einstellungen » Eigenschaften*.
. Geben Sie in der Ansicht *Filter* ggf. Suchbegriffe in die Suchfelder ein bzw. stellen Sie Filteroptionen in den Dropdown-Menüs ein. Beachten Sie die Erläuterungen in <<tabelle-filter-eigenschaften>>.
. Klicken Sie auf *Suchen*. +
...
|*Gruppentyp*
|Gruppentyp aus dem Dropdown-Menü wählen. Die Option steuert, wie Eigenschaften des Typs *Empty* im Bestellvorgang angezeigt werden. +
*Keine* = Eigenschaften werden standardmäßig nicht gruppiert. +
*Select* = Eine der gruppierten Eigenschaften ist per Dropdown-Menü wählbar. +
...
|*Aufpreistyp*
|Aufpreistyp aus dem Dropdown-Menü wählen. +
...
→ Ein Dropdown-Menü der Eigenschaftsgruppen wird angezeigt.
. Wählen Sie die Eigenschaftsgruppe aus dem Dropdown-Menü.
...
Artikeletiketten sind Hinweisschildchen auf einem Artikel oder der Artikelverpackung. Etiketten können Informationen über Preis, Inhalt etc. enthalten. Stellen Sie die Etikettengröße und die Positionierung der Artikel- und Auftragsparameter ein, die auf das Etikett gedruckt werden.
...
|**Etikett**
|Breite und Höhe des Etiketts in Millimeter eingeben. Die Etikettgröße muss zu den Werten der Seitengröße und der Zeilen- und Spaltenanzahl passen.
...
Etiketten generieren Sie entweder direkt aus der Vorlage oder über die Funktion **Etiketten** eines Artikels oder einer Variante. Sie können auch Prozesse erstellen, um <<basics/automatisierung/prozesse/aktionen#150, Artikeletiketten zu generieren>>.
...
|**Zustand; +
Zustand API**
|Zustand des Artikels wählen. Standardmäßig ist **Neu** eingestellt. Um den Zustand im Webshop in der Detailansicht eines Artikels anzuzeigen, die Template-Variable **$condition** in das Template <<omni-channel/online-shop/webshop-einrichten/cms-syntax#webdesign-itemview-container-itemviewsingleitem, ItemViewSingleItem>> einfügen. Die Einstellung **Zustand API** wird für den Marktplatz <<omni-channel/multi-channel/amazon/amazon-einrichten#, Amazon>> verwendet.
...
|**Zolltarifnummer**
|Zolltarifnummer eingeben. Weitere Informationen finden Sie z.B. auf der Webseite von link:http://auskunft.ezt-online.de/ezto/Welcome.do[**EZT-Online**^] und unter link:http://www.zoll-erklärung.de/Die%20Einreihung%20im%20EZT.pdf[**Die Einreihung im EZT**^].
...
**Sonderangebot** = Template <<omni-channel/online-shop/webshop-einrichten/cms-syntax#webdesign-itemview-container-itemviewspecialofferslist, ItemViewSpecialOffersList>> verwenden, um eine Liste von Sonderangeboten darzustellen. +
**Neuheit** = Template <<omni-channel/online-shop/webshop-einrichten/cms-syntax#webdesign-itemview-container-itemviewlatestitemslist, ItemViewLatestItemsList>> verwenden, um eine Liste der neuesten Artikel darzustellen. +
**Top-Artikel** = Template <<omni-channel/online-shop/webshop-einrichten/cms-syntax#webdesign-itemview-container-itemviewtopsellerslist, ItemViewTopSellersList>> verwenden, um eine Liste der meistverkauften Artikel darzustellen.
...
|**Technische Daten**
|Technische Daten des Artikels eingeben. Um die technischen Daten im Webshop anzuzeigen, die Template-Variable **$TechnicalData** und ggf. eine Überschrift in das Template <<omni-channel/online-shop/webshop-einrichten/cms-syntax#webdesign-itemview-container-itemviewsingleitem, ItemViewSingleItem>> einfügen.

|**URL-Pfad**
|URL-Pfad des Artikels im Webshop. Der URL-Pfad setzt sich standardmäßig aus Kategorien und Artikelname zusammen. Der Pfad wird beim Erstellen des Artikels automatisch von plentymarkets vergeben und als Teil der Artikel-URL angezeigt, wenn der Artikel im Webshop aufgerufen wird. Weitere Informationen zur Artikel-URL finden Sie in unserem <<omni-channel/online-shop/webshop-einrichten/cms-syntax#fallbeispiele-seo-guide, SEO-Guide>>.
...
Freitextfelder werden durch die Template-Variablen **$Free[1]** bis **$Free[20]** an beliebiger Stelle im Webshop angezeigt. Wie Sie Freitextfelder im Webshop verwenden, erfahren Sie auf der Handbuchseite <<omni-channel/online-shop/webshop-einrichten/cms#webdesign-webdesign-bearbeiten-itemview-masseingabe, Maßeingabe>>.

[#80]
=== Merkmale aktivieren

Merkmale sind Varianteneigenschaften, die Sie im Tab **Merkmale** aktivieren. Verknüpfen Sie beliebig viele Merkmale mit einem Artikel des Typs **Standard**. Anhand der verknüpften Merkmale ist die Merkmalsuche im Webshop möglich. Weitere Informationen zu Merkmalen finden Sie unter <<artikel/artikel-verwalten#480, Merkmale verwalten>>.
...
→ Wenn die Einstellung *Variantenname* oder *Variantennummer* eingestellt ist und diese Daten für eine Variante nicht gespeichert sind, wird stattdessen die *Varianten-ID* angezeigt. +
...
Die Verfügbarkeit wird standardmäßig über das Template <<omni-channel/online-shop/webshop-einrichten/cms-syntax#webdesign-itemview-container-itemviewsingleitem, ItemViewSingleItem>> im Webshop angezeigt. Über die Template-Variablen **$AvailabilityString** und **$AvailabilityIcon** werden Verfügbarkeitstext und -symbol im Webshop dargestellt. Diese Template-Variablen sind standardmäßig im Template **ItemViewSingleItem** der plentymarkets Standard-Designs enthalten.
...
Eigenschaften werden zentral im Menü *System » Einstellungen » Eigenschaften* verwaltet und mit den Varianten von Artikeln des Typs *Standard* verknüpft. Eigenschaften des Bereichs *Artikel* werden in zwei verschiedenen Tabs mit Varianten verknüpft:
...
→ Die verfügbaren Eigenschaften werden eingeblendet.
. Aktivieren Sie die Eigenschaft. +
*_Tipp:_* Sie können beliebig viele Eigenschaften mit der Variante verknüpfen.
. ???*Speichern* Sie die Einstellungen. +
...
. Klicken Sie auf *Texte hinzufügen*. +
→ Die verfügbaren Eigenschaften des Typs *Kurztext* und *Text* werden eingeblendet.
. Aktivieren Sie die Eigenschaft. +
*_Tipp:_* Sie können beliebig viele Eigenschaften mit der Variante verknüpfen.
. ???*Speichern* Sie die Einstellungen. +
...
*_Tipp:_* Klicken Sie auf *Multilingualität*, um die mehrsprachige Bearbeitungsansicht zu öffnen.
. *Speichern* Sie die Einstellungen.
...
. Öffnen Sie das Menü **System » Artikel » Suchindex » Tab: Artikelstamm » Tab: Standard-Index**.
...
. Klicken Sie auf die passende **Beziehung**. Beachten Sie dazu die Erläuterungen in <<tabelle-cross-selling-beziehung-wahlen>>. +
→ Die Artikel werden hinzugefügt und im Tab **Cross-Selling-Artikel** angezeigt.

[[tabelle-cross-selling-beziehung-wahlen]]
...
====
Wenn Sie große Mengen an Seriennummern auf einmal erstellen möchten, nutzen Sie das Datenformat **SerialKeys**, das Sie im Menü **Daten » Dynamischer Export** erstellen. Weitere Informationen zum Importieren von Seriennummern finden Sie auf der Handbuchseite <<basics/datenaustausch/datenformate#, Datenformate>>.
====
