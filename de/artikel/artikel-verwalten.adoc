...
Wähle Einstellungen im Bereich *Pakete* aus, um das <<artikel/artikel-verwalten#270, Gewicht>> und den <<artikel/artikel-verwalten#280, Einkaufspreis>> automatisch für <<artikel/multipacks-pakete-sets-verwalten#2500, Artikelpakete berechnen zu lassen>>.
...
<<artikel/multipacks-pakete-sets-verwalten#2000, Artikelpakete>> bestehen aus mehreren Artikeln des Typs **Standard**. Der Paketpreis kann dabei günstiger sein als die Summe der Einzelpreise.
