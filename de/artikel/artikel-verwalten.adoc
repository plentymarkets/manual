...
Standardmäßig wird Bild-URLs die Subdomain des CDN-Bereichs zugewiesen, in  dem das Bild gespeichert ist. Optional speichern Sie eine eigene Subdomain. Pro Mandant können Sie eine benutzerdefinierte Subdomain speichern. <<tabelle-subdomain-bild-URLs>> zeigt die Unterschiede zwischen der Standard-Subdomain und einer benutzerdefinierten Subdomain.
