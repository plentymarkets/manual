...
. Namen und Beschreibung der ersten Auswahl eingeben, die als Merkmal angezeigt werden soll, z.B. Version 1.0.
. Speichern.
. Im Fenster nach unten scrollen und einen weiteren Namen eingeben, z.B. Version 2.0.
...
|Kategoriewahl
|Die Kategorie wählen, in der das Set veröffentlicht werden soll. +
*_Oder:_* Auf **Neue Kategorie** klicken, um eine neue Kategorie anzulegen.
|====
...
.YOOCHOOSE
====
Der externe Dienstleister <<omni-channel/online-shop/webshop-einrichten/extras/yoochoose#, YOOCHOOSE>> ist eine Alternative zum plentymarkets Cross-Selling.
====
