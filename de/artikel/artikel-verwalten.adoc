...
====
Sie können Eigenschaften bereits im Menü *System » Einstellungen » Eigenschaften* erstellen und Werte hinzufügen. Sie können diese Varianteneigenschaften außerdem im Menü *Artikel » Artikel bearbeiten » Artikel öffnen » Eigenschaft öffnen » Tab: Eigenschaften* mit Varianten verknüpfen. Allerdings können die Varianteneigenschaften vorerst nur im plentymarkets Backend angezeigt werden. Eine Anzeige der Varianteneigenschaften im Webshop oder eine Übertragung an Marktplätze ist zurzeit jedoch noch nicht möglich. Wir arbeiten mit Hochdruck daran, Ihnen diese Funktionen zur Verfügung zu stellen.
====
