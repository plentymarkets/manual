...
|**Position**
a|include::_textblocks/tabelle/position.adoc[]

|**Bildverknüpfung möglich**
a|include::_textblocks/tabelle/bildverknuepfung.adoc[]

|**Attribut-Auswahl im Webshop**
a|include::_textblocks/tabelle/attribut-auswahl.adoc[]
...
Eigenschaften werden für die nähere Charakterisierung von Artikeln, Kontakte oder Lagerorte genutzt. Mit Eigenschaften kannst du zum Beispiel:

* technische Details einer Variante wie Bluetooth oder WLAN abbilden
* bestimmen, welche Lagerorte für <<artikel/artikel-verwalten#3010, Kühlware oder andere Produktgruppen>> geeignet sind
* Felder einbinden, in die Kunden bei der Bestellung Zusatzwünsche eingeben können

Eigenschaften werden zentral im Menü *System » Systemeinstellungen » Einstellungen » Eigenschaften » Konfiguration* <<artikel/artikel-verwalten#3100, erstellt>> und anschließend mit <<artikel/artikel-verwalten#4800, Varianten>>, <<crm/kontakte-verwalten#, Kontakte>> oder <<warenwirtschaft/lager-einrichten#500, Lagerorte>> verknüpft.

Eigenschaften des Bereichs *Artikel* werden mit Varianten verknüpft. Eigenschaften unterscheiden sich also von den <<artikel/artikel-verwalten#480, Merkmalen>>, die auf der Artikelebene verknüpft werden. Du kannst bis zu 500 Varianteneigenschaften erstellen und mit Varianten verknüpfen.

Im Gegensatz zu <<artikel/artikel-verwalten#390, Attributen>> sind die Eigenschaften passiv. Eigenschaften dienen also nicht dazu, Varianten zu erstellen. Eigenschaften sind nicht an den Warenbestand gekoppelt und in der Artikelansicht im Webshop nicht wählbar.
...
* <<artikel/artikel-verwalten#3100, Erstelle eine Eigenschaft>> des Bereichs *Lagerort*.
...
In plentymarkets stehen dir für die Verwaltung und Sortierung deiner Artikel <<artikel/kategorien-verwalten#, Kategorien>> zur Verfügung. Wir empfehlen, im Vorfeld alle Kategorien und Unterkategorien zu erstellen, um dein Produktportfolio zu strukturieren und zu überblicken.
...
(icon:map-signs[]) *_Oder:_* Klicke auf *GTIN generieren*, um einen durch den <<artikel/artikel-verwalten#650, Nummernkreis>> generierten Code einzufügen.
. *Speichere* die Einstellungen.
...
Eigenschaften werden zentral im Menü *System » Systemeinstellungen » Einstellungen » Eigenschaften » Konfiguration* <<artikel/artikel-verwalten#4800, verwaltet>> und mit den Varianten von Artikeln des Typs *Standard* verknüpft. Eigenschaften des Bereichs *Artikel* werden in zwei verschiedenen Tabs mit Varianten verknüpft:
...
. (icon:map-signs[]) *_Oder:_* Um nach Unterkategorien zu filtern, klappe eine Kategorie auf und klicke auf die Unterkategorie. +
...
. (icon:map-signs[]) *_Oder:_* Klappe einen Mandanten auf und klicken auf eine Kategorie. +
...
(icon:map-signs[]) *_Oder:_* Drücke die Enter-Taste, um die Seriennummer zu speichern.
