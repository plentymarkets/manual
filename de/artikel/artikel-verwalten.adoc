...
=== Eigene Subdomain für Bild-URLs speichern
...
Standardmäßig wird Bild-URLs die Subdomain des CDN-Bereichs zugewiesen, in  dem das Bild gespeichert ist. Optional speichern Sie eine eigene Subdomain.

* Eigene Subdomains können nur für die Hauptdomain gespeichert werden.
* Eigene Subdomains können nur für Mandanten gespeichert werden, die von plentymarkets gehostet werden.
* Pro Mandant kann eine eigene Subdomain gespeichert werden.

<<tabelle-subdomain-bild-URLs>> zeigt die Unterschiede zwischen der Standard-Subdomain und einer benutzerdefinierten Subdomain.

[[tabelle-subdomain-bild-URLs]]
.Eigene Subdomain für Bilder-URLs speichern
[cols="2,2,1"]
|====
|Subdomain-Einstellung |Erläuterung |Beispiel-URL

|Bild-URL ohne eigene Subdomain
|Als Subdomain wird der CDN-Bereich angegeben, auf dem die Bilddatei liegt.
|https://*cdn01*.ihrshop.de/item/images/118/full/118-Relaxsessel-Rio.jpg

|Bild-URL mit eigener Subdomain
|Statt des CDN-Bereichs wird die benutzerdefinierte Subdomain angegeben.
|https://*ihresubdomain*.ihrshop.de/item/images/118/full/118-Relaxsessel-Rio.jpg
|====

Gehen Sie wie unten beschrieben vor, um eine eigene Subdomain für die Bilder-URLs eines Mandanten zu speichern.

[IMPORTANT]
.Nach dem Erstellen die Subdomain aktivieren
====
Das Erstellen der Subdomain kann mehrere Stunden dauern. Erst wenn in allen drei Spalten *SSL*, *DNS* und *Cloud-Status* grüne Häkchen angezeigt werden, ist der Vorgang abgeschlossen und die Subdomain kann aktiviert werden.
====
...
→ Bei AWS wird ein eigenes SSL-Zertifikat für die Subdomain erstellt. +
...
. Wenn alle drei Häkchen angezeigt werden, klicken Sie in der Spalte *Status* auf *Aktivieren*, um die Subdomain zu aktivieren.
...
|*Bereich*
|Den CDN-Bereich aus der Dropdown-Liste wählen, auf dem die Artikelbilder gespeichert sind. Aktuell ist nur der CDN-Bereich *CDN1* verfügbar.
