...
*_Hinweis:_* Wenn die Option *Artikelauflistung: sichtbar wenn Netto-WB positiv*, die Option *Artikelauflistung: unsichtbar wenn kein Netto-WB* oder beide Optionen aktiviert werden, wird die Option *Unsichtbar: in Artikelauflistung* automatisch deaktiviert.
...
*_Hinweis:_* Wenn eine oder beide Optionen aktiviert sind, wird die Option *Unsichtbar: in Artikelauflistung* automatisch deaktiviert. +
Wenn die Optionen *Webshop: sichtbar wenn Netto-WB positiv* bzw. *Webshop: unsichtbar wenn kein Netto-WB* aktiviert sind, kann die Variante auch nicht mehr über die direkte URL aufgerufen werden. Die Einstellung der Sichtbarkeit im Webshop hat also Priorität. Die Sichtbarkeit in der Artikelauflistung und die Sichtbarkeit im Webshop
