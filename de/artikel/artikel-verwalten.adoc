...
Artikelpakete bestehen aus mehreren Artikeln des Typs **Standard**. Der Paketpreis kann dabei günstiger sein als die Summe der Einzelpreise. Wie Sie Artikelpakete einrichten, erfahren Sie unter <<artikel/produkte-kombinieren#2000, Artikelpakete einrichten>>.
