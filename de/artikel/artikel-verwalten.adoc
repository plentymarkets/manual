...
Schließlich erfahren Sie, wie Sie Artikel und Varianten als <<artikel/artikel-verwalten#920, Artikelpakete>> anbieten. Zudem wird beschrieben, wie Sie Ihre Produkte, z.B. durch <<artikel/artikel-verwalten#950, Cross-Selling>>, besser präsentieren.

////
Schließlich erfahren Sie, wie Sie Artikel und Varianten als <<artikel/artikel-verwalten#920, Artikelpakete>> oder als <<artikel/artikel-verwalten#2080, Artikelsets>> anbieten. Zudem wird beschrieben, wie Sie Ihre Produkte, z.B. durch <<artikel/artikel-verwalten#950, Cross-Selling>>, besser präsentieren.
////
...
. Nehmen Sie ggf. weitere Einstellungen vor. Beachten Sie dazu die Erläuterungen in <<tabelle-attribut-erstellen>>.
...
**Auswahl per Box** = Attribute per Box wählen. Attribute werden als Boxen mit Attributwerten im Webshop angezeigt. Diese Einstellung ist nur bei der Attributverfügbarkeit mit **Client-Prüfung** möglich. Weitere Informationen finden Sie auf der Handbuchseite <<omni-channel/online-shop/webshop-einrichten/artikelansichten#, Grundeinstellungen>>.

|*Gruppierbar in Artikellisten* +
(nur Callisto)
|Anzeige der verfügbaren Artikelvarianten mit dem Callisto-Template <<omni-channel/online-shop/webshop-einrichten/cms-syntax#webdesign-itemview-container-itemviewcategorieslist, ItemViewCategoriesList>> aktivieren. Festlegen, anhand welches Attributs die Anzeige der Artikelvarianten erfolgen soll, z.B. für Schuhe das Attribut **Farbe** einstellen. So werden zunächst alle Farbvarianten angezeigt. Nach Wahl der Farbe wird eine weitere Dropdown-Liste mit dem nächsten Attribut, z.B. **Größe**, in der Artikeldetailansicht verfügbar. In den Einstellungen des Callisto-Templates unter **$ItemViewCategoriesList_GroupByVariation** ist wählbar, ob eine Gruppierung nach Attributen oder nach Varianten erfolgt.
...
. Nehmen Sie ggf. weitere Einstellungen vor. Beachten Sie dazu die Erläuterungen in <<tabelle-attributwerte-festlegen>>.
. **Speichern** Sie die Einstellungen.
...
Sie können Bilder für Attributwerte hochladen. Diese Bilder werden im Webshop als Kacheln angezeigt. Die Größe von Attributbildern legen Sie im Menü <<artikel/artikel-verwalten#670, System » Artikel » Bilder>> fest.
...
Merkmale sind Eigenschaften eines Artikels. Im Gegensatz zu Attributen sind Merkmale aber passive Eigenschaften. Merkmale bilden also keine Varianten. Merkmale sind auch in der Artikelansicht im Webshop nicht wählbar. Über Merkmale lassen sich Features des Artikels abbilden, z.B. technische Details wie Bluetooth oder WLAN. Merkmale sind passive Eigenschaften, die nicht an den Warenbestand gekoppelt sind. Mit Merkmalen bieten Sie z.B. Serviceleistungen gegen Aufpreis an oder binden ein Feld für Zusatzwünsche des Kunden ein. Über die Merkmalsuche finden Sie Artikel, die mit dem gesuchten Merkmal verknüpft sind. Über Merkmale verknüpfen Sie außerdem Ihre Artikel mit den Varianteneigenschaften auf einem Marktplatz.
...
|**Bestellmerkmal**
|Aktivieren, wenn das Merkmal im Bestellvorgang verfügbar sein soll. Der Kunde kann dann je nach *Merkmaltyp* des Bestellmerkmals z.B. einen Text oder Wert eingeben oder eine Option aus der Dropdown-Liste wählen.

|**Notiz**
|Notiz eingeben, um z.B. besondere Hinweise zum Merkmal anzuzeigen.

|Merkmalverknüpfung zu Marktplätzen und Preisportalen
|Marktplatz-Merkmal aus der Dropdown-Liste wählen bzw. Merkmalverknüpfung zu einem Marktplatz aktivieren. Weitere Informationen zum Erstellen von Merkmalen für Marktplätze und Preisportale finden Sie auf den Handbuchseiten der Marktplätze im Themenbereich <<omni-channel/multi-channel#, Multi-Channel>>.
|====
...
Eigenschaften sind wiederholt auftretende Informationen, die Sie in verschiedenen Bereichen von plentymarkets verknüpfen. Eigenschaften werden zentral im Menü *System » Einstellungen » Eigenschaften » Konfiguration* verwaltet und können in den folgenden Bereichen von plentymarkets eingesetzt werden:
...
. Nehmen Sie ggf. weitere Einstellungen vor. Beachten Sie dazu die Erläuterungen in <<tabelle-hersteller-hinzufuegen>>.
. **Speichern** Sie die Einstellungen. +
...
Plus.de-ID; +
Cdiscount.com-ID**
|Hersteller-ID des Marktplatzes eingeben. Die Hersteller-IDs eines Marktplatzes erhalten Sie beim Einrichten des <<omni-channel/multi-channel#, Marktplatzes>>.

|**Externer Name**
|Externen Namen für den Hersteller eingeben, um eine alternative Bezeichnung für den Export zu speichern. Beim Artikelexport zu externen Marktplätzen, z.B. über das Menü **System » Märkte » Preisportale » Exporte**, wird der hier eingegebene Name des Herstellers verwendet. Wenn kein externer Name eingegeben wurde, wird die Eingabe unter **Name** verwendet. Der externe Name wird auch zu <<omni-channel/online-shop/webshop-einrichten/extras/findologic#, FINDOLOGIC>> übertragen und für die Suche indexiert.
...
. Ändern Sie ggf. die Daten des Herstellers. Beachten Sie dazu die Erläuterungen in <<tabelle-herstellerprovision-hinzufuegen>>.
...
Viele Händler haben für ihre Artikel keine GTINs (Barcodes), da sie die Artikel direkt importieren und die Hersteller keine GTIN vergeben. Hier besteht die Möglichkeit, bei GS1 Germany GTINs zu erwerben, um diese GTINs z.B. auf den Marktplätzen <<omni-channel/multi-channel/amazon/amazon-einrichten#, Amazon>> oder <<omni-channel/multi-channel/real-de/real-de-einrichten#, real.de>> einstellen zu können. 13-stellige GTINs (früher EAN) setzen sich zusammen aus Basisnummer, Artikelnummer und Prüfziffer. Die Basisnummer hat 7 bis 9 Stellen und besteht aus dem Länderpräfix der GS1-Mitgliedsgesellschaft, z.B. 400 bis 440 für Deutschland, und der Unternehmensnummer. Die Artikelnummer des Herstellers hat 3 bis 5 Stellen (je nach Länge der Basisnummer). Die Prüfziffer nimmt die letzte Stelle ein.

[.instruction]
GTIN-Nummernkreis einrichten:

. Öffnen Sie das Menü **System » Artikel » GTIN**.
...
a|Statt der Standard-Domain wird die benutzerdefinierte Domain angegeben. Der Kunden-Hash wird nicht in der URL angezeigt:
...
. Öffnen Sie das Menü *System » Mandant » Mandant öffnen » Domains*.
...
.Was ist DNS?
====
DNS steht für Domain Name System. Dieses System sorgt dafür, dass Ihre Kunden nicht die numerische IP-Adresse Ihres Webshops eingeben müssen, sondern auch der Domain-Name der richtigen IP-Adresse zugeordnet wird.
====
...
→ Wenn im Menü *System » Mandant » Mandant öffnen » Domains* des plentymarkets Backend in den Spalten *SSL*, *DNS* und *Cloud-Status* grüne Häkchen angezeigt werden, ist der Vorgang abgeschlossen.
. Wenn im Menü *System » Mandant » Mandant öffnen » Domains* alle drei Häkchen angezeigt werden, klicken Sie in der Spalte *Status* auf *Aktivieren*. +
→ Die Domain wird aktiviert.
...
Im Menü *System » Artikel » Bilder » Größen* nehmen Sie Einstellungen für jede Bildgröße fest. Die folgenden Größen sind verfügbar:
...
**Aktionspreis** = Aktivieren, um einen Verkaufspreis als Aktionspreis zu kennzeichnen. Aktionspreise werden z.B. für Marktplätze wie <<omni-channel/multi-channel/amazon/amazon-einrichten#, Amazon>> und <<omni-channel/multi-channel/real-de/real-de-einrichten#, real.de>> verwendet. +
...
|**Klasse**
|Eine, mehrere oder **ALLE** Klassen aktivieren, mit denen der Verkaufspreis verknüpft wird. Der Verkaufspreis gilt nur für Kunden der gewählten Klassen.
...
. Öffnen Sie das Menü **System » Artikel » Preiskalkulation**.
...
. Öffnen Sie das Menü **System » Artikel » Einheiten**.
. Klicken Sie auf **Neu**. +
...
Gehen Sie wie unten beschrieben vor, um eine Etikettenvorlage zu erstellen.

[.instruction]
Etikettenvorlage erstellen:

. Öffnen Sie das Menü *System » Artikel » Etiketten*.
...
|*Seite*
|Seitenbreite und -höhe in Millimeter eingeben. Bei Verwendung von <<basics/arbeiten-mit-plentymarkets/drucker#50, Etikettendruckern>> kann die Seitengröße gleich der Etikettengröße sein.
...
Grafiken in der <<omni-channel/online-shop/webshop-einrichten/cms#bilder-galerie, Bildergalerie>> hochladen. Die relative URL der Grafik aus der Bildergalerie kopieren und in das Feld *URL* einfügen.
...
* Sie erstellen Prozesse, um <<basics/automatisierung/prozesse/aktionen#150, Artikeletiketten zu generieren>>.
...
[#3340]
==== Etikett in der Artikelsuche der plentymarkets App drucken (ab App-Version 1.8)
...
. Öffnen Sie das Menü **System » Artikel » Markierungen**.
...
*_Tipp:_* Die Template-Einstellungen sind nur für Systeme mit Callisto-Webshop relevant.
. **Speichern** Sie die Einstellungen.
...
. Nehmen Sie ggf. weitere Einstellungen vor. Beachten Sie dazu die Erläuterungen in <<tabelle-standardartikel-erstellen>>.
. **Speichern** Sie die Einstellungen. +
→ Der Artikel des Typs **Standard** samt Hauptvariante wird erstellt und in einem neuen Tab geöffnet.

Alternativ erstellen Sie einen neuen Artikel des Typs **Standard**, indem Sie im Menü <<artikel/kategorien-verwalten#, Artikel » Kategorien>> auf den Pfeil neben einer Kategorie klicken. Klicken Sie dann im eingeblendeten Kontextmenü auf **Neue Kategorie erstellen**.
...
**Set** = Erstellt einen Setartikel. Setartikel sind ein neues plentymarkets Feature. Setartikel können aktuell noch nicht im Webshop dargestellt werden. Daher wird das Erstellen von Setartikeln nicht empfohlen.
...
|**Variantennr.**
|Die Variantennummer wird automatisch nach dem im Menü **System » Artikel » Einstellungen** festgelegten Muster vergeben. Variantennummern sind nachträglich im Tab **Einstellungen** einer Variante änderbar.
...
In der Artikelarchitektur von plentymarkets 7 setzt sich ein Artikel des Typs **Standard** aus globalen Einstellungen und Daten der Hauptvariante und optional weiterer Varianten zusammen. Welche Artikeldaten Sie variantenübergreifend pflegen und bearbeiten, erfahren Sie in diesem Kapitel.

=== In Artikel-Tabs anzeigte Artikeldaten ändern

Standardmäßig wird in den Tabs von Artikeln die Artikel-ID angezeigt. Alternativ können Sie den Namen oder die Nummer der Hauptvariante des Artikels anzeigen lassen. Gehen Sie wie unten beschrieben vor, um die angezeigten Artikeldaten zu ändern.
...
|*Zustand*; +
*Zustand API*
|Zustand des Artikels wählen. Standardmäßig ist **Neu** eingestellt. Die Einstellung *Zustand API* wird für den Marktplatz <<omni-channel/multi-channel/amazon/amazon-einrichten#, Amazon>> verwendet.
...
|**Zolltarifnummer**
|Zolltarifnummer eingeben. Weitere Informationen finden Sie z.B. auf der Webseite von link:http://auskunft.ezt-online.de/ezto/Welcome.do[EZT-Online^].

|**Erlöskonto**
|Erlöskonto eingeben. Weitere Informationen zu Erlöskonten finden Sie auf der Handbuchseite <<auftragsabwicklung/auftraege/buchhaltung#90, Buchhaltung>>.

|*Max. Bestellmenge*
|Wert eingeben, um die Gesamtanzahl aller Varianten des Artikels zu begrenzen, die Kunden pro Auftrag bestellen können. +
...
Wert größer 0 = Kunden können maximal diese Gesamtmenge aller Varianten des Artikels bestellen. Kommawerte sind möglich, um z.B. Bestellungen nach Gewicht oder Länge abzubilden. Dieser Wert hat Priorität gegenüber der maximalen Bestellmenge der einzelnen Varianten des Artikels.
...
*Nur mit Aktionsgutschein kaufbar* = Kunden können die Varianten des Artikels nur kaufen, wenn sie den Code eines Aktionsgutscheins eingeben. +
Weitere Informationen zu Aktionsgutscheinen finden Sie auf der Handbuchseite <<auftragsabwicklung/auftraege/gutscheine#, Gutscheine>>.
...
Im Tab **Multi-Channel** nehmen Sie Einstellungen für die Marktplätze <<omni-channel/multi-channel/amazon/amazon-einrichten#, Amazon>>, <<omni-channel/multi-channel/ebay/ebay-einrichten#, eBay>> und <<omni-channel/multi-channel/neckermann/neckermann-at-einrichten#, Neckermann.at>> vor. Zudem verknüpfen Sie hier Ihre Kategorien mit den Kategorien von Marktplätzen. Einstellungen dieses Bereichs werden im Themenbereich <<omni-channel/multi-channel#, Multi-Channel>> verwendet und bei den Marktplätzen näher erläutert.
...
Die Länge des Artikelnamens ist auf 240 Zeichen begrenzt. Der Artikelname wird für den Aufbau der Artikel-URL verwendet. Weitere Informationen zur Artikel-URL finden Sie in unserem <<omni-channel/online-shop/webshop-einrichten/cms-syntax#fallbeispiele-seo-guide, SEO-Guide>>.
...
. Nehmen Sie ggf. weitere Einstellungen vor. Beachten Sie dazu die Erläuterungen in <<tabelle-merkmal-verknuepfen>>.
. **Speichern** Sie die Einstellungen.
...
. Klicken Sie auf **Öffnen**. +
→ Die Datei wird hochgeladen und in der Übersicht angezeigt.
. Nehmen Sie die Einstellungen gemäß <<tabelle-datei-hochladen>> vor.
. **Speichern** Sie die Einstellungen.
...
Wenn Sie <<basics/arbeiten-mit-plentymarkets/tags#, Tags>> für den Bereich **Artikel** verfügbar gemacht haben, können Sie Artikel mit Tags versehen.
...
→ In der Artikelübersicht kann der Artikel über den Tag-Filter gefunden werden.
...
=== In Varianten-Tabs anzeigte Variantendaten ändern

Standardmäßig wird in den Tabs von Varianten die Varianten-ID angezeigt. Alternativ können Sie den Variantennamen oder die Variantennummer anzeigen lassen. Gehen Sie wie unten beschrieben vor, um die angezeigten Variantendaten zu ändern.
...
|**Variantennummer**
|Variantennummer wird automatisch nach dem im Menü **System » Artikel » Einstellungen** festgelegten Muster vergeben. Variantennummern sind nachträglich im Tab **Einstellungen** einer Variante änderbar.
...
**__Hinweis:__** Wenn im Menü **System » Mandant » Mandant wählen » Artikelansichten » Einstellungen** für die Einstellung **Automatische Sortierung nach monatlichen Verkäufen** die Option **Ja** eingestellt ist, werden manuell eingegebene Positionsnummern überschrieben.
|====
...
. Öffnen Sie das Menü **System » Artikel » Verfügbarkeit**.
...
[#200]
==== Callisto: Verfügbarkeit im Webshop anzeigen

Die Verfügbarkeit wird in Callisto standardmäßig über das Template <<omni-channel/online-shop/webshop-einrichten/cms-syntax#webdesign-itemview-container-itemviewsingleitem, ItemViewSingleItem>> im Webshop angezeigt. Über die Template-Variablen **$AvailabilityString** und **$AvailabilityIcon** werden Verfügbarkeitstext und -symbol im Webshop dargestellt. Diese Template-Variablen sind standardmäßig im Template **ItemViewSingleItem** der plentymarkets Standard-Designs enthalten.
...
. Öffnen Sie das Menü **System » Mandant » Mandant wählen » Artikelansichten » Verfügbarkeit**.
...
Varianten, deren Verfügbarkeit nicht wie beschrieben aktiviert ist, sind nicht im Webshop bestellbar. Ob die Variante im Webshop sichtbar ist, hängt davon ab, welche Art der Prüfung im Menü <<omni-channel/online-shop/webshop-einrichten/artikelansichten#, System » Mandant » Mandant wählen » Artikelansichten » Einstellungen>> für die Attribut-Verfügbarkeit gewählt wurde:
...
**__Hinweis:__** Die Verfügbarkeitsstufe ist eine statische Einstellung. Das heißt, dass sich die gewählte Verfügbarkeitsstufe unabhängig vom tatsächlichen Warenbestand nicht ändert. Die Einstellung ist nur relevant, wenn keine automatische Warenbestandsanzeige eingestellt ist.
...
|Aktivieren, um die Variante in der Artikelauflistung des Webshops unsichtbar zu stellen. Wenn die Option aktiviert ist und kein Netto-Warenbestand verfügbar ist, kann die Variante nur noch über die direkte URL aufgerufen werden. Die Variante wird nicht in den Kategorien, in den Suchergebnissen und in den Artikellisten (Shop-Aktionen, Cross-Selling, zuletzt gesehene Artikel) angezeigt. +
*_Hinweis:_* Wenn die Option *Artikelauflistung: sichtbar wenn Netto-WB positiv*, die Option *Artikelauflistung: unsichtbar wenn kein Netto-WB* oder beide Optionen aktiviert werden, wird die Option *Unsichtbar: in Artikelauflistung* und ggf. auch die Vererbung deaktivert.

|*Artikelauflistung: sichtbar wenn Netto-WB positiv*; +
*Artikelauflistung: unsichtbar wenn kein Netto-WB* +
(Option funktioniert aktuell nur in Callisto, Umsetzung in Ceres folgt)
|Aktivieren, damit die Variante bei positivem Nettowarenbestand in der Artikelauflistung sichtbar wird und unsichtbar wird, wenn kein Nettowarenbestand vorhanden ist. Diese beiden Funktionen ergänzen sich und greifen nur, wenn die Option *Beschränkung* auf *Auf Netto-WB* gestellt ist. +
Wenn die Optionen aktiviert sind und kein Netto-Warenbestand verfügbar ist, kann die Variante nur noch über die direkte URL aufgerufen werden. Die Variante wird nicht in den Kategorien, in den Suchergebnissen und in den Artikellisten (Shop-Aktionen, Cross-Selling, zuletzt gesehene Artikel) angezeigt. +
*_Hinweis:_* Wenn eine oder beide Optionen aktiviert sind, wird die Option *Unsichtbar: in Artikelauflistung* und ggf. auch die Vererbung automatisch deaktiviert. +
*_Hinweis:_* Die Optionen *Webshop: sichtbar wenn Netto-WB positiv* bzw. *Webshop: unsichtbar wenn kein Netto-WB* haben Priorität. Wenn diese Optionen aktiviert sind und kein Netto-Warenbestand verfügbar ist, kann die Variante also auch nicht über die direkte URL aufgerufen werden. Daher ist es sinnvoll, die Sichtbarkeit entweder über die Webshop-Sichtbarkeit oder über die Artikelauflistungssichtbarkeit zu steuern und diese Einstellungen nicht zu kombinieren.
...
Weitere Informationen zu Vorbestellungen finden Sie auf der Handbuchseite <<auftragsabwicklung/auftraege/auftraege-verwalten#vorbestellungen, Vorbestellungen>>.
...
Verknüpfen Sie Verkaufspreise mit den Hauptvarianten von Artikeln des Typs **Standard**, um Preise zu speichern. Sie können Preise eingeben oder anhand einer Preiskalkulation errechen lassen. Die an der Hauptvariante gespeicherten Kombinationen aus Verkaufspreis und Preis werden von der Hauptvariante an die Varianten des Artikels vererbt, wenn die Vererbung nicht an der Variante deaktiviert ist.
...
ASIN (Amazon Standard Identification Number) und ePID (eBay Product ID) sind Produktkennzeichnungen von <<omni-channel/multi-channel/amazon/amazon-einrichten#, Amazon>> bzw. <<omni-channel/multi-channel/ebay/ebay-einrichten#, eBay>>. Die ASIN besteht aus 10 Buchstaben und/oder Ziffern. Bei Büchern entspricht die ASIN der ISBN-Nummer. Die ASIN finden Sie auf der Produktseite bei Amazon. Die ePID wird von eBay zur Verfügung gestellt. Verknüpfen Sie ASIN und ePID mit Varianten.
...
. Wählen Sie **ASIN** bzw. **ePID** aus der Dropdown-Liste.
...
Die Berechnung von Grundpreisen, z.B. pro Kilogramm, erfolgt auf der Basis des Gewichtes, das unter **Inhalt** eingetragen ist und der Einstellung unter **Einheit** in Verbindung mit dem **Preis**. Der Eintrag bei der Option **VPE** hat keinen Einfluss auf die Berechnung eines Grundpreises.
...
|**Umsatzsteuer**
|Umsatzsteuersatz für die Variante wählen. Weitere Informationen über Umsatzsteuersätze finden Sie auf der Handbuchseite <<auftragsabwicklung/auftraege/buchhaltung#3, Buchhaltung>>.

|**EK netto**
|Der Nettoeinkaufspreis. Abhängig von den Einstellungen im Menü <<warenwirtschaft/wareneingaenge-verwalten#250, System » Waren » Warenbestand » Wareneingang>> wird der Einkaufspreis berechnet oder manuell gepflegt. +
...
**__Hinweis:__** Bei der Berechung wird nur Wareneingang in die *Lager für gleitenden Durchschnittspreis* berücksichtigt, die im Menü *System » Waren » Warenbestand » Wareneingang* aktiviert wurden. Wenn keine Lager aktiviert sind, erfolgt keine Berechnung.
...
Eigenschaften werden zentral im Menü *System » Einstellungen » Eigenschaften » Konfiguration* verwaltet und mit den Varianten von Artikeln des Typs *Standard* verknüpft. Eigenschaften des Bereichs *Artikel* werden in zwei verschiedenen Tabs mit Varianten verknüpft:
...
Um eine Eigenschaftsverknüpfung zu löschen, klicken Sie im Tab *Eigenschaften* bzw. *Texte* in der Variante in der Zeile der Eigenschaft auf *Löschen*. Beim Löschen einer Eigenschaftsverknüpfung greift die folgende Vererbungslogik:
...
Hier eingegebene Werte gelten für die Marktplätze <<omni-channel/multi-channel/neckermann/neckermann-at-einrichten#, Neckermann.at>>, <<omni-channel/multi-channel/otto#, OTTO>>, <<omni-channel/multi-channel/rakuten/rakuten-einrichten#, Rakuten>>, <<omni-channel/multi-channel/plus-de/plus-gartenxxl einrichten#, Plus.de>>. Die Werte sind gegenüber den Bestandspufferwerten der Marktplätze dominant.
...
Im Menü *System » Artikel » Suche » Backend » Suchindex* können Sie die Aktualisierung des Suchindex auch manuell starten.
...
. Öffnen Sie das Menü *System » Artikel » Suche » Backend » Suchindex*.
...
Im Menü *System » Artikel » Suche » Backend » Suchindex » Tab: Übersicht* sehen Sie, wie viele Artikel im System gespeichert sind und wie viele Artikel im Suchindex enthalten sind.
...
Im Menü *System » Artikel » Suche » Backend » Suchindex » Tab: Artikelmerkmale* sehen Sie, wie viele Artikel mit Merkmalen im System gespeichert sind und wie viele Artikel mit Merkmalen im Suchindex enthalten sind.
...
|Tags
|Tag-Namen eingeben, um nach Artikeln zu suchen, die im Tab **Global** mit diesen Tags verknüpft wurden. Tags werden im Menü *System » Einstellungen » Tags* erstellt. +
...
Im Tab **Mandant** suchen Sie ach Artikeln eines Mandanten oder Artikeln einer Kategorie des Mandanten. Sie können außerdem nach Artikeln suchen, die für einen Mandanten nicht verfügbar gestellt sind. Für die Filterung ist die Einstellung **Verfügbar** im Tab **Kategorien** der Variante ausschlaggebend.
...
|**Erlöskonto**
|Erlöskonto eingeben. Weitere Informationen zum Erlöskonto finden Sie auf der Handbuchseite <<auftragsabwicklung/auftraege/buchhaltung#90, Buchhaltung>>.
...
|**Artikelbewertung**
|Erstbewertung von **1** bis **5** bzw. **1** bis **10** für das Set eingeben. Wenn Sie Artikelbewertungen verwenden, wird der eingegebene Wert als Erstbewertung des Sets angezeigt. Der Wert wird nach jeder Bewertung automatisch auf einen Durchschnittswert angepasst. Den Bewertungsbereich legen Sie im Menü **System » Mandant » Global » Feedback » Tab: Artikel** unter **Maximale Bewertungspunkte** fest.
...
.YOOCHOOSE
====
Der externe Dienstleister <<omni-channel/online-shop/webshop-einrichten/extras/yoochoose#, YOOCHOOSE>> stellt eine Alternative zum plentymarkets Cross-Selling dar.
====
...
Wie Sie Artikellisten vom Typ **Cross-Selling** erstellen, erfahren Sie im Handbuch unter <<omni-channel/online-shop/ceres-einrichten#110, Artikellisten einrichten>>.
...
. Klicken Sie auf die passende *Beziehung*. Beachten Sie dazu die Erläuterungen in <<tabelle-cross-selling-beziehung-waehlen>>. +
→ Die Artikel werden hinzugefügt und im Tab *Cross-Selling-Artikel* angezeigt.

[[tabelle-cross-selling-beziehung-weahlen]]
...
Wie Sie Shop-Aktionen in Ceres einrichten, erfahren Sie unter <<omni-channel/online-shop/ceres-einrichten#110, Artikellisten einrichten>>.

Wir beschreiben hier am Beispiel **Top-Artikel**, wie Sie Shop-Aktionen in Callisto einrichten. Richten Sie andere Shop-Aktionen analog ein.

[#1020]
=== Callisto: Artikel als Top-Artikel präsentieren
...
Die so bestimmten Top-Artikel werden im Webshop über das Template <<omni-channel/online-shop/webshop-einrichten/cms-syntax#webdesign-itemview-container-itemviewtopsellerslist, ItemViewTopSellersList>> im Menü **CMS » Webdesign » Ordner: Layout » Ordner: ItemView » Template: ItemViewTopSellersList** dargestellt. Die Sortierreihenfolge legen Sie im Tab **Einstellungen** des Templates fest. Weitere Informationen zu den Templates der anderen Shop-Aktionen finden Sie auf folgenden Handbuchseiten:

* Sonderangebot: <<omni-channel/online-shop/webshop-einrichten/cms-syntax#webdesign-itemview-container-itemviewspecialofferslist, ItemViewSpecialOffersList>>
* Neuheit: <<omni-channel/online-shop/webshop-einrichten/cms-syntax#webdesign-itemview-container-itemviewlastseenlist, ItemViewLatestItemsList>>

[#1030]
=== Callisto: Top-Artikel positionieren

Sie haben auch die Möglichkeit, Top-Artikel im Webshop anhand der Positionsnummern darzustellen. Für diese Möglichkeit verwenden Sie das Template <<omni-channel/online-shop/webshop-einrichten/cms-syntax#webdesign-itemview-container-itemviewitemsbypositionlist, ItemViewItemsByPositionList>>. Die Positionsnummern vergeben Sie entweder manuell oder automatisch. Wenn Sie im Menü **System » Mandant » Mandant wählen » Artikelansichten » Einstellungen** für die Einstellung **Automatische Sortierung nach monatlichen Verkäufen** die Option **Nein** wählen, können Sie manuell Positionen eingeben. Wenn Sie **Ja** wählen, werden die Positionen automatisch vergeben. Bei dieser Einstellung werden manuell eingegebene Positionen überschrieben. Die automatische Vergabe erfolgt anhand der monatlichen Verkaufszahlen und spiegelt also tatsächlich Ihre meistverkauften Artikel wider.

[#1040]
==== Top-Artikel manuell positionieren

Durch eine manuelle Vergabe der Position legen Sie Ihre Top-Artikel selbst fest. Die Artikelansicht <<omni-channel/online-shop/webshop-einrichten/cms-syntax#webdesign-itemview-container-itemviewitemsbypositionlist, ItemViewItemsByPositionList>> zeigt Artikel absteigend sortiert nach Position an. Mit diesem Template zeigen Sie die manuell sortierten Top-Artikel im Webshop an. Das Template finden Sie im Menü **CMS » Webdesign » Ordner: Layout » Ordner: ItemView » Template: ItemViewItemsByPositionList**.
...
[#1050]
==== Callisto: Top-Artikel automatisch positionieren
...
Die Artikelansicht <<omni-channel/online-shop/webshop-einrichten/cms-syntax#webdesign-itemview-container-itemviewitemsbypositionlist, ItemViewItemsByPositionList>> zeigt Artikel absteigend sortiert nach Position an und kann verwendet werden, um Top-Artikel im Webshop anzuzeigen.

Weitere Informationen zur Einrichtung der verschiedenen Templates im Layout finden Sie auf der Handbuchseite <<omni-channel/online-shop/webshop-einrichten/artikelsortierung#, Artikelsortierung>>.

[#1080]
=== Callisto: Artikel mit Shop-Aktionen verknüpfen
...
. Öffnen Sie das Menü **System » Artikel » Aktionen**.
...
.Callisto: Artikel mit Shop-Aktion verknüpfen
[cols="1,2"]
|====
|Einstellung |Erläuterung
...
Mit Gratiszugaben generieren Sie höhere Umsätze in Ihrem Webshop da solche Gratiszugaben Ihre Kunden motivieren, mehr und öfter bei Ihnen einzukaufen. Die grundlegende Idee ist einfach: Sie bieten Kunden ab einem bestimmten Warenwert pro Einkauf eine Variante aus Ihrem Sortiment als Gratiszugabe an. Statt diese Variante jedem Auftrag manuell hinzuzufügen, automatisieren Sie diesen Vorgang in plentymarkets mit einer <<basics/automatisierung/ereignisaktionen#, Ereignisaktion>>.
...
[#720]
== Callisto: Artikelvorlagen verwalten
...
[#730]
=== Callisto: Artikelvorlagen erstellen
...
[#740]
=== Callisto: Artikelvorlage mit einem Artikel verknüpfen
...
====
Wenn Sie große Mengen an Seriennummern auf einmal erstellen möchten, nutzen Sie das Datenformat **SerialKeys**, das Sie im Menü **Daten » Dynamischer Export** erstellen. Weitere Informationen zum Importieren von Seriennummern finden Sie auf der Handbuchseite <<basics/datenaustausch/export-import/datenformate#, Datenformate>>.
====
...
Mit Prozessen können Sie das Erfassen von <<basics/automatisierung/prozesse/aktionen#420, Seriennummern automatisieren>>.
