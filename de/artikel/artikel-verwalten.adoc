...
|**GLD EK netto**
|Der <<warenwirtschaft/wareneingaenge-verwalten#250, gleitende Durchschnittseinkaufspreis>> (GLD EK netto) kann eingegeben oder berechnet werden. Der GLD EK netto wird bei jedem Wareneingang neu aus den Einkaufspreisen aller im Lager verfügbaren Bestände einer Variante berechnet. Manuell eingegebene Werte werden bei der Neuberechnung überschrieben. +
