...
|**Erlöskonto**
|Erlöskonto eingeben. Weitere Informationen zum Erlöskonto finden Sie auf der Handbuchseite **<<omni-channel/online-shop/mandanten-einrichten/buchhaltung#90, Buchhaltung >>**.
...
|**Umsatzsteuer**
|Umsatzsteuersatz für die Variante wählen. Weitere Informationen über Umsatzsteuersätze finden Sie auf der Handbuchseite **<<omni-channel/online-shop/mandanten-einrichten/buchhaltung#3, Buchhaltung >>**.
