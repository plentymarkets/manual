...
|**Zolltarifnummer**
|Zolltarifnummer eingeben. Weitere Informationen findest du zum Beispiel auf der Webseite von link:http://auskunft.ezt-online.de/ezto/Welcome.do[EZT-Online^]{nbsp}icon:external-link[].
