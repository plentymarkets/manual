...
|**Umsatzsteuer**
|Umsatzsteuersatz für die Variante wählen. Weitere Informationen über Umsatzsteuersätze finden Sie auf der Handbuchseite <<auftragsabwicklung/auftraege/_buchhaltung#3, Buchhaltung>>.
...
.YOOCHOOSE
====
Der externe Dienstleister <<omni-channel/online-shop/extras/yoochoose#, YOOCHOOSE>> stellt eine Alternative zum plentymarkets Cross-Selling dar.
====
