...
Standardmäßig wird Bildern die URL der Standard-CDN-Domain zugewiesen.

Optional verwenden Sie als Domain die Domain des Mandanten und speichern eine eigene Subdomain.

* Eigene Subdomains können nur für die Hauptdomain gespeichert werden.
* Pro Mandant kann nur eine eigene Subdomain gespeichert werden.

<<tabelle-domain-bild-URLs>> zeigt die Unterschiede zwischen der Standard-CDN-Domain und einer eigenen Domain.
...
|https://*ihresubdomain.ihrshop.de*/item/images/118/full/118-Relaxsessel-Rio.jpg
|====
...
[IMPORTANT]
.Nach Erstellen der Subdomain Domain aktivieren
====
...
.Testseite drucken
====
Je nach Drucker kann es auch bei einer korrekt eingerichteten Vorlage zu Abweichungen beim Ausdruck kommen. Drucken Sie daher beim Einrichten der Vorlage Probedrucke auf Normalpapier. Korrigieren Sie die Positionen, bis Sie mit dem Ergebnis zufrieden sind, bevor Sie Etikettenpapier verwenden.
====
...
Wie Sie Artikellisten vom Typ **Cross-Selling** anlegen, erfahren Sie im Handbuch unter <<omni-channel/online-shop/ceres-einrichten#110, Artikellisten einrichten>>.
