...
|**Vorschautext**
|Vorschautext eingeben. Der Vorschautext ist ein kurzer Text, der in Artikellisten angezeigt werden kann. Dieser kann im HTML-Format oder als Klartext eingegeben werden. 
