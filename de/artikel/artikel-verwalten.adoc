...
Für Ihre Produkte erstellen Sie Artikel und Artikelvarianten in plentymarkets. Artikel verkaufen Sie in Ihrem <<omni-channel/online-shop/webshop-einrichten#, Webshop>> und über die zahlreichen in plentymarkets verfügbaren <<maerkte#, Marktplätze>>.
...
. *_Optional:_* Zeigen Sie eine Vorschau des Artikels an:
...
====
Neue Artikel und Änderungen an Artikeldaten sind nicht sofort im Webshop und den Exporten verfügbar. Wie Sie prüfen, ob die Artikeldaten aktuell sind, erfahren Sie auf der Handbuchseite <<artikel/artikeldaten-status-pruefen#, Aktualität von Artikeldaten prüfen>>. Klicken Sie in der Speicherzeile des Artikels auf das Vorschausymbol, um eine Vorschau der Änderungen am Artikel im Webshop anzuzeigen.
====
...
.Änderungen nicht sofort sichtbar
====
Neue Varianten und Änderungen an Variantendaten sind nicht sofort im Webshop und den Exporten verfügbar. Wie Sie prüfen, ob die Variantendaten aktuell sind, erfahren Sie auf der Handbuchseite <<artikel/artikeldaten-status-pruefen#, Aktualität von Artikeldaten prüfen>>. Klicken Sie in der Speicherzeile der Variante auf das Vorschausymbol, um eine Vorschau der Änderungen an der Variante im Webshop anzuzeigen.
====
...
. *Speichern* Sie die Einstellungen.
. *_Optional:_* Zeigen Sie eine Vorschau der Variante an:
...
|Tags
|Tag-Namen eingeben, um nach Varianten zu suchen, die mit diesen Tags verknüpft wurden. Tags werden im Menü *System » Einstellungen » Tags* erstellt. +
*_Tipp:_* Den ersten Buchstaben des Tags eingeben und dann die Autovervollständigung nutzen.
