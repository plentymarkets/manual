...
Der Ablauf ist wie folgt. Lege zunächst <<einstellungen/attribute#100, Attribute>>, wie Farbe sowie die entsprechenden <<einstellungen/attribute#200, Werte>>, wie rot, blau und grün an. <<einstellungen/attribute#300, Erzeuge danach Varianten>>, indem du Attributwerte miteinander kombinierst. Zum Beispiel ergeben sich 9 verschiedene Varianten, wenn du die Größen S, M, L mit den Farben rot, blau und grün kombinierst. Dieses Video bietet dir eine spielerische Einführung in das Thema:

.Lerne Attribute spielerisch kennen
video::265389643#t=0m54s[vimeo]

Verkaufst du deine Produkte auf Märkten wie Amazon und eBay? Einige Märkte erfordern, dass du <<einstellungen/attribute#500, deine eigenen Attributwerte mit ihren Attributwerten>> verknüpfst.
