...
Es ist technisch möglich, Attribute beim <<artikel/import-export-anlage/anlage/neue-artikel#200, manuellen Anlegen eines neuen Artikels>> auszuwählen. Wir empfehlen diese Vorgehensweise jedoch nicht.

Vielmehr empfehlen wir dir, zuerst einen neuen Artikel, d.h. eine Hauptvariante, ohne Attribute anzulegen. Anschließend empfehlen wir dir, Attribute auszuwählen, während du <<artikel/import-export-anlage/anlage/neue-artikel#400, zusätzliche Varianten erstellst>>.
