...
* *Per Box* = Attribute werden als Boxen mit Attributwerten im Webshop angezeigt. Diese Einstellung betrifft nur den Callisto Webshop und ist nur bei der <<webshop/webshop-einrichten/artikelansichten#, Attributverfügbarkeit mit Client-Prüfung>> möglich.
...
Es ist technisch möglich, Attribute beim <<artikel/import-export-anlage/anlage/neue-artikel#200, manuellen Erstellen eines neuen Artikels>> auszuwählen. Wir empfehlen diese Vorgehensweise jedoch nicht.
...
====
Gib eine möglichst kurze Bezeichnung ein, da der Platz begrenzt ist. Der Attributname wird im Webshop neben einer Auswahlbox angezeigt.
====
