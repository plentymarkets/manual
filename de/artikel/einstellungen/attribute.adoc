...
Möchtest du beispielsweise nur die technischen Features eines Produkts in deinem Shop hervorheben?
...
| *Position*
a|Welches Attribut soll im Webshop als erstes, zweites, drittes, usw. angezeigt werden?
...
| *Position*
|Welcher Attributwert soll im Webshop als erster, zweiter, dritter, usw. angezeigt werden?
Gib eine Positionsnummer in dieses Feld ein.
