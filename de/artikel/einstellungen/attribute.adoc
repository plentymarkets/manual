...
.. Setze links den Filter <<artikel/einleitung/suche#tabellentyp, Tabellentyp>> auf *Varianten*.
.. Setze links den Filter <<artikel/einleitung/suche#aktiv, Aktiv>> auf *ALLE*.
.. Wähle im Filter <<artikel/einleitung/suche#alle, ALLE>> das Attribut aus der Dropdown-Liste.
