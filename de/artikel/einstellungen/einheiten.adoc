...
Dargestellt werden kann er <<artikel/artikel-verwalten#270, im Webshop>>, auf Vertriebskanälen wie <<maerkte/amazon/varianten-vorbereiten#860, Amazon>>, <<maerkte/ebay/ebay-einrichten#4000, eBay>> oder <<maerkte/plus-gartenxxl#365, Netto>> und <<artikel/einstellungen/barcodes#900, auf Artikeletiketten>>.
