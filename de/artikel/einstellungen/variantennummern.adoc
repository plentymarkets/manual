...
:keywords: Variantennummer, Variantennummern, Varianten-Nummer, Variantennr., Präfix für neue Variantennummern, Zuletzt vergebene Variantennummer, Präfix, NEW-, Muster
