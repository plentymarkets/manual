...
//später :position: 40 einfügen wenn die Seite live sein soll
...
====
Merkmale werden mit Artikeln verknüpft. Daher gelten Merkmale für alle Varianten des Artikels. Merkmale sind veraltet und schrittweise durch <<artikel/einstellungen/eigenschaften#500, Eigenschaften>> ersetzt. Eigenschaften werden mit Varianten verknüpft und bieten daher mehr Flexibilität.
====
