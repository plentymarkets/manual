...
| *Bereich*
a|Wofür möchtest du die Eigenschaft nutzen? Wähle den entsprechenden Bereich aus der Dropdown-Liste.
...
Verwende dazu den Import-Typ *Eigenschaften*. Welche Felder du für den Abgleich und die Zuordnung verwenden kannst, ist auf der Handbuchseite des Import-Typs <<daten/daten-importieren/sync-typen/elasticSync-eigenschaften#, Eigenschaften>> beschrieben.
...
Verwende dazu den Import-Typ *Artikel* und die Zuordnungsfelder unter der Überschrift <<daten/daten-importieren/sync-typen/elasticSync-artikel#2410, Eigenschaften>>.
