...
. <<artikel/frontend-artikelsuche-verwalten#, Erstelle Webshop-Filter>>, z.B. wenn deine Kunden nach Bluetooth-fähigen Produkten im Webshop filtern können sollen.
