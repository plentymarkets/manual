...
.. Setze links den Filter <<artikel/einleitung/suche#tabellentyp, Tabellentyp>> auf *Artikel*.
.. Setze links den Filter <<artikel/einleitung/suche#aktiv, Aktiv>> auf *ALLE*.
.. Wähle im Filter <<artikel/einleitung/suche#hersteller, Hersteller>> den Hersteller aus der Dropdown-Liste.
