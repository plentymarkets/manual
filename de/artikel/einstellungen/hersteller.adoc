...
Du kannst Herstellerdatensätze entweder <<artikel/einstellungen/hersteller#150, manuell erstellen>> oder <<artikel/einstellungen/hersteller#200, importieren>>. Außerdem kannst du <<artikel/einstellungen/hersteller#300, Provisionen für deine Hersteller speichern>> und angeben, <<artikel/einstellungen/hersteller#400, wer jedes deiner Artikel herstellt>>.

[#100]
== Herstellerdatensätze erstellen

Lege zunächst einen Datensatz für jeden deiner Hersteller an.
Wenn du nur wenige Herstellerdatensätze anlegen möchtest, empfiehlt sich die <<artikel/einstellungen/hersteller#150, manuelle Erstellung>>.
Hast du aber dagegen viele verschiedene Hersteller, dann ist es wahrscheinlich schneller, deine <<artikel/einstellungen/hersteller#200, Herstellerdaten zu importieren>>.
...
| *Straße*
.8+|Gib die Adress- und Kontaktdaten des Herstellers ein.
| *Haus-Nr.*
| *PLZ*
| *Ort*
| *Land*
...
| *PIXmania-ID*
.7+|Gib die Hersteller-ID des Marktplatzes ein.
