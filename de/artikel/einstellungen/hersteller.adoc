...
* Sollen deine Kunden im Webshop gezielt nach Produkten des Herstellers suchen können?
Passe die <<artikel/einstellungen/hersteller#450, Webshop-Einstellungen>> bei Bedarf an.
...
* Der externe Name wird für Kunden im Webshop sichtbar sein.
Er ist auch <<artikel/einstellungen/hersteller#450, für die Webshop-Suche relevant>>.
...
Sollen deine Kunden im Webshop gezielt nach Produkten eines bestimmten Herstellers suchen können?
