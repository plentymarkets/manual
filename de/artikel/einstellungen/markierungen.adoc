...
Du kannst auch <<gezielt nach Varianten im Backend suchen>>, die ein bestimmtes Tag haben.
* *_Schlagworte im Webshop_*: du entscheidest, welche Tags für Kunden im Webshop sichtbar sein sollen und welche nicht.
...
##Varianten-Gruppenfunktion und Stapelverarbeitung##
