...
* *_Schlagworte im Webshop_*: du entscheidest, welche Tags <<willkommen/allgemeine-funktionen/tags#intable-mandant, für Kunden im Webshop sichtbar>> sein sollen und welche nicht.
...
include::../../willkommen/allgemeine-funktionen/tags.adoc[tag=neue-tags-erstellen]
