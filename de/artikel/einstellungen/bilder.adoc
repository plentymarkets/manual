...
:keywords: Bild, Bilder, Artikelbild, Artikelbilder, Variantenbild, Variantenbilder, Bilddatei, Bilddateien, S3, CDN, CloudFront, FTP, FTP-Server, FTP-Import, skalierbar, skalieren, Skalierung, Platzhalterbilder, Platzhalterbild, Attributbild, Attributbilder, Größe, Bildgröße, Bildergröße, Höhe, Breite, Bildnamen, Bildname, Präfix, Vorschaubild, Vorschaubilder, Pixel, Pixels, Pixeln, Bild-URLs, Bild-URL, Domain, Domains, Subdomain, Subdomains, preview, secondPreview, middle, full, EXIF, XMP, IPTC, vergrößern, Originalbild, Komprimierung, Komprimierungslevel, Progressiv
...
. Nimm die Einstellungen vor. Beachte die Erläuterungen in <<table-image-settings>>.
...
. Nimm die Einstellungen vor. Beachte dazu die Erläuterungen in <<table-plenty-domain>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen. +
...
. Klicke auf *Hinzufügen*. +
→ Das Fenster *Neue Domain* wird geöffnet.
. Nimm die Einstellungen vor. Beachte dazu die Erläuterungen in <<table-external-domain>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen. +
→ Für die Subdomain wird ein DNS-Eintrag erstellt.
...
. Nimm für jede Bildgröße die Einstellungen vor. Beachte die Erläuterungen in <<table-image-sizes>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
