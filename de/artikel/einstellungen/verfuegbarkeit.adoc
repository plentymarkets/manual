...
Konfiguriere zunächst die zehn Verfügbarkeitsstufen. Im zweiten Schritt definierst du dann die <<artikel/artikel-verwalten#symbol, Verfügbarkeit jedes Artikels>>.
...
Dann <<artikel/artikel-verwalten#symbol, verknüpfst du die passende Verfügbarkeitsstufe mit jedem deiner Artikel>>.
