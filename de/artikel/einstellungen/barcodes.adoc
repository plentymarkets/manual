...
*_Tipp_*: Auf den Etiketten werden nur Werte ausgegeben, für die X- und Y-Koordinaten gespeichert wurden.
. *Speichere* (icon:save[role="green"]) die Einstellungen. +
...
*_Hinweis_*: Wird der Preistyp *UVP* gewählt, wird unabhängig vom gewählten Verkaufspreis immer der UVP der Variante ausgegeben.
...
*_Hinweis_*: Wird der Preistyp *UVP* gewählt, wird unabhängig vom gewählten Verkaufspreis immer der UVP der Variante ausgegeben. +
*_Hinweis_*: Wenn *Preis* und *Grundpreis* angezeigt werden sollen sicherstellen, dass für beide Optionen derselbe Preistyp und/oder Verkaufspreis gewählt wird.
