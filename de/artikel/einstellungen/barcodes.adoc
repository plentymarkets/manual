...
Hast du GTINs (Barcodes) für deine Artikel? Möglicherweise nicht, wenn du die Artikel direkt importierst und deine Hersteller keine GTINs vergeben.
