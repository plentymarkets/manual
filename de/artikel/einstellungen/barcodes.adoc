...
* <<artikel/einstellungen/barcodes#200, Erwerbe die Barcodes>>: +
...
Hast du GTINs (Barcodes) für deine Artikel?
...
TIP: Um GTINs mehrere Varianten gleichzeitig zuzuordnen, nutze die <<artikel/import-export-anlage/anlage/massenbearbeitung#300, Varianten-Gruppenfunktion>> oder die <<artikel/import-export-anlage/anlage/massenbearbeitung#600, Varianten-Stapelverarbeitung>>.
...
====
Möchtest du die Artikeldaten in normaler oder fetter Schrift darstellen?
Sollen die Daten klein oder groß sein?
Verwende die Dropdown-Listen, um die Schriftgröße und Schriftschnitt festzulegen.

Möchtest du den Titel von bestimmten Artikelparametern anzeigen?
Soll der Text umgebrochen werden, wenn er die Breite des Etiketts überschreitet?
Setze dazu Häkchen (icon:check-square[role="blue"]) neben den Optionen *Titel verbergen* und *Zeilenumbruch erlauben*.
====
...
| *Name*
|Gib einen Name für das Etikett ein.

|[#intable-sprache]*Sprache*
|Wähle die Sprache für das Etikett aus.
Standardmäßig ist die Systemsprache voreingestellt.

| *Zeichensatz*
|Wähle den Zeichensatz aus.
...
*_Hinweis_*:
Wenn *Preis* und *Grundpreis* angezeigt werden sollen, stelle sicher, dass für beide Optionen derselbe Preistyp und/oder Verkaufspreis ausgewählt wird.
