...
[.collapseBox]
.*Artikelbilder sollen in der Suchleiste erscheinen. Wie geht das?*
--
...
[.collapseBox]
.*Ein Hersteller wird nicht gefunden. Warum nicht?*
--

Stelle sicher, dass du den <<artikel/einstellungen/hersteller#150, externen Herstellernamen>> gepflegt hast.
Ist kein externer Name gespeichert, dann erscheint der Hersteller nicht in den Suchergebnissen.

*_Hinweis_*: Es kann etwas dauern, bis der Index aktualisiert ist und alles korrekt angezeigt wird.
Wenn die Hersteller am nächsten Tag immer noch nicht in den Suchergebnissen erscheinen, wende dich an link:https://forum.plentymarkets.com/c/item[das Item-Team im Forum]{nbsp}icon:external-link[].
...
. Ferner musst du die Suchleiste für jede Sprache zusammenstellen, d.h. Widgets hinzufügen, die Texte anpassen und das Aussehen anpassen.
