...
====
Es ist zwar technisch möglich, Artikelvorlagen mit dem Ceres-Webshop zu verwenden.
...
Mit Hilfe von Artikelvorlagen kannst du die Produktseiten deines Webshops gestalten.
...
. Stelle zum Schluss das Ceres-Plugin bereit.
...
<<willkommen/schnelleinstieg/schnelleinstieg-webshop#270, Stelle das Ceres-Plugin bereit>> und prüfe, wie die Vorlage in deinem Webshop aussieht.
