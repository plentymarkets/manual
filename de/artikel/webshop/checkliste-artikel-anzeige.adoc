...
Du hast deinen <<artikel/import-export-anlage/anlage/neue-artikel#, Artikel angelegt>> und möchtest jetzt prüfen, wie er in deinem Shop aussieht. Aber wo ist er? Warum ist er nicht sichtbar?
