...
* <<willkommen/allgemeine-funktionen/tags#, Erstelle die Tags>>, die du für deine Artikel verwenden möchtest, z.B. "Bestseller".
...
====
Die obige Anleitung erklärt, wie du Artikel manuell zu einer Shop-Aktion hinzufügst. Du könntest aber auch die Gruppenfunktion verwenden, um <<artikel/import-export-anlage/anlage/massenbearbeitung#100, mehrere Artikel gleichzeitig hinzuzufügen>>. Oder du könntest den Aktionsmanager verwenden, um <<artikel/webshop/shop-aktionen#400, Artikel automatisch zur Aktion hinzuzufügen>>, z.B. wenn der Preis fällt.
====
