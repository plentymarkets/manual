...
* <<artikel/artikel-verwalten#268, Verknüpfe deine Varianten mit den Tags>>. Versehe zum Beispiel alle deine meistverkauften Artikel mit dem "Bestseller"-Tag.
//musste den dritten Punkt stattdessen hierhin verlinken?
