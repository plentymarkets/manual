...
////
//Dienst ist möglicherweise nur für Callisto relevant, da Link zum Callisto-Kapitel führt
//Dienst gibt es nicht als Plugin in plentyMarketplace
//nachdem Callisto aus dem Handbuch raus fliegt, prüfe ob diesen Deinst noch erwähnt wird
[TIP]
...
. Veröffentliche die Cross-Selling-Liste in deinem <<artikel/webshop/cross-selling#700, Ceres Webshop>>.
...
////
//erster Absatz kann ganz weg
//zweiter Absatz (dynamisches Cross-Selling) soll irgendwann mit Ceres funktionieren
...
Mit Hilfe von _ShopBuilder_ und sogenannten _Artikellisten_ kannst du Cross-Selling-Artikel im Ceres Webshop darstellen.
