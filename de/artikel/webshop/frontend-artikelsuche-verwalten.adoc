...
====
Es ist möglich, die Frontend-Artikelsuche für deinen link:https://marketplace.plentymarkets.com/plugins/sales/online-shops/ceres_4697[Ceres 5] Webshop anzupassen.
