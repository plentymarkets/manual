...
image::artikel/webshop/assets/suchergebnisse.jpeg[]
...
[TIP]
.Teilbegriffe liefern auch Ergebnisse!
====
Es ist nicht weiter schlimm, wenn dein Kunde nur Teil eines Wortes eingibt.
Die Suchfunktion liefert Ergebnisse für Präfixe, Suffixe und Teilbegriffe.
