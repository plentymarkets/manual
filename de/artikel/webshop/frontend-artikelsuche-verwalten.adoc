...
Passe die Frontend-Artikelsuche individuell an und helfe deinen Kunden, ihre gewünschten Produkte leichter zu finden.

Diese Seite bietet Informationen über zwei verschiedene Sucharten: die <<#50, Suchleiste>> und die <<#80, Facettensuche>>.

[#50]
== Suchleiste

Passe die Frontend-Suchleiste individuell an deine Bedürfnisse an!
Du kannst entscheiden, wie die Suchleiste in deinem Webshop aussehen soll und welche Ergebnisse sie liefern soll.
Du kannst z.B. entscheiden:

* welche <<#60, Art von Suchergebnissen>> deine Kunden sehen sollen.
** Artikel, die dem Suchbegriff entsprechen.
** Kategorien, die dem Suchbegriff entsprechen.
* ob Kunden eine Liste von <<#60, vorgeschlagenen Suchbegriffen>> erhalten sollen, wenn sie ungenaue oder falsch geschriebene Texte eingeben. "Meinten Sie..."?
...
[TIP]
.Teilbegriffe können auch verwendet werden!
====
...
[#60]
=== Suchfeld mit Widgets zusammenstellen

//once Franz has given you the URL replace the link for drei Widgets

Mit Hilfe von <<webshop#, drei Widgets>> kannst du dein Suchfeld individuell im ShopBuilder zusammenstellen.
Die Widgets enthalten zusätzliche Einstellungen, die du konfigurieren kannst, um z.B. Suchbegriffe hervorzuheben oder den gesamten Kategoriepfad anzuzeigen.
...
Zunächst werden <<#100, Facetten erstellt>>, anschließend durch <<#110, weitere Einstellungen>> näher bestimmt und schließlich <<#140, mit den gewünschten Werten verknüpft>>.
Außerdem musst du einige Einstellungen speziell für deinen <<#300, Ceres>> oder <<#210, Callisto>> Webshop konfigurieren.
...
. Wähle einen *Typ* aus der Dropdown-Liste. Beachte die Erläuterungen in <<table-available-facet-types>>.
...
| *Verfügbarkeit*
|Facetten des Typs *Verfügbarkeit*, zum Beispiel "Kurzfristig lieferbar", werden mit den im Menü *Einrichtung » Artikel » Verfügbarkeit* erstellten <<artikel/einstellungen/verfuegbarkeiten#, Verfügbarkeiten>> verknüpft.

| *Hersteller*
|Facetten des Typs *Hersteller*, zum Beispiel "Adidas", werden mit den im Menü *Einrichtung » Artikel » Hersteller* erstellten <<artikel/einstellungen/hersteller#, Herstellern>> verknüpft.
|====
