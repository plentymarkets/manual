...
[WARNING]
.Artikelsuche wird derzeit noch entwickelt
====
Erst ab link:https://marketplace.plentymarkets.com/plugins/sales/online-shops/ceres_4697[Ceres 5] wird es möglich sein, die Frontend-Artikelsuche wie in diesem Kapitel beschrieben anzupassen.
====

[TIP]
.Teilbegriffe können auch verwendet werden!
====
Es ist nicht weiter schlimm, wenn dein Kunde nur Teil eines Wortes eingibt.
Die Suchvorschläge liefern Ergebnisse für Präfixe, Suffixe und Teilbegriffe.
Beispielsweise schlägt die Suche "Sessel" vor, auch wenn dein Kunde "Sesse" oder "ssel" eingibt.
====
...
|*Verfügbarkeit*
|Facetten des Typs *Verfügbarkeit*, zum Beispiel "Kurzfristig lieferbar", werden mit den im Menü *Einrichtung » Artikel » Verfügbarkeit* erstellten <<artikel/artikel-verwalten#180, Verfügbarkeiten>> verknüpft.
