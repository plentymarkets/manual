...
Die Frontend-Artikelsuche ermöglicht es Kunden, dein Produktsortiment im Webshop zu durchsuchen.
...
* welche <<Art von Suchergebnissen>> deine Kunden sehen sollen.
** Artikel, die dem Suchbegriff entsprechen.
** Kategorien, die dem Suchbegriff entsprechen.
* ob Kunden eine Liste von <<vorgeschlagenen Suchbegriffen>> erhalten sollen, wenn sie ungenaue oder falsch geschriebene Texte eingeben. "Meinten Sie..."?
...
Mit Hilfe von <<drei Widgets>> kannst du dein Suchfeld individuell im ShopBuilder zusammenstellen.
...
Bei Ceres-Webshops ist die sogenannte "Facettensuche" standardmäßig für die Artikelsuche eingestellt.
Im älteren Callisto-Webshops wird die Facettensuche im Menü *Einrichtung » Mandant » Mandant wählen » Webshop » Artikelsuche* aktiviert.
