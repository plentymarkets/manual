...
Passe die Frontend-Artikelsuche an und unterstütze deine Webshop-Besucher dabei, ihre gewünschten Produkte schneller zu finden.
...
//fix this sentence, then add it to each tab
...
. *_Optional_*: Verknüpfe weitere Werte.
. *Speichere* die Einstellungen.

//eher hier, oder wo gehört das hin?
[TIP]
