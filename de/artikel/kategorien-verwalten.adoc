...
. Nehmen Sie die Einstellungen vor. Beachten Sie Tabelle 3. +
...
|**Canonical**
|Ggf. die URL einer Kategorie eingeben, die den gleichen Inhalt enthält, um **<<omni-channel/online-shop/cms-syntax#110, Duplicate Content>>** zu verhindern.
...
Über die Dropdown-Liste rechts über dem Eingabefeld wählen Sie den Editor, mit dem Sie die Beschreibung bearbeiten möchten. Zur Verfügung stehen der **<<omni-channel/online-shop/cms#webdesign-werkzeuge-editor, Editor>>**, der HTML-Editor **Textfeld** und der <<omni-channel/online-shop/cms#webdesign-werkzeuge-syntax-editor, **Syntax-Editor**>>. Für den Typ **Container** stehen nur der HTML-Editor **Textfeld** und der **Syntax-Editor** zur Verfügung.
...
Das Menü **System » Mandant (Shop) » Standard » Kategorien » Aktivieren** bietet Ihnen die Möglichkeit, mehrere oder alle Kategorien eines Mandanten gleichzeitig zu aktivieren oder zu deaktivieren.

[.instruction]
Mehrere Kategorien für Mandanten gleichzeitig aktivieren:

. Öffnen Sie das Menü **System » Mandant (Shop) » Standard » Kategorien » Aktivieren**.
...
Im Menü **System » Mandant (Shop) » Standard » Kategorien » Rabatte** hinterlegen Sie Mengenrabatte für einzelne Artikelkategorien. Pro Kategorie sind bis zu drei Mengenrabatte möglich. Die gespeicherten Rabatte werden automatisch angewendet, wenn Kunden die rabattfähige Menge an Artikeln aus einer Kategorie erreichen oder überschreiten. Die eingegebenen Rabatte gelten jedoch nur für die Standardkategorie eines Artikels.

[.instruction]
Kategorierabatte speichern:

. Öffnen Sie das Menü **System » Mandant (Shop) » Standard » Kategorien » Rabatte**.
. Nehmen Sie die Einstellungen vor. Beachten Sie Tabelle 4.
. **Speichern** Sie die Einstellungen. +
→ Der Rabatt wird automatisch im Webshop angewendet, wenn Kunden die rabattfähige Artikelmenge bestellen. +
**__Hinweis:__** Die Rabatte gelten nur für die Standardkategorie eines Artikels.
...
**Rabatt 2 (%)**; +
**Rabatt 3 (%)**
|Rabatt in Prozent eingeben, der angewendet werden soll, wenn die eingegebene Menge an Artikeln erreicht wird.

|**ab Menge**
|Menge der Artikel eingeben, die Kunden aus dieser Kategorie bestellen müssen, damit der Rabatt angewendet wird.
|====
