...
|**Volltextsuche**
|Wählen, ob die Kategorie zum Suchindex der Kategoriesuche im Webshop hinzugefügt werden soll. Die Kategoriesuche wird in der Facettensuche im Menü *System » Mandant » Mandant öffnen » Dienste » Facettensuche » Tab: Volltext* über die Option *Kategorie* aktiviert. +
**Ja** = Die Kategoriedaten werden zum Suchindex der Kategoriesuche im Webshop hinzugefügt. Wenn Kunden im Webshop einen Suchbegriff eingeben, werden der Kategoriename, Beschreibung 1, Beschreibung 2 und der Meta-Titel der Kategorie nach diesem Suchbegriff durchsucht. +
**Nein** = Die Kategorie wird nicht zum Suchindex der Kategoriesuche hinzugefügt. +
*_Hinweis:_* FINDOLOGIC berücksichtigt diese Einstellung nicht.
