...
Das Menü **System » Mandant » Mandant öffnen » Kategorien » Aktivieren** bietet Ihnen die Möglichkeit, mehrere oder alle Kategorien eines Mandanten gleichzeitig zu aktivieren oder zu deaktivieren.

[.instruction]
Mehrere Kategorien für Mandanten gleichzeitig aktivieren:

. Öffnen Sie das Menü **System » Mandant » Mandant öffnen » Kategorien » Aktivieren**.
...
Im Menü **System » Mandant » Mandant öffnen » Kategorien » Rabatte** hinterlegen Sie Mengenrabatte für einzelne Artikelkategorien. Pro Kategorie sind bis zu drei Mengenrabatte möglich. Die gespeicherten Rabatte werden automatisch angewendet, wenn Kunden die rabattfähige Menge an Produkten aus einer Kategorie erreichen oder überschreiten. Die eingegebenen Rabatte gelten jedoch nur für die Standardkategorie einer Variante.

[.instruction]
Kategorierabatte speichern:

. Öffnen Sie das Menü **System » Mandant » Mandant öffnen » Kategorien » Rabatte**.
