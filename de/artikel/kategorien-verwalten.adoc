...
**Ja** = Die Kategoriedaten werden zum Suchindex der Kategoriesuche im Webshop hinzugefügt. Bei einer Kategoriesuche werden die folgenden Daten der Kategorie durchsucht: Kategoriename, Beschreibung 1 und 2 und Meta-Titel. +
