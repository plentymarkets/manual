...
|**Volltextsuche**
|Wählen, ob die Kategorie zum Suchindex hinzugefügt werden soll. +
**Ja** = Die Kategorie zum Suchindex hinzugefügt. +
**Nein** = Die Kategorie wird nicht zum Suchindex hinzugefügt. +
*_Hinweis:_* Diese Einstellung wird nur bei der plentymarkets internen Suche berücksichtigt. FINDOLOGIC berücksichtigt diese Einstellung nicht.
