...
. Die Variante muss verfügbar sein, d.h., der Warenbestand muss positiv sein und für die Variante muss im Tab **Verfügbarkeit** die Option **Webshop** auf **Sichtbar** gestellt sein.
...
. Passen Sie ggf. die Position der Kategorie an, um die Kategorie korrekt einzuordnen.
