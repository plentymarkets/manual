...
|**Meta-Beschreibung**
|Eine Meta-Beschreibung eingeben (max. 350 Zeichen). Die Meta-Beschreibung wird von Suchmaschinen ausgewertet und ist daher besonders für die Startseite wichtig. +
__**SEO-Tipp:**__ Die Meta-Beschreibung soll den wesentlichen Inhalt in einem Satz enthalten.
