...
|**Volltextsuche**
|Wählen, ob die Kategorie zum Suchindex der Kategoriesuche im Webshop hinzugefügt werden soll. Die Kategoriesuche wird im Menü *System » Mandant » Mandant öffnen » Dienste » Facettensuche » Tab: Volltext* über die *Kategorie* aktiviert. +
