...
. Wähle die gewünschten Einstellungen im Bereich *Paket* aus. Beachte dazu die Erläuterungen in <<tabelle-gewicht-ek-berechnen>>.
. *Speichere* die Einstellungen.
