...
Diese Artikelbeschreibung wird an Flubit übertragen. Die Artikelbeschreibung muss auf **<<omni-channel/online-shop/mandanten-einrichten/mehrsprachiger-webshop#, Englisch >>** eingetragen sein, andernfalls wir der Artikel nicht exportiert.
...
* Artikelbeschreibung ist auf **<<omni-channel/online-shop/mandanten-einrichten/mehrsprachiger-webshop#, Englisch >>** eingegeben
...
Richten Sie eine **<<basics/automatisierung/ereignisaktionen#, Ereignisaktion  >>** ein, um Flubit automatisch über Stornierungen zu informieren. Bei Stornierungen muss ein Grund für die Stornierung an Flubit übertragen werden. Erstellen Sie im Menü **<<auftragsabwicklung/auftraege/auftraege-verwalten#, Einstellungen » Aufträge » Auftragsstatus  >>** ggf. zusätzliche Auftragsstatus. Folgende Stornierungsgründe können an Flubit übertragen werden:
