...
**link:https://www.flubit.com/About[Flubit^]** ist ein auf das Vereinigte Königreich beschränkter Online-Marktplatz, der keine Provision vom Händler verlangt.

[#100]
== Bei Flubit registrieren

Registrieren Sie sich zunächst als Verkäufer bei **link:https://www.weflubit.com/start-selling[WeFlubit^]**, der zentralen Flubit-Anlaufstelle für Verkäufer.
