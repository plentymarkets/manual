...
**link:https://www.flubit.com/About[Flubit, window="_blank"]** ist ein auf das Vereinigte Königreich beschränkter Online-Marktplatz, der keine Provision vom Händler verlangt.

[#100]
== Bei Flubit registrieren

Registrieren Sie sich zunächst als Verkäufer bei **link:https://www.weflubit.com/start-selling[WeFlubit, window="_blank"]**, der zentralen Flubit-Anlaufstelle für Verkäufer.
...
. Öffnen Sie das Menü **Einstellungen » Märkte » Flubit » Grundeinstellungen**.
...
Diese Artikelbeschreibung wird an Flubit übertragen. Die Artikelbeschreibung muss auf **<<omni-channel/online-shop/mandanten-einrichten/_multilingualismus#40, Englisch >>** eingetragen sein, andernfalls wir der Artikel nicht exportiert.
...
Damit Sie Artikel, Merkmale etc. mit Flubit verknüpfen können, muss im Menü **Einstellungen » Aufträge » Auftragsherkunft** die Auftragsherkunft Flubit aktiviert werden.
...
* Artikelbeschreibung ist auf **<<omni-channel/online-shop/mandanten-einrichten/_multilingualismus#40, Englisch >>** eingegeben
...
Richten Sie eine **<<auftragsabwicklung/auftraege/einstellungen/ereignisaktionen#, Ereignisaktion  >>** ein, um Versandbestätigungen automatisch an Flubit zu senden, nachdem ein Warenausgang gebucht wurde.
...
Richten Sie eine **<<auftragsabwicklung/auftraege/einstellungen/ereignisaktionen#, Ereignisaktion  >>** ein, um Flubit automatisch über Stornierungen zu informieren. Bei Stornierungen muss ein Grund für die Stornierung an Flubit übertragen werden. Erstellen Sie im Menü **<<auftragsabwicklung/auftraege/einstellungen/auftragsstatus#, Einstellungen » Aufträge » Auftragsstatus  >>** ggf. zusätzliche Auftragsstatus. Folgende Stornierungsgründe können an Flubit übertragen werden:
...
Richten Sie eine **<<auftragsabwicklung/auftraege/einstellungen/ereignisaktionen#, Ereignisaktion  >>** ein, um Flubit automatisch über Retouren zu informieren.
...
Im Menü **<<basics/datenaustausch/api-log#, Datenaustausch » API-Log  >>** im Tab **Flubit** finden Sie eine Historie über Vorgänge, die über die Flubit-Schnittstelle ausgeführt wurden. Folgende Formate stehen Ihnen für Flubit zur Auswahl:
