...
Aktivieren Sie die <<auftragsabwicklung/payment/zahlungsarten-verwalten#, Zahlungsart>> *Flubit*, wie im Folgenden beschrieben.
...
Richten Sie eine <<basics/automatisierung/ereignisaktionen#, Ereignisaktion>> ein, um Versandbestätigungen automatisch an Flubit zu senden, nachdem ein Warenausgang gebucht wurde.
...
Richten Sie eine <<basics/automatisierung/ereignisaktionen#, Ereignisaktion>> ein, um Flubit automatisch über Stornierungen zu informieren. Bei Stornierungen muss ein Grund für die Stornierung an Flubit übertragen werden. Erstellen Sie im Menü <<auftragsabwicklung/auftraege/auftraege-verwalten#, System » Aufträge » Auftragsstatus>> ggf. zusätzliche Auftragsstatus. Folgende Stornierungsgründe können an Flubit übertragen werden:
...
Richten Sie eine <<basics/automatisierung/ereignisaktionen#, Ereignisaktion>> ein, um Flubit automatisch über Retouren zu informieren.
