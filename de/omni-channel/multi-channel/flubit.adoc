...
Richten Sie eine **<<basics/automatisierung/ereignisaktionen#, Ereignisaktion  >>** ein, um Flubit automatisch über Stornierungen zu informieren. Bei Stornierungen muss ein Grund für die Stornierung an Flubit übertragen werden. Erstellen Sie im Menü **<<auftragsabwicklung/auftraege/auftragsstatus#, Einstellungen » Aufträge » Auftragsstatus  >>** ggf. zusätzliche Auftragsstatus. Folgende Stornierungsgründe können an Flubit übertragen werden:
