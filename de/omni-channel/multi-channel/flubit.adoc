...
Diese Artikelbeschreibung wird an Flubit übertragen. Die Artikelbeschreibung muss auf **<<omni-channel/online-shop/standard/webshop/multilingualismus#40, Englisch >>** eingetragen sein, andernfalls wir der Artikel nicht exportiert.
...
* Artikelbeschreibung ist auf **<<omni-channel/online-shop/standard/webshop/multilingualismus#40, Englisch >>** eingegeben
...
Richten Sie eine **<<auftragsabwicklung/auftraege/einstellungen/ereignis-aktionen#, Ereignisaktion  >>** ein, um Versandbestätigungen automatisch an Flubit zu senden, nachdem ein Warenausgang gebucht wurde.
...
Richten Sie eine **<<auftragsabwicklung/auftraege/einstellungen/ereignis-aktionen#, Ereignisaktion  >>** ein, um Flubit automatisch über Retouren zu informieren.
