...
. Öffnen Sie das Menü *System » Märkte » Fruugo » Einstellungen*.
...
Damit Sie Artikel, Merkmale etc. mit Fruggo verknüpfen können, muss im Menü *System » Aufträge » Auftragsherkunft* die Auftragsherkunft Fruggo aktiviert werden.
...
Aktivieren Sie die <<auftragsabwicklung/payment/zahlungsarten-verwalten#, Zahlungsart>> *Fruugo* wie im Folgenden beschrieben.
...
Richten Sie eine <<basics/automatisierung/ereignisaktionen#, Ereignisaktion>> ein, um nach Eingang eines Auftrags automatisch eine Auftragsbestätigung an Fruugo zu senden.
...
Richten Sie eine <<basics/automatisierung/ereignisaktionen#, Ereignisaktion>> ein, um automatisch eine Versandbestätigung an Fruugo zu senden, nachdem ein Warenausgang gebucht wurde.
...
Richten Sie eine <<basics/automatisierung/ereignisaktionen#, Ereignisaktion>> ein, um Fruugo automatisch über Stornierungen zu informieren.
...
Richten Sie eine <<basics/automatisierung/ereignisaktionen#, Ereignisaktion>> ein, um Fruugo automatisch über Retouren zu informieren.
