...
[TIP]
.Zahlungshinweis im Dokument <<omni-channel/online-shop/standard/dokumente/rechnung#, Rechnung  >> für die Zahlungsart Rakuten Rechnung
====
...
Richten Sie eine **<<auftragsabwicklung/auftraege/einstellungen/ereignis-aktionen#, Ereignisaktion  >>** ein, um Versandbestätigungen automatisch an Rakuten zu senden, nachdem ein Warenausgang gebucht wurde.
...
Richten Sie eine **<<auftragsabwicklung/auftraege/einstellungen/ereignis-aktionen#, Ereignisaktion  >>** ein, um Retouren automatisch an Rakuten zu senden.
...
Richten Sie eine **<<auftragsabwicklung/auftraege/einstellungen/ereignis-aktionen#, Ereignisaktion  >>** ein, um Stornierungen automatisch an Rakuten zu senden.
