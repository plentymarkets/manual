...
Im Menü **Daten » API-Log » Tab: API-Log** finden Sie eine Historie über Vorgänge, die über die Rakuten-Schnittstelle ausgeführt wurden. Das Format **Rakuten** steht Ihnen für Rakuten zur Verfügung.
