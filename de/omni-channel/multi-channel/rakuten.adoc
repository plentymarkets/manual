...
plentymarkets bietet Ihnen die Möglichkeit, Ihre Artikel auf den Plattformen Rakuten.de zu verkaufen.

[#100]
== Bei Rakuten registrieren

Bevor Sie Rakuten in plentymarkets einrichten, müssen Sie sich bei Rakuten registrieren. Die Registrierungsformulare finden Sie unter link:http://leadgen.rakuten.de/form?leadsource=marketplace_header[**rakuten.de**, window="_blank"].
...
. Öffnen Sie das Menü **Einstellungen » Märkte » Rakuten » Grundeinstellungen**. +
...
**Aktivieren** = Auftragsbestätigung an den Kunden übermitteln. Die unter **Einstellungen » Mandant (Shop) » Standard » E-Mail » Automatischer Versand** eingetragene E-Mail-Vorlage wird an den Kunden versendet.
...
Damit Sie Artikel, Merkmale etc. mit Rakuten verknüpfen können, muss im Menü **Einstellungen » Aufträge » Auftragsherkunft** die Auftragsherkunft Rakuten aktiviert werden.
...
Artikel, die Sie auf Rakuten.de verkaufen möchten, müssen im Menü <<artikel/artikel-verwalten#, **Artikel » Artikel bearbeiten » Artikel öffnen » Tab: Varianten-ID**  >> im Tab **Verfügbarkeit** aktiviert werden.
...
. Wählen Sie aus dem Dropdown-Menü **Rakuten.de** im Bereich **Kategorieverknüpfung** die Hauptkategorie für den Artikel. +
...
. Tragen Sie unter **Backendname** einen Namen für das Merkmal ein.
. Wählen Sie aus dem Dropdown-Menü im Feld **Merkmaltyp** die Option **Kein**.
. Wählen Sie aus dem Dropdown-Menü im Feld **Rakuten.de-Merkmal** das Rakuten-Merkmal.
. **Speichern** Sie die Einstellungen.

Die Merkmale verknüpfen Sie im Tab <<artikel/artikel-verwalten#480, **Merkmale** >> eines Artikels.

Das Energieetikett wird im Tab <<artikel/artikel-verwalten#660, **Bilder** >> des Artikels gespeichert. Gehen Sie dazu wie im Folgenden beschrieben vor.

[.instruction]
Energieetikett im Tab Bilder speichern:

. Öffnen Sie das Menü **Artikel » Artikel bearbeiten**.
. Laden Sie das Bild des Energieetiketts im Tab **Bilder** des Artikels hoch.
. Weisen Sie dem Bild des Energieetiketts die Positionsnummer zu, die Sie für Energieetiketten verwenden.
. Öffnen Sie das Menü **Einstellungen » Märkte » Rakuten » Grundeinstellungen**.
. Wechseln Sie in das Tab **Neues Konto**.
. Klappen Sie das Untermenü **Rakuten-Artikel-Export** auf.
. Tragen bei der Option **Bildposition für das Energieetikett** die Positionsnummer des Bildes gemäß Tabelle 2 ein.
. **Speichern** Sie die Einstellungen.

Das Produktdatenblatt stellen Sie für Rakuten in elektrischer Form über einen Link in der Artikelbeschreibung zur Verfügung. Fügen Sie den Link zum Produktdatenblatt im Tab <<artikel/artikel-verwalten#, **Texte**  >> eines Artikels ein. Gehen Sie wie im Folgenden beschrieben vor.
...
|**Format**
|Format **RakutenDE** aus dem Dropdown-Menü wählen.
...
2+|Formatinstellungen

|**Auftragsherkunft**
|**Rakuten.de** wählen.

|**Marktplatzkonto**
|Beim Erstexport von Artikeldaten wird das hier gewählte Konto für die Generieirung der SKU berücksichtigt.
|====
...
Sie finden die Werte für Lieferzeiten auch in der link:http://doku.rakuten.de/doku.php/neuer_import/start[**Schnittstellendokumentation**, window="_blank"] von Rakuten.

[#1400]
== Verkaufspreis festlegen

Gehen Sie wie im Folgenden beschrieben vor, um für die Auftragsherkunft Rakuten.de bzw. Rakuten.co.uk einen Verkaufspreis festzulegen. Dieser Preis wird auf Rakuten.de bzw. Rakuten.co.uk angezeigt.
...
. Setzen Sie ein Häkchen bei der Herkunft **Rakuten.de** bzw. **Rakuten.co.uk**.
. **Speichern** Sie die Einstellungen.
...
Damit Zahlungen für Aufträge von Rakuten durchgeführt und in Ihrem plentymarkets System angezeigt werden, aktivieren Sie die Zahlungsarten **Rakuten Payment**, **Rakuten Rechnung** und **Klarna**. Dabei ist **Rakuten Rechnung** nur für die Plattform Rakuten.de notwendig. Wenn Sie nur die Plattform Rakuten.co.uk nutzen, genügt es, **Rakuten Payment** zu aktivieren.
...
[TIP]
.Zahlungshinweis im Dokument <<omni-channel/online-shop/mandanten-einrichten/dokumente/rechnung#, Rechnung  >> für die Zahlungsart Rakuten Rechnung
====
...
Richten Sie eine **<<auftragsabwicklung/auftraege/einstellungen/ereignisaktionen#, Ereignisaktion  >>** ein, um Versandbestätigungen automatisch an Rakuten zu senden, nachdem ein Warenausgang gebucht wurde.
...
Richten Sie eine **<<auftragsabwicklung/auftraege/einstellungen/ereignisaktionen#, Ereignisaktion  >>** ein, um Retouren automatisch an Rakuten zu senden.
...
Richten Sie eine **<<auftragsabwicklung/auftraege/einstellungen/ereignisaktionen#, Ereignisaktion  >>** ein, um Stornierungen automatisch an Rakuten zu senden.
...
→ Das Fenster **Neue Ereignisaktion erstellen** wird geöffnet.
.  Tragen Sie einen Namen ein.
.  Wählen Sie das **Ereignis** gemäß Tabelle 9.
. **Speichern** Sie die Einstellungen.
...
Im Menü **Datenaustausch » API-Log » Tab: API-Log** finden Sie eine Historie über Vorgänge, die über die Rakuten-Schnittstelle ausgeführt wurden. Das Format **Rakuten** steht Ihnen für Rakuten zur Verfügung.

[.instruction]
API-Log abrufen:

.  Öffnen Sie das Menü **Datenaustausch » API-Log**.
.  Wählen Sie das Format **Rakuten** aus dem Dropdown-Menü **Vorgang**.
...
[.indented]
Wenn bei Rakuten.de der automatische CSV-Import eingerichtet ist, werden die neuen Warenbestände durch den erneuten Import der CSV-Datei abgeglichen. Wie oft der Abgleich erfolgt, stellen Sie im Backend bei Rakuten.de ein.[.instruction]
Wie wird der Warenbestand in plentymarkets mit Rakuten.co.uk abgeglichen?

[.indented]
Der Abgleich der Bestände erfolgt stündlich über die API-Anbindung.
