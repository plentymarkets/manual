...
**Aktivieren** = Auftragsbestätigung an den Kunden übermitteln. Die unter **System » Mandant » Mandant öffnen » E-Mail » Automatischer Versand** eingetragene E-Mail-Vorlage wird an den Kunden versendet.
