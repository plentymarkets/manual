...
Folgende Prozesse werden durch das link:https://marketplace.plentymarkets.com/plugins/markets/ElasticExportRakutenDE_4721[*Elastic Export Rakuten.de-Plugin*^] abgebildet:

* stündlicher Bestandsabgleich
* stündlicher Preisabgleich

Mit dem *Elastic Export Rakuten.de-Plugin* können Sie das Datenformat für den elastischen Export nutzen. Das Plugin ist im link:https://marketplace.plentymarkets.com/plugins/markets[*plentyMarketplace*^] erhältlich. Informationen zur Einrichtung des Plugins finden Sie im User Guide des Plugins.
