...
Außerdem können Sie mit dem *Elastic Export Rakuten.de-Plugin* das Datenformat für den elastischen Export nutzen. Das Plugin ist im link:https://marketplace.plentymarkets.com/plugins/markets[*plentyMarketplace*^] erhältlich. Informationen zur Einrichtung des Plugins finden Sie im User Guide des Plugins.
...
==== Präfix und Suffix zu SKU hinzufügen
