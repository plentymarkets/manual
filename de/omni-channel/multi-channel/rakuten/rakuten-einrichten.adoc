...
Richten Sie eine <<basics/automatisierung/ereignisaktionen#, Ereignisaktion>> ein, um Versandbestätigungen automatisch an Rakuten zu senden, nachdem ein Warenausgang gebucht wurde.
...
Richten Sie eine <<basics/automatisierung/ereignisaktionen#, Ereignisaktion>> ein, um Retouren automatisch an Rakuten zu senden.
...
Richten Sie eine <<basics/automatisierung/ereignisaktionen#, Ereignisaktion>> ein, um Stornierungen automatisch an Rakuten zu senden.
