...
Mit dem *ElasticExportRakutenDE-Plugin* können Sie das Datenformat für den elastischen Export nutzen. Das Plugin ist im link:https://marketplace.plentymarkets.com/plugins/markets[*plentyMarketplace*^] erhältlich. Informationen zur Einrichtung des Plugins finden Sie im User Guide des Plugins.
