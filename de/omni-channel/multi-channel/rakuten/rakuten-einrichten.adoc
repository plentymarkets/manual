...
Mit dem *ElasticExportRakutenDE-Plugin* können Sie das Datenformat für den elastischen Export nutzen. Das Plugin ist im link:https://marketplace.plentymarkets.com/plugins/markets[plentyMarketplace^] erhältlich. Weitere Informationen zur Einrichtung des Plugins finden Sie im User Guide des Plugins.
...
====
Bitte beachten Sie, dass Präfix und Suffix nur zu den Parent-SKUs hinzugefügt werden, die neu für Rakuten.de generiert werden, nachdem diese Einstellung vorgenommen wurde. Bereits bestehende Parent-SKUs für Rakuten.de werden nicht berücksichtigt. Fügen Sie die Präfixe und Suffixe manuell für diese SKUs hinzu, wenn gewünscht.
====

[#800]
=== Preisabgleich einrichten

In diesem Kapitel erfahren Sie, wie Sie den Preisabgleich für Rakuten aktivieren. Der Preisagbleich für Rakuten.de erfolgt über den elastischen Export mit dem Datenformat RakutenDE. Dafür müssen zuvor die Plugins *ElasticExport* und *ElasticExportRakutenDE* installiert worden sein. +
...
In diesem Kapitel erfahren Sie, wie Sie den Bestandsabgleich für Rakuten aktivieren. Der Bestandsabgleich für Rakuten erfolgt über den elastischen Export mit dem Datenformat RakutenDE. Dafür müssen zuvor die Plugins *ElasticExport* und *ElasticExportRakutenDE* installiert worden sein. +
...
Weitere Informationen finden Sie auf der Handbuchseite *<<basics/statistik#, Statistik>>*. Ein Beispiel für pauschale und prozentuale Kosten finden Sie auf der Handbuchseite *<<auftragsabwicklung/payment/zahlungsarten-verwalten#20, Zahlungsarten verwalten>>*.
|====
