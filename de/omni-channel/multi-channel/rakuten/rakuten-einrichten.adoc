...
Wenn Sie das link:https://marketplace.plentymarkets.com/plugins/markets/ElasticExportRakutenDE_4721[Rakuten-Plugin^] in Ihrem plentymarkets System installiert haben, haben Sie die Möglichkeit, Parent-SKUs um Präfixe und Suffixe zu erweitern. Dadurch vermeiden Sie, dass die Parent-SKU und die zugehörigen Child-SKUs identisch sind und deshalb bei Rakuten als der gleiche Artikel angegeben werden.
