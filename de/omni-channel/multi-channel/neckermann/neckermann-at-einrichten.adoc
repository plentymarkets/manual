...
|Ziffer der Bildposition des Artikelbildes eingeben, wenn das Energieetikett als Artikelbild und nicht als Merkmal gespeichert wurde. Weitere Informationen zum Energieetikett finden Sie im Kapitel <<omni-channel/multi-channel/neckermann/neckermann-at-einrichten#150, **Energieeffizienz angeben**>>.
...
Wenn Sie <<artikel/artikel-verwalten#390, **Attribute**>> im plentymarkets System erstellt haben, müssen diese Attribute mit Neckermann verknüpft werden. Dazu müssen Sie zunächst die <<omni-channel/multi-channel/neckermann/neckermann-at-einrichten#500, **Neckermann-Komponenten**>> importieren. Nachfolgend wird beschrieben, wie Sie das Attribut Farbe mit Neckermann verknüpfen. Verknüpfen Sie andere Attribute analog.
