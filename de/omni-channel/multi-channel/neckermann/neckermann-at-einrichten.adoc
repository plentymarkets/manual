...
// Richten Sie Neckermann.at Cross-Docking analog dazu ein.
...
Neckermann stellt verschiedene Logos, z. B. für Eigenschaften oder Qualitätsmerkmale zur Verfügung. Logos werden durch Hochladen einer CSV-Datei importiert, die Daten von Neckermann enthält. Logos verknüpfen Sie analog zur Verknüpfung von Neckermann-Komponenten.
...
Wenn Sie <<artikel/artikel-verwalten#390, Attribute>> im plentymarkets System erstellt haben, müssen diese Attribute mit Neckermann verknüpft werden. Dazu müssen Sie zunächst die <<Komponenten importieren, Neckermann-Komponenten>> importieren. Nachfolgend wird beschrieben, wie Sie das Attribut Farbe mit Neckermann verknüpfen. Verknüpfen Sie andere Attribute analog.
