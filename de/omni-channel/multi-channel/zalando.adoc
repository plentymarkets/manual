...
Artikel, die Sie auf Zalando verkaufen möchten, müssen im Menü <<artikel/artikel-verwalten#170, Artikel » Artikel bearbeiten » Artikel öffnen » Tab: Varianten-ID>> im Tab *Verfügbarkeit* aktiviert werden.
...
Weitere Informationen finden Sie auf der Handbuchseite <<basics/statistik#, Statistik>>. Ein Beispiel für pauschale und prozentuale Kosten finden Sie im Kapitel <<auftragsabwicklung/payment/zahlungsarten-verwalten#20, Zahlungsart einrichten>>.
|====
...
Im Menü *Daten » API-Log » Tab: API-Log* finden Sie eine Historie über Vorgänge, die über die Zalando-Schnittstelle ausgeführt wurden. Das Format *ZalandoController* steht Ihnen für Zalando zur Verfügung.
