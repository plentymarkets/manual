...
// Die Einrichtung von Neckermann.at Cross-Docking erfolgt analog.
...
|Ziffer der Bildposition des Artikelbildes eingeben, wenn das Energieetikett als Artikelbild und nicht als Merkmal gespeichert wurde. Weitere Informationen zum Energieetikett finden Sie im Kapitel <<omni-channel/multi-channel/neckermann-at/neckermann-at-einrichten#150, **Energieeffizienz angeben**>>.

////
<tr>
<td><b>Cross-Selling übertragen</b></td>
<td><strong>Nein</strong> = Cross-Selling-Einstellungen werden standardmäßig nicht übertragen.<br /><strong>Ja</strong> = Cross-Selling-Einstellungen werden übertragen.</td>
</tr>
////
...
**Beispiel**: Für einen Artikel mit einem Bestand von 50 und einem Bestandspuffer von 10 wird der Bestandswert 40 übertragen. Weitere Informationen finden Sie auf der Handbuchseite **<<warenwirtschaft/warenbestaende-verwalten#, Bestand>>**.
...
|**Ja** = In der Grundeinstellung kommen die Aufträge als **nicht bezahlt** im System an, da die Zahlungsabwicklung zu einem späteren Zeitpunkt erfolgt. +
...
Damit Sie Artikel, Merkmale etc. mit Neckermann.at verknüpfen können, muss im Menü **System » Aufträge » Auftragsherkunft** die Auftragsherkunft Neckermann.at aktiviert werden.

[.instruction]
Auftragsherkunft für Neckermann.at aktivieren:

. Öffnen Sie das Menü **System » Aufträge » Auftragsherkunft**.
. Setzen Sie bei **Neckermann.at** ein Häkchen.
. **Speichern** Sie die Einstellungen.
...
. Wählen Sie aus dem Dropdown-Menü im Feld **Neckermann.at EP Komponente** die Neckermann-Komponente.
. **Speichern** Sie die Einstellungen.
...
Wenn Sie <<artikel/artikel-verwalten#390, **Attribute**>> im plentymarkets System erstellt haben, müssen diese Attribute mit Neckermann verknüpft werden. Dazu müssen Sie zunächst die <<omni-channel/multi-channel/neckermann-at/neckermann-at-einrichten#500, **Neckermann-Komponenten**>> importieren. Nachfolgend wird beschrieben, wie Sie das Attribut Farbe mit Neckermann verknüpfen. Verknüpfen Sie andere Attribute analog.
...
. Wählen Sie im Dropdown-Menü **Marktplatz** die Option **Neckermann.at Enterprise**. +
→ Ein zusätzliches Dropdown-Menü **Neckermann.at Enterprise** wird angezeigt.
. Wählen Sie im Dropdown-Menü **Neckermann.at Enterprise** das Attribut **Farbe**.
...
//  und/oder Neckermann.at Cross-Docking
.
...
. Wählen Sie ein **Enterprise-Privisionsmodell**.
. Wählen Sie einen **Enterprise-Produkttyp**.
. **Speichern** Sie die Einstellungen.
...
Die Merkmale verknüpfen Sie im Tab <<artikel/artikel-verwalten#80, **Merkmale**>> eines Artikels.
...
Alternativ zur Verknüpfung mit dem Merkmal **Energieetikett** speichern Sie das Energieetikett im Tab <<artikel/artikel-verwalten#90, **Bilder**>> des Artikels. Gehen Sie dazu wie im Folgenden beschrieben vor.
...
. Wählen Sie im Tab **Übersicht** aus dem Dropdown-Menü **Retoure...** die Option **anlegen**. +
...
. Nehmen Sie die Einstellungen vor. Beachten Sie dazu Tabelle 4.
...
|**Warenausgangsdatum**
|Datum aus dem Kalender wählen. Das Warenausgangsdatum wird nur als Filter wirksam, wenn im Dropdown-Menü **Auftragsstatus** der Status **[7] Warenausgang gebucht** gewählt ist.
...
.  Wählen Sie das Format **NeckermannATEP** aus dem Dropdown-Menü **Vorgang**.
