...
Je nach Zahlungsart erfolgen Rechnungserzeugung sowie Rechnungsversand bereits durch Shopgate, sodass Sie keine Rechnung mehr an den Kunden schicken müssen. Sie können dies jeweils in Ihren Aufträgen von Shopgate prüfen oder eine <<basics/automatisierung/ereignisaktionen#neue-ereignisaktion, Ereignisaktion>> einrichten, um dies zu automatisieren.
