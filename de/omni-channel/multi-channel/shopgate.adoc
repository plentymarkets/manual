...
*Nein* = Es werden keine Cross-Selling-Artikel übertragen.
...
Je nach Zahlungsart erfolgen Rechnungserzeugung sowie Rechnungsversand bereits durch Shopgate, sodass Sie keine Rechnung mehr an den Kunden schicken müssen. Sie können prüfen, ob die Rechnungserzeugung und der Rechnungsversand durch Shopgate erfolgen, indem Sie jeweils Ihre Aufträgen von Shopgate prüfen oder eine <<basics/automatisierung/ereignisaktionen#neue-ereignisaktion, Ereignisaktion>> einrichten, um die Rechnungserzeugung und den Rechnungsversand zu automatisieren.
