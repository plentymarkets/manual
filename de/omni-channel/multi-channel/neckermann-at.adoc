...
Wenn Sie Partner bei link:http://www.neckermann.at/[**Neckermann Österreich**, window="_blank"] werden möchten, wenden Sie sich bitte zunächst direkt an Neckermann.at.
...
**Artikel-Lieferzeit 1 - 5** = Lieferzeit in Tagen bei jeder Option eingeben. Die Optionen für Artikelverfügbarkeit werden im Menü <<artikel/artikel-verwalten#190, **Einstellungen » Artikel » Artikelverfügbarkeit**>> eingerichtet.
...
Damit Sie Artikel, Merkmale etc. mit Neckermann.at verknüpfen können, muss im Menü **Einstellungen » Aufträge » Auftragsherkunft** die Auftragsherkunft Neckermann.at aktiviert werden.
