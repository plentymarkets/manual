...
====
Damit Amazon Prime-Aufträge bearbeitet werden können, müssen bestimmte Informationen im Menü **System » Aufträge » Versand » Dienstleister » Grundeinstellungen** hinterlegt sein. Amazon definiert folgende Pflichtfelder: **Firma**, **Straße**, **Hausnummer**, **PLZ**, **Ort**, **Land**, **Telefon** und **E-Mail**. Diese Pflichtfelder müssen gefüllt sein, damit die Anmeldung Ihrer Amazon Prime-Aufträge ausgeführt werden kann.
====
