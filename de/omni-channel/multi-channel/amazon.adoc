...
====
Dieses Feature ist nur für <<omni-channel/multi-channel/amazon#16-1, **Amazon Multi-Channel**>> vorgesehen.
====
...
Es werden nur Bestände von Artikeln übernommen, die in den letzten 30 Tagen eine Bestandsänderung auf Amazon erfahren haben. Für den Erstimport empfehlen wir Ihnen den manuellen Abgleich. Die Warenbestände werden gemäß der <<omni-channel/multi-channel/amazon#2-4, **Grundeinstellungen**>> abgeglichen.
...
.SKU-Zuordnung
====
Für den manuellen Abgleich muss die SKU-Zuordnung in den <<omni-channel/multi-channel/amazon#2-3, **Grundeinstellungen**>> eingetragen werden.
====
...
Für den manuellen und automatischen Auftragsimport beachten Sie das Kapitel **<<omni-channel/multi-channel/amazon#12, FBA-Aufträge automatisch importieren>>**.
...
.  Öffnen Sie den Artikel.
.  Wechseln Sie in das Tab **Multi-Channel**.
.  Nehmen Sie die Einstellungen im Bereich **Amazon** vor. Beachten Sie dazu die Erläuterungen in Tabelle 5 im Kapitel <<omni-channel/multi-channel/amazon#3, **Artikelverfügbarkeit einstellen**>>.
. **Speichern** Sie die Einstellungen.
...
Dabei werden nur Änderungen der Bestandsdaten berücksichtigt. Weitere Möglichkeiten zum Bestandsimport sind in Kapitel <<omni-channel/multi-channel/amazon#9-5, **Bestand abgleichen**>> beschrieben.

|**Lager**
| Wählen, welches <<omni-channel/multi-channel/amazon#10, **Lager**>> für den Versand durch Amazon verwendet werden soll.
