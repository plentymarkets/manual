...
|<<auftragsabwicklung/auftraege/auftragsstatus#, **Auftragstatus**  >> für Retouren wählen, die erfolgreich an Amazon gemeldet wurden.

|**Status für nicht übertragene Retouren**
|<<auftragsabwicklung/auftraege/auftragsstatus#, **Auftragstatus**  >> für Retouren wählen, die nicht erfolgreich an Amazon gemeldet wurden.
...
|**Status**
|<<auftragsabwicklung/auftraege/auftragsstatus#, **Status**  >> der Aufträge wählen, die von Amazon importiert wurden.
...
|<<auftragsabwicklung/auftraege/auftragsstatus#, **Auftragstatus**  >> für Aufträge wählen, die erfolgreich an FBA übertragen wurden.
...
Legen Sie zunächst einen Auftragsstatus für Amazon-Retouren im Menü **<<auftragsabwicklung/auftraege/auftragsstatus#, Einstellungen » Aufträge » Auftragsstatus  >>** an, z.B. [9.6] Retoure an Amazon gesendet. Diesen Auftragsstatus benötigen Sie für die Amazon-Einstellungen.
...
Im Menü **<<auftragsabwicklung/auftraege/auftraege-verwalten#, Aufträge » Aufträge bearbeiten  >>** werden alle Ihre Aufträge angezeigt. Diese Aufträge können Sie über **<<auftragsabwicklung/auftraege/auftraege-bearbeiten/suche#, Filter  >>** eingrenzen und sich z.B. nur Amazon Prime-Aufträge anzeigen lassen.
