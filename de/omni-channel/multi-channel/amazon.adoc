...
Richten Sie eine **<<auftragsabwicklung/auftraege/einstellungen/ereignisaktionen#, Ereignisaktion  >>** ein, um Retouren in Form von Gutschriften automatisch an Amazon zu senden.
...
Beachten Sie dazu die Handbuchseiten **<<auftragsabwicklung/auftraege/einstellungen/ereignisaktionen#, Ereignisaktionen  >>** sowie **link::/[Standard-Fulfillment im Detail]**.
====
...
Richten Sie eine **<<auftragsabwicklung/auftraege/einstellungen/ereignisaktionen#, Ereignisaktion  >>** ein, damit Amazon automatisch eine Meldung über den Auftrag erhält und den Auftrag bearbeiten sowie den Versand veranlassen kann.
