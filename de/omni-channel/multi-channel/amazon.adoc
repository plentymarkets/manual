...
.  Öffnen Sie das Menü **Einstellungen » Märkte » Amazon » Grundeinstellungen**.
...
Beachten Sie die weiteren link:http://services.amazon.de/programme/verkaufen-bei-amazon/ein-europisches-konto/[Informationen zum europäischen Verkäuferkonto, window="_blank"] sowie die link:http://services.amazon.de/faq-fuer-das-europaeische-verkaeuferkonto/[**FAQ**, window="_blank"] von Amazon.
====
...
|**Ja** = Artikel werden auf Amazon mit **link:https://ssw.starsellersworld.com/[starsellersworld, window="_blank"]** gelistet. Beim Auftragsimport wird dann die SKU des Artikels nach dem letzten "-" abgeschnitten, um eine Zuordnung des Artikels im System zu ermöglichen. +
...
Damit Sie Artikel, Merkmale etc. mit Amazon-Plattformen verknüpfen können, muss im Menü **Einstellungen » Aufträge » Auftragsherkunft** die Auftragsherkunft für die Amazon-Plattformen aktiviert werden.
...
.  Öffnen Sie das Menü <<artikel/artikel-verwalten#480, **Einstellungen » Artikel » Merkmale » Tab: Neues Merkmal**>>.
...
.  Öffnen Sie das Menü **Einstellungen » Märkte » Amazon » Frei definierbare Felder**.
...
.  Rufen Sie über diesen **link:https://sellercentral-europe.amazon.com/gp/help/help-folder.html/?ie=UTF8&itemID=1661[Link, window="_blank"]** das Hilfe-Center im Seller Central auf.
...
.  Öffnen Sie das Menü **Einstellungen » Märkte » Amazon » Kategorieverknüpfung** in Ihrem plentymarkets Backend.
...
Die Verknüpfung des Merkmals eines Artikels mit dem Amazon-Produkttyp erfolgt im Menü <<artikel/artikel-verwalten#480, **Einstellungen » Artikel » Merkmale**>>. In plentymarkets können maximal 8 Verknüpfungen pro Merkmal gespeichert werden.
...
.  Öffnen Sie das Menü **Einstellungen » Märkte » Amazon » Datenaustausch » Datenexport**.
...
.  Öffnen Sie das Menü **Einstellungen » Märkte » Amazon » Datenaustausch » Auftragsimport**.
...
.  Öffnen Sie das Menü **Einstellungen » Märkte » Amazon » Datenaustausch » Versandbestätigung**.
...
Im Menü **Einstellungen » Märkte » Amazon » Datenaustausch » Berichte** können Amazon-Bestellberichte zeitlich eingestellt und nachträglich zurückgesetzt werden.

[#2350]
====  Intervall für Auftragsberichte setzen

Im Menü **Einstellungen » Märkte » Amazon » Datenaustausch » Berichte » Tab: Geplante Berichte** bestimmen Sie, in welchem Zeitraum Bestellberichte von Amazon erstellt werden. Beim automatischen Auftragsimport werden Aufträge aus diesen Berichten importiert. Daher empfehlen wir sowohl für die Erstellung von Berichten als auch für den Auftragsimport einen möglichst niedrigen Intervall zu setzen. Bestellberichte erkennt man an ihrer Bezeichnung **GET ORDERS DATA**.

[.instruction]
Intervall festlegen:

.  Öffnen Sie das Menü **Einstellungen » Märkte » Amazon » Datenaustausch » Berichte » Tab: Geplante Berichte**.
.  Wählen Sie ein Amazon-Konto aus dem Dropdown-Menü.
...
Im Menü **Einstellungen » Märkte » Amazon » Datenaustausch » Berichte » Tab: Auftragsberichte zurücksetzen** setzen Sie die Auftragsberichte von Amazon eines bestimmten Datums zurück.
...
.  Öffnen Sie das Menü **Einstellungen » Märkte » Amazon » Datenaustausch » Berichte » Auftragsberichte zurücksetzen**.
.  Wählen Sie ein Amazon-Konto aus dem Dropdown-Menü.
...
.  Öffnen Sie das Menü **Einstellungen » Märkte » Amazon » Datenaustausch » FBA-Warenbestand**.
...
Legen Sie zunächst einen Auftragsstatus für Amazon-Retouren im Menü **<<auftragsabwicklung/auftraege/auftraege-verwalten#, Einstellungen » Aufträge » Auftragsstatus>>** an, z.B. [9.6] Retoure an Amazon gesendet. Diesen Auftragsstatus benötigen Sie für die Amazon-Einstellungen.
...
.  Öffnen Sie das Menü **Einstellungen » Aufträge » Grundeinstellungen**.
...
Im Retourenfall sendet der Käufer die Ware zurück an Amazon. Die Retoure wird in Ihr plentymarkets System importiert und mit dem Retourenstatus, den Sie im Menü **<<auftragsabwicklung/auftraege/_grundeinstellungen#, Einstellungen » Aufträge » Grundeinstellungen>>** gewählt haben, im Auftragsmenü angelegt.
