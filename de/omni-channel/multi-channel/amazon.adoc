...
|<<auftragsabwicklung/auftraege/einstellungen/auftragsstatus#, **Auftragstatus**  >> für Retouren wählen, die erfolgreich an Amazon gemeldet wurden.

|**Status für nicht übertragene Retouren**
|<<auftragsabwicklung/auftraege/einstellungen/auftragsstatus#, **Auftragstatus**  >> für Retouren wählen, die nicht erfolgreich an Amazon gemeldet wurden.
...
|**Herkunft**
| Wählen, ob nur Aufträge von Amazon mit FBA abgewickelt werden oder ob auch Aufträge von anderen <<auftragsabwicklung/auftraege/einstellungen/auftragsherkunft#, **Herkünften**  >> mit FBA abgewickelt werden können.
...
|**Status**
|<<auftragsabwicklung/auftraege/einstellungen/auftragsstatus#, **Status**  >> der Aufträge wählen, die von Amazon importiert wurden.
...
|<<auftragsabwicklung/auftraege/einstellungen/auftragsstatus#, **Auftragstatus**  >> für Aufträge wählen, die erfolgreich an FBA übertragen wurden.
...
Legen Sie zunächst einen Auftragsstatus für Amazon-Retouren im Menü **<<auftragsabwicklung/auftraege/einstellungen/auftragsstatus#, Einstellungen » Aufträge » Auftragsstatus  >>** an, z.B. [9.6] Retoure an Amazon gesendet. Diesen Auftragsstatus benötigen Sie für die Amazon-Einstellungen.
...
Richten Sie eine **<<auftragsabwicklung/auftraege/einstellungen/ereignis-aktionen#, Ereignisaktion  >>** ein, um Retouren in Form von Gutschriften automatisch an Amazon zu senden.
...
Beachten Sie dazu die Handbuchseiten **<<auftragsabwicklung/auftraege/einstellungen/ereignis-aktionen#, Ereignisaktionen  >>** sowie **link::/[Standard-Fulfillment im Detail]**.
====
...
Im Retourenfall sendet der Käufer die Ware zurück an Amazon. Die Retoure wird in Ihr plentymarkets System importiert und mit dem Retourenstatus, den Sie im Menü **<<auftragsabwicklung/auftraege/einstellungen/grundeinstellungen#, Einstellungen » Aufträge » Grundeinstellungen  >>** gewählt haben, im Auftragsmenü angelegt.
...
|**Status für übertragene Aufträge**
| Bestimmt den Auftragsstatus für Aufträge, die erfolgreich an FBA übertragen wurden.
...
Richten Sie eine **<<auftragsabwicklung/auftraege/einstellungen/ereignis-aktionen#, Ereignisaktion  >>** ein, damit Amazon automatisch eine Meldung über den Auftrag erhält und den Auftrag bearbeiten sowie den Versand veranlassen kann.
...
Im Menü **<<auftragsabwicklung/auftraege/auftraege-bearbeiten#, Aufträge » Aufträge bearbeiten  >>** werden alle Ihre Aufträge angezeigt. Diese Aufträge können Sie über **<<auftragsabwicklung/auftraege/auftraege-bearbeiten/suche#, Filter  >>** eingrenzen und sich z.B. nur Amazon Prime-Aufträge anzeigen lassen.
