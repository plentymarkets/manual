...
|**Lieferverzugsaufschlag**
| Lieferverzugsaufschlag in Tagen eintragen. Wird nur angezeigt, wenn bei **Durchschnittliche Lieferzeit** die Option **"Mittlere Lieferzeit in Tagen" übermitteln + Lieferverzugsaufschlag** gewählt wurde.
