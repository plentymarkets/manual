...
Richten Sie eine **<<auftragsabwicklung/auftraege/einstellungen/ereignis-aktionen#, Ereignisaktion  >>** ein, um Zahlungsbestätigungen automatisch an DaWanda zu senden.
...
Richten Sie eine **<<auftragsabwicklung/auftraege/einstellungen/ereignis-aktionen#, Ereignisaktion  >>** ein, um Versandbestätigungen automatisch an DaWanda zu senden, nachdem ein Warenausgang gebucht wurde.
