...
*true*, *yes*, *ja*, *1* eingeben oder ein Merkmal vom Typ *Kein* verknüpfen = Angebot wird nach Ende der Laufzeit automatisch verlängert.  +
*Hinweis:* Bei Artikeln, bei denen das Merkmal *AutoRenewEnabled* nicht verknüpft wurde oder ungültige Werte verknüpft wurden, wird automatisch *false* übertragen. Das Angebot wird nicht automatisch verlängert. +
Merkmaltyp: Kein
