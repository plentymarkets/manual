...
*true*, *ja*, *1*, *yes* eingeben oder ein Merkmal vom Typ **Kein** verknüpfen = Angebot wird nach Ende der Laufzeit automatisch verlängert.  +
*Hinweis:* Bei Artikeln, bei denen das Merkmal *AutoRenewEnabled* nicht eingestellt wurde oder ungültige Werte, wird automatisch *false* übertragen. Das Angebot wird nicht automatisch verlängert. +
Merkmaltyp: Kein
