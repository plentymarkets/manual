...
Um die Schnittstelle zu **Allyouneed** einzurichten, registrieren Sie sich zunächst als Händler bei link:http://de.allyouneed.com/de/dealer/page/selfsignup/step1[**Allyouneed**, window="_blank"]. Sie erhalten die nötigen Zugangsdaten, die Sie für die Einstellungen in plentymarkets benötigen.
...
.  Öffnen Sie das Menü **Einstellungen » Märkte » Allyouneed » Grundeinstellungen**.
...
|**Testkonto**
|**Ja** für **Testmodus**. +
Testumgebung von Allyouneed aktivieren. Damit wird der Artikelupload getestet und Testaufträge in das System importiert. Für ein Testkonto sind andere Zugangsdaten nötig. Registrieren Sie sich bei Allyouneed für ein link:https://portal.allyouneed.com/funktionsuebersicht/testsystem.html[**Testsystem**, window="_blank"].
...
| Verfügbarkeit wählen. Es werden Artikel mit den gewählten Verfügbarkeiten übertragen. Die Optionen für Artikelverfügbarkeit werden im Menü <<artikel/artikel-verwalten#190, **Einstellungen » Artikel » Artikelverfügbarkeit** >> eingerichtet.
...
Einstellungen zu Steuersätzen im Menü <<omni-channel/online-shop/mandanten-einrichten/buchhaltung#, **Buchhaltung**  >> beachten.
...
Damit Sie Artikel, Merkmale etc. mit Allyouneed verknüpfen können, muss im Menü **Einstellungen » Aufträge » Auftragsherkunft** die Auftragsherkunft Allyouneed aktiviert werden.
...
. Aktivieren Sie die Option **Allyouneed**.
. Aktiviern Sie die Option **Web-API**.
...
====
Die Kategorien bei Allyouneed sind flexibel erweiterbar. Nehmen Sie dazu Kontakt mit **link:https://portal.allyouneed.com/verkaufen-mit-allyouneed.html[Allyouneed.com, window="_blank"]** auf.
====

[.instruction]
Kategorien verknüpfen:

.  Öffnen Sie das Menü **Einstellungen » Märkte » Allyouneed » Kategorieverknüpfung**.
.  Wählen Sie aus dem Dropdown-Menü **Allyouneed-Kategorie** eine passende Hauptkategorie. +
...
. Wählen Sie im Dropdown-Menü **Marktplatz** die Option **Allyouneed**. +
→ Ein zusätzliches Dropdown-Menü **Allyouneed** wird angezeigt.
. Wählen Sie im Dropdown-Menü **Gruppe** die Option **Oberbekleidung**.
. Wählen Sie im Dropdown-Menü **Attribut** die Option **Farbe**.
...
Bei Allyouneed gibt es einen Extrabereich für den link:https://portal.allyouneed.com/verkaufen-mit-allyouneed/highlights-vorteile/b-ware.html[**Verkauf von B-Ware**, window="_blank"]. Um dort zu listen, gibt es zwei unterschiedliche Möglichkeiten:
...
. Geben Sie unter **Backendname** einen Namen ein.
...
→ Geben Sie eine Beschreibung ein und verknüpfen Sie die Kategorien.[.instruction]
...
→ Es kann nur ein Preisset übertragen werden. Löschen Sie die weiteren Preissets in plentymarkets, entfernen Sie den Artikel auf Allyouneed und übertragen Sie ihn erneut.[#1400]
...
→ Prüfen Sie Ihre Herstellerangaben und nehmen Sie notfalls Kontakt mit Allyouneed auf.[.instruction]
Ein Produkt mit identischen Herstellerangaben wurde gefunden. (Code: 4025)

[.indented]
Nehmen Sie Kontakt mit Allyouneed auf.[.instruction]
...
→ Löschen Sie den Artikel aus dem Allyouneed-Konto. Bei einer erneuten Übertragung sollte auch er problemlos gelistet werden.[.instruction]
...
→ Sofern auf diese Meldung kein "PRODUCT_NOT_FOUND" folgt handelt es sich hier eher um eine Warnung, da das Produkt trotzdem gelistet wird. Allerdings nicht mit Ihrer Beschreibung, sondern der im Allyouneed-Katalog.[.instruction]
...
→ Löschen Sie den Artikel aus dem Konto bei Allyouneed. Bei einer erneuten Übertragung sollte er problemlos gelistet werden.[.instruction]
...
[.indented]
Diese Fehlermeldung besagt, dass der Artikel bereits von einem anderen Händler mit Varianten übertragen wurde und bei Ihrem Artikel aber keine oder andere Varianten hinterlegt sind.[.instruction]
...
→ Löschen Sie den Artikel aus dem Konto bei Allyouneed oder wenden Sie sich an Allyouneed.[.instruction]
...
[.indented]
Diese Meldung besagt, dass die Attributverknüpfungen nicht stimmen. Beispielsweise wenn nur Zahlen als Werte erlaubt sind, aber auch Buchstaben angegeben wurden. Oder wenn die Kombination der Attribute nicht zusammen passt, z.B. wenn ein Attribut für "Schuhe" mit einem Attribut für Hüte kombiniert wurde.[.instruction]
...
→ Führen Sie die unter **<<artikel/artikel-verwalten#390, Attribute verknüpfen >>** aufgeführten Schritte aus.[#1500]
...
→ Überprüfen Sie, ob die eingegebene Kategorie-ID richtig ist. Wenn Sie die ID direkt eingegeben haben, handelt es sich vielleicht um einen Tippfehler.[#1600]
...
→ Nehmen Sie Kontakt zu Allyouneed auf.[#1700]
...
[.indented]
Diese Fehlermeldung besagt, dass die Attributverknüpfung fehlerhaft ist oder der Artikel bereits von einem anderen Händler mit Varianten übertragen wurde, jedoch bei Ihrem Artikel keine Varianten hinterlegt sind.[.instruction]
...
→ Geben Sie für den Artikel einen Preis in den Artikeldaten ein.[.instruction]
...
→ Weitere Informationen zu Allyouneed-Gruppen finden Sie unter **<<artikel/artikel-verwalten#390, Attribute verknüpfen >>**.[#1800]
...
→ Geben Sie eine EAN und Beschreibung in den Artikeldaten ein und verknüpfen Sie die Kategorien.[.instruction]
missing "name"

[.indented]
Diese Fehlermeldung besagt, dass der Artikel keinen Namen hat. +
→ Geben Sie einen Namen in den Artikeldaten ein.[.instruction]
missing "productId"

[.indented]
Diese Fehlermeldung besagt, dass eine ID fehlt. +
→ Wenden Sie sich an plentymarkets.[.instruction]
