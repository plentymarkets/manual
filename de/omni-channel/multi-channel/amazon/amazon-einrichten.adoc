...
Innerhalb des Filters *Amazon* stehen Ihnen acht Optionen zur Auswahl:
...
Auf der Handbuchseite *<<auftragsabwicklung/payment/amazon-pay#, Amazon Payments Advanced>>* erhalten Sie wichtige Hinweise zur Integration des Zahlungsanbieters in plentymarkets.
