...
|*Gutschriftenimport*
|Wählen, ob Gutschriften in Ihr plentymarkets System importiert werden sollen. Nutzen Sie diese Option für Amazon FBA (= Versand durch Amazon). +
...
[#2900]
==== Automatischen Gutschriftenimport für Amazon FBA nutzen
