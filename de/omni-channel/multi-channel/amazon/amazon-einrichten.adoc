...
*Nein* = Es findet kein Gutschriftenimport statt. Wenn Sie *Nein* wählen, erstellen Sie eine Ereignisaktion, um Retouren als Gutschriften in Ihr plentymarkets System zu importieren. +
...
Die Verknüpfung des Merkmals eines Artikels mit dem Amazon-Produkttyp erfolgt im Menü <<artikel/artikel-verwalten#480, System » Artikel » Merkmale>>. In plentymarkets können maximal 16 Verknüpfungen pro Merkmal gespeichert werden.
...
.SKU-Zuordnung
====
Für den manuellen Abgleich muss die SKU-Zuordnung in den <<Basiseinstellungen vornehmen, Grundeinstellungen>> eingetragen werden.
====
...
Falls Amazon den Auftrag nicht freigibt, wird dieser nicht aktualisiert, sondern automatisch in Status *[8] Storniert* verschoben.
