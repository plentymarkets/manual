...
. Wählen Sie als Merkmaltyp **Text** aus dem Dropdown-Menü.
.  Wählen Sie bei **Amazon-Verknüpfung** den Produkttyp. +
→ Ein neues Dropdown-Menü erscheint.
.  Wählen Sie im Dropdown-Menü das Amazon-Feld **sale_from_date**.
.  Klicken Sie auf **Hinzufügen**. +
...
.  Wählen Sie den **Datentyp** aus dem Dropdown-Menü.
...
.  Wählen Sie ein **Exportfeld** aus dem Dropdown-Menü.
.  Wählen Sie das passende Feld aus dem Dropdown-Menü **Freitextfeld**. +
...
.  Wählen Sie die Freitextfelder aus den Dropdown-Menüs aus.
. **Speichern** Sie die Einstellungen.
.  Öffnen Sie das Menü **System » Artikel » Freitextfelder**.
.  Tragen Sie bei den eben gewählten Freitextfeldern unter **Feldbezeichnung** den Namen ein.
.  Wählen Sie aus Dropdown-Menü in der Spalte **Datentyp** einen Typ aus.
.  Tragen Sie die maximal mögliche **Zeichenlänge** für das Freitextfeld ein.
. **Speichern** Sie die Einstellungen. +
...
.  Wählen Sie bei **Amazon-Verknüpfung** den Produkttyp. +
→ Ein neues Dropdown-Menü erscheint.
.  Wählen Sie im Dropdown-Menü das Amazon-Feld.
.  Klicken Sie auf **Hinzufügen**. +
→ Die Verknüpfung wird angelegt.
...
.  Wählen Sie aus dem Dropdown-Menü **Verfahren für Auftragsimport** die Option **XML-Schnittstelle abrufen**. +
→ Ein zweites Dropdown-Menü erscheint.
.  Wählen Sie aus dem Dropdown-Menü **Amazon-Account** das Konto.
...
.  Öffnen Sie das Menü **System » Märkte » Amazon » Datenaustausch » Auftragsimport**.
.  Wählen Sie aus dem Dropdown-Menü **Verfahren für Auftragsimport** die Option **CSV-Datei importieren**. +
...
.  Wählen Sie ein Amazon-Konto aus dem Dropdown-Menü.
...
Retouren von Amazon-Aufträgen bearbeiten[#3000]
...
.  Wählen Sie aus dem Dropdown-Menü **Versanddienstleister** die Option **Amazon Prime**.
