...
Wenn Sie Amazon VCS in plentymarkets aktivieren, erstellt plentymarkets automatisch Amazon-Rechnungen und überträgt die Rechnungen zu Amazon. Aktivieren Sie Amazon VCS im Menü *System » Märkte » Amazon » Amazon-Konto wählen » Tab: Einstellungen* im Bereich *Basiseinstellungen* in plentymarkets.

[.instruction]
Amazon VCS aktivieren:

1. Öffnen Sie das Menü *System » Märkte » Amazon » Amazon-Konto wählen » Tab: Einstellungen*.
2. Wählen Sie im Bereich *Basiseinstellungen* für die Option *Rechnung generieren* die Einstellung *Amazon VCS*.
