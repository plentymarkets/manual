...
<<artikel/artikel-verwalten#3000, Eigenschaften>>, die Sie im Menü <<artikel/artikel-verwalten#3100, *System » Einstellungen » Eigenschaften » Konfiguration*>> erstellt haben und zu einer Variante hinzugefügt haben, verknüpfen Sie im Menü *System » Einstellungen » Eigenschaften » Konfiguration » Tab: Amazon* mit Amazon.
