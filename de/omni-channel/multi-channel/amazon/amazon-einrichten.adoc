...
Amazon VCS (= VAT Calculation Service) ist ein von Amazon angebotener Umsatzsteuerservice, mit dem Amazon Rechnungen automatisch erstellt und die Umsatzsteuer berechnet. Mit plentymarkets haben Sie die Möglichkeit, Amazon-Rechnungen direkt in Ihrem plentymarkets System zu erstellen. +

Der Umsatzsteuerservice ist derzeit nur für ausgewählte Händler verfügbar. Diese Händler werden von Amazon kontaktiert. Nachdem Sie für Amazon VCS ausgewählt wurden, muss durch plentymarkets ein Modul in Ihrem plentymarkets System freigeschaltet werden. Kontaktieren Sie plentymarkets im link:https://forum.plentymarkets.com/[Forum^], damit Amazon VCS für Sie freigeschaltet wird. +

Wenn Sie Amazon VCS in plentymarkets aktivieren, erstellen Sie Amazon-Rechnungen direkt in Ihrem plentymarkets System. Die Amazon-Rechnungen werden dann automatisch zu Amazon übertragen. Aktivieren Sie Amazon VCS im Menü *System » Markets » Amazon » Amazon-Konto wählen » Tab: Einstellungen* im Bereich *Basiseinstellungen* in plentymarkets.
