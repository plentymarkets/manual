...
*Ja* = FBA-Gutschriften werden einmal täglich in Ihr plentymarkets System importiert. +
...
Nutzen Sie für Amazon FBA den Gutschriftenimport, um FBA-Gutschriften automatisch in Ihr plentymarkets System zu importieren. FBA-Gutschriften werden dann einmal täglich importiert.

[IMPORTANT]
.FBA-Retouren nicht per Ereignisaktion als Gutschriften anlegen
====
Wenn Sie den Gutschriftenimport aktivieren, werden FBA-Gutschriften automatisch einmal täglich in Ihr plentymarkets System importiert. Verwenden Sie deshalb in diesem Fall keine Ereignisaktion, um FBA-Retouren als Auftragstyp *Gutschrift* anzulegen.
====
