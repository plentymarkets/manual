...
Nachdem das Amazon-Konto für Amazon Business freigeschaltet wurde, müssen Sie Verkaufspreise für B2B-Artikel anlegen und verknüpfen. Sie können neben dem Standardpreis für Artikel ab Menge 1 bis zu 3 weitere Preise für Mengenrabatte anlegen. Dabei können Preise für Mengenrabatt als Festpreis oder prozentual angelegt werden.
