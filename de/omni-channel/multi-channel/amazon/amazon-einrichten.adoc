...
[#1390]
== Eigenschaften zu Amazon übertragen

Um Eigenschaften, die Sie im Menü *Artikel » Artikel bearbeiten » Artikel öffnen » Tab: Varianten-ID » Tab: Eigenschaften* zu einer Variante hinzugefügt haben, zu Amazon zu übertragen
