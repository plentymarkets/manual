...
*Ja* = Gutschriften werden einmal täglich in Ihr plentymarkets System importiert. Wenn *Ja* gewählt wird, muss die Ereignisaktion zur automatischen Meldung von Gutschriften an Amazon deaktiviert werden. +
