...
*Ja* = Gutschriften werden einmal täglich in Ihr plentymarkets System importiert. Wenn *Ja* gewählt wird, muss die <<Einstellungen der Schnittstelle in plentymarkets vornehmen, Ereignisaktion>> zur automatischen Generierung von Gutschriften, die als Retouren an Amazon gesendet werden, deaktiviert werden. +
