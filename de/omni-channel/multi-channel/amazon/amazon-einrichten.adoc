...
|*Gutschriftenimport*
| Wählen, ob FBA-Gutschriften in Ihr plentymarkets System importiert werden sollen. Nutzen Sie diese Option für Amazon FBA (= Versand durch Amazon). Weitere Informationen finden Sie im Kapitel <<FBA-Gutschriften automatisch importieren, FBA-Gutschriften automatisch importieren>>. +
*Ja* = FBA-Gutschriften werden alle 4 Stunden in Ihr plentymarkets System importiert. +
...
====
Wählen Sie für den Filter *Auftrag > Herkunft* keine Amazon FBA-Herkunft, wie z.B. Amazon FBA Germany, wenn Sie den automatischen Gutschriftenimport für FBA-Gutschriften nutzen.
====
...
Nutzen Sie für Amazon FBA den Gutschriftenimport, um FBA-Gutschriften automatisch in Ihr plentymarkets System zu importieren. FBA-Gutschriften werden dann alle 4 Stunden importiert.
