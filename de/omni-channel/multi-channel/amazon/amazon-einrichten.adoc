...
Wenn Sie Amazon VCS in plentymarkets aktivieren, erstellt plentymarkets automatisch Amazon-Rechnungen überträgt die Rechnungen zu Amazon. Aktivieren Sie Amazon VCS im Menü *System » Markets » Amazon » Amazon-Konto wählen » Tab: Einstellungen* im Bereich *Basiseinstellungen* in plentymarkets.
