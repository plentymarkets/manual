...
|*Gutschriftenimport*
| Wählen, ob FBA-Gutschriften in Ihr plentymarkets System importiert werden sollen. Nutzen Sie diese Option für Amazon FBA (= Versand durch Amazon). Weitere Informationen finden Sie im Kapitel <<Gutschriften automatisch importieren, Gutschriften automatisch importieren>>. +
