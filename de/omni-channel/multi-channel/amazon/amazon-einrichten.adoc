...
Setzen sie unter *Tax reports* ein Intervall, um Steuerberichte für Amazon Business abzurufen. Alternativ können Steuerberichte in der Amazon Seller Central abgerufen werden. Wenn Sie in plentymarkets ein Intervall für die Erstellung von Steuerberichten setzen, müssen Sie dazu keine weiteren Einstellungen in der Seller Central vornehmen. +

FBA-Bestellberichte werden automatisch alle 4 Stunden abgerufen. Unter *FBA orders* können Sie optional ein Intervall setzen, für das Bestellberichte zusätzlich abgerufen werden sollen.
...
Nutzen Sie den Gutschriftenimport, um FBA-Gutschriften automatisch in Ihr plentymarkets System zu importieren. Die Gutschriften werden mit dem Status *[10] Gewährleistung* importiert. Wenn der Gutschriftenimport aktiviert ist, werden FBA-Gutschriften alle 4 Stunden importiert.
