...
* *SameDay* Amazon-Aufträge werde in der Auftragsübersicht gelistet, die nicht zu Amazon-Prime gehören, aber bei denen der Versand dennoch am gleichen Tag erfolgen muss.
