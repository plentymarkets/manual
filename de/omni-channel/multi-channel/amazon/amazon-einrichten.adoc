...
====
Wählen Sie für den Filter *Auftrag > Herkunft* keine Amazon FBA-Herkunft, z.B. Amazon FBA Germany, wenn Sie den automatischen Gutschriftenimport für FBA-Gutschriften nutzen.
====
