...
Öffnen Sie das Menü *Benutzerberechtigungen* in der Amazon Seller Central und klicken Sie auf *Entwickler autorisieren*. Um Amazon MWS einzurichten, geben Sie den *Namen des Entwicklers* und die *Entwickler-ID* ein und klicken Sie auf *Weiter*. +
