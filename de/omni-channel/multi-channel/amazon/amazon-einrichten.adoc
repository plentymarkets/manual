...
|*Abgleich zusätzlicher SKU*
| Datenaustausch für zusätzliche Amazon-SKUs aktivieren. +
*ALLE*, *Bestandsabgleich*, oder *Preisabgleich* für <<Amazon-Auftragsimport-SKU manuell festlegen, Amazon-Auftragsimport-SKUs>> aktivieren.
|====
