...
//Das folgende Video-Tutorial veranschaulicht, wie schnell Sie Artikel auf Amazon hochladen können:
...
Im Menü <<artikel/artikel-verwalten#170, Artikel » Artikel bearbeiten » Artikel öffnen » Tab: Varianten-ID>> im Tab *Verfügbarkeit* fügen Sie, wenn nötig, manuell SKUs hinzu. Alternativ können zusätzliche SKUs über das Datenformat VariationAdditionalSKU importiert werden.
...
====
Sollten Aufträge von Amazon in Ihr System importiert werden, die Sie nicht mit plentymarkets eingestellt haben bzw. Aufträge, für die Artikel bisher nicht in plentymarkets angelegt sind, haben Sie die Möglichkeit, bei diesen Aufträgen manuell die Artikel zuzuordnen und den Status einzustellen. Alternativ können Sie aus dem Auftrag heraus den Artikel in Ihrem plentymarkets System anlegen.
====
...
[#3150]
== Amazon VCS in plentymarkets nutzen

Amazon VCS (= VAT Calculation Service) ist ein von Amazon angebotener Umsatzsteuerservice, mit dem Amazon Rechnungen automatisch erstellt und die Umsatzsteuer berechnet. Der Umsatzsteuerservice ist derzeit nur für ausgewählte Händler verfügbar. Diese Händler werden von Amazon kontaktiert. Nachdem Sie für Amazon VCS ausgewählt wurden, muss durch plentymarkets ein Modul in Ihrem plentymarkets System freigeschaltet werden. +
Im Menü *System » Markets » Amazon » Amazon-Konto wählen » Tab: Einstellungen* im Bereich *Basiseinstellungen* aktivieren Sie VCS in plentymarkets. Dadurch haben Sie die Möglichkeit, Amazon-Rechnungen in Ihrem plentymarkets System zu erstellen.

[.instruction]
Amazon VCS aktivieren:

1. Öffnen Sie das Menü *System » Märkte » Amazon » Amazon-Konto wählen » Tab: Einstellungen*.
2. Wählen Sie für die Option *Rechnung generieren* die Einstellung *Amazon VCS*.
3. *Speichern* Sie die Einstellungen.

[.subhead]
Ereignisaktion zur automatischen Übertragung von Rechnungen zu Amazon

Erstellen Sie eine Ereignisaktion, damit die in plentymarkets erstellten Rechnungen automatisch zu Amazon übertragen werden.
...
→ Das Fenster *Neue Ereignisaktion erstellen* wird geöffnet.
.  Tragen Sie einen Namen ein.
.  Wählen Sie das *Ereignis* gemäß <<ereignisaktion-amazon-vcs>>.
. *Speichern* Sie die Einstellungen.
.  Nehmen Sie die Einstellungen gemäß <<ereignisaktion-amazon-vcs>> vor.
.  Setzen Sie ein Häkchen bei *Aktiv*.
. *Speichern* Sie die Einstellungen.
--

[[ereignisaktion-amazon-vcs]]
.Ereignisaktion zum automatischen Übertragen von Rechnungen an Amazon
[cols="1,3,3"]
|====
| Einstellung | Option | Auswahl
...
|*Aktion*
|*Auftrag > Rechnung an Amazon senden*
|
|====
