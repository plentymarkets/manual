...
|*Gutschriftenimport*
|Wählen, ob Gutschriften in Ihr plentymarkets System importiert werden sollen. +
Diese Funktion muss von plentymarkets freigeschaltet werden. Wenden Sie sich dazu an einen plentymarkets Supporter. +
*Ja* = Gutschriften werden einmal täglich in Ihr plentymarkets System importiert. Wenn *Ja* gewählt wird, muss die <<omni-channel/multi-channel/amazon/amazon-einrichten#2800, Ereignisaktion>> zur automatischen Meldung von Gutschriften an Amazon deaktiviert werden. +
...
| Artikelkatalog für den Export wählen. Beim Artikelkatalogexport zu Amazon werden nur noch Artikel berücksichtigt, die jeweils in den vergangenen 3 Tagen geändert wurden. Bestände und Preise werden weiterhin wie gewohnt automatisiert abgeglichen.
...
Retouren können Sie in Form von Gutschriften per Ereignisaktion an Amazon melden. Nur mit Hilfe eines Auftrags vom Typ Gutschrift kann die Rückzahlung der Artikelsumme und den Versandkosten garantiert werden. Gehen Sie dazu wie im Folgenden beschrieben vor.
