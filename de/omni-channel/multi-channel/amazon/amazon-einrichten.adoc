...
====
Wenn Sie ein Merkmal und eine Eigenschaft mit demselben Amazon-Feld verknüpft haben, wird die Eigenschaft bevorzugt und das Merkmal, das mit diesem Amazon-Feld verknüpft ist, beim Artikelexport überschrieben.
====
...
. *Speichern* Sie die Einstellungen. +
→ Die Eigenschaft ist mit dem Amazon-Feld verknüpft und wird beim nächsten Artikelexport übertragen.
