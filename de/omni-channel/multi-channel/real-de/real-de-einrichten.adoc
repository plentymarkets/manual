...
Weitere Informationen zur Merkmalverknüpfung bei real.de finden Sie auf der Best Practice-Seite <<omni-channel/multi-channel/real-de/best-practices#merkmalverknüpfung, Merkmale mit Attributen verknüpfen>>.
