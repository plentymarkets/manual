...
====
Rechnungen werden von real.de in Ihr plentymarkets System übertragen. Deshalb können Sie keine eigenen Rechnungen über Ihr System generieren. Das bedeutet, dass Sie - im Gegensatz zu anderen Marktplätzen - keine Prozesse zur Rechnungabwicklung über <<basics/automatisierung/ereignisaktionen#, Ereignisaktionen>> steuern können.
====
