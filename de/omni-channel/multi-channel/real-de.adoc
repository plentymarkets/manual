...
====
Rechnungen werden von real.de in Ihr plentymarkets System übertragen. Es ist somit nicht möglich, über Ihr System eigene Rechnungen zu generieren. Das bedeutet, dass Sie - im Gegensatz zu anderen Marktplätzen - keine Prozesse zur Rechnungabwicklung über <<auftragsabwicklung/auftraege/einstellungen/ereignisaktionen#, **Ereignisaktionen**  >> steuern können.
====

[#900]
== Stornierungen automatisch senden

Richten Sie eine **<<auftragsabwicklung/auftraege/einstellungen/ereignisaktionen#, Ereignisaktion  >>** ein, um real.de automatisch über Stornierungen zu informieren. Bei Stornierungen muss ein Grund für die Stornierung an real.de übertragen werden. Erstellen Sie im Menü **<<auftragsabwicklung/auftraege/einstellungen/auftragsstatus#, Einstellungen » Aufträge » Auftragsstatus  >>** ggf. zusätzliche Auftragsstatus. Folgende Stornierungsgründe können an real.de übertragen werden:
