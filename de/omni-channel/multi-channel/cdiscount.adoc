...
Die hier wählbaren Optionen sind die im Menü **link::/[Einstellungen » Aufträge » Versand » Versandoptionen » Tab: Versandkosten berechnen]** gewählten Einstellungen für Konfiguration 1 und Konfiguration 2.
...
Richten Sie eine **<<auftragsabwicklung/auftraege/einstellungen/ereignis-aktionen#, Ereignisaktion  >>** ein, um Retouren automatisch an Cdiscount zu senden.
...
Richten Sie eine **<<auftragsabwicklung/auftraege/einstellungen/ereignis-aktionen#, Ereignisaktion  >>** ein, um den Auftragsstatus bei Cdiscount automatisch zu aktualisieren, wenn bestimmte Ereignisse eintreten. Sie haben die Möglichkeit, Aufträge bei Cdiscount per Ereignisaktion automatisch in die
