...
|*Lager*
|Wählen, welches Lager verwendet werden soll. Ein Lager oder *Summe aus allen Lagern* wählen.
...
Wenn Sie <<artikel/artikel-verwalten#390, Attribute>> im plentymarkets System erstellt haben, müssen diese Attribute mit Cdiscount verknüpft werden. Nachfolgend wird beschrieben, wie Sie das Attribut Farbe mit Cdiscount verknüpfen. Verknüpfen Sie weitere Attribute analog.
