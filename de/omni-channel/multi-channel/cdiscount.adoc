...
. Öffnen Sie das Menü **System » Märkte » Cdiscount » Tab: Einstellungen**.
...
====
Wenn im Menü **System » Märkte » Cdiscount » Tab: Einstellungen** die Einstellung **Produkterstellung anfordern** aktiv ist, werden beim nächtlichen Übertragungsprozess für jede Variante, die exportiert wird automatisch eine SKU generiert, die der Varianten-ID entspricht.
====
...
. Öffnen Sie das Menü **System » Märkte » Cdiscount » Tab: Kategorieliste**.
...
. Öffnen Sie das Menü **System » Märkte » Cdiscount » Tab: Kategorieverknüpfung**.
...
. Öffnen Sie das Menü **System » Märkte » Cdiscount » Tab: Herstellerliste**.
...
Klicken Sie dazu im Menü **System » Märkte » Cdiscount » Tab: Herstellerliste** auf **Herstellerliste als CSV Datei herunterladen**.
