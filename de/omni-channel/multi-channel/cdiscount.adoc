...
. Öffnen Sie das Menü **System » Märkte » Cdiscount.com.com » Tab: Archiv**.
...
Da es in seltenen Fällen zu Problemen beim automatischen Artikelexport kommen kann, können Sie Ihren auf französisch hinterlegten Artikelkatalog unter <<basics/datenaustausch/daten-exportieren#, **Daten » Elastischer Export**>> auch als CSV-Datei an Cdiscount exportieren. Nachdem Sie alle dafür notwendigen Einstellungen wie unten beschrieben vorgenommen und gespeichert haben, müssen Sie die komplette URL kopieren und an Cdiscount übermitteln. Der stündliche Bestandsabgleich erfolgt weiterhin automatisch.
...
Im Menü **Daten » API-Log » Tab: API-Log** finden Sie eine Historie über Vorgänge, die über die Cdiscount-Schnittstelle ausgeführt wurden. Das Format **Cdiscount.com** steht Ihnen für Cdiscount zur Verfügung.
