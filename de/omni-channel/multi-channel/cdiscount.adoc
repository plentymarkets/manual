...
. Öffnen Sie das Menü **Einstellungen » Märkte » Cdiscount » Tab: Einstellungen**.
...
Die hier wählbaren Optionen sind die im Menü **<<auftragsabwicklung/fulfillment/versand-vorbereiten#1700, [Einstellungen » Aufträge » Versand » Versandoptionen » Tab: Versandkosten berechnen>>** gewählten Einstellungen für Konfiguration 1 und Konfiguration 2.
...
Damit Sie Artikel, Merkmale etc. mit Cdiscount verknüpfen können, muss im Menü **Einstellungen » Aufträge » Auftragsherkunft** die Auftragsherkunft Cdiscount aktiviert werden.
...
Die Verfügbarkeit für mehrere Varianten kann entweder über die link:https://www.plentymarkets.eu/handbuch/artikel/artikel-verwalten/#18[Varianten-Gruppenfunktion], die link:https://www.plentymarkets.eu/handbuch/artikel/artikel-verwalten/#18[Stapelverarbeitung] oder den dynamischen Ex- und Import des Formats link:https://www.plentymarkets.eu/handbuch/datenaustausch/datenformate/variationmarketlink/[VariationMarketLink] bearbeitet werden.
...
====
Wenn im Menü **Einstellungen » Märkte » Cdiscount » Tab: Einstellungen** die Einstellung **Produkterstellung anfordern** aktiv ist, werden beim nächtlichen Übertragungsprozess für jede Variante, die exportiert wird automatisch eine SKU generiert, die der Varianten-ID entspricht.
====
...
link:https://www.plentymarkets.eu/handbuch/artikel/artikel-verwalten/#17-2[Verknüpfen] Sie den Verkaufspreis im Anschluss mit den gewünschten Varianten falls noch nicht verknüpft.
...
.  Öffnen Sie das Menü **Einstellungen » Artikel » Barcode » Barcode öffnen**.
.  Setzen Sie ein Häkchen bei der Herkunft **Cdiscount**.
. **Speichern** Sie die Einstellungen.

link:https://www.plentymarkets.eu/handbuch/artikel/artikel-verwalten/#17-3[Verknüpfen] Sie den Barcode im Anschluss mit den gewünschten Varianten falls noch nicht verknüpft.
...
. Öffnen Sie das Menü **Einstellungen » Märkte » Cdiscount » Tab: Kategorieliste**.
. Klicken Sie auf das **Kategorieliste aktualisieren**. +
...
. Öffnen Sie das Menü **Einstellungen » Märkte » Cdiscount » Tab: Kategorieverknüpfung**.
...
. Wählen Sie im Dropdown-Menü **Marktplatz** die Option **Cdiscount.com**. +
→ Ein zusätzliches Dropdown-Menü **Cdiscount** wird angezeigt.
. Wählen Sie im Dropdown-Menü **Cdiscount.com** das Attribut **Farbe**.
...
. Öffnen Sie in das Menü **Einstellungen » Artikel » Merkmale**.
. Öffnen Sie das Tab **Neues Merkmal**.
. Geben Sie unter **Backendname** einen Namen für das Merkmal ein.
. Wählen Sie aus dem Dropdown-Menü **Sprache** für Französisch **fr**.
...
. Wählen Sie aus dem Dropdown-Menü im Feld **Cdiscount.com-Merkmal** das Cdiscount-Merkmal.
. **Speichern** Sie die Einstellungen.
...
. Öffnen Sie das Menü **Einstellungen » Märkte » Cdiscount » Tab: Herstellerliste**.
...
. Öffnen Sie das Menü **Einstellungen » Märkte » Cdiscount.com » Tab: Archiv**.
...
Da es in seltenen Fällen zu Problemen beim automatischen Artikelexport kommen kann, können Sie Ihren auf französisch hinterlegten Artikelkatalog unter <<basics/datenaustausch/daten-exportieren#, **Datenaustausch » Export » elastischer Export**  >> auch als CSV-Datei an Cdiscount exportieren. Nachdem Sie alle dafür notwendigen Einstellungen wie unten beschrieben vorgenommen und gespeichert haben, müssen Sie die komplette URL kopieren und an Cdiscount übermitteln. Der stündliche Bestandsabgleich erfolgt weiterhin automatisch.
...
. **Speichern** Sie die Einstellungen.
. Wechseln Sie in das Menü **Datenaustausch » Export » elastischer Export**.
. Öffnen Sie das Tab **Neuer Export**.
. Wählen Sie **Cdiscount.com** aus dem Dropdown-Menü **Datenformat**.
. Geben Sie einen Namen für den Export ein.
. Nehmen Sie die Einstellungen gemäß  der Handbuchseite <<basics/datenaustausch/daten-exportieren#20, **Daten exportieren** >> vor.
. **Speichern** Sie die Einstellungen. +
...
====
Wenn Sie Ihren Artikelkatalog über eine CSV-Datei an Cdiscount übermitteln, müssen im Menü <<artikel/artikel-verwalten#480, **Einstellungen » Artikel » Merkmale** >> die Merkmale **Geschlecht**, **Hauptfarbe**, **Hinweis**, **Kommentar**, **Marketing-Beschreibung**, **Publikum** und **Sport** verknüpft werden.
====
...
.  Wählen Sie das Format **Cdiscount.com** aus dem Dropdown-Menü **Vorgang**.
