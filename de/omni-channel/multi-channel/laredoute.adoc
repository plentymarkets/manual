...
. Öffnen Sie das Menü **Einstellungen » Märkte » La Redoute » Grundeinstellungen**.
...
|**CatalogSupplierName**
|Von La Redoute erhaltenen Namen eingeben.
...
|Wählen, ob Aufträge von La Redoute als **bezahlt** oder **offen** importieren werden sollen, da die Kunden an La Redoute überweisen und La Redoute Ihnen das Geld erst danach auszahlt.
|====
...
Damit Sie Artikel, Merkmale etc. mit La Redoute verknüpfen können, muss im Menü **Einstellungen » Aufträge » Auftragsherkunft** die Auftragsherkunft La Redoute aktiviert werden.
...
. Wählen Sie aus dem Dropdown-Menü **Öffne Sprache** die Einstellung **fr**.
...
. Öffnen Sie das Menü **Einstellungen » Märkte » La Redoute » Artikelmerkmal-Import**.
. Klicken Sie auf **Durchsuchen ...**.
. Wählen Sie die CSV-Datei mit den Merkmalen.
. Wählen Sie das Feldtrennzeichen.
. **Speichern** Sie die Einstellungen. +
→ Die Datei wird hochgeladen.
. Wechseln Sie in das Menü **Einstellungen » Artikel » Merkmale**.
...
. Wählen Sie aus dem Dropdown-Menü im Feld **La Redoute-Merkmal** das La Redoute-Merkmal.
. **Speichern** Sie die Einstellungen.
...
. Öffnen Sie das Menü **Einstellungen » Märkte » La Redoute » Kategorieverknüpfung**.
. Geben Sie in der Spalte **La Redoute-Kategorie-ID** die ID der Kategorie ein, die am besten zu Ihrer Webshop-Kategorie passt. +
...
. Wählen Sie die Option **La Redoute** aus dem Dropdown-Menü **Marktplatz**. +
→ Ein Dropdown-Menü wird im Bereich **Einstellungen** geöffnet.
. Wählen Sie das passende La Redoute-Attribut aus dem Dropdown-Menü.
...
Die Zahlungsart **La Redoute Payment** ist für Aufträge, die über den französischen Marktplatz **link:http://www.laredoute.com/[La Redoute, window="_blank"]** in Ihr plentymarkets System kommen.
...
. **Speichern** Sie die Einstellungen.
. Wechseln Sie in das Tab **Suche**.
. Suchen Sie den erstellten Kunden.
. Notieren Sie die **Kunden-ID**.
. Wechseln Sie in das Menü **Einstellungen » Märkte » La Redoute » Grundeinstellungen**.
...
Richten Sie eine **<<auftragsabwicklung/auftraege/einstellungen/ereignis-aktionen#, Ereignisaktion  >>** ein, um Versandbestätigungen automatisch an La Redoute zu senden. Die Versandbestätigung an La Redoute erfolgt automatisch mit dem Wechsel auf Status **[7] Warenausgang gebucht**. Der Käufer wird automatisch durch La Redoute über den Versand benachrichtigt.
...
Richten Sie eine **<<auftragsabwicklung/auftraege/einstellungen/ereignis-aktionen#, Ereignisaktion  >>** ein, um Retouren automatisch an La Redoute zu senden.
...
.  Wählen Sie das Format **LaRedoute** aus dem Dropdown-Menü **Vorgang**.
