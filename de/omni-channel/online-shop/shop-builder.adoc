...
[#10]
Der Shop Builder ist plentymarkets Baukastenmodul um ihren link:https://marketplace.plentymarkets.com/plugins/templates/Ceres_4697[Ceres Webshops^] schnell und einfach per Drag&Drop zu erstellen und zu bearbeiten. Dafür sind keinerlei Programmierungskenntnisse nötig.
