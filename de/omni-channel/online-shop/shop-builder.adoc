...
|*GoogleMaps*
|Stellt eine Karte zur Verfügung, um beispielsweise die Adresse Ihres Ladengeschäfts anzuzeigen. Klicken Sie auf *Bearbeiten*, um den *Google API-Schlüssel*, den Sie von link::https://cloud.google.com/maps-platform/maps/?hl=de[Google Cloud^]  erhalten, einzugeben. _*Hinweis:*_ Die GoogleMaps API ist unter Umständen kostenpflichtig. +
...
=== Inalte im ShopBuilder umbenennen
