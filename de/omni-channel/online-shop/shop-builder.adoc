...
[WARNING]
.Voraussetzungen für den Shop Builder
====
- Um den Shop Builder nutzen zu können, müssen Sie über ein gültiges SSL-Zertifikat verfügen.
...
====
Zum gegenwärtigen Zeitpunkt können ausschließlich die Startseite und Content-Kategorien Ihres Ceres Webshops über den Shop Builder bearbeitet werden. Der Funktionsumfang des Shop Builders wird nach und nach erweitert und in Zukunft wird es möglich sein, den gesamten Ceres Shop darüber zu bearbeiten.
====
...
Der Shop Builder beinhaltet Strukturelemente, die das Layout der Seite gliedern und sogenannte Widgets, also verschiedenen Seitenelemente, mit denen die Strukturelemente befüllt werden können. Die folgende Tabelle erklärt diese Elemente im Detail:
...
Der Shop Builder bietet ebenfalls die Möglichkeit, eine beliebige Schriftart einzubinden. Dazu kann entweder eine Schrift-URL eingefügt oder eine Schrift hochgeladen werden.
...
[#90]
== Optimale Bildergößen für den Shop Builder
...
.Optimale Bildergrößen für Shop Builder Widgets
[cols="a,a,a,a"]
|====
