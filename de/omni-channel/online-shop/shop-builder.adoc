...
*Kategorieebenen des Mega-Menüs* = Wählen, ob das Mega-Menü 2, 3 oder 4 Kategorieebenen anzeigt. Diese Einstellung ist nur wirksam, wenn *Mega-Men+* als *Stil der Kategorie-Navigation* gewählt wurde. +
*Anzahl der Kategorien* = Anzahl der Kategorien eingeben, die in der jeweiligen Ebene des Mega-Menüs angezeigt werden. Diese Einstellung ist nur wirksam, wenn *Mega-Men+* als *Stil der Kategorie-Navigation* gewählt wurde. +
...
*Beim Scrollen der Seite fixieren* = Aktivieren, um die Breadcrumb-Navigation immer anzuzeigen. +
...
[#100]
== Skripte im TextWidget

Um Skripte im Shop nutzen zu können, kann das script2-Tag verwendet werden. Dieses wird wie ein normales script-Tag verwendet.
Die Dokumentation des Frameworks ist link:https://github.com/taoeffect/vue-script2[hier^] zu finden.

<script2 src="https://momentjs.com/downloads/moment.js"></script2>

*Erklärung*: Hier wird ein script2-Tag nur mit dem src Attribut verwendet, um ein externes Skript zu laden.
...
*Tipp*: Externe Skripte können im Webspace hochgeladen und über den ShopBuilder eingebunden werden.
