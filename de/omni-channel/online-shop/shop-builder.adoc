...
|*Live-Shopping*
|Stellt einen Container für einen Live-Shopping-Artikel zur Verfügung. Klicken Sie auf *Bearbeiten*, um einen Titel und eine Beschreibung für den Live-Shopping-Artikel einzugeben. Unter *Live-Shopping-Auswahl* wählen Sie eins von 10 Live-Shopping-Profilen, die Sie im Menü *System » Mandant » Global » Live-Shopping* erstellen. Unter *Sortierung* wählen Sie die Sortieroption, entlang welcher die Reihenfolge bestimmt wird, in der die Varianten angezeigt werden. +
 Aktivieren Sie die Option *Timer anzeigen*, um einen ablaufenden Countdown für das Live-Shopping-Angebot anzuzeigen. Ist diese Option aktiv, können Sie ebenfalls einen *zeitabhängigen Fortschrittsbalken anzeigen*, welcher unterhalb des Countdowns angezeigt wird. Aktivieren Sie die Option *Bestand anzeigen*, um den noch verfügbaren Bestand anzuzeigen. Ist diese Option aktiv, können Sie ebenfalls einen *bestandsabhängigen Fortschrittsbalken anzeigen*

*Nochmal über Sortierung sprechen!*

Live-Shopping Auswahl
	Anmerkung: sollte in der UI mit Bindestrich geschrieben werden

Sortierung
	Es wird ja nur eins angezeigt; ist Sortierung überhaupt das richtige Wort?
	denn es werden ja nicht mehrere Einträge sortiert sondern nur das verwendete Variantenbild?
	Denn LS ist Artikel-abhängig und nicht Variantenabhängig -> Ist Sortierung überhaupt sinnvoll?

Timer anzeigen
Bestand anzeigen

Zeit- und bestandsabhängigen Fortschrittsbalken anzeigen (nur zutreffend wenn die jeweilige Checkbox darüber angehakt ist)

Streichpreis anzeigen (wo wird der hinterlegt?)Wird UVP als Streichpreis genommen=? vermutlich

BHildauswahl. wenn leer = variantenbild
