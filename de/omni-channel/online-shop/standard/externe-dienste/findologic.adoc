...
Erfahren Sie mehr über die Features der FINDOLOGIC-Suche auf unserer link:https://www.plentymarkets.eu/produkt/online-shop/webshop-erweiterungen/findologic/a-1769/[**Partnerseite**, window="_self"].
...
**link:http://www.findologic.com/pricing[FINDOLOGIC-Software bestellen, window="_blank"]**.
...
* __**URL der SOAP API WSDL**__ +
Diese URL ist im Menü **Einstellungen » Grundeinstellungen » API-Daten** unter **SOAP WSDL** zu finden. Die WSDL hat folgenden Aufbau: **http://WWW.SHOPURL.COM/plenty/api/soap/version1xx/?xml****.**(**xx** = jeweils aktuelle SOAP-Version)
...
* Die __**Logindaten**__ für den Benutzer (siehe Kapitel 2.1) +
...
image::omni-channel/online-shop/standard/externe-dienste/assets/DE-Einstell-Mandant-Std-ExtDienste-findologic-01-SI.png[]

__Bild 1: FINDOLOGIC-**Einstellungen**__

[.instruction]
FINDOLOGIC aktivieren:

. Öffnen Sie das Menü **Einstellungen » Mandant (Shop) » Standard » Dienste » FINDOLOGIC**. +
...
__Tab. 1: **FINDOLOGIC** aktivieren__
...
__**Beispiel-CSS**__ für FINDOLOGIC:

link:https://secure.findologic.com/integration/download.php?module=shops/plenty[**autocomplete.css**, window="_blank"]
...
**image::omni-channel/online-shop/standard/externe-dienste/assets/DE-Einstell-Mandant-Std-ExtDienste-findologic-02-SI.png[]**

__Bild 2: Code für Suchergebnis__
...
__**Code-Beispiel**__, das Sie für das Template verwenden können:
...
__Tab. 2: **Template-Funktionen** für FINDOLOGIC CODES__
