...
image::omni-channel/online-shop/cms-syntax/fallbeispiele/assets/DE-CMS-CheckoutIndicator.png[Fortschrittsanzeige der Bestellschritte]
...
image::omni-channel/online-shop/cms-syntax/fallbeispiele/assets/DE-CMS-Zahlungsarten.png[Einstellungen der Zahlungsarten]
