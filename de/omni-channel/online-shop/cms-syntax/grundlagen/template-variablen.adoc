...
image::omni-channel/online-shop/cms-syntax/grundlagen/assets/Globale-Template-Variablen.png[Globale Template-Variablen]
...
image::omni-channel/online-shop/cms-syntax/grundlagen/assets/Template-Variablen.png[]
