...
Ein **<<omni-channel/online-shop/cms-syntax/grundlagen/typen#6, Array >>** darf nur aus einer Dimension bestehen. Die einzelnen Werte eines Array dürfen auch von unterschiedlichen Datentypen sein.
