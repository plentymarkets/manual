...
Wenn diese Vorarbeiten geleistet sind, klicken Sie im Menü *Plugins » Plugin Übersicht* auf das Plugin *IO*.
...
|*Routen aktivieren*
|Aktivieren Sie die von Ceres verwendeten Routen. Für die Verwendung von *Ceres* müssen alle Routen aktiviert sein. Für die Verwendung des *Ceres-Checkouts* in Callisto müssen einige Routen deaktiviert werden. Nähere Informationen hierzu finden Sie in unserem <<omni-channel/online-shop/best-practices#checkout, Best Practice>>.
