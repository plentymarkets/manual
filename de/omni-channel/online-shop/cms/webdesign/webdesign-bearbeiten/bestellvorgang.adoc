...
.jQuery
====
In diesem Bereich sind jQuery-Funktionen integriert. Wenn Sie diese Funktionen anpassen oder erweitern möchten, beachten Sie die Hinweise auf der Handbuchseite <<omni-channel/online-shop/cms/webdesign/syntax/jquery#, **jQuery**  >>.
====
...
Nutzen Sie den Service von **link::/[Google Analytics]** oder anderen Tracking-Dienstleistern, wie <<omni-channel/online-shop/conversion-tracking/etracker#, **etracker**  >>, um diese Funktionen in Ihren Webshop zu integrieren.
