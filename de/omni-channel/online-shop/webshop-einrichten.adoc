...
|Den Website key von Google reCAPTCHA eingeben. Den Website key erhalten Sie, wenn Sie ihre link:https://www.google.com/recaptcha/admin#list[*Website bei Google reCAPTCHA registrieren*, window="_blank"]. Wenn *Ja* unter *Sicherheitscode in Kontaktformularen abfragen* gewählt wurde, wird das Google reCAPTCHA im Kontaktformular angezeigt. Zudem steht Google reCAPTCHA auch für das Formular <<omni-channel/online-shop/_cms/kunden-feedback, *Kunden-Feedback*>> zur Verfügung.

|Google reCAPTCHA Secret key
|Den Secret key von Google reCAPTCHA eingeben. Den Secret key erhalten Sie, wenn Sie ihre link:https://www.google.com/recaptcha/admin#list[*Website bei Google reCAPTCHA registrieren*, window="_blank"].
