...
.  Öffnen Sie das Menü *System » Mandant » Mandant öffnen » Webshop » Grundeinstellungen*.
...
. Öffnen Sie das Menü *System » Mandant » Mandant öffnen » Webshop » Webshop sperren*.
...
*_Wichtig:_* Wenn diese Funktion aktiviert ist, wird eine unter *System » Mandant » Mandant öffnen » Webshop » Seiten* als *404-Fehlerseite* hinterlegte Kategorieseite nicht angezeigt.
...
*_Wichtig:_* Wenn diese Funktion aktiviert ist, wird eine unter *System » Mandant » Mandant öffnen » Webshop » Seiten* als *Seite "Artikel nicht gefunden"* hinterlegte Kategorieseite nicht angezeigt.
|====
...
. Öffnen Sie das Menü *System » Mandant » Mandant öffnen » Webshop » Rechtliche Angaben*.
...
Die Kategorieseiten müssen im Menü <<#infoseiten,  *System » Mandant » Mandant öffnen » Webshop » Seiten*>> bzw. designspezifisch
...
Im Menü *System » Mandant » Mandant öffnen » Webshop » Seiten* verknüpfen Sie *Kategorieseiten*. Es handelt sich hier um Seiten,
...
====
Für Designs, bei denen im Menü *CMS » Webdesign » Einstellungen » Design-Einstellungen » Tab: Mandanten* Kategorieverknüpfungen vorgenommen wurden, gelten die unten beschriebenen Verknüpfungen im Menü *System » Mandant » Mandant öffnen » Webshop » Seiten* nicht. Die designspezifischen Kategorieverknüpfungen sind dominant.
====
