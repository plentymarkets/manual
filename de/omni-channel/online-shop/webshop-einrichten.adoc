...
Im Menü *plentymarkets » Einstellungen » Mandant (Shop) » Standard » Webshop » Grundeinstellungen* konfigurieren Sie die grundlegenden Einstellungen Ihres Webshops.
...
Informationen zu Favicons z.B. unter link:http://de.wikipedia.org/wiki/Favicon[*Wikipedia*, window="_blank"].
...
|Den Websiteschlüssel von Google reCAPTCHA eingeben. Den Schlüssel erhalten Sie, wenn Sie ihre link:https://www.google.com/recaptcha/admin#list[*Website bei Google reCAPTCHA registrieren*, window="_blank"]. Wenn *Ja* unter *Sicherheitscode in Kontaktformularen abfragen* gewählt wurde, wird das Google reCAPTCHA im Kontaktformular angezeigt. Zudem steht Google reCAPTCHA auch für das Formular <<omni-channel/online-shop/_cms/kunden-feedback, *Kunden-Feedback*>> zur Verfügung.

|*Google reCAPTCHA Geheimer Schlüssel*
|Den geheimen Schlüssel von Google reCAPTCHA eingeben. Den Schlüssel erhalten Sie, wenn Sie ihre link:https://www.google.com/recaptcha/admin#list[*Website bei Google reCAPTCHA registrieren*, window="_blank"].
...
*_Hinweis:_* Wenn hier keine URL eingetragen wird, erfolgt keine Weiterleitung von Preisportalen etc. zu den Artikeln im Webshop.
|====
...
*_Wichtig:_* Wenn diese Funktion aktiviert ist, wird eine unter *Einstellungen » Mandant (Shop) » Standard » Webshop » Seiten* als *404-Fehlerseite* hinterlegte Kategorieseite nicht angezeigt.
...
*_Wichtig:_* Wenn diese Funktion aktiviert ist, wird eine unter *Einstellungen » Mandant (Shop) » Standard » Webshop » Seiten* als *Seite "Artikel nicht gefunden"* hinterlegte Kategorieseite nicht angezeigt.
|====
...
_Bild 1: *Template-Variablen* für *AGB* in der Kategorieseite einbinden_
...
====
Wenn Sie Template-Variablen oder -Funktionen in Ihr Design eingefügt haben, veröffentlichen Sie Ihr Design neu. Dies erfolgt im Menü <<omni-channel/online-shop/cms#webdesign-benutzeroberflaeche, *CMS » Webdesign*>>.
====
...
_Bild 2: Die Zuordnung der Kategorieseiten Ihres Webshops_
...
|*Seite 404*
|Eine <<artikel/kategorien/kategorietyp-content-bearbeiten#, *Kategorieseite*>> wählen, um diese statt der Standard-404-Seite anzuzeigen. +
...
|Eine <<artikel/kategorien/kategorietyp-content-bearbeiten#, *Kategorieseite*>> wählen, um diese statt der Standardmeldung anzuzeigen, wenn ein Artikel nicht gefunden wird.
