...
====
Wenn Sie Template-Variablen oder -Funktionen in Ihr Design eingefügt haben, veröffentlichen Sie Ihr Design neu. Dies erfolgt im Menü <<omni-channel/online-shop/webshop-einrichten/cms#webdesign-benutzeroberflaeche, CMS » Webdesign>>.
====
