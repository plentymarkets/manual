...
|*Seite 404*
|Eine <<artikel/kategorien-verwalten#, *Kategorieseite*>> wählen, um diese statt der Standard-404-Seite anzuzeigen. +
...
|Eine <<artikel/kategorien-verwalten#, *Kategorieseite*>> wählen, um diese statt der Standardmeldung anzuzeigen, wenn ein Artikel nicht gefunden wird.
