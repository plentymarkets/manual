...
Diese Handbuchseite gibt einen Überblick darüber, welche ElasticSearch *Ergebnisfelder* genutzt werden können, um auf Informationen zuzugreifen, für die es im ehemaligen Webshop Callisto <<omni-channel/online-shop/webshop-einrichten/cms-syntax#_globale_template_variablen_2, Template-Variablen>> gab.
...
[cols="1,1,1"]
|====
|ES-Result |Template-Variable | Erläuterung
...
|calculatedPrices.prices.default.price.value
|$Price
|Beinhaltet den Preis des Artikels. TODO: bedeutet Preis hier WERT oder INKL Währungszeichen?
...
|variation.weightG
|$Weight
|Beinhaltet das Artikelgewicht

|variation.weightNetG
|$WeightNet
|Beinhaltet das Netto-Gewicht eines Artikels
