...
Sie entscheiden, ob Sie die relative oder die absolute URL verwenden. Eine kurze Erläuterung zu den Typen finden Sie auf der Handbuchseite **<<omni-channel/online-shop/_cms-syntax/fallbeispiele/seo-guide#40, URL-Info >>**.
