...
Die Sprache ist eine Pflichtangabe und muss vor der Kategorie gewählt werden. Die Sprachen, die zur Auswahl stehen, werden im Menü **<<omni-channel/mandant-shop/standard/module/blog-weblog#, System » Mandant » Mandant öffnen » Module » Blog>>** angelegt. Die Blogbeiträge können auch anhand der Sprache gefiltert werden.

|**Kategorie**
|Eine Kategorie für den Blogbeitrag wählen.  +
Die Kategorie ist eine Pflichtangabe. Blogkategorien werden im Menü **<<omni-channel/mandant-shop/standard/module/blog-weblog#, System » Mandant » Mandant öffnen » Module » Blog>>** erstellt. +
