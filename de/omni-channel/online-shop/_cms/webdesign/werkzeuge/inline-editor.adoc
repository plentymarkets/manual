...
|**SetCategoryId**
| Gibt innerhalb eines anderen Bereiches des Webshops den Inhalt der geöffneten Kategorie aus. Weitere Details dazu finden Sie auf der Handbuchseite **<<omni-channel/online-shop/_cms-syntax/webdesign/pagedesign/setcategoryid#, SetCategoryId  >>**.
