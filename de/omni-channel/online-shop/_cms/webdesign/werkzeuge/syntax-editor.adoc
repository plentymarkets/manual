...
Emmet ist eine Syntax-Sprache, die CSS-ähnliche Anweisungen in HTML-Code übersetzt. Es können damit sowohl einfache, als auch komplexe HTML-Strukturen sehr schnell erzeugt werden. Die <<omni-channel/online-shop/_cms/webdesign/syntax#, **Syntax**  >> muss ggf. erlernt werden. Für Benutzer, die sich mit <<omni-channel/online-shop/_cms/webdesign/webdesign-bearbeiten/css#, **CSS**  >> oder <<omni-channel/online-shop/_cms/webdesign/syntax/jquery#, **jQuery**  >> auskennen, wird es nicht viel neues sein. Wenn Sie oft und viel HTML schreiben müssen, lohnt es sich auf jeden Fall, wenn Sie sich das einmal ansehen!
