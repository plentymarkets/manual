...
Für die acht Bestellschritte des Individuellen Bestellvorgangs in **Callisto Light** sind in den **<<omni-channel/online-shop/_cms/webdesign/webdesign-bearbeiten#, Design-Einstellungen  >>** Kategorien verknüpft (Bild 2).
