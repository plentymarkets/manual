...
====
Kategorieseiten verknüpfen Sie auch im Menü **System » Mandant » Mandant öffnen » Webshop » Seiten**. Die dort vorgenommenen Verknüpfungen gelten für alle Designs eines Mandanten. Wenn Sie für ein Design wie unten beschrieben Kategorieseiten verknüpfen, haben die designspezifischen Verknüpfungen Vorrang.
====
