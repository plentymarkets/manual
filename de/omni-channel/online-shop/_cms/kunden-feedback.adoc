...
Richten Sie das Modul zunächst im Menü <<omni-channel/mandant-shop/globale-einstellungen/kunden-feedback#, **System » Mandant (Shop) » Global » Feedback**>> ein und aktivieren Sie Bewertungen für die gewünschten Bereiche.
