...
|*Primary colour*
| Wählen Sie die Primärfarbe Ihres Webshops. Nutzen Sie hierfür entweder den Farbwähler oder geben Sie einen entsprechenden Hex-Wert ein.

|*Secondary colour*
| Wählen Sie die Sekundärfarbe Ihres Webshops. Nutzen Sie hierfür entweder den Farbwähler oder geben Sie einen entsprechenden Hex-Wert ein.

|*Success colour*
| Wählen Sie die Farbe für Erfolgsmeldungen, die in Ihrem Webshop angezeigt werden. Nutzen Sie hierfür entweder den Farbwähler oder geben Sie einen entsprechenden Hex-Wert ein.

|*Information colour*
| Wählen Sie die Farbe für Informationshinweise, die in Ihrem Webshop angezeigt werden. Nutzen Sie hierfür entweder den Farbwähler oder geben Sie einen entsprechenden Hex-Wert ein.

|*Warning colour*
| Wählen Sie die Farbe für Warnhinweise, die in Ihrem Webshop angezeigt werden. Nutzen Sie hierfür entweder den Farbwähler oder geben Sie einen entsprechenden Hex-Wert ein.

|*Danger colour*
| Wählen Sie die Farbe für Gefahrhinweise, die in Ihrem Webshop angezeigt werden. Nutzen Sie hierfür entweder den Farbwähler oder geben Sie einen entsprechenden Hex-Wert ein.
