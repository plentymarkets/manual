...
Mit der Blog-Funktion veröffentlichen Sie Text- und Bild-Beiträge in ihrem Ceres Webshop, mit denen Sie Ihre Kunden über Neuerungen, Änderungen oder andere interessante Themen informieren können. Über das Menü *CMS » Blog* können Sie Blogeinträge erstellen, bearbeiten und löschen. Die Blog-Funktion wurde komplett überarbeitet und ist nun intuitiver, leichter bedienbar und optimal für SEO aufgestellt.

[IMPORTANT]
====
Die Blog-Funktion für Ceres Webshops befindet sich gegenwärtig in der Betaphase.
====
...
. Nehmen Sie die Einstellungen vor und geben Sie Ihre Inhalte ein. Beachten Sie die Erläuterungen in <<tablle-neuer-blogeintrag>>
. *Speichern* Sie die Einstellungen.
...
|*Autor*
|Autor des Blogeintrags auswählen. Dieser wird XXXX (wo?) angezeigt.

|*Tags*
|Tags über den Tagpicker auswählen, um den Blogeintrag mit Schlagworte zu verknüpfen. Sie erstellen neue Tags im Menü *System » Einstellungen » Tags*.
...
// brauchen wir hier noch einen kurzen Erkläuterungsatz?

  - Toolbar erklären (Neuer Blogeintrag, Vorschaumodus für die Übersicht, Blogeinträge löschen;;; die anderen 2 Optionen copy und export sind future mvp)

- Neuer Blog Oberfläche:


  - Editor fenster:
    - H1 Titel + Vorschautext
    - Body
    - Im Body kann ich weitere Bilder hinterlegen, über das Bildericon
// muss ich erklären welches Icon das ist? Oder ist das intuitiv?




MISC:
    - Autor ist z.Zt. nicht frei konfigurierbar; der Erstellende ist momentan noch automatisch als Autor zugewiesen
    - Blogkategorien werden unter Artikel » Kategorien angelegt
    - Auf jeden Fall nochmal überprüfen ob das ganze als Plugin funktioniert - tut es! Ich hab nur die Freigabe noch nicht.
    - Ceres Header Konfi9guration (Blog-Kategorien)
    - Blog-Button beschreiben // sprich: "Zurück zum Shop" o.Ä.
    -

// Was mache ich hier mit den ganzen misc Informationen? stelle ich die als zusätzliche Informationen zur Verfügung oder ignorier ich das oder feede ich das mit in die einzelnen Unterkapitel?
