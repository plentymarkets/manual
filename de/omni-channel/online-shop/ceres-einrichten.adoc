...
====
Installierte Plugins werden nach Position geladen. Das Plugin mit der niedrigsten Position steht in der Plugin-Liste ganz oben und wird zuerst geladen. Das Plugin mit der höchsten Positionsnummer steht in der Liste an letzter Stelle und wird auch zuletzt geladen. Die Plugin-Position ist besonders beim Webshop-Plugin *IO* zu beachten, damit sämtliche Routen des Webshops korrekt aufgerufen werden.
====
...
|Aktivieren, um die in Callisto verwendete URL-Struktur in Ceres zu nutzen. Dies ist beispielsweise nötig, um die link:https://forum.plentymarkets.com/t/howto-ceres-checkout-fuer-callisto-einrichten/69276[Kaufabwicklung aus Ceres mit Callisto^] zu nutzen.
