...
====
Der Shop Builder ist erst ab Version 2.8.0 von Ceres und IO verfügbar. Sollten Sie eine ältere Version benutzen, besuchen Sie den link:https://marketplace.plentymarkets.com[plentyMarketplace^], um die jeweils aktuelle Version zu installieren.
====
