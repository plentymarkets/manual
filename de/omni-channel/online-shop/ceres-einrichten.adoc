...
*Ceres* wird mit einer Standard-Startseite ausgeliefert. Passen Sie diese Startseite mit dem <<omni-channel/online-shop/shop-builder#10, Shop Builder>> an, um eigene Inhalte auf der Startseite anzuzeigen. Deaktivieren Sie die Standard-Startseite, um diese mit der Shop Builder Startseite zu ersetzen.
...
Informationen zur Einrichtung des Shop Builders finden Sie auf der Shop Builder <<omni-channel/online-shop/shop-builder#10, Handbuchseite>>.
