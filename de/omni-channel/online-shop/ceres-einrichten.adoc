...
|Seitenzahl angeben, ab der Suchmaschinen die Suchergebnisse nicht weiter auf den Index setzen.
...
* [ ] Haben Sie eine Ereignisaktion eingerichtet, über welche die Bestellbestätigung automatisch versendet wird?
