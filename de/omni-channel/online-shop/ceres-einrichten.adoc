...
|*ID der Artikelvariante, die auf der ersten/zweiten/dritten Folie des Image Sliders angezeigt wird*
|ID der Variante eines Artikels eingeben, die auf der ersten/zweiten/dritten Folie des Image Sliders angezeigt wird. Wird keine ID eingegeben, sondern nur eine URL, dann wird nur das Bild im Slider angezeigt. Wird nur eine ID und keine URL eingegeben, dann wird das erste Bild der Artikelvariante im Slider angezeigt.

|*URL des Artikelbildes auf der ersten/zweiten/dritten Folie*
...
|*URL des Artikelbildes in der oberen/unteren Artikelvorschau*
...
|*Artikelkategorie, die in der ersten/zweiten/dritten/vierten Kategorievorschau angezeigt wird*
...
|*Artikelkategorie für die erste/zweite Artikelliste*
...
|*Titelleiste*
|Stellt eine Textbox zur Verfügung. Klicken Sie auf *Bearbeiten*, um Text einzugeben.
...
|*Artikelliste*
|Stellt die <<omni-channel/online-shop/ceres-einrichten#110, Ceres Artikelliste>> zur Verfügung. Klicken Sie auf *Bearbeiten*, um Bilder hinzuzufügen oder zu entfernen.
|====
