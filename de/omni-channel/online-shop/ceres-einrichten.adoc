...
→ Das Plugin wird geöffnet.
. Klicken Sie im Verzeichnisbaum auf *Konfiguration*.
. Wechseln Sie in das Tab *Registration* bzw. *Logging and performance*.
...
|Reguläre Ausdrücke für E-Mail-Validierung eingeben.

|*The RegEx used for the password*
|Reguläre Ausdrücke für Passwort-Validierung eingeben.
