...
*Ein Overlay des Warenkorbs anzeigen* = Ein Overlay des Warenkorbs anzeigen. +
*Warenkorbvorschau ein- und ausblenden* = Die Warenkorbvorschau ein- und ausblenden. +
*Keine Informationen anzeigen* = Keine Informationen anzeigen.

|*Art der Warenkorbvorschau*
|Wählen, welche Art der Warenkorbvorschau angezeigt wird. +

*Rechts einblenden* = Die Warenkorbvorschau wird auf der rechten Seite eingeblendet.
*Dropdown bei Mouse-over* = Die Warenkorbvorschau wird bei Mouse-Over über dem Warenkorbsymbol eingeblendet.
...
|Position der Paginierung wählen. +

*Oberhalb der Artikelliste* = Paginierung oberhalb der Artikelliste anzeigen. +
*Unterhalb der Artikelliste* = Paginierung unterhalb der Artikelliste anzeigen. +
*Oberhalb und unterhalb der Artikelliste* = Paginierung oberhalb und unterhalb der Artikelliste anzeigen.
...
|*Sekundärfarbe*
| Wählen Sie die Sekundärfarbe Ihres Webshops. Diese bestimmt die Farbgebung der Kategorienvorschau, die Sie in der Ceres-Konfiguration der <<#50, Homepage>> in den Feldern *Category to display in the first/second category preview* verknüpfen. Geben Sie hierfür einen entsprechenden Hex-Wert ein.
