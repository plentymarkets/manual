...
Auf dieser Handbuchseite erfahren Sie, wie Sie <<#10, Ceres einrichten>> und wie Sie <<#1000, Ceres individualisieren>>.
Nachdem die <<#15, Voraussetzungen>> für Ceres-Shops gelistet wurden, führen die folgenden Kapitel durch die Einrichtung der einzelnen Tabs der <<#20, Ceres Konfiguration>>.
...
- im Menü *Plugins » Einkäufe* <<basics/erste-schritte/plugins#90, installieren>>
- im Menü *Plugins » Plugin-Übersicht* mit <<basics/erste-schritte/schnelleinstieg#560, Positionsnummern>> versehen
- im Menü *Plugins » Plugin-Übersicht* <<basics/erste-schritte/plugins#60, bereitstellen>>
...
Wenn beide Plugins als Plugin Set bereitgestellt sind, können Sie mit der Einrichtung Ihres Ceres-Webshops beginnen.
...
|Bilddatei des Favicons auswählen. Das Favicon kann auf der rechten Seite über den Button *Datei wählen* hochgeladen werden. Die Bilddatei muss eine *.ICO*-Datei sein.
...
Nach dem Speichern der Content-Kategorie wird das Plugin *CategoryTemplates* im Menü *Plugin » Plugin-Übersicht* verfügbar. Das Plugin Set muss über den Button *Speichern & Plugin Set bereitstellen* bereitgestellt werden. Anschließend verknüpfen Sie die Kategorie in den Einstellungen von *Ceres*:
...
. Wählen Sie die zuvor erstellte Kategorie, um diese für die Anzeige der Informationen zu Versandkosten zu verknüpfen.
. Klicken Sie auf *Auswählen*.
. *Speichern* Sie die Einstellungen. +
→ Die Kategorie wird verknüpft.

Nach dem Verknüpfen der Kategorie muss das Plugin *CategoryTemplates* im Plugin Set *aktiv* geschaltet und über den Button *Speichern & Plugin Set bereitstellen* bereitgestellt werden.

[#50]
=== Standard-Startseite deaktivieren

*Ceres* wird mit einer Standard-Startseite ausgeliefert. Passen Sie diese Startseite mit dem <<#65, Shop Builder>> an, um eigene Inhalte auf der Startseite anzuzeigen. Deaktivieren Sie die Standard-Startseite, um diese mit der Shop Builder Startseite zu ersetzen.
...
|Deaktivieren, um eigene Änderungen an der Startseite anzuzeigen. Wenn diese Option aktiv ist, wird eine Standard-Startseite angezeigt und Änderungen werden ignoriert.
...
Mit dem Shop Builder können Sie die Startseite Ihres link:https://marketplace.plentymarkets.com/plugins/templates/Ceres_4697[Ceres Webshops^] mit wenigen Handgriffen in Ihrem Terra-Backend erstellen und bearbeiten.
...
Der Shop Builder beinhaltet Strukturelemente und Seitenelemente. Bei den Strukturelementen gibt es vorgegebene Raster der Widgets mit zwei, drei oder vier Platzhaltern. Die Seitenverhältnisse können über den Bearbeitungsstift beliebig verändert werden und Strukturelemente mit drei oder vier Platzhaltern können außerdem in der Ansicht gestapelt werden.
...
Nach dem Speichern der Kategorie wird das Plugin *CategoryTemplates* im Menü *Plugin » Plugin-Übersicht* verfügbar. Das Plugin muss für ein Plugin Set aktiviert und bereitgestellt werden. Anschließend verknüpfen Sie die Kategorie in den Einstellungen von *Ceres*.
...
|IDs der <<#75, Kategorien>> vom Typ *Content* eingeben, die in der ersten/zweiten/dritten Spalte im Footer des Webshops angezeigt werden. +
...
*Dynamisch* = Wählen, um Varianten dynamisch anzuzeigen. Bei der Auflistung der Varianten werden sowohl aktive Haupt- als auch aktive Untervarianten berücksichtigt. Die Anzeige der Varianten in der Artikelliste ist dabei abhängig von der gewählten Sortierungoption im Frontend.
...
*Verschwommene Ladeanimation* = Die Kategorieansicht wird beim Laden kurz verschwommen dargestellt. +
*Ladeanimation mit Balken* = Beim Laden der Kategorieansicht wird eine Ladeanimation mit Balken angezeigt. +
*Ladeanimation mit Spinner* = Beim Laden der Kategorieansicht wird eine Ladeanimation mit Spinner angezeigt.
...
|Anzahl der zuletzt gesehenen Artikel wählen, die in Artikellisten vom Typ *Last seen* angezeigt werden.
...
|Typ der Artikelliste wählen. Sie bearbeiten die *Titel* Ihrer Artikellisten im Menü *CMS » Mehrsprachigkeit*. +
...
Im Tab *Pagination und Sorting* passen Sie die Paginierung, also die Seitennummerierung, der Artikelübersicht und die Sortierung von Artikeln im Webshop an.
...
→ Das Plugin wird geöffnet.
. Klicken Sie im Verzeichnisbaum auf *Konfiguration*.
. Wechseln Sie in das Tab *Pagination und Sorting*.
...
Im Tab *Währungen* finden Sie Einstellungen für Verfügbarkeit und Anzeige von Währungen in Ihrem Webshop. Hier legen Sie z.B. fest, ob Ihre Kunden die Währung im Webshop ändern dürfen und stellen ein, welche Währungen verfügbar sind und wie diese dargestellt werden.
...
====
Beachten Sie, dass Änderungen an den Designeinstellungen ein erneutes Bereitstellen des Plugin Sets erfordert, bevor diese im Webshop angezeigt werden können.
====

[#207]
=== Einstellungen für Plugin-Entwickler

Im Tab *Logging und Performance* stehen insbesondere für Plugin-Entwickler Einstellungsmöglichkeiten zur Verfügung. Hier stellen Sie beispielsweise ein, welche Informationen bei der Plugin-Entwicklung protokolliert werden sollen und welchen Modus Sie für den Webshop verwenden möchten.
...
Im Menü *CMS » Mehrsprachigkeit* verwalten Sie sprachabhängige Texte Ihres Webshops, z.B. den Webshopnamen oder SEO-relevante Meta-Beschreibungen. Wählen Sie links oben aus der Dropdown-Liste den *Mandanten*, für den Sie Textelemente bearbeiten möchten.
...
Für jede <<#220, aktivierte Webshop-Sprache>> stellen Sie ein Standardlieferland ein. Beim Wechsel der Sprache in *Ceres* wechselt automatisch das Lieferland im Header und in der Kaufabwicklung. Wie Sie Lieferländer einrichten, erfahren Sie unter <<auftragsabwicklung/fulfillment/versand-vorbereiten#100, Lieferländer einrichten>>.
...
Richten Sie dazu zunächst Attribute und Merkmale ein und verknüpfen diese mit Ihren Artikeln.
