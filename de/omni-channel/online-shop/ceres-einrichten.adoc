...
Ab Ceres Version 2.15 können die Verlinkungen zu Ihren rechtlichen Angaben im <<omni-channel/online-shop/shop-builder#10, Shop Builder>> über das Widget *Rechtliche Informationen* im Footer angepasst werden.
...
Sie passen die Startseite Ihres Shops mit dem <<omni-channel/online-shop/shop-builder#10, Shop Builder>> an. Deaktivieren Sie die Standard-Startseite, damit diese mit der Shop Builder Startseite ersetzt wird.
...
. Aktivieren Sie die Einstellung *Shop Builder Startseite anzeigen*.
. *Speichern* Sie die Einstellungen. +
...
[NOTE]
====
Die Einstellungen an Header und Footer greifen nur bis Ceres 2.14. Ab Ceres 2.15 richten Sie Header und Footer über den <<omni-channel/online.shop/shop-builder#10, Shop Builder>> ein.
====
