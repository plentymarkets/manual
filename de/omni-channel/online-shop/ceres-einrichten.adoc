...
Der Shop Builder beinhaltet sowohl Struktur- als auch Seitenelemente. Bei den Strukturelementen gibt es vorgegebene Raster der Widgets mit zwei, drei oder vier Spalten. Die Seitenverhältnisse können über den Bearbeitungsstift beliebig verändert werden und Strukturelemente mit drei oder vier Spalten können außerdem in der Ansicht gestapelt werden.
