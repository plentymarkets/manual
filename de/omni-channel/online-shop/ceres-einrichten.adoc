...
Die folgenden Kapitel behandeln Websop-relevante Einstellungen, die Sie nicht über die Ceres-Konfiguration anpassen können. Hierzu gehören beispielsweise die <<#321, Bearbeitung von Webshop-Texten>>, die Einrichtung von <<#330, Filtern>> und <<#340, Bestellmerkmale>>.
