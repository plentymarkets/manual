...
Nach dem Speichern der Kategorie wird das Plugin *CategoryTemplates* im Menü *Plugin » Plugin-Übersicht* verfügbar. Das Plugin Set muss über deen Button *Speichern und Plugin Set bereitstellen* bereitgestellt werden. Anschließend verknüpfen Sie die Kategorie in den Einstellungen von *Ceres*.
