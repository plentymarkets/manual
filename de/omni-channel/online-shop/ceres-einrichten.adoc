...
Gehen Sie wie im Folgenden beschrieben vor, um Einstellungen an Ihrem Design vorzunehmen, für die keine Programmierkenntnisse erforderlich sind.
...
Im Tab *Global* nehmen Sie Einstellungen vor, die sich auf das gesamte Template auswirken. Hier richten Sie außerdem die Kontaktseite für Ihren Webshop und das Kontaktformular für Kundenanfragen ein.
...
Im Tab *Global* verknüpfen Sie eine Kategorie, mit der Sie Informationen zu Ihren Versandkosten im Webshop anzeigen. Erstellen Sie dafür zunächst eine Kategorie vom Typ *Content*.
...
|Aktivieren, um die mit dem <<omni-channel/online-shop/shop-builder#, Shop Builder>> erstellte Startseite anzuzeigen.

|*Standardstartseite anzeigen*
|Deaktivieren, um eigene Änderungen an der Startseite anzuzeigen. Wenn diese Option aktiv ist, wird eine Standard-Startseite angezeigt und vorgenommene Änderungen werden ignoriert.
...
|*Tags: Sortierung*
|<<#191, Sortieroption>> wählen, die bei der Sortierung der Tag-Artikelliste voreingestellt ist.
...
Eine vollständige Auflistung und Erläuterung der verfügbaren Container finden Sie in unserer englischsprachigen link:https://developers.plentymarkets.com/dev-doc/template-containers[Entwicklerdokumentation^]. Diese richtet sich primär an erfahrenere Nutzer und ist für eine Basiseinrichtung von Ceres nicht notwendig.
...
Stellen Sie die Standardzahlungsart für Ihren Webshop ein. Nur link:https://marketplace.plentymarkets.com/plugins/payment[Plugin-Zahlungsarten^] können in *Ceres* verwendet werden. Zahlungsarten stehen nach ihrer Einrichtung als Standardzahlungsart zur Verfügung.
...
Über Bestellmerkmale ermöglichen Sie Ihren Kunden die Eingabe eines Textes bei der Bestellung des verknüpften Artikels. Kunden können z.B. einen Wunschtext angeben, der auf den Artikel gedruckt werden soll. Richten Sie dazu Merkmale ein und verknüpfen Sie die Merkmale mit Ihren Artikeln. Weitere Informationen zu Merkmalen finden Sie unter <<artikel/artikel-verwalten#480, Merkmale verwalten>>.
