...
====
Wenn Sie die Template-Plugins *Ceres* und *IO* <<basics/erste-schritte/plugins#50, in Productive bereitstellen>>, ist der alte plentymarkets Webshop Callisto nicht mehr erreichbar, da *Ceres* die URL des Webshops übernimmt.
====
...
- im Menü *Plugins » Einkäufe* <<basics/erste-schritte/schnelleinstieg#550, installieren>>
- im Menü *Plugins » Plugin-Übersicht* mit <<basics/erste-schritte/schnelleinstieg#560, Positionsnummern>> versehen
- im Menü *Plugins » Plugin-Übersicht* <<basics/erste-schritte/schnelleinstieg#560, bereitstellen>>
...
Wenn beide Plugins bereitgestellt sind, können Sie mit der Einrichtung Ihres Ceres-Webshops beginnen.
...
Nach dem Verknüpfen der Kategorie muss das Plugin *CategoryTemplates* nochmal in Stage oder Productive bereitgestellt werden.
