...
|IDs der <<omni-channel/online-shop/ceres-einrichten#75, **Kategorien** >> vom Typ **Content** eingeben, die in der ersten Spalte im Footer des Webshops angezeigt werden. +
...
|IDs der <<omni-channel/online-shop/ceres-einrichten#75, **Kategorien** >> vom Typ **Content** eingeben, die in der zweiten Spalte im Footer des Webshops angezeigt werden. +
**__Hinweis:__** Mehrere IDs kommasepariert eingeben.
...
|IDs der <<omni-channel/online-shop/ceres-einrichten#75, **Kategorien** >> vom Typ **Content** eingeben, die in der dritten Spalte im Footer des Webshops angezeigt werden. +
**__Hinweis:__** Mehrere IDs kommasepariert eingeben.
...
In unserem link:https://developers.plentymarkets.com/dev-doc/theme-plugins[Theme Guide, window="_blank"] finden Sie ausführliche Infomationen darüber, wie Sie Ihr eigenes Theme-Plugin erstellen und **Ceres** damit vollständig individualisieren.
