...
|*Primary colour*
| Wählen Sie die Primärfarbe Ihres Webshops. Geben Sie hierfür einen entsprechenden Hex-Wert ein.

|*Secondary colour*
| Wählen Sie die Sekundärfarbe Ihres Webshops. Geben Sie hierfür einen entsprechenden Hex-Wert ein.
