...
Wenn Sie Ihren Kunden die Möglichkeiten bieten möchten, sich über *Facebook-Zugangsdaten* in Ihren *Webshop einzuloggen*, können Sie dies wie nachfolgend beschrieben einrichten. Um die Funktion verwenden zu können, benötigen Sie eine eingerichtete *Facebook-App*. Zur Verlinkung zu Facebook hinterlegen Sie dann Ihre Facebook-Zugangsdaten, wie nachfolgend beschrieben.
