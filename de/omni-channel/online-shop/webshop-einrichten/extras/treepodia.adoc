...
|*Video abspielen*
|Wenn Sie einen Text für einen *Button* zum *Abspielen des Videos* eintragen, wird dieser angezeigt. Tragen Sie z.B. *Video abspielen* ein (<<bild-einstellungen-treepodia>>).

|*Video posten*
|Wenn Sie einen Text für einen *Button* zum *Posten des Videos* eintragen, wird dieser angezeigt. Tragen Sie z.B. *Video teilen* ein (<<bild-einstellungen-treepodia>>).
