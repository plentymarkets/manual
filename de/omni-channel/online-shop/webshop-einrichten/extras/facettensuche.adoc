...
Die Konfiguration besteht aus mehreren Schritten. Zunächst werden Facetten angelegt, anschließend durch weitere Einstellungen näher bestimmt und schließlich mit den gewünschten Werten verknüpft. Zudem muss im Menü *System » Mandant » Mandant wählen » Webshop » Artikelsuche* die Option *Facettensuche* eingestellt sein.
