...
Die angelegten Werte werden nun links aufgelistet. Bestimmen Sie die Werte in den folgenden Schritten näher und verknüpfen Sie sie mit Informationen aus Ihrem System. Im Beispiel des Typs *Attribut/Merkmal* ist besonders praktisch, dass Attribute, Merkmale und Eigenschaften in Ihrem System in einem Filter zusammengefasst und so zusammen in einem Ergebnis ausgegeben werden können.
