...
Im Menü *plentymarkets » Einstellungen » Mandant (Shop) » Standard » Webshop » Multilingualismus* können Sie den *Bestellvorgang* und auch das *Webshop-Layout* sowie die *Artikelbeschreibungen* in verschiedenen Sprachen anlegen.
