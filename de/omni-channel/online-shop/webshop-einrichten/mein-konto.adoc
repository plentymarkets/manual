...
image::omni-channel/online-shop/webshop-einrichten/assets/DE-Einstell-Mandant-Std-MeinKonto-Grundeinstell-01.png[]
...
_*Info*_: Das entsprechende Untermenü im Bereich <<omni-channel/online-shop/webshop-einrichten/cms#webdesign-webdesign-bearbeiten-mein-konto, CMS » Webdesign » Mein Konto>> wird erst sichtbar, wenn diese Funktion aktiviert ist.
...
_*Tipp*_: Die Option *Artikelpreis mit Stern(*)* kann eingesetzt werden, wenn unter dem Stern ein Hinweis zum Artikelpreis erscheinen soll, z. B. auf die MwSt. +
_*Info*_: Die Option *Preis mit MwSt. und Versand* ist z. B. für eine Trusted Shops-Zertifizierung nötig.
...
_*Wichtig*_: Bei aktivierter Anzeige, sollte die Einstellungen der Zahlenformate unter <<_includes/presets/zahlenformate#, System » Einstellungen » Zahlenformate>> geprüft werden. Wenn hier beispielsweise *in Kilogramm: keine Nachkommastelle* eingestellt ist, werden Gewichte unter 1000 Gramm als 0 angezeigt.
