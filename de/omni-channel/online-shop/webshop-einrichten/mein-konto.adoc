...
Das Menü **System » Mandant » Mandant öffnen » Mein Konto » Einstellungen** enthält Grundeinstellungen
...
Im Menü **System » Mandant » Mandant öffnen » Mein Konto » Auftragsinformationen** hinterlegen Sie Einstellungen, die die Sichtbarkeit von Informationen in Aufträgen steuern.

[.instruction]
Auftragsinformationen konfigurieren:

. Öffnen Sie das Menü **System » Mandant » Mandant öffnen » Mein Konto » Auftragsinformationen**.
