...
Das Menü **System » Mandant (Shop) » Standard » Mein Konto » Einstellungen** enthält Grundeinstellungen
...
Im Menü **System » Mandant (Shop) » Standard » Mein Konto » Auftragsinformationen** hinterlegen Sie Einstellungen, die die Sichtbarkeit von Informationen in Aufträgen steuern.

[.instruction]
Auftragsinformationen konfigurieren:

. Öffnen Sie das Menü **System » Mandant (Shop) » Standard » Mein Konto » Auftragsinformationen**.
