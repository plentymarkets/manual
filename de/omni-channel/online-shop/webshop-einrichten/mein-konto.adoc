...
__*Wichtig*__: Bei aktivierter Anzeige, sollte die Einstellungen der Zahlenformate unter <<_includes/presets/zahlenformate#, System » Einstellungen » Zahlenformate>> geprüft werden. Wenn hier beispielsweise *in Kilogramm: keine Nachkommastelle* eingestellt ist, werden Gewichte unter 1000 Gramm als 0 angezeigt.
