...
* $AttributeSelect — Beinhaltet pro Attribut eine Dropdown-Liste mit den Attributwerten eines Artikels. Der Attributname wird oberhalb des Dropdown-Listen angezeigt. Die Attributwerte stehen in der Dropdown-Liste zur Auswahl.
