...
* <<omni-channel/online-shop/webshop-einrichten/cms-syntax#webdesign-pagedesign-emaildirid, EMailDirID>> — Gibt das Dropdown-Menü für die Auswahl des Newsletter aus.
