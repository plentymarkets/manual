...
* $BankAccount — Beinhaltet die im Menü *System » Einstellungen » Bank* eingetragene Kontonummer.
* $BankAccountOwner — Beinhaltet den im Menü *System » Einstellungen » Bank* eingetragenen Kontoinhaber.
* $BankCode — Beinhaltet die im Menü *System » Einstellungen » Bank* eingetragene Bankleitzahl.
* $BankIban — Beinhaltet die im Menü *System » Einstellungen » Bank* eingetragene IBAN.
* $BankName — Beinhaltet den im Menü *System » Einstellungen » Bank* eingetragenen Namen der Bank.
* $BankSwift — Beinhaltet den im Menü *System » Einstellungen » Bank* eingetragenen BIC.
...
* $GeneralTermsAndConditions — Beinhaltet die im Menü *System » Mandant » Mandant wählen » Webshop » Rechtliches* hinterlegten AGB des Webshops.
...
* $PrivacyPolicy — Beinhaltet die im Menü *System » Mandant » Mandant wählen » Webshop » Rechtliches* hinterlegte Datenschutzrichtlinie des Webshops.
...
* $ShowNetPrices
* $SocialMedia — Beinhaltet die URLs der sozialen Medien, die im Menü *System » Mandant » Mandant wählen » Externe Dienste » Social Media*, hinterlegt sind. Jedoch sind diese URLs nur beinhaltet, wenn *aktiv* für Social Media eingestellt wurde.
* $StoreCountryID
