...
Eigene Variablen sind nur in dem Template (z.B. PageDesignContent, ItemViewSingleItem), in dem die Variablen definiert wurden, gültig. Sie können in unterschiedlichen Templates eigene Variablen mit gleichem Namen definieren, ohne dass dies zu einem Konflikt führt.
