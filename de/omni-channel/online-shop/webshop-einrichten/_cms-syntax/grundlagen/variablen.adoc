...
Eigene Variablen sind nur in dem Template (z.B. PageDesignContent, ItemViewSingleItem), in dem die Variablen definiert wurden, gültig. Sie können in unterschiedlichen Templates eigene Variablen mit gleichem Namen definieren, ohne dass es dabei zu einem Konflikt kommt.
...
[source,plenty]
----
include::assets/EX-DE-var-access.html[]
...
[source,plenty]
----
include::assets/EX-DE-var-boolean.html[]
...
[source,plenty]
----
include::assets/EX-DE-var-int.html[]
...
[source,plenty]
----
include::assets/EX-DE-var-float.html[]
...
[source,plenty]
----
include::assets/EX-DE-var-string.html[]
...
[source,plenty]
----
include::assets/EX-DE-var-template-var.html[]

----
=== Array

Ein <<omni-channel/online-shop/webshop-einrichten/cms-syntax#grundlagen-typen, Array>> darf nur aus einer Dimension bestehen. Die einzelnen Werte eines Array dürfen auch von unterschiedlichen Datentypen sein.
...
[source,plenty]
----
include::assets/EX-DE-var-array.html[]
...
[source,plenty]
----
include::assets/EX-DE-var-null.html[]
...
[source,plenty]
----
include::assets/EX-DE-var-container.html[]
