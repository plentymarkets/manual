...
image::omni-channel/online-shop/webshop-einrichten/_cms-syntax/fallbeispiele/assets/DE-CMS-BestPractice-ArtikelvariantenDyn-01-SI.png[]
...
====
Um Aufpreise im Auswahlfeld nicht anzuzeigen, öffnen Sie das Menü <<omni-channel/online-shop/webshop-einrichten/artikelansichten#, System » Mandant » Mandant wählen » Artikelansichten » Einstellungen>>. Wählen Sie dort für die Option *Attribut-Aufpreis* die Einstellung *nicht anzeigen*.
====
...
Aktivieren Sie nun die <<omni-channel/online-shop/webshop-einrichten/artikelansichten#, Client-Prüfung>>, um die Attributbilder dynamisch anzuzeigen.
...
image::omni-channel/online-shop/webshop-einrichten/_cms-syntax/fallbeispiele/assets/DE-CMS-BestPractice-ArtikelvariantenDyn-02-SI.png[]
...
Fügen Sie den folgenden <<omni-channel/online-shop/webshop-einrichten/cms#webdesign-webdesign-bearbeiten-css, CSS-Code>> im Menü *CMS » Webdesign » Layout » CSS » CSSContent* am Ende des vorhandenen Codes ein. Sichern Sie den vorhandenen Code, bevor Sie den folgenden Code einfügen.
