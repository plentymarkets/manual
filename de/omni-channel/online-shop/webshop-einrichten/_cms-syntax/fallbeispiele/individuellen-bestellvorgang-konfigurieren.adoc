...
image::omni-channel/online-shop/webshop-einrichten/_cms-syntax/fallbeispiele/assets/DE-CMS-CheckoutIndicator.png[Fortschrittsanzeige der Bestellschritte]
...
image::omni-channel/online-shop/webshop-einrichten/_cms-syntax/fallbeispiele/assets/DE-CMS-Zahlungsarten.png[Einstellungen der Zahlungsarten]
