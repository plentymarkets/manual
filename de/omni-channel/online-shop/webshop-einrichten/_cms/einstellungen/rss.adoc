...
Im Menü *System » CMS » RSS* können Sie RSS-Feeds anlegen, welche beim Aufruf automatisch aktualisiert werden und jeweils eine Stunde gültig sind. Danach werden die RSS-Feeds beim nächsten Aufruf aktualisiert.
