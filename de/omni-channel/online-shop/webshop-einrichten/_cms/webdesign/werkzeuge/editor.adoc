...
====
Wenn Sie im Menü *System » Einstellungen » Editoren* für bestimmte Bereiche den Editor deaktiviert haben, steht der Editor in der Dropdown-Liste dieser Bereiche nicht zur Auswahl.
====
