...
====
Um eine Sprachvariante einer Kategorie im Webshop anzeigen zu können, muss für die Kategorie in der Standardsprache mindestens ein Artikel hinterlegt sein und die Kategorie muss aktiviert sein. Setzen sie dazu unter *Einstellungen » Mandant (Shop) » Standard » Kategorien » Aktivieren* ein Häkchen bei der Kategorie.
====
...
. Öffnen Sie das Menü *Einstellungen » Mandant (Shop) » Standard » Standorte » Dokumente*.
