...
_Bild 1: *Multilingualismus* konfigurieren_

[.instruction]
Sprachoptionen einstellen:

. Öffnen Sie das Menü *System » Mandant » Mandant öffnen » Webshop » Multilingualismus*.
...
====
Um eine Sprachvariante einer Kategorie im Webshop anzeigen zu können, muss für die Kategorie in der Standardsprache mindestens ein Artikel hinterlegt sein und die Kategorie muss aktiviert sein. Setzen sie dazu unter *System » Mandant » Mandant öffnen » Kategorien » Aktivieren* ein Häkchen bei der Kategorie.
====
...
. Wählen Sie aus dem Dropdown-Menü *Öffne Sprache* die gewünschte Sprache.
...
_Bild 2: Sprachkürzel in der URL einer englischen Artikel-Sprachvariante_

Dies gilt analog auch für *Kategorien*.

== Sprachvariante einer E-Mail-Vorlage einrichten

Alle E-Mails, die über plentymarkets versendet werden, basieren auf *E-Mail-Vorlagen*. Diese werden im Menü *System » Mandant » Mandant öffnen » E-Mail » Vorlagen* verwaltet. Sie können die E-Mail-Vorlagen dort lesen und ändern sowie neue Vorlagen erstellen. Ein plentymarkets System enthält bereits verschiedene vorkonfigurierte E-Mail-Vorlagen.
Je nachdem, in welcher Sprache Ihr Kunde den Webshop nutzt, erhält er die entsprechende Sprachvariante der E-Mail-Vorlage.
...
. Wählen Sie die gewünschte Sprache aus dem Dropdown-Menü *Sprache wählen*.
...
. Öffnen Sie das Menü *System » Mandant » Mandant öffnen » Standorte » Dokumente*.
. Wählen Sie das gewünschte Dokument.
. Wählen Sie im Dropdown-Menü die gewünschte Sprachvariante für das Dokument.
...
. Notieren Sie sich die URL, z.B. */layout/stonepattern/images/Flagge_USA.png*. Diese setzt sich zusammen aus dem Pfad links oben im Dropdown-Menü und dem Bildnamen mit Endung.
. Öffnen Sie das Menü *CMS » Webdesign*.
. Wählen Sie im Dropdown-Menü *Sprache* die Sprache des Designs, die Sie bearbeiten möchten, z.B. Deutsch.
