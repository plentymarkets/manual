...
|**Ausblenden, wenn kein Angebot aktiv** = Template-Variable **<<omni-channel/online-shop/_cms-syntax/webdesign/itemview/container-itemviewliveshopping#, Container_ItemViewLiveShopping()  >>** wird nur befüllt, wenn ein Artikel gerade zum günstigen Preis gekauft werden kann. +
