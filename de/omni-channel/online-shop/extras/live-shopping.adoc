...
//  plentymarkets 7
Beim Live-Shopping wird täglich ein Artikel aus dem Sortiment für einen bestimmten Zeitraum (z.B. von 9:00 bis 18:00 Uhr) zu einem vergünstigten Preis angeboten. Live-Shopping-Angebote konfigurieren Sie im Menü **plentymarkets » System » Mandant (Shop) » Global » Live-Shopping**.
...
. Öffnen Sie das Menü **System » Mandant (Shop) » Global » Live-Shopping**.
