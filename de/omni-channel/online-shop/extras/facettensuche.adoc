...
image::omni-channel/online-shop/extras/assets/DE-Mandant-Global-Dienste-Facetten-01.png[]
...
====
Eine direkte Verknüpfung von Artikeln mit den einzelnen Facetten ist nicht nötig. Die Zuordnung Ihrer Artikel zu Facetten erfolgt automatisch durch die <<omni-channel/online-shop/extras/facettensuche#2-3, **Verknüpfung der Facette mit Werten** >>, die am Artikel hinterlegt sein müssen.
====
...
|**Verfügbarkeit**
|Facetten des Typs **Verfügbarkeit**, z.B. "Kurzfristig lieferbar", werden mit den unter <<omni-channel/online-shop/extras/facettensuche#180, **Einstellungen » Artikel » Artikelverfügbarkeiten** >> angelegten Verfügbarkeiten verknüpft.

|**Hersteller**
|Facetten des Typs **Hersteller**, z.B. "Adidas", werden mit den unter <<omni-channel/online-shop/extras/facettensuche#560, **Einstellungen » Artikel » Hersteller** >> angelegten Herstellern verknüpft.
|====
...
Erklärungen zu den Tabs **Werte** und **Bilder** finden Sie in <<omni-channel/online-shop/extras/facettensuche#2-3, **Kapitel 2.3** >> dieser Handbuchseite.
...
image::omni-channel/online-shop/extras/assets/DE-Mandant-Global-Dienste-Facetten-02.png[]
...
Über die Template-Funktion **<<omni-channel/online-shop/_cms-syntax/webdesign/navigation/container-navigationfacetslist#, Container_NavigationFacetsList  >>** fügen Sie das Template **NavigationFacetsList** in den gewünschten Bereich Ihres Webshops ein. Gehen Sie dazu wie unten beschrieben vor.
...
. Öffnen Sie das Menü <<omni-channel/online-shop/_cms/webdesign#2-3, **CMS » Webdesign** >>.
