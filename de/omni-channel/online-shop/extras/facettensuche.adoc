...
. Wählen Sie einen *Typ* aus dem Dropdown-Menü gemäß den Erläuterungen in <<tabelle-verfuegbare-facettentypen>>.
...
Die Facettensuche wird im Template *NavigationFacetsList* definiert. Das Template *NavigationFacetsList* unseres Standard-Designs Callisto Light enthält fertigen Code, mit dem Sie eine Facettensuche erstellen, die dem in <<bild-facettensuche-webshop>> dargestellten Beispiel entspricht. Dieser Code ist natürlich ausbaubar. +
