...
**plentymarkets » System » Mandant (Shop) » Global » Dienste » Facettensuche**
...
Die Konfiguration besteht aus mehreren Schritten. Zunächst werden Facetten angelegt, anschließend werden sie durch weitere Einstellungen näher bestimmt und schließlich mit den gewünschten Werten verknüpft. Zudem muss im Menü **System » Mandant (Shop) » Standard » Webshop » Artikelsuche** die Option **Facettensuche** eingestellt sein.
...
. Öffnen Sie das Menü **System » Mandant (Shop) » Global » Dienste » Facettensuche**.
...
|**Verfügbarkeit**
|Facetten des Typs **Verfügbarkeit**, z.B. "Kurzfristig lieferbar", werden mit den unter <<omni-channel/online-shop/extras/facettensuche#180, **System » Artikel » Verfügbarkeiten**>> angelegten Verfügbarkeiten verknüpft.

|**Hersteller**
|Facetten des Typs **Hersteller**, z.B. "Adidas", werden mit den unter <<omni-channel/online-shop/extras/facettensuche#560, **System » Artikel » Hersteller**>> angelegten Herstellern verknüpft.
|====
...
Die Konfiguration nehmen Sie im Menü **System » Mandant (Shop) » Standard / Shop » Dienste » Facettenverknüpfungen** vor. Dort wählen Sie den Shop, mit dem Sie Facetten verknüpfen möchten.
...
. Öffnen Sie das Menü **System » Mandant (Shop) » Standard / Shop » Dienste » Facettenverknüpfungen**.
