...
Die Konfiguration besteht aus mehreren Schritten. Zunächst werden Facetten angelegt, anschließend werden sie durch weitere Einstellungen näher bestimmt und schließlich mit den gewünschten Werten verknüpft. Zudem muss im Menü **System » Mandant » Mandant öffnen » Webshop » Artikelsuche** die Option **Facettensuche** eingestellt sein.
...
Die Konfiguration nehmen Sie im Menü **System » Mandant » Mandant öffnen » Dienste » Facettenverknüpfungen** vor. Dort wählen Sie den Shop, mit dem Sie Facetten verknüpfen möchten.
...
. Öffnen Sie das Menü **System » Mandant » Mandant öffnen » Dienste » Facettenverknüpfungen**.
