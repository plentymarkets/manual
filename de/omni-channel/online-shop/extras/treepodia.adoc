...
**System » Mandant » Mandant öffnen » Dienste » Treepodia**
...
Die Zugangsdaten werden im Menü **System » Mandant » Mandant öffnen » Dienste » Treepodia** konfiguriert.
...
Die folgende Tabelle erläutert die Einstellungen im Menü **System » Mandant » Mandant öffnen » Dienste » Treepodia**:
...
Die robots.txt Ihres Systems finden Sie unter **System » Mandant » Mandant öffnen » SEO » robots.txt**.
|====
