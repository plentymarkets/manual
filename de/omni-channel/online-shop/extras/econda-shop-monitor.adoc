...
Die Weiterleitungsart von **PayPal Express** bei der **<<omni-channel/online-shop/_cms/webdesign/webdesign-bearbeiten/bestellvorgang/bestellbestaetigung#, Bestellbestätigung  >>** muss für das Tracking auf **JavaScript** gestellt werden.
