...
**plentymarkets » System » Mandant (Shop) » Standard » Dienste » Econda**
...
. Öffnen Sie das Menü **System » Mandant (Shop) » Standard » Dienste » Econda**.
...
. Öffnen Sie das Menü **System » Mandant (Shop) » Standard » Dienste » Econda » Tab: Einstellungen**.
