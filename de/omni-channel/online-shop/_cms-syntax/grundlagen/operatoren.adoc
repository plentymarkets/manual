...
[source,plenty]
----
include::assets/EX-DE-operator-var-one-line.html[]
...
[source,plenty]
----
include::assets/EX-DE-operator-var-multi-line.html[]
...
[source,plenty]
----
include::assets/EX-DE-operator-logical.html[]
...
[source,plenty]
----
include::assets/EX-DE-operator-concatenate.html[]

----
== Operator-Rangfolge

Die Operator-Rangfolge legt fest, wie "eng" ein Operator zwei Ausdrücke miteinander verbindet. Zum Beispiel ist das Ergebnis des Ausdruckes __1 + 5 * 3__ gleich __16__ und nicht __18__, da der Multiplikations-Operator (*) in der Rangfolge höher steht als der Additions-Operator (+). Wenn nötig, können Sie Klammern setzen, um die Rangfolge der Operatoren zu beeinflussen. Zum Beispiel ergibt __(1 + 5) * 3__ gleich __18__. Ist die Rangfolge der Operatoren gleich, so wird links nach rechts Assoziativität benutzt.
