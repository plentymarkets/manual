...
**Globale Template-Variablen** können in allen Templates verwendet werden. Globale Template-Variablen sind nur in den Bereichen Webdesign und Kategorien vorhanden. Sie finden diese Variablen im Abschnitt __Global__der Übersicht aller Template-Variablen und -Funktionen.

image::omni-channel/online-shop/_cms-syntax/grundlagen/assets/Globale-Template-Variablen.png[Globale Template-Variablen]
...
image::omni-channel/online-shop/_cms-syntax/grundlagen/assets/Template-Variablen.png[]
