...
Die Darstellung von __Inhalt__ erfolgt erst, wenn __Ausdruck__ wahr ist. __Ausdruck__ wird zu einem boolschen Wahrheitswert (TRUE oder FALSE) ausgewertet. Evaluiert __Ausdruck__ zu *TRUE*, wird __Inhalt__ ausgegeben, andernfalls wird __Inhalt__ ignoriert.
...
----
Im nächsten Beispiel wird __Inhalt__ sowohl dargestellt, wenn nur der Wert von *$_a*, *$_b* oder *$_c* größer 0 ist, als auch, wenn der Wert von zweien oder allen dreien größer 0 ist.
