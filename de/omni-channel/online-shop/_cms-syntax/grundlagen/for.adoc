...
Eine for-Schleife kann angewendet werden, indem eine Zählervariable und ein Zahlenbereich definiert wird. Alternativ kann eine Iteration über ein **<<omni-channel/online-shop/_cms-syntax/grundlagen/typen#6, Array >>** vorgenommen werden.
