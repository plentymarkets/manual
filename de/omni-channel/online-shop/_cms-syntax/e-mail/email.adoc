...
* $SignatureHTML — Diese Variable beinhaltet die Signatur des Mandanten im HTML-Format. Im Menü System » Mandant (Shop) » Standard » E-Mail » Signatur wird diese Signatur hinterlegt.
* $SignatureText — Diese Variable beinhaltet die Signatur des Mandanten im reinen Textformat. Im Menü System » Mandant (Shop) » Standard » E-Mail » Signatur wird diese Signatur hinterlegt.
* $SystemPassword
* $SystemURL
* $SystemUsername
