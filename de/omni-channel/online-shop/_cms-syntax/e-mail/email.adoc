...
* <<omni-channel/online-shop/cms-syntax#e-mail-email-link-basket, Link_Basket>> — Diese Funktion gibt die URL zum Warenkorb aus.
* <<omni-channel/online-shop/cms-syntax#e-mail-email-link-checkout, Link_Checkout>> — Diese Funktion gibt eine URL zur Verkaufsabwicklung aus.
* <<omni-channel/online-shop/cms-syntax#e-mail-email-link-item, Link_Item>>
* <<omni-channel/online-shop/cms-syntax#e-mail-email-link-newpassword, Link_NewPassword>> — Diese Funktion gibt eine URL zum Formular zum Anlegen eines neuen Passworts aus.
* <<omni-channel/online-shop/cms-syntax#e-mail-email-link-termsconditions, Link_TermsConditions>> — Diese Funktion gibt die URL zu den AGB aus.
* <<omni-channel/online-shop/cms-syntax#e-mail-email-link-webstore, Link_Webstore>> — Diese Funktion gibt die URL zum Webshop aus.
...
* $SignatureHTML — Diese Variable beinhaltet die Signatur des Mandanten im HTML-Format. Im Menü System » Mandant » Mandant öffnen » E-Mail » Signatur wird diese Signatur hinterlegt.
* $SignatureText — Diese Variable beinhaltet die Signatur des Mandanten im reinen Textformat. Im Menü System » Mandant » Mandant öffnen » E-Mail » Signatur wird diese Signatur hinterlegt.
* $SystemPassword
* $SystemURL
* $SystemUsername
...
* $WebstoreID — Diese Variable beinhaltet die ID des Mandanten. Die ID wird vom System vergeben. Im Menü System » Mandant » Mandant öffnen » Einstellungen unter Webstore ID ist die ID aufgeführt.
* $WithdrawalFormHTML
* $WithdrawalFormText
