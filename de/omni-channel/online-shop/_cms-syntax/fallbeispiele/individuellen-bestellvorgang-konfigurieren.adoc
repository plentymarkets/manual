...
Das Standarddesign **Callisto Light** setzt verstärkt auf den Einsatz des Scripts link:https://github.com/plentymarkets/plenty-cms-library[**plentymarketsCMSTools.js**, window="_blank"]. Das Script ist ein Opensource-Projekt von **plenty**markets und kann auf GitHub.com geklont und nach Belieben manipuliert werden. +
