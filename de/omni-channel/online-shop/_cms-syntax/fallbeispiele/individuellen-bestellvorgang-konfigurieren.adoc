...
image::omni-channel/online-shop/_cms-syntax/fallbeispiele/assets/DE-CMS-CheckoutIndicator.png[Fortschrittsanzeige der Bestellschritte]

__Bild 1: Fortschrittsanzeige der Bestellschritte__
...
__Tab. 1: vordefinierte Template-Funktionen für Login, Logout, Kundenregistrierung, Passwort vergessen und Bestellbestätigung__
...
Das Standarddesign **Callisto Light** setzt verstärkt auf den Einsatz des Scripts link:https://github.com/plentymarkets/plenty-cms-library[**plentymarketsCMSTools.js**^]. Das Script ist ein Opensource-Projekt von **plenty**markets und kann auf GitHub.com geklont und nach Belieben manipuliert werden. +
...
image::omni-channel/online-shop/_cms-syntax/fallbeispiele/assets/DE-CMS-Zahlungsarten.png[Einstellungen der Zahlungsarten]

__Bild 2: Einstellungen der Zahlungsarten__

=== Zahlungsart übertragen

////
bedenke: so schreiben, als ob ich es jmd erzähle, der es noch nicht kennt. Mit Template MethodsOfPayment beginnen
...
__Tab. 2: Validatoren, die für den Bestellvorgang wichtig sind.__
