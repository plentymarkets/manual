...
__Tab. 1: Mögliche Template-Variablen/-Funktionen für eine E-Mail-Vorlage zur Artikelverfügbarkeit__
...
. Kopieren Sie den Beispieltext (__Nachricht__) in das Tab **E-Mail-Nachricht » Inhalt » HTML-formatierter Text** mit dem Syntax-Editor ein.
...
. Wählen Sie bei der Option **Benachrichtigung bei verfügbarem Artikel** die E-Mail-Vorlage aus dem Dropdown-Menü.
...
Wenn im Menü **System » Mandant » Mandant öffnen » Artikelansichten » Einstellungen** für die Einstellung **Attribut-Verfügbarkeit** die **Client-Prüfung** aktiviert ist, wird durch das nachfolgende Code-Beispiel das zuvor erzeugte Formular je nach Verfügbarkeit der Variante dynamisch ein- und ausgeblendet.
