...
Fügen Sie den folgenden <<omni-channel/online-shop/cms#webdesign-webdesign-bearbeiten-css, **CSS-Code**  >> im Menü **CMS » Webdesign » Layout » CSS » CSSContent** am Ende des vorhandenen Codes ein. Sichern Sie den vorhandenen Code, bevor Sie den folgenden Code einfügen.
