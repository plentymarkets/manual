...
image::omni-channel/online-shop/_cms-syntax/fallbeispiele/assets/DE-CMS-BestPractice-ArtikelvariantenDyn-01-SI.png[]

__Bild 1: Beispielansicht für dynamische Artikelpreise__
...
====
Um Aufpreise im Auswahlfeld nicht anzuzeigen, öffnen Sie das Menü **<<omni-channel/online-shop/mandanten-einrichten/_artikelansichten/grundeinstellungen#, Einstellungen » Mandant (Shop) » Standard » Artikelansichten » Grundeinstellungen  >>**. Wählen Sie dort für die Option **Attribut-Aufpreis** die Einstellung **nicht anzeigen**.
====
...
. Öffnen Sie das Menü **<<artikel/artikel-verwalten#390, Einstellungen » Artikel » Attribute >>**.
...
Aktivieren Sie nun die **<<omni-channel/online-shop/mandanten-einrichten/_artikelansichten/grundeinstellungen#, Client-Prüfung  >>**, um die Attributbilder dynamisch anzuzeigen.
...
image::omni-channel/online-shop/_cms-syntax/fallbeispiele/assets/DE-CMS-BestPractice-ArtikelvariantenDyn-02-SI.png[]

__Bild 2: Beispielcode für dynamische Artikelbilder__
...
Fügen Sie den folgenden <<omni-channel/online-shop/_cms/webdesign/webdesign-bearbeiten/css#, **CSS-Code**  >> im Menü **CMS » Webdesign » Layout » CSS » CSSContent** am Ende des vorhandenen Codes ein. Sichern Sie den vorhandenen Code, bevor Sie den folgenden Code einfügen.
...
Im Menü <<artikel/artikel-verwalten#660, **Einstellungen » Artikel » Bilder** >> hinterlegen Sie Maximalwerte für die Breite und Höhe von **<<artikel/artikel-verwalten#450, Artikelattributbildern >>**. Die Werte geben Sie in Pixeln an.
