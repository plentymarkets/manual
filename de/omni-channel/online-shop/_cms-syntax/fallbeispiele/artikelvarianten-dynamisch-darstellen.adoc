...
====
Um Aufpreise im Auswahlfeld nicht anzuzeigen, öffnen Sie das Menü **<<omni-channel/online-shop/webshop-einrichten/artikelansichten#, System » Mandant (Shop) » Standard » Artikelansichten » Einstellungen>>**. Wählen Sie dort für die Option **Attribut-Aufpreis** die Einstellung **nicht anzeigen**.
====
