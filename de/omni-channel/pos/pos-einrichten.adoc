...
Verkaufsgutscheine verkaufen Sie in plentymarkets über Gutscheinartikel. wenn Sie einen Gutscheinartikel verkaufen, händigen Sie Kunden einen Gutschein-Code aus. Kunden können diesen Gutschein-Code nur einlösen, wenn dieser Gutschein-Code zum Zeitpunkt der Einlösung im plentymarkets Backend gespeichert ist.
...
* *_Optional:_* Gutschein-Codes erzeugen oder manuell speichern.
...
====
Sie haben mehr als eine Kasse und möchten mit eigenen Gutschein-Codes arbeiten? Dann teilen Sie die ausgedruckten Gutschein-Codes zwischen den Kassen auf oder erstellen Sie für jede Kasse eigene Gutscheinkampagnen und -artikel, damit Kassenbenutzerinnen keine Zeit damit verschwenden, bereits verkaufte Gutschein-Codes einzugeben.
====
...
Im Menü **Einstellungen » Aufträge » Gutscheine** wählen Sie nun einmalig dieses Freitextfeld und ordnen es so Gutscheinkampagnen zu.
...
*_Beispiel:_* Sie möchten Gutscheine im Wert von 10 Euro, 25 Euro und 50 Euro sowie einen Gutschein verkaufen möchten, bei dem Kassenbenutzer den Wert frei wählen können. Sie erstellen also 3 Kampagnen mit den Rabattwerten 10, 25 und 50 Euro sowie eine Kampagne mit einem beliebigen Rabattwert.
...
* Der Kassenbenutzer hat eine Liste mit Gutschein-Codes, die in plentymarkets gespeichert sind. Er gibt einen Code ein. Der Gutscheinwert wird abgerufen.
...
*_Tipp:_* Bringen Sie Gutschein-Codes nicht doppelt in Umlauf. Teilen Sie bei mehreren Kassen die Gutschein-Codes entweder auf oder erstellen Sie separate Kampagnen pro Kasse, damit Kassenbenutzer keine Zeit damit verschwenden, bereits verkaufte Gutschein-Codes einzugeben.

!!!Optional können Sie innerhalb derselben Kampagne Gutschein-Codes mit verschiedenen Werten generieren. Sie müssen die Kampagne dann jedoch entweder mit einem Artikel mit Preis 0,00 Euro verknüpfen oder pro Gutscheinwert einen eigenen Artikel mit dem Gutscheinwert als Preis erstellen.
...
Wie viele Artikel brauchen Sie?

Wie viele Artikel Sie benötigen, hängt von folgenden Faktoren ab:

Sie generieren die Codes automatisch beim Verkauf.
Sie haben mehrere feste Gutscheinwerte definiert.
=>
...
* Beim Kassieren gibt der Kassenbenutzer in einem zusätzlichen Schritt den Wert des Gutscheins ein.
