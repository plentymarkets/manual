...
* *Passend* = Bei passender Barzahlung können Kassenbenutzer auf diese Taste tippen, statt den erhaltenen Betrag einzugeben. Das Feld *Erhalten* wird mit dem zu zahlenden Betrag aufgefüllt.
