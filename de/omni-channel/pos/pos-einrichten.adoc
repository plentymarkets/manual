...
Das Kassensystem plentymarkets POS wird über die plentymarkets App bereitgestellt. Für den Einsatz von plentymarkets POS bestehen jedoch zusätzliche Hardware-Voraussetzungen. Informationen zu den Systemvoraussetzungen für die plentymarkets App und plentymarkets POS finden Sie auf der Handbuchseite <<basics/erste-schritte/systemvoraussetzungen#, Systemvoraussetzungen>>.
