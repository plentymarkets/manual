...
-> Stellen Sie sicher, dass Ihre Bestellbestätigung die Auftrags-ID enthält und Sie explizit darauf hinweisen, dass diese ID benötigt wird.
* Erklären Sie Ihren Kassenkräften, wie sie die Identität von Personen, die bezahlte Ware abholen prüfen, damit sie die Ware nicht Unbefugten aushändigen.
