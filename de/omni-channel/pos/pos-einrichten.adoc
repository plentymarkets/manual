...
*_Hinweis:_* Artikel ohne Netto-Warenbestand werden im POS-Warenkorb rot markiert, können aber verkauft werden. Daher kann es zu rechnerischen Überverkäufen kommen.
...
In den Kasseneinstellungen wählen Sie das Retourenlager und legen in den Benutzerrechten fest, wer Retouren durchführen darf. Weiter sind keine Einstellungen nötig, um Retouren über plentymarkets POS abzuwickeln. Beachten Sie jedoch die folgenden Hinweise zu Retouren:
...
* Über die Kasse können für alle im System gespeicherten Aufträge Retouren gebucht werden. Kunden können also auch Artikel aus Aufträgen mit anderen Herkünften zurückzugeben. Die Entscheidung, ob Kunden Artikel zurückgeben können, trifft das Kassenpersonal. Informieren Sie daher das Kassenpersonal, ob und wenn ja welche Herkünfte von der Retoure ausgeschlossen sind.
* Bei Retouren für einen Hauptauftrag mit Versandkosten entscheidet das Kasselpersonal, ob die Versandkosten erstattet werden. Schulen Sie daher das Kassenpersonal, damit Ihre Belegschaft weiß, in welchen Fällen die Versandkosten erstatten werden sollen.
...
* Bei Kauf auf Rechnung oder Anzahlungen wird dem Kunden bei einer Retoure erst Geld ausgehändigt, wenn der Preis der zurückgegebenen Artikel höher ist als der Betrag, der bisher bezahlt wurde. Der
