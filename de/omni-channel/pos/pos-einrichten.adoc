...
Aktiviert = Kassenbenutzer können vor dem Scannen des Artikels die Menge über das Zahlenfeld eingeben. Wenn vor dem Scannen keine Menge eingegeben wird, wird der gescannte Artikel mit der Menge 1 in den POS-Warenkorb gelegt.
