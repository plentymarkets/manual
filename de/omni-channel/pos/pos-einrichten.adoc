...
a|
* Ingenico iPP480 mit Drucker (Betriebsart **ZVT**, Verbindungsart **TCP/IP**) - Anbindung über link:XXXX[Ingenico ZVT-Plugin, window="_blank"]
* SumUp Air - Anbindung über link:XXXX[SumUp-Plugin, window="_blank"] +
...
* link:XXXX[Ingenico-Geräte über ZVT-Schnittstelle, window="_blank"]
