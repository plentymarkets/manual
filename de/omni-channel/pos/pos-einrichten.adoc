...
* Als Lagerort für Retourenartikel wird Kassenkräften standardmäßig der Lagerort angezeigt, der im Tab *Grundeinstellungen* der Kasse als *Reparturlagerort* festgelegt ist. Ab Version 1.8.2 können Kassenkräfte optional einen anderen Lagerort für die Retourenartikel wählen. Die möglichen Lager werden in der folgenden Reihenfolge angezeigt:
