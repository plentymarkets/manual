...
* Als Lagerort für Retourenartikel wird Kassenkräften standardmäßig der Lagerort angezeigt, der im Tab *Grundeinstellungen* der Kasse als *Standard-Reparturlagerort* festgelegt ist. Ab Version 1.8.2 können Kassenkräfte optional einen anderen Lagerort für die Retourenartikel wählen. Die möglichen Lagerorte werden in der folgenden Reihenfolge angezeigt:
...
* Ab Version 1.8.3 kann der Retourenbetrag statt in bar auch in Form eines Gutscheins ausgezahlt werden. Wenn Sie diese Möglichkeit nutzen möchten, schulen Sie das Kassenpersonal, damit Ihre Belegschaft weiß, in welchen Fällen der Retourenbetrag in bar und in welchen Fällen als Gutschein ausgezahlt werden soll.

[#3100]
=== Retourengutscheine vorbereiten (ab Version 1.8.3)
