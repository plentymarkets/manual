...
//**__Standort Österreich:__** Das Land des Kassenstandorts ist nicht mehr änderbar, sobald der Startbeleg für die Kasse erstellt wurde.
...
[WARNING]
.Noch nicht alle RKSV-konformen Nullbelege implementiert
====
Nach Erstellen des Startbelegs werden sämtliche Kassenvorgänge signiert und RKSV-konform protokolliert. Aktuell können jedoch noch nicht alle von der RKSV geforderten Nullbelege in plentymarkets POS erstellt werden.
====
...
====
Nach Erstellen des Startbelegs werden sämtliche Kassenvorgänge RKSV-konform signiert und protokolliert. Aktuell erfüllt plentymarkets POS jedoch noch nicht alle Anforderungen der RKSV.
====
...
* Die Kassenidentifikationsnummer der plentymarkets POS Kasse. Die Kassenidentifikationsnummer ergibt sich aus dem Präfix "POS-BASE-"" und der ID der Kasse. +
**__Beispiel:__** Für eine Kasse mit der ID 30 lautet die Kassenidentifikationsnummer POS-BASE-30.
* Den AES-Schlüssel, mit dem der Umsatzzähler der Kasse verschlüsselt wurde
