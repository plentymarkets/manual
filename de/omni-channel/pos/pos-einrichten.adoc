...
====
Damit Kassenaufträge und Tagesabschlüsse mit dem plentymarkets Backend synchronisiert werden können, müssen Datum und Uhrzeit des Geräts korrekt eingestellt sein. Daher wird empfohlen, das Datum und die Uhrzeit des Geräts automatisch einstellen zu lassen, damit Datum und Uhrzeit automatisch abgeglichen werden.
====
