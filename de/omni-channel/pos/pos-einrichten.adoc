...
* Statt in bar kann der Retourenbetrag auch in Form eines Gutscheins ausgezahlt werden. Wenn Sie diese Möglichkeit nutzen möchten, schulen Sie das Kassenpersonal, damit Ihre Belegschaft weiß, in welchen Fällen der Retourenbetrag in bar und in welchen Fällen als Gutschein ausgezahlt werden soll.
