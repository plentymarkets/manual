...
* Weisen Sie Ihr Kassenpersonal an, zurückgegebene Artikel auf dem Kaufbeleg durchzustreichen. So verhindern Sie, dass Kunden Artikel mehrmals zurückzugeben.
...
. Geben Sie die E-Mail-Adresse der Kassenkraft ein, damit sie Benachrichtigungen des Systems empfängt.
...
====
Bei fehlender Internetverbindung werden Aufträge offline gespeichert und erst später synchronisiert. Wenn Sie die App deinstallieren, bevor die Aufträge an plentymarkets übertragen wurden, werden die lokal gespeicherten Aufträge unwiederbringlich gelöscht und können auch vom plentymarkets Support nicht wiederhergestellt werden. Prüfen Sie deshalb vor jeder Deinstallation Ihrer App, dass keine Offline-Aufträge auf dem Gerät vorhanden sind.
====
