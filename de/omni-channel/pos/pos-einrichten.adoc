...
Das Kassensystem plentymarkets POS wird über die plentymarkets App bereitgestellt. Für den Einsatz von plentymarkets POS bestehen jedoch zusätzliche Hardware-Voraussetzungen. Informationen zu den Systemvoraussetzungen für die plentymarkets App und plentymarkets POS finden Sie auf der Handbuchseite <<basics/erste-schritte/systemvoraussetzungen#50, Systemvoraussetzungen>>.
...
|*Standardkunde*
|Für Kassenaufträge <<omni-channel/pos/pos-einrichten#90, erstellten Standardkunden>> wählen, dem über diese Kasse generierte Aufträge zugeordnet werden sollen.
...
|Wählen, ob Kassenpersonal einen Gutschein in Höhe des Retourenbetrags aushändigen können, statt den Betrag bar auszuzahlen.
...
Die Einstellungen, die Sie benötigen, um ein Benutzerkonto für Kassenpersonal zu erstellen, werden nachfolgend beschrieben. Allgemeine Informationen zu Benutzerkonten und -rechten finden Sie auf der Handbuchseite <<basics/arbeiten-mit-plentymarkets/benutzer-verwalten#, Benutzer verwalten>>.

[TIP]
.Tipp: Rolle für Kassenpersonal erstellen
====
Um die Rechteverwaltung für Kassenpersonal zu vereinfachen, erstellen Sie eine <<basics/arbeiten-mit-plentymarkets/benutzer-verwalten#70, Rolle>> mit den Berechtigungen, die Sie Kassenpersonal zuweisen möchten, und verknüpfen Sie diese Rolle mit den Benutzerkonten des Kassenpersonals.
====

[#140]
=== Benutzerkonto für Kassenpersonal erstellen

Damit neues Kassenpersonal Zugriff auf plentymarkets POS erhält, legen Sie zunächst im plentymarkets Backend <<basics/arbeiten-mit-plentymarkets/benutzer-verwalten#, Benutzerkonten>> der Benutzerklasse **Variabel** für diese Personen an. Gehen Sie dazu wie unten beschrieben vor.
...
. Wenn die Kassenkraft auf weitere Bereiche der plentymarkets App zugreifen können soll, aktivieren Sie <<omni-channel/pos/pos-einrichten#170, weitere Berechtigungen>>.
. *Speichern* Sie die Einstellungen. +
...
Damit Kassenpersonal in plentymarkets POS Preise bearbeiten, Auftragspositionen umbenennen und/oder Rabatte gewähren können, müssen Sie die Berechtigungen dazu zuweisen. Wie Sie Rollen einrichten und Benutzern zuweisen, erfahren Sie <<basics/arbeiten-mit-plentymarkets/benutzer-verwalten#, hier>>. Dort schalten Sie auch weitere App-Funktionen für Kassenpersonal frei.
...
Gehen Sie wie unten beschrieben vor, um einen Versanddienstleister **Selbstabholung** zu erstellen. Nur die für diesen Versanddienstleister relevanten Einstellungen werden beschrieben. Allgemeine Informationen zu Versanddienstleistern finden Sie auf der Handbuchseite <<auftragsabwicklung/fulfillment/versand-vorbereiten#800, Versand vorbereiten>>.
...
Erstellen Sie nun ein Versandprofil für die Selbstabholung. Nur die für dieses Versandprofil relevanten Einstellungen werden beschrieben. Allgemeine Informationen zu Versandprofilen finden Sie auf der Handbuchseite <<auftragsabwicklung/fulfillment/versand-vorbereiten#1000, Versand vorbereiten>>.
...
Diese Schritte werden nachfolgend kurz erläutert. Eine detaillierte Anleitung zum Erstellen von Kampagnen und Gutscheinen finden Sie auf der Handbuchseite <<auftragsabwicklung/auftraege/gutscheine#, Gutscheine>>.
...
In den Kasseneinstellungen wählen Sie einen Standard-Reparaturlagerort für Retouren und legen in den Benutzerrechten fest, wer Retouren durchführen darf. Wenn Sie Retourenbeträge nur in bar auszahlen möchten, sind keine weiteren Einstellungen nötig, um Retouren über plentymarkets POS abzuwickeln. Beachten Sie die <<omni-channel/pos/pos-einrichten#2000, Hinweise zu Retouren>>. Wenn Sie die Möglichkeit haben möchten, den Retourenbetrag als Gutschein auszuzahlen, bereiten Sie außerdem <<omni-channel/pos/pos-einrichten#3100, Retourengutscheine>> vor.
...
[#3700]
== Click & Collect vorbereiten

* Kunde bestellt und bezahlt online und holt die Ware im Laden ab.
* Kunde bestellt online und bezahlt bei der Abholung im Laden.

[#2000]
=== Hinweise zu Click & Collect

Beachten Sie die folgenden Hinweise zu Click & Collect:

* Aufträge können nur anhand der Auftrags-ID in die Kasse geladen werden. +
→ Stellen Sie sicher, dass Ihre Bestellbestätigung die Auftrags-ID enthält und Sie explizit darauf hinweisen, dass diese ID benötigt wird, um den Auftrag in der Filiale zu bearbeiten.
* Erklären Sie Ihren Kassenkräften, wie sie die Identität von Personen, die bezahlte Ware abholen, prüfen sollen, damit sie die Ware nicht Unbefugten aushändigen.
* Wenn Sie Prozesse und/oder Ereignisaktionen nutzen, um Aufträge zu bearbeiten, die über den Webshop oder Marktplätze ins System gelangen, prüfen Sie diese automatischen Abläufe, bevor Sie eine Abholung im Laden anbieten. +
→ Stellen Sie sicher, dass Aufträge nicht automatisch über eine Ereignisaktion oder einen Prozess in den Status *Warenausgang gebucht* versetzt werden, bevor die Kundin die Ware im Laden abholt.
* Aufträge aus dem Webshop können an der Kasse nicht bearbeitet werden. Kassenpersonal können nur Zahlungen anlegen und Notizen zum Auftrag speichern. +
* Zurzeit können Kunden Click-&-Collect-Aufträge noch nicht mit Verkaufsgutscheinen bezahlen.
* Click-&-Collect-Aufträge können nicht an der Kasse storniert werden.
* Zahlungen, die an der Kasse getätigt werden, um einen Click-&-Collect-Auftrag zu zahlen, sind für die Kasse umsatzneutral. +
...
* Die Kasse zeigt an, dass die Kundin die Ware erhalten hat, wenn im plentymarkets System für den Auftrag ein Warenausgang gebucht wurde. +
→ Falls Probleme auftreten und die Kundin darauf besteht, die Ware nicht erhalten zu haben, muss der Auftrag im plentymarkets Backend geprüft werden. Möglicherweise liegen Fehler in den Automatismen vor, über die Aufträge abgearbeitet werden.
...
*_Empfehlung:_* Konfigurieren Sie plentyBase so, dass plentyBase beim Starten des Rechners automatisch gestartet wird.
* Wurde der Drucker im plentymarkets Backend <<basics/arbeiten-mit-plentymarkets/drucker, gespeichert und konfiguriert>>?
...
. *Speichern* Sie die Einstellungen. +
→ Die Kassenbenutzerin ist berechtigt, <<omni-channel/pos/pos-kassenbenutzer#270, Monatsbelege in plentymarkets POS>> zu erstellen.
