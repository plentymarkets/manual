...
|*Mengeneingabe vor Artikel-Scan aktivieren*
|Aktivieren, um eine Mengeneingabe vor dem Scannen zu aktivieren. +
Nicht aktiviert = Gescannte Artikel werden mit der Menge 1 in den POS-Warenkorb gelegt. +
Aktiviert = Kassenbenutzer können vor dem Scannen des Artikels die Menge eingeben. Wenn vor dem Scannen keine Menge eingegeben wird, wird der gescannte Artikel mit der Menge 1 in den POS-Warenkorb gelegt.

|*Schnelle Eingabe bei passendem Betrag aktivieren*
|Aktivieren, um bei passender Zahlung die Zahlung zu bestätigen, ohne den erhaltenden Betrag einzugeben. +
Nicht aktiviert = Kassenbenutzer geben den erhaltenen Betrag ein. +
Aktiviert = Bei passender Barzahlung tippen Kassenbenutzer auf *Betrag erhalten*, ohne den Betrag einzugeben.

|*Passenden Betrag vor Auftragsabschluss bestätigen* +
(nur verfügbar, wenn *Schnelle Eingabe bei passendem Betrag aktivieren* aktiviert ist)
|Aktivieren, um vor Auftragsabschluss den Erhalt des passenden Betrags zu bestätigen. +
Nicht aktiviert = Wenn Kassenbenutzerinnen auf *Betrag erhalten* tippen, ohne einen Betrag einzugeben, wird die Auftragssumme automatisch als gezahlter Betrag übernommen. +
Aktiviert = Wenn Kassenbenutzerinnen auf *Betrag erhalten* tippen, ohne einen Betrag einzugeben, wird eine Sicherheitsabfrage eingeblendet. Die Auftragssumme wird erst als gezahlter Betrag übernommen, wenn die Kassenbenutzerin diese Sicherheitsabfrage bestätigt.
...
* *Code löschen* +
* *Code anzeigen* +
*_Hinweis:_* Code-Rechte sind nur für den Gutscheinverkauf erforderlich.
|====
