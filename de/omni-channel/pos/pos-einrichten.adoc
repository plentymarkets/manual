...
* Das Kassenpersonal hat eine Liste mit Gutschein-Codes pro Gutscheinwert, die in plentymarkets gespeichert sind. Die Kassenkraft einen Code ein. Der Gutscheinwert wird abgerufen.
