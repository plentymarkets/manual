...
[#3700]
== Abholen und Zahlen von Online-Bestellungen im Laden vorbereiten

Kundinnen und Kunden können Waren über den Webshop bestellen und entweder im Ladengeschäft die bereits bezahlten Artikel abholen oder die bestellten Artikel im Ladengeschäft bezahlen und abholen.

Die folgenden Vorbereitungen sind nötig, wenn Sie Kundinnen und Kunden das Abholen und Zahlen von Online-Bestellungen im Laden anbieten möchten:
...
*
Erklären Sie Ihren Kassenkräften, wie sie die Identität von Personen prüfen sollen, die bezahlte Ware im Ladengeschäft abholen. Sonst besteht Gefahr, dass Kassenkräfte die Ware an Unbefugte aushändigen.
...
* Zurzeit können Kunden Online-Bestellungen an der Kasse noch nicht mit Verkaufsgutscheinen bezahlen.
* Kassenkräfte können Online-Aufträge noch nicht an der Kasse stornieren.
* Zahlungen, die an der Kasse getätigt werden, um einen Online-Auftrag zu zahlen, sind für die Kasse umsatzneutral. +
