...
====
Die App-PIN erlaubt einen schnellen Wechsel des Benutzerkontos in allen Menüs der plentymarkets App. Bei der ersten Anmeldung in der App wird aber das Passwort abgefragt. Ihr Kassenpersonal benötigt also Passwort und PIN.
====
