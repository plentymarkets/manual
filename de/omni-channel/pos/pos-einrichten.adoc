...
Nachdem Sie Kassen gebucht haben, richten Sie sie im plentymarkets Backend ein. Dabei weisen Sie die Kassen einem Mandanten zu, indem Sie sie im Menü **System » Mandant (Shop) » Standard » POS** erstellen und weitere Einstellungen vornehmen. Gehen Sie dazu wie unten beschrieben vor.
...
. Öffnen Sie das Menü **System » Mandant (Shop) » Standard » POS**.
...
====
Stellen Sie für die Zahlungsart **11 » Barverkauf/EC-Karte** außerdem im Menü **System » Mandant (Shop) » Standard » POS  » Kasse öffnen » Tab: Zahlungsart** die Option **Ohne Anbindung** im Bereich **EC-Terminal** ein.
====
...
|System » Mandant (Shop) » Mandant wählen » Standorte » Standort wählen » Buchhaltung
...
|System » Mandant (Shop) » Mandant wählen » POS » Kasse wählen » Tab: Beleg
|Identische Auftragspositionen
a|
* Einzeln darstellen
* Zusammenfassen
...
. **Speichern** Sie die Einstellungen.
. Öffnen Sie das Menü **System » Mandant (Shop) » Standard » POS » Kasse öffnen » Grundeinstellungen**.
...
2+|*System » Mandant (Shop) » Mandant öffnen » POS » Kasse öffnen*
...
Im Menü **System » Aufträge » Gutscheine** wählen Sie nun dieses Freitextfeld und ordnen es so Gutscheinkampagnen zu.
