...
Wenn Kassenbenutzer Einlagen und Entnahmen über plentymarkets POS durchführen, wählen sie einen Kassenvorfall als Grund für die Buchung. Systemseitig sind dafür standardmäßig ein Kassenvorfall *Entnahme* und ein Kassenvorfall *Einlage* verfügbar, die nicht gelöscht werden können. Für diese Vorfälle können Sie Buchungskonten speichern, werden die Beträge auf bestimmte Buchungskonten gebucht werden sollen. Gehen Sie wie unten beschrieben vor, um Konten für diese Vorfälle zu speichern. Optional speichern Sie in einem weiteren Schritt zusätzliche Konten, um mit mehreren Buchungskonten zu arbeiten.
