...
|**Externer Name DE**
|Externen Namen eingeben. Der externe Name wird ggf. im Webshop angezeigt und ist für Kunden sichtbar.
...
|*Rabattwert*
|Einen Gutscheinwert eingeben, z.B. 1,00.
...
* Ist plentyBase auf dem Rechner gestartet?
* Wurden die plentyBase Konfigurationseinstellungen vor kurzem geändert, z.B. der HTTP-Port oder der Access Token? +
