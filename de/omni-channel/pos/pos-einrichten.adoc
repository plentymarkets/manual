...
Definieren Sie nun das Freitextfeld, dass für Kampagnen verwendet werden soll.
...
*_Tipp_*: Der Name sollte die Kasse und den Gutscheinwert enthalten.
...
|**Rabattwert**
|Den Gutscheinwert eingeben, z.B. 10 = 10 Euro. +
*_Hinweis:_* Diesen Wert nicht mehr ändern, nachdem der erste Gutschein verkauft wurde.
...
Verkaufsgutscheine können in plentymarkets POS nur eingelöst werden, wenn ein Gutschein-Code eingegeben wird.
Damit Restbeträge bei einer Teileinlösung korrekt berechnet werden, benötigt außerdem jeder verkaufte Gutschein einen eigenen Gutschein-Code. Gutschein-Codes können Sie auf verschiedene Arten erstellen:
...
Beide Verfahren werden hier erläutert.
...
. Exportieren Sie die Gutschein-Codes und stellen Sie sie Kassenbenutzern zur Verfügung. +
*_Hinweis:_* Achten Sie darauf, dass Gutschein-Codes nicht doppelt in Umlauf geraten. Dies ist besonders wichtig, wenn Sie später weitere Codes generieren.
