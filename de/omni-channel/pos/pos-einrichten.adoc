...
[TIP]
.App-PIN für schnellen Benutzerwechsel
====
Die App-PIN erlaubt einen schnellen Wechsel der Benutzer in allen Menüs der plentymarkets App. Bei der ersten Anmeldung in der App wird aber das Passwort benötigt. Ihr Kassenpersonal benötigt also das Passwort und die PIN.
====
...
. Wenn die Kassenkraft auf weitere Bereiche der plentymarkets App zugreifen können soll, aktivieren Sie weitere Berechtigungen.
. *Speichern* Sie die Einstellungen. +
