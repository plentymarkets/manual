...
[#940]
=== Buchungskonten für Kassenvorfälle speichern

Aufträge, die über plentymarkets POS generiert werden, werden den in plentymarkets gespeicherten Erlöskonten zugewiesen. Wie Sie Erlöskonten speichern, erfahren Sie auf der Handbuchseite <<auftragsabwicklung/auftraege/buchhaltung#800, Buchhaltung>>. Da Einlagen, Entnahmen und Kassenstürze keine Aufträge sind, können Sie für diese Kassenvorfälle eigene Buchungskonten speichern. Wie das geht, erfahren Sie ebenfalls auf der Handbuchseite <<auftragsabwicklung/auftraege/buchhaltung#910, Buchhaltung>>.
