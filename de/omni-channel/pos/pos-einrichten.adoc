...
//(nur neue Kassen mit Standort Österreich)
//|Wählen, um den <<omni-channel/pos/pos-einrichten#900, **Startbeleg  zu erstellen**>> und so die manipulationssichere Sicherheitseinrichtung zu aktivieren. Nach Erstellen des Startbelegs ist das Standortland der Kasse nicht mehr änderbar.
|====
...
Erstellen Sie nun den Startbeleg, um die Kasse produktiv zu nutzen. Um den Startbeleg zu erstellen, benötigen Sie die PIN für das Signaturzertifikat des Vertrauensdiensteanbieters. Den Startbeleg erstellen Sie im POS-Menü der plentymarkets App.

[WARNING]
.Noch nicht alle RKSV-konforme Nullbelege implementiert
====
