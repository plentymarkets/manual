...
|Aktivieren, um bei Retouren mit Hauptauftrag die Auftragspositionen nicht für die Retoure vorzumerken. Das Kassenpersonal wählt manuell die Auftragspositionen, die retourniert werden sollen. +
*_Tipp:_* Diese Einstellung eignet sich vor allem für Kassen, über die Aufträge mit vielen Auftragspositionen abgewickelt werden und an denen Artikel manuell, also ohne Scanner, erfasst werden.
