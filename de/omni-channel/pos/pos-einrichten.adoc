...
Diese Schritte werden hier kurz erläutert. Eine detaillierte Anleitung zum Erstellen von Gutscheinen finden Sie auf der Handbuchseite https://knowledge.plentymarkets.com/auftragsabwicklung/auftraege/gutscheine.
...
_*Hinweis:*_ Achten Sie auf die Schreibweise. Der Name **Kampagne ID** ist nur in der Schreibweise mit Leerzeichen gültig.
...
. Nehmen Sie die Einstellungen vor. Beachten Sie Tabelle 13.
. **Speichern** Sie die Einstellungen.  +
...
. Nehmen Sie die weiteren Einstellungen vor. Beachten Sie Tabelle 14.
. **Speichern** Sie die Einstellungen.
...
. Geben Sie einen Namen ein.
. Wählen Sie das **Ereignis** gemäß Tabelle 15.
. **Speichern** Sie die Einstellungen.
...
. Nehmen Sie die Einstellungen vor. Beachten Sie Tabelle 16.
. **Speichern** Sie die Einstellungen. +
...
. Wählen Sie die Filter. Beachten Sie die Erläuterungen in Tabelle 17.
...
. Öffnen Sie das Menü **Aufträge » POS » Kassenjournal**.
. Wählen Sie die Filter. Beachten Sie die Erläuterungen in Tabelle 16.
. Klicken Sie auf **Suchen**. +
→ Die Kassenvorgänge, die den Suchkriterien entsprechen, werden im Tab **Kassenjournal** aufgelistet.
