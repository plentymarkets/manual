...
*_Tipp:_* Bringen Sie Gutschein-Codes nicht doppelt in Umlauf. Teilen Sie bei mehreren Kassen die Gutschein-Codes entweder auf oder erstellen Sie separate Kampagnen pro Kasse, damit Kassenbenutzer keine Zeit damit vergeuden, bereits verkaufte Gutschein-Codes einzugeben.
