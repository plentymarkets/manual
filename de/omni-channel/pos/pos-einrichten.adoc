...
* Gutschein-Codes in plentymarkets generieren und Kassierern zur Verfügung stellen
* Gutschein-Codes extern erstellen (z.B. bei Gutscheinausstellung) und dann in plentymarkets speichern/importieren

Beide Verfahren werden hier erläutert. Empfohlen wird, Gutschein-Codes in plentymarkets zu generieren und Kassierern diese Codes zur Verfügung zu stellen.
