...
a|
* Ingenico iPP480 mit Drucker (Betriebsart **ZVT**, Verbindungsart **TCP/IP**) - Einbindung über link:XXXX[Ingenico ZVT-Plugin, window="_blank"]
...
Bestimmte Kartenterminals können Sie über Plugins anbinden. Aktuell unterstützt plentymarkets POS die folgenden Karten-Terminals:

* link:XXXX[Ingenico iPP480 mit Drucker (Betriebsart **ZVT**, Verbindungsart **TCP/IP**), window="_blank"]
