...
*_Hinweis:_* Artikel ohne Netto-Warenbestand werden im POS-Warenkorb rot markiert, können aber dennoch verkauft werden. Daher kann es zu rechnerischen Überverkäufen kommen.
...
|*Numpad (Tablet-Ansicht): Buttons für schnelle Mengeneingabe und passende Zahlung einblenden* (ab Version 1.7.9)
...
* *Passend* = Bei passender Barzahlung können Kassenbenutzer auf diesen Button tippen, statt den erhaltenen Betrag einzugeben. Das Feld *Erhalten* wird mit dem zu zahlenden Betrag aufgefüllt.
...
|**Gutscheinbeleg drucken und speichern** (ab Version 1.7.6)
...
*_Hinweis:_* In der Dropdown-Liste werden der Bondrucker und die plentyBase Drucker im Netzwerk angezeigt, auf die die Kasse Zugriff hat.
...
*_Hinweis:_* In den Dropdown-Listen werden der Bondrucker und die plentyBase Drucker im Netzwerk angezeigt, auf die die Kasse Zugriff hat.
...
. Öffnen Sie die plentymarkets App.
. Öffnen Sie das Menü *plentymarkets App » Einstellungen » POS*.
. Tippen Sie rechts oben auf das Menü-Symbol. +
...
→ Wenn alles korrekt eingerichtet ist, wird eine Testseite gedruckt. +
