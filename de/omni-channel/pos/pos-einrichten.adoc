...
*_Hinweis:_* Beim Verkauf eines Gutscheins wird der Gutschein-Code unabhängig von der gewählten Einstellung immer auf dem normalen Auftragsbeleg ausgegeben.
