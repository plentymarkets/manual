...
|**Drucker** +
(nur mit dem Plugin link:https://marketplace.plentymarkets.com/plugins/integration/plentyBase_5053[plentyBase^] verfügbar)
|Optional können weitere Drucker angebunden werden.
Dazu muss das Plugin link:https://marketplace.plentymarkets.com/plugins/integration/plentyBase_5053[plentyBase^] auf einem Rechner installiert sein, der die A4-Drucker ansteuern kann. +
