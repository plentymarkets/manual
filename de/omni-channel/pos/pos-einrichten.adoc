...
* link:https://marketplace.plentymarkets.com/plugins/payment/ingenicozvt_5140[Ingenico-Geräte über ZVT-Schnittstelle, window="_blank"]
* link:https://marketplace.plentymarkets.com/plugins/payment/sumup_5141[SumUp Air, window="_blank"]
...
====
Bei Kassen mit Standortland Österreich, bei denen die Sicherheitseinrichtung aktiviert wurde, muss der Endbeleg in der App erstellt werden, um die Kasse dauerhaft außer Betrieb zu nehmen. Dadurch wird die Kasse automatisch gelöscht.
====
...
[WARNING]
.plentymarkets POS ist nicht RKSV-konform
====
Nach <<omni-channel/pos/pos-einrichten#900, **Erstellen des Startbelegs**>> werden sämtliche Kassenvorgänge RKSV-konform signiert und protokolliert. Aktuell erfüllt plentymarkets POS jedoch noch nicht alle Anforderungen der RKSV.
====

[#870]
=== Übersicht: Inbetriebnahme der Kasse

Für Kassen mit Standort Österreich sind die in Tabelle 1 erläuterten Schritte notwendig, um die von der RKSV vorgeschriebene Sicherheitseinrichtung in Betrieb zu nehmen. Detaillierte Informationen zu diesen rechtlichen Anforderungen finden Sie auf der Website des österreichischen link:https://www.bmf.gv.at/steuern/selbststaendige-unternehmer/Sicherheitseinrichtung_in_Registrierkassen.html[**Bundesministeriums für Finanzen**, window="_blank"]. Auf dieser Handbuchseite werden nur die Schritte beschrieben, die erforderlich sind, um eine plentymarkets POS Kasse mit Standort Österreich in Betrieb zu nehmen. Sie ersetzt keine rechtliche und steuerrechtliche Beratung.
...
[#920]
=== Endbeleg erstellen (Standort Österreich)

Um eine Kasse dauerhaft außer Betrieb zu nehmen, erstellen Sie für Kassen mit Standortland Österreich, für die ein Startbeleg erstellt wurde, einen Endbeleg. Den Endbeleg erstellen Sie im POS-Menü der plentymarkets App. Nachdem der Endbeleg für eine Kasse erstellt wurde, kann die Kasse nicht mehr verwendet werden.
...
→ Die Kasse wird dauerhaft außer Betrieb genommen.
