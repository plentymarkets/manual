...
Nachdem Sie Kassen gebucht haben, richten Sie sie im plentymarkets Backend ein. Dabei weisen Sie die Kassen einem Mandanten zu, indem Sie sie im Menü **System » Mandant » Mandant öffnen » POS** erstellen und weitere Einstellungen vornehmen. Gehen Sie dazu wie unten beschrieben vor.
...
. Öffnen Sie das Menü **System » Mandant » Mandant öffnen » POS**.
...
====
Stellen Sie für die Zahlungsart **11 » Barverkauf/EC-Karte** außerdem im Menü **System » Mandant » Mandant öffnen » POS  » Kasse öffnen » Tab: Zahlungsart** die Option **Ohne Anbindung** im Bereich **EC-Terminal** ein.
====
...
|System » Mandant » Mandant öffnen » Standorte » Standort öffnen » Buchhaltung
...
|System » Mandant » Mandant öffnen » POS » Kasse öffnen » Tab: Beleg
|Identische Auftragspositionen
a|
* Einzeln darstellen
* Zusammenfassen
...
. **Speichern** Sie die Einstellungen.
. Öffnen Sie das Menü **System » Mandant » Mandant öffnen » POS » Kasse öffnen » Grundeinstellungen**.
...
2+|*System » Mandant » Mandant öffnen » POS » Kasse öffnen*
...
====
Aktivieren Sie für Kassenbenutzern mit variablen Benutzerklassen die Rechte **Code erstellen** und **Code anzeigen**. Diese Berechtigungen finden Sie im Menü *System » Benutzer » Benutzer öffnen » Tab: Berechtigung » Tab: REST-API*.
====
