...
Damit neues Kassenpersonal Zugriff auf plentymarkets POS erhält, legen Sie zunächst im plentymarkets Backend <<basics/arbeiten-mit-plentymarkets/benutzer-verwalten#, Benutzerkonten>> der Benutzerklasse **Variabel** für diese Benutzer an. Gehen Sie dazu wie unten beschrieben vor.
