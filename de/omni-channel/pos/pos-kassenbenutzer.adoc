...
[#450]
=== Online-Bestellungen abschließen (ab Version 1.xx)

Viele Unternehmen verkaufen Waren nicht nur im Ladengeschäft, sondern auch über einen Webshop. Kundinnen und Kunden können dann Waren auch über den Webshop bestellen und entweder im Ladengeschäft die bereits bezahlten Artikel abholen oder die bestellten Artikel im Ladengeschäft bezahlen und abholen. In der Praxis können also die folgenden Fälle auftreten:
...
* Sie können nur Zahlungen buchen und Notizen speichern, alle anderen Kassenvorgänge sind gesperrt.
* Die Aufträge können noch nicht mit Verkaufsgutscheinen bezahlt werden.
* Die Aufträge können an der Kasse nicht storniert werden.
* Die Auftragsdaten sind nicht änderbar.

[#460]
==== Bezahlte Online-Bestellung aushändigen (ab Version 1.xx)
...
[.instruction]
Bezahlte Online-Bestellungen an Kunden aushändigen:
...
*_Tipp:_* Um den Auftrag zu verlassen, tippen Sie oben rechts auf das Dreipunktmenü und dann auf *Neuer Auftrag* oder oben links auf *Zurück*.
. Händigen Sie dem Kunden die Ware aus.
. Tippen Sie auf *Auftrag abschließen*. +
→ Die Ware wird automatisch aus dem Lager ausgebucht. +
*_Hinweis:_* Wenn Sie statt auf *Auftrag abschließen* auf *Neuer Auftrag* tippen, wird der Warenausgang nicht gebucht.


[#470]
==== Zahlung für Online-Bestellung buchen (ab Version 1.xx)
...
[#480]
==== Rechnung an der Kasse bezahlen (ab Version 1.xx)
...
====
Tagesabschlussberichte werden im plentymarkets Backend gespeichert. Öffnen Sie das Menü <<auftragsabwicklung/auftraege/dokumentenarchiv#_archivierte_pdf_dokumente_suchen, Aufträge » Dokumentenarchiv>> und filtern Sie nach dem Dokumenttyp *Z-Report*. In der Spalte *Datei* kann der Bericht als PDF-Datei heruntergeladen werden.
====
...
→ Der Tagesabschlussbericht wird in plentymarkets importiert und als Z-Report-Dokument im Menü **Aufträge » Dokumentenarchiv** gespeichert. +
