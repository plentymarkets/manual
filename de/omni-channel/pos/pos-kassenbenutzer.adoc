...
. Bearbeiten Sie den POS-Auftrag wie gewohnt weiter.
. Wenn Sie mit Gutscheinbelegen arbeiten, wird ein Gutscheinbeleg erstellt, wenn der Gutschein nicht vollständig eingelöst wird. Händigen Sie dem Kunden dann auch den Gutscheinbeleg aus. +
