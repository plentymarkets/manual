...
////
→ Für Kassen mit dem Standort Österreich wird ein Nullbeleg erstellt und im Kassenjournal gespeichert.
////
...
Monatsbelege sind signierte Kontrollbelege mit einem Betrag von Null (0) Euro. Laut RKSV muss am Ende jedes Monats ein Monatsbeleg erstellt werden. Der Monatsbeleg für den Monat Dezember dient gleichzeitig als Jahresbeleg.
...
=== Die Signatureinheit ist ausgefallen - was jetzt?

Wie Sie vorgehen sollten, wenn die Signatureinheit der Registrierkasse ausfällt, ist von den Abläufen in Ihrem Ladengeschäft abhängig. Erkundigen Sie sich daher,

* Weichen Sie wenn möglich auf eine Registrierkasse mit funktionierender Signatureinheit aus.
* Notieren Sie den Zeitpunkt des Ausfalls.
* Informieren Sie ggf. Ihren Vorgesetzten und Kollegen über den Ausfall.
