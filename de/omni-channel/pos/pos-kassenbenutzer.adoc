...
[#450]
=== Online-Bestellungen abschließen (ab Version 1.8.9)
...
[#460]
==== Bezahlte Online-Bestellung aushändigen (ab Version 1.8.9)
...
[#470]
==== Zahlung für Online-Bestellung buchen (ab Version 1.8.9)
...
[#480]
==== Rechnung an der Kasse bezahlen (ab Version 1.8.9)
...
====
Tagesabschlussberichte werden im plentymarkets Backend gespeichert. Öffnen Sie das Menü <<auftragsabwicklung/auftraege/dokumentenarchiv#_archivierte_pdf_dokumente_suchen, Aufträge » Dokumentenarchiv>>. Filtern Sie nach dem Dokumenttyp *Tagesabschluss*. In der Spalte *Datei* kann der Bericht als PDF-Datei heruntergeladen werden.
====
