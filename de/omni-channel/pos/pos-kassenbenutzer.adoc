...
Wenn Kunden Artikel zurückgeben möchten, haben Sie zwei Möglichkeiten, einer Retoure zu buchen:

* Sie rufen den Originalauftrag auf und führen die Retoure über diesen ursprünglichen Hauptauftrag durch (ab Version x.xx).
...
====
Aus technischen Gründen kann der Retourenbestrag aktuell nur in bar an Kunden ausgezahlt werden.
====

=== Retoure mit Zuordnung zum Hauptauftrag buchen (ab Version x.xx)
...
. Zahlen Sie dem Kunden den Retourenbetrag aus.
