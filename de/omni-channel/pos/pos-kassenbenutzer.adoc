...
*_Tipp:_* Alternativ tippen Sie in der App oben links auf das Menüsymbol und dann auf *Ausloggen*. +
...
. Wenn der Auftrag vollständig bezahlt ist, tippen Sie auf *Betrag erhalten/Zahlung abschließen*. Buchen Sie sonst weitere Zahlungen. +
→ Die Ansicht *Auftrag erstellt* wird angezeigt. +
→ Der Auftrag wird erstellt. +
→ Ein Beleg wird gedruckt. Alternativ tippen Sie auf *Beleg drucken*, um den Beleg zu drucken. +
