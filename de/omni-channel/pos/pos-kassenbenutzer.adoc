...
====
Aufträge mit Kauf auf Rechnung können bis zum nächsten Tagesabschluss wie gewohnt storniert werden. Aus technischen Gründen sind aktuell jedoch Retouren von nicht oder nur teilweise bezahlten Aufträgen mit Rechnungskauf noch nicht möglich. Nur vollständig bezahlte Aufträge können retourniert werden. Da Sie jedoch in der plentymarkets App nicht prüfen können, ob ein Auftrag vollständig bezahlt wurde, müssen Sie vor einer Retoure im plentymarkets Backend prüfen, ob der Auftrag tatsächlich vollständig bezahlt wurde.
====
...
Wenn Sie ohne Scanner arbeiten, erfassen Sie die Retourenartikel manuell. Wie Sie dabei vorgehen ist allerdings davon abhängig, wie die Kasse eingestellt ist. Denn je nach Kasseneinstellung sind beim Öffnen des Auftrags entweder alle Artikel eines Auftrags für die Retoure vorausgewählt oder es sind keine Artikel für die Retoure vorausgewählt. Der Retourenwarenkorb ist also beim Öffnen des Auftrags entweder voll oder leer:

* Alle Auftragspositionen sind vorausgewählt, wenn Sie den Artikel öffnen. +
...
* Keine Auftragspositionen sind vorausgewählt, wenn Sie den Artikel öffnen. +
...
*_Tipp:_* Der Betrag, den der Kunde noch bezahlen muss, steht auf dem Retourenbeleg.
|Der Kunde bekommt kein Geld zurück. +
...
* Zurückgegebene Artikel kosten mehr als der noch offene Rechnungsbetrag = Der Kunde bekommt die Summe aus offenem Betrag minus Preis des zurückgegebenen Artikels zurück.  +

Im Hintergrund wird bei der Retoure eine Gutschrift für die zurückgegebenen Artikel erstellt. Dabei stimmen der Gutschriftsbetrag und der ausgezahlte Betrag nicht unbedingt überein.
...
Wenn Sie mit plentyBase und Etikettendruckern arbeiten, können Sie in der Artikelsuche der plentymarkets App auch Artikeletiketten drucken. Wie das geht, erfahren Sie im Kapitel
<<artikel/artikel-verwalten#3340, Etikett in der Artikelsuche der plentymarkets App drucken>>.
