...
. Wählen Sie das Konto aus der Dropdown-Liste, das der Einlage zugeordnet werden soll.
. *_Optional:_* Geben Sie in das Feld **Grund** weitere Informationen zu der Einlage ein.
...
→ Das **POS-Menü** wird eingeblendet.
. Tippen Sie auf **Einlagen und Entnahmen**.
. Wählen Sie das Konto aus der Dropdown-Liste, das der Entnahme zugeordnet werden soll.
. *_Optional:_* Geben Sie in das Feld **Grund** weitere Informationen zu der Entnahme ein.
