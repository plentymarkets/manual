...
Wenn Sie mit Artikeletiketten arbeiten, können Sie Artikel auch zum POS-Warenkorb hinzufügen, indem Sie das Etikett eines Artikels scannen. Artikel können Sie über die Kamera des Mobilgeräts oder einen angeschlossenen Scanner einlesen. Gehen Sie dazu wie unten beschrieben vor.

[.instruction]
Artikeletikett mit integrierter Kamera scannen:
...
→ Der Artikel wird mit einer Menge von 1 in den Warenkorb gelegt und die zu zahlende Summe aktualisiert. +
...
[.instruction]
Artikeletikett mit externem Scanner scannen:
