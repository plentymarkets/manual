...
*_Hinweis:_* Buchen Sie bei einer Teilzahlung auf Rechnung alle anderen Zahlungsarten und wählen Sie erst zuletzt die Option *Rechnungskauf*, um den Restbetrag als Rechnungsbetrag zu übernehmen.
→ Die erste Zahlung wird gebucht.
. Geben Sie über das Ziffernfeld den Betrag ein, den die Kundin mit der zweiten Zahlungsart bezahlen möchte.
. Tippen Sie auf den Button für die Zahlungsart, in der Sie den Betrag erhalten haben. +
*_Tipp:_* Wenn Sie zweimal eine Barzahlung buchen, werden die beiden Zahlungen addiert.
→ Die zweite Zahlung wird gebucht.
