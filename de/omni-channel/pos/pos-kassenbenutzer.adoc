...
Nachdem Sie alle Artikel des Kunden in den POS-Warenkorb gelegt haben und bei Bedarf Rabatte/Verkaufsgutscheine angewendet haben, buchen Sie die Zahlung. Kunden können in Bar und je nach den Abläufen in Ihrem Ladengeschäft auch über einen EC-Terminal oder per Gutschein bezahlt werden.
...
*_Tipp:_* Wenn Sie den Betrag passend erhalten und der Button *Betrag erhalten* wählbar ist, können Sie auf *Betrag erhalten* tippen, ohne den Betrag einzugeben. Die Auftragssumme wird dann automatisch als gezahlter Betrag übernommen. Diese Komfortfunktion muss ein Administrator für die Kasse aktivieren.
