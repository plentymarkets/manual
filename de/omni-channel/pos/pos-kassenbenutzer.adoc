...
====
Tagesabschlussberichte werden im plentymarkets Backend gespeichert. Öffnen Sie das Menü <<auftragsabwicklung/auftraege/dokumentenarchiv#_archivierte_pdf_dokumente_suchen, Aufträge » Dokumentenarchiv>> und filtern Sie nach dem Dokumenttyp *Tagesabschluss*. In der Spalte *Datei* kann der Bericht als PDF-Datei heruntergeladen werden.
====
