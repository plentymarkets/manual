...
* Sie rufen den Originalauftrag auf und führen die Retoure über diesen ursprünglichen Hauptauftrag durch (ab Version 1.9).
* Wenn der Hauptauftrag nicht bekannt ist oder nicht geöffnet werden kann, erstellen Sie eine Retoure ohne Hauptauftrag.

=== Retoure mit Zuordnung zum Hauptauftrag buchen (ab Version 1.9)
...
Wenn dem Kunden nicht der volle Kaufpreis erstattet werden soll, zum Beispiel, weil Artikel beschädigt sind, ändern Sie den Preis einer Auftragsposition.
