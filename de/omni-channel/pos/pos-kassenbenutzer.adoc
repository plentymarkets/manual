...
[#400]
=== Zugriff sperren und entsperren (ab Version 1.8.3)
...
[#390]
=== Abmelden und Login-Daten verwerfen (ab Version 1.8.3)
...
[#420]
=== App beenden und aktuelle Login-Daten merken (ab Version 1.8.3)
...
. Tippen Sie unten rechts auf das Symbol *Ausloggen*. +
→ Das Fenster *Ausloggen* wird angezeigt. +
*_Oder:_* Tippen tippen Sie in der App oben links auf das Menüsymbol und dann auf *Ausloggen*. +
...
. Wenn der Auftrag vollständig bezahlt ist, tippen Sie auf *Betrag erhalten/Zahlung abschließen*, um die Zahlung abzuschließen. +
→ Die Ansicht *Auftrag erstellt* wird angezeigt. +
→ Der Auftrag wird erstellt. +
→ Ein Beleg wird gedruckt. Tippen Sie sonst auf *Beleg drucken*, um den Beleg zu drucken. +
...
→ Der Auftrag wird erstellt. +
→ Die Belege werden gedruckt. Tippen Sie sonst auf *Händlerbeleg drucken* bzw. *Kundenbeleg drucken*, um das Drucken manuell zu starten. +
*_Tipp:_* Über den Button *Auftrag anzeigen* rufen Sie die Auftragsdaten auf.
. Tippen Sie auf *Neuer Auftrag*, um einen neuen POS-Auftrag zu erstellen.
...
[IMPORTANT]
.Bei Teilbeträgen Rechnungskauf immer zuletzt
====
...
→ Wenn der gesamte Auftrag bezahlt wurde, wird der Auftrag abgeschlossen.
→ Die Ansicht *Auftrag erstellt* wird angezeigt. +
→ Der Auftrag wird erstellt. +
→ Die Belege werden gedruckt. Alternativ tippen Sie auf *Belege drucken*. +
. Händigen Sie der Kunden den Beleg aus.
...
. *_Optional:_* Wählen Sie einen anderen Ziellagerort (ab Version 1.8.2): +
...
. Tippen Sie auf *Abschließen und Bargeld auszahlen* oder (optional, ab Version 1.8.3) auf *Abschließen und Gutschein erstellen*. +
...
→ Als Ziellagerort wird der *Standard-Reparaturlagerort* der Kasse angezeigt.
. *_Optional:_* Wählen Sie einen anderen Ziellagerort für den Artikel (ab Version 1.8.2): +
  .. Tippen Sie auf den Artikel.
  .. Wählen Sie in der Dropdown-Liste die Option *Ziellagerort ändern*. +
...
. Ändern Sie bei Bedarf die Menge und Lagerorte weiterer Auftragspositionen.
. *_Optional:_* Fügen Sie eine <<omni-channel/pos/pos-kassenbenutzer#100, Notiz zur Retoure hinzu>>.
. Streichen Sie auf dem Kassenbeleg die zurückgegebenen Artikel durch.
. Tippen Sie auf *Abschließen und Bargeld auszahlen* oder (optional, ab Version 1.8.3) auf *Abschließen und Gutschein erstellen*. +
. Wenn der Hauptauftrag Versandkosten enthält, wählen Sie, ob diese Versandkosten erstattet werden sollen. +
