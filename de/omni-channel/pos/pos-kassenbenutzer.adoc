...
. **__Abhängig vom Kartenterminal:__** Wählen Sie, ob der stornierte Betrag bar oder über das Terminal zurückerstattet werden soll.
. Zahlen Sie den stornierten Betrag bar aus oder wickeln Sie die Rückzahlung über das Kassenterminal ab.
