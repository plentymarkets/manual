...
Wenn Sie den Kassenbereich verlassen, aber weiterhin eingeloggt bleiben möchten, sperren Sie den Zugriff auf die App. Gehen Sie wie unten beschrieben vor, um den Zugriff auf die App zu sperren und zu entsperren.
...
=== Über das Hauptmenü abmelden

[.instruction]
Über das Hauptmenü abmelden und App beenden:

. Tippen Sie in der App oben links auf das Menüsymbol. +
→ Die verfügbaren Menüpunkte werden angezeigt.
...
=== Über die Benutzerliste abmelden
