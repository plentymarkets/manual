...
////
h2>Barbestand prüfen<a id="20." name="20."></a></h2>

<p>Nachdem Sie sich bei plentymarkets POS angemeldet haben, werden Sie aufgefordert, den aktuellen Barbestand zu prüfen und zu bestätigen. </p>

<h5>Aktuellen Barbestand prüfen:</h5>

<ol>
<li>Melden Sie sich bei der plentymarkets App an.</li>
<li>Tippen Sie in der Menüleiste auf das <strong>Menüsymbol</strong>.</li>
<li>Tippen Sie auf <strong>POS beta</strong>.<br />
→ Der Soll-Kassenbestand wird angezeigt.</li>
<li>Prüfen Sie, ob der tatsächliche Kassenbestand mit dem angezeigten Soll-Kassenbestand übereinstimmt.</li>
<li>Wenn die Kassenbestände übereinstimmen, tippen Sie auf das Häkchen.</li>
<li>Wenn die Kassenbestände nicht übereinstimmen, geben Sie den tatsächlichen Kassenbestand ein. Tippen Sie dann auf das Häkchen.<br />
→ Der aktuelle Kassenbestand wird gespeichert und der Warenkorb geöffnet.</li>
</ol
////
[#30]
== Kassieren
...
_*Hinweis:*_ Jeder Gutschein-Code darf nur einmal verkauft werden, da der Betrag nur einmal eingelöst werden kann.
...
. Tippen Sie im Menü **POS beta** auf **Retoure**. +
...
. Fügen Sie optional eine Notiz zur Retoure hinzu. [.collapseBox]
.Notiz hinzufügen
--
...
. Tippen Sie auf **Einlagen und Entnahmen**. +
→ Ein Tastenfeld wird angezeigt, über das Sie den Betrag eingeben können.
. Geben Sie in das Feld **Grund** Informationen zu der Entnahme ein (optional).
