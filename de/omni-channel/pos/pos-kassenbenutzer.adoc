...
*_Hinweis:_* Der Gutschein-Code steht auf dem Gutscheinbeleg und dem Kassenbeleg. Daher sollten Kunden beide Belege mitnehmen, damit niemand sonst den Gutschein einlöst.
