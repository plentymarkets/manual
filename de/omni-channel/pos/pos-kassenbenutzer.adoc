...
*_Tipp:_* (ab Version 1.8.5) Wenn die Kundin den gesamten Betrag mit nur einer EC-Kartenzahlung zahlen möchte, brauchen Sie den Betrag nicht mehr einzugeben, bevor Sie auf *EC-Terminal* tippen. Der Gesamtbetrag wird automatisch für die EC-Zahlung übernommen.
