...
|**Land**
|Land aus der Dropdown-Liste wählen, in dem die Kasse eingesetzt wird. Standardeinstellung richtet sich nach der Option **Firmensitz für FiBu** im Menü **<<basics/arbeiten-mit-plentymarkets/grundeinstellungen/stammdaten#, Einstellungen » Grundeinstellungen » Stammdaten  >>**.
