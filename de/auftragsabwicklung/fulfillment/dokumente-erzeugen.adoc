...
. Erzeugen Sie eine oder mehrere Rechnungen. Beachten Sie dazu die Erläuterungen auf der Handbuchseite <<auftragsabwicklung/auftraege/fulfillment/rechnungen-erzeugen#, **Rechnungen erzeugen**  >>.
. Erstellen Sie aus diesen Rechnungen eine Packliste aller Aufträge, die nun verpackt werden müssen. Beachten Sie dazu die Erläuterungen auf der Handbuchseite <<auftragsabwicklung/auftraege/fulfillment/packliste#, **Packliste**  >>.
...
Richten Sie im Menü **Einstellungen » Aufträge » Ereignisaktionen** eine Ereignisaktion ein und wählen Sie für das Ereignis **Auftragsänderung &gt; Paketnummer** die Aktion **Auftrag &gt; Warenausgang buchen**. Zudem können Sie Ihren Kunden eine E-Mail-Vorlage mit der Paketnummer und einem Link zu Paketverfolgung senden. Weitere Informationen zu Ereignisaktionen finden Sie auf der Handbuchseite <<auftragsabwicklung/auftraege/einstellungen/ereignis-aktionen#, **Ereignisaktionen**  >>.
