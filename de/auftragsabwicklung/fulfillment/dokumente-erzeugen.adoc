...
////
p>Bereiten Sie die im Folgenden beschriebene Ereignisaktion vor.</p>
...
<li>Wählen Sie das <strong>Ereignis</strong> gemäß Tabelle 1.</li>
<li><strong>Speichern</strong> Sie die Einstellungen.</li>
<li>Nehmen Sie die Einstellungen gemäß Tabelle 1 vor.</li>
...
<table>
<caption>Ereignisaktion zum automatischen Buchen des Warenausgangs</caption>
<tr>
<th>Einstellung</th>
<th>Option</th>
<th>Auswahl</th>
...
<td><strong>Auftragsänderung: Statuswechsel</strong></td>
<td>Status <strong>[7] Warenausgang gebucht</strong></td>
</tr>
<tr>
...
<td><strong>Auftrag > Warenausgang buchen</strong></td>
<td></td>
</tr>
</table
////
...
. Nehmen Sie die Einstellungen im Bereich **CSV-Import** vor. Beachten Sie dazu die Erläuterungen in Tabelle 2.
...
a|Option im Dropdown-Menü wählen, z.B. **Auftrags-ID**. Spalte der CSV-Datei wählen, in der z.B. die **Auftrags-ID** oder eine andere Option enthalten ist, die zur Identifizierung der Pakete verwendet werden soll. +
...
Richten Sie im Menü **Einstellungen » Aufträge » Ereignisaktionen** eine Ereignisaktion ein und wählen Sie für das Ereignis **Auftragsänderung &gt; Paketnummer** die Aktion **Auftrag &gt; Warenausgang buchen**. Zudem können Sie Ihren Kunden eine E-Mail-Vorlage mit der Paketnummer und einem Link zu Paketverfolgung senden. Weitere Informationen zu Ereignisaktionen finden Sie auf der Handbuchseite <<auftragsabwicklung/auftraege/einstellungen/ereignisaktionen#, **Ereignisaktionen**  >>.
...
Wenn Sie bereits eine Adressetikettenvorlage erstellt und eine PDF-Vorlage hinterlegt haben, fahren Sie fort mit Kapitel <<auftragsabwicklung/fulfillment/dokumente-erzeugen#700, **Adressetikett erzeugen** >>.
...
. Öffnen Sie das Menü **Einstellungen » Aufträge » Dokumente » Adressetikett**.
...
.Einstellungen im Menü **Einstellungen » Aufträge » Dokumente » Adressetikett**
[cols="a,a"]
|====
|Einstellung |Erläuterung
...
|**Artikelauflistung**
|Die Artikelauflistung bestimmt, wie die Artikeldaten auf dem Etikett angezeigt werden. Es gibt zwei Typen: **Standard** und **Individuell**. Eine Erläuterung zu diesen beiden Typen finden Sie im Kapitel <<auftragsabwicklung/fulfillment/dokumente-erzeugen#600, **Artikelauflistung** >>.
...
|**Kundeneigenschaften**
|Die Koordinaten zur Positionierung der Kundeneigenschaften eingeben. Die <<crm/kundendaten-verwalten#400, **Eigenschaft** >> aus dem Dropdown-Menü wählen. Auf den Adressetiketten wird der Text angezeigt, der im Menü <<crm/kundendaten-verwalten#1500, **Kunden » Kunden bearbeiten » Kunde suchen » Kunde öffnen » Tab: Eigenschaften** >> gespeichert wurde.

|**Freitextfelder 1 bis 10**
|Freitextfelder ermöglichen das Anzeigen beliebiger Texte, die dort eingegeben wurden. +
**__Beispiel__**: Ein verbreitetes Anwendungsbeispiel ist das Hinterlegen des Absenders.
|====

Bereits erstellte Vorlagen können Sie im Menü **Einstellungen » Aufträge » Dokumente » Adressetikett » Tab: Vorlagen** im Dropdown-Menü **Vorlage** wählen und bearbeiten. Sie haben auch die Möglichkeit, eine Vorschau des Etiketts anzuzeigen und die Vorlage im Vorschaumodus direkt zu drucken. Wenn Sie die Vorlage löschen, wird auch die Verknüpfung der PDF-Vorlage gelöscht.
...
. Nehmen Sie die Einstellungen für die Suchfilter vor. Beachten Sie dazu die Erläuterungen in Tabelle 5.
