...
**Lieferant aktiv** = Lieferländer mit dieser Eigenschaft stehen für die Einstellung als **Standardlieferland** im Menü **<<omni-channel/online-shop/mandanten-einrichten/bestellvorgang/grundeinstellungen#, Einstellungen » Mandant (Shop) » Standard » Bestellvorgang » Grundeinstellungen  >>** nicht zur Verfügung.

|**Lager**
|Lager wählen, das dem Lieferland als Hauptlager zugeordnet werden soll und z.B. in Aufträgen automatisch eingestellt sein soll. **ALLE** wählen, wenn alle Lager dem Lieferland zugeordnet werden sollen. In diesem Fall wird für Aufträge automatisch das Lager mit der kleinsten ID gewählt. Dazu auch die <<auftragsabwicklung/auftraege/einstellungen/grundeinstellungen#, **Lagereinstellungen**  >> im Menü **Einstellungen » Aufträge » Grundeinstellungen** beachten.
...
|**Inselzuschlag**
|Viele Versanddienstleister nehmen für Inselregionen höhere Gebühren. Auf diesen Kosten sollte der Händler nicht sitzenbleiben. Daher pro Versandprofil einen pauschalen Aufschlag für den Versand in Inselregionen festlegen. Eine Liste der Postleitzahlen, für die Inselzuschlag berechnet wird, sollte ggf. beim Versanddienstleister erhältlich sein. Die Postleitzahlen der Inselregionen sind systemseitig hinterlegt. Der Abgleich mit dem Auftrag erfolgt automatisch. Bei Aktivierung des Inselzuschlags erfolgt eine Berechnung nur, wenn die Postleitzahl im System als Inselregion erkannt wird. +
...
[.subhead]
Berechnungstyp: Gewichtsabhängig[#1620]
...
[.subhead]
Berechnungstyp: Volumenabhängig[#1630]
...
[.subhead]
Berechnungstyp: Mengenabhängig[#1640]
...
[.subhead]
Berechnungstyp: Preisabhängig[#1650]
...
[.subhead]
Berechnungstyp: Artikelporto[#1660]
...
====
Wenn ein Auftrag Artikel enthält, bei denen kein Versandprofil aktiviert wurde, wird das Standardversandprofil aus dem Standard-Webshop für die Artikel verwendet. Das Standardversandprofil wählen Sie im Menü <<omni-channel/online-shop/mandanten-einrichten/bestellvorgang/grundeinstellungen#, **Einstellungen » Mandant (Shop) » Standard » Bestellvorgang » Grundeinstellungen**  >>. Wenn kein Standardversandprofil eingerichtet ist, wird das Versandprofil mit der höchsten Priorität verwendet.
====
...
====
Wenn Sie mit dem Generieren der Exportdokumente gleichzeitig den Warenausgang buchen möchten, können Sie das über eine Ereignisaktion im Menü **Einstellungen » Aufträge » Ereignisaktionen** erledigen. Weitere Informationen finden Sie auf der Handbuchseite **<<auftragsabwicklung/auftraege/einstellungen/ereignisaktionen#, Ereignisaktionen  >>**.
====
...
Richten Sie nun eine **<<auftragsabwicklung/auftraege/einstellungen/ereignisaktionen#, Ereignisaktion  >>** ein, um die Retourenetiketten automatisch zu erzeugen.
...
Wenn Sie erlauben, dass Kunden Retouren selbst anlegen können, stehen die <<auftragsabwicklung/auftraege/einstellungen/auftragstypen/retoure#, **Retourengründe**  >>, die Sie eingegeben haben, auch im **Mein-Konto**-Bereich zur Auswahl. +
...
[.subhead]
Lager für DHL Fulfillment erstellen[#4900]
...
[.subhead]
Auftragsstatus erstellen[#5000]

Zur Zuordnung legen Sie im Menü **Einstellungen » Aufträge » Auftragsstatus** zwei <<auftragsabwicklung/auftraege/einstellungen/auftragsstatus#, **Auftragsstatus**  >> für die an DHL Fulfillment übermittelten Aufträge an. Nachfolgend zwei Beispiele:
...
[.subhead]
Retourengründe anlegen[#5100]

Wenn die Retouren von DHL Fulfillment in Ihr plentymarkets System importiert werden sollen, benötigen Sie Retourengründe. Diese Retourengründe legen Sie im Menü **<<auftragsabwicklung/auftraege/einstellungen/auftragstypen/retoure#, Einstellungen » Aufträge » Auftragstypen » Retoure  >>** an. Verknüpfen Sie dann die von Ihnen konfigurierten Retourengründe mit den von DHL Fulfillment vorgegebenen Gründen im Menü **Einstellungen » Aufträge » Versand » Fulfillment-Dienstleister » DHL Fulfillment**.

[.subhead]
Schnittstelle einrichten[#5200]
...
|**Retourengründe**
|Retourengründe von DHL Fulfillment mit den im Menü **<<auftragsabwicklung/auftraege/einstellungen/auftragstypen/retoure#, Einstellungen » Aufträge » Auftragstypen » Retoure  >>** angelegten Retourengründen verknüpfen.
|====
