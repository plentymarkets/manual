...
|<<auftragsabwicklung/fulfillment/versand-vorbereiten#4250, *Parcelforce Wordlwide*>>
|Für Händler innerhalb des Vereinigten Königreichs. Versand: international.
...
Die aktuell gültige, plentymarkets bekannte Tracking-URL von DHL lautet +http://nolp.dhl.de/nextt-online-public/set_identcodes.do?lang=de&zip=$PLZ&idc=$PaketNr+.
...
Die aktuell gültige, plentymarkets bekannte Tracking-URL von DPD lautet +https://tracking.dpd.de/parcelstatus?query=[PaketNr]&locale=de_DE+.
...
Die aktuell gültige, plentymarkets bekannte Tracking-URL von GLS lautet +http://www.gls-group.eu/276-I-PORTAL-WEB/content/GLS/DE03/DE/5004.htm?txtRefNo=[PaketNr]&txtAction=71000+.
...
Die aktuell gültige, plentymarkets bekannte Tracking-URL von Hermes lautet +http://myhermes.de/wps/portal/PRIPS_DEU/SISYR?auftragsNummer=[PaketNr]+.
...
Die aktuell gültige, plentymarkets bekannte Tracking-URL von UPS lautet +http://wwwapps.ups.com/WebTracking/track?track=yes&trackNums=[PaketNr]&loc=de_de+.
