...
====
Bei Aufträgen mit der Zahlungsart *Nachnahme*, die über DPD versendet werden sollen, wird der Nachnahme-Service automatisch gewählt. Zusätzlichen Einstellungen sind nicht erforderlich.
====
