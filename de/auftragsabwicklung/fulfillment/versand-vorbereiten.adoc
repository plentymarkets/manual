...
*_Hinweis:_* Wenn im Versandprofil die Option *Einwilligung zur Übertragung von Daten an Versanddienstleister anzeigen* aktiviert ist, wird die Adresse des Versanddienstleisters dann im Webshop in einer Checkbox, mit dessen Aktivieren der Kunde der Übertragung seiner Telefonnummer und E-Mail-Adresse an den Versandddienstleister zustimmt, angezeigt.
...
|*Einwilligung zur Übertragung von Daten an Versanddienstleister anzeigen*
|Option aktivieren, wenn dem Kunden im Webshop eine Checkbox angezeigt werden soll, mit dessen Aktivieren der Kunde zustimmt, dass ggf. seine Telefonnummer und E-Mail-Adresse an den Versanddienstleister übertragen werden.
