...
Gehen Sie wie im Folgenden beschrieben vor, um die Schnittstelle zu link:https://www.post.at/geschaeftlich.php[*EasyPAK*, window="_blank"] in plentymarkets einzurichten.
