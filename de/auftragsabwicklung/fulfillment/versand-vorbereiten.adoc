...
*_Hinweis:_* Wenn im Versandprofil die Option *Einwilligung zur Datenübertragung* aktiviert ist, wird die Adresse des Versanddienstleisters dann im Ceres-Webshop in einer Checkbox angezeigt. Wenn der Kunde diese aktiviert, stimmt dieser der Übertragung seiner Telefonnummer und E-Mail-Adresse an den Versandddienstleister zu.
