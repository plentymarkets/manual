...
|Käufer haben im Webshop auch die Möglichkeit, die Postnummer des DHL-Services *Postfinder* zu hinterlegen. Wählen, ob die Postnummer im Bestellvorgang abgefragt werden soll. +
