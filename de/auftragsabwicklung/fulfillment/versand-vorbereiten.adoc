...
. Öffnen Sie das Menü *System » Mandant » Mandant wählen » Mein-Konto » Grundeinstellungen*.
. Wählen Sie in der Zeile *Retoure* eine Option aus dem Dropdown-Menü. Beachten Sie dazu die Erläuterungen in Tabelle 21.
. *Speichern* Sie die Einstellungen.

.Retourenanlage im Menü *System » Mandant » Mandant wählen » Mein-Konto » Grundeinstellungen* erlauben
[cols="a,a"]
|====
|Einstellung |Erläuterung
