...
.Template-Variablen
====
Zu den verschiedenen Berechnungstypen finden Sie <<omni-channel/online-shop/_cms-syntax/grundlagen/template-variablen#, **Template-Variablen**  >> im Menü <<omni-channel/online-shop/_cms-syntax/webdesign/itemview/container-itemviewsingleitem#, **CMS » Webdesign » Layout » ItemView » ItemViewSingleItem**  >>. Die Template-Variable **$Volumen** gibt dabei keine Maße zurück, sondern das Volumen in Kubikmeter.
====
...
Mit dem DHL-Postfinder werden Ihren Kunden im Mein Konto-Bereich bei der <<omni-channel/online-shop/_cms/webdesign/webdesign-bearbeiten/bestellvorgang/kaufabwicklung#, **Kaufabwicklung**  >> anhand der Postleitzahl die in der Nähe liegenden Postfilialen und Packstation angezeigt. Ihre Kunden haben dann die Möglichkeit, die Auswahl direkt in die Lieferanschrift zu übernehmen.

Um den DHL-Postfinder zu nutzen, müssen Sie Einstellungen in mehreren Menüs vornehmen. Diese Einstellungen sind auf der Handbuchseite <<omni-channel/online-shop/_cms/webdesign/webdesign-bearbeiten/bestellvorgang/dhl-postfinder#, **DHL-Postfinder**  >> zusammengefasst.
...
Zur Zuordnung legen Sie im Menü **Einstellungen » Aufträge » Auftragsstatus** zwei <<auftragsabwicklung/auftraege/auftragsstatus#, **Auftragsstatus**  >> für die an DHL Fulfillment übermittelten Aufträge an. Nachfolgend zwei Beispiele:
