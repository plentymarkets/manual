...
*_Wichtig_*: Mindestens 2 Konten müssen angelegt sein, andernfalls ist diese Option nicht sichtbar. Weitere Informationen finden Sie im Kapitel <<auftragsabwicklung/fulfillment/versand-vorbereiten#1200, Tipps und Tricks: Versandkosten von Bestellungen über eBay>>.
...
Weitere Informationen finden Sie auf der Handbuchseite <<basics/datenaustausch/export-import/daten-exportieren#, Daten exportieren>> im Kapitel <<basics/datenaustausch/export-import/daten-exportieren#30, Datenformate für Preissuchmaschinen exportieren>>.
...
Wählen Sie im Menü *System » Artikel » Einstellungen* das soeben erstellte Merkmal aus der Dropdown-Liste *Artikelmerkmal zur Alterssichtprüfung*. *Speichern* Sie die Einstellungen.
...
====
Sie haben die Möglichkeit, das Retourenetikett automatisch an Ihren Kunden zu versenden. Richten Sie dazu eine Ereignisaktion ein und wählen als Ereignis *Retourenlabel gespeichert*. Außerdem richten Sie eine E-Mail-Vorlage im Menü *System » Mandant » Mandant wählen » E-Mail » Vorlagen* ein und wählen aus der Dropdown-Liste *PDF-Anhang* die Option *Retoure*.
====
...
Gehen Sie wie im Folgenden beschrieben vor, um link:https://gls-group.eu/DE/de/home[GLS Germany^] mit plentymarkets zu nutzen. Beachten Sie, dass die Daten, die Sie im Menü *System » Aufträge » Versand » Dienstleister » GLS Germany* eingeben, ausschließlich in der CSV-Datei, die Sie im Menü *Aufträge » Fulfillment » Bereich: Lieferanschriftenliste* mit dem Datenformat *GLS preadvise* generieren, ausgegeben werden. Eine direkte Schnittstelle zu GLS Germany existiert nicht in plentymarkets.
...
Details zum Einrichten des Postfinder finden Sie im Kapitel <<auftragsabwicklung/fulfillment/versand-vorbereiten#4600, DHL-Postfinder einrichten>>.
...
Zur Zuordnung legen Sie im Menü *System » Aufträge » Auftragsstatus* 2 <<auftragsabwicklung/auftraege/auftraege-verwalten#, Auftragsstatus>> für die an DHL Fulfillment übermittelten Aufträge an. Im Folgenden finden Sie 2 Beispiele:
...
|*Schnittstelle aktiv*
|Option aktivieren, um die Schnittstelle zu aktivieren. Schnittstelle erst aktivieren, wenn die <<auftragsabwicklung/fulfillment/versand-vorbereiten#4900, Lager erstellt>> wurden.
...
====
Erstellen Sie im Menü *System » Artikel » Merkmale* die folgenden 3 Merkmale mit dem Merkmaltyp *Kein*:
...
Erstellen Sie dann im Menü *System » Aufträge » Versand » Optionen » Tab: Versanddienstleister* den Fulfillment-Dienstleister. Wählen Sie in der Spalte *Versanddienstleister* die Option *Sonstiges* aus der Dropdown-Liste. Weitere Informationen finden Sie im Kapitel <<auftragsabwicklung/fulfillment/versand-vorbereiten#800, Versanddienstleister erstellen>>.
