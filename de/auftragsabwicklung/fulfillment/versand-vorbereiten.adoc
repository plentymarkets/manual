...
|*Treueprogramm*
|Ein oder mehrere Treueprogramme wählen. Die Treueprogramme können Sie mit <<omni-channel/multi-channel/ebay/ebay-einrichten#6600, eBay Plus>> oder <<omni-channel/multi-channel/amazon/amazon-einrichten#4200, Amazon einrichten>> verwenden. +
...
Gehen Sie wie im Folgenden beschrieben vor, um die Schnittstelle zu link:http://cbc-logistics.com/[c.b.c. logistics^] in plentymarkets einzurichten.

[.instruction]
Schnittstelle einrichten:

. Öffnen Sie das Menü *System » Aufträge » Versand » Dienstleister » CBC Logistics*.
...
. Wechseln Sie in das Tab *Portotabelle*.
. Klappen Sie die Region auf.
. Nehmen Sie die Einstellungen im Bereich *CBC Logistics* vor. Beachten Sie dazu die Erläuterungen in <<tabelle-versandservices-cbc-logistics>>.
. *Speichern* Sie die Einstellungen.

[[tabelle-versandservices-cbc-logistics]]
...
====
Sie haben die Möglichkeit, das Retourenetikett automatisch an Ihren Kunden zu versenden. Richten Sie dazu eine Ereignisaktion ein und wählen als Ereignis *Retourenlabel gespeichert*. Außerdem richten Sie eine E-Mail-Vorlage im Menü *Mandant » Mandant wählen » E-Mail » Vorlagen* ein und wählen im Dropdown-Menü *PDF-Anhang* die Option *Retoure*.
====
