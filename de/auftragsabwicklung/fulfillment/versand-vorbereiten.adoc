...
Gehen Sie wie im Folgenden beschrieben vor, um link:https://gls-group.eu/DE/de/home[GLS Germany^] mit plentymarkets zu nutzen. Beachten Sie, dass die Daten, die Sie im Menü *System » Aufträge » Versand » Dienstleister » GLS Germany* eingeben, ausschließlich in der CSV-Datei, die Sie im Menü *Aufträge » Fulfillment » Bereich: Lieferanschriftenliste* mit dem Datenformat *GLS preadvise* generieren, ausgegeben werden. Eine direkte Schnittstelle zu GLS Germany existiert in plentymarkets nicht.
