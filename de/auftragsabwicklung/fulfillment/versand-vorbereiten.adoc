...
**Lieferant aktiv** = Lieferländer mit dieser Eigenschaft stehen für die Einstellung als **Standardlieferland** im Menü **<<omni-channel/online-shop/mandanten-einrichten/bestellvorgang#, Einstellungen » Mandant (Shop) » Standard » Bestellvorgang » Grundeinstellungen  >>** nicht zur Verfügung.
