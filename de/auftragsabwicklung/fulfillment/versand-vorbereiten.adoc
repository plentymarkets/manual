...
. Öffnen Sie das Menü *System » Aufträge » Versand » Optionen » Tab: Lieferländer » Tab: Übersicht*.
...
.Übersicht der Lieferländer im Menü *System » Aufträge » Versand » Optionen » Tab: Lieferländer*
[cols="a,a"]
|====
...
*Lieferant aktiv* = Lieferländer mit dieser Eigenschaft stehen für die Einstellung als *Standardlieferland* im Menü <<omni-channel/online-shop/webshop-einrichten/bestellvorgang#, System » Mandant » Mandant wählen » Bestellvorgang » Einstellungen>> nicht zur Verfügung.

|*Lager*
|Lager wählen, das dem Lieferland als Hauptlager zugeordnet werden soll und z.B. in Aufträgen automatisch eingestellt sein soll. *ALLE* wählen, wenn alle Lager dem Lieferland zugeordnet werden sollen. In diesem Fall wird für Aufträge automatisch das Lager mit der kleinsten ID gewählt. Dazu auch die <<auftragsabwicklung/auftraege/auftraege-verwalten#, Lagereinstellungen>> im Menü *System » Aufträge » Einstellungen* beachten.
...
. Öffnen Sie das Menü *System » Aufträge » Versand » Optionen » Tab: Lieferländer » Tab: Filter*.
...
. Öffnen Sie das Menü *System » Aufträge » Versand » Dienstleister*.
...
.Übersicht im Menü *System » Aufträge » Versand » Optionen » Tab: Versanddienstleister*
[cols="a,a"]
|====
|Einstellung |Erläuterung
...
Die aktuell gültigen, plentymarkets bekannten Tracking-URLs finden Sie im Kapitel des Versanddienstleisters. Über das Kapitel <<auftragsabwicklung/fulfillment/versand-vorbereiten#2500, Versanddienstleister im Überblick>> gelangen Sie auf die Kapitel der Versanddienstleister.
====
...
|*Inselzuschlag*
|Viele Versanddienstleister verlangen für den Versand in Inselregionen höhere Gebühren. Auf diesen Kosten sollte der Händler nicht sitzenbleiben. Daher pro Versandprofil einen pauschalen Aufschlag für den Versand in Inselregionen festlegen. Die Postleitzahlen der Inselregionen sind systemseitig hinterlegt. Der Abgleich mit dem Auftrag erfolgt automatisch. Bei Aktivierung des Inselzuschlags erfolgt eine Berechnung nur, wenn die Postleitzahl im System als Inselregion erkannt wird. +
...
*_Beispiel_*: Versandgruppe A enthält die Versandprofile 1 und 2. Versandgruppe B enthält die Versandprofile 3 und 4. Wenn einem Artikel nun die Versandprofile 3 und 4 zugewiesen werden sollen, am Artikel im Tab *Global* im Bereich *Versandprofile* die Versandgruppe B im Dropdown-Menü wählen. +
...
*_Wichtig_*: Es müssen mindestens zwei Konten angelegt sein, andernfalls ist diese Option nicht sichtbar. Weitere Informationen finden Sie im Kapitel <<auftragsabwicklung/fulfillment/versand-vorbereiten#1200, Tipps und Tricks: Versandkosten von Bestellungen über eBay>>.
...
*_Wichtig_*: Prüfen, ob Expressversand vom Service des Versanddienstleisters unterstützt wird. Nur dann kann die Option genutzt werden.

|*Treueprogramm*
|Ein oder mehrere Treueprogramme wählen. Die Treueprogramme können Sie mit <<omni-channel/multi-channel/ebay/ebay-einrichten#6600, eBay Plus>> oder <<omni-channel/multi-channel/amazon/amazon-einrichten#4200, Amazon>> verwenden. +
*_Wichtig_*: Versandprofile, bei denen hier ein Treueprogramm gewählt wurde, können ausschließlich für Aufträge des Marktplatzes genutzt werden und nicht für den Webshop. Wenn in einem Versandprofil z.B. die Option *eBay Plus* aktiviert ist, wird das Versandprofil nur noch für Aufträge von *eBay Plus* verwendet. Es gilt daher die Empfehlung, für die Nutzung eines Treueprogramms ein eigenes Versandprofil anzulegen.
|====
...
Stellen Sie die Versandkosten für Bestellungen über eBay im Menü *System » Listings » Kaufabwicklung* ein. Wählen Sie dazu bei der Option *Versandkosten neuer eBay-Aufträge* die Einstellung *von eBay übernehmen* oder *von plentymarkets berechnen lassen*.
...
====
Wenn Sie in Ihrem plentymarkets System mehrere eBay-Konten aktiviert haben, können Sie für jedes eBay-Konto ein eigenes Versandprofil festlegen. Die Konten können Sie dann unter der Option *eBay-Konto* im Menü *System » Aufträge » Versand » Optionen » Tab: Versandprofile » Tab: Base* wählen.
====
...
====
Nicht für alle Versanddienstleister ist die Auswahl eines Versandservices vorgesehen. Wenn vorhanden, werden die Versandservices in der Portotabelle des Versanddienstleisters angezeigt, nachdem Sie die Portotabelle gespeichert und neu geladen haben. Öffnen Sie das Versandprofil im Menü *System » Aufträge » Versand » Optionen » Tab: Versandprofile*. Wechseln Sie in das Tab *Portotabelle* und klappen die Region auf. Im unteren Teil der Portotabelle werden die Versandservices angezeigt.
====
...
|Warenwert eingeben, ab dem die Lieferung für den Kunden versandkostenfrei erfolgt. Der Warenwert bezieht sich auf den Bruttowarenwert. +
...
Die Berechnungstypen im Tab *Portotabelle* bieten unterschiedliche Möglichkeiten, Versandkosten je nach Artikel zu berechnen. So können Sie eine gewichts- oder volumenabhängige Versandkostenberechnung oder eine mengenabhängige Staffelung hinterlegen. Pro Region können Sie einen eigenen Berechnungstyp wählen. Im Folgenden wird jeder Berechnungstyp kurz erläutert. In <<tabelle-einstellungen-berechnungstypen>> finden Sie Hinweise, die generell für die Berechnungstypen gelten.
...
. Öffnen Sie das Menü *System » Aufträge » Versand » Optionen » Tab: Versandkosten berechnen*.
...
. Öffnen Sie das Menü *System » Aufträge » Versand » Versandpakete*.
...
Im Menü *Daten » API-Log » Tab: Versand Center API-Log* finden Sie Meldungen zu Sendungen, die Sie im Menü *Aufträge » Versand-Center* angemeldet haben. Wählen Sie den Versanddienstleister aus dem Dropdown-Menü *Vorgang* sowie ein Datum und die angezeigten Vorgänge pro Seite. Nach einem Klick auf *Suchen* werden die Vorgänge angezeigt.
...
|<<auftragsabwicklung/fulfillment/versand-vorbereiten#4250, Parcelforce Worldwide>>
|Für Händler innerhalb des Vereinigten Königreichs. Versand: international.

|<<auftragsabwicklung/fulfillment/versand-vorbereiten#2600, PARCEL.ONE>>
|Für Händler innerhalb Deutschlands. Versand: international.
...
. Öffnen Sie das Menü *System » Aufträge » Versand » Dienstleister » DHL Easylog*.
...
. Öffnen Sie das Menü *System » Aufträge » Versand » Dienstleister » DHL Freight*.
...
. Öffnen Sie das Menü *System » Aufträge » Versand » Dienstleister » DHL Intraship/Versenden*.
...
*_Wichtig_*: Beachten Sie dazu die Erläuterungen in der Box unterhalb der Tabelle. +
...
*_Wichtig_*: Die URL des Logos darf nur mit *http://* hinterlegt werden. +
...
====
Wenn Sie mit dem Erzeugen der Exportdokumente gleichzeitig den Warenausgang buchen möchten, können Sie das über eine Ereignisaktion im Menü *System » Aufträge » Ereignisse* erledigen. Weitere Informationen finden Sie auf der Handbuchseite <<basics/automatisierung/ereignisaktionen#, Ereignisaktionen>>.
====
...
Erstellen Sie im Menü *System » Artikel » Merkmale* ein Merkmal vom Merkmaltyp *Auswahl*. Speichern Sie für die Auswahl zur Altersgrenze 16 Jahre den Wert *A16* und zur Altersgrenze 18 Jahre den Wert *A18*.
...
Wählen Sie das soeben erstellte Merkmal im Menü *System » Artikel » Einstellungen* im Dropdown-Menü *Artikelmerkmal zur Alterssichtprüfung*. *Speichern* Sie die Einstellungen.
...
. Öffnen Sie das Menü *System » Aufträge » Versand » Dienstleister » DHL RETOURE Beilegeretiketten*.
...
Sie benötigen ein Lager, um die Informationen, die Sie von DHL für Retouren erhalten, zu hinterlegen. In plentymarkets gibt es verschiedenen Lagertypen. Für Retouren eignet sich insbesondere der Lagertyp *Reparatur*. Das Reparaturlager kann dann über die Einstellung *Zugeordnetes Reparaturlager* im Menü *System » Waren » Lager » Lager wählen » Einstellungen* einem Hauptlager vom Typ *Vertrieb* zugeordnet werden. Wenn später ein Retourenetikett erzeugt wird, wird anhand des Lagers des Auftrags das zugehörige Vertriebs- oder Reparaturlager verwendet.

Wenn Sie noch kein Lager erstellt haben, erstellen Sie zunächst ein Lager oder ein Vertriebs- und Reparaturlager im Menü *System » Waren » Lager*. Wie Sie ein Lager erstellen, ist auf der Handbuchseite <<warenwirtschaft/lager-einrichten#, Lager einrichten>> beschrieben.
...
. Öffnen Sie das Menü *System » Aufträge » Versand » Dienstleister » DHL Retoure Online*.
...
. Wählen Sie in der Zeile *Retoure* eine Option aus dem Dropdown-Menü. Beachten Sie dazu die Erläuterungen in <<tabelle-retourenanlage-erlauben>>.
. *Speichern* Sie die Einstellungen.

[[tabelle-retourenanlage-erlauben]]
.Retourenanlage im Menü *System » Mandant » Mandant wählen » Mein Konto » Einstellungen* erlauben
[cols="a,a"]
|====
|Einstellung |Erläuterung
...
[NOTE]
.Retourenetikett per E-Mail an den Kunden versenden
====
Sie haben die Möglichkeit, das Retourenetikett automatisch an Ihren Kunden zu versenden. Richten Sie dazu eine Ereignisaktion ein und wählen als Ereignis *Retourenlabel gespeichert*. Außerdem richten Sie eine E-Mail-Vorlage im Menü *System » Mandant » Mandant wählen » E-Mail » Vorlagen* ein und wählen im Dropdown-Menü *PDF-Anhang* die Option *Retoure*.
====
...
. Öffnen Sie das Menü *System » Aufträge » Versand » Dienstleister » DHL Supply Chain*.
...
. Öffnen Sie das Menü *System » Aufträge » Versand » Dienstleister » DHL UK*.
...
. Öffnen Sie das Menü *System » Aufträge » Versand » Dienstleister » DPD Cloud Webservice*.
...
. Öffnen Sie das Menü *System » Aufträge » Versand » Dienstleister » DPD DELISprint*.
...
. Öffnen Sie das Menü *System » Aufträge » Versand » Dienstleister » EasyPAK*.
...
Gehen Sie wie im Folgenden beschrieben vor, um die Schnittstelle zu link:https://gls-group.eu/DE/de/home[GLS Germany^] in plentymarkets einzurichten.

[.instruction]
Schnittstelle einrichten:

. Öffnen Sie das Menü *System » Aufträge » Versand » Dienstleister » GLS Germany*.
. Nehmen Sie die Einstellungen vor. Beachten Sie dazu die Erläuterungen in <<tabelle-schnittstelle-gls-germany>>.
. *Speichern* Sie die Einstellungen.

[[tabelle-schnittstelle-gls-germany]]
...
. Öffnen Sie das Menü *System » Artikel » Merkmale » Tab: Neues Merkmal*.
...
. Öffnen Sie das Menü *System » Aufträge » Versand » Dienstleister » Hermes (2-Mann-Handling)*.
...
. Öffnen Sie das Menü *System » Aufträge » Versand » Dienstleister » Hermes (ProfiPaketService)*.
...
. Öffnen Sie das Menü *System » Aufträge » Versand » Dienstleister » MyDPD Business / iloxx*.
...
. Öffnen Sie das Menü *System » Aufträge » Versand » Dienstleister » NetDespatch*.
...
. Öffnen Sie das Menü *System » Aufträge » Versand » Dienstleister » Parcelforce Worldwide*.
...
|*Zusatzservice*
|Zusatzservice aus dem Dropdown-Menü wählen. Aktuell ist die Option *Saturday delivery* verfügbar.
...
. Öffnen Sie das Menü *System » Aufträge » Versand » Dienstleister » PARCEL.ONE*.
...
. Öffnen Sie das Menü *System » Aufträge » Versand » Dienstleister » Swiss Post*.
...
. Wechseln Sie in das Tab *Portotabelle*.
. Klappen Sie die Region auf.
. Nehmen Sie die Einstellungen vor. Beachten Sie dazu die Erläuterungen in <<tabelle-versandervices-swiss-post>>.
. *Speichern* Sie die Einstellungen.

[[tabelle-versandervices-swiss-post]]
...
*_Wichtig_*: Die Service-Gruppen stehen erst nach dem Einrichten des technischen Benutzers zur Verfügung.
...
. Öffnen Sie das Menü *System » Aufträge » Versand » Dienstleister » UPS*.
...
*_Wichtig_*: Die Einstellung *Gesammelt anmelden* ist Pflicht bei Nachnahmeaufträgen mit mehreren Paketen. +
...
DHL unterhält ein Netz von Packstationen, die rund um die Uhr verfügbar sind. Eine DHL-Packstation oder eine DHL-Postfiliale kann von Ihren Kunden optional als Lieferadresse angegeben werden. Nehmen Sie die Einstellungen für DHL-Packstationen im Menü *System » Mandant » Mandant wählen » Bestellvorgang » DHL-Packstation* vor.
...
. Öffnen Sie das Menü *System » Mandant » Mandant wählen » Bestellvorgang » DHL-Packstation*.
...
*_Wichtig_*: Der Eintrag 0,00 (Standard) bedeutet, dass es keine Einschränkung des Bestellwertes gibt.
...
Die Sendungsanmeldung an DHL Fulfillment erfolgt automatisch über die Schnittstelle. Meldungen zu Sendungen, die bei DHL Fulfillment angemeldet wurden, finden Sie im Menü *Daten » API-Log*. Weitere Informationen zu den API-Log-Einträgen von DHL Fulfillment finden Sie auf der Handbuchseite <<basics/datenaustausch/api-log#, API-Log>>.

[#4900]
==== Lager erstellen

Erstellen Sie zunächst im Menü *System » Waren » Lager* die Lager für die von DHL Fulfillment verwalteten Artikel. Geben Sie bei allen Lagern den gleichen Namen ein, z.B. DHL Fulfillment. Wählen Sie diese Lager dann auch als Hauptlager für die von DHL Fulfillment verwalteten Artikel. Öffnen Sie dazu den Artikel im Menü *Artikel » Artikel bearbeiten* und wählen Sie das Hauptlager im Bereich *Versand*. Weitere Informationen zum Erstellen von Lagern finden Sie auf der Handbuchseite <<warenwirtschaft/lager-einrichten#, Lager einrichten>>.
...
Beachten Sie, dass Ihr plentymarkets System Anpassungen am Artikelbestand nur übernehmen kann, wenn die Artikeldaten über plentymarkets an DHL Fulfillment übertragen wurden. Wichtig hierbei ist, dass DHL Fulfillment die Artikel bestätigt, damit diese berücksichtigt werden können.

[#5000]
==== Auftragsstatus erstellen

Zur Zuordnung legen Sie im Menü *System » Aufträge » Auftragsstatus* zwei <<auftragsabwicklung/auftraege/auftraege-verwalten#, Auftragsstatus>> für die an DHL Fulfillment übermittelten Aufträge an. Nachfolgend zwei Beispiele:
...
Meldungen zu Sendungen, die bei DHL Fulfillment angemeldet wurden, finden Sie im Menü *Daten » API-Log*. Weitere Informationen zu den API-Log-Einträgen von DHL Fulfillment finden Sie auf der Handbuchseite <<basics/datenaustausch/api-log#, API-Log>>.
====
...
Wenn die Retouren von DHL Fulfillment in Ihr plentymarkets System importiert werden sollen, benötigen Sie Retourengründe. Diese Retourengründe legen Sie im Menü <<auftragsabwicklung/auftraege/auftraege-verwalten#retoure, *System » Aufträge » Auftragstypen » Retoure>> an. Verknüpfen Sie dann die von Ihnen konfigurierten Retourengründe mit den von DHL Fulfillment vorgegebenen Gründen im Menü *System » Aufträge » Versand » Fulfillment » DHL Fulfillment*.
...
. Öffnen Sie das Menü *System » Aufträge » Versand » Fulfillment » DHL Fulfillment*.
...
*_Wichtig_*: Der hier gewählte Auftragsstatus hat Auswirkungen auf die Anmeldung neuer Aufträge an DHL Fulfillment, d.h. neue Aufträge mit diesem Status werden bei der Anmeldung nicht berücksichtigt.
...
|Merkmalverknüpfung zur Übermittlung der Artikeleigenschaft an DHL Fulfillment. Details dazu im Abschnitt <<auftragsabwicklung/fulfillment/versand-vorbereiten#5300, Merkmale übermitteln>>.

|*Retourengründe*
|Retourengründe von DHL Fulfillment mit den im Menü <<auftragsabwicklung/auftraege/auftraege-verwalten#retoure, *System » Aufträge » Auftragstypen » Retoure>> angelegten Retourengründen verknüpfen.
|====

[#5300]
==== Merkmale übermitteln

Erstellen Sie im Menü *System » Artikel » Merkmale* Eigenschaften wie z.B. "Zerbrechlich" oder "Originalkarton", die Sie anschließend an DHL Fulfillment übermitteln, damit die Artikel logistisch entsprechend vorbereitet werden können. Wie Sie ein Merkmal erstellen, ist auf der Handbuchseite <<artikel/artikel-verwalten#, Artikel verwalten>> im Kapitel <<artikel/artikel-verwalten#500, Merkmale erstellen>> beschrieben. Die folgenden Merkmale können an DHL Fulfillment übermittelt werden:
...
====
Erstellen Sie im Menü *System » Artikel » Merkmale* die folgenden drei Merkmale mit dem Merkmaltyp *Kein*:
...
Nachdem Sie die Merkmale erstellt haben, <<artikel/artikel-verwalten#80, aktivieren>> Sie die Merkmale am Artikel im Tab *Merkmale*. Abschließend ordnen Sie die Merkmale in der Schnittstellenkonfiguration im Menü *System » Aufträge » Versand » Fulfillment » DHL Fulfillment* zu.
...
Um den Briefversand mit DHL Fulfillment nutzen zu können und so z.B. Einschreiben sowohl national als auch international zu versenden, müssen Sie den <<auftragsabwicklung/fulfillment/versand-vorbereiten#800, Versanddienstleister>> erstellen sowie <<auftragsabwicklung/fulfillment/versand-vorbereiten#1000, Versandprofil>> und <<auftragsabwicklung/fulfillment/versand-vorbereiten#1500, Portotabelle>> einrichten. Dafür müssen <<auftragsabwicklung/fulfillment/versand-vorbereiten#100, Lieferländer>> aktiviert und  <<auftragsabwicklung/fulfillment/versand-vorbereiten#400, Regionen>> erstellt sein. +

Anschließend wählen Sie in der Portotabelle die Region *Deutschland*, das Versandprodukt für den nationalen oder internationalen Versand und aktivieren die Versandservices. Diese Services sind erst in der Portotabelle sichtbar, nachdem Sie die Einstellungen im Versandprofil gespeichert haben. Beachten Sie auch, dass das Versandprofil am Artikel <<auftragsabwicklung/fulfillment/versand-vorbereiten#1800, aktiviert>> sein muss.

[#5320]
==== Für UK: National und international versenden

Damit Sie als Händler im Vereinigten Königreich über DHL Fulfillment Ihre Artikel sowohl national als auch international versenden können, müssen Sie den <<auftragsabwicklung/fulfillment/versand-vorbereiten#800, Versanddienstleister>> erstellen sowie <<auftragsabwicklung/fulfillment/versand-vorbereiten#1000, Versandprofil>> und <<auftragsabwicklung/fulfillment/versand-vorbereiten#1500, Portotabelle>> einrichten. Dafür müssen <<auftragsabwicklung/fulfillment/versand-vorbereiten#100, Lieferländer>> aktiviert und  <<auftragsabwicklung/fulfillment/versand-vorbereiten#400, Regionen>> erstellt sein.
...
Erstellen Sie dann im Menü *System » Aufträge » Versand » Optionen » Tab: Versanddienstleister* den Fulfillment-Dienstleister. Wählen Sie in der Spalte *Versanddienstleister* die Option *Sonstiges* aus dem Dropdown-Menü. Weitere Informationen finden Sie im Kapitel <<auftragsabwicklung/fulfillment/versand-vorbereiten#800, Versanddienstleister erstellen>>.

Richten Sie anschließend das Versandprofil im Menü *System » Aufträge » Versand » Optionen » Tab: Versandprofile* ein. Wie Sie dazu vorgehen, ist im Kapitel <<auftragsabwicklung/fulfillment/versand-vorbereiten#1000, Versandprofil erstellen>> beschrieben.
...
. Öffnen Sie das Menü *System » Aufträge » Versand » Fulfillment » IDS Logistik*.
...
- Prüfziffer (1 Stelle) +
*_Beispiel_*: 800 6913 000001 00 0 +
...
. Öffnen Sie das Menü *System » Aufträge » Versand » Fulfillment » iLopack*.
...
FBA ist das Kürzel für Fulfillment by Amazon, einem Service von Amazon, bei dem Amazon die Lagerhaltung sowie die gesamte Logistik übernimmt. Welche Einstellungen Sie vornehmen müssen, um diesen Service zu nutzen, lesen Sie auf der Handbuchseite von <<omni-channel/multi-channel/amazon/amazon-einrichten#, Amazon einrichten>> im Kapitel <<omni-channel/multi-channel/amazon/amazon-einrichten#3300, FBA-Service von Amazon nutzen>>.

== Amazon Prime

Sie haben in plentymarkets die Möglichkeit, Filter einzustellen, damit Aufträge mit den Versandbedingungen von Amazon Prime gesondert behandelt werden. Außerdem können Sie Versandlabel für Amazon Prime-Aufträge über die Amazon Merchant Fulfillment API generieren. Welche Einstellungen Sie vornehmen müssen, ist auf der Handbuchseite von <<omni-channel/multi-channel/amazon/amazon-einrichten#, Amazon einrichten>> im Kapitel <<omni-channel/multi-channel/amazon/amazon-einrichten#4200, Amazon Prime-Aufträge bearbeiten>> beschrieben.
