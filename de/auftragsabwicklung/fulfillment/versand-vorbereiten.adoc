...
|*Alternative E-Mail*
|Alternative E-Mail-Adresse, die an den Dienstleister übertragen werden soll, eingeben. Wenn hier ein Eintrag gemacht wird, muss in der vorherigen Dropdown-Liste *E-Mail und Telefonnr. übertragen* die Option *Alternative übertragen* gewählt werden.

|*Alternative Telefonnr.*
|Alternative Telefonnummer, die an den Dienstleister übertragen werden soll, eingeben. Wenn hier ein Eintrag gemacht wird, muss in der vorherigen Dropdown-Liste *E-Mail und Telefonnr. übertragen* die Option *Alternative übertragen* gewählt werden.
