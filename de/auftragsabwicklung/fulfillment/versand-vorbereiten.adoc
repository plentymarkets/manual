...
*Lieferant aktiv* = Lieferländer mit dieser Eigenschaft stehen für die Einstellung als *Standardlieferland* im Menü <<omni-channel/online-shop/webshop-einrichten/bestellvorgang#, *System » Mandant (Shop) » Standard » Bestellvorgang » Einstellungen*>> nicht zur Verfügung.
...
====
Wenn ein Auftrag Artikel enthält, bei denen kein Versandprofil aktiviert wurde, wird das Standardversandprofil aus dem Standard-Webshop für die Artikel verwendet. Das Standardversandprofil wählen Sie im Menü <<omni-channel/online-shop/webshop-einrichten/bestellvorgang#, *System » Mandant (Shop) » Standard » Bestellvorgang » Einstellungen*>>. Wenn kein Standardversandprofil eingerichtet ist, wird das Versandprofil mit der höchsten Priorität verwendet.
====
...
====
Wenn Sie mit dem Erzeugen der Exportdokumente gleichzeitig den Warenausgang buchen möchten, können Sie das über eine Ereignisaktion im Menü *System » Aufträge » Ereignisaktionen* erledigen. Weitere Informationen finden Sie auf der Handbuchseite <<basics/automatisierung/ereignisaktionen#, *Ereignisaktionen*>>.
====
...
. Öffnen Sie das Menü *System » Mandant (Shop) » Shop wählen » Mein-Konto » Grundeinstellungen*.
. Wählen Sie in der Zeile *Retoure* eine Option aus dem Dropdown-Menü. Beachten Sie dazu die Erläuterungen in Tabelle 21.
. *Speichern* Sie die Einstellungen.

.Retourenanlage im Menü *System » Mandant (Shop) » Shop wählen » Mein-Konto » Grundeinstellungen* erlauben
[cols="a,a"]
|====
|Einstellung |Erläuterung
...
DHL unterhält ein Netz von Packstationen, die rund um die Uhr verfügbar sind. Eine DHL-Packstation oder eine DHL-Postfiliale kann von Ihren Kunden optional als Lieferadresse angegeben werden. Nehmen Sie die Einstellungen für DHL-Packstationen im Menü *System » Mandant (Shop) » Standard » Bestellvorgang » DHL-Packstation* vor.
...
. Öffnen Sie das Menü *System » Mandant (Shop) » Standard » Bestellvorgang » DHL-Packstation*.
