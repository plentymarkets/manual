...
Zur Zuordnung legen Sie im Menü *System » Aufträge » Auftragsstatus* 2 <<auftragsabwicklung/auftraege/auftraege-verwalten#, Auftragsstatus>> für die an DHL Fulfillment übermittelten Aufträge an. Nachfolgend 2 Beispiele:
