...
. Wechseln Sie in das Tab *Portotabelle*.
. Klappen Sie die Region auf.
. Nehmen Sie die Einstellungen im Bereich *DHL Freight* vor. Beachten Sie dazu die Erläuterungen in <<tabelle-schnittstelle-dhl-freight>>.
. *Speichern* Sie die Einstellungen.
...
====
Sie haben die Möglichkeit, das Retourenetikett automatisch an Ihren Kunden zu versenden. Richten Sie dazu eine Ereignisaktion ein und wählen als Ereignis *Retourenlabel gespeichert*. Außerdem richten Sie eine E-Mail-Vorlage im Menü *Mandant » Mandant wählen » E-Mail » Vorlagen* ein und wählen im Dropdown-Menü *PDF-Anhang* die Option *Retourenlabel*.
====
