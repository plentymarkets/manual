...
|Option aktivieren, wenn dem Kunden im Webshop eine Checkbox angezeigt werden soll, mit dessen Aktivieren der Kunde zustimmt, dass seine Daten an den Versanddienstleister übertragen werden.
