...
. Wechseln Sie in das Tab *Portotabelle*.
. Klappen Sie die Region auf.
. Nehmen Sie die Einstellungen im Bereich *DHL Easylog* vor. Beachten Sie dazu die Erläuterungen in Tabelle 12.
. *Speichern* Sie die Einstellungen.
...
. Wechseln Sie in das Tab *Portotabelle*.
. Klappen Sie die Region auf.
. Nehmen Sie die Einstellungen im Bereich *DHL Freight* vor. Beachten Sie dazu die Erläuterungen in Tabelle 14.
. *Speichern* Sie die Einstellungen.
...
. Nehmen Sie die Einstellungen vor. Beachten Sie dazu die Erläuterungen in Tabelle 15.
. *Speichern* Sie die Einstellungen.
...
. Wechseln Sie in das Tab *Portotabelle*.
. Klappen Sie die Region auf.
. Nehmen Sie die Einstellungen im Bereich *DHL Intraship/Versenden* vor. Beachten Sie dazu die Erläuterungen in Tabelle 16.
. *Speichern* Sie die Einstellungen.
...
. Nehmen Sie die Einstellungen vor. Beachten Sie dazu die Erläuterungen in Tabelle 18.
. *Speichern* Sie die Einstellungen.
...
. Nehmen Sie die Einstellungen vor. Beachten Sie dazu die Erläuterungen in Tabelle 20.
. *Speichern* Sie die Einstellungen.
...
. Wählen Sie in der Zeile *Retoure* eine Option aus dem Dropdown-Menü. Beachten Sie dazu die Erläuterungen in Tabelle 21.
. *Speichern* Sie die Einstellungen.
...
. Nehmen Sie die Einstellungen vor. Beachten Sie dazu die Erläuterungen in Tabelle 23.
. *Speichern* Sie die Einstellungen.
...
. Wechseln Sie in das Tab *Portotabelle*.
. Klappen Sie die Region auf.
. Nehmen Sie die Einstellungen im Bereich *DHL UK* vor. Beachten Sie dazu die Erläuterungen in Tabelle 24.
. *Speichern* Sie die Einstellungen.
...
. Nehmen Sie die Einstellungen vor. Beachten Sie dazu die Erläuterungen in Tabelle 27.
. *Speichern* Sie die Einstellungen.
...
. Wechseln Sie in das Tab *Portotabelle*.
. Klappen Sie die Region auf.
. Nehmen Sie die Einstellungen im Bereich *PAT Easypak* vor. Beachten Sie dazu die Erläuterungen in Tabelle 28.
. *Speichern* Sie die Einstellungen.
...
. Nehmen Sie die Einstellungen vor. Beachten Sie dazu die Erläuterungen in Tabelle 30.
. *Speichern* Sie die Einstellungen.
...
. Wechseln Sie in das Tab *Portotabelle*.
. Klappen Sie die Region auf.
. Nehmen Sie die Einstellungen im Bereich *Hermes 2-Mann-Handling* vor. Beachten Sie dazu die Erläuterungen in Tabelle 31.
. *Speichern* Sie die Einstellungen.
...
. Nehmen Sie die Einstellungen vor. Beachten Sie dazu die Erläuterungen in Tabelle 33.
. *Speichern* Sie die Einstellungen.
...
. Wechseln Sie in das Tab *Portotabelle*.
. Klappen Sie die Region auf.
. Nehmen Sie die Einstellungen im Bereich *NetDespatch* vor. Beachten Sie dazu die Erläuterungen in Tabelle 34.
. *Speichern* Sie die Einstellungen.
...
. Nehmen Sie die Einstellungen vor. Beachten Sie dazu die Erläuterungen in Tabelle 35.
. *Speichern* Sie die Einstellungen.
...
. Wechseln Sie in das Tab *Portotabelle*.
. Klappen Sie die Region auf.
. Nehmen Sie die Einstellungen im Bereich *NetDespatch* vor. Beachten Sie dazu die Erläuterungen in Tabelle 36.
. *Speichern* Sie die Einstellungen.
...
. Wechseln Sie in das Tab *Portotabelle*.
. Klappen Sie die Region auf.
. Nehmen Sie die Einstellungen im Bereich *Parcelforce Worldwide* vor. Beachten Sie dazu die Erläuterungen in Tabelle 37.
. *Speichern* Sie die Einstellungen.
...
. Wechseln Sie in das Tab *Portotabelle*.
. Klappen Sie die Region auf.
. Nehmen Sie die Einstellungen im Bereich *UPS Service* vor. Beachten Sie dazu die Erläuterungen in Tabelle 41.
. *Speichern* Sie die Einstellungen.
...
In Tabelle 43 finden Sie die in plentymarkets verfügbaren Fulfillment-Dienstleister aufgelistet. Mit einem Klick auf den Dienstleister in der Tabelle gelangen Sie in das Unterkapitel, in dem dienstleisterspezifische Einstellungen beschrieben sind.
...
. Nehmen Sie die Einstellungen vor. Beachten Sie dazu die Erläuterungen in Tabelle 46.
. *Speichern* Sie die Einstellungen.
...
. Nehmen Sie die Einstellungen vor. Beachten Sie dazu die Erläuterungen in Tabelle 47.
