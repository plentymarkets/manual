...
. Nehmen Sie die Einstellungen vor. Beachten Sie dazu die Erläuterungen in <<tabelle-versandauftrag-bearbeiten>>.
. *Speichern* Sie die Einstellungen.

[[tabelle-versandauftrag-bearbeiten]]
.Versandpaket bearbeiten
[cols="a,a"]
|====
|Einstellung |Erläuterung
...
. Öffnen Sie das Menü *Aufträge » Versand-Center*.
. Wählen Sie aus dem Dropdown-Menü *Versandstatus* die Option *offen*.
. Wählen Sie aus dem Dropdown-Menü *Versanddienstleister* die Option *DHL*.
. Klicken Sie auf die Lupe. +
→ Die offenen Versandaufträge für DHL werden angezeigt.
. Wechseln Sie in das Tab *Anmelden*.
. Wählen Sie aus dem Dropdown-Menü *Versanddienstleister* die Option *DHL Freight* aus.
. Wählen Sie aus dem Dropdown-Menü *Ändere Auftragsstatus* den Auftragsstatus, den die Aufträge nach erfolgreicher Anmeldung erhalten sollen.  +
...
. Öffnen Sie das Menü *Aufträge » Versand-Center » Tab: Suche*.
. Wählen Sie aus dem Dropdown-Menü *Versandstatus* die Option *angemeldet DHL Intraship/Versenden*.
. Klicken Sie auf die Lupe. +
...
. Wählen Sie den Versanddienstleister für die Zusammenfassung aus dem Dropdown-Menü. +
