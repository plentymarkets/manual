...
_*Wichtig*_: Die Anzahl der Versandpakete im Menü *Aufträge » Aufträge bearbeiten » Auftrag öffnen » Tab: Einstellungen* hat keinen Einfluss auf die hier hinterlegten Pakete und wird bei Änderungen nicht angepasst. Daher die Anzahl der Pakete ausschließlich im Versand-Center ändern.
