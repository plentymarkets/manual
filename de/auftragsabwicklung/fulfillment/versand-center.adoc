...
→ Diese Funktion kann mit einer **<<auftragsabwicklung/auftraege/einstellungen/ereignisaktionen#, Ereignisaktion  >>**, die z.B. automatisch den Warenausgang bucht, kombiniert werden.
