...
Erfahren Sie mehr über Lieferaufträge im folgenden Videotutorial:

video::87113504[vimeo]
...
Wenn Sie einen Auftrag zurücksetzen, ist er in plentymarkets wieder als offener Auftrag verfügbar, aber beim Versanddienstleister weiterhin angemeldet und wird berechnet. Die Funktion *Zurücksetzen* setzt lediglich die Anmeldungen zurück. Der Versandauftrag wird dabei nicht beim Dienstleister storniert. Daher sollten Sie den Auftrag generell stornieren.
====
