...
**__Hinweis__**: Wenn ein Benutzer mit der Benutzerklasse **Variabel** die Filteroption **ALLE** wählt, werden ihm trotzdem nur die Aufträge angezeigt, deren Status für ihn im Benutzerkonto als **sichtbare Auftragsstatus** ausgewählt sind.
...
__**Wichtig**__: Die Anzahl der Versandpakete im Menü **Aufträge » Aufträge bearbeiten » Auftrag öffnen » Tab: Einstellungen** hat keinen Einfluss auf die hier hinterlegten Pakete und wird bei Änderungen nicht angepasst. Daher die Anzahl der Pakete ausschließlich im Versand-Center ändern.
...
→ Diese Funktion kann mit einer **<<auftragsabwicklung/auftraege/einstellungen/ereignis-aktionen#, Ereignisaktion  >>**, die z.B. automatisch den Warenausgang bucht, kombiniert werden.
...
Es ist nicht möglich, Pakete im Auftrag im Tab <<auftragsabwicklung/auftraege/auftraege-bearbeiten/auftrag-aendern#40, **Einstellungen** >> hinzuzufügen. Wenn Sie weitere Pakete zu einen Auftrag hinzufügen oder die Anzahl ändern möchten, öffnen Sie den Auftrag im Versand-Center und bearbeiten Sie diesen im Tab **<<auftragsabwicklung/fulfillment/versand-center#400, Hinzufügen >>**.
