...
Nach der Generierung Ihrer Dokumentenvorlagen können Sie im Bereich **<<basics/automatisierung/ereignisaktionen#, Einstellungen » Aufträge » Ereignisaktionen>>** automatische Aktionen einstellen. Interessant ist beispielsweise das Buchen von Warenausgängen beim Rechnungsdruck. Weitere Aktionen, z.B. das automatische Versenden von aktionsgesteuerten E-Mails, sind ebenfalls einstellbar.
