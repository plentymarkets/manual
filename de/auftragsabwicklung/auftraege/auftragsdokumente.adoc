...
Folgende Vorlagen werden im Ordner **Dokumente** unter **System » Mandant » Mandant wählen » Standorte** konfiguriert und verwaltet:
...
image::auftragsabwicklung/auftraege/assets/DE-Einstellungen-Standort-Dokumente-01.png[]
...
Die Seitenränder sind wichtig für den automatischen Seitenumbruch und die Positionierung von Fließtext. Sie bestimmen außerdem die Positionierung der <<auftragsabwicklung/auftraege/auftragsdokumente#170, **PDF-Vorlage**>>.
...
Das Format eines Dokuments wird vom Format der PDF-Vorlage bestimmt. Im Standard bzw. wenn keine PDF-Vorlage hinterlegt wird, werden Rechnungsdokumente im Format DIN A4 erzeugt. Beachten Sie dazu auch das Kapitel zu <<auftragsabwicklung/auftraege/auftragsdokumente#170, **PDF-Vorlagen**>>.
...
image::auftragsabwicklung/auftraege/assets/DE-Einstellungen-Standort-Dokumente-02.png[]
...
Im Bereich **Spalten Artikelpositionen** erfolgt die Positionierung der Einträge in der Kopfzeile der Artikeltabelle. Tragen Sie zu jeder verfügbaren Spalte einen Feldnamen ein, d.h. eine Bezeichnung, die in der Kopfzeile angezeigt werden soll. Die Feldnamen werden nur im Dokument angezeigt, wenn in der Dropdown-Liste **Position** ein Wert gewählt wurde. Verbleibt die Auswahl auf **Pos**, wird die Spalte nicht angezeigt. Mit diesen Einstellungen legen Sie die Reihenfolge für die Anzeige der Feldnamen in der Kopfzeile fest.
...
image::auftragsabwicklung/auftraege/assets/DE-Einstellungen-Standort-Dokumente-03.png[]
...
image::auftragsabwicklung/auftraege/assets/DE-Einstellungen-Standort-Dokumente-04.png[]

__Bild 4: Barcodeeinstellungen; optionale Elemente__

image::auftragsabwicklung/auftraege/assets/DE-Einstellungen-Standort-Dokumente-05.png[]
...
image::auftragsabwicklung/auftraege/assets/DE-Einstellungen-Standort-Dokumente-06.png[]
...
|**Zahlungshinweis**
|Die Schriftgröße wählen. **Normal**oder **Fett** für den **Schriftschnitt** wählen. In der Dropdown-Liste **Zahlungsart** eine Zahlungsart wählen. Den **Zahlungshinweis** für diese Zahlungsart in das Textfeld eintragen (Bild 2). +
Der Zahlungshinweis ist nicht fest mit der Zahlungsart verknüpft. Wird die Zahlungsart über die Dropdown-Liste geändert, bleibt der im Textfeld eingetragene Hinweis bestehen. Er wird auf die neu gewählte Zahlungsart angewendet. Bild 7 zeigt ein Beispiel.
|====

__Tab. 2: Optionale Elemente unter Artikelpositionstabelle__

image::auftragsabwicklung/auftraege/assets/DE-Einstellungen-Standort-Dokumente-07.png[]
...
image::auftragsabwicklung/auftraege/assets/DE-Einstellungen-Standort-Dokumente-08.png[]
...
image::auftragsabwicklung/auftraege/assets/DE-Einstellungen-Standort-Dokumente-09.png[]
...
image::auftragsabwicklung/auftraege/assets/DE-Einstellungen-Standort-Dokumente-10.png[]
...
image::auftragsabwicklung/auftraege/assets/DE-Einstellungen-Standort-Dokumente-11.png[ ]
...
image::auftragsabwicklung/auftraege/assets/DE-Einstellungen-Standort-Dokumente-12.png[ ]
...
image::auftragsabwicklung/auftraege/assets/DE-Einstellungen-Standort-Dokumente-13.png[ ]
