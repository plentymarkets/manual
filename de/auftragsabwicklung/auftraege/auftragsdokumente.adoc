...
Folgende Vorlagen werden im Ordner **Dokumente** unter **System » Mandant » Mandant öffnen » Standorte** konfiguriert und verwaltet:
...
Damit diese Einstellungen greifen und auf den Dokumenten angezeigt werden, müssen Sie zuvor unter **<<auftragsabwicklung/auftraege/buchhaltung#, System » Mandant » Mandant öffnen » Buchhaltung » Tab: Umsatzsteuersätze>>** die Option **Differenzbesteuerung** in der Konfiguration des Standardlands auf einen der vier Steuersätze setzen.
include::{includedir}/presets/entwurf-sina.adoc[]
