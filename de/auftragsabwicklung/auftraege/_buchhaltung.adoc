...
Die Standard-Umsatzsteuer-ID wird im Menü <<basics/erste-schritte/stammdaten#, **Einstellungen » Grundeinstellungen » Stammdaten**  >> hinterlegt. Diese Standard-Umsatzsteuer-ID wird immer verwendet, wenn in der Buchhaltung für das Standard-Lieferland im Tab **Umsatzsteuersätze** keine Umsatzsteuer-ID hinterlegt ist.
