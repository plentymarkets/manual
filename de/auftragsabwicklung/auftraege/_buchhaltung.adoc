...
__**Wichtig:**__ Bei fehlenden Einträgen bzw. Werten exportiert plentymarkets immer das Standard-Debitorkonto. Wenn bei einem Kunden ein Debitorkonto hinterlegt wurde, wird immer dieses exportiert. +
