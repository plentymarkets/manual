...
|Mit **JA** oder **NEIN** auswählen, ob ein Zahlungsziel, Valuta oder Skonto auf der Rechnung angezeigt werden. +
...
|**Zahlungsziel**
|Eine Anzahl von Tagen eingeben, die als Zahlungsziel auf der Rechnung erscheinen soll.

|**Skonto von X % bei Zahlung binnen X Tagen**
|Einen Prozentsatz und eine Anzahl von Tagen angeben, um die Skontobedingungen festzulegen.
