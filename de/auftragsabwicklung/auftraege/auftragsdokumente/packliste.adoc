...
== Allgemeines zur Packliste

Mit plentymarkets können Sie Packlisten als PDF-Dateien generieren. +
Eine Packliste liefert Ihnen und Ihren Kunden eine Übersicht der Aufträge inklusive aller Positionen. Zudem ist die Auftrags-ID als Barcode abgebildet. So kann der Warenausgang der Aufträge nach dem Versand mittels Scannen des Barcodes gebucht werden.

== Artikeldaten darstellen

Im Menü **Packliste** bestimmen Sie, welche Artikeldaten auf Ihren Packlisten angezeigt werden, z.B. **Artikel-ID**, **Menge** oder **Artikelbild**.
...
====
Mithilfe der Optionen **anzeigen** und **nicht anzeigen** bestimmen Sie, ob ein Feld auf der Packliste angezeigt wird oder nicht.
====
