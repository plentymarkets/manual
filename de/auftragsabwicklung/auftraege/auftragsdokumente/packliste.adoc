...
|**Mindesthaltbarkeit**
|Wählen Sie, ob das Mindesthaltbarkeitdatum auf der Packliste angezeigt werden soll.

|**Chargennummer**
|Wählen Sie, ob die Chargennummernummer auf der Packliste angezeigt werden soll.
|====
