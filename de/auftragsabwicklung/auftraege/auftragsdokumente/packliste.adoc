...
|**Bestellmerkmale**
|Festlegen, wie Bestellmerkmale auf der Packliste dargestellt wird. Informationen zur Verwaltung von Merkmalen und Bestellmerkmalen finden Sie auf der Handbuchseite **<<artikel/artikel-verwalten#480, Artikel verwalten>>**.
