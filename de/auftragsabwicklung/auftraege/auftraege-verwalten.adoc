...
Aufträge bilden Ihre Verkäufe sowie damit einhergehende und übliche Geschäftsvorfälle ab. Mithilfe von Auftragstypen werden die unterschiedlichen Geschäftsvorfälle kenntlich gemacht. Fortschritte bei der Bearbeitung eines Auftrags werden durch <<auftragsabwicklung/auftraege/auftrage-verwalten#1200, Auftragsstatus>> angezeigt. Welche Möglichkeiten Ihnen Auftragstypen und Auftragsstatus bieten und wie Sie Aufträge sinnvoll abwickeln, erfahren Sie in den folgenden Beschreibungen. Alle Aufträge werden zentral und in einem einheitlichen Format erfasst. Bereits in der <<auftragsabwicklung/auftraege/auftrage-verwalten#1400, Auftragsübersicht>> sehen Sie wichtige Informationen auf einen Blick und können einige Arbeiten direkt ausführen.

[#100]
== Allgemeines zur Auftragsanlage in plentymarkets

In plentymarkets wird ein *Auftrag* automatisch angelegt, wenn Kunden Bestellungen in Ihrem Webshop tätigen. Die unterschiedlichen Geschäftsvorfälle wie *Lieferaufträge*, *Retouren*, *Gutschriften*, *Gewährleistung* und *Reparaturen* werden eigene Aufträge verschiedener Typen angelegt, die mit dem Hauptauftrag verbunden sind. Über die *Auftragsübersicht* lassen sich Aufträge ungeachtet der *<<auftragsabwicklung/auftraege/auftragsherkunft#, Auftragsherkunft>>* öffnen und bearbeiten. Für viele Auftragstypen, wie zum Beispiel *Lieferaufträge*, macht das Einrichten von *<<basics/automatisierung/ereignisaktionen#, Ereignisaktionen>>* Sinn, um Vorgänge zu automatisieren. Einige Beispiele für die Nutzung von Ereignisaktionen für die Auftragsbearbeitung werden in den folgenden Kapiteln erläutert. +
...
Im Menü *System » Aufträge » Auftragstypen » Lieferauftrag* legen Sie vorab fest, nach welchen Kriterien Aufträge in Lieferaufträge gesplittet werden sollen.
...
==== Beispiel A: Ereignisaktion "Lieferauftrag generieren bei Auftragseingang" einrichten

Wenn Sie möchten, dass schon beim Eingang eines Auftrags die zugehörigen Lieferaufträge generiert werden, nutzen Sie folgende Einstellungen.
...
====
Um den Hauptauftrag öffnen zu dürfen, müssen variable Benutzer über die *<<basics/arbeiten-mit-plentymarkets/benutzer-verwalten#90, Berechtigung>>* für alle Lager der Lieferaufträge eines Hauptauftrags verfügen. Prüfen Sie dazu die Einstellungen im Menü **Einstellungen » Benutzer » Konten » Tab: Sichtbarkeiten*.
====
