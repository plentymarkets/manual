...
.3+|Werden nicht automatisch vergeben. Ein Anwendungsfall ist der vorgefüllte Warenkorb. Ein Auftrag wird angelegt und ein Link zum Warenkorb des Auftrags wird zur Bestätigung an den Kunden geschickt.
...
|**[9]** Retoure
|Ist beim Anlegen eines Auftrags vom Typ Retoure automatisch vorausgewählt. Sie können auch einen anderen Status als Standard festlegen. Die Einstellung erfolgt im Menü *Einstellungen » Aufträge » Grundeinstellungen*.
...
|**[11]** Gutschrift
|Wird einem Auftrag vom Typ Gutschrift automatisch zugeordnet, wenn eine Gutschrift angelegt wird. Sie können auch einen anderen Status als Standard festlegen. Die Einstellung erfolgt im Menü *Einstellungen » Aufträge » Grundeinstellungen*.
...
|**[13]** Sammelauftrag
|Wird einem Auftrag vom Typ Sammelauftrag automatisch zugeordnet, wenn er angelegt wird. Sie können auch einen anderen Status als Standard festlegen. Die Einstellung erfolgt im Menü *Einstellungen » Aufträge » Grundeinstellungen*.

|**[14]** Sammelgutschrift
|Wird einem Auftrag vom Typ Sammelgutschrift automatisch zugeordnet, wenn er angelegt wird. Sie können auch einen anderen Status als Standard festlegen. Die Einstellung erfolgt im Menü *Einstellungen » Aufträge » Grundeinstellungen*.
|===
...
[#400]
=== Statusnamen auf andere Sprache übertragen
...
. Wählen Sie die Option **Bezeichnungen für andere Sprachen übernehmen**.
. Wählen Sie die Sprachen, für die Sie die Bezeichnungen der aktuell ausgewählten Sprache übernehmen möchten.
...
. Öffnen Sie das Menü **Aufträge » Aufträge bearbeiten**.
. Wählen Sie im Tab **Filter** einen Dokumententyp aus dem Dropdown-Menü **Dokument**, z.B. Rechnung.
...
. Öffnen Sie das Menü **Aufträge » Aufträge bearbeiten**.
. Wählen Sie im Tab **Filter** einen Dokumententyp aus dem Dropdown-Menü **Dokument**, z.B. Lieferschein.
