...
Der Auftragstyp Retoure bildet den Geschäftsvorfall einer Retoure ab. Sie und Ihre Mitarbeiter können Retouren manuell erfassen. Zusätzlich können Sie auch Ihren Webshop-Kunden erlauben, Retouren über den *Mein Konto* Bereich anzumelden. Egal auf welchem Weg eine Retoure ins System gelangt, das Erfassen einer Retoure bucht die retournierten Artikel noch nicht zurück in den Warenbestand. Sie erfassen also die retournierten Artikel zunächst und können dann die Artikel prüfen und anschließend entscheiden, ob die Artikel wieder zum Bestand gebucht werden oder ob weitere Schritte, wie z.B. eine Reparatur, notwendig sind. Die Retoure ist ein untergeordneter Auftragstyp, da Retouren entweder einem Auftrag oder einer Gewährleistung zugeordnet sind.
Bevor Sie Retouren erfassen können, legen Sie Retourengründe und Artikelstatus für retournierte Artikel an. Anhand von Retourengründen ist später nachvollziehbar, ob ein Artikel besonders häufig wegen des selben Grundes retourniert wurde. Mithilfe der Artikelstatus für retournierte Artikel geben Sie an, wie gut der Artikelzustand nach der Retoure ist. So können Sie ableiten, wie Sie die Artikel weiter verarbeiten.
...
Sie können bis zu 20 Retourengründe eintragen. Beim Erfassen einer Retoure wählen Sie dann für jede Auftragsposition einen Grund.
...
Wenn hier ein Grund gewählt wird, hat dieser Grund Priorität gegenüber den einzel wählbaren Gründen auf Artikelpositionsebene.
...
Einen Rücksendeschein können Sie Ihren Kunden bei Zustellung der Ware im Paket beilegen. In diesem Fall sollte der Rücksendeschein Blankofelder für die Retourengründe enthalten. Sie können Ihren Kunden aber auch erlauben den Rücksendeschein im *Mein Konto* Bereich auszufüllen und nach Angabe der Retourengründe auszudrucken, um ihn der Retoure beizulegen.
