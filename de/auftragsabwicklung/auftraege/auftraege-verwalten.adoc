...
|Wählen, welcher Auftragsstatus von Aufträgen für Sammelaufträge berücksichtigt werden soll. Eine Mehrfachauswahl ist möglich. Um gezielt nur Aufträge zu erfassen, die für Sammelaufträge vorgesehen sind, empfehlen wir, je nach Anwendungsfall einen eigenen Auftragsstatus anzulegen.

|*Auftragsstatus Gutschriften*
|Wählen, welcher Auftragsstatus von Gutschriften für Sammelgutschriften berücksichtigt werden soll. Eine Mehrfachauswahl ist möglich.
|====
