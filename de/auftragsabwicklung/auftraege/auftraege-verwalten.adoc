...
Wenn Sie Lieferaufträge automatisch anlegen, greifen die zuvor in <<tabelle-auftragstypen-lieferauftrag-optionen>> beschriebenen Kriterien zum Aufsplitten in Lieferaufträgen. Somit müssen die Auftragspostionen und -mengen nicht einzeln ausgewählt werden. Stattdessen überführt das System je nach gewähltem Kriterium alle Auftragspositionen automatisch in Lieferaufträge.
