...
Die Option **IP-Adresse des Käufers** wird im Menü <<omni-channel/online-shop/mandanten-einrichten/bestellvorgang#, **Einstellungen » Mandant (Shop) » Standard » Bestellvorgang » Grundeinstellungen**  >> aktiviert bzw. deaktiviert.
