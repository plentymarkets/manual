...
Eine Retoure erfassen Sie manuell, wenn ein Paket bei Ihnen eingegangen ist oder Sie erlauben Ihren Webshop-Kunden direkt im Kundenkonto des Shops Retouren anzumelden. Nachdem eine Retoure erfasst wurde, werden weitere Bearbeitungsmöglichkeiten sichtbar. So können Sie z.B. den Artikelstatus der retournierten Artikel erst nach dem Erfassen angeben. Einen Rücksendeschein können Sie Ihren Kunden bei Zustellung der Ware im Paket beilegen. In diesem Fall sollter der Rücksendeschein Blankofelder für die Retourengründe enthalten. Sie können Ihren Kunden aber auch erlauben den Rücksendeschein im Mein-Konto-Bereich auszufüllen und nach Angabe der Retourengründe auszudrucken, um ihn der Retoure beizulegen.
