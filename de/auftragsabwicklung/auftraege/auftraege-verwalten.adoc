...
In plentymarkets wird ein *Auftrag* automatisch angelegt, wenn Kunden Bestellungen in Ihrem Webshop tätigen. Die unterschiedlichen Geschäftsvorfälle wie *Lieferauftrag*, *Retoure*, *Gutschrift*, *Gewährleistung* und *Reparatur* werden eigene Aufträge verschiedener Typen angelegt, die immer mit dem Hauptauftrag verbunden sind. Über die *Auftragsübersicht* lassen sich Aufträge ungeachtet der <<auftragsabwicklung/auftraege/auftragsherkunft#, Auftragsherkunft>> öffnen und bearbeiten. Für viele Auftragstypen, wie zum Beispiel <<auftragstyp_lieferauftrag_nutzen, Lieferaufträge>>, macht das Einrichten von <<basics/automatisierung/ereignisaktionen#, Ereignisaktionen>> Sinn, um Vorgänge zu automatisieren. Einige Beispiele für die Nutzung von Ereignisaktionen für die Auftragsabwicklung werden in den folgenden Kapiteln erläutert. +
