...
Die Option **IP-Adresse des Käufers** wird im Menü <<omni-channel/online-shop/webshop-einrichten/bestellvorgang#, **System » Mandant » Mandant öffnen » Bestellvorgang » Einstellungen**>> aktiviert bzw. deaktiviert.
...
. Öffnen Sie das Menü **System » Mandant » Mandant öffnen » Standorte » Standort öffnen » Dokumente » Stornobeleg**.
...
. Öffnen Sie das Menü **System » Mandant » Mandant öffnen » Standorte » Standort öffnen » Dokumente » Stornobeleg Gutschrift**.
. Wechseln Sie in das Tab **Transfer**.
. Klicken Sie unter **Einstellungen aus Standard-Dokumentenvorlage übernehmen** auf **Übernehmen**.
