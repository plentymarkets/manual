...
|empfohlen, um zu erkennen, dass ein Mahnung versendet wurde. Mithilfe einer Ereignisaktion oder Prozessen lässt sich hier eine Automatisierung erreichen.

|**[4]** In Versandvorbereitung
|steht in Verbindung mit Bestandsbeschränkung +
...
Wenn Sie die Bestandsbeschränkung und diesen Status bei fehlendem Bestand nutzen, können Sie z.B. erreichen, dass nur Lieferscheine und Rechnungen für Aufträge erzeugen, die auch weiter abgewickelt werden können.
...
|empfohlen, um zu kennzeichen, dass die Ware durch einen Fulfillment-Anbieter zusammengestellt und verschickt wird.

|**[6]** Gerade im Versand
|empfohlen, wenn Aufträge zum Packen an das Lager übertragen wurden. Mithilfe von Ereignisaktionen lässt sich hier eine Automatisierung erreichen.
...
|empfohlen, um in einer Retoure anzuzeigen, dass eine Gewährleistung zur Retoure eingeleitet wurde.
...
|**[13]** Sammelauftrag
|wird einem Auftrag vom Typ Sammelauftrag automatisch zugeordnet, wenn er angelegt wird.

|**[14]** Sammelgutschrift
|wird einem Auftrag vom Typ Sammelgutschrift automatisch zugeordnet, wenn er angelegt wird.
|===

=== Status bearbeiten

Sobald Sie für einen Status einen Namen speichern, steht der Status in anderen Menüs zur Verfügung. Pflegen Sie verschiedene Sprachen, wenn Sie Ihren Kunden z.B. per E-Mail oder im Kundenkonto des Webshops über den Fortschritt informieren. Wird ein Name leer gelassen bzw. gelöscht, wird der Auftragsstatus in Ihrem System nicht mehr angezeigt.

[.instruction]
Status bearbeiten:

. Öffnen Sie das Menü **Einstellungen » Aufträge » Auftragsstatus**.
. Wählen Sie im Dropdown-Menü oben links den *Mandanten*, für den Sie die Auftragsstatus ändern möchten. +
→ Ihr *Standard-Mandant** ist vorausgewählt.
. Wählen Sie im mittleren Dropdown-Menü die *Sprache*, für die Sie die Auftragsstatus ändern möchten. +
→ Ihre Systemsprache ist vorausgewählt.
. Tragen Sie in der Spalte *Bezeichnung* den Namen für einen Status ein.
...
=== Statusnamen auf andere Sprach übertragen
...
. Öffnen Sie das Menü **Einstellungen » Aufträge » Auftragsstatus**.
. Wählen Sie im Dropdown-Menü oben links den *Mandanten*, für den Sie Benennungen übertragen möchten.
