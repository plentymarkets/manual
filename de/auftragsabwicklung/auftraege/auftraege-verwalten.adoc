...
* Die *Menge*, die für eine Auftragsposition im Hauptauftrag hinterlegt ist, darf nicht in eine Menge geändert werden, die die Menge der Auftragspositionen unterschreitet, die in Lieferaufträgen verteilt sind.
====
