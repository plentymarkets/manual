...
[WARNING]
.Alle Auftragspositionen in Lieferaufträge überführen
====
Stellen Sie beim manuellen Anlegen von Lieferaufträgen sicher, dass Sie *alle* Auftragspositionen in Lieferaufträge überführen und keine Auftragspositionen unter *NZMenge* verbleiben, da es sonst zu Fehlfunktionen kommt.
====
