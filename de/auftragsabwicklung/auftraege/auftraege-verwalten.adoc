...
*_Wichtig_*: Die Option *Lagerkorrektur* gleicht die Anzeige im Tab *Einstellungen* des Auftrags mit dem Lager ab, das an den enthaltenen Auftragspositionen hinterlegt ist. Die Option erscheint nur, wenn Sie im Menü *auftragsabwicklung/auftraege/grundeinstellungen#, System » Aufträge » Einstellungen* die Option *b) pro Artikelposition kann ein Lager zugeordnet werden* gewählt haben. Ändern Sie im Tab *Übersicht* an einer Auftragsposition manuell das Lager und wird das neue Lager nicht automatisch in das Tab *Einstellungen* des Auftrags übernommen, klicken Sie auf *Lagerkorrektur*, um die Anzeige des Lagers zu aktualisieren.
