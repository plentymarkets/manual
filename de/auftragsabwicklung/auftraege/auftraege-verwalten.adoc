...
Einen Sammelauftrag für einen bestimmten Kontakt legen Sie direkt im Kontaktdatensatz im Menü *CRM » Kontakte* an. Öffnen Sie dazu einen Kontakt und wählen Sie links im Menü die Option *Neuer Sammelauftrag*. Anschließend wird automatisch ein Sammelauftrag generiert, der alle unbezahlten Aufträge des Kontakts enthält.
...
In diesem Kapitel erfahren Sie, wie Sie Sammelrechnungen erstellen. Die Erstellung von Sammelrechnungen ist nur in Sammelaufträgen verfügbar. +
