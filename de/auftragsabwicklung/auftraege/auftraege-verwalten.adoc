...
Bevor Sie eine Gutschrift anlegen, prüfen Sie den Standardstatus für Gutschriften im Menü *<<auftragsabwicklung/auftraege/grundeinstellungen#, System » Aufträge » Einstellungen>>*, passen den Standardstatus bei Bedarf an und speichern die Einstellungen.
...
Durch Wahl der Option *Gutschrift / anlegen* im Tab *Übersicht* wird ein neuer Gutschriftauftrag in plentymarkets erzeugt. Bei einem Gutschriftauftrag handelt es sich um einen speziellen Auftrag, der alle Artikel und Preise des verknüpften Originalauftrags enthält.
...
====
Soweit notwendig oder von Ihnen gewünscht, müssen Sie alle nicht in einer Gutschrift änderbare Optionen, wie z.B. das *Lager*, direkt im Auftrag vor Anlegen der Gutschrift ändern.
====
