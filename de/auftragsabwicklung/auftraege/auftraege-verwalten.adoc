...
Im Menü *System » Aufträge » Auftragstypen » Lieferauftrag* legen Sie fest, nach welchen Kriterien Aufträge in Lieferaufträge gesplittet werden sollen. Beachten Sie hierzu die Informationen in <<tabelle-auftragstypen-lieferauftrag-optionen>>.
...
Beachten Sie dazu die Handbuchseite *System » Aufträge » <<auftragsabwicklung/auftraege/grundeinstellungen#, Grundeinstellungen>>*.
