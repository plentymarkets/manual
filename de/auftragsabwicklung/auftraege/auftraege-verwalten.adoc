...
Durch Wahl der Option *Gutschrift / anlegen* im Tab *Übersicht* des Auftrags wird ein neuer Gutschriftauftrag erzeugt. Bei einem Gutschriftauftrag handelt es sich um einen speziellen Auftrag, der alle Artikel und Preise des verknüpften Originalauftrags enthält.
...
Wurde zu einem Auftrag eine Gutschrift erzeugt, ist die Gutschrift im Tab *Übersicht* über die Dropdown-Liste *Gutschrift / suchen* verlinkt.
...
|*Warenbestand zurückbuchen*
|Bucht die Artikel vollständig oder teilweise zurück.
