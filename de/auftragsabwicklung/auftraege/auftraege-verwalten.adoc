...
Mithilfe der in plentymarkets verfügbaren Ereignisaktionen können Sie das Generieren von Sammelrechnungen automatisieren. Gehen Sie dazu wie nachfolgend beschrieben vor:
