...
image::auftragsabwicklung/auftraege/scheduler/assets/DE-Scheduler-Scheduler-Auftraege-01.png[]
...
image::auftragsabwicklung/auftraege/scheduler/assets/DE-Scheduler-Scheduler-Auftraege-02.png[]
+
__Bild 2: Spalte **Letzter Durchlauf** gefüllt__

Im Menü **Aufträge** wird ein Auftrag angelegt (Bild 3).

image::auftragsabwicklung/auftraege/scheduler/assets/DE-Scheduler-Scheduler-Auftraege-03.png[]
...
Der gewählte Mandant bestimmt die im Tab **Artikel** verfügbaren **<<omni-channel/online-shop/mandanten-einrichten/buchhaltung#, Mehrwertsteuersätze  >>** (siehe unten).
