...
Der gewählte Mandant bestimmt die im Tab **Artikel** verfügbaren **<<omni-channel/online-shop/standard/buchhaltung#, Mehrwertsteuersätze  >>** (siehe unten).
