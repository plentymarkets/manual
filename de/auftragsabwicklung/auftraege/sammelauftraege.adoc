...
Bevor Sie mit dieser Funktion arbeiten, nehmen Sie die Grundeinstellungen für Sammelaufträge im Menü <<auftragsabwicklung/auftraege/einstellungen/auftragstypen/sammelauftrag#, **Einstellungen » Aufträge » Auftrags-Typen » Sammelauftrag**  >> vor. Weiterhin legen Sie im Menü <<auftragsabwicklung/auftraege/_grundeinstellungen#, **Einstellungen » Aufträge » Grundeinstellungen**  >> mit der Option **Standard-Status Sammelauftrag** fest, welchen Auftragsstatus ein Sammelauftrag beim Anlegen erhalten soll. Es steht dafür der Status **[13] Sammelauftrag** zur Verfügung. Die folgenden Fallbeispiele sollen Ihnen dabei eine Orientierungshilfe geben.
