...
Die Option **IP-Adresse des Käufers** wird im Menü <<omni-channel/online-shop/standard/bestellvorgang/grundeinstellungen#, **Einstellungen » Mandant (Shop) » Standard » Bestellvorgang » Grundeinstellungen**  >> aktiviert bzw. deaktiviert.
...
**__Tipp__**: Lagerorte können Artikeln auch per **<<auftragsabwicklung/auftraege/einstellungen/ereignis-aktionen/konfiguration#, Ereignisaktion  >>** zugeordnet werden.
...
Da die Einstellungen der Vorlage für Stornobelege mit den Einstellungen der Vorlage für Rechnungen übereinstimmen, finden Sie nährere Erläuterungen zu den einzelnen Einstellungen auf der Seite <<omni-channel/online-shop/standard/dokumente/rechnung#, **Rechnung**  >>.
