...
Im Folgenden wird beispielhaft beschrieben, wie Sie einen Nummernkreis für <<omni-channel/online-shop/standard/dokumente/rechnung#, **Rechnungsdokumente**  >> festlegen. Gehen Sie für andere Dokumente analog vor.
...
Nach der Generierung Ihrer Dokumentenvorlagen können Sie im Bereich **<<auftragsabwicklung/auftraege/einstellungen/ereignis-aktionen#, Einstellungen » Aufträge » Ereignisaktionen  >>** automatische Aktionen einstellen. Interessant ist beispielsweise das Buchen von Warenausgängen beim Rechnungsdruck. Weitere Aktionen, z.B. das automatische Versenden von aktionsgesteuerten E-Mails, sind ebenfalls einstellbar.
