...
Besonders hilfreich ist die Arbeit mit den Auftragsstatus im Bereich **<<auftragsabwicklung/auftraege/fulfillment#, Aufträge » Fulfillment  >>**. Dort werden u.a. Rechnungen erstellt. Die Selektion erfolgt ganz einfach anhand der jeweiligen Status.
