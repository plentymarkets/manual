...
image::auftragsabwicklung/auftraege/einstellungen/assets/Einstellungen-Auftraege-Auftragsstatus01-SI.png[ ]
...
image::auftragsabwicklung/auftraege/einstellungen/assets/Einstellungen-Auftraege-Auftragsstatus02-SI.png[]
