...
__**Wichtig:**__ Wenn im Kundendatensatz eines Kunden ein Debitorkonto gespeichert wurde, wird dieses Debitorkonto immer exportiert. +
...
*Anfangsbuchstabe* = Debitorkonto wird anhand der Anfangsbuchstaben von Kundendaten zugeordnet. Welche Kundendaten und in welcher Reihenfolge berücksichtigt werden, bestimmen Sie durch die 2. Dropdown-Liste. +
...
Aufträge, die über plentymarkets POS generiert werden, werden den in plentymarkets gespeicherten Erlöskonten zugewiesen. Da Einlagen, Entnahmen und Differenzen aus Kassenstürzen keine Aufträge sind, können Sie für diese Kassenvorfälle eigene Buchungskonten speichern. Wie Sie Buchungskonten für Kassenvorfälle speichern, erfahren Sie auf der Handbuchseite <<auftragsabwicklung/auftraege/buchhaltung#940, POS einrichten>>.
...
Im Menü **Daten » Daten-Export** wählen Sie das Datenformat und nehmen den <<basics/datenaustausch/export-import/daten-exportieren#10, Datenexport>> vor.
