...
. Geben Sie in das Feld *Bezeichnung* den Namen an, der Kassenbenutzern bei der Entnahme angezeigt wird.
. Geben Sie in das Feld *Konto* den Namen des Kontos an, auf das die Entnahme gebucht werden soll.
. *Speichern* Sie die Einstellungen. +
