...
Über Buchungskonten werden gleiche Arten von Ausgaben und Einnahmen zusammengefasst. Im Tab *Kassenvorfälle* legen Sie fest, auf welche Buchungskonten Einnahmen und Einlagen gebucht werden, die über plentymarkets POS Kassen getätigt werden.
...
==== Buchungskonten für Standardeinlagen und -entnahmen speichern

Bei Einlagen und Entnahmen über plentymarkets POS wählen Kassenbenutzer den Kassenvorfall, um die Beträge spezifischen Buchungskonten zuzuweisen. Systemseitig sind eine Entnahme und eine Entnahme bereits hinterlegt und können nicht gelöscht werden. Gehen Sie wie unten beschrieben vor, um Konten für diese Standardvorfälle zu speichern. Optional speichern Sie in einem weiteren Schritt zusätzliche Konten.
...
→ Das Tab *Buchungsschlüssel* wird geöffnet.
. Wechseln Sie in das Tab *Kassenvorfälle*.
. Geben Sie für die Bezeichnung *Entnahme* in die Spalte *Konto* das Konto ein, auf das allgemeine Entnahmen gebucht werden.
. Geben Sie für die Bezeichnung *Einlage* in die Spalte *Konto* das Konto ein, auf das allgemeine Einlagen gebucht werden.
. *Speichern* Sie die Einstellungen. +
→ Die Buchungskonten werden gespeichert. +
...
Wenn Ihre Einlagen und Entnahmen je nach Grund verschiedenen Buchungskonten zugewiesen werden sollen, legen Sie weitere Kassenvorfälle an, die Kassenbenutzer wählen können, wenn sie Bargeld aus der Kasse entnehmen oder in die Kasse legen. Gehen Sie wie unten beschrieben vor, um weitere Buchungskonten zu speichern.
...
→ Kassenbenutzer können bei Einlagen oder Entnahmen das Konto aus der Dropdown-Liste wählen.
