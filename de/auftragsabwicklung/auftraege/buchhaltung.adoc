...
__Bild 1: Vorangelegte Umsatzsteuersätze und Standorte__

[TIP]
.Vorangelegte Steuerkonfiguration und Standorte ersetzen
====
Die in Bild 1 gezeigte Steuerkonfiguration ist vorangelegt, enthält jedoch eine Phantasieumsatzsteuer-ID, weshalb Sie zwingend eine eigene Konfiguration anlegen müssen und anschließend die vorangelegte löschen können.
====
