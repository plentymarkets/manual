...
Bei der Überschreitung von Lieferschwellen legen Sie eine <<auftragsabwicklung/auftraege#550, neue Steuerkonfiguration>> für das Lieferland in einem bereits bestehenden Standort an. Legen Sie bei Lieferschwellenüberschreitung keinen neuen Standort an.
