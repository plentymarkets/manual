...
Standorte fügen Sie für Firmensitze hinzu und Länder in einem Standort, wenn Sie durch Lieferschwellenüberschreitung steuerpflichtig werden.
...
. Beachten Sie die Erläuterungen zu den Einstellungen in Tabelle ...
. *Speichern* Sie die Einstellungen.
