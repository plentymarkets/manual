...
Über Buchungskonten werden gleiche Arten von Ausgaben und Einnahmen zusammengefasst. In plentymarkets legen Sie fest, auf welche Buchungskonten Einnahmen und Einlagen gebucht werden, die über plentymarkets POS Kassen getätigt werden.
...
→ Bei Einlagen oder Entnahmen steht Kassenbenutzern das Konto zur Auswahl zur Verfügung.
...
|**Konto**
|Buchungskonto eingeben, dem die Einlage oder Entnahme buchhalterisch zugewiesen werden soll.
|====
