...
Im plentymarkets Backend legen Sie auch fest, auf welche Buchungskonten Einnahmen und Einlagen gebucht werden, die über plentymarkets POS Kassen getätigt werden. Dort speichern Sie Buchungskonten für Differenzen, die sich aus Kassenstürzen ergeben. Zusätzlich hinterlegen Sie ein oder mehrere Konten für Einlagen und Entnahmen.
