...
. Aktivieren Sie im Steuersatz die Einstellung **Nur für digitale Artikel**.
...
Debitorenkonten richten Sie z.B. für Ihre Forderungen ein. In plentymarkets können Sie wählen anhand welches Kriteriums Forderungen Debitorenkonten zugeordnet werden. Sie können z.B. die Nachnamen der Debitoren oder das Lieferland zur Zuordnung nutzen. Legen Sie also zuerst das Kriterium fest und tragen dann die Konten ein.
