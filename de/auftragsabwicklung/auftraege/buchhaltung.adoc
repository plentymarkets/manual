...
Bei der Überschreitung von Lieferschwellen legen Sie eine <<auftragsabwicklung/auftraege#550, neue Steuerkonfiguration>> für das Lieferland in einem bereits bestehenden Standort an. Legen Si bei Lieferschwellenüberschreitung keinen neuen Standort an.
