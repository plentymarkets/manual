...
====
Der Scheduler berücksichtigt die Option *Abo-Intervall* des Verkaufspreises  nicht. Es ist zwar technisch möglich, Verkaufspreise für verschiedene Abo-Intervalle zu erstellen. Die Einstellung wird jedoch zurzeit noch ignoriert.
====
