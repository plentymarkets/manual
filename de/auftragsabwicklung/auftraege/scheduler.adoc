...
_Bild 1: Abo-Funktion: Umsetzung der Template-Variablen im Webshop_
...
_Bild 2: Auflistung Ihrer Scheduler-Aufträge_
...
|*Lastschriftmandat*
|Suche nach Kunden, für die ein *<<crm/kundendaten-verwalten#1100, SEPA-Lastschriftmandat>>* vorliegt oder nicht vorliegt.
...
_Bild 3: Spalte *Letzter Durchlauf* gefüllt_
...
_Bild 4: Scheduler-Auftrag in der Auftragsübersicht_
...
_Bild 5: Übersicht im Menü Aufträge » Durchlauf_
