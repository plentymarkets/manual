...
. Öffnen Sie das Menü **<<omni-channel/online-shop/mandanten-einrichten/mein-konto/grundeinstellungen#, Einstellungen » Mandant (Shop) » Standard » Mein-Konto » Grundeinstellungen  >>**.
...
Der gewählte Mandant bestimmt die im Tab **Artikel** verfügbaren **<<auftragsabwicklung/auftraege/_buchhaltung#, Mehrwertsteuersätze  >>** (siehe unten).
