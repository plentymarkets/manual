...
. Öffnen Sie das Menü **<<omni-channel/online-shop/webshop-einrichten/mein-konto#, System » Mandant (Shop) » Standard » Mein-Konto » Grundeinstellungen>>**.
