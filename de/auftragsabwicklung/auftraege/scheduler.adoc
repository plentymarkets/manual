...
Das Tab *Kunde* enthält sämtliche Menüs, die Ihnen auch im Hauptmenü <<crm/kontakte-verwalten#, CRM » Kontakte>> für einen Kunden zur Verfügung stehen. Änderungen, die Sie hier vornehmen, werden auch im Hauptmenü *CRM » Kunden bearbeiten* im Kundendatensatz übernommen.
