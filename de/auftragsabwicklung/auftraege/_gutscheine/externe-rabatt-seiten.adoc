...
. Wählen Sie im Dropdown-Menü rechts die Option **Syntax-Editor**.
...
. Öffnen Sie das Menü **<<auftragsabwicklung/payment/zahlungsarten-verwalten#, Einstellungen » Aufträge » Zahlung » Zahlungsarten>>**.
