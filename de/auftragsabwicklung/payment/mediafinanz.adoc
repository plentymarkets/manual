...
Bevor Sie den Service von mediafinanz in plentymarkets einrichten können, registrieren Sie sich bei **link:https://www.mediafinanz.de/inkassoverfahren-starten[mediafinanz, window="_blank"]**.
...
. Öffnen Sie das Menü **Einstellungen » Grundeinstellungen » Stammdaten**.
...
. Öffnen Sie das Menü **Einstellungen » Aufträge » Inkassodienstleister » mediafinanz**. +
...
Richten Sie eine <<auftragsabwicklung/auftraege/einstellungen/ereignis-aktionen#, **Ereignisaktion**  >> ein, um den Mahnartikel automatisch allen unbezahlten Aufträgen zuzuordnen.
