...
Zahlungen von BitBay werden nicht automatisch in plentymarkets importiert. BitPay-Zahlungen müssen Sie <<auftragsabwicklung/payment/zahlungen-verwalten#40, manuell buchen>>.
...
Richten Sie die <<auftragsabwicklung/payment/zahlungsarten-verwalten#20, Zahlungsart>> BitPay im Tab *Einstellungen* der Zahlungsart ein. Prüfen Sie zudem die Einstellungen für *Erlaubte Zahlungsarten* in den <<auftragsabwicklung/payment/zahlungsarten-verwalten#30, Kundenklassen>> und für *Gesperrte Zahlungsarten* in den <<auftragsabwicklung/fulfillment/versand-vorbereiten#1000, Versandprofilen>>.
