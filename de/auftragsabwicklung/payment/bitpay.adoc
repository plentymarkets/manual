...
|**ApiKey**
|Api-Schlüssel von BitPay eingeben. Der **link:https://bitpay.com/api-keys[ApiKey, window="_blank"]** kann nach der Registrierung bei BitPay erzeugt werden.
