...
[#70]
== ExperCash in plentymarkets einrichten

Gehen Sie wie unten beschrieben vor, um die Schnittstelle zu ExperCash einzurichten.
...
Richten Sie die **<<auftragsabwicklung/payment/zahlungsarten-verwalten#20, Zahlungsarten >>** für ExperCash im Tab **Einstellungen** der Zahlungsarten ein. Prüfen Sie zudem die Einstellungen für **Erlaubte Zahlungsarten** in den **<<auftragsabwicklung/payment/zahlungsarten-verwalten#30, Kundenklassen >>** und für **Gesperrte Zahlungsarten** in den **<<auftragsabwicklung/fulfillment/versand-vorbereiten#1000, Versandprofilen >>**.
