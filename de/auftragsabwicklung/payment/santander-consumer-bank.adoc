...
Im Menü **CMS** haben Sie die Möglichkeit, die Texte anzupassen, die einem Käufer im Bestellvorgang bei der Zahlungsart Santander Consumer Bank angezeigt werden. Das Formular für die Bestellbestätigung passen Sie wie folgt an. Weitere Informationen finden Sie auch unter **<<omni-channel/online-shop/cms#webdesign-webdesign-bearbeiten-bestellvorgang-bestellbestaetigung, Bestellbestätigung  >>**.
