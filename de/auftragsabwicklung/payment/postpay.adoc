...
* Der Kunde ist nicht in Ihrem Webshop eingeloggt und wählt POSTPAY über den Button im Warenkorb. Der Kunde wird zu POSTPAY weitergeleitet und loggt sich dort mit seinen POSTPAY-Daten ein. Die primäre Zahlungsart und die Adresse sind bereits hinterlegt und die Bestellung kann mit einem Klick abgeschlossen werden. Hat der Kunde noch keinen POSTPAY-Account, muss er dort seine Daten für Rechnungs- und Lieferanschrift eingeben.

[#20]
== Bei POSTPAY registrieren

Sofern Sie bereits einen Händlerkonto bei **link:https://de.allyouneed.com/de/customerlogin.html[Allyouneed.com, window="_blank"]** haben, ist keine erneute Registrierung notwendig. Sie können sofort mit der **<<auftragsabwicklung/payment/postpay#30, Einrichtung von POSTPAY >>** beginnen.

Wenn Sie noch keinen Vertrag haben, registrieren Sie sich bei link:https://de.allyouneed.com/de/dealer/page/selfsignup/step1?ssu=postpay[**POSTPAY**, window="_blank"]. Im Anschluss erhalten Sie den Händlervertrag für Allyouneed.com und POSTPAY per Post oder E-Mail übermittelt, der unterschrieben zurückgesendet werden muss. Ergänzen Sie diesen um Angaben zum wirtschaftlichen Berechtigten und zum gesetzlichen Vertreter. Nach einer internen Prüfung durch POSTPAY wird Ihr Konto aktiviert und Sie erhalten per E-Mail eine Bestätigung mit Ihren Zugangsdaten. Diese benötigen Sie im nächsten Schritt für die Einrichtung in plentymarkets.

[#30]
== POSTPAY in plentymarkets einrichten

Gehen Sie wie unten beschrieben vor, um die Schnittstelle zu POSTPAY einzurichten.
...
Richten Sie die **<<auftragsabwicklung/payment/zahlungsarten-verwalten#20, Zahlungsart >>** POSTPAY im Tab **Einstellungen** der Zahlungsart ein. Prüfen Sie zudem die Einstellungen für **Erlaubte Zahlungsarten** in den **<<auftragsabwicklung/payment/zahlungsarten-verwalten#30, Kundenklassen >>** und für **Gesperrte Zahlungsarten** in den **<<auftragsabwicklung/fulfillment/versand-vorbereiten#1000, Versandprofilen >>**.
...
Richten Sie eine <<auftragsabwicklung/auftraege/einstellungen/ereignisaktionen#, **Ereignisaktion**  >> ein, um Versandbestätigungen automatisch zu versenden, nachdem der Warenausgang gebucht wurde.
...
Richten Sie eine <<auftragsabwicklung/auftraege/einstellungen/ereignisaktionen#, **Ereignisaktion**  >> ein, um Retouren automatisch an POSTPAY zu senden. Weitere Details zum Anlegen von Retouren finden Sie auf der Handbuchseite **<<auftragsabwicklung/auftraege/auftraege-bearbeiten/retoure#, Retoure  >>**.
...
Richten Sie eine <<auftragsabwicklung/auftraege/einstellungen/ereignisaktionen#, **Ereignisaktion**  >> ein, um POSTPAY automatisch über Stornierungen zu informieren.
