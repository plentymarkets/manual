...
Richten Sie eine <<auftragsabwicklung/auftraege/einstellungen/ereignis-aktionen#, **Ereignisaktion**  >> ein, um Versandbestätigungen automatisch zu versenden, nachdem der Warenausgang gebucht wurde.
...
Richten Sie eine <<auftragsabwicklung/auftraege/einstellungen/ereignis-aktionen#, **Ereignisaktion**  >> ein, um Retouren automatisch an POSTPAY zu senden. Weitere Details zum Anlegen von Retouren finden Sie auf der Handbuchseite **<<auftragsabwicklung/auftraege/auftraege-bearbeiten/retoure#, Retoure  >>**.
...
Richten Sie eine <<auftragsabwicklung/auftraege/einstellungen/ereignis-aktionen#, **Ereignisaktion**  >> ein, um POSTPAY automatisch über Stornierungen zu informieren.
