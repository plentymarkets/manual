...
Sofern Sie bereits einen Händlerkonto bei **link:https://de.allyouneed.com/de/customerlogin.html[Allyouneed.com^]** haben, ist keine erneute Registrierung notwendig. Sie können sofort mit der **<<auftragsabwicklung/payment/postpay#30, Einrichtung von POSTPAY>>** beginnen.
