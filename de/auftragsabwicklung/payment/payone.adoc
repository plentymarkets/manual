...
|Aktivieren, wenn PAYONE für link:https://docs.google.com/document/d/10mPeV3xqx4We71dYQdPmJK2qvb21Rpym6FG_tKwHKfc/edit#heading=h.h38ew7hip4tl[**Shopware**, window="_blank"] verwendet werden soll. Weitere Informationen finden Sie unter **<<auftragsabwicklung/payment/payone#140, PAYONE für Shopware verwenden >>**.
|====
...
Richten Sie eine <<auftragsabwicklung/auftraege/einstellungen/ereignis-aktionen#, **Ereignisaktion**  >> ein, um Versandbestätigungen automatisch an PAYONE zu versenden, nachdem der Warenausgang gebucht wurde.
...
Richten Sie eine <<auftragsabwicklung/auftraege/einstellungen/ereignis-aktionen#, **Ereignisaktion**  >> ein, um Rückerstattungen automatisch an PAYONE zu senden.
