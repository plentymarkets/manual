...
Im Menü **CMS** haben Sie die Möglichkeit, die Texte anzupassen, die einem Käufer im Bestellvorgang bei der Zahlungsart PAYONE angezeigt werden. Außerdem erfahren Sie, wo Sie das Design über das CSS anpassen können. Das Formular für Kreditkartendaten sowie das Formular für Online-Überweisungen passen Sie wie folgt an. Weitere Informationen finden Sie auch unter <<omni-channel/online-shop/_cms/webdesign/webdesign-bearbeiten/bestellvorgang/kaufabwicklung#, **Kaufabwicklung**  >>.
