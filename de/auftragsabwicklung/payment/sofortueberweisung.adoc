...
.Domainwechsel
====
Bei einem Domainwechsel müssen die <<auftragsabwicklung/payment/sofortueberweisung#50, **Einstellungen**>> bei SOFORT Überweisung im Backend angepasst werden - die URLs stimmen dann nicht mehr. Der Zahlungsablauf funktioniert weiterhin, aber die Zahlungen werden nicht mehr ins System importiert.
====
