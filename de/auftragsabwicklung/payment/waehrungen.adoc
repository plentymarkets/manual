...
Diese Einstellung ist nicht unbedingt identisch mit der <<auftragsabwicklung/payment/waehrungen#70, **Anzeige der Währung im Webshop**>>. Sie können für jeden Webshop und jede Sprache eine individuelle Standardwährung einstellen. Diese Einstellung nehmen Sie im Menü **System » Mandant » Mandant öffnen » Webshop » Währung** vor.
...
<ol><li>Öffnen Sie das Menü <strong>System » Mandant » Mandant öffnen » Webshop » Währung</strong>.</li>
