...
Diese Einstellung ist nicht unbedingt identisch mit der <<auftragsabwicklung/payment/waehrungen#70, **Anzeige der Währung im Webshop**>>. Sie können für jeden Webshop und jede Sprache eine individuelle Standardwährung einstellen. Diese Einstellung nehmen Sie im Menü **System » Mandant (Shop) » Standard » Webshop » Währung** vor.
