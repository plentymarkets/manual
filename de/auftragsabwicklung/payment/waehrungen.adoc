...
In plentymarkets können Sie mit verschiedenen Währungen arbeiten, wenn Sie Ihre Artikel in verschiedenen Ländern anbieten möchten. Auf dieser Seite werden die Währungseinstellungen beschrieben, die sich global auf alle Mandanten (Shops) Ihres plentymarkets Systems auswirken. Zudem finden Sie weitere Währungseinstellungen, die sich nur auf einen einzelnen Webshop beziehen. Auf dieser Seite wird außerdem beschrieben, wie Sie im Bereich <<omni-channel/online-shop/_cms/webdesign#, **CMS » Webdesign**  >> Template-Variablen einfügen, damit Ihre Kunden selbstständig im Webshop die Währung ändern können.
...
In **<<artikel/artikel-verwalten#870, Verkaufspreisen >>** aktivieren Sie unter **Währung: Live umrechnen**, ob die Shop-Währung in fremde Währungen umgerechnet wird. Zudem konfigurieren Sie die Währungseinstellungen im Menü **Einstellungen » Aufträge » Zahlung » Währungen**. Gehen Sie dazu wie unten beschrieben vor.

[.instruction]
Währung umrechnen:

. Öffnen Sie das Menü **Einstellungen » Aufträge » Zahlung » Währungen**.
. Nehmen Sie die Einstellungen vor. Beachten Sie dabei die Erläuterungen in Tabelle 2.
...
|**Standardwährung**
|<<auftragsabwicklung/payment/waehrungen#30, **Systemwährung** >> aus dem Dropdown-Menü wählen.
...
Diese Einstellung ist nicht unbedingt identisch mit der <<auftragsabwicklung/payment/waehrungen#70, **Anzeige der Währung im Webshop** >>. Sie können für jeden Webshop und jede Sprache eine individuelle Standardwährung einstellen. Diese Einstellung nehmen Sie im Menü **Einstellungen » Mandant (Shop) » Standard » Webshop » Währung** vor.
...
<ol><li>Öffnen Sie das Menü <strong>Einstellungen » Mandant (Shop) » Standard » Webshop » Währung</strong>.</li>
...
<li>Öffnen Sie das Menü <strong>Einstellungen » Aufträge » Zahlung » Währungen</strong>.</li>
