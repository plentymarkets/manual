...
In plentymarkets können Sie mit verschiedenen Währungen arbeiten, wenn Sie Ihre Artikel in verschiedenen Ländern anbieten möchten. Auf dieser Seite werden die Währungseinstellungen beschrieben, die sich global auf alle Mandanten (Shops) Ihres plentymarkets Systems auswirken. Zudem finden Sie weitere Währungseinstellungen, die sich nur auf einen einzelnen Webshop beziehen. Auf dieser Seite wird außerdem beschrieben, wie Sie im Bereich <<omni-channel/online-shop/webshop-einrichten/cms#webdesign, CMS » Webdesign>> Template-Variablen einfügen, damit Ihre Kunden selbstständig im Callisto-Webshop die Währung ändern können. Die notwendigen Währungseinstellungen für Ceres-Webshops werden auf der Handbuchseite <<omni-channel/online-shop/ceres-einrichten#201, Ceres Webshop einrichten>> erläutert.
...
. Nehmen Sie die Einstellungen vor. Beachten Sie dabei die Erläuterungen in <<tabelle-einstellungen-waehrung>>.
...
Diese Einstellung ist nicht unbedingt identisch mit der <<auftragsabwicklung/payment/waehrungen#60, Anzeige der Währung im Webshop>>. Sie können für jeden Webshop und jede Sprache eine individuelle Standardwährung einstellen. Diese Einstellung nehmen Sie im Menü *System » Mandant » Mandant wählen » Webshop » Währung* vor.
...
====
Die folgende Anleitung beschreibt die notwendigen Einstellungen zur Standardwährung und gilt ausschließlich für Callisto-Webshops. Eine für Ceres-Webshops gültige Anleitung finden Sie auf der Handbuchseite <<omni-channel/online-shop/ceres-einrichten#201, Ceres einrichten>>.
====
...
[WARNING]
.Gültigkeit der Anleitungen
====
Die folgenden Anleitungen beschreiben die notwendigen Einstellungen zur Anzeige der Standardwährung und gelten ausschließlich für Callisto-Webshops. Eine für Ceres-Webshops gültige Anleitung finden Sie auf der Handbuchseite <<omni-channel/online-shop/ceres-einrichten#201, Ceres einrichten>>.
====
