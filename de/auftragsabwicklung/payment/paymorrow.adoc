...
Fordern Sie ggf. unter link:mailto:technik@paymorrow.de[technik@paymorrow.de] einen Test-Account an und führen Sie testweise einige Transaktionen durch, bevor Sie die Zugangsdaten einrichten. Zu dieser Vorgehensweise stellt Paymorrow ein link:https://www.plentymarkets.eu/documents/category/2611/Abnahmeprotokoll-paymorrow.pdf[technisches Abnahmeprotokoll^] zur Verfügung, das Sie ausfüllen müssen, um die Zugangsdaten zu erhalten. In diesem Dokument ist auch die Vorgehensweise erläutert. Für den Testbetrieb erfolgt die Authentifizierung über eine eigene <<auftragsabwicklung/payment/paymorrow#40, RSA-Zertifikatsregistrierung>>.
...
Die Zahlungsart Paymorrow ist in diesem Fall nicht wählbar. Einer der eingestellten Grenzwerte für Aufträge wurde nicht eingehalten. Der erlaubte Bereich für Bestellungen wird dabei angezeigt. Im Beispiel (<<bild-grenzwert-nicht-eingehalten>>) wurde für das Minimum 20 Euro und für das Maximum 20.000 Euro gewählt.
