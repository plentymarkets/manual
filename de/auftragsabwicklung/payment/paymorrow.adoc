...
Wenn ein Kunde die Ware oder einen Teil davon zurückgeschickt hat, müssen Sie eine Gutschrift anlegen und Paymorrow darüber informieren, damit der Kunde keine Mahnung von Paymorrow erhält. Richten Sie eine <<auftragsabwicklung/auftraege/einstellungen/ereignis-aktionen#, **Ereignisaktion**  >> ein, um Gutschriften automatisch an Paymorrow zu senden.
...
Wird ein Auftrag storniert, muss der Status den Einstellungen unter **Einstellungen » Aufträge » Grundeinstellungen** entsprechen, damit der Vorgang auch als storniert an Paymorrow übermittelt wird. Richten Sie eine <<auftragsabwicklung/auftraege/einstellungen/ereignis-aktionen#, **Ereignisaktion**  >> ein, um Stornierungen automatisch an Paymorrow zu senden.
