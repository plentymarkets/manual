...
====
Um die Bankdaten von Paymorrow korrekt auf Ihrer Rechnung auszugeben, muss für den Zahlungshinweis im Menü **System » Mandant » Mandant öffnen » Standorte » Standort öffnen » Dokumente » Rechnung** eine Breite von 120 Millimetern eigegeben werden.
====
