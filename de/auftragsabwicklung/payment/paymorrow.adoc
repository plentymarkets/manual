...
Wird ein Auftrag storniert, muss der Status den Einstellungen unter **Einstellungen » Aufträge » Grundeinstellungen** entsprechen, damit der Vorgang auch als storniert an Paymorrow übermittelt wird. Richten Sie eine <<basics/automatisierung/ereignisaktionen#, **Ereignisaktion**  >> ein, um Stornierungen automatisch an Paymorrow zu senden.
