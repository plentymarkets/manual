...
Sie benötigen für die Zahlungsart **Amazon Pay** ein separates Konto für Amazon. Sie können das im Menü **Einstellungen » Märkte » Amazon » Grundeinstellungen** angelegte Amazon Seller Central-Konto für diese Zahlungsart nicht nutzen. Der Prozess, um sich als Händler bei **Bezahlen mit Amazon** zu registrieren, wird im **link:https://www.plentymarkets.eu/documents/category/2077/Login-und-Bezahlen-Registrierungshandbuch-DE-v1-2.pdf[Amazon-Pay-Registrierungshandbuch^]** beschrieben.
