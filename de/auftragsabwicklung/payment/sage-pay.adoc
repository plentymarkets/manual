...
====
Bei der Zahlungsart *Sage Pay* kann eine Stornierung der Zahlung in plentymarkets nur am selben Tag erfolgen, an dem der Auftrag auch eingegangen ist. In Ihrem Sage Pay-Konto können Sie die Zahlung u.U. auch noch später stornieren.
====
