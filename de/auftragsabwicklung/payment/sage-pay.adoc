...
Richten Sie eine <<auftragsabwicklung/auftraege/einstellungen/ereignis-aktionen#, **Ereignisaktion**  >> ein, um Sage Pay automatisch über Stornierungen zu informieren.
...
Wenn Sie eine Zahlung bereits erhalten haben und dem Kunden das Geld per Gutschrift erstatten möchten, richten Sie eine <<auftragsabwicklung/auftraege/einstellungen/ereignis-aktionen#, **Ereignisaktion**  >> ein, um Gutschriften automatisch an Sage Pay zu senden.
