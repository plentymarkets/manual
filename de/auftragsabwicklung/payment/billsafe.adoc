...
====
Um die Bankdaten von BillSAFE korrekt auf Ihrer Rechnung auszugeben, muss für den Zahlungshinweis im Menü **System » Mandant (Shop) » Shop wählen » Standorte » Standort wählen » Dokumente » Rechnung** eine Breite von 120 Millimetern eigegeben werden.
====
