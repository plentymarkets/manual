...
. Öffnen Sie das Menü **System » Mandant (Shop) » Standard » Dienste » atriga**.
...
Wenn atrigapaymax aktiviert ist, kann ein registrierter Kunde die Zahlungsart eines Auftrags in seinem Konto nicht nachträglich ändern, selbst dann nicht, wenn Sie im Menü **System » Mandant (Shop) » Standard » Bestellvorgang » Einstellungen** für die Einstellung **Nachträgliche Änderung von Aufträgen erlauben** die Option **JA** gewählt haben.
...
. Öffnen Sie das Menü **System » Mandant (Shop) » Standard » Mein-Konto » Grundeinstellungen**.
...
__Bild 1: Aktion für atriga konfigurieren__
...
Im Beispiel in Bild 1 werden alle Aufträge, die im Status **3 Warten auf Zahlung** sind und schon **20 Tage** diesen Status haben, an atriga geschickt. Im atriga **link:http://dm.atriga.de/[DebitManager™]** finden Sie Informationen zu Ihren Inkassoaufträgen.
