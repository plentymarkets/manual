...
. Öffnen Sie das Menü **System » Mandant » Mandant öffnen » Dienste » atriga**.
...
Wenn atrigapaymax aktiviert ist, kann ein registrierter Kunde die Zahlungsart eines Auftrags in seinem Konto nicht nachträglich ändern, selbst dann nicht, wenn Sie im Menü **System » Mandant » Mandant öffnen » Bestellvorgang » Einstellungen** für die Einstellung **Nachträgliche Änderung von Aufträgen erlauben** die Option **JA** gewählt haben.
