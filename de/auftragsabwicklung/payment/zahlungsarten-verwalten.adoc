...
|*Allyouneed Payments*
|Zahlungsart für Aufträge, die über den Marktplatz Allyouneed ins plentymarkets System kommen. Zahlungsart <<omni-channel/multi-channel/allyouneed#100, Allyouneed Payments>> aktivieren.
