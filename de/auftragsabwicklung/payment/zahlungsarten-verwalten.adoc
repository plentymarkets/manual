...
**Inland** entspricht dem unter **System » Einstellungen » Stammdaten** bei der Einstellung **Firmensitz für FiBu** festgelegten Land. Bei Mandanten (Shops) haben Sie auch die Möglichkeit, Ihr **Standard-Lieferland** automatisch als **Land des Firmensitzes** zu verwenden. Diese Einstellung finden Sie unter **System » Mandant » Mandant öffnen » Bestellvorgang » Einstellungen**. Differenziertere Konfigurationsmöglichkeiten von Rabatten auf Zahlungsarten sind über das Rabattsystem in plentymarkets möglich. Beachten Sie dazu die Handbuchseite <<crm/kundendaten-verwalten#3900, **Rabatt auf Zahlungsart**>>.
====
