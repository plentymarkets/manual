...
|*Amazon*
|Zahlungsart für Aufträge, die über den Marktplatz Amazon ins plentymarkets System kommen. Zahlungsart <<omni-channel/multi-channel/amazon#4500, Amazon>> aktivieren.

|*Amazon Payments*
|Zahlungsart im Webshop für Kunden, die über den Marktplatz Amazon im Webshop einkaufen. Zahlungsart <<omni-channel/multi-channel/amazon#460, Amazon Payments>> aktivieren.

|*Amazon Payments Advanced*
|Zahlungsart im Webshop für Kunden, die über den Marktplatz Amazon im Webshop einkaufen. Zahlungsart <<omni-channel/multi-channel/amazon#570, Amazon Payments Advanced>> aktivieren.
