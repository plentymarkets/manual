...
|*Cdiscount*
|Zahlungsart für Aufträge, die über den Marktplatz Cdiscount ins plentymarkets System kommen. Zahlungsart <<omni-channel/multi-channel/cdiscount#90, Cdiscount>> aktivieren.
