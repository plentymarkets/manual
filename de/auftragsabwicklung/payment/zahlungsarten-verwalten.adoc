...
. Klicken Sie auf den Zahlungsanbieter oder die Zahlungsart, um diese(n) zu öffnen.
...
|*Lieferländer*
| Lieferland wählen. +
*_Hinweis:_* Lieferländer nur wählen, wenn die Zahlungsart im Webshop verwendet wird. Bei Marktplatz-Zahlungsarten keine Lieferländer wählen. Eine Marktplatz-Zahlungsart wird nicht im Webshop verwendet. Deshalb wird diese Zahlungsart in plentymarkets nur aktiviert, aber nicht vollständig konfiguriert.
...
. Wählen Sie unter *Standard-Zahlungsart* eine Zahlungsart aus dem Dropdown-Menü.
. *Speichern* Sie die Einstellungen.
...
|*Allyouneed Payments*
|Zahlungsart für Aufträge, die über den Marktplatz Allyouneed ins plentymarkets System kommen. Zahlungsart <<omni-channel/multi-channel/allyouneed/allyouneed-einrichten#100, Allyouneed Payments>> aktivieren.

|*Amazon*
|Zahlungsart für Aufträge, die über den Marktplatz Amazon ins plentymarkets System kommen. Zahlungsart <<omni-channel/multi-channel/amazon/amazon-einrichten#4500, Amazon>> aktivieren.

|*Amazon Payments*
|Zahlungsart im Webshop für Kunden, die über den Marktplatz Amazon im Webshop einkaufen. Zahlungsart <<omni-channel/multi-channel/amazon/amazon-einrichten#460, Amazon Payments>> aktivieren.

|*Amazon Payments Advanced*
|Zahlungsart im Webshop für Kunden, die über den Marktplatz Amazon im Webshop einkaufen. Zahlungsart <<omni-channel/multi-channel/amazon/amazon-einrichten#570, Amazon Payments Advanced>> aktivieren.

|*Cdiscount*
|Zahlungsart für Aufträge, die über den Marktplatz Cdiscount ins plentymarkets System kommen. Zahlungsart <<omni-channel/multi-channel/cdiscount/cdiscount-einrichten#90, Cdiscount>> aktivieren.

|*DaWanda*
|Zahlungsart für Aufträge, die über den Marktplatz DaWanda ins plentymarkets System kommen. Zahlungsart <<omni-channel/multi-channel/dawanda#70, DaWanda>> aktivieren.
...
|*Flubit*
|Zahlungsart für Aufträge, die über den Marktplatz Flubit ins plentymarkets System kommen. Zahlungsart <<omni-channel/multi-channel/flubit#, Flubit>> aktivieren.

|*Fruugo*
|Zahlungsart für Aufträge, die über den Marktplatz Fruugo ins plentymarkets System kommen. Zahlungsart <<omni-channel/multi-channel/fruugo#60, Fruugo>> aktivieren.
...
|*La Redoute Payment*
|Zahlungsart für Aufträge, die über den Marktplatz La Redoute ins plentymarkets System kommen. Zahlungsart <<omni-channel/multi-channel/laredoute#100, La Redoute Payment>> aktivieren.

|*Neckermann Payment*
|Zahlungsart für den Marktplatz Neckermann.at. Zahlungsart <<omni-channel/multi-channel/neckermann-at/neckermann-at-einrichten#160, Neckermann.at>> aktivieren.

|*Otto Payment*
|Zahlungsart für den Marktplatz Otto. Zahlungsart <<omni-channel/multi-channel/otto#30, OTTO>> aktivieren.

|*PIXmania Payment*
|Zahlungsart für den Marktplatz PIXmania. Zahlungsart <<omni-channel/multi-channel/pixmania/pixmania-einrichten#80, PIXmania>> aktivieren.
...
|*Yatego Rechnung*
|Zahlungsart für den Marktplatz Yatego. Zahlungsart <<omni-channel/multi-channel/yatego/yatego-einrichten#80, Yatego Rechnung>> aktivieren.

|*Zalando Payment*
|Zahlungsart für den Marktplatz Zalando. Zahlungsart <<omni-channel/multi-channel/zalando/zalando-einrichten#80, Zalando Payment>> aktivieren.
|====
