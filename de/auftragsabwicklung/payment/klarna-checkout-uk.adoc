...
Klarna Checkout UK wird über ein iFrame direkt in plentymarkets integriert. Daher ist für die Nutzung der Zahlungsart ein <<basics/arbeiten-mit-plentymarkets/plentymarkets-konto/service-center/ssl-zertifikat#, **SSL-Zertifikat**  >> notwendig.
...
Bevor Sie Klarna Checkout UK in Ihrem plentymarkets System einrichten, müssen Sie sich bei link:https://www.klarna.com/uk/business/sell-online-with-klarna[**Klarna**, window="blank"] registrieren.
...
Um dem Käufer den gesamten Betrag zu erstatten, legen Sie einen Auftrag vom Typ **Retoure** an. Anschließend richten Sie eine <<auftragsabwicklung/auftraege/einstellungen/ereignis-aktionen#, **Ereignisaktion**  >> ein, um Rückerstattungen automatisch an Klarna UK zu senden. Weitere Details zum Anlegen von Retouren finden Sie auf der Handbuchseite **<<auftragsabwicklung/auftraege/auftraege-bearbeiten/retoure#, Retoure  >>**.
...
Richten Sie eine <<auftragsabwicklung/auftraege/einstellungen/ereignis-aktionen#, **Ereignisaktion**  >> ein, um Stornierungen automatisch an Klarna UK zu senden.
