...
Klarna Checkout UK wird über ein iFrame direkt in plentymarkets integriert. Daher ist für die Nutzung der Zahlungsart ein <<basics/arbeiten-mit-plentymarkets/plentymarkets-konto#ssl-zertifikat, SSL-Zertifikat>> notwendig.
...
* Weitere <<auftragsabwicklung/payment/klarna-checkout-uk#80, externe Zahlungsarten>>
...
Richten Sie die <<auftragsabwicklung/payment/zahlungsarten-verwalten#20, Zahlungsart>> Klarna Checkout UK in Ihrem plentymarkets ein und aktivieren Sie die Zahlungsart. Prüfen Sie zudem die Einstellungen für *Erlaubte Zahlungsarten* in den <<auftragsabwicklung/payment/zahlungsarten-verwalten#30, Kundenklassen>> und für *Gesperrte Zahlungsarten* in den <<auftragsabwicklung/fulfillment/versand-vorbereiten#1000, Versandprofilen>>.
...
Um dem Käufer den gesamten Betrag zu erstatten, legen Sie einen Auftrag vom Typ *Retoure* an. Anschließend richten Sie eine <<basics/automatisierung/ereignisaktionen#, Ereignisaktion>> ein, um Rückerstattungen automatisch an Klarna UK zu senden. Weitere Details zum Anlegen von Retouren finden Sie auf der Handbuchseite <<auftragsabwicklung/auftraege/auftraege-verwalten#retoure, Retoure>>.
...
Richten Sie eine <<basics/automatisierung/ereignisaktionen#, Ereignisaktion>> ein, um Stornierungen automatisch an Klarna UK zu senden.
