...
Um dem Käufer den gesamten Betrag zu erstatten, legen Sie einen Auftrag vom Typ **Retoure** an. Anschließend richten Sie eine <<auftragsabwicklung/auftraege/einstellungen/ereignisaktionen#, **Ereignisaktion**  >> ein, um Rückerstattungen automatisch an Klarna UK zu senden. Weitere Details zum Anlegen von Retouren finden Sie auf der Handbuchseite **<<auftragsabwicklung/auftraege/auftraege-bearbeiten/retoure#, Retoure  >>**.
...
Richten Sie eine <<auftragsabwicklung/auftraege/einstellungen/ereignisaktionen#, **Ereignisaktion**  >> ein, um Stornierungen automatisch an Klarna UK zu senden.
