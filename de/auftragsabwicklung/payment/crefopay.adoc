...
Damit CrefoPay Beträge an Sie auszahlt, müssen Sie bestätigen, dass Sie dem Kunde die Ware gesendet haben. Richten Sie eine <<auftragsabwicklung/auftraege/einstellungen/ereignisaktionen#, **Ereignisaktion**  >> ein, um Versandbestätigungen automatisch zu versenden, nachdem der Warenausgang gebucht wurde.
...
Richten Sie eine <<auftragsabwicklung/auftraege/einstellungen/ereignisaktionen#, **Ereignisaktion**  >> ein, um CrefoPay automatisch über Stornierungen zu informieren.
