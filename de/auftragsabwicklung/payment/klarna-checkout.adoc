...
Zur Unterstützung mehrerer Mandanten muss im Menü **<<omni-channel/online-shop/standard/webshop/grundeinstellungen#, Einstellungen » Mandant (Shop) » Standard » Webshop » Grundeinstellungen  >>** für die Option **Login** die Einstellung **Login in jedem einzelnen Shop ermöglichen** aktiviert sein.
...
Damit Klarna über den Versand der Artikel, die Stornierung von Aufträgen und über Retouren informiert wird sowie die Rechnung erstellt bzw. gelöscht wird, erstellen Sie Ereignisaktionen. Die Funktionalität sollte vor Live-Schaltung mit Ihrem Ansprechpartner der Klarna-Integrationsabteilung getestet werden. Richten Sie eine <<auftragsabwicklung/auftraege/einstellungen/ereignis-aktionen#, **Ereignisaktion**  >> ein, um Versandbestätigungen automatisch an Klarna zu senden.
...
Richten Sie eine <<auftragsabwicklung/auftraege/einstellungen/ereignis-aktionen#, **Ereignisaktion**  >> ein, um Retouren automatisch an Klarna zu senden. Weitere Details zum Anlegen von Retouren finden Sie auf der Handbuchseite **<<auftragsabwicklung/auftraege/auftraege-bearbeiten/retoure#, Retoure  >>**.
...
Richten Sie eine <<auftragsabwicklung/auftraege/einstellungen/ereignis-aktionen#, **Ereignisaktion**  >> ein, um Stornierungen automatisch an Klarna zu senden.
