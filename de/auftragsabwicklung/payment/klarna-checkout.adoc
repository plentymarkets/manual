...
link:https://klarna.com/de/mit-klarna-verkaufen/klarna-checkout[**Klarna Checkout**, window="_blank"] ist eine integrierte Checkout-Lösung, mit der Sie Ihren Kunden zahlreiche Zahlungsarten anbieten. Der Klarna Checkout ist responsive. Klarna selbst ist ein europäischer Anbieter von Zahlungslösungen im Internethandel.
...
Klarna Checkout wird über ein iFrame direkt in plentymarkets integriert. Daher ist für die Nutzung der Zahlungsart ein <<basics/arbeiten-mit-plentymarkets/plentymarkets-konto/service-center/ssl-zertifikat#, **SSL-Zertifikat**  >> notwendig.
...
Zur Unterstützung mehrerer Mandanten muss im Menü **<<omni-channel/online-shop/mandanten-einrichten/webshop/grundeinstellungen#, Einstellungen » Mandant (Shop) » Standard » Webshop » Grundeinstellungen  >>** für die Option **Login** die Einstellung **Login in jedem einzelnen Shop ermöglichen** aktiviert sein.
...
**__Wichtig:__** In plentymarkets ist Klarna Checkout für die <<auftragsabwicklung/payment/klarna-checkout#20, **Lieferländer** >> Deutschland, Österreich, Finnland, Norwegen und Schweden verfügbar. Das heißt, dass nur Kunden mit Wohnsitz in diesen Ländern Aufträge über Klarna Checkout bezahlen können.
...
**__Hinweis:__** Im Namen der Versandprofile, für die Packstation als Lieferadresse möglich sein soll, muss DHL vorkommen.
...
Richten Sie die zusätzlich gewünschten **<<auftragsabwicklung/payment/zahlungsarten-verwalten#20, Zahlungsarten >>** im Menü **Einstellungen » Aufträge » Zahlung » Zahlungsarten** in Ihrem plentymarkets ein und aktivieren Sie die Zahlungsarten.
...
. Öffnen Sie das Menü **Einstellungen » Mandant (Shop) » Standard » Webshop » Währung**.
...
→ Die Nutzungsbedingungen finden Sie unter dieser URL: **link:https://cdn.klarna.com/1.0/shared/content/legal/terms/EID/de_de/checkout[https://cdn.klarna.com/1.0/shared/content/legal/terms/EID/de_de/checkout, window="_blank"]**.
...
. Fügen Sie den Anker **cancellation_rights** an der Stelle in der Kategorie ein, an der die Widerrufsinformationen beginnen.
. **Speichern** Sie die Einstellungen.
. Öffnen Sie das Menü **Einstellungen » Mandant (Shop) » Standard » Webshop » Seiten**.
. Wählen Sie aus dem Dropdown-Menü **Seite AGB** die Seite, die sowohl die AGB als auch das Widerrufrecht enthält.
. **Speichern** Sie die Einstellungen.
...
<li>Wählen Sie aus dem rechten Dropdown-Menü die Option <strong>Textfeld</strong>.</li>
...
<ol>
<li>
Öffnen Sie das Menü <strong>Einstellungen » Aufträge » Zahlung » Zahlungsarten</strong>.</li>
<li>
...
Damit Klarna über den Versand der Artikel, die Stornierung von Aufträgen und über Retouren informiert wird sowie die Rechnung erstellt bzw. gelöscht wird, erstellen Sie Ereignisaktionen. Die Funktionalität sollte vor Live-Schaltung mit Ihrem Ansprechpartner der Klarna-Integrationsabteilung getestet werden. Richten Sie eine <<auftragsabwicklung/auftraege/einstellungen/ereignisaktionen#, **Ereignisaktion**  >> ein, um Versandbestätigungen automatisch an Klarna zu senden.
...
Richten Sie eine <<auftragsabwicklung/auftraege/einstellungen/ereignisaktionen#, **Ereignisaktion**  >> ein, um Retouren automatisch an Klarna zu senden. Weitere Details zum Anlegen von Retouren finden Sie auf der Handbuchseite **<<auftragsabwicklung/auftraege/auftraege-bearbeiten/retoure#, Retoure  >>**.
...
Richten Sie eine <<auftragsabwicklung/auftraege/einstellungen/ereignisaktionen#, **Ereignisaktion**  >> ein, um Stornierungen automatisch an Klarna zu senden.
