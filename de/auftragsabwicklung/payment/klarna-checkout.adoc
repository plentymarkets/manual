...
Richten Sie eine <<basics/automatisierung/ereignisaktionen#, **Ereignisaktion**  >> ein, um Retouren automatisch an Klarna zu senden. Weitere Details zum Anlegen von Retouren finden Sie auf der Handbuchseite **<<auftragsabwicklung/auftraege/auftraege-bearbeiten/retoure#, Retoure  >>**.
