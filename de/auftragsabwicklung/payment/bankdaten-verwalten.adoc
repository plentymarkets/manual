...
*_Wichtig:_* Erst nach dem Aktivieren der Option können die pain.008-Formate für den <<auftragsabwicklung/payment/bankdaten-verwalten#200, SEPA-Zahlungsverkehr>> abgerufen werden.
