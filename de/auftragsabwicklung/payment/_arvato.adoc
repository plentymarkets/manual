...
. Öffnen Sie das Menü **Einstellungen » Aufträge » Inkassodienstleister » arvato**.
...
. Öffnen Sie das Menü **Einstellungen » Aufträge » Bonitätsprüfung » arvato infoscore**.
