...
Du kannst plentymarkets POS auf einem Tablet oder Smartphone nutzen. Da die Bildschirme jedoch unterschiedliche Formate und Größen haben, sind einige der Funktionen je nach Gerät unterschiedlich angeordnet.
