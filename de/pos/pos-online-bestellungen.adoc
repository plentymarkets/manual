...
====
Um Online-Bestellungen über plentyPOS abwickeln zu können, muss mindestens Version 1.9 der plentymarkets App <<willkommen/schnelleinstieg/systemvoraussetzungen#500, auf der passenden Hardware>> installiert sein.
====

[#100]
== Abholung und Bezahlung von Online-Bestellungen vorbereiten
...
Je nachdem, zu welchem Zeitpunkt und auf welche Weise Kund:innen die Online-Bestellung bezahlen, ergeben sich verschiedene Abläufe für die Abwicklung in plentyPOS.
