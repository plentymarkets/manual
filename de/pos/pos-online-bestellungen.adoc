...
====
Um Online-Bestellungen über plentyPOS abwickeln zu können, muss mindestens Version 1.9 der plentymarkets App <<willkommen/schnelleinstieg/systemvoraussetzungen#200, auf der passenden Hardware>> installiert sein.
====
