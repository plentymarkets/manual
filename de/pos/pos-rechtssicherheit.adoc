...
====
Wir empfehlen, für jede verwendete Kasse eine eigene technische Sicherheitseinrichtung zu verwenden. Die Kombination aus mehreren Kassen, die auf eine TSE zugreifen, führt zu Verzögerungen und Wartezeiten bei den Kassiervorgängen.
====

[[tabelle-inbetriebnahme-tse-deutschland]]
.Technische Sicherheitseinrichtung in Deutschland koppeln
[cols="1,3,3"]
|====
...
|3.
|Registrierung der TSE-Einheit(en) beim Finanzamt
