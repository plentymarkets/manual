...
:author: team-mobile
:keywords: plentymarkets POS, plenty POS, plentyPOS Kasse, POS, plentymarkets Kasse, Rechtssicherheit, GoBD, Finanzexport, Finanzexport Kasse, TSE, technische Sicherheitseinrichtung, Kassensicherungsverordnung, KassenSichV
:position: 30
...
====
Für Kassenkräfte ohne Admin-Zugang zum plentymarkets Backend musst du die <<business-entscheidungen/benutzerkonten-zugaenge#100, Menü-Sichtbarkeit>> aktivieren, damit sie Zugriff auf das oben beschriebene Menü erhalten.
...
====
Die im IDEA-Export enthaltenen Daten sind vollständig GoBD-konform. Das Zertifikat kannst du beispielsweise zum Nachweis gegenüber deinem Steuerbüro oder Behörden link:https://www.plentymarkets.eu/documents/category/3339/GoBD-Export-Zertifikat-plentymarkets.pdf[hier^] herunterladen.
====
...
* Aktiviere die Option *ePOS-Device* in der Konfiguration des Bondruckers. Gib hierzu die IP-Adresse des Druckers in die Adresszeile deines Browsers ein. Klicke unter dem Menüpunkt *Configuration* auf *ePOS-Device* und wähle die Option *Enable*.
...
→ Die Kassenkraft ist berechtigt, <<pos/pos-kassenbenutzer#270, Monatsbelege in plentyPOS>> zu erstellen.
