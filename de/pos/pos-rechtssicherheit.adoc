...
:author: team-mobile
:keywords: plentymarkets POS, plenty POS, plentyPOS Kasse, POS, plentymarkets Kasse, Rechtssicherheit, GoBD, Finanzexport, Finanzexport Kasse
:position: 30
...
====
Für Kassenbenutzer, die als Backend-Benutzer auf das plentymarkets Backend zugreifen, musst du die <<business-entscheidungen/benutzerkonten-zugaenge#100, Menü-Sichtbarkeit>> aktivieren, damit diese Benutzer Zugriff auf das unten beschriebene Menü erhalten.
...
.Menü-Sichtbarkeit für Backend-Benutzer aktivieren
====
Für Kassenbenutzer, die als Backend-Benutzer auf das plentymarkets Backend zugreifen, musst du zuvor die <<business-entscheidungen/benutzerkonten-zugaenge#100, Menü-Sichtbarkeit>> aktivieren, damit diese Benutzer Zugriff auf das oben beschriebene Menü erhalten.
...
.Menü-Sichtbarkeit für Backend-Benutzer aktivieren
====
Für Kassenbenutzer, die als Backend-Benutzer auf das plentymarkets Backend zugreifen, musst du die <<business-entscheidungen/benutzerkonten-zugaenge#100, Menü-Sichtbarkeit>> aktivieren, damit diese Benutzer Zugriff auf das oben beschriebene Menü erhalten.
