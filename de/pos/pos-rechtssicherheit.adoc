...
Um deine Kasse mit einer technischen Sicherheitseinrichtung zu koppeln und somit KassenSichV-konform zu betreiben, befolge die in <<tabelle-inbetriebnahme-tse-deutschland>> 
...
Gehe wie unten beschrieben vor, um den täglichen TSE-Export zu erstellen:
