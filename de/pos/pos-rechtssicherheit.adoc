...
|**Status**
|Zeigt den Status der TSE-Einheit an. //TODO: welche Status sind möglich und was heißen sie?

|**Zertifikat gültig bis**
|Zeigt das Gültigkeitsdatum des TSE-Zertifikats an. Nach Ablauf des angezeigten Datums muss ein neues Zertifikat erworben werden. //TODO: Klären ob das stimmt/Info reicht

|**Registrierte Clients**
|Anzahl aller Kassen, die mit der TSE verbunden sind.

|**Gestartete Transaktionen**
| //TODO: Gescheite Erklärung für Transaktionen

2+|Bereich **Signaturen**

|**Erstellt**
| //TODO: Gescheite Erklärung für Signaturen
...
|**Letzter Export**
|Datum, an dem die letzte TSE-Exportdatei erstellt wurde.
