...
[TIP]
.Täglichen TSE-Export durchführen
====
...
. Klicke auf *Alle Exporte herunterladen*, um alle verfügbaren Exportdateien herunterzuladen. +
→ *_Oder_*: Setze ein Häkchen für einzelne Einträge in der Liste und klicke auf *Ausgewählte Exporte herunterladen*. +
→ Die Exportdateien werden im .tar-Format heruntergeladen. Entpacke die Dateien anschließend, um den Export im CSV-Format zu erhalten.
