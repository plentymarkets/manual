...
Die folgenden Schritte sind notwendig, um deine Kasse mit einer TSE zu koppeln

//TO DO: Ablauf der Kopplung und notwendige Schritte kurz skizzieren, evtl. mit Links zu Bezugsquelle oder weiteren Informationen
