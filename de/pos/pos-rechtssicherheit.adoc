...
:author: team-mobile
:keywords: plentymarkets POS, plentyPOS Kasse, POS, plentymarkets Kasse, Rechtssicherheit, GoBD, Finanzexport, Finanzexport Kasse
:position: 30
...
* Sobald die Signatureinheit wieder funktioniert, wird in plentyPOS automatisch ein Sammelbeleg erstellt und gedruckt.
...
[#900]
== plentyPOS in Österreich nutzen
...
* Den **AES-Schlüssel**, der im Menü **Einstellungen » Mandant » Standard » POS » Kasse öffnen » Tab: Grundeinstellungen** angezeigt wird.
...
→ Die Kassenbenutzerin ist berechtigt, <<pos/pos-kassenbenutzer#270, Monatsbelege in plentyPOS>> zu erstellen.
