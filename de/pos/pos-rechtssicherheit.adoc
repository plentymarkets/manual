...
Der TSE-Export sollte täglich beim Tagesabschluss erstellt werden. Im ersten Schritt erstellt der Kassenbenutzer den TSE-Export in der App. Die Exportdatei wird anschließend automatisch hochgeladen und steht im zweiten Schritt im plentymarkets Backend zum Download zur Verfügung.
Erstelle bestenfalls bei jedem Tagesabschluss auch gleich einen TSE-Export, damit alle Kassenvorgänge seit dem letzten Tagesabschluss sauber dokumentiert sind. +
