...
Bei der Verwendung von plentymarkets POS gibt es einige Punkte, die beachten solltest, um rechtssicher zu arbeiten. Zumeist handelt es sich um steuer- und finanzrechtliche Themen. Einige Aspekte sind bereits bei der Einrichtung der Kasse relevant, andere werden abhängig von Kontrollen durch die Finanzbehörden notwendig. Diese Handbuchseite beschreibt alle Vorgehensweisen, damit du plentymarkets POS rechtssicher verwendest. Dabei wird zwischen den Ländern Deutschland und Österreich differenziert, da in beiden Ländern unterschiedliche rechtliche Grundlagen für den Betrieb von Registrierkassen gelten.
...
In Deutschland gelten mehrere Verordnungen für den Betrieb von Registrierkassen. Unter anderem sind die "Grundsätze zur ordnungsmäßigen Führung und Aufbewahrung von Büchern, Aufzeichnungen und Unterlagen in elektronischer Form sowie zum Datenzugriff" (*GoBD*) für den Kassenbetrieb relevant. Grundsätzlich müssen Kassenvorgänge elektronisch unveränderbar aufgezeichnet sowie digital lesbar archiviert werden. Informiere dich genau bei deinem Steuerberater über die geltenden Gesetze und bespreche, welche Daten du exportieren und archivieren solltest.

[NOTE]
.plentymarkets POS ist GoBD-zertifiziert
====
Die Funktionalitäten von plentymarkets POS sind GoBD-konform. Das Zertifikat kannst du beispielsweise zum Nachweis gegenüber deinem Steuerberater oder Behörden link:https://www.plentymarkets.eu/documents/category/3339/GoBD-Export-Zertifikat-plentymarkets.pdf[hier^] herunterladen.
====
...
[IMPORTANT]
.Menü-Sichtbarkeit für variable Benutzer aktivieren
====
Für Kassenbenutzer, die als variable Benutzer auf das plentymarkets Backend zugreifen, musst du die <<basics/admin-aufgaben/benutzer-verwalten#100, Menü-Sichtbarkeit>> aktivieren, damit diese Benutzer Zugriff auf das oben beschriebene Menü erhalten.
Öffne dazu das Menü *Einrichtung » Einstellungen » Benutzer » variablen Benutzer wählen » Rechte*. Aktiviere im Bereich *Menü-Sichtbarkeiten* unter *Aufträge » POS* die Option *Kassenjournal*. Klicke abschließend auf *Speichern*.
====
...
. *Speichere* (icon:save[role="lightGrey"])die Datei.
...
. Klicke auf das Download-Symbol (icon:download[role="purple"])in der Spalte *Aktionen*.
...
====
Für Kassenbenutzer, die als variable Benutzer auf das plentymarkets Backend zugreifen, musst du die <<basics/admin-aufgaben/benutzer-verwalten#100, Menü-Sichtbarkeit>> aktivieren, damit diese Benutzer Zugriff auf das oben beschriebene Menü erhalten.
Öffne dazu das Menü *Einrichtung » Einstellungen » Benutzer » variablen Benutzer wählen » Rechte*. Aktiviere im Bereich *Menü-Sichtbarkeiten* unter *Aufträge » POS* die Option *IDEA-Export*. Klicke abschließend auf *Speichern*.
====

[#400]
=== Umgang mit der Kassensicherungsverordnung

In Deutschland gilt für alle Registrierkassen die Kassensicherungsverordnung (KassenSichV). Ab diesem Datum bist du verpflichtet, alle deine Kassen mit einer so genannten technischen Sicherheitseinrichtung (TSE) auszustatten. Die TSE signiert alle Kassenbelege und legt die Kassenvorgänge unveränderbar in einem speziellen Dateiformat ab. Einen TSE-Export, der diese Daten enthält, solltest du täglich erstellen. Im Rahmen einer Prüfung durch die Finanzbehörden bist du außerdem verpflichtet, einen Export der vorhandenen gesammelten TSE-Daten vorzulegen.

[#500]
==== Technische Sicherheitseinrichtung koppeln

Um deine Kasse mit einer technischen Sicherheitseinrichtung zu koppeln und somit KassenSichV-konform zu betreiben, beachte die Informationen in <<tabelle-inbetriebnahme-tse-deutschland>>.
...
[[tabelle-inbetriebnahme-tse-deutschland]]
.Technische Sicherheitseinrichtung koppeln
[cols="1,2,3"]
|====
...
|1.
|Hardware beschaffen
|Nach dem 01.01.2020 angeschaffte Hardware muss per Gesetz entweder bereits KassenSichV-konform oder aufrüstbar sein. Kontaktiere deinen Kassenanbieter, um neue Bondrucker mit angeschlossener TSE zu beschaffen. *_Alternativ_*: Informiere dich bei deinem Kassenanbieter, ob deine aktuell verwendete Hardware aufgerüstet werden kann oder muss.

|2.
|TSE-Einheit koppeln
|Schließe deine Hardware an dein Kassensystem an. Daraufhin wird vom Bondrucker automatisch ein Beleg ausgegeben. +
Öffne die App und klicke im Menü auf *Einstellungen*. Gib die IP-Adresse der TSE-Einheit ein, die auf dem Bon vermerkt ist. Tippe dann auf *TSE-Einheit koppeln*. +
Im Menü *Einrichtung » Mandant » Mandant wählen » POS* wird im Tab *Grundeinstellungen* im Bereich *Fiskalisierung (Deutschland)* die *Seriennummer der TSE* und der *Public Key* der TSE nach der Kopplung automatisch eingetragen und gespeichert. Bei Bedarf kannst du die Daten hier einsehen und kontrollieren.

|3.
|Registrierung der TSE-Einheit beim Finanzamt
|Melde deine TSE inklusive der *Seriennummer* (siehe vorheriger Schritt) an dein zuständiges Finanzamt. Weitere Informationen zur Meldepflicht folgen.
|====

[TIP]
.IP-Adresse der TSE notieren
====
Wir empfehlen dir, die IP-Adresse der TSE separat zu notieren. Bestenfalls bringst du nach erfolgreicher Kopplung ein Etikett mit der IP-Adresse außen am Bondrucker an. So kannst du nach Verbindungsabbrüchen oder anderen Störungen einfach auf die bei der Kopplung gespeicherte IP-Adresse zugreifen und vermeidest, dass die falsche TSE gekoppelt wird.
====

[#600]
=== Bei Ausfall der TSE kassieren

Falls die technische Sicherheitseinrichtung ausfällt, kannst du weiterhin Kassiervorgänge an der Kasse durchführen. Jedoch solltest du zwingend die folgenden Schritte beachten:
...
* Kontaktiere umgehend deinen Kassenanbieter, um die TSE wieder instandzusetzen oder sie bei Bedarf auszutauschen.
...
[#700]
==== TSE-Export in der App erstellen

Den TSE-Export solltest du täglich nach dem <<pos/pos-kassenbenutzer#210, Tagesabschluss>> erstellen. Dazu startest du zuerst den TSE-Export in der App. Die Exportdatei wird anschließend automatisch hochgeladen und steht im zweiten Schritt im plentymarkets Backend zum Download zur Verfügung.

[TIP]
.TSE-Export täglich erstellen
====
Wir empfehlen, darauf zu achten, nach jedem Tagesabschluss auch gleich einen TSE-Export durchzuführen, damit alle Kassenvorgänge seit dem letzten Tagesabschluss sauber dokumentiert sind.
====
...
Im plentymarkets Backend stehen dir nach Erstellung über die App alle bisher generierten TSE-Exportdateien zur Verfügung. Im Fall einer Überprüfung durch die Finanzbehören greifst du über das Menü *Aufträge » POS » TSE-Export* auf die Exportdateien zu und kannst diese herunterladen.

[WARNING]
.Kassenpersonal schulen
====
Im Fall einer Prüfung durch die Finanzbehörden muss jeder Kassenbenutzer in der Lage sein, den TSE-Export unverzüglich erstellen und in elektronischer Form übergeben zu können. Schule deshalb dein Kassenpersonal sorgfältig mithilfe der folgenden Anleitung!
====

Gehe wie unten beschrieben vor, um gesammelte TSE-Exporte herunterzuladen:
...
====
Für Kassenbenutzer, die als variable Benutzer auf das plentymarkets Backend zugreifen, musst du die <<basics/admin-aufgaben/benutzer-verwalten#100, Menü-Sichtbarkeit>> aktivieren, damit diese Benutzer Zugriff auf das oben beschriebene Menü erhalten.
Öffne dazu das Menü *Einrichtung » Einstellungen » Benutzer » variablen Benutzer wählen » Rechte*. Aktiviere im Bereich *Menü-Sichtbarkeiten* unter *Aufträge » POS* die Option *TSE-Export*. Klicke abschließend auf *Speichern*.
====

[#900]
==== TSE-Informationen in der App einsehen
...
Gehe wie unten beschrieben vor, um Informationen zur TSE-Einheit in der App einzusehen:
...
→ Das Menü wird angezeigt.
. Tippe auf *TSE-Einheit*. +
→ Die verfügbaren Informationen zur TSE-Einheit werden aufgelistet. Beachte dazu <<tabelle-app-tse-einheit>>.

[[tabelle-app-tse-einheit]]
...
|*Status*
|Zeigt den Status der TSE-Einheit an. +
Sobald die TSE-Einheit erfolgreich gekoppelt wurde, wird der Standard-Status *INITIALIZED* angezeigt. 

|*Zertifikat gültig bis*
|Zeigt das Gültigkeitsdatum des TSE-Zertifikats an. Nach Ablauf des angezeigten Datums muss ein neues Zertifikat erworben werden. Zertifikat wird bestellt (zB. bei Epson). Bei Ablauf muss man ein neues Zertifikat beim Anbieter beantragt. Abgelaufenes Zertifikat: Man kann weiter in der Kasse arbeiten aber muss baldmöglichst erneuert werden.

|*Registrierte Clients*
|Anzahl aller Kassen, die mit der TSE verbunden sind. Im Optimalfall ist jede Kasse mit einer eigenen TSE ausgestattet. Es ist möglich, mehrere Kassen mit derselben TSE zu betreiben. Allerdings kann es bei diesem Vorgehen zu Wartezeiten kommen.

|*Gestartete Transaktionen*
|Zeigt die Anzahl TSE-Transaktionen, die aktuell ausgeführt und durch die TSE signiert werden.

2+|Bereich *Signaturen*

|*Erstellt*
|Zeigt die Anzahl der Signaturen, die auf der aktuell verwendeten TSE erstellt wurden. Hierzu zählen alle Vorgänge, die die TSE im Hintergrund abwickelt (Anmeldungsvorgang, Einstellungsänderungen, Zeitabgleiche) sowie jeder einzelne durch die TSE signierte Kassenbeleg./

|*Verbleibend*
|Zeigt die Anzahl der verbleibenden Signaturen, die für die aktuell verwendete TSE noch zur Verfügung stehen, bis die Gesamtanzahl (siehe unten) erreicht ist.

|*Gesamt*
|Zeigt die Anzahl der Signaturen, die auf der aktuell verwendeten TSE maximal erstellt werden können. Ist diese Anzahl erreicht, musst du die TSE-Einheit beim Anbieter austauschen lassen. 

2+|Bereich *Speicher*

|*Verwendet*
|Zeigt den aktuell auf der TSE-Einheit verwendeten Speicher an. Der Speicher der TSE-Einheit wird durch die TSE-Exportdateien belegt. <<pos/pos-rechtssicherheit#600, Erstelle einen Export>>,um den Speicher der TSE-Einheit zu leeren.

|*Gesamt*
|Zeigt den maximal verfügaren Gesamtspeicherplatz der TSE-Einheit an.

2+|Bereich *Export*

|*Letzter Export*
|Datum, an dem die letzte TSE-Exportdatei erstellt und erfolgreich hochgeladen wurde.
...
Der österreichische Gesetzgeber gibt vor, wie du vorgehen sollst, falls die Signatureinheit der Registrierkasse ausfällt.
...
====
Für Kassenbenutzer, die als variable Benutzer auf das plentymarkets Backend zugreifen, musst du die <<basics/admin-aufgaben/benutzer-verwalten#100, Menü-Sichtbarkeit>> aktivieren, damit diese Benutzer Zugriff auf das oben beschriebene Menü erhalten.
Öffne dazu das Menü *Einrichtung » Einstellungen » Benutzer » variablen Benutzer wählen » Rechte*. Aktiviere im Bereich *Menü-Sichtbarkeiten* unter *Aufträge » POS* die Option *DEP-Export*. Klicke abschließend auf *Speichern*.
====
