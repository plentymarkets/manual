...
. Wähle die gewünschten Filter. Beachte dazu die Erläuterungen in <<tabelle-POS-kassenjournal-menue>>.
. Klicke auf **Suchen**. +
...
.Menü-Sichtbarkeit für variable Benutzer aktivieren
====
Für Kassenbenutzer, die als variable Benutzer auf das plentymarkets Backend zugreifen, musst du zuvor die <<basics/admin-aufgaben/benutzer-verwalten#100, Menü-Sichtbarkeit>> aktivieren, damit diese Benutzer Zugriff auf das oben beschriebene Menü erhalten.
...
WARNUNG: Kassenpersonal schulen
...
====
.Menü-Sichtbarkeit für variable Benutzer aktivieren
Für Kassenbenutzer, die als variable Benutzer auf das plentymarkets Backend zugreifen, musst du zuvor die Menü-Sichtbarkeit aktivieren, damit diese Benutzer Zugriff auf das oben beschriebene Menü erhalten.
Öffne dazu das Menü *Einrichtung » Einstellungen » Benutzer » variablen Benutzer wählen » Rechte*. Aktiviere im Bereich *Menü-Sichtbarkeiten* unter *Aufträge » POS* die Option *DSFinV-K-Export*. Klicke abschließend auf *Speichern*.
====
