...
Im plentymarkets Backend stehen dir nach Erstellung über die App alle bisher generierten TSE-Exportdateien zur Verfügung. Im Fall einer Überprüfung durch die Finanzbehören greifst du über das Menü **Aufträge » POS » TSE-Export** auf die Exportdateien zu.
...
[.instruction]
TSE-Export herunterladen:

. Öffne das Menü **Aufträge » POS » TSE-Export**.
. Wähle im Dropdown-Menü die Seriennummer der betreffenden TSE-Einheit aus.
. Wähle über den Filter das Start- und Enddatum für den Zeitraum des Exports.
. Klicke auf **Suchen**. +
→ Die Liste aller verfügbarer Exportdateien wird angezeigt.
. Klicke auf **Herunterladen**, um die Exportdateien herunterzuladen. +
...
////
TO DO: Möglichkeit, für Zeiträume gesammelt die TSE-Exporte herunterzuladen (aktueller Stand: immer nur pro Datum/einzelne TSE-Berichte) - von Jacek/Marcel zeigen lassen
////
...
Beim Koppeln wird die TSE Einheit initialisiert, der Status INITIALIZED steht für normalen funktionierenden betrieb
...
|Anzahl aller Kassen, die mit der TSE verbunden sind. Optimalfall: 1 TSE pro Kasse drucken

|**Gestartete Transaktionen**
|Transaktionen die gerade laufen. Bon parken: Transaktion wird gestartet, bon wird geparkt, dann geupdated und beendet, stehen in der Zwischenzeit dann vor dem Slash

2+|Bereich **Signaturen**

|**Erstellt**
| //TODO: Gescheite Erklärung für Signaturen. Alle Vorgänge der TSE, also Anmeldung der TSE, Einstellungsänderungen, Zeitabgleiche, 

|**Verbleibend**
|Verbleibende Signaturen

|**Gesamt**
|Wenn aufgebraucht muss TSE Einheit beim anbieter ausgetauscht werden.

2+|Bereich **Speicher**

|**Verwendet**
|Zeigt den aktuell auf der TSE-Einheit verwendeten Speicher an.
...
|wie groß die Datei wäre wenn jetzt ein export gemacht wird.
|===
