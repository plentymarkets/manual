...
* Nutze Prozesse und/oder Ereignisaktionen, um Aufträge zu bearbeiten, die über den Webshop oder Marktplätze ins System gelangen? +
...
. Öffne das Menü **Einstellungen » Mandant » Standard » POS**.
