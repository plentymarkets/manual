...
|Wählen, ob der Soll-Bestand beim Erstellen eines <<pos/pos-einrichten#230, Tagesabschlusses>> oder <<pos/pos-einrichten#450b, Kassensturzes>> sichtbar sein soll. Diese Option ist standardmäßig deaktiviert. Somit sehen Kassenpersonal beim Zählen _nicht_ wie viel Geld in die Kasse erwartet wird. Es ist sinnvoll den Soll-Bestand ausgeblendet zu lassen, damit Kassenpersonal den Soll-Bestand wirklich selbst zählen. Ist die Information eingeblendet, können Kassenpersonal den Soll-Bestand direkt übernehmen, ohne selbst gezählt zu haben.
