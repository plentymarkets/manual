...
Die Einstellungen, die du benötigst, um ein Benutzerkonto für Kassenpersonal zu erstellen, werden nachfolgend beschrieben. Allgemeine Informationen zu Benutzerkonten und Berechtigungen findest du auf der Handbuchseite <<business-entscheidungen/benutzerkonten-zugaenge#, Benutzerkonten verwalten>>.
...
| *CRM*
a| * *Kampagne » Code » Anzeigen*
* *Kampagne » Code » Erstellen*
* *Kampagne » Code » Löschen*
* *Adresse » Anzeigen*
...
Damit Kassenpersonal in plentyPOS Preise bearbeiten, Auftragspositionen umbenennen und/oder Rabatte gewähren können, müsst du die Berechtigungen dazu zuweisen. Wie du Rollen einrichtest und Benutzern zuweist, erfährst du <<business-entscheidungen/benutzerkonten-zugaenge#, hier>>. Dort schaltest du auch weitere App-Funktionen für Kassenpersonal frei.
...
=== plentyPOS Zahlungsarten umbenennen

Die <<#710, oben>> beschriebenen Standardzahlungsarten **4 » Bar bei Übergabe** und **11 » Barverkauf/EC-Karte** kannst du im Backend individuell umbenennen. So behältst du leichter den Überblick.

Zur Umbenennung der Zahlungsarten wird das folgende Plugin benötigt:

* link:https://marketplace.plentymarkets.com/pospaymentmethodrenaming_6813[plentyPOS Zahlungsarten^]{nbsp}icon:external-link[]

Informationen dazu, wie du dieses Plugin an plentyPOS anbindest, findest du in der Beschreibung des Plugins.
...
. Klicke auf das gewünschte Konto. +
→ Die Ansicht *Rechte* wird geöffnet.
. Aktiviere im Bereich *Berechtigungen* die in <<tabelle-berechtigungen-gutscheinverkauf>> gelisteten Berechtigungen.
. *Speichere* die Einstellungen.

[[tabelle-berechtigungen-gutscheinverkauf]]
.Berechtigungen für Gutscheinverkauf
[cols="1,3"]
|====
|Bereich |Berechtigung
...
Über den Webshop, Marktplätze oder andere Herkünfte bestellte Ware kann auch entweder online bezahlt und im Ladengeschäft abgeholt oder im Ladengeschäft bezahlt und abgeholt werden. Befolge die unten beschriebenen Schritte, um Click & Collect einzurichten und an der Kasse abzuwickeln.
