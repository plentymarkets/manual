...
Aktiviert (Standardeinstellung) = Der Warenausgang wird automatisch gebucht. Der Button *Warenausgang buchen* wird Kassenkräften nicht angezeigt. +
...
Die Einstellungen, die Sie benötigen, um ein Benutzerkonto für Kassenpersonal zu erstellen, werden nachfolgend beschrieben. Allgemeine Informationen zu Benutzerkonten und -rechten finden Sie auf der Handbuchseite <<basics/admin-aufgaben/benutzer-verwalten#, Benutzer verwalten>>.

[TIP]
.Tipp: Rolle für Kassenpersonal erstellen
====
Um die Rechteverwaltung für Kassenpersonal zu vereinfachen, erstellen Sie eine <<basics/admin-aufgaben/benutzer-verwalten#70, Rolle>> mit den Berechtigungen, die Sie Kassenpersonal zuweisen möchten, und verknüpfen Sie diese Rolle mit den Benutzerkonten des Kassenpersonals.
====

[#140]
=== Benutzerkonto für Kassenpersonal erstellen

Damit neues Kassenpersonal Zugriff auf plentymarkets POS erhält, legen Sie zunächst im plentymarkets Backend <<basics/admin-aufgaben/benutzer-verwalten#, Benutzerkonten>> der Benutzerklasse **Variabel** für diese Personen an. Gehen Sie dazu wie unten beschrieben vor.
...
. Geben Sie die E-Mail-Adresse der Kassenkraft ein, damit diese Person Benachrichtigungen des Systems empfängt.
...
[#150]
=== REST-API-Berechtigungen für Kassenpersonal aktivieren
...
. Aktivieren Sie die in <<tabelle-POS-REST-Berechtigungen>> gelisteten Berechtigungen.
. **Speichern** Sie die Einstellungen.

[[tabelle-POS-REST-Berechtigungen]]
.REST-API-Berechtigungen für variable Benutzer
[cols="1,3"]
|====
...
*_Hinweis:_* Diese Code-Rechte sind nur für den Gutscheinverkauf erforderlich.
|====

[#160]
=== POS-Sichtbarkeit für Kassenpersonal aktivieren

Im Tab *Mobile* legen Sie fest, welche Bereiche und Kennzahlen für Kassenpersonal der Benutzerklasse *Variabel* in der plentymarkets App sichtbar sein sollen.
...
. Wenn die Kassenkraft auf weitere Bereiche der plentymarkets App zugreifen können soll, aktivieren Sie <<pos/pos-einrichten#170, weitere Berechtigungen>>.
. *Speichern* Sie die Einstellungen. +
...
2+|*System » Systemeinstellungen » Einstellungen » Benutzer » Konten » Konto öffnen » Tab: Berechtigung » Tab: Mobile » POS-Funktionen*
...
. Öffnen Sie das Menü *System » Systemeinstellungen » Einstellungen » Benutzer » Konten*.
. Öffnen Sie das variable Benutzerkonto.
. Öffnen Sie das Tab *Berechtigung*.
. Wechseln Sie in das Tab *REST-API*.
. Öffnen Sie den Bereich *Gutschein » Kampagne » Code*.
...
* Variablen Benutzerkonten REST-API-Berechtigungen erteilen.
...
Benutzer mit Admin-Rechten haben standardmäßig die Berechtigungen, Retourengutscheine zu erstellen. Benutzern der Benutzerklasse *Variabel* müssen diese Berechtigungen separat erteilt werden.
