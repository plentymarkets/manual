...
plentymarkets POS ist für das Kassieren mit den Währungen Euro (EUR), Schweizer Franken (CHF) und Britische Pfund (GBP) vorbereitet. Sie können die Kasse allerdings nur in der <<payment/waehrungen#30, Systemwährung>> betreiben. Die Systemwährung legen Sie im Menü *System » Aufträge » Zahlung » Währungen* fest.
...
Nachdem Sie Kassen gebucht haben, richten Sie diese Kassen im plentymarkets Backend ein. Zunächst weisen Sie die Kassen einem Mandanten zu, indem Sie die Kasse im Menü **System » Mandant » Mandant wählen » POS** erstellen und weitere Einstellungen vornehmen. Gehen Sie dazu wie unten beschrieben vor.
...
|Wählen, ob Kassenpersonal einen Gutschein in Höhe des Retourenbetrags aushändigen dürfen, statt den Betrag bar auszuzahlen.
...
Aktiviert (Standardeinstellung) = Der Warenausgang wird automatisch gebucht. Der Button *Warenausgang buchen* wird nicht angezeigt. +
Nicht aktiviert  = Wenn ein externer Auftrag vollständig bezahlt wird, wird der Warenausgang automatisch gebucht. Der Button *Warenausgang buchen* wird nicht angezeigt. +
*_Hinweis:_* 
...
Aktiviert = Die Auftragspositionen werden aus dem für die Kasse eingestellten *Vertriebslager* gebucht. Das Lager am Auftrag wird überschrieben.
...
|Wählen, welche Kontaktdaten durchsucht werden, wenn ein Barcode mit dem Präfix *+* gescannt wird. +
...
*_Tipp:_* Bei der Einstellung *Kundennummer* können vorab Kundenkarten mit Barcodes gedruckt werden. Der Barcode-Code ohne das Präfix *+* kann dann in dem Feld *Kundennummer* des Kontakts gespeichert werden.
...
|**Kopfzeile**
|Wenn die Komponente gewählt wurde, wird Inhalt des Felds als Kopfzeile aller Belege der Kasse ausgegeben. Standardmäßig ist die Kopfzeile mit den im Menü **System » Einstellungen » Stammdaten** gespeicherten Daten befüllt. Daten bei Bedarf anpassen.
...
Im Menü **System » Aufträge » Gutscheine** wählen Sie nun einmalig dieses Freitextfeld und ordnen das Freitextfeld so Gutscheinkampagnen zu.
...
Ab App-Version 1.9 können über den Webshop oder Marktplätze bestellte Waren auch entweder online bezahlt und im Ladengeschäft abgeholt oder im Ladengeschäft bezahlt und abholt werden.

Die folgenden Vorbereitungen sind POS-seitig nötig, wenn Sie Kundinnen und Kunden anbieten möchten, Online-Bestellungen im Laden abzuholen oder im Laden abzuholen und zu bezahlen:
...
* Mit Verkaufsgutscheinen können Kunden Online-Bestellungen an der Kasse erst ab App-Version 1.9.2 bezahlen.
