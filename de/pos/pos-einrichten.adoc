...
====
.Kasse buchen
Um plentyPOS verwenden zu können, link:https://www.plentymarkets.eu/preise/[buche zunächst eine oder mehrere Kassen^] für deinen plentymarkets Tarif. Informationen zu den Konditionen findest du direkt bei der Buchung oder auf der link:https://www.plentymarkets.eu/produkt/pos/[plentyPOS Produktseite^]{nbsp}icon:external-link[].
====
