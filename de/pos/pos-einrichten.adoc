...
Nachdem du das Plugin *plentyBase ItemCachePOS* vollständig eingerichtet hast, kannst auch ohne Internetverbindung Artikel über plentyPOS verkaufen. Das Plugin funktioniert wie ein Zwischenspeicher, in dem die Vorgänge abgelegt werden, bis wieder eine Internetverbindung besteht. Sobald wieder eine Internetverbindung besteht, werden die durchgeführten Vorgänge automatisch im Hintergrund mit deinem plentymarkets System synchronisiert.

Zusätzlich sind die folgenden Funktionen im Offline-Betrieb verfügbar:
...
* Kunden wechseln
* Online-Bestellungen (Click & Collect) laden und kassieren
* Retouren mit Zuordnung zum Hauptauftrag buchen
