...
Um plentyPOS verwenden zu können, link:https://www.plentymarkets.eu/preise/[buche zunächst eine oder mehrere Kassen^]. Informationen zu den Konditionen findest du direkt bei der Buchung oder auf der link:https://www.plentymarkets.eu/produkt/pos/[plentyPOS Produktseite^]{nbsp}icon:external-link[].
...
* Stelle das Plugin link:https://marketplace.plentymarkets.com/plugins/payment/PayUponPickup_4757[Barzahlung]{nbsp}icon:external-link[] für den Mandanten bereit. +
...
→ Die Konfigurationsanleitung findest du in der Beschreibung des Plugins link:https://marketplace.plentymarkets.com/plugins/integration/plentyBase_5053[plentyBase^]{nbsp}icon:external-link[]. +
...
→ Wie du die plentyBase Verbindungsdaten in der App speicherst, erfährst du in der Beschreibung des Plugins link:https://marketplace.plentymarkets.com/plugins/integration/plentyBase_5053#140.[plentyBase^]{nbsp}icon:external-link[].
...
→ Die Konfigurationsanleitung findst du in der Beschreibung des Plugins link:https://marketplace.plentymarkets.com/plugins/integration/plentyBase_5053[plentyBase^]{nbsp}icon:external-link[]. +
...
====
Um Etiketten drucken zu können, benötigst du das kostenlose Plugin plentyBase. plentyBase stellt eine Schnittstelle bereit, über die du aus dem plentymarkets Backend und/oder der plentymarkets App die Drucker nutzen kannst, die an den Computer angeschlossen sind. Wie du plentyBase installierst und konfigurierst erfährst du in der Beschreibung des Plugins link:https://marketplace.plentymarkets.com/plugins/integration/plentyBase_5053[plentyBase^]{nbsp}icon:external-link[].
====
