...
====
.Kasse buchen
Um plentyPOS verwenden zu können, link:https://www.plentymarkets.com/de/produkt/preise/[buche zunächst eine oder mehrere Kassen^] für deine plentymarkets Edition. Informationen zu den Konditionen findest du direkt bei der Buchung oder auf der link:https://www.plentymarkets.eu/produkt/pos/[plentyPOS Produktseite^]{nbsp}icon:external-link[].
====
...
. Aktiviere im Bereich *Berechtigungen* die in <<table-POS-REST-rights>> gelisteten Berechtigungen.
. *Speichere* (icon:save[role="darkGrey"]) die Einstellungen.
...
. Nimm die Einstellungen vor. Beachte dazu die Erläuterungen in <<table-POS-payment-methods>>.
...
. Klicke auf das gewünschte Konto. +
→ Die Ansicht *Rechte* wird geöffnet.
. Aktiviere im Bereich *Berechtigungen* die in <<table-rights-selling-coupons>> gelisteten Berechtigungen.
. *Speichere* (icon:save[role="darkGrey"]) die Einstellungen.

[[table-rights-selling-coupons]]
...
. Gib einen Namen ein.
. Wähle das **Ereignis** gemäß <<table-POS-event-procedure-outgoing-items>>.
. **Speichere** (icon:save[role="darkGrey"]) die Einstellungen.
. Nimm die Einstellungen gemäß <<table-POS-event-procedure-outgoing-items>> vor.
...
→ Das Fenster **Neue Ereignisaktion erstellen** wird geöffnet.
. Gib einen Namen ein.
. Wähle das **Ereignis** gemäß <<table-POS-event-procedure-send-receipt>>.
. **Speichere** (icon:save[role="darkGrey"]) die Einstellungen.
. Nimm die Einstellungen gemäß <<table-POS-event-procedure-send-receipt>> vor.
. Setze ein Häkchen bei **Aktiv**.
. **Speichere** (icon:save[role="darkGrey"]) die Einstellungen.
--
