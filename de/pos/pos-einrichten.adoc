...
Im Falle einer <<pos/pos-kassenbenutzer#175, Retoure>> oder eines <<pos/pos-kassenbenutzer#450, Click-and-Collect-Auftrags>> bringen Kund:innen typischerweise ihre Kaufbelege mit in den Laden. Wurde ein Barcode auf dem Beleg gedruckt, muss das Kassenpersonal lediglich <<pos/pos-kassenbenutzer#520, den Barcode scannen>>, um den entsprechenden Auftrag aufzurufen. +
...
*_Hinweis:_* Damit dieses Recht greift, muss der Kassenkraft im Menü *Einrichtung » Einstellungen » Benutzer » Rechte » Benutzer* auch die Berechtigung *CRM » Adresse » Adresse anzeigen* erteilt werden.
...
Bietest du <<pos/pos-einrichten#4100, Click & Collect>> über deinen Webshop an, musst du zusätzlich die Auftragsherkünfte **Manuelle Eingabe**, **Webshop** und, falls zutreffend, die Auftragsherkunft des für Click & Collect genutzten Marktplatzes aktivieren.
====
...
*_Tipp:_* Der externe Name wird in der Sprache auf dem Beleg ausgegeben, die das Kassenpersonal bei der Kassenanmeldung wählt.
...
*_Hinweis:_* Lieferländer nur wählen, wenn die Zahlungsart auch im Webshop verwendet wird.
