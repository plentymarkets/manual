...
Für Kassenaufträge wird ein Auftrag im plentymarkets Backend erstellt. Nach dem Erstellen des Auftrags können keine nachträglichen Änderungen von vertragsrelevanten Daten mehr vorgenommen werden. Ausgenommen hiervon sind Daten, die sich im Rahmen der Bearbeitung und Erfüllung von Aufträgen ändern bzw. deren Historie dokumentieren:
