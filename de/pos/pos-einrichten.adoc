...
Mit dem mobilen Kassensystem plentymarkets POS integrierst du den stationären Handel mühelos in plentymarkets. Das Kassensystem plentymarkets POS wird über die <<app/installation#, plentymarkets App>> bereitgestellt.
...
[#10]
== Erste Schritte mit der plentymarkets App

Das Kassensystem plentymarkets POS wird über die <<app/installation#, plentymarkets App>> bereitgestellt. Wirf mal einen Blick in unsere Dokumentation und lerne:

* welche <<app/installation#400, Hardware-Voraussetzungen>> für plentymarkets POS bestehen.
* wo du die kostenlose <<app/installation#500, plentymarkets App herunterladen>> kannst.
* wie du deine Mitarbeiter <<app/installation#600, Zugang zur App>> gewährst.
* wie du dich in die App <<app/installation#1100, einloggst und zurechtfindest>>.

== Unterstützte Währungen

plentymarkets POS ist für das Kassieren mit den Währungen Euro (EUR), Schweizer Franken (CHF) und Britische Pfund (GBP) vorbereitet. Du kannst die Kasse allerdings nur in der <<payment/waehrungen#30, Systemwährung>> betreiben. Die Systemwährung legst du im Menü *Einrichtung » Aufträge » Zahlung » Währungen* fest.

[#20]
== plentymarkets POS Kasse buchen

Um plentymarkets POS verwenden zu können, link:https://www.plentymarkets.eu/preise/[buche zunächst eine oder mehrere Kassen^]. Informationen zu den Konditionen findest du direkt bei der Buchung oder auf der link:https://www.plentymarkets.eu/produkt/pos/[plentymarkets POS Produktseite^].
...
**__Hinweis:__** Damit dieses Recht greift, muss der Kassenkraft im Menü *Einrichtung » Einstellungen » Benutzer » Rechte » Benutzer* auch die Berechtigung *CRM » Adresse » Adresse anzeigen* erteilt werden.
...
. Aktiviere alle Kassen, an denen der Kassenbenutzer arbeiten soll.
. **Speichere** die Einstellungen.

[WARNING]
.Auftragsherkünfte sorgfältig aktivieren
====
Achte genau darauf, **alle** POS-Auftragsherkünfte zu aktivieren, zu denen der Kassenbenutzer Kassiervorgänge ausführen soll. Betreibst du beispielsweise 2 Kassen, aktiviere für den Benutzer beide Kassen als Auftragsherkunft. Ansonsten ist es dem Benutzer nicht möglich, an Kasse 1 zu kassieren und später an der Kasse 2 einen Retourenvorgang für den selben Verkauf durchzuführen.
Bietest du <<pos/pos-einrichten#4100, Click & Collect>> über deinen Webshop an, musst du zusätzlich die Auftragsherkünfte **Manuelle Eingabe**, **Webshop** und, falls zutreffend, die Auftragsherkunft des für Click & Collect genutzten Marktplatzes für den Benutzer aktivieren.
====
...
|**Land**
|Land aus der Dropdown-Liste wählen, in dem die Kasse eingesetzt wird. Standardeinstellung richtet sich nach der Option **Firmensitz für FiBu** im Menü <<schnelleinstieg/schnelleinstieg-basiseinstellungen#100, Einrichtung » Einstellungen » Stammdaten>>.
...
[#2100]
== Verkaufsgutscheine und Aktionsgutscheine

In plentymarkets sind Verkaufsgutscheine im Sinne von _Geschenkgutscheinen_ zu verstehen. Es handelt sich dann um einen Verkaufsgutschein, wenn der Inhaber diesen zur Einlösung gegen Gegenstände oder Dienstleistungen verwenden kann.
...
* Entscheide <<auftraege/gutscheine#15, welche Artikel aus deinem Sortiment>> per Gutschein bezahlbar sein sollen.
* <<auftraege/gutscheine#120, Erstelle Gutscheinartikel>> mit 0% MwSt., d.h. füge die kaufbare Geschenkgutscheine deinem Sortiment hinzu.
* <<auftraege/gutscheine#20, Erstelle eine Kampagne>> für deine Gutscheine. Bestimme mit der Option *Gutscheinart*, ob es sich um Verkaufsgutscheine oder Aktionsgutscheine handelt.
* <<auftraege/gutscheine#130, Verknüpfe deine Gutscheinartikel mit der Kampagne>>.
* *_Optional:_* <<pos/pos-einrichten#850, Generiere Gutschein-Codes>> oder speichere deine eigene Gutschein-Codes im Backend.
...
Eine praxisnahe und einfache Methode im Umgang mit Gutscheinen ist der Verkauf von Gutscheinkarten in variabler Höhe direkt an der Kasse. So kann dein Kassenpersonal stets schnell und umkompliziert Gutscheine in der von Kunden gewünschten Höhe direkt an der Kasse verkaufen.
...
====
Wenn du deinen Gutscheincodes das Präfix *#* voranstellst, beschleunigst du später den Einlösungsvorgang, weil plentyPOS dadurch direkt beim Scannen erkennt, dass es sich um einen Gutschein handel. So musst du nicht erst manuell die Schaltfläche für den Gutscheindialog betätigen.
====
...
[#4100]
== Onlinebestellungen abwickeln (Click & Collect)

Über den Webshop, Marktplätze oder andere Herkünfte bestellte Ware kann auch entweder online bezahlt und im Ladengeschäft abgeholt oder im Ladengeschäft bezahlt und abholt werden. Befolge die unten beschriebenen Schritte, um Click & Collect einzurichten und an der Kasse abzuwickeln.
...
Gehe wie unten beschrieben vor, um einen <<fulfillment/versand-vorbereiten#800, Versanddienstleister>> für die Abholung in der Filiale zu erstellen. In diesem Beispiel nennen wir diesen Versanddienstleister *Abholung in der Filiale*. Natürlich kannst du auch einen anderen Namen verwenden.
...
Erstelle nun ein <<fulfillment/versand-vorbereiten#1000, Versandprofil>> für die Abholung in der Filiale. In diesem Beispiel nennen wir dieses Versandprofil *Abholung in der Filiale*. Natürlich kannst du auch einen anderen Namen verwenden.
