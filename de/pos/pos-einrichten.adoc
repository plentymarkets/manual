...
→ Stellen Sie sicher, dass Auftragsbestätigungen die Auftrags-ID enthalten. Weisen Sie Kundinnen und Kunden explizit darauf hin, dass diese Auftrags-ID benötigt wird, um den Auftrag in der Filiale zu bearbeiten.
