...
* Online-Aufträge können an der Kasse erst ab App-Version 1.9.2 mit Verkaufsgutscheinen bezahlt werden. Voraussetzung ist, dass für den Auftrag noch keine Zahlung durchgeführt wurde und noch keine Rechnung für den Auftrag generiert wurde.
