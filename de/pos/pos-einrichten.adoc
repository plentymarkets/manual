...
Aktiviert = Die Auftragspositionen werden aus dem für die Kasse eingestellten *Vertriebslager* gebucht.
...
*_Tipp:_* Bei der Einstellung *Kundennummer* können vorab Kundenkarten mit Barcodes gedruckt werden. Der Barcode-Code kann dann in das Feld *Kundennummer* des Kontakts  gespeichert werden.
