...
|Wählen, aus welchem Lager die Auftragspositionen ausgebucht werden sollen, wenn externe Aufträge an der Kasse abgeschlossen werden. +
Nicht aktiviert (standard) = Die Auftragspositionen werden aus dem Lager ausgebucht, das dem Auftrag bei der Erstellung zugeordnet wurde. +
Aktiviert = Die Auftragspositionen werden aus dem Lager ausgebucht, das im Tab *Vertriebslager* der Kasse gewählt wurde.
...
*Kontakt-ID* = Wählen, wenn Barcodes die Kontakt-ID enthalten. +
*_Hinweis:_* Wir empfehlen die Einstellung *Kundennummer*. Sie können dann Kundenkarten mit Barcodes drucken und
