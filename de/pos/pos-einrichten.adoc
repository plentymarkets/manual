...
* <<auftraege/gutscheine#20, Erstelle eine Kampagne>> für deine Gutscheine. Bestimme mit der Option *Gutscheinart*, ob es sich um Mehrzweckgutscheine oder Aktionsgutscheine handelt.
...
.Einstellungen für POS-Mehrzweckgutscheinkampagnen
[cols="1,3"]
|====
...
. Nimm die weiteren Einstellungen vor. Beachte dazu die Erläuterungen in <<tabelle-POS-mehrzweckgutscheine-artikeleinstellungen>>.
. **Speichere** die Einstellungen.
...
. **Speichere** die Einstellungen. +
→ Der Artikel wird erstellt und zur weiteren Bearbeitung geöffnet.
. Nimm die weiteren Einstellungen vor. Beachte dazu die Erläuterunngen in <<tabelle-POS-mehrzweckgutscheine-artikeleinstellungen>>.
. **Speichere** die Einstellungen. +
...
[[tabelle-POS-mehrzweckgutscheine-artikeleinstellungen]]
...
Benutzer mit Admin-Rechten haben standardmäßig die Berechtigungen, Mehrzweckgutscheine zu erstellen. Benutzern der Benutzerklasse *Backend* müssen diese Berechtigungen separat erteilt werden.
