...
Bietest du <<pos/pos-einrichten#4100, Click & Collect>> an, musst du zusätzlich die Auftragsherkunft **Manuelle Eingabe** und, falls zutreffend, die Auftragsherkunft des für Click & Collect genutzten Marktplatzes für den Benutzer aktivieren.
====
