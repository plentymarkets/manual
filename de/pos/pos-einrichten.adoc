...
|**Land**
|Land aus der Dropdown-Liste wählen, in dem die Kasse eingesetzt wird. Standardeinstellung richtet sich nach der Option **Firmensitz für FiBu** im Menü <<basics/erste-schritte/stammdaten#, System » Systemeinstellungen » Einstellungen » Stammdaten>>.
