...
:author: team-mobile
:keywords: plentymarkets POS, plentyPOS, plenty POS, Kasse, POS, plentymarkets Kasse, Kasse installieren, Kasse benutzen, POS benutzen, Kassenbenutzer, POS-Benutzer, Kassenpersonal, Kassierer, POS Auftrag, POS Aufträge, Kassenbeleg, Kassenabschluss, Tagesabschluss, Kassiervorgang, Bon, Kassensturz
:position: 20
...
. Gib die Zugangsdaten ein. Beachte dazu die Erläuterungen in <<tabelle-POS-kassenpersonal-anmeldung>>.
. Tippe auf **Login**. +
...
[IMPORTANT]
.Varianten mit Bestelleigenschaften
====
Varianten, an denen Bestelleigenschaften hinterlegt sind, können in plentyPOS nicht zu Aufträgen hinzugefügt werden und sind vom Kassiervorgang ausgeschlossen. Ab Version 1.11.7 der plentymarkets App wird daher eine Fehlermeldung angezeigt, wenn du versuchst, solche Varianten zum Warenkorb hinzuzufügen.
Bestelleigenschaften werden in einer künftigen Version der plentymarkets App zur Verfügung stehen. Beobachte unseren link:https://forum.plentymarkets.com/c/changelog[Changelog^], um auf dem Laufenden zu bleiben.
====
...
Noch einfacher als <<#135, oben beschrieben>> kannst du den Kundendatensatz für das Kassieren auswählen, wenn du Kundenkarten mit Barcodes scannst. Weitere Informationen zur Beschaffung von Kundenkarten findest du auf der Handbuchseite <<pos/pos-einrichten#990, plentyPOS einrichten>>.

Sobald du Kundenkarten mit Barcodes beschafft hast, musst du Bestandskund:innen nicht mehr über die <<#135, Kundensuche>> auswählen. Stattdessen scannst du direkt beim Öffnen der Kassieransicht den Barcode der Kundenkarte. Der im Barcode hinterlegte Kontakt wird dann automatisch ausgewählt und dem Auftrag zugeordnet. Fahre dann damit fort, <<#40, Artikel zum POS-Warenkorb hinzuzufügen>> und den Auftrag wie gewohnt an der Kasse abzuschließen.
