...
====
Varianten, an denen Bestellmerkmale hinterlegt sind, sind in plentyPOS vom Kassiervorgang ausgeschlossen. Ab Version 1.11.5 der plentymarkets App wird daher eine Fehlermeldung angezeigt, wenn du versuchst, solche Varianten zum Warenkorb hinzuzufügen.
