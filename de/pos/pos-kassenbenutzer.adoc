...
:author: team-mobile
:keywords: plentymarkets POS, plentyPOS, plenty POS, Kasse, POS, plentymarkets Kasse, Kasse installieren, Kasse benutzen, POS benutzen, Kassenbenutzer, POS-Benutzer, Kassenpersonal, Kassierer, POS Auftrag, POS Aufträge, Kassenbeleg, Kassenabschluss, Tagesabschluss, Kassiervorgang, Bon, Kassensturz, Katzenbenutzer
:position: 20
...
| **System (Basis-URL)**
|Domain des plentymarkets Systems ohne führendes https:// oder http:// eingeben, zum Beispiel **mein-shop.de**.
