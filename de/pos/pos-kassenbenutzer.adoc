...
====
Beachte bei den folgenden Anleitungen, dass die Erstattung von Retourenbeträgen mittels Kartenterminal erst in App-Version 1.11.5 und höher möglich ist.
====
...
. Zahle den Retourenbetrag bar, per Kartenterminal oder als Gutschein aus.
