...
====
Kaufen Kund:innen in deinem Webshop Varianten mit Bestelleigenschaften und holen diese anschließend in deinem Ladengeschäft ab? Für diesen Anwendungsfall ist die oben beschriebene Einstellung nicht relevant. Bei diesen so genannten <<pos/pos-online-bestellungen#, Click&Collect-Aufträgen>> werden Bestelleigenschaften schon jetzt vollständig in plentyPOS angezeigt. Dies gilt auch für Retouren zu Click&Collect-Aufträgen, die du über plentyPOS anlegst, falls Kund:innen Varianten zurückgeben. +
