...
*_Tipp:_* Wenn in der untersten Zeile des Ziffernblocks der Kasse die Schaltfläche *X* eingeblendet ist, können Sie auf diese Schaltfläche tippen, die Menge eingeben und dann den Artikel scannen oder einen Favoritenartikel wählen. Der Artikel wird dann mit der eingegebenen Menge in den POS-Warenkorb gelegt. Ein Administrator für die Kasse muss diese Komfortfunktion aktivieren.
...
Nachdem Sie alle Artikel in den POS-Warenkorb gelegt haben und bei Bedarf Rabatte/Verkaufsgutscheine angewendet haben, buchen Sie die Zahlung. Kund*innen können in bar und je nach den Abläufen in Ihrem Ladengeschäft auch über einen EC-Terminal oder per Gutschein bezahlen.
...
. Geben Sie über das Ziffernfeld den Betrag ein, den Sie erhalten haben. +
*_Tipp:_* Wenn der Betrag passend in bar bezahlt wird, tippen Sie stattdessen in der untersten Zeile des Ziffernblocks auf die Schaltfläche *Passend*. Die erhaltene Summe wird dann automatisch in das Feld *Erhalten* eingefügt.
...
*_Tipp:_* Über die Schaltfläche *Auftrag anzeigen* rufen Sie die Auftragsdaten auf.
...
. *_Optional:_* Wenn nur ein Teilbetrag per EC-Karte gezahlt wird, geben Sie diesen Teilbetrag ein. +
*_Tipp:_* (ab Version 1.8.5) Wenn der gesamte Betrag mit nur einer Kartenzahlung beglichen wird, brauchen Sie den Betrag nicht mehr einzugeben, bevor Sie auf *EC-Terminal* tippen. Der Gesamtbetrag wird automatisch für die EC-Zahlung übernommen.
...
. *_Optional:_* Wenn nur ein Teilbetrag per EC-Karte bezahlt wird, geben Sie diesen Teilbetrag ein. +
*_Tipp:_* (ab Version 1.8.5) Wenn der gesamte Betrag mit nur einer Kartenzahlung beglichen wird, brauchen Sie den Betrag nicht mehr einzugeben, bevor Sie auf *EC-Terminal* tippen. Der Gesamtbetrag wird automatisch für die EC-Zahlung übernommen.
. Tippen Sie auf *EC-Terminal*. +
...
Jeder Verkaufsgutschein hat einen einzigartigen Gutschein-Code. Diesen Gutschein-Code geben Sie während des Kassiervorgangs ein, um den Gutschein auf den Einkauf anzuwenden. Damit ein Gutschein-Code eingelöst werden kann, muss dieser Gutschein-Code zu dem Zeitpunkt, in dem der Gutschein eingelöst wird, im plentymarkets System gespeichert sein. Ab App-Version 1.8.1 können pro Kassenvorgang auch mehrere Gutscheine eingelöst werden. Beim Erstellen des Auftrags werden die Gutscheine in der Reihenfolge eingelöst, in der Sie die Gutscheincodes eingeben. Wenn Sie einen Gutscheincode entfernen, bevor der Auftrag erstellt wurde, wird der Restbetrag neu berechnet.

[.instruction]
Verkaufsgutscheine einlösen:

. Legen Sie alle Artikel in den POS-Warenkorb.
...
. *_Optional:_* Um weitere Gutscheine einzulösen, geben Sie diese Gutscheincodes auf dieselbe Art ein. +
...
→ Wenn Sie mit Gutscheinbelegen arbeiten und der Gutschein nicht vollständig eingelöst wird, wird ein Gutscheinbeleg erstellt. Händigen Sie dann zusammen mit dem Kaufbeleg auch den Gutscheinbeleg aus. +
...
Wenn im plentymarkets Backend das Plugin *plentyPOS Kauf auf Rechnung* aktiviert ist, können Sie auch Artikel auf Rechnung verkaufen. Über plentyPOS können aber keine neuen Kundendaten erfasst werden. Kund*innen können Artikel also nur auf Rechnung kaufen, wenn ihre Kundendaten im System gespeichert sind.
...
. Rufen Sie die <<135, den Kundendatensatz>> auf. +
*_Wichtig:_* Vergewissern Sie sich, dass wirklich die im Kundendatensatz gespeicherte Person die Artikel kauft. +
...
====
Wenn Sie auf das Symbol *Rechnungskauf* tippen, wird der Auftrag abgeschlossen und eine Rechnung erstellt. Der noch offene Betrag wird auf der Rechnung ausgewiesen. Wenn ein Teil des Auftrags per Rechnung gezahlt werden soll, buchen Sie deshalb erst alle anderen Zahlungsarten und wählen Sie erst dann die Option *Rechnungskauf*, um den Auftrag abzuschließen.
====
...
. Geben Sie über das Ziffernfeld den Betrag ein, der mit der ersten Zahlungsart bezahlt wird.
. Tippen Sie auf die Schaltfläche für die Zahlungsart, in der Sie den Betrag erhalten haben. +
*_Hinweis:_* Wenn ein Teil des Betrags auf Rechnung bezahlt wird, buchen Sie zuerst alle anderen Zahlungsarten und wählen Sie erst zuletzt die Option *Rechnungskauf*, um den Restbetrag als Rechnungsbetrag zu übernehmen.
→ Die erste Zahlung wird gebucht.
. Geben Sie über das Ziffernfeld den Betrag ein, der mit der nächsten Zahlungsart bezahlt wird.
. Tippen Sie auf die Schaltfläche für die Zahlungsart, in der Sie den Betrag erhalten haben. +
...
. Händigen Sie den Beleg aus.
*_Bei Rechnungskauf:_* Ein Händlerbeleg, ein Zahlungsbeleg und eine Rechnung werden erstellt. Händigen Sie den Zahlungsbeleg und die Rechnung aus.
*_Tipp:_* Über die Schaltfläche *Auftrag anzeigen* rufen Sie die Auftragsdaten auf.
. Tippen Sie auf *Neuer Auftrag*, um einen neuen POS-Auftrag zu erstellen.
...
Jeder Verkaufsgutschein hat einen einzigartigen Gutschein-Code. Dieser Gutschein-Code wird auf dem Beleg ausgegeben, wenn Sie einen Gutscheinartikel verkaufen. Damit ein Gutschein-Code eingelöst werden kann, muss dieser Gutschein-Code zu dem Zeitpunkt, in dem der Gutschein eingelöst werden soll, im plentymarkets System gespeichert sein. Je nach den Abläufen in Ihrem Ladengeschäft generieren Sie Gutschein-Codes entweder automatisch beim Verkauf des Gutscheins oder Sie arbeiten mit Gutschein-Code-Listen, die Ihnen Ihr Arbeitgeber zur Verfügung stellt. Die Codes auf dieser Liste sind entweder bereits im System gespeichert oder Sie speichern die Codes beim Verkauf. Erkundigen Sie sich bei Ihrem Arbeitgeber, wie Sie beim Verkauf von Gutscheinen vorgehen sollten.
...
. Händigen Sie den Kassenbeleg aus.
. Wenn Sie auch Gutscheinbelege drucken, händigen Sie auch den Gutscheinbeleg aus. +
...
. Wenn sich Artikel im POS-Warenkorb befinden, erfolgt die Abfrage **Preise aktualisieren?**. Wenn Sie **Ja** wählen, werden Rabatte, die für die Kundenklasse der gewählten Person gelten, auf alle Artikel des Auftrags angewendet. +
...
====
Über eine <<pos/pos-einrichten#70, Ereignisaktion>> kann der Beleg  als Anhang per E-Mail an den Kontakt gesendet werden, sobald ein Beleg generiert wird. Bei POS-Aufträgen, die Sie im Offline-Modus abschließen, wird der Beleg jedoch erst versendet, wenn die POS-Aufträge hochgeladen werden.
====
...
*_Wichtig:_* Vergewissern Sie sich, dass die Person die Ware wirklich bestellt und bezahlt hat. +
. Händigen Sie die Ware aus.
...
. Tippen Sie auf *Suchen*. +
→ Die Auftragsdaten werden in die Kasse geladen. +
*_Wichtig:_* Vergewissern Sie sich, dass die Person die Ware wirklich bestellt hat. +
...
*_Hinweis:_* Ab App-Version 1.9.2 können bestimmte Online-Bestellungen auch mit Verkaufsgutscheinen bezahlt werden. +
...
. Händigen Sie die Ware aus. +
→ Die Ware wird aus dem Lager ausgebucht. +
*_Hinweis:_* Wenn nach der Zahlung die Schaltfläche *Warenausgang buchen* angezeigt wird, wird die Ware nur ausgebucht, wenn Sie auf diese Schaltfläche tippen. +
...
Tipp: Über die Schaltfläche *Auftrag anzeigen* rufen Sie die Auftragsdaten auf.
. Tippen Sie auf *Neuer Auftrag*, um einen neuen POS-Auftrag zu erstellen.
...
Wenn Artikel zurückgegeben werden sollen, haben Sie zwei Möglichkeiten, eine Retoure zu buchen:
...
. Scannen Sie den Barcode der Artikel, die zurückgegeben werden. +
...
*_Tipp:_* Wenn alle Artikel des Auftrags zurückgegeben werden, tippen Sie einfach sofort auf *Retoure erstellen*.
...
Wenn Sie im Bereich *Retoure* einen Auftrag öffnen, sind keine Auftragspositionen des Auftrags für die Retoure vorgemerkt. Gehen Sie wie unten beschrieben vor, um die Auftragspositionen zur Retoure hinzuzufügen, die zurückgegeben werden.

[TIP]
.Sind die Retourenartikel vorausgewählt?
====
Ob Retourenartikel beim Öffnen des Auftrags vorausgewählt sind hängt davon ab, wie die Kasse eingestellt ist. Dass die Retourenartikel nicht vorausgewählt sind erkennen Sie daran, dass die Auftragspositionen ausgegraut sind und rechts daneben ein grünes Plus angezeigt wird. An diesem grünen Plus erkennen Sie, dass der Retourenwarenkorb leer ist und Sie die Artikel hinzufügen müssen, die zurückgegeben werden sollen.
====
...
Wenn Sie Anzahlungen oder den Kauf auf Rechnung anbieten kann es vorkommen, dass Kund*innen Artikel aus Aufträgen zurückgeben möchten, die noch nicht oder nur teilweise bezahlt sind. plentymarkets POS berechnet automatisch, ob Sie Geld auszahlen sollen oder nicht. <<tabelle-POS-Retoure-Rechnung>> verdeutlicht die Berechnung, die im Hintergrund stattfindet, damit Sie Kund*innen diese Berechnung bei Bedarf erklären können.
...
|*Teilweise bezahlt*
a|Die Kasse errechnet automatisch, ob und wenn ja wie viel Geld Sie auszahlen. Vereinfacht lautet die Formel: Offener Rechnungsbetrag minus Preis der zurückgegebenen Artikel.
...
|Sie zahlen den Betrag aus, der bisher bezahlt wurde. +
...
Bei einer Kassenrückschau durch die Finanzpolizei muss auf Verlangen ein Kontrollbeleg mit dem Betrag Null erstellt werden. Dieser Kontrollbeleg ermöglicht der prüfenden Person, die Gültigkeit der Signatur mit einer Prüf-App direkt vor Ort in Ihrem Laden zu prüfen. Sie benötigen keine zusätzlichen Berechtigungen, um den Kontrollbeleg zu erstellen.
