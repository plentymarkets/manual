...
Im Tagesgeschäft kann es vorkommen, dass du einen Bon erneut drucken musst. In plentyPOS selbst besteht keine direkte Möglichkeit zum Nachdrucken. Du kannst jedoch im <<auftraege/dokumentenarchiv#, Dokumentenarchiv>> im plentymarkets Backend den gewünschten Beleg finden und erneut ausdrucken.
...
. Wähle für die Einstellung *Dokumen* die Option *Kassenbeleg* aus.
