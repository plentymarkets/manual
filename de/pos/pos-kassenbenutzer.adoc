...
*_Tipp:_* Wenn der Betrag passend in bar bezahlt wird, tippen Sie stattdessen in der untersten Zeile des Ziffernblocks auf der Button *Passend*. Die erhaltene Summe wird dann automatisch in das Feld *Erhalten* eingefügt.
