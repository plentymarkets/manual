...
Beachte beim Hinzufügen von Artikeln jedoch die folgenden Hinweise:

//TODO: Stichpunkte oder Tabs
...
====
Varianten, an denen Bestelleigenschaften hinterlegt sind, können in plentyPOS nicht zu Aufträgen hinzugefügt werden und sind vom Kassiervorgang ausgeschlossen. Ab Version 1.11.8 der plentymarkets App wird daher eine Fehlermeldung angezeigt, wenn du versuchst, solche Varianten zum Warenkorb hinzuzufügen.
