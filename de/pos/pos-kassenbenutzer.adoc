...
*_Hinweis:_* Hast du die Stornierung während des <<pos/pos-einrichten#1100, Offline-Modus>> durchgeführt, ist die Stornierung erst nach erfolgter Synchronisierung im plentymarkets Backend sichtbar. Diese findet automatisch im Hintergrund statt, sobald wieder eine Internetverbindung verfügbar ist.
...
. Setze bei Bedarf <<auftraege/dokumentenarchiv#100, weitere Filter>> für die Suche.
