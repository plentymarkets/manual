...
[IMPORTANT]
.Varianten mit Bestellmerkmalen
====
Varianten, an denen Bestellmerkmale hinterlegt sind, können in plentyPOS nicht zu Aufträgen hinzugefügt werden und sind vom Kassiervorgang ausgeschlossen. Ab Version 1.11.7 der plentymarkets App wird daher eine Fehlermeldung angezeigt, wenn du versuchst, solche Varianten zum Warenkorb hinzuzufügen.
Bestellmerkmale werden in einer künftigen Version der plentymarkets App zur Verfügung stehen. Beobachte unseren link:https://forum.plentymarkets.com/c/changelog[Changelog^], um auf dem Laufenden zu bleiben.
====
