...
|**Canonical**
|Ggf. die URL einer Kategorie eingeben, die den gleichen Inhalt enthält, um **<<omni-channel/online-shop/cms-syntax/fallbeispiele/seo-guide#110, Duplicate Content >>** zu verhindern.
