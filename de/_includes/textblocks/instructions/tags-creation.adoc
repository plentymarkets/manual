...
[TIP]
.Tags können jederzeit weiter bearbeitet werden
====
...
* *Bereich* = Wähle einen oder mehrere Bereiche aus. In den Suchergebnissen werden nur die Tags angezeigt, die für diesen Bereich aktiviert wurden.
* *Sprache* = Wähle eine oder mehrere Sprachen aus. In den Suchergebnissen werden nur die Tags angezeigt, deren Name in dieser Sprache gespeichert ist.
====
