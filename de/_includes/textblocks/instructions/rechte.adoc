...
Benutzer:innen vom Typ *Backend* <<business-entscheidungen/benutzerkonten-zugaenge#105, sehen nur bestimmte Bereiche und Menüs>> in plentymarkets. Somit können sie nur eingeschränkt im System arbeiten. Sie können also nur eingeschränkt im System arbeiten. Sollen Mitarbeiter:innen mit dem Zugang *Backend* {rights-purpose}, benötigen diese Mitarbeiter:innen mindestens die folgenden Rechte:
