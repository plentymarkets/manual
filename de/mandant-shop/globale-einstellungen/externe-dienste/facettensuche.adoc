...
**plentymarkets » Einstellungen » Mandant (Shop) » Globale Einstellungen » Dienste » Facettensuche**
...
Die übersichtliche Filternavigation können Sie flexibel einrichten und in Ihrem CMS individuell gestalten. Mit der Facettensuche bieten Sie Ihren Kunden vielfach mehr Möglichkeiten als z.B. bei der Merkmalsuche. Die angezeigten Artikel in einer Kategorie können mit Facetten nicht nur nach Merkmalen, sondern auch nach folgenden Kriterien weiter eingeschränkt werden:
...
Diese vier Facettentypen verbinden Sie in plentymarkets mit verschiedenen Werten, die das Filterergebnis bestimmen. Je mehr Facetten Sie erstellen und mit Werten verknüpfen, desto umfangreicher wird die in Bild 1 dargestellte Filterauswahl. Wie genau das geht, erfahren Sie im Folgenden.

image::mandant-shop/globale-einstellungen/externe-dienste/assets/DE-Mandant-Global-Dienste-Facetten-01.png[]

__Bild 1: Beispiel der Facettensuche im Webshop__

[TIP]
.Artikel mit Facetten verknüpfen
====
Eine direkte Verknüpfung von Artikeln mit den einzelnen Facetten ist nicht nötig. Die Zuordnung Ihrer Artikel zu Facetten erfolgt automatisch durch die <<mandant-shop/globale-einstellungen/externe-dienste/facettensuche#2-3, **Verknüpfung der Facette mit Werten** >>, die am Artikel hinterlegt sein müssen.
====

== Konfiguration

Die Konfiguration besteht aus mehreren Schritten. Zunächst werden Facetten angelegt, anschließend werden sie durch weitere Einstellungen näher bestimmt und schließlich mit den gewünschten Werten verknüpft. Zudem muss im Menü **Einstellungen » Mandant (Shop) » Standard » Webshop » Artikelsuche** die Option **Facettensuche** eingestellt sein.
...
. Öffnen Sie das Menü **Einstellungen » Mandant (Shop) » Globale Einstellungen » Dienste » Facettensuche**.
. Klicken Sie auf **Neu**, um eine neue Facette hinzuzufügen.
. Tragen Sie einen **Namen** für die Facette in der Systemsprache ein.
. Wählen Sie einen **Typ** aus dem Dropdown-Menü gemäß den Erläuterungen in Tabelle 1.
...
|**Attribut/Merkmal**
|Facetten des Typs **Attribut/Merkmal** werden mit Attributen und Merkmalen in Ihrem System verknüpft und stellen so vielfältige Filtermöglichkeiten her, z.B. nach Farben, Größen etc.

|**Verfügbarkeit**
|Facetten des Typs **Verfügbarkeit**, z.B. "Kurzfristig lieferbar", werden mit den unter <<mandant-shop/globale-einstellungen/externe-dienste/facettensuche#180., **Einstellungen » Artikel » Artikelverfügbarkeiten** >> angelegten Verfügbarkeiten verknüpft.

|**Hersteller**
|Facetten des Typs **Hersteller**, z.B. "Adidas", werden mit den unter <<mandant-shop/globale-einstellungen/externe-dienste/facettensuche#560., **Einstellungen » Artikel » Hersteller** >> angelegten Herstellern verknüpft.
|====

__Tab. 1: Verfügbare Facettentypen__

=== Facetten konfigurieren

Nachdem Sie eine Facette angelegt haben, wird diese geöffnet. Es stehen vier Tabs zur Verfügung, um weitere Einstellungen vorzunehmen und Werte zu verknüpfen. Hier werden die Einstellungen der Tabs **Einstellungen** und **Name** erläutert.
Erklärungen zu den Tabs **Werte** und **Bilder** finden Sie in <<mandant-shop/globale-einstellungen/externe-dienste/facettensuche#2-3, **Kapitel 2.3** >> dieser Handbuchseite.
...
. Nehmen Sie die Einstellungen im Tab **Einstellungen** gemäß Tabelle 2 vor.
. Klicken Sie auf **Speichern**, um die Einstellungen zu sichern.
...
|Legt fest, wie viele Ergebnisse es für einen Facettenwert mindestens geben muss, damit er im Webshop angezeigt wird.
...
__Tab. 2: Facetten bearbeiten; Tab **Einstellungen**__
...
Die angelegten Werte werden nun links aufgelistet. Bestimmen Sie die Werte in den folgenden Schritten näher und verknüpfen Sie sie mit Informationen aus Ihrem System. Im Beispiel des Typs **Attribut/Merkmal** ist besonders praktisch, dass Attribute und Merkmale in Ihrem System in einem Filter zusammengefasst und so zusammen in einem Ergebnis ausgegeben werden können.
...
Im Tab **Einstellungen** eines Wertes hinterlegen Sie wie für die Facette eine **Position** und eine **CSS-Klasse** (Tabelle 2). +
...
. Wählen Sie das Attribut oder das Merkmal, das Sie verknüpfen möchten, aus der Liste.
. Klicken Sie links unten auf **Verknüpfen**. +
→ Das Attribut oder das Merkmal wird mit dem Wert der Facette verknüpft.
. Klicken Sie auf **Speichern**, um die Einstellungen zu sichern.
...
Im Tab **Bilder** verknüpfen Sie Facetten und ihre Werte mit Bildern, wenn Sie zum Beispiel die Hersteller in Ihrem Webshop nicht mit Namen, sondern mit Logo anzeigen möchten.
...
image::mandant-shop/globale-einstellungen/externe-dienste/assets/DE-Mandant-Global-Dienste-Facetten-02.png[]

__Bild 2: Such-Index; Tab **Gewichtung**__
...
. Öffnen Sie das Menü **Einstellungen » Mandant (Shop) » Standard / Shop » Dienste » Facettenverknüpfungen**.
...
Die Facettensuche wird im Template **NavigationFacetsList** definiert. Das Template **NavigationFacetsList** unseres Standard-Designs Callisto Light enthält fertigen Code, mit dem Sie eine Facettensuche erstellen, die dem in Bild 1 dargestellten Beispiel entspricht. Dieser Code ist natürlich ausbaubar. +
Über die Template-Funktion **<<cms-syntax/webdesign/navigation/container-navigationfacetslist#, Container_NavigationFacetsList  >>** fügen Sie das Template **NavigationFacetsList** in den gewünschten Bereich Ihres Webshops ein. Gehen Sie dazu wie unten beschrieben vor.
...
. Öffnen Sie das Menü <<cms/webdesign#2-3, **CMS » Webdesign** >>.
