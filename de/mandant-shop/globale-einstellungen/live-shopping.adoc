...
|**Ausblenden, wenn kein Angebot aktiv** = Template-Variable **<<cms-syntax/webdesign/itemview/container-itemviewliveshopping#, Container_ItemViewLiveShopping()  >>** wird nur befüllt, wenn ein Artikel gerade zum günstigen Preis gekauft werden kann. +
