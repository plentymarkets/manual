...
|Die Umsatzsteuersätze des Landes in Prozent eintragen. Die Textfelder **Name** sind nur für die Buchhaltungssoftware <<datenaustausch/daten-exportieren#10, **Xero** >> relevant.
...
Nachdem alle Konten und Buchungsschlüssel hinterlegt wurden, nehmen Sie im Menü **Datenaustausch » Daten-Export** verschiedene <<datenaustausch/daten-exportieren#, **Daten-Exporte**  >> vor.
