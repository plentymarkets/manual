...
|**Passwort ändern**
|Diese Einstellung dient dazu, die Anzeige der Option zur Änderung des <<arbeiten-mit-plentymarkets/benutzer-verwalten#, **Passworts**  >> zu **aktivieren** oder zu **deaktivieren**.
