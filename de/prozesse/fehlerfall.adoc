...
Die Konfiguration der Fehlerbehandlung wird im Folgenden am Beispiel der Aktion **<<prozesse/aktionen#430., Versand-Center >>** erläutert.
...
image::prozesse/assets/DE-Prozesse-Fehlerfall-01.png[]
...
*  Aktion: **<<prozesse/aktionen#220., E-Mail >>**
* Subaktion: <<prozesse/subaktionen#330, **Versenden** >>

*  Aktion: <<prozesse/aktionen#170., **Auftrag** >>
* Subaktion: <<prozesse/subaktionen#290., **Status ändern** >>

* Subaktion: <<prozesse/subaktionen#130., **Auftragsnotizen hinzufügen** >>
