...
:keywords: Amazon, Prime, Auftragsablauf, NextDay, SecondDay, Prime NextDay, Prime SecondDay, Prime-Auftrag, Prime Auftrag, Prime Fehler
:position: 600
...
.Grundsätzliches:
====
Wenn wir von Prime-Aufträgen sprechen, sind nicht nur die Aufträge von Prime-Kund:innen auf Amazon gemeint, sondern auch Aufträge, welche mit einem Versandservice (NextDay, SecondDay) von nicht-Prime-Kund:innen auf Amazon erteilt wurden.
====
...
Wollt ihr also ein Versandprofil für z.B. Prime NextDay-Aufträge erstellen, muss der Filter *Treueprogramm* bei der Option *Amazon Prime NextDay* aktiviert sein.
...
Als Wert für die Auswahl oder den Text in dem Artikel hinterlegt ihr den Namen der Versandgruppe, welche ihr zuvor in eurem Seller Central erstellt habt.
