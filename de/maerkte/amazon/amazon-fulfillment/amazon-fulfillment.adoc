...
<<maerkte/amazon/variantendaten-exportieren#, Amazon-Variantenexport per Katalog einrichten icon:long-arrow-left[]>>

[.text-left]
_oder_

<<maerkte/amazon/variantendaten-exportieren-alt#, Variantenexport über alte Technologie einrichten icon:long-arrow-left[]>>
...
*_Tipp:_* Du hast dich schon für Amazon FBA entschieden? Dann geh gleich weiter zur Handbuchseite <<maerkte/amazon/amazon-fba-nutzen#, FBA-Service von Amazon nutzen>>.
...
[.next-navigation]
Überzeugt? Dann weiter zu <<maerkte/amazon/amazon-fba-nutzen#, FBA-Service von Amazon nutzen icon:long-arrow-right[]>>
