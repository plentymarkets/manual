...
======
Wenn du die Pakete selbst versendest und dies nicht von Amazon übernommen wird, sind die Schaltflächen *Versandkosten einholen*, *Versandkosten annehmen*, *Bestätigung stornieren* und *Labels drucken* nicht verfügbar.
======
...
* Für Paketsendungen beträgt die Frist, innerhalb der du den Auftrag stornieren kannst, 24 Stunden.
* Für LKW-Teilladungen/LKW-Ladungen beträgt die Frist, innerhalb der du den Auftrag stornieren kannst, 1 Stunde.
