...
Wenn du in plentymarkets Sendungen als versendet markierst, wird diese Anfrage an Amazon gesendet. plentymarkets erhält dann von Amazon den Status *SHIPPED* zurück.
