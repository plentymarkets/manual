...
* Amazon bearbeitet Aufträge schnell und zuverlässig. Spitzenzeiten vor Weihnachten sind genauso problemlos wie das Sommerloch während der Urlaubszeit.
...
[#70]
=== Auftragseinstellungen für Amazon FBA vornehmen
...
| *Lager*
| Wählen, welches <<Lager für Amazon FBA erstellen, Amazon FBA-Lager>> für den Bestandabgleich des Kontos verwendet werden soll. Dieses Lager wird auch für die FBA-Auftragszuordnung des Kontos verwendet, falls kein FBA-Auftrag zugeordnet werden kann, weil für das Auftragsland kein Lager eingerichtet wurde.
...
|v*Status für übertragene Aufträge*
...
2+|XXXAuftragseigenschaften-Typ
...
| *XXXVersandart*
|
// Option kommt im Screenshot doppelt vor
|====
...
Nachdem du im Amazon Seller Central eine FBA-Inbound-Sendung erstellt hast und diese Sendung in plentymarkets importiert wurde, buchst du die Varianten der Sendung in dein FBA-Lager um. Durch das Umbuchen der Ware in das FBA-Lager wird ein FBA-Inbound-Auftrag in plentymarkets erstellt. Diese Auftrag kann dann im Lager weiter bearbeitet werden.
...
Im Menü *Waren » Amazon FBA Inbound* werden die FBA-Inbound-Aufträge angezeigt. Beachte, dass erst ein FBA-Inbound-Auftrag erstellt wird, wenn du die Ware in dein FBA-Lager umgebucht hast.
...
→ Das Versandetikett wird gedruckt.
