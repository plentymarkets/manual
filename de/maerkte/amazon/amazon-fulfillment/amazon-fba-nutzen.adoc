...
====
Das Amazon FBA-Lager verfügt _nicht_ über verschiedene Lagerorte, sondern verwendet immer nur den Standardlagerort. Führe als vor dem Erstellen der Pickliste und dem Verwenden der Paketinhaltsliste _keine Warenbewegungsbuchung in der Umbuchung_ durch. Andernfalls werden auf der Pickliste die Lagerorte falsch angezeigt.
====
