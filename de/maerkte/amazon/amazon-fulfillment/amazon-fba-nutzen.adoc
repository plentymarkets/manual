...
| Wählen, in welches <<Lager für Amazon FBA erstellen, Amazon FBA-Lager>> unverkäuflicher Bestand des Kontos gebucht werden soll. Wenn du kein Lager wählst, wird der unverkäufliche Bestand nicht importiert. +
