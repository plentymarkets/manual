...
. Wähle den Etikettentyp aus der Dropdown-Liste.
...
[IMPORTANT]
Aktuell können keine Artikelpakete (Bundles) in diesem Prozess verarbeitet werden.
...
====
In diesem Menü werden nur Sendungen angezeigt, wenn alle darin enthaltenen Artikel über die SKU mit einer Variante in plentymarkets abgeglichen werden können.
====
...
| *Bestellung*
|Auf *Umbuchung anlegen* klicken, um für diese Sendung eine Umbuchung anzulegen.
...
====
Das Amazon FBA-Lager verfügt _nicht_ über verschiedene Lagerorte, sondern verwendet immer nur den Standardlagerort. Du solltest also vor dem Erstellen der Pickliste und dem Verwenden der Paketinhaltsliste _keine Warenbewegungsbuchung in der Umbuchung_ durchführen. Andernfalls werden auf der Pickliste die Lagerorte falsch angezeigt.
====

[#140]
=== FBA-Inbound-Auftrag für Sendung erstellen

Nachdem du im Amazon Seller Central eine FBA-Inbound-Sendung erstellt hast, diese Sendung in plentymarkets importiert wurde und du eine Umbuchung angelegt hast, ist der FBA-Inbound-Auftrag in plentymarkets erstellt. Dieser Auftrag kann dann im Lager weiter bearbeitet werden.
...
. *Speichere* (icon:save[set=plenty]) die Einstellungen. +
→ Für diese Sendung wird eine Umbuchung angelegt, die alle Varianten der Sendung enthält. +
...
Im Menü *Waren » Amazon FBA Inbound* werden die FBA-Inbound-Aufträge angezeigt. Beachte, dass erst ein FBA-Inbound-Auftrag erstellt wird, wenn du für die Sendung eine Umbuchung angelegt hast.
...
Die Paketinhaltsliste bereitet die Pakete anhand der Einstellungen an der Variante vor. Du kannst diese Einstellungen ändern. Öffne dazu das Menü *Artikel » Artikel bearbeiten* » _Artikel öffnen_ » *Tab: Einstellungen » Bereich: Versand* und ändere die Option in der Dropdown-Liste *Packstücke*.
...
*_Hinweis:_* Die Versandarten *Kleine Pakete* und *Teilladung/Vollladung* stehen zur Verfügung.
. Gib die Paketverfolgungsnummer für alle Pakete ein. +
*_Hinweis:_* Wenn du die Versandart *Teilladung/Vollladung* (oder *Palettenlieferung*) gewählt hast, musst du die PRO-Nummer eingeben. Die PRO-Nummer ordnet der Versanddienstleister der Sendung zu.
. Klicke auf *Ja*. +
...
*_Hinweis:_* Wenn du mit einem Amazon-Transportpartner versendest, steht dir nur die Versandart *Kleine Pakete* zur Verfügung.
...
======
Wenn du die Sendung mit einem Amazon-Transportpartner versenden möchtest, entscheidet Amazon, mit welchem Versanddienstleister die Artikel versendet werden. +
Im Amazon Seller Central musst du die Geschäftsbedingungen für das Amazon-Transportpartner-Programm sowie die Geschäftsbedingungen aller zur Verfügung stehenden Versanddienstleister akzeptieren. Andernfalls kann dies zu Fehlermeldungen führen, wenn Amazon einen Versanddienstleister wählt, den du normalerweise nicht einsetzt.
======
...
* Für kleine Pakete beträgt die Frist, innerhalb der du den Auftrag stornieren kannst, 24 Stunden.
* Für Voll- und Teilladungen beträgt die Frist, innerhalb der du den Auftrag stornieren kannst, 1 Stunde.

Du kannst die Sendung allerdings jederzeit erneut anmelden, indem du die Versandkosten anforderst und diese akzeptierst.
====

Wenn du eine Sendung löschen möchtest, musst du die Sendung im Amazon Seller Central löschen. Das Löschen über plentymarkets ist nicht möglich.
