...
*_Hinweis:_* Die FBA-Berichte enthalten Auftragsdaten von 0:00 Uhr des Startdatums bis 0:00 Uhr des Enddatums. Sie enthalten also keine Auftragsdaten des gewählten Enddatums.
. Klicke auf *Bericht generieren* (icon:execute[set=plenty]).
→ Der FBA-Bericht wird generiert. +
→ Fehlende, gelöschte oder korrigierte FBA-Aufträge werden neu importiert.
