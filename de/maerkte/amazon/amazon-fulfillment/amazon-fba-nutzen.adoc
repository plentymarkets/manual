...
*_Hinweis:_* Amazon generiert die Berichte nur einmal täglich.
...
== FBA-Berichte generieren

Um dir einen Überblick über deine FBA-Aufträge zu verschaffen, kannst du im plentymarkets Backend einen Bericht deiner FBA-Aufträge generieren. Anders als über Seller Central erzeugte Berichte enthalten die im plentymarkets Backend erstellten Berichte auch personenbezogene Daten zu deinen Endkund:innen.

IMPORTANT: Das Generieren von FBA-Berichten erzeugt eine hohe Datenlast. Wenn du zu viele Berichte generierst, wird deshalb die API deines Systems temporär deaktiviert. Dadurch können auch andere Prozesse deines Systems kurzzeitig in Mitleidenschaft gezogen werden. Beachte, dass auch Amazon selbst nur einmal pro Tag FBA-Berichte erzeugt.

[.instruction]
FBA-Bericht generieren:
...
. Speichere den Bericht auf der Festplatte deines PCs.
