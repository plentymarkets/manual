...
====
Das Amazon FBA-Lager hat keine Stellplätze, sondern verwendet immer nur den Standardlagerort. Du solltest also vor dem Erstellen der Pickliste und dem Verwenden der Paketinhaltsliste _keine Warenbewegungsbuchung in der Umbuchung_ durchführen. Andernfalls werden auf der Pickliste die Stellplätze falsch angezeigt.
====
...
//Frage: hier Info, dass die PCL die Artikel abhängig von den Einstellungen am Artikel packt? Man kann die Einstellungen am Artikel vorab anpassen.
