...
→ Du kannst die Sendung jederzeit erneut anmelden, indem du die Versandkosten anforderst und akzeptierst.

NOTE: Wenn du eine Sendung löschen möchtest, musst du die Sendung im Amazon Seller Central löschen. Das Löschen einer Sendung über plentymarkets ist nicht möglich.
