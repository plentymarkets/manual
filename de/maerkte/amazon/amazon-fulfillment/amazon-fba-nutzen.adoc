...
*_Hinweis:_* Die FBA-Berichte enthalten Auftragsdaten von 0:00 Uhr des Startdatums bis 0:00 Uhr des Enddatums (Zeitzone des plentymarkets Systems). Die Berichte enthalten also keine Auftragsdaten des gewählten Enddatums.
