...
| Wählen, in welches <<Lager für Amazon FBA erstellen, Amazon FBA-Lager>> unverkäuflicher Bestand des Kontos gebucht werden soll. +
Der unverkäufliche Bestand ist die Anzahl der Einheiten einer SKU, die sich in Amazon-Logistikzentren befinden und den Zustand "nicht verkaufbar" haben. Im Bericht "Lagerbestand mit Versand durch Amazon" entspricht dies der Menge in der Spalte *afn-unsellable-quantity*.
