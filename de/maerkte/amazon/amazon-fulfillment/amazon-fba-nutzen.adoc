...
| *Sendungsstatus*
|Der Status, in dem sich die Amazon-Sendung aktuell befindet. Die folgenden, bei Amazon verfügbaren Status werden hier angezeigt: *WORKING*, *SHIPPED* oder *CANCELLED*. 
