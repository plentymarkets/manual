...
====
TIP: Wenn du für den Export schon die neuen Kataloge nutzt, kannst du den Schritt *Eigenschaft mit Amazon verknüpfen* überspringen. Der Assistent *Kataloge erstellen - Amazon* kann automatisch Eigenschaften erstellen.
====
...
====
TIP: Merkmale sind ein veraltetes Feature. Wir empfehlen dir daher, keine neuen Merkmale mehr anzulegen. Nutze stattdessen die <<#1390, Eigenschaften>>.
====
