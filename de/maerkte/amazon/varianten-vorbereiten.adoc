...
Erstelle im ersten Schritt die <<artikel/artikel-verwalten#70, Freitextfelder>>, die du mit den frei definierbaren Feldern bei Amazon verknüpfen möchtest. Gehe dazu wie im Folgenden beschrieben vor.
...
====
TIP: Merkmale sind ein veraltetes Feature. Wir empfehlen dir daher, keine neuen Merkmale mehr zu erstellen. Nutze stattdessen die <<#1390, Eigenschaften>>.
====
