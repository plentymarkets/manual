...
* *SKU*: Füge im Menü *Artikel » Artikel bearbeiten » [Artikel öffnen] » [Variante öffnen] » Tab: Verfügbarkeit* im Bereich *SKU* eine SKU mit der Herkunft *Amazon* hinzu.
--
...
--
* Aktiviere den Artikel im Menü *Artikel » Artikel bearbeiten » [Artikel öffnen] » [Variante öffnen] » Tab: Verfügbarkeit*. Dazu aktivierst du zunächst im *Tab: Einstellungen* die Option *Aktiv* im Bereich *Verfügbarkeit*. Aktiviere außerdem im *Tab: Verfügbarkeit* in der Dropdown-Liste im Bereich *Märkte* die Option *Web-API* und die gewünschte *Amazon-Herkunft*.
