...
Du hast nun die Schnittstelle zu Amazon in plentymarkets eingerichtet und deine Varianten vorbereitet. Entscheide nun, ob du deine Varianten per Export oder über den alten Artikelexport zu Amazon exportieren möchtest.
