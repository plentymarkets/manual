= Best Practice: Rechnungsservice VCS nutzen
:lang: de
...
In eurem plentymarkets System aktiviert ihr den Amazon-Rechnungsservice im Menü *Einrichtung » Märkte » Amazon » Einstellungen »* _Amazon-Konto wählen_ *» Tab: Einstellungen* unter der Option *Rechnung erzeugen*.
...
. Die folgenden Lager müssen in eurem plentymarkets System vorhanden sein:
  ...
  .. Für jede Amazon-Plattform, auf der ihr Waren verkauft
  .. Für jedes Land, aus dem ihr Ware versendet
  .. Für jedes Amazon-FBA-Logistiklager, in dem eure Ware bei Amazon lagert +
  <<maerkte/amazon/amazon-fba-nutzen#60, So erstellst du Lager für Amazon FBA>>
====
