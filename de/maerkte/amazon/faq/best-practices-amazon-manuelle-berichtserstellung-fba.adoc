...
1. In der link:https://sellercentral.amazon.de/[Amazon Seller Central für Europa^]{nbsp}icon:external-link[] einloggen und in das Menü *Berichte » Versand durch Amazon* wechseln.
...
*_Wichtig:_* Erstellt den Bericht im *TXT-Form* und nicht im CSV-Format (neue Option von Amazon). Die Berichte können im CSV-Format nicht eingelesen werden.
