...
Dieses Best Practice soll dich dabei unterstützen, den Gesamtwarenbestand deines europäischen Amazon-Verkäuferkontos jeweils für EU und UK separat im System darzustellen. So siehst du sowohl auf Artikel- als auch auf Variantenebene den jeweiligen Bestand. Das heißt, es kann pro Artikel oder Variante der Warenbestand für alle europäischen Lager (summiert, Gesamtbestand) und der Bestand aller Lager des Vereinigten Königreichs (summiert, Gesamtbestand) im System dargestellt werden. Korrekt konfiguriert bedeutet dies, dass ihr an einer Variante oder einem Artikel zwei Lager sehen könnt, wobei das eine Lager den *FBA EU Stock* (= Bestand EU) und ein Lager den *FBA UK Stock* (= Bestand UK) darstellt. Beachte, dass nur Bestand dargestellt wird, wenn Bestand vorhanden ist.
...
image::maerkte/assets/bp-amazon-bestand-eu-plattform.jpeg[EU-Plattform]

[[EU-Bestand]]
.Lager: FBA EU Stock
image::maerkte/assets/bp-amazon-bestand-eu.jpeg[EU-Bestand]
...
[[UK-Plattform]]
.Amazon-Plattform UK
image::maerkte/assets/bp-amazon-bestand-uk-plattform.jpeg[Amazon-Plattform UK]

[[UK-Bestand]]
.Lager: FBA UK Stock
image::maerkte/assets/bp-amazon-bestand-uk.jpeg[UK-Bestand]
