...
MFN steht für Merchant Fulfillment Network. Das bedeutet: Du bearbeitest deine Amazon-Aufträge selbst und verpackst und versendest die Ware. Zu diesem Thema findest du im Best Practice <<maerkte/amazon/best-practices-amazon-mfn-auftragsimport#, Best Practice: MFN-Auftragsimport>> weitere Informationen.
