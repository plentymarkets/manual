...
* Die Pflichtfelder der Flatfile werden schon im Assistenten verknüpft. Weitere Datenfelder werden direkt im erstellten Katalog im Menü *Daten » Kataloge* verknüpft.
