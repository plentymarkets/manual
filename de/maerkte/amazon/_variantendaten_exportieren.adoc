...
[.tabs]
====
Im Assistenten *Grundeinstellungen - Amazon*::
+
--
...
*_Hinweis:_* Der Schritt *Automatische Datenübertragung* ist nur sichtbar, wenn im Schritt *Marktplatz einrichten* die Einstellung *Erweiterte Einstellungen anzeigen* aktiviert ist.
|======
