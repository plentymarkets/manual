...
:keywords: Katalog validieren, Katalogvalidierung, Bestandsinformationen, Bestandsexport, plentyBI
:position: 100
...
Mit der Kennzahl *Marktplatz-Variantenvalidierung* prüfst du, ob die Variantendaten eines Katalogs wichtige Regeln des Marktplatzes Amazon erfüllen.
...
Zurzeit kannst du die Exporte der folgenden Amazon Flatfiles prüfen:
