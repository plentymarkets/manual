...
*_Hinweis:_* <<crm/kontakte-verwalten#15, Erstelle die nötigen Kundenklassen>> im Voraus, falls sie nicht bereits in deinem plentymarkets System vorhanden sind.
