...
Mit Filtern in den Bereichen Auftragssuche und Ereignisaktionen werden Aufträge mit den Versandbedingungen von Amazon Prime gesondert in plentymarkets behandelt. Versandlabel für Amazon Prime-Aufträge werden über die Amazon Merchant Fulfillment API generiert.
