...
:description: Multi-Channel in plentymarkets: Biete auch in deinem Webshop das Bezahlen mit Amazon an.
:position: 80
...
====
Aufträge mit der Zahlungsart Amazon Pay sollten innerhalb von 30 Tagen abgewickelt werden, da sie sonst nach 30 Tagen automatisch storniert werden. Wenn du generell Artikel mit längeren Lieferzeiten verkaufst, kontaktiere bitte den Support von Amazon Pay. In Ausnahmefällen kann die 30-Tage-Frist verlängert werden.
====
