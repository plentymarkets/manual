...
* Bevor du deinen ersten Amazon-Katalog erstellst, mache dich damit vertraut, <<daten/daten-exportieren/kataloge#, wie Kataloge in plentymarkets funktionieren>>.
