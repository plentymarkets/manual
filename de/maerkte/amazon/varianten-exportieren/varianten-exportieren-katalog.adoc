...
*_Hinweis:_* Wenn Amazon eine neue Version der Flatfile veröffentlicht, muss auch ein neuer Katalog erstellt werden. Die gute Nachricht ist: Du kannst den Katalog mit der alten Flatfile-Version einfach und schnell <<daten/daten-exportieren/marktplatzexport#80, kopieren und anpassen>>.
...
* Bevor du deinen ersten Amazon-Katalog erstellst, mache dich damit vertraut, <<daten/daten-exportieren/marktplatzexport/kataloge#, wie Kataloge in plentymarkets funktionieren>>.
