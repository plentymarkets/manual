...
'''
*Datenquelle manuell verknüpfen* = Diese Felder werden nicht automatisch im Assistenten verknüpft. Du musst diese Datenfelder manuell im Katalog verknüpfen, nachdem der Katalog erstellt wurde.
--
