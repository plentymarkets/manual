...
TIP: Wenn du schon einmal einen Katalog für Amazon erstellt hast, werden beim nächsten Katalog Quellen als Vorschläge eingeblendet. Für jedes Feld wird die Quelle vorgeschlagen, die du bisher am häufigsten mit diesem Feld verknüpft hast.
