...
qu*_Tipp:_* Eigenschaften, die du über den Assistenten erstellst, werden automatisch im Menü *Einrichtung » Einstellungen » Eigenschaften » Gruppen* zu der Gruppe *Amazon Catalog* hinzugefügt. Anhand dieser Gruppe kannst du sehen, welche neuen Eigenschaften du verknüpfen musst.
