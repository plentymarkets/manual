...
[#700]
== Im Assistenten angelegte Quellen mit Varianten verknüpfen
...
* Wie du Eigenschaften mit Varianten verknüpfst, erfährst du im Kapitel <<artikel/artikel-verwalten#4900, Eigenschaft verknüpfen und Wert speichern>>. + *_Tipp:_* Eigenschaften, die du über den Assistenten erstellst, werden automatisch im Menü *Einrichtung » Einstellungen » Eigenschaften » Gruppen* zu der Gruppe *Amazon Catalog* hinzugefügt. Anhand dieser Gruppe kannst du sehen, welche neuen Eigenschaften du verknüpfen musst.
