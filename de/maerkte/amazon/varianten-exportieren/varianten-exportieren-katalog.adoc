...
* *Datenquelle manuell verknüpfen* = Diese Felder werden nicht automatisch im Assistenten verknüpft und müssen manuell im Katalog verknüpfen musst, nachdem der Katalog erstellt wurde.
...
[#700]
== Vom Assistenten erstellte Eigenschaften mit Varianten verknüpfen
