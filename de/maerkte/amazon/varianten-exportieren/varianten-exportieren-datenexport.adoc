...
* Hast du Amazon in plentymarkets eingerichtet? <<maerkte/amazon/amazon-einrichten#, So geht's>>
* Hast du deine Variantendaten vorbereitet? <<maerkte/amazon/varianten-vorbereiten#, So geht's>>
...
In unserem yymaerkte/amazon/best-practices-amazon-artikeldatenexport, Best Practice zum Artikeldatenexport>> findest du eine Checkliste, die dir hilft, wenn ein Artikel nicht zu Amazon exportiert wird.
