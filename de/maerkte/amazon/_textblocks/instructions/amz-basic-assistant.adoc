...
*_Hinweis:_* Wenn du die Autorisierung erfolgreich abgeschlossen hast, wird in diesem Assistenten-Schritt die Verkäufer-ID deines Amazon-Verkäuferkontos angezeigt. Wenn die Autorisierung fehlgeschlagen ist, wird anstelle der Verkäufer-ID *N/A* angezeigt.
