...
| Maximale Variantenmenge eingeben.
...
*_Tipp:_* Im Menü *Einrichtung » Märkte » Amazon » Einstellungen »* _Konto öffnen_ *» Tab: Auftragseinstellungen* findest du diese Einstellung im Bereich *Eigener Versand (MFN)*.
