...
Du wirst zu Amazon weitergeleitet und musst deine Amazon-Zugangsdaten, bestehend aus E-Mail und Passwort, eingeben. Nachdem du dich bei Amazon eingeloggt hast, setze dort ein Häkchen und klicke auf *Confirm*, um die Autorisierung abzuschließen. +
...
* Wenn die Autorisierung erfolgreich abgeschlossen wurde, öffnet sich ein neuer Tab in deinem Browser mit der Meldung "The authorization of plentymarkets for the seller ID [Seller ID] has been successfully completed. You can now close this window and go back to the plentymarkets assistant.</p>." +
→ Du kannst diesen Tab schließen und zum Asssistenten in plentymarkets zurückkehren.
...
Nachdem du die Autorisierung bei Amazon abgeschlossen hast, wird in plentymarkets ein neuer Schritt im Assistenten geöffnet, der dich über den Status der Autorisierung informiert:

* Die Autorisierung war erfolgreich: +
*Zugriff auf Amazon erlaubt* +
Die Autorisierung von plentymarkets auf Amazon wurde erfolgreich abgeschlossen. Nun können Daten zwischen Amazon und plentymarkets ausgetauscht werden und du kannst über plentymarkets auf Amazon verkaufen, nachdem du die Einrichtung von Amazon in plentymarkets abgeschlossen hast. +
→ Du kannst mit dem nächsten Schritt des Assistenten fortfahren. Klicke dazu auf *Weiter*.

* Die Autorisierung ist fehlgeschlagen: +
*Zugriff auf Amazon fehlgeschlagen* +
Die Autorisierung von plentymarkets auf Amazon ist fehlgeschlagen. Wiederhole den Schritt *Zugriff auf Amazon erlauben*, um die Autorisierung abzuschließen und plentymarkets Zugriff auf Amazon zu erlauben. +
→ Du musst den Assistenten-Schritt *Zugriff auf Amazon erlauben* wiederholen, um die Autorisierung von plentymarkets abzuschließen, da du deine Artikel ansonsten nicht auf Amazon verkaufen kannst. Du kannst den Schritt entweder sofort wiederholen oder zuerst die nächsten Schritte des Assistenten abschließen und dann zu diesem Schritt zurückkehren.

*_Hinweis:_* Wenn du die Autorisierung erfolgreich abgeschlossen hast, wird in der Schaltfläche *Zugriff erlauben* die Verkäufer-ID deines Amazon-Benutzerkontos angezeigt.
