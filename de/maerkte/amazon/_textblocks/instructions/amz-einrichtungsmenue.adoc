...
! *Ja*
! Der Rabattbetrag wird beim Import von Auftragswert abgezogen. Wenn der Rabatt von der Händler:in gewährt wurde, muss der Auftrag manuell angepasst werden.
...
*_Hinweis:_* Um die Beispiele zu vereinfachen werden die Gebühren, die du an Amazon zahlst, dabei nicht berücksichtigt.
!===

| *Rabatte aus Versandkampagnen*
| Aus Amazon-Berichten geht nicht hervor, ob Rabatte auf Versandkosten eines Auftrags von der Händler:in oder von Amazon gewährt wurden.
...
* Der Auftrag wird mit einem Auftragswert von 10,00 Euro + 3,00 Euro Versandkosten importiert.
