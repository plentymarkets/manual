...
*_Wichtig:_* Wenn du bereits auf Amazon verkaufst und nun anfangen möchtest, deine Artikel über plentymarkets auf Amazon zu verkaufen, ordne deine bestehenden SKU-Nummern im Menü *Artikel » Artikel bearbeiten » [Artikel öffnen] » Tab: Varianten-ID » Tab: Einstellungen » Tab: Verfügbarkeit* zu.
...
| *Rabatte aus Artikelkampagnen*
| Aus Amazon-Berichten geht nicht hervor, ob Artikelrabatte eines Auftrags von der Händler:in oder von Amazon gewährt wurden.

Wählen, wie Rabattbeträge beim Import von Aufträgen behandelt werden sollen.

[cols="1,3a"]
!===
! *Tatsächlichen Wert importieren*
! Der Betrag aus dem Bericht wird importiert. Wenn der Rabatt von Amazon gewährt wurde, muss der Auftrag manuell angepasst werden, da die Summen nicht stimmen.

Ablauf bei Rabatt von Amazon:

* Eine Kundin kauft einen deiner Artikel für 10 Euro.
* Amazon gibt der Kundin einen Rabatt von 1 Euro.
* Der Auftrag wird mit einem Auftragswert von 9 Euro importiert.
* Amazon zahlt dir 10 Euro aus.
* Der Auftrag muss manuell korrigiert werden, da der Auftragswert und der Betrag, den Amazon an dich auszahlt, nicht übereinstimmen.

Ablauf bei Rabatt von Händler:in:

* Eine Kundin kauft einen deiner Artikel für 10 Euro.
* Du gibst der Kundin einen Rabatt von 1 Euro.
* Der Auftrag wird mit einem Auftragswert von 9 Euro importiert.
* Amazon zahlt dir 9 Euro aus.

! *Betrag 0,00 importieren*
! Rabatt die Information gibt welches Rabatt von den Händler und welches Rabatt von Amazon komm
...
* Amazon gibt der Kundin einen Rabatt von 1 Euro.
* Amazon zahlt dir 10 Euro aus.
* Der Auftrag wird mit einem Auftragswert von 10 Euro importiert.
