...
* Eine Kundin kauft einen deiner Artikel für 10,00 Euro lus 3,00 Euro Versandkosten.
...
! *Ja*
! Der Rabattbetrag wird beim Import vom Auftragswert abgezogen. Wenn der Rabatt von der Händler:in gewährt wurde, muss der Auftrag manuell angepasst werden.
