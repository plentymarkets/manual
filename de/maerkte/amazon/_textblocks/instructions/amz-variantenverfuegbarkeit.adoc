...
Später, <<maerkte/amazon/amazon-variantenexport#, wenn du deine Artikel an Amazon überträgst>>, wirst du immer nur einen Produkttyp, d.h. eine Kategorie, auf einmal übertragen.
//end::produkttyp-export[]

//tag::produkttyp-note[]
*_Hinweis_*: Eine Übersicht der Amazon-Produkttypen kannst du link:https://cdn02.plentymarkets.com/pmsbpnokwu6a/frontend/plenty_article_amazon_type_view.csv[hier^]{nbsp}icon:external-link[] herunterladen.
