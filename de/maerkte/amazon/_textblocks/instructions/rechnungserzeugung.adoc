...
* Der Auftrag wurde nachträglich importiert und ist eigentlich kein VCS-Auftrag, weil der Kauf vor dem Aktivieren von VCS getätigt, aber nach dem Aktivieren von VCS importiert wurde.
