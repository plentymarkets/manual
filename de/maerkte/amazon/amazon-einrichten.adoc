...
====
Beachten Sie auch die <<maerkte/amazon/best-practices#vcs, Best Practice-Seite zum Thema VCS>>. Dort finden Sie weitere hilfreiche Informationen zur Einrichtung des Amazon-Rechnungsservices VCS in plentymarkets.
====
