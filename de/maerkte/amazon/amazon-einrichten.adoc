...
====
Beachte, dass du die Rechnung erst bei Amazon hochladen kannst, wenn der Versand des Auftrags auf Amazon bestätigt wurde. Da Versandbestätigungen stündlich an Amazon übertragen werden, kann es bis zu einer Stunde dauern, bis der Versand auf Amazon bestätigt wurde.
====
