...
*_Hinweis:_* Wähle für den Filter *Auftrag > Herkunft* keine Amazon FBA-Herkunft, wie z.B. Amazon FBA Germany, wenn du den automatischen Gutschriftenimport nutzt.
