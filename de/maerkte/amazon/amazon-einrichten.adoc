...
Amazon-Rechnungsnummern und Gutschriften werden in plentymarkets importiert.
|====
...
[IMPORTANT]
.Amazon VCS zuerst auf Amazon aktivieren
====
Amazon VCS muss zuerst in der Amazon Seller Central aktiviert und freigeschaltet werden, bevor du den Service in deinem plentymarkets System aktivieren kannst. +
...
[IMPORTANT]
.Amazon VCS und IDU nicht gleichzeitig nutzen
====
Wenn du Amazon VCS nutzt, darfst du <<Eigene Rechnungen bei Amazon hochladen, Amazon IDU>> nicht verwenden, da Rechnungsdokumente ansonsten doppelt bei Amazon hochgeladen werden und dies durch eine Überlastung der Schnittstelle dazu führen kann, dass Rechnungen in der Seller Central fehlen.
====
...
Aktiviere Amazon VCS im Menü *Einrichtung » Märkte » Amazon » Amazon-Konto wählen » Tab: Einstellungen* im Bereich *Basiseinstellungen* in plentymarkets.
...
|*VCS Amazon*
|*Voraussetzung:* Amazon VCS wird genutzt. +
Amazon-Rechnungen werden von Amazon erzeugt. Amazon-Rechnungsnummern und Gutschriften werden in plentymarkets importiert. +
*Wichtig:* Wenn du diese Option aktivierst, können Amazon-Rechnungen *nicht mehr* manuell oder durch Ereignisaktionen erstellt werden.
|====
...
Du hast die Möglichkeit, deine eigenen in plentymarkets erstellten Rechnungsdokumente bei Amazon hochzuladen (Amazon Invoice Document Uploader - IDU), wenn du Amazon VCS nicht nutzt. Um eigene Rechnungen bei Amazon hochzuladen, erstelle eine Ereignisaktion im Menü *Einrichtung » Aufträge » Ereignisse*. +

Mit der Ereignisaktion können von plentymarkets erzeugte Rechnungen sowie Rechnungen, die mit einer externen Software erstellt wurden, bei Amazon hochgeladen werden. Rechnungen, die von plentymarkets erzeugt wurden, haben jedoch immer Vorrang vor externen Rechnungen, d.h. alle Rechnungsdokumente werden geprüft und plentymarkets Rechnungen werden zuerst hochgeladen, wenn vorhanden. Wenn es keine plentymarkets Rechnung gibt, wird die externe Rechnung zu Amazon hochgeladen.

[IMPORTANT]
.Amazon IDU und VCS nicht gleichzeitig nutzen
====
Wenn du Amazon IDU nutzt, darfst du <<Amazon VCS in plentymarkets aktivieren, Amazon VCS>> nicht verwenden, da Rechnungsdokumente ansonsten doppelt bei Amazon hochgeladen werden und dies durch eine Überlastung der Schnittstelle dazu führen kann, dass Rechnungen in der Seller Central fehlen.
====

[TIP]
.Versandbestätigung zuerst senden
====
Beachte, dass du die Rechnung erst bei Amazon hochladen kannst, wenn der Versand des Auftrags auf Amazon bestätigt wurde.
====
