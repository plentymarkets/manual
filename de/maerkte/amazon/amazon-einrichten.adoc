...
Wenn du in plentymarkets erstellte Rechnungen selbst bei Amazon hochladen möchtest, erstelle eine Ereignisaktion. Weitere Informationen dazu findest du im Kapitel <<Eigene Rechnungen bei Amazon hochladen, Eigene Rechnungen bei Amazon hochladen>>. +
*VCS plentymarkets* = *Voraussetzung:* <<Amazon VCS in plentymarkets aktivieren, Amazon VCS>> wird genutzt. Amazon-Rechnungen werden automatisch von plentymarkets erzeugt und zu Amazon übertragen. +
*VCS Amazon* = *Voraussetzung:* <<Amazon VCS in plentymarkets aktivieren, Amazon VCS>> wird genutzt. Amazon-Rechnungen werden von Amazon erzeugt. +
Amazon-Rechnungen und Gutschriften werden in plentymarkets importiert.
|====
...
[#6800]
== Rechnungserstellung für Amazon-Aufträge einrichten

Rechnungen für Amazon-Aufträge können in plentymarkets oder durch Amazon erstellt werden. In beiden Fällen kannst du den VCS-Service von Amazon nutzen. Amazon VCS (= VAT Calculation Service) ist ein Umsatzsteuerservice, bei dem Amazon die Umsatzsteuer berechnet. <<amazon-rechnungen>> zeigt die verschiedenen Möglichkeiten für das Erstellen von Rechnungen.

[[amazon-rechnungen]]
.Möglichkeiten für die Rechnungserstellung
[cols="1,3"]
|====
|Option |Erläuterung

|<<#3175, Amazon Invoice Document Uploader - IDU>>
|plentymarkets berechnet die Umsatzsteuer. Rechnungen werden von plentymarkets über eine Ereignisaktion erzeugt.
...
*_Wichtig:_* Amazon-Rechnungen können nicht mehr manuell oder durch Ereignisaktionen erstellt werden.
...
Wenn du Amazon VCS nicht nutzt, kannst du eigene in plentymarkets erstellte Rechnungsdokumente bei Amazon hochladen (Amazon Invoice Document Uploader - IDU).
...
[.indented]
* Prüfe zunächst einmal, ob du alle Einstellungen für das Hochladen von Amazon-Rechnungen korrekt vorgenommen hast. Weitere Informationen dazu findest du im Kapitel <<#6800, Rechnungserstellung für Amazon-Aufträge einrichten>>.
