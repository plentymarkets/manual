...
. Aktiviere die gewünschten Amazon-Plattformen.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
. Öffne das Menü *Einrichtung » Artikel » Verkaufspreise » Verkaufspreis öffnen » Tab: Einstellungen*.
. Aktiviere in der Zeile *Preistyp* die Einstellung *UVP*.
. Aktiviere die gewünschte Amazon-Herkunft.
. Aktiviere das gewünschte Amazon-Konto.
. Öffne das Tab *Sprache*.
. Gib in die Felder *Interner Name* und *Externer Name* die gewünschten Namen ein. +
...
. Öffne das Menü *Einrichtung » Artikel » Verkaufspreise » Verkaufspreis öffnen » Tab: Einstellungen*.
. Aktiviere in der Zeile *Preistyp* die Einstellung *Aktionspreis*.
. Aktiviere die gewünschte Amazon-Herkunft.
. Aktiviere das gewünschte Amazon-Konto.
. Öffne das Tab *Sprache*.
. Gib in die Felder *Interner Name* und *Externer Name* die gewünschten Namen ein. +
...
. Aktiviere bei den Aufträgen, die importiert werden sollen, die Einstellung *Importieren*.
...
. Wähle das Konto.
. Wechsele in das Tab *Auftragseinstellungen*.
. Aktiviere im Bereich *Amazon FBA* die Einstellung *Aktiv*.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
