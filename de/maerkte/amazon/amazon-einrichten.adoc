...
Beachten Sie dazu die Handbuchseiten *<<basics/automatisierung/ereignisaktionen#, Ereignisaktionen>>* sowie *<<fulfillment#, Standard-Fulfillment im Detail>>*.
====
...
Auf der Handbuchseite <<payment/amazon-pay#, Amazon Pay>> erhalten Sie wichtige Hinweise zur Integration des Zahlungsanbieters in plentymarkets.
