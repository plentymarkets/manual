...
*VCS plentymarkets* = Rechnungen für Amazon-Aufträge werden automatisch von plentymarkets erzeugt und zu Amazon übertragen. Die Umsatzsteuer wird von Amazon berechnet. Amazon nennt diese Option VCS Lite. Siehe <<#3150, VCS plentymarkets nutzen>>. +
...
*_Tipp_:* Amazon nennt diese Option VCS Lite.
*_Hinweis:_* In Amazon Seller Central muss VCS aktiviert sein. +
*_Wichtig:_* Rechnungen für Amazon-Aufträge können nicht mehr manuell oder über Ereignisaktionen erstellt werden.
|====
