...
*Wichtig:* Diese Option wählen, wenn Amazon VCS _nicht_ genutzt wird _oder_ wenn Amazon VCS genutzt wird und eigene Rechnungsdokumente zu Amazon hochgeladen werden sollen, ohne dass die Umsatzsteuer von Amazon berechnet wird. Ereignisaktion erstellen, um eigene Rechnungen automatisch bei Amazon hochzuladen.
