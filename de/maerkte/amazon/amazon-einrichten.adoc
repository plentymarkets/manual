...
Schau dir außerdem dieses Video an, um zu erfahren, welche Einstellungen du vornehmen musst, um die Schnittstelle zu Amazon in plentymarkets einzurichten:

.Schnittstelle zu Amazon einrichten
...
In diesem Video-Tutorial erhältst du außerdem weitere Informationen zu den verschiedenen Artikeleinstellungen:
...
Weitere Informationen zum Händlerversand findest du auch in diesem Video-Tutorial:
