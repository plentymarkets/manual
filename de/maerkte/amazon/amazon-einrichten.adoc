...
====
Aktivieren Sie Amazon VCS in der Amazon Seller Central, bevor Sie den Service in Ihrem plentymarkets System aktivieren.
====
...
====
Beachten Sie auch die <<maerkte/amazon/best-practices#vcs, Best Practice-Seite zum Thema VCS>>. Dort finden Sie weitere hilfreiche Informationen zur Einrichtung und des Amazon-Rechnungsservices VCS in plentymarkets.
====
...
|*VCS plentymarkets*
|*Voraussetzung:* Amazon VCS wird genutzt. Amazon-Rechnungen werden automatisch von plentymarkets erzeugt und zu Amazon übertragen. +
