...
. Wähle *Web-API*.
. Klicke auf *Hinzufügen* (icon:plus-square[role="darkGrey"]).
...
====
Wenn du deine Artikel für MFN und FBA verfügbar stellen möchtest, wähle, am Beispiel für Deutschland, die Amazon Länderplattform *Amazon Germany* und die Länderplattform *Amazon FBA Germany.*
====
...
. Öffne das Menü *Artikel » Artikel bearbeiten » Artikel öffnen » Tab: Varianten-ID » Tab: Einstellungen*.
. Wechsele in das Tab *Verfügbarkeit*.
. Klicke im Bereich *SKU* auf *Hinzufügen* (icon:plus-square[role="darkGrey"]). +
...
. Öffne das Menü *Artikel » Artikel bearbeiten » Artikel öffnen » Tab: Varianten-ID » Tab: Einstellungen*.
. Wechsele in das Tab *Verfügbarkeit*.
. Klicke im Bereich *Zusätzliche SKU* auf *Hinzufügen* (icon:plus-square[role="darkGrey"]). +
...
Die Kategorieverknüpfungen werden nur für Standard-Kategorien berücksichtigt, die im Menü <<artikel/artikel-verwalten#300, Artikel » Artikel bearbeiten » Artikel öffnen » Tab: Kategorien>> des Artikels gewählt wurden.
...
. Klicke auf *Ereignisaktion hinzufügen* (icon:plus-square[role="darkGrey"]). +
...
*Wichtig:* Diese Option wählen, wenn Amazon VCS _nicht_ genutzt wird und du mit einer Ereignisaktion <<Eigene Rechnungen bei Amazon hochladen, eigene Rechnungsdokumente bei Amazon hochladen>> möchtest (Amazon Invoice Document Uploader - IDU).
...
|*VCS Amazon*
|*Voraussetzung:* Amazon VCS wird genutzt. +
Amazon-Rechnungen werden von Amazon erzeugt. Amazon-Rechnungen und Gutschriften werden in plentymarkets importiert. +
*Wichtig:* Wenn du diese Option aktivierst, können Amazon-Rechnungen *nicht mehr* manuell oder durch Ereignisaktionen erstellt werden.
|====
...
Du hast die Möglichkeit, deine eigenen in plentymarkets erstellten Rechnungsdokumente bei Amazon hochzuladen (Amazon Invoice Document Uploader - IDU), wenn du Amazon VCS nicht nutzt. Um eigene Rechnungen bei Amazon hochzuladen, erstelle eine Ereignisaktion im Menü *System » Systemeinstellungen » Aufträge » Ereignisse*.
...
. Öffne den Artikel.
. Wechsele in das Tab *Multi-Channel*.
. Nimm die Einstellungen im Bereich *Amazon* vor. Beachte dazu die Erläuterungen in <<artikelverfügbarkeit-amazon>> im Kapitel <<maerkte/amazon/amazon-einrichten#700, Artikelverfügbarkeit einstellen>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
