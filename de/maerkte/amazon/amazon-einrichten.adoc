...
.  Öffnen Sie das Menü *System » Systemeinstellungen » Märkte » Amazon » Einstellungen*.
...
Wenn Sie mit einem europäischen Verkäuferkonto mehrere Amazon-Plattformen nutzen, richten Sie, je nachdem, welche Optionen sie nutzen möchten, für jede Plattform ein neues Konto mit plattformspezifischen Einstellungen in plentymarkets ein. Richten Sie einzelne Konten für den Preisabgleich, den Artikeldatenexport und den Import von ausstehenden Aufträgen ein. Wenn Sie beispielsweise nur den Bestandsabgleich nutzen möchten, legen Sie kein eigenes Konto für die unterschiedlichen Länderplattformen ein. +
Die Zugangsdaten sind für alle Plattformen gleich.

[TIP]
.Amazon-Plattformen
====
Mit plentymarkets können Sie auf den Amazon-Plattformen Amazon.de, Amazon.co.uk, Amazon.fr, Amazon.it, Amazon.es, Amazon.com, Amazon.ca und Amazon.com.mx verkaufen.
====
...
|*Amazon-Plattform*
| Eine Plattform muss direkt beim Anlegen gewählt werden und kann hier geändert werden. Wenn Sie ein europäisches Verkäuferkonto haben, können Sie für jede Plattform auf der Sie verkaufen möchten, eigene Einstellungen vornehmen. Weitere Informationen dazu finden Sie im Abschnitt <<Konto einrichten, Amazon-Plattform>>.
...
Im Tab *Prozessstatus* rufen Sie Informationen zu den Bestellberichten Ihrer MFN-Aufträge ab. Über die Schaltfläche *Zeitplan abrufen* werden das Intervall, in dem die Bestellberichte von Amazon generiert werden, und der Zeitpunkt des nächsten Abrufs von Ihrem plentymarkets Systems angezeigt.

[#660]
== Auftragsherkunft aktivieren

Damit Sie Artikel, Merkmale etc. mit Amazon-Plattformen verknüpfen können, muss im Menü *System » Systemeinstellungen » Aufträge » Auftragsherkunft* die Auftragsherkunft für die Amazon-Plattformen aktiviert werden.
...
Wenn Sie die Option *Amazon FBA* aktivieren, können für diesen Artikel FBA-Bestände in plentymarkets importiert werden und Amazon Multi-Channel-Aufträge, die mit FBA versendet werden, können angemeldet werden.
|====
...
Zusätzliche SKUs werden beim Amazon-Auftragsimport automatisch berücksichtigt. Den Bestands- und Preisabgleich für zusätzliche SKUs aktivieren Sie manuell im Menü *System » Systemeinstellungen » Märkte » Amazon » Einstellungen » Tab: Artikeleinstellungen*. +

Der Bestands- und Preisabgleich für zusätzliche SKUs läuft zusammen mit dem normalen Bestands- und Preisabgleich in dem Intervall, das sie unter *System » Systemeinstellungen » Märkte » Amazon » Einstellungen » Tab: Artikeleinstellungen* im Bereich *Automatismen* für die Optionen *Preisänderungen* und *Bestandabgleich* gewählt haben.

[.instruction]
Bestands- und Preisabgleich aktivieren:

. Öffnen Sie das Menü *System » Systemeinstellungen » Märkte » Amazon » Einstellungen » Tab: Artikeleinstellungen*.
...
Im Menü *System » Systemeinstellungen » Märkte » Amazon » ASIN-Verknüpfung* verknüpfen Sie ASIN mit Varianten. Die ASIN (= Amazon Standard Identification Number) ist eine eindeutige Produktkennzeichnung auf Amazon. Um unkompliziert und schnell Produkte zu verkaufen, die es auf Amazon bereits gibt, sollte an jeder Variante eine ASIN gespeichert sein. ASIN werden
...
. Öffnen Sie das Menü <<artikel/artikel-verwalten#480, System » Systemeinstellungen » Artikel » Merkmale » Tab: Neues Merkmal>>.
...
. Geben Sie einen *Namen* in der gewünschten Sprache im Bereich *Webshop* ein.
...
Nachdem Sie die Freitextfelder eingerichtet haben, verknüpfen Sie diese wie im Folgenden beschrieben mit den Exportfeldern bei Amazon Seller Central.

[.instruction]
Freitextfelder mit Amazon-Exportfeldern verknüpfen:

.  Öffnen Sie das Menü *System » Systemeinstellungen » Märkte » Amazon » Frei definierbare Felder*.
...
Die Kategorieverknüpfung führen Sie im Menü *System » Systemeinstellungen » Märkte » Amazon » Kategorieverknüpfung* durch. In plentymarkets können Sie jeder Artikelkategorie bis zu zwei Amazon-Klassifikationsnummern aus den Browse Tree Guides zuweisen.
...
.  Öffnen Sie das Menü *System » Systemeinstellungen » Märkte » Amazon » Kategorieverknüpfung* in Ihrem plentymarkets Backend.
...
Eigenschaften, die Sie im Menü <<artikel/artikel-verwalten#3100, System » Systemeinstellungen » Einstellungen » Eigenschaften » Konfiguration>> erstellt haben und zu einer Variante hinzugefügt haben, verknüpfen Sie im Menü *System » Systemeinstellungen » Einstellungen » Eigenschaften » Konfiguration » Tab: Amazon* mit Amazon.
...
.  Öffnen Sie das Menü *System » Systemeinstellungen » Märkte » Amazon » Datenaustausch » Datenexport*.
...
Im Menü *System » Systemeinstellungen » Märkte » Amazon » Datenaustausch » Auftragsimport* richten Sie den Import von Amazon-Aufträgen ein. Aufträge können sowohl automatisch über die XML-Schnittstelle als auch manuell über eine CSV-Datei importiert werden. Beide Varianten werden folgend beschrieben.
...
.  Öffnen Sie das Menü *System » Systemeinstellungen » Märkte » Amazon » Datenaustausch » Auftragsimport*.
...
.  Öffnen Sie das Menü *System » Systemeinstellungen » Märkte » Amazon » Datenaustausch » Versandbestätigung*.
...
Im Menü *System » Systemeinstellungen » Märkte » Amazon » Datenaustausch » Berichte » Tab: Geplante Berichte* bestimmen Sie, in welchem Zeitraum Bestellberichte von Amazon erstellt werden. Beim automatischen Auftragsimport werden Aufträge aus diesen Berichten importiert. Daher empfehlen wir sowohl für die Erstellung von Berichten als auch für den Auftragsimport ein möglichst niedriges Intervall zu setzen. +
...
Wenn Sie Amazon FBA unter *System » Systemeinstellungen » Märkte » Amazon » Einstellungen » Tab: Auftragseinstellugen* aktiviert haben, werden FBA-Bestellberichte automatisch alle 4 Stunden abgerufen. Unter *FBA orders* können Sie optional ein Intervall setzen, in dem Bestellberichte zusätzlich abgerufen werden sollen.

[.instruction]
Intervall festlegen:

.  Öffnen Sie das Menü *System » Systemeinstellungen » Märkte » Amazon » Datenaustausch » Berichte » Tab: Geplante Berichte*.
.  Wählen Sie ein Amazon-Konto aus der Dropdown-Liste.
...
Im Menü *System » Systemeinstellungen » Märkte » Amazon » Datenaustausch » Berichte » Tab: MFN Berichte* setzen Sie die Auftragsberichte von Amazon eines bestimmten Datums zurück.
...
.  Öffnen Sie das Menü *System » Systemeinstellungen » Märkte » Amazon » Datenaustausch » Berichte » Tab: MFN Berichte*.
.  Wählen Sie ein Amazon-Konto aus der Dropdown-Liste.
...
Im Menü *System » Systemeinstellungen » Märkte » Amazon » Datenaustausch » FBA-Warenbestand* haben Sie die Möglichkeit neben dem stündlichen automatischen Bestandsabgleich mit Amazon Ihren Bestand mit einer automatischen Aktion oder per CSV-Datei abzugleichen.
...
.  Öffnen Sie das Menü *System » Systemeinstellungen » Märkte » Amazon » Datenaustausch » FBA-Warenbestand*.
...
Legen Sie zunächst einen Auftragsstatus für Amazon-Retouren im Menü <<auftraege/auftraege-verwalten#1200, System » Systemeinstellungen » Aufträge » Status>> an, z.B. [9.6] Retoure an Amazon gesendet. Diesen Auftragsstatus benötigen Sie für die Amazon-Einstellungen.
...
Richten Sie eine <<automatisierung/ereignisaktionen#, Ereignisaktion>> ein, um Retouren in Form von Gutschriften automatisch an Amazon zu senden.
...
.  Nehmen Sie die weiteren Einstellungen gemäß <<ereignisaktion-automatische-retoure>> vor.
...
. *Speichern* Sie die Einstellungen. +
→ Das Ereignis wird erstellt.
.  Nehmen Sie die weiteren Einstellungen gemäß <<ereignisaktion-auftragsstatus-aktualisieren>> vor.
.  Setzen Sie ein Häkchen bei *Aktiv*.
. *Speichern* Sie die Einstellungen. +
→ Die Ereignisaktion wird gespeichert.
--
...
====
Aktivieren Sie Amazon VCS zuerst in der Amazon Seller Central, bevor Sie den Service in Ihrem plentymarkets System aktivieren.
====

Amazon VCS (= VAT Calculation Service) ist ein von Amazon angebotener Umsatzsteuerservice, mit dem Amazon die Umsatzsteuer berechnet. Sie entscheiden, ob die Amazon-Rechnungen von Amazon oder plentymarkets erzeugt werden sollen. Wenn Sie Amazon-Rechnungen von plentymarkets erstellen lassen, werden die Rechnungen automatisch zu Amazon übertragen. Aktivieren Sie Amazon VCS im Menü *System » Systemeinstellungen » Märkte » Amazon » Amazon-Konto wählen » Tab: Einstellungen* im Bereich *Basiseinstellungen* in plentymarkets.

[IMPORTANT]
.Rechnungserstellung nicht mehr anders möglich
====
Beachten Sie unbedingt, dass Amazon-Rechnungen nicht mehr anders erstellt werden können (d.h. nicht manuell oder durch eine Ereignisaktion), sobald Sie die Optionen *VCS plentymarkets* oder *VCS Amazon* aktivieren.
====

[TIP]
.Best Practice zum Thema Amazon VCS
====
Beachten Sie auch die <<maerkte/amazon/best-practices-amazon-vcs#, Best Practice-Seite zum Thema VCS>>. Dort finden Sie weitere hilfreiche Informationen zur Einrichtung des Amazon-Rechnungsservices VCS in plentymarkets.
====

[.instruction]
Rechnungsservice Amazon VCS in plentymarkets aktivieren:

1. Öffnen Sie das Menü *System » Systemeinstellungen » Märkte » Amazon » Amazon-Konto wählen » Tab: Einstellungen*. +
→ *Wichtig:* Sie müssen den Rechnungsservice zuerst bei Amazon in der Seller Central aktivieren, bevor Sie die Einstellungen in plentymarkets vornehmen.
2. Wählen Sie eine Option für die Einstellung *Rechnung erzeugen*. Beachten Sie dazu die Erläuterungen in <<amazon-vcs>>.
...
*Wichtig:* Wenn Sie diese Option aktivieren, können Amazon-Rechnungen *nicht mehr* manuell oder durch Ereignisaktionen erstellt werden.
...
. Wechseln Sie in das Tab *Auftragseinstellungen*.
. Setzen Sie im Bereich *Amazon FBA* ein Häkchen bei *Aktiv*.
. *Speichern* Sie die Einstellungen.
...
====
Legen Sie die für den Fulfillment-Prozess nötigen Ereignisaktionen an, um eine Rechnung zu erzeugen und per E-Mail automatisch an den Käufer zu senden sowie den Auftrag dann in einen weiteren Status zu setzen. +
Beachten Sie dazu die Handbuchseiten *<<automatisierung/ereignisaktionen#, Ereignisaktionen>>* sowie *<<fulfillment#, Standard-Fulfillment im Detail>>*.
====
...
Amazon erweitert kontinuierlich das europäische Versandnetzwerk für Händler, die Versand durch Amazon nutzen. Eine Voraussetzung ist, dass Sie in allen Ländern, in denen Sie FBA-Logistikzentren nutzen steuerrechtlich registriert sind. Damit für diese neuen Logistikzentren Ihre Rechnungen auch steuerlich korrekt erstellt werden, können Sie neben Ihrem Firmensitz jetzt auch im Menü *System » Systemeinstellungen » Mandant » Mandant wählen » Standorte » Standort wählen » Buchhaltung* den Lagerstandort als Basis für den Standard-Umsatzsteuersatz wählen und das individuell für jeden Ihrer Mandanten (Shops). Im gleichen Menü im Tab *Umsatzsteuersätze* erfassen Sie auch die notwendigen Steuersätze für die Länder.

[TIP]
.Beispiel: Logistikzentrum in Polen mit Versand nach Deutschland
====
Damit für Aufträge, die von einem Logistikzentrum in Polen nach Deutschland verschickt werden, nicht der polnische Steuersatz verwendet wird, muss für den Standort Polen zusätzlich das Land Deutschland mit dem deutschen Steuersatz eingetragen werden. Wählen Sie dafür im Menü *System » Systemeinstellungen » Mandant » Mandant wählen » Standorte » Polen » Buchhaltung » Tab: Umsatzsteuersätze* das Land *Deutschland* und tragen Sie den deutschen Steuersatz sowie die gültige USt-IdNr. ein.
====

[#3600]
===  FBA-Retouren automatisch importieren

Im Retourenfall sendet der Käufer die Ware zurück an Amazon. Die Retoure wird in Ihr plentymarkets System importiert und mit dem Retourenstatus, den Sie im Menü <<auftraege/grundeinstellungen#200, System » Systemeinstellungen » Aufträge » Einstellungen>> gewählt haben, im Auftragsmenü angelegt.
...
Die folgenden Schritte sind nötig, um Ihre Bestandsverwaltung und Artikeldaten für Amazon Multi-Channel einzurichten.
...
.  Öffnen Sie den Artikel.
.  Wechseln Sie in das Tab *Multi-Channel*.
.  Nehmen Sie die Einstellungen im Bereich *Amazon* vor. Beachten Sie dazu die Erläuterungen in Tabelle 5 im Kapitel <<maerkte/amazon/amazon-einrichten#700, Artikelverfügbarkeit einstellen>>.
. *Speichern* Sie die Einstellungen.
...
Richten Sie eine <<automatisierung/ereignisaktionen#, Ereignisaktion>> ein, damit Amazon automatisch eine Meldung über den Auftrag erhält und den Auftrag bearbeiten sowie den Versand veranlassen kann.
...
. *Speichern* Sie die Einstellungen. +
→ Das Ereignis wird erstellt.
.  Nehmen Sie die weiteren Einstellungen gemäß <<ereignisaktion-fba-versandfreigabe>> vor.
.  Setzen Sie ein Häkchen bei *Aktiv*.
. *Speichern* Sie die Einstellungen. +
→ Die Ereignisaktion wird gespeichert.
--
...
Im Menü <<auftraege/auftraege-verwalten#, Aufträge » Aufträge bearbeiten>> werden alle Ihre Aufträge angezeigt. Diese Aufträge können Sie über <<auftraege/auftraege-verwalten#1300, Filter>> eingrenzen und sich z.B. nur Amazon Prime-Aufträge anzeigen lassen.
...
Aktivieren Sie die <<payment/zahlungsarten-verwalten#, Zahlungsart>> *Amazon*, wie im Folgenden beschrieben.
...
Weitere Informationen finden Sie auf der Handbuchseite <<payment/zahlungsarten-verwalten#30, Zahlungsart in Kundenklasse erlauben>>.
====
...
Mit Amazon Business verkaufen Sie Ihre Artikel an gewerbliche Kunden. Bevor Sie Einstellungen in plentymarkets vornehmen, link:https://services.amazon.de/programme/b2b-verkaufen/merkmale-und-vorteile.html[registrieren^] Sie sich bei Amazon für das Verkäuferprogramm. Damit Ihre Artikel als B2B-Artikel an Amazon Business übermittelt werden, muss Amazon Business für das Amazon-Konto freigeschaltet werden. Sie können einen Standard-Verkaufspreis für Amazon Business erstellen und bis zu 5 weitere Verkaufspreise erstellen, wenn Sie Mengenrabatte für Amazon Business anbieten wollen. Nehmen Sie die im Folgenden beschriebenen Einstellungen vor, um Artikel an Amazon Business zu übermitteln.
...
Im Menü *System » Systemeinstellungen » Märkte » Amazon » Einstellungen* aktivieren Sie das Amazon-Konto für Amazon Business.

[.instruction]
Amazon-Konto für Amazon Business aktivieren:

.  Öffnen Sie das Menü *System » Systemeinstellungen » Märkte » Amazon » Einstellungen » Konto öffnen » Tab: Einstellungen*.
...
Nachdem das Amazon-Konto für Amazon Business freigeschaltet wurde, haben Sie die Möglichkeit, Verkaufspreise für B2B-Artikel zu erstellen und zu verknüpfen. Sie können neben dem Standardpreis für Artikel ab Menge 1 bis zu 5 weitere Preise für Mengenrabatte anlegen. Dabei können Preise für Mengenrabatt als Festpreis oder prozentual angelegt werden. +

Wenn Sie keinen separaten Verkaufspreis für Amazon Business erstellen, wird der Standard-Verkaufspreis für Amazon übertragen, sofern Amazon Business an diesem Preis aktiviert wurde.

[#4565]
==== Verkaufspreis anlegen

Legen Sie zunächst einen Standardpreis für B2B-Artikel an. Dabei müssen im Menü *System » Systemeinstellungen » Artikel » Verkaufspreise* die Option *Ab Menge*, die *Herkunft* und das *Amazon-Konto* eingestellt werden.
...
Gehen Sie wie im Folgenden beschrieben vor, um Amazon Business-Kunden Mengenrabatte anzubieten.
...
Auf der Handbuchseite <<payment/zahlungsanbieter/amazon-pay#, Amazon Pay>> erhalten Sie wichtige Hinweise zur Integration des Zahlungsanbieters in plentymarkets.
...
[.indented]
* *Verkaufspreis* aktivieren: Achten Sie darauf, dass der Verkaufspreis des Artikels im Menü *System » Systemeinstellungen » Artikel » Verkaufspreise* für das Amazon-Konto und die Amazon-Herkunft aktiviert ist.
