...
====
Die Rechnungen, die plentymarkets für Amazon-Aufträge generiert, enthalten nur den Betrag, den Amazon Endkund:innen in Rechnung gestellt hat. Technisch kann man nicht unterscheiden werden, welche Rabatte von Amazon und welche Rabatte von Händler:innen gewährleistet werden.
====
