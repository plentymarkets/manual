...
*Hinweis:* Auch wenn du beispielsweise nur 20.000 Varianten für Amazon hast, kann es sein, dass mehr als 5.000 Datensätze in einer Exportdatei enthalten sind, da auch die Parents der Varianten in der Exportdatei erscheinen.
