...
* <<#500, Mit dem Assistenten Grundeinstellungen - Amazon>>
* <<#660, Im Einrichtungsmenü>>
...
[#550]
=== Amazon im Einrichtungsmenü einrichten
...
Es gibt zwei Möglichkeiten, den Warenbestand für ausstehende Aufträge in plentymarkets zu reservieren. Entweder mit einer Ereignisaktion oder direkt in den Auftragsgrundeinstellungen.
