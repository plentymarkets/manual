...
Im Menü *System » Systemeinstellungen » Märkte » Amazon » ASIN-Verknüpfung* verknüpfen Sie ASIN mit Varianten. Wenn die ASIN am Artikel angegeben ist, können Artikel schneller und einfacher auf Amazon verkauft werden.
