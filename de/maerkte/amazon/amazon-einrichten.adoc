...
→ *Hinweis:* Die zweite Spalte für *Marktplatz-Attributwerte* wird momentan nur für die Kategorie *Size* in der Flatfile *Shoes* verwendet. Beim Export dieser Flatfile wird die Spalte *footwear_size* mit dem in der zweiten Spalte eingegebenem Wert befüllt.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
