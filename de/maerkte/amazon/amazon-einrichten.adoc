...
. Wähle für die Option *Rechnung erzeugen* die Einstellung *plentymarkets*.
. *Speichere* (icon:save[role="green"]) die Einstellungen. +
...
. Öffne das Menü *Einrichtung » Märkte » Amazon » Amazon-Konto wählen » Tab: Einstellungen*.
. Wähle für die Option *Rechnung erzeugen* die Einstellung *VCS plentymarkets*. +
...
. Öffne das Menü *Einrichtung » Märkte » Amazon » Amazon-Konto wählen » Tab: Einstellungen*.
. Wähle für die Option *Rechnung erzeugen* die Einstellung *VCS Amazon*. +
