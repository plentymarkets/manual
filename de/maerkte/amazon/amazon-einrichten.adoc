...
Wenn Amazon VCS genutzt wird, eigene Rechnungen mit einer Ereignisaktion zu Amazon hochladen.
...
*Wichtig:* Diese Option wählen, wenn Amazon VCS _nicht_ genutzt wird _oder_ wenn Amazon VCS genutzt wird und eigene Rechnungsdokumente zu Amazon hochgeladen werden sollen (Amazon Invoice Document Uploader - IDU), ohne dass die Umsatzsteuer von Amazon berechnet wird. Ereignisaktion erstellen, um eigene Rechnungen automatisch bei Amazon hochzuladen.
...
[.subhead]
Eigene Rechnungen bei Amazon hochladen ohne Umsatzsteuerberechnung

Du hast die Möglichkeit, deine eigenen in plentymarkets erstellten Rechnungsdokumente bei Amazon hochzuladen, ohne dass Amazon die Umsatzsteuer berechnet. Dadurch kann vermieden werden, dass sich die Umsatzsteuerberechnungen von Amazon und plentymarkets unterscheiden. Um eigene Rechnungen ohne Umsatzsteuerberechnung bei Amazon hochzuladen, erstellst du eine Ereignisaktion im Menü *System » Systemeinstellungen » Aufträge » Ereignisse*.
