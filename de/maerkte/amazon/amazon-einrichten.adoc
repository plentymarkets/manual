...
ASINs werden im Menü *Einrichtung » Märkte » Amazon » ASIN-Verknüpfung* mit Varianten verknüpft.
...
Nutze die Gruppenfunktion im Menü *Einrichtung » Märkte » Amazon » ASIN-Verknüpfung*, um mehrere ASINs auf einmal mit Varianten zu verknüpfen.
...
Eigenschaften, die du im Menü <<artikel/artikel-verwalten#3100, Einrichtung » Einstellungen » Eigenschaften » Konfiguration>> erstellt hast und zu einer Variante hinzugefügt haben, verknüpfst du im Menü *Einrichtung » Einstellungen » Eigenschaften » Konfiguration » Tab: Amazon* mit Amazon.
...
Das Merkmal eines Artikels wird im Menü <<artikel/artikel-verwalten#480, Einrichtung » Artikel » Merkmale>> mit dem Amazon-Produkttyp verknüpft. In plentymarkets können maximal 16 Verknüpfungen pro Merkmal gespeichert werden.
...
Im Retourenfall sendet der Käufer die Ware zurück an Amazon. Die Retoure wird in dein plentymarkets System importiert und mit dem Retourenstatus, den du im Menü <<auftraege/grundeinstellungen#200, Einrichtung » Aufträge » Einstellungen>> gewählt hast, im Auftragsmenü angelegt.
