...
*VCS plentymarkets* = *Voraussetzung:* Amazon VCS wird genutzt. Amazon-Rechnungen werden von plentymarkets erzeugt und automatisch zu Amazon übertragen. +
...
Legen Sie zunächst einen Auftragsstatus für Amazon-Retouren im Menü <<auftraege/auftraege-verwalten#1200, System » Aufträge » Status>> an, z.B. [9.6] Retoure an Amazon gesendet. Diesen Auftragsstatus benötigen Sie für die Amazon-Einstellungen.
...
[IMPORTANT]
.Amazon VCS nur nach Aktivierung eines Moduls in plentymarkets nutzbar
====
Die folgende Anleitung ist nur gültig, wenn Sie Amazon VCS in der Amazon Seller Central aktiviert haben und wenn plentymarktes das Modul in Ihrem plentymarkets System aktiviert hat.
====

Amazon VCS (= VAT Calculation Service) ist ein von Amazon angebotener Umsatzsteuerservice, mit dem Amazon die Umsatzsteuer berechnet. Sie entscheiden, ob die Amazon-Rechnungen von Amazon oder plentymarkets erzeugt werden sollen. +

Der Umsatzsteuerservice ist derzeit nur für ausgewählte Händler verfügbar. Diese Händler werden von Amazon kontaktiert. Nachdem Sie für Amazon VCS ausgewählt wurden, muss durch plentymarkets ein Modul in Ihrem plentymarkets System freigeschaltet werden. Kontaktieren Sie plentymarkets im link:https://forum.plentymarkets.com/c/multi-channel/amazon[Forum^], damit Amazon VCS für Sie freigeschaltet wird. +

Wenn Sie Amazon VCS in plentymarkets aktivieren, können Sie wählen, ob Amazon-Rechnungen durch Amazon oder durch plentymarkets erstellt werden sollen. Wenn Sie Amazon-Rechnungen von plentymarkets erstellen lassen, werden die Rechnungen automatisch zu Amazon übertragen. Aktivieren Sie Amazon VCS im Menü *System » Märkte » Amazon » Amazon-Konto wählen » Tab: Einstellungen* im Bereich *Basiseinstellungen* in plentymarkets.

[.instruction]
Amazon VCS aktivieren:

1. Öffnen Sie das Menü *System » Märkte » Amazon » Amazon-Konto wählen » Tab: Einstellungen*.
...
|*VCS plentymarkets*
|*Voraussetzung:* Amazon VCS wird genutzt. Amazon-Rechnungen werden von plentymarkets erzeugt und automatisch zu Amazon übertragen.

|*VCS Amazon*
|*Voraussetzung:* Amazon VCS wird genutzt. Amazon-Rechnungen werden von Amazon erzeugt.
|====
...
Im Retourenfall sendet der Käufer die Ware zurück an Amazon. Die Retoure wird in Ihr plentymarkets System importiert und mit dem Retourenstatus, den Sie im Menü <<auftraege/grundeinstellungen#200, System » Aufträge » Einstellungen>> gewählt haben, im Auftragsmenü angelegt.
