...
*VCS plentymarkets* = Rechnungen für Amazon-Aufträge werden automatisch von plentymarkets erzeugt und zu Amazon übertragen. Die Umsatzsteuer wird von Amazon berechnet. Siehe <<#3150, VCS plentymarkets nutzen>>. +
...
Wenn du dich für VCS plentymarkets entscheidest, berechnet Amazon die Umsatzsteuer, aber Rechnungen für Amazon-Aufträge werden von plentymarkets erstellt und automatisch zu Amazon übertragen.
