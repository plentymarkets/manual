...
[.indented]
* *Verkaufspreis* aktivieren: Achte darauf, dass der Verkaufspreis des Artikels im Menü *Einrichtung » Artikel » Verkaufspreise* für das Amazon-Konto und die Amazon-Herkunft aktiviert ist.
