...
| *Lagerauswahl*
a|Nach welcher Logik sollen den Zalando-Aufträgen Lager zugewiesen werden? +
...
| *Sprache*
| Die <<daten/interne-IDs#10, Sprache>> des Merkmals. Bisher ist nur die deutsche Sprache verfügbar.
|====
