...
:keywords: Zalando, zalando.de, salando, zalando.com
...
| *Möchtest du Bestand zu Zalando exportieren?*
| *Bestandsexport aktivieren* = Option aktivieren, um alle 10 Minuten deinen Bestand zu Zalando zu exportieren.

| *In welche Schnittstellenumgebung soll der Bestand exportiert werden?*
a| Wählen, ob echte Daten oder Testdaten exportiert werden sollen.

* *Sandbox* = Testdaten werden an Zalando exportiert.
* *Productive* = Echte Bestandsdaten werden an Zalando exportiert.

| *Aus welchen Lagern soll der Bestand exportiert werden?*
a| Einen oder mehrere Lager wählen. Die Summe des Nettobestands dieser Lager wird exportiert.
