...
*_Hinweis:_* Wenn keine Gruppen angezeigt werden, hast du möglicherweise Zalando noch keine FTP-Zugangsdaten zukommen lassen. Weitere Informationen findest du im Kapitel <<#150, Ablauf nach der Registrierung>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen. +
