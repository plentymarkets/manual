...
| *Aus welchen Lagern sollen Bestandsdaten exportiert werden?*
a| Einen oder mehrere Lager wählen. Die Summe des Nettobestands dieser Lager wird exportiert. +
*_Hinweis:_* Im Menü *Einrichtung » Märkte » Zalando » Einstellungen* kannst du einen Bestandspuffer festlegen. Die Summe des Nettobestands dieser Lager wird dann um die dort eingegebenen Stückzahl reduziert.
