...
Die Anbindung des Marktplatzes stellt die in <<#datenaustausch-zalando>> gelisteten automatisierten Funktionen bereit.

[[datenaustausch-zalando]]
[cols="1,1"]
|====
|Daten |Intervall
...
NOTE: Pro Attribut kann nur ein Größenregister und ein Längenregister verknüpft werden.
