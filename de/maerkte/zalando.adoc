...
| Artikelexport
| plentymarkets generiert die Artikeldaten einmal täglich nachts als XML. Zalando ruft die XML meist einmal pro Tag ab.

| Bestandsabgleich
| Zalando ruft die Bestandsdaten alle 10 Minuten ab.

| Preisabgleich
| Alle 15 Minuten über API

| Auftragsimport
| Alle 5 Minuten über zDirect (API)
|====
...
Du hast einen Vertrag mit Zalando abgeschlossen. Wie geht es jetzt weiter?

* Melde dich in der Kategorie Multi-Channel des plentymarkets Forums.
* Dort erhältst du ein Formular im CSV-Format. Dieses Formular enthält die folgenden Informationen:
  ** REST-Routen für Artikel und Bestände
  ** deinen Benutzernamen und Kennwort
  ** Zugangsdaten zum plentymarkets FTP-Server für Silhouetten +
  *_Tipp:_* Auf diesen FTP-Server sendet Zalando deine Silhouetten, damit wir sie in dein System importieren können.
...
* Length register bei Längenangaben (z.B. Hosenlänge)
...
| Wird aus der SKU genommen. Aktuell können nur reine Zahlen verarbeitet werden. Zeichenketten mit Buchstaben sind nicht erlaubt.

| partnerArticleSimpleId
|
|====
