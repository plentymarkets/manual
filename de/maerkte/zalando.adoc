...
*_Tipp:_* Im Menü *Einrichtung » Märkte » Zalando » Einstellungen* kannst du einen Bestandspuffer festlegen. Die Summe des Nettobestands dieser Vertriebslager wird dann um die dort eingegebenen Stückzahl reduziert.
