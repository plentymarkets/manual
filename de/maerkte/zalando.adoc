...
Nachdem Zalando dich in das Partnerprogramm aufgenommen hat, stellt dir Zalando ein Handbuch und Hilfestellung beim Einrichten der Schnittstelle zur Verfügung. In plentymarkets nimmst du die folgenden Grundeinstellungen vor.
...
| *Artikelname*
| *Name 1*, *Name 2* oder *Name 3* wählen. Dieser Name wird zu Zalando exportiert.
...
* *Übertrage die Bestandsmenge des Vertriebslagers mit dem aktuell größten Bestand* = Das Vertriebslager mit dem aktuell größtem Bestand des Artikels als Lager wählen. +
...
* *Retoure*: Es wurde eine Retoure in plentymarkets erstellt.
...
[.instruction]
Kontoeinstellungen mit dem Assistenten vornehmen:
...
--
[[table-zalando-account-settings-assistant]]
[width="100%"]
[cols="1,2"]
|======
|Einstellung |Erläuterung

2+| Schritt *Artikelstatusbericht*

| *Sollen für deine Artikel auf Zalando Statusberichte generiert werden?*
a| Wenn du die Option *Artikelstatusberichte generieren* aktivierst, stehen im Menü *Einrichtung » Märkte » Zalando » Einstellungen » Tab: Verarbeitungsberichte* die folgenden Artikelstatusberichte im CSV-Format zur Verfügung:
