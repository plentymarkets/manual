...
a| Die Artikelstatusberichte werden von Zalando generiert. Diese Berichte enthalten deshalb nur Informationen zu Varianten, die erfolgreich zu Zalando exportiert wurden.
...
| *Preis-Berichte*
a| Die Preis-Berichte werden von Zalando generiert. Zalando generiert einen Preis-Bericht pro aktiven Channel. Die Berichte enthalten einen Eintrag für jede Preisaktualisierung, die in den letzten 7 Tagen an Zalando gesendet wurde. Berichte können also mehrere Einträge für dieselbe EAN enthalten.




<<#910, So rufst du Preis-Berichte ab>>
|====
