...
Du möchtest am link:https://www.zalando.de/partner-programm/[Partnerprogramm von Zalando^]{nbsp}icon:external-link[] teilnehmen? Dann wende dich zunächst direkt an Zalando.
...
[.collapseBox]
.Schritt: *Auftragsimport*
--

[[assistant-zalando-order-import]]
.Einstellungen des Schritts *Auftragsimport*
[cols="1,3"]
|====
|Einstellung |Erläuterung
