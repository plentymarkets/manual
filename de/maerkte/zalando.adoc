...
Die exportierten Zalando-Merkmale können Sie mittels <<basics/datenaustausch/export-import/datenformate/_itemproperties#, Datenformat>> über den *dynamischen Import* mit den Artikeln in Ihrem plentymarkets System verknüpfen.
...
Aktivieren Sie die <<auftragsabwicklung/payment/zahlungsarten-verwalten#, Zahlungsart>> *Zalando Payment*, wie im Folgenden beschrieben.
