...
|Reservierungen werden standardmäßig mit Status *[3] Warten auf Zahlung* importiert und müssen nach der Stornierung durch Käufer:innen oder durch Zalando in einen anderen Status *[8.X]* verschoben werden. In diesem Schritt entscheidest du, in welchen Status stornierte Reservierungen verschoben werden sollen. +
