...
*_Häufige Fehler und Warnungen:_*

* specialDescriptions = Technische Daten
* lengthRegister = Längen-Register (Merkmale)
* Keywords = Meta-Keywords (Artikel-Tab: Texte)
* size / length = Größe und Länge (Merkmal) oder innerhalb der Attributsverknüpfungen für Zalando bei Variantenartikeln
...
* material = Material
* season = Jahreszeit
* silhouette = Kategorie (Bekleidung, Schuhe etc.)
* sizeGrid = Größe
