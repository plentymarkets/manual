...
| *Preis-Berichte*
a| Zalando generiert einmal täglich über Nacht einen Preis-Bericht pro aktiven Channel. Diese Berichte enthalten Informationen zum Verarbeitungsstatus aller Preis-Updates, die in den letzten sieben Tagen bei Zalando eingegangen sind. Die Berichte können also mehrere Einträge für dieselbe EAN enthalten.

[.instruction]
Preis-Berichte abrufen:
