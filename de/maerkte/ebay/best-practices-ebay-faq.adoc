...
:keywords: eBay, Fragen, FAQ, eBay Hilfe, eBay FAQ, eBay Verkaufspreis, eBay Plus Auftrag, eBay Fehler, eBay Fehlercodes, eBay internationaler Verkauf
:position: 40
...
Überprüfe das im Menü *Einrichtung » Märkte » eBay » Konten*.
...
Im Bereich *Einrichtung » Listings » Kaufabwicklung* kann man nun die Option *Offene eBay-Aufträge automatisch zusammenfassen* finden. +
