...
Benutzer:innen mit *Backend*-Zugang benötigen die in <<#plugin-ebay-marketing-rights>> gezeigten Rechte.

[[plugin-ebay-marketing-rights]]
[cols="1,3"]
|====
| Menü-Sichtbarkeiten
...
. Aktiviere in den Bereichen *Autorisierung* und *Menü-Sichtbarkeiten* die in <<#plugin-ebay-marketing-rights>> aufgelisteten Rechte.
. *Speichere* die Einstellungen.
