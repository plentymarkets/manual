...
Benutzer:innen mit *Backend*-Zugang benötigen die in <<#table-ebay-marketing-rights>> gezeigten Rechte.
...
. Aktiviere in den Bereichen *Autorisierung* und *Menü-Sichtbarkeiten* die in <<#table-ebay-marketing-rights>> aufgelisteten Rechte.
. *Speichere* die Einstellungen.
