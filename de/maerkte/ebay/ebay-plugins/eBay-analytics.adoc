...
| *Klickrate*
| Gibt an, wie oft ein Käufer eine Impression gesehen und sich dann bis zur Listing-Seite durchgeklickt hat.

| *Impressions auf der eBay-Suchergebnisseite*
| Gibt an, wie oft ein Listing in der Suchergebnisseite angezeigt wurde. Jenachdem wie das Listing auf der Suchergebnisseite positioniert wurde, ist es vom Käufer eventuell nicht gesehen worden.

| *Impressions im eBay-Shop*
| Gibt an, wie oft das Listing im eBay-Shop angezeigt wurde. Jenach dem wie das Listing auf der Suchergebnisseite positioniert wurde, ist es vom Käufer eventuell nicht gesehen worden.

| *Gesamtanzahl der Impressions*
| Gibt an, wie oft das Listing auf der Suchergebnisseite oder im eBay-Shop angezeigt wurde. Wenn das Listing auf beiden Seiten angezeigt wurde, zählt es zweimal. Jenach dem wie das Listing auf der Suchergebnisseite positioniert wurde, ist es vom Käufer eventuell nicht gesehen worden.

| *Direkte Aufrufe*
| Die Anzahl der direkten Listing-Aufrufe, z.B. über ein Lesezeichen.

| *Externe Aufrufe*
| Die Anzahl der Listing-Aufrufe über eine externe Seite, z.B. über einen Link aus der Suchergebnisseite bei Google.
...
| *Startdatum*
| Startdatum eingeben. Das Startdatum muss vor dem Enddatum liegen. Zeitintervall ist max. 30 Tag.
...
Damit Benutzer:innen mit dem Zugang *Backend* das *eBay Analytics-Plugin* nutzen können, sind Rechte für Menü-Sichtbarkeiten und REST-API erforderlich.

Benutzer:innen mit *Backend*-Zugang benötigen die in <<#plugin-ebay-analytics-rights>> gezeigten Rechte.

[[plugin-ebay-analytics-rights]]
[cols="1,2"]
|====
| Menü-Sichtbarkeiten
a| | *Listings* und alle untergeordneten Berechtigungen

| REST-API-Rechte
a| * Listing » *Market-Listing* und alle untergeordneten Berechtigungen
* Listing » Versandprofil » *Listing anzeigen*
* Listing » *Listing aktualisieren*
...
. Aktiviere in den Bereichen *Autorisierung* und *Menü-Sichtbarkeiten* die in <<#plugin-ebay-analytics-rights>> aufgelisteten Rechte.
