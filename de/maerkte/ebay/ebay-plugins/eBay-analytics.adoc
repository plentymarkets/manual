...
Benutzer:innen mit *Backend*-Zugang benötigen die in <<#table-ebay-analytics-rights>> gezeigten Rechte.

[[table-ebay-analytics-rights]]
.Rechte für eBay Analytics
[cols="1,2a"]
|====
|Bereich |Rechte
...
. Aktiviere in den Bereichen *Autorisierung* und *Menü-Sichtbarkeiten* die in <<#table-ebay-analytics-rights>> aufgelisteten Rechte.
