...
1. Öffne das Menü *Plugins » Plugin-Übersicht » eBay NBA-Plugin öffnen*.
...
→ Im oberen Bereich des Fensters erhältst du eine Übersicht über die verschiedenen Aktionen, die in dieser Kategorie ausgeführt werden können, um Listings zu optimieren und eine Übersicht über die Anzahl der betroffenen Listings. Weitere Informationen dazu findest du in <<#table-ebay-nba-recommedations>>.

[[table-ebay-nba-recommedations]]
