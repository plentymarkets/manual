...
4. Wähle ein Ereignis aus der Dropdown-Liste, z.B. *Neue Nachricht vom Mitarbeiter*.
...
1. Öffne das Menü *Einrichtung » Einstellungen » Benutzer » Konten*.
2. Klicke auf den *Benutzer*, dem du Berechtigungen zuweisen möchtest.
3. Wechsele zu *Tab: Berechtigung » Tab: Menü*.
4. Aktiviere die benötigten Berechtigungen:
