...
Verkaufsplaner fügt eigentlich nur dann ein Listing zu den zukünftigen Listings hinzu, wenn es dort noch keinen Eintrag für die MLID gibt und wenn es kein aktives oder ausgeblendetes Listing zu dieser MLID gibt.
