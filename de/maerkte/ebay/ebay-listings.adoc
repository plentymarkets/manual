...
| *Fehlermeldung anzeigen, wenn bereits ein Listing existiert* (Standardeinstellung) = Du erhältst eine Fehlermeldung, wenn du ein Listing für einen Artikel erstellst, für den bereits ein Listing vorhanden ist.
...
| Wählen, welcher Artikelname als Listing-Titel exportiert werden soll. + Mögliche Optionen:

* *Name 1*
* *Name 2*
* *Name 3*

Die Artikelnamen werden im Tab <<artikel/artikel-verwalten#50, Texte>> des Artikels eingegeben. Wenn für einen Artikel für die gewählte Spalte kein Name gespeichert ist, kommt es zu der Fehlermeldung *No description found for itemId: 509*.
|====
