...
* Ein Attribut, durch das das Aussehen von Varianten verändert wird

_oder_

* Eine Eigenschaft, durch die das Aussehen von Varianten verändert wird

[.collapseBox]
.*_Beispiel:_* Farbinformationen für Produkttyp "Fashion" zuordnen
--
