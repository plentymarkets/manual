...
*_Zur Erinnerung:_* Wenn die Varianten eines Artikels unterschiedliche Bilder haben, weil sie sich optisch unterscheiden, wird eine REWE Produktgruppe benötigt. Produktgruppenattribute sind also Attribute, die das Aussehen des Produkts beeinflussen.

Du ordnest dem Marktplatz-Datenfeld *Attribute für Produktgruppen* also folgendes plentymarkets Datenfeld zu:

* Ein Attribut, durch das das Aussehen der Varianten verändert wird

_oder_

* Eine Eigenschaft, durch die das Aussehen der Varianten verändert wird
