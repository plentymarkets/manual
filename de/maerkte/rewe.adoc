...
| Wie <<#1000, oben beschrieben>> unterscheidet REWE zwischen Produktgruppen und Variantengruppen. Zur Erinnerung: Wenn die Varianten eines Artikels unterschiedliche Bilder haben, weil sie sich optisch unterscheiden, wird eine REWE Produktgruppe benötigt. Produktgruppenattribute sind also Attribute, die das Aussehen des Produkts beeinflussen.

Du ordnest also das folgende plentymarkets Datenfeld zu:
