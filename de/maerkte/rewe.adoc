...
Um REWE in plentymarkets nutzen zu können, installiere zunächst das link:https://marketplace.plentymarkets.com/plugins/channels/marktplaetze/rewe_5901[REWE-Plugin^] in deinem plentymarkets System. Das Plugin findest du im link:https://marketplace.plentymarkets.com/[plentyMarketplace^]{nbsp}icon:external-link[].
...
IMPORTANT: Am Enddatum wird der Angebotspreis nicht automatisch auf REWE beendet. Der Angebotspreis wird erst beendet, wenn du den Preis bearbeitest, der für den REWE-Aktionspreis in plentymarkets gespeichert ist.

[#1801]
=== Angebotspreis festlegen

Voraussetzungen für den korrekten Preisexport:
...
* Du hast in den REWE-Katalogen die folgenden Zuordnungen vorgenommen:
  ** Martplatz-Datenfeld *Angebotspreis* = plentymarkets Verkaufspreis des Typs *Aktionspreis*
  ** Martplatz-Datenfeld *Angebot beginnt* = plentymarkets Eigenschaft *REWE Angebotspreis Startdatum*
  ** Martplatz-Datenfeld *Angebot endet* = plentymarkets Eigenschaft *REWE Angebotspreis Enddatum*
...
→ An diesem Tag wird der Aktionspreis auf REWE gestartet.
. Verknüpfe die Variante mit der Eigenschaft *REWE Angebotspreis Enddatum*.
. Speichere ein Datum für die Eigenschaft. +
*_Wichtig:_* Der Aktionspreis wird am Enddatum nicht automatisch beendet. Setze dir deshalb eine Erinnerung für das Enddatum. An diesem Tag musst du den Angebotspreis selbst beenden.
