...
Mit der Installation des REWE-Plugins stehen folgende automatisierte Prozesse bereit:
...
. Setze Häkchen bei *Artikelexport*, *Bestands- und Preisabgleich* und *Auftragsimport*, um den automatischen Datenaustausch mit REWE zu aktivieren.
. *Speichere* die Einstellungen.
...
. Setze ein Häkchen bei der Option *Aktiv* im Bereich *Verfügbarkeit*.
. Wechsele in das Tab *Verfügbarkeit*.
. Klicke im Bereich *Märkte* in das Auswahlfeld. +
→ Eine Liste mit allen verfügbaren Märkten wird angezeigt.
. Setze ein Häkchen bei der Option *REWE*.
. Klicke auf *Hinzufügen*. +
→ Der Marktplatz wird hinzugefügt.
. *Speichere* die Einstellungen. +
→ Der Artikel ist nun auf REWE verfügbar.
...
→ Alle mit * gekennzeichneten Pflichtfelder müssen mit einer plentymarkets Datenquelle verknüpft werden.
. *Speichere* die Einstellungen.
