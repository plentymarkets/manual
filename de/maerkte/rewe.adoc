...
Damit du deine Artikel zu REWE exportieren kannst, musst du für die verschiedenen REWE-Produktkategorien Kataloge erstellen. Verknüpfe anschließend im Katalog-Template die von REWE vorgegebenen Felder mit in plentymarkets gespeicherten Artikeldaten. Die Katalog-Vorlagen werden automatisch einmal täglich zu REWE exportiert, wenn du unter *Einrichtung » Märkte » REWE » Grundeinstellungen* den *Artikelexport* aktiviert hast.
