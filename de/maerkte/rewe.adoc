...
Welche REWE-Gruppenattribute und REWE-Variantenattribute für einen Produkttyp zur Verfügung stehen, siehst du, wenn du einen Katalog mit Template erstellt hast. Öffne dazu im Katalog-Template die Dropdown-Listen *Attribut für Variantengruppe* und *Attribut für Produktgruppe*.
