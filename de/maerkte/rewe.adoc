...
Standardmäßig werden für jede Variante die Bestandsinformationen übermittelt, die du über die Einstellung *Beschränkung* an der Variante festlegst. Ab Plugin-Version 1.17.23 kannst du diese Einstellung aber ignorieren und für alle Varianten den tatsächlichen Netto-Warenbestand an REWE übermitteln.
