...
| Wie <<#1000, oben beschrieben>> unterscheidet REWE zwischen Produktgruppen und Variantengruppen.
...
Du ordnest dem Marktplatz-Datenfeld *Attribute für Produktgruppen* also folgendes plentymarkets Datenfeld zu:

* *_Möglichkeit 1:_* Ein Attribut, durch das das Aussehen der Varianten verändert wird
* *_Möglichkeit 2:_* Eine Eigenschaft, durch die das Aussehen der Varianten verändert wird

Natürlich kannst du auch mit Ausweich-Datenfeldern arbeiten und so Attribute und Eigenschaften exportieren.
...
* Zusätzlich muss das Marktplatz-Datenfeld *Farbe* zugeordnet werden.
...
. Ordne dem Marktplatz-Datenfeld *Attribut für Produktgruppen* das folgende plentymarkets Datenfeld zu:
  * *_Möglichkeit 1:_* Attribut für *Farbe*
  * *_Möglichkeit 2:_* Eigenschaft für Farbe

*_Detaillierte Beschreibung für Katalog-Einsteiger:innen:_*
...
. Klicke auf *+ Datenfeld hinzufügen*.
. Klicke in der Liste der Datenfelder auf die Gruppe *Attribut*.
. Klicke auf das Plus rechts neben dem Attribut.
. Klicke auf *Bestätigen*. +
→ Das plentymarkets Datenfeld wird zugeordnet.
...
. Klicke in der Liste der Datenfelder auf die Gruppe *Eigenschaft*.
. Klicke auf die Gruppe, die die Eigenschaft enthält.
. Klicke auf das Plus rechts neben der Eigenschaft.
. Klicke auf *Bestätigen*. +
→ Das plentymarkets Datenfeld wird zugeordnet.
--
...
* Zusätzlich muss das Marktplatz-Datenfeld *Größe* zugeordnet werden.
...
. Navigiere zum Bereich *Attribut für Produktgruppe*.
. Ordne dem Marktplatz-Datenfeld *Attribut für Produktgruppen* das folgende plentymarkets Datenfeld zu:
  * *_Möglichkeit 1:_* Attribut für *Größe*
  * *_Möglichkeit 2:_* Eigenschaft für Größe
--
|====
