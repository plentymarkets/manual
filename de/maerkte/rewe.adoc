...
| *Kontakterstellung deaktivieren*
a|
* _Option deaktiviert_ (icon:toggle-off[role="darkGrey"]) (Standardeinstellung) = Die Kontakterstellung ist deaktiviert. Beim Import des ersten REWE-Auftrags wird für REWE ein Kontakt erstellt. Alle weiteren REWE-Aufträge werden mit diesem Kontakt verknüpft. Alle Rechnungsadressen werden diesem Kontakt zugeordnet.
...
* _Option aktiviert_ (icon:toggle-on[role="green"]) = Die Kontakterstellung ist deaktiviert. Beim Import von REWE-Aufträgen wird kein Kontakt erstellt. Rechnungsadresse und Lieferadresse werden erstellt und dem Auftrag zugeordnet.
