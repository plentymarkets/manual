...
'''
*Datenfeld wählen* = Ein bereits in plentymarkets vorhandenes Datenfeld wird an REWE exportiert. Das Datenfeld aus der Dropdown-Liste *Datenfeld* wählen. +
...
Die automatisch erstellte Eigenschaft wird im Menü <<artikel/einstellungen/eigenschaften#500, Einrichtung » Einstellungen » Eigenschaften » Konfiguration>> gespeichert.
