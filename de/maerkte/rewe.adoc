...
====
Die Einstellungen zur Provision bei REWE sind optional. Wenn du keine Provision einstellst, werden Aufträge mit den Verkaufspreisen des Endkunden in plentymarkets importiert.
====
