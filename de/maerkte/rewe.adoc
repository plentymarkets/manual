...
| *Bestand übertragen*
a| * *Varianteneinstellung 'Beschränkung' berücksichtigen* (Standardeinstellung) = Der Bestand wird für jede Variante so übermittelt, wie an der Variante eingestellt. Die Beschränkung des Bestands wird im Menü *Artikel » Artikel bearbeiten » [Artikel öffnen] » [Variante öffnen] » Varianten-Tab: Einstellungen » Bereich: Verfügbarkeit* über die Einstellung *Beschränkung* gesteuert. +
