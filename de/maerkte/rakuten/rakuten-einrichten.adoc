...
. Öffnen Sie das Menü *System » Systemeinstellungen » Märkte » Rakuten » Einstellungen*. +
...
Damit Sie Artikel, Merkmale etc. mit Rakuten verknüpfen können, muss im Menü *System » Systemeinstellungen » Aufträge » Auftragsherkunft* die Auftragsherkunft Rakuten aktiviert werden.
...
.  Nehmen Sie die weiteren Einstellungen gemäß <<ereignisaktion-versandvorbereitung-rakuten>> vor.
...
. *Speichern* Sie die Einstellungen. +
→ Das Ereignis wird erstellt.
.  Nehmen Sie die weiteren Einstellungen gemäß <<ereignisaktion-versandbestätigung-rakuten>> vor.
.  Setzen Sie ein Häkchen bei *Aktiv*.
. *Speichern* Sie die Einstellungen. +
→ Die Ereignisaktion wird gespeichert.
--
...
. *Speichern* Sie die Einstellungen. +
→ Das Ereignis wird erstellt.
.  Nehmen Sie die weiteren Einstellungen gemäß <<ereignisaktion-retoure-rakuten>> vor.
.  Setzen Sie ein Häkchen bei *Aktiv*.
. *Speichern* Sie die Einstellungen. +
→ Die Ereignisaktion wird gespeichert.
--
...
. *Speichern* Sie die Einstellungen. +
→ Das Ereignis wird erstellt.
.  Nehmen Sie die weiteren Einstellungen gemäß <<ereignisaktion-stornierung-rakuten>> vor.
.  Setzen Sie ein Häkchen bei *Aktiv*.
. *Speichern* Sie die Einstellungen. +
→ Die Ereignisaktion wird gespeichert.
--
