...
*_Hinweis:_* Die Versandkosten werden in deinem Vertrag mit limango festgelegt und von limango im limango-Backend gespeichert. Deshalb gibst du hier die ID des Versanddienstleisters und _nicht_ die ID eines Versandprofils.
...
Die Versandkosten werden in deinem Vertrag mit limango festgelegt und von limango im limango-Backend gespeichert. Versandkosten können deshalb nur in Absprache mit dem limango Partnermanagement angepasst werden. In plentymarkets gibt es deshalb für die Versandkosten keine Einstellung.
