...
| * *1*/*success* = Die Preise wurden erfolgreich zu limango exportiert. Der Zeitpunkt des Exports wird unter *Zeitpunkt des letzten erfolgreichen Preisexports* angezeigt.
...
image::maerkte/assets/limango-gender-variation.png[]
