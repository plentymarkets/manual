...
2+| *Order statuses mapping*

| *Order status ID for orders whose items are not found in plenty (order status id should be >= 5)*
|

| *Order status ID for the orders with no carrier mapped (>= 5)*
|

2+| *Versanddienstleister verknüpfen*
