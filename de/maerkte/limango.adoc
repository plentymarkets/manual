...
| _aktiviert:_ Wenn keine Bilder auf Variantenebene verknüpft sind, werden die ersten 10 Bilder mit der Marktplatzverfügbarkeit limango des Artikels exportiert. +
