...
a| Materialangaben werden mit Eigenschaften des Typs *Text* zu limango exportiert. Für jedes Marktplatz-Datenfeld benötigst du eine eigene Eigenschaft.

Der Name der Eigenschaften muss mit den von limango erlaubten Werten für die Materialkomponenten übereinstimmen:
...
Die Eigenschaften verknüpfst du mit der Hauptvariante des Artikels und speicherst alle Bestandteile eines Materialmix in dieser Eigenschaft.
