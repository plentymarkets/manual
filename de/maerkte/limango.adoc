...
a| Materialangaben werden mit Eigenschaften des Typs *Kurztext* an limango übertragen. Pro Marktplatz-Datenfeld benötigst du eine Eigenschaft. An der Variante speicherst du alle Bestandteile des Materialmix des Artikels in dieser Eigenschaft.
