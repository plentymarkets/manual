...
| *Auftragsstatus für Aufträge ohne Versanddienstleister (>= 7)*
| Auftragsstatus größer oder gleich 7 eingeben. Dieser Status wird Aufträgen zugewiesen, wenn der Versanddienstleister im Auftrag nicht mit einem Versanddienstleister in plentymarkets verknüpft ist.
