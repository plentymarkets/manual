...
| Beschreibung
| Feld *Artikeltext* und bei bestimmten Kategorien zusätzliche Produktinformationen in einer Eigenschaft des Typs *Text*. +
...
| [#intable-product-id]*Händler-Produkt-ID*
| Die Händler-Produkt-ID wird automatisch aus *Parent-SKU* + *Farbe* erzeugt.

| [#intable-description]*Beschreibung*
...
| [#intable-measurements]Maßangaben +
(*Länge*; +
*Breite*; +
*Höhe*; +
*Volumen*; +
...
| [#intable-energy-label]*Energielabel-URL*
