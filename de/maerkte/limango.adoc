...
. Ordne dem Marktplatz-Datenfeld *Farbe* ein plentymarkets Datenfeld zu: +
*_Möglichkeit 1:_* Feld *Wertname* des Attributs für *Farbe*. +
...
* Du prüfst und korrigierst die Versanddienstleister in den Plugin-Einstellungen und schiebst den Auftrag dann in den Status für *Auftragsstatus für Aufträge mit Versanddienstleister (> 5 - < 7)*.
...
Diesen Status legst du im Menü *Plugins » Plugin-Set-Übersicht » [Plugin öffnen] » Auftragsstatus* fest.
