...
* Du nutzt das Feld *Technische Daten* des Artikels für Materialangaben.

_oder_

* Du erstellst eine Eigenschaft des Typs *Text* und speicherst darin die Materialangaben. Diese Eigenschaft verknüpfst du mit der Hauptvariante des Artikels.
...
*Höhe*; +
etc.)
a| Maßangaben müssen im Format *[Zahlenwert];[Einheit]* zu limango exportiert werden. Da Maß und Einheit in plentymarkets in unterschiedlichen Datenfeldern gespeichert sind, kombinierst du zwei plentymarkets Datenfelder mit einem Semikolon als Trennzeichen.
...
. Ordne dem Marktplatz-Datenfeld *Durchmesser* das plentymarkets Datenfeld *Durchmesser* zu.
. Klicke rechts neben diesem Datenfeld auf *Datenfeld hinzufügen* (icon:link[rotate=90]).
