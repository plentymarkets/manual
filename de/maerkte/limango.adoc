...
* Du prüfst und korrigierst die Versanddienstleister in den Plugin-Einstellungen und schiebst den Auftrag dann in den Status *Auftragsstatus für Aufträge mit Versanddienstleister (> 5 - < 7)*.
