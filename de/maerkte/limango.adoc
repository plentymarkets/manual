...
. Füge zur Eigenschaft *Maßangaben Einheit* alle Einheiten als Eigenschaftswerte hinzu, die du benötigst. +
...
*_Tipp:_* Wenn du dir sicher bist, dass du für alle deine Varianten nur eine einzige Einheit benötigst, kannst du die Einheit auch als eigenen Wert eingeben. Ordne dazu statt der Eigenschaft *Volumen Einheit* das Feld *Eigener Wert* zu und gib eine die Einheit in das Feld ein.
. Klicke ganz rechts in der Zeile auf *Einstellungen* (icon:cog[]).
. Wähle aus der Dropdown-Liste *Trennzeichen* die Option *Semikolon*.
--
