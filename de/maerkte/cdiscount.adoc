...
Varianten können bei Cdiscount nur als Einzelartikel eingestellt werden, wenn die folgenden Einstellungen vorgenommen wurden:

* Die Variante ist mit <<#600, Attributen>> für Kleidungsgröße oder Kleidungsfarbe verknüpft.
* Der Artikel ist mit einem <<#700, Merkmal>> des Typs *Kein* mit der Cdiscount-Verknüpfung *Variantenartikel* verknüpft.

Wenn du auf Cdiscount das gleiche Attribut für Einzelartikel und Varianten verwendest, kannst du mit einem Merkmal des Typs *Kein* mit der Cdiscount-Verknüpfung *Variantenartikel* den Artikel als Einzelartikel einstellen.
...
Beispiel
Name des Einzelartikels: Damenfahrrad, 28 Zoll, Mountainbike
Name des Attributs: blau
Produktname auf Cdiscount: Damenfahrrad, 28 Zoll, Mountainbike [blau]
...
*_Hinweis:_* Attribute, die als Kleidungsfarbe oder Kleidungsgröße definiert wurden, werden auf Cdiscount bei Variantenartikeln an den Produktnamen angehängt. Weitere Informationen dazu findest du im Kapitel «#einzelartikel-variantenartikel, Unterscheidung von Einzelartikeln und Variantenartikeln».
...
[IMPORTANT]
.Gutschriften bei Retouren immer für alle Auftragspositionen 
====
Wenn ein Cdiscount-Auftrag mehrere Auftragspositionen hat und Kund:innen nur eine Auftragsposition retournieren, wird bei Cdiscount immer der Betrag des gesamten Auftrags erstattet. Dies ist aufgrund einer Limitierung bei Cdiscount nicht anders möglich. +
*_Beispiel:_*
Ein:e Kund:in bestellt einen Pullover für 30€ und eine Jacke für 50€ und retourniert die Jacke. Bei Cdiscount wird eine Gutschrift für alle Auftragspositionen erstellt, also in diesem Fall für 80€.
====
