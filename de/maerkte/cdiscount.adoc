...
.Zugangsdaten
====
Verwenden Sie für die Einrichtung die API-Zugangsdaten. Die API-Zugangsdaten entsprechen nicht Ihren Zugangsdaten zum Händler-Backend von Cdiscount. Der Benutzername kann im Händler-Backend von Cdiscount eingesehen werden und das Passwort kann dort generiert oder angepasst werden.
====

[.instruction]
Cdiscount in plentymarkets einrichten:

. Öffnen Sie das Menü *System » Systemeinstellungen » Märkte » Cdiscount.com » Tab: Einstellungen*.
...
.Zugangsdaten
====
Verwenden Sie für die Einrichtung die API-Zugangsdaten (Benutzername und Passwort). Der Benutzername hat das Suffix api. Die Login-Zugangsdaten sind dagegen zum Login in das Backend bei Cdiscount bestimmt.
====
...
Die hier wählbaren Optionen sind die im Menü <<fulfillment/versand-vorbereiten#1700, System » Systemeinstellungen » Aufträge » Versand » Optionen » Tab: Versandkosten berechnen>> gewählten Einstellungen für Konfiguration 1 und Konfiguration 2.
...
Damit Sie Artikel, Merkmale etc. mit Cdiscount verknüpfen können, muss im Menü *System » Systemeinstellungen » Aufträge » Auftragsherkunft* die Auftragsherkunft Cdiscount aktiviert werden.
...
====
Wenn im Menü *System » Systemeinstellungen » Märkte » Cdiscount.com » Tab: Einstellungen* die Einstellung *Produkterstellung anfordern* aktiv ist, werden beim nächtlichen Übertragungsprozess für jede Variante, die exportiert wird automatisch eine SKU generiert, die der Varianten-ID entspricht.
====
...
. Öffnen Sie das Menü *System » Systemeinstellungen » Märkte » Cdiscount.com » Tab: Kategorieliste*.
...
. Öffnen Sie das Menü *System » Systemeinstellungen » Märkte » Cdiscount.com » Tab: Kategorieverknüpfung*.
...
. Öffnen Sie in das Menü *System » Systemeinstellungen » Artikel » Merkmale*.
...
. Öffnen Sie das Menü *System » Systemeinstellungen » Märkte » Cdiscount.com » Tab: Herstellerliste*.
...
Klicken Sie dazu im Menü *System » Systemeinstellungen » Märkte » Cdiscount.com » Tab: Herstellerliste* auf *Herstellerliste als CSV Datei herunterladen*.
...
Aktivieren Sie die <<payment/zahlungsarten-verwalten#, Zahlungsart>> *Cdiscount*, wie im Folgenden beschrieben.
...
. Öffnen Sie das Menü *System » Systemeinstellungen » Märkte » Cdiscount.com » Tab: Archiv*.
...
Da es in seltenen Fällen zu Problemen beim automatischen Artikelexport kommen kann, können Sie Ihren auf französisch hinterlegten Artikelkatalog unter <<daten/export-import/daten-exportieren#, Daten » Elastischer Export>> auch als CSV-Datei an Cdiscount exportieren. Nachdem Sie alle dafür notwendigen Einstellungen wie unten beschrieben gespeichert haben, müssen Sie die komplette URL kopieren und an Cdiscount übermitteln. Bestände werden weiterhin stündlich automatisch abgeglichen.
...
. Nehmen Sie die Einstellungen gemäß  der Handbuchseite <<daten/export-import/daten-exportieren#20, Daten exportieren>> vor.
. *Speichern* Sie die Einstellungen. +
...
====
Wenn Sie Ihren Artikelkatalog über eine CSV-Datei an Cdiscount übermitteln, müssen im Menü <<artikel/artikel-verwalten#480, System » Systemeinstellungen » Artikel » Merkmale>> die Merkmale *Geschlecht*, *Hauptfarbe*, *Hinweis*, *Kommentar*, *Marketing-Beschreibung*, *Publikum* und *Sport* verknüpft werden.
====

[#1200]
== Retouren automatisch senden

Richten Sie eine <<automatisierung/ereignisaktionen#, Ereignisaktion>> ein, um Retouren automatisch an Cdiscount zu senden.
...
.  Nehmen Sie die weiteren Einstellungen gemäß <<ereignisaktion-retouren-cdiscount>> vor.
...
Richten Sie eine <<automatisierung/ereignisaktionen#, Ereignisaktion>> ein, um den Auftragsstatus bei Cdiscount automatisch zu aktualisieren, wenn bestimmte Ereignisse eintreten. Sie haben die Möglichkeit, Aufträge bei Cdiscount per Ereignisaktion automatisch in die
...
. *Speichern* Sie die Einstellungen. +
→ Das Ereignis wird erstellt.
.  Nehmen Sie die weiteren Einstellungen gemäß <<ereignisaktion-auftragsstatus-cdiscount>> vor.
.  Setzen Sie ein Häkchen bei *Aktiv*.
. *Speichern* Sie die Einstellungen. +
→ Die Ereignisaktion wird gespeichert.
--
