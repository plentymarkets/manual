...
. Öffne das Menü *System » Systemeinstellungen » Märkte » Cdiscount.com » Tab: Einstellungen*.
...
Damit du Artikel, Merkmale etc. mit Cdiscount verknüpfen kannst, muss im Menü *System » Systemeinstellungen » Aufträge » Auftragsherkunft* die Auftragsherkunft Cdiscount aktiviert werden.
...
Artikel, die du auf Cdiscount verkaufen möchtest, müssen im Menü <<artikel/artikel-verwalten#170, Artikel » Artikel bearbeiten » Artikel öffnen » Tab: Varianten-ID>> im Tab *Verfügbarkeit* aktiviert werden.
...
link:https://knowledge.plentymarkets.com/artikel/artikel-verwalten#240[Verknüpfe^] den Verkaufspreis im Anschluss mit den gewünschten Varianten, falls noch nicht verknüpft.
...
link:https://knowledge.plentymarkets.com/artikel/artikel-verwalten#250[Verknüpfe^] den Barcode im Anschluss mit den gewünschten Varianten, falls noch nicht verknüpft.
...
. Öffne das Menü *System » Systemeinstellungen » Märkte » Cdiscount.com » Tab: Kategorieliste*.
...
. Öffne das Menü *System » Systemeinstellungen » Märkte » Cdiscount.com » Tab: Kategorieverknüpfung*.
...
. Öffne in das Menü *System » Systemeinstellungen » Artikel » Merkmale*.
...
. Öffne das Menü *System » Systemeinstellungen » Märkte » Cdiscount.com » Tab: Herstellerliste*.
...
Klicke dazu im Menü *System » Systemeinstellungen » Märkte » Cdiscount.com » Tab: Herstellerliste* auf *Herstellerliste als CSV Datei herunterladen*.
...
. Öffne das Menü *System » Systemeinstellungen » Märkte » Cdiscount.com » Tab: Archiv*.
...
Da es in seltenen Fällen zu Problemen beim automatischen Artikelexport kommen kann, kannst du deinen auf französisch hinterlegten Artikelkatalog unter <<daten/export-import/daten-exportieren#, Daten » Elastischer Export>> auch als CSV-Datei an Cdiscount exportieren. Nachdem du alle dafür notwendigen Einstellungen wie unten beschrieben gespeichert hast, musst du die komplette URL kopieren und an Cdiscount übermitteln. Bestände werden weiterhin stündlich automatisch abgeglichen.
...
. Nimm die Einstellungen gemäß  der Handbuchseite <<daten/export-import/daten-exportieren#20, Daten exportieren>> vor.
. *Speichere* die Einstellungen. +
...
====
Wenn du deinen Artikelkatalog über eine CSV-Datei an Cdiscount übermittelst, müssen im Menü <<artikel/artikel-verwalten#480, System » Systemeinstellungen » Artikel » Merkmale>> die Merkmale *Geschlecht*, *Hauptfarbe*, *Hinweis*, *Kommentar*, *Marketing-Beschreibung*, *Publikum* und *Sport* verknüpft werden.
====
