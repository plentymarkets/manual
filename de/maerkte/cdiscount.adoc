...
Bevor du Cdiscount in plentymarkets einrichten kannst, musst du dich bei Cdiscount registrieren. Fülle das link:https://seller.cdiscount.com/Account_creation.html[Registrierungsformular^]{nbsp}icon:external-link[] aus und übermittele deine Daten an Cdiscount. Ein Support-Mitarbeiter des Marktplatzes wird dich kontaktieren, um die Registrierung zu verifizieren.
...
Die Verfügbarkeit für mehrere Varianten kann entweder über die link:https://knowledge.plentymarkets.com/artikel/artikel-verwalten#330[Varianten-Gruppenfunktion^] oder die link:https://knowledge.plentymarkets.com/artikel/artikel-verwalten#330[Stapelverarbeitung^]{nbsp}icon:external-link[] bearbeitet werden.
