...
Die hier wählbaren Optionen sind die im Menü <<fulfillment/versand-vorbereiten#1700, System » Aufträge » Versand » Optionen » Tab: Versandkosten berechnen>> gewählten Einstellungen für Konfiguration 1 und Konfiguration 2.
