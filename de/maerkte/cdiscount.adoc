...
Wenn du auf Cdiscount das gleiche Attribut für Einzelartikel und Varianten verwendest, kannst du mit einem Merkmal des Typs *Kein* mit der Cdiscount.com-Merkmal-Verknüpfung *Variantenartikel* den Artikel als Einzelartikel einstellen.
