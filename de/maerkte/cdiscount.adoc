...
Ist diese Option zusammen mit der Option *Produkterstellung anfordern* aktiviert, findet der automatische Datenaustausch nur über die API-Schnittstelle statt.
...
include::_textblocks/instructions/sku-manuell.adoc[tags=sku-man;sku-cdiscount;!*]
