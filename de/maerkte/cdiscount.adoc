...
Die hier wählbaren Optionen sind die im Menü *System » Systemeinstellungen » Aufträge » Versand » Optionen » Tab: Versandkosten berechnen* gewählten Einstellungen für Konfiguration 1 und Konfiguration 2.
