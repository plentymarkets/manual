...
:keywords: Cdiscount, Marktplatz, Cdiscount einrichten, Cdiscount Marktplatz, Multi-Channel, Multichannel, Multi-Channel Cdiscount, Multichannel Cdiscount, multi channel Cdiscount, C discount
...
[TIP]
.Alle Varianten eines Artikels auf Cdiscount verkaufen
====
Wenn du alle Varianten eines Artikels auf Cdiscount verkaufen möchtest, nimm die unten beschriebenen Einstellungen an der Hauptvariante vor. Die Einstellungen werden dann an alle Varianten des Artikels vererbt.
====

[.instruction]
Variantenverfügbarkeit für Cdiscount einstellen:

. Öffne das Menü *Artikel » Artikel bearbeiten » Artikel öffnen » Tab: Varianten-ID » Tab: Einstellungen*.
. Öffne die Variante, die du auf Cdiscount verkaufen möchtest.
