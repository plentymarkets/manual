...
OTTO Market ist das Marktplatzmodell von OTTO. Du wirst als Verkäufer:in an deinen Produkten angezeigt und die Kommunikation mit Kund:innen wird von dir selbst verwaltet. +
