...
:keywords: OTTO market, OTTO, Otto einrichten, Marktplatz, Otto-Assistent, Otto Assistent, Otto-Kategoriegruppe, Otto Kategoriegruppe
...
.Ereignisaktion um Versandinformation an OTTO zu melden
[cols="1,3,3"]
|====
|Einstellung |Option |Auswahl
