...
Damit die Tracking-Nummer zusammen mit der Versandbestätigung an OTTO market gesendet wird, musst du die Ereignisaktion *DHL Retoure Online-Label generieren* erstellen.
