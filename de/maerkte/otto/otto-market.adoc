...
Richte eine <<automatisierung/ereignisaktionen#, Ereignisaktion>> ein, um OTTO market über die Stornierung eines Auftrags zu informieren. Es kann aus verschiedenen Gründen nötig sein, Aufträge zu stornieren. Wenn du beispielsweise als Händler den Auftrag selbst stonierst, wähle *Status [8] Storniert*. Wenn ein Kunde den Auftrag storniert, wähle *Status [8.1] Storniert durch Kunden*.
