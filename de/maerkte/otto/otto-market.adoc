...
Damit die Tracking-Nummer zusammen mit der Versandbestätigung an OTTO Market gesendet wird, musst du die Ereignisaktion *DHL Retoure Online-Label generieren* erstellen. Außerdem kannst du Retourenlabels mit den Plugins link:https://marketplace.plentymarkets.com/plugins/integration/glsshipping_6463[GLS Shipping^] oder link:https://marketplace.plentymarkets.com/plugins/integration/hermesshippinginterface_5437[Hermes^] einrichten. Weitere Informationen dazu findest du in den User Guides der Plugins.
