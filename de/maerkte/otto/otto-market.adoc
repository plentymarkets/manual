...
*_Hinweis:_* Wähle einen Status, der zu deinem Arbeitsablauf passt. Du kannst dafür beispielsweise den Status *[8.3] Retoure an OTTO melden* erstellen.
|
...
| *_Hinweis:_* Durch die Aktion *Retoure an OTTO melden* wird eine Gutschrift ausgelöst und der Endkunde erhält eine Rückerstattung.
|====
...
| *Ereignis*
|Ereignis wählen, z.B. *Auftragsänderung: Statuswechsel* +
*_Hinweis:_* Wähle einen Status, der zu deinem Arbeitsablauf passt. Du kannst dazu beispielsweise den Status *[8.2] Retoure von OTTO ablehnen* erstellen.
|
