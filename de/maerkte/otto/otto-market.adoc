...
| *_Hinweis:_* Durch die Aktion *Retoure an OTTO melden* wird eine Gutschrift ausgelöst und der Endkunde erhält eine Rückerstattung. Das von OTTO erstellte Gutschriftendokument wird automatisch an den Auftrag vom Typ *Gutschrift* angehängt und der Endkunde erhält eine Rückerstattung.
|====
