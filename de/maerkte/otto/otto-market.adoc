...
+
Dieser Fehler zeigt an, dass die Kategorieverknüpfung im Katalog fehlt. Prüfe im Katalog, ob mindesteins eine Kategorie der gewünschten Variante mit einer OTTO Market-Kategorie verknüpft ist.
+
