...
a| Die Variante muss mit der Eigenschaft *Otto-Kategoriegruppe* verknüpft sein.
...
a| Die Variante muss über positiven Nettowarenbestand verfügen.
...
a| Mindestens alle Pflichtfelder des Marktplatzes müssen plentymarkets Datenfeldern zugeordnet sein. Die Pflichtfelder unterscheiden sich je nach OTTO-Kategoriegruppe. Die Pflichtfelder sind im Katalog mit einem Sternchen (*) versehen.

* <<#600, So ordnest du Marktplatz-Datenfeldern ein oder mehrere plentymarkets Datenfelder zu.>>

| _Keine Fehler gefunden?_
a| Alles stimmt und die Variante wird trotzdem nicht exportiert? Dann prüfe das Daten-Log.
