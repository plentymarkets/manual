...
Damit die Tracking-Nummer zusammen mit der Versandbestätigung an OTTO Market gesendet wird, musst du die Ereignisaktion *DHL Retoure Online-Label generieren* oder ** erstellen. Außerdem kannst du eine Ereignisaktion zum Erstellen eines Retourenlabels mit dem Plugin *GLS Shipping* einrichten. Weitere Informationen dazu findest du im link:https://marketplace.plentymarkets.com/plugins/integration/glsshipping_6463[User Guide des Plugins^].

*Hinweis:* Das Retourenlabel kann momentan nur mit DHL, Hermes und GLS Shipping generiert werden. Weitere Versanddienstleister folgen.

[IMPORTANT]
.Plugins installieren
====
Um ein Retouren-Label generieren zu können, müssen die Plugins *DHL Retoure Online*, *Hermes* oder *GLS Shipping* in deinem plentymarkets System installiert, aktiviert und eingerichtet sein, je nachdem, mit welchen Versanddienstleister du ein Retourenlabel erstellen möchtest. Die Plugins erhältst du im link:https://marketplace.plentymarkets.com/plugins/fulfillment-stock/versand[plentyMarketplace^]{nbsp}icon:external-link[].
====

Wie du eine <<automatisierung/ereignisaktionen#, Ereignisaktion>> einrichtest, um ein Retourenlabel zu generieren, ist im Folgenden beschrieben.

:table-event-procedure: <<#retouren-label-otto>>

include::../../_includes/textblocks/instructions/EA.adoc[]

[[retouren-label-otto]]
.Ereignisaktion zum Erstellen eines Retourenlabels
[cols="1,3,3"]
|====
...
| *Aktion*
| *Plugins > DHL Retoure Online-Label generieren* oder
|
|====
