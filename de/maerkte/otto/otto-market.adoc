...
* *Alternativer Retouren-Versanddienstleister* = Einen Versanddienstleister aus der angezeigten Dropdown-Liste wählen. Dieser feste Versanddienstleister wird für alle Sendungen verwendet, die über die REST-API ins System kommen.
* *Keinen alternativen Retouren-Versanddienstleister verwenden* = Es wird gar kein Versanddienstleister für Retouren zugeordnet.
