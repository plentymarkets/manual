...
. OTTO erstellt einen Gutschriftenbeleg.
. In plentymarkets wird ein Auftrag des Typs *Gutschrift* erstellt.
. Für diesen Auftrag wird ein Gutschriftenbeleg generiert.
...
* Wenn im ursprünglichen Auftrag ein Coupon verwendet wurde, wird dieser Coupon auch im Gutschriften-Auftrag als Artikelposition importiert und die Preise werden berücksichtigt.
