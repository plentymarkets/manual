...
Artikeldaten werden über Kataloge zu OTTO Market übertragen. Mit dem Assistenten *Kataloge erstellen - OTTO Market* erstellst du ein Marktplatz-Format pro OTTO-Kategoriegruppe.
