...
In den folgenden Kapiteln werden Ereignisaktionen zum Generieren eines DHL-Retourenlabels, zum Senden einer Auftragsbestätigung an OTTO market und zur Meldung der Versandinformation an OTTO market beschrieben. Richte weitere Ereignisaktionen auf die gleiche Weise ein.
