...
Die Grundeinstellungen für OTTO market nimmst du im Menü *Einrichtung » Assistenten » Omni-Channel* mit zwei Assistenten vor. Durchlaufe im Menü *Einrichtung » Assistenten » Omni-Channel* die folgenden Assistenten, um OTTO market in deinem plentymarkets System einzurichten:
...
Damit du OTTO market in plentymarkets nutzen kannst, sind nachdem du die Assistenten durchlaufen hast weitere Einstellungen an deinen Artikeln nötig, damit alle Daten korrekt übertragen werden können.
...
. Klicke auf *Marke hinzufügen* (icon:plus-square[role="green"]), um *AudioAffairs* hinzuzufügen.
