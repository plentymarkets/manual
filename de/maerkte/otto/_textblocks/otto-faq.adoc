...
* <<#13014, Wo hinterlege ich die Versandkosten im OTTO-Partnerportal?>>

FAQ: Artikeldatenexport

* <<#1302, Warum werden meine Artikeldaten nicht zu OTTO Market exportiert?>>
* <<#13016, Mögliche Fehlermeldungen im Log>>
  ** <<#13023, delivery.deliveryTime>>
  ** <<#13010, delivery.type>>
  ** <<#13017, ean>>
  ** <<#1309, mediaAssets.IMAGE _oder_ mediaAssets>>
  ** <<#13024, pricing.standardPrice.amount _oder_ pricing.standardPrice.currency>>
...
* <<#13027, Eine Versandbestätigung wurde nicht an OTTO Market gemeldet. Was kann ich tun?>>
* <<#1305, Mögliche Fehlermeldungen im Log>>
...
[#1307]
[.collapseBox]
.*Code: 200009 - ATTRIBUTE_CHANGE_DENIED* _oder_ *title: Der Wert dieses Feldes kann nicht geändert werden.*
--
