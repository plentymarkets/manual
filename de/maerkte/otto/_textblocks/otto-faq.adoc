...
OTTO berechnet den Grundpreis der Variante anhand dieser Daten. <<#table-faq-unit-price>> zeigt Details zu den Datenfeldern.

[[table-faq-unit-price]]
.OTTO Market-Datenfelder für Grundpreise
[cols="1,3a,3a"]
|======
|OTTO Market-Datenfelder |Zuordnung in plentymarkets |Erläuterung
...
| Die Grundpreismenge dient als Grundlage für das Berechnen des Grundpreises. OTTO erlaubt die Werte *1*, *100* oder *1000*. Verknüpfe dieses Feld mit einer Eigenschaft, die den Wert *1*, *100* oder *1000* beinhaltet. +
...
In das Feld den ISO-Wert der Einheit eingeben. +
Die ISO-Werte findest du im Menü *Einrichtung » Artikel » Einheiten* in der Spalte *ISO*. +
