...
[#500]
== _Möglichkeit 1:_ Artikelexport über Elastischen Export (bald veraltet)
...
NOTE: Der Elastische Export wird für den Marktplatz-Export nicht mehr weiterentwickelt. Wir empfehlen dir deshalb, lieber <<#900, Kataloge für Check24 zu erstellen>>.
...
Mit dem link:xxxx[neuen Check24-Plugin^]{nbsp}icon:external-link[] werden Artikeldaten über ein Katalog-Format zu Check24 übertragen. Kataloge erstellst du im Menü *Daten » Kataloge*.
