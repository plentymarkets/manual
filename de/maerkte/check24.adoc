...
[#500]
== Möglichkeit 1: Artikelexport über Elastischen Export (bald veraltet)
...
NOTE: Der Elastische Export wird nicht mehr weiterentwickelt und ist bald veraltet. Wir empfehlen dir deshalb, lieber <<#900, einen Katalog für Check24 zu erstellen>>.
...
[#900]
== Möglichkeit 2: Artikelexport über Katalog-Format (Testphase)

Mit dem neuen link:xxxx[neue Check24-Plugin^]{nbsp}icon:external-link[] werden Artikeldaten über ein Katalog-Format zu Check24 übertragen. Kataloge erstellst du im Menü *Daten » Kataloge*.
...
Um Artikeldaten über ein Katalog-Format an Check24 exportieren zu können, installiere zunächst das link:xxxx[neue Check24-Plugin^]{nbsp}icon:external-link[] in deinem plentymarkets System. Das Plugin findest du im link:https://marketplace.plentymarkets.com/[plentyMarketplace^]{nbsp}icon:external-link[].
...
Artikeldaten werden über die Marktplatz-Formate *Check24* und *Check24 Fashion* zu Check24 übertragen. Um deine Artikel zu Check24 zu übertragen, erstellst du im Menü *Daten » Kataloge* einen Katalog. Verknüpfe dann im Marktplatz-Format die von Check24 vorgegebenen Felder mit in plentymarkets gespeicherten Artikeldaten. Die Katalogdaten werden automatisch in regelmäßigen Abständen zu Check24 exportiert, wenn du den Katalog aktivierst.
...
--
include::_textblocks/catalogue-mappings/check24-recommended-mappings.adoc[]
--

[.collapseBox]
.Liste mit empfohlenen Datenfeld-Zuordnungen für Check24 Fashion
--
include::_textblocks/catalogue-mappings/check24-fashion-recommended-mappings.adoc[]
--
