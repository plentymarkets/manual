...
* <<#500, _Möglichkeit 1:_ Artikelexport über Elastischen Export (veraltet)>>
* <<#catalogue-export, _Möglichkeit 2:_ Artikelexport über Katalog-Formate (Testphase)>>

[#500]
=== _Möglichkeit 1:_ Elastischen Export (veraltet)
...
--
include::_textblocks/catalogue-mappings/check24fashion-recommended-mappings.adoc[]
--

[.collapseBox]
.Liste mit empfohlenen Datenfeld-Zuordnungen für Check24 Offer
--
include::_textblocks/catalogue-mappings/check24offer-recommended-mappings.adoc[]
--
