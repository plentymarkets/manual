...
.Ereignisaktion, um Auftragsbestätigung an {marketplace} zu melden
[cols="1,2,2"]
|===
| *Einstellung*
| *Option*
...
.Ereignisaktion, um Versandbestätigung an {marketplace} zu melden
[cols="1,2,2"]
|===
| *Einstellung*
| *Option*
...
.Ereignisaktion, um Auftragsstornierung an {marketplace} zu melden
[cols="1,2,2"]
|===
| *Einstellung*
| *Option*
...
.Ereignisaktion, um Rückerstattung an {marketplace} zu melden
[cols="1,2,2"]
|===
| *Einstellung*
| *Option*
