...
| Hier kannst du eine Bestandsmenge für Varianten ohne Netto-Warenbestandsbeschränkung oder für Varianten, bei denen kein Warenbestand geführt wird, speichern und für den Export festlegen.
