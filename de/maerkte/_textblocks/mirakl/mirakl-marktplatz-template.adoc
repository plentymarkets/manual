...
*_Hinweis:_* Wenn du die API-Umgebung wechselst, also zum Beispiel vom Test-Modus in den Produktiv-Modus, musst du einen neuen <<#1300, API-Schlüssel>> erzeugen.

| API Key
| Trage den <<#1300, API-Schlüssel>> ein, den du erzeugt hast. +
*_Hinweis:_* Wenn du die API-Umgebung wechselst, also zum Beispiel vom Test-Modus in den Produktiv-Modus wechselst, musst du einen neuen <<#1300, API-Schlüssel>> erzeugen.
...
Wenn du für eine oder alle deine Varianten mehrere <<artikel/einstellungen/attribute#, Attribute>> definiert hast, erstelle eine Eigenschaft, die diese Attribute vereint. Unterscheidest du bei einer Variante zum Beispiel sowohl nach Farbe als auch nach Größe, legst du eine Eigenschaft mit der Benennung "Grau XL" an. <<artikel/einstellungen/eigenschaften#1400, Ordne diese Eigenschaften>> den entsprechenden Varianten zu.
