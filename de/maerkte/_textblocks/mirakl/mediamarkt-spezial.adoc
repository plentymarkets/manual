...
* Die Plugins link:{marketplace-url}[{marketplace}^]{nbsp}icon:external-link[] sowie *Mirakl Connector* wurden im Marktplatz gekauft, heruntergeladen und in einem Plugin-Set installiert und bereitgestellt.
