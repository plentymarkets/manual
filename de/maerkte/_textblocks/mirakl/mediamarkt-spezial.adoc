...
// tag::hinweis-logistikklasse[]
*_Hinweis_*: Die Eigenschaften *Versandvorlaufzeit* und *Abzugsverfahren* werden automatisch mit dem Typ *Auswahl* erstellt. Du musst also nur die Eigenschaft *Logistikklasse* wie im folgenden Kapitel beschrieben erstellen.
// end::hinweis-logistikklasse[]
