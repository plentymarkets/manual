...
* Versandvorlaufzeit
** Es handelt sich hier um das sogenannte „leadtime-to-ship“: die Zeit (in Tagen), die ein Händler zwischen Auftragsanlage und Versandmeldung benötigt. Hier muss eine ganze Zahl zwischen 1 und 45 übergeben werden.
* Abzugsverfahren
