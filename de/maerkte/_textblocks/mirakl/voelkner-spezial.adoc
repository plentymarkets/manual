...
:do-not-map-fields: Produktbild 1 URL + \
Produktbild 2 URL + \
Produktbild 3 URL + \
Produktbild 4 URL + \
Produktbild 5 URL
...
* *product-id-type*: Dieses Feld wird standardmäßig mit dem Wert *SHOP_SKU* befüllt. Im Assistentenschritt *Zuordnung der Angebots- Eigenschaften* kannst du eine Eigenschaft zuordnen, um pro Variante den folgenden Wert zu übertragen: *SKU*. Der EAN-Abgleich wird <<eans-abgleichen#, weiter unten>> detaillierter erklärt.
