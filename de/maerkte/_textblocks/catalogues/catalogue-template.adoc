...
Mit dem link:xxxx[neuen {market}-Plugin^]{nbsp}icon:external-link[] werden Artikeldaten über ein Katalog-Format zu {market} übertragen. Kataloge erstellst du im Menü *Daten » Kataloge*.
...
Artikeldaten werden über ein Marktplatz-Format zu {market} übertragen. Um deine Artikel zu {market} zu übertragen, erstellst du im Menü *Daten » Kataloge* einen Katalog. Verknüpfe dann im Marktplatz-Format die von {market} vorgegebenen Felder mit in plentymarkets gespeicherten Artikeldaten. Wenn du den Katalog aktivierst hast, werden die Katalogdaten in regelmäßigen Abständen automatisch zu {market} exportiert.
...
--
include::_textblocks/catalogue-mappings/{market}-recommended-mappings.adoc[]
--
////
