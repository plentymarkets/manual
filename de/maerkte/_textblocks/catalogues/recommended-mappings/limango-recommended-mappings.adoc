...
*_Tipp:_* Wende dich an das limango Partnermanagement, wenn du eine Marke verkaufen willst, die nicht in der Liste der Marken enthalten ist. limango fügt die Marke dann zu der Liste hinzu. plentymarkets aktualisiert die Markenliste einmal täglich.
...
*_Gültige Werte:_*
    ...
    ** `Babys, Kinder` = Babys und Kleinkinder
    ** `Erwachsene`
...
image::../../../assets/limango-steuerklasse-1.png[]
...
image::../../../assets/limango-steuerklasse-2.png[]
