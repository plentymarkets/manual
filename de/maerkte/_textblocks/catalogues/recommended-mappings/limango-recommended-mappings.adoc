...
*_Hinweis:_* Die Produktgruppen-ID ist frei wählbar und wird nicht im limango Shop angezeigt.
| Produktgruppe
...
*_Hinweis:_* Der Produktgruppen-Name ist frei wählbar und wird nicht im limango Shop angezeigt.
| Produktgruppe
