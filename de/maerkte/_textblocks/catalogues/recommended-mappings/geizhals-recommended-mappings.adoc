...
|
| * *Grundpreis » Preis » [Selben Verkaufspreis wie für Datenfeld "Preis" wählen]*

| Grundpreis: Einheit
|
| * *Grundpreis » Einheit Name » [Selben Verkaufspreis wie für Datenfeld "Preis" wählen]*, Sprache *Deutsch*

| Grundpreis: Menge
|
| * *Grundpreis » Anzahl » [Selben Verkaufspreis wie für Datenfeld "Preis" wählen]*
