...
====
In den Katalogeinstellungen findest du auch Optionen für *Formateinstellungen*, *Exporteinstellungen* und *Download-Einstellungen*.
Diese Einstellungen sind optional und haben keine Auswirkung auf den Export zum Marktplatz.
