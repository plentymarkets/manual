...
Für jedes Marktplatz-Datenfeld hast die folgenden Zuordnungsmöglichkeiten, die in <<#mapping-types>> näher beschrieben werden:
...
image:maerkte/assets/durchmesser.gif[width=360]
--
|====
