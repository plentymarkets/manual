...
Komplexe Zuordnungen erkennst du daran, dass sich unterhalb des Namens des Marktplatz-Datenfelds ein Eingabefeld befindet. Wenn du in dieses Eingabefeld klickst, werden die Werte angezeigt, die es für dieses Marktplatz-Datenfeld gibt.
