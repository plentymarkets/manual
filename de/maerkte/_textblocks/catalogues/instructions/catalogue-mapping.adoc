...
. Nun ordnest du den Marktplatz-Datenfeldern passende plentymarkets Datenfelder zu. Du hast die folgenden Zuordnungsmöglichkeiten:
...
In <<#mapping-types>> erfährst du, wie du diese Zuordnungen vornimmst.
