...
*_Tipp:_* Du brauchst mehr Informationen zu den plentymarkets Datenfeldern? Alle Datenfelder sind auf der Handbuchseite für das Standardformat <<daten/daten-exportieren/katalog-artikel#, Artikel (neu)>> beschrieben.
...
* *_Datenfelder des Marktplatzes_*:
  ** Informationen zu den Marktplatz-Datenfeldern erhältst du in der Dokumentation des Marktplatzes.
