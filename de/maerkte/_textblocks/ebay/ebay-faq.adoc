...
* Versuchst du, ein Merkmal für die Variante zu exportieren, das auch schon als Attribut an der Variante gespeichert ist? Prüfe die Merkmale, Listing-Merkmale und Attribute des Artikels. Entferne ggf. entweder das Listing-Merkmal oder das Merkmal am Artikel, da eBay doppelte Werte nicht akzeptier.
