...
| nein
| Eigenschaft des Typs *Auswahl* mit folgenden möglichen Werten: +
*_Hinweis:_* Wenn du zusätzlich zu der Shop-Sprache "Deutsch" auch weitere Exportsprachen verwendest, musst du die Werte für dieses Marktplatz-Datenfeld auf Englisch angeben.
...
(is_customizable)
| nein
| *_Hinweis:_* Ordne für dieses Marktplatz-Datenfeld nur ein plentymarkets Datenfeld zu, wenn du auf Etsy die Funktion *Anfragen für Spezialanfertigungen* aktiviert hast.
...
*_Tipp:_* Bei Etsy heißen die Kategorien inzwischen "Taxonomy". Die Taxonomy-ID entspricht also der Kategorie-ID auf Etsy.
