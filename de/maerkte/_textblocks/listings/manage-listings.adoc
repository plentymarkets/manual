...
[#prepare-listings]
== [#2300] [#1200] [#800] Listings vorbereiten

[#listing-basic-settings]
=== [#2400] [#1300] [#900] Grundeinstellungen für Listings vornehmen
...
[#listings-stock]
=== [#2500] [#1400] [#1000] Warenbestand für Listings einstellen
...
[#listings-checkout]
=== [#2600] [#1500] [#1100] Kaufabwicklung einrichten
...
=== [#2700] [#1600] [#1200] Verkaufsplaner einrichten
...
[#listings-groups]
=== [#3200] [#2100] [#1700] [#3300] [#2200] [#1800] Verzeichnisse zum Gruppieren von Listings einrichten
...
=== [#2800] [#1300] Layout-Vorlagen verwalten
...
[#2900]
==== [#2900] [#1400] Layout-Vorlagen erstellen
