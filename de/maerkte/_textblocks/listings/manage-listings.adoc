...
Im nächsten Schritt verknüpfst du Listings mit der Layout-Vorlage. Dazu musst du schon Listings in plentymarkets erstellt haben. Wie du Listings in plentymarkets erstellst, erfährst du im Kapitel <<Listings erstellen, Listings erstellen>>. +
