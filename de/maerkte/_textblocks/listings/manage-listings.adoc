...
[#3200]
=== Verzeichnisse für die Listing-Verwaltung erstellen

Verzeichnisse dienen dazu, deine Listings zu gruppieren. Im Menü *Einrichtung » Listings » Verzeichnisse* im Tab *Neues Verzeichnis* erstellst du beliebig viele Verzeichnisse und Unterverzeichnisse, in die du deine Listings einordnest.
...
. *Speichere* (icon:save[role="green"]) die Einstellungen. +
→ Das Listing wird erstellt und im Tab *Verzeichnis* angezeigt.

[#3300]
=== Verzeichnisse bearbeiten

Im Tab *Verzeichnis* kannst du Verzeichnisse umbenennen oder löschen.
