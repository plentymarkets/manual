...
. Folge den Anweisungen auf dem Bildschirm. Wenn du zusätzliche Informationen zu einer der Option benötigst, klappe die {number-of-boxes} unter dieser Beschreibung auf (icon:chevron-down[role="darkGrey"]).
