...
include::../../../artikel/import-export-anlage/anlage/massenbearbeitung.adoc[tag=artikel-gruppenfunktion]
...
include::../../../artikel/import-export-anlage/anlage/massenbearbeitung.adoc[tag=artikel-stapelverarbeitung]
