...
====
Die Verfügbarkeit für mehrere Varianten bearbeitest du entweder über die <<artikel/artikel-verwalten#330, Varianten-Gruppenfunktion>> oder die <<artikel/artikel-verwalten#330, Stapelverarbeitung>>.
====
