...
. Klicke auf *Konfiguration > Einstellungen*.
...
Beachte, dass das Konfigurationsmenü zwei Bereiche enthält: *Einstellungen* und *Eigenschaften*. Den Bereich *Eigenschaften* kannst du vernachlässigen. Hier können keine Einstellungen vorgenommen werden.
...
// wie verhält es sich hier mit dem Katalog? Sinan fragen.
