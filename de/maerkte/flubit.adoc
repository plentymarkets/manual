...
Artikel, die du auf Flubit verkaufen möchtest, müssen im Menü <<artikel/artikel-verwalten#170, Artikel » Artikel bearbeiten » Artikel öffnen » Tab: Varianten-ID>> im Tab *Verfügbarkeit* aktiviert werden.
...
Im Menü <<basics/datenaustausch/api-log#, Daten » API-Log>> im Tab *Flubit* findest du eine Historie über Vorgänge, die über die Flubit-Schnittstelle ausgeführt wurden. Folgende Formate stehen dir für Flubit zur Auswahl:
