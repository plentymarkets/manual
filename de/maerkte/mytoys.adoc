...
|*Produktname*
|Die Zeichenzahl für Produktnamen ist technisch nicht limitiert. Achte dennoch darauf, nicht zu viele Zeichen zu verwenden, da der Produktname systemseitig von myToys sonst abgeschnitten wird. Der Produktname sollte daher so kurz wie möglich sein. +
Hersteller bzw. Eigenmarken müssen nicht im Produktnamen erwähnt werden, diese werden bei myToys gesondert darüber angezeigt. Auch Farben oder ähnliches sollten nicht über den Produktnamen genannt werden.
...
Beachte auch die von myToys zur Verfügung gestellte link:https://cdn02.plentymarkets.com/pmsbpnokwu6a/frontend/myToys/Checkliste_fu_r_Partner.pdf[Checkliste für Partner], anhand derer du überprüfen kannst, ob du die Vorgaben von myToys eingehalten hast.
...
. Kund:innen senden die Ware inklusive des ausgefüllten <<#1175>> Rücksendescheins an dich zurück.
