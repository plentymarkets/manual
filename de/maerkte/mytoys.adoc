...
So wie in plentymarkets Varianten auf Artikeln basieren, basieren bei myToys Artikel auf den Produkten. Dementsprechend werden in myToys den Artikeln Attribute zugeordnet, wie zum Beispiel Farbe und Größe. Diese Übereinstimmung in der Artikelstruktur erleichtert die Zuordnung der Datenfelder in den Katalogen.
