...
//TODO DB: Einleitungstext für Assistent #2 und include reparieren

:catalogue-assistant-name: Kataloge erstellen - myToys
:number-of-boxes: Info-Boxen
:catalogue-path: Einrichtung » Assistenten » Plugins » [Plugin-Set wählen]
