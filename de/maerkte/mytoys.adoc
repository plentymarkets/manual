...
//Hinweis zu simple and complex mappings hinzufügen
...
Für alle complex mappings gilt, dass alle Eigenschaftstypen außer *kein* verwendet werden dürfen.
// "complex mappings" hier noch mal erklären oder reicht es dann oben?

Da myToys keine HTML-Tags verarbeiten kann, werden diese herausgefiltert. Achte darauf, besonders für Artikelbeschreibungen und Aufzählungszeichen.
...
|*Produktname*
|Die Zeichenzahl für Produktnamen ist technisch nicht limitiert. Achte dennoch darauf, nicht zu viele Zeichen zu verwenden, da der Produktname systemseitig von myToys sonst abgeschnitten wird. Der Produktname sollte daher so kurz wie möglich sein. Hersteller bzw. Eigenmarken müssen nicht im Produktnamen erwähnt werden, diese werden bei myToys gesondert darüber angezeigt. Auch Farben oder ähnliches sollten nicht über den Produktnamen genannt werden. +
...
//Materialangabe von limango übernommen. Passt so?
