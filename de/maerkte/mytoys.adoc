...
*_Hinweis:_* Wenn das Feld *Zolltarifnummer* leer ist, wird automatisch der Wert `12345678` übertragen. Diese Nummer wird von MyToys als "keine Intrastatnummer" interpretiert.
