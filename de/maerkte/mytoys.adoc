...
////
MÜssen noch besprochen und eingefügt werden.
////
Die Struktur der Artikeldaten von myToys unterscheidet sich von der Struktur in plentymarkets.

////
Die limango Artikeldatenstruktur gliedert sich in drei Ebenen:
...
|===
////
check Benennungen der Filter und Aktionen
////
[#1300]
== Automatische Versandbestätigungen einrichten
////

FÜR MYTOYS AUCH SO KOMPLIZIERT? MINDESTENS PLUGIN-EINSTELLUNGEN SOLLTEN WEGFALLEN.
...
|====
////
CHECK Ablauf generell sowie Benennung Filter und Aktion
////
[#1600]
