...
image::assets/mytoys-delivery-note-settings-1.png[]
...
image::assets/mytoys-delivery-note-settings-2.png[]

| *Externe Kundennummer*
| Option *Ja* wählen.

image::assets/mytoys-delivery-note-settings-3.png[]
