...
:keywords: myToys, mytoys, toys, Marktplatz, mytoys einrichten, mytoys Marktplatz, Multi-Channel, Multichannel, Multi-Channel mytoys, Multichannel mytoys, Multi Channel mytoys
...
//Checken, ob immer noch nicht der eigene vergebene Name angezeigt wird, sondern der von myToys verwendete für die Kategorie.
...
//* <<#1350, So gibst du den Retourenhinweis für limango-Lieferscheine ein>>

[#1300]
=== PDF-Vorlage für Lieferscheine hochladen

//TODO: Noch klären: bisher ist die Zahlungsart "Plugin: myToys" Payment nicht im Testsystem zu finden. Daher dieses Kapitel erstmal pro forma angepasst.
