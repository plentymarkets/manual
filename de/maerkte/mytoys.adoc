...
Nachdem du das myToys-Plugin installiert hast, richtest du zunächst die technische Schnittstelle zum Datenaustausch mit dem Marktplatz über einen Assistenten ein. Halte dazu die Zugangsdaten bereit, die du von myToys erhalten hast.
...
//TODO DB: Einleitungstext für Assistent #2 
