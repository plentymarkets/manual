...
| *Saison*
| Möchtest du einen saisonunabhängigen Artikel einstellen, wähle hier *NOOS* (never out of season). Weitere Abkürzungen: +
- *FS* = Frühling / Sommer +
- *HW* = Herbst / Winter

| *Muster*
| Möchtest du einen Artikel ohne Muster einstellen, wähle *uni*.

| *EAN*
| Dieser Wert ist ein Pflichtwert und muss am Artikel gepflegt sein, da er genau so an myToys übergeben wird.

| *Materialzusammensetzung*
| Einige Kategorien, zum Beispiel Fashion, verlangen die Angabe der Materialzusammensetzung. Von den fünf zur Verfügung stehenden Feldern muss mindestens ein Feld verknüpft werden. Hierbei handelt es sich um ein mehrdimensionales Mapping: +
...
| *Altersempfehlung*
| Die Altersempfehlung wird verwendet, um automatisch zu entscheiden, in welchem Shop der Artikel angeboten wird:

* Produkte mit einer Altersempfehlung *bis 16 Jahre* werden in myToys eingestellt.
* Produkte mit einer Altersempfehlung *ab 18 Jahre* werden bei mirapodo/yomonda eingestellt.
...
[.collapseBox]
.Eigenschaft für *Altersempfehlung* erstellen
--
