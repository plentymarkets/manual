...
| Auf der myToys Artikelseite werden zusätzliche Informationen über den Artikel mit Aufzählungszeichen (bullet points) aufgeführt.

Erstelle pro Aufzählungszeichen eine Eigenschaft des Typs *Text*. Pro Aufzählungszeichen können bis zu 255 Zeichen exportiert werden. Nach 355 Zeichen wird der Text abgeschnitten und mit `...` versehen.
