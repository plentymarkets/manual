...
Beachte außerdem, dass es für myToys einige *Pflichtfelder* gibt. Mindestens diese Pflichtfelder müssen in der Zuordnung ausgefüllt werden. Über den Toggle *Nur Pflichtfelder anzeigen* kannst du dir auch ausschließlich die Pflichtfelder anzeigen lassen.
...
|*Produktname*
|Die Zeichenzahl für Produktnamen ist technisch nicht limitiert. Achte dennoch darauf, nicht zu viele Zeichen zu verwenden, da der Produktname im Frontend sonst abgeschnitten wird.
////
Gibt es hier vielleicht doch noch etwas Genaueres, das wir angeben können?
////
...
Wenn ein eingegebener Preis kleiner als der UVP ist, wird der UVP auf der myToys Artikelseite nicht ausgegeben.

|*Aufzählungszeichen*
|Auf der myToys Artikelseite werden zusätzliche Informationen über den Artikel mit Aufzählungszeichen aufgeführt. Hierfür bietet es sich an, dies in plentymarkets über die Eigenschaft *Kurztext* zu pflegen.
...
////
Noch weitere Besonderheiten / Infos, die hier eingefügt werden sollten?
////

|====

Dir fehlen Marktplatz-Datenfelder für die korrekte Zuordnung deiner Artikel? Dann wende dich an myToys, um diese ggf. hinzufügen zu lassen.
...
Beachte zudem, dass im <<maerkte/mytoys#902, Assistenten>> erstellte Kategorien den entsprechenden Varianten im Bereich *Varianteneigenschaften* im Menü *Artikel » Artikel bearbeiten » [Artikel öffnen] » Varianten-Tab: Eigenschaften* zugeordnet werden müssen.
...
////
Checken, ob immer noch der eigene vergebene Name angezeigt wird, oder inzwischen schon der von myToys verwendete für die Kategorie.
////
[#1200]
...
//TODO: Noch klären: bisher ist die versprochene Zahlungsart "Plugin: myToys" Payment nicht im Testsystem zu finden. Daher dieses Kapitel erstmal pro forma angepasst.
...
//TODO: Kapitel scheinbar entfernen. Warten auf Rückmeldung, ob bei myToys auch Retourenhinweis oder ähnliches verpflichtend ist.
