...
*_Hinweis:_* Wenn das Feld *Zolltarifnummer* leer ist, wird automatisch der Wert `12345678` übertragen. MyToys interpretiert diese Zahl als "keine Intrastatnummer".
