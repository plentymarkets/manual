...
//TODO: Assistent Nr. 2 beschreiben. Folgendes Include kommt in Frage:

include::_textblocks/instructions/catalogue-assistant-config.adoc[]

//TODO: Schauen, dass es aussieht wie hier: https://knowledge.plentymarkets.com/maerkte/otto/otto-market#_katalog_mit_dem_assistenten_erstellen
