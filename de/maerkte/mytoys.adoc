...
* {market} kann keine HTML-Tags verarbeiten. Deshalb werden HTML-Tags beim Export entfernt. Prüfe deshalb rov allem die Marktplatz-Datenfelder *Artikelbeschreibungen* und *Aufzählungszeichen*.
...
*_Hinweis:_* Wenn das Feld nicht gefüllt ist, wird automatisch der Wert `12345678` übertragen. +
*_Tipp:_* Die Zolltarifnummer speicherst du im Menü *Artikel » Artikel bearbeiten » [Variante öffnen] » Tab: Einstellungen » Bereich: Kosten » Eingabefeld: Zolltarifnummer*.

| A_ORG_COUNTRY +
(_Pflichtangabe_)
| Entspricht dem Herkunftsland (Country of Origin, COO) der Variante. Dieses Feld kann im Katalog nicht zugeordnet werden. Stattdessen wird automatisch das Land übertragen, das in der Dropdown-Liste *Herstellungsland* des Artikels gewählt wurde. Es wird also nur ein Herstellungsland für alle Varianten eines Artikels exportieren. +
...
image::maerkte/assets/mytoys-delivery-note-settings-1.png[]
...
image::maerkte/assets/mytoys-delivery-note-settings-4.png[]
...
image::maerkte/assets/mytoys-delivery-note-settings-2.png[]

| *Externe Kundennummer*
| Option *Ja* wählen.

image::maerkte/assets/mytoys-delivery-note-settings-3.png[]
