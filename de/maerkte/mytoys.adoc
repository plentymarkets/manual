...
*_Hinweis:_* Verwende in den Eigenschaften für die Aufzählungszeichen keine HTML-Tags. {market} kann keine HTML-Tags verarbeiten. Deshalb werden HTML-Tags beim Export entfernt.
