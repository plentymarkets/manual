...
Zusätzlich zur oben beschriebenen Methode kannst du auch gezielt prüfen, bei welchen Varianten Pflichtfelder nicht ausgefüllt wurden. Nimm im Vorfeld die folgenden Einstellungen vor, um diese Informationen einsehen zu können.
