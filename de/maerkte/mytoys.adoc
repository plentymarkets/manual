...
Verknüpfe alle externen Versanddienstleister mit plentymarkets <<fulfillment/versand-vorbereiten#1000, Versandprofilen>>, die für {market}-Aufträge möglich sein sollen:
