...
*_Tipp:_* Die Eigenschaft wird in der Eigenschaftsgruppe *idealoDE* gespeichert.

! *Vorhandene Eigenschaft verknüpfen*
! Wähle eine Eigenschaft des Typs *Text* aus der Dropdown-Liste. Der Wert, der für diese Eigenschaft an den Varianten gespeichert ist, wird an idealo exportiert.
!===
