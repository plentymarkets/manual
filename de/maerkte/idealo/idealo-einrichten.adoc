...
- *Artikelexport:* Richte den <<#850, automatischen Artikelexport>> oder den <<A#900, Artikelexport per CSV-Datei>> ein, je nachdem, wie du Artikel zu idealo übertragen möchtest.
...
[#1600]
== Ereignisaktionen für idealo Direktkauf einrichten
