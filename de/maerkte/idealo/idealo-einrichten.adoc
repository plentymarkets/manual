...
- *Variantenverfügbarkeit:* Aktiviere im Menü *Artikel » Artikel bearbeiten »* _Artikel öffnen_ *» Tab: Varianten-ID » Tab: Verfügbarkeit* im Bereich *Märkte* zusätzlich zur Option *idealo* auch die <<Variantenverfügbarkeit einstellen, Verfügbarkeit>> *idealo Direktkauf*.
...
include::../_textblocks/instructions/variantenverfuegbarkeit.adoc[tags=verfuegbarkeit;web-api;idealo-direkt;!*]
...
. *_Optional:_* Wenn du noch keinen Verkaufspreis angelegt hast, klicke auf *Neu*, um einen Verkaufspreis zu erstellen.
. Aktiviere die Herkunft *idealo*.
...
:table-event-procedure: <<#stornierungen-idealo>>
