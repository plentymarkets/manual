...
- *Variantenverfügbarkeit:* Aktiviere im Menü *Artikel » Artikel bearbeiten » [Artikel öffnen] » Tab: Varianten-ID » Tab: Verfügbarkeit* im Bereich *Märkte* zusätzlich zur Option *idealo* auch die <<#500, Verfügbarkeit>> *idealo Direktkauf*.
