...
Wenn der Auftrag ein Elektrogerät enthält ung Kund:innen die Mitnahme von Altelektrogeräten wünschen, wird an den Auftragspositionen des Auftrags eine *OrderItemProperty* mit der ID 92 hinzugefügt und der Text "[inkl. Altgerätemitnahme/incl. WEEE take back]" zum Artikelnamen hinzugefügt. +
