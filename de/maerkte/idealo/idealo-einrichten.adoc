...
| Für manche idealo Direktkauf-Aufträge werden erst nach dem Import in dein plentymarkets System Stornierungsanfragen von Kund:innen gestellt. Diese Aufträge werden über einen 15-minütigen Cron abgefragt. Damit solche Aufträge für dich sichtbar sind und du sie weiter bearbeiten kannst, z.B. über Ereignisaktionen, wählst du hier einen eigenen Auftragsstatus aus, den sie zugewiesen bekommen. Die Stornierung akzeptierst du über die Ereignisaktion <<maerkte/idealo/idealo-einrichten, Stornierung durch Käufer:in akzeptieren>>.

| *Bis zu welchem Status sollen Anfragen zu Auftragsstornierungen von Kund:innen berücksichtigt werden?*
|Lege in diesem Schritt des Assistenten fest, welche der von Kund:innen stornierten Aufträge den soeben ausgewählten eigenen Auftragsstatus erhalten. Lege dafür einen Auftragsstatus fest, bis zu dem die Anfragen berücksichtigt werden. Ist ein Auftrag schon in einem höheren Auftragsstatus als der von dir hier ausgewählte, bleibt er im bestehenden Auftragsstatus und wird nicht in den Auftragsstatus für stornierte Aufträge durch Kund:innen verschoben.
