...
! Erstellt eine Eigenschaft des Typs *Text* und verknüpft diese Eigenschaft mit dem idealo-Attribut. Der Wert, der für diese Eigenschaft an den Varianten gespeichert ist, wird an idealo exportiert. +
*_Tipp:_* Die Eigenschaft wird in der Eigenschaftsgruppe *ElasticExportIdealoDE* gespeichert.

! *Vorhandene Eigenschaft verknüpfen*
! Wähle eine Eigenschaft aus der Dropdown-Liste. Der Wert, der für diese Eigenschaft an den Varianten gespeichert ist, wird an idealo exportiert.
!===
...
| Mit dieser Eigenschaft gibst du an, ob sich die Daten zur Energieeffizienz, die du in den restlichen idealo-Attributen angegeben hast, auf die alte oder die neue Energieeffizienzskala beziehen.
