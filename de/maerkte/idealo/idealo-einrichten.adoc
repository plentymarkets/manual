...
a| Du benötigst die API-Client-Zugangsdaten, damit plentymarkets auf dein idealo-Konto zugreifen kann. Dadurch kann der Artikeldatenaustausch aktiviert werden. Die Zugangsdaten generierst du in idealo Business.
|======
--
