...
* *Neue Eigenschaft erstellen* = Erstellt eine Eigenschaft und verknüpft diese Eigenschaft mit dem idealo-Attribut.
...
| *Welche plentymarkets Eigenschaft nutzt du für das Energieeffizienzklassen-Attribut "Spectrum" für idealo?*
| Mit dieser Eigenschaft exportierst du das Spektrum der verfügbaren Effizienzklassen eines Produkts an idealo. +
*_Gültige Werte:_*

* A+++, A++, A+, A, B, C, D, E, F, G (alte Klassifizierung)
* A, B, C, D, E, F, G (neue Klassifizierung) +
*_Beispiel:_* `A-G`



* *Neue Eigenschaft erstellen* = Erstellt eine Eigenschaft und verknüpft diese Eigenschaft mit dem idealo-Attribut. Der Wert, der für diese Eigenschaft an den Varianten gespeichert ist, wird an idealo exportiert.
* *Vorhandene Eigenschaft verknüpfen* = Wähle eine Eigenschaft aus der Dropdown-Liste. Der Wert, der für diese Eigenschaft an den Varianten gespeichert ist, wird an idealo exportiert.
