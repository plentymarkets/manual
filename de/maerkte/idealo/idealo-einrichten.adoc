...
:menu-path: pass:quotes[*Einrichtung » Assistenten » Plugins »* _Mandant öffnen_]
...
| *Bestände und Preise übertragen* = Preise und Bestände werden alle 15 Minuten importiert.
...
| Die URL wird benötigt, damit Kund:innen über das Preisportal in deinen Webshop weitergeleitet werden können. Varianten-URLs können nur übertragen werden, wenn du den Ceres-Shop verwendest.
Artikel-URL
Varianten-URL
...
- *Grundeinstellungen:* Durchlaufe im Menü *Einrichtung » Assistenten » Plugins »* _Mandant öffnen_ den Assistenten *idealo Grundeinstellungen*.
