...
====
Wenn du deine Artikeldaten per API (PWS 2.0-Schnittstelle) zu idealo exportieren möchtest, kontaktiere idealo unbedingt vorher unter tam@idealo.de.
====
...
! Wähle eine Eigenschaft aus der Dropdown-Liste. Du kannst eine Eigenschaft des Typs *Zeichenkette*, *Datei*, *Text*, *Ganzzahl*, *Kommazahl* oder *Auswahl* wählen. Der Wert, der für diese Eigenschaft an den Varianten gespeichert ist, wird an idealo exportiert.
!===
