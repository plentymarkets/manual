...
. *_Optional:_* Wenn du noch keinen Verkaufspreis erstellt hast, klicke auf *Neu*, um einen Verkaufspreis zu erstellen.
...
Welcher Preis als Mindestpreis für die idealo-Preisspanne an idealo übertragen werden soll, legst du im idealo-Assistenten im xArtikeldaten* mit der Einstellung *Welcher Preis soll als Mindestpreis an idealo übertragen werden?* fest. +
...
|Option *überschreiben* aktivieren und in die Felder *1* bis *10*, die die ID der Verfügbarkeit darstellen, Artikelverfügbarkeiten eingeben. Somit werden die Artikelverfügbarkeiten, die im Menü *System » Artikel » Verfügbarkeit* eingestellt wurden, überschrieben.
|====
