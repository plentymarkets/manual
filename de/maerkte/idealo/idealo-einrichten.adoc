...
| Die URL wird benötigt, damit Kund:innen über das Preisportal in deinen plentyShop weitergeleitet werden können. Varianten-URLs können nur übertragen werden, wenn du den Ceres plentyShop verwendest.
Artikel-URL
Varianten-URL
