...
| Mit welcher plentymarkets Eigenschaft pflegst du das Energieeffizienzklassen-Attribut *Energieeffizienzklasse* für idealo?
|

* *Neue Eigenschaft erstellen* = Erstellt eine Eigenschaft mit den folgenden Werten:
    **

* *Vorhandene Eigenschaft verknüpfen* = Eigenschaft aus der Dropdown-Liste wählen. Der Wert, der für diese Eigenschaft an einer Variante gespeichert ist, wird an idealo exportiert.

| Mit welcher plentymarkets Eigenschaft pflegst du das Energieeffizienzklassen-Attribut *Spectrum* für idealo?
| Mit dieser Eigenschaft exportierst du das Spektrum der verfügbaren Effizienzklassen an idealo.
...
| Mit welcher plentymarkets Eigenschaft pflegst du das Energieeffizienzklassen-Attribut *Link zum Label* für idealo?
| Mit dieser Eigenschaft exportierst du den Link zum Energielabel an idealo.

* *Neue Eigenschaft erstellen* = Erstellt eine Eigenschaft des Typs *Text*.
* *Vorhandene Eigenschaft verknüpfen* = Wähle eine Eigenschaft aus der Dropdown-Liste. Der Wert, der für diese Eigenschaft an einer Variante gespeichert ist, wird an idealo exportiert.
