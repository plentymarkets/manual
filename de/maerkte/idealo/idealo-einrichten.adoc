...
*_Hinweis:_* Der Import dieser stornierten idealo Direktkauf-Aufträge löst die für den gewählten Status eingerichteten Ereignisaktionen aus. Wähle deshalb einen Status, bei dem keine Ereignisaktionen (z.B. Stornierungsbestätigung an Kunden) ausgelöst werden.
