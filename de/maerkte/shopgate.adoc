...
| *Ziel-URL (Kategorie)*
|URL der mobilen Variante des plentyShop eingeben, z.B. *http://mobile.ihrplentyshop.de*. Auf diese URL werden Kund:innen weitergeleitet, die mit einem mobilen Endgerät auf den plentyShop zugreifen. +
