...
| *Framework-URL*
|URL der Schnittstelle. Die URL wird automatisch hinterlegt. Die Framework-URL wird nur angezeigt, wenn bei der Option *Aktiv* die Option *Ja* gewählt wurde.
...
*_Hinweis:_* Wenn hier keine URL eingegeben wird, erfolgt keine Weiterleitung von Preisportalen etc. zu den Artikeln im Webshop.
|====
