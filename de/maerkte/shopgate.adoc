...
|Wählen, ob die im Tab *Kategorie* einer Variante gespeicherte *Position* an Shopgate übertragen werden soll. Anhand dieser Position werden Artikel bei der Artikelauflistung im Webshop sortiert.
...
[#900]
== Ausgewählte Artikel mehrerer Mandanten übertragen
