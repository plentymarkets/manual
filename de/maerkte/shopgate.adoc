...
*Tipp*: Mit der Template-Variable *$ReferrerID* in der URL kann nachvollzogen werden, woher Kund*innen weitergeleitet wurden. Die URL sieht dann z.B. so aus: *http://mobile.testshop.de/?referrerId=$referrerId*
