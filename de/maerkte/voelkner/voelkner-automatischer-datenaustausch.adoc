...
ifdef::mediamarkt[]
Im Katalog werden die für Marktplatzattribute gültigen Parameter in Klammern hinter dem Attribut angezeigt. Kontaktiere die Ansprechpartner des Marktplatzes, um die zugehörigen Codes anzufragen, die an den Marktplatz übergeben werden müssen.
endif::mediamarkt[]
