...
Im Katalog werden für Marktplatzattributen die gültige Wertelisten Parameternamen in Klammern dargestellt. Die Parameternamen können im Attribut-Hilfe-Tool gesucht werden, um die korrespondierenden gütligen Werten darzustellen."
