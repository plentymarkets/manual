...
Im Katalog werden die für Marktplatzattribute gültigen Parameter in Klammern hinter dem Attribut angezeigt. Die zugehörigen Codes, die an den Marktplatz übergeben werden müssen, findest du im <<#attribut-hilfetool, Attribut-Hilfetool>> in der Spalte *Value Code*. Gib dazu den Parameter im Attribut-Hilfetool ein.
