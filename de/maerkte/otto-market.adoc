...
Wenn der Auftrag ein Elektrogerät enthält und Kund:innen die Mitnahme von Altgeräten wünschen, wird an der entesprechenden Auftragsposition des Auftrags eine *OrderItemProperty* mit der Typ-ID 92 hinzugefügt und der Text "[inkl. Altgerätemitnahme/incl. WEEE take back]" zum Artikelnamen hinzugefügt.
