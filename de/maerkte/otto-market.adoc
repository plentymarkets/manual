...
Wenn der Auftrag ein Elektrogerät enthält und Kund:innen die Mitnahme von Altelektrogeräten wünschen, wird an der entesprechenden Auftragsposition des Auftrags eine *OrderItemProperty* mit der ID 92 hinzugefügt und der Text "[inkl. Altgerätemitnahme/incl. WEEE take back]" zum Artikelnamen hinzugefügt.
