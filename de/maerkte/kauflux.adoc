...
a| Wählen, welche Artikel beim Export übertragen werden sollen. Standardmäßig sind keine Filter voreingestellt. Artikelfilter aus der Dropdown-Liste wählen und auf *Hinzufügen* klicken. Es ist möglich, alle Artikelfilter aus der Dropdown-Liste nacheinander hinzuzufügen. +
