...
Artikel, die du auf Kauflux verkaufen möchtest, müssen im Menü <<artikel/artikel-verwalten#170, Artikel » Artikel bearbeiten » Artikel öffnen » Tab: Varianten-ID>> im Tab *Verfügbarkeit* aktiviert werden.
...
Nachdem du Kauflux eingerichtet hast, kannst du deine Artikel unter *System » Systemeinstellungen » Märkte » Preisportale » Exporte* exportieren.
...
Du kannst deine Aufträge von Kauflux automatisch in dein plentymarkets System einpflegen lassen. Dazu musst du die API-URL, die du unter *System » Systemeinstellungen » Märkte » Kauflux » Einstellungen* findest, bei Kauflux hinterlegen. Nach diesem Schritt werden Aufträge automatisch in dein System eingepflegt und im Menü *Aufträge » Aufträge bearbeiten* angezeigt.
