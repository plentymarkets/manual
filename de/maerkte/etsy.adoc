...
*_Fehlerbehebung:_* Du wirst auf die Startseite deines plentyShops weitergeleitet? Dann ist dein plentyShop wahrscheinlich gesperrt.
...
| *Anlass*; +
*Empfänger*
| Wenn du zusätzlich zu der Shop-Sprache "Deutsch" auch weitere Exportsprachen verwendest, musst du die Werte für dieses Marktplatz-Datenfeld auf Englisch angeben.
|====
...
Du hast auf Etsy die Funktion *Anfragen für Spezialanfertigungen* nicht aktiviert. Im Katalog hast du aber dem Marktplatz-Datenfeld *Personalisierbar* ein plentymarkets Datenfeld zugeordnet.

*_Lösung:_*

* Aktiviere auf Etsy die Funktion *Anfragen für Spezialanfertigungen*.
