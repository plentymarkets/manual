...
[#550]
== _Optional:_ Existierende Etsy Listing-ID hinterlegen

Wenn du bereits auf Etsy listest, hinterlege die Etsy Listing-ID als SKU für die Herkunft *Etsy*. So können Artikel beim Artikelexport den bereits auf Etsy gelisteten Artikel zugewiesen werden und Überverkäufe werden verhindert. +

[.instruction]
Etsy Listing-ID hinterlegen:
