...
*_Fehlerbehebung:_* Die Seite *Hier entsteht dein plentymarkets Shop* wird angezeigt?
Dann entsperre kurzfristig deinen Webshop im Menü *Einrichtung » Mandant » Standard » Webshop » Shop sperren*. Sperre den Shop wieder, wenn die Authentifizierung abgeschlossen ist.
