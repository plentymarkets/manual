...
:author: none
:keywords: Etsy, Marktplatz, Multi-Channel, Marktplatz, Etsy einrichten, Etsy Marktplatz, Multi-Channel, Multichannel, Multi-Channel Etsy, Multichannel Etsy, multi channel Etsy, dawanda, Etsy einrichten, Etsy-Plugin, Etsy Plugin
...
und nimmst Einstellungen zu den Exportsprachen vor. Standardmäßig wird die Shop-Sprache exportiert
