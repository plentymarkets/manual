...
:author: none
:keywords: Etsy, Marktplatz, Multi-Channel, Etsy einrichten, Etsy Marktplatz, Multichannel, Multi-Channel Etsy, Multichannel Etsy, multi channel Etsy, dawanda, Etsy-Plugin, Etsy Plugin
...
====
Bei *Etsy* handelt es sich um ein Plugin. Um das Etsy-Plugin nutzen zu können, lade es im plentyMarketplace herunter.
====
...
. Klicke auf das Weltkugel-Icon, um neue Credentials hinzuzufügen. +
...
. Wähle die Sprache aus, für die rechtliche Hinweise hinterlegt werden sollen.
. Gib deinen Text ein.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
