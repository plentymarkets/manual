...
====
Bevor du das Etsy-Plugin in plentymarkets einrichtest, muss bei Etsy im Menü *Shop-Manager » Artikel »* _Artikel öffnen_ die Option *Erneuerungsoptionen* auf *Manuell* gestellt werden, da das Etsy-Plugin sonst nicht korrekt funktioniert.
====
