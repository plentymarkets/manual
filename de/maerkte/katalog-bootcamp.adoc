...
Auf dieser Handbuchseite erfährst du, wie du Kataloge verwendest, um Variantendaten an Marktplätze zu exportieren. In den Beispielen auf dieser Seite wird der Marktplatz limango verwendet. limango wurde für die Beispiele gewählt, weil für den Marktplatz pro System nur ein Katalog erstellt wird. So lässt sich das Prinzip der Kataloge gut veranschaulichen.

[#10]
== Grundsätzliches: Was ist ein Katalog?

Jeder Marktplatz strukturiert Produktdaten anders. Häufig müssen sogar an denselben Marktplatz unterschiedliche Produktdaten für verschiedene Produktkategorien (Tierfutter, Haushalt, Lebensmittel) exportiert werden.

Mit Katalogen mit Marktplatz-Format schneidest du die Informationen zu deinem Produktsortiment genau auf die Anforderungen des Marktplatzes zu. Denn in Katalogen mit Marktplatz-Formaten ordnest du jedem Datenfelder eines Marktplatzes ein passendes plentymarkets Datenfeld zu. Beim Export deiner Variantendaten zu den Marktplatz werden dann die Datenfelder des Marktplatzes mit den richtigen Daten aus plentymarkets befüllt.
...
Marktplatz-Datenfelder sind die Felder, für die du Variantendaten an den Marktplatz exportieren kannst. Weil jeder Marktplatz Artikeldaten anders aufbaut und verarbeitet, unterscheiden sich auch die Marktplatz-Datenfelder der einzelnen Marktplätze.

[[marketplace-data-fields]]
.Marktplatz-Datenfelder im Katalog für OTTO Market
image::assets/catalogue-bootcamp/marketplace-data-fields.png[]
...
image::assets/catalogue-bootcamp/plentymarkets-data-fields.png[]

*_Das solltest du über Marktplatz-Datenfelder wissen:_*

* Der Marktplatz verlangt Produktdaten, die nicht direkt an der Variante gespeichert werden können? Dann erstelle eine Eigenschaft und speichere die
Produktdaten als Werte für diese Eigenschaft. +
*_Beispiel:_* Der Marktplatz REWE kennt die Größenangabe "Durchmesser". Da du keine Durchmesserangaben an der Variante speichern kannst, erstellst du eine Eigenschaft und verknüpfst diese Eigenschaft im Katalog mit dem Marktplatz-Datenfeld *Durchmesser*.

[#3040]
=== Ausweich-Datenfelder

Als Ausweich-Datenfelder stehen dir wieder alle plentymarkets Datenfelder zur Verfügung. Der Unterschied ist, dass der Inhalt des Ausweich-Datenfelds nur exportiert wird, wenn das zugeordnete Datenfeld für eine Variante nicht existiert oder leer ist. Der Ablauf ist also so:
...
image::assets/catalogue-bootcamp/fallback-data-fields.png[]

[#40]
== Das kleine 1x1 der Datenfeld-Zuordnungen

*Mit einer Zuordnung legst du fest: Ich möchte, dass dieses Marktplatz-Datenfeld mit den Daten aus dieser plentymarkets Einstellung befüllt wird.*
...
Bei einer 1:1-Zuordnung ordnest du dem Markplatz-Datenfeld eine Einstellung in plentymarkets zu. Zusätzlich gibst du ein Ausweich-Datenfeld an, damit das System weitersucht, wenn ein plentymarkets-Datenfeld nicht befüllt ist.

* Ich möchte, dass dieses Marktplatz-Datenfeld mit den Daten aus dieser plentymarkets Einstellung befüllt wird.
* Wenn das Datenfeld für eine Variante leer ist, wird das Ausweich-Datenfeld geprüft und dieser Wert für die Variante exportiert.
...
Bei einer 1:n-Zuordnung ordnest du dem Markplatz-Datenfeld mehrere Einstellungen in plentymarkets zu.

[#4020]
== Eigener-Wert-Zuordnungen: 1 Marktplatz-Datenfeld, für jede Variante derselbe Wert
