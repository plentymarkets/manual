...
Auf dieser Handbuchseite erfährst du, wie du Kataloge verwendest, um Variantendaten an Marktplätze zu exportieren. In den Beispielen auf dieser Seite wird der Marktplatz Etsy verwendet. Etsy wurde für die Beispiele gewählt, weil für den Marktplatz pro System nur ein Katalog erstellt wird. So lässt sich das Prinzip der Kataloge besonders gut veranschaulichen.
...
[#30]
== Datenfelder: Welche Arten von Datenfeldern gibt es?
...
Screenshot mit Datenfeldern


[#3020]
=== Marktplatz-Datenfeld

* Pflichtfelder sind im Katalog mit einem Sternchen gekennzeichnet. Für diese Pflichtfelder müssen auf jeden Fall Daten exportiert werden.
* Für alle optionalen Datenfelder kannst du Daten exportieren, um deine Verkaufschancen zu steigern.
...
Den Marktplatz-Datenfeldern ordnest du plentymarkets Datenfelder zu. Die plentymarkets Datenfelder entsprechen den Einstellungen, die du für deine Artikel und Varianten vornehmen kannst. Für jede Einstellung eines Artikels gibt es also auch ein Datenfeld im Katalog.



*Durch die Zuordnung legst du also fest: Ich möchte, dass das Marktplatz-Datenfeld XY mit den Daten aus dem plentymarkets Backend befüllt wird, die in dieser Einstellung gespeichert sind.*
...
Als Ausweich-Datenfelder stehen dir wieder alle plentymarkets Datenfelder zur Verfügung. Der Unterschied ist, dass der Inhalt des Ausweich-Datenfelds nur exportiert wird, wenn das als erstes zugeordnete Datenfeld nicht existiert oder leer ist. Genauso funktioniert es, wenn du mehrere Ausweich-Datenfelder angibst: Beim Export wird jedes Feld einzeln abgeklappert. Sobald ein Feld befüllt ist, wird dieser Inhalt exportiert. Wenn das Datenfeld nicht existiert oder leer ist, springt das System zum nächsten Datenfeld und prüft, ob es hier Daten findet. 

[#40]
== (Fast) alles über Zuordnungen

[#4010]
== 1:1-Zuordnungen

Hier steht bald (hoffentlich) eine richtig tolle Erklärung!

In einer 1:1-Beziehung ist ein Datensatz in einer Tabelle mit einem und nur einem Datensatz in einer anderen Tabelle verknüpft.
...
In einer 1:n-Beziehung kann ein Datensatz in einer Tabelle mit einem oder mehreren Datensätzen in einer anderen Tabelle verknüpft sein.
...
[#65]
=== _Optional:_ Katalog als Datei exportieren (nicht für Markplatzexport)
