...
* Ein Marktplatz-Format stellt ein Gerüst der Datenfelder bereit, die ein Marktplatz entgegennehmen kann. Über das Marktplatz-Formate gibt der Marktplatz also vor, welche Daten übertragen werden können. Es ist auch sofort ersichtlich, welche Daten du unbedingt übertragen musst und welche optional sind.
...
* Der Marktplatz verlangt Produktdaten, die nicht direkt an der Variante gespeichert werden können? Dann erstelle eine Eigenschaft. Verknüpfe diese Eigenschaft dann mit deinen Varianten und speichere einen Wert.
...
*Mit einer Zuordnung legst du fest: Ich möchte, dass dieses eine Marktplatz-Datenfeld mit den Daten aus dieser einen plentymarkets Einstellung befüllt wird.*
...
image::assets/catalogue-bootcamp/catalogue-durchmesser.png[]
...
Wie du einen Katalog für die einzelnen Marktplätze erstellst, erfährst du auf der Handbuchseite des Marktplatzes.
