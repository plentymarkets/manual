...
Kataloge dienen dazu, Daten für den Export ideal vorzubereiten. Für den Export von Variantendaten an Marktplätze und Preisportale verwendest du Kataloge mit Marktplatz-Formaten.

plentymarkets arbeitet daran, alle Marktplätze auf den Katalogexport umzuziehen. Zurzeit kannst du zum Beispiel Artikeldaten zu den folgenden Marktplätzen per Katalog exportieren:
...
Auf dieser Handbuchseite erfährst du, wie du Kataloge verwendest, um Variantendaten an Marktplätze zu exportieren. Dabei wird die allgemeine Vorgehensweise erläutert. Genauere Informationen dazu, wie du die Kataloge für die einzelnen Marktplätze erstellst und aufbaust, erfährst du aber auf den Handbuchseiten der einzelnen Marktplätze.
