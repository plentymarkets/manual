...
Kataloge dienen dazu, Daten für den Export ideal vorzubereiten. Für den Export von Variantendaten an Marktplätze und Preisportale benötigst du Kataloge mit Marktplatz-Formaten. plentymarkets arbeitet daran, alle Marktplätze auf den Katalogexport umzuziehen.

Zurzeit kannst du zum Beispiel den Export zu den folgenden Marktplätzen per Katalog einrichten:

* REWE
* OTTO Market
* Amazon (je nach Flatfile)
* Etsy
* Voelkner
* Conrad
...
* Ein Marktplatz-Format stellt ein Gerüst der Daten bereit, die ein Marktplatz entgegennehmen kann. Über ein Marktplatz-Formate gibt der Marktplatz also vor, welche Daten übertragen werden können und müssen.
...
Als Ausweich-Datenfelder stehen dir wieder alle plentymarkets Datenfelder zur Verfügung. Der Unterschied ist, dass der Inhalt des Ausweich-Datenfelds nur exportiert wird, wenn das zugeordnete Datenfeld für eine Variante nicht existiert oder leer ist.
...
* Ich möchte, dass dieses Marktplatz-Datenfeld mit den Daten aus diesen plentymarkets Einstellungen befüllt wird.



[#4020]
== Zuordnungen "Eigener Wert": 1 Marktplatz-Datenfeld, für jede Variante derselbe Wert
