...
| *Shop-Typ*
|Zeigt das gebuchte Shop-Paket bei Hood an, z.B. link:https://www.hood.de/hood-shop-einrichten.htm[Platin^]{nbsp}icon:external-link[].
|====
...
Das Einstellen von Artikeln und Abrufen von Aufträgen ist ohne aktiven Shop bei Hood möglich. Für einige Optionen, z.B. wenn du Variantenartikel einstellen möchtest, ist jedoch ein Shop nötig, den du in verschiedenen Ausführungen bei Hood link:https://www.hood.de/hood-shop-einrichten.htm[buchen^]{nbsp}icon:external-link[] kannst.

[#1000]
=== Variantenartikel einstellen

Wenn du Variantenartikel bei Hood einstellen möchtest, benötigst du einen gebuchten Shop. Wenn du einen Shop bei Hood gebucht hast, werden die Artikel für Hood über eine Kategorieverknüpfung dort eingebunden. Die Shop-Kategorien selbst richtest du direkt bei link:https://www.hood.de/tips/924/artikel-anlegen.htm[Hood^]{nbsp}icon:external-link[] ein. Lade die Kategorien anschließend in plentymarkets, damit du diese im Listing wählen kannst.
...
Beispiele: link:http://www.sellerfox.de/[http://www.sellerfox.de, window="_new"], link:http://www.ayee.net/[http://www.ayee.net, window="_new"]{nbsp}icon:external-link[]
...
Mehrere Listings erstellst du per *Gruppenfunktion* oder per *Stapelverarbeitung* im Menü *Artikel*. Bei der Gruppenfunktion werden Listings für zuvor gewählte Artikel erstellt. Bei der Stapelverarbeitung werden Listings für zuvor gefilterte Artikel erstellt. Wenn für die gewählten Artikel im Menü *Artikel » Artikel bearbeiten »* _Artikel öffnen_ *» Tab: Multi-Channel* im Bereich *Listing-Voreinstellungen* keine *Listing-Vorlage* eingestellt ist, werden automatisch eBay-Listings erstellt. Um mehrere Hood-Listings zu erstellen, stelle sicher, dass im Menü *Artikel » Artikel bearbeiten »* _Artikel öffnen_ *» Tab: Multi-Channel* im Bereich *Listing-Voreinstellungen* eine *Listing-Vorlage* mit Hood-spezifischen Einstellungen gewählt wurde.
...
Du kannst per Gruppenfunktion und Stapelverarbeitung Listing-Vorlagen erstellen, bearbeiten und löschen. In Listing-Vorlagen speicherst du Einstellungen und kannst die Einstellungen dann immer wieder auf Listings anwenden, ohne die Einstellungen erneut vorzunehmen. Listing-Vorlagen können sowohl auf einzelne Listings angewendet als auch für die Gruppenfunktion und die Stapelverarbeitung verwendet werden. Die Listing-Vorlagen werden dann entweder im Menü *Artikel » Artikel bearbeiten »* _Artikel öffnen_ *» Tab: Multi-Channel* ausgewählt, bevor Listings über die Gruppenfunktion oder Stapelverarbeitung erstellt werden, oder im Bearbeitungsfenster *Neues Market-Listing*, während ein einzelnes Listing erstellt wird.
