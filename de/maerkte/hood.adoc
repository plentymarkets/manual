...
. Öffne das Menü *System » Systemeinstellungen » Märkte » Hood*.
...
Richte nach diesem Schema weitere Versandprofile ein. Die Versandprofile stehen dann im <<maerkte/hood#2300, Listing>> im Tab *Base* zur Verfügung.
...
. Öffne das Menü *System » Systemeinstellungen » Märkte » Hood » Versandprofilverknüpfungen*.
...
Die Zahlungsarten, die du für den Marktplatz benötigst, richtest du zunächst in deinem Konto bei Hood ein. Wähle zwischen mehreren Optionen wie z.B. Vorkasse per Überweisung, Kauf auf Rechnung oder PayPal. Die Zahlungsarten stehen im Listing zur Verfügung.
...
→ Das Fenster *Neue Ereignisaktion erstellen* wird geöffnet.
. Gib einen Namen ein.
. Wähle das *Ereignis* gemäß <<automatische-versandbestätigung>>.
. *Speichere* die Einstellungen. +
→ Das Ereignis wird erstellt.
. Nimm die weiteren Einstellungen gemäß <<automatische-versandbestätigung>> vor.
. Setze ein Häkchen bei *Aktiv*.
. *Speichere* die Einstellungen. +
→ Die Ereignisaktion wird gespeichert.
--
...
→ Das Fenster *Neue Ereignisaktion erstellen* wird geöffnet.
. Gib einen Namen ein.
. Wähle das *Ereignis* gemäß <<automatische-zahlungsbestätigung>>.
. *Speichere* die Einstellungen. +
→ Das Ereignis wird erstellt.
. Nimm die weiteren Einstellungen gemäß <<automatische-zahlungsbestätigung>> vor.
. Setze ein Häkchen bei *Aktiv*.
. *Speichere* die Einstellungen. +
→ Die Ereignisaktion wird gespeichert.
--
...
Das Einstellen von Artikeln und Abrufen von Aufträgen ist ohne aktiven Shop bei Hood möglich. Für einige Optionen, z.B. wenn du Variantenartikel einstellen möchtest, ist jedoch ein Shop nötig, den du in verschiedenen Ausführungen bei Hood link:https://www.hood.de/hood-shop-einrichten.htm[buchen^] kannst.

[#1000]
=== Variantenartikel einstellen

Wenn du Variantenartikel bei Hood einstellen möchtest, benötigst du einen gebuchten Shop. Wenn du einen Shop bei Hood gebucht hast, werden die Artikel für Hood über eine Kategorieverknüpfung dort eingebunden. Die Shop-Kategorien selbst richtest du direkt bei link:https://www.hood.de/tips/924/artikel-anlegen.htm[Hood^] ein. Lade die Kategorien anschließend in plentymarkets, damit du diese im Listing wählen kannst.

[.instruction]
Shop-Kategorien für Hood laden:

. Öffne das Menü *System » Systemeinstellungen » Märkte » Hood*.
. Klicke im Bereich *Shop-Kategorien* auf *Aktualisieren*. +
...
. Aktiviere die Einstellung *Anzeige als Hood-Merkmal*.
. *Speichere* die Einstellungen. +
...
Im Menü *System » Systemeinstellungen » Listings* nimmst du Einstellungen vor, die für alle Listings, unabhängig vom Marktplatz, gelten. Um Listings in plentymarkets zu erstellen, musst du die hier beschriebenen Einstellungen vornehmen und deine <<artikel/artikel-verwalten#20, Artikel>> vollständig erstellt haben.
...
*Status 1* = Kund*innen werden durch die Bestellabwicklung geleitet und müssen aktiv die Schritte durchgehen. Dabei befinden sie sich im Webshop und werden animiert, weitere Artikel zu kaufen. +
...
|Wählen, wie die Versandkosten berechnet werden, wenn Kund*innen während der Kaufabwicklung die erworbene Menge erhöhen. +
...
plentymarkets bietet dir mehrere Möglichkeiten, Listings zu erstellen. Du musst im Vorfeld deine <<artikel/artikel-verwalten#20, Artikel>> vollständig erstellen. Dann erstellst du Listings in der Artikelübersicht, mittels Stapelverarbeitung oder über ein bereits vorhandenes Listing. Verwende das Datenformat <<daten/export-import/datenformate/itemlistingmarkethood#, ItemListingMarketHood>>, um neue Hood-Listings zu erstellen, bestehende Hood-Listings zu bearbeiten oder um umfangreiche Artikelbestände automatisiert zu erstellen.
...
Mehrere Listings erstellst du per *Gruppenfunktion* oder per *Stapelverarbeitung* im Menü *Artikel*. Bei der Gruppenfunktion werden Listings für zuvor gewählte Artikel erstellt. Bei der Stapelverarbeitung werden Listings für zuvor gefilterte Artikel erstellt. Wenn für die gewählten Artikel im Menü *Artikel » Artikel bearbeiten » Artikel öffnen » Tab: Multi-Channel* im Bereich *Listing-Voreinstellungen* keine *Listing-Vorlage* eingestellt ist, werden automatisch eBay-Listings erstellt. Um mehrere Hood-Listings zu erstellen, stelle sicher, dass im Menü *Artikel » Artikel bearbeiten » Artikel öffnen » Tab: Multi-Channel* im Bereich *Listing-Voreinstellungen* eine *Listing-Vorlage* mit Hood-spezifischen Einstellungen gewählt wurde.
...
. Filtere die Artikel.
. Aktiviere im Abschnitt *Aktionen* die Einstellung *Listing erstellen*. +
→ Einstellungen, die nicht dazu passen, werden ausgegraut.
...
Ein Market-Listing kopierst du, wenn du z.B. das gleiche Listing in einer anderen Variante auf Hood einstellen willst. Die Kopie des Listings hat die gleichen Einstellungen wie das Original. Ändere also nach dem Kopieren nur noch die Variante.
...
In plentymarkets hast du mehrere Möglichkeiten, Listings automatisch zu starten bzw. Listings erneut zu starten, nachdem sie bereits eingestellt wurden. Mit dem Verkaufsplaner legst du *Startzeiten* für Listings fest. Den Verkaufsplaner richtest du im Menü *System » Systemeinstellungen » Listings » Verkaufsplaner* ein.
...
Du kannst per Gruppenfunktion und Stapelverarbeitung Listing-Vorlagen erstellen, bearbeiten und löschen. In Listing-Vorlagen speicherst du Einstellungen und kannst die Einstellungen dann immer wieder auf Listings anwenden, ohne die Einstellungen erneut vorzunehmen. Listing-Vorlagen können sowohl auf einzelne Listings angewendet als auch für die Gruppenfunktion und die Stapelverarbeitung verwendet werden. Die Listing-Vorlagen werden dann entweder im Menü *Artikel » Artikel bearbeiten » Tab Sonstige » Tab: eBay-Optionen* ausgewählt, bevor Listings über die Gruppenfunktion oder Stapelverarbeitung erstellt werden oder im Bearbeitungsfenster *Neues Market-Listing*, während ein einzelnes Listing erstellt wird.
...
. Wähle in der Dropdown-Liste *Vorgang* die Option *ItemListingControllerHood* oder *LeaveFeedback*.
...
Für den Austausch von Daten zwischen plentymarkets und Hood steht dir ElasticSync im Menü *Daten » ElasticSync* zur Verfügung. Verwende den Sync-Typ <<daten/daten-importieren/sync-typen/elasticsync-market-listing#, Market-Listing>>, um Listing-Daten in plentymarkets zu importieren.
