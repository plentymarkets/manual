...
:author: none
:keywords: Hood, Marktplatz, Listing, Layout-Vorlage, Multi-Channel, Marktplatz, Hood einrichten, Hood Marktplatz, Multi-Channel, Multichannel, Multi-Channel Hood, Multichannel Hood, multi channel hood, hood.de
...
Um eigene Merkmale für den Marktplatz Hood nutzen zu können, müssen die Merkmale im Menü *Einrichtung » Artikel » Merkmale* mit Hood verknüpft werden. Maximal sind 12 Merkmale pro Artikel und maximal 16 Zeichen pro Name erlaubt.
...
Im Menü *Einrichtung » Listings* nimmst du Einstellungen vor, die für alle Listings, unabhängig vom Marktplatz, gelten. Um Listings in plentymarkets zu erstellen, musst du die hier beschriebenen Einstellungen vornehmen und deine <<artikel/artikel-verwalten#20, Artikel>> vollständig erstellt haben.
...
Du kannst per Gruppenfunktion und Stapelverarbeitung Listing-Vorlagen erstellen, bearbeiten und löschen. In Listing-Vorlagen speicherst du Einstellungen und kannst die Einstellungen dann immer wieder auf Listings anwenden, ohne die Einstellungen erneut vorzunehmen. Listing-Vorlagen können sowohl auf einzelne Listings angewendet als auch für die Gruppenfunktion und die Stapelverarbeitung verwendet werden. Die Listing-Vorlagen werden dann entweder im Menü *Artikel » Artikel bearbeiten » Artikel öffnen » Tab: Multi-Channel* ausgewählt, bevor Listings über die Gruppenfunktion oder Stapelverarbeitung erstellt werden, oder im Bearbeitungsfenster *Neues Market-Listing*, während ein einzelnes Listing erstellt wird.
...
Für den Austausch von Daten zwischen plentymarkets und Hood steht dir ElasticSync im Menü *Daten » Import* zur Verfügung. Verwende den Sync-Typ <<daten/daten-importieren/sync-typen/elasticsync-market-listing#, Market-Listing>>, um Listing-Daten in plentymarkets zu importieren.
