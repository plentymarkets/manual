...
*_Hinweis:_* Pflichtfelder, die an den Marktplatz übertragen werden müssen, sind mit *** gekennzeichnet. Diesen Feld muss ein plentymarkets Datenfeld zugeordnet werden, da ansonsten keine Daten für das Feld des Marktplatzes übertragen werden können.
