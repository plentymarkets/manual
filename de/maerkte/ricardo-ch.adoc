...
Mehrere Listings erstellst du per *Gruppenfunktion* oder per *Stapelverarbeitung* im Menü *Artikel*. Bei der Gruppenfunktion werden Listings für zuvor gewählte Artikel erstellt. Bei der Stapelverarbeitung werden Listings für zuvor gefilterte Artikel erstellt. Wenn für die gewählten Artikel im Menü *Artikel » Artikel bearbeiten » Artikel öffnen » Tab: Multi-Channel* im Bereich *Listing-Voreinstellungen* keine *Listing-Vorlage* eingestellt ist, werden automatisch eBay-Listings erstellt. Um mehrere ricardo-Listings zu erstellen, stelle sicher, dass im Menü *Artikel » Artikel bearbeiten » Artikel öffnen » Tab: Multi-Channel* im Bereich *Listing-Voreinstellungen* eine *Listing-Vorlage* mit ricardo-spezifischen Einstellungen gewählt wurde.
...
Ein Market-Listing kopierst du, wenn du z.B. das gleiche Listing in einer anderen Variante auf ricardo einstellen möchtest. Die Kopie des Listings hat die gleichen Einstellungen wie das Original. Ändere also nach dem Kopieren nur noch die Variante.
...
In plentymarkets hast du mehrere Möglichkeiten, Listings automatisch zu starten oder Listings erneut zu starten, nachdem sie bereits eingestellt wurden. Mit dem Verkaufsplaner legst du *Startzeiten* für Listings fest. Den Verkaufsplaner richtest du im Menü <<Verkaufsplaner einrichten, System » Systemeinstellungen » Listings » Verkaufsplaner>> ein.
...
. Öffne das Menü *Listings » Aktive Listings*.
. Öffne ein Market-Listing.
. Aktiviere im Tab <<Grundeinstellungen vornehmen, Base>> die Einstellung *Endloslister*. +
...
Du kannst per Gruppenfunktion und Stapelverarbeitung Listing-Vorlagen erstellen, bearbeiten und löschen. In Listing-Vorlagen speicherst du Einstellungen und kannst die Einstellungen dann immer wieder auf Listings anwenden, ohne die Einstellungen erneut vorzunehmen. Listing-Vorlagen können sowohl auf einzelne Listings angewendet als auch für die Gruppenfunktion und die Stapelverarbeitung verwendet werden. Die *Listing-Vorlagen* werden dann entweder im Menü *Artikel » Artikel bearbeiten » Artikel öffnen » Tab: Multi-Channel* im Bereich *Listing-Voreinstellungen* ausgewählt, bevor Listings über die Gruppenfunktion oder Stapelverarbeitung erstellt werden oder im Bearbeitungsfenster *Neues Market-Listing* während ein einzelnes Listing erstellt wird.
...
Im Menü *Daten » API-Log » Tab: API-Log* findest du eine Historie über Vorgänge, die über die ricardo.ch-Schnittstelle ausgeführt wurden. Das Format *ItemListingControllerRicardo* steht dir für ricardo.ch zur Verfügung.

[.instruction]
API-Log abrufen:

. Öffne das Menü *Daten » API-Log*.
. Wähle das Format *ItemListingControllerRicardo* oder *LeaveFeedback* aus der Dropdown-Liste *Vorgang*.
...
[.indented]
Du hast bei den ricardo-Optionen des Listings bei Garantie, Zahlungskonditionen oder Lieferkonditionen *Gemäss Beschreibung* ausgewählt. Du musst diese Bedingungen noch unter *System » Systemeinstellungen » Märkte » ricardo » Einstellungen* in den Untermenüs *Garantiebedingungen*, *Zahlungskonditionen* und *Lieferkonditionen* hinterlegen.

===== Ich kann bei den ricardo-Einstellungen eines Listings keine Auswahl bzgl. Zahlungsmethoden etc. vornehmen.

[.indented]
Aktualisiere die Optionen für die ricardo-Marktplätze unter *System » Systemeinstellungen » Märkte » ricardo » Konten* im Bereich *Optionen aktualisieren*.
