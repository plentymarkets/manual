...
Im Menü *Daten » API-Log* findest du eine Historie über Vorgänge, die über die ricardo.ch-Schnittstelle ausgeführt wurden. Das Format *ItemListingControllerRicardo* steht dir für ricardo.ch zur Verfügung.
