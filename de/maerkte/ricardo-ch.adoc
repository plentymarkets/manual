...
.if-Logik verwenden
====
In Layout-Vorlagen kann <<webshop/webshop-einrichten/cms-syntax#grundlagen-if, if-Logik>> nach den Regeln des <<webshop/webshop-einrichten/cms#webdesign, Webdesigns in plentymarkets>> verwendet werden.
====
