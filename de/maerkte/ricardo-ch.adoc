...
:keywords: ricardo, Listing, Marktplatz, Layout-Vorlage, ricardo.ch, ricardo einrichten, ricardo Marktplatz, Multi-Channel, Multichannel, Multichannel ricardo, Multichannel ricardo.ch, Multi-Channel ricardo, Multi-Channel ricardo.ch, Multi Channel ricardo, Multi Channel ricardo.ch
...
Mit der Einstellung *Optionen aktualisieren* im Menü *Einrichtung » Märkte » ricardo » Konten* aktualisierst du Einstellungen von Listings und behebst Probleme wie z.B. die fehlende Auswahl der Zahlungsmethoden eines ricardo.ch-Listings.
...
Mehrere Listings erstellst du per *Gruppenfunktion* oder per *Stapelverarbeitung* im Menü *Artikel*. Bei der Gruppenfunktion werden Listings für zuvor gewählte Artikel erstellt. Bei der Stapelverarbeitung werden Listings für zuvor gefilterte Artikel erstellt. Wenn für die gewählten Artikel im Menü *Artikel » Artikel bearbeiten »* _Artikel öffnen_ *» Tab: Multi-Channel* im Bereich *Listing-Voreinstellungen* keine *Listing-Vorlage* eingestellt ist, werden automatisch eBay-Listings erstellt. Um mehrere ricardo-Listings zu erstellen, stelle sicher, dass im Menü *Artikel » Artikel bearbeiten »* _Artikel öffnen_ *» Tab: Multi-Channel* im Bereich *Listing-Voreinstellungen* eine *Listing-Vorlage* mit ricardo-spezifischen Einstellungen gewählt wurde.
...
| *Verzeichnis*
|Verzeichnis, in das das Listing im Menü *Listing » Listing bearbeiten »* _Listing öffnen_ *» Tab: Base* einsortiert wurde.
...
Du kannst per Gruppenfunktion und Stapelverarbeitung Listing-Vorlagen erstellen, bearbeiten und löschen. In Listing-Vorlagen speicherst du Einstellungen und kannst die Einstellungen dann immer wieder auf Listings anwenden, ohne die Einstellungen erneut vorzunehmen. Listing-Vorlagen können sowohl auf einzelne Listings angewendet als auch für die Gruppenfunktion und die Stapelverarbeitung verwendet werden. Die *Listing-Vorlagen* werden dann entweder im Menü *Artikel » Artikel bearbeiten »* _Artikel öffnen_ *» Tab: Multi-Channel* im Bereich *Listing-Voreinstellungen* ausgewählt, bevor Listings über die Gruppenfunktion oder Stapelverarbeitung erstellt werden oder im Bearbeitungsfenster *Neues Market-Listing* während ein einzelnes Listing erstellt wird.
...
* *ItemListingControllerRicardo* (Meldungen von ricardo.ch, z.B. zu fehlerhaften Listings)
...
Für den Austausch von Daten zwischen plentymarkets und ricardo steht dir ElasticSync im Menü *Daten » Import* zur Verfügung. Verwende den Sync-Typ <<daten/daten-importieren/sync-typen/elasticsync-market-listing#, Market-Listing>>, um Listing-Daten in plentymarkets zu importieren.
