...
* _Merkmal nicht mit Artikel verknüpft_ = Du versendest die Varianten des Artikels.
* _Merkmal mit Artikel verknüpft_ = bol.com versendet die Varianten des Artikels (FBB/LVB).
...
* _Merkmal nicht mit Artikel verknüpft_ = Varianten des Artikels sind neu.
* _Merkmal mit Artikel verknüpft_ = Varianten des Artikels sind gebraucht.
...
Um eine Variante über Fullfilment by bol.com (FBB oder LVB) zu verkaufen, sind die in <<#table-bol-fbb>> beschriebenen Einstellungen erforderlich:
