...
. Öffne das Menü *System » Systemeinstellungen » Märkte » bol.com » Einstellungen*.
...
Damit du Artikel, Merkmale etc. mit bol.com verknüpfen kannst, muss im Menü *System » Systemeinstellungen » Aufträge » Auftragsherkunft* die Auftragsherkunft bol.com aktiviert werden.
...
Artikel, die du auf bol.com verkaufen möchtest, müssen im Menü <<artikel/artikel-verwalten#170, Artikel » Artikel bearbeiten » Artikel öffnen » Tab: Varianten-ID>> im Tab *Verfügbarkeit* aktiviert werden.
...
. Öffne das Menü *System » Systemeinstellungen » Märkte » bol.com » Kategorieverknüpfung*.
. Klicke auf *Suchen*.  +
...
. Nimm weitere Einstellungen für Artikelfilter und Formateinstellungen vor. Beachte dazu die Erläuterungen in Tabelle 5 auf der Handbuchseite <<daten/export-import/daten-exportieren#60, Daten über dynamischen Export exportieren>>.
. *Speichere* die Einstellungen. +
