...
|Ist der Datenaustausch aktiviert, werden Daten zu Angeboten und Aufträgen mit bol.com ausgetauscht. Weitere Informationen findest du unterhalb der Tabelle im Kapitel *Prozesse*.
