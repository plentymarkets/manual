...
* Im Tab *Eigenschaften* der Variante muss unter *Varianteneigenschaften* der Eigenschaftswert für die bol.com-Kategorie verknüpft sein. Der Eigenschaftswert hat denselben Namen wie die bol.com-Kategorie und der Katalog.
