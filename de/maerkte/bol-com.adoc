...
Nutze optional die in <<#tabelle-referenztypen>> aufgeführten Referenztypen und Referenzwerte, um die Suchergebnisse zu filtern:
...
Alle Fehlermeldungen, die durch Fehler im Prozess oder fehlerhafte API-Anfragen verursacht werden, sind außerdem über die Referenztypen *variationId* und *sku* mit entsprechenden Referenzwerten abrufbar.
