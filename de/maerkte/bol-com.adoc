...
|Ist der Datenaustausch aktiviert, findet ein täglicher Artikelexport, ein stündlicher Bestandsabgleich und ein viertelstündlicher Auftragsimport statt. Retouren werden automatisch mit dem Status [9.00] importiert.
...
* Einmal stündliche Aktualisierung von Angeboten für Varianten, deren Bestand in den letzten 90 Minuten aktualisiert wurde +
*_Hinweis:_* Die Erstellung des Angebots muss abgeschlossen sein, bevor Bestandsaktualisierungen gesendet werden können. Der Status der Angebotserstellung wird einmal täglich geprüft. Es kann also bis zu 24 Stunden dauern, bis ein Angebot nach der Erstellung erstmals aktualisiert wird.
...
[#800]
== bol.com über Retouren informieren

Richte eine <<automatisierung/ereignisaktionen#, Ereignisaktion>> ein, um bol.com automatisch über Retouren zu informieren, die Kund*innen vorher nicht bei bol.com angemeldet haben. Bei Retouren muss ein Status an bol.com übertragen werden. Ab API-Version 3.0 können folgende Retourenstatus an bol.com übertragen werden:
...
[IMPORTANT]
.Nur für bestimmte Retouren
====
Diese Ereignisaktion kann nur für Retouren verwendet werden, bei denen sich Kund*innen direkt an dich wenden und die Retoure vorher nicht bei bol.com angemeldet haben.
====
...
|Wähle einen Referenzwert, um nach nach Ereignisaktionen eines bestimmten Typs zu suchen. +
*shippingConfirmation* = Filtert nach Ereignisaktionen des Typs *Versandbestätigung an bol.com senden*. +
