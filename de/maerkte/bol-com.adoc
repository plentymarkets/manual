...
Als nächstes erstellst du <<artikel/einstellungen/eigenschaften#100, Merkmale>> und verknüpfst diese Merkmale mit den bol.com-Merkmalen. Die passenden Merkmale zu einer bol.com-Kategorie entnimmst du der bol.com-Datei Datamodel. Die bol.com Datamodel-Datei kannst du link:https://developers.bol.com/datamodel/[hier^]{nbsp}icon:external-link[] herunterladen.
...
* Im Tab *Verfügbarkeit* der Variante müssen im Bereich *Märkte* die Marktplatzverfügbarkeiten *bol.com* oder *bol.com FBB* hinzugefügt werden. +
