...
[IMPORTANT]
.Bis 30.09.2021 Artikelexport auf Kataloge umstellen!
====
Die API v3 von bol.com wird am 30.09.2021 deaktiviert. Erstelle daher vor dem 30.09.2021 Kataloge für deinen Artikelexport. (<<#600, Wie?>>)
====
...
.Coming soon...
--
Die Optionen zum Erstellen eines Katalogs sind bisher nur im Assistenten selbst beschrieben. Folge also einfach den Anweisungen in deinem System.
--
