...
. Öffnen Sie das Menü *System » Systemeinstellungen » Märkte » bol.com » Einstellungen*.
...
Damit Sie Artikel, Merkmale etc. mit bol.com verknüpfen können, muss im Menü *System » Systemeinstellungen » Aufträge » Auftragsherkunft* die Auftragsherkunft bol.com aktiviert werden.
...
. Öffnen Sie das Menü *System » Systemeinstellungen » Märkte » bol.com » Kategorieverknüpfung*.
...
Aktivieren Sie die <<payment/zahlungsarten-verwalten#, Zahlungsart>> *BOL.com*, wie im Folgenden beschrieben.
...
Richten Sie eine <<automatisierung/ereignisaktionen#, Ereignisaktion>> ein, um Versandbestätigungen automatisch an bol.com zu senden, nachdem ein Warenausgang gebucht wurde.
...
.  Nehmen Sie die weiteren Einstellungen gemäß <<ereignisaktion-versandbestätigung-bol>> vor.
...
Richten Sie eine <<automatisierung/ereignisaktionen#, Ereignisaktion>> ein, um bol.com automatisch über den Status einer Retoure zu informieren. Bei Retouren muss ein Status an bol.com übertragen werden. Folgende Stornierungsgründe können an bol.com übertragen werden:
...
. *Speichern* Sie die Einstellungen. +
→ Das Ereignis wird erstellt.
.  Nehmen Sie die weiteren Einstellungen gemäß <<ereignisaktion-retourenstatus-bol>> vor.
.  Setzen Sie ein Häkchen bei *Aktiv*.
. *Speichern* Sie die Einstellungen. +
→ Die Ereignisaktion wird gespeichert.
--
...
Richten Sie eine <<automatisierung/ereignisaktionen#, Ereignisaktion>> ein, um bol.com automatisch über Stornierungen zu informieren. Bei Stornierungen muss ein Grund für die Stornierung an bol.com übertragen werden. Erstellen Sie im Menü *System » Systemeinstellungen » Aufträge » Auftragsstatus* ggf. zusätzliche Auftragsstatus. Folgende Stornierungsgründe können an bol.com übertragen werden:
...
. *Speichern* Sie die Einstellungen. +
→ Das Ereignis wird erstellt.
.  Nehmen Sie die weiteren Einstellungen gemäß <<ereignisaktion-stornierungen-bol>> vor.
.  Setzen Sie ein Häkchen bei *Aktiv*.
. *Speichern* Sie die Einstellungen. +
→ Die Ereignisaktion wird gespeichert.
--
