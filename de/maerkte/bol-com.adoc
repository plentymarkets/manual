...
* Fullfilment by bol.com (FBB/LVB) = Der Versand erfolgt durch bol.com.

Beachte, dass plentymarkets Fullfilment by bol.com nur eingeschränkt unterstützt. Du kannst deine Varianten zwar auf für Fullfilment by bol.com zu bol.com exportieren. Allerdings werden FBB-Aufträge und -Retouren nicht in plentymarkets importiert. Auch ein Bestandsableich zwischen dem bol-Fulfillment-Lager und plentymarkets ist nicht möglich.

Um eine Variante über Fullfilment by bol.com (FBB oder LVB) zu verkaufen, sind die in <<#table-bol-fbb>> Einstellungen erforderlich:

[[table-bol-fbb]]
.Einstellungen für bol.com FBB
[cols="1,3a"]
|====
|Einstellung |Erläuterung

| Merkmal verknüpfen
| Merkmal *bol_fulfillment* erstellen und mit Variante verknüpfen.
...
[.instruction]
Merkmal bol_fulfillment erstellen:
...
. Gib in der Zeile *bol.com-Merkmal* den Text *bol_fulfillment* ein.
. *Speichere* (icon:save[role="green"]) die Einstellungen.

[.instruction]
Merkmal bol_fulfillment mit Artikel verknüpfen:

. Öffne das Menü *Artikel » Artikel bearbeiten*.
. Öffne den Artikel.
. Wechsele in das Tab *Merkmale*.
. Aktiviere im Bereich *Weitere Merkmale aktivieren* das Merkmal für *bol_fulfillment*.
. *Speichere* (icon:save[role="green"]) die Einstellungen. +
...
| Verfügbarkeit
a| Marktplatzverfügbarkeit *bol.com FBB* an der Variante aktivieren.
...
[.instruction]
Marktplatzverfügbarkeit bol.com FBB aktivieren:
...
| *bol_fulfillment*
| Mit einem Merkmal *bol_fulfillment* steuerst du, ob die Varianten des Artikels von dir oder von bol.com versendet wird.

* _Merkmal nicht mit Artikel verknüpft_ = Du versendest die Varianten.
* _Merkmal mit dem Artikel verknüpft_ = bol.com versendet die Varianten (FBB/LVB).

Gib beim Erstellen des Merkmals in der Zeile *bol.com-Merkmal* das bol.com-Merkmal *bol_fulfillment* ein.
...
* _Merkmal nicht mit Artikel verknüpft_ = Artikel ist neu.
* _Merkmal mit dem Artikel verknüpft_ = Artikel ist gebraucht.
