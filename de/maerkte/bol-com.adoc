...
| *Format*
|Format *BolItemExport* für den Artkelexport aus der Dropdown-Liste wählen.
...
Im Menü *Daten » API-Log* findest du eine Historie über Vorgänge, die über die bol.com-Schnittstelle ausgeführt wurden.
