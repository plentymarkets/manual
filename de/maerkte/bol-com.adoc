...
* _Merkmal ist nicht mit Artikel verknüpft_ = Du versendest die Varianten des Artikels.
* _Merkmal ist mit Artikel verknüpft_ = bol.com versendet die Varianten des Artikels (FBB/LVB).
