...
. Gib in der Zeile *bol.com-Merkmal* das bol.com-Merkmal ein, wie aus der Datamodel-Datei in der Spalte *Attribute name* entnommen.
. *Speichere* (icon:save[role="green"]) die Einstellungen.

*bol_fulfillment* ist ein Pflichtfeld für den Angebotsexport. Dabei gibst du an, ob der Artikel direkt von dir oder von bol.com versendet wird. Gib dazu in der Zeile *bol.com-Merkmal* das bol.com-Merkmal *bol_filfillment* ein.

Wenn du gebrauchte Artikel über bol.com verkaufen möchtest, musst du den gebrauchten Zustand der Artikel über das Merkmal *bol_used* angeben. Gib dazu in der Zeile *bol.com-Merkmal* das bol.com-Merkmal *bol_used* ein.
