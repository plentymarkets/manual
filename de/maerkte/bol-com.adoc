...
:catalogue-note: Für jede bol.com-Kategorie benötigst du einen eigenen Katalog.
...
Mit dem Assistenten hast du bereits wichtige Pflichtfelder zugeordnet. Nachdem du den Assistenten abgeschlossen hast, musst du aber noch weitere Datenfelder zuordnen, um noch mehr Informationen zu deinen Produkten an bol.com zu übermitteln.

:catalogue-assistant:
include::_textblocks/instructions/katalog-datenfelder-zuordnen.adoc[]


[#mappings-market-specific]
