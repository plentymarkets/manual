...
*_Hinweis:_* Sobald Client ID und Client Secret gespeichert wurden, werden Daten über API-Version 3.0 mit bol.com ausgetauscht.
...
*_Hinweis:_* Die Erstellung des Angebots muss abgeschlossen sein, bevor Bestandsaktualisierungen gesendet werden können. Der Erstellungsstatus wird einmal täglich geprüft. Es kann also bis zu 24 Stunden dauern, bis ein Angebot nach der Erstellung erstmals aktualisiert wird.
...
* Retoure unvollständig (v2)
* Rückerstattung ohne Rücksendung (v2)
////
