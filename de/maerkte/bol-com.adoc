...
Als nächstes erstellst du <<artikel/einstellungen/eigenschaften#100, Merkmale>> und verknüpfst diese mit den bol.com-Merkmalen. Die passenden Merkmale zu einer bol.com-Kategorie entnimmst du der bol.com-Datei Datamodel. Die bol.com Datamodel-Datei kannst du link:https://developers.bol.com/datamodel/[hier^]{nbsp}icon:external-link[] herunterladen.
