...
a|Ist der Datenaustausch aktiviert, werden die folgenden Daten mit bol.com ausgetauscht: +

* viertelstündlicher Bestandsabgleich +
* stündlicher Preisabgleich +
* stündlicher Auftragsimport
* stündliche Angebotserstellung für neue oder reaktivierte Varianten +
...
* *Verfügbarkeit:* Im Tab *Verfügbarkeit* einer Variante müssen im Bereich *Märkte* die Marktplatzverfügbarkeiten *bol.com* oder *bol.com FBB* hinzugefügt werden.
