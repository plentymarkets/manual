...
Nachdem du die Schnittstelle zu bol.com in plentymarkets eingerichtet hast, stehen die in  <<#datenaustausch>> gelisteten automatisierten Abläufe bereit.
...
Artikeldaten werden über Kataloge zu bol.com exportierst. Mit dem Assistenten *Kataloge erstellen - bol.com* erstellst du ein Marktplatz-Format pro bol.com-Kategorie.
...
Nachdem du einen Katalog erstellt hast, ordnest du die Datenfelder des Marktplatzes den in plentymarkets gespeicherten Artikeldaten zu. In diesem Kapitel erfährst du, wie du Datenfelder zuordnest und welche Besonderheiten es bei {market} gibt. Außerdem findest du hier Empfehlungen für eine korrekte Zuordnung. Die Informationen sind wie folgt aufgebaut:

* <<#data-field-mappings, Datenfelder im Katalog zuordnen>>
* <<#special-mappings, Besonderheiten bei der Zuordnung von Datenfeldern>>
...
| Name
a| An der Variante muss ein Name in der Sprache *Niederländisch* gespeichert sein.
...
| Artikelbeschreibung
a| An der Variante muss eine Beschreibung in der Sprache *Niederländisch* gespeichert sein.
...
| Eigenschaft für bo.com-Kategorie
a| Die Variante muss mit der Eigenschaft für die bol.com-Kategorie verknüpft sein. Diese Eigenschaft wird automatisch erstellt, wenn du den Assistenten abschließt.

* Im Tab *Eigenschaften* der Variante muss unter *Varianteneigenschaften* die Eigenschaft für die bol.com-Kategorie verknüpft sein. Die Eigenschaft hat denselben Namen wie die bol.com-Kategorie und der Katalog.
...
== Varianten mit BOL-Kategoriegruppe verknüpfen

Nachdem du mit dem Assistenten das erste Marktplatz-Format für bol.com erstellt hast, wird in deinem plentymarkets System die Eigenschaft *BOL-Kategoriegruppe* erstellt. Für jede bol.com-Kategorie, für die du einen Katalog erstellst, wird ein neuer Auswahlwert zur Eigenschaft *BOL-Kategoriegruppe* hinzugefügt. Dieser Auswahlwert hat denselben Namen wie die bol.com-Kategorie und der Katalog.

Damit deine Varianten im gewünschten Katalog exportiert werden, müssen sie im *Tab: Eigenschaften* einer Variante mit der Eigenschaft *BOL-Kategoriegruppe* verknüpft werden.

[.instruction]
Variante mit BOL-Kategoriegruppe verknüpfen:
