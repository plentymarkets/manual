...
. Öffne das Menü *System » Systemeinstellungen » Märkte » Fruugo » Einstellungen*.
...
Damit du Artikel, Merkmale etc. mit Fruggo verknüpfen kannst, muss im Menü *System » Systemeinstellungen » Aufträge » Auftragsherkunft* die Auftragsherkunft Fruggo aktiviert werden.
...
Artikel, die du auf Fruugo verkaufen möchtest, müssen im Menü <<artikel/artikel-verwalten#170, Artikel » Artikel bearbeiten » Artikel öffnen » Tab: Varianten-ID>> im Tab *Verfügbarkeit* aktiviert werden.
...
Im Menü <<basics/datenaustausch/api-log#, Daten » API-Log>> findest du eine Historie über Vorgänge, die über die Fruugo-Schnittstelle ausgeführt wurden. Folgende Formate stehen dir für Fruugo zur Auswahl:
