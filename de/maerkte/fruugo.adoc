...
:keywords: Fruugo, Multi-Channel, Marktplatz, Fruugo einrichten, Fruugo Marktplatz, Multi-Channel, Multichannel, Multi-Channel Fruugo, Multichannel Fruugo, multi channel Fruugo, Froogo, Frougo, Frugo
...
[TIP]
.Alle Varianten eines Artikels auf Fruugo verkaufen
====
Wenn du alle Varianten eines Artikels auf Fruugo verkaufen möchtest, nimm die unten beschriebenen Einstellungen an der Hauptvariante vor. Die Einstellungen werden dann an alle Varianten des Artikels vererbt.
====

[.instruction]
Variantenverfügbarkeit für Fruugo einstellen:

. Öffne das Menü *Artikel » Artikel bearbeiten » Artikel öffnen » Tab: Varianten-ID » Tab: Einstellungen*.
. Öffne die Variante, die du auf Fruugo verkaufen möchtest.
