...
4. *Speichere* (icon:save[role="green"]) die Einstellungen. +
...
| *Produkt-URL*
|Wählen, ob die URL des Artikels oder der Variante an BeezUP übertragen wird. Varianten URLs können nur in Kombination mit dem Ceres Webshop übertragen werden.
