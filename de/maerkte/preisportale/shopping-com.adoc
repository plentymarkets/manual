...
| Diese Einstellung muss aktiviert sein, da Shopping.com nur spezifische Werte akzeptiert, die hier eingegeben werden müssen. Weitere Informationen dazu findest du im Kapitel <<Verfügbare Spalten der Exportdatei, Verfügbare Spalten der Exportdatei>>.
