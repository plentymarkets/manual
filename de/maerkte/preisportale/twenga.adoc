...
Twenga.com ist eine internationale Shopping-Plattform und bietet einen umfassenden Preisvergleich. Um das Plugin für Twenga.com in plentymarkets einzurichten, musst du dich zunächst bei link:https://www.surveymonkey.de/r/LVX5W8K[MyBestBrands.de^] registrieren.
...
Artikeldaten werden von Twenga über eine URL abgerufen. Damit deine Artikeldaten zu Twenga übertragen werden können, hinterlege die URL bei Twenga.
...
. Speichere die im Feld *URL* angezeigte URL bei Twenga.
...
. Öffne das Menü *Daten » Elastischer Export*.
. Klicke in der Zeile des Formats *TwengaCOM-Plugin* auf *Herunterladen* (icon:download[role="purple"]). +
