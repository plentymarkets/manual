...
Artikeldaten werden von Geizhals.de über eine URL abgerufen. Damit deine Artikeldaten zu Geizhals.de übertragen werden können, hinterlege die URL bei Geizhals.de.
...
→ Eine ID für das Exportformat *GeizhalsDE-Plugin* wird vergeben. +
→ Das Exportformat wird in der Übersicht *Exporte* angezeigt.
. Speichere die im Feld *URL* angezeigte URL bei Geizhals.de.
