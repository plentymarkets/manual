...
Mit dem Export über Kataloge machst du deinen Export zu {market} zukunftssicher und flexibler denn je.
...
Wenn nur bestimmte Artikel zu {market} exportieren möchtest, kannst du optional Filter setzen.
