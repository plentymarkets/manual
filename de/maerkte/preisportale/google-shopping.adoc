...
Um das Plugin für Google Shopping in plentymarkets einzurichten, musst du dich zunächst bei link:https://support.google.com/merchants/answer/188924?hl=de[Google Shopping^]{nbsp}icon:external-link[] als Händler registrieren.


[#200]
== Das Format GoogleShopping-Plugin in plentymarkets einrichten

:exportformat: GoogleShopping-Plugin
:preisportal: GoogleShopping
:tabelle-preisportal: <<#einstellungen-google-shopping>>
...
Das gesamte Projekt unterliegt der GNU AFFERO GENERAL PUBLIC LICENSE – weitere Informationen findest du in der link:https://github.com/plentymarkets/plugin-elastic-export-google-shopping/blob/master/LICENSE.md[LICENSE.md^]{nbsp}icon:external-link[].
