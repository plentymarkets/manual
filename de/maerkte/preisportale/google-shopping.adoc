...
====
Um Artikeldaten zu Google Shopping exportieren zu können, benötigst du die Plugins link:https://marketplace.plentymarkets.com/plugins/channels/preisportale/elasticexportgoogleshopping_4722[Google Shopping^] und link:https://marketplace.plentymarkets.com/plugins/sales/marktplaetze/elasticexport_4763[Elastischer Export^]. Die Plugins kannst du im link:https://marketplace.plentymarkets.com/[plentyMarketplace^] herunterladen.
====
...
Um das Plugin für Google Shopping in plentymarkets einzurichten, musst du dich zunächst bei link:https://support.google.com/merchants/answer/188924?hl=de[Google Shopping^] als Händler registrieren.
...
Sobald beide Plugins in deinem System installiert sind, kann das Exportformat *GoogleShopping-Plugin* erstellt werden. Weitere Informationen findest du auf der Handbuchseite <<daten/daten-exportieren/elastischer-export#, Elastischer Export>>.

Artikeldaten werden von GoogleShopping über eine URL abgerufen. Damit deine Artikeldaten zu GoogleShopping übertragen werden können, hinterlege die URL bei GoogleShopping.
...
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#einstellungen-google-shopping>>.
...
. Speichere die im Feld *URL* angezeigte URL bei GoogleShopping.

In <<#einstellungen-google-shopping>> findest du Hinweise zu den einzelnen Formateinstellungen und empfohlenen Artikelfiltern für das Format *GoogleShopping-Plugin*.

[[einstellungen-google-shopping]]
.Formateinstellungen für Google Shopping
[cols="1,3"]
|====
...
| *Dateiname*
|Der Dateiname muss auf *.csv* oder *.txt* enden, damit Google Shopping die Datei erfolgreich importieren kann.
...
. Öffne das Menü *Daten » Elastischer Export*.
. Klicke in der Zeile des Formats *GoogleShopping-Plugin* auf *Herunterladen* (icon:download[role="purple"]). +
...
Das gesamte Projekt unterliegt der GNU AFFERO GENERAL PUBLIC LICENSE – weitere Informationen findest du in der link:https://github.com/plentymarkets/plugin-elastic-export-google-shopping/blob/master/LICENSE.md[LICENSE.md^].
