...
Anders als bei anderen Marktplatz-Formaten kannst du für dieses Format nicht einfach den Katalog aktivieren und so den Export starten. Stattdessen exportierst du das Marktplatz-Format manuell in eine CSV-Datei und reichst diese Datei dann auch manuell an die Preissuchmaschine weiter.
