...
Mit dem Format *Basic Price Search Engine* kannst du Artikeldaten exportieren, um sie an eine beliebige Preissuchmaschine zu übergeben. Du kannst Artikeldaten zuordnen, die die meisten Preissuchmaschinen erwarten.

TIP: Bevor du den Export einrichtest, kannst du im link::https://marketplace.plentymarkets.com/plugins/sales/preisportale[plentyMarketplace] prüfen, ob plentymarkets oder ein Drittunternehmen eine direkte Schnittstelle zu der Preissuchmaschine anbietet, auf der du deine Produkte verkaufen möchtest.
...
Setze nun Filter, um nur die gewünschten Artikel zu dem Preisportal zu exportieren. Wie du Filter setzt, erfährst du auf der Seite <<daten/daten-exportieren/kataloge-verwalten#, Kataloge verwalten>>.
...
* Diese Liste ist neu und wird stetig erweitert. Bitte habe etwas Geduld, falls es für ein Marktplatz-Datenfeld noch keine Empfehlung gibt. Unsere Supporter:innen helfen dir bei Fragen zur Zuordnung gern weiter.
