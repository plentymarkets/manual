...
Anders als bei anderen Marktplatz-Formaten kannst du für dieses Format nicht einfach den Katalog aktivieren und damit den Export zur Preissuchmaschine starten. Stattdessen speicherst du die URL des Katalogexports bei der Preissuchmaschine.
