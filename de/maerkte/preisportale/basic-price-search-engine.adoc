...
TIP: Bevor du das Plugin *Basic Price Search Engine* einrichtest kannst du <<maerkte#, in der Liste der Marktplätze und Preissuchmaschinen>> prüfen, ob plentymarkets eine direkte Schnittstelle zu der Preissuchmaschine anbietet, auf der du deine Produkte anbieten möchtest.

[#200]
== Häufigkeit des Datenaustauschs

Nachdem du das Plugin installiert und eingerichtet hast, stehen die in <<#datenaustausch-preissuchmaschine>> gelisteten automatisierten Abläufe bereit:

[[datenaustausch-preissuchmaschine]]
.Häufigkeit des Datenaustauschs
[cols="1,3a"]
|====
|Daten |Intervall
