...
====
Um Artikeldaten mit dem Basic Price Search Engine-Plugin übertragen zu können, benötigst du die Plugins link:https://marketplace.plentymarkets.com/plugins/channels/preisportale/elasticexportbasicpricesearchengine_4777[Basic Price Search Engine^] und link:https://marketplace.plentymarkets.com/plugins/sales/marktplaetze/elasticexport_4763[Elastischer Export^]. Die Plugins kannst du im link:https://marketplace.plentymarkets.com/[plentyMarketplace^]{nbsp}icon:external-link[] herunterladen.
====
...
. Öffne das Menü *Daten » Elastischer Export*.
. Klicke in der Zeile des Formats *BasicPriceSearchEngine-Plugin* auf *Herunterladen* (icon:download[role="purple"]). +
...
Das gesamte Projekt unterliegt der GNU AFFERO GENERAL PUBLIC LICENSE – weitere Informationen findest du in der link:https://github.com/plentymarkets/plugin-elastic-export-basic-price-search-engine/blob/master/LICENSE.md[LICENSE.md^]{nbsp}icon:external-link[].
