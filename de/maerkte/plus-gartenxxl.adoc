...
icon:map-signs[] *_Oder:_* Als Alternative kannst du ein Merkmal für die Grundpreispflicht erstellen. Dieses Merkmal überschreibt die Einstellung für die Option *Grundpreisanzeige*. Weitere Informationen dazu findest du im Kapitel <<Merkmal für Grundpreispflicht erstellen, Merkmal für Grundpreispflicht erstellen>>.
