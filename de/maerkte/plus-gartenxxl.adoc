...
Nachdem du die Schnittstelle zu {market} eingerichtet hast, stehen die in <<#data-exchange>> gelisteten automatisierten Abläufe bereit:
...
TIP: Diese Verknüpfungen benötigst du nicht mehr, wenn du deine Artikeldaten über Kataloge zu Netto Marken-Discount exportierst.
...
Mit <<artikel/einstellungen/eigenschaften#100, Eigenschaften>> verknüpfst du Produktinformationen mit deinen Varianten, die du für die Einrichtung von Netto Marken-Discount benötigst.

[#800]
=== Provisionssätze festlegen

Erstelle eine Eigenschaft, um für jede Variante einen Provisionssatz zu exportieren.

Normalerweise vereinbarst du einen Standardprovisionssatz. Für bestimmte Netto eStores-Warengruppen können aber andere Provisionen gelten.
