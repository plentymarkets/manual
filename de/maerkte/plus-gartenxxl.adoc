...
Mit dem Plugin link:xxxx[Netto Marken-Discount^]{nbsp}icon:external-link[] werden Artikeldaten über ein Katalog-Format zu Netto Marken-Discount übertragen. Kataloge erstellst du im Menü *Daten » Kataloge*.
...
Um Artikeldaten über ein Katalog-Format an Netto Marken-Discount zu exportieren, installiere zuerst das Plugin link:xxxx[Netto Marken-Discount^]{nbsp}icon:external-link[] in deinem plentymarkets System. Dieses und viele andere Plugins findest du im link:https://marketplace.plentymarkets.com/[plentyMarketplace^]{nbsp}icon:external-link[].

:plugin: Netto Marken-Discount
...
Ordne nun die Datenfelder von Netto Marken-Discount den in plentymarkets gespeicherten Artikeldaten zu.
...
[.collapseBox]
.Liste mit empfohlenen Datenfeld-Zuordnungen für Netto Marken-Discount
--
