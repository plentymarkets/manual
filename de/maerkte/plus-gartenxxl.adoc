...
Für Artikel, die du auf Netto verkaufst, muss verpflichtend angegeben werden, ob der Artikel einen Grundpreis hat. Im Menü *Artikel » Artikel bearbeiten » [Artikel öffnen] » [Variante öffnen] » Tab: Einstellungen* gibst du mit der Option *Grundpreisanzeige* an, ob ein Artikel einen Grundpreis benötigt. Wenn du die Option *Grundpreisanzeige* nicht aktivierst, wird *nein* übertragen. Der Artikel wird als nicht grundpreispflichtig gekennzeichnet.
