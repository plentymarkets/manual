...
Artikel, die du auf Netto verkaufen möchtest, müssen im Menü *Artikel » Artikel bearbeiten »* _Artikel öffnen_ *» Tab: Varianten-ID* im Tab *Verfügbarkeit* aktiviert werden.
...
Für Artikel, die du auf Netto verkaufst, muss verpflichtend angegeben werden, ob der Artikel einen Grundpreis hat. Im Menü *Artikel » Artikel bearbeiten »* _Artikel öffnen_ *» Tab: Varianten-ID » Tab: Einstellungen* gibst du mit der Option *Grundpreisanzeige* an, ob ein Artikel einen Grundpreis benötigt.
