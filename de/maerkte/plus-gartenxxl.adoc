...
link:https://shop.netto-online.de/[Netto Marken-Discount]{nbsp}icon:external-link[] bietet Produkte aus den Kategorien Lebensmittel, Drogerie, Wohnen, Haushalt, Garten und Freizeit an (Quelle: https://shop.netto-online.de).
...
Hier lädst du die Vorlagendatei für link:https://cdn02.plentymarkets.com/pmsbpnokwu6a/frontend/pdf-template_netto_simple.pdf[Netto Marken-Discount^]{nbsp}icon:external-link[] als PDF-Datei herunter.
