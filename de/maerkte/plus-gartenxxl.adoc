...
Für die Auszeichnung deiner Artikel für Netto Marken-Discount gemäß der neuen Verordnung der EU zur Energieeffizienzrichtlinie sind seit 1.1.2015 Angaben zur Energieeffizienz sowie die Bereitstellung von Produktdatenblättern vorgeschrieben. Erstelle dazu die folgenden drei <<artikel/einstellungen/eigenschaften#100, Merkmale>>: *Energieeffizienzklasse*, *Energieetikett* und *Produktdatenblatt*.
...
Die Merkmale verknüpfst du dann wie im Folgenden beschrieben im Tab <<artikel/einstellungen/eigenschaften#100, Merkmale>> eines Netto eStores-Artikels.
