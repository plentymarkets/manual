...
====
Netto Marken-Discount versendet die Rechnung an die Kund:innen. Deshalb erhältst du von Netto die Lieferadresse, aber nicht die Rechnungsadresse von Kund:innen. Die von Netto Marken-Discount übertragene Lieferadresse wird in plentymarkets als Liefer- und Rechnungsadresse hinterlegt. Du schickst die Ware an diese Adresse.
====
