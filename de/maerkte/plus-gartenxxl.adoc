...
Hier lädst du die Vorlagendatei für link:https://cdn02.plentymarkets.com/pmsbpnokwu6a/frontend/ElasticSync_BestPractice/netto_pdf_Lieferscheinrohling.pdf[Netto Marken-Discount^]{nbsp}icon:external-link[] als PDF-Datei herunter. +
*_Hinweis:_* Beachte, dass die korrekte Firmierung bei Dropshipment "Netto Digital - NeS GmbH" ist.
