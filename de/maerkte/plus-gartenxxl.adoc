...
Gehe wie im Folgenden beschrieben vor, um für die Auftragsherkunft Netto einen Verkaufspreis festzulegen.
...
Mit <<artikel/einstellungen/eigenschaften#100, Eigenschaften>> verknüpfst du bestimmte Artikelinformationen, die du für die Einrichtung von Netto Marken-Discount benötigst, mit deinen Artikeln. Du trägst bei Bedarf von den Standardeinstellungen abweichende Provisionen und Kategorieverknüpfungen auf Artikelebene ein. Über Merkmalfilter übermittelst du außerdem Artikelinformationen und legst Filter für die Artikelsuche auf den Marktplätzen fest.
...
[#901]
=== Voraussetzungen für Artikelexport zu Netto Marken-Discount
