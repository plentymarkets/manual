...
.  Öffnen Sie das Menü *System » Systemeinstellungen » Märkte » Allyouneed » Einstellungen*.
...
| Verfügbarkeit wählen. Artikel mit den gewählten Verfügbarkeiten werden übertragen. Die Optionen für Artikelverfügbarkeit werden im Menü <<artikel/artikel-verwalten#190, *System » Systemeinstellungen » Artikel » Verfügbarkeit*>> eingerichtet.
...
Damit Sie Artikel, Merkmale etc. mit Allyouneed verknüpfen können, muss im Menü *System » Systemeinstellungen » Aufträge » Auftragsherkunft* die Auftragsherkunft Allyouneed aktiviert werden.
...
.  Öffnen Sie das Menü *System » Systemeinstellungen » Märkte » Allyouneed » Kategorieverknüpfung*.
