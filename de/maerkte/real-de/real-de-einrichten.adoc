...
|Diese Einstellung ist ausschließlich dafür bestimmt, die real.de-Versandgruppen mit den plentymarkets Versandprofilen zu verknüpfen. Sind an einem Artikel mehrere Versandprofile gespeichert, wird das Versandprofil mit der niedrigsten Kategorie und der höchsten Priorität exportiert. Die Kategorie und Priorität des Versandprofils werden unter *System » Aufträge » Versand » Optionen » Tab: Versandprofile* im jeweiligen Versandprofil im Tab *Base* eingestellt. +
