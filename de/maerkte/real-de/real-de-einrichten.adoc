...
link:https://www.real.de[real.de^]{nbsp}icon:external-link[] gehört zu den größten Festpreismarktplätzen Deutschlands. Auf Kaufland.de kannst du Artikel aus zahlreichen Produktkategorien verkaufen. Die Zahlungsabwicklung übernimmt Kaufland.de für dich, d.h. du trägst weder Paymentkosten noch Inkassorisiko. +
...
Um die Schnittstelle zu Kaufland.de nutzen zu können, musst du dein Kaufland.de-Benutzerkonto als Händlerkonto registrieren. Rufe dazu auf der link:https://www.real.de/seller/new/[real.de-Website^]{nbsp}icon:external-link[] den Bereich *Mein Konto* auf und gib dort deine Umsatzsteuer-Identifikationsnummer ein.
...
a| * *Ja* (Standardeinstellung) = Angebote werden stündlich und täglich bei Kaufland.de aktualisiert. Nur wenn diese Option und die Option *Schnittstelle zu real.de aktivieren* aktiviert sind, findet der tägliche vollständige Angebotsabgleich und der stündliche Abgleich für geänderte Angebote statt. +
...
| *Lager*
a| Wählen, aus welchen Lagern Bestand zu Kaufland.de übertragen werden soll. Ein Lager oder *Summe aus allen Lagern* wählen. +
...
Weitere Informationen zur Merkmalverknüpfung bei Kaufland.de findest du auf der Best Practice-Seite <<maerkte/real-de/best-practices-real-merkmalverknuepfung#, Merkmale mit Attributen verknüpfen>>.
...
====
Es kann vorkommen, dass deine Unterkategorien nicht mit denen von real.de übereinstimmen. Verknüpfe deine Artikel in diesem Fall mit der passenden Hauptkategorie von Kaufland.de. Kaufland.de ordnet deine Artikel automatisch einer Unterkategorie zu. Artikel, die keiner Kaufland.de-Kategorie zugeordnet wurden, solltest du nicht an real.de übertragen.
====
