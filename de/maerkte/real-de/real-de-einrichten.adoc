...
|plentymarkets Artikelverfügbarkeiten einer minimalen und maximalen Lieferzeit in Tagen zuordnen. +
In den Feldern *Minimale Lieferzeit (in Werktagen)* und *Maximale Lieferzeit (in Werktagen)* die minimale und maximale Lieferzeit in Tagen eingeben, die der plentymarkets Artikelverfügbarkeit entspricht. +
