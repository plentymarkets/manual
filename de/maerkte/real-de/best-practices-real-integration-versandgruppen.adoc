...
In plentymarkets unter *System » Systemeinstellungen » Märkte » real.de » Einstellungen* für den entsprechenden Mandanten die Versandgruppen von real.de importieren. Dafür gibt es die Schaltfläche *Versandgruppen aktualisieren* im Bereich *Versandprofile verknüpfen*.
