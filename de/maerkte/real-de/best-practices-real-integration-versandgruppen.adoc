...
:keywords: Versand, real.de, hitmeister, real Versandgruppen, real Versandeinstellungen, Versandprofil, Versandgruppen aktualisieren
:position: 20
...
Bei *real.de* die *Versandgruppen* unter *Händlereinstellungen » Versandeinstellungen* einrichten.
