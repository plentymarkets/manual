...
. Öffne das Menü *System » Systemeinstellungen » Märkte » Yatego » Einstellungen*.
...
Damit du Artikel, Merkmale etc. mit Yatego verknüpfen kannst, muss im Menü *System » Systemeinstellungen » Aufträge » Auftragsherkunft* die Auftragsherkunft Yatego aktiviert werden.
...
. Öffne das Menü *System » Systemeinstellungen » Märkte » Yatego » Kategorieverknüpfung*.
...
<div class="plentyInfoBoxContent">Den <strong>Web-Token</strong> findest du in plentymarkets im Menü <b>Einstellungen &gt; Grundeinstellungen &gt; API-Daten</b> und dort unter <strong>WebToken</strong>.</div></div>
