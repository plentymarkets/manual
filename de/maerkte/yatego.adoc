...
:keywords: Yatego, Marktplatz, yatego.com, Yatego einrichten, Yatego Marktplatz, Multi-Channel, Multichannel, Multi-Channel Yatego, Multichannel Yatego, Multi channel Yatego
...
Artikel, die du auf Yatego verkaufen möchtest, müssen im Menü *Artikel » Artikel bearbeiten » Artikel öffnen » Tab: Varianten-ID* im Tab *Verfügbarkeit* aktiviert werden.

[TIP]
.Alle Varianten eines Artikels auf Yatego verkaufen
====
Wenn du alle Varianten eines Artikels auf Yatego verkaufen möchtest, nimm die unten beschriebenen Einstellungen an der Hauptvariante vor. Die Einstellungen werden dann an alle Varianten des Artikels vererbt.
====


[.instruction]
Variantenverfügbarkeit für Yatego einstellen:

. Öffne das Menü *Artikel » Artikel bearbeiten » Artikel öffnen » Tab: Varianten-ID » Tab: Einstellungen*.
. Öffne die Variante, die du auf Yatego verkaufen möchtest.
...
[.indented]
Varianten, für die im Menü *Artikel » Artikel bearbeiten » Artikel öffnen » Tab: Varianten-ID » Tab: Einstellungen » Bereich » Sichtbarkeit* für die Option *Beschränkung* die Einstellungen *Keine* oder *Keinen WB für diese Variante führen* ausgewählt wurde, werden mit dem Wert *-1* an Yatego übermittelt. So erkennt Yatego, dass es sich um eine unbeschränkt kaufbare Variante handelt.
