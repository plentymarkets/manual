...
| *Versandkosten*
a| * *Porto pro Artikel aufsummieren* = plentymarkets überträgt hier pro Artikel die für den Webshop gültigen Versandkosten (Inland). Kauft ein Kunde bei Yatego zwei Artikel, werden dabei die Versandkosten der einzelnen Artikel aufsummiert. Zusätzlich dazu werden die in Yatego hinterlegten Versandkosten zu den von plentymarkets übergebenen Versandkosten addiert. +
