...
--
Varianten, für die im Menü *Artikel » Artikel bearbeiten » [Artikel öffnen] » [Variante öffnen] » Tab: Einstellungen » Bereich » Sichtbarkeit* für die Option *Beschränkung* die Einstellungen *Keine* oder *Keinen WB für diese Variante führen* ausgewählt wurde, werden mit dem Wert *-1* an Yatego übermittelt. So erkennt Yatego, dass es sich um eine unbeschränkt kaufbare Variante handelt.
--
