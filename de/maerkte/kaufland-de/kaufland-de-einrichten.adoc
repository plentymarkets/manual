...
*_Hinweis:_* Aufträge, für die keine Versandbestätigung an {market} gesendet werden konnten, werden in den Status verschoben, den du im Menü *Einrichtung » Märkte » Kaufland.de » Einstellungen » Option: xy* gewählt hast. +
