...
!===
! *stündlichen Cron*
! Dieser Cron wird bald abgeschaltet. Richte deshalb jetzt die Ereignisaktion <<#shipping-confirmation, Versandbestätigung an Kaufland.de senden>> ein. Stelle die Option *Versandbestätigungen senden über* dann auf *Ereignisaktion*.

*_Hintergrund:_* Kaufland stellt auf eine neue API-Version um. Deshalb ist es bald nicht mehr möglich, Versandbestätigungen über den stündlichen Cron zu senden. Richte deshalb jetzt die Ereignisaktion <<#shipping-confirmation, Versandbestätigung an Kaufland.de senden>> ein.
...
* kleiner als der Status, der die Ereignisaktion <<#shipping-confirmation, Versandbestätigung an Kaufland.de senden>> auslöst
