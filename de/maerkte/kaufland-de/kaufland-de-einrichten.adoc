...
Anforderungen an den gewählten Status:

* größer als 5
* kleiner als 7
* kleiner als der Status, der die Ereignisaktion <<#shipping-confirmation, Versandbestätigung an Kaufland.de melden>> auslöst

*_Hintergrund:_* Mit der Ereignisaktion <<#shipping-confirmation, Versandbestätigung an Kaufland.de melden>> informierst du {market} automatisch darüber, dass die Artikel eines Auftrags versendet wurden. Wenn die Ereignisaktion nicht ausgeführt werden kann, wird der Auftrag in den Status geschoben, den du für die Einstellung *XXX* gewählt hast.
...
Richte eine <<automatisierung/ereignisaktionen#, Ereignisaktion>> ein, um {market} darüber zu informieren, dass die Artikel eines Auftrags versendet wurden.
...
| *Aktion*
| *Auftrag*
| *Versandbestätigung an Kaufland.de melden* +
*_Hinweis:_* Aufträge, für die keine Versandbestätigung an {market} gesendet werden konnten, werden in den Status verschoben, den du im Menü *Einrichtung » Märkte » Kaufland.de » Einstellungen » Option: xxx* gewählt hast. +
...
Mit der Ereignisaktion <<#shipping-confirmation, Versandbestätigung an Kaufland.de melden>> informierst du {market} automatisch darüber, dass die Artikel eines Auftrags versendet wurden. Wenn die Ereignisaktion nicht ausgeführt werden kann, wird der Auftrag in den Status geschoben, den du für die Einstellung *XXX* gewählt hast.
...
Verschiebe Aufträge nach der Korrektur zurück in den Status, der die Ereignisaktion <<#shipping-confirmation, Versandbestätigung an Kaufland.de melden>> auslöst.
--
