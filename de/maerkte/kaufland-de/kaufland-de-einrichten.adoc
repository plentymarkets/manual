...
====
Beachte beim Angebotsexport die Lagerverknüpfung bei Kaufland.de. Artikel mit derselben *EAN*, *OfferID* und demselben *Zustand* können bei Kaufland.de immer nur in einem Lager gleichzeitig sein. Sind Artikel mit derselben *EAN*, *OfferID* und demselben *Zustand* in unterschiedlichen Lagern, werden sie beim Angebotsexport überschrieben und nur das letzte Angebot in der Angebotsdatei wird übertragen. +
Wenn du die gleichen Artikel aus verschiedenen plentymarkets Lagern an Kaufland.de übertragen möchtest, verknüpfe im Menü *Einrichtung » Märkte » Kaufland.de » Einstellungen » [Mandanten wählen] » Angebotseinstellungen » Lager verknüpfen* alle plentymarkets Lager mit demselben Lager von Kaufland.de. Die Bestände der Artikel werden dann addiert.
====
