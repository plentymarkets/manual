...
*_Hinweis:_* Wähle ein Ereignis, zu dem die Rechnung bereits existiert. Das Ereignis *Auftrag: Rechnung generiert* wird nicht empfohlen, da die Rechnung noch nicht vollständig generiert ist, wenn dieses Ereignis ausgelöst wird. 
|
