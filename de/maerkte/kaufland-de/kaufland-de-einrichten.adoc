...
*_Hintergrund:_* Kaufland stellt auf eine neue API-Version um. Deshalb wird der stündliche Cron für Versandbestätigungen bald abgeschaltet. Richte deshalb jetzt die Ereignisaktion <<#shipping-confirmation, Versandbestätigung an Kaufland.de senden>> ein.
