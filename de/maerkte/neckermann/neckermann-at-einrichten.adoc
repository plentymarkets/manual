...
Für die Auszeichnung deiner Artikel für Neckermann gemäß der Verordnung der EU zur Energieeffizienzrichtlinie sind seit 1.1.2015 Angaben zur Energieeffizienz sowie die Bereitstellung von Produktdatenblättern vorgeschrieben. Erstelle dazu folgende <<artikel/einstellungen/eigenschaften#100, Merkmale>>:
...
*_Tipp:_* Wenn du die Zolltarifnummer in das Feld der Hauptvariante eingibst, wird die Zolltarifnummer an alle Varianten des Artikels vererbt.
. Scrolle zum Bereich *Kosten*.
. Gib in das Feld *Zolltarifnummer* die Zolltarifnummer ein.
. *Speichere* (icon:save[role="green"]) die Einstellungen. +
