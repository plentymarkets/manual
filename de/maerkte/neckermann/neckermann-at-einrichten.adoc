...
Nachdem du Neckermann-Partner geworden bist, verwende deine Zugangsdaten, um den Marktplatz in plentymarkets einzurichten. Du kannst die Plattform Neckermann.at Enterprise
// als auch Neckermann.at Cross-Docking
an plentymarkets anbinden. Um Neckermann.at Enterprise in plentymarkets einzurichten, gehe wie im Folgenden beschrieben vor.
...
Artikel, die du auf Neckermann.at verkaufen möchtest, müssen im Menü <<artikel/artikel-verwalten#170, Artikel » Artikel bearbeiten » Artikel öffnen » Tab: Varianten-ID>> im Tab *Verfügbarkeit* aktiviert werden.
...
Im Menü *Daten » API-Log » Tab: API-Log* findest du eine Historie über Vorgänge, die über die Neckermann-Schnittstelle ausgeführt wurden. Die Formate *NeckermannATEP* und *NeckermannATCD* stehen dir für Neckermann zur Verfügung.
