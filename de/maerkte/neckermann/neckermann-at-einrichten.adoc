...
. Wähle aus der Dropdown-Liste *Marktplatz* die Option *Neckermann.at Enterprise*. +
→ Eine zusätzliche Dropdown-Liste *Neckermann.at Enterprise* wird angezeigt.
. Wähle aus der Dropdown-Liste *Neckermann.at Enterprise* das Attribut *Farbe*.
...
Für die Auszeichnung deiner Artikel für Neckermann gemäß der neuen Verordnung der EU zur Energieeffizienzrichtlinie sind seit 1.1.2015 Angaben zur Energieeffizienz sowie die Bereitstellung von Produktdatenblättern vorgeschrieben. Erstelle dazu folgende <<artikel/artikel-verwalten#480, Merkmale>>:
