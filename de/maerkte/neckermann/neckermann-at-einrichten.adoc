...
.  Öffnen Sie das Menü *System » Systemeinstellungen » Märkte » Neckermann Österreich Enterprise*.
...
*Artikel-Lieferzeit 1 - 5* = Lieferzeit in Tagen bei jeder Option eingeben. Die Optionen für Artikelverfügbarkeit werden im Menü <<artikel/artikel-verwalten#190, System » Systemeinstellungen » Artikel » Verfügbarkeit>> eingerichtet.
...
Damit Sie Artikel, Merkmale etc. mit Neckermann.at verknüpfen können, muss im Menü *System » Systemeinstellungen » Aufträge » Auftragsherkunft* die Auftragsherkunft *Neckermann.at Enterprise* aktiviert werden.
...
→ Nach dem Import der Brand-IDs finden Sie die Neckermann-ID eines Herstellers im Menü *System » Systemeinstellungen » Artikel » Hersteller*.
