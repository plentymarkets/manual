...
====
Beachten Sie die Hinweise im Handbuch zum Datenformat <<basics/datenaustausch/datenformate/stock#, **Stock**>> – insbesondere bevor Sie durch einen Import Bestände überschreiben. Anhand eines Testimports mit nur einer Variante können Sie prüfen, ob der Import das gewünschte Ergebnis liefert.
====
...
. Öffnen Sie das Menü <<basics/datenaustausch/daten-exportieren#, **Daten » Dynamischer Export**>>.
. Öffnen Sie das Untermenü des Datenformats <<basics/datenaustausch/datenformate/stock#, **Stock**>> oder legen Sie dieses **<<basics/datenaustausch/datenformate#2-2, Datenformat>>** an, wenn das Untermenü noch nicht vorhanden ist.
...
Wenn Sie nach der Bestandszählung alle Bestandsabweichungen auf einmal prüfen möchten, exportieren Sie vor Beginn der Inventur den Bestand über das Datenformat <<basics/datenaustausch/datenformate/stock#, Stock>>. Führen Sie einen weiteren Export nach Ende der Inventur durch und vergleichen Sie die Bestandsdaten.
