...
====
Erfassen Sie alle Artikel, die sich an einem Lagerort befinden. Wenn Sie verschiedene Artikel auf demselben Lagerplatz lagern, wird der Bestand aller Artikel, die Sie bei der Inventur nicht erfassen, auf Null gesetzt. Beispiel: +
