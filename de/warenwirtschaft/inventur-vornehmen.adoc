...
. Öffnen Sie das Menü <<basics/datenaustausch/daten-exportieren#, **Datenaustausch » Export » Dynamischer Export**>>.
...
. Öffnen Sie das Menü <<basics/datenaustausch/daten-importieren#, **Datenaustausch » Import » Dynamischer Import**>>.
...
. Öffnen Sie das Menü **System » Waren » Lager » Lager auswählen » Untermenü: Einstellungen**.
