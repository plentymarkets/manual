...
Idealerweise haben Sie für die Auftragsbearbeitung eine **<<auftragsabwicklung/auftraege/fulfillment/pickliste#, Pickliste  >>** erstellt und ausgedruckt, dort bereits alle bearbeiteten Aufträge abgehakt und die kleinen Barcodestreifen Ihrer Versandetiketten neben den Auftrag geklebt.
