...
Idealerweise haben Sie für die Auftragsbearbeitung eine **<<auftragsabwicklung/auftraege/auftragsdokumente/pickliste#, Pickliste>>** erstellt und ausgedruckt, dort bereits alle bearbeiteten Aufträge abgehakt und die kleinen Barcodestreifen Ihrer Versandetiketten neben den Auftrag geklebt.
...
Eine weitere Möglichkeit, die Paketnummern zu importieren, ist per **<<auftragsabwicklung/fulfillment/dokumente-erzeugen#900, CSV-Datei>>**.
...
Wie Sie Retouren anlegen und Warenbestand zurückbuchen, erfahren Sie ausführlich unter **<<auftragsabwicklung/auftraege/auftraege-verwalten#retoure, Retoure>>**.
...
Wie Sie Gewährleistungen anlegen, erfahren Sie ausführlich unter **<<auftragsabwicklung/auftraege/auftraege-verwalten#gewaehrleistung, Gewährleistung>>**.
