...
Idealerweise haben Sie für die Auftragsbearbeitung eine **<<auftraege/fulfillment/pickliste#, Pickliste  >>** erstellt und ausgedruckt, dort bereits alle bearbeiteten Aufträge abgehakt und die kleinen Barcodestreifen Ihrer Versandetiketten neben den Auftrag geklebt.
...
Wie Sie Retouren anlegen und Warenbestand zurückbuchen, erfahren Sie ausführlich unter **<<auftraege/auftraege-bearbeiten/retoure#, Retoure  >>**.
...
Wie Sie Gewährleistungen anlegen, erfahren Sie ausführlich unter **<<auftraege/auftraege-bearbeiten/gewaehrleistung#, Gewährleistung  >>**.
