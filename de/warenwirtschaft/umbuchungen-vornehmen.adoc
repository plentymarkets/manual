...
Um den Aufwand beim Anlegen einer neuen Nachbestellung zu verringern, können Sie einige Standardeinstellungen vornehmen. Durch diese Einstellungen werden einzelne mit Standardwerten vorausgefüllt, wenn Sie eine neue Umbuchung erstellen. Gehen Sie dazu wie im Folgenden beschrieben vor:
