...
Die Auftragspositionen sind bearbeitbar, solang die Bestellung noch nicht ausgelöst wurde. Du kannst zum Beispiel die *Menge* ändern oder Artikel *löschen*. Im Feld *Artikelname* kannst du die Bezeichnung für den Artikel anpassen. Die Änderungen gelten nur für die Umbuchung, in der sie vorgenommen wurden. Möchtest du die <<artikel/einstellungen#, Artikeleinstellungen>> generell anpassen, kannst du dies im Menü *Artikel » Artikel bearbeiten* im entsprechenden Tab machen.
