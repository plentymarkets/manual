...
| *Tags*
| Wähle <<warenwirtschaft/umbuchungen-vornehmen#300, Tags>>, um nach Umbuchungen zu suchen, denen dieses Tag zugeordnet wurde. Du kannst mehrere Tags auswählen. Es handelt sich um eine "oder"-Suche. Das bedeutet, dass bei Auswahl von mehreren Tags alle Umbuchungen in den Suchergebnissen angezeigt werden, denen eines dieser Tags zugeordnet wurde.
