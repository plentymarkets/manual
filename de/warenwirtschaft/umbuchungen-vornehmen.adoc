...
Im nächsten Schritt fügst du die Auftragspositionen hinzu, die von einem Lager in ein anderes Lager umgebucht werden sollen. Wende die Suche (icon:search[]) an, um die gewünschten Auftragspositionen anhand der vorhandenen Artikel mit Bestand zu finden.
...
| *Varianten-ID*
|Es wird nach der Variante mit dieser ID gesucht. Du kannst mehrere IDs kommasepariert eingeben.

| *Artikel-ID*
|Es wird nach dem Artikel mit dieser ID gesucht. Du kannst mehrere IDs kommasepariert eingeben.

| *Variantennummer*
|Es wird nach der Variante mit dieser Variantennummer gesucht. Du kannst mehrere Nummern kommasepariert eingeben.

| *Barcode*
|Es wird nach der Variante mit diesem Barcode gesucht.

| *Artikelname*
|Es wird nach dem Artikel mit diesem Namen gesucht.

| *Lieferantennummer*
|Es wird nach Artikeln mit dieser Lieferant:innen-Nummer gesucht.
