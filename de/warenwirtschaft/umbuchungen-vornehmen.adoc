...
.Umbuchung löschen
====
Umbuchungen können in der Detailansicht gelöscht werden, solange die Umbuchung noch nicht durch Setzen des Bestelldatums ausgelöst wurde. Klicke zum Löschen auf *Bestellung löschen* (icon:trash-o[]) rechts oberhalb der Infoboxen.
====
