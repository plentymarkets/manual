...
Sie können Varianten mit MHD/Charge einbuchen. Dafür muss an der Variante an dem Lager die ensprechende Option aktiviert sein. Sie finden die Einstellungen unter *<<warenwirtschaft/wareneingaenge-verwalten#200, Lagerort einer Variante angeben>>*.
...
====
Auf einen Lagerort darf pro Variante nur ein MHD/Charge gebucht werden. Wir empfehlen, diese Einstellung nicht zu verändern. Buchen Sie unterschiedliche MHD/Chargen auf einen Lagerort, kann es zu Problemen bei der Komissionierung kommen. Die Einstellung nehmen Sie im Menü *System » Waren » Warenbestand » Wareneingang* über die Option *Lagerort auf Chargen/MHD beim Wareneingang beschränken* vor.
====
