...
Hier eingetragene Werte gelten für die Marktplätze <<maerkte/amazon/amazon-einrichten#, Amazon>>, <<maerkte/ebay/ebay-einrichten#, eBay>> und <<maerkte/shopgate#, Shogate>>. Die Werte sind gegenüber den hinterlegten Bestandspufferwerten dieser Marktplätze dominant.
