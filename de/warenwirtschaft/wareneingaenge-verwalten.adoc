...
__Beispiel__: Der Artikel hat einen Bestand von 50. Du möchtest einen Bestandspuffer von 10 Artikeln, damit der Artikel nicht vollständig über den Marktplatz abverkauft wird. Dazu **10** als Bestandspuffer eintragen. Zum Marktplatz wird ein Bestandswert von **40** übertragen.  +
...
. Öffne das Menü **System » Systemeinstellungen » Waren » Warenbestand » Wareneingang**.
...
. Öffne das Menü **System » Systemeinstellungen » Waren » Neuer Wareneingang**.
...
Um einen Wareneingang zu erfassen, benötigst du mindestens ein Lager und einen Lieferanten.
Lieferanten legst du als <<crm/kontakte-verwalten#100, Kunden>> an und ordnest ihnen den Kundentyp Lieferant zu.
...
Die Eigner stehen dir nach ID sortiert zur Verfügung.
...
. Wähle einen Eigner.  +
→ Wenn du als <<basics/admin-aufgaben/benutzer-verwalten#40, Eigner für Wareneingänge>> aktiviert wurdest, bist du als eingeloggter Benutzer als Eigner vorausgewählt.
. Nimm weitere optionale Einstellungen vor.
. Klicke auf *Speichern*, um den Wareneingang anzulegen.  +
...
Zunächst werden dir alle Artikel aller Lieferanten aufgelistet. Nutze die Suche, um Artikel einzelner Lieferanten anzuzeigen. +
...
. Klicke in der Spalte **Aktionen** auf **Artikel hinzufügen**.  +
...
. Klicke auf die Schaltfläche **Hinzufügen**, der oberhalb der Artikelliste angezeigt wird.  +
...
. Klicke auf **Speichern**, um die Kosten zu sichern.
...
. Klicke auf **Speichern**, um die Notiz zu sichern.  +
