...
. Erteilen Sie bei Bedarf zusätzliche Einzelberechtigungen. Beachten Sie dazu die Erläuterungen in Tabelle 6.
. **Speichern** Sie die Einstellungen.
...
. Öffnen Sie das Menü **Waren » Neuer Wareneingang**.
. Wählen Sie die gewünschten Sucheinstellungen. Beachten Sie dabei auch die Erläuterungen in Tabelle 8.
. Klicken Sie auf **Suchen**.
