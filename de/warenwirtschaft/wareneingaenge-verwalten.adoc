...
|Bei dieser Methode wird durch jeden Wareneingang eine Neuberechnung ausgelöst. Allerdings nur, wenn das Lager, in das Sie Bestand buchen auch für den GLD berücksichtigt wird. Der GLD wird in der Variante in einem separaten Feld automatisch angezeigt.
