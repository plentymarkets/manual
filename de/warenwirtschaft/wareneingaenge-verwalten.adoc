...
|**MHD**
Entscheiden Sie, ob für die Variante und das Lager die Funktion MHD aktiviert werden soll. Sobald Lagerbestand auf dem Lager vorhanden ist, ist es nicht mehr möglich, die Option MHD zu deaktivieren. Ist der Lagerbestand auf diesem Lager gleich 0, ist eine aktivierung/deaktivierung von MHD möglich.

|**Charge**
Entscheiden Sie, ob für die Variante und das Lager die Funktion Charge aktiviert werden soll. Sobald Lagerbestand mit Charge vorhanden ist, ist es nicht mehr möglich, die Option Charge zu deaktivieren. Ist der Lagerbestand auf diesem Lager gleich 0, ist eine aktivierung/deaktivierung von Chargen möglich.
...
[IMPORTANT]
.Vererbung der Einstellung an Untervarianten
====
Wenn Sie ein Lager für eine Variante aktivieren, wird diese Einstellung auch an alle Untervarianten vererbt.
====
...
[#810]
=== Wareneingang mit MHD/Charge
Sie können Artikel mit MHD/Charge einbuchen. Dafür müssen Sie in der Variante an dem Lager die ensprechende Option aktiviert haben. Sie finden die Einstellungen unter **<<warenwirtschaft/wareneingaenge-verwalten#200, Lagerort einer Variante angeben>>**.
[.instruction]
Varianten mit MHD/Charge hinzufügen:
...
====
Auf eine Lagerort darf pro Variante nur ein MHD/Charge gebucht werden. Wir empfehlen diese Einstellung nicht zu verändern. Buchen Sie unterschiedliche MHD/Chargen auf einen Lagerort kann es zu problem bei der Komissionierung kommen. Die Einstellung können Sie unter *System » Waren » Warenbestand » Wareneingang »Lagerort auf Chargen / MHD beim Wareneingang beschränken* einstellen.
====
