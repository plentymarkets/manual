...
*_Hinweis:_* Sobald Lagerbestand mit Charge vorhanden ist, kann die Option *Charge* nicht mehr deaktiviert werden. Ist der Lagerbestand auf diesem Lager gleich 0, ist das Aktivieren/Deaktivieren der Option *Charge* möglich.
