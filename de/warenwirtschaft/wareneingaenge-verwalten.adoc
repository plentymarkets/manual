...
|**MHD**
Entscheiden Sie, ob für die Variante und das Lager die Funktion MHD aktiviert werden soll. Sobald Lagerbestand mit MHD vorhanden ist, ist es nicht mehr möglich, die Option MHD zu deaktivieren. Ist der Lagerbestand mit MHD gleich 0, ist eine Änderung auch im Nachhinein möglich.

|**Charge**
Entscheiden Sie, ob für die Variante und das Lager die Funktion Charge aktiviert werden soll. Sobald Lagerbestand mit Charge vorhanden ist, ist es nicht mehr möglich, die Option Charge zu deaktivieren. Ist der Lagerbestand mit Charge gleich 0, ist eine Änderung auch im Nachhinein möglich.
...
Sie können Artikel mit MHD/Charge einbuchen. Dafür müssen Sie in der Variante an dem Lager die ensprechende Option aktiviert haben. Sie finden die Einstellungen unter https://knowledge.plentymarkets.com/warenwirtschaft/wareneingaenge-verwalten#200
