...
|latexmath:[$DEK_neu = {EK_alt \cdot Menge_alt + EK_neu \cdot Menge_neu\over Menge_alt + Menge_neu}$]
|latexmath:[$GLD_neu = {GLD_alt \cdot Menge_alt + EK_neu \cdot Menge_neu\over Menge_alt + Menge_neu}$]
