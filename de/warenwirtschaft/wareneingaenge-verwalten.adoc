...
. Erteilen Sie bei Bedarf zusätzliche Einzelberechtigungen. Beachten Sie dazu die Erläuterungen in Tabelle 5.
. **Speichern** Sie die Einstellungen.
...
. Nehmen Sie die Einstellungen vor. Beachten Sie Tabelle 6. +
