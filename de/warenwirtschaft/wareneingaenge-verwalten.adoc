...
|$DEK_neu = {EK_alt \cdot Menge_alt + EK_neu \cdot Menge_neu\over Menge_alt + Menge_neu}$
|$GLD_neu = {GLD_alt \cdot Menge_alt + EK_neu \cdot Menge_neu\over Menge_alt + Menge_neu}$
...
stem: $$GLD_neu = {GLD_alt \cdot Menge_alt + EK_neu \cdot Menge_neu\over Menge_alt + Menge_neu}$$

.subhead
Live-Durchschnittseinkaufspreis berechnen

stem: $$DEK_neu = {EK_alt \cdot Menge_alt + EK_neu \cdot Menge_neu\over Menge_alt + Menge_neu}$$
