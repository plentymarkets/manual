...
Für die Suche nach Wareneingängen gibt es zwei Menüs, **Waren » Wareneingänge** und **Waren » Neuer Wareneingang**. Im Menü **Waren » Wareneingänge** werden alle Wareneingänge aufgelistet, egal ob sie über die App, per ElasticSync oder über das Menü **Neuer Wareneingang** erfolgt sind. Im Menü **Neuer Wareneingang** werden nur Wareneingänge aufgeführt, die über dieses Menü erfolgt sind.
