...
Außerdem muss mindestens ein Benutzer als <<business-entscheidungen/benutzerkonten-zugaenge#40, Eigner für Wareneingänge>> aktiviert sein, damit der Wareneingang einem Eigner zugeordnet werden kann.
...
. Wähle einen Eigner.  +
→ Wenn du als <<business-entscheidungen/benutzerkonten-zugaenge#40, Eigner für Wareneingänge>> aktiviert wurdest, bist du als eingeloggter Benutzer als Eigner vorausgewählt.
