...
|Erlaubt dem Backend-Benutzer, Wareneingänge zu sehen, die über die App, per Import oder über das Menü *Neuer Wareneingang* erfolgt sind.

| *Warenbestände > Neuer Wareneingang > Anzeigen*
|Erlaubt dem Backend-Benutzer, Wareneingänge zu sehen, die über das Menü *Neuer Wareneingang* erfolgt sind.
