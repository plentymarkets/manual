...
Hier eingetragene Werte gelten für die Marktplätze <<maerkte/amazon/amazon-einrichten#, Amazon>> und <<maerkte/shopgate#, Shogate>>. Die Werte sind gegenüber den hinterlegten Bestandspufferwerten dieser Marktplätze dominant. +
