...
|**EK**
|Einkaufspreis der Variante eintragen. Je nach Einstellung für Wareneingänge wird dieser EK überschrieben. Im Menü **Einrichtung » Waren » Warenbestand » Wareneingang** stellst du ein, ob der Einkaufspreis eines Wareneingangs für Lieferanten übernommen wird.
