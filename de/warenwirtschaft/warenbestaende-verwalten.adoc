...
|Erlaubt dem Backend-Benutzer, Warenbestände zu sehen.

| *Warenbestände > Bearbeiten*
|Erlaubt dem Backend-Benutzer, Warenbestände zu bearbeiten.
