...
Ab plentymarkets kann Ware auch über die plentymarkets App umgebucht werden. Erteile dazu Benutzern der Benutzerklasse **Variabel** und **Logistik** die nötigen Berechtigungen. Mit Umbuchungsvorlagen und App-Einstellungen passt du den Umbuchungsvorgang an deine Lagergegebenheiten an.
