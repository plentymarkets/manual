...
Alle Datenformate und eine allgemeine Beschreibung des Datenexports und Datenimports finden Sie im Thema <<basics/datenaustausch#daten/export-import#, Datenaustausch>>.
