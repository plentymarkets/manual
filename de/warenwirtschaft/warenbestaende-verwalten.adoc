...
Je nach Berechtigungen eines Benutzers werden eventuell nicht alle Parameter angezeigt. So können z.B. bei einem Benutzer unter **Berechtigungen** im Bereich **Menü-Sichtbarkeiten** die Lageroptionen eingeschränkt sein. Prüfe die Einstellungen des Benutzers, der die Warenbestände bearbeiten soll, im Menü **Einrichtung » Einstellungen » Benutzer**.
