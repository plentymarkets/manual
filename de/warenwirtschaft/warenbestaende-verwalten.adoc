...
Sie können Varianten mit MHD/Charge in andere Lager umbuchen. Beachten Sie beim Umbuchen von Varianten mit MHD/Charge die in <<Beschränkung Lagerumbuchungen mit MHD/Charge>> aufgeführten Beschränkungen.
