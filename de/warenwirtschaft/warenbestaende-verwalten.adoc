...
.Beschränkung bei Lagerumbuchungen mit MHD/Charge
...
*_Hinweis:_* Standardmäßig kann Ware mit verschiedenen MHD/Chargen nicht auf denselben Lagerort gebucht werden. Beachten Sie auch die in <<Beschränkung_Lagerumbuchungen>> beschriebenen Beschränkungen beim Umbuchen von Ware mit MHD/Chargen. +
