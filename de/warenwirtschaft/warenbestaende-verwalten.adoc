...
|**Meld**
|Aktuell eingetragener Meldebestand. +
...
. Öffnen Sie das Menü **System » Einstellungen » plentymarkets-App » Umbuchung**.
...
|**Beschreibung**
|Beschreibung des Felds eingeben, die Benutzern angezeigt wird. Wenn keine Beschreibung eingegeben wird, wird nur der Wert ohne Erläuterung angezeigt.
...
Aktiviert = Der gesamte Bestand am Lagerplatz wird automatisch eingefügt.
...
|**Schnelles Umbuchen**
|Aktivieren, um die Auswahl des Quelllagers zu überspringen. +
...
Vorlagen werden im plentymarkets Backend im Menü **System » Einstellungen » plentymarkets-App » Umbuchung** erstellt.
|====
