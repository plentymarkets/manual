...
| *Allgemeine Informationen* (icon:person[set=material])
...
| *Funktionen* (icon:apps[set=material])
...
| *Letzte Aktivitäten* (icon:history[set=material])
...
| *Anzeige* (icon:aspect_ratio[set=material])
...
| *plentyBase* (icon:icon-referrer_backend[set=plenty])
...
| *Sprachausgabe* (icon:speaker[set=material])
...
| *Sonstiges* (icon:settings[set=material])
