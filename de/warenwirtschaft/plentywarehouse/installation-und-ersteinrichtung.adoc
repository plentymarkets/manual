...
Auf dieser Seite wird Schritt für Schritt beschrieben, wie du plentyWarehouse einrichtest und welche Aufgaben du erledigen solltest, bevor du plentyWarehouse produktiv im Lager einsetzt.
...
//TODO: Link im PlayStore zur open beta hinzufügen
...
. Gib deine Zugangsdaten ein. Beachte die Informationen in <<table-plentywarehouse-login>>.
. Tippe auf *Login*. +
→ Du wirst in plentyWarehouse eingeloggt.

[[table-plentywarehouse-login]]
