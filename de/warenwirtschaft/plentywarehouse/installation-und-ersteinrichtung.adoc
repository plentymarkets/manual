...
//TODO: Icons, Funktionssymbole in Tabelle, Links zu plentyBase und anderen pW Features.
...
====
Du kannst die Bereiche des Dashboards in beliebiger Reihenfolge untereinander anordnen. Tippe und halte dazu (icon:drag_handle[role="darkGrey"]) oben rechts an jedem Bereich und ziehe den Bereich an die gewünschte Stelle. Diese Einstellung wird permanent gespeichert.
====
...
| *Funktionen*
|Dieser Bereich enthält Kacheln mit Symbolen für die einzelnen Funktionen von plentyWarehouse. Tippe auf eine Kachel, um schnell zur jeweiligen Funktion zu gelangen. Wenn du die Funktionen von plentyWarehouse einige Male genutzt hast, sortieren sich die Kacheln automatisch. So werden die Kacheln der meistgenutzten Funktionen immer links im Bereich angezeigt.
...
====
Wenn du auf das Menüsymbol tippst, siehst du unter anderem eine Lister der Funktionen von plentyWarehouse. Einige Einträge sind in grau dargestellt. Das bedeutet, dass die Funktion innerhalb der Beta-Phase noch nicht zur Verfügung steht.
====
