...
Artikel kannst du nicht nur <<warenwirtschaft/umbuchungen-vornehmen#, im plentymarkets Backend>>, sondern auch mit der plentyWarehouse App umbuchen. Die Funktion zum Umbuchen von Artikeln steht dir zur Verfügung, sobald du plentyWarehouse auf einem passenden Gerät installiert hast. So kannst du ganz praktisch im Lager Artikel erfassen, Quell- und Ziellagerorte auswählen und im Handumdrehen Artikel umbuchen. 
...
.Lagerorte labeln
====
Noch schneller buchst du Ware um, wenn du deine <<warenwirtschaft/lager-einrichten#800, Lagerorte labelst>>. Beim Umbuchen kannst du dann die Labels der Quell- und Ziellagerorte scannen. So sparst du Zeit und vermeidest Fehler.
====
