...
Bevor du eine mit plentyWarehouse durchführst, muss sichergestellt sein, dass alle Benutzer:innen über die entsprechenden Berechtigungen verfügen. Nur so kann die Umbuchung korrekt abgewickelt werden und die Bestandsänderungen im plentymarkets Backend gespeichert werden.
