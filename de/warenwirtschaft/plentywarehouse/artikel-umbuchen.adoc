...
Wusstest du, dass du Artikel nicht nur <<warenwirtschaft/umbuchungen-vornehmen#, im plentymarkets Backend>>, sondern auch mit der plentyWarehouse App umbuchen kannst?

Diese Seite beschreibt Schritt für Schritt, wie du die Funktion einrichtest und nutzt.
