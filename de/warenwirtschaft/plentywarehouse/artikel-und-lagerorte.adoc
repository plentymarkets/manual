...
* <<artikel/einstellungen/eigenschaften#500, Eigenschaften>> //TODO: Hinweisbox, welche Sichtbarkeit gesetzt sein muss.
--
...
. Tippe unten auf *Einstellungen* (icon:settings[role="darkGrey"]). +
→ Das Einstellungsmenü öffnet sich.
. Tippe auf *Lagerort inspizieren* (image:_/assets/icon_inspect_storage-location.png[width=14, height=14]).
...
| *Zweck*
|Verwende die Umschaltflächen, um festzulegen, welche <<warenwirtschaft/lager-einrichten#500, Lagerortzwecke>> beim Suchen von Lagerorten zur Filterung auswählbar sein sollen. +
...
Die Ergebnisse der Lagerortsuche sind immer gleich aufgebaut. Die oberste Karte enthält Informationen zum Lagerort. Darunter werden die Artikel aufgelistet, die sich aktuell auf diesem Lagerort befinden. Scrolle in der Artikelliste nach unten, um die einzelnen Artikel im Bestand des Lagerorts genauer einzusehen. Tippe alternativ auf icon:filter_list[role="darkGrey"], um die Artikel nach bestimmten Suchkriterien zu durchsuchen.
