...
|Wo befinden sich deine Artikel, bevor sie verräumt werden? Tippe auf die gewünschten <<warenwirtschaft/lager-einrichten#intable-zweck, Lagerort-Zwecke>>, um sie beim Verräumen ein- oder auszuschließen. +
...
| *Zweck*
|Mithilfe dieser Option kannst du Lagerorte mit bestimmten <<warenwirtschaft/lager-einrichten#intable-zweck, Zwecken>> von den vorgeschlagenen Ziellagerorten ausschließen. +
