...
== Ware über die plentymarkets App entpacken (ab App-Version 1.XX)
...
Gehen Sie wie unten beschrieben vor, um Ware über die plentymarkets App zu entpacken.

[TIP]
.Lagerorte labeln
====
Noch schneller entpacken Sie Ware, wenn Sie Ihre <<warenwirtschaft/lager-einrichten#800, Lagerorte labeln>>. Beim Entpacken können Sie dann die Labels der Quell- und Ziellagerorte scannen.
====
