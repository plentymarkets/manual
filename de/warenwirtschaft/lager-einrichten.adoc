...
====
Jedes System hat zu Beginn 2 Beispiellager, ein Vertriebslager und ein zugehöriges Reparaturlager. Diese Lager kannst du umbenennen und weiter nutzen oder löschen und eigene Lager anlegen. Du benötigst mindestens ein Lager in deinem System, um Wareneingänge zu buchen und Bestände zu pflegen. Ohne ein Lager kannst du also keine Bestände verwalten. Eingehende Aufträge werden je nach Artikelverfügbarkeit einem Lager zugeordnet.
====
...
Hinweis: Damit für eine Variante die Differenz zum Meldebestand basierend auf dem dynamischen Meldebestand berechnet wird, muss der <<warenwirtschaft/nachbestellungen-verwalten/nachbestellungen-verwalten#500, Meldebestand der Variante>> für das Lager 0 sein. +
*inaktiv* = die Differenz zum Meldebestand wird für Varianten in diesem Lager nicht basierend auf dem dynamischen Meldebestand berechnet, sondern basierend auf dem <<warenwirtschaft/nachbestellungen-verwalten/nachbestellungen-verwalten#500warenwirtschaft/nachbestellungen-verwalten/#500, eingetragenen Meldebestand>>. Du kannst also einen Meldebestand für die Variante eingeben, der größer als 0 ist.
...
. Klicke auf *Neue Dimension hinzufügen*. +
→ Eine weitere Dimension kann nun hinzugefügt werden. Folge dazu wieder den Schritten 4 bis 6.
. *Speichere* die Einstellungen, um die Dimensionen zu erstellen.
...
. Öffne das Menü *System » Systemeinstellungen » Waren » Lager » Lager wählen » Untermenü: Box-Regale*.
...
. Öffne das Menü *System » Systemeinstellungen » Waren » Lager » Lager wählen » Untermenü: Label*.
...
Im Menü *System » Systemeinstellungen » Einstellungen » Eigenschaften » Konfiguration* erstellst du Eigenschaften, die du im Anschluss für die nähere Charakterisierung deiner Lagerorte nutzt.
...
*_Hinweis:_* Standardmäßig wird der Name für die Systemsprache angezeigt. Nachdem die Eigenschaft erstellt wurde, kannst du den Namen in einer beliebigen Sprache speichern.

|*Beschreibung*
|Beschreibung der Eigenschaft eingeben. +
*_Hinweis:_* Standardmäßig wird die Beschreibung für die Systemsprache angezeigt. Nachdem die Eigenschaft erstellt wurde, kannst du die Beschreibung in einer beliebigen Sprache speichern.
...
. Öffne das Menü *System » Systemeinstellungen » Einstellungen » Waren » Lager*. +
. Wähle ein Lager.
. Klicke auf *Lagerorte*. +
→ Die Übersicht wird geöffnet.
. Wähle die Lagerorte, die du den Eigenschaften zuordnen willst.
. Klicke auf *Gruppenfunktion*. +
→ Die Einstellungen werden geöffnet.
. Wähle bis zu 3 Eigenschaften und die dazugehörigen Werte.
. *Speichere* die Einstellungen. +
