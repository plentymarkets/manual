...
. Öffnen Sie das Menü **System » Waren » Lager » Lager auswählen » Einstellungen**.
...
|Löscht alle Warenbestände aus dem Lager. Verwenden Sie diese Funktion mit Vorsicht. Wie Sie im Fall einer Inventur am Besten vorgehen, erfahren Sie unter **<<warenwirtschaft/inventur-vornehmen#, Inventur vornehmen>>**.
...
. Öffnen Sie das Menü **System » Waren » Lager » Lager auswählen » Untermenü: Regale**.
...
. Öffnen Sie das Menü **System » Waren » Lager » Lager auswählen » Untermenü: Box-Regale**.
...
. Öffnen Sie das Menü **System » Waren » Lager » Lager auswählen » Untermenü: Label**.
