...
. Öffnen Sie das Menü **Einstellungen » Waren » Lager » Lager auswählen » Einstellungen**.
...
|**Standort**
|Standort des Lagers.  +
Hier stehen die Länder zur Auswahl, die als Lieferländer unter <<auftragsabwicklung/fulfillment/versand-vorbereiten#100, **Einstellungen » Aufträge » Versand » Versandoptionen » Tab: Lieferländer**>> eingerichtet wurden.
...
. Öffnen Sie das Menü **Einstellungen » Waren » Lager » Lager auswählen » Untermenü: Regale**.
...
. Öffnen Sie das Menü **Einstellungen » Waren » Lager » Lager auswählen » Untermenü: Box-Regale**.
...
. Öffnen Sie das Menü **Einstellungen » Waren » Lager » Lager auswählen » Untermenü: Label**.
