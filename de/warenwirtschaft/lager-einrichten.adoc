...
So kann gezielt nach kleinen, mittleren oder großen Lagerorten gesucht werden und alle Artikel-IDs können damit verknüpft werden. Außerdem kann dir die nähere Charakterisierung dabei helfen, deine Artikel link:https://knowledge.plentymarkets.com/artikel/artikel-verwalten#3000[direkt am passenden Ort zu lagern]. +
