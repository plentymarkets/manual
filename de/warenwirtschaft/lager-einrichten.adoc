...
|Diese Option ist z.B. für die Erzeugung von <<auftraege/auftraege-verwalten#lieferauftrag, Lieferaufträgen>> auf *Ja* zu stellen, insofern damit gearbeitet wird.
