...
|*Lagerort-Typ*
|Typ des Lagerorts wählen. Hier kannst du entscheiden, ob du einen anderen Lagerort-Typ wählen möchtest, als den, der bereits in den Einstellungen des Lagers für den Standard-Lagerort-Typ festgelegt wurde. 
...
. Wähle in der Dropdown-Liste *Bereich* die Option *Lagerort*.
...
| *Bereich*
|Einstellung *Lagerort* aus der Dropdown-Liste wählen, damit die Eigenschaft in dem Bereich verwendet werden kann. +
Außerdem sind die Bereiche <<artikel/einstellungen/eigenschaften#500, Artikel>> und <<crm/kontakte-verwalten#950, Kontakt>> verfügbar.
...
[#950]
=== Eigenschaften mit dem Lagerort verknüpfen
...
| *Bereich*
|Bereich *Lagerort* wählen, um nur Eigenschaften dieses Bereichs anzuzeigen.
...
Im Menü *Einrichtung » Einstellungen » Eigenschaften » Konfiguration* sind alle Eigenschaften, die du bisher erstellt hast, aufgelistet. Hier kannst du die in <<table-create-properties>> beschriebenen Einstellungen ändern.
...
| *Position*
|Gib eine Positionsnummer für die Eigenschaftsgruppe ein. Standardmäßig wird aufsteigend nach Positionsnummer sortiert. Wenn ein Lagerort Eigenschaften aus mehreren Gruppen hat, werden die Gruppen aufsteigend dargestellt. +
...
. Öffne das Menü *Einrichtung » Einstellungen » Eigenschaften » Gruppen*.
. Klicke auf *Suchen* (icon:search[role="blue"]), um alle Eigenschaftsgruppen anzuzeigen oder wähle Filter, um die Ergebnisse einzugrenzen. Beachte die Erläuterungen in <<#table-filter-properties>>.
...
Mit dem FormatDesigner und dem Format-Typ *Eigenschaften* kannst du Eigenschaften exportieren. Weitere Informationen findest du auf der Handbuchseite des Format-Typs <<daten/daten-exportieren/FormatDesigner/format-typen/eigenschaften#, Eigenschaften>>.
