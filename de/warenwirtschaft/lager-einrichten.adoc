...
include::_textblocks/instructions/eigenschaft-suchen.adoc[]

[#eigenschaft-bearbeiten]
=== Eigenschaften von Lagerorten bearbeiten

include::_textblocks/instructions/eigenschaft-bearbeiten.adoc[]
...
include::_textblocks/instructions/eigenschaft-loeschen.adoc[]

[#1400]
==== Mehrere Eigenschaften löschen

include::_textblocks/instructions/mehrere-eigenschaften-loeschen.adoc[]
