...
|Hier wählen Sie die Auftragsherkünfte, für die das Lager bevorzugt behandelt werden soll. Geht über eine der ausgewählten Auftragsherkünfte ein Auftrag ein, wird dieses Lager bei der automatischen Lagerauswahl zugeordnet. *_Wichtig:_* Diese Einstellungen haben Priorität über die Einstellungen, die Sie bei der Option *Automatische Lagerauswahl* im Menü *<<auftraege/grundeinstellungen#, System » Aufträge » Einstellungen>>* vorgenommen haben.

/////
TODO: evtl. Beispiel für Auftragsherkünfte-Einstellung mit eintragen. Wann sticht sich das?
/////
