...
| *Lagername*
|Name des Lagers.
//TO BE ADJUSTED ACCORDING TO FEEDBACK
| *Lagertyp*
...
//Hier anstatt dyn. Export den Katalog erwähnen?
...
//Hieraus einen FAQ-Bereich erstellen?
// Frage: What is the fallback when mapping SLs? Wie erfolgt die Zuordnung eines Lagerorts?
[#1500]
