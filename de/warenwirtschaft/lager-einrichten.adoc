...
Hinweis: Damit für eine Variante die Differenz zum Meldebestand basierend auf dem dynamischen Meldebestand berechnet wird, muss der <<warenwirtschaft/wareneingaenge-verwalten/#200, Meldebestand der Variante>> für das Lager 0 sein. +
*inaktiv* = die Differenz zum Meldebestand wird für Varianten in diesem Lager nicht basierend auf dem dynamischen Meldebestand berechnet, sondern basierend auf dem <<warenwirtschaft/wareneingaenge-verwalten/#200, eingetragenen Meldebestand>>. Sie können also einen Meldebestand für die Variante eintragen, der größer als 0 ist.
