...
Der Zweck *Box* wird für die link:https://knowledge.plentymarkets.com/app/funktionen/lagerverwaltung/rollende-kommissionierung[rollende Kommissionierung] genutzt. +
