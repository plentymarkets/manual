...
Nutzer vom Typ *Backend* sehen nur bestimmte Bereiche und Menüs im plentymarkets Backend. Somit können sie nur eingeschränkt im System arbeiten. Sollen Mitarbeiter mit dem Zugang *Backend* mit Lagern arbeiten können, muss ein Nutzer vom Typ *Admin* das im folgenden beschriebene Recht für Benutzer mit dem Zugang *Backend* vergeben.
...
|Erlaubt dem Backend-Benutzer, Lagerorte zu aktualisieren.

| *Warenbestände > Lager > Lagerort > Anzeigen*
|Erlaubt dem Backend-Benutzer, Lagerorte zu sehen.

| *Warenbestände > Lager > Lagerort > Erstellen*
|Erlaubt dem Backend-Benutzer, Lagerorte zu erstellen.
...
Wie du Eigenschaften gruppierst und mit Eigenschaftsgruppen arbeitest ist auf der Handbuchseite <<willkommen/allgemeine-funktionen/eigenschaften#, Eigenschaften>> beschrieben.
...
include::_textblocks/instructions/eigenschaft-erstellen.adoc[]
...
Du kannst bis zu 3 Eigenschaften mit einem Lagerort verknüpfen.

[.instruction]
Eigenschaften mit Lagerorten verknüpfen:

. Öffne das Menü *Einrichtung » Einstellungen » Waren » Lager* » _Lager wählen_.
. Klicke auf *Lagerorte*. +
→ Die Übersicht wird geöffnet.
. Wähle einen Lagerort, den du mit den Eigenschaften verknüpfen möchtest. +
...
Die IDs deiner Lager findest du im Menü *Einrichtung » Waren » Lager » _Lager wählen_ » Einstellungen* und die deiner Lagerorte im Menü *Einrichtung » Waren » Lager » _Lager wählen_ » Lagerorte*.
