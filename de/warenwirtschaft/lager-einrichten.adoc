...
Wie du Eigenschaften gruppierst und mit Eigenschaftsgruppen arbeitest ist auf der Handbuchseite <<basics/arbeiten-mit-plentymarkets/eigenschaften#, Eigenschaften>> beschrieben.
