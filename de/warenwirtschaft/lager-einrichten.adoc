...
. Nehmen Sie die Einstellungen vor. Beachten Sie hierzu die Tabelle <<tabelle-Lagerorte-generieren>>
. Tragen Sie pro Dimension bei *Von* einen Startwert ein.
. Tragen Sie pro Dimension bei *Bis* einen Endwert ein.
. Tragen Sie pro
. **Speichern** Sie die Einstellungen. +
