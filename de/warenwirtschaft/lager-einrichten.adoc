...
*_Tipp:_* Auf *Eigenschaftsgruppe hinzufügen* (icon:plus-square[role="green"]) klicken, um eine Gruppe zu erstellen.
...
Auf *Wert hinzufügen* (icon:plus-square[role="green"]) klicken, um einen Wert zu erstellen. +
