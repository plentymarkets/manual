...
. Öffnen Sie das Menü **System » Waren » Bestellwesen » Einstellungen**.
...
[NOTE]
.Differenz zum Meldebestand dynamisch berechnen
====
Die Differenz zum Meldebestand, MeldΔ, kann basierend auf dem dynamischen Meldebestand ermittelt werden. Der dynamische Meldebestand selbst wird jedoch noch nicht im System dargestellt. Die Berechnung erfolgt pro Lager. Damit MeldΔ dynamisch berechnet wird, muss die Lagereinstellung *Dynamischer Meldebestand* als *aktiv* gespeichert werden. Außerdem muss der Meldebestand der Variante für das Lager 0 sein. Wenn ein Meldebestand größer als 0 gespeichert ist, wird die Berechnung nicht ausgeführt.
====
...
. Öffnen Sie das Menü **System » Waren » Bestellwesen » Bestellstatus**.
. Wechseln Sie in das Tab **Neue Sprache**.
. Wählen Sie Deutsch oder Englisch aus dem Dropdown-Menü.
. **Speichern** Sie die Einstellungen. +
...
. Öffnen Sie das Menü **System » Aufträge » Dokumente » Nachbestellung**.
...
. **Speichern** Sie die Einstellungen.
. Wählen Sie aus dem Dropdown-Menü **PDF-Anhang** die Option **Nachbestellung (PDF)**.
...
--
. Öffnen Sie das Menü **System » Waren » Bestellwesen » Ereignisse**.
...
Pro Lager können Sie entscheiden, ob Sie mit den dynamischen Meldebestand nutzen oder nicht. Wenn Sie den dynamischen Meldebestand nutzen, berechnet ihr System im Hintergrund den dynamischen Meldebestand. Allerdings wird der dynamische Meldebestand noch in keinem Feld dargestellt, d.h. Sie sehen den Wert nicht. Die Differenz zum Meldebestand, MeldΔ, basiert dann jedoch auf dem dynamischen Meldebestand. So können Sie anhand der Differenz absehen wann eine Nachbestellung erfolgen sollte.
Wenn Sie den dynamischen Meldebestand nutzen, dürfen Sie manuell keinen statischen Meldebestand eintragen. Belassen Sie den Meldebestand für die Varianten in dem Lager auf 0.

Der dynamische Meldebestand wird jede Nacht anhand der folgenden Formel berechnet:

latexmath:[Dynamischer Meldebestand = {(Durchschnittlicher Abverkauf \cdot Lagerreichweite) + (Durchschnittlicher Abverkauf \cdot kürzeste Lieferzeit einer Variante)}]

Die Differenz zum dynamischen Meldebestand (MeldΔ), die Ihnen auch dargestellt wird, berechnet sich folgendermaßen:

latexmath:[MeldΔ = {dynamischen Meldebestand - (Nettobestand + nachbestellte Menge)}]


<<warenwirtschaft/lager-einrichten#Meldebestand_Variante_Lager, Testlink zum dyn. Meldebestand>>

<<warenwirtschaft/lager-einrichten#Meldebestand_Variante_Lager, Testlink zur Lagerpriorität>>
<<warenwirtschaft/lager-einrichten/Meldebestand_Variante_Lager, Testlink 2 zur Lagerpriorität>>

<<warenwirtschaft/lager-einrichten#Anker_Lagertyp, Testlink zum Lagertyp>>
<<warenwirtschaft/lager-einrichten/Anker_Lagertyp, Testlink 2 zum Lagertyp>>
...
→ Der Umrechnungskurs wird automatisch aus dem Menü **System » Aufträge » Zahlung » Währungen** übernommen.
. **Speichern** Sie die Einstellungen. +
...
Beachten Sie dazu auch die Erklärungen auf der Handbuchseite **<<auftragsabwicklung/auftraege/auftragsdokumente#, Dokumente>>**.
====
...
Die Vorschau ermöglicht per Klick auf das **Auge**, das PDF-Dokument der <<auftragsabwicklung/auftraege/einstellungen/dokumente/nachbestellung#, **Nachbestellung**>> jederzeit downzuloaden. Bei Änderungen der Vorlage oder der PDF-Vorlage der Nachbestellung auf das Reload-Icon klicken, um das PDF-Dokument zu aktualisieren.  +
...
Im Menü **System » Waren » Bestellwesen » Bestellstatus** sind die Statusbenennungen änderbar.
...
. Öffnen Sie das Menü **System » Waren » Bestellwesen » Bestellungen löschen**.
