...
====
Die Differenz zum Meldebestand, MeldΔ, kann auch dynamisch ermittelt werden. Der Meldebestand selbst ist jedoch nicht dynamisch. Die Berechnung erfolgt pro Lager. Damit MeldΔ dynamisch berechnet wird, muss die Lagereinstellung *Dynamischer Meldebestand* als *aktiv* gespeichert werden. Außerdem muss der Meldebestand der Variante für das Lager 0 sein. Wenn ein Meldebestand größer als 0 gespeichert ist, wird die Berechnung nicht ausgeführt.
====
