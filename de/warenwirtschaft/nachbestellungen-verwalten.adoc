...
Beachten Sie dazu auch die Erklärungen auf der Handbuchseite **<<auftraege/einstellungen/dokumente#, Dokumente  >>**.
====
...
Die Vorschau ermöglicht per Klick auf das **Auge**, das PDF-Dokument der <<auftraege/einstellungen/dokumente/nachbestellung#, **Nachbestellung**  >> jederzeit downzuloaden. Bei Änderungen der Vorlage oder der PDF-Vorlage der Nachbestellung auf das Reload-Icon klicken, um das PDF-Dokument zu aktualisieren.  +
