...
.E-Mail Vorlage einrichten
====
Vor der Nutzung des E-Mail-Service für die Abwicklung der Nachbestellung musst du im Menü *Einrichtung » Mandant » Mandant wählen » E-Mail » Vorlagen* eine E-Mail-Vorlage für diesen Zweck erstellen. Weitere Informationen findest du auf der Handbuchseite <<crm/e-mails-versenden#1200, E-Mails versenden>>.
====
