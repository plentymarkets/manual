...
Die Übersichtstabelle im Menü *Waren » Bestellwesen » Bestellung* sowie die Tabellen in einer geöffneten Nachbestellung sind individuell anpassbar. Das bedeutet, dass du selbst entscheiden kannst, welche Informationen dir in den Tabellenspalten angezeigt werden. Gehe dafür folgendermaßen vor:
...
Wenn du deine Tabelle angepasst hast, wird diese Auswahl gespeichert. Die Tabelle ist jederzeit anpassbar.
