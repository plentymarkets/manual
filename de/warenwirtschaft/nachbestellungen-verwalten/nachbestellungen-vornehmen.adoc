...
====
Vor der erstmaligen Nutzung des Dokuments *Nachbestellung* muss die Dokumentenvorlage erstellt werden. Solange keine Vorlage eingerichtet wurde, kann der Bestellschein nicht erzeugt werden.
====

Im Folgenden wird erste beschrieben, wie du die einfache Standard-Vorlage übernimmst, die in deinem plentymarkets System bereits hinterlegt ist.
...
|*Adressfeld*
|Positioniert das Feld, in dem die Anschrift des Lieferanten angezeigt wird. CHECK

|*Dokumentenname / -nummer (z.B.: Nachbestellung)*
|Namen eintragen, beispielsweise *Nachbestellung* oder *Nachbestellungs-Nr.*. Lege anschließend die Positionierung und Größe des Feldinhaltes fest.

|*Datum*
|Aktuelles Datum des Dokuments. Lege anschließend die Positionierung und Größe des Feldinhaltes fest.

|*Bestelldatum*
|Datum der Bestellung. Lege anschließend die Positionierung und Größe des Feldinhaltes fest.

|*Währung*
|Namen der Währung eintragen. Lege anschließend die Positionierung und Größe des Feldinhaltes fest. CHECK

|*Liefertermin*
|Liefertermin eintragen. Lege anschließend die Positionierung und Größe des Feldinhaltes fest. (IST DAS DER AUS DEN DETAILS?)

|*eigene Kundennummer*
|Gib deine Kundennummer bei dem Lieferanten der Nachbestellung ein. Lege anschließend die Positionierung und Größe des Feldinhaltes fest.

|*Eigene USt-IdNr.*
|Gib deine Umsatzsteuernummer ein. Lege anschließend die Positionierung und Größe des Feldinhaltes fest.
...
Lege anschließend die Positionierung und Größe des Feldinhaltes fest.

|*Menge*
|Gibt jeweils die Menge der Artikelposition an. +
Dies ist ein Pflichtfeld.

|*Artikel-ID*
| Optional kannst du in dieser Spalte die Artikel-IDs ausgeben lassen. Genommen werden die Artikel-IDs, die im System hinterlegt sind.

|*Varianten-ID*
|Optional kannst du in dieser Spalte die Varianten-IDs ausgeben lassen. Genommen werden die Varianten-IDs, die im System hinterlegt sind.

|*Varianten-Nr.*
|Optional kannst du in dieser Spalte die Variantennummern ausgeben lassen. Genommen werden die Variantennummern, die im System hinterlegt sind.

|*Gewicht*
|Optional kannst du in dieser Spalte das Gewicht der Artikelposition ausgeben lassen. Genommen wird das Gewicht, das im System für den Artikel hinterlegt ist.

|*Artikelbezeichnung*
|

|*Lagerort*
|Optional kannst du eine Spalte mit dem Lagerort der jeweiligen Artikelposition ausgeben lassen. Genommen werden die Lagerorte, die im System am Artikel (ODER DER VARIANTE?) hinterlegt sind.

|*Einzelpreis*
|Optional kannst du eine Spalte mit dem Einzelpreis der Artikelposition ausgeben lassen. WELCHER PREIS? WIE VOM LIEFERANTEN BESTIMMT?

|*Gesamtpreis*
|Gibt den Gesamtpreis der Bestellung ODER DER ARTIKELPOSITIONEN?? an. +
Dies ist ein Pflichtfeld.

|*Einheit*
| Optional kannst du eine Spalte mit der Einheit ausgeben lassen. WO HINTERLEGT?

|*Variantenname*
|Optional kannst du eine Spalte mit Variantennamen ausgeben lassen. Genommen werden die Variantennamen, die im System hinterlegt sind.

|*Lieferanten-Artikelnummer*
|Optional kannst du eine Spalte mit der Lieferanten-Artikelnummer ausgeben lassen.

|*Lieferanten-Artikel-Bezeichnung*
|Optional kannst du eine Spalte mit der Lieferanten-Artikel-Bezeichnung ausgeben lassen.

|*GTIN*
|Optional kannst du eine Spalte mit der GTIN ausgeben lassen.

|*Attributauswahl*
|Optional kannst du eine Spalte mit für den Artikel ausgewählten Attributen ausgeben lassen. CHECK

|*Kommissionsnummer*
|Optional kannst du eine Spalte mit der Kommissionsnummer ausgeben lassen. WOHER?

|*Kunden-ID (Kommission)*
|Optional kannst du eine Spalte mit deiner Kunden-ID für Kommissionen ausgeben lassen. WOHER?

|*Kundenname (Kommission)*
|Optional kannst du eine Spalte mit deinem Kundennamen für Kommissionen ausgeben lassen. WOHER?
...
|*Auftragssumme*
|In der Spalte wird der Nettowarenwert als Auftragssumme ausgegeben.

|*Zwischensumme (jede Seite)*
|Ist das Nachgestellungs-Dokument mehrere Seiten lang, wird auf jeder Seite eine Zwischensumme ausgegeben.

2+| *Optionale Elemente*

|*Absender Adresszeile (1)*
|Optional kannst du eine Adresszeile mit der Absenderadresse (LAGER??) einfügen. Wähle dafür *JA* aus und lege anschließend die Positionierung fest.
...
|*Hinweis*
|SETZT SICH WIE ZUSAMMEN? EVTL. BEISPIEL EINFÜGEN.
...
. Nutze die Suchfunktion und öffne die zu bearbeitenden Benutzer:in.
...
Im Feld *Einkaufspreis* kannst du den voreingetragenen Einkaufspreis ändern oder gewährten Rabatt eingeben, falls deine Lieferant:in dir beispielsweise kurzfristig einen veränderten Preis zugesagt hat.
...
====
Hast du die Nachbestellung versehentlich abgeschlossen, klicke erneut auf das Symbol. So wird die Nachbestellung entsperrt und einzelne Informationen können erneut bearbeitet werden.
====
