...
Im Folgenden wird beispielhaft beschrieben, wie du eine Nachbestellung für Artikel anlegst, die den Meldebestand unterschritten haben. Im vorigen Kapitel wurde bereits beschrieben, wie du Artikel filterst, die den Meldebestand erreicht oder unterschritten haben. Die folgenden Schritte schließen sich an das Filtern an.
...
////
DONE: Kapitel 7 der alten HBS: Stimmt auch noch so.
