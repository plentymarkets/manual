...
. Klicke auf das *Warenkorb-Icon* (icon:cart-plus[role="green"]). +
...
| *Zahlungsziel*
|Manuell das Datum auswählen, das als Zahlungsziel festgelegt wird. Alternativ über die Funktion *Zahlungsziel ermitteln* nutzen. Das System berechnet dann auf Basis von *???* das passende Datum
