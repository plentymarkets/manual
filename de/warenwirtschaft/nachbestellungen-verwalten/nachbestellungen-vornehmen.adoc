...
| *Tags*
| Wähle <<warenwirtschaft/nachbestellungen-verwalten/nachbestellungen-vornehmen#130, Tags>>, um nach Nachbestellungen zu suchen, denen dieses Tag zugeordnet wurde. Du kannst mehrere Tags auswählen. Es handelt sich um eine "oder"-Suche. Das bedeutet, dass bei Auswahl von mehreren Tags alle Nachbestellungen in den Suchergebnissen angezeigt werden, denen eines dieser Tags zugeordnet wurde.
