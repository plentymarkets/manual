...
:keywords: Nachbestellung, Waren nachbestellen, Bestellwesen, Waren, Bestellung, Lieferanten, Varianten, Auftragsposition, Rückstandsliste, Meldebestand, Abverkaufszeitraum, Bestellmengenvorschlag, Bestellmengen, Nachbestellungs-Status, Nachbestellungsstatus, Nachbestellungsvorschlag, Nachbestellungs-Vorschlag, Warenbestand, Nettobestand, Netto-Bestand, Nettowarenbestand, Netto-Warenbestand, Wiederbeschaffungszeit, Lagerreichweite, Dokument, Nachbestellungstag, Nachbestellungs-Tag, Bestellschein, Mandant, dynamischer Meldebestand, statischer Meldebestand, Abverkauf, Mindestabnahme, Artikel, Einkaufspreis, Wareneingang, Lieferdatum, Händlerzeichen, Währung, Rückstandsliste, Waren einbuchen, Wareneinbuchung, Lagerort, Teilmenge, Teilmengen buchen, Warenbewegung, Menge, Umbuchung, stornieren, Teilmenge stornieren, Zulauf, Nachbestellung abschließen
...
Möchtest du das Dokument *Nachbestellung* individueller gestalten, zum Beispiel das Logo deiner Firma oder zusätzliche Informationen darauf abbilden, dann gehe gemäß der Anleitung auf der Handbuchseite zum Thema <<auftraege/auftragsdokumente#300, Auftragsdokumente>> vor.
...
====
Auf dem Dashboard deines Systems kannst du anzeigen lassen, wie viele Varianten eines Lagers den Meldebestand unterschritten haben. Füge dafür das Element *Artikel unter Meldebestand* hinzu. Ein Klick auf die Anzahl der Varianten öffnet das Menü *Waren » Warenbestände* und filtert nach Varianten unter Meldebestand.
====
...
====
Eine Mindestabnahme lässt sich nur eingeben, wenn der Variante ein Lieferant zugeordnet ist. Wenn kein Lieferant zugeordnet ist, füge zunächst den <<artikel/artikel-verwalten#310, Lieferanten hinzu>>.
====
...
[#180]
=== Rechte vergeben
Nutzer vom Typ *Backend* sehen nur bestimmte Bereiche und Menüs im plentymarkets Backend. Somit können sie nur eingeschränkt im System arbeiten. Sollen Mitarbeiter mit diesem Nutzertyp Nachbestellungen anlegen und abwickeln, muss ein Nutzer vom Typ *Admin* zumindest die in <<tabelle-rechte-nachbestellung>> beschriebenen Rechte für diese Benutzer vergeben.

Allgemeine Informationen zur Vergabe von Rechten findest du auf der Handbuchseite <<business-entscheidungen/benutzerkonten-zugaenge#105, Benutzer verwalten>>.
...
. Aktiviere im Bereich *Berechtigungen* die Berechtigungen anhand von <<tabelle-rechte-nachbestellung>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.

[[tabelle-rechte-nachbestellung]]
...
| *POS > Kasse anzeigen*
|Erlaubt dem Backend-Benutzer, die über POS integrierte Kasse einzusehen.

| *Aufträge > Anzeigen*
|Erlaubt dem Backend-Benutzer, Aufträge im plentymarkets System einzusehen.

| *Aufträge > Auftragsposition > Transaktionen*
|Erlaubt dem Backend-Benutzer, Warenbewegungen an Aufträgen einzusehen.

| *Aufträge > Bestellungen*
|Erlaubt dem Backend-Benutzer, Bestellungen anzulegen und die dazugehörigen Einstellungen zu bearbeiten.

| *Aufträge > Buchung*
|Erlaubt dem Backend-Benutzer, Waren ein- und auszubuchen.

| *Aufträge > Dokumente > Anlegen*
|Erlaubt dem Backend-Benutzer, Auftragsdokumente anzulegen.

| *Aufträge > Dokumente > Anzeigen*
|Erlaubt dem Backend-Benutzer, Auftragsdokumente einzusehen

| *Artikel > Aktionen > Bearbeiten*
|Erlaubt dem Backend-Benutzer, Artikel zu bearbeiten.

| *Artikel > Artikel > Variante > Variante anzeigen*
|Erlaubt dem Backend-Benutzer, Varianten einzusehen.

| *CRM > Kontakt > Anzeigen*
|Erlaubt dem Backend-Benutzer, auf den Kontaktdatensatz (z.B. des Lieferanten) zuzugreifen.

| *CRM > Nachricht > Anzeigen*
|Erlaubt dem Backend-Benutzer, Nachrichten im Messenger einzusehen.

| *Einrichtung > Eigenschaft > Anzeigen*
|Erlaubt dem Backend-Benutzer, Eigenschaften einzusehen.

| *Einrichtung > Tag > Anzeigen*
|Erlaubt dem Backend-Benutzer, Tags einzusehen.

| *Einrichtung > Tag > Löschen*
|Erlaubt dem Backend-Benutzer, Tags zu löschen.

| *Einrichtung > Tag > Tag-Verknüpfung*
|Erlaubt dem Backend-Benutzer, Tag-Verknüpfungen anzuzeigen, zu aktualisieren, zu erstellen und zu löschen.

| *Warenbestände > Anzeigen*
|Erlaubt dem Backend-Benutzer, Warenbestände einzusehen.

| *Warenbestände > Lager*
|Erlaubt dem Backend-Benutzer, Informationen zu Lagern einzusehen.

| *Warenbestände > Lagerort-Verwaltung*
|Erlaubt dem Backend-Benutzer, die Lagerort-Verwaltung zu nutzen.

| *Warenbestände > Nachbestellung*
|Erlaubt dem Backend-Benutzer, Nachbestellungen einzusehen und zu bearbeiten.
...
Weitere Informationen zum Messenger allgemein findest du auf der Handbuchseite <<crm/kontakte-verwalten#, Kontakte>> im Kapitel <<crm/kontakte-verwalten#1390, Nachrichten mit dem Messenger verwalten>>.

[#200]
== Varianten für die Nachbestellung identifizieren
Für eine gut funktionierende Warenwirtschaft ist es wichtig, nachzubestellende Varianten zeitnah zu ermitteln. So vermeidest du, dass dir Artikel ausgehen und verhinderst somit unnötig lange Lieferzeiten für deine Kunden.
...
Je nach Bedarf bietet dir dein plentymarkets System verschiedene Möglichkeiten an, Nachbestellungen anzulegen. Du kannst Artikel direkt nachbestellen, wenn diese den Meldebestand unterschritten haben, Artikel direkt pro Lager und Liferant nachbestellen, eine Nachbestellung aus einem Auftrag heraus anlegen oder gezielt einzelne Varianten nachbestellen. In den folgenden Unterkapiteln werde alle Vorgehensweisen erklärt, so dass du abhängig von deiner Arbeitsweise den passenden Workflow für dich auswählen kannst.

[#310]
=== Artikel unter Meldebestand nachbestellen

Wenn ein Artikel den Meldebestand erreicht oder unterschritten hat, kannst du eine Nachbestellung anlegen. Diese Artikel werden dir wie im Kapitel <<#200, Varianten für die Nachbestellung identifizieren>> beschrieben angezeigt. Die folgenden Schritte schließen sich an das dort erklärte Filtern an.
...
Wenn du *Mengen für Varianten erhöhen* auswählst, kannst du in einem neuen Fenster die Bestellmenge für die Nachbestlleung der im Auftrag enthaltenen Varianten nachträglich erhöhen.
...
. Lieferant auswählen und mit dieser Variante verknüpfen, falls noch keiner hinterlegt sein sollte.
...
. Öffne das Menü *Waren » Bestellwesen » Bestellung*
. Suche (icon:search[role="blue"]) anhand der Filtereinstellung die gewünschte Nachbestellung und öffne sie.
...
_Beachte_, dass die Nachbestellung nun angelegt, aber noch nicht ausgelöst wurde. Die Nachbestellung wurde also noch nicht an den Lieferanten übermittelt. Vor Auslösen der Nachbestellung kannst du im Bereich *Details* noch weitere Informationen hinterlegen, beachte dafür die nachfolgenden Kapitel. Löst du die Nachbestllung nun aus, lassen sich die Artikelpositionen nicht mehr bearbeiten.
...
Im Feld *Einkaufspreis* kannst du den voreingetragenen Einkaufspreis ändern oder gewährten Rabatt eintragen, falls dein Lieferant dir beispielsweise kurzfristig einen veränderten Preis zugesagt hat.
...
Gehe wie im Folgenden beschrieben vor, um den Bestellschein manuell zu erzeugen. Je nach Workflow kannst du auch einen bereits erstellten Bestellschein durch Hochladen des Scheins hinterlegen, falls dir das Dokument vom Lieferanten übermittelt wurde.
...
Abhängig von deinen Arbeitsabläufen, Lieferanten und Nachbestellungen, kann es sein, dass nicht alle Zusatzkosten in der gleichen Währung anfallen. Damit in einer Nachbestellung aber alle Kosten in derselben Währung angezeigt werden, kannst du an jeder der oben aufgelisteten Kosten den *Warenbezugskostenrechner* zur Umrechnung nutzen. Dieser befindet sich jeweils rechts an dem entsprechenden Kostenfeld und öffnet sich durch einen Klick. Beachte für die Nutzung die Erläuterungen in <<tabelle-einstellungen-warenbezugskostenrechner>>.

[[tabelle-einstellungen-warenbezugskostenrechner]]
...
| *Sender*
|Wenn du *Nachbestellung* im Filter *Auftrags-Typ* gewählts hast, werden dir für Sender deine im System hinterlegten Lieferanten in einer Dropdown-Liste angezeigt. Wähle einen der Lieferanten aus, wenn du Nachbestellungen, die du über diesen Lieferanten abwickelst, suchen möchtest.

| *Empfänger*
|Wenn du *Nachbestellung* im Filter *Auftrags-Typ* gewählts hast, werden dir für Empfänger deine im System hinterlegten Lager in einer Dropdown-Liste angezeigt. Wähle eines der Lager aus, wenn du Nachbestellungen suchst, für die eines der Lager angegeben wurde. +
