...
|Entscheide dich aus der Dropdown-Liste für einen Filter, der in der Artikelsuche vorausgewählt sein soll.
...
|Aktivierst du diese Option, werden in den Suchergebnissen nur Artikel des Lieferanten angezeigt, der in den Auftragsdetails ausgewählt wurde.
