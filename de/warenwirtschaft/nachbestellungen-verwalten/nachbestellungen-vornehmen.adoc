...
Mit Hilfe der Filter Bookmarks (icon:bookmarks[set=material]) kannst du ausgewählte Filter in der UI speichern. Die damit ausgewählten Filter sind dann bei jedem Öffnen des Menüs vorausgewählt, ähnlich wie Lesezeichen. Jede:r Benutzer:in kann eigene Filter festlegen.
