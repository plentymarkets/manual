...
|Namen eintragen, beispielsweise *Nachbestellung* oder *Nachbestellungs-Nr.*.
...
|*Währung*
|Namen der Währung eintragen.

|*Liefertermin*
|Liefertermin eintragen. (IST DAS DER AUS DEN DETAILS?)

|*eigene Kundennummer*
|Gib deine Kundennummer bei dem Lieferanten der Nachbestellung ein.

|*Eigene USt-IdNr.*
|Gib deine Umsatzsteuernummer ein
...
|*Artikelpositionen*
|In diesem Abschnitt positionierst du die Artikelpositionen auf dem Dokument.

|*Anzahl Nachkommastellen bei Auftragspositionen*
|Zwischen 2 und 4 Nachkommastellen für die Anzeige wählen. Diese Einstellung beeinflusst nur die Anzeige auf Dokumenten und bestimmt nicht mit wie vielen Nachkommastellen Preise berechnet werden. Ob das System mit 2 oder 4 Nachkommastellen Preise berechnet, stellst du im Menü *Einrichtung » Mandant » [Mandant wählen] » Standorte » [Standort wählen] » Buchhaltung*.
...
|*Artikel-ID*
| Wie im System am Artikel gepflegt?
...
|*Artikelbezeichnung*
|WOher werden Infos genommen? Was genau?
...
|*Einheit*
| Erstes freies Feld die Benennung?
