...
====
Möchtest du im Anschluss an das automatische Erzeugen des Bestellscheins diesen auch automatisiert an den Lieferanten senden, richte zusätzlich die im Kapitel <<#150, Versand der Nachbestellung vorbereiten>> beschriebene Ereignisaktion ein.
====
