...
Beim Öffnen des Menüs *Waren » Bestellwesen* werden dir alle Nachbestellungen und angezeigt. Das Ergebnis kannst du durch Verändern der Filter einschränken, um so entweder alle oder ein weiter eingeschränktes Ergebnis anzuzeigen.

[.instruction]
Nachbestellung suchen:

. Öffne das Menü *Waren » Bestellwesen* +
. Wählen einen der in <<tabelle-nachbestellung-suchen-filter>> beschriebenen Filter, um die Ergebnisse einzugrenzen.
. Klicke auf *Suchen*.
