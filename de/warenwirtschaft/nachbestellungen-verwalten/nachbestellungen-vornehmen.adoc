...
. Öffne das Menü *Waren » Bestellwesen » Bestellung*
. Suche anhand der Filtereinstellungen die gewünschte Nachbestellung und öffne sie.
...
Beim Öffnen des Menüs *Waren » Bestellwesen » Bestellung* werden dir alle Nachbestellungen und <<warenwirtschaft/umbuchungen-vornehmen#, Umbuchungen>> in einer Übersichtstabelle angezeigt. Wende die Suche (icon:search[]) an, um die angezeigten Umbuchungen und Nachbestellungen eingrenzen.
