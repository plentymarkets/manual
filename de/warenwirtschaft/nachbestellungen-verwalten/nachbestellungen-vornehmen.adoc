...
*_Oder_*: Wähle die Option *Negativer Netto-Warenbestand oder Netto-Warenbestand gleich 0*, wenn du den Meldebestand nicht nutzt.
...
*_Oder_*: Wenn nicht alle im Auftrag enthaltenen Positionen nachbestellt werden sollen, wähle die nachzubestellenden Auftragspositionen aus und klicke auf *Markierte Positionen nachbestellen*. +
→ Die Nachbestellung wird geöffnet.
...
*_Oder_*: Wähle die Option *Bestellschein hochladen*, um einen vom Lieferanten erstellten Bestellschein hochzuladen. +
