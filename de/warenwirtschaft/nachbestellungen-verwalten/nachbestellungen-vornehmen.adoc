...
Es kann vorkommen, dass du eine Nachbestellung bezogen auf ein spezielles Lager oder eine spezielle Lieferant:in anlegen möchtest. Gehe dazu wie im Folgenden beschrieben vor.
...
Im Feld *Einkaufspreis* kannst du den voreingetragenen Einkaufspreis ändern oder gewährten Rabatt eintragen, falls deine Lieferant:in dir beispielsweise kurzfristig einen veränderten Preis zugesagt hat.
...
.E-Mail Vorlage einrichten
====
Vor der Nutzung des E-Mail-Service für die Abwicklung der Nachbestellung musst du im Menü *Einrichtung » Mandant » _Mandant wählen_ » E-Mail » Vorlagen* eine E-Mail-Vorlage für diesen Zweck erstellen. Weitere Informationen findest du auf der Handbuchseite <<crm/e-mails-versenden#1200, E-Mails>>.
====
