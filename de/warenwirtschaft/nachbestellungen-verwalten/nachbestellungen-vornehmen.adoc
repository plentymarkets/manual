...
|*Gesamtpreis*
|Gibt den Gesamtpreis der der Artikelpositionen in der Nachbestellung auf dem Dokument aus. Vergib einen Namen für die Spalte und lege die Tabellenposition sowie die Spaltengröße fest. +
Dies ist ein Pflichtfeld.
