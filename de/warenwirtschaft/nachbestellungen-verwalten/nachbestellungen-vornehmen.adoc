...
====
Diese Handbuchseite beschreibt das Anlegen und Verwalten von Nachbestellungen mit der Betaversion der neuen Funktionalitäten zur Nachbestellung. Diese Funktionalitäten werden erst nach Abschluss der Testphase in den kommenden Wochen in allen plentymarkets Systemen sichtbar. Weitere Informationen zum Stand der Veröffentlichung findest du in diesem link:https://forum.plentymarkets.com/t/ankuendigung-releaseprozess-neue-nachbestellung/542252[Forumsbeitrag^] (Stand 24.05.2019).
====
...
|Erlaubt dem Backend-Benutzer, Varianten anzuzeigen.
