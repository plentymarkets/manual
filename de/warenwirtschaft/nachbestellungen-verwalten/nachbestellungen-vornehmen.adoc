...
Du kannst in der Nachbestellung auf der linken Seite auf *Messenger* klicken oder den Messenger im unteren Bereich der Nachbestellung aufklappen.

Klicke auf das Plus, um eine neue Nachricht hinzuzufügen. Wähle einen Empfänger aus und weise der Nachricht einen oder mehrere Tags zu. Es ist außerdem möglich, der Nachricht beliebig viele Dateianhänge hinzuzufügen.

Nach Absenden der Nachricht, wird die Nachricht dann automatisch mit der Nachbestellungs-ID verknüpft. Die Nachricht kann nach der Bearbeitung als geschlossen markiert werden.

Weitere Informationen findest du auf der Handbuchseite <<crm/kontakte-verwalten#, Kontakte>> im Kapitel <<crm/kontakte-verwalten#1390, Nachrichten mit dem Messenger verwalten>>.

[#150]
=== Versand des Bestellscheins vorbereiten
Nachdem du im vorherigen Schritt die Dokumentenvorlage für den Bestellschein eingerichtet hast, solltest du im Folgenden noch Einstellungen zum Versand des Dokuments vornehmen, damit dein Lieferant die Nachbestellung auch erhält. Hierfür richtest du zunächst eine E-Mail-Vorlage ein, die den Bestellschein als PDF-Anhang enthält. Die grundlegenden Schritte zur Einrichtung der E-Mail-Vorlage werden im Folgenden beschrieben. Weitere Informationen zu E-Mail-Vorlagen findest du auf der Handbuchseite <<crm/e-mails-versenden#1200, E-Mails>>.
...
Allgemeine Informationen zum Vergeben von Rechten findest du auf der Handbuchseite <<business-entscheidungen/benutzerkonten-zugaenge#105, Benutzer verwalten>>.
...
| *plentymarkets Logo (Start) > Dashboard*
|Erlaubt dem Backend-Benutzer, den Startbildschirm des Backends inklusive Dashboard zu sehen.

| *POS > Kasse anzeigen*
|Erlaubt dem Backend-Benutzer, die über POS integrierte Kasse anzuzeigen.

| *Aufträge > Aufträge anzeigen*
|Erlaubt dem Backend-Benutzer, Aufträge im plentymarkets System anzuzeigen.
...
| *Aufträge > Dokumente*
|Erlaubt dem Backend-Benutzer, Auftragsdokumente anzulegen und anzuzeigen. Aktivieren Sie die beiden Optionen *Dokument anlegen* und *Dokument anzeigen*.

| *Artikel > Artikelbearbeitung*
|Erlaubt dem Backend-Benutzer, Artikel zu bearbeiten.

| *Artikel > Artikelbearbeitung > Variante > Variante anzeigen*
...
| *Warenbestände > Bestände anzeigen*
|Erlaubt dem Backend-Benutzer, Warenbestände einzusehen.

| *Warenbestände > Lager*
|Erlaubt dem Backend-Benutzer, Informationen zu Lagern einzusehen. Aktivieren Sie alle der folgenden Optionen: *Lager bearbeiten*, *Lageradresse* und *Lagerort*
...
|Erlaubt dem Backend-Benutzer, Nachbestellungen anzuzeigen und zu bearbeiten.
...
. Klicke auf den *Briefumschlag*, um die E-Mail zu versenden.
...
In der Detailansicht stornierst du eine Nachbestellung zum Beispiel dann, wenn noch offene Mengen nicht mehr geliefert werden. Öffne dafür im Menü *Waren » Bestellwesen » Bestellung* die entsprechende Nachbestellung und klicke im Bereich *Auftragspositionen* auf *Offene Mengen stornieren*. Die noch nicht gelieferten Artikel werden storniert und aus dem Zulauf genommen. Schließe danach die Nachbestellung ab, indem du in den Details auf *Bestellung abschließen* klickst. Dadurch werden die offenen Positionen der Nachbestellung nicht mehr für den Zulauf anerkannt, sie wird auch nicht mehr in der Rückstandsliste geführt und die Nachbestllung ist abgeschlossen.
