...
. Nimm die Einstellungen gemäß <<tabelle-dokumenteneinstellungen-nachbestellung>> vor. +
...
[[tabelle-dokumenteneinstellungen-nachbestellung]]
...
|*Gewicht*
|Optional kannst du in dieser Spalte das Gewicht der Artikelposition ausgeben lassen. Genommen wird das Gewicht, das im System für den Artikel hinterlegt ist. BRUTTO
...
|*Gesamtpreis*
|Gibt den Gesamtpreis der DER ARTIKELPOSITIONEN an. +
Dies ist ein Pflichtfeld.

|*Einheit*
| Optional kannst du eine Spalte mit der Einheit ausgeben lassen.
