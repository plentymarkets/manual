...
Arbeitest du bereits mit der neuen Funktionalität zur Abwicklung von <<warenwirtschaft/nachbestellungen-verwalten/nachbestellungen-vornehmen#, Nachbestellungen>> in deinem plentymarkets System? Dann erklärt dir dieses Best Practice, wie du die Daten deiner Nachbestellungen über das Zusammenspiel zwischen FormatDesigner und Elastischem Export exportieren kannst.

[IMPORTANT]
.Funktionalitäten der neuen und alten Nachbestellung
====
Wir empfehlen dir besonders, die folgenden Anleitungen zu befolgen, wenn du schon mit der vorherigen Version der Nachbestellungen gearbeitet hast. Im Rahmen des Umstiegs auf die neue Funktionalität ist der Export von Nachbestellungen nur noch über den Elastischen Export möglich.
====
...
image::warenwirtschaft/assets/DE-Best-Practices-Nachbestellungen-01.png[]
