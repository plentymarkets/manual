...
====
Wähle für das erste im Bild gezeigte Feld OrderItemProperty.Value die Zuordnung *Externe Artikel ID* und für das zweite die Zuordnung *Lager*, um das Format im Elastischen Export korrekt einzurichten.
====
