...
Um festzuhalten, welche Artikelmengen vor der Inventur auf Lager waren, solltest du einen Export durchführen. Dies geschieht über den <<daten/daten-exportieren/dateiexport#, Katalog>> und das Exportformat <<daten/daten-exportieren/katalog-warenbestaende#, Warenbestände>>.
...
Das Katalogformat <<daten/daten-exportieren/katalog-warenbewegungen#, Warenbewegungen>> vereinfacht die Auswertung der Inventurergebnisse. Der Katalog mit diesem Format ermöglicht es, Abweichungen zwischen Zählung und vorherigem Bestand im System pro Variante sowie Abweichungen auf einzelnen Lagerorten festzustellen. +
...
Um nur die Warenbewegungen zu exportieren, die mit der Inventur zu tun haben, setze außerdem den Filter für den <<daten/daten-exportieren/katalog-warenbewegungen#30, Grund>> *Warenkorrektur durch Inventur* mit der ID `302`.
...
Nutze dafür zunächst den Filter für den <<daten/daten-exportieren/katalog-warenbewegungen#30, Datumsbereich>>, in dem die Inventur stattgefunden hat. Um nur die Warenbewegungen zu erhalten, die mit der Inventur zu tun haben, verwende außerdem den Filter für den <<daten/daten-exportieren/katalog-warenbewegungen#30, Grund>> *Korrektur durch Inventur* mit der ID `302`.
