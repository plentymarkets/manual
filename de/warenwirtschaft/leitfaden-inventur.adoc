...
====
Aktuell beinhalten Zählprotokolle nur Daten zu Inventuren, die mit der <<warenwirtschaft/plentywarehouse#, plentyWarehouse App>> durchgeführt werden. Inventuren, die mit der <<app/funktionen/lagerverwaltung/inventur#, plentymarkets App>> oder lediglich durch den <<warenwirtschaft/inventur-vornehmen#100, Export und Import von Warenbeständen>> vorgenommen werden, können also nicht mithilfe des Zählprotokolls dokumentiert werden.
====
...
Erstelle einen Export mit dem Katalogformat <<daten/daten-exportieren/katalog-warenbewegungen#, Warenbewegungen>> und filtere dabei nach dem <<daten/daten-exportieren/katalog-warenbewegungen#30, Datumsbereich>> und dem <<daten/daten-exportieren/katalog-warenbewegungen#30, Grund>> für die Warenbewegung (ID 302). So werden nur die Warenbewegungen exportiert, die während und durch die Inventur entstanden sind. Wenn du ebenfalls den Filter für die <<daten/daten-exportieren/katalog-warenbewegungen#30, Summe der Warenbewegungen>> pro Variante nutzt, enthält der Export nur eine Datenzeile pro Variante.
