...
====
Wenn du mit den Prozessen und/oder der App arbeitest, solltest du die Funktionen zur Verwaltung von MHD/Chargen noch nicht nutzen, da MHD- und Chargen-Daten in der App und den Prozessen aktuell noch zu Fehlern führen können. Diese Funktionen werden in Kürze nachgeliefert.
====
