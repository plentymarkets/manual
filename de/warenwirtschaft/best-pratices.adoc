= Best Practices: Bestand umbuchen / korrigieren / löschen
:lang: de
...
Wie das allgemeine Vorgehen beim Importieren und Exportieren von Daten ist, wird im Handbuch unter <<basics/datenaustausch/export-import/daten-exportieren#, Daten exportieren>> und <<basics/datenaustausch/export-import/daten-importieren#, Daten importieren>> erläutert.
Welche Datenformate außerdem zur Verfügung stehen, findest du <<basics/datenaustausch/export-import/datenformate#, hier>> ebenfalls.
