...
Mit dem Datenformat **OrderComplete** exportieren Sie Aufträge. Dieses Datenformat steht ausschließlich für den Export zur Verfügung. Sie erstellen und exportieren das Datenformat im Menü **Datenaustausch » Dynamischer Export**. Wie Sie das Datenformat exportieren, ist auf der Handbuchseite **<<datenaustausch/daten-exportieren#, Daten exportieren  >>** beschrieben.
