...
Verwenden Sie das Datenformat **IncomingItems**, um nur bestimmte Wareneingänge und keinen kompletten Warenbestand zu importieren. Wie Sie den kompletten Warenbestand importieren, ist im Kapitel **<<datenaustausch/daten-importieren#120, Warenbestand importieren >>** auf der Handbuchseite **<<datenaustausch/daten-importieren#, Daten importieren  >>** beschrieben.
