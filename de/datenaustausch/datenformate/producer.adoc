...
Mit dem Datenformat **Producer** können Sie Hersteller exportieren, bearbeiten und importieren. Sie erstellen und exportieren das Datenformat im Menü **Datenaustausch » Dynamischer Export**. Importieren Sie das Datenformat wieder im Menü **Datenaustausch » Datenimport » Dynamischer Import**. Wie Sie das Datenformat exportieren und importieren, ist auf den Handbuchseiten **<<datenaustausch/daten-exportieren#, Daten exportieren  >>** und **<<datenaustausch/daten-importieren#, Daten importieren  >>** beschrieben.
...
Die in Tabelle 2 aufgelisteten Datenfelder stehen zum <<datenaustausch/daten-importieren#25., **Datenabgleich** >> zur Verfügung. Bei Pflichtabgleichfeldern (P) muss für die **Importaktion** die Option **Abgleich** gewählt werden. Wählen Sie mindestens eines der Datenfelder aus der Tabelle zum Abgleich.
