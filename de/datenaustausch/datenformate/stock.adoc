...
Detaillierte Informationen zur Vorgehensweise beim Datenaustausch mit dem Datenformat **Stock** finden Sie im Kapitel **<<datenaustausch/daten-exportieren#90., Warenbestände exportieren >>** auf der Handbuchseite **Daten exportieren**.
...
|**PriceUnit**
|Standardeinheit des Artikels; siehe Handbuchseite <<datenaustausch/datenformate/item#, **Datenformat Item**  >>.
|
