...
Mit dem Datenformat **CustomerProperty** exportieren, bearbeiten und importieren Sie die im Menü <<crm/kundendaten-verwalten#400., **Einstellungen » Kunden » Eigenschaften** >> gespeicherten Kundeneigenschaften. Sie erstellen und exportieren das Datenformat im Menü **Datenaustausch » Export » Dynamischer Export**. Importieren Sie das Datenformat wieder im Menü **Datenaustausch » Import » Dynamischer Import**. Wie Sie das Datenformat exportieren und importieren, ist auf den Handbuchseiten **<<datenaustausch/daten-exportieren#, Daten exportieren  >>** und **<<datenaustausch/daten-importieren#, Daten importieren  >>** beschrieben.
...
Die in Tabelle 2 aufgelisteten Datenfelder stehen zum <<datenaustausch/daten-importieren#25., **Datenabgleich** >> zur Verfügung. Bei Pflichtabgleichfeldern (P) muss für die **Importaktion** die Option **Abgleich** gewählt werden. Alternative Abgleichfelder sind mit einem **A** gekennzeichnet.
