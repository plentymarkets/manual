...
Das Datenformat **ItemListingMarketHood** wird verwendet, um neue Hood-Listings zu erstellen oder bestehende Hood-Listings zu bearbeiten. Sie können z.B. einzelne Parameter ändern oder löschen. Sie erstellen und exportieren das Datenformat im Menü **Datenaustausch » Dynamischer Export**. Importieren Sie das Datenformat wieder im Menü **Datenaustausch » Datenimport » Dynamischer Import**. Wie Sie das Datenformat exportieren und importieren, ist auf den Handbuchseiten **<<datenaustausch/daten-exportieren#, Daten exportieren  >>** und **<<datenaustausch/daten-importieren#, Daten importieren  >>** beschrieben.
