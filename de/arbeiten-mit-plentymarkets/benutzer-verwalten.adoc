...
|**Variabel**
|Klasse, für die im Benutzerkonto unter **Tab: Berechtigung**<<arbeiten-mit-plentymarkets/benutzer-verwalten#100, **Bereiche** >> und <<arbeiten-mit-plentymarkets/benutzer-verwalten#110, **Funktionen** >> freigeschaltet werden.
...
|**API**
|Klasse, für die im Benutzerkonto <<arbeiten-mit-plentymarkets/benutzer-verwalten#120, **API-Calls** >> freigeschaltet werden. Die API-Calls werden dann einzeln aktiviert. Es werden dem Benutzer also nicht pauschal alle API-Calls freigeschaltet.
...
|**Rollen**
|Rollen des Benutzers wählen. Damit Rollen zur Auswahl stehen, müssen zuvor <<arbeiten-mit-plentymarkets/benutzer-verwalten#70, **Rollen** >> erstellt werden.
...
|**Grußformel**
|In diesem Tab geben Sie einen Text ein, der Ihren Nachrichten und Kommentaren im Ticketsystem automatisch als <<arbeiten-mit-plentymarkets/benutzerkonto-personalisieren#10, **Grußformel** >> angefügt wird.

|**Signatur**
|In diesem Tab geben Sie einen Text ein, der Ihren Nachrichten und Kommentaren im Ticketsystem automatisch als <<arbeiten-mit-plentymarkets/benutzerkonto-personalisieren#20, **Signatur** >> angefügt wird.

|**Berechtigung**
|Dieses Tab wird im Kapitel <<arbeiten-mit-plentymarkets/benutzer-verwalten#90, **Berechtigungen zuordnen** >> detailliert beschrieben.

|**Persönliche Einstellungen**
|Hier nehmen Sie Einstellungen vor, die nur für den im System angemeldeten Benutzer gelten. Deshalb ist das Tab für Sie auch nur in Ihrem eigenen Benutzerkonto sichtbar. Das Tab unterteilt sich in die Tabs <<arbeiten-mit-plentymarkets/benutzerkonto-personalisieren#40, **Allgemein** >>, <<arbeiten-mit-plentymarkets/benutzerkonto-personalisieren#50, **Shortcuts** >> und <<arbeiten-mit-plentymarkets/benutzerkonto-personalisieren#60, **Favoriten** >>, die nur Sie persönlich betreffen.
...
Verwenden Sie Rollen z.B. auch bei **<<prozesse/prozesse-einrichten#, Prozessen  >>** im **<<tools/plentymarkets-client#, plentymarkets Client  >>**. Rollenbezogene Prozesse erstellen und verknüpfen Sie im plentymarkets Client.

image::arbeiten-mit-plentymarkets/assets/DE-Einstell-Grund-Benutzer-Rollen-03.png[]
