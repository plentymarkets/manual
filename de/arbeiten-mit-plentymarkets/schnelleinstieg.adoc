...
Der Schnelleinstieg ist in die Kapitel **<<arbeiten-mit-plentymarkets/schnelleinstieg#10, Basiseinstellungen >>**, **<<arbeiten-mit-plentymarkets/schnelleinstieg#270, Webshop einrichten >>** und **<<arbeiten-mit-plentymarkets/schnelleinstieg#690, Automatismen einrichten >>** untergliedert, die jeweils einen Teilbereich der Einrichtung Ihres Webshops abdecken. Arbeiten Sie diese Kapitel in der bestehenden Reihenfolge durch, da die Kapitel aufeinander aufbauen. Die schnelle Einrichtung eines funktionsfähigen Webshops steht im Vordergrund, weshalb nur die dafür notwendigen Funktionen beschrieben sind.
...
Bevor Sie Änderungen an Ihrem Webshop vornehmen, sollten Sie diesen <<mandant-shop/standard/webshop/webshop-sperren#, **sperren**  >> und Ihre Besucher währenddessen auf eine Seite mit einem Wartungshinweis umleiten. Nach Abschluss der Arbeiten müssen Sie Ihren Webshop wieder entsperren, sonst erhalten Sie keine Bestellungen mehr. Wir empfehlen Ihnen, nach jeder Wartung den Webshop über die Standard-URL in einem anderen Browser zu starten und bei dieser Gelegenheit alle Änderungen gründlich zu prüfen.
...
. Klicken Sie auf **Neu**. +
→ Das Fenster **<<arbeiten-mit-plentymarkets/benutzer-verwalten#10, Neuen Benutzer erstellen >>** wird geöffnet (Bild 1).
...
image::arbeiten-mit-plentymarkets/assets/DE-Schnelleinstieg-01.png[]
...
. Nehmen Sie Änderungen bzw. weitere Einstellungen vor. Beachten Sie dazu die Erläuterungen auf der Seite <<arbeiten-mit-plentymarkets/benutzer-verwalten#20, **Benutzer bearbeiten** >>.
. **Speichern** Sie die Einstellungen.

image::arbeiten-mit-plentymarkets/assets/DE-Schnelleinstieg-02.png[]
...
image::arbeiten-mit-plentymarkets/assets/DE-Schnelleinstieg-03.png[]
...
Die Einrichtung erfolgt in zwei Schritten. Zunächst laden Sie das Dokument im Menü <<cms/dokumente#, **CMS » Dokumente**  >> hoch. Dann verknüpfen Sie das Dokument mit einer E-Mail-Vorlage. Gehen Sie dazu wie im Folgenden beschrieben vor.
...
Im nächsten Schritt erfolgt die Einrichtung Ihrer Versandoptionen. Legen Sie zuerst fest, welche **<<fulfillment/versand-vorbereiten#100, Länder >>** Sie beliefern möchten. Diese werden in einem weiteren Schritt in **<<fulfillment/versand-vorbereiten#400, Regionen >>** eingeteilt, um Ihnen die weitere Einrichtung und spätere Verwaltung zu erleichtern. Nachdem Sie im dritten Schritt einen oder mehrere **<<fulfillment/versand-vorbereiten#800, Versanddienstleister >>** erstellt haben, erstellen Sie **<<fulfillment/versand-vorbereiten#1000, Versandprofile >>**. Schließlich richten Sie für jedes Versandprofil eine **<<fulfillment/versand-vorbereiten#1500, Portotabelle >>** ein.

Die Konfiguration des Versands erfolgt nach einem besonderen Konzept in plentymarkets. Sie legen dabei fest, welche Versandart und welche Versandkosten Bestellungen in Abhängigkeit von Lieferland und **<<auftraege/einstellungen/auftragsherkunft#, Auftragsherkunft  >>** zugeordnet werden. Für Ihre Aufträge von der Plattform eBay können Sie z.B. nicht nur mehrere eBay-Konten verwalten, sondern auch die einzelnen Listing-Typen unterscheiden und so ein sehr differenziertes Versandkostensystem aufbauen.

[#170]
==== Lieferländer einrichten

In der Übersicht sehen Sie alle **<<fulfillment/versand-vorbereiten#100, Lieferländer >>**, die in der ISO 3166-1 aufgeführt sind.
...
In diesem Bereich richten Sie die **<<fulfillment/versand-vorbereiten#800, Versanddienstleister >>** ein, mit denen Sie die Ware an Ihre Kunden verschicken möchten.
...
image::arbeiten-mit-plentymarkets/assets/DE-Schnelleinstieg-04.png[]
...
|**Mandanten (Shops)**
|Webshops oder **<<start/plentymarkets-konto/service-center/mandant-shop#, Mandanten  >>** wählen, für die das Versandprofil gelten soll (Mehrfachauswahl möglich).

|**Auftragsherkunft**
|**<<auftraege/einstellungen/auftragsherkunft#, Auftragsherkunft  >>** wählen, wenn das Versandprofil ausschließlich für bestimmte Aufträge gelten soll (Mehrfachauswahl möglich). Mindestens ein Versandprofil sollte die Auftragsherkunft **ALLE** beinhalten, damit tatsächlich für alle Aufträge mindestens ein Versandprofil zur Verfügung steht.

|**Gesperrte Zahlungsarten**, **Gesperrte Kundenklassen**
|**<<payment#, Zahlungsarten  >>** und **<<crm/kundendaten-verwalten#100, Kundenklassen >>** wählen, für die das Versandprofil nicht gelten soll (Mehrfachauswahl möglich).

|**eBay-Konto (nur bei Herkunft eBay)**
|Konten wählen, die genutzt werden sollen, wenn mehrere **<<multi-channel/ebay#30, Konten bei eBay >>** bestehen (Mehrfachauswahl möglich).

|**Listing-Typ (nur für eBay)**
|**<<multi-channel/ebay#350, Listing-Typen >>** wählen, für die das Profil gelten soll (Mehrfachauswahl möglich).
|====

[#210]
==== Portotabellen erstellen

Nachdem Sie Ihre Versandprofile erstellt haben, können Sie nun Ihre Versandkosten bearbeiten. Dazu erstellen Sie für jede Lieferregion eine eigene Portotabelle. Bevor Sie Werte eingeben, müssen Sie sich pro Region für einen der angebotenen **<<fulfillment/versand-vorbereiten#1600, Berechnungstypen >>** entscheiden.
...
Die folgenden **<<payment/zahlungsarten-verwalten#40, Zahlungsarten >>** stehen unabhängig von Zahlungsanbietern zur Verfügung:
...
❏ Wurden die Daten des <<arbeiten-mit-plentymarkets/schnelleinstieg#100, **Standardbenutzers** >> geändert?

❏ Sind die <<arbeiten-mit-plentymarkets/schnelleinstieg#120, **E-Mail-Kontodaten** >> (für Benachrichtigungen an Kunden) im System eingegeben?

❏ Wurde der <<arbeiten-mit-plentymarkets/schnelleinstieg#130, **Testmodus** >> aktiviert, damit alle E-Mails an den Administrator gesendet werden?

❏ Wurde der <<arbeiten-mit-plentymarkets/schnelleinstieg#140, **E-Mail-Infodienst** >> eingerichtet?

❏ Enthalten alle <<arbeiten-mit-plentymarkets/schnelleinstieg#150, **E-Mail-Vorlagen** >> die Variable **Link_Checkout()**?

❏ Sind alle <<arbeiten-mit-plentymarkets/schnelleinstieg#170, **Lieferländer** >> mit gleichen Portokosten zu <<arbeiten-mit-plentymarkets/schnelleinstieg#180, **Regionen** >> gruppiert?

❏ Sind alle <<arbeiten-mit-plentymarkets/schnelleinstieg#170, **Lieferländer** >> einer <<arbeiten-mit-plentymarkets/schnelleinstieg#180, **Region** >> zugeordnet?

❏ Wurden alle <<arbeiten-mit-plentymarkets/schnelleinstieg#190, **Versanddienstleister** >> inklusive Tracking-URL erstellt?

❏ Liegt für alle folgenden Optionen ein gültiges <<arbeiten-mit-plentymarkets/schnelleinstieg#200, **Versandprofil** >> vor?
...
❏ Haben Sie Ihre <<arbeiten-mit-plentymarkets/schnelleinstieg#210, **Portotabellen** >> für alle Regionen erstellt?

❏ Wurde für mindestens ein <<arbeiten-mit-plentymarkets/schnelleinstieg#200, **Versandprofil** >> die Option **Bei neuen Artikeln aktivieren** gewählt?

❏ Wurde mindestens eine <<arbeiten-mit-plentymarkets/schnelleinstieg#230, **Zahlungsart** >> für jedes Lieferland freigeschaltet?

❏ Haben Sie Kontakt zu den Zahlungsanbietern hergestellt, die Sie nutzen möchten?

❏ Haben Sie <<arbeiten-mit-plentymarkets/schnelleinstieg#250, **Prioritäten** >> bei Versand und Zahlung definiert?
...
Partner, die Ihnen bei der Erstellung rechtssicherer Texte behilflich sind, finden Sie unter **<<mandant-shop/standard/externe-dienste#, Dienste  >>**.
...
Die <<mandant-shop/standard/artikelansichten/grundeinstellungen#, **Sortierung der Kategorien**  >> für die Anzeige im Webshop kann anhand von Positionen, anhand von Namen (alphabetische Sortierung) oder zufällig erfolgen.
...
image::arbeiten-mit-plentymarkets/assets/DE-Schnelleinstieg-06.png[]
...
image::arbeiten-mit-plentymarkets/assets/DE-Schnelleinstieg-07.png[]
...
|**Versandprofile**
|Ein, mehrere oder **ALLE****<<fulfillment/versand-vorbereiten#1800, Versandprofile >>** aktivieren. Standardmäßig ist kein Versandprofil aktiviert. Pro Artikel mindestens ein Versandprofil aktivieren, da sonst ungewollte Effekte bei der Versandkostenberechnung auftreten können.
...
image::arbeiten-mit-plentymarkets/assets/DE-Schnelleinstieg-08.png[]
...
Wenn Sie die Warenbestände nicht in plentymarkets führen möchten, wählen Sie im Menü **Artikel » Artikel bearbeiten** im Tab **Varianten-ID » Einstellungen** bei der Einstellung **Beschränkung** die Option **Keinen Warenbestand für diese Variante führen**. Fahren Sie dann fort mit <<arbeiten-mit-plentymarkets/schnelleinstieg#480, **Artikelbilder verwalten** >>.
...
. Klicken Sie auf **Neuer Wareneingang**. Achten Sie darauf, dass ein Benutzer als <<arbeiten-mit-plentymarkets/schnelleinstieg#105, **Eigner** >> eingestellt ist.
...
image::arbeiten-mit-plentymarkets/assets/DE-Schnelleinstieg-09.png[]
...
Ihr Webshop wird mit einem voll funktionsfähigen Testdesign angezeigt. Dieses Testdesign können Sie jederzeit nach Ihren eigenen Vorstellungen ändern und ergänzen. Dabei wählen Sie aus verschiedenen Standarddesigns, die im Bereich <<cms#, **CMS**  >> zur Verfügung stehen. Wenn Sie Wert auf noch mehr Individualität legen, stehen Ihnen unsere **link:https://www.plentymarkets.eu/partner/zertifizierte-agenturen/[zertifizierten Dienstleister, window="_blank"]** mit Rat und Tat zur Seite.
...
====
Standardmäßig wird nur Bild 1 im Webshop angezeigt. Hierfür wurde eine <<cms-syntax/grundlagen/if#, **if-Abfrage**  >> mit der Template-Variable **$CurrentCategoryImageUrl** in das Template **ItemViewCategoriesList** eingebaut. Damit auch Bild 2 angezeigt wird, müssen Sie eine zweite if-Abfrage in das Template einbauen.
====
...
Des Weiteren können Sie in plentymarkets als Ziel eines Links neben Kategorien auch einzelne Artikel angeben, die ebenfalls über **<<cms-syntax/webdesign#, Template-Variablen und -Funktionen  >>** erreichbar sind. Die folgende Tabelle listet einige wichtige Template-Funktionen auf:
...
Wenn Sie den Aufbau der URL geändert haben, muss das Design inklusive aller Kategorien veröffentlicht werden, damit die Änderungen wirksam werden. Nach der Veröffentlichung wird das in Ihrem Webshop aktive Design im Menü **<<cms/webdesign#, CMS » Webdesign  >>** in der Kopfzeile grün angezeigt.
...
|**Blog**
|Wählen, um noch nicht veröffentlichte, z.B. über Schnittstellen oder Importformate importierte Blogs zu veröffentlichen. Änderungen an bereits veröffentlichten Blogs werden sofort übernommen, ein erneutes Veröffentlichen der Blogs ist nicht erforderlich. Blogs können alternativ auch im Menü <<cms/blog-weblog#, **CMS » Blog**  >> veröffentlicht werden.
|====

Löschen Sie nach einer Neuveröffentlichung den Datei-Cache, um die Änderungen sofort anzuzeigen. Da Sie an dieser Stelle das Design zum ersten Mal veröffentlichen, wird im Schnelleinstieg nicht beschrieben, wie Sie den Datei-Cache zurücksetzen. Weitere Informationen dazu finden Sie auf der Handbuchseite <<cms/webdesign/webdesign-bearbeiten#, **Webdesign bearbeiten**  >>.

[#610]
==== Name für Ihren Webshop eingeben

Im Menü **<<mandant-shop/standard/grundeinstellungen#, Einstellungen » Mandant (Shop) » Standard » Grundeinstellungen  >>** geben Sie den Namen für Ihren Webshop ein. Außerdem werden hier die ID Ihres Webshops sowie weitere Grunddaten, darunter die Domain und die Sprache, angezeigt.

[#620]
==== Grundeinstellungen für Ihren Webshop vornehmen

Im Menü **<<mandant-shop/standard/webshop/grundeinstellungen#, Einstellungen » Mandant (Shop) » Standard » Webshop » Grundeinstellungen  >>** nehmen Sie Einstellungen Ihres Webshops vor.
...
Im Menü <<mandant-shop/standard/bestellvorgang/grundeinstellungen#, **Einstellungen » Mandant (Shop) » Standard » Bestellvorgang » Grundeinstellungen**  >> individualisieren Sie den Bestellvorgang in Ihrem Webshop. Bei vielen Angaben können Sie wählen, ob diese dem Webshop-Besucher angezeigt werden sollen oder nicht.
...
|**Standardlieferland**
|Zur Auswahl stehen die im Menü **Einstellungen » Aufträge » Versand » Versandoptionen » Lieferländer** eingerichteten <<fulfillment/versand-vorbereiten#100, **Lieferländer** >>. Sie werden hier sprachabhängig zugeordnet.

|**Standardversandart, +
Standardversandprofil, +
Standardzahlungsart**
|Wählen, welche Einstellungen standardmäßig angeboten werden. Diese Einstellungen wurden bereits im ersten Teil des Schnelleinstiegs vorgenommen, siehe <<arbeiten-mit-plentymarkets/schnelleinstieg#250, **Prioritäten bei Zahlung und Versand** >>.
...
Im Bereich <<mandant-shop/standard/mein-konto#, **Einstellungen » Mandant (Shop) » Standard » Mein Konto**  >> nehmen Sie in den Untermenüs <<mandant-shop/standard/mein-konto/grundeinstellungen#, **Grundeinstellungen**  >> und <<mandant-shop/standard/mein-konto/auftragsinformationen#, **Auftragsinformationen**  >> wichtige Einstellungen für den individuellen Kundenbereich Ihres Webshops vor.
...
In plentymarkets können Sie den Bestellvorgang, das komplette Shop-Design und die Artikelbeschreibungen in mehreren Sprachen einrichten. Im Menü **<<mandant-shop/standard/webshop/multilingualismus#, Einstellungen » Mandant (Shop) » Standard » Webshop » Multilingualismus  >>** bestimmen Sie, ob Sie alle Bereiche des Webshops oder nur den Bestellvorgang mehrsprachig einrichten wollen. Vergessen Sie nicht, diese Texte dann auch zu übersetzen und einzupflegen.

Namen und Beschreibungstexte eines Artikels erstellen und speichern Sie in verschiedenen Sprachen im Bearbeitungsmenü des Artikels im Tab <<artikel/artikel-verwalten#90, **Texte** >>. Auch **<<artikel/kategorien/kategorien-bearbeiten#, Kategorien  >>** und **<<cms/webdesign#, Webshop-Design  >>** können in verschiedenen Sprachen erstellt werden. Gehen Sie wie im Folgenden beschrieben vor, um die Spracheinstellungen im Menü **Multilingualismus** vorzunehmen.
...
❏ Haben Sie den <<arbeiten-mit-plentymarkets/schnelleinstieg#320, **Artikelkatalog** >> mit allen Beschreibungstexten aufgebaut?

❏ Wurden die Texte für die <<arbeiten-mit-plentymarkets/schnelleinstieg#410, **Artikelverfügbarkeit** >> angepasst?

❏ Ist die <<arbeiten-mit-plentymarkets/schnelleinstieg#410, **Artikelverfügbarkeit** >> korrekt gesetzt?

❏ Haben Sie alle <<arbeiten-mit-plentymarkets/schnelleinstieg#420, **Preise und MwSt.-Sätze nochmals geprüft?** >>

❏ Konnten Sie sinnvolle <<arbeiten-mit-plentymarkets/schnelleinstieg#500, **Cross-Selling** >>-Verknüpfungen unter Ihren Artikeln bilden?

❏ Haben Sie alle wichtigen Kategorien des Typs <<arbeiten-mit-plentymarkets/schnelleinstieg#530, **Content** >> mit Ihren Inhalten versehen?

❏ Stimmen die angegebenen <<arbeiten-mit-plentymarkets/schnelleinstieg#650, **Versandinformationen und -kosten** >> mit Ihren Einstellungen überein?
...
* das Einrichten von **<<prozesse/prozesse-einrichten#, Prozessen  >>**. Dieses Menü können Sie nur nutzen, wenn Sie den plentymarkets Client installiert haben, und richtet sich an fortgeschrittene plentymarkets Nutzer, weshalb Prozesse im Schnelleinstieg nicht näher beschrieben werden.
...
Im Kapitel **<<arbeiten-mit-plentymarkets/schnelleinstieg#10, Basiseinstellungen >>** wurde beschrieben, wie Sie E-Mail-Vorlagen erstellen und vorhandene Vorlagen anpassen. Nun bleibt die Frage, wie plentymarkets diese E-Mail-Vorlagen automatisch verschickt.
...
plentymarkets bietet Ihnen im Menü <<auftraege/einstellungen/ereignis-aktionen#, **Einstellungen » Aufträge » Ereignisaktionen**  >> hierfür eine wirkungsvolle Möglichkeit, da Sie viele dieser Routineaufgaben automatisch ausführen lassen und Ihren Webshop damit äußerst effizient führen können.
...
Richten Sie eine <<auftraege/einstellungen/ereignis-aktionen#, **Ereignisaktion**  >> ein, damit der Kunde seine Rechnung im PDF-Format per E-Mail erhält, sobald diese im System erzeugt wurde.
...
Wer bereits erste Erfahrungen im E-Business gesammelt hat, kennt das folgende Problem: Statt den korrekten Betrag zu überweisen, hat der Kunde versehentlich einen zu geringen Betrag gezahlt. Man muss den Kunden dann darauf hinweisen, den Sachverhalt erklären und den zu zahlenden Restbetrag nachfordern. In plentymarkets haben Sie die Möglichkeit, solche Fälle mit einer <<auftraege/einstellungen/ereignis-aktionen#, **Ereignisaktion**  >> ohne aufwändige Zusatzarbeit automatisiert zu bearbeiten.
...
Die folgende <<auftraege/einstellungen/ereignis-aktionen#, **Ereignisaktion**  >> wird beim Import der Paketnummer dem Kunden eine Versandbestätigung senden, den Status der Bestellung auf 7 setzen und zusätzlich den Warenausgang im Lager buchen, damit die physischen Lagerbestände aktualisiert werden.
...
Leider kommt es in der Praxis immer wieder vor, dass Kunden Waren z.B. auf Rechnung bestellen, dann aber nicht bezahlen. In diesem Fall sollten Sie den Kunden per E-Mail eine Erinnerung senden. Diese Aufgabe kann der <<auftraege/einstellungen/aktions-manager#, **Aktionsmanager**  >> automatisch für Sie übernehmen.
...
Zuletzt bleibt Ihnen bei offenen Rechnungen nur noch die Übergabe des Auftrages an einen **<<payment#, Inkassodienstleister  >>**. Auch diese Aufgabe können Sie mit plentymarkets einfach und bequem automatisieren.
...
❏ Konnten Sie die grundlegende Statuslogik bei der <<arbeiten-mit-plentymarkets/schnelleinstieg#700, **Auftragsbearbeitung** >> nachvollziehen?

❏ Haben Sie Ihre <<arbeiten-mit-plentymarkets/schnelleinstieg#710, **E-Mail-Vorlagen** >> bearbeitet, die Widerrufsbelehrung eingefügt sowie Ihre Bankverbindung und Kontaktdaten korrekt eingegeben?

❏ Wurde in der **Versandbestätigung zur Bestellung** die Tracking-URL korrekt eingegeben?

❏ Haben Sie wichtige Ereignisse mithilfe von <<arbeiten-mit-plentymarkets/schnelleinstieg#720, **Ereignisaktionen** >> oder des <<arbeiten-mit-plentymarkets/schnelleinstieg#770, **Aktionsmanagers** >> automatisiert?
...
Abschließend müssen Sie nur noch Ihren <<mandant-shop/standard/webshop/webshop-sperren#, **Webshop wieder entsperren**  >>, damit Ihre Kunden auf Ihren Webshop gelangen können. Damit Ihre Kunden auch die richtigen E-Mails erhalten, müssen Sie außerdem den <<crm/e-mails-versenden#100, **Testmodus wieder deaktivieren** >>.
