...
Beachten Sie
// außerdem
die allgemeinen <<arbeiten-mit-plentymarkets/systemvoraussetzungen#, **Systemvoraussetzungen**  >> von plentymarkets.
...
* <<arbeiten-mit-plentymarkets/tools/plentybase-installieren#30., **Installieren Sie plentyBase** >> auf einem Rechner des Netzwerks.
...
. Wenn Sie bei der Installation auf dem Host-Rechner einen anderen Port als den Standard-Port gewählt haben, geben Sie <<arbeiten-mit-plentymarkets/tools/plentybase-installieren#40., **den Port des Host-Rechners** >> im plentymarkets Backend ein.
