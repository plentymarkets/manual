...
**MX** steht für Mail Exchange Resource Record. Hierbei handelt es sich um die Parameter der <<start/plentymarkets-konto/service-center/domain#3-5, **Mailserver** >>, die für den Empfang und den Versand von E-Mails zur Verfügung stehen.
...
Speichern Sie außerdem im Menü <<payment/bankdaten-verwalten#70., **Einstellungen » Aufträge » Zahlung » EBICS** >> die dort bereits hinterlegten Daten erneut, um die Grundeinstellungen zu aktualisieren.
====
...
Bei einem Wechsel zu einem anderen <<start/plentymarkets-konto/service-center/domain#3-10, **Provider** >> benötigen Sie für Ihre Domain einen Authentifizierungscode. Dieser Auth-Code weist Sie als Eigner der Domain aus. Den Auth-Code erzeugen Sie in diesem Bereich.
...
image::start/plentymarkets-konto/service-center/assets/DE-ServiceCenter-Domain-01.png[]
...
* Erzeugen Sie einen <<start/plentymarkets-konto/service-center/domain#3-7, **Auth-Code** >>.
