...
plentymarkets erzeugt alle E-Mails auf Basis von Vorlagen. <<#tabelle-e-mail-vorlagen>> listet die E-Mail-Vorlagen auf, deren Einrichtung wir dir für den Anfang empfehlen. E-Mail-Vorlagen werden im Menü *Einrichtung » Mandant » [Mandant wählen] » E-Mail » Vorlagen* erstellt.
