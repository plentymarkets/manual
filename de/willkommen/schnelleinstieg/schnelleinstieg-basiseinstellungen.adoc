...
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#tabelle-schnelleinstieg-kundenklasse-erstellen>>.
...
Wenn du bereits eine Domain bei einem anderen Provider hast und den Provider wechseln möchtest, gehe wie auf der Handbuchseite <<business-entscheidungen/systemadministration/system-umzug#, Systemumzug>> beschrieben vor.
