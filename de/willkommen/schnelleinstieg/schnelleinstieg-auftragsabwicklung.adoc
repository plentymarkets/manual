...
Eine vollständige Erklärung der Lageroptionen und findest du unter <<auftraege/grundeinstellungen#intable-lagerauswahl, Automatische Lagerauswahl>>.
