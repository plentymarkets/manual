...
→ Der *Name (de)* ist für deine Kund:innen im Webshop sowie auf Rechnungen sichtbar. Der *Name (Backend)* ist für die Kund:innen nicht sichtbar und dient der internen Unterscheidung für dich und deine Mitarbeiter:innen.
