...
Öffne das Menü *Einrichtung* und suche nach dem Assistenten *Verkaufspreise*. Nach Abschluss des Assistenten kannst du die erstellten Verkaufspreise <<willkommen/schnelleinstieg/schnelleinstieg-artikelkatalog#220, mit allen relevanten Varianten verknüpfen>> und den eigentlichen Preisen eintragen.
