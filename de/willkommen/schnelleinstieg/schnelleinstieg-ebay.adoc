...
IMPORTANT: Hast du deinen Shop schon durch ein Plugin aus dem plentyMarketplace erweitert? Noch nicht? Dann geht's hier zurück zum Thema <<willkommen/schnelleinstieg/schnelleinstieg-plugins#, Plugins dem System hinzufügen>>.
...
Falls du noch kein Mitgliedskonto bei eBay hast, musst du dich zunächst bei link:https://scgi.ebay.de/ws/eBayISAPI.dll?RegisterEnterInfo&bizflow=2[eBay^]{nbsp}icon:external-link[] registrieren.
...
====
Nach Änderungen an den eBay-Kontodaten müssen deine Shop-Kategorien sowie Rücknahmebedingungen neu eingestellt werden. Die *Shop-Kategorien* stellst du direkt in diesem Menü ein. Die *Rücknahmebedingungen* werden unter *Einrichtung » Märkte » eBay » Rahmenbedingungen » Tab: eBay-Rücknahmebedingungen* festgelegt.
====

[#500]
===  Grundeinstellungen vornehmen

Im Menü *Einrichtung » Märkte » eBay » Einstellungen* nimmst du Basiseinstellungen für eBay und Einstellungen an deinen eBay-Konten vor.
...
*Ja* = Wenn Produktdetails im eBay-Katalog vorhanden sind, werden sie automatisch übernommen. Weitere Details zum Produktkatalog findest du bei link:http://pages.ebay.de/help/sell/product-details.html[eBay^]{nbsp}icon:external-link[]. +
...
*Ja* = Wenn zusätzlich zu den eigenen Bildern weitere Produktbilder im eBay-Katalog vorhanden sind, werden sie automatisch übernommen. Weitere Details zum Produktkatalog findest du bei link:http://pages.ebay.de/help/sell/sharing-content.html[eBay^]{nbsp}icon:external-link[]. +
...
| *Auftragsposition*
| *Auftragsposition übernehmen* = Wenn jemand 5 Exemplare eines Artikels kauft, wird der Artikel im Auftrag einmal mit der Stückzahl 5 aufgeführt. +
*pro Stück eine Auftragsposition* = Wenn jemand 5 Exemplare eines Artikels kauft, werden im Auftrag 5 einzelne Auftragspositionen mit je 1 Stück aufgeführt.
...
*Nein* = eBay-Retourenprozess ist in plentymarkets nicht aktiviert. Neue eBay-Retouren werden nicht in plentymarkets importiert. Retouren werden stattdessen bei eBay im *Mein eBay*-Bereich bearbeitet.
...
| *Ja* = Eine Kopie der eBay-Rechnung wird automatisch an die Händler:in gesendet. +
*Nein* = Es wird keine Kopie der eBay-Rechnung an die Händler:in gesendet.
...
Der eingegebene Mindestbestand hat keinen Einfluss auf GTC-Angebote, bei denen *Ja* für die Einstellung *"Nicht mehr vorrätig"-Option nutzen* gewählt wurde.
...
Bevor du eBay-Versandprofile mit den Versandprofilen in plentymarkets verknüpfen kannst, musst du im Menü *Einrichtung » Märkte » eBay » Rahmenbedingungen* Zahlungs-, Versand- und Rahmenbedingungen festlegen und Versandprofile erstellen.
...
====
Die Währungsumrechnung für Listings wird im Menü *Einrichtung » Aufträge » Zahlung » Währungen* mit der Option *Umrechnungsfaktoren täglich automatisch aktualisieren* auf *Ja* eingestellt. Bei allen von dir verwendeten Währungen muss ein Umrechnungsfaktor eingegeben sein. +
...
In diesem Menü findest du eine Übersicht der bisher erstellten *Zahlungsprofile*. Hier bearbeitest oder löschst du bestehende Zahlungsprofile oder legst neue Zahlungsprofile an.

[.instruction]
Neues Zahlungsprofil erstellen:
...
| *PayPal-Konto*
| PayPal-Konto wählen. Nur PayPal-Konten werden angezeigt, die unter *Einrichtung » Aufträge » Zahlung » Zahlungsarten » PayPal* eingerichtet wurden.
...
| Wählen, ob Versandkostentabellen übernommen werden sollen. Versandkostentabellen müssen bei eBay eingerichtet werden. Weitere Informationen findest du bei eBay unter link:https://www.ebay.de/help/selling/shipping-items/versandoptionen-einrichten?id=4089#tables[Versandoptionen anbieten^]{nbsp}icon:external-link[].
...
| *Rücksendekosten*
| Wählen, ob Käufer:in oder Verkäufer:in die Rücksendekosten trägt. *Aktualisiere* die betroffenen Listings.
...
* [ ] Hast du einen Verkaufspreis für eBay erstellt?
* [ ] Hast du die Rahmenbedingungen für eBay festgelegt?

Herzlichen Glückwunsch, der erste Schritt ist geschafft! Du hast eBay in plentymarkets eingerichtet und Grundeinstellungen für den Marktplatz getroffen. Im nächsten Schritt bereitest du Listings vor. Wie das funktioniert, erklären wir dir im nächsten Kapitel. Voraussetzung dafür ist, dass du deine Artikel bereits vollständig in plentymarkets erstellt hast.

[#1700]
==  Listings vorbereiten

Im Menü *Einrichtung » Listings* nimmst du Einstellungen vor, die für alle Listings gelten, unabhängig von der Plattform.
...
====
Wenn du in diesem Menü Änderungen speicherst, werden andere Benutzer:innen automatisch ausgeloggt und müssen sich neu einloggen, damit die Änderungen auch für diese Benutzerprofile übernommen werden.
====

[#1900]
===  Warenbestand einstellen

Im Menü *Einrichtung » Listings » Warenbestand* wählst du, ob Listings automatisch beendet und an den Netto-Warenbestand angepasst werden. Außerdem wird das Lager gewählt, aus dem die Ware für Listings stammt. Beachte für das Beenden von Angeboten die Bestimmungen des Marktplatzes und die rechtlichen Hinweise.
...
*Status 1* = Kund:innen werden durch die Bestellabwicklung geleitet und müssen aktiv die Schritte durchgehen. Dabei befinden sich Kund:innen im Webshop und werden animiert, weitere Artikel zu kaufen. +
...
Darauf achten, dass verwendete Bilder per URL erreichbar sind. Dazu die Bilder z.B. per *FTP* auf einen Server laden.
|====

[#2400]
====  Layout-Vorlage verknüpfen

Im nächsten Schritt verknüpfst du Listings mit der Layout-Vorlage. Dazu musst du bereits Listings in plentymarkets erstellt haben. Wie du Listings erstellst, erfährst du im Kapitel <<Listings erstellen, Listings erstellen>>. +
...
Sie können beispielsweise hier eBay-Galerien erstellen lassen: link:http://www.sellerfox.com/?lang=de[www.sellerfox.de^], link:http://www.ayee.net/newpage/[www.ayee.net^]{nbsp}icon:external-link[]
...
plentymarkets bietet dir mehrere Möglichkeiten, Listings anzulegen. Du musst im Vorfeld deine *Artikel* vollständig erstellen. Dann erstellst du Listings in der Artikelübersicht, entweder mit der Stapelverarbeitung oder über ein bereits vorhandenes Listing. Nutze außerdem das Datenformat <<daten/export-import/datenformate/itemlistingmarketebay#, ItemListingMarketEbay>>, um umfangreiche Artikelbestände automatisiert zu erstellen.
...
Wenn du bereits ein Listing für einen Artikel erstellt hast, fügst du als nächstes Market-Listings zu deinem Listing hinzu. Du benötigst Market-Listings, um auf eBay verkaufen zu können. An einem Market-Listing triffst du spezifische Artikeleinstellungen für einen Marktplatz.
...
. Öffne das Menü *Artikel » Artikel bearbeiten*.
. Setze Häkchen bei Artikeln, für die ein Listing erstellt werden soll.
...
In der Listing-Übersicht werden dir alle erstellten Listings angezeigt. Öffne ein Market-Listing, um Grundeinstellungen, Texte und Layout sowie Marktplatzeinstellungen zu ändern.
...
| Betrag eingeben. Alle darunter liegenden Preisvorschläge werden automatisch abgelehnt.

| *Mindestpreis akzeptieren*
| Betrag eingeben. Alle darüber liegenden Preisvorschläge werden automatisch angenommen.
...
| *Merkmale*
| Merkmale bearbeiten. Im Fenster *eBay-Merkmale* werden alle Merkmale für die gewählte Kategorie angezeigt. Auf *Hinzufügen* klicken, um ein eigenes Merkmal anzulegen. Einen Namen des Merkmals in das linke Textfeld eingeben. Einen Wert für das Merkmal mit maximal 128 Zeichen in das rechte Textfeld eingeben. Die hier gespeicherten Merkmale haben beim Übertragen zu eBay Vorrang vor den Merkmalen des Artikels. Bei Fehleingaben oder wenn keine Merkmale verfügbar sind, wird die Fehlermeldung *Code: 046 In dieser Kategorie sind die Artikelmerkmale durch ebay deaktiviert* angezeigt.
|====
...
[#3800]
==== Checkliste Listings erstellen

Arbeite die Checkliste durch, um deine Einstellungen zum Thema *Listings erstellen* zu prüfen.

[%interactive]
* [ ] Hast du Listings erstellt?
* [ ] Hast du Market-Listings zu deinen Listings erstellt?

Herzlichen Glückwunsch, du hast deine Listings erstellt! Nachdem du deine Listings erstellt und bearbeitet hast, kann es schon bald mit dem Verkauf losgehen, denn im nächsten Schritt startest du deine Listings. +
...
In plentymarkets hast du mehrere Möglichkeiten, Listings automatisch zu starten oder erneut zu starten, nachdem sie bereits eingestellt wurden. Mit dem Verkaufsplaner legst du *Startzeiten* für Listings fest. Den Verkaufsplaner richtest du im Menü *Einrichtung » Listings » Verkaufsplaner* ein.
...
Du kannst per Gruppenfunktion und Stapelverarbeitung Listing-Vorlagen erstellen. In Listing-Vorlagen speicherst du Einstellungen und kannst Einstellungen dann immer wieder auf Listings anwenden, ohne die Einstellungen erneut vorzunehmen. Listing-Vorlagen können sowohl auf einzelne Listings angewendet als auch für die Gruppenfunktion und die Stapelverarbeitung verwendet werden.
...
Klicke auf den Link *eBay-Merkmale* in den Grundeinstellungen des Listings und prüfe, ob für die Attributnamen, die für die Artikelvarianten benutzt werden, z.B.: Größe oder Farbe, hier keine Werte eingegeben sind. Falls die Werte eingegeben sein sollten, lösche den Inhalt der entsprechenden Textfelder.
====
...
Seit dem 15. August 2018 verpflichtet eBay Händler:innen dazu, Produkte aus bestimmten Kategorien, die auf eBay verkauft werden, mit ePIDs zu verknüpfen. Eine ePID (eBay Product ID) ist eine von eBay vorgegebene, eBay-spezifische Produktkennzeichnung. Durch die Verwendung von ePIDs soll sichergestellt werden, dass identische Produkte gebündelt auf eBay angezeigt werden. +

Für ein Produkt, das auf eBay einzeln und in einem Set verkauft wird, kann es mehrere ePIDs geben. Im Menü *Einrichtung » Märkte » eBay » ePID-Verknüpfung* verknüpfst du Varianten mit ePIDs.
...
- Momentan können nur Produkte aus bestimmten eBay-Kategorien mit ePIDs verknüpft werden. Weitere Informationen zu diesen Kategorien findest du bei link:https://developer.ebay.com/api-docs/sell/static/inventory/pbse-phase1-categories.html[eBay^]{nbsp}icon:external-link[].

[IMPORTANT]
.eBay OAuth2-Plugin
====
Um ePIDs verknüpfen zu können, benötigst du das link:https://marketplace.plentymarkets.com/plugins/markets/EbayOAuth2_4787[eBay OAuth2-Plugin^]. Das eBay OAuth2-Plugin ist im link:https://marketplace.plentymarkets.com/plugins/markets[plentyMarketplace^]{nbsp}icon:external-link[] erhältlich.
====
...
Für den Austausch von Daten zwischen plentymarkets und eBay steht dir ElasticSync im Menü *Daten » Import* zur Verfügung. Verwende den Sync Typ <<daten/daten-importieren/sync-typen/elasticsync-market-listing, Market-Listing>>, um Listing-Daten in plentymarkets zu importieren.
