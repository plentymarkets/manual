...
Für den Austausch von Daten zwischen plentymarkets und eBay steht dir das Import-Tool im Menü *Daten » Import* zur Verfügung. Verwende den Import-Typ <<daten/daten-importieren/sync-typen/elasticsync-market-listing, Market-Listing>>, um Listing-Daten in plentymarkets zu importieren.
