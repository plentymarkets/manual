...
Gehe wie im Folgenden beschrieben vor, um einen Termin zu erstellen. Abhängig von deinen Zugriffsrechten, die gemäß <<#tabelle-kalender-grundeinstellungen>> eingestellt werden, kannst du auch Termine für andere Benutzer:innen erstellen. Du kannst nur Termine für Benutzer:innen erstellen, für die du Schreibrechte hast. Benutzer:innen, für die du nicht über Schreibrechte verfügst, stehen beim Erstellen eines Termins nicht zur Auswahl.
