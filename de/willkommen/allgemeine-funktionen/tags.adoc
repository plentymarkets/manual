...
//Falls es irgendwann möglich ist, Tags mit ElasticSync zu importieren, dann hier ein Kapitel ergänzen
...
. Öffne das Menü *Einrichtung » Einstellungen » Tags*.
. Wähle einen oder mehrere Filter links. Beachte dazu die Erläuterungen in <<#tabelle-tag-filter>>.
...
|Variante
a|* <<artikel/artikel-verwalten#268, Tags können manuell mit Varianten verknüpft>>.
