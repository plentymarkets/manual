...
|*Klarna*
|Richte das Plugin mithilfe des Assistenten in deinem System ein, um deinen Kund:innen die Klarna-Zahlungsart anzubieten. Lade es dafür über den link:https://marketplace.plentymarkets.com/invoice_4760[plentyMarketplace^]{nbsp}icon:external-link[] herunter und installiere es in einem Plugin-Set.
