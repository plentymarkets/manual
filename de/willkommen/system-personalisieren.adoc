...
| *Karte bearbeiten*
|Passe den Text an, wenn gewünscht.
...
*_Hinweis:_* Wenn die Karte mit dem Kontakt verknüpft ist, wird ein Symbol auf der Karte angezeigt. Über dieses Symbol kannst du den Kontakt direkt im Menü *CRM » Kontakte* öffnen oder die Verknüpfung zum Kontakt löschen.

// symbol für verknüpften kontakt ergänzen
...
// symbol für verknüpftes ticket ergänzen
...
// symbol für verknüpften auftrag ergänzen
...
*_Tipp:_* Um die Person zu entfernen, den Mauszeiger über das Symbol bewegen und auf *Benutzer entfernen* klicken.
