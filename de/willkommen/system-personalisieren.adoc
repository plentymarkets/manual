...
:description: Richte z.B. eigene Shortcuts und eine Signatur ein und personalisiere so dein Benutzerkonto im plentymarkets System.
:position: 40
...
Diese Handbuchseite beschreibt Einstellungen in plentymarkets, die du einmalig vornimmst, um dein Benutzerkonto zu personalisieren. Selbstverständlich hast du die Möglichkeit, deine Angaben und Einstellungen jederzeit anzupassen.
