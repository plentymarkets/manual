...
:keywords: Personalisieren, Anpassen, Individuell, Individualisieren, Benutzerkonto, Benutzer, Konto, Benutzerbild, gravatar, Gravatar, Grußformel, Signatur, SignatureHTML, Persönliche Einstellungen, Menüansicht, Ansicht einrichten, Menüansichten, Shortcut, Shortcuts, Tastenkürzel, Tastenkombination, Tastenkombinationen, Dashboard, Startseite, Favorit, Favoriten, Editor, Editoren, CSS-Editor, CSS, CSSContent
:description: Bist du neu bei plentymarkets? Dann empfiehlt es sich, zunächst mal dein Benutzerkonto und System individuell anzupassen.
:position: 40
:url: willkommen/system-personalisieren
:id: 49S4GON
:author: denise-breidenbach

//add this url weiterleitung /basics/arbeiten-mit-plentymarkets/benutzerkonto-personalisieren/;/willkommen/system-personalisieren/;301;L
...
. Klicke im Tab des Menüs auf das Dreieck (icon:caret-down[]) und wähle *Link zu Favoriten hinzufügen*. +
...
|*Meine Aufgaben*
|Zeigt Ihre <<willkommen/allgemeine-funktionen/aufgaben-und-kalender#100, Aufgaben>> an.
