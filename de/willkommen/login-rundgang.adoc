...
[#tipps]
== Effizienteres Arbeiten: Tools und Tipps

Text

#BILD#

* *Suche* = Mit der Suchfunktion kannst du alle Menüs im Backend nach Einträgen durchsuchen. Gibt es keine Treffer, kannst du auch direkt das Handbuch durchsuchen.
* *Notification-Center* = Im Notification-Center erhältst du wichtige Informationen zu verschiedenen Teilen von deinem plentymarkets System. Wenn du eine Benachrichtigung schließt, kannst du sie nicht wiederherstellen. Für andere Benutzer ist die Benachrichtigung weiterhin sichtbar.
* *Service-Angebote* = Klicke auf die Hilfe (icon:question-circle[]) oben rechts im plentymarkets Backend, um verschiedene Support-Angebote aufzurufen.
* *plentyShop-Vorschau* = Klicke auf deine plenty ID oben rechts im plentymarkets Backend, um die Startseite deines Webshops in einer Vorschau aufzurufen.
* *Benutzer:innen-Konto* = Klicke auf das Kontosymbol (icon:user-circle[]) um in dein Benutzer:innen-Konto zu gelangen. Hier kannst du z.B. den <<business-entscheidungen/benutzerkonten-zugaenge#30, Benutzer:innen-Namen und das Passwort ändern>>, die dir in der Begrüßungs-E-Mail zugesandt wurden.
* *Vollbildmodus* = Klicke auf icon:ellipsis-v[] oben rechts im plentymarkets Backend, um den Vollbildmodus zu aktivieren bzw. zu deaktivieren.
* *Favoriten* = Klicke auf icon:ellipsis-v[] oben rechts im plentymarkets Backend, um <<willkommen/system-personalisieren#90, deine Favoriten>> anzuzeigen, alle zu öffnen oder diese zu löschen.
