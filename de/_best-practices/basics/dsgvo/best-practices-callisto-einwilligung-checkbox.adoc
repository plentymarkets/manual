...
Besten Dank an Forumsnutzer wdsrakoe, der diese Lösung in link:https://forum.plentymarkets.com/t/dsgvo-e-mail-adresse-an-dhl-nur-mit-einwilligung/329771/5[diesem^]{nbsp}icon:external-link[] Forumsbeitrag vorgestellt hat.
