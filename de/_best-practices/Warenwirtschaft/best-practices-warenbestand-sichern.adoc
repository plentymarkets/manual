...
Du möchtest deinen Warenbestand täglich sichern können? In diesen Best Practices zeigen wir dir Schritt für Schritt, wie man den Bestand von zwei Lagern addiert und schließlich den Warenbestand zu einem beliebigen Zeitpunkt ermittelt.
...
. Falls noch nicht vorhanden, lege das Format *Warenbestand* an.
...
image::/assets/elastischer-export.png[]
