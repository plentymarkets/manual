...
Dieser Styleguide soll dir dabei helfen auf einfachem Wege Best Practices auf link:https://knowledge.plentymarkets.com[Knowledge^] zu veröffentlichen. Wir nutzen link:https://de.wikipedia.org/wiki/AsciiDoc[Asciidoc^]{nbsp}icon:external-link[] als Format für unsere Inhalte. Nachfolgend haben wir die wichtigsten Punkte für dich zusammengefasst.

[TIP]
.Weiterführende Lektüre
====
Weitere Informationen zum Thema Asciidoc findest du unter link:http://asciidoc.org/userguide.html[AsciiDoc User Guide^] und link:http://asciidoctor.org/docs/asciidoc-writers-guide/[AsciiDoc Writer’s Guide^]{nbsp}icon:external-link[].
====
...
Weitere Informationen und Beispiele findest du in der link:http://asciidoctor.org/docs/asciidoc-syntax-quick-reference/#section-titles[AsciiDoc Syntax Quick Reference^]{nbsp}icon:external-link[].
...
`+link:https://knowledge.plentymarkets.com[Knowledge^]{nbsp}icon:external-link[]+`
...
*Weitere Informationen findest du link:https://forum.plentymarkets.com/[hier^]{nbsp}icon:external-link[]*

und schreiben stattdessen

*Weitere Informationen findest du im link:https://forum.plentymarkets.com/[Forum^]{nbsp}icon:external-link[]*.
...
* Es folgt die Video-ID. Diese findest du in der link:https://vimeo.com/248305451[URL des Videos^]{nbsp}icon:external-link[].
