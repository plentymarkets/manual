...
Im Forum sind ein paar Screenshots von verschiedenen Domain-Providern hinterlegt, anhand dessen man die notwendigen Schritte zum Hinterlegen der korrekten DNS-Einstellungen nachvollziehen kann:
