...
image:_best-practices/cloud/ssl-zertifikat/assets/assets/monatlichen_kosten.png[monatlichen_kosten]
...
image:_best-practices/cloud/ssl-zertifikat/assets/assets/comodo_bestellen_service-center.png[comodo_bestellen_service-center]

Der folgende Dialog erscheint:
image:_best-practices/cloud/ssl-zertifikat/assets/assets/comodo_bestellen_service-center_bestaetigen.png[comodo_bestellen_service-center_bestaetigen]

Nach dem Klick auf *“Bestellung fortsetzen”* wird die erste Validierungsmail versendet:
image:_best-practices/cloud/ssl-zertifikat/assets/assets/ssl_email_versendet.png[ssl_email_versendet]
...
image:_best-practices/cloud/ssl-zertifikat/assets/assets/button_ssl_bestellen.png[button_ssl_bestellen]
betätigt werden.

image:_best-practices/cloud/ssl-zertifikat/assets/assets/ssl-zertifikat_bestellen_auswahl.png[ssl-zertifikat_bestellen_auswahl]

Daraufhin erscheint folgende Meldung:

image:_best-practices/cloud/ssl-zertifikat/assets/assets/ssl-zertifikat_bestellt.png[ssl-zertifikat_bestellt]
...
image:_best-practices/cloud/ssl-zertifikat/assets/assets/ssl-zertifikat_email_comodo.png[ssl-zertifikat_email_comodo]

Man wird auf die Bestätigungsseite der Zertifizierungsstelle geleitet:

image:_best-practices/cloud/ssl-zertifikat/assets/assets/ssl-zertifikat_comodo_key.png[ssl-zertifikat_comodo_key]
...
image:_best-practices/cloud/ssl-zertifikat/assets/assets/ssl-zertifikat_status_done.png[ssl-zertifikat_status_done]
