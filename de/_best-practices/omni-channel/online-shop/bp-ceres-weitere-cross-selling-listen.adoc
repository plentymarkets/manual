...
[source,plenty]
----
include::assets/contexts-MyThemeContext.php[]
...
Füge oben in der Datei die Zeile `use Theme\Contexts\ThemeNameSingleItemContext;` ein, damit der neu erstellte Kontext vom ServiceProvider berücksichtigt wird.

Zusätzlich fügst du nun innerhalb der *boot* Funktion folgenden Code ein:

[source,plenty]
----
include::assets/contexts-boot-funktion.php[]
...
[source,plenty]
----
include::assets/contexts-myThemeContext-extended.php[]
