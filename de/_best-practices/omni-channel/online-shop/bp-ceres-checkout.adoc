...
. Aktiviere die Routen */checkout*, */confirmation*, */login*, */register*, *password-reset*, */place-order & /execute-payment*, */basket* und */my-account*.
...
Der Ceres-Checkout wird sich von deinem bisherigen Callisto-Layout optisch unterscheiden. Du kannst Header und Footer des Checkouts und des Warenkorbs global über den <<webshop/shop-builder#95, ShopBuilder>> bearbeiten. Den Checkout selbst wirst du mit Ceres Version 3.1.0 über den ShopBuilder bearbeiten können. Weiterhin kannst du eigene Anpassungen über ein Theme realisieren.
