...
Das *de* in der Zeile `{% if $Lang !== 'de' %}` bezieht sich hier auf die Standartprache des Webshops. Falls die Standardsprache nicht Deutsch ist, muss das Sprachkürzel entsprechend angepasst werden.
