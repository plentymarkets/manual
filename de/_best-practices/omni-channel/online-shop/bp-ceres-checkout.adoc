...
Wenn du einen Callisto-Shop betreibst, der den *Standard-Bestellvorgang* nutzt, musst du mit der Einbindung des Ceres-Checkouts etwas früher beginnen: der Standard-Bestellvorgang wird zum 01.07.2019 abgestellt. Wie du erfährst, welchen Bestellvorgang du verwendest, findest du in <<webshop/best-practices#bp-ceres-EOL, diesem Kapitel>>. +
