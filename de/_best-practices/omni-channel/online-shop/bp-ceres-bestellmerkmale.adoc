...
→ Setze einen Haken bei *Als Zusatzkosten darstellen*, damit der Kunde in der Artikelansicht sieht, welchen Aufpreis er für das Merkmal zahlt.
. Setze im Bereich *Anzeige* die Haken an dern Stellen, an denen das Merkmal angezeigt werden soll.
...
image::_best-practices/omni-channel/online-shop/asts/bp-ceres-bestellmerkmale-neues-merkmal.png[]
