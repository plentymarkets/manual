...
====
Für die Übergabe von Artikeldaten an Amazon kann der **autom. Export** nachts oder der **manuelle Export** unter **Einstellungen » Märkte » Amazon » Datenaustausch » Datenexport** genutzt werden.
...
C. Ist der Artikel in der CSV-Datei, die ihr durch den manuellen Export im Menü **Einstellungen » Märkte » Amazon » Datenaustausch » Datenexport** erzeugen könnt, zu finden?
...
Damit ihr diese Herkünfte erst seht bzw. auswählen könnt, müssen diese unter **Einstellungen » Aufträge » Auftragsherkunft** für eure Menüs sichtbar gestellt sein.
...
Dieser Punkt bezieht sich auf die Einstellungen unter **Einstellungen » Märkte » Amazon » Grundeinstellungen**. Hier kann z.B. eingestellt werden, dass nur Artikel mit einer gewissen **Markierung** exportiert werden sollen. Ist diese Markierung nicht an dem Artikel hinterlegt -> wird der Artikel nicht exportiert.
...
Gemeint damit ist die Option Preistyp in den Verkaufspreisen unter **Einstellungen » Artikel » Verkaufspreise**
