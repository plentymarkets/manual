...
Anlegen eines Elastischen Exports unter **Datenaustausch » Export » Elastischer Export** für jeden Account der auf Rakuten gepflegt ist:
...
* *(Optional) Filter “Mandant”:* Den Mandanten wählen, der unter *System » Märkte » Rakuten.de* bei der Option *Mandant (Shop)-Zuordnung* beim jeweiligen Account gewählt wurde.
...
Die URL des elastischen Exports nutzen um den Import der Datei im Händlerbereich bei Rakuten.de1 einzurichten. Wer noch wenig oder keine Erfahrung damit hat, wendet sich an den Support bei Rakuten, damit diese einem bei der Einrichtung eines Zeitplans unterstützen.
