...
Einen Überblick über VCS und eine Anleitung, wie ihr VCS in plentymarkets aktiviert, erhaltet ihr in unserem <<maerkte/amazon/amazon-einrichten, Handbucheintrag zum Thema VCS>>.
...
image::_best-practices/omni-channel/multi-channel/amazon/assets/bp-amazon-vcs-plentymarkets.png[Rechnungserstellung durch Amazon]
