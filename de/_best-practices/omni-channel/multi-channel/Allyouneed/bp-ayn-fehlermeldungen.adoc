...
Damit unsere Attribute korrekt mit Attributen von Allyouneed in Verbindung gebracht werden können, müssen diese verknüpft werden. Besteht diese Verknüpfung nicht, dann kommt es zu dieser Fehlermeldung.

Die Verknüpfung wird unter *System » Artikel » Attribute » Öffne Attribut mit der ID X » Attributverknüpfung » Allyouneed.com* gesetzt.
...
Weitere Infos zum Unterschied zwischen Produkt und Angebot link:https://forum.plentymarkets.com/t/allyouneed-artikelexport-unterschied-produkt-und-angebot/58922[hier]
--
