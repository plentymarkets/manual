...
Für DHL Intraship-Kunden können sowohl DHL Paket-Produkte als auch DHL Express-Produkte genutzt werden, z.B. OFP (Office Paket). Für Kunden des Geschäftskundenportals gilt das leider nicht mehr! Darüber lassen sich nur DHL Paket-Produkte anmelden.
