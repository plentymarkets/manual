...
Diese Fehlermeldung erscheint, wenn bei einer Nachnahmebestellung die Bankverbindung, die bei für das DHL Shipping Plugin hinterlegt wurde, im Geschäftskundenportal nicht als Standardbankverbindung ausgewählt wurde. Eine erfolgreiche Anmeldung kann erfolgen, wenn die zu verwendene Bankverbindung für das DHL Shipping Plugin auch die Standardbankverbindung im Geschäftskundenportal ist.
