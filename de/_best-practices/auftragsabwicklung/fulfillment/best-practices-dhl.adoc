...
|Lieferant aktiv
|Lieferländer mit dieser Eigenschaft stehen für die Einstellung als Standardlieferland im Menü *System » Systemeinstellungen » Mandant* » _Mandant wählen_ » *Bestellvorgang » Einstellungen* nicht zur Verfügung.
|====
