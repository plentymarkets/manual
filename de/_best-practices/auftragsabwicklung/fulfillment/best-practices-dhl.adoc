...
Die Angaben der Lieferadresse werden von DHL über die API geprüft. In diesem Fall ist es nötig, DHL zu kontaktieren und zu erfragen, wie genau die Schreibweise lauten soll, damit eine Anmeldung möglich ist.
