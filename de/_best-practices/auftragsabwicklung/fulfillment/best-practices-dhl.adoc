...
In diesem Fall konnte keine Versandeinstellung gefunden werden (Menü *Einrichtung » Aufträge » Versand » DHLShipping » Versandeinstellungen*), die mit dem Versandprofil am Auftrag erstellt wurde.
