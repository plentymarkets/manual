...
Aktiviere daher das entsprechende Lieferland im Menü *System » Aufträge » Versand » Optionen » Tab: Lieferländer*, weise es danach im *Tab: Region* einer Region zu und ändere anschließend das Lieferland im Auftrag, damit diese fehlenden Angaben übermittelt werden können und die Anmeldung weitergeführt werden kann.
