...
image::_best-practices/auftragsabwicklung/fulfillment/assets/DHL_Shipping_Plugin_Uebersicht.png[]
...
.Tabellenansicht: DHL Shipping Plugin bereitstellen
image::_best-practices/auftragsabwicklung/fulfillment/assets/DHL_Shipping_Plugin_bereitstellen_Tabellenansicht.png[]

.Kartenansicht: DHL Shipping Plugin bereitstellen
image::_best-practices/auftragsabwicklung/fulfillment/assets/DHL_Shipping_Plugin_bereitstellen_Kartenansicht.png[]
...
.Plugin-Log
image::_best-practices/auftragsabwicklung/fulfillment/assets/DHL_Shipping_Plugin_Log.png[]
