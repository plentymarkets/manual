...
Beachte, dass du jeweils eine Option in den Dropdown-Menüs *Frankatur bei Auslandssendungen* und *Sendungsart* im Menü *System » Aufträge » Versand » DHL Shipping » Versandeinstellungen* wählen musst.
