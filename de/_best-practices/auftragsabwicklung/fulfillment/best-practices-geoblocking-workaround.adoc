...
Generell wäre der erste Schritt, dass die "übrigen" Länder, in denen ihr bisher nicht als Händler bereits gewerblich tätig seid, unter **System » Aufträge » Versand » Optionen » Reiter: Lieferländer** auf *Aktiv* gesetzt werden.
