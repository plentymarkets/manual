...
|*Domain*
|Die URL der <<basics/admin-aufgaben/plentymarkets-konto#domain, Domain>> des Mandanten (Shops). Eine Domain bezeichnet in der Regel eine Internetadresse in Form eines Namens sowie einer Erweiterung, d.h. der Top Level Domain, beides getrennt durch einen Punkt. Wenn ein <<basics/admin-aufgaben/plentymarkets-konto#ssl-zertifikat, SSL-Zertifikat>> angelegt wurde, wird die URL des Mandanten mit *https* statt *http* angezeigt. Über das *Auge* wird der Webshop geöffnet.
