...
Dieses Kapitel führt die empfohlenen Bildergrößen für Kategorie- und Artikelbilder im Ceres Webshop auf. Alle auf der Startseite dargestellten Bilder werden mittlerweile über Widgets des <<webshop/shop-builder#, ShopBuilders>> bereitgestellt. +
