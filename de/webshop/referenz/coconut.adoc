...
Die Änderungen, die du in <<#55, Kapitel 1.2>> gemacht hast, werden hierfür vorausgesetzt, d.h. dass alle <<#70, die Namespaces>> wie oben beschrieben auf *CeresCoconut* geändert sein müssen. Das Ausblenden von Elementen funktioniert in der Regel immer gleich: Suche die relevante Stelle im Code, entferne sie, speichere die Einstellungen und stell dein Plugin-Set erneut bereit. Fertig. Wir begleiten dich einmal durch den gesamten Prozess:
...
Nach erneutem Bereitstellen deines Plugin-Sets wird der *Zur Wunschliste hinzufügen*-Button nicht mehr angezeigt.
