...
// | *Alle Plugins außer Ceres und IO deaktivieren*
...
. Klicke auf die Schaltfläche *Toogle device toolbar* (image:assets/toggle-device-toolbar.png[width=14, height=14]). +
...
*_Oder:_* Verwende die Tastenkombination *CMD + Option + I* (macOS) oder *Strg + Umschalten + I* (Windows), um die Entwicklerkonsole zu öffnen.
. Klicke auf die Schaltfläche *Bildschirmgrößen testen* (image:assets/toggle-device-toolbar.png[width=14, height=14]). +
*_Oder:_* Verwende die Tastenkombination *CMD + Shift + M* (macOS) oder *Strg + Umschalten + M* (Windows), um die Geräteansicht zu aktivieren.
--
====
...
image::assets/device-selection.png[width=640, height=360]