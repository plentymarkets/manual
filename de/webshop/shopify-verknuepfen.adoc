...
| Hat die Kund:in kein plentymarkets Konto, kann die Authentizität der Kund:in von keiner der beiden Seiten garantiert werden. Dies gilt auch dann, wenn die Kontaktdaten in mehreren Aufträgen identisch sind. +
