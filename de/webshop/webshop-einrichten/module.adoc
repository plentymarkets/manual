...
:keywords: Module, Webshop, Callisto
:position: 80
:icons: font
...
. Öffne das Menü *Einrichtung » Mandant » Mandant wählen » Module » Link-Cloud*.
...
. Öffne das Menü *Einrichtung » Mandant » Mandant wählen » Module » Blog*.
...
Deine Kunden können durch das Hinterlasseneiner Nachricht, einer Meinung under eines Wunschs in einem Gästebuch ihren Besuch in deinem Webshop dokumentieren. Im Menü *Einrichtung » Mandant » Mandant wählen » Module » Gästebuch* erstellst und konfigurierst du Gästebücher.
...
. Öffne das Menü *Einrichtung » Mandant » Mandant wählen » Module » Gästebuch*.
...
. Öffne das Menü *Einrichtung » Mandant » Mandant wählen » Module » Forum*.
...
. Öffne das Menü <<crm/e-mails-versenden#1800, Einrichtung » Mandant » Mandant wählen » E-Mail » Automatischer Versand>>.
