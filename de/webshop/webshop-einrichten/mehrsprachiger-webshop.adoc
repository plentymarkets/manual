...
. Öffnen Sie das Menü *System » Mandant » Mandant wählen » Webshop » Multilingualismus*.
...
Um Ihre E-Mail-Vorlagen bei gewählten Events automatisch zu versenden, legen Sie Ereignisaktionen an. Weitere Details zum automatischen E-Mail-Versand finden Sie auf den Handbuchseiten <<crm/e-mails-versenden#2300, Automatischer Versand>> und <<basics/automatisierung/ereignisaktionen#, Ereignisaktionen>>.
...
. Öffnen Sie das Menü *System » Mandant » Mandant wählen » Standorte » Dokumente*.
...
Weitere Details zu diesen Dokumenten und den Einstellungen finden Sie auf der Handbuchseite <<auftragsabwicklung/auftraege/auftragsdokumente#, Auftragsdokumente>>.
