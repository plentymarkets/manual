...
Im Menü *System » Systemeinstellungen » Mandant » Mandant wählen » Mein Konto » Auftragsinformationen* hinterlegen Sie Einstellungen, die die Sichtbarkeit von Informationen in Aufträgen steuern.

[.instruction]
Auftragsinformationen konfigurieren:

. Öffnen Sie das Menü *System » Systemeinstellungen » Mandant » Mandant wählen » Mein Konto » Auftragsinformationen*.
