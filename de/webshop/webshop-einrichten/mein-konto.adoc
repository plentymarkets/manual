...
|*Passwort ändern*
|Diese Einstellung dient dazu, die Anzeige der Option zur Änderung des <<business-entscheidungen/benutzerkonten-zugaenge#, Passworts>> zu *aktivieren* oder zu *deaktivieren*.
