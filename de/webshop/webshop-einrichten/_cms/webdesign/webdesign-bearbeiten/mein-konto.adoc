...
Das Menü <<omni-channel/mandant-shop/standard/mein-konto/grundeinstellungen#, Einrichtung » Mandant » Mandant wählen » Mein Konto » Einstellungen>> enthält wichtige Grundeinstellungen für den Mein Konto-Bereich deines Webshops. So kannst du hier z.B. einige fakultative Kontobereiche aktivieren bzw. deaktivieren.
...
*Passwortsicherheit* +
Für das Passwort genügen 6 Zeichen. Die Sicherheitsstufe im Webshop ist nicht so hoch wie im Admin-Bereich. Daher genügt für das Passwort der Login-Daten die einfache Mischung aus Buchstaben und Ziffern. Siehe Handbuchseite <<business-entscheidungen/benutzerkonten-zugaenge#10, Benutzer anlegen>>.
