...
* $BasketItemAvailabilityIcon — Beinhaltet das Verfügbarkeitssymbol der Artikelverfügbarkeit. Ein Symbol wird im Menü *System » Systemeinstellungen » Artikel » Verfügbarkeit* hinterlegt.
* $BasketItemAvailabilityString — Beinhaltet den Namen der Artikelverfügbarkeit. Die Namen werden im Menü *System » Systemeinstellungen » Artikel » Verfügbarkeit* hinterlegt.
...
* $BasketItemReferrerID — Beinhaltet die ID der Herkunft. Die ID wird vom System vergeben. Die IDs sind im Menü System » Systemeinstellungen » Aufträge » Auftragsherkunft aufgeführt.
