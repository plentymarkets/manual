...
Eine for-Schleife kann angewendet werden, indem eine Zählervariable und ein Zahlenbereich definiert wird. Alternativ kann eine Iteration über ein <<omni-channel/online-shop/webshop-einrichten/cms-syntax#grundlagen-typen, Array>> vorgenommen werden.
