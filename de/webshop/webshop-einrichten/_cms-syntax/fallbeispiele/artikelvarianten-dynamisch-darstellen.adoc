...
====
Um Aufpreise im Auswahlfeld nicht anzuzeigen, öffnen Sie das Menü <<webshop/webshop-einrichten/artikelansichten#, System » Systemeinstellungen » Mandant » Mandant wählen » Artikelansichten » Einstellungen>>. Wählen Sie dort für die Option *Attribut-Aufpreis* die Einstellung *nicht anzeigen*.
====
...
. Öffnen Sie das Menü <<artikel/artikel-verwalten#390, System » Systemeinstellungen » Artikel » Attribute>>.
...
Im Menü <<artikel/artikel-verwalten#660, System » Systemeinstellungen » Artikel » Bilder>> hinterlegen Sie Maximalwerte für die Breite und Höhe von <<artikel/artikel-verwalten#450, Artikelattributbildern>>. Die Werte geben Sie in Pixeln an.
