...
====
Um Aufpreise im Auswahlfeld nicht anzuzeigen, öffne das Menü <<webshop/webshop-einrichten/artikelansichten#, System » Systemeinstellungen » Mandant » Mandant wählen » Artikelansichten » Einstellungen>>. Wähle dort für die Option *Attribut-Aufpreis* die Einstellung *nicht anzeigen*.
====
...
. Öffne das Menü <<artikel/artikel-verwalten#390, System » Systemeinstellungen » Artikel » Attribute>>.
...
Im Menü <<artikel/artikel-verwalten#660, System » Systemeinstellungen » Artikel » Bilder>> hinterlegst du Maximalwerte für die Breite und Höhe von <<artikel/artikel-verwalten#450, Artikelattributbildern>>. Die Werte werden in Pixeln angegeben.
