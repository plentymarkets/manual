...
//  plentymarkets
Beim Live-Shopping wird täglich ein Artikel aus dem Sortiment für einen bestimmten Zeitraum (z.B. von 9:00 bis 18:00 Uhr) zu einem vergünstigten Preis angeboten. Live-Shopping-Angebote konfigurierst du im Menü *Einrichtung » Mandant » Global » Live-Shopping*.
...
. Öffne das Menü *Einrichtung » Mandant » Global » Live-Shopping*.
...
Live-Shopping-Angebote können auch auf externen Plattformen eingestellt werden, z.B. auf link:http://www.liveshopping-aktuell.de[liveshopping-aktuell.de^]{nbsp}icon:external-link[]. Registriere dich dazu bei dem Anbieter und hinterlege die URL der Angebote nach folgendem Muster:
