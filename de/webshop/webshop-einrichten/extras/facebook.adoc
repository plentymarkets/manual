...
.Tipp: Facebook-App
====
Wenn du noch keine *Facebook-App* entwickelt hast und diesbezügliche *Informationen* benötigst, findest du hilfreiche Information dazu auf link:http://developers.facebook.com/docs/appsonfacebook/tutorial/[developers.facebook.com/docs/appsonfacebook/tutorial/^]{nbsp}icon:external-link[]. +
...
Nun benötigest du einen Code, um die Kommentarfunktion in deinem Webshop einzufügen. Den Code generierst du auf dieser link:http://developers.facebook.com/docs/reference/plugins/comments/[Facebook-Seite^]{nbsp}icon:external-link[]. Trage die URL deines Webshops in der Zeile *URL to comment on* ein und klicke auf *Get Code*, um den Code zu generieren.
