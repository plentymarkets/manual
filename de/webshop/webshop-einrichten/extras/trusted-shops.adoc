...
link:http://www.trustedshops.de/[Trusted Shops^]{nbsp}icon:external-link[] ist das bekannte Internet-Gütesiegel für Online-Shops mit Käuferschutz für deine Online-Kunden.
...
* Weiteres in den link:http://www.trustedshops.de/info/kategorie/haeufige_fragen_zu_trusted_shops/geld-zurueck-garantie/[Fragen zum Käuferschutz^]{nbsp}icon:external-link[].
...
. Öffne das Menü *Einrichtung » Mandant » Mandant wählen » Dienste » Trusted Shops*.
...
.Tipp
====
Das Widget ist im link:https://www.trustedshops.de/shop/login.html[Trusted Shops System^]{nbsp}icon:external-link[] bzgl. *Höhe*, *Breite*, *Kommentar* und *Branding* konfigurierbar.
====
...
. Öffne das Menü <<automatisierung/aktionsmanager#, Einrichtung » Aufträge » Aktionen>>.
...
→ Die <<crm/e-mails-versenden#1200, E-Mail-Vorlage>> erstellst du unter *Einrichtung » Mandant » Mandant wählen » E-Mail » Vorlagen*.
...
.Tipp
====
Weiterführende Hinweise zur Installation findest du ebenfalls im  link:http://support.trustedshops.com/de/apps/plentymarkets?shop_id=&variant=&yOffset=[Support-Bereich von Trusted Shops^]{nbsp}icon:external-link[].
====
