...
====
Richten Sie unter *System » Systemeinstellungen » Einstellungen » Benutzer* ein neues Benutzerkonto der Benutzerklasse *API* für FINDOLOGIC ein.
...
. Öffnen Sie das Menü *System » Systemeinstellungen » Mandant » Mandant wählen » Dienste » FINDOLOGIC*. +
