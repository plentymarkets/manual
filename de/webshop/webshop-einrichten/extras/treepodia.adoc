...
*System » Mandant » Mandant wählen » Dienste » Treepodia*
...
Die Zugangsdaten werden im Menü *System » Mandant » Mandant wählen » Dienste » Treepodia* konfiguriert.
...
Die folgende Tabelle erläutert die Einstellungen im Menü *System » Mandant » Mandant wählen » Dienste » Treepodia*:
...
Die robots.txt Ihres Systems finden Sie unter *System » Mandant » Mandant wählen » SEO » robots.txt*.
|====
...
Die Exporteinstellungen nehmen Sie im Menü *System » Märkte » Preisportale » Exporte* vor. Konfigurieren Sie dort ein *Exportformat* für Treepodia.
...
Die folgende Tabelle erläutert die Einstellungen im Menü *System » Märkte » Preisportale » Exporte*:
...
Slogans und Freitextfelder werden auch im Menü *System » Märkte » Preisportale » Exporte* hinterlegt.
...
Filter und Formatierungen werden auch im Menü *System » Märkte » Preisportale » Exporte* konfiguriert.
