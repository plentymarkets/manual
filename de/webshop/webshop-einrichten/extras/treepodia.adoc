...
Die robots.txt deines Systems findest du unter *System » Systemeinstellungen » Mandant » Mandant wählen » SEO » robots.txt*.
|====
...
Die Exporteinstellungen nimsmt du im Menü *System » Systemeinstellungen » Märkte » Preisportale » Exporte* vor. Konfiguriere dort ein *Exportformat* für Treepodia.
...
*Tipp:* Im Menü *System » Systemeinstellungen » Aufträge » Auftragsherkunft* kannst du noch weitere Auftragsherkünfte anlegen.
