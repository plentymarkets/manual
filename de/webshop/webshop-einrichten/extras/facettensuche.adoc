...
Die Konfiguration nimmst du im Menü *System » Systemeinstellungen » Mandant » Mandant wählen » Dienste » Facettenverknüpfungen* vor. Dort wählst du den Shop, mit dem du Facetten verknüpfen möchtest.
