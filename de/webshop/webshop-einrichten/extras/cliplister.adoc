...
Um Cliplister für deinen Webshop zu aktivieren, ist zunächst eine Registrierung auf der link:http://www.cliplister.com/[Cliplister-Website^]{nbsp}icon:external-link[] notwendig. Du erhältst dort Registrierungsdaten, die du in plentymarkets hinterlegst.
