...
*System » Systemeinstellungen » Mandant » Mandant wählen » Dienste » Econda*
...
. Öffnen Sie das Menü *System » Systemeinstellungen » Mandant » Mandant wählen » Dienste » Econda*.
...
→ Hier sind nur Attribute auswählbar, wenn Sie zuvor unter <<artikel/artikel-verwalten#390, System » Systemeinstellungen » Artikel » Attribute>> welche angelegt haben.
...
. Öffnen Sie das Menü *System » Systemeinstellungen » Mandant » Mandant wählen » Dienste » Econda » Tab: Einstellungen*.
