...
. Öffne das Menü *System » Systemeinstellungen » Mandant » Mandant wählen » Dienste » Econda*.
...
→ Hier sind nur Attribute auswählbar, wenn du zuvor unter <<artikel/artikel-verwalten#390, System » Systemeinstellungen » Artikel » Attribute>> welche angelegt hast.
...
. Öffne das Menü *System » Systemeinstellungen » Mandant » Mandant wählen » Dienste » Econda » Tab: Einstellungen*.
