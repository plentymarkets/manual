...
Dieses Widget stellt ein Strukturelement mit 4 Spalten zur Verfügung. Die 3 Spalten werden nebeneinander standardmäßig im Verhältnis 1:1:1 dargestellt. Klicke auf das Zahnrad-Symbol des Widgets, um die Einstellungen zu öffnen.
