...
[#15]
== Die Kategorieansicht des ShopBuilders
...
.Kategorie-Ansicht des ShopBuilders
image::webshop/assets/ContentManager-UI.png[]

[[tabelle-content-manager-ui]]
.Elemente der Kategorie-Ansicht des ShopBuilders
[cols="1,1,3"]
|====
...
|Wenn durch ein Update des Plugins *Ceres* Änderungen an bereits verwendeten Widgets gemacht werden, dient diese Schaltfläche dazu, die betroffenen Widgets neu zu generieren, sodass Ihre ShopBuilder-Inhalte nach einem Update korrekt ausgegeben werden. Wenn es notwendig ist Inhalte neu zu generieren, machen wir darauf in unserem link:https://github.com/plentymarkets/plugin-ceres/blob/stable/meta/documents/changelog_de.md[Changelog^] unter der Überschrift *TODO* aufmerksam.
...
|7
|*Header-Elemente*
|In diesem Bereich erstellen und bearbeiten Sie neue Inhalte für den Header. Momentan ist der erstellte Header global für alle im ShopBuilder angelegten Seiten wirksam. Das gleiche gilt für den Bereich *Footer-Elemente* _*Hinweis*_: Dieser Bereich ist standardmäßig eingeklappt.
...
|*Tabs*
|Stellt ein Struktur-Widget zur Verfügung, mit dem man Widgets als Tabs gruppieren kann. Klicken Sie auf *Bearbeiten*, um die <<#45, Farbe>> des Widgets zu ändern,  dem Widget *neue Tabs* hinzuzufügen und die Tabs zu benennen. *Hinweis*: Bevor man ein Widget in dieses Strukturelement ziehen kann, muss der Titel von mindestens einem Tab in den Widget-Einstellungen hinterlegt werden.
...
|*Titelleiste*
|Stellt eine Textbox zur Verfügung. Klicken Sie auf *Bearbeiten*, um Text einzugeben und die <<#45, Farbe>> der Titelleiste zu ändern. Es kann nur Reintext verwendet werden.

|*Text*
|Stellt eine Textbox zur Verfügung. Klicken Sie auf *Bearbeiten*, um Text einzugeben und die <<#45, Farbe>> der Textbox zu ändern. Im Texteditor kann Reintext und, nach Klick auf *</>*, auch HTML eingegeben werden. Es ist nicht möglich, CSS in diesem Widget einzubinden.
...
=== Vorschau mit Bearbeitungsmöglichkeiten (Inline Editing)

Mit der Veröffentlichung von Ceres 4.0 wurde Inline Editing für bestimmte Widgets eingeführt. Inline Editing ermöglicht es, Texte und Code direkt in der Ansicht des ShopBuilders zu bearbeiten. Um Inline Editing zu aktivieren, klicken Sie auf dem Widget auf das *Stift*-Symbol. Sie können den eingegebenen Text markieren, um einen Texteditor zu öffnen, der die gängigen Formatierungsoptionen bereitstellt. Die Texte der folgenden Widgets können inline bearbeitet werden:
...
Weiterhin wurde mit dem *Code-Widget* ein Widget hinzugefügt, mit dem Sie Code direkt im ShopBuilder bearbeiten können. Klicken Sie auf das *</>*-Symbol auf dem Code-Widget, um das Bearbeitungsfenster zu öffnen.

[#31]
=== Kategorie zur Anzeige von Versandinformationen verknüpfen
...
. Öffen Sie das Menü *CMS » ShopBuilder*. +
→ Die Kategorieansicht des ShopBuilders wird geöffnet. +
. Klicken Sie links im Kategoriebaum auf *Neue Kategorie erstellen*. +
→ Das Fenster *Neue Kategorie erstellen* wird geöffnet. +
. Geben Sie einen Namen für die Kategorie ein, z.B. *Versandkosteninformationen*.
. Wählen Sie *Hauptseite*.
. Klicken Sie auf *Erstellen*. +
→ Das Fenster *Kategorie bearbeiten* wird geöffnet. +
. Verknüpfen Sie die Kategorie mit einem Mandanten und nehmen Sie die Einstellungen gemäß <<tabelle-kategorie-bearbeiten>> vor.
. *Speichern* Sie die Einstellungen.
→ Die Kategorie wurde angelegt.
. Klicken Sie auf *Neu*, um einen neuen Inhalt für die Kategorie anzulegen. +
→ Das Fenster *Neue Seite erstellen* wird geöffnet.
. Wählen Sie den Typ *Content* aus.
. Geben Sie einen Namen für den Inhalt ein.
. *Speichern* Sie den Inhalt.
. Klicken Sie auf den gerade angelegten Inhalt, um den ShopBuilder-Editor zu öffnen.
. Richten Sie die Seite nach Ihren Wünschen ein.
...
. Öffnen Sie das Menü *CMS » ShopBuilder*. +
→ Die Kategorieansicht des ShopBuilders wird geöffnet. +
. Klicken Sie links oben auf das Zahnrad-Icon *Einstellungen öffnen*. +
→ Die Verknüpfungsoberfläche wird geöffnet.
. Wählen Sie unter *Kategorie zur Anzeige von Versandkosteninformationen* die zuvor erstellte Kategorie aus.
. Klicken Sie auf *Auswählen*.
. *Speichern* Sie die Einstellungen.
. Wechseln Sie zurück in die Kategorieansicht des ShopBuilders.
. Klicken Sie auf die zuvor angelegte Kategorie zur Anzeige Ihrer Versandkosteninformationen.
. *Aktivieren* Sie den angelegten Inhalt durch Klick auf das Auge-Icon. +
...
[#110]
== Ceres-Checkout mit dem ShopBuilder bearbeiten

Ab Ceres Version 3.1.0 kann auch die Kaufabwicklung in Ceres Webshops über den ShopBuilder bearbeitet werden. Zusätzlich zu den Checkout-Widgets sind auch alle <<tabelle-elemente-shop-builder, Widgets>> verfügbar, die auf der Startseite platziert werden können. Der Checkout wird auf die gleiche Weise eingerichtet wie die <<#20, Startseite>>. +
...
. Klicken Sie links im Kategoriebaum auf *Neue Kategorie erstellen*. +
→ Das Fenster *Neue Kategorie erstellen* wird geöffnet. +
. Geben Sie einen Namen für die Kategorie ein, z.B. *Kaufabwicklung*.
. Wählen Sie *Hauptseite*.
. Klicken Sie auf *Erstellen*. +
→ Das Fenster *Kategorie bearbeiten* wird geöffnet. +
. Verknüpfen Sie die Kategorie mit einem Mandanten und nehmen Sie die Einstellungen gemäß <<tabelle-kategorie-bearbeiten>> vor.
...
. Öffen Sie das Menü *CMS  ShopBuilder*. +
→ Der ShopBuilder wird geöffnet. +
. Klicken Sie links in der Werkzeugleiste auf *Einstellungen öffnen*. +
→ Die Verknüpfungs-Oberfläche wird geöffnet. +
. Klicken Sie in das Feld *Kategorie für Checkout*.
. Wählen Sie über die Kategorieauswahl die zuvor erstellte Kategorie.
. Klicken Sie auf *Auswählen*. +
...
. Öffen Sie das Menü *CMS  ShopBuilder*. +
→ Der ShopBuilder wird geöffnet. +
. Wählen Sie im Kategoriebaum auf der linken Seite Ihre Checkout-Kategorie aus.
. Klicken Sie auf *Neu*. +
→ Das Fenster *Neue Seite erstellen* wird geöffnet. +
. Wählen Sie den Content-Typ *Checkout*.
. Geben Sie einen Namen für die Checkout-Seite ein.
. Wählen Sie bei Bedarf eine Vorlage für den Checkout aus.
. *Speichern* Sie die Einstellungen. +
→ Die neue Checkout-Seite wurde angelegt. +
. Klicken Sie auf der Kachel der neuen Seite auf *Aktivieren*, um diese Seite als aktiven Checkout zu verwenden.
. Klicken Sie auf die Kachel der neuen Seite, um die Seite einzurichten. Beachten Sie dabei <<tabelle-elemente-checkout>> und <<tabelle-elemente-shop-builder>>.
. *Speichern* Sie die Einstellungen.

[[tabelle-elemente-checkout]]
.Widgets für die Kaufabwicklung
[cols="1,3"]
|====
|Widget |Erläuterung
...
|*Warenkorbinhalt*
|Stellt eine Übersicht der Artikel im Warenkorb zur Verfügung. Klicken Sie auf *Bearbeiten*, um die <<#45, Farbe>> der Darstellung zu bestimmen.

|*Gutscheineingabe*
|Stellt das Eingabefeld zur Verfügung, in welchem Kunden und Kundinnen Gutscheincodes einlösen können. Klicken Sie auf *Bearbeiten*, um die <<#45, Farbe>> der Darstellung zu bestimmen.
...
|Stellt eine Schaltfläche zur verfügung, über die Ihre Kunden einen verifizierten Kauf eines Payment-Plugins (z.B. PayPal) abbrechen können. Klicken Sie auf *Bearbeiten*, um Einstellungen vorzunehmen. +
...
== *Mein Konto*-Bereich mit dem ShopBuilder bearbeiten
...
Zusätzlich zu den Mein-Konto-Widgets sind auch alle <<tabelle-elemente-shop-builder, Widgets>> verfügbar, die auf der Startseite platziert werden können, mit Ausnahme der Widgets für den Footer und Header. Der *Mein Konto*-Bereich wird auf die gleiche Weise eingerichtet wie die <<#20, Startseite>>. +
...
. Klicken Sie links im Kategoriebaum auf *Neue Kategorie erstellen*. +
→ Das Fenster *Neue Kategorie erstellen* wird geöffnet. +
. Geben Sie einen Namen für die Kategorie ein, z.B. *Kundenbereich*.
. Wählen Sie *Hauptseite*.
. Klicken Sie auf *Erstellen*. +
→ Das Fenster *Kategorie bearbeiten* wird geöffnet. +
. Verknüpfen Sie die Kategorie mit einem Mandanten und nehmen Sie die Einstellungen gemäß <<tabelle-kategorie-bearbeiten>> vor.
...
. Öffen Sie das Menü *CMS » ShopBuilder*. +
→ Der ShopBuilder wird geöffnet. +
. Wählen Sie im Kategoriebaum auf der linken Seite Ihre *Mein Konto*-Kategorie aus.
. Klicken Sie auf *Neu*. +
→ Das Fenster *Neue Seite erstellen* wird geöffnet. +
. Wählen Sie den Content-Typ *My Account*.
. Geben Sie einen Namen für die Mein-Konto-Seite ein.
. *Speichern* Sie die Einstellungen. +
→ Die neue *Mein Konto*-Seite wurde angelegt. +
. Klicken Sie auf der Kachel der neuen Seite auf *Aktivieren*, um diese Seite als aktiven Mein-Konto-Bereich zu verwenden.
. Klicken Sie auf die Kachel der neuen Seite, um die Seite einzurichten. Beachten Sie dabei <<tabelle-elemente-mein-konto>> und <<tabelle-elemente-shop-builder>>.
. *Speichern* Sie die Einstellungen.
...
|*Bankdaten*
|Stellt ein Widget zur Verfügung, über welches Kunden und Kundinnen ihre Bankdaten hinzufügen und ändern können. Klicken Sie auf *Bearbeiten*, um die <<#45, Farbe>> der Schaltfläche *Bankdaten hinzufügen* zu ändern und einen *Hinweistext* einzugeben, der zwischen Widget-Überschrift und Bankdaten angezeigt wird.

|*Auftragshistorie*
|Stellt Ihren Kunden und Kundinnen eine Auflistung ihrer früheren Bestellungen zur Verfügung. Die Auftragshistorie beinhaltet Informationen über *Auftrags-ID*, *Summe*, *Auftragsdatum*, *Versanddatum* und *Status*. Klicken Sie auf *Bearbeiten*, um die <<#45, Farbe>> des Widgets zu ändern und einen *Hinweistext* einzugeben, der zwischen Widget-Überschrift und Auftragshistorie angezeigt wird. Weiterhin geben Sie an, wie viele *Aufträge pro Seite* angezeigt werden, ob Sie das *Ändern der Zahlungsart* durch Kunden zulassen und ob Sie *Retouren erlauben*. Dieses Widget ist auf 1 pro Seite limitiert.
...
|*Ausloggen*
|Stellt die Schaltfläche zur Verfügung, über die sich Ihre Kunden aus dem Webshop ausloggen können. Klicken Sie auf *Bearbeiten*, um die <<#45, Farbe>> der Schaltfläche *Ausloggen* zu ändern und die *Button-Größe* zu wählen.
...
→ Das Fenster *Kategorie bearbeiten* wird geöffnet.
. Klicken Sie oben auf die Schaltfläche *Löschen*. +
