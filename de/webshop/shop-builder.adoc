...
Dieses Widget stellt den Kaufen-Button zur Verfügung, über den deine Kund:innen die Bestellung im Webshop abschließen. Klicke auf icon:cog[role="darkGrey"] *Einstellungen*icon:cog[role="darkGrey"] *Einstellungen*, um die Widget-Einstellungen zu öffnen. +
...
Dieses Widget stellt einen Button zur Verfügung, über den deine Kund:innen die für ihre Bestellung relevanten Dokumente herunterladen können. Klicke auf icon:cog[role="darkGrey"] *Einstellungen*, um die Widget-Einstellungen zu öffnen. +
