...
====
Zum gegenwärtigen Zeitpunkt können die Startseite, der Checkout und die Content-Kategorien Ihres Ceres Webshops über den ShopBuilder bearbeitet werden. Der Funktionsumfang des ShopBuilders wird nach und nach erweitert und in Zukunft wird es möglich sein, den gesamten Ceres Shop darüber zu bearbeiten.
====
...
*Adressformat* = DE oder UK wählen. Je nachdem, welches Adressformat gewählt wird, stehen bei der Anzeige und Validierung der Adressfelder unterschiedliche Felder zur Verfügung. +
*Rechnungs- und Lieferadressfelder anzeigen* = Adressfelder wählen, die Ihren Kunden für die Adresseingabe angezeigt werden. +
*Rechnungs- und Lieferadressfelder validieren* = Adressfelder wählen, die beim Klick auf *Kaufen* validiert werden. Wenn diese Felder beim Klick auf *Kaufen* nicht ausgefüllt sind, wird der Kauf nicht abgeschlossen. +
2+|*Warenkorb*
...
//== MyAccount-Seiten mit dem ShopBuilder bearbeiten
