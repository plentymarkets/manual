...
link:https://marketplace.plentymarkets.com/plugins/widgets/Feedback_5115[Kunden-Feedback^] ist ein Plugin für den Webshop link:https://marketplace.plentymarkets.com/plugins/templates/Ceres_4697[Ceres^]. Installiere das Plugin *Kunden-Feedback*, um Kundenrezensionen im Webshop anzuzeigen und zu beantworten. Im Menü *CMS » Feedback-Bewertungen* schaltest  Kundenrezensionen für die Besucher deines Webshops frei. Hier beantwortest oder bearbeitest du Kundenrezensionen. Auch das Migrieren von bestehenden Rezensionen und das Löschen von Kundenrezensionen ist in diesem Menü möglich.

[#100]
== Kundenrezensionen migrieren

Wenn du von deinem Callisto-Webshop auf den Ceres-Webshop umsteigst, stehen dir die Kundenrezensionen nach einer Migration auch im neuen Webshop zur Verfügung. Gehe wie im Folgenden beschrieben vor, um bestehende Kundenrezensionen zu migrieren.

[#200.instruction]
Bestehende Kundenrezensionen migrieren:

. Öffne das Menü *CMS » Feedback-Bewertungen*.
. Klicke auf *Bestehende Feedbacks migrieren*. +
