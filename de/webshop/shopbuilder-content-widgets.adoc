...
Mit diesem Plugin fügst du 20 zusätzliche Widgets zu ShopBuilder hinzu. Einzelheiten zum Erwerben des Plugins link:https://marketplace.plentymarkets.com/shopbuilder-content-widgets_55026[findest du auf plentyMarketplace^].
