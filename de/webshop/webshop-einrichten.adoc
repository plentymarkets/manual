...
.  Öffnen Sie das Menü *System » Systemeinstellungen » Mandant » Mandant wählen » Webshop » Grundeinstellungen*.
...
. Öffnen Sie das Menü *System » Systemeinstellungen » Mandant » Mandant wählen » Webshop » Shop sperren*.
...
*_Wichtig:_* Wenn diese Funktion aktiviert ist, wird eine unter *System » Systemeinstellungen » Mandant » Mandant wählen » Webshop » Seiten* als *404-Fehlerseite* hinterlegte Kategorieseite nicht angezeigt.
...
*_Wichtig:_* Wenn diese Funktion aktiviert ist, wird eine unter *System » Systemeinstellungen » Mandant » Mandant wählen » Webshop » Seiten* als *Seite "Artikel nicht gefunden"* hinterlegte Kategorieseite nicht angezeigt.
|====
...
. Öffnen Sie das Menü *System » Systemeinstellungen » Mandant » Mandant wählen » Webshop » Rechtliche Angaben*.
...
Die Kategorieseiten müssen im Menü <<#infoseiten,  System » Systemeinstellungen » Mandant » Mandant wählen » Webshop » Seiten>> bzw. designspezifisch
...
====
Wenn Sie Template-Variablen oder -Funktionen in Ihr Design eingefügt haben, veröffentlichen Sie Ihr Design im Menü <<webshop/webshop-einrichten/cms#webdesign-benutzeroberflaeche, CMS » Webdesign>> neu.
====
...
Im Menü *System » Systemeinstellungen » Mandant » Mandant wählen » Webshop » Seiten* verknüpfen Sie *Kategorieseiten*. Es handelt sich hier um Seiten,
...
====
Für Designs, bei denen im Menü *CMS » Webdesign » Einstellungen » Design-Einstellungen » Tab: Mandanten* Kategorien verknüpft wurden, gelten die unten beschriebenen Verknüpfungen im Menü *System » Systemeinstellungen » Mandant » Mandant wählen » Webshop » Seiten* nicht. Die designspezifischen Kategorieverknüpfungen sind dominant.
====
