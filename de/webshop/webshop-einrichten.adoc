...
.  Öffne das Menü *System » Systemeinstellungen » Mandant » Mandant wählen » Webshop » Grundeinstellungen*.
...
. Öffne das Menü *System » Systemeinstellungen » Mandant » Mandant wählen » Webshop » Shop sperren*.
...
. Öffne das Menü *System » Systemeinstellungen » Mandant » Mandant wählen » Webshop » Rechtliche Angaben*.
. Öffne eine Sprache.
...
Im Menü *System » Systemeinstellungen » Mandant » Mandant wählen » Webshop » Seiten* verknüpfst du *Kategorieseiten*. Es handelt sich hier um Seiten,
