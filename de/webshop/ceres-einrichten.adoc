...
====
Unsere Assistenten helfen dir bei der Einrichtung deines Webshops. Durchlaufe den Integrationen-Assistenten unter *Einrichtung » Assistenten » Grundeinrichtung » Integrationen*, um Ceres zu installieren. Durchlaufe danach den Ceres-Assistent unter *Einrichtung » Omni-Channel » plentyShop Ceres* um deinen Webshop nach deinen Vorstellungen aufzusetzen. 
====
