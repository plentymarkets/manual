...
Eine vollständige Auflistung und Erläuterung der verfügbaren Container findest du in unserer englischsprachigen link:https://developers.plentymarkets.com/dev-doc/template-containers[Entwicklerdokumentation^]{nbsp}icon:external-link[]. Die Entwicklerdokumentation richtet sich primär an erfahrenere Nutzerinnen und Nutzer und ist für eine Basiseinrichtung von Ceres nicht notwendig.
