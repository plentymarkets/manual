...
|Gib einen Wert ein, gemäß welchem Google entscheidet, ob es sich bei einem Benutzer um einen Menschen oder einen Bot handelt. Je höher der Wert, desto strikter fällt die Validierung aus. Der Standardwert besträgt 0,5.
