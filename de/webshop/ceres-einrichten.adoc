...
Hier nimmst du Einstellungen vor, die den Header deines plentyShops betreffen. Der Header ist der obere Bereich einer Seite. Du kannst für jede Seite einen individuellen Header mit dem ShopBuilder <<webshop/shop-builder#10, ShopBuilder>> erstellen.
...
Warum wird meine Kategorie nicht im Shop angezeigt?::
    Gehe <<artikel/webshop/checkliste-kategorien-anzeige#, diese Checkliste>> Schritt für Schritt durch. Sollte deine Kategorie trotzdem nicht angezeigt werden, kontaktiere uns im link:https://forum.plentymarkets.com/c/plentyshop[Forum^].

[qanda]
Warum wird mein Artikel nicht im Shop angezeigt?::
    Gehe <<artikel/webshop/checkliste-artikel-anzeige#, diese Checkliste>> Schritt für Schritt durch. Sollte dein Artikel trotzdem nicht angezeigt werden, kontaktiere uns im link:https://forum.plentymarkets.com/c/plentyshop[Forum^].
