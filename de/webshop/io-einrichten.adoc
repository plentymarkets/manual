...
Der plentymarkets 7 Webshop ist auf zwei unterschiedliche Plugins aufgeteilt: link:https://marketplace.plentymarkets.com/plugins/templates/Ceres_4697[Ceres^] stellt das Webshop-Design zur Verfügung und kann nach deinen Bedürfnissen angepasst werden.
...
====
Wenn Du die Template-Plugins *Ceres* und *IO* in einem Plugin-Set <<basics/erste-schritte/plugins#70, aktivierst>>, ist der alte plentymarkets Webshop Callisto nicht mehr erreichbar, da *Ceres* und *IO* die URL des Webshops übernehmen.
====
