...
Lade die aktuelle Version der technischen Systemdokumentation von plentymarkets link:https://cdn02.plentymarkets.com/pmsbpnokwu6a/frontend/plentymarkets_Rechtliches/Verfahrensdokumentation_V7.1.pdf[hier herunter^]. Ältere Versionen findest du link:https://github.com/plentymarkets/template-procedure-document/releases[hier^]{nbsp}icon:external-link[].
