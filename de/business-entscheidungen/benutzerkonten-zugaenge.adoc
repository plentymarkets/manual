...
:keywords: Eigner, Benutzer, Benutzerkonten, Benutzerkonto, Benutzer verwalten, Benutzerverwaltung, Benutzerkonto verwalten, Benutzerkonten verwalten, Rolle, Rollen, Berechtigungen, Berechtigungen zuordnen, Rechte, Rechte vergeben, Menü- und REST-API Rechte, Sichtbarkeiten festlegen, Zugang, Zugänge, Benutzerzugang, Benutzerzugänge, CUL-Benutzerlizenz, Benutzerlizenz, Benutzerlizenzen, Limit, Limitierung, Passwortsicherheit, Admin, Backend, REST-API, REST API, Stammdaten, Postfach erstellen, Rollen und Prozesse, plentymarkets Forum, Session-Verwaltung, Adminrechte, Admin-Rechte
...
In jedem plentymarkets System sind kostenfrei fünf CUL-Benutzerlizenzen enthalten. Weitere Benutzerkonten buchst du im link:http://www.plentymarkets.eu/preise/[Konfigurator]{nbsp}icon:external-link[] hinzu.
...
| *Backend*
|Zugang, für den im Benutzerkonto unter *Tab: Berechtigung* <<business-entscheidungen/benutzerkonten-zugaenge#100, Bereiche>> und <<business-entscheidungen/benutzerkonten-zugaenge#110, Funktionen>> freigeschaltet werden.

| *REST-API*
|Zugang, für den im Benutzerkonto <<business-entscheidungen/benutzerkonten-zugaenge#120, REST-Calls>> freigeschaltet werden. Die REST-Calls werden dann einzeln aktiviert. Es werden dem Benutzerkonto also nicht pauschal alle REST-Calls freigeschaltet. +
...
| *Farbe*
<<<<<<< HEAD:de/business-entscheidungen/benutzerkonten-zugaenge.adoc
|Im Bearbeitungsfenster eine Farbe durch Verschieben der Farbauswahl festlegen, einen Hexadezimalwert oder RGB-Werte eingeben. Die Farbe erleichtert die Identifikation des Benutzerkontos in anderen Bereichen, zum Beispiel im <<willkommen/allgemeine-funktionen/aufgaben-und-kalender#600, Kalender>>.
=======
...
>>>>>>> master:de/basics/admin-aufgaben/benutzer-verwalten.adoc
...
| *Rollen*
<<<<<<< HEAD:de/business-entscheidungen/benutzerkonten-zugaenge.adoc
|Rollen des Benutzerkontos wählen. Damit Rollen zur Auswahl stehen, müssen zuvor <<business-entscheidungen/benutzerkonten-zugaenge#70, Rollen>> erstellt werden.
=======
...
|Hier nimmst du Einstellungen vor, die nur für das im System angemeldete Benutzerkonto gelten. Deshalb ist das Tab für dich auch nur in deinem eigenen Benutzerkonto sichtbar. Das Tab unterteilt sich in die Tabs <<willkommen/system-personalisieren#70, Allgemein>>, <<willkommen/system-personalisieren#80, Shortcuts>> und <<willkommen/system-personalisieren#90, Favoriten>>, die nur dich persönlich betreffen.

| *Kalender*
|Hier werden Einstellungen für den <<willkommen/allgemeine-funktionen/aufgaben-und-kalender#600, Kalender>> vorgenommen.
=======
...
| *Berechtigung*
|Dieses Tab wird im Kapitel <<basics/admin-aufgaben/benutzer-verwalten#105, Rechte verwalten>> detailliert beschrieben.
...
Im Menü *Einrichtung » Einstellungen » Benutzer » Rechte » Benutzer* können Rechte für einzelne Benutzer vergeben werden. Dies beinhaltet die REST-API-Berechtigungen, die Menü-Sichtbarkeiten und die Plugin-Menü-Sichtbarkeiten.
...
icon:map-signs[] *_Oder:_* Ziehe ein Benutzerkonto per Drag &amp; Drop in die Spalte *Zugeordnete Benutzer*.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
