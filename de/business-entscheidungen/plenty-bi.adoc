...
Wartest du sehnsüchtig auf ein neues Feature für plentyBI? Wir informieren dich gerne über Änderungen an der Software! Änderungen werden link:https://forum.plentymarkets.com/c/changelog/changelog-app[in einem Changelog^]{nbsp}icon:external-link[] veröffentlicht. Abonniere den Changelog und bleibe immer auf dem Laufenden.
