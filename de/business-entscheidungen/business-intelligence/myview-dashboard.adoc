...
Bei der Einrichtung eines Dashboards ist eine Standardansicht vorhanden. Diese ist für alle Benutzer deines plentymarkets Systems sichtbar. +
Überlege dir vor der Arbeit mit dem Dashboard, welche Benutzer die Standardansicht sehen dürfen. Du kannst im Dashboard auch weitere Ansichten anlegen {hier noch link zum Kapitel einfügen}, die für Benutzer sichtbar sein sollen. Die Zuweisung dieser Sichtbarkeit erfolgt pro Rolle. Weitere Informationen und eine Anleitung für die Zuweisung pro Rolle findest du auf der Handbuchseite <<business-entscheidungen/benutzerkonten-zugaenge#116, Benutzer:innen-Konten und Zugänge>>.
