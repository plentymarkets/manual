...
//TODO: Diagrammbeschreibungen ergänzen
...
Füge zunächst <<business-entscheidungen/business-intelligence#420, wie oben beschrieben>> ein *Diagramm* hinzu. Gehe danach wie folgt vor, um individuelle Einstellungen für das Tortendiagramm vorzunehmen.
...
Balken- und Liniendiagramme sind ebenfalls häufig verwendete Diagrammtypen. Sie geben besonders deutlich Aufschluss über zeitliche Entwicklungen von Werten. Deshalb kannst du für diese Diagramme auch mehrere Kennzahlen pro Element auswählen. 
...
Füge zunächst <<business-entscheidungen/business-intelligence#420, wie oben beschrieben>> ein *Balkendiagramm* oder ein *Liniendiagramm* hinzu. Gehe danach wie folgt vor, um individuelle Einstellungen für die Diagramme vorzunehmen.
...
| Wähle aus der Dropdown-Liste eine oder mehrere Kennzahlen und Zeiträume aus, die im Balken- oder Liniendiagramm dargestellt werden soll. Klicke alternativ auf *Neue Kennzahl erstellen* icon:plus[role="green"], um <<business-entscheidungen/business-intelligence#220, direkt im Einstellungsmenü>> eine neue Kennzahl anzulegen.
