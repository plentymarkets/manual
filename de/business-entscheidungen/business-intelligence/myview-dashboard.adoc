...
| *Zoom aktivieren*
| Aktiviere diese Option, um die Ansicht des Dashboard-Elements per Zoom-Funktion regulieren zu können. Lege zusätzlich einen *Anfangswert* fest, auf den der Zoom standardmäßig eingestellt werden soll.
