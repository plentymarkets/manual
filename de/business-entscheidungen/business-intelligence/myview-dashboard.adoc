...
| Wähle aus der Dropdown-Liste Kennzahlen und Zeiträume aus, die im Balken- oder Liniendiagramm dargestellt werden sollen. Klicke alternativ auf *Neue Kennzahl erstellen* icon:plus[role="green"], um <<#220, direkt im Einstellungsmenü>> eine neue Kennzahl anzulegen.
