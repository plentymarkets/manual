...
:position: 72
:url: business-entscheidungen/business-intelligence/reports/datenformate/messages
:id: 3ROK81J
:author: team-crm
...
|account contact id
|ID des Kontakts
// hier ist die ac_id gemeint statt der c_id (=category ID), muss in der CSV/im Code angepasst werden.
...
1 = Kostenpflichtig
// ist der Datentyp korrekt? Vorschlag CRM-Team: TINYINT
