...
Setze außerdem <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/auftraege#200, Filter>> um zu konkretisieren, nach welchen Kriterien die Aufträge berechnet werden sollen.
