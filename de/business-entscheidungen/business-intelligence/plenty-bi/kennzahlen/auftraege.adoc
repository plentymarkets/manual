...
Wähle zusätzlich <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/auftraege#100, Dimensionen>> und <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/auftraege#200, Filter>>, um zu konkretisieren, nach welchen Kriterien die Anzahl der Aufträge berechnet werden soll.
