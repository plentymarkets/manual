...
:position: 80
:url: business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/auftraege
:id: D2IR751
...
plentymarkets berechnet die Anzahl der Aufträge, indem die Aufträge einmal täglich gezählt werden. Wähle zusätzlich <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/auftraege#400, Dimensionen>> und <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/auftraege#500, Filter>>, um zu konkretisieren nach welchen Kriterien die Anzahl der Aufträge berechnet werden soll. Beachte, dass die Aufträge gezählt werden, die du im Filter *Auftragstyp* definierst.
...
_Beachte_, dass für die Kennzahl die Aufträge gezählt werden, die du in diesem Filter auswählst.
