...
Wähle zusätzlich eine <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/auftraege#100, Dimension>> um festzulegen, wie das Ergebnis aufgeschlüsselt werden soll.
Setze außerdem <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/auftraege#200, Filter>> um zu konkretisieren, nach welchen Kriterien die Aufträge berechnet werden soll.
...
:kennzahl: Die Aufträge
:das-bedeutet: So erkennst du auf einen Blick, wie viele Aufträge ?????? in welchem Rechnungsland generiert wird. Differenziert wird zusätzlich nach Erstellungsdatum der Aufträge.
