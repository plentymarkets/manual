...
:kennzahl: Der Absatz
:das-bedeutet: So erkennst du auf einen Blick, wie viel Absatz in welchem welchem Rechnungsland differenziert nach Erstellungsdatum der Aufträge erfolgt.
...
:kennzahl: Der Absatz
:das-bedeutet: So erkennst du auf einen Blick, wie viel Absatz in welchem welchem Lieferland differenziert nach Erstellungsdatum der Aufträge erfolgt.
...
:kennzahl: Der Absatz
:das-bedeutet: So erkennst du auf einen Blick, welcher Absatz über welche Auftragsherkunft differenziert nach Erstellungsdatum der Aufträge erfolgt.
...
:kennzahl: Der Absatz
:das-bedeutet: So erkennst du auf einen Blick, welcher Absatz für welche Kategorie differenziert nach Erstellungsdatum der Aufträge erfolgt.
...
:kennzahl: Der Absatz
:das-bedeutet: So erkennst du auf einen Blick, welcher Absatz über welches Lager differenziert nach Erstellungsdatum der Aufträge erfolgt.
...
:kennzahl: Der Absatz
:das-bedeutet: So erkennst du auf einen Blick, welcher Absatz über welchen Mandanten differenziert nach Erstellungsdatum der Aufträge erfolgt.
...
:kennzahl: Der Absatz
:das-bedeutet: So erkennst du auf einen Blick, welcher Absatz für welchen Hersteller differenziert nach Erstellungsdatum der Aufträge erfolgt.
...
:kennzahl: Der Absatz
:das-bedeutet:  So erkennst du auf einen Blick, wie der Absatz durch Retourengründe beeinflusst wird. Zudem wird nach Erstellungsdatum der Aufträge differenziert.
...
:kennzahl: Der Absatz
:das-bedeutet: So erkennst du auf einen Blick, welcher Absatz über welche Zahlungsart differenziert nach Erstellungsdatum der Aufträge erfolgt.
...
:kennzahl: Der Absatz
:das-bedeutet: So erkennst du auf einen Blick, welcher Absatz über welche Auftragsherkunft erfolgt.  Mit dem Zusatz Zahlungsdatum wird zusätzlich nach dem Datum, an dem einem Auftrag eine Zahlung zugeordnet wird, differenziert.
...
:kennzahl: Der Absatz
:das-bedeutet: So erkennst du auf einen Blick, welcher Absatz über welches Lager erfolgt.  Mit dem Zusatz Zahlungsdatum wird zusätzlich nach dem Datum, an dem einem Auftrag eine Zahlung zugeordnet wird, differenziert.
...
:kennzahl: Der Absatz
:das-bedeutet: So erkennst du auf einen Blick, welcher Absatz über welchen Mandant erfolgt.  Mit dem Zusatz Zahlungsdatum wird zusätzlich nach dem Datum, an dem einem Auftrag eine Zahlung zugeordnet wird, differenziert.
...
:kennzahl: Der Absatz
:das-bedeutet: So erkennst du auf einen Blick, welcher Absatz über welche Auftragsherkunft differenziert nach Warenausgangsdatum erfolgt.
...
:kennzahl: Der Absatz
:das-bedeutet: So erkennst du auf einen Blick, welcher Absatz über welches Lager differenziert nach Warenausgangsdatum erfolgt.
...
:kennzahl: Der Absatz
:das-bedeutet: So erkennst du auf einen Blick, welcher Absatz über welchen Mandant differenziert nach Warenausgangsdatum erfolgt.
