...
:kennzahl: Der Absatz
:das-bedeutet: Das bedeutet, dass beim Zuzsammenzählen der Auftragspositionen Gutschriften und Retouren abgezogen werden, wenn diese im Filter *Auftragstyp* ausgewählt sind.
