...
:keywords: Absatz, Business Intelligence, Statistik, Statistiken, Kennzahl, Kennzahlen, Dashboard, Rohdaten, Report, Reports, KPI, KPIs, Key Performance Indicator
:position: 20
:url: business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/absatz
:id: MSSWL41
...
plentymarkets berechnet den Absatz, indem die Menge der Auftragspositionen summiert wird. Wähle zusätzlich <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/absatz#400, Dimensionen>> und <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/absatz#500, Filter>>, um zu konkretisieren nach welchen Kriterien der Absatz berechnet werden soll.
...
:kennzahl: Der Absatz
:das-bedeutet: Das bedeutet, dass bei der Summierung der Auftragspositionen keine Unterscheidung zwischen Auftragstypen gemacht wird. Auch Gutschriften und Retouren werden einbezogen.
...
:kennzahl: Der Absatz
:das-bedeutet: Das bedeutet, dass bei der Summierung der Auftragspositionen Gutschriften und Retouren nicht eingerechnet werden.
...
:kennzahl: Der Absatz
:das-bedeutet: So erkennst du auf einen Blick, wie viel Absatz in welchem welchem Rechnungsland erfolgt. Differenziert wird zusätzlich nach Erstellungsdatum der Aufträge.
...
:kennzahl: Der Absatz
:das-bedeutet: So erkennst du auf einen Blick, wie viel Absatz in welchem welchem Lieferland erfolgt. Differenziert wird zusätzlich nach Erstellungsdatum der Aufträge.
...
:kennzahl: Der Absatz
:das-bedeutet: So erkennst du auf einen Blick, welcher Absatz über welche Auftragsherkunft erfolgt. Differenziert wird zusätzlich nach Erstellungsdatum der Aufträge.
...
:kennzahl: Der Absatz
:das-bedeutet: So erkennst du auf einen Blick, welcher Absatz für welche Kategorieerfolgt. Differenziert wird zusätzlich nach Erstellungsdatum der Aufträge.
...
:kennzahl: Der Absatz
:das-bedeutet: So erkennst du auf einen Blick, welcher Absatz über welches Lager erfolgt. Differenziert wird zusätzlich nach Erstellungsdatum der Aufträge.
...
:kennzahl: Der Absatz
:das-bedeutet: So erkennst du auf einen Blick, welcher Absatz über welchen Mandanten erfolgt. Differenziert wird zusätzlich nach Erstellungsdatum der Aufträge.
...
:kennzahl: Der Absatz
:das-bedeutet: So erkennst du auf einen Blick, welcher Absatz für welchen Hersteller erfolgt. Differenziert wird zusätzlich nach Erstellungsdatum der Aufträge.
...
:kennzahl: Der Absatz
:das-bedeutet:  So erkennst du auf einen Blick, wie der Absatz durch Retourengründe beeinflusst wird. Differenziert wird zusätzlich nach Erstellungsdatum der Aufträge.
...
:kennzahl: Der Absatz
:das-bedeutet: So erkennst du auf einen Blick, welcher Absatz über welche Zahlungsart erfolgt. Differenziert wird zusätzlich nach Erstellungsdatum der Aufträge.
...
:kennzahl: Der Absatz
:das-bedeutet: So erkennst du auf einen Blick, welcher Absatz über welche Auftragsherkunft erfolgt. Differenziert wird zusätzlich nach dem Datum, an dem einem Auftrag eine Zahlung zugeordnet wurde.
...
:kennzahl: Der Absatz
:das-bedeutet: So erkennst du auf einen Blick, welcher Absatz über welches Lager erfolgt. Differenziert wird zusätzlich nach dem Datum, an dem einem Auftrag eine Zahlung zugeordnet wurde.
...
:kennzahl: Der Absatz
:das-bedeutet: So erkennst du auf einen Blick, welcher Absatz über welchen Mandant erfolgt. Differenziert wird zusätzlich nach dem Datum, an dem einem Auftrag eine Zahlung zugeordnet wurde.
...
:kennzahl: Der Absatz
:das-bedeutet: So erkennst du auf einen Blick, welcher Absatz über welche Auftragsherkunft erfolgt. Differenziert wird zusätzlich nach dem Datum, an dem die Waren für die Aufträge versandt wurden.
...
:kennzahl: Der Absatz
:das-bedeutet: So erkennst du auf einen Blick, welcher Absatz über welches Lager erfolgt. Differenziert wird zusätzlich nach dem Datum, an dem die Waren für die Aufträge versandt wurden.
...
:kennzahl: Der Absatz
:das-bedeutet: So erkennst du auf einen Blick, welcher Absatz über welchen Mandant erfolgt. Differenziert wird zusätzlich nach dem Datum, an dem die Waren für die Aufträge versandt wurden.
...
_Beachte_, dass die Auftragspositionen in Gutschriften und Retouren vom Absatz abgezogen werden, wenn du diese Auftragstypen auswählst.
