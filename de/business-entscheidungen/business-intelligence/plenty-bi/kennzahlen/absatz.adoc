...
Wähle zusätzlich eine <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/umsatz#200, Dimension>> um festzulegen, wie das Ergebnis aufgeschlüsselt werden soll.
Setze außerdem <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/umsatz#300, Filter>> um zu konkretisieren, nach welchen Kriterien der Absatz berechnet werden soll.
...
:kennzahl: Der Absatz
:das-bedeutet: Das bedeutet, dass beim Zusammenzählen der Auftragspositionen Gutschriften und Retouren nicht abgezogen werden, wenn diese im Filter *Auftragstyp* aktiviert sind.
...
:kennzahl: Der Absatz
:das-bedeutet: Das bedeutet, dass beim Zuzsammenzählen der Auftragspositionen Gutschriften und Retouren nicht eingerechnet werden, wenn diese im Filter *Auftragstyp* aktiviert sind.
