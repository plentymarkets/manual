...
Du entscheidest im Bereich <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/absatz#100, Berechnung>>, ob der Brutto-Absatz oder der Netto-Absatz berechnet wird.
Wähle zusätzlich eine <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/absatz#200, Dimension>> um festzulegen, wie das Ergebnis aufgeschlüsselt werden soll.
Setze außerdem <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/absatz#300, Filter>> um zu konkretisieren, nach welchen Kriterien der Absatz berechnet werden soll.
...
:kennzahl: Der Absatz
:das-bedeutet: Das bedeutet, dass beim Zuzsammenzählen der Auftragspositionen Gutschriften und Retouren nicht eingerechnet werden, wenn diese im Filter *Auftragstyp* ausgewählt sind.
...
:kennzahl: Der Absatz
:das-bedeutet: So erkennst du auf einen Blick, wie viel Ware aufgeschlüsselt nach Retourengründen verkauft wird. Differenziert wird zusätzlich nach Erstellungsdatum der Aufträge.
