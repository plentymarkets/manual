...
plentymarkets berechnet den Absatz, indem die Menge der Auftragspositionen in den Aufträge zusammengerechnet wird: +
_Menge + Menge + ... = Absatz_ +
Wähle zusätzlich <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/absatz#400, Dimensionen>> und <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/absatz#500, Filter>>, um zu konkretisieren, nach welchen Kriterien der Absatz berechnet werden soll.
