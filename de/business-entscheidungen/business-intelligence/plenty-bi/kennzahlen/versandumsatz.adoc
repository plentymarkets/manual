...
Wähle zusätzlich eine <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/versandumsatz#100, Dimension>> um festzulegen, wie das Ergebnis aufgeschlüsselt werden soll.
Setze außerdem <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/versandumsatz#200, Filter>> um zu konkretisieren, nach welchen Kriterien der Versandumsatz berechnet werden soll.
