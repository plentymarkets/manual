...
_Versandkosten + Versandkosten + ... = Versandumsatz_ +
Du entscheidest im Bereich <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/versandumsatz#300, Berechnung>>, ob der Brutto-Versandumsatz oder der Netto-Versandumsatz berechnet wird.
...
Wähle zusätzlich <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/versandumsatz#400, Dimensionen>> und <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/versandumsatz#500, Filter>>, um zu konkretisieren nach welchen Kriterien der Versandumsatz berechnet werden soll.
