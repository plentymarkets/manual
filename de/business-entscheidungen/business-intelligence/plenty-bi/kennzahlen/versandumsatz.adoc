...
Setze außerdem <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/umsatz#200, Filter>> um zu konkretisieren, nach welchen Kriterien der Versandumsatz berechnet werden soll.
