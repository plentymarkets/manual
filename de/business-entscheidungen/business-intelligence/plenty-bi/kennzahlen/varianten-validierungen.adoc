...
Mit der Kennzahl *{kennzahl}* prüfst du, ob Varianten, die für einen Marktplatz aktiviert sind, bestimmte Regeln des Marktplatzes erfüllen und an den Marktplatz exportiert werden können.
...
Bei der Validierung werden die folgenden Regeln geprüft:
