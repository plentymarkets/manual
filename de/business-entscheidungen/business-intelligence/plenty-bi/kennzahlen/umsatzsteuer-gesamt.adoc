...
plentymarkets berechnet die Umsatzsteuer gesamt, indem die Nettopreise von den jeweiligen Bruttopreisen abgezogen werden. Diese Ergebnisse werden summiert. Wähle zusätzlich <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/umsatzsteuer-gesamt#400, Dimensionen>> und <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/umssatzsteuer-gesamt#500, Filter>>, um zu konkretisieren nach welchen Kriterien die Umsatzsteuer gesamt berechnet werden soll.
