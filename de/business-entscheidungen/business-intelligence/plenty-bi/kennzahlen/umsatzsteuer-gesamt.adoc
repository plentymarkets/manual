...
_∑ Steuersatz = Umsatzsteuer gesamt_ +
Wähle zusätzlich <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/umsatzsteuer-gesamt#100, Dimensionen>> und <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/umssatzsteuer-gesamt#200, Filter>>, um zu konkretisieren, nach welchen Kriterien die Umsatzsteuer gesamt berechnet werden soll.
