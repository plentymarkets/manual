...
Du entscheidest im Bereich <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/retourenquote#100, Berechnung>>, ob die Retourenquote oder Retourenquote Umsatz berechnet wird.
Wähle zusätzlich <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/retourenquote#200, Dimensionen>> und <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/retourenquote#300, Filter>>, um zu konkretisieren nach welchen Kriterien die Retourenquote berechnet werden soll. Beachte, dass beim Filtern die Auftragstypen Gutschrift und Retoure aktiviert werden müssen.
