...
Setze außerdem <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/umsatz#300, Filter>> um zu konkretisieren, nach welchen Kriterien die Retourenquote berechnet werden soll.
