...
Du entscheidest im Bereich <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/retourenquote#100, Berechnung>>, ob die Retourenquote oder Retourenquote Umsatz berechnet werden soll.
Wähle zusätzlich eine <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/retourenquote#200, Dimension>> um festzulegen, wie das Ergebnis aufgeschlüsselt werden soll.
Setze außerdem <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/retourenquote#300, Filter>> um zu konkretisieren, nach welchen Kriterien die Retourenquote berechnet werden soll.
...
Die Retourenquote wird wie in der Einleitung beschrieben berechnet: Die Anzahl der Gutschriften und Retouren wird durch die Anzahl der Aufträge geteilt, die nicht vom Typ Gutschrift oder Retoure sind. Beachte, dass du den Filter Auftragstyp mit der Auswahl Gutschrift und Retoure setzen musst.

=== Retourenquote Umsatz

Der Umsatz der Retourenquote wird berechnet, indem die Bruttobeträge von allen Gutschriften und Retouren zusammengezählt werden und dann durch den Gesamtbruttobetrag aller anderen Auftragstypen geteilt wird: +
