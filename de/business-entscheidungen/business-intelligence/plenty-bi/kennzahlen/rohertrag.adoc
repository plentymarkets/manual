...
:position: 40
:url: business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/Rohertrag
:id: MYYD7IM
...
plentymarkets berechnet den Rohertrag, indem die Menge der Auftragspositionen mit dem jeweiligen Nettopreis abzüglich des Einkaufspreises multipliziert wird.
Wähle zusätzlich <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/rohertrag#400, Dimensionen>> und <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/rohertrag#500, Filter>>, um zu konkretisieren nach welchen Kriterien der Rohertrag berechnet werden soll.
...
:kennzahl: Der Rohertrag
:das-bedeutet: So erkennst du auf einen Blick, wie viel Rohertrag in welchem Rechnungsland differenziert nach Erstellungsdatum der Aufträge generiert wird.
...
:kennzahl: Der Rohertrag
:das-bedeutet: So erkennst du auf einen Blick, wie viel Rohertrag in welchem Lieferland differenziert nach Erstellungsdatum der Aufträge generiert wird.
...
:kennzahl: Der Rohertrag
:das-bedeutet: So erkennst du auf einen Blick, wie viel Rohertrag über welche Auftragsherkunft differenziert nach Erstellungsdatum der Aufträge generiert wird.
...
:kennzahl: Der Rohertrag
:das-bedeutet: So erkennst du auf einen Blick, wie viel Rohertrag welche Kategorie differenziert nach Erstellungsdatum der Aufträge generiert.
...
:kennzahl: Der Rohertrag
:das-bedeutet: So erkennst du auf einen Blick, wie viel Rohertrag über welches Lager differenziert nach Erstellungsdatum der Aufträge generiert wird.
...
:kennzahl: Der Rohertrag
:das-bedeutet: So erkennst du auf einen Blick, wie viel Rohertrag über welchen Mandanten differenziert nach Erstellungsdatum der Aufträge generiert wird.
...
:kennzahl: Der Rohertrag
:das-bedeutet: So erkennst du auf einen Blick, wie viel Rohertrag welcher Hersteller differenziert nach Erstellungsdatum der Aufträge generiert.
...
:kennzahl: Der Rohertrag
:das-bedeutet: So erkennst du auf einen Blick, wie der Rohertrag durch Retourengründe beeinflusst wird. Zudem wird nach Erstellungsdatum der Aufträge differenziert.
...
:kennzahl: Der Rohertrag
:das-bedeutet: So erkennst du auf einen Blick, wie viel Rohertrag mit welcher Zahlungsart differenziert nach Erstellungsdatum der Aufträge generiert wird.
...
:kennzahl: Der Rohertrag
:das-bedeutet: So erkennst du auf einen Blick, wie viel Rohertrag welche Auftragsherkunft generiert. Mit dem Zusatz Zahlungsdatum wird zusätzlich nach dem Datum, an dem einem Auftrag eine Zahlung zugeordnet wird, differenziert.
...
:kennzahl: Der Rohertrag
:das-bedeutet: So erkennst du auf einen Blick, wie viel Rohertrag über welches Lager generiert wird.  Mit dem Zusatz Zahlungsdatum wird zusätzlich nach dem Datum, an dem einem Auftrag eine Zahlung zugeordnet wird, differenziert.
...
:kennzahl: Der Rohertrag
:das-bedeutet: So erkennst du auf einen Blick, wie viel Rohertrag welcher Mandant generiert.  Mit dem Zusatz Zahlungsdatum wird zusätzlich nach dem Datum, an dem einem Auftrag eine Zahlung zugeordnet wird, differenziert.
...
:kennzahl: Der Rohertrag
:das-bedeutet: So erkennst du auf einen Blick, wie viel Rohertrag welche Auftragsherkunft differenziert nach Warenausgangsdatum generiert.
...
:kennzahl: Der Rohertrag
:das-bedeutet: So erkennst du auf einen Blick, wie viel Rohertrag über welches Lager differenziert nach Warenausgangsdatum generiert wird.
...
:kennzahl: Der Rohertrag
:das-bedeutet: So erkennst du auf einen Blick, wie viel Rohertrag welcher Mandant differenziert nach Warenausgangsdatum generiert.
