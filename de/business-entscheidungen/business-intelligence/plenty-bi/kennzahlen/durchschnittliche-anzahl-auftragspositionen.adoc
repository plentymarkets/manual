...
_(∑ Menge) : Auftragsanzahl = ø Anzahl der Auftragspositionen_ +
Wähle zusätzlich <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/durchschnitt-auftragspositionen#100, Dimensionen>> und <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/durchschnitt-auftragspositionen#200, Filter>>, um zu konkretisieren, nach welchen Kriterien die durchschnittliche Anzahl der Auftragspositionen berechnet werden soll.
