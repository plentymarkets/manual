...
Setze außerdem <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/umsatz#200, Filter>> um zu konkretisieren, nach welchen Kriterien die durchschnittliche Anzahl der Auftragspositionen berechnet werden soll.
