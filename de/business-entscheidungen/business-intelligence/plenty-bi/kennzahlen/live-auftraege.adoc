...
:position: 10
:url: business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/auftraege-live
:id: DXR4I10
...
Wähle zusätzlich eine <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/auftraege-live#200, Dimension>> um festzulegen, wie das Ergebnis aufgeschlüsselt werden soll.
Setze außerdem <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/auftraege-live#300, Filter>> um zu konkretisieren, nach welchen Kriterien die Aufträge berechnet und dargestellt werden sollen.
...
Die Auftragsanzahl wird in Echtzeit angezeigt. Die Daten werden live aus der Datenbank genommen. Es werden alle Auftragstypen angezeigt, wenn du den Filter *Auftragstyp* nicht setzt und keine Auswahl triffst.

=== Auftragsstatus, Auftrag

Es wird angezeigt, wie viele Aufträge sich in den verschiedenen Auftragsstatus befinden. Es werden alle Auftragsstatus angezeigt, wenn du den Filter *Auftragsstatus* nicht setzt und keine Auswahl triffst.
