...
Du entscheidest im Bereich <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/umsatz#300, Berechnung>>, ob mit Brutto-Preisen oder Netto-Preisen multipliziert wird.
...
:kennzahl: Der Umsatz
:das-bedeutet: Das bedeutet, dass die Anzahl der Auftragspositionen jeweils mit den entsprechenden Brutto-Preisen multipliziert wird. Angezeigt wird dir somit der Brutto-Umsatz.
...
:kennzahl: Der Umsatz
:das-bedeutet: Das bedeutet, dass die Anzahl der Auftragspositionen jeweils mit den entsprechenden Netto-Preisen multipliziert wird. Angezeigt wird dir somit der Netto-Umsatz.
