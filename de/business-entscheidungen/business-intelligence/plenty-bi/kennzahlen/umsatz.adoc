...
Du entschiedest im Bereich <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/umsatz#300, Berechnung>>, ob mit Brutto-Preisen oder Netto-Preisen multipliziert wird.
So kannst du entweder den Brutto-Umsatz oder den Netto-Umsatz berechnen.
Wähle zusätzlich <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/umsatz#400, Dimensionen>> und <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/umsatz#500, Filter>>, um zu konkretisieren, nach welchen Kriterien der Umsatz berechnet werden soll.
...
:kennzahl: Der Umsatz
:das-bedeutet: Das bedeutet, dass die Anzahl der Auftragspositionen jeweils mit den entsprechenden Brutto-Preisen multipliziert wird. Angezeigt wird dir somit der Netto-Umsatz.
...
:kennzahl: Der Umsatz
:das-bedeutet: Das bedeutet, dass die Anzahl Auftragspositionen jeweils mit den entsprechenden Brutto-Preisen multipliziert wird. Angezeigt wird dir somit der Brutto-Umsatz.
