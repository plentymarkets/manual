...
Setze außerdem <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/umsatz#300, Filter>> um zu konkretisieren, nach welchen Kriterien der Umsatz berechnet werden soll.
