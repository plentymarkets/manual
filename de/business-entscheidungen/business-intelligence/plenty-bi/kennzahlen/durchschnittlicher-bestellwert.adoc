...
Wähle zusätzlich eine <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/umsatz#100, Dimension>> um festzulegen, wie das Ergebnis aufgeschlüsselt werden soll.
Setze außerdem <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/umsatz#200, Filter>> um zu konkretisieren, nach welchen Kriterien der durchschnittliche Bestellwert berechnet werden soll.
...
_Beachte_: Sind im Filter *Auftragstyp* auch Retouren und Gutschriften ausgewählt, werden die Preise aus diesen Auftragstypen abgezogen.
