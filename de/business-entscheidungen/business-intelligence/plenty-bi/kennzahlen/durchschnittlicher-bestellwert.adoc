...
:position: 50
:url: business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/durchschnittlicher-bestellwert
:id: CPZCUGB
...
plentymarkets berechnet den durchschnittlichen Bestellwert, indem die Menge der Auftragspositionen mit dem jeweiligen Preisen multipliziert wird.
Dieses Ergebnis wird dann durch die Anzahl der Aufträge geteilt.
Wähle zusätzlich <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/durchschnittsbestellwert#400, Dimensionen>> und <<business-entscheidungen/business-intelligence/plenty-bi/kennzahlen/durchschnittsbestellwert#500, Filter>>, um zu konkretisieren nach welchen Kriterien der durchschnittliche Bestellwert berechnet werden soll.
...
_Beachte_, dass die Beträge von Gutschriften und Retouren vom durchschnittlichen Bestellwert abgezogen werden, wenn du diese Auftragstypen im Filter auswählst.
