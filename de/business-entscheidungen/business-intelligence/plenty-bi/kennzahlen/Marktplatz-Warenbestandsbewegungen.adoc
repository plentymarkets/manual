...
:kennzahl: Marktplatz Warenbestandsbewegungen
...
include::../reports/datenformate/marketplaceStockMovement.adoc[]
...
include::../../../_textblocks/plentyBI-calculation-type/warenstandsbewegungen.adoc[]
...
:das-bedeutet: Das bedeutet, dass die Daten sortiert nach dem Datum angezeigt werden, xxx.
