...
:daten: Warenbestandsbewegungen zu bestimmten Marktplätzen
...
Aktuell werden Warenbestandsbewegungen zu folgenden Marktplätzen gespeichert:
...
| VARCHAR NOT NULL
| ID
| Die einzigartige ID der Warenbestandsbewegung
...
| VARCHAR NOT NULL
| Kennzeichenwert
| Identifikatorwert des Datensatzes +
...
Im plentyBI-Tool können Warenbestandsbewegungen anhand dieses Kennzeichenwerts gefiltert werden.

| referrerId
| NUMERIC(5,2)
| Herkunfts-ID
| ID der Auftragsherkunft des Marktplatzes +
*_Hinweis:_* Zurzeit werden nur Warenbestandsbewegungen für den Marktplatz Amazon gespeichert.
