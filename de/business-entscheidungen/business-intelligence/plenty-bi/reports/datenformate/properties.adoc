...
:position: 163
:url: business-entscheidungen/business-intelligence/reports/datenformate/properties
:author: team-item
...
//|10
//|Die minimale Anzahl an Tagen, bis die generierte Rohdaten-Datei wieder vom Cloud-Speicher entfernt wird. Eine Weiterverarbeitung muss somit vorher erfolgen. Die genaue Dauer kann im Menü *Einrichtung » plentyBI » Rohdaten* definiert werden.

//|deleteRawDataAfterDaysMaximum
//|Maximale Anzahl an Tagen bis zur Löschung
//|60
//|Die maximal Anzahl an Tagen, bis die generierte Rohdaten-Datei wieder vom Cloud-Speicher entfernt wird. Eine Weiterverarbeitung muss somit vorher erfolgen. Die genaue Dauer kann im Menü *Einrichtung » plentyBI » Rohdaten* definiert werden.
