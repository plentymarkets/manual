= marketplaceVariationValidation
:lang: de
...
:datenformat: pass:quotes[*marketplaceVariationValidation*]
...
:spezifikationen: <<tabelle-spezifikationen-marketplaceVariationValidation>>
:datenspalten: <<tabelle-datenspalten-marketplaceVariationValidation>>
...
[[tabelle-spezifikationen-marketplaceVariationValidation]]
.Technische Spezifikationen des Formats *marketplaceVariationValidation*
[cols="1,1,1,3"]
|====
...
Dateiname: *marketplaceVariationValidation-xxx.csv.gz*
...
[[tabelle-datenspalten-marketplaceVariationValidation]]
.Datenspalten des Formats *marketplaceVariationValidation*
[cols="1,1,1,3"]
|====
