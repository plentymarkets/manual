...
//ToDo - add the external links to plentyMarketplace - chapter Plugin herunterladen und installieren
...
Das #<<Prohandel-Plugin>># steht kostenpflichtig auf plentyMarketplace zur Verfügung.
...
| *Lief.-Farbe*
|Welcher plentymarkets Attributwert passt zu deiner Prohandel-Lieferantenfarbe?
Wähle den Attributwert aus der Dropdown-Liste aus.

*_Voraussetzung_*: Hast du bereits <<artikel/einstellungen/attribute#, Attribute in plentymarkets konfiguriert>>?
Diese Dropdown-Liste enthält nur die Attributwerte, die bereits in plentymarkets vorhanden sind.

| *Größe*
|Welcher plentymarkets Attributwert passt zu deiner Prohandel-Größe?
Wähle den Attributwert aus der Dropdown-Liste aus.
...
//Frage an Team PM --> aktuell werden Artikel als inaktiv importiert. Wird sich das ändern? Falls ja, wisst ihr ungefähr wann?
...
Zum Beispiel:
.. Setze den Tag-Filter auf den im Assistant gewählten <<business-entscheidungen/prohandel#70, Tag für neu importierte Artikel>>.
...
* angeben, wo deine Produkte verkauft werden sollen, d.h. <<artikel/artikel-verwalten#340, Auftragsherkünfte>> und <<artikel/artikel-verwalten#340, Mandanten>> aktivieren.
