...
| //TODO: Beschreibung ergänzen / Meeting
...
//TODO: Beschreibung ergänzen / Meeting
Das einfache Säulendiagramm erlaubt dir, auf einen Blick die Werte zwei verschiedener Kennzahlen zu sehen. Jeder der beiden Werte wird in nebeneinander platzierten Säulen dargestellt.
...
Die verfügbaren Optionen für das einfache Säulendiagramm sind identisch mit den des regulären Säulendiagramms. Es handelt sich lediglich um eine vereinfachte Form der Darstellung. Die Erläuterungen zu den einzelnen Optionen kannst du im <<#721, vorherigen Kapitel>> nachlesen.
...
Das Fortschritsdiagramm stellt mehrere Kennzahlen als Teilstücke eines einzigen Balkens dar. Somit kannst du anschaulich die Anteile mehrere Kennzahlen darstellen und die Größenverhältnisse der verschiedenen Werte auf einen Blick kenntlich machen.
...
| *Titel*
| Gib einen aussagekräftigen Titel ein. Der Titel wird als Name auf dem  Fortschrittsdiagramm angezeigt. Klicke auf (icon:preview[role="skyBlue"]), wenn der Titel überhaupt nicht angezeigt werden soll.
