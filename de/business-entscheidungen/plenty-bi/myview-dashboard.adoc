...
. Platziere die gewünschten Elemente in der Ansicht.
. *Speichere* icon:save[set=plenty] die Einstellungen. +
...
| *Titel*
| Gib einen aussagekräftigen Titel ein. Der Titel wird als Name auf der Kachel angezeigt. Klicke auf icon:preview[role="blue"], wenn der Titel nicht auf der Kachel angezeigt werden soll.
...
| *Titel*
| Gib einen aussagekräftigen Titel ein. Der Titel wird als Name auf dem Tortendiagramm angezeigt. Klicke auf icon:preview[role="blue"], wenn der Titel nicht auf dem Tortendiagramm angezeigt werden soll.
...
<<willkommen/login-rundgang#notification-center, Benachrichtigungen>> beinhalten wichtige Informationen über dein plentymarkets System. Dazu findest du am oberen Rand des plentymarkets Backend ein Glockensymbol. Klickst du auf dieses, werden dir aktuelle Benachrichtigungen angezeigt. Benachrichtigungen werden beim erstmaligen Öffnen des Dashboards und beim Anlegen jeder neuen Dashboard-Ansicht bereits standardmäßig angezeigt. Gehe wie unten beschrieben vor, falls du diesen Bereich entfernt hast und ihn wieder anzeigen möchtest.
