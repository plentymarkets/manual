...
//TODO: Evtl. in längere Anleitung inkl. Tabelle auslagern? Gibt es nur den Typ "Link öffnen"? Wie viele Shortcuts lassen sich maximal zur Kachel hinzufügen?

| *Link zu detaillierter Dashboard-Ansicht*
| Wähle, welche bereits angelegte Dashboard-Ansicht geöffnet werden soll, wenn du an der Kachel auf *Aktionen* icon:more_vert[set=material, role=blue] klickst und die Option *Details zur Kachel* wählst. Wählst du die Option *Keine*, wird beim Klick auf *Details zur Kachel* eine vom System vorgegebene Standard-Ansicht geöffnet. Diese enthält weitere Details zum Ergebnis und den Daten der Kennzahl, die als Grundlage für die Kachel gewählt wurde.

| *Parameter für Detailansicht*
| Hast du dich bei der Einstellung *Link zu detaillierter Dashboard-Ansicht* für die Option *Keine* entschieden? Dann kannst du hier festlegen, nach welchen Kriterien die Standard-Ansicht eingegrenzt wird.
// TODO: Rücksprache mit DB halten (Detailansicht war früher in einem Standardformat; jetzt kann es durch Parameter eingegrenzt werden. Welche Parameter gibt es? Unterscheiden sich pro Kennzahl.) --> Parameter haben keinen Einfluss auf das Standard Detail Ding, also wenn man darüber "Keine" wählt, wird auch nix gefiltert. Diese Einstellung filtert das individuell ausgesuchte Dashboard. Funktioniert noch nicht richtig, daher erstmal nur grob beschreiben
...
. Wähle aus, welche Aktion du für das Diagramm ausführen möchtest. <<tabelle-zusatz-optionen-diagramme>> erläutert die verfügbaren Optionen.

[[tabelle-zusatz-optionen-diagramme]]
[width="100%"]
[cols="1,3"]
|====
|Option |Erläuterung
...
| *Rohdaten*
|
// TODO: bereits bei DB angesprochen; eigentlich müsste die Option "Kennzahl" heißen. 
Antwort: Daneben steht immer der Titel der Kennzalkonfiguration, die ja auf Basis der Rohdaten die Ergebnisse der Kennzahl berechnet. "Rohdaten" ist hier also nur ein grober Überbegriff
...
| *Shortcut Typ*
|Gib an, welche Aktion beim Klick auf die Schaltfläche ausgeführt werden soll. Aktuell steht nur die Option *Link öffnen* zur Verfügung. //TODO: Dashboard öffnen gibt es jetzt auch
