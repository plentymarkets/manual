...
====
Damit ein Beitrag in deinem Dashboard angezeigt wird, muss er bei der Erstellung entweder mit der Markierung *important* versehen oder global angepinnt worden sein. Stelle sicher, dass du für weitere Informationen, die in Bezug auf andere Module für dich relevant sind, auch die jeweilige Kategorie des Teams oder des Moduls abonnierst.
====