...
- linke Seite repräsentiert den Wert der Kennzahl, je nach Wert größer
- kann um 90 Grad gedreht werden
- wie passt ein Wert zum anderen?
- Use case: Woche pro Woche Werte einer Kennzahl
- Mehrere Kennzahlen einbinden
