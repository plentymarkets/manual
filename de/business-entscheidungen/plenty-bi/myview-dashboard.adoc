...
| Aktiviere diese Option, um zusätzlich zu den Säulen eine Linie im Diagramm anzuzeigen, die die Durchschnittswerte darstellt. Die Durchscnittswerte berechnen sich aus den Ergebnissen der Kennzahlen, die zur Darstellung im Diagramm ausgewählt wurden. *_Hinweis:_* Diese Option ist nur vorhanden, wenn du mehr als eine Kennzahl für die Darstellung im Säulendiagramm ausgewählt hast.
