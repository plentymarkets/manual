...
Füge zunächst <<#420, wie oben beschrieben>> ein *Säulendiagramm* oder ein *Liniendiagramm* hinzu. Gehe danach wie folgt vor, um individuelle Einstellungen für die Diagramme vorzunehmen.
...
Füge zunächst <<#420, wie oben beschrieben>> ein Tacho-Diagramm hinzu. Gehe danach wie folgt vor, um individuelle Einstellungen für das Tacho-Diagramm vorzunehmen.
