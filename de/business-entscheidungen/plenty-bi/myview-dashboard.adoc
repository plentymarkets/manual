...
Zusätzlich zur Darstellung von Daten in Form von Kacheln, Tabellen, Diagrammen und Zeilen lassen sich weitere Informationen innerhalb der Elemente auf dem Dashboard darstellen. 
