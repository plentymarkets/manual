...
Kennzahlen legst du entweder im Menü Menü *Einrichtung » plentyBI » Kennzahlen* oder direkt aus dem Dashboard heraus an. Im Folgenden werden beide Vorgehensweisen erklärt.
