...
// TODO: Rücksprache mit DB halten (Detailansicht war früher in einem Standardformat; jetzt kann es durch Parameter eingegrenzt werden. Welche Parameter gibt es? Unterscheiden sich pro Kennzahl.)
