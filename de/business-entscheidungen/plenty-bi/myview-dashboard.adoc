...
Formartierter Text bietet dir die Möglichkeit, Informationen in Textform im Dashboard darzustellen. 
...
. Klicke an dem Element, in dem Text dargestellt werden soll, auf *Bearbeiten* icon:edit[set=plenty]. +
→ Das Einstellungsmenü öffnet sich.
...
. *Speichere* icon:save[set=plenty] die Einstellungen. +
→ Der Text wird permanent im Element dargestellt.
