...
| Hast du bei der Einstellung *Link zu detaillierter Dashboard-Ansicht* eine bereits existierende Dashboard-Ansicht ausgewählt Dann kannst du hier festlegen, nach welchen Kriterien diese Ansicht eingegrenzt wird. Klicke auf *Parameter-Konfiguration* icon:icon-settings[role=darkGrey], um eine oder mehrere Kriterien festzulegen. Je nach der Kennzahl, die auf der Kachel dargestellt wird, stehen die Parameter *Lieferland*, *Benutzer* oder *Nachrichten-Tag* zur Verfügung.
...
. Wähle aus, welche Aktion du für das Diagramm ausführen möchtest. <<tabelle-optionen-diagramme>> erläutert die verfügbaren Optionen.

[[tabelle-optionen-diagramme]]
[width="100%"]
[cols="1,3"]
|====
|Option |Erläuterung
...
| *Shortcut Typ*
|Gib an, welche Aktion beim Klick auf die Schaltfläche ausgeführt werden soll. Die OPtinen *Link öffnen* und *Dashboard öffnen* stehen zur Verfügung.
...
| *Dashboard öffnen*
| Wähle aus der Dropdown-Liste ein Dashboard aus, das beim Klick auf die Schaltfläche geöffnet werden soll. *_Wichtig:_* Das Dashboard muss bereits existieren und Benutzer:innen müssen über die erforderlichen <<#408, Rechte zur Ansicht>> verfügen, um alle benötigten Dashboards sehen und auswählen zu können.
