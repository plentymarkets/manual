...
*_Wichtig:_* Das Dashboard muss bereits existieren und Benutzer:innen müssen über die erforderlichen <<#408, Rechte zur Ansicht>> verfügen, um alle benötigten Dashboards sehen und auswählen zu können.
