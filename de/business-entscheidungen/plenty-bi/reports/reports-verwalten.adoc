...
====
Rohdaten stellen in plentymarkets die Datengrundlage für die Kennzahlen bereit, die im Modul <<business-entscheidungen/plenty-bi#, plentyBI>> zur Verfügung stehen. Je nach gebuchtem plentyBI-Tarif werden Rohdaten unterschiedlich lang im System gespeichert und vorgehalten. 
