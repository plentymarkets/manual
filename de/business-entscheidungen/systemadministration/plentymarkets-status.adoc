...
. Klicke auf *plentymarkets Status*. +
→ Die Ansicht *plentymarkets Status abonnieren* wird geöffnet.
. Klicke auf die Schaltfläche *plentymarkets Status abbestellen* (icon:toggle-off[role="green"]). +
