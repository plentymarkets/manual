...
Wie du plentymarkets Status abbestellst, ist im Kapitel <<business-entscheidungen/systemadministration/plentymarkets-status#plentymarkets-status-abbestellen, plentymarkets Status abbestellen>> beschrieben.
...
====
Wenn du deine E-Mail-Adresse im Benutzerkonto geändert hast, ist es notwendig, dass du plentymarkets Status wie oben beschrieben einmal <<business-entscheidungen/systemadministration/plentymarkets-status#plentymarkets-status-abbestellen,  abbestellst>> und anschließend erneut <<business-entscheidungen/systemadministration/plentymarkets-status#plentymarkets-status-abonnieren, abonnierst>>. +
