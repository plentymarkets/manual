...
* Verlängerung:
** verlängert sich nicht automatisch
** sollte nach Ende der Laufzeit (mindestens 1 Jahr) <<business-entscheidungen/systemadministration/ssl-zertifikat_bestellen#1300, verlängert werden>>.
...
//** Wird ein EV SSL-Zertifikat vom Browser erkannt, färbt sich die Adressleiste grün. Außerdem werden der Organisationsname und die Zertifizierungsstelle neben der URL angezeigt.
* Gültigkeitsdauer:
** 1 Jahr
* Bestellung:
...
//falls es irgendwann technisch geht, könnte man die Berechnungsgrundlage mit Tooltips anzeigen statt in 2 discrete Kapitel
...
[discrete]
===== Sectigo
Für das Bereitstellen des SSL-Zertifikates wird eine *mtl. Gebühr in Höhe 1,68 € netto zzgl. der Kosten des SSL-Zertifikats und eine einmalige Einrichtungsgebühr* erhoben.
////
...
|===
|Zertifikat    |Berechnung^1^   | Jährliche Kosten^2^
|AlwaysOn DV 6 Monate | (6*2) + 0 + 0   | 24,- €
|COMODO DV 2 Jahre | (24*2) + 59,50 + 0 | 53,75 €
|COMODO DV 1 Jahr  | (12*2) + 35,70 + 0   | 59,70 €
|Sectigo OV 1 Jahr | (12*2) + 118,80 + 29 | 171,80 €
|Sectigo EV 1 Jahr | (12*2) + 348 + 99 | 471,- €
|===
[.small]#1. (Laufzeit * monatliche Gebühr) + Kosten des SSL-Zertifikats + Einrichtungsgebühr# +
[.small]#2. Alle Preise sind in netto angegeben.#
...
OV- und EV-Zertifikate (Sectigo) werden im Assistenten bestellt.
...
DV-Zertifikate (AlwaysOn und COMODO) werden im Einrichtungsmenü bestellt.
