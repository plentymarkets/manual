...
//zukünftig wird AlwaysOn nur noch eine Laufzeit von 2-3 Monate haben
...
Oder klicke auf *Neue Konfiguration* (icon:plus[role="green"]).
...
[#1280]
=== Veraltet: Bestellung im Einrichtungsmenü

[IMPORTANT]
.Dieses Menü ist veraltet und wird bald entfernt werden
====
Wir raten davon ab, SSL-Zertifikate im Einrichtungsmenü zu bestellen.
Das Menü ist veraltet und wird bald entfernt werden.
Zudem können nur DV-Zertifikate im Einrichtungsmenü bestellt werden.
Daher empfehlen wir, SSL-Zertifikate <<business-entscheidungen/systemadministration/ssl-zertifikat_bestellen#1220, mit Hilfe des Assistenten>> zu bestellen.
====
...
[.collapseBox]
.*Wie lange dauert es, bis mein DV Zertifikat ausgestellt wird?*
--
...
Dies bedeutet, dass das Zertifikat erfolgreich bestellt wurde und in ca. 2-3 Minuten aktiv sein sollte.

Wenn du eine Fehlermeldung im Assistenten erhältst oder dein SSL-Zertifikat nach ca. 2-3 Minuten nicht ausgestellt wird, wende dich bitte an das link:https://forum.plentymarkets.com/c/core[plenty-Core-Team im Forum]{nbsp}icon:external-link[].

--

[.collapseBox]
.*Ich erhalte eine Fehlermeldung im Assistenten. Was soll ich tun?*
--

Wenn du eine Fehlermeldung im Assistenten erhältst, wende dich bitte an das link:https://forum.plentymarkets.com/c/core[plenty-Core-Team im Forum]{nbsp}icon:external-link[].
