...
//add this url weiterleitung /basics/admin-aufgaben/plentymarkets-konto/;/business-entscheidungen/systemadministration/domains/;301;L
...
* Kostenloses SSL-Zertifikat von link:https://letsencrypt.org[Let’s Encrypt^]{nbsp}icon:external-link[] mit automatischer Verlängerung, monatlich kündbar.
...
Um statische Inhalte deines Webshops, wie zum Beispiel Artikelbilder, jederzeit möglichst schnell anzeigen zu können, werden diese Inhalte für eine gewisse Zeit im Cache vorgehalten. Aus diesem Grund sind Änderungen, zum Beispiel eines Bildes, nach dem Upload nicht sofort sichtbar, sondern erst nach einer Verzögerung von bis zu 1 Stunde. Beachte auch unseren link:https://www.plentymarkets.eu/blog/Im-Rollout-Mehr-Geschwindigkeit-bei-durchgehender-SSL-Verschluesselung/b-1207/[Blog-Beitrag]{nbsp}icon:external-link[] zu diesem Thema.
...
Im Menü *plentymarkets Logo (Start) » Umzug* beauftragst du einen kostenlosen Umzug deines Systems in eine andere Cloud. Im Menü *Umzug* werden außerdem der Status eines bereits geplanten Umzugs und Informationen zum zuletzt durchgeführten Umzug aufgeführt. Weitere Informationen zu den link:http://www.plentymarkets.eu/produkt/cloud-hosting/[Cloud-Lösungen von plentymarkets]{nbsp}icon:external-link[] findest du auf unserer Website.
...
* Du verfügst über einen aktuellen plentymarkets Cloud Vertrag. Wenn du keinen plentymarkets Cloud Vertrag hast, passe deinen link:http://www.plentymarkets.eu/preise/plentymarkets-classic-buchen/[Vertrag]{nbsp}icon:external-link[] an.
