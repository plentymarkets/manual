...
:id: 8NSQ6X6
:author: team-cloud
//zuletzt aktualisiert am 14.12.20

//nach plenty-Website Relaunch, bau einen Link zum Enterprise-Seite ein
...
Diese Option steht Händlern mit einem *ENTERPRISE-Tarif* zur Verfügung.
...
====
Dieses Menü steht lediglich Händlern mit einem ENTERPRISE-Tarif zur Verfügung.
Wenn du einen anderen Tarif hast, dann wirst du dieses Menü in deinem System nicht sehen.
Prüfe die Angaben auf deiner plentymarkets Rechnung, wenn du dir nicht sicher bist, welchen Tarif du hast.
====
...
//der genaue Zeitrum steht noch nicht fest - frag bei Cloud nach wann der Fallback greift
//die Benachrichtigung ist zur Zeit geplant aber nicht umgesetzt - frag bei Cloud, ob das tatsächlich im Voraus passiert
Updates können nicht ewig verschoben werden.
Nach 4 Wochen wird dein System automatisch aktualisiert.
Verwendest du also eine Version, die älter als 4 Wochen ist, dann wird dein System automatisch aktualisiert.
Du wirst im Voraus über das automatische Update informiert.
...
Einzelne Mandanten werden nicht aufgeführt.
