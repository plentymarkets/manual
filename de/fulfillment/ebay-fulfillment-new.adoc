...
Im Schritt *Status: Outbound-Aufträge senden/stornieren* kannst du zwei Status speichern: ein Status für Outbound-Aufträge, die an eBay Fulfillment by Orange Connex versendet werden können und ein Status für Outbound-Aufträge, die erfolgreich an eBay Fulfillment by Orange Connex versendet wurden, aber die du wieder stornieren möchtest.
