...
// dieses Kapitel dann unter den neuen Bereich "Einstellungen im Assistenten" packen.

Im Schritt *Datenübertragung und Lagereinstellungen* des Assistenten kannst du ein neues Lager erstellen oder ein bereits bestehendes wählen. Wenn du hier ein neues Lager erstellst, wird automatisch der Typ *Sales* gewählt und alle Auftragsherkünfte werden für dieses Lager aktiviert. Der Name des Lagers ist _eBay Fulfillment_. Es ist nicht notwendig, ein zweites Lager zu erstellen.
