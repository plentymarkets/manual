...
Im ersten Schritt des Assistenten authentifizierst du dich für die Nutzung von eBay Fulfillment by Orange Connex. Öffne die Webseite, indem du auf die Schaltfläche *Autorisieren* klickst. Gib dort deine Zugangsdaten ein.

// vom wem erhält der Händler die Zugangsdaten? eBay oder OC?    ...., die du von xxx erhalten hast.

Wenn du dann auf der Authentifizierungsseite die Schaltfläche *I agree* geklickt hast, erhältst du eine Meldung, dass die Authentifizierung erfolgreich war und du das Browser-Tab schließen und zum Assistenten zurückkehren kannst.
...
|Auftrag erfolgreich gesendet
|Wenn sich der Auftrag in diesem Status in deinem plentymarkets System befindet, war die Übertragung an Orange Connex erfolgreich.

|Auftrag abgelehnt
|Wenn sich der Auftrag in diesem Status in deinem plentymarkets System befindet, wurde der Auftrag von Orange Connex abgelehnt. +
Ein Grund dafür könnten fehlende Daten am Artikel sein.

|Auftrag storniert
|Wenn sich der Auftrag in diesem Status in deinem plentymarkets System befindet, hat Orange Connex die Stornierung des Auftrags akzeptiert.

|Auftrag Ausnahme
|Wenn sich der Auftrag in diesem Status in deinem plentymarkets System befindet, wurde der Auftrag nachträglich abgelehnt. Das bedeutet, zunächst hat Orange Connex den Auftrag akzeptiert und später dann doch abgelehnt.
// Beispielgrund ergänzen
