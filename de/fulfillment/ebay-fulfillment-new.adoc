...
====
Wenn du bereits die eBay Fulfillment-Lösung mit Fiege nutzt, ist es wichtig, dass du die korrekte Auftragsherkunft *eBay Fulfillment* _mit der höheren ID_ wählst.
====
...
Im Schritt *Auftragsstatus* des Assistenten *eBay Fulfillment* speicherst du die Status für die Outbound-Aufträge. Du kannst entweder bestehende Status wählen oder neue Status erstellen.

Wenn du einen bestehenden Status wählst, stelle sicher, dass dieser Status in keinem Prozess und in keiner  Ereignisaktion verwendet wird. Andernfalls könnte dies zu Fehlern führen.
