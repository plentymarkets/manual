...
====
Wenn du bereits die eBay Fulfillment-Lösung mit Fiege nutzt, ist es wichtig, dass du die korrekte Auftragsherkunft für *eBay Fulfillment* aktivierst. Dies ist die Herkunft _mit der höheren ID_.
====
...
// weitere Länder aus der Liste des eBay-Handbuchs (Seite 83) hinzufügen?!
...
Sobald du dich einmal erfolgreich registriert hast, ist der Schritt *Authentifizierung* nicht mehr sichtbar, wenn du den Assistenten das nächste Mal öffnest.
...
. Gib einen Namen ein, z.B. _eBay Fulfillment Outbound_ ein.
...
// müssen hier in der EA dann auch alle Lieferländer aktiviert werden, die eBay FF by OC bedient?
