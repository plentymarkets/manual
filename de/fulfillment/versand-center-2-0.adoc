...
*_Hinweis:_* In der Übersicht wird vor dem Auftragsstatus die Farbe, die du im Menü *Einrichtung » Aufträge » Status* für die jeweiligen Status gespeichert hast, angezeigt. _Beispiele:_ icon:circle[role="red"] oder icon:circle[role="green"].
