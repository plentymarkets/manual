...
*_Hinweis:_* In der Übersicht wird vor dem Auftragsstatus die Farbe, die du im Menü *Einrichtung » Aufträge » Status* für die jeweiligen Status gespeichert hast, angezeigt. _Beispiel:_ icon:circle[role="red"].
