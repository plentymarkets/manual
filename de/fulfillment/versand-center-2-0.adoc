...
| *Land*
|Wähle ein Land, um nach Aufträgen in diesem Land zu suchen. +
...
*_Hinweis:_* In der Übersicht wird vor dem Auftragsstatus die Farbe, die du im Menü *Einrichtung » Aufträge » Status* für die jeweiligen Status gespeichert hast, angezeigt.
...
*_Hinweis:_* Lege die Reihenfolge der Filtervoreinstellungen per Drag-and-drop fest. Klicke auf icon:trash[role="darkGrey"], um eine Filtervoreinstellung zu löschen.
