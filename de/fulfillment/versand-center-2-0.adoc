...
Diese Handbuchseite beschreibt das neue Versand-Center 2.0, das im September 2021 in einer geschlossenen Betaphase veröffentlicht wurde. Geschlossene Betaphase bedeutet, dass das Versand-Center 2.0 zunächst von einer kleinen Personengruppe getestet wird. Sobald das Versand-Center 2.0 weiter ausgereift wurde und mögliche Fehler behoben wurden, wird die offene Betaphase beginnen.
