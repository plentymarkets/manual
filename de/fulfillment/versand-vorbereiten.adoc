...
*Lieferant aktiv* = Lieferländer mit dieser Eigenschaft stehen für die Einstellung als *Standardlieferland* im Menü <<webshop/webshop-einrichten/bestellvorgang#, Einrichtung » Mandant » Mandant wählen » Bestellvorgang » Einstellungen>> nicht zur Verfügung.

|*Lager*
|Lager wählen, das dem Lieferland als Hauptlager zugeordnet werden soll und z.B. in Aufträgen automatisch eingestellt sein soll. *ALLE* wählen, wenn alle Lager dem Lieferland zugeordnet werden sollen. In diesem Fall wird für Aufträge automatisch das Lager mit der kleinsten ID gewählt. Dazu auch die <<auftraege/auftraege-verwalten#, Lagereinstellungen>> im Menü *Einrichtung » Aufträge » Einstellungen* beachten.
...
|*Alternative E-Mail*
|Diese Einstellung ist nur sichtbar, wenn in der Dropdown-Liste *E-Mail und Telefon übertragen* die Option *Alternative übertragen* gewählt wurde. Alternative E-Mail-Adresse, die an den Dienstleister übertragen werden soll, eingeben.

|*Alternative Telefonnr.*
|Diese Einstellung ist nur sichtbar, wenn in der Dropdown-Liste *E-Mail und Telefon übertragen* die Option *Alternative übertragen* gewählt wurde. Alternative Telefonnummer, die an den Dienstleister übertragen werden soll, eingeben.
...
Wenn unter *Beschränkungstyp* die Einstellung *Maximum (Kubikmeter)* gewählt wurde, muss der Wert hier in m eingegeben werden.
...
|Aktivieren, um die SFTP-Verzeichnisstruktur von DHL Freight zu nutzen.
|====
...
[TIP]
.Retourenlabel aller verfügbaren Versanddienstleister als E-Mail-Anhang mit einer Ereignisaktion versenden
====
Mit der Einstellung *Retourenlabel* in der Dropdown-Liste *PDF-Anhang* in der E-Mail-Vorlage werden die Retourenlabel aller in plentymarkets eingebundenen Versanddienstleister – sei es über ein Plugin oder eine feste Integration – als E-Mail-Anhang versendet. Wenn du die E-Mail-Vorlage mit dieser Einstellung mit einer Ereignisaktion verknüpfst, geschieht der Versand der E-Mail-Vorlage bei Eintritt des Ereignisses automatisch.
====
...
[TIP]
.Assistent zum einfachen Einrichten von DHL Retoure Online
====
Kaufe das Plugin *DHL Retoure Online* kostenlos im plentyMarketplace und installiere es in einem Plugin-Set. Der *DHL Retoure Online*-Assistent ist dann im Menü *Einrichtung » Assistenten* sichtbar.
====
...
. Öffne das Menü *Einrichtung » Aufträge » Versand » Dienstleister » DPD Cloud Webservice*.
...
. Öffne das Menü *Einrichtung » Aufträge » Versand » Dienstleister » DPD DELISprint*.
...
|*Flex/Predict aktiv*
|Aktivieren, um bei DPD den kostenpflichtigen Vorankündigungsservice link:https://www.dpd.com/de/de/empfangen[Predict^] (ehemals Flexzustellung) anzumelden. In der CSV-Datei wird dann der Zusatz *PRO* ausgegeben.
|====
...
Eine Unterteilung in diese 2 Versandprofile ist sinnvoll, weil auch beim Versanddienstleister selbst sich die Preise für diese 2 Versandmöglichkeiten unterscheiden und so die Kosten an die Kunden weitergegeben werden können.
|====
...
. Öffne das Menü *Einrichtung » Aufträge » Versand » Dienstleister » MyDPD Business / iloxx*.
...
.Versandservices von NetDespatch (Royal Mail) in der Portotabelle einstellen
[cols="1,3"]
|====
|Einstellung |Erläuterung
...
Um den DHL-Postfinder zu nutzen, musst diu Einstellungen in mehreren Menüs vornehmen. Diese Einstellungen sind auf der Handbuchseite <<fulfillment/versand-vorbereiten#4600#, DHL-Postfinder>> zusammengefasst.
...
|*Schnittstelle aktiv*
|Option aktivieren, um die Schnittstelle zu aktivieren. Schnittstelle erst aktivieren, wenn die <<fulfillment/versand-vorbereiten#4900, Lager erstellt>> wurden.
...
|*Retourengründe*
|Retourengründe von DHL Fulfillment mit den im Menü <<auftraege/auftraege-verwalten#400, Einrichtung » Aufträge » Auftragstypen » Retoure>> angelegten Retourengründen verknüpfen.
|====
