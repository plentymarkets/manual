...
Wähle im Menü *System » Systemeinstellungen » Artikel » Einstellungen* das soeben erstellte Merkmal aus der Dropdown-Liste *Artikelmerkmal zur Alterssichtprüfung*. *Speichere* die Einstellungen.
