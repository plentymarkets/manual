...
====
Wenn Sie mit dem Erzeugen der Exportdokumente gleichzeitig den Warenausgang buchen möchten, können Sie das über eine Ereignisaktion im Menü *System » Aufträge » Ereignisse* erledigen. Weitere Informationen finden Sie auf der Handbuchseite <<automatisierung/ereignisaktionen#, Ereignisaktionen>>.
====
...
Zur Zuordnung legen Sie im Menü *System » Aufträge » Auftragsstatus* 2 <<auftraege/auftraege-verwalten#1200, Auftragsstatus>> für die an DHL Fulfillment übermittelten Aufträge an. Im Folgenden finden Sie 2 Beispiele:
...
Wenn die Retouren von DHL Fulfillment in Ihr plentymarkets System importiert werden sollen, benötigen Sie Retourengründe. Diese Retourengründe legen Sie im Menü <<auftraege/auftraege-verwalten#410, System » Aufträge » Auftragstypen » Retoure>> an. Verknüpfen Sie dann die von Ihnen konfigurierten Retourengründe mit den von DHL Fulfillment vorgegebenen Gründen im Menü *System » Aufträge » Versand » Fulfillment » DHL Fulfillment*.
...
|*Retourengründe*
|Retourengründe von DHL Fulfillment mit den im Menü <<auftraege/auftraege-verwalten#400, System » Aufträge » Auftragstypen » Retoure>> angelegten Retourengründen verknüpfen.
|====
...
Richten Sie anschließend das Versandprofil im Menü *System » Aufträge » Versand » Optionen » Tab: Versandprofile* ein. Wie Sie dazu vorgehen, ist im Kapitel <<fulfillment/versand-vorbereiten#1000, Versandprofil erstellen>> beschrieben.
