...
Um weitere Informationen zum Einrichten des DHL Shipping (Versenden)-Plugins zu erhalten, klicke im Folgenden auf *Plugin* (Standardauswahl). Um weitere Informationen zur alten Schnittstelle DHL Intraship/Versenden zu erhalten, klicke auf *Alte Integration*.
...
Um weitere Informationen zum Einrichten des DHL Retoure Online-Plugins zu erhalten, klicke auf *Plugin* (Standardauswahl). Um weitere Informationen zur alten Schnittstelle DHL Retoure Online zu erhalten, klicke auf *Alte Integration*.
...
+
--
Gehe wie im Folgenden beschrieben vor, um die alte Schnittstelle zu DHL Reoture Online einzurichten.
