...
| *Nachnahme*
|Option aktivieren, damit Kund:innen im Checkout in deinem plentyShop die Zahlungsart _Nachnahme_ wählen können. +
...
| *Paketstation aktiv*
|Option aktivieren, damit für deine Kund:innen in deinem plentyShop verbesserte Eingabemöglichkeiten für das Feld *Paketstation* verfügbar sind. +
...
| *Postfiliale aktiv*
|Option aktivieren, damit für deine Kund:innen im plentyShop verbesserte Eingabemöglichkeiten für das Feld *Postfiliale* verfügbar sind. +
*_Wichtig:_* Voraussetzung ist, dass die Plugins link:https://marketplace.plentymarkets.com/plugins/templates/Ceres_4697[Ceres^]{nbsp}icon:external-link[] und link:https://marketplace.plentymarkets.com/plugins/templates/IO_4696[IO^]{nbsp}icon:external-link[] installiert sind.

| *Einwilligung zur Datenübermittlung*
|Option aktivieren, damit in deinem plentyShop eine Checkbox angezeigt wird. Wenn deine Kund:innen diese Checkbox aktivieren, stimmen sie zu, dass ggf. die Telefonnummer und E-Mail-Adresse an den Versanddienstleister übertragen werden.
