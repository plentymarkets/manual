...
|*Name (Backend)*
|Name für das Versandprofil eingeben. Der Name wird nur im System angezeigtund ist nicht für Kunden sichtbar.
...
*_Beispiel_*: Versandgruppe A enthält die Versandprofile 1 und 2. Versandgruppe B enthält die Versandprofile 3 und 4. Wenn einem Artikel nun die Versandprofile 3 und 4 zugewiesen werden sollen, am Artikel im Tab *Global* im Bereich *Versandprofile* die Versandgruppe B aus der Dropdown-Liste wählen. +
...
*_Wichtig_*: Mindestens 2 Konten müssen angelegt sein, andernfalls ist diese Option nicht sichtbar. Weitere Informationen finden Sie im Kapitel <<fulfillment/versand-vorbereiten#1200, Tipps und Tricks: Versandkosten von Bestellungen über eBay>>.
