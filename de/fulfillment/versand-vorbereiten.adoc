...
====
Nutze über die Schnittstelle zum DHL Geschäftskundenportal die Funktion *Versenden*. Das Plugin *DHL Shipping (Versenden)* steht dir im link:https://marketplace.plentymarkets.com/plugins/integration/dhlshipping_4871[plentyMarketplace^] zur Verfügung.
