...
plentymarkets ermöglicht genau abgestimmte Versandprozesse, die in hohem Maß automatisiert ablaufen. Von der Verknüpfung der Artikel mit den Versandprofilen über die Versandanmeldung bis zur Ausgabe eines Versandlabels steuert Ihr plentymarkets System die gesamten Abläufe - und das besonders effizient mit den Prozessen des **<<tools/plentymarkets-client#, plentymarkets Client  >>**. Der anfängliche Konfigurationsaufwand zahlt sich durch eine reibungslose Abwicklung aus, die ein sorgfältig eingestelltes System ermöglicht.
...
**Lieferant aktiv** = Lieferländer mit dieser Eigenschaft stehen für die Einstellung als **Standardlieferland** im Menü **<<mandant-shop/standard/bestellvorgang/grundeinstellungen#, Einstellungen » Mandant (Shop) » Standard » Bestellvorgang » Grundeinstellungen  >>** nicht zur Verfügung.

|**Lager**
|Lager wählen, das dem Lieferland als Hauptlager zugeordnet werden soll und z.B. in Aufträgen automatisch eingestellt sein soll. **ALLE** wählen, wenn alle Lager dem Lieferland zugeordnet werden sollen. In diesem Fall wird für Aufträge automatisch das Lager mit der kleinsten ID gewählt. Dazu auch die <<auftraege/einstellungen/grundeinstellungen#, **Lagereinstellungen**  >> im Menü **Einstellungen » Aufträge » Grundeinstellungen** beachten.
...
__**Wichtig**__: Es müssen mindestens zwei Konten angelegt sein, andernfalls ist diese Option nicht sichtbar. Weitere Informationen finden Sie im Kapitel **<<fulfillment/versand-vorbereiten#1200, Tipps und Tricks: Versandkosten von Bestellungen über eBay >>**.
...
|**Treueprogramm**
|Ein oder mehrere Treueprogramme wählen. Die Treueprogramme können Sie mit <<multi-channel/ebay#6600, **eBay Plus** >> oder <<multi-channel/amazon#4200, **Amazon** >> verwenden. +
...
Erfahren Sie mehr über das Erstellen von Portotabellen und die <<fulfillment/versand-vorbereiten#1600, **Berechnungstypen** >> im folgenden Videotutorial:
...
.Template-Variablen
====
Zu den verschiedenen Berechnungstypen finden Sie <<cms-syntax/grundlagen/template-variablen#, **Template-Variablen**  >> im Menü <<cms-syntax/webdesign/itemview/container-itemviewsingleitem#, **CMS » Webdesign » Layout » ItemView » ItemViewSingleItem**  >>. Die Template-Variable **$Volumen** gibt dabei keine Maße zurück, sondern das Volumen in Kubikmeter.
====
...
====
Wenn ein Auftrag Artikel enthält, bei denen kein Versandprofil aktiviert wurde, wird das Standardversandprofil aus dem Standard-Webshop für die Artikel verwendet. Das Standardversandprofil wählen Sie im Menü <<mandant-shop/standard/bestellvorgang/grundeinstellungen#, **Einstellungen » Mandant (Shop) » Standard » Bestellvorgang » Grundeinstellungen**  >>. Wenn kein Standardversandprofil eingerichtet ist, wird das Versandprofil mit der höchsten Priorität verwendet.
====
...
|**<<fulfillment/versand-vorbereiten#2600, c.b.c. logistics >>**
...
====
Wenn Sie mit dem Generieren der Exportdokumente gleichzeitig den Warenausgang buchen möchten, können Sie das über eine Ereignisaktion im Menü **Einstellungen » Aufträge » Ereignisaktionen** erledigen. Weitere Informationen finden Sie auf der Handbuchseite **<<auftraege/einstellungen/ereignis-aktionen#, Ereignisaktionen  >>**.
====
...
Richten Sie nun eine **<<auftraege/einstellungen/ereignis-aktionen#, Ereignisaktion  >>** ein, um die Retourenetiketten automatisch zu erzeugen.
...
Wenn Sie erlauben, dass Kunden Retouren selbst anlegen können, stehen die <<auftraege/einstellungen/auftragstypen/retoure#, **Retourengründe**  >>, die Sie eingegeben haben, auch im **Mein-Konto**-Bereich zur Auswahl. +
...
Details zur Konfiguration des Postfinder finden Sie im Kapitel <<fulfillment/versand-vorbereiten#4600, **DHL-Postfinder einrichten** >>.
...
Mit dem DHL-Postfinder werden Ihren Kunden im Mein Konto-Bereich bei der <<cms/webdesign/webdesign-bearbeiten/bestellvorgang/kaufabwicklung#, **Kaufabwicklung**  >> anhand der Postleitzahl die in der Nähe liegenden Postfilialen und Packstation angezeigt. Ihre Kunden haben dann die Möglichkeit, die Auswahl direkt in die Lieferanschrift zu übernehmen.

Um den DHL-Postfinder zu nutzen, müssen Sie Einstellungen in mehreren Menüs vornehmen. Diese Einstellungen sind auf der Handbuchseite <<cms/webdesign/webdesign-bearbeiten/bestellvorgang/dhl-postfinder#, **DHL-Postfinder**  >> zusammengefasst.
...
====
Die Auftragsübergabe von mit <<payment/klarna#, **Klarna**  >> bezahlten Aufträgen an DHL Fulfillment ist noch nicht möglich. Es können nur Aufträge mit einem vorhandenen Rechnungsdokument an DHL Fulfillment übertragen werden. Klarna übermittelt die Rechnung jedoch erst nach Warenausgang an plentymarkets.
====
...
Zur Zuordnung legen Sie im Menü **Einstellungen » Aufträge » Auftragsstatus** zwei <<auftraege/einstellungen/auftragsstatus#, **Auftragsstatus**  >> für die an DHL Fulfillment übermittelten Aufträge an. Nachfolgend zwei Beispiele:
...
Wenn die Retouren von DHL Fulfillment in Ihr plentymarkets System importiert werden sollen, benötigen Sie Retourengründe. Diese Retourengründe legen Sie im Menü **<<auftraege/einstellungen/auftragstypen/retoure#, Einstellungen » Aufträge » Auftragstypen » Retoure  >>** an. Verknüpfen Sie dann die von Ihnen konfigurierten Retourengründe mit den von DHL Fulfillment vorgegebenen Gründen im Menü **Einstellungen » Aufträge » Versand » Fulfillment-Dienstleister » DHL Fulfillment**.
...
|Merkmalverknüpfung zur Übermittlung der Artikeleigenschaft an DHL Fulfillment. Details dazu im Abschnitt **<<fulfillment/versand-vorbereiten#5300, Merkmale an DHL Fulfillment übermitteln >>**.

|**Retourengründe**
|Retourengründe von DHL Fulfillment mit den im Menü **<<auftraege/einstellungen/auftragstypen/retoure#, Einstellungen » Aufträge » Auftragstypen » Retoure  >>** angelegten Retourengründen verknüpfen.
|====
...
Erstellen Sie dann im Menü **Einstellungen » Aufträge » Versand » Versandoptionen » Tab: Versanddienstleister** den Fulfillment-Dienstleister. Wählen Sie in der Spalte **Versanddienstleister** die Option **Nicht bestimmt** aus dem Dropdown-Menü. Weitere Informationen finden Sie im Kapitel **<<fulfillment/versand-vorbereiten#800, Versanddienstleister erstellen >>**.

Richten Sie anschließend das Versandprofil im Menü **Einstellungen » Aufträge » Versand » Versandoptionen** ein. Wie Sie dazu vorgehen, ist im Kapitel **<<fulfillment/versand-vorbereiten#1000, Versandprofil erstellen >>** beschrieben.
...
FBA ist das Kürzel für Fulfillment by Amazon, einem Service von Amazon, bei dem Amazon die Lagerhaltung sowie die gesamte Logistik übernimmt. Welche Einstellungen Sie vornehmen müssen, um diesen Service zu nutzen, lesen Sie auf der Handbuchseite von <<multi-channel/amazon#, **Amazon**  >> im Kapitel **<<multi-channel/amazon#3300, FBA-Service von Amazon nutzen >>**.

== Amazon Prime

Sie haben in plentymarkets die Möglichkeit, Filter einzustellen, damit Aufträge mit den Versandbedingungen von Amazon Prime gesondert behandelt werden. Außerdem können Sie Versandlabel für Amazon Prime-Aufträge über die Amazon Merchant Fulfillment API generieren. Welche Einstellungen Sie vornehmen müssen, ist auf der Handbuchseite von <<multi-channel/amazon#, **Amazon**  >> im Kapitel <<multi-channel/amazon#4200, **Amazon Prime-Aufträge bearbeiten** >> beschrieben.
