...
====
Sie haben die Möglichkeit, das Retourenetikett automatisch an Ihren Kunden zu versenden. Richten Sie dazu eine Ereignisaktion ein und wählen als Ereignis *Retourenlabel gespeichert*. Außerdem richten Sie eine E-Mail-Vorlage im Menü *System » Systemeinstellungen » Mandant » Mandant wählen » E-Mail » Vorlagen* ein und wählen aus der Dropdown-Liste *PDF-Anhang* die Option *Retoure*.
====
