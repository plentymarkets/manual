...
Wenn Sie erlauben, dass Kunden Retouren selbst anlegen können, stehen die <<auftraege/auftraege-verwalten#retoure, Retourengründe>>, die Sie eingegeben haben, auch im *Mein Konto*-Bereich zur Auswahl. +
...
Zur Zuordnung legen Sie im Menü *System » Aufträge » Auftragsstatus* 2 <<auftraege/auftraege-verwalten#, Auftragsstatus>> für die an DHL Fulfillment übermittelten Aufträge an. Im Folgenden finden Sie 2 Beispiele:
...
Wenn die Retouren von DHL Fulfillment in Ihr plentymarkets System importiert werden sollen, benötigen Sie Retourengründe. Diese Retourengründe legen Sie im Menü <<auftraege/auftraege-verwalten#retoure, System » Aufträge » Auftragstypen » Retoure>> an. Verknüpfen Sie dann die von Ihnen konfigurierten Retourengründe mit den von DHL Fulfillment vorgegebenen Gründen im Menü *System » Aufträge » Versand » Fulfillment » DHL Fulfillment*.
