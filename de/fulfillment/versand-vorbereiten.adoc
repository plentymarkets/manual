...
| *Name*
|Der Name in diesem Feld wird deinen Kund:innen im Webshop angezeigt. Wähle einen Namen, z.B. _Standard_ oder _Express_. Wenn du deinen Webshop in mehreren Sprachen betreibst, verwende die Dropdown-Liste, um den Namen in jeder benötigten Sprache zu speichern.
