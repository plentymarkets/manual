...
Die Sendungsanmeldung an DHL Fulfillment erfolgt automatisch über die Schnittstelle. Meldungen zu Sendungen, die bei DHL Fulfillment angemeldet wurden, findest du im Menü *Daten » Daten-Log*. Weitere Informationen zu den Log-Einträgen findest du auf der Handbuchseite <<daten/datenlog#, Daten-Log>>.
