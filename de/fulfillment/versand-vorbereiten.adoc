...
| *Markierung*
|Wähle das Symbol, das in der Auftragsübersicht angezeigt wird. Anhand der Markierung siehst du auf den ersten Blick, welches Versandprofil gespeichert ist.
