...
Um weitere Informationen zum Einrichten des DHL Retoure Online-Plugins zu erhalten, klicke auf *Plugin*. Um weitere Informationen zur alten Schnittstelle DHL Retoure Online zu erhalten, klicke auf *Alte Integration*.
