...
Anschließend können Sie das Retourenetikett an Ihren Kunden versenden. Richten Sie dazu eine weitere Ereignisaktion ein und wählen als Ereignis *Dokumente > Retourenlabel gespeichert*. Außerdem richten Sie eine E-Mail-Vorlage im Menü *System » Systemeinstellungen » Mandant » Mandant wählen » E-Mail » Vorlagen* ein und wählen aus der Dropdown-Liste *PDF-Anhang* die Option *Retourenlabel*.
====
