...
Weitere Informationen findest du auf der Handbuchseite <<fulfillment/versanddienstleister-plugins/plugin-dhl-shipping-versenden#, DHL Shipping (Versenden)>>. Das Plugin *DHL Shipping (Versenden)* steht dir kostenlos im link:https://marketplace.plentymarkets.com/plugins/integration/dhlshipping_4871[plentyMarketplace^] zur Verfügung.
...
include::../_includes/textblocks/instructions/api-log-filter.adoc[]
