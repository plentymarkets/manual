...
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#table-table-of-shipping-charges-shipping-profile>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#table-interface-dhl-intraship-versenden>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
. Wechsele in das Tab *Portotabelle*.
. Klappe die Region auf (icon:angle-down[]).
. Nimm die gewünschten Einstellungen im Bereich *DHL Intraship/Versenden* vor. Beachte dazu die Erläuterungen in <<#table-shipping-services-dhl-intraship-versenden>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#table-dhl-export-documents>>.
...
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#table-dhl-packstation>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#table-interface-dhl-enclosed-return-labels>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
. Gib einen Namen ein.
. Wähle das *Ereignis* gemäß <<#table-event-procedure-dhl-return-labels>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
. Nimm die Einstellungen gemäß <<#table-event-procedure-dhl-return-labels>> vor.
...
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#ttable-interface-dpd-cloud-webservice>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
In <<#table-overview-fulfilment-service-providers>> findest die in plentymarkets verfügbaren Fulfillment-Dienstleister aufgelistet. Mit einem Klick auf den Dienstleister in der Tabelle gelangst du in das Unterkapitel, in dem dienstleisterspezifische Einstellungen beschrieben sind.
