...
+
--
Nutze über die Schnittstelle zum DHL Geschäftskundenportal die Funktion *Versenden*. Das Plugin *DHL Shipping (Versenden)* steht dir kostenlos im link:https://marketplace.plentymarkets.com/plugins/integration/dhlshipping_4871[plentyMarketplace^]{nbsp}icon:external-link[] zur Verfügung.
...
======
Kaufe dir das Plugin *DHL Retoure Online* kostenlos im link:https://marketplace.plentymarkets.com/plugins/integration/dhlretoureonline_6714[plentyMarketplace^]{nbsp}icon:external-link[] und installiere es in einem Plugin-Set. Der *DHL Retoure Online*-Assistent ist dann im Menü *Einrichtung » Assistenten* im Bereich *Integrationen* sichtbar.
======
...
====
Verwende das Plugin DPD Versand-Services. Das Plugin steht dir im link:https://marketplace.plentymarkets.com/plugins/integration/dpdshippingservices_6320[plentyMarketplace^]{nbsp}icon:external-link[] zur Verfügung.
====
...
Gehe wie im Folgenden beschrieben vor, um die Schnittstelle zu link:https://esolutions.dpd.com/entwickler/dpd-cloud-webservice.aspx[DPD Cloud Webservice^]{nbsp}icon:external-link[] in plentymarkets einzurichten.
...
Bevor du die Schnittstelle zu DPD DELISprint in plentymarkets einrichten, registriere dich bei link:https://www.dpd.com/portal_de[DPD^]{nbsp}icon:external-link[]. Mit dem Programm DPD DELISprint erstellst du als DPD-Kunde DPD-Paketscheine.

Wie du Versanddienstleister und Versandprofile einrichtest und welche Einstellungen du außerdem vornehmen musst und kannst, ist in den Kapiteln <<fulfillment/versand-vorbereiten#100, Lieferländer einrichten>> bis <<fulfillment/versand-vorbereiten#2400, API-Log abrufen>> beschrieben. Die dort beschriebenen Einstellungen bilden die Voraussetzung, um nun versanddienstleisterspezifische Einstellungen vorzunehmen. Nimm daher die Einstellungen in den genannten Kapiteln zuerst vor. Fahre anschließend mit diesem Kapitel fort.

Gehe wie im Folgenden beschrieben vor, um die Schnittstelle zu link:https://www.dpd.com/ch/home/esolutions/clientloesungen/delisprint_6[DPD DELISprint^]{nbsp}icon:external-link[] in plentymarkets einzurichten.
...
====
Die Schnittstelle zu Hermes 2-Mann-Handling kann nur noch von Bestandskunden genutzt werden. Neukunden werden gebeten, sich an die link:https://www.hermesworld.com/de/unsere-dienstleistungen/distribution/2-mann-handling/2-mann-handling/[HERMES Einrichtungs Service GmbH &amp; Co.KG^]{nbsp}icon:external-link[] zu wenden.
====
...
Gehe wie im Folgenden beschrieben vor, um die Schnittstelle zu link:http://www.dpd.iloxx.de/home.aspx[MyDPD Business / iloxx^]{nbsp}icon:external-link[] in plentymarkets einzurichten.
