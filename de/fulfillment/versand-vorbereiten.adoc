...
.Template-Variablen
====
Zu den verschiedenen Berechnungstypen findest du <<webshop/webshop-einrichten/cms-syntax#grundlagen-template-variablen, Template-Variablen>> im Menü <<webshop/webshop-einrichten/cms-syntax#webdesign-itemview-container-itemviewsingleitem, CMS » Webdesign » Layout » ItemView » ItemViewSingleItem>>. Die Template-Variable *+$Volumen+* gibt keine Maße zurück, sondern das Volumen in Kubikmeter.
====
