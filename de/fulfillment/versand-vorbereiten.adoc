...
Gehe wie im Folgenden beschrieben vor, um die Schnittstelle zu link:https://www.dpd.com/ch/home/esolutions/clientloesungen/delisprint_6[DPD Print^]{nbsp}icon:external-link[] in plentymarkets einzurichten.
...
Der Versanddienstleister iloxx gehört zu DPD und firmiert unter dem Namen DPD iloxx DPD eService GmbH.

Wie du Versanddienstleister und Versandprofile einrichtest und welche Einstellungen du außerdem vornehmen musst und kannst, ist in den Kapiteln <<fulfillment/versand-vorbereiten#100, Lieferländer einrichten>> bis <<fulfillment/versand-vorbereiten#2400, API-Log abrufen>> beschrieben. Die dort beschriebenen Einstellungen bilden die Voraussetzung, um nun versanddienstleisterspezifische Einstellungen vorzunehmen. Nimm daher die Einstellungen in den genannten Kapiteln zuerst vor. Fahre anschließend mit diesem Kapitel fort.

Gehe wie im Folgenden beschrieben vor, um die Schnittstelle zu link:http://www.dpd.iloxx.de/home.aspx[Iloxx^]{nbsp}icon:external-link[] in plentymarkets einzurichten.
