...
Weitere Informationen finden Sie auf der Handbuchseite <<datenaustausch/daten-exportieren#, **Daten exportieren**  >> im Kapitel <<datenaustausch/daten-exportieren#30, **Datenformate für Preissuchmaschinen exportieren** >>.
...
Weitere Informationen zu den API-Log-Einträgen von DHL Fulfillment und DPD Cloud Webservice finden Sie auf der Handbuchseite <<datenaustausch/api-log#, **API-Log**  >>.
...
Die Sendungsanmeldung an DHL Fulfillment erfolgt automatisch über die Schnittstelle. Meldungen zu Sendungen, die bei DHL Fulfillment angemeldet wurden, finden Sie im Menü **Datenaustausch » API-Log**. Weitere Informationen zu den API-Log-Einträgen von DHL Fulfillment finden Sie auf der Handbuchseite <<datenaustausch/api-log#, **API-Log**  >>.
...
Meldungen zu Sendungen, die bei DHL Fulfillment angemeldet wurden, finden Sie im Menü **Datenaustausch » API-Log**. Weitere Informationen zu den API-Log-Einträgen von DHL Fulfillment finden Sie auf der Handbuchseite <<datenaustausch/api-log#, **API-Log**  >>.
====
