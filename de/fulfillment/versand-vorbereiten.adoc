...
.Übersicht der Lieferländer im Menü *Einrichtung » Aufträge » Versand » Optionen* im Tab *Lieferländer*
[cols="1,3"]
|====
...
*Lieferant aktiv* = Lieferländer mit dieser Eigenschaft stehen für die Einstellung als *Standardlieferland* im Menü <<omni-channel/online-shop/webshop-einrichten/bestellvorgang#, Einrichtung » Mandant » Mandant wählen » Bestellvorgang » Einstellungen>> nicht zur Verfügung.
...
.Übersicht im Menü *Einrichtung » Aufträge » Versand » Optionen* im Tab *Versanddienstleister*
[cols="1,3"]
|====
|Einstellung |Erläuterung
...
====
Wenn ein Auftrag Artikel enthält, bei denen kein Versandprofil aktiviert wurde, wird das Standardversandprofil aus dem Standard-Webshop für die Artikel verwendet. Das Standardversandprofil wählst du im Menü <<omni-channel/online-shop/webshop-einrichten/bestellvorgang#, Einrichtung » Mandant » Mandant wählen » Aufträge>>. Wenn kein Standardversandprofil eingerichtet ist, wird das Versandprofil mit der höchsten Priorität verwendet.
====
