...
Im folgenden Video-Tutorial lernst du anhand des Beispiels *DHL Shipping (Versenden)*, wie du deine Versandeinstellungen einrichtest.

*_Hinweis:_* Bitte beachte, dass das Video ab Minute 3:42 nicht mehr aktuell ist, weil die Einrichtung des Plugins nicht mehr über das plentymarkets Backend eingerichtet wird, sondern über die Assistenten *DHL Shipping (Versenden): Grundeinstellungen* und *DHL Shipping (Versenden): Einstellungsverknüpfung*. Die Assistenten stehen dir nach erfolgreicher Installation des Plugins im Menü *Einrichtung » Assistenten* im Bereich *Integration* zur Verfügung. Weitere Informationen findest du auf der Handbuchseite <<fulfillment/versanddienstleister-plugins/plugin-dhl-shipping-versenden#, DHL Shipping (Versenden)>>.

[[video-versandeinstellungen-dhl-versenden]]
.Richte deine Versandeinstellungen mit DHL Shipping (Versenden) ein
...
. Nimm die gewünschten Einstellungen im Bereich *Übersicht* vor. Beachte dazu die Erläuterungen in <<#tabelle-uebersicht-lieferlaender>>.
...
*_Wichtig:_* Du kannst den Namen des Lieferlandes in verschiedenen Sprachen eingeben. Wähle dazu im Tab *Filter* in der Dropdown-Liste *Sprache (Name)* das Sprachkürzel und klicke auf *Suchen* klicken. Die eingegebenen Namen der Sprache werden angezeigt. Passe die Namen in der Spalte *Name (xy)* in der Übersicht nach deinen Wünschen an.
...
*Lieferant aktiv* = Lieferländer mit dieser Eigenschaft stehen für die Einstellung als <<webshop/webshop-einrichten/bestellvorgang#_bestellvorgang_konfigurieren, Standardlieferland>> im Menü *Einrichtung » Mandant » Mandant wählen » Bestellvorgang » Einstellungen* nicht zur Verfügung.

| *Lager*
|Wähle das Lager, das dem Lieferland als Hauptlager zugeordnet werden soll und z.B. in Aufträgen automatisch eingestellt sein soll. +
Wähle *ALLE*, wenn alle Lager dem Lieferland zugeordnet werden sollen. In diesem Fall wird für Aufträge automatisch das Lager mit der kleinsten ID gewählt. Beachte dazu auch die <<auftraege/auftraege-verwalten#, Lagereinstellungen>> im Menü *Einrichtung » Aufträge » Einstellungen*.
...
. Nimm die gewünschten Einstellungen im Bereich *Filter* vor. Beachte dazu die Erläuterungen in <<#tabelle-filter-lieferlaender>>.
. Klicke auf *Suchen*. +
...
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#tabelle-versanddienstleister-erstellen>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
| *Name (xy)*
|Gib den Namen des Versanddienstleisters ein, wie er im Warenkorb und auf der Rechnung angezeigt werden soll. Gib den tatsächlichen Namen des Versanddienstleisters oder eine allgemeine Bezeichnung ein, z.B. Versicherter Versand. Dieser Name ist für Kund:innen sichtbar.

| *Name (Backend)*
|Gib den Namen des Versanddienstleisters ein, wie er systemintern angezeigt werden soll. Gib den tatsächlichen Namen des Versanddienstleisters oder eine alternative Bezeichnung ein, die den Dienstleister charakterisiert, z.B. Pakete Schweiz. Dieser Name ist für Kund:innen _nicht_ sichtbar.

| *Versanddienstleister*
|Wähle den Versanddienstleister. Dies ist besonders wichtig, wenn du unter *Name* eine abweichende Bezeichnung eingegeben und/oder keine Tracking-URL verwendet hast.
...
*_Hinweis:_* Wenn du im Versandprofil die Option *Einwilligung zur Datenübermittlung* aktiviert hast, wird die Adresse des Versanddienstleisters dann im Ceres-Webshop in einer Checkbox angezeigt. Wenn Kund:innen die Checkbox in deinem Webshop aktivieren, stimmen sie der Übertragung der Telefonnummer und E-Mail-Adresse an den Versandddienstleister zu.
...
. Öffne das Menü *Einrichtung » Aufträge » Versand » Optionen*.
. Wechsele in das Tab *Versanddienstleister*.
. Nimm die gewünschten Einstellungen im Bereich *Filter* vor. Beachte dazu die Erläuterungen in <<#tabelle-filter-versanddienstleister>>.
. Klicke auf *Suchen*. +
...
| *Versanddienstleister*
|Filtert Versanddienstleister anhand der Option, die du in der Dropdown-Liste *Versanddienstleister* gewählt hast.
...
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#tabelle-grundeinstellungen-versandprofil>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen. +
...
| *Name*
|Der Name in diesem Feld wird im Webshop angezeigt. Wähle den Namen, der den Kund:innen angezeigt werden soll, z.B. _Standard_ oder _Express_. Wenn du deinen Webshop in mehreren Sprachen betreibst, verwende die Dropdown-Liste, um den Namen in jeder benötigten Sprache zu speichern.

| *Name (Backend)*
|Gib den Namen für das Versandprofil ein. Der Name wird nur im System angezeigt und ist _nicht_ sichtbar für Kund:innen.

| *Markierung*
|Wähle das Icon, das in der Auftragsübersicht angezeigt wird. Anhand der Markierung siehst du auf den ersten Blick, welches Versandprofil gespeichert ist.
...
|Setze das Häkchen, um die im Artikeldatensatz gespeicherten Portoaufschläge zu aktivieren. Bis zu 2 Portoaufschläge können bei der Hauptvariante eines Artikels im Bereich *Versand* eingegeben werden. +
*Portoaufschlag 1* fügt den Versandkosten den dort gespeicherten Preis für den ersten Artikel hinzu, *Portoaufschlag 2* gilt ab dem zweiten Artikel. Portoaufschläge bieten sich für größere oder sperrige Artikel an, deren Versand teurer ist. +
Weitere Informationen findest du im Kapitel <<fulfillment/versand-vorbereiten#1100, Tipps und Tricks: Portoaufschläge>>.

| *POSTIDENT*
|Legitimationsprüfung durch die Deutsche Post AG. Dient zur Verifizierung von Personen, z.B. im Zusammenhang mit dem nötigen Altersnachweis für FSK 18-Artikel. Setze zum Aktivieren das Häkchen. +
...
|Setze das Häkchen, wenn das Versandprofil neuen Artikeln automatisch zugeordnet werden soll. +
Du solltest diese Option bei mindestens einem Versandprofil wählen, damit neuen Artikeln immer automatisch dieses Versandprofil zugewiesen wird. Ist ein Artikel nicht mit mindestens einem Versandprofil verknüpft, kann dieser Artikel auch nicht versendet werden.

| *Nachnahme*
|Aktiviere die Option, damit Kund:innen in deinem Ceres-Webshop die Zahlungsart *Nachnahme* wählen können. +
...
| *Paketstation aktiv*
|Aktiviere die Option, damit für Kund:innen in deinem Ceres-Webshop verbesserte Eingabemöglichkeiten für das Feld *Paketstation* verfügbar sind. +
*_Wichtig:_* Voraussetzung ist, dass die Plugins link:https://marketplace.plentymarkets.com/plugins/templates/Ceres_4697[Ceres^]{nbsp}icon:external-link[] und link:https://marketplace.plentymarkets.com/plugins/templates/IO_4696[IO^]{nbsp}icon:external-link[] installiert sind.

| *Postfiliale aktiv*
|Aktiviere die Option, damit für Kund:innen in deinem Ceres-Webshop verbesserte Eingabemöglichkeiten für das Feld *Postfiliale* verfügbar sind. +
*_Wichtig:_* Voraussetzung ist, dass die Plugins link:https://marketplace.plentymarkets.com/plugins/templates/Ceres_4697[Ceres^]{nbsp}icon:external-link[] und link:https://marketplace.plentymarkets.com/plugins/templates/IO_4696[IO^]{nbsp}icon:external-link[] installiert sind.

| *Einwilligung zur Datenübermittlung*
|Aktiviere die Option, damit im Ceres-Webshop eine Checkbox angezeigt wird. Wenn deine Kund:innen diese Checkbox aktivieren, stimmen sie zu, dass ggf. die Telefonnummer und E-Mail-Adresse an den Versanddienstleister übertragen werden.
...
| *Alternative E-Mail*
|Diese Einstellung ist nur sichtbar, wenn in der Dropdown-Liste *E-Mail und Telefon übertragen* die Option *Alternative übertragen* gewählt wurde. +
...
| *Mandanten (Shops)*
|Wähle eine der Optionen oder die Option *ALLE*, wenn das Versandprofil für alle Webshops gelten soll. +
Diese Option wird nur angezeigt, wenn mindestens ein Mandant (Shop) eingerichtet ist.

| *Auftragsherkunft*
|Wähle eine oder mehrere der Optionen, um mögliche Auftragsherkünfte für dieses Versandprofil zu bestimmen, oder wähle  *ALLE*, um alle Herkünfte freizugeben.

| *Gesperrte Zahlungsarten*
|Wähle alle Zahlungsarten, die für das Versandprofil nicht angeboten werden sollen. Wähle bei Versandprofilen, die keine Nachnahmeoption enthalten oder bei denen Nachnahme nicht gewünscht wird, alle Optionen, die mit Nachnahme in Verbindung stehen.

| *Gesperrte Kundenklassen*
|Sperre eine oder mehrere Kundenklassen für das Versandprofil.

| *Letzte Änderung*
|Bei Änderungen an den Einstellungen wird hier das Datum aktualisiert.

| *Versandgruppen*
|Wenn für deine Versandprofile Gruppen angelegt werden sollen, gib hier einen Namen für die Versandgruppe ein und klicke auf *Hinzufügen*. Gib diesen Namen in jedem Versandprofil, das zu dieser Gruppe gehören soll, ein. Somit entstehen verschiedene Gruppen, die unterschiedliche Versandprofile enthalten. +
...
Mit dieser Funktion kannst du sehr einfach die Versandprofile für neue Artikel zuweisen.
...
====
Wenn du im Menü *Einrichtung » Mandant* » _Mandant wählen_ » *Aufträge* ein Standardversandprofil definiert hast, ist die Schaltfläche zum Löschen dieses Versandprofils in der Übersicht der Versandprofile im Menü *Einrichtung » Aufträge » Versand » Optionen » Tab: Versandprofile* ausgegraut. Es ist daher nicht möglich das Versandprofil, das als Standardversandprofil gespeichert wurde, zu löschen.
====
...
In diesem Beispiel bestellt ein:e Kund:in 2 PCs und 2 Monitore. Für die Artikel sind folgende Versandkosten eingegeben:
...
In diesem Beispiel bestellt ein:e Kund:in einmal 1 PC, dann 2 PCs und dann 3 PCs. Für den Artikel sind folgende Versandkosten eingegeben:
...
Bei den Bestellungen ergeben sich folgende Versandkosten:
...
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#tabelle-portotabelle-versandprofil>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
| *Berechnungstyp*
|Wähle den <<fulfillment/versand-vorbereiten#1600, Berechnungstyp>>. Der Berechnungstyp bildet die Grundlage für die Berechnung der Versandkosten.
...
|Gib in das Feld *Ab Warenwert ...* den Warenwert ein, ab dem die Lieferung zu einer festen Pauschale erfolgt. Die Pauschale im Feld *... pauschale Versandkosten von* eingeben. +
Dieser Betrag darf nicht höher sein als der Betrag für die Pauschale *Versandkostenfrei ab Warenwert*, weil der Versand ab diesem Wert bereits kostenfrei ist.

2+|Beschränkungen

| *Beschränkungstyp*
|Wähle den Beschränkungstyp. +
...
| *Mindestwert*
|Gib einen Wert ein. Erst ab diesem Wert, bezogen auf den angegebenen Beschränkungstyp, ist das Versandprofil gültig. +
Wenn du unter *Beschränkungstyp* die Einstellung *Maximum (Kubikmeter)* gewählt hast, gib den Wert hier in _m_ ein.

| *Maximalwert*
|Gib einen Wert ein. Bis zu diesem Wert, bezogen auf den angegebenen Beschränkungstyp, ist das Versandprofil gültig. +
Wenn du unter *Beschränkungstyp* die Einstellung *Maximum (Kubikmeter)* gewählt hast, gib den Wert hier in _m_ ein.

2+|Allgemeine Konfiguration

| *Standardpaket*
|Wähle das <<fulfillment/versand-vorbereiten#1900, Versandpaket>>, das als Standardpaket für dieses Versandprofil verwendet werden soll. +
*_Hinweis:_* Du kannst diese Option erst sehen, nachdem du die Portotabelle gespeichert und neu geladen hast.
...
| *Alternative E-Mail*
|Du kannst diese Einstellung nur sehen, wenn du in der Dropdown-Liste *E-Mail und Telefonnr. übertragen* die Option *Alternative übertragen* gewählt hast. +
Gib eine alternative E-Mail-Adresse, die an den Dienstleister übertragen werden soll, ein.
...
| *_Hinweis:_* Die Einstellungen des Versanddienstleisters werden erst sichtbar, nachdem du die Portotabelle gespeichert und neu geladen hast.
...
Bei diesem Berechnungstyp stellen die eingegebenen Versandkosten die Gesamtsumme dar. Das bedeutet: Unabhängig davon, wie viele Artikel die Kund:in kauft, die Kund:in bezahlt nur die hier eingegebenen Versandkosten.
...
====
Wenn ein Auftrag Artikel enthält, bei denen kein Versandprofil aktiviert wurde, wird das Standardversandprofil aus dem Standard-Webshop für die Artikel verwendet. Das Standardversandprofil wählst du im Menü <<webshop/webshop-einrichten/bestellvorgang#, Einrichtung » Mandant » Mandant wählen » Aufträge>>. Wenn kein Standardversandprofil eingerichtet ist, wird das Versandprofil mit der höchsten Priorität verwendet.
====
...
====
_Definierte Versandpakete_: Ein:e Händler:in verschickt Artikel in 2 verschiedenen Kartongrößen und legt dazu 2 Versandpakete an. Das Volumen ergibt sich aus den Abmessungen. +
Versandpaket 1: 30 cm x 25 cm x 40 cm +
Versandpaket 2: 50 cm x 50 cm x 25 cm

_Flexible Verpackung_: Für den Versand von Möbeln verwendet ein:e Händler:in Verpackungsmaterial, das je nach Größe des Versandguts individuell angepasst wird (Wellpappe, Folie etc.). Das Volumen wird aus den Artikeldaten berechnet.
====
...
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#tabelle-versandpaket-erstellen>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
| *Volumenangabe*
|Wähle *vom Versandpaket beziehen* (Länge, Breite, Höhe) oder *von Artikeldaten beziehen (summiert)*. +
Wenn du die Option *von Artikeldaten beziehen (summiert)* gewählt hast, sind die Zeilen *Länge*, *Breite* und *Höhe* nicht mehr sichtbar.
...
*_Hinweis:_* Dieser Wert bezieht sich auf das Gesamtvolumen des Versandpakets und setzt sich zusammen aus den Volumina der enthaltenen Artikel. Diese Angabe dient als Richtwert und du kannst besser abschätzen, ob die Artikel eines Auftrags in das Versandpaket passen.

| *Mandant (Shop)*
|Wähle den Mandant (Shop) aus der Dropdown-Liste. Wähle die Option *ALLE*, wenn das Versandpaket für alle Webshops verfügbar sein soll.
|====
...
|Alte Integration <<fulfillment/versand-vorbereiten#2900, DHL Intraship/Versenden>>
|Für Händler:innen innerhalb Deutschlands. Versand: international.
...
|Plugin <<fulfillment/versanddienstleister-plugins/plugin-dhl-wunschpaket#, DHL Wunschpaket>>
...
Gehe wie im Folgenden beschrieben vor, um die Schnittstelle zu link:https://www.dhl.de/de/paket/geschaeftskunden/versandsoftware.html[DHL Easylog^]{nbsp}icon:external-link[] in plentymarkets einzurichten.

[.instruction]
Schnittstelle einrichten:

. Öffne das Menü *Einrichtung » Aufträge » Versand » Dienstleister » DHL Easylog*.
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#tabelle-schnittstelle-dhl-easylog>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
|Gib die Daten wie von DHL erhalten ein.
...
. Wechsele in das Tab *Portotabelle*.
. Klappe die Region auf (icon:angle-down[]).
. Nimm die gewünschten Einstellungen im Bereich *DHL Easylog* vor. Beachte dazu die Erläuterungen in <<#tabelle-versandservices-dhl-easylog>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
Gehe wie im Folgenden beschrieben vor, um die Schnittstelle zu link:http://www.dhl.de/de/logistik/frachttransport/land-schienentransport.html[DHL Freight^]{nbsp}icon:external-link[] in plentymarkets einzurichten.

[.instruction]
Schnittstelle einrichten:

. Öffne das Menü *Einrichtung » Aufträge » Versand » Dienstleister » DHL Freight*.
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#tabelle-schnittstelle-dhl-freight>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
| *Niederlassung*
|Gib die dreistellige Abkürzung wie von DHL erhalten ein.
...
. Wechsele in das Tab *Portotabelle*.
. Klappe die Region auf (icon:angle-down[]).
. Nimm die gewünschten Einstellungen im Bereich *DHL Freight* vor. Beachte dazu die Erläuterungen in <<#tabelle-versandservices-dhl-freight>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
Wir empfehlen das Einrichten des Plugins *DHL Shipping (Versenden)*. Die Schnittstelle kannst du dann ganz einfach mit der Hilfe von Assistenten einrichten.

Um weitere Informationen zum Einrichten des DHL Shipping (Versenden)-Plugins zu erhalten, klicke im Folgenden auf *Plugin DHL Shipping (Versenden)* (Standardauswahl). Um weitere Informationen zur alten Schnittstelle DHL Intraship/Versenden zu erhalten, klicke auf *Alte Integration DHL Intraship/Versenden*.
...
+
--
Nutze über die Schnittstelle zum DHL Geschäftskundenportal die Funktion *Versenden*. Weitere Informationen findest du auf der Handbuchseite <<fulfillment/versanddienstleister-plugins/plugin-dhl-shipping-versenden#, DHL Shipping (Versenden)>>. Das Plugin *DHL Shipping (Versenden)* steht dir kostenlos im link:https://marketplace.plentymarkets.com/plugins/integration/dhlshipping_4871[plentyMarketplace^]{nbsp}icon:external-link[] zur Verfügung.

Exportdokumente werden automatisch mit der Anmeldung im Versand-Center beim Versandetikett gespeichert.
--

Alte Integration DHL Intraship/Versenden::
+
--
Die in plentymarkets fest integrierte Schnittstelle wird weiterhin unter *DHL Intraship/Versenden* geführt, bis DHL uns darüber informiert hat, dass alle Kunden *DHL Versenden* nutzen. Die Schnittstelle DHL Intraship/Versenden sowie Einstellungen, die diese Schnittstelle in anderen Menüs betreffen, gelten bis zur Abschaltung von DHL Intraship für bestehende DHL Intraship-Kunden.
...
Gehe wie im Folgenden beschrieben vor, um die Schnittstelle zu link:http://www.dhl.de/de/paket/geschaeftskunden/versandsoftware.html[DHL Intraship/Versenden^]{nbsp}icon:external-link[] in plentymarkets einzurichten.

[.instruction]
Schnittstelle einrichten:

. Öffne das Menü *Einrichtung » Aufträge » Versand » Dienstleister » DHL Intraship/Versenden*.
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#tabelle-schnittstelle-dhl-intraship-versenden>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
. Wechsele in das Tab *Portotabelle*.
. Klappe die Region auf (icon:angle-down[]).
. Nimm die gewünschten Einstellungen im Bereich *DHL Intraship/Versenden* vor. Beachte dazu die Erläuterungen in <<#tabelle-versandservices-dhl-intraship-versenden>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.

[[tabelle-versandservices-dhl-intraship-versenden]]
.Versandservices von DHL Intraship/Versenden in der Portotabelle einstellen
[cols="1,3"]
|====
|Einstellung |Erläuterung
...
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#tabelle-dhl-exportdokumente>>.
...
======
Wenn du mit dem Erzeugen der Exportdokumente gleichzeitig den Warenausgang buchen möchtest, kannst du das über eine Ereignisaktion im Menü *Einrichtung » Aufträge » Ereignisse* erledigen. Weitere Informationen findest du auf der Handbuchseite <<automatisierung/ereignisaktionen#, Ereignisaktionen>>.
======

[discrete]
=== DHL Packstation einrichten

DHL unterhält ein Netz von Packstationen, die rund um die Uhr verfügbar sind. Eine DHL Packstation oder eine DHL Postfiliale kann von deinen Kunden optional als Lieferadresse angegeben werden. Nimm die Einstellungen für DHL Packstationen im Menü *Einrichtung » Mandant* » _Mandant wählen_ » *Bestellvorgang » DHL Packstation* vor.
...
. Öffne das Menü *Einrichtung » Mandant* » _Mandant wählen_ » *Bestellvorgang » DHL Packstation*.
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#tabelle-dhl-packstation>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
Mit dem DHL Postfinder werden deine Kunden im Mein Konto-Bereich bei der <<webshop/webshop-einrichten/cms#webdesign-webdesign-bearbeiten-bestellvorgang-kaufabwicklung#, Kaufabwicklung>> anhand der Postleitzahl die in der Nähe liegenden Postfilialen und Packstation angezeigt. Deine Kunden haben dann die Möglichkeit, die Auswahl direkt in die Lieferanschrift zu übernehmen.

Um den DHL Postfinder zu nutzen, musst du Einstellungen in mehreren Menüs vornehmen. Diese Einstellungen sind auf der folgenden <<webshop/webshop-einrichten/cms#webdesign-webdesign-bearbeiten-bestellvorgang, Handbuchseite>> im Bereich "DHL Postfinder" zusammengefasst.
...
Mit DHL Retoure Beilegeretiketten erzeugst du Etiketten für Aufträge, die über DHL innerhalb Deutschlands ausgeliefert werden. Deine Kund:innen erhalten bereits bei der Lieferung ein komplett vorbereitetes Retourenlabel. Im Fall der Rücksendung, z.B. aufgrund von Gewährleistungen oder Reparaturen, müssen deine Kund:innen die Ware nur noch einpacken und das Label anbringen. Die Etiketten werden per Ereignisaktion erzeugt und sind dann im Versand-Center zum Abruf und Ausdruck verfügbar.

Gehe wie im Folgenden beschrieben vor, um die Schnittstelle zu link:https://www.dhl.de/de/paket/geschaeftskunden/ab-200-pakete/nationaler-versand/retoure.html[DHL Retoure Beilegeretiketten^]{nbsp}icon:external-link[] in plentymarkets einzurichten.

[.instruction]
Schnittstelle einrichten:

. Öffne das Menü *Einrichtung » Aufträge » Versand » Dienstleister » DHL RETOURE Beilegeretiketten*.
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#tabelle-schnittstelle-dhl-retoure-beilegeretiketten>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
| *Empfänger*
|Gib die Daten der Empfänger:in ein.

| *Abrechnungsnummer*
|Gib die Abrechnungsnummer wie von DHL erhalten ein.

| *Kundenkennung*
|Gib die Kundenkennung wie von DHL erhalten ein.

| *Leitcode-Sequenz*
|Gib die Daten ein. Gib den Straßencode und die Hausnummer immer dreistellig ein, d.h. die Zahl 10 als 010 eingeben.
...
Gehe wie im Folgenden beschrieben vor, um die Schnittstelle zu link:http://www.dhl.de/de/paket/geschaeftskunden/ab-200-pakete/nationaler-versand/retoure.html[DHL Retoure Online^]{nbsp}icon:external-link[] in plentymarkets einzurichten.

[.instruction]
Schnittstelle einrichten:

. Öffne das Menü *Einrichtung » Aufträge » Versand » Dienstleister » DHL Retoure Online*.
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#tabelle-schnittstelle-dhl-retoure-online>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
. Öffne das Menü *Einrichtung » Mandant* » _Mandant wählen_ » *Mein Konto » Einstellungen*.
...
Gehe wie im Folgenden beschrieben vor, um die Schnittstelle zu link:http://www.dhl.de/de/logistik/supply-chain-loesungen.html[DHL Supply Chain^]{nbsp}icon:external-link[] in plentymarkets einzurichten.

[.instruction]
Schnittstelle einrichten:

. Öffne das Menü *Einrichtung » Aufträge » Versand » Dienstleister » DHL Supply Chain*.
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#tabelle-schnittstelle-dhl-supply-chain>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
Gehe wie im Folgenden beschrieben vor, um die Schnittstelle zu link:http://www.dhl.co.uk/en.html[DHL UK^]{nbsp}icon:external-link[] in plentymarkets einzurichten.

[.instruction]
Schnittstelle einrichten:

. Öffne das Menü *Einrichtung » Aufträge » Versand » Dienstleister » DHL UK*.
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#tabelle-schnittstelle-dhl-uk>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
| *Passwort*
|Gib das Passwort wie von DHL erhalten ein.
...
. Wechsele in das Tab *Portotabelle*.
. Klappe die Region auf (icon:angle-down[]).
. Nimm die gewünschten Einstellungen im Bereich *DHL UK* vor. Beachte dazu die Erläuterungen in <<#tabelle-versandservices-dhl-uk>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#tabelle-schnittstelle-dpd-cloud-webservice>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
| *User-ID*
|Gib die User-ID wie von DPD erhalten ein.

| *User-Token*
|Gib den User-Token wie von DPD erhalten ein.
...
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#tabelle-schnittstelle-dpd-print>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.

[[tabelle-schnittstelle-dpd-print]]
...
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#tabelle-schnittstelle-easypak>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
|Gib die Daten wie von EasyPAK erhalten ein.  +
...
. Wechsele in das Tab *Portotabelle*.
. Klappe die Region auf (icon:angle-down[]).
. Nimm die gewünschten Einstellungen im Bereich *PAT Easypak* vor. Beachte dazu die Erläuterungen in <<#tabelle-versandservices-easypak>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#tabelle-gls-germany>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
|Gib die Daten wie von GLS erhalten ein. +
...
====
Das Bestellmerkmal ist mit dem Artikel und nicht mit dem Versanddienstleister verknüpft. Wenn für den Artikel mehr als eine Versandart bzw. andere Versanddienstleister als Hermes hinterlegt sind, füge für deine Endkund:innen einen Hinweis in den Webshop ein, dass der Montageservice nur bei Versand mit Hermes erfolgt.
====
...
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#tabelle-schnittstelle-hermes-2mannhandling>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
|Gib die Daten wie von Hermes erhalten ein.

| *Montageservice*
|Wähle den Montageservice aus der Dropdown-Liste. +
Erst sichtbar, wenn du wie oben beschrieben, das Bestellmerkmal angelegt und mit dem Artikel verknüpft hast.
|====
...
. Wechsele in das Tab *Portotabelle*.
. Klappe die Region auf (icon:angle-down[]).
. Nimm die gewünschten Einstellungen im Bereich *Hermes 2-Mann-Handling* vor. Beachte dazu die Erläuterungen in <<#tabelle-versandservices-hermes-2mannhandling>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
====
Hermes schaltet die ProfiPaketService-Schnittstelle zum 31.03.2020 ab. Stelle daher jetzt auf *Hermes Shipping Interface* um. Lade dir das Plugin kostenlos im link:https://marketplace.plentymarkets.com/plugins/integration/hermesshippinginterface_5437[plentyMarketplace^]{nbsp}icon:external-link[] herunter.
====
...
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#tabelle-schnittstelle-hermes-profipaketservice>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
| *Zugangsdaten*
|Gib den internen Namen, Login-Name und Passwort wie von Hermes erhalten ein.

| *Abrechnung zum Staffelpreis*
|Akzeptiere die AGB von Hermes sowie den Hinweis auf die Limitierung des Paketwerts. +
Setze beide Häkchen. Andernfalls steht der Hermes-Dienst nicht zur Verfügung. Die AGB kannst du über den Link aufrufen.
...
. Gib *User-ID* und *User-Token* wie von Iloxx erhalten ein.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
Gehe wie im Folgenden beschrieben vor, um link:https://www.ukmail.com/[UK Mail^] über die integrierte Schnittstelle zu link:http://www.netdespatch.com/[NetDespatch^]{nbsp}icon:external-link[] in plentymarkets einzurichten.
...
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#tabelle-schnittstelle-netdespatch-ukmail>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
. Wechsele in das Tab *Portotabelle*.
. Klappe die Region auf (icon:angle-down[]).
. Nimm die gewünschten Einstellungen im Bereich *NetDespatch* vor. Beachte dazu die Erläuterungen in <<#tabelle-versandservices-netdespatch-ukmail>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
Gehe wie im Folgenden beschrieben vor, um die Schnittstelle zu link:http://www.parcelforce.com/[Parcelforce Worldwide^]{nbsp}icon:external-link[] in plentymarkets einzurichten.
...
. Wechsele in das Tab *Portotabelle*.
. Klappe die Region auf (icon:angle-down[]).
. Nimm die gewünschten Einstellungen im Bereich *Parcelforce Worldwide* vor. Beachte dazu die Erläuterungen in <<#tabelle-versandservices-parcelforce-worldwide>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
. Gib Benutzer und Passwort wie von PARCEL.ONE erhalten ein.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
. Wechsele in das Tab *Portotabelle*.
. Klappe die Region auf (icon:angle-down[]).
. Nimm die gewünschten Einstellungen im Bereich *PARCEL.ONE* vor. Beachte dazu die Erläuterungen in <<#tabelle-versandservices-parcel-one>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#tabelle-schnittstelle-swiss-post>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
|Gib die Daten wie von Swiss Post erhalten ein.

| *Nachnahmebetrag*
|Wähle *Mit dem ersten Versandpaket* oder *Auf Versandpakete verteilen*.

| *Neuen Webservice-Endpoint nutzen*
|Wähle *JA*. Aufgrund einer Umstellung bei Swiss Post wird die Schnittstelle angepasst. +
Alle Kund:innen erhalten neue Zugangsdaten. Gib diese Zugangsdaten hier ein. Wenn du Probleme mit der neuen Konfiguration hast, kontaktiere Swiss Post direkt.
|====
...
. Wechsele in das Tab *Portotabelle*.
. Klappe die Region auf (icon:angle-down[]).
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#tabelle-versandservices-swiss-post>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#tabelle-schnittstelle-ups>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
|Gib die Daten wie von UPS erhalten ein.

| *Anmeldung*
|Wie sollen Versandaufträge mit mehreren Paketen bei UPS angemeldet werden?. +
*Gesammelt anmelden* = Alle Pakete werden zusammenhängend angemeldet und erreichen gleichzeitig den:die Empfänger:in. +
*_Wichtig:_* Die Einstellung *Gesammelt anmelden* ist Pflicht bei Nachnahmeaufträgen mit mehreren Paketen. +
*Separat anmelden* = Jedes Versandpaket wird einzeln als Versandauftrag angemeldet. Die Pakete können den:die Empfänger:in zeitlich versetzt erreichen.
|====

[IMPORTANT]
.Zahlungsart Nachnahme
====
Bei Nachnahmesendungen per UPS sind nur Schecks erlaubt. Wenn Schecks nicht berücksichtigt werden sollen, musst du im UPS-Versandprofil die Zahlungsart _Nachnahme_ sperren, damit Sendungen dieser Art nicht über UPS angemeldet werden können.
====

[WARNING]
.Telefonnummer der Empfänger:in bei Auslandssendungen angeben
====
Gib in den Absenderdaten die Telefonnummer der Empfänger:in generell auf Sendungen ins Ausland an.
====
...
. Wechsele in das Tab *Portotabelle*.
. Klappe die Region auf (icon:angle-down[]).
. Nimm die gewünschten Einstellungen im Bereich *UPS Service* vor. Beachte dazu die Erläuterungen in <<#tabelle-versandservices-ups>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
Richte link:http://www.dhl.de/fulfillment[DHL Fulfillment^]{nbsp}icon:external-link[] in deinem plentymarkets System ein. Gehe dazu wie im Folgenden beschrieben vor.
...
Für die korrekte Abwicklung über die DHL Fulfillment-Schnittstelle benötigst du mindestens ein Lager des Lagertyps *Vertrieb* mit dem Logistiktyp *DHL Fulfillment*. Bis zu 4 Lager sind möglich. Die Zuordnung erfolgt seitens DHL anhand der von DHL verwendeten Bestandstypen: DHL ordnet dem Vertriebslager z.B. Waren des Bestandstyps *Prime Selection* zu. Diese Waren sind direkt zum Verkauf bestimmt. Waren des Bestandstyps *Second Quality* sind nicht für den Verkauf bestimmt und benötigen ein separates Lager, z.B. ein Lager des Lagertyps *Vorrat*. Werden solche Waren nach Prüfung für gut befunden, erhalten sie den Bestandstyp *Prime Selection* und somit die Zuordnung zum Vertriebslager.

[WARNING]
.Lagerzuordnung erfolgt durch DHL Fulfillment
====
...
Beschädigte Waren können Retouren sein, aber auch Artikel, die z.B. bei der Bewegung im Lager beschädigt wurden oder beschädigt geliefert wurden.
...
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#tabelle-schnittstelle-dhl-fulfillment>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
| *Schnittstelle aktiv*
|Setze ein Häkchen, um die Schnittstelle zu aktivieren. Aktivere die Schnittstelle erst, wenn die <<fulfillment/versand-vorbereiten#4900, Lager erstellt>> wurden.

| *Mandantenkennung*
|DHL Fulfillment-Mandantenkennung, d.h. Kundennummer, eingeben.

| *FTP-Zugang*
|Bevor die Schnittstelle produktiv genutzt werden kann, ist ein Testbetrieb vorgesehen. Wähle zum Testen der Schnittstelle die Option *Testbetrieb* und gib die von DHL erhaltenen Zugangsdaten ein. Diese sind für Test- und Produktivbetrieb unterschiedlich. +
...
|Welcher Auftragsstatus soll für die Meldung bei DHL Fulfillment verwendet werden? +
...
|Welcher Auftragsstatus soll bei Fehlern verwendet werden?

| *Aufbau Produktnummer*
|Wie soll die Produktnummer an DHL Fulfillment übermittelt werden? +
*SKU* = (Standardeinstellung) Die SKU besteht aus Artikel-ID, Preis-ID und Varianten-ID. +
...
| *Alternative E-Mail*
|Diese Einstellung ist nur sichtbar, wenn in der Dropdown-Liste *E-Mail und Telefonnr. übertragen* die Option *Alternative übertragen* gewählt wurde. +
Gib eine alternative E-Mail-Adresse, die an den Dienstleister übertragen werden soll, ein.
...
| *Retourengründe*
|Retourengründe von DHL Fulfillment mit den im Menü *Einrichtung » Aufträge » Auftragstypen » Retoure* angelegten <<auftraege/auftraege-verwalten#410, Retourengründen>> verknüpfen.
|====
...
* *Seriennummer*: Die am Packplatz erfassten Seriennummern werden mit der Versandmeldung (Auftragsrückmeldung) von DHL Fulfillment an plentymarkets zurückgespielt, damit die Seriennummer z.B. auf die Rechnung gedruckt und von Kund:innen für weitere Verwendungen (z.B. Dokumentation, Gutscheinfreigabe) verwendet werden kann.
...
Vor der Übertragung des Auftrags an DHL Fulfillment findet eine Prüfung der Empfängeradresse auf Richtigkeit der Form und Struktur statt. Das bedeutet: plentymarkets prüft z.B., ob alle Pflichtfelder wie beispielsweise der Name ausgefüllt wurden. +
...
Bevor du die Schnittstelle zu IDS Logistik einrichtest, registriere dich bei link:http://www.ids-logistik.de[IDS Logistik^]{nbsp}icon:external-link[].
...
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#tabelle-schnittstelle-ids-logistik>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
|Gib die Depotnummer wie von IDS Logistik erhalten ein. Standard: 800
...
|Gib die 4-stellige Sendungsnummer wie von IDS Logistik erhalten ein.
...
Gehe wie im Folgenden beschrieben vor, um die Schnittstelle zu iLOPACK einzurichten. Unterhalb von <<#tabelle-schnittstelle-ilopack>> wird beschrieben, wie du die <<fulfillment/versand-vorbereiten#datenuebergabe-ilopack, Datenübergabe zu iLOPACK einrichtest>>.

[.instruction]
Schnittstelle einrichten:

. Öffne das Menü *Einrichtung » Aufträge » Versand » Fulfillment » iLopack*.
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#tabelle-schnittstelle-ilopack>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
| *iLopack-User-ID*
|Gib die User-ID wie von iLOPACK erhalten ein.
...
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#tabelle-datenuebergabe-ilopack>>.
...
| *Mandant (Shop)*
|Wähle einen Mandant (Shop) oder *ALLE*.
...
|Stelle den Auftragsstatus, in den die Daten nach der Datenübergabe wechseln sollen.
|====
