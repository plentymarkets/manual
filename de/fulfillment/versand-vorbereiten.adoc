...
|<<fulfillment/versand-vorbereiten#2900, DHL Shipping (Versenden) und DHL Intraship/Versenden>>
|Für Händler innerhalb Deutschlands. Versand: international.
...
[#2900]
=== DHL Shipping (Versenden) und DHL Intraship/Versenden

Um weitere Informationen zum Einrichten des DHL Shipping (Versenden)-Plugins zu erhalten, klicke auf *Plugin*. Um weitere Informationen zur alten Schnittstelle DHL Intraship/Versenden zu erhalten, klicke auf *Alte Integration*.
...
+
--
Nutze über die Schnittstelle zum DHL Geschäftskundenportal die Funktion *Versenden*. Das Plugin *DHL Shipping (Versenden)* steht dir kostenlos im link:https://marketplace.plentymarkets.com/plugins/integration/dhlshipping_4871[plentyMarketplace^] zur Verfügung.
...
======
Kaufe dir das Plugin *DHL Retoure Online* kostenlos im link:https://marketplace.plentymarkets.com/plugins/integration/dhlretoureonline_6714[plentyMarketplace^] und installiere es in einem Plugin-Set. Der *DHL Retoure Online*-Assistent ist dann im Menü *Einrichtung » Assistenten* im Bereich *Integrationen* sichtbar.
======
...
====
Hermes schaltet die ProfiPaketService-Schnittstelle zum 31.03.2020 ab. Stelle daher jetzt auf *Hermes Shipping Interface* um. Lade dir das Plugin kostenlos im link:https://marketplace.plentymarkets.com/plugins/integration/hermesshippinginterface_5437[plentyMarketplace^] herunter.
====
...
Bevor du die Schnittstelle zu IDS Logistik einrichtest, registriere dich bei link:http://www.ids-logistik.de[IDS Logistik^].
