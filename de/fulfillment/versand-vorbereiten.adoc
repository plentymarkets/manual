...
. Öffne das Menü *System » Systemeinstellungen » Aufträge » Versand » Optionen » Tab: Lieferländer » Tab: Übersicht*.
. Nimm die Einstellungen vor. Beachte dazu die Erläuterungen in <<tabelle-uebersicht-lieferlaender>>.
...
. Öffne das Menü *System » Systemeinstellungen » Aufträge » Versand » Optionen » Tab: Lieferländer » Tab: Filter*.
. Nimm die Einstellungen vor. Beachte dazu die Erläuterungen in <<tabelle-filter-lieferlaender>>.
. Klicke auf *Suchen*. +
...
. Öffne das Menü *System » Systemeinstellungen » Aufträge » Versand » Optionen » Tab: Regionen*.
...
. Öffne das Menü *System » Systemeinstellungen » Aufträge » Versand » Optionen » Tab: Versanddienstleister*.
. Nimm die Einstellungen im Tab *Filter* vor. Beachte dazu die Erläuterungen in <<tabelle-filter-versanddienstleister>>.
. Klicke auf *Suchen*. +
...
====
Wenn du in deinem plentymarkets System mehrere eBay-Konten aktiviert hast, kannst du für jedes eBay-Konto ein eigenes Versandprofil festlegen. Die Konten kannst du dann unter der Option *eBay-Konto* im Menü *System » Systemeinstellungen » Aufträge » Versand » Optionen » Tab: Versandprofile » Tab: Base* wählen.
====
...
Wenn dann bei mindestens einem der Artikel kein Versandprofil aufgrund von gesetzten Filtern und Einschränkungen (z.B. gesperrte Zahlungsarten) greift, ist diese Ermittlung der Versandprofilermittlung lückenhaft.
...
Die Fehlermeldung sowie die Übersetzung für den Code 53 kannst du im Menü *System » Systemeinstellungen » Einstellungen » Mandant » Global » Sprachpakete* im Bereich *Fehlermeldungen* anpassen. +
Wenn du die Fehlermeldung im Menüpunkt *Sprachpakete* angepasst hast, solltest du diese auch im Menü *CMS » Mehrsprachigkeit* für das Ceres-Plugin anpassen. Klappe dazu den Bereich *Benachrichtigungen* auf und gib die Übersetzung für den Punkt *notificationsCalculatedShippingFailed* ein.
====
...
. Öffne das Menü *System » Systemeinstellungen » Aufträge » Versand » Optionen » Tab: Versandkosten berechnen*.
...
. Klappe das Untermenü *DHL Intraship-Exportdokumente erzeugen* auf.
...
Erzeuge nun die CSV-Datei in den Prozessen oder im Menü *Aufträge » Versand-Center » Tab: Polling*. Speichere Datei und lade sie im DHL Geschäftskundenportal hoch.
...
DHL Retoure Online ermöglicht das Erzeugen von Retourenetiketten für Aufträge aus verschiedenen Lieferländern. Die Etiketten sind dann im Menü *Aufträge » Versand-Center » Tab: Retoure* verfügbar. Du kannst deinem Kunden das Etikett auch im *Mein Konto*-Bereich des Webshops zur Verfügung stellen oder dem Kunden das Etikett über eine Ereignisaktion automatisch per E-Mail senden.
...
Beachte die Meldungen zu Sendungen, die du später über das <<fulfillment/versand-center#700, Versand-Center>> bei DPD Cloud Webservice anmeldest. Diese Meldungen findest du im Menü *Daten » API-Log » Tab: Versand Center API-Log*. Weitere Informationen zu den API-Log-Einträgen von DPD Cloud Webservice findest du auf der Handbuchseite <<daten/api-log#, API-Log>>.
...
. Klappe den Bereich *Royal Mail Einstellungen* auf.
...
. Öffne das Menü *System » Systemeinstellungen » Aufträge » Versand » Dienstleister » NetDespatch*.
. Klappe den Bereich *UK Mail Einstellungen* auf.
...
Richte anschließend das Versandprofil im Menü *System » Systemeinstellungen » Aufträge » Versand » Optionen » Tab: Versandprofile* ein. Wie du dazu vorgehst, ist im Kapitel <<fulfillment/versand-vorbereiten#1000, Versandprofil erstellen>> beschrieben.
