...
. Verwenden Sie die Pfeile, um die markierten Lieferländer in das Fenster *Ausgewählte Länder* zu verschieben. Die Doppelpfeil-Schaltflächen verschieben alle Länder eines Fensters in das andere Fenster.
...
|*Abrechnungsnummern*
|Gemäß des DHL-Vertrages Abrechnungsnummern eingeben. Pro Abrechnungsnummer können eigene Absenderdaten gepflegt werden. Die 14-stellige DHL Intraship/Versenden-Abrechnungsnummer setzt sich folgendermaßen zusammen: +
