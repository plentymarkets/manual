...
======
Wir empfehlen, das Plugin *DHL Retoure Online* kostenlos im link:https://marketplace.plentymarkets.com/plugins/integration/dhlretoureonline_6714[plentyMarketplace^] zu kaufen. Installiere es dann in einem Plugin-Set. Der *DHL Retoure Online*-Assistent ist dann im Menü *Einrichtung » Assistenten* sichtbar.
======
