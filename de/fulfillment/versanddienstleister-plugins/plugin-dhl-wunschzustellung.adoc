...
====
Das Einbinden der DHL Wunschzustellung-Services wird über ein Plugin integriert. Um die DHL Wunschzustellung-Services nutzen zu können, lade das Plugin im link:https://marketplace.plentymarkets.com/plugins/integration/dhlwunschzustellung_5435[plentyMarketplace^]{nbsp}icon:external-link[] herunter.
...
* link:https://marketplace.plentymarkets.com/plugins/integration/DHLWunschzustellung_5435[DHL Wunschzustellung^]{nbsp}icon:external-link[]
