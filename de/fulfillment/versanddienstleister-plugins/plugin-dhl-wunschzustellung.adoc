...
Du benötigst außerdem die Plugins link:https://marketplace.plentymarkets.com/dhlshipping_4871[DHL Shipping (Versenden)^]{nbsp}icon:external-link[], link:https://marketplace.plentymarkets.com/ceres_4697[Ceres^]{nbsp}icon:external-link[] und link:https://marketplace.plentymarkets.com/io_4696[IO^]{nbsp}icon:external-link[].
====
...
* link:https://marketplace.plentymarkets.com/ceres_4697[Ceres^]{nbsp}icon:external-link[]
