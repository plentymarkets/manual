...
[TIP]
Jeder Artikel ist einem Lager zugeordnet. Es ist wichtig, dass du dieses Lager auch im Assistenten wählst. Ansonsten erscheint eine Fehlermeldung, dass keine Verbindung zwischen Lager und Land gefunden werden konnte: `No settings found for the warehouse x and country y`.
