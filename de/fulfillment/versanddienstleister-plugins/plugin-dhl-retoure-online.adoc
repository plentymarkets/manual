...
Sobald du das Plugin wie oben im aufklappbaren Bereich *Erste Schritte und Anforderungen* beschrieben installiert und das Plugin-Set gespeichert und bereitgestellt hast, ist der Assistent im Menü *Einrichtung » Assistenten* im Bereich *Integration* sichtbar und du kannst mit dem Einrichten beginnen.
...
Es ist möglich, DHL Retoure Online-Labels  auch für Retouren aus der Schweiz zu generieren. Das CN23-Formular wird beim Anmelden der Retoure dann als PDF-Datei hinzugefügt.
