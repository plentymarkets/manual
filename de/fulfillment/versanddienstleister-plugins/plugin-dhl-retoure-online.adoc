...
Weitere Informationen zum Erstellen von E-Mail-Vorlagen findest du auf der Handbuchseite <<crm/emailbuilder-testphase#, EmailBuilder>>.
--

Vorgehensweise über die "alten" Vorlagen im Mandant::
+
--
Erstelle die E-Mail-Vorlage im Menü *Einrichtung » Mandant » [Mandant wählen] » E-Mail » Vorlagen* Beachte:
