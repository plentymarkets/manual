...
== Vorbereitende Einstelllungen vornehmen
...
//Supporter fragen, welcher Typ das Lager haben soll und ob sonst noch auf etwas geachtet werden muss

Weitere Informationen zum Einrichten des Lagers findest du auf der Handbuchseite <<warenwirtschaft/lager-einrichten#, Lager einrichten>>.

[discrete]
=== Lieferländer aktivieren

// https://forum.plentymarkets.com/t/dhl-umstellung-der-retoure-online-auf-das-neue-plugin-dhl-retoure-online-switching-from-the-old-integration-to-our-plugin/597709
...
In diesem Schritt gibst du die Zugangsdaten des Benutzers ein, der im DHL Geschäftskundenportal (GKP) für Retouren freigeschaltet ist.
