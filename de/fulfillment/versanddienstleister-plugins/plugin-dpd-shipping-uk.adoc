...
[IMPORTANT]
.DPD Shipping UK-Plugin installieren
====
...
** Wenn du den Assistenten abschließt, wird das Plugin automatisch im Hintergrund heruntergeladen und installiert. Sobald dieser Vorgang abgeschlossen ist, steht dir das Menü *Einrichtung » Aufträge » Versand » DPD Shipping UK* zum Einrichten der Schnittstelle zur Verfügung.
