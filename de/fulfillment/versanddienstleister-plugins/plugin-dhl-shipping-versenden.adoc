...
====
Die Schnittstelle zu DHL Versenden wird über ein Plugin integriert. Um das DHL Versenden-Plugin nutzen zu können, lade das Plugin im link:https://marketplace.plentymarkets.com/plugins/integration/dhlshipping_4871[plentyMarketplace^]{nbsp}icon:external-link[] herunter.
====

[#bei-dhl-registrieren]
== Bei DHL registrieren

Um die Schnittstelle für DHL Versenden in deinem plentymarkets System einzurichten und die Funktion _Versenden_ im DHL Geschäftskundenportal zu nutzen, musst du bei link:https://www.dhl.de/de/geschaeftskunden/paket/kunde-werden/angebot-dhl-geschaeftskunden-online.html?cid=c_dhl.de_ke_Z353_20190016_5902_A3045[DHL^]{nbsp}icon:external-link[] registriert sein. Du erhältst von DHL die Daten, die du für die Einstellungen in plentymarkets benötigst.

[#dhl-shipping-versenden-einrichten]
== DHL Versenden in plentymarkets einrichten

[TIP]
.DHL Versenden mit Hilfe von Assistenten einfach einrichten
====
Die Schnittstelle zu DHL Versenden wird über ein Plugin integriert. Um das DHL Versenden-Plugin nutzen zu können, lade das Plugin im link:https://marketplace.plentymarkets.com/plugins/integration/dhlshipping_4871[plentyMarketplace^]{nbsp}icon:external-link[] herunter. +
 ...
 ** Das DHL Versenden-Plugin muss im link:https://marketplace.plentymarkets.com/plugins/integration/dhlshipping_4871[plentyMarketplace^]{nbsp}icon:external-link[] heruntergeladen worden sein, damit es dir hier angezeigt wird.
...
Die folgende Tabelle listet alle Produkte und Services auf, die aktuell über das Plugin *DHL Versenden* zur Verfügung stehen.
