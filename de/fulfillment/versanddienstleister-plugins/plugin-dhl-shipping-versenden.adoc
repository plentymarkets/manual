...
In diesem Schritt speicherst du deine Zugangsdaten zum DHL Geschäftskundenportal. Du hast die Möglichkeit, mehrere Zugangsdaten zu speichern, wenn du z.B. mehrere Mandanten (Shops) hast und/oder mehr als einen Vertrag mit DHL abgeschlossen hast. Im zweiten Assistenten *DHL Shipping (Versenden): Einstellungsverknüpfung* kannst du diese Daten dann verknüpfen.
...
Wenn du im DHL Shipping (Versenden)-Versandprofil im Menü *Einrichtung » Aufträge » Versand » Optionen* im Tab *Versandprofile* die Option *Einwilligung zur Datenübermittlung* aktiviert hast, wird deinen Kund:innen im Checkout deines Ceres-Webshops eine Checkbox angezeigt. Deine Kunden können dann entscheiden, ob sie der Übertragung ihrer Daten an den Versanddienstleister zustimmen oder nicht.

* Wenn Kund:innen der Übertragung der Daten zustimmen, wird die E-Mail-Adresse der Kund:innen an den Versanddienstleister übertragen.
* Wenn Kund:innen der Übertragung der Daten _nicht_ zustimmen, wird die alternative E-Mail-Adresse, die du im Versandprofil eingegeben hast, übertragen.
* Wenn Kund:innen der Übertragung der Daten _nicht_ zustimmen und du keine alternative E-Mail-Adresse im Versandprofil eingegeben hast, wird eine Fehlermeldung angezeigt und der Auftrag kann nicht bei DHL angemeldet werden. +
...
Damit du deinen Kund:innen den Warenpost-Service anbieten kannst, musst du die folgenden Einstellungen vornehmen:
...
Um das DHL Shipping-Plugin nutzen zu können, müssen für Benutzer:innen mit dem Zugang *Backend* im Benutzerkonto bestimmte Bereiche aktiviert werden.

Beachte außerdem, dass die Funktion *Versenden* für den Benutzer:innen im DHL Geschäftskundenportal freigeschaltet sein muss.
