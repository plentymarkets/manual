...
* Return immediately, 2nd attempt of delivery, Verpackungsrücknahme, Unzustellbarkeitsnachricht (bei Wahl von DHL Paket National, Produkt 01) +
* immediate, after deadline abandonment (bei Wahl von DHL Paket International, Produkt 53) +
