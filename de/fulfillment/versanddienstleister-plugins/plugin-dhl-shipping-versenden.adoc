...
Möchtest du, dass dein Firmenlogo auf dem Versandlabel angezeigt wird? Gib dazu deine Absenderreferenz in das entsprechende Feld ein und lade dein Firmenlogo im DHL Geschäftskundenportal in der Absenderadresse hoch.
...
* `1234567890` ist die Kundennummer (EKP)
