...
* Damit die Maße nicht überschritten werden, kannst du eine der beiden Optionen nutzen, die in den Versandpaketeinstellungen im Menü *Einrichtung » Aufträge » Versand » Versandpakete* unter *Volumenangaben* eingerichtet werden können
