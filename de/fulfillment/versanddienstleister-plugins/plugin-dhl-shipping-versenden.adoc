...
Auch für dieses Plugin steht dir ein Assistent mit dem Namen *DHL Wunschpaket* im Menü *Einrichtung » Assistenten* im Bereich *Integration* zur Verfügung, damit du deine Services schnell und einfach einrichten kannst. Weitere Informationen findest du auf der Handbuchseite <<fulfillment/versanddienstleister-plugins/plugin-dhl-wunschpaket#, DHL Wunschpaket>>.
====
