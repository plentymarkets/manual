...
====
Die Schnittstelle zu DPD Versand-Services-Plugin wird über ein Plugin integriert. Durchlaufe den *Integrationen*-Assistenten im Menü *Einrichtung » Assistenten » Erste Schritte*, um das Plugin *DPD Versand-Services-Plugin* einfach und schnell zu installieren. +
...
* Erstelle den <<fulfillment/versand-vorbereiten#800, Versanddienstleister>> *DPD Versand-Services*.
** Versanddienstleister kannst du aktuell nur im Backend und _nicht_ über einen Assistenten erstellen.

* Erstelle <<fulfillment/versand-vorbereiten#1000, Versandprofile>> und <<fulfillment/versand-vorbereiten#1500, Portotabellen>> für *DPD Versand-Services*. +
...
Weitere Informationen findest du auf der Handbuchseite <<fulfillment/versand-center#retourenetikett-abrufen, Versand-Center nutzen>>.
--
