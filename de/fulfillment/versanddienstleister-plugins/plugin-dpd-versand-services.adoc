...
Sobald du das <<plugins/hinzugefuegte-plugins-installieren#plugin-installieren, Plugin in einem Plugin-Set installiert>> hast, sind die beiden DPD-Assistenten im Menü *Einrichtung » Assistenten* im Bereich *Integration* sichtbar. Du kannst mit dem Einrichten beginnen.
