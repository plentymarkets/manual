...
=== Assistent *DPD Versand-Services: Grundeinstellungen*
...
Klicke auf die Schaltfläche icon:toggle-off[role="red"] *Möchtest du weitere Zugangsdaten hinzufügen?*, um weitere Zugangsdaten hinzuzufügen.
...
Klicke auf die Schaltfläche icon:toggle-off[role="red"] *Möchtest du weitere Zugangsdaten hinzufügen?*, um weitere Absenderadressen hinzuzufügen. Du kannst bis zu 20 Absenderadressen hinzufügen.
...
=== Assistent *DPD Versand-Services: Einstellungsverknüpfung*
...
In diesem Assistenten verknüpfst du die Einstellungen, die du zuvor in den Assistenten *Versandeinstellungen* und *DPD Versand Services: Grundeinstellungen* vorgenommen hast.

Du verknüpfst die Versandeinstellung mit den Zugangsdaten, Versandarten und Services und der Absenderadresse.
