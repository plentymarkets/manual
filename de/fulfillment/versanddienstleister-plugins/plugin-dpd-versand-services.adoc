...
In diesem Schritt gibst du im Bereich *Zugangsdaten* deine Zugangsdaten für DPD Deutschland ein. Dies sind jeweils die Delis ID und das dazugehörige Passwort.
