...
Aktiviere die Option *ParcelShopFinder nutzen* (icon:toggle_on[set=material, role=skyBlue]), wenn du deinen Kund:innen den ParcelShopFinder in deinem plentyShop anbieten möchtest.
