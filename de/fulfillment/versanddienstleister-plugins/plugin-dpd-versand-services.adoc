...
Klicke auf die Schaltfläche icon:toggle-off[role="red"] *Möchtest du eine weitere Absenderadresse hinzufügen?*, um weitere Absenderadressen hinzuzufügen. Du kannst bis zu 20 Absenderadressen hinzufügen.
