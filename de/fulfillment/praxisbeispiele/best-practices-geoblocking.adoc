...
Ganz grob bedeutet dies, dass Kund:innen, die online Artikel bestellen möchten, nicht aufgrund ihres Wohnsitzes unterschiedlich behandelt oder gar vom Kauf der Artikel ausgeschlossen werden darf.
...
====
Für Ceres: Die Fehlermeldungen können im Menü *CMS » Mehrsprachigkeit* im Bereich *Ceres » Benachrichtigungen* angepasst werden Der Key heißt '
`notificationsCalculateShippingFailed`. +
Für Callisto: Die Fehlermeldungen können im Menü *Einrichtung » Mandant » Global » Sprachpakete* angepasst werden.
====

Eine Anpassung der Fehlermeldung für Ceres-Webshops wird im Menü *CMS » Mehrsprachigkeit* und dort im Bereich *Ceres » Benachrichtigungen* vorgenommen. Der Key dazu heißt `notificationsCalculateShippingFailed`.
...
.Ceres: Fehlermeldung unter Mehrsprachigkeit anpassen
...
Unter *Einrichtung » Artikel » Verkaufspreise* solltet ihr kontrollieren, ob ein gültiger Verkaufspreis vorhanden ist, damit Käufer:innen Artikel in den Warenkorb legen können.
