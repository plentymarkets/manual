...
====
Für plentyShop LTS: Die Fehlermeldungen können im Menü *CMS » Mehrsprachigkeit* im Bereich *plentyShop LTS » Benachrichtigungen* angepasst werden Der Key heißt '
