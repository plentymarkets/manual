...
====
Die Schnittstelle zu CLC wird über ein Plugin integriert. Um das CLC-Plugin nutzen zu können, lade das Plugin im link:https://marketplace.plentymarkets.com/CLC-Fulfillment_7015[plentyMarketplace^]{nbsp}icon:external-link[] herunter.
====
