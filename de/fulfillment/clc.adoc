...
Um die Schnittstelle für CLC in deinem plentymarkets System einzurichten, musst du bei link:https://www.tietjegroup.com/kontakt/[CLC^]{nbsp}icon:external-link[] registriert sein. Schreibe einfach eine E-Mail an mailto:email[kontakt@tietjegroup.com].
