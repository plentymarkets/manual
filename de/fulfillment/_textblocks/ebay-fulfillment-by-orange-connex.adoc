...
|Outbound-Auftrag unzustellbar
|Wenn sich der Outbound-Auftrag in diesem Status in deinem plentymarkets System befindet, konnte der Outbound-Auftrag nicht zugestellt werden. +
Ein Grund für die Unzustellbarkeit könnte eine inkorrekte Adresse sein.
