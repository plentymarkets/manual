...
Wenn du bereits die eBay Fulfillment-Lösung mit Fiege nutzt, beachte die folgenden Punkte und prüfe die Einstellungen in deinem plentymarkets System:
...
* icon:exclamation-triangle[role="red"] Die bisher verwendete Auftragsherkunft für die eBay Fulfillment-Lösung mit Fiege sollte jedoch _nicht_ deaktiviert werden, bis der Umzug der Waren abgeschlossen ist.
...
* icon:exclamation-triangle[role="red"] Die bisher verwendete Verfügbarkeit für die eBay Fulfillment-Lösung mit Fiege sollte jedoch _nicht_ entfernt werden, bis der Umzug der Waren abgeschlossen ist.
...
Erstelle einen neuen Auftragsstatus oder wähle einen bestehenden Auftragsstatus für die folgenden Reaktionen:
...
Ein Grund für die fehlgeschlagene Übermittlung ist z.B.:

* der Straßennname hat zu viele Zeichen

Logge dich in das Orange Connex-Portal ein und behebe den Fehler dort, damit der Auftrag korrekt übermittelt werden kann.
