...
Neben der Möglichkeit, größere Mengen an Paketnummern komfortabel über den <<fulfillment/dokumente-erzeugen#paketnummern-elasticsync, ElasticSync>> in dein System zu importieren, kannst du dies auch <<fulfillent/dokumente-erzeugen#paketnummern-manuell-importieren, manuell>> oder mit Hilfe eines <<fulfillment/dokumente-erzeugen#paketnummern-barcodescanner, Barcodescanners>> erledigen.

[#paketnummern-elasticsync]
=== Paketnummern mit dem ElasticSync importieren

Der einfachste Weg, um Paketnummern in dein plentymarkets System zu importieren, ist der ElasticSync. Erstelle dazu einen Sync vom Typ *Aufträge*. Beachte dazu bitte unser <<daten/daten-importieren/elasticsync-best-practices/best-practices-elasticsync-paketnummern-fulfillment#, Best Practice: Paketnummern von Versanddienstleistern importieren>>.
...
.Einstellungen im Menü *Einrichtung » Aufträge » Dokumente » Adressetikett*
[cols="1,3"]
|====
|Einstellung |Erläuterung
