...
| *Kunden-ID*
|Eine oder mehrere Kunden-IDs eingeben. Adressetiketten werden dann ausschließlich für die eingegebenen Kund:innen generiert. Mehrere IDs kommagetrennt eingeben.
