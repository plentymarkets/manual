...
.Einstellungen im Menü *Aufträge » Fulfillment* im Bereich *Lieferanschriftenliste*
[cols="1,3"]
|====
...
.Einstellungen im Menü *Aufträge » Fulfillment* im Bereich *Adressetiketten*
[cols="1,3"]
|====
|Einstellung |Erläuterung
...
.Einstellungen im Menü *Aufträge » Fulfillment* im Bereich *Einlieferungsliste*
[cols="1,3"]
|====
|Einstellung |Erläuterung
