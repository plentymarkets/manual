...
. Erzeugen Sie eine oder mehrere Rechnungen. Beachten Sie dazu die Erläuterungen auf der Handbuchseite <<auftraege/fulfillment/rechnungen-erzeugen#, **Rechnungen erzeugen**  >>.
. Erstellen Sie aus diesen Rechnungen eine Packliste aller Aufträge, die nun verpackt werden müssen. Beachten Sie dazu die Erläuterungen auf der Handbuchseite <<auftraege/fulfillment/packliste#, **Packliste**  >>.
...
Richten Sie im Menü **Einstellungen » Aufträge » Ereignisaktionen** eine Ereignisaktion ein und wählen Sie für das Ereignis **Auftragsänderung &gt; Paketnummer** die Aktion **Auftrag &gt; Warenausgang buchen**. Zudem können Sie Ihren Kunden eine E-Mail-Vorlage mit der Paketnummer und einem Link zu Paketverfolgung senden. Weitere Informationen zu Ereignisaktionen finden Sie auf der Handbuchseite <<auftraege/einstellungen/ereignis-aktionen#, **Ereignisaktionen**  >>.
...
Wenn Sie bereits eine Adressetikettenvorlage erstellt und eine PDF-Vorlage hinterlegt haben, fahren Sie fort mit Kapitel <<fulfillment/dokumente-erzeugen#700, **Adressetikett erzeugen** >>.
...
|**Artikelauflistung**
|Die Artikelauflistung bestimmt, wie die Artikeldaten auf dem Etikett angezeigt werden. Es gibt zwei Typen: **Standard** und **Individuell**. Eine Erläuterung zu diesen beiden Typen finden Sie im Kapitel <<fulfillment/dokumente-erzeugen#600, **Artikelauflistung** >>.
