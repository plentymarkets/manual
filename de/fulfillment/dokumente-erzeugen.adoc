...
| *Kundeneigenschaften*
|Die Koordinaten zur Positionierung der Kundeneigenschaften eingeben. Die <<crm/kontakte-verwalten#950, Eigenschaft>> aus der Dropdown-Liste wählen. Auf den Adressetiketten wird der Text angezeigt, der im Menü *CRM » Kontakte* » _Kontakt öffnen_ » *Ansicht: Eigenschaften* gespeichert wurde.
