...
. Öffne das Menü *Aufträge » Fulfillment*.
. Klappe den Bereich *Adressetiketten* auf.
. Nimm die Einstellungen vor. Beachte dazu die Erläuterungen in <<tabelle-adressetikett-erzeugen>>.
. Klicke auf das Zahnrad. +
...
. Klicke auf das Zahnrad, um die Einlieferungsliste zu generieren. +
