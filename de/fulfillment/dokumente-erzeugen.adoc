...
. Erzeugen Sie eine oder mehrere Rechnungen. Beachten Sie dazu die Erläuterungen auf der Handbuchseite <<auftraege/auftragsdokumente/rechnungen-erzeugen#, Rechnungen>>.
...
*_Beispiel:_* Ein verbreitetes Anwendungsbeispiel ist das Speichern des Absenders.
|====
