...
In den folgenden Unterkapiteln findest du Fehlermeldungen, die von UPS an plentymarkets über die Schnittstelle zurückgesendet werden. Die möglichen Lösungen zu diesen Fehlermeldungen findest du direkt im jeweiligen Kapitel.
...
image::fulfillment/assets/UPS_Versandprofil.png[width=640, height=360]
...
image::fulfillment/assets/UPS_Portotabelle.png[width=640, height=360]
