...
--
* Versanddienstleister UPS und Deutsche Post DHL (<<fulfillment/ebay-fulfillment#80, Link zum Kapitel>>)
* Automatische Lagerzuordnung (<<fulfillment/ebay-fulfillment#290, Link zum Kapitel>>)
* Stornieren von Inbound-Aufträgen (<<fulfillment/ebay-fulfillment#270, Link zum Kapitel>>)
* Status "Abgelehnt" (<<fulfillment/ebay-fulfillment#190, Link zum Kapitel>>)
--
...
→ *_Tipp:_* Wenn du bereits ein Versandprofil mit diesem Versanddienstleister eingerichtet hast, verwende zur einfacheren Unterscheidung einen anderen Namen, z.B. *eBay Fulfillment* _plus Name des Versanddienstleisters_.
...
.Versanddienstleister erstellen am Beispiel von Hermes
