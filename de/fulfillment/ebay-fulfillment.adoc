...
Stelle sicher, dass für alle Versanddienstleister, die für das eBay Fulfillment-Programm eingesetzt werden, ein Versanddienstleister sowie ein Versandprofil eingerichtet sind. Aktuell wird Hermes als Fulfillment-Dienstleister eingesetzt.

[IMPORTANT]
.Versandprofil und Versanddienstleister erstellen
====
Für jeden neuen Fulfillment-Dienstleister muss sowohl ein neuer Versanddienstleister als auch ein neues Versandprofil vorhanden sein. Aktuell wird Hermes als Fulfillment-Dienstleister für das eBay Fulfillment-Programm eingesetzt.
====
...
Im plentymarkets Backend im Menü *Einrichtung » Aufträge » Versand » Optionen » Tab: Versanddienstleister* muss ein Versanddienstleister, z.B. Hermes, erstellt und dessen Tracking-URL gespeichert sein.
...
→ *_Tipp:_* Wenn du bereits ein Hermes-Versandprofil mit diesem Versanddienstleister eingerichtet hast, verwende zur einfacheren Unterscheidung einen anderen Namen, z.B. *eBay Fulfillment* _plus Name des Versanddienstleisters_.
