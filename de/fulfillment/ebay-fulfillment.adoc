...
<<bild-ebay-konto-token-aktualsieren>> zeigt, wie du den Token für das eBay-Konto im Menü *Einrichtung » Märkte » eBay » Konten* aktualisierst.

[[bild-ebay-konto-token-aktualsieren]]
.Token im eBay Konto aktualisieren
image::fulfillment/assets/eBay-Konten-Token.png[width=640, height=360]

<<bild-ebay-oauth2-konto-token-aktualsieren>> zeigt, wie du den Token für das eBay OAuth2-Konto im Menü *Einrichtung » Märkte » eBay » Konten » OAuth2* aktualisierst.

[[bild-ebay-oauth2-konto-token-aktualsieren]]
