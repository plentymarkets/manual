...
. Die Option *Automatische Zuordnung des eBay Fulfillment Lagers* ist standardmäßig aktiviert. Wenn ein neuer eBay-Auftrag in dein plentymarkets System importiert wird, wird geprüft, ob Artikelbestand im eBay Fulfillment-Lager vorhanden ist. Wenn Bestand vorhanden ist, wird automatisch das eBay Fulfillment-Lager für die Auftragspositionen zugeordnet. +
*_Hinweis:_* Entferne den Haken bei dieser Option, wenn das eBay Fulfillment-Lager nicht automatisch zugeordnet werden soll.
