...
Melde dich bei PayPal an und prüfe über diesen link:https://www.paypal.com/businessprofile/mysettings[Link^], ob die korrekte Zeitzone eingestellt ist. Hier sollte *(GMT+01:00) Mitteleuropäische Zeit (Berlin, Paris, Rom)* angezeigt werden.

[#760]
==== Immediate Payment Notifications

Melde dich bei PayPal und prüfe über diesen link:https://www.paypal.com/cgi-bin/customerprofileweb?cmd=_profile-ipn-notify[Link^], ob die Immediate Payment Notifications aktiviert sind. Wenn die Funktion aktiviert ist, trage dort die URL deines plentymarkets Systems ein.
