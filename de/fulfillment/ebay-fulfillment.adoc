...
Nachdem du von eBay freigeschaltet wurdest, kaufe das link:https://marketplace.plentymarkets.com/plugins/integration/ebayfiege_6018[eBay Fulfillment-Plugin2] kostenlos im plentyMarketplace und installiere es. Gehe dazu genauso vor, wie in der Handlungsanweisung in Kapitel <<fulfillment/ebay-fulfillment#20, eBay OAuth2-Plugin kaufen und installieren>> beschrieben.
