...
In einem offenen Versandauftrag kannst du Versandpakete bearbeiten, hinzufügen oder löschen. Die Kundendaten des Empfängers bearbeitest du im Menü <<crm/kontakte-verwalten#300, CRM » Kontakte>>. Wenn du im Versandauftrag auf die ID des Kunden klickst, wird der Kundendatensatz geöffnet.
...
. Klicke im Tab *Versandpakete* auf den Stift (icon:pencil[role="yellow-background"]), um den Versandauftrag zu bearbeiten.
