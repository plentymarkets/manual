...
====
Als Alternative zur Auftragszusammenfassung eines Tages im Menü *Aufträge » Versand-Center » Tab: Zusammenfassung* können Sie einen <<daten/export-import/daten-exportieren#, dynamischen Datenexport>> durchführen. Nutzen Sie dazu das Datenformat <<daten/export-import/datenformate/order#, Order>> und filtern Sie nach Versanddienstleister und Datum. Mit dem Datenfeld *PackageNo* wird z.B. die Paketnummer exportiert.
====
