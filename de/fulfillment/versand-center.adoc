...
//*_Hinweis:_* Wenn ein Benutzer mit dem Zugang *Backend* die Filteroption *ALLE* wählt, werden ihm trotzdem nur die Aufträge angezeigt, deren Status für ihn im Benutzerkonto als *sichtbare Auftragsstatus* ausgewählt sind.
