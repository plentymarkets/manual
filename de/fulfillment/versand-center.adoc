...
*_Wichtig:_* Die Anzahl der Versandpakete im Menü *Aufträge » Aufträge bearbeiten* » _Auftrag öffnen_ im Tab *Einstellungen* hat keinen Einfluss auf die hier hinterlegten Pakete und wird bei Änderungen nicht angepasst. Daher die Anzahl der Pakete ausschließlich im Versand-Center ändern.
...
. Klicke auf den Stift im Tab *Versandpakete* (icon:pencil[role="yellow-background"]). +
