...
Im Menü **Aufträge » Versand-Center » Tab: Anmelden** melden Sie Ihre Aufträge bei einem Versanddienstleister an und übertragen diese gleichzeitig an den Dienstleister. Voraussetzung für die Anmeldung ist, dass Sie zuvor im Tab **Suche****<<fulfillment/versand-center#100, Aufträge gesucht >>** haben, die jetzt hier angezeigt werden. Sie haben z.B. die Möglichkeit, mithilfe der Filtereinstellungen in der Suche des Versand-Centers nur Aufträge für einen oder für alle Versanddienstleister anzuzeigen. Bei der Anmeldung erhalten Sie sowohl im Erfolgsfall als auch im Fehlerfall eine Meldung vom Versanddienstleister.
...
→ Diese Funktion kann mit einer **<<auftraege/einstellungen/ereignis-aktionen#, Ereignisaktion  >>**, die z.B. automatisch den Warenausgang bucht, kombiniert werden.
...
Es ist nicht möglich, Pakete im Auftrag im Tab <<auftraege/auftraege-bearbeiten/auftrag-aendern#40, **Einstellungen** >> hinzuzufügen. Wenn Sie weitere Pakete zu einen Auftrag hinzufügen oder die Anzahl ändern möchten, öffnen Sie den Auftrag im Versand-Center und bearbeiten Sie diesen im Tab **<<fulfillment/versand-center#400, Hinzufügen >>**.
