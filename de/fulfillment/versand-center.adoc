...
Es ist nicht möglich, Pakete im Auftrag im Tab <<auftraege/auftraege-verwalten#auftrag-aendern-40, Einstellungen>> hinzuzufügen. Wenn Sie weitere Pakete zu einen Auftrag hinzufügen oder die Anzahl ändern möchten, öffnen Sie den Auftrag im Versand-Center und bearbeiten Sie diesen im Tab <<fulfillment/versand-center#400, Hinzufügen>>.
