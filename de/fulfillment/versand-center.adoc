...
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#tabelle-versandpaket-bearbeiten>>.
...
. Öffne das Menü *Aufträge » Versand-Center*.
. Wähle aus der Dropdown-Liste *Versandstatus* die Option *angemeldet* _(Name des Versanddienstleisters)_.
. Klicke auf die Lupe (icon:search[role="blue"]). +
