...
Im Menü *Aufträge » Versand-Center » Tab: Label* haben Sie die Möglichkeit, für Ihre angemeldeten Aufträge Versandlabels zu erzeugen und diese dann anschließend zu drucken. Die Labels werden in einer PDF-Datei zum Download zur Verfügung gestellt.
...
. Öffnen Sie das Menü *Aufträge » Versand-Center.
. Wählen Sie im Tab *Suche* den angemeldeten Versandstatus aus der Dropdown-Liste *Versandstatus*.
. Klicken Sie auf die Lupe.
. Aktivieren Sie die Aufträge, für die Sie ein Label generieren möchten.
