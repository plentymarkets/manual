...
Bei Retouren, die du hier im Tab *Retoure* des Versand-Centers anmeldest und dann das Retourenetikett erhältst, wurde das Paket schon ausgeliefert und die Kund:in hat die Ware erhalten. Bei <<fulfillment/versand-vorbereiten#3100, DHL Retoure Beileger>> legst du den Paketen schon vor der Lieferung an die Kund:innen Retourenetiketten bei. Diese Beilegeretiketten werden ebenfalls im Tab *Retourenetiketten* des Versandauftrages angezeigt.
