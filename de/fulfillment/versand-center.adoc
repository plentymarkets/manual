...
====
Als Alternative zur Auftragszusammenfassung eines Tages im Menü *Aufträge » Versand-Center » Tab: Zusammenfassung* können Sie einen <<daten/daten-exportieren/elastischer-export, elastischen Export>> durchführen. Erstellen Sie dazu im Vorfeld ein Exportformat <<daten/daten-exportieren/FormatDesigner#, FormatDesigner>>. 
