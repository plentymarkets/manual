...
// Box ergänzen, die den Unterschied von zurücksetzen und stornieren erklärt. darauf achten, dass Box innerhalb der tabbing contens aus 6 = besteht, nicht aus 4.
--
...
* <<#zusammenfassung, Zusammenfassung für einzelnen Auftrag erzeugen>>
* <<#auftrag-zuruecksetzen, Einzelnen Auftrag zurücksetzen>>
* <<#auftrag-stornieren, Einzelnen Auftrag stornieren>>
* <<#versandlabel-generieren, Versandlabel generieren>>
...
// * <<#exportlabel-abrufen, Exportlabel abrufen>>
...
[#zusammenfassung]
=== Zusammenfassung für einzelnen Auftrag erzeugen
...
// Text
// Hinweis, dass das nur einzeln geht und nicht über die Gruppenfunktion
