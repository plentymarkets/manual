...
* ID
* Retouren-ID
// ist die Retouren-ID, die ID, die man vom Diensleister erhält, wenn die Retoure erfolgreich angemeldet wurde?
...
* Paketnummer
** Hier wird die Paketnummer angezeigt, die nach erfolgreicher Anmeldung des Auftrags vom Retourendienstleister zurückkommt.
...
Die Parameter wie Gewicht und Volumen werden aus den Artikeldaten ermittelt. Prüfe daher die Angaben der Versandpakete und nimm ggf. Korrekturen vor.
