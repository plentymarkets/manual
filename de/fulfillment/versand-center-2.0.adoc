...
Diese Handbuchseite beschreibt das neue Versand-Center 2.0, das im September 2021 in einer geschlossenen Betaphase veröffentlicht wurde. Geschlossene Betaphase bedeutet, dass das Versand-Center 2.0 zunächst von einer kleinen Personengruppe getestet wird. +
Sobald das Versand-Center 2.0 vollständig ausgereift ist und mögliche Fehler behoben wurden, wird die offene Betaphase beginnen.
...
Die Übersicht des Versand-Centers 2.0 zeigt standardmäßig die folgenden Spalten an:
...
Sobald du einen Auftrag markiert hast (icon:check-square[]), werden die verschiedenen Schaltflächen der Gruppenfunktion sichtbar (siehe <<#image-group-function-overview>>). Wähle mindestens 2 Aufträge aus der Liste, um die Gruppenfunktionen nutzen zu können. In <<#table-group-functions>> sind die Bedienelemente aus der Gruppenfunktion sowie deren Erläuterungen aufgelistet.
...
. Aktiviere (icon:check-square[role="blue"]) die Aufträge, die du bearbeiten möchtest.
. Klicke in der Übersicht ganz oben auf *Aufträge bearbeiten* (icon:edit[set=plenty]). +
...
. Klicke in der Übersicht ganz oben auf *Aufträge anmelden* (icon:outgoing_items[set=plenty]). +
...
. Öffne das Menü *Aufträge » Versand-Center 2.0*.
. Suche die Aufträge, für die eine Retoure anmelden möchtest, anhand der Filtereinstellungen wie im Kapitel <<#auftrag-suchen, Auftrag im Versand-Center suchen>> beschrieben. +
→  Die Aufträge, die den eingestellten Suchkriterien entsprechen, werden in der Übersicht angezeigt.
. Wähle (icon:check-square[role="blue"]) die Aufträge, für die du eine Retoure anmelden möchtest.
. Klicke auf *Retouren anmelden* (icon:order_return[set=plenty]). +
...
→ Die Aufträge werden beim Retourendienstleister angemeldet.
...
. Öffne das Menü *Aufträge » Versand-Center 2.0*.
. Suche die Aufträge, die du zurücksetzen möchtest, anhand der Filtereinstellungen wie im Kapitel <<#auftrag-suchen, Auftrag im Versand-Center suchen>> beschrieben. +
→  Die Aufträge, die den eingestellten Suchkriterien entsprechen, werden in der Übersicht angezeigt.
. Wähle (icon:check-square[role="blue"]) die Aufträge, die du zurücksetzen möchtest.
. Klicke auf *Aufträge zurücksetzen* (icon:reset[set=plenty]). +
