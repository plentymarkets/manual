...
. Öffnen Sie das Menü **<<auftraege/gutscheine#, Aufträge » Gutscheine  >>**.
. Erstellen Sie eine neue **<<auftraege/gutscheine#, Kampagne  >>**.
...
Erzeugen Sie nun die erforderlichen Gutschein-Codes. Gutschein-Codes können <<auftraege/gutscheine#10, **manuell generiert oder manuell eingetragen** >> werden.
...
. Öffnen Sie das Menü **<<payment/zahlungsarten-verwalten#, Einstellungen » Aufträge » Zahlung » Zahlungsarten  >>**.
