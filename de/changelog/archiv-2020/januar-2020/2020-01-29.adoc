...
+
In plentymarkets wird OTTO market im Menü *Einrichtung » Assistenten » Omni-Channel* mit den Assistenten *OTTO market Grundeinstellungen* und *OTTO market Kataloge* erstellen eingerichtet. Weitere Informationen findest du auf der <<maerkte/otto-market#, OTTO market-Handbuchseite>>.
