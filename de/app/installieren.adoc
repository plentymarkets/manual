...
In deiner link:https://www.plentymarkets.eu/preise/[plentymarkets Edition^]{nbsp}icon:external-link[] wird festgelegt, wie viele Benutzerkonten gleichzeitig in plentymarkets eingeloggt sein dürfen. Dieses Limit gilt für dein plentymarkets Backend und für die plentymarkets App.
