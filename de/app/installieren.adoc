...
Die App ist nur in Kombination mit link:https://www.plentymarkets.eu/gratis-testen/[einem gebuchten plentymarkets System^]{nbsp}icon:external-link[] funktionsfähig. Das heißt, dass Nutzer:innen sich mit den Login-Daten eines gültigen plentymarkets Systems anmelden müssen.
...
|Welche <<app/funktionen/kennzahlen#, Geschäftskennzahlen>> sollen deine Mitarbeiter:innen sehen können? Setze Häkchen und bestimme somit die genauen Daten, die sichtbar sein sollen.
|====
...
. Gib eine App-PIN ein. Beachte dazu die Erläuterungen in <<tabelle-app-pin>>.
...
In deinem link:https://www.plentymarkets.eu/preise/[plentymarkets Tarif^]{nbsp}icon:external-link[] wird festgelegt, wie viele Benutzerkonten gleichzeitig in plentymarkets eingeloggt sein dürfen. Dieses Limit gilt für dein plentymarkets Backend und für die plentymarkets App.
