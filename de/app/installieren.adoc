...
Die App ist nur in Kombination mit link:https://www.plentymarkets.eu/gratis-testen/[einem gebuchten plentymarkets System^]{nbsp}icon:external-link[] funktionsfähig. Das heißt, dass Nutzer:innen sich mit den Zugangsdaten eines gebuchten plentymarkets Systems anmelden müssen.
...
Die plentymarkets App ist nur in Kombination mit link:https://www.plentymarkets.eu/gratis-testen/[einem gebuchten plentymarkets System^]{nbsp}icon:external-link[] funktionsfähig. Das heißt, dass du bei der Anmeldung die Zugangsdaten deines gebuchten plentymarkets Systems eingeben musst.
...
. Gib die Zugangsdaten deines plentymarkets Systems ein. Beachte dazu die Erläuterungen in <<tabelle-app-einloggen>>.
. Tippe auf **Login**. +
...
. Bestimme, ob du beim nächsten Anmelden deine Zugangsdaten erneut eingeben möchtest oder nicht. Beachte dazu die Erläuterungen in <<tabelle-app-ausloggen>>.
