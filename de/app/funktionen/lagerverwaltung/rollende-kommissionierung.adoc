...
:author: team-mobile
:keywords: Rollende Kommissionierung, kommissionieren, mobil kommissionieren, mobile Kommissionierung, Box, Boxen, Picken, Picking, Packen, Packing
:position: 20
...
. Vergebe die *nötigen Berechtigungen*. Beachte dazu die Erläuterungen in <<tabelle-einstellungen-rechte-kommissionierung>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
|Erlaube deinem Lagerist, ein Bild vom gekauften Artikel in der App zu sehen. +
...
====
Verwende <<business-entscheidungen/benutzerkonten-zugaenge#70, Rollen>>, um mehreren Benutzern die gleichen Berechtigungen zu erteilen, ohne jedes Benutzerkonto einzeln bearbeiten zu müssen.
====

[TIP]
.Brauchen Admin-Benutzer auch diese Rechte?
====
*Admin*-<<business-entscheidungen/benutzerkonten-zugaenge#10, Benutzer>> verfügen bereits über alle Rechte und ihre Konten müssen nicht angepasst werden. *Backend*- und *REST-API*-Zugänge hingegen verfügen nicht automatisch über Rechte.
====
...
. Füge die Aktion und die Subaktion hinzu. Nimm die Einstellungen gemäß <<tabelle-aktion-subaktion-kommissionierung>> vor.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
. Nehme die Einstellungen vor. Beachte dazu die Erläuterungen in <<tabelle-einstellungen-rollende-kommissionierung>>.
...
| *Vorlage*
|Wie soll deine <<Artikel im Lager finden, Artikelliste>> aussehen? Die plentymarkets App verfügt bereits über eine Standard-Vorlage, die für die meisten Kommissionierungsprozesse geeignet ist. Du kannst allerdings auch weitere Vorlagen im Menü *Einrichtung » plenty App » Mobile Pickliste* erstellen und dann hier in dieser Dropdown-Liste auswählen. +
