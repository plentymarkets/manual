...
Konten mit Admin-Rechten haben standardmäßig die Berechtigungen, um Inventuren über die App vorzunehmen. Personen mit der Benutzerklasse *Backend* und *Logistik* musst du diese Berechtigungen erteilen.
...
. Aktiviere in der Spalte *Berechtigungen* die Berechtigung *Warenbestände » Lager » Lagerort » Anzeigen*.
. *Speichere* die Einstellungen.
