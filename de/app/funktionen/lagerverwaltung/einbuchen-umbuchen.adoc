...
:author: team-mobile
:keywords: Wareneingang, Ware einbuchen, Waren einbuchen, App, Ware umbuchen, Waren umbuchen, Umbuchung, Einbuchung, Einbuchen personalisieren, Einbuchung personalisieren, umbuchen personalisieren, Umbuchung personalisieren, Umbuchungsvorlage, Umbuchung Vorlage, Umbuchung über App, Einbuchung über App, App umbuchen, App einbuchen
:position: 30
:url: app/funktionen/lagerverwaltung/einbuchen-umbuchen

Ware kann nicht nur <<warenwirtschaft/umbuchungen-vornehmen#, im plentymarkets Backend>>, sondern auch über die plentymarkets App ein- und umgebucht werden.
...
Ware kann nicht nur <<warenwirtschaft/wareneingaenge-verwalten#, im plentymarkets Backend>>, sondern auch über die plentymarkets App eingebucht werden. Voraussetzung ist, dass App-Benutzer:innen die Berechtigung zum Einbuchen von Ware haben. Zusätzlich können Benutzer:innen auch die Berechtigung erhalten, beim Einbuchen den Einkaufspreis anzupassen. Alternativ kann automatisch entweder der im Tab **Einstellungen** der Variante gespeicherte Einkaufspreis (**EK netto**) oder der durchschnittliche Nettoeinkaufspreis eingefügt werden.
...
Benutzerkonten mit Admin-Rechten haben standardmäßig die Berechtigungen, um Einbuchungen über die App vorzunehmen. Personen mit *Backend*-Zugang musst du diese Berechtigungen erteilen.
...
|Festlegen, ob der Person mit diesem Benutzerkonto beim Einbuchen über die App der Einkaufspreis angezeigt werden.

| *Einkaufspreis (EK) bearbeiten*
|Festlegen, ob die Person mit diesem Benutzerkonto beim Einbuchen über die App den Einkaufspreis bearbeiten darf.
|====

[#300]
=== Einbuchen über die plentymarkets App personalisieren

In der plentymarkets App können Benutzer:innen weitere Einstellungen vornehmen, um den Einbuchungsvorgang zu personalisieren.
...
*_Hinweis:_* Je nach Anzahl der Lagerorte kann die Einstellung **Leere Lagerorte** das Einbuchen stark verlangsamen. Daher Varianten mit Lagerorten verknüpfen und **Leere Lagerorte** nur im Ausnahmefall aktivieren.
...
*_Tipp:_* Wenn du gelabelte Lagerorte habst, scanne stattdessen das Label des Lagerortes. Dazu bei Bluetooth-Scannern vorher in das Feld **Barcode** tippen. +
...
Ware kann nicht nur im plentymarkets Backend, sondern auch über die plentymarkets App umgebucht werden. Erteile dazu Benutzer:innen mit einem Zugang vom Typ **Backend** die nötigen Berechtigungen. Mit Umbuchungsvorlagen und App-Einstellungen passt du den Umbuchungsvorgang an deine Lagergegebenheiten an.
...
Benutzerkonten mit Admin-Rechten haben standardmäßig die Berechtigung, Umbuchungen über die App vorzunehmen. Personen mit *Backend*-Zugang musst du diese Berechtigungen erteilen.
...
Im plentymarkets Backend erstellst du beliebig viele Vorlagen für das Umbuchen über die plentymarkets App. Über diese Vorlagen definierst du die Felder und Feldanordnung, die Benutzer:innen beim Umbuchen in der App angezeigt werden.
...
| **Beschreibung**
|Beschreibung des Felds eingeben. Diese Beschreibung wird Benutzer:innen als Name des Felds angezeigt. Wenn keine Beschreibung eingegeben wird, wird keine Beschreibung angezeigt. +
...
Vorlagen werden im plentymarkets Backend im Menü **Einrichtung » plentymarkets-App » Umbuchung** erstellt.
|====
