...
:author: team-mobile
:keywords: App, plentymarkets App, Artikelsuche, App-Artikelsuche, Artikelsuche anpassen, Etikettendruck, Etiketten drucken, Drucker, Auftragssuche, Aufträge suchen, Auftragssuche anpassen, Aufträge in der App suchen, Kunden in der App suchen, Artikel in der App suchen, Artikelfilter, Filter App
...
Willst du prüfen, ob du besondere Zahlungskonditionen für bestimmte Kund:innen hinterlegt hast? Zum Beispiel, ob ein prozentualer Skontoabzug gewährt wird, wenn Kund:innen innerhalb eines bestimmten Zeitrahmens zahlen?
Die plentymarkets App macht es möglich.
...
*Aktiviert* (icon:toggle-on[role="green"]) = Es wird möglich sein, Kund:innen anhand dieses Parameters zu suchen.
