...
. Nehme die Einstellungen vor. Beachte dazu die Erläuterungen in <<table-modify-customer-search>>.
. Tippe auf das Häkchen oben rechts (icon:check[role="blue"]), um die Änderung zu bestätigen.
...
. Nehme die Einstellungen vor. Beachte dazu die Erläuterungen in <<table-modify-order-search>>.
. Tippe auf das Häkchen oben rechts (icon:check[role="blue"]), um die Änderung zu bestätigen.
