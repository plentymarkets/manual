...
. Tippe auf das erstelle Feld, um die in <<tabelle-app-kennzahlen-einstellungen>> beschriebenen Einstellungen vorzunehmen und  die Daten für die Anzeige der Kennzahl einzugrenzen.
