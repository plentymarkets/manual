...
Du willst wissen, wie viele Aufträge im aktuellen Monat eingegangen sind? Oder wie viele Erstbestellungen hinzugekommen sind? In der plentymarkets App kannst du dir die wichtigsten Kennzahlen direkt auf der Startseite anzeigen lassen.
...
Anhand des folgenden Beispiels zeigen wir dir hier die notwendigen Schritte.

=== Beispiel: Umsatz anzeigen

. Öffne die plentymarkets App.
. Tippe rechts auf den Stift und dann auf *Neue Kennzahlen hinzufügen*. +
