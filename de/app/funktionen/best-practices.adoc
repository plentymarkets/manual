...
. Tippe auf das erstelle Feld, um die in <<tabelle-app-kennzahl-einstellungen>> beschriebenen Einstellungen vorzunehmen und  die Daten für die Anzeige der Kennzahl einzugrenzen.
. Tippe auf das Häkchen oben rechts (icon:check[role="blue"]), um die Änderung zu bestätigen.

[[tabelle-app-kennzahl-einstellungen]]
