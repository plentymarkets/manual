...
|Wählen Sie den <<auftraege/auftraege-verwalten#1200, Auftragsstatus>>, in den die von der Aktion betroffenen Aufträge wechseln sollen.  Belassen Sie die Auswahl auf *---*, wenn kein Statuswechsel stattfinden soll.
...
|*atriga (Inkasso)*
|Wählen Sie die Option *AKTIV*, wenn Sie den Inkassodienstleister <<payment/atriga#, atriga>> in Ihrem plentymarkets System verwenden. Betroffene Aufträge werden dann automatisch von plentymarkets an atriga gemeldet. Belassen Sie die Auswahl auf *---*, wenn Sie atriga nicht nutzen.

|*mediafinanz*
|Wählen Sie die Option *AKTIV*, wenn Sie den Inkassodienstleister <<payment/mediafinanz#, mediafinanz>> in Ihrem plentymarkets System verwenden. Betroffene Aufträge werden dann automatisch von plentymarkets an mediafinanz gemeldet. Belassen Sie die Auswahl auf *---*, wenn Sie mediafinanz nicht nutzen.
|====
