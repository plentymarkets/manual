...
| *Lieferdatum*
|Wählen, in welcher Form das avisierte Lieferdatum einer Nachbestellung berücksichtigt wird. Hier wird das Datum berücksichtigt, das im Feld *Lieferdatum* in den Auftragsdetails einer Nachbestellung gespeichert ist. Wähle *Nachbestellung* für den Filter *Auftragstyp* aus, da dieses Datum nur in Verbindung mit Nachbestellungen nutzbar ist. +
