...
|*atriga (Inkasso)*
|Wählen Sie die Option *AKTIV*, wenn Sie den Inkassodienstleister <<payment/zahlungsanbieter/atriga#, atriga>> in Ihrem plentymarkets System verwenden. Betroffene Aufträge werden dann automatisch von plentymarkets an atriga gemeldet. Belassen Sie die Auswahl auf *---*, wenn Sie atriga nicht nutzen.

|*mediafinanz*
|Wählen Sie die Option *AKTIV*, wenn Sie den Inkassodienstleister <<payment/zahlungsanbieter/mediafinanz#, mediafinanz>> in Ihrem plentymarkets System verwenden. Betroffene Aufträge werden dann automatisch von plentymarkets an mediafinanz gemeldet. Belassen Sie die Auswahl auf *---*, wenn Sie mediafinanz nicht nutzen.
|====
