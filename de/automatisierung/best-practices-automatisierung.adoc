= Best Practices: Aktionsmanager und Ereignisaktionen
:lang: de
...
Die E-Mail wird an die Adresse des gewählten Mitarbeiters versendet. Damit eine E-Mail-Adresse hier wählbar ist, muss sie im Menü <<basics/admin-aufgaben/benutzer-verwalten#42, System » Einstellungen » Benutzer » Konten>> beim Benutzer eingetragen sein. +
...
[[tabelle-ereignisaktion-versandbestaetigung]]
...
Wenn du Käufer mit Aufträgen der Zahlungsart *Vorkasse* an eine ausstehende Zahlung erinnern möchtest, nutze die in <<tabelle-aktionsmanager-zahlungserinnerung>> beschriebene Aktion. Beachte bei den Einstellungen, dass Aufträge mit der Zahlungsart *Vorkasse* in deinem plentymarkets System direkt den Status *[3] Warten auf Zahlung* erhalten.
