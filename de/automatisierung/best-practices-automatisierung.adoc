...
Die E-Mail wird an die Adresse des gewählten Mitarbeiters versendet. Damit eine E-Mail-Adresse hier wählbar ist, muss sie im Menü <<basics/admin-aufgaben/benutzer-verwalten#42, Einrichtung » Einstellungen » Benutzer » Konten>> beim Benutzer eingetragen sein. +
