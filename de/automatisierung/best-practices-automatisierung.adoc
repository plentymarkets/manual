...
====
Einige der auf dieser Seite genannten Einrichtungsbeispiele versenden E-Mail-Vorlagen oder erzeugen bestimmte Auftragsdokumente. Stelle daher sicher, dass die entsprechenden *E-Mail-Vorlagen* im Menü *System » Systemeinstellungen » Mandant » Mandant wählen » E-Mail » Vorlagen* erstellt sind. Ebenso müssen vor dem Einrichten und Verwenden der Automatismen, die Dokumente erzeugen, die entsprechenden Dokumentenvorlagen im Menü *System » Systemeinstellungen » Mandant » Mandant wählen » Standorte » Standort wählen » Dokumente* eingerichtet sein.
====
...
Die E-Mail wird an die Adresse des gewählten Mitarbeiters versendet. Damit eine E-Mail-Adresse hier wählbar ist, muss sie im Menü <<basics/admin-aufgaben/benutzer-verwalten#42, System » Systemeinstellungen » Einstellungen » Benutzer » Konten>> beim Benutzer eingetragen sein. +
