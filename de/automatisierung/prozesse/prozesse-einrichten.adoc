...
Über Prozesse automatisierst du viele komplexe Abläufe in plentymarkets. Hilfreiche Videos zu Prozessen findest du auch in unseren
link:https://www.plentymarkets.eu/knowledge/video-tutorials/automatisierung/automatisiere-deine-auftragsabwicklung/a-4582/#list-prozesse[Video-Tutorials].
...
. Öffne das Menü *System » Systemeinstellungen » Prozesse » Neuer Prozess*. +
*_Hinweis:_* Wenn der Menüpunkt *System » Systemeinstellungen » Prozesse* nicht angezeigt wird, installiere das Plugin link:https://marketplace.plentymarkets.com/plugins/externe-tools/plentyBase_5053/[plentyBase^].
. Nimm die Einstellungen vor. Beachte die Erläuterungen in <<tabelle-prozess-einstellungen>>.
...
. Öffne das Menü *System » Systemeinstellungen » Prozesse*.
. Zeige mit der Maus auf den Prozess, den du kopieren möchtest.
. Klicke rechts auf den Pfeil nach unten. +
...
*_Oder:_* Klicke im geöffneten Prozess auf *Prozess kopieren*.
...
*_Oder:_* Klicke im geöffneten Prozess auf *Prozess exportieren*.
...
. Öffne das Menü *System » Systemeinstellungen » Prozesse*.
. Zeige mit der Maus auf den Ordner *Meine Prozesse*.
. Klicke rechts auf den Pfeil nach unten. +
→ Die Option *Prozess importieren* wird geöffnet.
. Klicke auf *Prozess importieren*. +
→ Das Fenster *Prozess importieren* wird geöffnet.
. Gib einen Namen für den Prozess ein und klicke auf *Dateien hochladen*.
...
In der Kategorie link:https://forum.plentymarkets.com/c/suche-biete/prozess-basar[Prozesse, window="_blank"] des plentymarkets Forum findest du den plentymarkets Prozessbasar. Hier stellen engagierte Händlerinnen und Händler ihre Prozesse zur Verfügung.
