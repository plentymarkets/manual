...
:author: team-mobile
:keywords: Prozesse einrichten, Prozess einrichten, Prozess Einstellungen, Prozess-Einstellungen, Prozesseinstellungen, Prozess Elemente, Prozess-Elemente, Prozesselemente, plentyBase, Arbeitsschritt, Arbeitsschritte, Prozess importieren, Prozesse importieren, Prozess Import, Prozessimport, Prozess-Import, plentyBase, plenty Base
:position: 10
...
Die Ordnerstruktur des Menüs *Einrichtung » Prozesse* entspricht der Sichtbarkeit und Verfügbarkeit der Prozesse für Benutzerkonten. <<tabelle-sichtbarkeit-prozesse>> zeigt die verfügbaren Ordner.

[IMPORTANT]
.Sichtbarkeit des Menüs Einrichtung » Prozesse
====
Personen mit Admin-Rechten haben standardmäßig die Berechtigung, das Menü *Einrichtung » Prozesse* aufzurufen. Personen mit der Benutzerklasse *Backend* musst du diese Berechtigung erteilen. Öffne das Menü *Einrichtung » Einstellungen » Benutzer » Rechte » Benutzer*. Öffne das Konto und aktiviere in der Ansicht *Rechte* die Menü-Sichtbarkeit *Einrichtung » Prozesse*.
====
...
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<tabelle-prozess-einstellungen>>.
...
In der Kategorie link:https://forum.plentymarkets.com/c/suche-biete/prozess-basar[Prozesse, window="_blank"]{nbsp}icon:external-link[] des plentymarkets Forum findest du den plentymarkets Prozessbasar. Hier stellen engagierte Händlerinnen und Händler ihre Prozesse zur Verfügung.
