...
:author: team-mobile
:keywords: Prozesse einrichten, Prozess einrichten, Prozess Einrichtung, Prozess Einstellungen, Prozess-Einstellungen, Prozesseinstellungen, Prozess Elemente, Prozess-Elemente, Prozesselemente, plentyBase, Arbeitsschritt, Arbeitsschritte, Prozess importieren, Prozesse importieren, Prozess Import, Prozessimport, Prozess-Import, plentyBase, plenty Base
:position: 10
...
====
Benutzer:innen mit Admin-Rechten haben standardmäßig die Berechtigung, das Menü *Einrichtung » Prozesse* aufzurufen. Benutzer:innen mit der Benutzerklasse *Backend* musst du diese Berechtigung erteilen. Öffne das Menü *Einrichtung » Einstellungen » Benutzer » Rechte » Benutzer*. Öffne das Konto und aktiviere in der Ansicht *Rechte* die Menü-Sichtbarkeit *Einrichtung » Prozesse*.
====
