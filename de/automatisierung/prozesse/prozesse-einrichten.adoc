...
Prozesse erstellen und verwalten Sie im Menü *System » Systemeinstellungen » Prozesse*.
...
<<tabelle-prozesse-arbeitsschritte>> zeigt die verfügbaren Arbeitsschritte.
