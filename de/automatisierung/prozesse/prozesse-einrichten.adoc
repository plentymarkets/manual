...
Lerne die Grundlagen spielerisch kennen:
...
====
Du benötigst das Tool <<basics/admin-aufgaben/plentybase-installieren#, plentyBase>>, um Prozesse im plentymarkets Backend zu erstellen und auszuführen. Die Installationsdateien für plentyBase findest du im link:https://marketplace.plentymarkets.com/plugins/externe-tools/plentyBase_5053/[plentyMarketplace^].
====
...
Die Ordnerstruktur des Menüs *System » Systemeinstellungen » Prozesse* entspricht der Sichtbarkeit und Verfügbarkeit der Prozesse für Benutzerkonten. <<tabelle-sichtbarkeit-prozesse>> zeigt die verfügbaren Ordner.
...
Bedenke aber, dass du dabei einige systemspezifische Einstellungen anpassen musst. Lerne spielerisch wie das geht:

.Prozesse importieren und die systemspezifische Einstellungen anpassen
