...
Hierbei handelt es sich nicht um eine Fehlermeldung im klassischen Sinn, vielmehr werden Sie darauf hingewiesen, dass noch kein Access Token zur Absicherung der Kommunikation zwischen dem plentymarkets System und dem lokal installierten plentyBase eingerichtet wurde.

Damit diese Meldung nicht mehr erscheint und die Verbindung abgesichert ist, muss ein Token im Terra Backend erzeugt und in plentyBase hinterlegt werden:
...
** Den in die Zwischenablage kopierten Token links einfügen, rechts zum Beispiel “plentymarkets” eingeben
** *Ok* drücken
