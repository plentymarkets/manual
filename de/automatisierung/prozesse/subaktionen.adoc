...
====
Richte die Subaktion Zwischenspeichern nicht für eine Aktionein, für die du auch eine Aktion für den Fehlerfall erstellst. Da das Zwischenspeichern asynchron läuft, behindern sich diese Vorgänge sonst gegenseitig.
====
