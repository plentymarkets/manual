...
:author: team-mobile
:keywords: plentyBase, Prozesse, Drucken, Drucker installieren, Prozesse ausführen, Automatisierung, Druckverlauf, Druckhistorie, base, Base, plenty Base User Guide, plentyBase User Guide, plentyBase installieren, plentyBase Installation, HTTPS Port, HTTPS-Port, HOSTS-Datei, HOSTS Datei, plentymarkets App, App Verbindungsdaten, Verbindungsdaten speichern
...
Wenn plentyBase auf dem Rechner installiert ist, können diese Abläufe über das Backend deines plentymarkets Systems ausgeführt werden.
