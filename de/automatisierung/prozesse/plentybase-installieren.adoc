...
*_Hinweis:_* Wenn du einen neuen API Access Token generierst, wird der vorherige Token überschrieben. Speichere den neuen Token direkt nach der Generierung in den Einstellungen von plentyBase. Nutzt du plentyBase auf mehreren Rechnern? Dann stelle sicher, dass du auf jedem Gerät den neuen Token speicherst. 
...
image::automatisierung/prozesse/assets/baseMac.png[width=640, height=360]
