...
|**Artikelstatus**
|Einen Artikelstatus wählen, der im Prozess beim Anlegen der Retoure voreingestellt wird. Die Artikelstatus für Retouren werden im Menü <<auftraege/auftraege-verwalten#410, Einrichtung » Aufträge » Auftragstypen » Retoure>> angelegt.
...
|**Retourengrund**
|Grund wählen, damit Retouren beim Anlegen diesen Rückgabegrund erhalten. Retourengründe werden im Menü <<auftraege/auftraege-verwalten#410, Einrichtung » Aufträge » Auftragstypen » Retoure>> erstellt.
|====
