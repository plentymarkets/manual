...
Auf dieser Handbuchseite finden Sie Erläuterungen zu den Steuerelementen und Aktionen, die Sie im Menü **System » Systemeinstellungen » Prozesse** zu den Arbeitsschritten von Prozessen hinzufügen können.
...
|**Artikelstatus**
|Einen Artikelstatus wählen, der im Prozess beim Anlegen der Retoure voreingestellt wird. Die Artikelstatus für Retouren werden im Menü <<auftraege/auftraege-verwalten#410, System » Systemeinstellungen » Aufträge » Auftragstypen » Retoure>> angelegt.
...
|**Retourengrund**
|Grund wählen, damit Retouren beim Anlegen diesen Rückgabegrund erhalten. Retourengründe werden im Menü <<auftraege/auftraege-verwalten#410, System » Systemeinstellungen » Aufträge » Auftragstypen » Retoure>> erstellt.
|====
