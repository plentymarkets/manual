...
.Rechte erforderlich
====
Damit die Aktion **Picklisten-Suche** korrekt funktioniert, wenn Benutzer:innen ohne Admin-Rechte einen Prozess starten, der die Aktion nutzt, müssen diese Benutzer:innen über die unten aufgelisteten Benutzerrechte verfügen.
====
...
|Bereits im plentymarkets System angelegte <<automatisierung/prozesse/drucker#10, Druckerkonfiguration für plentyBase>> wählen, die zum Druck der Artikeletiketten genutzt werden soll.

| **Etikettenvorlage**
|Bereits im plentymarkets System angelegte <<artikel/einstellungen/barcodes#800, Etikettenvorlage>> wählen, die zum Druck der Artikeletiketten genutzt werden soll.
