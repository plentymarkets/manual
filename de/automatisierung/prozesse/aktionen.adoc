...
Mit der Aktion **Polling** wird eine <<fulfillment/versand-center#1400, Polling-Datei>> im CSV-Format erzeugt, die für bestimmte Versanddienstleister benötigt wird. Per Subaktion können Sie diese Datei speichern.
...
|**Retourentyp**
|Zwischen <<fulfillment/versand-vorbereiten#3200, DHL Retoure Online und DHL Retoure Beileger>> wählen. +
