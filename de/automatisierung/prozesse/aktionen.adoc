...
:keywords: Aktionen, Prozesse, Prozesse steuern, plentyBase, Steuerelemente, Aktion, Prozess, Steuerelement, Arbeitsschritt, Arbeitsschritte, Subaktion, Subaktionen
...
Dein Lagermitarbeiter scannt ganz einfach die Seriennummer, während er den Artikel im Lager kommissioniert. Die Seriennummer wird automatisch der Bestellung zugeordnet. Die Seriennummer erscheint auch automatisch auf der Rechnung deines Kunden.
