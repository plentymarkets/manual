...
Mit der Aktion **Auftrag** werden verschiedene Vorgänge in der <<auftraege/auftraege-verwalten#auftrag-aendern, Auftragsbearbeitung>> per Subaktion automatisch ausgeführt, zum Beispiel wird der Status von ausgewählten Aufträgen geändert oder es werden Paketnummern erfasst.
...
|**Artikelstatus**
|Einen Artikelstatus wählen, der im Prozess beim Anlegen der Retoure voreingestellt wird. Die Artikelstatus für Retouren werden im Menü <<auftraege/auftraege-verwalten#retoure, System » Aufträge » Auftragstypen » Retoure>> angelegt.

|**Artikelwert**
|Einen Prozentwert eingeben, um ihn retournierten Artikeln zuzuweisen. Nachdem eine Retoure angelegt wurde, wird der Wert auch im Tab **Übersicht** einer <<auftraege/auftraege-verwalten#retoure, Retoure>> bei der Artikelposition angezeigt.
...
|**Retourengrund**
|Grund wählen, damit Retouren beim Anlegen diesen Rückgabegrund erhalten. Retourengründe werden im Menü <<auftraege/auftraege-verwalten#retoure, System » Aufträge » Auftragstypen » Retoure>> erstellt.
|====
...
Mit der Aktion **Rücksendeschein** wird ein Rücksendeschein per Subaktion automatisch zum Beispiel gedruckt oder gespeichert. Dieser Rücksendeschein wird einem Artikel beigelegt, wenn der Kunde für eine <<auftraege/auftragsdokumente/ruecksendeschein-erzeugen#, Retoure>> einen Rücksendeschein benötigt.
...
Mit der Aktion **SEPA Pain001** exportieren Sie Transaktionsdateien Ihrer <<payment/bankdaten-verwalten#200, SEPA-Überweisungen>> in eine ZIP-Datei. Diese ZIP-Datei speichern Sie per Subaktion, um diese Datei Ihrer Bank zur Verfügung zu stellen.
...
Mit der Aktion **SEPA Pain008** exportieren Sie Transaktionsdateien Ihrer <<payment/bankdaten-verwalten#200, SEPA-Lastschriften>> in eine ZIP-Datei. Diese ZIP-Datei speichern Sie per Subaktion, um diese Datei Ihrer Bank zur Verfügung zu stellen.
...
Mit der Aktion **Zahlungseingang anlegen** wird im Menü <<payment/zahlungen-verwalten#, Aufträge » Zahlungseingänge>> eine Zahlung mit Datum und Zahlungsart angelegt. Damit erhalten Sie einen Überblick und einen Nachweis über die Zahlungen, die per <<payment/bankdaten-verwalten#200, SEPA-Lastschrift>> in Ihr System kommen.
