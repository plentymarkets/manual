...
Auf dieser Handbuchseite findest du Erläuterungen zu den Steuerelementen und Aktionen, die du im Menü **System » Systemeinstellungen » Prozesse** zu den Arbeitsschritten von Prozessen hinzufügen kannst.

[IMPORTANT]
.Tool plentyBase erforderlich
====
Um Prozesse zu erstellen und auszuführen benötigst du das Tool <<basics/admin-aufgaben/plentybase-installieren#, plentyBase>>. Die Installationsdateien für plentyBase findest du im link:https://marketplace.plentymarkets.com/plugins/externe-tools/plentyBase_5053/[plentyMarketplace^].
====
...
. Öffne das Menü *System » Systemeinstellungen » Prozesse » Ordner wählen » Prozess wählen*.
...
Dieses Kapitel beschreibt die Steuerelemente, die du für Prozesse konfigurieren kannst. Steuerelemente dienen dazu, Aktionen innerhalb eines Arbeitsschrittes miteinander zu verknüpfen.

[#480]
==== Allgemeine Einstellungen für Steuerelemente

Bestimmte Einstellungen sind für alle Steuerelemente verfügbar. <<tabelle-steuerelemente-allgemeine-einstellungen>> erläutert diese Einstellungen. Die Einstellungen **Anzeigen** und **Ziel** stehen nicht für alle Steuerelemente zur Verfügung, werden aber dennoch hier erläutert. Ob die Einstellungen für ein Steuerelement verfügbar ist, prüfst du in den Erläuterungen zu dem Steuerelement.
...
Zur individuellen Gestaltung einer solchen Abfrage stehen verschiedene Möglichkeiten zur Verfügung. Zusätzlich zum Titel kannst du dem Bearbeiter eine Nachricht hinterlassen und die Auswahlmöglichkeiten über verschiedene Schaltflächen konfigurieren.
Mit dem Steuerelement Dialog kannst du zum Beispiel eine Abfrage erstellen, welcher Dienst eines Versanddienstleisters für Aufträge verwendet werden soll. Die verfügbaren Dienste werden dabei als Schaltflächen angezeigt. Der Bearbeiter wählt im Prozess über die Schaltfläche den gewünschten Dienst.
...
<<tabelle-steuerelement-dialog>> erläutert die zusätzlichen Einstellungen des Steuerelements. Informationen zu den allgemeinen Einstellungen für Steuerelemente findest du in <<tabelle-steuerelemente-allgemeine-einstellungen>>. Da das Steuerelement ein Eingreifen der Person erfordert, die den Prozess ausführt, ist die Einstellung **Anzeigen** für dieses Steuerelement nicht verfügbar.
...
<<tabelle-steuerelement-filter>> erläutert die zusätzlichen Einstellungen des Steuerelements. Informationen zu den allgemeinen Einstellungen für Steuerelemente findest du in <<automatisierung/prozesse/aktionen#480, Tabelle 1>>.
...
<<tabelle-steuerelement-filter-aufloesen>> erläutert die zusätzlichen Einstellungen des Steuerelements. Informationen zu den allgemeinen Einstellungen für Steuerelemente findest du in <<automatisierung/prozesse/aktionen#480, Tabelle 1>>. Die Einstellung **Ziel** ist für dieses Steuerelement nicht verfügbar.
...
<<tabelle-steuerelement-split>> erläutert die zusätzlichen Einstellungen des Steuerelements. Informationen zu den allgemeinen Einstellungen für Steuerelemente findest du in <<automatisierung/prozesse/aktionen#480, Tabelle 1>>.
...
Dieses Kapitel beschreibt die Aktionen, die du für Prozesse konfigurieren kannst. Eine Aktion wird zu einem Arbeitsschritt hinzugefügt. Die Aktion selbst kann wiederum <<automatisierung/prozesse/subaktionen#, Subaktionen>> enthalten.
...
Für diese Aktion sind keine zusätzlichen Einstellungen verfügbar. Informationen zu den allgemeinen Einstellungen für Aktionen findest du in <<tabelle-aktionen-einstellungen-allgemein>>.
...
<<tabelle-aktion-adressetikett>> erläutert die zusätzlichen Einstellungen der Aktion. Informationen zu den allgemeinen Einstellungen für Aktionen findest du in <<tabelle-aktionen-einstellungen-allgemein>>.
...
Für die Aktion sind keine zusätzlichen Einstellungen verfügbar. Informationen zu den allgemeinen Einstellungen für Aktionen findest du in <<tabelle-aktionen-einstellungen-allgemein>>.
...
<<tabelle-aktion-artikelerfassung>> erläutert die zusätzlichen Einstellungen der Aktion. Informationen zu den allgemeinen Einstellungen für Aktionen findest du in <<tabelle-aktionen-einstellungen-allgemein>>. Die Einstellung **Im Fehlerfall** ist für diese Aktion nicht verfügbar.
...
<<tabelle-aktion-artikeletikett>> erläutert die zusätzlichen Einstellungen der Aktion. Informationen zu den allgemeinen Einstellungen für Aktionen findest du in <<tabelle-aktionen-einstellungen-allgemein>>. Die Einstellung **Im Fehlerfall** ist für diese Aktion nicht verfügbar.
...
Für diese Aktion sind keine zusätzlichen Einstellungen verfügbar. Informationen zu den allgemeinen Einstellungen für Aktionen findest du in <<tabelle-aktionen-einstellungen-allgemein>>. Die Einstellung **Im Fehlerfall** ist für diese Aktion nicht verfügbar.
...
<<tabelle-aktion-auftragssuche>> erläutert die zusätzlichen Einstellungen der Aktion. Informationen zu den allgemeinen Einstellungen für Aktionen findest du in <<tabelle-aktionen-einstellungen-allgemein>>. Die Einstellung **Im Fehlerfall** ist für diese Aktion nicht verfügbar.
...
*Box-Suche* = Wird für die <<automatisierung/prozesse/rollende-kommissionierung, rollende Kommissionierung>> verwendet. Der Lagerist scannt den Barcode eines Lagerorts. Daraufhin ruft plentymarkets den entsprechenden Auftrag auf.
...
<<tabelle-aktion-email>> erläutert die zusätzlichen Einstellungen der Aktion. Informationen zu den allgemeinen Einstellungen für Aktionen findest du in <<tabelle-aktionen-einstellungen-allgemein>>. Die Einstellung **Im Fehlerfall** ist für diese Aktion nicht verfügbar.
...
<<tabelle-aktion-fibu-export>> erläutert die zusätzlichen Einstellungen der Aktion. Informationen zu den allgemeinen Einstellungen für Aktionen findest du in <<tabelle-aktionen-einstellungen-allgemein>>.
...
<<tabelle-aktion-lager-pickliste>> erläutert die zusätzlichen Einstellungen der Aktion. Informationen zu den allgemeinen Einstellungen für Aktionen findest du in <<tabelle-aktionen-einstellungen-allgemein>>.
...
<<tabelle-aktion-packliste>> erläutert die zusätzlichen Einstellungen der Aktion. Informationen zu den allgemeinen Einstellungen für Aktionen findest du in <<tabelle-aktionen-einstellungen-allgemein>>.
...
<<tabelle-aktion-pickliste>> erläutert die zusätzlichen Einstellungen der Aktion. Informationen zu den allgemeinen Einstellungen für Aktionen findest du in <<tabelle-aktionen-einstellungen-allgemein>>.
...
<<tabelle-aktion-picklisten-suche>> erläutert die zusätzlichen Einstellungen der Aktion. Informationen zu den allgemeinen Einstellungen für Aktionen findest du in <<tabelle-aktionen-einstellungen-allgemein>>. Die Einstellung **Im Fehlerfall** ist für diese Aktion nicht verfügbar.
...
Mit der Aktion **Polling** wird eine <<fulfillment/versand-center#1400, Polling-Datei>> im CSV-Format erzeugt, die für bestimmte Versanddienstleister benötigt wird. Per Subaktion kannst du diese Datei speichern.
...
<<tabelle-aktion-polling>> erläutert die zusätzlichen Einstellungen der Aktion. Informationen zu den allgemeinen Einstellungen für Aktionen findest du in <<tabelle-aktionen-einstellungen-allgemein>>.
...
<<tabelle-aktion-rechnung>> erläutert die zusätzlichen Einstellungen der Aktion. Informationen zu den allgemeinen Einstellungen für Aktionen findest du in <<tabelle-aktionen-einstellungen-allgemein>>.
...
Die Einstellungen, die du beim Erstellen der Aktion wählst, werden beim Erstellen der Retoure zu Voreinstellungen, die du übernehmen oder ändern kannst. <<tabelle-aktion-retoure-anlegen-bearbeiten>> erläutert die zusätzlichen Einstellungen der Aktion. Informationen zu den allgemeinen Einstellungen für Aktionen findest du in <<tabelle-aktionen-einstellungen-allgemein>>. Die Einstellung **Im Fehlerfall** ist für diese Aktion nicht verfügbar.
...
<<tabelle-aktion-retourenetikett>> erläutert die zusätzlichen Einstellungen der Aktion. Informationen zu den allgemeinen Einstellungen für Aktionen findest du in <<tabelle-aktionen-einstellungen-allgemein>>.
...
<<tabelle-aktion-sepa-pain001>> erläutert die zusätzlichen Einstellungen der Aktion. Informationen zu den allgemeinen Einstellungen für Aktionen findest du in <<tabelle-aktionen-einstellungen-allgemein>>.
...
<<tabelle-aktion-sepa-pain008>> erläutert die zusätzlichen Einstellungen der Aktion. Informationen zu den allgemeinen Einstellungen für Aktionen findest du in <<tabelle-aktionen-einstellungen-allgemein>>.
...
====
Wenn du Seriennummern nur für ausgewählte Artikel erfassen möchtest, stelle im Artikel im Tab **Sonstiges** die Option **Seriennummern** auf **Ja**. Baue im Prozess vor der Aktion einen **Filter** des Filtertyps **Seriennummern** ein und stelle die Option im Filter auf **Ja**.
====
...
<<tabelle-aktion-versand-center>> erläutert die zusätzlichen Einstellungen der Aktion. Informationen zu den allgemeinen Einstellungen für Aktionen findest du in <<tabelle-aktionen-einstellungen-allgemein>>.
...
<<tabelle-aktion-wareneingang-bestellung>> erläutert die zusätzlichen Einstellungen der Aktion. Informationen zu den allgemeinen Einstellungen für Aktionen findest du in <<tabelle-aktionen-einstellungen-allgemein>>. Die Einstellung **Im Fehlerfall** ist für diese Aktion nicht verfügbar.
...
<<tabelle-aktion-wareneingang-einfach>> erläutert die zusätzlichen Einstellungen der Aktion. Informationen zu den allgemeinen Einstellungen für Aktionen findest du in <<tabelle-aktionen-einstellungen-allgemein>>. Die Einstellung **Im Fehlerfall** ist für diese Aktion nicht verfügbar.
...
Mit der Aktion **Zahlungseingang anlegen** wird im Menü <<payment/zahlungen-verwalten#, Aufträge » Zahlungseingänge>> eine Zahlung mit Datum und Zahlungsart angelegt. Damit erhältst du einen Überblick und einen Nachweis über die Zahlungen, die per <<payment/bankdaten-verwalten#200, SEPA-Lastschrift>> in dein System kommen.
...
<<tabelle-aktion-zahlungseingang-anlegen>> erläutert die zusätzlichen Einstellungen der Aktion. Informationen zu den allgemeinen Einstellungen für Aktionen findest du in <<tabelle-aktionen-einstellungen-allgemein>>. Die Einstellung **Im Fehlerfall** ist für diese Aktion nicht verfügbar.
