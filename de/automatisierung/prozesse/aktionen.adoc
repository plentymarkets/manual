...
:description: Übersicht der Aktionen und Steuerelemente, die du für Prozesse einstellen kannst.
:position: 40
...
Dieses Kapitel beschreibt die Steuerelemente, die du für Prozesse einstellen kannst. Steuerelemente dienen dazu, Aktionen innerhalb eines Arbeitsschrittes miteinander zu verknüpfen.
...
Zur individuellen Gestaltung einer solchen Abfrage stehen verschiedene Möglichkeiten zur Verfügung. Zusätzlich zum Titel kannst du der Person, die den Prozess ausführt, eine Nachricht hinterlassen und die Auswahlmöglichkeiten über verschiedene Schaltflächen einstellen.
...
Dieses Kapitel beschreibt die Aktionen, die du für Prozesse einstellen kannst. Eine Aktion wird zu einem Arbeitsschritt hinzugefügt. Die Aktion selbst kann wiederum <<automatisierung/prozesse/subaktionen#, Subaktionen>> enthalten.
...
Mit der Aktion **Zahlungseingang anlegen** wird im Menü <<payment/zahlungen-verwalten#, Aufträge » Zahlungseingänge>> eine Zahlung mit Datum und Zahlungsart erstellt. Damit erhältst du einen Überblick und einen Nachweis über die Zahlungen, die per <<payment/bankdaten-verwalten#200, SEPA-Lastschrift>> in dein System kommen.
