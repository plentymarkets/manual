...
:author: team-mobile
:keywords: Aktionen, Prozesse, Prozess-Aktion, Prozesse steuern, plentyBase, Steuerelemente, Aktion, Prozess, Steuerelement, Arbeitsschritt, Arbeitsschritte, Subaktion, Subaktionen, plentyBase, plenty Base
...
Zur individuellen Gestaltung einer solchen Abfrage stehen verschiedene Möglichkeiten zur Verfügung. Zusätzlich zum Titel kannst du der Person, die den Prozess ausführt, eine Nachricht hinterlassen und die Auswahlmöglichkeiten über verschiedene Schaltflächen konfigurieren.
...
Dein Lagerpersonal scannt ganz einfach die Seriennummer, während es den Artikel im Lager kommissioniert. Die Seriennummer wird automatisch der Bestellung zugeordnet. Die Seriennummer erscheint auch automatisch auf der Rechnung deines Kunden.
