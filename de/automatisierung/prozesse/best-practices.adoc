...
//TODO: angepassten Prozess verlinken
=== Importdatei für den Prozess

link:https://s3.eu-central-1.amazonaws.com/download.plentybase.de/process_configs/Mobile_Pickliste.plentyprocess[Mobile_Pickliste.plentyprocess]{nbsp}icon:external-link[] (1,3 KB)
