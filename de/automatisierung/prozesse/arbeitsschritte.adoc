...
→ Das Einstellungsfenster wird geöffnet (Bild 2).
...
→ Das Einstellungsfenster wird geöffnet (Bild 3).
...
.Arbeitsschritt **Auftragsbearbeitung**, Einstellungen öffnen
image::automatisierung/prozesse/assets/DE-Einstell-Prozesse-Auftragsbearbeitung-02-SI.png[Arbeitsschritt **Auftragsbearbeitung**, Einstellungen öffnen]
...
→ Das Einstellungsfenster wird geöffnet (Bild 5).
...
.Arbeitsschritt **Wareneingang**, Einstellungen öffnen
image::automatisierung/prozesse/assets/DE-Einstell-Prozesse-Wareneingang-02-SI.png[Arbeitsschritt **Wareneingang**, Einstellungen öffnen]
