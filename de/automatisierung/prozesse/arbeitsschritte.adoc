...
Beim Konfigurieren eines Arbeitsschrittes des Typs **Auftragsabwicklung** legst du fest, welche und wie viele Aufträge den Prozess durchlaufen sollen. Wähle bei Bedarf Filter für die Auswahl der Aufträge und lege fest, ob und inwiefern durch den Arbeitsschritt Änderungen an den Aufträgen vorgenommen werden sollen.
...
Die **Filter** verwendest du, um Aufträge nach den dort verfügbaren Kriterien für den Prozess auszuwählen.
...
Folgende <<automatisierung/prozesse/aktionen#, Aktionen>> und <<automatisierung/prozesse/subaktionen#, Subaktionen>> stehen dir für den Arbeitsschritt **Auftragsbearbeitung** zur Verfügung. Informationen zur Konfiguration erhältst du auf der jeweiligen Unterseite.
...
. Nimm die Einstellungen vor, wie in <<tabelle-arbeitsschritte-einstellungen>> erläutert.
. Klicke auf **Speichern**.
...
|*Position*
|Wenn du mehrere Arbeitsschritte konfiguriert hast, kannst du anhand der Position die Reihenfolge der Schritte anpassen.
...
Weitere Informationen zum Prozessablauf erhältst du auf der Handbuchseite <<automatisierung/prozesse/prozesse-ausfuehren#2.4, Prozesse ausführen>> im Unterkapitel **4.2 Buchung einfacher Wareneingänge**.
