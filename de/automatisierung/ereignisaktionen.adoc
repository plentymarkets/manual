...
|*Tag*
|Die Aufträge werden anhand der ihnen zugeordneten <<willkommen/allgemeine-funktionen/tags#, Tags>> gefiltert. Definiere nach Auswahl des Filters, welche Tags am Auftrag sein müssen, damit die Ereignisaktion für den Auftrag greift.
...
|Die Aktion fügt je nach Auswahl <<willkommen/allgemeine-funktionen/tags#, Tags>> zum Auftrag hinzu oder entfernt sie. Wähle entweder die Funktion *Tag hinzufügen* oder die Funktion *Tag entfernen* aus. Nutze dann das Eingabefeld, um die Tags, die hinzugefügt oder entfernt werden sollen, zu bestimmen. +
