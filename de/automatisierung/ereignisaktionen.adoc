...
|Diese Aktion meldet die Retoure über die bereits eingerichtete Schnittstelle oder das Plugin an, sofern der Versanddienstleister die Retourenanmeldung erlaubt.

| *DHL Retoure Online-Label generieren*
|Diese Aktion meldet die Retoure über DHL Retoure Online an. Pro Auftrag wird unabhängig von der Paketanzahl ein Label generiert.

| *DHL Retoure Online-Label generieren (1 Label/Paket: 1 Datei)*
|Diese Aktion meldet die Retoure über DHL Retoure Online an. Pro Paket wird ein Label generiert. Wenn mehrere Pakete vorhanden sind, wird eine Datei mit allen Retourenlabels generiert.

| *DHL Retoure Online-Label generieren (1 Label/Paket: mehrere Dateien)*
|Diese Aktion meldet die Retoure über DHL Retoure Online an. Pro Paket wird ein Label generiert. Wenn mehrere Pakete vorhanden sind, wird jeweils eine Datei pro Retourenlabel generiert.
