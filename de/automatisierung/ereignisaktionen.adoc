...
|*Mollie Rückzahlung erfolgreich*
|

|*Mollie Versandanmeldung gescheitert*
|

|*Mollie Versandanmeldung erfolgreich*
|

|*PayPal Rückzahlung gescheitert*
|

|*PayPal Rückzahlung erfolgreich*
|
...
Die verfügbaren Filter sind genau wie die Ereignisse in Gruppen unterteilt. <<table-event-procedures-filter-groups>> beschreibt die verfügbaren Filter nach ihren Filtergruppen sortiert.

[.instruction]
Einen Filter hinzufügen:

. Öffne das Menü *Einrichtung » Aufträge » Ereignisse*.
. Öffne auf die Ereignisaktion, der du einen Filter hinzufügen möchtest.
...
| *Aktiver Benutzer*
|Aufträge werden anhand der aktiven Benutzer:in gefiltert, d.h. die Person, die den durch die Ereignisaktion aktivierten Vorgang auslöst. Es sind auch *alle* Benutzer:innen auf einmal wählbar.
