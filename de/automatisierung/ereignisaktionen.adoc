...
Im Menü *System » Systemeinstellungen » Aufträge » Ereignisse* legen Sie neue Ereignisaktionen an. Sie können dort auch alle bereits von Ihnen angelegten Ereignisaktionen einsehen und <<automatisierung/ereignisaktionen#300, bearbeiten>>.
...
Den Prozentwert für Anzahlungen auf Produktionsware hinterlegen Sie im Menü *<<auftraege/grundeinstellungen#, System » Systemeinstellungen » Aufträge » Einstellungen>>*.
