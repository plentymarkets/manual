...
Jeweils eigene Aktionen sind verfügbar für: <<apayment/zahlungsanbieter/klarna#, Klarna>>, <<maerkte/amazon/amazon-einrichten#, Amazon>>, <<maerkte/plus-gartenxxl#, Netto eStores>>, <<payment/zahlungsanbieter/postpay#, POSTPAY>>, <<maerkte/rakuten/rakuten-einrichten#, Rakuten>>, <<maerkte/shopgate#, Shopgate>>, <<maerkte/flubit#, Flubit>>, <<maerkte/idealo/idealo-einrichten#, idealo>>, <<maerkte/fruugo#, Fruugo>> und <<maerkte/cdiscount#, Cdiscount>>. +
Siehe dazu auch die Handbuchseite der <<apaymentzahlungsanbieter/#, Zahlungsart>>.
