...
|Diese Aktion meldet die Retoure bei DHL Retoure Online an. Pro Paket wird ein Label generiert. Wenn mehrere Pakete vorhanden sind, wird eine Datei mit allen Retourenlabels generiert.

| *DHL Retoure Online-Label generieren (1 Label/Paket: mehrere Dateien)*
|Diese Aktion meldet die Retoure bei DHL Retoure Online an. Pro Paket wird ein Label generiert. Wenn mehrere Pakete vorhanden sind, wird jeweils eine Datei pro Retourenlabel generiert.
