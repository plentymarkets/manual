...
| *Status*
|Aufträge werden anhand des Auftragsstatus gefiltert. Hier ist ein bestimmter Status wählbar. Mit den Operatoren gleich (==), größer als (>), größer gleich (>=), kleiner als (<) oder kleiner gleich (⇐) filterst du nach Aufträgen, die dem gewählten Status beispielsweise entsprechen oder darüber bzw. darunter liegen.
