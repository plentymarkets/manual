...
Einige praktische Anwendungsbeispiele für die Verwendung von Ereignisaktionen finden Sie auf der Handbuchseite <<automatisierung/best-practices-automatisierung#, Best Practices: Ereignisaktionen und Aktionsmanager>>.

[#100]
== Neue Ereignisaktion anlegen

Im Menü *System » Aufträge » Ereignisse* legen Sie neue Ereignisaktionen an. Sie können dort auch alle bereits von Ihnen angelegten Ereignisaktionen einsehen und <<automatisierung/ereignisaktionen#300, bearbeiten>>.
...
|*Click & Collect*
|Aufträge werden anhand der Versandart Click & Collect gefiltert. Click & Collect ist nur für Aufträge mit der Herkunft eBay UK und dem Lieferland UK nutzbar. Weitere Informationen finden Sie im Kapitel zum Thema <<maerkte/ebay/ebay-einrichten#7010, Click & Collect>>.
...
Weitere Informationen zu Amazon- und Amazon Prime-Aufträgen finden Sie auf den Handbuchseite zu <<maerkte/amazon/amazon-einrichten#4200, Amazon>> und <<maerkte/ebay/ebay-einrichten#100, eBay>>.
...
Dieser Filter prüft auf im Auftrag enthaltene Artikel, an denen Sie im Menü *System » Systemeinstellungen » Einstellungen » Eigenschaften » Konfiguration* bestimmte <<artikel/artikel-verwalten#3000, Eigenschaften>> hinterlegt haben. Innerhalb des Filters können Sie eine Eigenschaft wählen, nach der Artikel gefiltert werden.
