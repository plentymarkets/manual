...
Den Prozentwert für Anzahlungen auf Produktionsware hinterlegen Sie im Menü *<<auftraege/grundeinstellungen#, System » Aufträge » Einstellungen>>*.
...
|Löscht eine Rechnung der Zahlungsart *Klarna* bei einer Stornierung. Erläuterungen dazu sowie zu weiteren Ereignisaktionen auf der Handbuchseite zum Thema <<payment/klarna#, Klarna>> beachten.
...
Fügen Sie zur Darstellung der Mahngebühr die *Varianten-ID* des <<auftraege/auftragsdokumente/mahnungen-erzeugen#200, Artikels für die Mahngebühr>> ein, den Sie in Ihrem plentymarkets System angelegt haben. +
Ein *Kommentar* kann optional eingegeben und erscheint dann unterhalb der Artikelpositionen.
...
Jeweils eigene Aktionen sind verfügbar für: <<payment/amazon-pay#, Amazon Pay>>, <<payment/crefopay#, CrefoPay>>, <<payment/klarna#, Klarna>>, <<payment/klarna-checkout-uk#, Klarna UK>>, <<payment/masterpayment#, Masterpayment>>, <<payment/payolution#, Payolution>>, <<payment/payone#, PAYONE>>, <<omni-channel/multi-channel/plus-gartenxxl#, Netto eStores>>, <<payment/postpay#, POSTPAY>>, *Zentralverkauf*, <<omni-channel/multi-channel/hood#, Hood>>, <<omni-channel/multi-channel/ebay/ebay-einrichten#, eBay>>, <<omni-channel/multi-channel/rakuten/rakuten-einrichten#, Rakuten.de>>, <<omni-channel/multi-channel/fruugo#, Fruugo>>, <<omni-channel/multi-channel/flubit#, Flubit>>, <<omni-channel/multi-channel/idealo/idealo-einrichten#, idealo>> und <<omni-channel/multi-channel/bol-com#, bol.com>>.
...
Jeweils eigene Aktionen sind verfügbar für: *ClickandBuy*, <<payment/payone#, PAYONE>>, <<payment/postpay#, POSTPAY>>, <<payment/worldpay#, Worldpay>> und <<payment/klarna#, Klarna>>.

|*Auftrag an Klarna senden*
|Es wird ein Auftrag an <<payment/klarna#, Klarna>> gesendet.

|*Auftragsänderung an Klarna melden*
|Es wird eine Auftragsänderung an <<payment/klarna#, Klarna>> gemeldet.
...
Jeweils eigene Aktionen sind verfügbar für: <<payment/amazon-pay#, Amazon Pay>>, <<payment/crefopay#, CrefoPay>>, <<payment/payolution#, Payolution>> und <<payment/klarna-checkout-uk#, Klarna UK>>.

|*Rückzahlung senden*
|Es wird eine Rückzahlung an einen Zahlungsanbieter gesendet. +
Jeweils eigene Aktionen sind verfügbar für: <<payment/masterpayment#, Masterpayment>>, <<payment/paypal-plus#, PayPal PLUS>> und <<payment/paypal#, PayPal>>.

|*Stornierung senden*
|Es wird eine Stornierung an einen Zahlungsanbieter gesendet. +
Jeweils eigene Aktionen sind verfügbar für: <<payment/crefopay#, CrefoPay>>, <<payment/amazon-pay#, Amazon Pay>>, *ClickandBuy*, <<payment/paymorrow#, paymorrow>>, <<omni-channel/multi-channel/plus-gartenxxl#, Netto eStores>>, <<payment/postpay#, POSTPAY>>, <<omni-channel/multi-channel/rakuten/rakuten-einrichten#, Rakuten>>, <<payment/worldpay#, Worldpay>>, <<payment/sage-pay#, SagePay>>, <<payment/klarna-checkout-uk#, Klarna UK>>.
...
|Erzeugt ein DHL-Retourenlabel über <<ulfillment/versand-vorbereiten#3200, DHL Online Retoure>> oder <<fulfillment/versand-vorbereiten#3100,DHL Retoure Beilegeretikett>>, das im *Versand-Center* bzw. im Webshop im Bereich *Mein Konto* verfügbar ist.

|*Retoure senden*
|Eine Retoure an einen Marktplatz oder Zahlungsanbieter senden. +
Jeweils eigene Aktionen sind verfügbar für: <<apayment/klarna#, Klarna>>, <<multi-channel/amazon/amazon-einrichten#, Amazon>>, <<omni-channel/multi-channel/plus-gartenxxl#, Netto eStores>>, <<payment/postpay#, POSTPAY>>, <<omni-channel/multi-channel/rakuten/rakuten-einrichten#, Rakuten>>, <<omni-channel/multi-channel/shopgate#, Shopgate>>, <<omni-channel/multi-channel/flubit#, Flubit>>, <<omni-channel/multi-channel/idealo/idealo-einrichten#, idealo>>, <<omni-channel/multi-channel/fruugo#, Fruugo>> und <<omni-channel/multi-channel/cdiscount#, Cdiscount>>. +
Siehe dazu auch die Handbuchseite der <<apayment#, Zahlungsart>>.
