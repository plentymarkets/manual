...
|*Karte erstellen*
|Beim Eintreten des gewählten Ereignisses wird im Menü *plentymarkets Logo (Start) » Boards* eine <<basics/arbeiten-mit-plentymarkets/boards#30, neue Karte>> hinzugefügt. +
...
|*Karten löschen*
|Beim Eintreten des gewählten Ereignisses werden im Menü *plentymarkets Logo (Start) » Boards* ausgewählte Karten <<basics/arbeiten-mit-plentymarkets/boards#40, gelöscht>>. +
Innerhalb der Aktion wählst du das *Board* und die *Spalte(n)*, deren enthaltene Karten gelöscht werden sollen.

|*Karten verschieben*
|Beim Eintreten des gewählten Ereignisses werden im Menü *plentymarkets Logo (Start) » Boards* ausgewählte Karten <<basics/arbeiten-mit-plentymarkets/boards#40, verschoben>>. +
