...
Im Menü *System » Systemeinstellungen » Aufträge » Ereignisse* legst du neue Ereignisaktionen an. Dort kannst du auch alle bereits von dir angelegten Ereignisaktionen einsehen und <<automatisierung/ereignisaktionen#300, bearbeiten>>.

[.instruction]
Neue Ereignisaktion erstellen:

. Öffne das Menü *System » Systemeinstellungen » Aufträge » Ereignisse*.
. Klick links unten auf das *grüne Plus*, um eine neue Ereignisaktion zu erstellen.
...
Den Prozentwert für Anzahlungen auf Produktionsware hinterlegst du im Menü *<<auftraege/grundeinstellungen#, System » Systemeinstellungen » Aufträge » Einstellungen>>*.
...
. Öffne das Menü *System » Systemeinstellungen » Aufträge » Ereignisse*.
. Klick auf die Ereignisaktion, der du einen Filter hinzufügen möchtest.
. Klick im Bereich Filter auf das *grüne Plus*.
...
Dieser Filter prüft auf im Auftrag enthaltene Artikel, an denen du im Menü *System » Systemeinstellungen » Einstellungen » Eigenschaften » Konfiguration* eine bestimmte <<artikel/artikel-verwalten#3000, Eigenschaft>> hinterlegt hast. Innerhalb des Filters wählst du eine Eigenschaft, nach der Artikel gefiltert werden.
...
====
Wenn du mehrere Aktionen zugleich auswählst, werden diese nacheinander abgearbeitet. Klick auf die grau hinterlegten *Pfeile* an den bereits hinzugefügten Aktionen, um die Reihenfolge zu ändern, in der die Aktionen ausgeführt werden.
====
...
. Öffne das Menü *System » Systemeinstellungen » Aufträge » Ereignisse*.
. Klick auf die Ereignisaktion, der du eine eine Aktion hinzufügen möchtest.
. Klick im Bereich *Aktionen* auf das *grüne Plus*.
