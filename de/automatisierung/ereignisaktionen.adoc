...
Jeweils eigene Aktionen sind verfügbar für: <<payment/crefopay#, CrefoPay>>, <<payment/amazon-pay#, Amazon Pay>>, *ClickandBuy*, <<payment/paymorrow#, paymorrow>>, <<maerkte/plus-gartenxxl#, Netto eStores>>, <<payment/postpay#, POSTPAY>>, <<maerkte/rakuten/rakuten-einrichten#, Rakuten>>, <<payment/worldpay#, Worldpay>>, <<payment/sage-pay#, SagePay>>, <<payment/klarna-checkout-uk#, Klarna UK>>.
...
Jeweils eigene Aktionen sind verfügbar für: <<apayment/klarna#, Klarna>>, <<multi-channel/amazon/amazon-einrichten#, Amazon>>, <<maerkte/plus-gartenxxl#, Netto eStores>>, <<payment/postpay#, POSTPAY>>, <<maerkte/rakuten/rakuten-einrichten#, Rakuten>>, <<maerkte/shopgate#, Shopgate>>, <<maerkte/flubit#, Flubit>>, <<maerkte/idealo/idealo-einrichten#, idealo>>, <<maerkte/fruugo#, Fruugo>> und <<maerkte/cdiscount#, Cdiscount>>. +
