...
|Die Aktion splittet Aufträge nach <<artikel/einstellungen/verfuegbarkeiten#, Artikelverfügbarkeit>>. Stelle aus den Artikelverfügbarkeiten eine *Verfügbarkeitsgruppe* zusammen, die für die gefilterten Aufträge greift. Verschiebe dafür eine oder mehrere der Verfügbarkeiten nach rechts in die Gruppe. +
...
//Check: Neuer Auftrag mit Artikeln dieser Gruppe, was ist mit dem Rest?
