...
| *Statuswechsel*
|Die Ereignisaktion wird ausgelöst, wenn ein Auftrag den Status wechselt.
...
|Die Ereignisaktion wird ausgelöst, wenn in einem Auftrag der Reparaturstatus geändert wird.

| *Wechsel der Zahlungsart*
|Die Ereignisaktion wird ausgelöst, wenn in einem Auftrag die Zahlungsart geändert wird.
...
| *Vollständig*
|Die Ereignisaktion wird ausgelöst, wenn eine vollständige Zahlung eingebucht und einem Auftrag zugewiesen wird, der Auftrag dementsprechend vollständig bezahlt ist.
...
|Wenn eine Nachbestellung oder Umbuchung ausgelöst wurde. Bei Nachbestellungen bedeutet dies, dass die Bestellung an den Lieferanten übermittelt wurde. Bei Umbuchungen bezeichnet das Auslösen den Beginn der Umbuchung von Waren von einem Senderlager in ein Empfängerlager.
