...
Jeweils eigene Aktionen sind verfügbar für: <<payment/zahlungsanbieter/crefopay#, CrefoPay>>, <<payment/zahlungsanbieter/amazon-pay#, Amazon Pay>>, *ClickandBuy*, <<payment/zahlungsanbieter/paymorrow#, paymorrow>>, <<maerkte/plus-gartenxxl#, Netto eStores>>, <<payment/zahlungsanbieter/postpay#, POSTPAY>>, <<payment/zahlungsanbieter/worldpay#, Worldpay>>, <<payment/zahlungsanbieter/sage-pay#, SagePay>>, <<payment/zahlungsanbieter/klarna-checkout-uk#, Klarna UK>>.
...
Jeweils eigene Aktionen sind verfügbar für: <<payment/zahlungsanbieter/klarna#, Klarna>>, <<maerkte/amazon/amazon-einrichten#, Amazon>>, <<maerkte/plus-gartenxxl#, Netto eStores>>, <<payment/zahlungsanbieter/postpay#, POSTPAY>>, <<maerkte/shopgate#, Shopgate>>, <<maerkte/flubit#, Flubit>>, <<maerkte/idealo/idealo-einrichten#, idealo>>, <<maerkte/fruugo#, Fruugo>> und <<maerkte/cdiscount#, Cdiscount>>. +
