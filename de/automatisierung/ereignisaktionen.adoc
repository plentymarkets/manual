...
| *Statuswechsel*
|Die Ereignisaktion wird ausgelöst, wenn ein Auftrag den <<auftraege/auftraege-verwalten#1200, Auftragsstatus>> wechselt.
...
|Die Ereignisaktion wird ausgelöst, wenn in einem Auftrag die Auftragsart geändert wird.

| *Wechsel des Reparaturstatus*
|Die Ereignisaktion wird ausgelöst, wenn in einem Auftrag der <<auftraege/auftraege-verwalten#710, Reparaturstatus>> geändert wird.
