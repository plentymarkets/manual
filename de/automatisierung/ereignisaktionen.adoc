...
Dieser Filter prüft auf im Auftrag enthaltene Artikel, an denen Sie im Menü *System » Systemeinstellungen » Einstellungen » Eigenschaften » Konfiguration* eine bestimmte <<artikel/artikel-verwalten#3000, Eigenschaft>> hinterlegt haben. Innerhalb des Filters wählen Sie eine Eigenschaft, nach der Artikel gefiltert werden.
