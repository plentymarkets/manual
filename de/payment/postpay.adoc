...
Sofern Sie bereits einen Händlerkonto bei **link:https://de.allyouneed.com/de/customerlogin.html[Allyouneed.com, window="_blank"]** haben, ist keine erneute Registrierung notwendig. Sie können sofort mit der **<<payment/postpay#30, Einrichtung von POSTPAY >>** beginnen.
...
Richten Sie eine <<auftraege/einstellungen/ereignis-aktionen#, **Ereignisaktion**  >> ein, um Versandbestätigungen automatisch zu versenden, nachdem der Warenausgang gebucht wurde.
...
Richten Sie eine <<auftraege/einstellungen/ereignis-aktionen#, **Ereignisaktion**  >> ein, um Retouren automatisch an POSTPAY zu senden. Weitere Details zum Anlegen von Retouren finden Sie auf der Handbuchseite **<<auftraege/auftraege-bearbeiten/retoure#, Retoure  >>**.
...
Richten Sie eine <<auftraege/einstellungen/ereignis-aktionen#, **Ereignisaktion**  >> ein, um POSTPAY automatisch über Stornierungen zu informieren.
