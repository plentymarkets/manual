...
:id: PBKWNPM
:keywords: PayPal, PayPal einrichten, PayPal verknüpfen, PayPal PLUS, Konto, Ceres, Plugin, Callisto, PayPal-Konto, Konto, Kontoverknüpfung, Browser, Konto-Einrichtung, Konto einrichten, Kontoeinrichtung
:author: team-order-payment

Im plentyMarketplace erhältst du alle wichtigen Informationen zum link:https://marketplace.plentymarkets.com/plugins/payment/paypal_4690[PayPal-Plugin^]. Nutze zudem auch das link:https://forum.plentymarkets.com/c/payment[Forum^], um entweder Informationen aus einem bestehenden Thread zu ziehen oder deine Frage an unsere Supporter zu stellen.
...
* *Lösung 2:* Es existiert noch eine API-Berechtigung im PayPal-Konto. Entferne die Berechtigung für plentymarkets. Die API-Berechtigung ist unter folgender URL zu finden: link:https://www.paypal.com/cgi-bin/webscr?cmd=_profile-api-list-auths[].
...
Wenn diese Meldung während der Rückleitung erscheint, muss möglicherweise noch die E-Mail bestätigt werden: link:https://www.paypal.de/emailbestaetigung[].
