...
Hier findest du Best Practices zum Thema *PayPal-Plugin*.
...
Bitte überprüfe zuerst, ob die aktuellste Version des PayPal-Plugins in deinem plentymarkets System installiert und bereitgestellt ist.

[WARNING]
.Aktivierung und Vorschau des Plugins
====
Stelle sicher, dass das PayPal-Plugin zum Zeitpunkt der Kontoverknüpfung bereits im <<basics-erste-schritte/plugins#20, Plugin-Set>> des Hauptmandanten aktiviert und bereitgestellt ist. Ist dies nicht der Fall, kommt es zu Fehlfunktionen. +
