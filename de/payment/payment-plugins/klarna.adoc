...
Stelle sicher, dass die Zahlungsart in den <<crm/kontakte-verwalten#15, Kundenklassen>> erlaubt ist. Überlege dir hierfür, für welche Kundenklassen die Zahlungsart gelten soll. Dies ist in jedem System individuell einstellbar.
