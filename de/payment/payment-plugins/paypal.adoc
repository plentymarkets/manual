...
Der PayPal SmartButton und die PayPal Ratenzahlung Banner stehen im ShopBuilder als Widgets zur Verfügung.
...
|*PayPal SmartButton*
|Optional: Der SmartButton ist universell hinterlegbar, z.B. neben dem Warenkorb (Shopping cart). Er gibt Kund:innen die Möglichkeit, den Inhalt des gesamten Warenkorbs sofort zu kaufen, ohne den Umweg über die Kaufabwicklung zu machen. Hierbei wird er direkt zur Zahlung weitergeleitet. Die Lieferadresse wird von PayPal bereitgestellt.
