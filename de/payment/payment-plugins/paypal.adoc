...
* *PayPal PLUS*: Setze den Haken nur, wenn das Konto von PayPal für PayPal PLUS freigeschaltet ist.
...
[cols="3,3,3"]
|====
|Problemfall |Erläuterung |Reaktionsmöglichkeiten
...
. Wähle eine Option als Reaktion. Beachte dabei die Erläuterungen in <<table-responce-options-for-conflicts>>.
