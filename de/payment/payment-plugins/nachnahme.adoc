...
Mit dem Plugin *Nachnahme* bindest du die Zahlungsart Nachnahme in deinem Webshop ein und stellst sie so deinen Kund:innen zur Auswahl. Zudem musst du einige grundlegende Einstellungen in deinem plentymarkets System ausführen, damit die Zahlungsart auch in deinem System aktiviert ist.
