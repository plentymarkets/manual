...
Mit der Funktion Ein-Klick-Zahlungen können deine Kund:innen ihre Kreditkartendaten durch Anlegen eines Kundenkontos bei Mollie direkt speichern. So müssen Daten nicht bei jedem Einkauf wieder eingegeben werden und die Zahlungsabwicklung kann schneller erfolgen.
