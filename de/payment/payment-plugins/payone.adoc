...
Sollte eine ausgewählte Zahlungsart im Checkout zurückgewiesen werden oder nicht möglich sein, haben deine Kund:innen haben die Möglichkeit die Zahlungsart zu wechseln. Sie können dann zwischen allen verfügbaren Zahlungsarten außer Amazon Pay wählen.
