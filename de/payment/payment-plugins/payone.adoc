...
[#60]
== Ceres-Checkout anpassen CHECK!

Als Nächstes ist eine Anpassung im Ceres Checkout notwendig, damit deine Kund:innen bei Bezahlvorgängen mit Payone ihr Geburtsdatum (nur für den gesicherten Rechnungskauf) korrekt eingeben können.
