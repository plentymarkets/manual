...
Du kannst dir auch den link:https://www.plentymarkets.eu/blog/plentyCommunity-Projekt-EBICS-Komplett-auf-den-Anwender-ausgerichtet/b-1941/[Blog-Beitrag^]{nbsp}icon:external-link[] zum Plugin durchlesen, um allgemeine Informationen zur Entwicklung des Plugins zu erfahren.
