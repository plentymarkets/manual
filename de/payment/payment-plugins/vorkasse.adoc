...
:keywords: Zahlungsarten, Zahlungen, Vorkasse, Vorkassenzahlung, Vorkasse-Plugin, Vorkasseplugin, Vorkasseassistent, Vorkasse-Assistent, Plugin, Zahlungsplugin, Zahlungs-Plugin, Payment-Plugin, Paymentplugin, Payment-Integration, Paymentintegration, Paymentschnittstelle, Payment-Schnittstelle, Bankdaten-Container, Vorkasse-Template, Vorkasse-Container, Vorab-Zahlung, Advance, Cash in advance
...
. Klicke auf *Container-Verknüpfungen*.
. Wähle den Bereich *Container-Links* aus.
. Wähle aus der *Data-Provider* Dropdown-Liste *Cash in advance Reinitilise Payment* aus.
...
Wenn gewünscht kannst du das Logo der Zahlungsart auf der Startseite deines plentyShops verknüpfen. Gehe dafür wie im Folgenden beschrieben vor.
...
. *Speichere* (icon:save[role=green]) die Einstellungen. +
→ Das Logo der Zahlungsart wird auf der Startseite deines plentyShops angezeigt.
