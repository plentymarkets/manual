...
Mit dem Plugin *Sofort* bindest du die KLarna-Zahlungsart *Sofort* in deinem Webshop ein und stellst sie so deinen Kund:innen zur Auswahl. Dafür musst du einige grundlegende Einstellungen in deinem plentymarkets System ausführen, damit die Zahlungsart auch in deinem System aktiviert ist. +
