...
====
Diese Handbuchseite beschreibt ausschließlich die Einrichtung der Schnittstelle *heidelpay* für Callisto Shops. Für die Verwendung von *heidelpay* in Ceres Shops erhältst du in der Beschreibung des Plugins im link:https://marketplace.plentymarkets.com/plugins/payment/Heidelpay_5700[plentyMarketplace^]{nbsp}icon:external-link[].
====
...
Kontaktiere das heidelpay-Vertriebsteam unter Tel. 06221-6517020 oder link:mailto:sales@heidelpay.de[sales@heidelpay.de]{nbsp}icon:external-link[] und bitte um ein Angebot. Unterschreibe das Angebot und sende es zurück an heidelpay. Du erhältst dann einen Kreditkartenakzeptanzvertrag von heidelpay zur Unterschrift. Nach Freigabe durch die Bank erhältst du die Zugangsdaten von heidelpay. Die Zugangsdaten benötigst du für die Aktivierung in plentymarkets.
