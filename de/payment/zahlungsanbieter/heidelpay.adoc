...
Gehen Sie wie unten beschrieben vor, um die Schnittstelle zu heidelpay für Ihren Callisto Shop in plentymarkets einzurichten. Zusätzlich steht für heidelpay das Untermenü <<payment/zahlungsanbieter/heidelpay#80, Optionen>> zur Verfügung, wo Sie z.B. ein Stylesheet (CSS) hinterlegen.
