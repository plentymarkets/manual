...
link:https://www.creditreform.de/crefopay.html[CrefoPay^]{nbsp}icon:external-link[] wird angeboten vom Verband der Vereine Creditreform e.V. und ist eine Payment-Lösung für den Online-Handel.
...
Registriere dich bei CrefoPay, bevor du mit der Einrichtung in plentymarkets fortfährst. Nimm hier link:http://www.creditreform.de/microsites/crefopay-kontakt.html[Kontakt^]{nbsp}icon:external-link[] zu CrefoPay auf.
