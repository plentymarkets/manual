...
| *ApiKey*
|Api-Schlüssel von BitPay eingeben. Der link:https://bitpay.com/api-keys[ApiKey^]{nbsp}icon:external-link[] kann nach der Registrierung bei BitPay erzeugt werden.
