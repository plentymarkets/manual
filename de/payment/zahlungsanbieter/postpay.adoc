...
Sofern Sie bereits einen Händlerkonto bei link:https://de.allyouneed.com/de/customerlogin.html[Allyouneed.com^] haben, ist keine erneute Registrierung notwendig. Sie können sofort mit der <<payment/postpay#30, Einrichtung von POSTPAY>> beginnen.
...
Richten Sie eine <<basics/automatisierung/ereignisaktionen#, Ereignisaktion>> ein, um Retouren automatisch an POSTPAY zu senden. Weitere Details zum Anlegen von Retouren finden Sie auf der Handbuchseite <<auftraege/auftraege-verwalten#retoure, Retoure>>.
