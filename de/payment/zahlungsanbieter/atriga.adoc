...
In plentymarkets hast du die Möglichkeit, sowohl nur link:http://gateway.atriga.com/dls/services/?DID=400005000[atriga Inkasso^] zu nutzen als auch atriga Inkasso in Verbindung mit der Bonitätsprüfung von link:http://www.atriga.de/co/atriga/paymax/paymax.html[atrigapaymax^]{nbsp}icon:external-link[].

[#10]
== atriga-Konditionen für plentymarkets

Für plentymarkets Kunden entstehen keinerlei Inkassokostenvorschüsse und keine Kosten bei Nichterfolg. Im Erfolgsfall erhältst du 100% Auszahlung. Ganz nach deiner Wahl, entweder online per DebitManager, E-Mail und/oder RSS-Feed, bist du jederzeit über den Ablauf der Inkassoaufträge informiert. In das atriga-link:http://gateway.atriga.com/dls/services/?DID=400002000[Inkassoverfahren^]{nbsp}icon:external-link[] ist die SCHUFA-Prüfung* deines Schuldners kostenfrei für dich integriert. Die Prüfung ermöglicht eine solide Einschätzung darüber, wie es um deinen Schuldner wirtschaftlich steht.
...
Registriere dich online kostenfrei und unverbindlich im atriga link:http://dm.atriga.de/[DebitManager™^]{nbsp}icon:external-link[].  +
Am Ende der Registrierung erhältst du eine atriga-Kundennummer. Die atriga-Kundennummer sendest du einfach per E-Mail an link:mailto:info@atriga.com[info@atriga.com]{nbsp}icon:external-link[]. Gib das Stichwort „plentymarkets“ im Betreff der E-Mail an, um die oben beschriebenen Konditionen zu erhalten. atriga stellt deinen Status dann auf plentymarkets Kunden um. Nach der Umstellung erhältst von atriga eine Nachricht und kannst anschließend die automatisierte Übertragung der Inkassomandate einrichten.  +
...
Im Beispiel in <<bild-aktion-atriga-konfigurieren>> werden alle Aufträge, die sich seit *20 Tagen* im Status *3 Warten auf Zahlung* befinden, an atriga geschickt. Im atriga link:http://dm.atriga.de/[DebitManager™^]{nbsp}icon:external-link[] findest du Informationen zu deinen Inkassoaufträgen.
