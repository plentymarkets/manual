...
Wenn eine Bonitätsprüfung fehlschlägt, werden für den Kunden die Einstellungen eines negativen, d.h. roten, Bonitätsergebnisses berücksichtigt. Ob eine Prüfung fehlgeschlagen ist, können Sie im <<basics/datenaustausch/api-log#, API-Log>> nachvollziehen. Die Prüfung ist fehlgeschlagen, wenn in der Response von atrigapaymax ein Error vermerkt ist. Beim nächsten Einkauf des Kunden wird erneut eine Prüfung durchgeführt.
