...
. Öffne das Menü *System » Systemeinstellungen » Mandant » Mandant wählen » Dienste » atriga*.
...
. Öffne das Menü *System » Systemeinstellungen » Mandant » Mandant wählen » Mein-Konto » Grundeinstellungen*.
