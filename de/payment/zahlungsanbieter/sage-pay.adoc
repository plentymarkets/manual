...
Mit einer Ereignisaktion senden Sie die <<payment/zahlungsanbieter/sage-pay#110, Stornierung>> an Sage Pay.
...
Richten Sie eine <<automatisierung/ereignisaktionen#, Ereignisaktion>> ein, um Sage Pay automatisch über Stornierungen zu informieren.
...
Wenn Sie eine Zahlung bereits erhalten haben und dem Kunden das Geld per Gutschrift erstatten möchten, richten Sie eine <<automatisierung/ereignisaktionen#, Ereignisaktion>> ein, um Gutschriften automatisch an Sage Pay zu senden.
