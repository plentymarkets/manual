...
Mithilfe der in Ihrem plentymarkets System verfügbaren Ereignisaktionen können Sie die Kommunikation mit Kunden automatisieren, die Amazon Pay als Zahlungsart für ihre Aufträge gewählt haben. Im Folgenden werden die Ereignisaktionen für das automatische Versenden von <<auftragsabwicklung/payment/amazon-pay#80, Versandbestätigungen>>, <<auftragsabwicklung/payment/amazon-pay#90, Stornierungen>> sowie für die Abwicklung von <<auftragsabwicklung/payment/amazon-pay#100, Rückerstattungen>> und die Meldung <<auftragsabwicklung/payment/amazon-pay#150, abgelehnter Zahlungen>> beschrieben.
