...
====
Um die Bankdaten von Paymorrow korrekt auf Ihrer Rechnung auszugeben, muss für den Zahlungshinweis im Menü *System » Systemeinstellungen » Mandant » Mandant wählen » Standorte » Standort wählen » Dokumente » Rechnung* eine Breite von 120 Millimetern eigegeben werden.
====
...
Wird ein Auftrag storniert, muss der Status den Einstellungen unter *System » Systemeinstellungen » Aufträge » Einstellungen* entsprechen, damit der Vorgang auch als storniert an Paymorrow übermittelt wird. Richten Sie eine <<automatisierung/ereignisaktionen#, Ereignisaktion>> ein, um Stornierungen automatisch an Paymorrow zu senden.
