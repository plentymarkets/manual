...
Schließe einen link:https://www.six-payment-services.com/dam/downloads/contracts/116004201_CO_Saferpay_Contract_DEU_DE_active.pdf[Vertrag für die Nutzung von Saferpay^]{nbsp}icon:external-link[] mit SIX Payment Services ab. Du erhältst mit der Bestätigung des Vertrags die Zugangsdaten, die du für die Aktivierung in plentymarkets benötigst.
