...
Bevor du den Service von mediafinanz in plentymarkets einrichten kannst, registriere dich bei link:https://www.mediafinanz.de/inkassoverfahren-starten[mediafinanz^]{nbsp}icon:external-link[].
...
. Öffne das Menü *Einrichtung » Aufträge » Inkasso » mediafinanz*. +
