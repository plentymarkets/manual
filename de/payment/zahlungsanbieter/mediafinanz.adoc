...
Für die Zuordnung der Mahnstufe zu unbezahlten Aufträgen benötigen Sie einen <<auftraege/auftraege-verwalten#, Auftragsstatus>>. Sie können einen Standardstatus verwenden oder einen eigenen Auftragsstatus erstellen. Mit der folgenden Aktion ordnen Sie unbezahlten Aufträgen mit dem Aktionsmanager eine Mahnstufe zu.
