...
====
Wir empfehlen Ihnen grundsätzlich, wenn Sie mit Zahlungs- und Kundendaten arbeiten, eine <<start/plentymarkets-konto/service-center/ssl-zertifikat#, **SSL-Verschlüsselung**  >> für Ihren Webshop. Für Zahlungsarten, die mit einem iframe arbeiten, ist dies zwingend.
====
...
|**Rechnung**
|Bei dieser Zahlungsart bestellt der Kunde die Ware auf Rechnung. Die Zahlung erfolgt nach Erhalt der Ware. Der Kunde erhält zum Begleichen des fälligen Betrags ein **<<mandant-shop/standard/dokumente/rechnung#, Rechnungsdokument  >>** mit den Bankdaten des Verkäufers. Zahlungseingänge werden **<<payment/zahlungen-verwalten#30, importiert >>** und anschließend Aufträgen im plentymarkets System zugeordnet. Die Zahlungsart global anbieten oder gezielt nur **<<crm/kundendaten-verwalten#800, für einzelne Kunden erlauben >>**. Weitere Informationen zu dieser Zahlungsart unter **<<payment/zahlungsarten-verwalten#55, Einstellungen für den Rechnungskauf vornehmen >>**.
...
|**Allyouneed Payments**
|Zahlungsart für Aufträge, die über den Marktplatz Allyouneed ins plentymarkets System kommen. Zahlungsart **<<multi-channel/allyouneed#100, Allyouneed Payments >>** aktivieren.

|**Amazon**
|Zahlungsart für Aufträge, die über den Marktplatz Amazon ins plentymarkets System kommen. Zahlungsart **<<multi-channel/amazon#4500, Amazon >>** aktivieren.

|**Amazon Payments**
|Zahlungsart im Webshop für Kunden, die über den Marktplatz Amazon im Webshop einkaufen. Zahlungsart **<<multi-channel/amazon#460, Amazon Payments >>** aktivieren.

|**Amazon Payments Advanced**
|Zahlungsart im Webshop für Kunden, die über den Marktplatz Amazon im Webshop einkaufen. Zahlungsart **<<multi-channel/amazon#570, Amazon Payments Advanced >>** aktivieren.

|**Cdiscount**
|Zahlungsart für Aufträge, die über den Marktplatz Cdiscount ins plentymarkets System kommen. Zahlungsart **<<multi-channel/cdiscount#90, Cdiscount >>** aktivieren.

|**DaWanda**
|Zahlungsart für Aufträge, die über den Marktplatz DaWanda ins plentymarkets System kommen. Zahlungsart **<<multi-channel/dawanda#70, DaWanda >>** aktivieren.

|**eBay-Rechnungskauf**
|Zahlungsart für Kauf auf Rechnung bei eBay. Zahlungsart <<multi-channel/ebay#2250, **eBay-Rechnungskauf** >> aktivieren.
...
|**Fruugo**
|Zahlungsart für Aufträge, die über den Marktplatz Fruugo ins plentymarkets System kommen. Zahlungsart **<<multi-channel/fruugo#60, Fruugo >>** aktivieren.

|**GartenXXL.de**
|Zahlungsart für den Marktplatz GartenXXL.de. Zahlungsart <<multi-channel/plus-gartenxxl#40, **GartenXXL.de** >> aktivieren.

|**La Redoute Payment**
|Zahlungsart für Aufträge, die über den Marktplatz La Redoute ins plentymarkets System kommen. Zahlungsart **<<multi-channel/laredoute#100, La Redoute Payment >>** aktivieren.

|**Neckermann Payment**
|Zahlungsart für den Marktplatz Neckermann.at. Zahlungsart <<multi-channel/neckermann-at#160, **Neckermann.at** >> aktivieren.

|**Otto Payment**
|Zahlungsart für den Marktplatz Otto. Zahlungsart <<multi-channel/otto#30, **OTTO** >> aktivieren.

|**PIXmania Payment**
|Zahlungsart für den Marktplatz PIXmania. Zahlungsart <<multi-channel/pixmania#80, **PIXmania** >> aktivieren.

|**Plus.de Payment**
|Zahlungsart für den Marktplatz Plus.de. Zahlungsart <<multi-channel/plus-gartenxxl#40, **Plus.de Payment** >> aktivieren.

|**Rakuten**
|Zahlungsart für den Marktplatz Rakuten. Zahlungsart <<multi-channel/rakuten#150, **Rakuten** >> aktivieren.

|**real.de Payment**
|Zahlungsart für den Marktplatz real.de. Zahlungsart <<multi-channel/real-de#80, **real.de** >> aktivieren.

|**Shopgate Payment**
|Zahlungsart für den Marktplatz Shopgate. Zahlungsart <<multi-channel/shopgate#60, **Shopgate** >> aktivieren.

|**Yatego Rechnung**
|Zahlungsart für den Marktplatz Yatego. Zahlungsart <<multi-channel/yatego#80, **Yatego Rechnung** >> aktivieren.

|**Zalando Payment**
|Zahlungsart für den Marktplatz Zalando. Zahlungsart <<multi-channel/zalando#80, **Zalando Payment** >> aktivieren.
|====
