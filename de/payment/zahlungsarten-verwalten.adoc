...
Zahlungsarten für Ceres Shops werden über Plugins eingebunden. Die einzelnen Payment-Plugins sowie Anleitungen zur Einrichtung findest du im entsprechenden Bereich des link:https://marketplace.plentymarkets.com/plugins/payment[plentyMarketplace^]{nbsp}icon:external-link[].
...
| *OTTO Market*
|Zahlungsart für die Schnittstelle OTTO. Zahlungsart <<maerkte/otto/otto-market4250, OTTO Direktversand>> aktivieren.
