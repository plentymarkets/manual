...
Klarna Checkout wird über ein iFrame direkt in plentymarkets integriert. Daher ist für die Nutzung der Zahlungsart ein <<start/plentymarkets-konto/service-center/ssl-zertifikat#, **SSL-Zertifikat**  >> notwendig.
...
**__Wichtig:__** In plentymarkets ist Klarna Checkout für die <<payment/klarna-checkout#20, **Lieferländer** >> Deutschland, Österreich, Finnland, Norwegen und Schweden verfügbar. Das heißt, dass nur Kunden mit Wohnsitz in diesen Ländern Aufträge über Klarna Checkout bezahlen können.
...
Richten Sie die zusätzlich gewünschten **<<payment/zahlungsarten-verwalten#20, Zahlungsarten >>** im Menü **Einstellungen » Aufträge » Zahlung » Zahlungsarten** in Ihrem plentymarkets ein und aktivieren Sie die Zahlungsarten.
...
image::payment/assets/DE-Zahlungsarten-Klarna-Checkout-01.png[]
[#160]
...
Damit Klarna über den Versand der Artikel, die Stornierung von Aufträgen und über Retouren informiert wird sowie die Rechnung erstellt bzw. gelöscht wird, erstellen Sie Ereignisaktionen. Die Funktionalität sollte vor Live-Schaltung mit Ihrem Ansprechpartner der Klarna-Integrationsabteilung getestet werden. Richten Sie eine <<auftraege/einstellungen/ereignis-aktionen#, **Ereignisaktion**  >> ein, um Versandbestätigungen automatisch an Klarna zu senden.
...
Richten Sie eine <<auftraege/einstellungen/ereignis-aktionen#, **Ereignisaktion**  >> ein, um Retouren automatisch an Klarna zu senden. Weitere Details zum Anlegen von Retouren finden Sie auf der Handbuchseite **<<auftraege/auftraege-bearbeiten/retoure#, Retoure  >>**.
...
Richten Sie eine <<auftraege/einstellungen/ereignis-aktionen#, **Ereignisaktion**  >> ein, um Stornierungen automatisch an Klarna zu senden.
