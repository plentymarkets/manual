...
Gehen Sie wie unten beschrieben vor, um die Schnittstelle zu heidelpay einzurichten. Zusätzlich steht für heidelpay das Untermenü **<<payment/heidelpay#80., Optionen >>** zur Verfügung, wo Sie z.B. ein Stylesheet (CSS) hinterlegen.
