...
Der Eintrag *PayPal Import* mit dem PayPal-Icon in der linken Navigation wird nur angezeigt, wenn das PayPal-Plugin installiert ist. Dafür ist das PayPal-Plugin mindestens in Version 6.0 erforderlich. +
Mir der Funktion *PayPal Import* kannst du PayPal-Zahlungen über Transaktionsnummern von deinem PayPal-Konto direkt dein plentymarkets System importieren. Dabei werden nur neue Zahlungen importiert, es werden keine bereits existierenden Zahlungen aktualisiert. Gehe für den Import wie folgt vor:
...
. Wähle aus der Dropdown-Liste *PayPal-Konto* das passende Konto aus.
...
////
Noch rausfinden:
- Transaktionsnummer kommasepariert?
- finale Benennungen / Labels (de und en)
- Zum Ausführen: wie Schaltfläche? Icon?
- Supportfunktion beschreiben?
- Werden die Zahlungen dann auch automatisch zugeordnet, wie andere auch?
////
