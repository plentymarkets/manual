...
* Zahlung ist einem Auftrag zugeordnet: <<payment/beta-zahlungen-verwalten#40, Löse die Zahlung vom Auftrag>>. Prüfe vorher aber genau, ob das Lösen der Zahlung vom Auftrag ohne Bedenken durchgeführt werden kann.
* Zahlung wurde geteilt und Teilzahlungen existieren:
