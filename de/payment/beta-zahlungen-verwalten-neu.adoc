= Testphase: Zahlungseingänge bearbeiten
:lang: de
...
In der Ansicht zum Teilen einer Zahlung geben dir Infoboxen einen schnellen Überblick über die wichtigsten Informationen: Betrag, Eingangsdatum der Zahlung sowie Verwendungszweck. Der *Betrag* wird in grün wiedergegeben, wenn er über null liegt, ansonsten in grau. 
...
Neben den Funktionen <<payment/beta-zahlungen-verwalten#30, Zahlungen zuordnen>>, <<payment/beta-zahlungen-verwalten#40, Zahlungen lösen>> und <<payment/beta-zahlungen-verwalten#60, Zahlungen löschen>> bietet dir die Detailansicht einer Zahlung alle mit dieser Zahlung verknüpften Informationen. Infoboxen geben dir einen schnellen Überblick. Der *Betrag* wird in grün wiedergegeben, wenn er über null liegt, ansonsten in grau. Der *Status* wird ebenfalls über Farben ausgedrückt:

* Grün = Freigegeben
* Orange = Warten auf Bestätigung
* Rot = Abgelehnt
