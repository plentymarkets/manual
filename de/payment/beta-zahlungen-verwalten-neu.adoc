...
. Suche (icon:search[set=material]) die gewünschte Zahlung.
...
. Öffne das Menü *Aufträge » Zahlungsverkehr*.
. <<payment/beta-zahlungen-verwalten#20, Suche>> (icon:search[set=material]) die gewünschte Zahlung.
. Klicke in der Zeile der gewünschten Zahlung auf das Icon *Zahlung aufteilen* (icon:call_split[set=material]). +
...
. Öffne das Menü *Aufträge » Zahlungsverkehr*.
. Klicke in der Zeile eines Zahlungseingangs auf *Zahlung löschen* (icon:delete[set=material]). +
