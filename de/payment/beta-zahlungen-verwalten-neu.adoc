...
Neben den Funktionen <<payment/beta-zahlungen-verwalten#30, Zahlungen zuordnen>>, <<payment/beta-zahlungen-verwalten#40, Zahlungen lösen>> und <<payment/beta-zahlungen-verwalten#60, Zahlungen löschen>> bietet dir die Detailansicht einer Zahlung alle mit dieser Zahlung verknüpften Informationen. Infoboxen geben dir einen schnellen Überblick. Die Infobox *Betrag* wird in grün wiedergegeben, wenn der Betrag über null liegt, ansonsten in grau. Die Infobox *Zuordnungsdatum* zeigt dir das Datum, an dem die Zahlung einem Auftrag zugeordnet wurde. Die Infobox ist leer, wenn die Zahlung noch nicht zugeordnet wurde. Der Status der Zahlung wird ebenfalls über Farben der Infobox ausgedrückt:
...
So siehst du auf einen Blick, wann (Datum) von wem (Benutzer oder sonstige Quelle, wie z.B. ein Plugin) was (Aktion und Wert, z.B. zugeordnet | Auftrags-ID) mit der Zahlung gemacht wurde. Über *Spalten konfigurieren* (icon:settings[set=material]) kannst du selbst bestimmen, welche Spalten dir in welcher Reihenfolge angezeigt werden. +
Folgende Einträge kannst du der Zahlungshistorie entnehmen:
...
* Änderung von nicht buchbar zu buchbar
* Statusänderungen
