...
image::payment/assets/portlet-details-edit.png[Details]
...
image::payment/assets/portlet-infoboxes-edit.png[Infoboxen]
...
image::payment/assets/portlet-settings.png[Einstellungen]
