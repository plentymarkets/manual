...
Klarna Checkout UK wird über ein iFrame direkt in plentymarkets integriert. Daher ist für die Nutzung der Zahlungsart ein <<start/plentymarkets-konto/service-center/ssl-zertifikat#, **SSL-Zertifikat**  >> notwendig.
...
Um dem Käufer den gesamten Betrag zu erstatten, legen Sie einen Auftrag vom Typ **Retoure** an. Anschließend richten Sie eine <<auftraege/einstellungen/ereignis-aktionen#, **Ereignisaktion**  >> ein, um Rückerstattungen automatisch an Klarna UK zu senden. Weitere Details zum Anlegen von Retouren finden Sie auf der Handbuchseite **<<auftraege/auftraege-bearbeiten/retoure#, Retoure  >>**.
...
Richten Sie eine <<auftraege/einstellungen/ereignis-aktionen#, **Ereignisaktion**  >> ein, um Stornierungen automatisch an Klarna UK zu senden.
