...
|Aktivieren, wenn PAYONE für link:https://docs.google.com/document/d/10mPeV3xqx4We71dYQdPmJK2qvb21Rpym6FG_tKwHKfc/edit#heading=h.h38ew7hip4tl[**Shopware**, window="_blank"] verwendet werden soll. Weitere Informationen finden Sie unter **<<payment/payone#140., PAYONE für Shopware verwenden >>**.
|====
...
Für PAYONE steht Ihnen eine Vielzahl von Zahlungsarten zur Verfügung, die Sie im Menü **<<payment/zahlungsarten-verwalten#20., Einstellungen » Aufträge » Zahlung » Zahlungsarten >>** aktivieren. Prüfen Sie zudem die Einstellungen für **Erlaubte Zahlungsarten** in den **<<payment/zahlungsarten-verwalten#30., Kundenklassen >>** und für **Gesperrte Zahlungsarten** in den **<<fulfillment/versand-vorbereiten#1000., Versandprofilen >>**.

[#115]
== PAYONE im Webshop anzeigen

Im Menü **CMS** haben Sie die Möglichkeit, die Texte anzupassen, die einem Käufer im Bestellvorgang bei der Zahlungsart PAYONE angezeigt werden. Außerdem erfahren Sie, wo Sie das Design über das CSS anpassen können. Das Formular für Kreditkartendaten sowie das Formular für Online-Überweisungen passen Sie wie folgt an. Weitere Informationen finden Sie auch unter <<cms/webdesign/webdesign-bearbeiten/bestellvorgang/kaufabwicklung#, **Kaufabwicklung**  >>.
...
Das Formular für die Bestellbestätigung passen Sie wie folgt an. Weitere Informationen finden Sie auch unter **<<cms/webdesign/webdesign-bearbeiten/bestellvorgang/bestellbestaetigung#, Bestellbestätigung  >>**.
...
Richten Sie eine <<auftraege/einstellungen/ereignis-aktionen#, **Ereignisaktion**  >> ein, um Versandbestätigungen automatisch an PAYONE zu versenden, nachdem der Warenausgang gebucht wurde.
...
Richten Sie eine <<auftraege/einstellungen/ereignis-aktionen#, **Ereignisaktion**  >> ein, um Rückerstattungen automatisch an PAYONE zu senden.
