...
**link:https://www.creditreform.de/crefopay.html[CrefoPay, window="_blank"]** wird angeboten vom Verband der Vereine Creditreform e.V. und ist laut eigener Aussage eine Payment-Komplettlösung für den Online-Handel.
...
Registrieren Sie sich bei CrefoPay, bevor Sie die Einrichtung in plentymarkets vornehmen. Nehmen Sie link:http://www.creditreform.de/microsites/crefopay-kontakt.html[**Kontakt**, window="_blank"] zu CrefoPay auf.
...
. Ändern Sie die Werte der beiden Variablen von **false** auf **true**. Beachten Sie dazu auch die Erläuterungen in Tabelle 2.
. **Speichern** Sie die Einstellungen.
...
Damit CrefoPay Beträge an Sie auszahlt, müssen Sie bestätigen, dass Sie dem Kunde die Ware gesendet haben. Richten Sie eine <<auftraege/einstellungen/ereignis-aktionen#, **Ereignisaktion**  >> ein, um Versandbestätigungen automatisch zu versenden, nachdem der Warenausgang gebucht wurde.
...
Richten Sie eine <<auftraege/einstellungen/ereignis-aktionen#, **Ereignisaktion**  >> ein, um CrefoPay automatisch über Stornierungen zu informieren.
