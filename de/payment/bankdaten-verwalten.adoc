...
. Öffnen Sie das Menü *System » Systemeinstellungen » Einstellungen » Bank*.
...
Weitere Informationen zu den Einstellungen für Kategorien finden Sie unter <<artikel/kategorien-verwalten#_kategorie_bearbeiten, Kategorien bearbeiten>>.
...
. Öffnen Sie das Menü *System » Systemeinstellungen » Einstellungen » Daten » Migration*.
...
Bei der Umstellung Ihrer Konten auf EBICS erstellen Sie für Ihre Konten einen oder mehrere <<basics/admin-aufgaben/benutzer-verwalten#10, Benutzer>>. Benutzer werden unter EBICS als Teilnehmer bezeichnet. Sie können Teilnehmer mit unterschiedlichen Auftragstypen anlegen. Von diesen Teilnehmern muss ein Teilnehmer mittels der von der Bank erhaltenen *Teilnehmer-ID* im plentymarkets System gespeichert werden.
...
. Öffnen Sie das Menü *System » Systemeinstellungen » Aufträge » Zahlung » Plugins » EBICS*.
...
|Einstellung |Erläuterung
|*Aktiv*
|Klicken Sie auf die Umschaltfläche, um das Konto als aktiv zu markieren.
|*Kontoname*
...
.Domainwechsel
====
Speichern Sie nach einem <<basics/admin-aufgaben/plentymarkets-konto#domain, Domainwechsel>> die Grundeinstellungen des Kontos erneut, um die EBICS-Daten zu aktualisieren.
====
...
Im Menü *System » Systemeinstellungen » Aufträge » Dokumente* gibt es im Untermenü *SEPA-Lastschriftmandat* eine Vorlage für das SEPA-Lastschriftmandat. Weitere Informationen zu Dokumenten finden Sie auf der Handbuchseite zum Thema <<auftraege/auftragsdokumente#, Dokumentenvorlagen>>.
...
Die E-Mail-Vorlage versenden Sie z.B. durch eine <<automatisierung/ereignisaktionen#, Ereignisaktion>>, die durch einen neuen Auftrag aktiviert wird.
...
Sie haben die Möglichkeit, Prozesse einzurichten, um Ihre SEPA-Zahlungsprozesse zu automatisieren. Dazu finden Sie im Menü *System » Systemeinstellungen » Prozesse* die entsprechenden Aktionen <<automatisierung/prozesse/aktionen#400, SEPA Pain001>> und <<automatisierung/prozesse/aktionen#410, SEPA Pain008>>.
