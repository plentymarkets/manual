...
Die Bankdaten, die in den Grundeinstellungen zentral gespeichert werden, sind im gesamten System verknüpft. Eine Korrektur der Bankdaten ist ausschließlich im Menü *Einrichtung » Einstellungen » Bank* vorzunehmen. Änderungen wirken sich auf das gesamte System aus.
