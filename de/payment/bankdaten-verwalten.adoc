...
Auf dieser Handbuchseite erfährst du, wie du deine <<payment/bankdaten-verwalten#10, Bankinformationen>> und die <<payment/bankdaten-verwalten#63, Bankdaten deiner Kunden>> in plentymarkets speicherst und wie du <<payment/bankdaten-verwalten#70, EBICS>> und <<payment/bankdaten-verwalten#200, SEPA>> einrichtest.
...
Um den Zahlungsverkehr mit deinen Kunden auf SEPA umzustellen, migriere die Bankdaten der Kunden, die per Lastschrift bezahlen. Das sind Kunden, die die Zahlungsart Lastschrift nutzen oder für die Abonnements im Menü *Scheduler* eingerichtet sind.
