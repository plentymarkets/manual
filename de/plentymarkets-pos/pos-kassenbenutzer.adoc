...
.Auftrag stornieren
====
Sie können einen POS-Auftrag direkt stornieren, nachdem Sie die Zahlung gebucht haben. Tippen Sie dazu in der Ansicht **Auftrag erstellt** auf **Auftrag stornieren**. Abgeschlossene Aufträge, die seit dem letzten Tagesabschluss über die Kasse erstellt wurden, stornieren Sie über das Menü <<plentymarkets-pos/pos-kassenbenutzer#173, **POS beta » Auftrag stornieren** >>.
====
...
→ Wenn der gezahlte Preis vom aktuellen Preis des Artikels abweicht, <<plentymarkets-pos/pos-kassenbenutzer#140, **passen Sie den Preis des Artikels an** >>.
