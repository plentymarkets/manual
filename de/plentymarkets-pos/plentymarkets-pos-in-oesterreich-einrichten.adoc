...
Die Einstellungen, die Sie benötigen, um ein Benutzerkonto für Kassenbenutzer zu erstellen, werden nachfolgend beschrieben. Allgemeine Informationen zu Benutzerkonten und -rechten finden Sie auf der Handbuchseite <<arbeiten-mit-plentymarkets/benutzer-verwalten#, **Benutzer verwalten**  >>.

[TIP]
.Tipp: Rolle für Kassenbenutzer erstellen
====
Um die Rechteverwaltung für Kassenbenutzer zu vereinfachen, erstellen Sie eine <<arbeiten-mit-plentymarkets/benutzer-verwalten#70., **Rolle** >> mit den Berechtigungen, die Sie Kassenbenutzern zuweisen möchten, und verknüpfen Sie diese Rolle mit den Benutzerkonten von Kassenbenutzern.
====

[#140]
=== Benutzerkonto für Kassenbenutzer erstellen

Damit neue Kassenbenutzer Zugriff auf plentymarkets POS erhalten, legen Sie zunächst im plentymarkets Backend **<<arbeiten-mit-plentymarkets/benutzer-verwalten#, Benutzerkonten  >>** der Benutzerklasse **Variabel** für diese Benutzer an. Gehen Sie dazu wie unten beschrieben vor.
...
Damit Kassenbenutzer in plentymarkets POS Preise bearbeiten, Artikelpositionen umbenennen und/oder Rabatte gewähren können, müssen Sie die Berechtigungen dazu zuweisen. Wie Sie Rollen einrichten und Benutzern zuweisen, erfahren Sie **<<arbeiten-mit-plentymarkets/benutzer-verwalten#, hier  >>**. Dort schalten Sie auch weitere App-Funktionen für Benutzer frei.
...
|**Land**
|Land aus der Dropdown-Liste wählen, in dem die Kasse eingesetzt wird. Standardeinstellung richtet sich nach der Option **Firmensitz für FiBu** im Menü **<<arbeiten-mit-plentymarkets/grundeinstellungen/stammdaten#, Einstellungen » Grundeinstellungen » Stammdaten  >>**.
