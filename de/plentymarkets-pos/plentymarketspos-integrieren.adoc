...
|**Standardkunde**
|Für POS-Aufträge <<plentymarkets-pos/plentymarketspos-integrieren#90, **erstellten Standardkunden** >> wählen, dem über diese Kasse generierte Aufträge zugeordnet werden sollen.
