...
* <<cms-syntax/e-mail/email/link-basket#, Link_Basket  >> — Diese Funktion gibt die URL zum Warenkorb aus.
* <<cms-syntax/e-mail/email/link-checkout#, Link_Checkout  >> — Diese Funktion gibt eine URL zur Verkaufsabwicklung aus.
* <<cms-syntax/e-mail/email/link-item#, Link_Item  >>
* <<cms-syntax/e-mail/email/link-newpassword#, Link_NewPassword  >> — Diese Funktion gibt eine URL zum Formular zum Anlegen eines neuen Passworts aus.
* <<cms-syntax/e-mail/email/link-termsconditions#, Link_TermsConditions  >> — Diese Funktion gibt die URL zu den AGB aus.
* <<cms-syntax/e-mail/email/link-webstore#, Link_Webstore  >> — Diese Funktion gibt die URL zum Webshop aus.
