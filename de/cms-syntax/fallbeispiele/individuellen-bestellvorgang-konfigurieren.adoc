...
image::cms-syntax/fallbeispiele/assets/DE-CMS-CheckoutIndicator.png[Fortschrittsanzeige der Bestellschritte]
...
image::cms-syntax/fallbeispiele/assets/DE-CMS-Zahlungsarten.png[Einstellungen der Zahlungsarten]
