...
* **<<cms-syntax/fallbeispiele/warenkorbaktualisierung#checkout/basketitemslist, POST /rest/checkout/basketitemslist/ >>**
* **<<cms-syntax/fallbeispiele/warenkorbaktualisierung#checkout/basketitemslist, GET /rest/checkout/basketitemslist/ >>**
* **<<cms-syntax/fallbeispiele/warenkorbaktualisierung#itemview/container_itemviewbasketpreviewlist, GET /rest/itemview/container_itemviewbasketpreviewlist/ >>**
