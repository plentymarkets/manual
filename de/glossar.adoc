...
[#plentypos]
plentyPOS:: Kassensystem zum Einsatz auf mobilen Geräten (beispielsweise Tablets) im stationären Handel. Zur Nutzung der Funktionalitäten von plentyPOS muss die <<app#, plentymarkets App>> heruntergeladen werden.
