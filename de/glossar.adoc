...
[#wegoptimierung]
Wegoptimierung:: Optimierung des Laufwegs in einem Lager. Die Wegoptimierung sorgt dafür, dass Ware im Lager möglichst effizient und ohne Umwege gepickt werden kann.
