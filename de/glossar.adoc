...
[entnahme]
Entnahme:: Physische Reduzierung des Bargedlbestandes, um beispielsweise Beträge von der Kasse auf andere Konten zu transferieren. <<pos/pos-kassenbenutzer#200. Enthanhmen>> werden in der plentymarkets App oder im Backend verbucht und können verschiedenen Buchungskonten zugewiesen werden.
