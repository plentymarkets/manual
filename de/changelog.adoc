...
:nav-alias: Changelog 29. Dezember 2021

// Ab dem Eintrag weitermachen: https://forum.plentymarkets.com/t/zalando-erneute-bestands-update-anfrage-bei-internem-fehler-bei-zalando-retry-of-stock-update-request-on-internal-error-on-zalando/664775
...
Für early-Systeme wurden in der Woche vom {startWeekDate} bis zum {endWeekDate} keine Änderungen veröffentlicht.
