...
:nav-alias: Changelog 01. Dezember 2021

// Ab dem Eintrag weitermachen: https://forum.plentymarkets.com/t/auftraege-falsche-daten-im-suchindex-orders-wrong-data-in-search-index/661765
