...
<<<<<<< HEAD
// Ab dem Eintrag weitermachen: 
=======
// Ab dem Eintrag weitermachen: https://forum.plentymarkets.com/t/versand-center-2-0-auftragsdetails-wurden-nicht-fuer-gastbestellungen-angezeigt-shipping-centre-2-0-order-details-were-not-shown-for-guest-orders/664791
>>>>>>> master
