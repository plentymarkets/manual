...
:nav-alias: Changelog 19. Januar 2022

// Ab dem Eintrag weitermachen: https://forum.plentymarkets.com/t/fehler-bei-auftragsnotizen-fuer-auftraege-im-fehlerfall-behoben-fixed-error-with-order-notes-in-case-of-error/666903
...
+
image:changelog/assets/filter-lesezeichen.png[width=640, alt=Sternsymbol bei geöffnetem Filter]
+
...
+
image:changelog/assets/aktive-container-verknuepfungen.png[width=640, alt=Separate Liste aller aktiven Container-Verknüpfungen]
