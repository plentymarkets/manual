...
:nav-alias: Changelog 02. März 2022

// Ab dem Eintrag nach diesem weitermachen: https://forum.plentymarkets.com/t/kataloge-format-lager-verfuegbarkeit-der-lagerorte-ab-jetzt-exportierbar-catalogues-warehouse-availability-of-storage-locations-can-now-be-exported/671937
