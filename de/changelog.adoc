...
:nav-alias: Changelog 10. Juni 2020
...
SSL-Zertifikate können ab jetzt im Backend bestellt und verwaltet werden. Weitere Informationen dazu findest du ebenfalls auf der Handbuchseite <<business-entscheidungen/systemadministration/domains#ssl-zertifikat, Domains>> und dem Beitrag link:https://forum.plentymarkets.com/t/leitfaden-ssl-bestellung/214417[Leitfaden: SSL-Bestellung im Forum^]. +
