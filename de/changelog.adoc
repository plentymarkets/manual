...
:nav-alias: Changelog 10. November 2021

// Ab dem Eintrag weitermachen: https://forum.plentymarkets.com/t/auftraege-aenderung-des-mandanten-fuehrt-zu-falschem-standort-orders-changing-the-client-leads-to-the-wrong-location/659279
