...
:nav-alias: Changelog 14. April 2021
...
* Bei der Korrektur von Aufträgen durch Amazon-VCS-Berichte konnte es zu einem Fehler bei der Korrektur der Auftragspositionen kommen. Betroffene Händler:innen finden Fehlermeldungen ohne Nachricht und mit folgenden Logdetails beim Öffnen des Eintrags:
+
[source]
------
Datum: DD/MM/YYYY HH:MM:SS Zeile: 215 Nachricht:
Object
	message:"Validation error"
	trace:Array[3]
		0:Object
			file:"/plentymarkets/order/src/Repositories/Determiners/VatDeterminer.php"
			line:85
			function:"throwValidationException"
			class:"Plenty\Modules\Order\Repositories\Helper\OrderDetermineHelper"
			type:"::"
			args:Array[0]
		1:Object
			file:"/plentymarkets/order/src/Repositories/OrderBaseRepository.php"
			line:2580
			function:"onUpdate"
			class:"Plenty\Modules\Order\Repositories\Determiners\VatDeterminer"
			type:"::"
			args:Array[0]
		2:Object
			file:"/plentymarkets/order/src/Repositories/OrderBaseRepository.php"
			line:1722
			function:"runDeterminersUpdate"
			class:"Plenty\Modules\Order\Repositories\OrderBaseRepository"
			type:"->"
			args:Array[0]
code:0
line:30
messageBag:Array[1]
	0:Array[1]
		0:"OrderItem id XXXXX does not exist."
Trigger:"cli: artisan cron:run"
------
+
unter *Daten » Log* mit den folgenden Filtern:
...
|3.6.4
a| * Zur Nutzung des Feedback-Plugins muss Ceres in Version 5.0 oder höher installiert sein.
