...
Dazu wechselst Du in den Quellcode-Modus und fügst folgende Zeile ein:

....
<p>
  <a href="HierDeinVideoLink"> Hier dein Video Text, welcher erscheint </a>
</p>
....

Anschließend drückst Du nochmal auf den Button des Quellcode-Modus um wieder in den “normalen” Modus zu kommen. Dann ist deine Video-URL klickbar.
