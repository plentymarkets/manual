...
:nav-alias: Changelog 12. Januar 2022

// Ab dem Eintrag weitermachen: https://forum.plentymarkets.com/t/katalog-neuer-filter-zahlungsziel-fuer-auftraege-und-bestellungen-catalogs-new-filter-payment-due-date-for-orders-and-purchase-orders/666003
// Für den 19.12.: https://forum.plentymarkets.com/t/kataloge-bestellungen-und-bezugskosten-catalogs-purchase-orders-and-procurement-costs/665684
...
* Ab sofort steht dir der Standardformat *Lager* als Katalog für den Export der Daten zur Verfügung. Weitere Informationen findest du auf der Handbuchseite <<daten/daten-exportieren/lagerdaten-exportieren#, Lagerdaten exportieren>>.
...
+
image:changelog/assets/dashboard-forum-ankuendigung.png[width=640, alt=Wichtige Ankündigungen aus dem Forum.]
+
Weitere Informationen und eine Anleitung zum Hinzufügen des Elements auf deinem Dashboard findest du auf der Handbuchseite <<business-entscheidungen/plenty-bi/myview-dashboard#1100, Dashboard>>.
