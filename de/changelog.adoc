...
* In den GitHub-Repositories von link:https://github.com/plentymarkets/plugin-ceres[Ceres^] und link:https://github.com/plentymarkets/plugin-io[IO^]{nbsp}icon:external-link[] wurde jeweils der beta-Branch entfernt. Nutzer, die die Plugins über git auf diesen Branches eingebunden haben, sollten ab sofort die stable-Branches verwenden.
...
|link:https://marketplace.plentymarkets.com/plugins/individualisierung/shop-erweiterungen/findologic_6390[FINDOLOGIC^]{nbsp}icon:external-link[]
|3.0.0
|-

|link:https://marketplace.plentymarkets.com/plugins/individualisierung/widgets/cfourgoogletagmanager_5222[Google Tag Manager^]{nbsp}icon:external-link[]
|2.0.4
|-
...
|link:https://marketplace.plentymarkets.com/plugins/integration/payjoe_5145[PayJoe^]{nbsp}icon:external-link[]
|1.0.10
|-

|link:https://marketplace.plentymarkets.com/plugins/sales/online-shops/plentymarketsshopwareconnector_6787[Shopware 6 Connector^]{nbsp}icon:external-link[]
|1.0.3
|-
