...
Die plentymarkets App funktioniert nur in Kombination mit link:https://www.plentymarkets.com/de/[einem gebuchten plentymarkets System^]. Das heißt, dass du dich in der App <<app/installation#1200, mit denselben Zugangsdaten anmeldest>> wie in deinem plentymarkets System.
