...
[cols="2, 1" grid=none]
|===
|Dein Kunde hat gerade einen Artikel zurückgegeben und benötigt einen Ersatz. Erfahre, wie du ihm den Kaufpreis erstattest, einen Umtausch des Artikels vornimmst und eine Reparatur anlegst.
