...
[cols="2, 1" grid=none]
|===
|Der Kunde will den Artikel doch nicht oder du musst aus anderen Gründen den Auftrag stornieren? In plentymarkets geht das ganz schnell! Mit wenigen Klicks ist eine Stornierung erledigt und du kannst dich wieder deinem Alltag widmen.
