...
[cols="2, 1" grid=none]
|===
|Zähle, wieviel Geld in deiner Kasse ist und dokumentiere alles für deine Buchhaltung. Mit plentymarkets POS ist auch der Kassensturz kein Hexenwerk. Wir zeigen dir wie!
