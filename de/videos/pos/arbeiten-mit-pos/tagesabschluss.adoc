...
[cols="2, 1" grid=none]
|===
|Alles was mit deiner Kasse passiert ist, muss dokumentiert werden. Dafür erstellst du einen Tagesabschluss. plentymarkets POS macht es dir so einfach wie möglich.
...
<<videos/pos/arbeiten-mit-pos/tagesabschluss-zwischenbericht#video, Wo findest du den Beleg im Backend? (1:34)>>
