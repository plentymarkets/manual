...
Außerdem ist es auch entscheidend, dass du auf die korrekte Groß- und Kleinschreibung achtest.

Weiter mit den Bildern. Unabhängig davon, ob du die Produktbilder deines Lieferanten oder selbst gemachte Fotos verwenden willst, ist es dein Ziel, die URL des Bildes zu erhalten.
...
Als nächstes schauen wir uns mal die Kategorien an. Bevor du mit dem Import startest, solltest du sicherstellen, dass alle Kategorien im System bereits angelegt sind.
