...
Damit der Kunde genau für seine Sendung die Tracking-URL erhält, muss die URL die Paketnummer und oftmals auch die PLZ des Empfängers enthalten. Damit du diese Angaben nicht bei jeder Sendung einzeln angeben musst, fügst du einfach die Variablen *[PaketNr]* und *[PLZ]* in die Tracking-URL ein.

Beispiel für die DHL-Tracking-URL: +
...
////
TODO
Damit plentymarkets weiß, wie ein Artikel verschickt werden soll und dem Kunden nur dieses Versandprofil im Webshop zur Auswahl stellt, musst du deinen Artikel im Anschluss mit dem Versandprofil verknüpfen. Weitere Informationen dazu findest du im Bereich
