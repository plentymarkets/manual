...
→ Dies ist notwendig, um DSGVO-konform arbeiten zu können. Weitere Informationen dazu erhältst du auf der Handbuchseite <<fulfillment/versand-vorbereiten#800, Versand vorbereiten>>.
. *Speichere* die Einstellungen.
...
* <<fulfillment/best-practices-dhl#_fehlerbehebung_dhl#, DHL-Fehlermeldungen und deren Lösungen>>
