...
* die Region *Germany* mit dem Lieferland _Deutschland_ ist erstellt
...
Jetzt erfährst du, wie du den Versanddienstleister *DHL Shipping (Versenden)*, mit dem du deine Artikel an deine Kunden verschicken möchtest, einrichtest. Voraussetzung ist, dass du dich bei dem Versanddienstleister vorab registriert hast.
...
Gehe wie im Kapitel <<auftragsabwicklung/fulfillment/versand-vorbereiten#800, Versanddienstleister erstellen>> vor, um weitere Versanddienstleister analog zu erstellen.
...
Im Versandprofil stellst du Versandmöglichkeiten ein, die deine Kunden in der Kaufabwicklung wählen können oder die dein Webshop bestimmten Auftragsarten automatisch zuweist.
...
Nachdem du das Versandprofil erstellt hast, kannst du dich nun um die Versandkosten kümmern. Für jede erstellte Region muss eine eigene Portotabelle erstellt werden.
...
Das DHL Shipping (Versenden)-Plugin ist in deinem plentymarkets System im Menü *Plugins » Plugin-Übersicht* bereits installiert und aktiviert und dadurch im Menü *System » Aufträge » Versand » DHL Shipping* sichtbar. Du musst jetzt noch ein paar Einstellungen in diesem Menü vornehmen:
...
Bitte schaue dir den link:https://marketplace.plentymarkets.com/plugins/integration/DHLShipping_4871[User Guide des DHL Shipping (Versenden)-Plugins^] im plentyMarketplace an. Dort sind alle Einstellungen beschrieben, die du vornehmen musst, um deine Artikel über die Schnittstelle für DHL Shipping zu versenden.
...
* <<auftragsabwicklung/fulfillment/versand-vorbereiten#1600, Berechnungstypen in der Portotabelle>>
