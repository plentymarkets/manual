...
Du musst über ein PayPal-Geschäftskonto verfügen, um das PayPal-Plugin zu nutzen. Nimm nach der Erstellung des PayPal-Geschäftskontos die folgenden Schritte zum Einrichten des Plugins vor.
...
. Öffne das Menü *System » Systemeinstellungen » Mandant* » _Mandant wählen_ » *Standorte* » _Standort wählen_ » *Buchhaltung*.
