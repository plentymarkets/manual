...
[#100]
=== Warenbestand buchen
Hier erfährst du, wie neuer Warenbestand gebucht werden kann.

[.instruction]
Warenbestand buchen:

. Öffne das Menü *Waren » Neuer Wareneingang*.
. Klicke auf *Neuer Wareneingang*. Achte darauf, dass ein Benutzer als <<#110, Eigner>> eingestellt ist.
