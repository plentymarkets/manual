...
IMPORTANT: Hast du deinen Shop schon durch ein Plugin aus dem plentyMarketplace erweitert? Noch nicht? Dann geht's hier zurück zum Thema <<schnelleinstieg/plugins#, Plugins dem System hinzufügen>>.
...
. *Speichere* die Einstellungen. +
→ Die Zahlungsart *Vorkasse* ist in der Kaufabwicklung deines Webshops verfügbar.
