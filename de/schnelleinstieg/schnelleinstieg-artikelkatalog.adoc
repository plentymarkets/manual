...
Jedes neue plentymarkets System enthält standardmäßig einige Testartikel und Testvarianten. Diese Testdaten helfen dir, dich mit der Struktur von Artikeln und Varianten vertraut zu machen, bevor du deine eigenen Produkte importierst oder manuell ins System einpflegst.
...
Kategorien dienen dazu, dein Produktportfolio zu strukturieren und deinen Webshop übersichtlich zu gestalten. Überlege dir zunächst einmal, welche Kategorien und Unterkategorien für deine Produkte sinnvoll wären und es deinen Kundinnen und Kunden leicht machen, sich in deinem Shop zurechtzufinden. Trage diese Informationen am besten in einem Dokument zusammen, bevor du loslegst. Aber keine Panik: Du kannst auch jederzeit neue Kategorien erstellen und Artikel mehreren Kategorien zuordnen.
