...
*_Tipp:_* Du bist gesetzlich verpflichtet, Verbraucherinnen und Verbraucher über die Lieferfristen deiner Produkte zu informieren. Im Menü *System » Systemeinstellungen » Artikel » Verfügbarkeit* sind Standardtexte für 5 Verfügbarkeitsstufen gespeichert. Passe diese Texte bei Bedarf an.
...
*_Tipp:_* Die Umsatzsteuersätze werden im Menü *System » Systemeinstellungen » Mandant » Mandant wählen » Standorte » Standort wählen » Buchhaltung* gepflegt.
...
. Klicke auf *Wählen*. +
*_Tipp:_* Wenn die Schaltfläche ausgegraut ist, klicke mit der Maus auf die Datei in der Liste. +
