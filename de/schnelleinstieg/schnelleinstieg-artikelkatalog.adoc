...
.Artikel kopieren
====
Wenn mehrere deiner Artikel ähnlich sind, kannst du bei der Artikelerstellung Zeit sparen, indem du Artikel kopierst und anpasst. Klicke dazu in der obersten Zeile des Artikels auf das Symbol *Kopieren*.
====
...
link:xxx.xxx musterdatei_initialer_artikelimport.csv[Musterdatei für den initialen Artikelimport]
