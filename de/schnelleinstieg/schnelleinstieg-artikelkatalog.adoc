...
.Artikel kopieren
====
Wenn sich deine Artikel ähneln, kannst du bei der Artikelerstellung Zeit sparen, indem du Artikel kopierst und anpasst. Klicke dazu inder obersten Zeile des Artikels auf das Symbol *Kopieren*.
====
...
Prüfe vor dem Import, ob für alle Artikel und Varianten in der CSV-Datei die folgenden Daten gespeichert sind:
