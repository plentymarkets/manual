...
IMPORTANT: Hast du schon Vorlagen für Rechnung und Stornobelege erstellt? Noch nicht? Dann geht's hier zurück zum Thema <<schnelleinstieg/auftragsabwicklung#, Auftragsabwicklung vorbereiten>>.
...
Die folgenden 2 Ereignisaktionen haben sich im Alltag vieler plentymarkets Händler bewährt. Wir empfehlen dir, den Rechnungsversand in deinem plentymarkets System auf diese Weise zu automatisieren.
...
[%interactive]
* [ ] Hast du ausgewählt, welche <<#100, E-Mail-Vorlagen>> automatisch versendet werden sollen?
* [ ] Hast du Rechnungserzeugung und -versand mithilfe von <<#200, Ereignisaktionen>> automatisiert?

[#600]
== Mehr zum Thema *Automatisierung*

* <<crm/e-mails-versenden#, E-Mails versenden>>
* <<basics/automatisierung/ereignisaktionen#, Ereignisaktionen>>
* <<basics/automatisierung/aktionsmanager#, Aktionsmanager>>
* <<basics/automatisierung/best-practices-automatisierung#, Best Practices: Ereignisaktionen und Aktionsmanager>>
* <<basics/automatisierung/prozesse/prozesse-einrichten, Prozesse einrichten>>

TIP: Weiter zu den <<schnelleinstieg/schnelleinstieg-letzte-schritte#, letzten Schritten>>
