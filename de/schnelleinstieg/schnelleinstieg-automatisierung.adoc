...
====
Im Menü *System » Systemeinstellungen » Mandant* » _Mandant wählen_ » *E-Mail » Automatischer Versand* solltest du nur E-Mail-Vorlagen wählen, die du zuvor bearbeitet und mit deinen eigenen Daten ergänzt hast.
====
