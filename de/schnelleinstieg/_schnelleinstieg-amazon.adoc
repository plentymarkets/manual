...
.  Öffne das Menü *System » Systemeinstellungen » Märkte » Amazon » Kategorieverknüpfung* in plentymarkets.
...
Eigenschaften, die du im Menü <<artikel/artikel-verwalten#3100, System » Systemeinstellungen » Einstellungen » Eigenschaften » Konfiguration>> erstellt hast und zu einer Variante hinzugefügt hast, verknüpfst du im Menü *System » Systemeinstellungen » Einstellungen » Eigenschaften » Konfiguration » Tab: Amazon* mit Amazon.
...
Im Menü *System » Systemeinstellungen » Märkte » Amazon » Datenaustausch » Auftragsimport* richtest du den Import von Amazon-Aufträgen ein. Aufträge können sowohl automatisch über die XML-Schnittstelle als auch manuell über eine CSV-Datei importiert werden.
