...
Lege zunächst einen Auftragsstatus für Amazon-Retouren im Menü <<auftraege/auftraege-verwalten#1200, System » Aufträge » Status>> an, z.B. [9.6] Retoure an Amazon gesendet. Diesen Auftragsstatus benötigst du für die Amazon-Einstellungen.
