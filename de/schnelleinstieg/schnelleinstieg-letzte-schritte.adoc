...
. Öffne das Menü *System » Systemeinstellungen » Mandant » Standard Shop (Standard) » E-Mail » Zugangsdaten*.
...
. Öffne das Menü *System » Systemeinstellungen » Mandant » Standard Shop (Standard) » Webshop » Einstellungen*.
...
. Öffne das Menü *System » Systemeinstellungen » Einstellungen » Benutzer » Konten* » Name deines Benutzerkontos.
...
Wenn du dein System auf eine andere Version umstellen möchtest, findest du Information dazu in deinem Backend im Menü *System » Systemeinstellungen » Mandant » Standard-Shop (Standard) » Version*.
====
