...
* [ ] die link:https://knowledge.plentymarkets.com/schnelleinstieg/schnelleinstieg-basiseinstellungen[Basiseinstellungen^] vorgenommen?
* [ ] link:https://knowledge.plentymarkets.com/schnelleinstieg/schnelleinstieg-warenwirtschaft[Lager und Lieferant^] eingerichtet?
* [ ] die link:https://knowledge.plentymarkets.com/schnelleinstieg/schnelleinstieg-versandoptionen[Versandoptionen^] eingerichtet?
* [ ] deinen link:https://knowledge.plentymarkets.com/schnelleinstieg/schnelleinstieg-artikelkatalog[Artikelkatalog^] aufgebaut?
* [ ] den link:https://knowledge.plentymarkets.com/schnelleinstieg/schnelleinstieg-warenbestand[Warenbestand^] gebucht?
// * [ ] Amazon eingerichtet`
* [ ] link:https://knowledge.plentymarkets.com/schnelleinstieg/schnelleinstieg-ebay[eBay^] eingerichtet?
* [ ] deinen link:https://knowledge.plentymarkets.com/schnelleinstieg/schnelleinstieg-webshop[Webshop^] gestaltet?
* [ ] die link:https://knowledge.plentymarkets.com/schnelleinstieg/schnelleinstieg-zahlungsabwicklung[Zahlungsabwicklung^] eingerichtet?
* [ ] die link:https://knowledge.plentymarkets.com/schnelleinstieg/schnelleinstieg-auftragsabwicklung[Auftragsabwicklung^] vorbereitet?
* [ ] Einstellungen zur link:https://knowledge.plentymarkets.com/schnelleinstieg/schnelleinstieg-automatisierung[Automatisierung^] vorgenommen?
...
. Öffne das Menü *System » Einstellungen » Benutzer » Konten* » Name deines Benutzerkontos.
...
* Unsere link:https://www.plentymarkets.eu/knowledge/video-tutorials/[Videotutorials^] bieten dir weitere nützliche Anleitungen.
* Wenn du möchtest, dass dir unsere Einrichter mit Rat und Tat zur Seite stehen, kannst du link:https://www.plentymarkets.eu/service/systemeinrichtung-consulting/[hier^] einen Termin vereinbaren.
* Professionelle Unterstützung bei der Gestaltung deines Webshops erhältst du bei unseren link:https://www.plentymarkets.eu/service/partneragenturen/[Partneragenturen^].
