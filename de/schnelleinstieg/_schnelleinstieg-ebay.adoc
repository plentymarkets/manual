...
Auf dieser Seite erfährst du, welche Grundeinstellungen du vornehmen musst, um Artikel auf eBay verkaufen zu können. Wir gehen in diesem Schnelleinstieg davon aus, dass du bereits vor der Nutzung von plentymarkets Artikel auf eBay eingestellt hast und dass du deine Artikel vorrangig in Deutschland verkaufst.
...
Mehrere Listings legst du mit der *Gruppenfunktion* oder mit der *Stapelverarbeitung* im Menü *Artikel* an. Bei der Gruppenfunktion werden Listings für zuvor gewählte Artikel angelegt. Bei der Stapelverarbeitung werden Listings für zuvor gefilterte Artikel angelegt.

[IMPORTANT]
.Listing-Vorlagen am Artikel einstellen
====
Eine Listing-Vorlage stellst du im Tab *Sonstige »* Tab: *eBay-Optionen* eines Artikels ein. Obwohl das Tab *eBay-Optionen* heißt, kannst du auch Listing-Vorlagen für andere Marktplätze einstellen. Wenn für den Artikel keine *Listing-Vorlage* gespeichert wurde, wird über die Gruppenfunktion und die Stapelverarbeitung für *Artikel* ein eBay-Listing angelegt.
====
...
Du kannst ein einzelnes Listing oder mehrere Listings gleichzeitig kopieren. Das Kopieren von Listings kann sinnvoll sein, wenn du z.B. ein Listing auf ebay.de eingestellt hast und das Listing ebenfalls auf ebay.at oder einer anderen Länderplattform einstellen möchten. Um doppelte Listings im System zu vermeiden, ändere nach dem Kopieren die Einstellungen des Listings, also die Plattform, auf der das Listing eingestellt wird.
...
====
Wenn du Einstellungen in der Stapelverarbeitung oder der Gruppenfunktion änderst sowie die Aktion *Listings kopieren* wählst, werden die Einstellungen für die kopierten Listings übernommen. Somit werden Ihre Listings beim Kopieren geändert.
====
...
In der Übersicht des Menüs *Listings » Aktive Listings* siehst du alle aktiven Listings.
