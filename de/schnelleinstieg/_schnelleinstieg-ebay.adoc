...
|*PayPal-Konto*
| PayPal-Konto wählen. Nur PayPal-Konten werden angezeigt, die unter *System » Aufträge » Zahlung » Zahlungsarten » PayPal* eingerichtet wurden.
...
|*Rücksendekosten*
| Wählen, ob der Käufer oder der Verkäufer die Rücksendekosten trägt. *Aktualisiere* die betreffenden Listings.
|====
...
Im Menü *System » Märkte » eBay » Rahmenbedingungen » Tab: Versandprofile* findest du die Tabs *Übersicht* und *Neu*. Im Tab *Übersicht* siehst du die bereits angelegten Versandprofile. Hier bearbeitest oder löschst du bestehende Profile. Im Tab *Neu* legst du weitere Versandprofile an.
...
Der erste Schritt ist geschafft! Du hast eBay in plentymarkets eingerichtet und Grundeinstellungen für den Marktplatz getroffen. Der nächste Schritt, um Artikel auf eBay verkaufen zu können, ist, Listings in plentymarkets anzulegen. Wie du Listings in plentymarkets vorbereitest, erfährst du in diesem Kapitel. Voraussetzung dafür ist, dass du deine Artikel bereits vollständig in plentymarkets angelegt hast.

Im Menü *System » Listings* nimmst du Einstellungen vor, die für alle Listings gelten, unabhängig von der Plattform.
...
Im Menü *System » Listings » Warenbestand* wählst du, ob Listings automatisch beendet und an den Netto-Warenbestand angepasst werden. Außerdem wird das Lager gewählt, aus dem die Ware für Listings stammt. Beachte für das Beenden von Angeboten die Bestimmungen des Marktplatzes und die rechtlichen Hinweise.
...
Verknüpfe als nächstes Listings mit der Layout-Vorlage. Nutze für mehrere Listings eine <<Listing-Vorlagen anlegen, Listing-Vorlage>>. Einzelne Listings verknüpfst du direkt im Listing.
...
.if-Logik verwenden
====
In Layout-Vorlagen kann <<omni-channel/online-shop/webshop-einrichten/cms-syntax#grundlagen-if, if-Logik>> nach den Regeln des *Webdesigns* in plentymarkets verwendet werden.
====
...
====
Eine Listing-Vorlage stellst du im *Tab: Multi-Channel* im Bereich *Listing-Voreinstellungen* eines Artikels ein. Wenn für den Artikel keine *Listing-Vorlage* gespeichert wurde, wird über die Gruppenfunktion und die Stapelverarbeitung für *Artikel* ein eBay-Listing angelegt.
====
...
| Fahrzeugverwendungsliste hinzufügen. Name einer Liste oder einen Teil des Namens eintragen und eine Liste wählen. Fahrzeugverwendungsliste im Menü *System » Märkte » eBay » Fahrzeugverwendungsliste* erstellen.
...
Nachdem du deine Listings angelegt und bearbeitet hast, kann es schon bald mit dem Verkauf losgehen, denn im nächsten Schritt startest du deine Listings. +
...
In plentymarkets hast du mehrere Möglichkeiten, Listings automatisch zu starten oder erneut zu starten, nachdem sie bereits eingestellt wurden. Mit dem Verkaufsplaner legst du *Startzeiten* für Listings fest. Den Verkaufsplaner richtest du im Menü *System » Listings » Verkaufsplaner* ein.
...
Im Menü *System » Märkte » eBay » Einstellungen » Kontoeinstellungen* legst du fest, ob alle neu gestarteten Listings zum Treueprogramm gehören sollen. Listings können auch im Nachhinein bearbeitet und für das Treueprogramm aktiviert oder deaktiviert werden.
...
Weitere rund um eBay zu den folgenden Themen findest du hier:
