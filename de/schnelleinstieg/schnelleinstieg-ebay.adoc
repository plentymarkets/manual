...
Für ein Produkt, das auf eBay einzeln und in einem Set verkauft wird, kann es mehrere ePIDs geben. Im Menü *System » Märkte » eBay » ePID-Verknüpfung* verknüpfst du Varianten mit ePIDs.
