...
Weitere Informationen zu den Template-Variablen findest du weiter unten auf dieser Seite in den Kapiteln <<schnelleinstieg/schnelleinstieg-basiseinstellungen#600, Beispiel: E-Mail-Vorlage anpassen>> und <<schnelleinstieg/schnelleinstieg-basiseinstellungen#700, Template-Variablen und Template-Funktionen einfügen>>.
