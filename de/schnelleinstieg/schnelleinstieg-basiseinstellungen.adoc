...
Für den Anfang empfehlen wir dir das Erstellen von zwei Kundenklassen: B2C für deine Endkunden und B2B für Händler. Du benötigst die Kundenklassen für eventuelle weitere Einstellungen, die du in deinem plentymarkets System vornehmen möchtest, wie z.B. das Speichern von Verkaufspreisen oder die manuelle Anlage eines Kontaktdatensatzes.

[.instruction]
Kundenklasse erstellen:

. Öffne das Menü *System » CRM » Kundenklassen*.
. Wechsele in das Tab *Neue Kundenklasse*.
. Nimm die Einstellungen vor. Beachte dazu die Erläuterungen in <<tabelle-schnelleinstieg-kundenklasse-erstellen>>. 
. *Speichere* die Einstellungen.

[[tabelle-schnelleinstieg-kundenklasse-erstellen]]
.Kundenklasse erstellen
[cols="1,3"]
|====
|Einstellung |Erläuterung
...
|*Bezeichnung*
|Name für die Kundenklasse eingeben, z.B. Premiumkunde.

|*Rabattart*
|Ggf. Rabattart wählen. Weitere Informationen zu den Rabattarten findest du auf der Handbuchseite <<crm/kontakte-verwalten#, Kontakte verwalten>> im Kapitel <<crm/kontakte-verwalten#25, Rabattsystem nutzen>>.
...
plentymarkets erzeugt alle E-Mails auf Basis von Vorlagen. <<tabelle-e-mail-vorlagen>> listet die E-Mail-Vorlagen auf, deren Einrichtung wir dir für den Anfang empfehlen. E-Mail-Vorlagen werden im Menü *System » Mandant » Mandant wählen » E-Mail » Vorlagen* erstellt.
...
. Füge die Texte in den jeweiligen Tabs im Tab *Text* ein. +
→  *_Tipp:_* Lasse die Texte zu den rechtlichen Angaben von einem kundigen Fachanwalt prüfen.
. *Speichere* die Einstellungen.
...
→ *_Hinweis:_* Die Texte hast du vorab im System gespeichert wie in Kapitel <<schnelleinstieg/schnelleinstieg-basiseinstellungen#550, Rechtliche Angaben speichern>> beschrieben.
. Weitere Informationen zu den Template-Variablen für rechtliche Angaben findest du in <<tabelle-template-variablen-rechtliches>> am Ende dieses Kapitels.
...
[[tabelle-template-variablen-rechtliches]]
...
→ *_Tipp:_* Zeige dazu mit der Maus auf das rote plentymarkets Logo oben links.
