...
Wenn du bereits eine Domain bei einem anderen Provider hast und den Provider wechseln möchtest, gehe wie im Kapitel <<basics/admin-aufgaben/plentymarkets-konto#250, Domain-Umzug durchführen>> auf der Handbuchseite <<basics/admin-aufgaben/plentymarkets-konto#, plentymarkets Konto>> beschrieben vor.
...
* <<basics/admin-aufgaben/plentymarkets-konto#50, Domain-Daten verwalten>>
* <<basics/admin-aufgaben/plentymarkets-konto#ssl-zertifikat, SSL-Zertifikat verwalten>>
* <<basics/admin-aufgaben/plentymarkets-konto#20, Vertragsdaten ändern>>
