...
plentymarkets erzeugt alle E-Mails auf Basis von Vorlagen. <<tabelle-e-mail-vorlagen>> listet die E-Mail-Vorlagen auf, deren Einrichtung wir dir für den Anfang empfehlen. E-Mail-Vorlagen werden im Menü *System » Systemeinstellungen » Mandant* » _Mandant wählen_ » *E-Mail » Vorlagen* erstellt.
...
. Öffne das Menü *System » Systemeinstellungen » Mandant* » _Mandant wählen_ » *Webshop » Rechtliches*.
...
*_Hinweis:_* Wenn keine E-Mail-Adresse eingegeben wird, werden Antworten auf diese E-Mail-Vorlage an die E-Mail-Adresse, die im Menü *System » Systemeinstellungen » Mandant* » _Mandant wählen_ » *E-Mail » Zugangsdaten* gespeichert ist, versendet.
...
Die möglichen Typen eines PDF-Anhangs, z.B. Rechnung, sind in deinem plentymarkets System vorgegeben. Diese Dokumente richtest du im Menü *System » Systemeinstellungen » Mandant* » _Mandant wählen_ » *Standorte* » _Standort wählen_ » *Dokumente* ein.
...
. Öffne das Menü *System » Systemeinstellungen » Mandant* » _Mandant wählen_ » *Standorte* » _Standort wählen_ » *Dokumente*.
...
. Öffne das Menü *System » Systemeinstellungen » Mandant* » _Mandant wählen_ » *SSL*. +
