...
Weitere Informationen zu den Template-Variablen findest du weiter unten auf dieser Seite im Kapitel <<schnelleinstieg/schnelleinstieg-basiseinstellungen#700, Template-Variablen und Template-Funktionen einfügen>>.
...
Welche Template-Variablen dir für die E-Mail-Vorlagen zur Verfügung stehen, erfährst du weiter unten auf dieser Seite im Kapitel <<schnelleinstieg/schnelleinstieg-basiseinstellungen#600, Beispiel: E-Mail-Vorlage anpassen>>.
...
Im Menü *System » Mandant » Mandant wählen » E-Mail » Zugangsdaten* speicherst du die Zugangsdaten deines E-Mail-Kontos. An einer anderen Stelle definierst du Ereignisse, damit dein plentymarkets System später bei Eintritt dieses Ereignisses automatisch E-Mails wie Auftrags- und Versandbestätigungen erzeugt und an deine Kunden versendet.
...
Du kannst alle E-Mail-Vorlagen an deine Erfordernisse anpassen. Wie du dazu vorgehst, haben wir für dich am Beispiel der E-Mail-Vorlage *Webshop: Eingangsbestätigung Bestellung* weiter unten auf dieser Seite im Kapitel <<schnelleinstieg/schnelleinstieg-basiseinstellungen#600, Beispiel: E-Mail-Vorlage anpassen>> beschrieben.
...
*_Wichtig:_* Eine Rechnungsvorlage für den Standort *Deutschland* ist bereits vorkonfiguriert. Du kannst die Vorlage nach Bedarf im Menü *System » Mandant » Mandant wählen » Standorte » Standort wählen » Dokumente » Rechnung* anpassen. Wenn eine Rechnung für den Auftrag existiert und du eine Ereignisaktion eingerichtet hast, wird die Rechnung automatisch an den Kunden versendet, da in der Vorlage *Auftrag: Rechnung PDF-Anhang* der PDF-Anhang *Rechnung* bereits standardmäßig gewählt ist. +
 Weitere Informationen dazu findest du auf der Schnelleinstiegsseite <<schnelleinstieg/schnelleinstieg-automatisierung#, Vorgänge automatisieren>>.

|*Auftrag: Versandbestätigung*
|Wird bei Versand der Ware verschickt. +
*_Tipp:_* Erstelle eine Ereignisaktion mit dem Ereignis *Paketnummer* und füge Filter und Aktionen hinzu, damit die am Auftrag gespeicherte Paketnummer über die Template-Variable *$TrackingURL* ausgegeben wird. Weitere Informationen findest du auf der Schnelleinstiegsseite <<schnelleinstieg/schnelleinstieg-automatisierung#, Vorgänge automatisieren>>.
...
====
Achte unbedingt darauf, dass in allen E-Mail-Vorlagen deine Bankverbindung eingegeben ist und dass am Ende der E-Mail statt des Mustertextes deine Kontaktdaten korrekt und vollständig eingegeben sind. Du kannst dafür <<schnelleinstieg/schnelleinstieg-basiseinstellungen#700, Template-Variablen>> verwenden.
====
////
...
* [ ] Domain: Hast du die Domain für deinen Webshop bestellt?
...
* <<omni-channel/online-shop/ceres-einrichten#300, Rechtliche Angaben speichern>>
* <<schnelleinstieg/schnelleinstieg-automatisierung#10, Automatischer E-Mail-Versand>>
...
TIP: Weiter zum Thema <<schnelleinstieg/schnelleinstieg-warenwirtschaft#, Lager und Lieferant einrichten>>
