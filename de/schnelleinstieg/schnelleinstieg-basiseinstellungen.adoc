...
plentymarkets erzeugt alle E-Mails auf Basis von Vorlagen. <<tabelle-e-mail-vorlagen>> listet die E-Mail-Vorlagen auf, deren Einrichtung wir dir für den Anfang empfehlen. E-Mail-Vorlagen werden im Menü *System » Systemeinstellungen » Mandant » Mandant wählen » E-Mail » Vorlagen* erstellt.
...
*_Hinweis:_* Wenn keine E-Mail-Adresse eingegeben wird, werden Antworten auf diese E-Mail-Vorlage an die E-Mail-Adresse, die im Menü *System » Systemeinstellungen » Mandant » Mandant wählen » E-Mail » Zugangsdaten* gespeichert ist, versendet.
