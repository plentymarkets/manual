...
. Gib im Feld *Bezeichnung* den Namen für die Kundenklasse ein.
. Nimm weitere Einstellungen vor. Beachte dazu die Erläuterungen in <<tabelle-kundenklasse-erstellen>> auf der Handbuchseite <<crm/kontakte-verwalten#, Kontakte verwalten>>.
. *Speichere* die Einstellungen.
