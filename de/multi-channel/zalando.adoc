...
Die exportierten Zalando-Merkmale können Sie mittels **<<datenaustausch/datenformate/itemproperties#, Datenformat  >>** über den **dynamischen Import** mit den Artikeln in Ihrem plentymarkets System verknüpfen.
