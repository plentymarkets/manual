...
Einstellungen zu Steuersätzen im Menü <<mandant-shop/standard/buchhaltung#, **Buchhaltung**  >> beachten.
...
Aktivieren Sie die **<<payment/zahlungsarten-verwalten#, Zahlungsart  >>****Allyouneed Payments**, wie im Folgenden beschrieben.
