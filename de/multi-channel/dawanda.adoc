...
Aktivieren Sie die **<<payment/zahlungsarten-verwalten#, Zahlungsart  >>****DaWanda Gutschein**, um Kunden die Möglichkeit zu geben, auch mit DaWanda-Gutscheinen zu bezahlen. Aktivieren Sie anschließend die Zahlungsart **DaWanda Payment** analog.
...
Richten Sie eine **<<auftraege/einstellungen/ereignis-aktionen#, Ereignisaktion  >>** ein, um Zahlungsbestätigungen automatisch an DaWanda zu senden.
...
Richten Sie eine **<<auftraege/einstellungen/ereignis-aktionen#, Ereignisaktion  >>** ein, um Versandbestätigungen automatisch an DaWanda zu senden, nachdem ein Warenausgang gebucht wurde.
