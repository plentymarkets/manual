...
[TIP]
.Zahlungshinweis im Dokument <<mandant-shop/standard/dokumente/rechnung#, Rechnung  >> für die Zahlungsart Rakuten Rechnung
====
...
Richten Sie eine **<<auftraege/einstellungen/ereignis-aktionen#, Ereignisaktion  >>** ein, um Versandbestätigungen automatisch an Rakuten zu senden, nachdem ein Warenausgang gebucht wurde.
...
Richten Sie eine **<<auftraege/einstellungen/ereignis-aktionen#, Ereignisaktion  >>** ein, um Retouren automatisch an Rakuten zu senden.
...
Richten Sie eine **<<auftraege/einstellungen/ereignis-aktionen#, Ereignisaktion  >>** ein, um Stornierungen automatisch an Rakuten zu senden.
