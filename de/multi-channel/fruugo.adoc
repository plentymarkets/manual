...
Im Menü **<<datenaustausch/api-log#, Datenaustausch » API-Log  >>** finden Sie eine Historie über Vorgänge, die über die Fruugo-Schnittstelle ausgeführt wurden. Folgende Formate stehen Ihnen für Fruugo zur Auswahl:
