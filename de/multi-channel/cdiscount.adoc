...
Richten Sie eine **<<auftraege/einstellungen/ereignis-aktionen#, Ereignisaktion  >>** ein, um Retouren automatisch an Cdiscount zu senden.
...
Richten Sie eine **<<auftraege/einstellungen/ereignis-aktionen#, Ereignisaktion  >>** ein, um den Auftragsstatus bei Cdiscount automatisch zu aktualisieren, wenn bestimmte Ereignisse eintreten. Sie haben die Möglichkeit, Aufträge bei Cdiscount per Ereignisaktion automatisch in die
