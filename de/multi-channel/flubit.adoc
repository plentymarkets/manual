...
Diese Artikelbeschreibung wird an Flubit übertragen. Die Artikelbeschreibung muss auf **<<mandant-shop/standard/webshop/multilingualismus#40, Englisch >>** eingetragen sein, andernfalls wir der Artikel nicht exportiert.
...
* Artikelbeschreibung ist auf **<<mandant-shop/standard/webshop/multilingualismus#40, Englisch >>** eingegeben
...
Richten Sie eine **<<auftraege/einstellungen/ereignis-aktionen#, Ereignisaktion  >>** ein, um Versandbestätigungen automatisch an Flubit zu senden, nachdem ein Warenausgang gebucht wurde.
...
Richten Sie eine **<<auftraege/einstellungen/ereignis-aktionen#, Ereignisaktion  >>** ein, um Flubit automatisch über Stornierungen zu informieren. Bei Stornierungen muss ein Grund für die Stornierung an Flubit übertragen werden. Erstellen Sie im Menü **<<auftraege/einstellungen/auftragsstatus#, Einstellungen » Aufträge » Auftragsstatus  >>** ggf. zusätzliche Auftragsstatus. Folgende Stornierungsgründe können an Flubit übertragen werden:
...
Richten Sie eine **<<auftraege/einstellungen/ereignis-aktionen#, Ereignisaktion  >>** ein, um Flubit automatisch über Retouren zu informieren.
