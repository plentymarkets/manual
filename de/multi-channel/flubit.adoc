...
Im Menü **<<datenaustausch/api-log#, Datenaustausch » API-Log  >>** im Tab **Flubit** finden Sie eine Historie über Vorgänge, die über die Flubit-Schnittstelle ausgeführt wurden. Folgende Formate stehen Ihnen für Flubit zur Auswahl:
