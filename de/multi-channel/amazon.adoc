...
|<<auftraege/einstellungen/auftragsstatus#, **Auftragstatus**  >> für Retouren wählen, die erfolgreich an Amazon gemeldet wurden.

|**Status für nicht übertragene Retouren**
|<<auftraege/einstellungen/auftragsstatus#, **Auftragstatus**  >> für Retouren wählen, die nicht erfolgreich an Amazon gemeldet wurden.
...
|**Herkunft**
| Wählen, ob nur Aufträge von Amazon mit FBA abgewickelt werden oder ob auch Aufträge von anderen <<auftraege/einstellungen/auftragsherkunft#, **Herkünften**  >> mit FBA abgewickelt werden können.
...
|**Status**
|<<auftraege/einstellungen/auftragsstatus#, **Status**  >> der Aufträge wählen, die von Amazon importiert wurden.

|**Lager**
| Wählen, welches <<multi-channel/amazon#10, **Amazon FBA-Lager** >> für den Bestandabgleich des Kontos verwendet werden soll. Dieses Lager wird auch für die FBA-Auftragszuordnung des Kontos verwendet, falls kein FBA-Auftrag aufgrund eines nicht konfigurierten Lagers für das Auftragsland zugeordnet werden konnte.
...
|<<auftraege/einstellungen/auftragsstatus#, **Auftragstatus**  >> für Aufträge wählen, die erfolgreich an FBA übertragen wurden.
...
|**Amazon-Produkttyp**
|<<datenaustausch/datenformate/item#50, **Amazon-Produkttyp** >> wählen.
...
====
Dieses Feature ist nur für <<multi-channel/amazon#16-1, **Amazon Multi-Channel** >> vorgesehen.
====
...
Es werden nur Bestände von Artikeln übernommen, die in den letzten 30 Tagen eine Bestandsänderung auf Amazon erfahren haben. Für den Erstimport empfehlen wir Ihnen den manuellen Abgleich. Die Warenbestände werden gemäß der <<multi-channel/amazon#2-4, **Grundeinstellungen** >> abgeglichen.
...
.SKU-Zuordnung
====
Für den manuellen Abgleich muss die SKU-Zuordnung in den <<multi-channel/amazon#2-3, **Grundeinstellungen** >> eingetragen werden.
====
...
Für den manuellen und automatischen Auftragsimport beachten Sie das Kapitel **<<multi-channel/amazon#12, FBA-Aufträge automatisch importieren >>**.
...
Legen Sie zunächst einen Auftragsstatus für Amazon-Retouren im Menü **<<auftraege/einstellungen/auftragsstatus#, Einstellungen » Aufträge » Auftragsstatus  >>** an, z.B. [9.6] Retoure an Amazon gesendet. Diesen Auftragsstatus benötigen Sie für die Amazon-Einstellungen.
...
Richten Sie eine **<<auftraege/einstellungen/ereignis-aktionen#, Ereignisaktion  >>** ein, um Retouren in Form von Gutschriften automatisch an Amazon zu senden.
...
Beachten Sie dazu die Handbuchseiten **<<auftraege/einstellungen/ereignis-aktionen#, Ereignisaktionen  >>** sowie **link::/[Standard-Fulfillment im Detail]**.
====
...
Im Retourenfall sendet der Käufer die Ware zurück an Amazon. Die Retoure wird in Ihr plentymarkets System importiert und mit dem Retourenstatus, den Sie im Menü **<<auftraege/einstellungen/grundeinstellungen#, Einstellungen » Aufträge » Grundeinstellungen  >>** gewählt haben, im Auftragsmenü angelegt.
...
.  Öffnen Sie den Artikel.
.  Wechseln Sie in das Tab **Multi-Channel**.
.  Nehmen Sie die Einstellungen im Bereich **Amazon** vor. Beachten Sie dazu die Erläuterungen in Tabelle 5 im Kapitel <<multi-channel/amazon#3, **Artikelverfügbarkeit einstellen** >>.
. **Speichern** Sie die Einstellungen.
...
Dabei werden nur Änderungen der Bestandsdaten berücksichtigt. Weitere Möglichkeiten zum Bestandsimport sind in Kapitel <<multi-channel/amazon#9-5, **Bestand abgleichen** >> beschrieben.

|**Lager**
| Wählen, welches <<multi-channel/amazon#10, **Lager** >> für den Versand durch Amazon verwendet werden soll.
...
Richten Sie eine **<<auftraege/einstellungen/ereignis-aktionen#, Ereignisaktion  >>** ein, damit Amazon automatisch eine Meldung über den Auftrag erhält und den Auftrag bearbeiten sowie den Versand veranlassen kann.
...
Im Menü **<<auftraege/auftraege-bearbeiten#, Aufträge » Aufträge bearbeiten  >>** werden alle Ihre Aufträge angezeigt. Diese Aufträge können Sie über **<<auftraege/auftraege-bearbeiten/suche#, Filter  >>** eingrenzen und sich z.B. nur Amazon Prime-Aufträge anzeigen lassen.
...
Weitere Informationen finden Sie auf der Handbuchseite **<<payment/zahlungsarten-verwalten#40, Zahlungsarten und Kundenklassen >>**.
====
...
Auf der Handbuchseite **<<payment/amazon-payments-advanced#, Amazon Payments Advanced  >>** erhalten Sie wichtige Hinweise zur Integration des Zahlungsanbieters in plentymarkets.

[#6600]
==  API-Log abrufen

Im Menü **<<datenaustausch/api-log#, Datenaustausch » API-Log  >>** finden Sie eine Historie über Vorgänge, die über die Amazon-Schnittstelle ausgeführt wurden. Folgende Formate stehen Ihnen für Amazon zur Auswahl:
