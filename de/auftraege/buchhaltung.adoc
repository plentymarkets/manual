...
_Der Schwellenwert darf nicht für Lieferungen innerhalb Großbritanniens eingetragen werden._ Diese Option wird nur angezeigt, wenn das Lieferland Großbritannien ist. Info 135 GBP. Link?
Übernahme auf Dokumente.
