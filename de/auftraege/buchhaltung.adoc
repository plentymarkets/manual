...
Sie können einen Standort nur löschen, wenn ein weiterer Standort vorhanden ist. Ein Standort, der im Menü *System » Systemeinstellungen » Mandant » Standard Shop* als *Standard-Standort* hinterlegt ist, kann nicht gelöscht werden.
...
. Wählen Sie einen Standort unter *System » Systemeinstellungen » Mandant » Mandant wählen » Standorte » Standort wählen » Buchhaltung*. +
→ Das Tab *Grundeinstellungen* öffnet sich.
...
. Stellen Sie das Merkmal im Menü *System » Systemeinstellungen » Artikel » Einstellungen* bei der Option *Artikelmerkmal zur Erkennung von digitalen Produkten* ein.
...
Aufträge, die über plentymarkets POS generiert werden, werden den in plentymarkets gespeicherten Erlöskonten zugewiesen. Da Einlagen, Entnahmen und Differenzen aus Kassenstürzen keine Aufträge sind, können Sie für diese Kassenvorfälle eigene Buchungskonten speichern. Wie Sie Buchungskonten für Kassenvorfälle speichern, erfahren Sie auf der Handbuchseite <<pos/pos-einrichten#, POS einrichten>>.
