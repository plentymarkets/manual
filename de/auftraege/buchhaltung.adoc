...
Gehen Sie wie im Folgenden beschrieben vor, um einen neuen Standort anzulegen. Legen Sie außerdem einen Standort als Ihren <<webshop/mandanten-verwalten#20, Standard-Standort>> fest. Der Standard-Standort ist sozusagen der Hauptfirmensitz.
