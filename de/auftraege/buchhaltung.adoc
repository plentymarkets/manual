...
Ab 01.07.2021 gemeinsame Lieferschwelle von insgesamt 10.000 EUR. D.h. alle B2C (kein B2B) Lieferungen innerhalb der EU werden sozusagen zusammengefasst und man wird schneller umsatztsteuerpflichtig in einem Land.
in plentymarkets wichtig korrekte Pflege der Steuerkonfigurationen für EU-Länder. Hinweis EU-Umsatzsteuerassistent. Aber vorsicht beim Bearbeiten.

Teilnahme am OSS Verfahren: quasi zentrale Abrechnung, nicht mehr Umsatzsteuer pro Land. Pro Quartal. Verlinkung zum Bundeszentralamt für Steuern. Wenn Teilnahme: rechtzeitige Registrierung, da Abrechnungen nicht rückwirkend.

wichtig ist auch das Land, aus dem verschickt wird.

Verlinkung zur Zolltariftabelle, da zentral für Abbildung der unterschiedlichen Besteuerung.
...
[IMPORTANT]
.Ändern von Steuersatzkonfigurationen
====
Sobald eine Steuersatzkonfiguration aktiv ist, lässt sich nur noch das Datum *Ungültig ab* 
====
...
|Aktivieren diese Option, wenn die Steuerkonfiguration nur für digitale Artikel gelten soll. Beachte das Kapitel <<buchahltung/auftraege#600, Umsatzsteuer für digitale Artikel>>.
