...
Zum Import der Zolltarifnummern kannst du das Import-Tool verwenden oder die Nummern manuell einpflegen. Wir empfehlen, das Import-Tool zu nutzen und nur einzelne Zolltarifnummern oder kleine Änderungen manuell in der Tabelle zu pflegen.
