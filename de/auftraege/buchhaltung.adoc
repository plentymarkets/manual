...
Grundlegend dafür ist, dass du zunächst die Zolltarifnummern im System pflegst. Die <<artikel/artikel-verwalten#280, Hinterlegung von Zolltarifnummern>> erfolgt an den *Varianten* eines Artikels. Des Weiteren sollten <<auftrage/buchhaltung#550, Umsatzsteuersätze>> für die entsprechenden Länder eingerichtet sein. Umsatzsteuersätze lassen sich auch nachtragen, wir empfehlen aber die rechtzeitige Erstellung im System.
...
Allgemeine Informationen zum Import über ElasticSync findest du auf der Handbuchseite <<daten/daten-importieren/ElasticSync, Daten mit ElasticSync importieren>>. Die <<daten/daten-importieren/sync-typen/elasticSync-auftraege, Sync-Typen>> zum Import der Zolltarifnummern sind unter *Zuordnung Zolltarifnummer* zu finden.
...
|*Suche*
|Innerhalb der Tabelle kannst du nach Zuordnungen *suchen*. Dafür stehen dir die Filter *Zolltarifnummer* oder *Land* zur Verfügung.
