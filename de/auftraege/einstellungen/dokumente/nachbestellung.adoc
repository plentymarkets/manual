...
Damit eine Nachbestellung erzeugt werden kann, muss zuerst eine Vorlage eingerichtet werden. Details finden Sie auf der Handbuchseite **Dokumente** im Kapitel <<auftraege/einstellungen/dokumente#40, **Dokumentenvorlage konfigurieren** >>.
