...
Die Seitenränder sind wichtig für den automatischen Seitenumbruch und die Positionierung von Fließtext. Sie bestimmen außerdem die Positionierung der <<auftraege/einstellungen/dokumente#170, **PDF-Vorlage** >>.
...
Das Format eines Dokuments wird vom Format der PDF-Vorlage bestimmt. Im Standard bzw. wenn keine PDF-Vorlage hinterlegt wird, werden Rechnungsdokumente im Format DIN A4 erzeugt. Beachten Sie dazu auch das Kapitel zu <<auftraege/einstellungen/dokumente#170, **PDF-Vorlagen** >>.
...
Im Folgenden wird beispielhaft beschrieben, wie Sie einen Nummernkreis für <<mandant-shop/standard/dokumente/rechnung#, **Rechnungsdokumente**  >> festlegen. Gehen Sie für andere Dokumente analog vor.
...
Nach der Generierung Ihrer Dokumentenvorlagen können Sie im Bereich **<<auftraege/einstellungen/ereignis-aktionen#, Einstellungen » Aufträge » Ereignisaktionen  >>** automatische Aktionen einstellen. Interessant ist beispielsweise das Buchen von Warenausgängen beim Rechnungsdruck. Weitere Aktionen, z.B. das automatische Versenden von aktionsgesteuerten E-Mails, sind ebenfalls einstellbar.
