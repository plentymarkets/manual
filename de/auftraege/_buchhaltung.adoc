...
|Die Umsatzsteuersätze des Landes in Prozent eintragen. Die Textfelder **Name** sind nur für die Buchhaltungssoftware <<basics/datenaustausch/export-import/daten-exportieren#10, **Xero**>> relevant.
...
Nachdem alle Konten und Buchungsschlüssel hinterlegt wurden, nehmen Sie im Menü **Datenaustausch » Daten-Export** verschiedene <<basics/datenaustausch/export-import/daten-exportieren#, **Daten-Exporte**>> vor.
