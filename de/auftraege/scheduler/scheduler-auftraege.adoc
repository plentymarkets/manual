...
**Wichtig**: Variablen Benutzern stehen nur Mandanten zur Auswahl, für die sie eine Berechtigung haben. Berechtigungen werden unter <<arbeiten-mit-plentymarkets/benutzer-verwalten#90., **Einstellungen » Grundeinstellungen » Benutzer » Konten » Tab: Berechtigung** >> eingestellt.
|====
