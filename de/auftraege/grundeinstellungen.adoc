...
:id: UQ3KZYP
:keywords: Standardeinstellung, Auftragseinstellungen, Auftrags-Einstellungen, Auftragsherkunft, Auftragsstatus, Standard-Auftragsherkunft, Standard-Status, Standard-Status Retoure, Standard-Status Gutschrift, Standard-Status Reparatur, Standard-Status Sammelauftrag, Standard-Status Sammelgutschrift, Standard-Status Rückbuchung, Auftragsreservierung, Auftrag, Auftragsübersicht, Artikelpreis-Darstellung, Zuordnung des Lagers, Lagerauswahl, Warenbestand, Statuswechsel, Auftragsbearbeitung, Benutzer, Backend-Benutzer, Berechtigungen, Einstellungen Aufträge
...
Bei neuen Systemen sind Standard-Werte eingestellt, z.B. für Retouren der Status [9] und für Gutschriften der Status [11]. Diese Einstellungen sind änderbar. Wähle dazu einen anderen Status. Alternativ legst du im Menü *<<auftraege/auftraege-verwalten#1200, Einrichtung » Aufträge » Auftragsstatus>>* einen neuen Status an. Ein dort angelegter Status wird hier im Menü *Grundeinstellungen* angezeigt und ist auch als Standard-Status einstellbar.
...
. Nimm die Einstellungen gemäß <<tabelle-auftraege-grundeinstellungen>> vor.
...
| [#intable-lagerzuordnung]*Zuordnung des Lagers*
...
| [#intable-lagerauswahl]*Automatische Lagerauswahl*
...
| *Mengenänderung von Bundle-Artikel und Bundle-Bestandteilen erlauben*
...
__**Hinweis**__: Werden Mengen nachträglich manuell in einem Auftrag geändert, führt dies nicht automatisch zu einer Anpassung der Mengen der Bestandteile eines Bundles und auch nicht zu einer Preisanpassung.
...
*NEIN* = Es werden in Dropdown-Listen nur aktive Plugin-Zahlungarten zur Auswahl angezeigt.
|====

[#300]
== Auftragsbearbeitung durch Backend-Benutzer:innen

Damit Benutzer:innen vom Typ *Backend* Aufträge öffnen können, müssen hier Standard-Status für *Retouren* und *Gutschriften* gespeichert sein. In der Grundeinstellung ist kein Status voreingestellt. +
Backend-Benutzer:innen müssen außerdem im Benutzerprofil unter *<<business-entscheidungen/benutzerkonten-zugaenge#90, Berechtigung » Tab: Menü » Bereich: Aufträge>>* zur Bearbeitung von Aufträgen berechtigt werden.
Zudem müssen Backend-Benutzer:innen Aufträge der Typen *Retoure*, *Gewährleistung* und *Reparatur* anlegen können. Dafür müssen sie für die im Menü *Einrichtung » Aufträge » Einstellungen* hinterlegten Standard-Status dieser drei Auftragstypen berechtigt sein. Die Berechtigung erfolgt im Benutzerprofil der Backend-Benutzer:innen unter *<<business-entscheidungen/benutzerkonten-zugaenge#100, Berechtigung » Tab: Sichtbarkeiten>>*.
