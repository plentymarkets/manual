...
. Wähle für den Filter *Auftragstyp Ziel* den Auftragstyp aus, in den die Eigenschaften kopiert werden sollen.
. Setze optional noch den Filter *Nur kopierbare Eigenschaften*.
