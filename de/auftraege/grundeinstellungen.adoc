...
|Wähle aus der Dropdown-Liste aus, welches Präfix als Benennung für Artikelpakete (Bundles) verwendet werden soll.
//Leerzeichen?

|[#intable-prefix-bundle-components]*Präfix für Artikelpaketbestandteile*
|Wähle aus der Dropdown-Liste aus, welches Präfix als Benennung für Bestandteile von Artikelpaketen (Bundles) verwendet werden soll.
