...
Bestimme im Menü *Einrichtung » Aufträge » Eigenschaftskopie*, welche Eigenschaften kopiert werden sollen. Du kannst dies individuell für verschiedene Kombinationen, z.B. von Auftrag (Quelle) zu Lieferauftrag (Ziel), festlegen. Nicht alle Eigenschaften sind zum Kopieren freigeschaltet. Verwende den Toggle *Nur kopierbare Eigenschaften anzeigen*, um nur die kopierbaren anzeigen zu lassen. +
Die Tabellenspalte *Quelle* gibt wieder, woher die Eigenschaft kommt. *Intern* bedeutet, die Eigenschaft kommt vom System. *Interface* bedeutet, die Eigenschaft wurde über eine Schnittstelle wie ein Plugin oder per REST erstellt.
...
→ Die aktivierten Eigenschaften kopiert.
