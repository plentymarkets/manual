...
Im Menü *System » Systemeinstellungen » Aufträge » Einstellungen* wählst du die Einstellungen, die für Aufträge automatisch eingestellt werden bzw. bei bestimmten Auftragsstatus oder Bedingungen gelten sollen. Zum Beispiel wählst du Standard-Einstellungen für die Auftragsherkunft und den Status von Aufträgen.

[#100]
== Wichtige Vorbedingungen beachten

Bei neuen Systemen sind Standard-Werte eingestellt, z.B. für Retouren der Status [9] und für Gutschriften der Status [11]. Diese Einstellungen sind änderbar. Wähle dazu einen anderen Status. Alternativ legst du im Menü *<<auftraege/auftraege-verwalten#1200, System » Systemeinstellungen » Aufträge » Auftragsstatus>>* einen neuen Status an. Ein dort angelegter Status wird hier im Menü *Grundeinstellungen* angezeigt und ist auch als Standard-Status einstellbar.

[IMPORTANT]
.Grundeinstellungen speichern
====
Die Grundeinstellungen des Menüs *System » Systemeinstellungen » Aufträge » Einstellungen* müssen bei Inbetriebnahme des Systems gespeichert werden, damit die Einstellungen wirksam sind. Speichere daher die Einstellungen auch, wenn du sie nicht verändert hast, also die Standardkonfiguration verwenden möchten.
====
