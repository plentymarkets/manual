...
Bei neuen Systemen sind Standard-Werte eingestellt, z.B. für Retouren der Status [9] und für Gutschriften der Status [11]. Diese Einstellungen sind änderbar. Wählen Sie dazu einen anderen Status. Alternativ legen Sie im Menü *<<auftragsabwicklung/auftraege/auftraege-verwalten#1200, System » Aufträge » Auftragsstatus>>* einen neuen Status an. Ein dort angelegter Status wird hier im Menü *Grundeinstellungen* angezeigt und ist auch als Standard-Status einstellbar.
...
|Wählen, welcher Status bei *<<auftragsabwicklung/auftraege/auftraege-verwalten#850, Sammelgutschriften>>* automatisch eingestellt sein soll.
