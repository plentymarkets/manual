...
. Nutze die <<auftraege/auftraege-verwalten#1300, Suche>>, um die Aufträge zu suchen, die du über die Gruppenfunktion bearbeiten möchtest.
...
| *Status ändern*
| Mit dieser Gruppenfunktion kannst du den <<auftraege/auftraege-verwalten#1200, Auftragsstatus>> für die ausgewählten Aufträge ändern. Wähle dafür aus der Dropdown-Liste den Auftragsstatus, der den Aufträgen zugewiesen werden soll.
