...
Wenn eine Paketnummer hinterlegt wurde, kann das Paket über *Vorschau* (icon:eye[role="blue"]) verfolgt werden. Allerdings nur, wenn unter <<fulfillment/versand-vorbereiten#800,Einrichtung » Aufträge » Versand » Optionen » Tab: Versanddienstleister>> eine Tracking-URL für den entsprechenden Versanddienstleister hinterlegt wurde. Sonst wird das Vorschau-Symbol nicht angezeigt.
|====
