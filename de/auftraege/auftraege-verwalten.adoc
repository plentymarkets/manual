...
|*Status Netto-Warenbestand*
|In dieser Spalte wird durch einen farbigen Statusbalken angezeigt, ob Netto-Warenbestand für einen Artikel vorhanden ist oder nicht. Grün zeigt an, dass für den Artikel Netto-Warenbestand im ausgewählten Lager vorhanden ist. Rot zeigt an, dass für den Artikel kein Netto-Warenbestand im ausgewählten Lager vorhanden ist. Wurde vorher z.B. *Nur vorrätige Artikel anzeigen* ausgewählt, wird zunächst keiner der Statusbalken in der Tabelle in rot wiedergegeben werden. Erst, wenn durch das Hinzufügen von Artikelpositionen der Netto-Warenbestand unter 0 geht, wird der Statusbalken rot. Auf diese Weise siehst du auf einen Blick, in welchem Lager Netto-Warenbestand vorhanden ist.
