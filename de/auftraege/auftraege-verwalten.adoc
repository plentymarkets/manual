...
. Nutze die <<auftraege/auftraege-verwalten#1300>>, um die Aufträge zu suchen, die du über die Gruppenfunktion bearbeiten möchtest.
...
| *Markierung ändern*
| Mit dieser Gruppenfunktion kannst du die Markierung für die ausgewählten Aufträge ändern. Wähle dafür aus der Dropdown-Liste die Markierung aus, die den Aufträgen zugewiesen werden soll.

| *Status ändern*
| Mit dieser Gruppenfunktion kannst du den <<auftraege/auftraege-verwalten#1200, Auftragsstatus>> für die ausgewählten Aufträge ändern. Wähle dafür aus der Dropdown-Liste den Auftragsstatus aus, der den Aufträgen zugewiesen werden soll.

| *Versandprofil ändern*
| Mit dieser Gruppenfunktion kannst du die <<fulfillment/versand-vorbereiten#1000, Versandprofile>> der ausgewählten Aufträge ändern. Wähle dafür aus der Dropdown-Liste das Versandprofil aus, das den Aufträgen zugewiesen werden soll. Zudem kannst du zusätzliche *Versandkosten* veranschlagen und aktivieren (icon:check-square[role="blue"]).

| *Eigner ändern*
| Mit dieser Gruppenfunktion kannst du den Eigner für die ausgewählten Aufträge ändern. Wähle dafür aus der Dropdown-Liste den Eigner aus, der den Aufträgen zugewiesen werden soll.

| *Warenausgang buchen*
| Mit dieser Gruppenfunktion kannst du den Warenausgang für die ausgewählten Aufträge buchen. Wähle dafür aus der Dropdown-Liste das Datum und die Uhrzeit aus. Wird der Warenausgang für Aufträge gebucht, ändert sich auch der Auftragsstatus der Aufträge zu *7 - Warenausgang gebucht*.

| *Lieferdatum setzen*
| Mit dieser Gruppenfunktion kannst du das Lieferdatum für Auftragspositionen setzen. Wähle dafür das Lieferdatum, das gesetzt werden soll, aus der Dropdown-Liste aus.

| *Versanddatum setzen*
| Mit dieser Gruppenfunktion kannst du das Versanddatum eines Auftrags setzn. Das Versanddatum findest du im Tab *Einstellungen* in der Detailansicht eines Auftrags. Wähle dafür das Versanddatum, das gesetzt werden soll, aus der Dropdown-Liste aus.
...
| Mit dieser Gruppenfunktion kannst du die ausgewählten Aufträge an das Inkassounternehmen CHECK
