...
Vom Warenkorb aus kannst du die Eigenschaften der Auftragspositionen eines Auftrags bearbeiten. Die hier vorgenommenen Änderungen gelten nur für die Auftragspositionen dieses Auftrags. Die im System angelegten Eigenschaften werden nicht überschrieben. Möchtest du generell Eigenschaften erstellen und bearbeiten oder bist noch nicht mit der Struktur von Eigenschaften vertraut, informiere dich im Handbuchkapitel <<artikel/einstellungen/eigenschaften#, Eigenschaften und Merkmale>>.
...
Um die Eigenschaften zu bearbeiten oder weitere bereits bestehende Eigenschaften zu einer Auftragspositionen hinzuzufügen, klicke auf *Bearbeiten* (icon:pencil[]). Das gleiche Bearbeitungsfenster wie vom Warenkorb als Tabelle aus öffnet sich.
...
+
--
Die Eigenschaften werden in einer zweiten Zeile direkt unterhalb der dazugehörigen Auftragsposition angezeigt. Hier findest du Angaben zu *Name*, *Wert*, *Steuersatz* und *Aufpreis* der Eigenschaft. *Wert* und *Aufpreis* kannst du direkt in der Tabelle bearbeiten. Zudem kannst du die Eigenschaft für die Auftragsposition *löschen* (icon:minus-circle[role="red"]). Diese Eigenschaft wird dann für diesen Auftrag nicht berücksichtigt. Möchtest du eine weitere bereits bestehende Eigenschaft zu einer Auftragsposition hinzufügen, klicke auf *Hinzufügen* (icon:plus-square[role="green"]). Das gleiche Bearbeitungsfenster wie vom Warenkorb als Side cart aus öffnet sich.
...
* *Wert* = Der Wert der Eigenschaft. Der Wert ist bearbeitbar. Die Änderungen gelten nur für diesen Auftrag.
...
Durch Klicken auf *löschen* (icon:minus-circle[role="red"]) entfernst du eine Eigenschaft von einer Auftragsposition. Diese Eigenschaft wird dann für diesen Auftrag nicht berücksichtigt.

Durch Klicken auf *Hinzufügen* (icon:plus-square[role="green"]) kannst du weitere bereits bestehende Eigenschaften zu dieser Auftragsposition hinzufügen. Wähle dafür die gewünschte Eigenschaft aus der Dropdown-Liste aus. Hast du alle erforderlichen Anpassungen vorgenommen, klicke auf *Speichern*. Klickst du auf *Verwerfen*, wird keine der vorgenommenen Änderungen übernommen.

Im nächsten Schritt, der *Übersicht*, werden die Eigenschaften für Auftragspositionen nicht noch mal angezeigt. Stelle daher sicher, dass du alle Anpassungen vorgenommen hast, bevor du in der Erstellung des Auftrags weitergehst. +
Wenn hinzugefügte Eigenschaften Aufpreise und Mehrwertsteuerangaben enthalten, wird dies entsprechend der Einstellungen in der entsprechenden Eigenschaft in die Berechnungen der Auftragsbeträge einbezogen. Auf den Auftragsdokumenten werden Gruppennamen und Eigenschaftsnamen von Eigenschaften ausgegeben.
//Bez. Steuern und Dokumenten noch mal mit Emmanouil quatschen.
