...
====
Passe die Einstellungen im Menü *<<auftraege/grundeinstellungen#, Einrichtung » Aufträge » Einstellungen>>* an, bevor du die ersten Aufträge in deinem plentymarkets System abwickelst. *Speichere* die Grundeinstellungen auch dann einmalig ab, auch wen du die voreingestellten Werte nicht verändert hast.
====
...
Im Menü *Einrichtung » Aufträge » Auftragstypen » Lieferauftrag* legst du vorab fest, nach welchem Kriterium Aufträge in Lieferaufträge gesplittet werden sollen.
...
====
Um den Hauptauftrag öffnen zu dürfen, müssen variable Benutzer über die *<<basics/admin-aufgaben/benutzer-verwalten#90, Berechtigung>>* für alle Lager der Lieferaufträge eines Hauptauftrags verfügen. Prüfe dazu die Einstellungen im Menü *Einrichtung » Einstellungen » Benutzer » Konten » Tab: Sichtbarkeiten*.
====
...
Nutze die Gruppenfunktion im Menü *Einrichtung » Aufträge » Status*, um mehrere Aufträge zugleich zu bearbeiten.
...
Weitere Details zur Bearbeitung der Nachbestellung und wie du z.B. Teilmengen buchen findest du auf der Handbuchseite *<<warenwirtschaft/nachbestellungen-verwalten/nachbestellungen-vornehmen#, Nachbestellungen>>*.
...
. Öffne das Menü *Einrichtung » Mandant » Mandant wählen » Standorte » Standort wählen » Dokumente » Stornobeleg*.
. Wechsle in das Tab *Transfer*.
