...
====
Bevor <<auftraege/auftragsdokumente#, Gutschriftbelege>> erzeugt werden können, muss die Dokumentenvorlage im Menü *Einrichtung » Mandant » [Mandant wählen] » Standorte » [Standort wählen] » Dokumente » Gutschrift* eingerichtet werden.
====
