...
Zudem kannst du für Aufträge im Feld *Gutschein-Codes* einen oder mehrere Gutschein-Codes eingeben, um sie mit diesem Auftrag einzulösen. Gib einen Gutschein-Code ein und drücke _Enter_. Es wird sofort überprüft, ob der Gutschein einlösbar ist. Einlösbare Gutschein-Codes werden grün und geben den Wert des Gutscheins wieder. Nicht einlösbare Gutschein-Codes werden rot und statt des Codes wird *Nicht einlösbar* angezeigt. Wiederhole dies ggf. für weitere Gutschein-Codes. +
