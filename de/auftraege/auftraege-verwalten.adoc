...
Bei nicht erfolgreichem E-Mail-Versand prüfe die <<crm/e-mails-versenden#100, Zugangsdaten>>. Im Menü *Daten » API-Log (veraltet)* werden die Fehlermeldungen zum Vorgang *E-Mail* gespeichert.
