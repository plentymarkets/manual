...
//Letzten Absatz des vorherigen Kapitels noch anpassen
...
//Check Benennung für Chips. Wie im Deutschen?
//Noch machen: Tabs entweder oder
...
Um die Eigenschaften bearbeiten oder weitere bereits bestehende Eigenschaften zu einer Auftragspositionen hinzuzufügen, klicke auf *Bearbeiten* (icon:pencil[]). Das gleiche Bearbeitungsfenster wie vom Warenkorb als Tabelle aus öffnet sich.
