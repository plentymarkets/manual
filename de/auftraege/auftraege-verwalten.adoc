...
|*Mahnstufe*
|*<<payment/mediafinanz#30, Mahnstufen>>* können per Aktionsmanager zugeordnet werden
...
Ein Beispiel für das Verwenden von Mahnstufen finden Sie auf der Handbuchseite *<<payment/mediafinanz#, mediafinanz>>*.
