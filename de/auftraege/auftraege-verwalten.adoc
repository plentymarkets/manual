...
. Wähle aus der Dropdown-Liste *Lieferadresse* die Option *+ Neue Lieferadresse hinzufügen*. +
...
Eigner; +
Herkunft*
|Der Auftragstyp, der zugeordnete Eigner sowie die Herkunft des Auftrages werden angezeigt. Alle drei Felder sind manuell anpassbar.
...
| *Versanddienstleister*
|Der Versanddienstleister, über den die Artikel des Auftrags versendet werden. Der Versanddienstleister kann nur über eine Anpassung des Versandprofils geändert werden.

| *Versandprofil &amp; Porto*
|Das Versandprofil und die Portokosten des Auftrags. Das Versandprofil kann manuell geändert werden.
