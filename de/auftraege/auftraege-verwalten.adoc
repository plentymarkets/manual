...
|Die Werte für *Zahlungsziel (Tage)*, *Valuta (Tage)*, *Skonto (Tage)* und *Skonto (%)* werden einzeln oder kombiniert hinterlegt und damit die Zahlungsbedingungen gestaltet. Wenn die Werte bereits an der Firma in den <<crm/kontakte-verwalten#300, Kundendaten>> hinterlegt sind, werden sie vom System automatisch übernommen und hier eingetragen. Die Kundendaten haben also Priorität. +
...
Die Zahlungsbedingungen lassen sich am Auftrag manuell eintragen oder verändern. Dies ist unabhängig davon, von wo Werte übertragen wurden oder ob keine Werte übernommen wurden.
