...
_Beachte_, dass erstellte Belege nicht gelöscht werden können, lediglich externe Dokumente. Zu einigen Dokumenten, zum Beispiel einer Rechnung oder Mahnung, können Stornobelege erstellt werden. +
Es ist jedoch möglich Dokumente zu archivieren. Davon ausgenommen sind Rechnungen und rechnungsbedingende Dokumente. Klicke dazu auf *Archivieren* (icon:receipt_archive[set=plenty]). Die archivierten Dokumente findest du im Tab *Archivierte Dokumente* unter dem Tab *Belege*. +
