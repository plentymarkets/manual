...
. Öffne die Retoure und klicken Sie auf das Tab *Belege*.
...
Du kannst die Optionen der Auftragspositionen, die für den Gutschriftauftrag berücksichtigt werden sollen, im Tab *Bearbeiten* ändern oder nicht benötigte Auftragspositionen *Löschen*. Dabei ist es auch möglich, die *Menge* einer Auftragsposition zu ändern, die in den Gutschriftauftrag übernommen wird. Du erkennst änderbare Optionen an den Textfeldern, Dropdown-Listen oder Textlinks. Weiterhin findest du rechts Icons zu den Bereichen *Warenbestand* und *Nachbestellung anlegen*. Durch Klick auf *Löschen* entfernst du die Auftragsposition aus dem Gutschriftauftrag.
...
. Öffne das Menü *Aufträge » Aufträge bearbeiten*.
. Öffne den Auftrag, in dem Sie den Gutschriftbeleg stornieren möchten.
...
. Öffne das Menü *Aufträge » Aufträge bearbeiten*.
. Öffne den Gutschriftauftrag, für den Sie eine Rückzahlung buchen möchten.
. Öffne das Tab *Einstellungen*.
...
Im Menü *System » Systemeinstellungen » Aufträge » Auftragstypen » Multi-Order* nehmen Sie die Grundeinstellungen für Sammelaufträge vor. Hier legst du beispielsweise fest, für welche Auftragstypen und Auftragsstatus Sammelaufträge angelegt werden können.
