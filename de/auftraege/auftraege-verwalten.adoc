...
|*Menge*
|Gib die Menge ein, die in den Warenkorb gelegt werden soll. Es können nur ganze Zahlen eingegeben werden. Nicht zulässig sind negative Mengen sowie Mengen, die den Lagerbestand überschreiten. Werden solche Mengen eingegeben, wird eine Fehlermeldung angezeigt. Wenn die eingegebene Artikelmenge den Lagerbestand in dem ausgewählten Lager auf 0 setzt oder sogar überschreitet, wird die Tabellenzeile rot.
