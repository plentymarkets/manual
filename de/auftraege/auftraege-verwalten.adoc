...
|Wähle aus, wohin im System du nach Abschließen eines Auftrages geleitet werden möchtest. Du kannst wählen zwischen der Detailansicht des gerade angelegten Auftrags, der allgemeinen Auftragsübersicht oder der Auftragsübersicht des Kontaktes. Die Standardeinstellung ist die Weiterleitung zur Auftragsübersicht des Kontakts.
