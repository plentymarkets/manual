...
|Klicke auf die Artikel-ID oder die Varianten-ID, um in die Einstellungen des jeweiligen Artikels bzw. der Variante zu gelangen, wenn es erforderlich sein sollte.
...
Unterhalb der Auftragsdetails wird eine Tabelle mit den ausgewählten Artikelpositionen angezeigt. Zusätzlich zu den Angaben in der vorherigen Ansicht werden dir in dieser auch der *Verkaufspreis* und die *Umsatzsteuer* mit ausgegeben. Der Verkaufspreis ist bearbeitbar, solange der Auftrag noch nicht abgeschlossen ist.
