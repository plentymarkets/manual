...
* *Wert* = Der Wert der Eigenschaft wird angezeigt. Der Wert ist anpassbar. Je nach Eigenschaftstyp kannst du eine Auswahl treffen, den Wert ändern oder ihn eingeben oder eine Datei hochladen. Die Änderungen gelten nur für diesen Auftrag.
