...
. Suche die gewünschten Aufträge.
...
. Wähle eine Option. Beachte dazu die Erläuterungen in <<tabelle-gutschriften-anlegen>>.
...
. Wähle eine Option. Beachte dazu die Erläuterungen in <<tabelle-gewährleistungen-anlegen>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen. +
