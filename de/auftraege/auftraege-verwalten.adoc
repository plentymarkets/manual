...
Wenn du möchtest, dass zu einem Auftrag, der in den Status 5.0 wechselt, Lieferaufträge generiert werden, nutze die in <<table-event-procedure-delivery-order-status-5>> beschriebene Ereignisaktion.
...
. Wähle das *Ereignis* gemäß <<table-event-procedure-delivery-order-status-5>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
. Nimm die Einstellungen gemäß <<table-event-procedure-delivery-order-status-5>> vor.
...
→ Das Fenster *Neue Ereignisaktion erstellen* wird geöffnet.
. Gib einen eindeutigen Namen für die Ereignisaktion ein.
. Wähle das *Ereignis* gemäß <<table-event-procedure-invoice-generated>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
. Nimm die Einstellungen gemäß <<table-event-procedure-invoice-generated>> vor.
. Setze ein Häkchen bei *Aktiv* (icon:check-square-o[role="blue"]).
. *Speichere* (icon:save[role="green"]) die Einstellungen.
--
...
→ Das Fenster *Neue Ereignisaktion erstellen* wird geöffnet.
. Gib einen eindeutigen Namen für die Ereignisaktion ein.
. Wähle das *Ereignis* gemäß <<table-event-procedure-multi-invoice-automatic>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
. Nimm die Einstellungen gemäß <<table-event-procedure-multi-invoice-automatic>> vor.
...
*__Wichtig:__* Die weitere Option <<#intable-shipped-on, Versanddatum>> im Tab *Einstellungen* hat eine andere Funktion.
