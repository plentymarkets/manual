...
[.instruction]
. Öffne das Menü *Aufträge » Aufträge bearbeiten*.
. Suche die *Aufträge*, für die die Information per E-Mail an die Kunden verschickt werden soll. +
