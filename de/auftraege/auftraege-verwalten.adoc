...
Unterhalb der Auftragsdetails wird eine Tabelle mit den ausgewählten Artikelpositionen angezeigt. Zusätzlich zu den Angaben in der vorherigen Ansicht werden dir in dieser auch Preise und Umsatzsteuer ausgegeben. Die Preise sind bearbeitbar, solange der Auftrag noch nicht abgeschlossen ist.
