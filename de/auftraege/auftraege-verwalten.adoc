...
====
Um den Hauptauftrag öffnen zu dürfen, müssen variable Benutzer über die *<<basics/admin-aufgaben/benutzer-verwalten#90, Berechtigung>>* für alle Lager der Lieferaufträge eines Hauptauftrags verfügen. Prüfen Sie dazu die Einstellungen im Menü *System » Einstellungen » Benutzer » Konten » Tab: Sichtbarkeiten*.
====
...
*_Wichtig:_* Variable Benutzern stehen nur Mandanten zur Auswahl, für die sie eine Berechtigung haben. Berechtigungen werden unter <<basics/admin-aufgaben/benutzer-verwalten#90, System » Einstellungen » Benutzer » Konten » Tab: Berechtigung>> eingestellt.
|====
