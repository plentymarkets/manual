...
:id: 1HDXOGT
:keywords: Auftrags-ID, ID, Auftragsabwicklung, Auftragsbearbeitung, Auftrag, Aufträge, Auftrag bearbeiten, Aufträge bearbeiten, Auftragsstatus, Status, Standard-Status, Standardstatus, Auftragstyp, Auftrags-Typ, Lieferauftrag, Lieferaufträge, Auftrag manuell erstellen, Auftragsanlage, manuelle Auftragsanlage, Kontaktansicht, Kontakt, Kunde, Kundenansicht, Retoure, retournieren, Retouren, Retoure erstellen, Retoure anlegen, Gutschrift, Gewährleistung, Garantie, Reparatur, Reparaturauftrag, Sammelauftrag, Multi-Order, Multi-Auftrag, Sammelaufträge, Vorbestellung, Vorbestellungen,  Auftragssuche, Auftrag suchen, Auftrag filtern, Filter, Filteroption, Auftragsübersicht, Auftragsansicht, Auftrag anlegen, Auftrag erstellen,  referrer, Herkunft, Auftragsherkunft, Barzahlung, Zahlungsart, Auftragsdokument, Dokument, Dokumenttyp, Dokumententyp, Hauptstatus, Statusänderung, Split, splitten, teilen, Teilung, Teilmenge, Versandprofil, Lager, Warenlager, Auftragsposition, Ereignisaktion, Auftragseingang, Rechnung, Rechnung erzeugen, Rechnung erstellen, Rechnungserstellung, Retourengründe, Retourengrund, Eigner, Mandant, Rückerstattung, Rückzahlung, erstatten, Dokumentvorlage, Dokumentenvorlage, Template, Menge, Artikelmenge, Zustand, Umtausch, Artikelverfügbarkeit, Zahlungsaufforderung, Zahlungseingang, Warenausgang, Hauptauftrag, Retourenauftrag, Storno, Stornierung, Stornierungsbeleg, Beleg, Stornobeleg, Korrektur, Korrekturbeleg, Zahlung, Zahlungsbuchung, Zahlungseingang, Betrag, Währung, Versandkosten, Kundenklasse, Nachbestellung, Erscheinungsdatum, Artikelverfügbarkeit, maximale Bestellmenge, Zahlungsaufforderung, storniert, Mahnstufe, Artikelliste, Zahlungsstatus, Versandattum, Auftragshistorie, Historie, Statushistorie, Zahlungshistorie, Limit, Zahlungsaufforderung, Nummernkreis, Gutscheincode, Auftragsübersicht, Mahnung, Lieferland, Auftragsbestätigung, Versandart, Auftragsbestätigung, Lieferadresse, Rechnungsadresse, Zuordnung lösen, client, Lagerkorrektur, Rückgabedatum, Zahlungsziel, Paktenummer, Skonto, Bestellung, Auftragsdetails, Lief, Variantenmengen, Einkaufspreis, Verkaufspreis, Gruppenfunktion
...
====
Passe die Einstellungen im Menü <<auftraege/grundeinstellungen#, Einrichtung » Aufträge » Einstellungen>> an, bevor du die ersten Aufträge in deinem plentymarkets System abwickelst. *Speichere* die Grundeinstellungen auch dann einmalig ab, wenn du die voreingestellten Werte nicht verändert hast.
====
...
In einem Auftrag findest du das Icon *Neuer Auftrag* (icon:plus-square[role="green"]) im Tab *Übersicht*. Gehe wie unten beschrieben vor, um einen neuen Auftrag über das Tab *Übersicht* eines bestehenden Auftrags anzulegen.
...
Dieses Kapitel beschreibt das Anlegen von Aufträgen oder Angeboten über die Kontaktübersicht im  Menü *CRM » Kontakte*. Hierbei handelt es sich um eine neue Benutzeroberfläche, die zunächst in _beta_ zur Verfügung steht. Alle anderen Methoden Aufträge anzulegen sind ebenfalls weiterhin möglich.

[#250]
==== Standardeinstellungen vornehmen

Um die Auftragsanlage zu erleichtern und schneller vorgehen zu können, kannst du zunächst einige Standardeinstellungen für diese Methode Aufträge anzulegen wählen. Gehe dafür ins Menü  *Einrichtung » Aufträge » Auftragstypen » Auftrag [Beta]*. Die hier gewählten Optionen gelten nur für die Auftragsanlage in der Kontaktübersicht und sind dann dort vorausgewählt, können aber bei Bedarf dennoch angepasst werden.
...
. Nimm die Einstellungen vor. Beachte dazu die Erläuterungen in <<tabelle-standardeinstellungen-auftrag-kontaktübersicht>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.

[[tabelle-standardeinstellungen-auftrag-kontaktübersicht]]
.Standardeinstellungen für die Auftragsanlage in der Kontaktübersicht
[cols="1,3"]
|====
|Einstellung|Erläuterung

|[#intable-standard-eigner]*Standard-Eigner*
|Wähle einen Standardeigner aus. Dieser ist in den Auftragsdetails des neuen Auftrags dann standardmäßig vorausgewählt.

|[#intable-standard-mandant]*Standard-Mandant*
|Wähle einen Standardmandanten aus. Dieser ist in den Auftragsdetails des neuen Auftrags dann standardmäßig vorausgewählt.

|[#intable-standard-herkunft]*Standard-Herkunft*
|Wähle eine Standardherkunft aus. Diese ist in den Auftragsdetails des neuen Auftrags dann standardmäßig vorausgewählt.

|*Vorausgewählter Filter für die Artikelsuche*
|Nachdem die Auftragsdetails (z.B. Rechnungsadresse oder Zahlungsart) für den neuen Auftrag aufgenommen wurden, werden im nächsten Schritt Artikelpositionen hinzugefügt. Dafür wird eine Artikelsuche genutzt, für die man zwischen verschiedenen Filtern wählen kann. Entscheide dich hier für einen Filter, der in dieser Suche vorausgewählt sein soll. Aus einer Dropdown-Liste kannst du auswählen zwischen *Kein Filter vorausgewählt*, *Artikel-ID*, *Variantennummer*, *Varianten-ID*, *Artikelname*, *Barcode*. Es ist dennoch weiterhin möglich, bei der Auftragsanlage den Suchfilter zu wechseln.

|*Option ‚Nur vorrätige Artikel anzeigen‘ vorausgewählt*
|Aktiviere diese Option, damit sie für die Artikelsuche bei der Auftragsanlage vorausgewählt ist. Angezeigt werden in der Suche dann nur Artikel, die einen physischen Warenbestand haben.

|*Option ‚Nur Vertriebslager anzeigen‘ vorausgewählt*
|Aktiviere diese Option, damit sie für die Artikelsuche bei der Auftragsanlage vorausgewählt ist. Angezeigt werden in der Suche dann nur Vertriebslager und keine anderen.
...
Der Auftrag oder das Angebot wird individuell für Kund:innen im Menü *CRM » Kontakte* erstellt. Die Anlage verläuft in mehreren Schritten. Im ersten Schritt werden Auftragsdetails erfasst, im zweiten Schritt werden Artikel hinzugefügt und im 3. Schritt wird der Auftrag oder das Angebot abgeschlossen. Wähle zunächst aus den Kontakten aus, für wen der Auftrag oder das Angebot angelegt werden soll. Gehe dabei wir im Folgenden beschrieben vor.
...
. Suche den Kontakt anhand der Filtereinstellungen wie im Kapitel <<crm/kontakte-verwalten#200, Kontakt suchen>> beschrieben. +
→ Die Kontakte, die den Suchkriterien entsprechen, werden angezeigt.
. Klicke in der Zeile des Kontaktes auf *Aktionen*. +
→ Eine Auswahl der verfügbaren Optionen wird geöffnet.
. Klicke in der Auswahl auf *Beta: Neuer Auftrag* oder *Beta: Neues Angebot*. +
→ Du wirst automatisch zu den Einstellungen für den neuen Auftrag bzw. des neuen Angebotes weitergeleitet. +
→ Hier kannst du in Dropdown-Liste über den Auftragsdetails jederzeit auswählen, ob es sich um es sich um einen Auftrag oder ein Angebot handelt.

Die Ansichten der neuen Benutzeroberfläche sind so gestaltet, dass sich Auftrag oder Angebot schnell und übersichtlich anlegen lassen. Dies ist vor allem bei der telefonischen Aufnahme von Bestellungen von Vorteil. Zunächst werden die Auftragsdetails wie z.B. Adressen oder die Zahlungsart abgefragt. Danach werden dem Auftrag Artikel hinzugefügt, um ihn im letzten Schritt zu überprüfen und anzulegen.

[#270]
==== Auftragsdetails

Da der neue Auftrag oder das neue Angebot über die Kontaktdaten angelegt wird, werden in den Auftragsdetails bereits einige der im Kontakt hinterlegten Daten übernommen. Welche Informationen übernommen werden, hängt davon ab, welche Daten im Kontakt gespeichert sind. Beachte dazu auch <<tabelle-auftragsdetails-neuer-auftrag>>. Alle Angaben in den Auftragsdetails sind Pflichtfelder.

[[tabelle-auftragsdetails-neuer-auftrag]]
...
Über die Vorschau (icon:eye[role="blue"]) gelangst du direkt in den Kundendatensatz. Die bereits gewählten Einstellungen in den Auftragsdetails gehen nicht verloren.

|*Lieferadresse*
|Die im Datensatz des Kontaktes hinterlegte Lieferadresse wird übernommen. Sind mehrere Lieferadressen hinterlegt, wird die als primär definierte übernommen. Wenn keine Lieferadresse als primäre definiert ist, kann man aus der Dropdown-Liste die gewünschte auswählen. +
Über die Vorschau (icon:eye[role="blue"]) gelangst du direkt in den Kundendatensatz. Die bereits gewählten Einstellungen in den Auftragsdetails gehen nicht verloren.

|*Währung*
|Die <<payment/waehrungen#30, Systemwährung>> ist vorausgewählt. Über die Dropdown-Liste kannst du die Währung anpassen.

|*Zahlungsart*
|Wenn im Kontakt eine Zahlungsart hinterlegt ist, ist diese hier vorausgewählt. Ansonsten kannst du eine Zahlungsart aus der Dropdown-Liste auswählen. Angeboten werden dir alle <<payment/zahlungsarten-verwalten#20, Zahlungsarten>> angeboten, die bereits in deinem plentymarkets System integriert sind.

|*Lager*
|Welche Optionen dir hier angezeigt werden, hängt von den Grundeinstellungen ab, die du für die <<auftraege/grundeinstellungen#200, Zuordnung von Lagern>> gewählt hast: +
- Ist *a) pro Auftrag kann ein Lager zugeordnet werden* ausgewählt, kannst du hier in den Auftragsdetails aus einer Dropdown-Liste ein Lager für den Auftrag auswählen. +
- Ist *b) pro Artikelposition kann ein Lager zugeordnet werden* ausgewählt, wird dir hier *Abhängig vom Warenbestand* angezeigt. In der nächsten Ansicht werden dem Auftrag Artikel hinzugefügt, dort kannst du dann für jede Variation ein Lager aus einer Dropdown-Liste auswählen.

|*Mandant*
|Wähle den Mandanten aus, für den dieser Auftrag gelten soll. Hast du einen <<auftraege/auftraege-verwalten#intable-standard-mandant, Standard-Mandaten>> gesetzt, ist dieser hier vorausgewählt. Ansonsten ist die Vorauswahl *Standard Shop*.

|*Eigner*
|Wähle den Eigner für diesen Auftrag aus. Hast du einen <<auftraege/auftraege-verwalten#intable-standard-eigner, Standard-Eigner>> gesetzt, ist dieser hier vorausgewählt. Ansonsten werden dir in der Dropdown-Liste nur Eigner angezeigt, die das Benutzerrecht Aufträge zu erstellen und zu bearbeiten haben.

|*Herkunft*
|Wähle die Herkunft für diesen Auftrag aus. Hast du eine <<auftraege/auftraege-verwalten#intable-standard-herkunft, Standard-Herkunft>> gesetzt, ist diese hier vorausgewählt. Ansonsten ist die vorausgewählte Herkunft *Manuelle Eingabe*. Es werden nur die <<auftraege/auftragsherkunft#, Herkünfte>> angezeigt, die im Backend aktiv geschaltet sind.

|====

Nachdem du alle Einstellungen vorgenommen hast, gehe zum nächsten Schritt weiter indem du auf *Artikel hinzufügen* klickst. Die gewählten Einstellungen werden gespeichert und du wirst zum nächsten Arbeitsschritt geleitet. Hier fügst du dem Auftrag Artikel hinzu.

[#280]
==== Artikel hinzufügen

Während der Hinzufügens von Artikeln sind die Auftragsdetails gesperrt und nicht bearbeitbar. Eventuell erforderliche Anpassungen lassen sich im letzten Schritt durchführen. *Beachte* allerdings, dass die Adressen und die Währung auch dort nicht mehr bearbeitet werden können. Um einen Auftrag abzuschließen und ihn anzulegen, müssen Artikel hinzugefügt werden.

Führe eine Suche aus, um Artikel hinzuzufügen. Für die Artikelsuche kannst du zwischen verschiedenen Filtern wählen: +
...
Zusätzlich kannst du *Nur vorrätige Artikel anzeigen* und *Nur Vertriebslager anzeigen* auswählen. Setze ein Häkchen, wenn du eine oder beide dieser Optionen aktivieren möchtest. Wenn wie oben beschrieben deine Lagereinstellung in den Grundeinstellungen *a) pro Auftrag kann ein Lager zugeordnet werden* ist, kannst du hier nur die Option *Nur vorrätige Artikel anzeigen* wählen, weil du das Lager bereits vorher bestimmt hast.

Wenn du alle Suchparameter eingestellt hast, klicke auf *Suchen* (icon:search[role="blue"]). Eine Tabelle mit den Artikeln, die den Suchkriterien entsprechen, wird geöffnet.

Zeilen mit Artikeln, für die im ausgewählten Lager Bestand vorhanden ist, werden weiß angezeigt. Rot sind die Zeilen mit Artikeln, für die im ausgewählten Lager kein Bestand verfügbar ist. Wurde vorher z.B. *Nur vorrätige Artikel anzeigen* ausgewählt, wird keine der Zeilen der Tabelle in rot wiedergegeben werden. Auf diese Weise siehst du auf einen Blick, in welchem Lager welcher Bestand vorhanden ist und die Bestellung kann schneller abgeschlossen werden.

[[tabelle-übersicht-artikelsuche]]
.Informationen Artikelsuche
[cols="1,3"]
|====
|Einstellung |Erläuterung

|*Artikel-ID / Varianten-ID*
|Klicke auf die Artikel-ID / Varianten-ID, um in die Einstellungen des jeweiligen Artikels bzw. der Variante zu gelangen, wenn es erforderlich sein sollte.

|*Variantennummer*
|Klicke auf die Variantennummer, um in die Einstellungen der jeweiligen Variante zu gelangen, wenn es erforderlich sein sollte.
...
|*Barcode*
|Der am Artikel hinterlegte Barcode wird angezeigt.

|*Einkaufspreis*
|Der am Artikel hinterlegte Einkaufspreis wird angezeigt.

|*Lagerbestand*
|Der Warenbestand für das ausgewählte Lager wird angezeigt.

|*Lager*
|Wähle hier für den entsprechenden Artikel das gewünschte Lager aus der Dropdown-Liste aus, wenn wie oben beschrieben, deine Lagereinstellung in den Grundeinstellungen *a) pro Auftrag kann ein Lager zugeordnet werden* ist. Von dieser Auswahl hängt der Lagerbestand ab, der für den Artikel angezeigt wird.

|*Menge*
|Gib die Menge ein, die in den Warenkorb gelegt werden soll. Es können nur ganze Zahlen eingegeben werden. Nicht zulässig sind negative Mengen sowie Mengen, die den Lagerbestand überschreiten. Werden solche Mengen eingegeben, erscheint eine Fehlermeldung. Wenn die eingegebene Artikelmenge den Lagerbestand in dem ausgewählten Lager auf 0 setzt oder sogar überschreitet, wird die Tabellenzeile rot.
...
Klicke am Ende der Zeile auf den Warenkorb (icon:cart-plus[role="green"]), wenn der Artikel in der eingegebenen Menge dem Warenkorb hinzugefügt werden soll. Sobald sich Artikelpositionen im Warenkorb befinden, wird dieser unter der Ansicht *Artikel hinzufügen* geöffnet. Wenn du noch andere Artikel hinzufügen möchtest, kannst du nun eine neue Artikelsuche durchführen und aus den Ergebnissen dann ebenso Artikel zum Warenkorb hinzufügen.

Die Informationen im Warenkorb entsprechen denen in der Tabelle *Artikel hinzufügen*. Im Warenkorb kommt allerdings noch der *Verkaufspreis* hinzu. Dieser wird aus den im Artikel hinterlegten Daten gezogen *oder aus den Varianten? was ist genauer und welche Info ist hilfreich?*, lässt sich im Warenkorb aber manuell für diesen Auftrag anpassen. Wenn ein Verkaufspreis eingegeben wird, der niedriger ist als der Einkaufspreis, wirst du durch eine Warnung darauf hingewiesen. Allerdings ist es möglich einen niedrigeren Verkaufspreis zu wählen, wenn es gewünscht wird.

Artikelpositionen im Warenkorb können nicht nur hinzugefügt, sondern auch gelöscht werden. Klicke hierzu auf *Artikel löschen* (icon:minus-square[role="red"]).

Nachdem du alle gewünschten Artikel in entsprechender Menge und den gewünschten Preisen im Warenkorb hast, klicke auf *Übersicht*, um zum dritten und letzten Schritt zu gelangen. Du könntest auch zu den Auftragsdetails zurückkehren, indem du unter dem Warenkorb auf *Auftragsdetails* klickst. *Beachte* aber, dass dann alle Daten aus dem Warenkorb gelöscht werden.

[#280]
==== Übersicht: Auftrag abschließen

In der letzten Ansicht wird der Auftrag abgeschlossen. Über den Auftragsdetails wird dir die errechnete *Gesamtsumme* für den Auftrag sowohl in Brutto und Netto angezeigt. Zudem kannst du nun die *Versandart* und die *Versandkosten* anpassen, wenn gewünscht. Bis auf die Adressen und die Währung lassen sich die Auftragsdetails in dieser Ansicht bearbeiten.

Unterhalb der Auftragsdetails wird eine Tabelle mit den ausgewählten Artikelpositionen angezeigt. Zusätzlich zu den Angaben in der vorherigen Ansicht wird dir hier auch die *Umsatzsteuer* mit ausgegeben. Diese wird automatisch berechnet. Der Verkaufspreis ist bearbeitbar, solange der Auftrag noch nicht abgeschlossen ist.

Wenn du Änderungen vornimmst, müssen *Neuberechnungen* ausgeführt werden, da die Preiskalkulation von mehreren Faktoren abhängig ist. Bevor du den Auftrag abschließen kannst, musst du daher auf *Auftrag neu berechnen* klicken. Durch die Neuberechnung passt sich die Gesamtsumme an. Um danach den Auftrag fertigzustellen, klicke auf *Auftrag anlegen*. Der Auftrag ist nun erstellt und du wirst zur allgemeinen Auftragsübersicht weitergeleitet.
...
====
Im Menü *Einrichtung » Aufträge » Einstellungen* muss zwingend für die *Zuordnung des Lagers* die Option *b) pro Artikelposition kann ein Lager zugeordnet werden* ausgewählt werden.
====
...
. Klicke anschließend auf das *Zahnrad* (icon:gear[role="darkGrey"]) die Einstellungen. +
...
Lieferaufträge werden idealerweise über eine Ereignisaktion generiert. Du als Händler kannst somit bestimmen, wann und wie die Lieferaufträge zu einem Auftrag generiert werden. Im Folgenden werden drei Beispiele zum Generieren von Lieferaufträgen per Ereignisaktion beschrieben.
...
:table-event-procedure: <<tabelle-ereignisaktion-lieferauftrag-bei-auftragseingang>>
...
Wenn du möchtest, dass zu einem Auftrag, der in den Status 5.0 wechselt, Lieferaufträge generiert werden, nutze die in <<tabelle-ereignisaktion-lieferauftrag-bei-status-5>> beschriebene Ereignisaktion.
...
. Setze ein Häkchen bei *Aktiv* (icon:check-square-o[role="blue"]).
. *Speichere* (icon:save[role="green"]) die Einstellungen.
--
...
Wenn du möchtest, dass zu einem Auftrag beim Erzeugen der Rechnung die Lieferaufträge angelegt werden, nutze die in <<tabelle-ereignisaktion-lieferauftrag-bei-rechnungserzeugung>> beschriebene Ereignisaktion. +
...
====
Um den Hauptauftrag öffnen zu dürfen, müssen variable Benutzer über die <<business-entscheidungen/benutzerkonten-zugaenge#90, Berechtigung>> für alle Lager der Lieferaufträge eines Hauptauftrags verfügen. Prüfe dazu die Einstellungen im Menü *Einrichtung » Einstellungen » Benutzer » Konten » Tab: Sichtbarkeiten*.
====
...
====
Der Standardstatus für Retouren ist Status 9. Jede Retoure, die erfasst wird, erhält automatisch diesen Status. Du kannst jedoch jederzeit im Menü <<auftraege/grundeinstellungen#, Einrichtung » Aufträge » Einstellungen>> einen anderen Status als *Standard-Status Retoure* festlegen.
====
...
. *Speichere* (icon:save[]) die Einstellungen, um den Rücksendeschein zu generieren.
...
Bei einer Gutschrift bekommen deine Endkunden einen Betrag zurückerstattet. Dies kann beispielsweise nach einer <<auftraege/auftrage-verwalten#400, Retoure>> der Fall sein. Bei der Gutschrift in plentymarkets handelt es sich also nicht um eine Art umgekehrte Rechnung, sondern um eine Rückzahlung. Gutschriftaufträge erzeugst du unter *Aufträge » Aufträge bearbeiten* aus einem Auftrag. Eine Gutschrift ist also immer einem Auftrag zugeordnet. Die in einem Gutschriftauftrag erzeugten Gutschriftbelege werden auch in Buchhaltungsexporten, wie dem *DATEV*-Export, berücksichtigt.

[#510]
=== Standardstatus für Gutschriften speichern

Bevor du eine Gutschrift anlegst, prüfe den Standard-Status für Gutschriften im Menü <<auftraege/grundeinstellungen#, Einrichtung » Aufträge » Einstellungen>>. Passe den Standardstatus bei Bedarf an und speichere die Einstellungen.
...
====
Hat ein Kunde den Auftrag bereits gezahlt, beispielsweise per Vorkasse, und entscheidet sich vor dem Warenausgang gegen den Kauf, empfehlen wir den Auftrag zu stornieren und direkt im Hauptauftrag eine Gutschrift über alle Auftragspositionen anzulegen.

Kommt es nach erfolgter Zahlung, Warenausgang und Zustellung der Ware beim Kunden für eine oder alle Auftragspositionen zu einer <<auftraege/auftrage-verwalten#400, Retoure>> oder im Folgenden zu einem <<auftraege/auftrage-verwalten#700, Reparaturauftrag>>, lege die Gutschrift direkt im entsprechenden Retouren- oder Reparaturauftrag an.
====
...
. Öffne das Menü *Aufträge » Aufträge bearbeiten*.
. Suche (icon:search[role="blue"]) Aufträge.
...
Richte dir zunächst die Vorlage für das Dokument *Stornobeleg Gutschrift* ein. Der schnellste Weg ist in diesem Fall das Übernehmen der Einstellungen aus der Standard-Dokumentvorlage.  +
Im Folgenden wird daher kurz das Übernehmen der Standard-Dokumentvorlage beschrieben.

[.instruction]
Vorlage einrichten:

. Öffne das Menü *Einrichtung » Mandant » Mandant wählen » Standorte » Standort wählen » Dokumente » Stornobeleg Gutschrift*.
...
. Klicke auf das *Zahnrad* (icon:gear[role="darkGrey"]). +
...
|Wird automatisch in 3 Fällen gesetzt: +
- Wenn für einen Auftrag eine Teilzahlung gebucht wird, aber kein Warenbestand vorhanden ist. +
- Wenn für einen Auftrag eine Teilzahlung gebucht wird und Warenbestand für den Auftrag vorhanden ist. +
- Wenn für einen Auftrag eine Überbezahlung gebucht wird und Warenbestand für den Auftrag vorhanden ist.

| *[3.3]* Versandfertig; warten auf Zahlung
|Wird automatisch einem Auftrag des Typs Auftrag zugeordnet, wenn für den Auftrag eine Teil- oder Überzahlung gebucht wird und Warenbestand für den Auftrag vorhanden ist.
...
| *[9]* Retoure
|Ist beim Anlegen eines Auftrags vom Typ Retoure automatisch vorausgewählt. Du kannst auch einen anderen Status als Standard festlegen. Die Einstellung erfolgt im Menü *Einrichtung » Aufträge » Einstellungen*.
...
| *[11]* Gutschrift
|Wird einem Auftrag vom Typ Gutschrift automatisch zugeordnet, wenn eine Gutschrift angelegt wird. Du kannst auch einen anderen Status als Standard festlegen. Die Einstellung erfolgt im Menü *Einrichtung » Aufträge » Einstellungen*.

| *[11.1]* Gutschrift ausgezahlt
|Empfohlen, um zu kennzeichen, dass die Gutschrift ausgezahlt wurde und abgeschlossen ist.

| *[12]* Reparatur
|Ist beim Anlegen eines Auftrags vom Typ Reparatur automatisch vorausgewählt. Du kannst auch einen anderen Status als Standard festlegen. Die Einstellung erfolgt im Menü *Einrichtung » Aufträge » Einstellungen*.

| *[13]* Sammelauftrag
|Wird einem Auftrag vom Typ Sammelauftrag automatisch zugeordnet, wenn er angelegt wird. Du kannst auch einen anderen Status als Standard festlegen. Die Einstellung erfolgt im Menü *Einrichtung » Aufträge » Einstellungen*.

| *[14]* Sammelgutschrift
|Wird einem Auftrag vom Typ Sammelgutschrift automatisch zugeordnet, wenn er angelegt wird. Du kannst auch einen anderen Status als Standard festlegen. Die Einstellung erfolgt im Menü *Einrichtung » Aufträge » Einstellungen*.
|====
...
Gehe wie folgt vor, um einen bestehenden Status zu bearbeiten. Du kannst entweder einnen einzelnen Status bearbeiten oder über die Gruppenfunktion mehrere auf einmal.
...
. Klicke auf das *Zahnrad* (icon:gear[role="darkGrey", stack="long-arrow-right,lr,darkGrey"]), um die Einstellungen auf die ausgewählten Status zu übertragen. +
...
[[tabelle-symbole-auftragsübersicht]]
...
Das Löschen-Icon (icon:minus-square[role="red"]) wird in folgenden Fällen nicht angezeigt: +
- Wenn bereits steuerrelevante Dokumente für den Auftrag existieren. +
- Wenn der Benutzer nicht <<business-entscheidungen/benutzerkonten-zugaenge#90, berechtigt>> ist, Aufträge zu löschen. +
...
| *Teilen*
|Teilt den Auftrag. Es erfolgt eine Abfrage, welche Artikel in den Teilauftrag übernommen werden sollen. Ein Auftrag kann geteilt werden, wenn: +
- Noch kein Zahlungseingang erfolgt ist, +
- noch kein Warenausgang gebucht wurde und +
...
[[tabelle-optionen-tab-einstellungen]]
...
. Klicke im Tab *Nachbestellung* des Auftrags auf einen *Warenkorb* (icon:shopping-cart[role="darkGrey"]). +
...
. Klicke auf das *Zahnrad* (icon:gear[role="darkGrey"]), um den Lieferauftrag anzulegen.
...
. Klicke auf *Anwenden* (icon:cog[]), um die Aktion auszuführen.

[IMPORTANT]
.Grundeinstellungen zur Auftragsbearbeitung durch variable Benutzer
====
Damit variable Benutzer Aufträge öffnen können, müssen im Menü <<auftraege/grundeinstellungen#, Einrichtung » Aufträge » Einstellungen>> die Standard-Status für *Retouren* und *Gutschriften* gespeichert worden sein. In der Grundeinstellung ist dort kein Status voreingestellt.
Außerdem müssen diese Benutzer für die Erstellung und Bearbeitung von Aufträgen im Benutzerprofil unter <<business-entscheidungen/benutzerkonten-zugaenge#110, Berechtigung » Tab: Menü » Bereich: Aufträge>> berechtigt werden. +
Damit variable Benutzer Aufträge der Typen *Retoure*, *Gewährleistung* und *Reparatur* anlegen können, müssen sie für die im Menü <<auftraege/grundeinstellungen#, Einrichtung » Aufträge » Einstellungen>> hinterlegten Standard-Status dieser drei Auftragstypen berechtigt sein. Die Berechtigung erfolgt im *Benutzerprofil* des variablen Benutzers unter <<business-entscheidungen/benutzerkonten-zugaenge#100, Berechtigung » Tab: Sichtbarkeiten>>.
====

[.instruction]
*Beispiel B*: Kundeninformation durch E-Mail mit Gruppenfunktion.

*Ausgangssituation*: Ein begehrter Artikel in deinem Shop ist vorübergehend nicht lieferbar, es liegen aber bereits eine ganze Reihe von Bestellungen dafür vor. Gegen solche Lieferverzögerungen sind Händler in aller Regel machtlos, müssen aber die betroffenen Kunden schnellstmöglich über einen solchen Umstand informieren.
...
. Klicke auf *Anwenden* (icon:cog[]), um die Aktion auszuführen. +
→ Die E-Mail wird an die Kunden versendet.
