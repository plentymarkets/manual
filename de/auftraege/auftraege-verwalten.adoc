...
_Beachte_, dass erstellte Belege nicht gelöscht werden können. Zu einigen Dokumenten, zum Beispiel einer Rechnung oder Mahnung, können Stornobelege erstellt werden. Aber alle Dokumente, die erzeugt wurden, bleiben im Tab Belege erhalten. +
