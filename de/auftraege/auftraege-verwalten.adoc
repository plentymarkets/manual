...
In plentymarkets wird ein Auftrag automatisch angelegt, wenn Kunden Bestellungen in Ihrem Webshop tätigen. Unterschiedliche Geschäftsvorfälle wie <<auftraege/auftraege-verwalten#300, Lieferaufträge>>, <<auftraege/auftraege-verwalten#400, Retouren>>, <<auftraege/auftraege-verwalten#500, Gutschriften>>, <<auftraege/auftraege-verwalten#600, Gewährleistungen>> und <<auftraege/auftraege-verwalten#700, Reparaturen>> werden mithilfe eigene Aufträge verschiedener Typen abgebildet, die immer mit dem Hauptauftrag verbunden sind. Über die <<auftraege/auftraege-verwalten#1400, Auftragsübersicht>> lassen sich Aufträge ungeachtet der <<auftraege/auftragsherkunft#, Auftragsherkunft>> öffnen und bearbeiten. Für viele Auftragstypen, wie zum Beispiel <<auftraege/auftraege-verwalten#300, Lieferaufträge>>, macht das Einrichten von <<basics/automatisierung/ereignisaktionen#, Ereignisaktionen>> Sinn, um Vorgänge zu automatisieren. Einige Beispiele für die Nutzung von Ereignisaktionen für die Auftragsabwicklung werden in den folgenden Kapiteln erläutert. +
...
====
Passen Sie die Einstellungen im Menü *<<auftraege/grundeinstellungen#, System » Aufträge » Einstellungen>>* an, bevor Sie die ersten Aufträge in Ihrem plentymarkets System abwickeln. *Speichern* Sie die Grundeinstellungen auch dann einmalig ab, auch wenn Sie die voreingestellten Werte nicht verändert haben.
====
...
====
Der Standardstatus für Retouren ist Status 9. Jede Retoure, die erfasst wird, erhält automatisch diesen Status. Sie können jedoch jederzeit im Menü *<<auftraege/grundeinstellungen#, System » Aufträge » Einstellungen>>* einen anderen Status als *Standard-Status Retoure* festlegen.
====
...
Bevor Rücksendescheine erzeugt werden können, muss die Dokumentenvorlage *Rücksendeschein* im Menü *<<auftraege/auftragsdokumente#, System » Mandant » Mandant wählen » Standorte » Standort wählen » Dokumente » Rücksendeschein>>* eingerichtet werden.
...
Bevor Sie eine Gutschrift anlegen, prüfen Sie den Standard-Status für Gutschriften im Menü *<<auftraege/grundeinstellungen#, System » Aufträge » Einstellungen>>*. Passen Sie den Standardstatus bei Bedarf an und speichern Sie die Einstellungen.
...
Im Menü *System » Aufträge » Scheduler* konfigurieren Sie das Abo-Modul für Ihren Webshop. Nachdem Sie das Modul konfiguriert haben, finden Sie eine Übersicht Ihrer Abonnements im Menü <<auftraege/scheduler#scheduler-auftraege, Aufträge » Scheduler-Aufträge>>.
...
|*Neuer Auftrag*
|Legt einen *<<auftraege/auftraege-verwalten#neuer-auftrag, neuen Auftrag>>* für den Kunden an. Darin werden automatisch Standardeinstellungen vorgenommen, die ggf. angepasst werden müssen.
...
Aufträge teilen Sie im Menü *<<auftraege/auftraege-verwalten#30, Aufträge » Aufträge bearbeiten » Auftrag öffnen » Tab: Übersicht>>*. Ein Auftrag darf nur unter folgenden Bedingungen geteilt werden:
...
|*Versanddatum*
|Das Versanddatum wird vom Artikel aus der Option **Erscheinungsdatum** übernommen und ist damit eine Funktion für *<<auftraege/auftraege-verwalten#vorbestellungen, Vorbestellungen>>*. Sind mehrere vorbestellte Artikel im Auftrag vorhanden, wird das am weitesten in der Zukunft liegende Datum hier übernommen. Das Datum ist manuell änderbar.
...
Wenn eine Paketnummer hinterlegt wurde, kann das Paket über *Vorschau* verfolgt werden. Allerdings nur, wenn unter *<<fulfillment/versand-vorbereiten#800,System » Aufträge » Versand » Optionen » Tab: Versanddienstleister>>* ein entsprechender Tracking-Code hinterlegt wurde. Sonst wird das Vorschau-Symbol nicht angezeigt.
|====
...
Im Tab *Lief* werden *<<auftraege/auftraege-verwalten#lieferauftrag, Lieferaufträge>>* erstellt. Sie sehen dort die Artikelpositionen des Auftrags, die noch nicht in Lieferaufträge überführt wurden.
...
.Grundeinstellungen zur Auftragsbearbeitung durch variable Benutzer
====
Damit variable Benutzer Aufträge öffnen können, müssen im Menü *<<auftraege/grundeinstellungen#, System » Aufträge » Einstellungen>>* die Standard-Status für *Retouren* und *Gutschriften* gespeichert worden sein. In der Grundeinstellung ist dort kein Status voreingestellt.
