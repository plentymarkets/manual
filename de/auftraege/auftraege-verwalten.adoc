...
|Wählst du eine <<auftraege/auftraege-verwalten#295, Auftragsvorlage>> als Standard-Auftragsvorlage aus, ist diese für den neuen Auftrag oder das Angebot standardmäßig vorausgewählt. Die Werte der ausgewählten Auftragsvorlage werden dann automatisch für den Auftrag oder das Angebot übernommen. Es können nur bereits angelegte Auftragsvorlagen ausgewählt werden. +
...
Über die Vorschau (icon:eye[role="blue"]) gelangst du direkt in den Kontaktatensatz. Die bereits gewählten Einstellungen in den Auftragsdetails gehen nicht verloren.
...
Über die Vorschau (icon:eye[role="blue"]) gelangst du direkt in den Kontaktdatensatz. Die bereits gewählten Einstellungen in den Auftragsdetails gehen nicht verloren.
...
Zudem kannst du mithilfe der Filter Bookmarks (icon:bookmarks[set=material]) ausgewählte Filter in der UI speichern. Die damit ausgewählten Filter sind dann bei jedem Öffnen des Menüs vorausgewählt, ähnlich wie Lesezeichen. Jede:r Benutzer:in kann eigene Filter festlegen.
...
* Gesamtbruttobetrag: Zeigt den errechneten Gesamtbruttobetrag des Auftrags. Der Statusbalken wird in grau angezeigt, wenn der Betrag null ist und in grün, wenn er darüber liegt.
* Gesamtnettobetrag: Zeigt den errechneten Gesamtnettobetrag des Auftrags. Der Statusbalken wird in grau angezeigt, wenn der Betrag null ist und in grün, wenn er darüber liegt.
* Gesamt: Zeigt die Gesamtanzahl der Artikelpositionen des Auftrags an. Der Statusbalken wird immer in grau angezeigt.
* Rabatt: Zeigt den gewährten Rabatt (Ermäßigung durch Aktionsgutscheine). Der Statusbalken wird immer in grau angezeigt.
* Offener Betrag: Zeigt den von Kund:in zu zahlenden Betrag. Der Statusbalken wird in grün angezeigt, wenn der Betrag bei null liegt. Rot bedeutet, der Betrag liegt über null und orange bedeutet, der Betrag liegt unter null.
