...
*_Beachte_*, dass bei Anwendung einer Auftragsvorlage mit Artikeln dem entsprechenden Auftrag noch keine Artikel hinzugefügt sein sollten. Bereits vorher vorhandene Artikel werden überschrieben. Du kannst aber nach Anwendung der Auftragsvorlage weitere Artikel zum Auftrag hinzufügen.
