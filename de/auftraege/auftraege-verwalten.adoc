...
|Durch Aktivierung des Toggles erlaubst du, dass vor dem Abschließen des Auftrages im letzten Schritt <<auftraege/auftraege-verwalten#290, Übersicht>> der Auftragsanlage Steuersätze geändert werden dürfen. Die Steuersätze richten sich dabei nach der Lieferadresse des Auftrages. +
Der Toggle ist standardmäßig deaktiviert. Lass ihn deaktiviert, wenn du die Mehrwertsteuersätze in der Übersicht nur sichtbar, aber nicht bearbeitbar lassen möchtest.
...
====
Bevor Gutschriftbelege erzeugt werden können, muss die Dokumentenvorlage für <<auftraege/auftragsdokumente/gutschriften-erzeugen#, Gutschriften>> im Menü <<auftraege/auftragsdokumente#, Einrichtung » Mandant » [Mandant wählen] » Standorte » [Standort wählen] » Dokumente » Gutschrift>> eingerichtet werden.
====
...
Einen Gutschriftauftrag und den dazugehörigen Gutschriftbeleg korrigierst du, indem du zunächst einen *Stornobeleg Gutschrift* erzeugst. Anschließend kann der Gutschriftauftrag wieder bearbeitet werden, also die Daten korrigiert werden, und ein neuer Gutschriftbeleg erzeugt werden.
