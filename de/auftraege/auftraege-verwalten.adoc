...
- Berechnungen
- im nächsten Schritt werden porperties nicht noch mal angezeigt, nur hier
- Dokumente: wie bei anderen properties auch, werden auf der rechnung der gruppenname und eigenschaftsname ausgegeben
