...
| *Teilen*
|Teilt den Auftrag. Beim Teilen eines Auftrages werden 2 neue Aufträge erstellt. Der ursprüngliche Auftrag wird gelöscht. Für die neuen Aufträge werden jeweils die Versandkosten neu ermittelt. Bevor der Auftrag geteilt wird erfolgt eine Abfrage zur Verteilung der Auftragspositionen. +
...
- keine steuerrelevenaten Dokumente am Auftrag hängen und +
...
Mit der Gruppenfunktion *Aufträge gruppieren* können bestimmte Aufträge gruppiert werden. Das bedeutet, dass die ausgewählten Aufträge in einem neuen Auftrag zusammengefasst werden. Die ursprünglichen Aufträge werden dabei gelöscht. Die Versandkosten werden dann für den neuen Auftrag neu berechnet. Damit Aufträge gruppiert werden können, müssen sie folgende Kriterien erfüllen: +
