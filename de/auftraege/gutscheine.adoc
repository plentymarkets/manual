...
. Stelle die Option *Aktionsgutschein* auf *Möglich*.
...
Da jeder Gutschein einer Kampagne angehört, muss zuerst eine Kampagne erstellt werden. Kampagnen erstellst du im Menü *Aufträge » Gutscheine*. Bereits erstellte Kampagnen enthalten neben dem Tab *Einstellungen* zwei weitere Tabs: <<auftraege/gutscheine#60, Codes>> und <<auftraege/gutscheine#140, Vorlagen>>.
...
Im Menü *Aufträge » Gutscheine » Tab: Kampagnen* werden die wichtigsten Informationen der erstellten Kampagnen in der Übersicht angezeigt. <<tabelle-kampagnenuebersicht>> erläutert die Kampagnenübersicht. Über die Funktion *Ansicht bearbeiten* entscheidest du, welche Informationen in der Übersicht angezeigt werden.
...
Verwende den ElasticSync im Menü *Daten » ElasticSync*, um <<daten/daten-importieren/sync-typen/elasticSync-gutschein-codes#, Gutschein-Codes>> zu importieren. Auf diese Weise ist es möglich, größere Mengen an Gutscheincodes in einem Arbeitsgang zu importieren, statt sie einzeln manuell einzugeben. Erstelle dazu einen Sync des Typs *Gutschein-Code*.

Um Kampagnen zu importieren, verwende den Sync-Typ <<daten/daten-importieren/sync-typen/elasticSync-kampagnen#, Kampagnen>>.

Wenn du deine bestehenden Gutscheinkampagnen exportieren möchtest, verwende das Datenformat <<daten/export-import/datenformate/campaign#, Campaign>> im Menü *Daten » Dynamischer Export*. Um Gutschein-Codes zu exportieren, verwende das Datenformat <<daten/export-import/datenformate/campaigncoupon#, CampaignCoupon>>.
...
. Klappe den Bereich *Gutschein-Vorlage* auf.
. Klicke bei *Dokumenten-Vorlage Upload* auf *Datei auswählen*.
. Markiere das Dokument.
. *Speichere* die Einstellungen.  +
*_Tipp:_* Nach erfolgreichen Upload wird eine Erfolgsmeldung angezeigt. Solltest du diese nicht erhalten und nach dem Klicken auf *Vorlage anzeigen* wird eine Fehlermeldung angezeigt, wende dich bitte an den Support. Unter Umständen ist das Gutscheinverkaufsmodul für dein System nicht aktiviert.
. Klappe den Bereich *Gutschein-Layout* auf .
. Wähle den Zeichensatz aus der Dropdown-Liste.
. Gib Werte für die X- und Y-Koordinaten und für die Schriftgröße ein.
. *Speichere* die Einstellungen. +
*_Tipp:_* Nach erfolgreichem Speichern wird eine Erfolgsmeldung angezeigt. Klicke auf *Vorschau anzeigen*, um einen Eindruck davon zu bekommen, wie der Gutschein aussehen wird und korrigiere die Werte, bis du mit dem Ergebnis zufrieden bist.
...
. Öffne das Menü *System » Systemeinstellungen » Aufträge » Ereignisaktionen*.
. Klicke auf *Ereignisaktion hinzufügen*. +
→ Das Fenster *Neue Ereignisaktion erstellen* wird geöffnet.
. Gib einen Namen ein.
. Wähle das Ereignis gemäß Tabelle <<tabelle-ereignisaktion-gutscheinvorlagen>>.
. *Speichere* die Einstellungen. +
→ Das Ereignis wird erstellt.
. Nimm die weiteren Einstellungen gemäß Tabelle <<tabelle-ereignisaktion-gutscheinvorlagen>> vor.
