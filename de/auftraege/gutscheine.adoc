...
| *Mehrzweckgutschein*
|Wenn du als *Gutscheinart* die Option *Mehrzweckgutschein* gewählt hast, musst mit dem Setzen des Häkchens bestätigen, dass du Mehrzweckgutscheine verkaufst. Wenn das Häkchen nicht gesetzt wird, kann die Kampagne nicht erstellt werden. +
...
[#25.subhead]
Beispiel für die Berechnung von Aktions- und Mehrzweckgutscheinen

In der Kampagne im Tab *Einstellungen* kannst du die Gutscheinart *Aktionsgutschein* oder *Mehrzweckgutschein* wählen. Die Auswahl der Gutscheinart hat Einfluss darauf, wie der Gutschein im Webshop verrechnet wird. Aktionsgutscheine werden z.b. ähnlich wie Rabatte verrechnet.
...
[[tabelle-vergleich-aktionsgutschein-mehrzweckgutschein]]
.Vergleich von Aktionsgutschein und Mehrzweckgutschein
[cols="3,3,3"]
|====
| |Mehrzweckgutschein |Aktionsgutschein
...
| *Gutscheinart*
|Zu den Gutscheinarten *Aktionsgutschein* und *Mehrzweckgutschein* die Erläuterungen in <<tabelle-einstellungen-gutscheinkampagne>> sowie das <<auftraege/gutscheine#25, Beispiel>> unter der Tabelle beachten.
...
Bevor du Gutscheine in deinem Webshop zum Verkauf anbieten kannst, muss die <<auftraege/gutscheine#20, Gutscheinkampagne>> mit der Gutscheinart *Mehrzweckgutschein* erstellt sein. Weitere Informationen findest du in <<tabelle-einstellungen-gutscheinkampagne>>.
