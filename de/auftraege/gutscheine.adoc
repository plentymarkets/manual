...
So kann auch per Newsletter jedem Kunden ein automatisch generierter Gutschein-Code zugeschickt werden. Dazu muss der Kampagne zunächst eine <<crm/e-mails-versenden#4200, Template-Variable>> zugewiesen werden, z.B. *$CouponCode1*.
