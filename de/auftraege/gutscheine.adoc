...
*_Hinweis:_* Preisportale sind alle Herkünfte > 1. Das bedeutet, dass neben Preisportalen auch Marktplätze und Plattformen inbegriffen sind. Die manuelle Anlage (Herkunft 0) und Webshop (Herkunft 1) sind von dieser Einstellung nicht betroffen.
...
. Gib in das Freitextfeld, das du zuvor im Menü *Einrichtung » Aufträge » Gutscheine* für Gutscheinkampagnen gewählt hast, die ID der Kampagne ein, die du mit dem Gutscheinartikel verknüpfen möchten.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
