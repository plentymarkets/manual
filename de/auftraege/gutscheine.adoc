...
| *Mehrzweck-Gutschein*
|Wenn du *Gutscheinart* die Option *Mehrzweck-Gutschein* gewählt hast, musst mit dem Setzen des Häkchens bestätigen, dass du Mehrzweck-Gutscheine verkaufst. Wenn das Häkchen nicht gesetzt wird, kann die Kampagne nicht erstellt werden. +
