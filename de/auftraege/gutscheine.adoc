...
. Öffne das Menü *Aufträge » Gutscheine*.
. Suche (icon:search[role="blue"]) die Kampagne, die du bearbeitest möchtest anhand der Filtereinstellungen in <<tabelle-kampagne-suchen>>.
...
. Klicke in die Zeile der Kampagne. +
→ Das Tab *Einstellungen* wird geöffnet.
. Klicke auf *Kopieren* (icon:clone[role="yellow-background"]). +
