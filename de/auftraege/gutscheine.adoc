...
====
Wenn ein bestimmter Artikel nicht per Gutschein bezahlbar sein soll, stelle im Menü *Artikel » Artikel bearbeiten* » _Artikel öffnen_ im Tab *Global* die Option *Aktionsgutschein* auf *Verboten*. Wenn eine Person einen solchen Artikel in den Warenkorb legt, wird der Rabattbetrag für diesen Artikel nicht abgezogen. Dies ist z.B. bei Sonderangeboten sinnvoll, die nicht weiter rabattiert werden sollen.
...
| [#intable-gutscheinkampagne-name]*Name*
| Name der Kampagne eingeben.

| [#intable-gutscheinkampagne-beschreibung]*Beschreibung*
|Beschreibung der Kampagne eingeben.

| [#intable-gutscheinkampagne-konzept-code]*Konzept: Code*
...
| [#intable-gutscheinkampagne-konzept-einloesungen]*Konzept: Einlösungen*
...
*_Wichtig:_* Wenn Personen nicht registriert sind und sich über einen Gastzugang einloggen, werden sie im System als neue Kund:innen geführt. Der Gutschein kann immer wieder eingelöst werden, da eine Einlösung _pro_ Kund:in eingestellt ist - also neue Kund:in, neuer Gutschein.  +
...
| [#intable-gutscheinkampagne-nutzung]*Nutzung*
| *Einzelbestellungen* oder <<auftraege/scheduler#, Abonnement>> oder beides wählen.

| [#intable-gutscheinkampagne-mindestbestellwert]*Mindestbestellwert*
| Mindestbestellwert, der erreicht werden muss, damit der Gutschein eingelöst werden kann.

2+| [#intable-gutscheinkampagne-gueltigkeiten]*Gültigkeiten*

| [#intable-gutscheinkampagne-startdatum]*Startdatum*
|Das Datum, ab dem die Kampagne aktiv sein soll.

| [#intable-gutscheinkampagne-enddatum]*Enddatum*
|Das Datum, bis zu dem die Kampagne aktiv sein soll.

| [#intable-gutscheinkampagne-code-gueltigkeiten-wochen]*Code-Gültigkeit in Wochen*
...
| [#intable-gutscheinkampagne-gutscheintyp]*Gutscheintyp*
...
| [#intable-gutscheinkampagne-code-zuweisung]*Code-Zuweisung*
...
| [#intable-gutscheinkampagne-gutscheinart]*Gutscheinart*
...
| [#intable-gutscheinkampagne-mehrzweckgutschein]*Mehrzweckgutschein*
...
| [#intable-gutscheinkampagne-artikel-preisportale]*Artikel über Preisportale*
...
| [#intable-gutscheinkampagne-kategorien]*Kategorien*
...
| [#intable-gutscheinkampagne-artikel]*Artikel*
...
| [#intable-gutscheinkampagne-mandanten]*Mandanten (Shops)*
...
| [#intable-gutscheinkampagne-kundenklassen]*Kundenklassen*
...
| [#intable-gutscheinkampagne-kundentypen]*Kundentypen*
...
| [#intable-gutscheinkampagne-variable]*Variable*
...
[#gutschein-erzeugen]
=== Gutschein erzeugen (ab Ceres-Version 5)
...
[TIP]
Um einen persönlichen Text zu speichern, müssen Kund:innen in ihrem *Mein Konto*-Bereich des Webshops beim Artikel noch einmal auf *Ändern* klicken. Schreibe am besten einen kurzen Hinweis in der Beschreibung des Gutscheinartikels, um die Kund:innen darüber zu informieren. +
Beachte, dass du diese Funktion ab link:https://marketplace.plentymarkets.com/ceres_4697[Ceres^]{nbsp}icon:external-link[]-Version *5* nutzen kannst.
...
. Im Ceres-Webshop einloggen.
. Den Bereich *Mein Konto* des Ceres-Webshops im Bereich *Auftragshistorie* öffnen.
