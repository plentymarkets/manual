...
. *Speichere* die Einstellungen.  +
*_Tipp:_* Nach erfolgreichem Upload der Datei wird eine Erfolgsmeldung angezeigt. Wenn nach dem Klick auf *Vorlage anzeigen* eine Fehlermeldung und keine Erfolgsmeldung angezeigt wird, wende dich an den Support. Unter Umständen ist das Gutscheinverkaufsmodul für dein System nicht aktiviert.
