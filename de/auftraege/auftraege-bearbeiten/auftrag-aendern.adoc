...
image::auftraege/auftraege-bearbeiten/assets/DE-Auftraege-aendern-01.png[]
...
image::auftraege/auftraege-bearbeiten/assets/DE-Auftraege-aendern-02.png[]
...
Die Option **IP-Adresse des Käufers** wird im Menü <<mandant-shop/standard/bestellvorgang/grundeinstellungen#, **Einstellungen » Mandant (Shop) » Standard » Bestellvorgang » Grundeinstellungen**  >> aktiviert bzw. deaktiviert.
...
Ein Beispiel für den Einsatz von Mahnstufen finden Sie auf der Handbuchseite **<<payment/mediafinanz#, mediafinanz  >>**.
...
|**Neuer Auftrag**
|Legt einen <<auftraege/auftraege-bearbeiten/neuer-auftrag#, **neuen Auftrag**  >> für den Kunden an. Darin werden automatisch Standardeinstellungen vorgenommen, die ggf. angepasst werden müssen.
...
**__Tipp__**: Lagerorte können Artikeln auch per **<<auftraege/einstellungen/ereignis-aktionen/konfiguration#, Ereignisaktion  >>** zugeordnet werden.
...
image::auftraege/auftraege-bearbeiten/assets/DE-Auftraege-aendern-03.png[]
...
|**Versanddatum**
|Das Versanddatum wird vom Artikel aus der Option **Erscheinungsdatum** übernommen und ist damit eine Funktion für <<auftraege/auftraege-bearbeiten/vorbestellungen#, **Vorbestellungen**  >>. Sind mehrere vorbestellte Artikel im Auftrag vorhanden, wird das am weitesten in der Zukunft liegende Datum hier übernommen. Das Datum ist manuell änderbar.
...
|**Zeichen Kunde**
|Zeigt ein Zeichen bzw. einen Text an, den der Kunde bei der Bestellung hinterlegen kann, wenn das Feld **Ihr Zeichen** für den Bestellvorgang sichtbar ist. Dazu die Hinweise in Tabelle 1 der Handbuchseite **<<cms/webdesign/webdesign-bearbeiten/bestellvorgang/kaufabwicklung#, Kaufabwicklung  >>** beachten.
...
image::auftraege/auftraege-bearbeiten/assets/DE-Auftraege-aendern-04.png[]
...
Die Dokumente werden anhand von Dokumentenvorlagen erstellt, die im Menü **<<auftraege/einstellungen/dokumente#, Einstellungen » Aufträge » Dokumente  >>** hinterlegt wurden. Prüfen Sie daher vor der Erstellung der Belege bzw. auch bei einer Fehlermeldung, ob Sie die Dokumentenvorlagen erstellt haben.

[TIP]
.Tipp: Dokumentenvorlagen kopieren
====
Wenn Sie bei der Einrichtung der <<auftraege/einstellungen/dokumente#20, **Dokumentenvorlagen** >> Zeit sparen möchten, kopieren Sie sie von einer bereits konfigurierten Dokumentenvorlage und passen sie nach Bedarf an.
====

image::auftraege/auftraege-bearbeiten/assets/DE-Auftraege-aendern-05.png[]
...
image::auftraege/auftraege-bearbeiten/assets/DE-Auftraege-aendern-06.png[]
...
image::auftraege/auftraege-bearbeiten/assets/DE-Auftraege-aendern-07.png[]
...
image::auftraege/auftraege-bearbeiten/assets/DE-Auftraege-aendern-08.png[]
...
image::auftraege/auftraege-bearbeiten/assets/DE-Auftraege-aendern-09.png[]
...
image::auftraege/auftraege-bearbeiten/assets/DE-Auftraege-aendern-10.png[]
...
Im Tab **Lief** werden <<auftraege/einstellungen/auftragstypen/lieferauftrag#, **Lieferaufträge**  >> erstellt. Sie sehen dort die Artikelpositionen des Auftrags, die noch nicht in Lieferaufträge überführt wurden.

image::auftraege/auftraege-bearbeiten/assets/DE-Auftraege-aendern-11.png[]
...
Da die Einstellungen der Vorlage für Stornobelege mit den Einstellungen der Vorlage für Rechnungen übereinstimmen, finden Sie nährere Erläuterungen zu den einzelnen Einstellungen auf der Seite <<mandant-shop/standard/dokumente/rechnung#, **Rechnung**  >>.
...
image::auftraege/auftraege-bearbeiten/assets/DE-Auftraege-aendern-12.png[]
...
Ein weiteres Beispiel für die Verwendung der Gruppenfunktion finden Sie auf der Handbuchseite <<auftraege/auftraege-bearbeiten/suche#, **Auftragssuche**  >>.
