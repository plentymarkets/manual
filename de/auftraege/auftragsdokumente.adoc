...
|Für Aufträge mit der Zahlungsart Lastschrift wird auf den Dokumenten Rechnung und Lieferschein standardmäßig der Hinweis *Der Rechnungsbetrag wird dankend von Ihrem Konto abgebucht* angezeigt. Aktivieren Sie die Option *Hinweis ausblenden*, wenn dieser Hinweis auf den Dokumenten nicht angezeigt werden soll.
