...
. Wähle einen Standort unter *System » Systemeinstellungen » Mandant » Mandant wählen » Standorte*.
...
. Öffne das Menü *System » Systemeinstellungen » Aufträge » Dokumente*.
...
. Öffne das Menü *System » Systemeinstellungen » Mandant » Mandant wählen » Standorte*.
