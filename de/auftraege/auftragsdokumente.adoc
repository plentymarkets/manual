...
:id: SVWTISV
:keywords: Dokument, Vorlage, Dokumentvorlage, Dokumentenvorlage, Dokument-Vorlage, Documentvorlage, Document, Template, Auftragsdokument, Auftragsdokumente, Auftrags-Dokument, PDF, pdf-Vorlage, Nummerkreise, Nummernkreise, Rechnung, Sammelrechnung, Sammel-Rechnung, Lieferschein, Gutschrift, Korrekturbeleg, Korekturbeleg, Korrektur-Beleg, Korektur-Beleg, Mahnung, Manung, Rücksendeschein, Rüksendeschein, Gelangensbestätigung, Gelangens-Bestätigung, SEPA-Lastschrift, SEPA-Lastschriftmandant, Standort, standortbezogen, Mandant, Fulfillment-Dokument, Fullfilment-Dokument, Fulfilment-Dokument, Fullfillment-Dokument, Adressetikett, Addressetikett, Adressettiket, Pickliste, Pick-Liste, Packliste, Pack-Liste, Lager-Pickliste, Standard-Dokumentvorlage, Adresse, Addresse, Addrese, Dokument einrichten, Auftragsbestätigung, Proformarechnung, Angebot, Abhollieferung, Reparaturschein, Abhol-Lieferung, Reperaturschein, Reparatur-Schein
...
Folgende Dokumente werden im Menüpunkt *Dokumente* unter *Einrichtung » Mandant » _Mandant wählen_ » Standorte* eingerichtet und verwaltet:
...
* <<auftraege/auftragsdokumente/gutschriften-erzeugen#, Gutschriften / Sammelgutschrift>>
...
* <<auftraege/auftragsdokumente/reparaturschein-erzeugen, Reparaturschein>>
* <<auftragsdokumente/abhollieferung-erzeugen, Abhollieferung>>
...
* <<auftraege-verwalten#1670, Stornobeleg Rechnung>>
* <<auftraege/auftraege-verwalten#540, Stornobeleg Gutschrift>>
* <<auftragsdokumente/proformarechnung-erzeugen, Proformarechnung>>

[.instruction]
Standortbezogenes Dokument einrichten:

. Wähle einen Standort unter *Einrichtung » Mandant » _Mandant wählen_ » Standorte*.
...
| *Zahlungsziel*
|Mit *JA* oder *NEIN* einstellen, ob eine Option auf dem Dokument angezeigt wird oder nicht. Bei *JA* muss auch ein *Zahlungsziel in Tagen* gewählt werden. Beachte bei der Einstellung, dass ein in den Kundendaten hinterlegtes Zahlungsziel Priorität hat. Wenn in den Kundendaten kein Zahlungsziel hinterlegt ist, hat das Zahlungsziel der Kundenklasse Priorität.

| *Zahlungseingang*
|Das Datum wird nur angezeigt, wenn der Zahlungseingang vollständig ist.

|[#intable-zahlungsbedingungen-anzeigen]*Möchtest du die neuen Zahlungsbedingungen nutzen? (Valuta, Zahlungsziel und Skonto) (Beta)*
|Wähle *Ja*, wenn du auf die neue Logik für die Zahlungsbedingungen wechseln möchtest. Stelle dafür sicher, dass du vorher deine bisherigen Einstellungen überträgst. +
Wähle *Nein*, wenn du die alte Logik nutzen möchtest. _Beachte_, dass diese zum *01.01.2021* abgeschaltet wird. Wir empfehlen daher die zeitnahe Umschaltung auf die neue Logik.

|[#intable-zahlungsbedingungen-dokumente]*Zahlungsbedingungen* (neue Logik)
...
_Wichtig_: Die Zahlungsbedingungen werden nur auf Dokumenten übernommen, wenn es sich um einen Auftrag mit der _Zahlungsart Rechnung_ handelt. Möchtest du Valuta und Skonto nutzen, muss ein Zahlungsziel angeben sein. Wenn für Zahlungsziel nichts oder der Wert 0 eingetragen ist, sind die Zahlungsbedingungen nicht gültig und werden auch nicht auf Dokumenten übernommen. +
*Anzeigen*: Wähle aus, ob die Zahlungsbedingungen auf dem Dokument angezeigt werden sollen. Vergib im Freitextfeld *Title* einen Titel dafür. +
...
Die Platzhalter werden mit den Werten befüllt, die in den <<crm/kontakte-verwalten#100, Kundendaten>> hinterlegt sind. Dazu die Info zur Gestaltung von Zahlungsbedingungen auf der Handbuchseite <<crm/kontakte-verwalten#100, Kontakte>> beachten. +
...
. Öffne das Menü *Einrichtung » Mandant » _Mandant wählen_ » Standorte*.
...
. Öffne das Menü *Einrichtung » Mandant » _Mandant wählen_ » Standorte » _Standort wählen_ » Dokumente » Rechnung*.
. Wähle die gewünschte *Sprache* aus der Dropdown-Liste.
...
Die erforderlichen *steuerrechtlichen Hinweise* können individuell abweichen. Kläre den Wortlaut mit deinem Steuerbüro ab.
