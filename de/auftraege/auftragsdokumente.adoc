...
. Wählen Sie einen Standort unter *System » Systemeinstellungen » Mandant » Mandant wählen » Standorte*.
...
. Öffnen Sie das Menü *System » Systemeinstellungen » Mandant » Mandant wählen » Standorte*.
. Wählen Sie einen Standort.
