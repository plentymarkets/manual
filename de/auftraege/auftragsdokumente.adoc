...
|*Möchtest du die neuen Zahlungsbedingungen nutzen? (Valuta, Zahlungsziel und Skonto) (Beta)*
|Wähle *Ja*, wenn du auf die neue Logik für die Zahlungsbedingungen wechseln möchtest. Stelle dafür sicher, dass du vorher deine bisherigen Einstellungen überträgst. *LINK LINK LINK LINK* +
Wähle *Nein*, wenn du die alte Logik nutzen möchtest. _Beachte_, dass diese zum *31.12.2020* abgeschaltet wird. Wir empfehlen daher die zeitnahe Umschaltung auf die neue Logik.
...
|_Achtung_: Dieses Feld wird nur angezeigt, wenn du die alte Logik nutzt. Diese wird zum *31.12.2020* abgeschaltet. Wir empfehlen daher die zeitnahe Umschaltung auf die neue Logik. +
