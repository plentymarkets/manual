...
Nachdem Sie Ihre Dokumentenvorlagen eingerichtet haben, können Sie im Bereich <<automatisierung/ereignisaktionen#, System » Aufträge » Ereignisse>> automatische Aktionen einstellen. Interessant ist beispielsweise das Buchen von Warenausgängen beim Rechnungsdruck. Weitere Aktionen, wie das automatische Versenden von aktionsgesteuerten E-Mails, sind ebenfalls einstellbar.
