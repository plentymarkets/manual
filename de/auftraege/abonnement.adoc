...
Oder gehe über *Bearbeiten* (icon:pencil[role="yellow-background"]) und gelange direkt zum bestehenden Warenkorb für das ausgewählte Abonnement. Folgende Bearbeitungsmöglichkeiten stehen dir dort zur Verfügung:
