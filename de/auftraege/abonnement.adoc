...
Zur vollständigen Anlage des Abonnements müssen Artikel hinzugefügt werden. Erst danach wird das Abonnement gespeichert und angelegt. Wende die Suche (icon:search[]) an, um die gewünschten Artikel zu finden und zum Abonnement hinzuzufügen.
...
. Füge die Auftragspositionen in gewünschter Menge zum Warenkorb (icon:cart-plus[]) hinzu.
