...
. Wähle das *Ereignis* gemäß <<table-event-procedure-sending-offer-document>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
. Nimm die weiteren Einstellungen gemäß <<table-event-procedure-sending-offer-document>> vor.
