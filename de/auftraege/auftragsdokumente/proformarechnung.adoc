...
:id: 82PZJ1F
:keywords: Proformarechnung, Proformarechnung erzeugen, Proforma-rechnung, Pro-formarechnung, Auftragsdokumente, Auftragsabwicklung, Lieferung, Dokumentenvorlage, Vorlage, Mandant, Standort, Auftrag, Nummer, Dokumentennummer, Beleg, Dokumententyp, Dokument, PDF, PDF-Vorlage, PDF-Datei, Steuer, Zoll
...
Bevor du Proformarechnungen generieren kannst, muss eine Dokumentenvorlage eingerichtet werden. Dies geschieht im Menü *Einrichtung » Mandant » _Mandant wählen_ » Standorte » _Standort wählen_ » Dokumente » Proformarechnung*. +
...
[#200]
== Proformarechnungen manuell erzeugen
...
. Nimm die Einstellungen anhand <<tabelle-proformarechnung-erzeugen>> vor.
...
[[tabelle-proformarechnung-erzeugen]]
