...
:position: 10
:url: auftrage/auftragsdokumente/rechnungen-erzeugen
...
Bevor Sie Rechnungen generieren können, muss eine Dokumentenvorlage eingerichtet werden. Dokumentenvorlagen richten Sie im Menü **System » Systemeinstellungen » Mandant » Mandant wählen » Standorte » Standort wählen » Dokumente** ein. +
