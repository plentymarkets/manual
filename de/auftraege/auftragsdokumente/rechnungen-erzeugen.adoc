...
:id: I75PCMI
:keywords: Rechnung, Rechnungen erzeugen, Skonto, Aufträge, Auftrag, Dokument, Auftragsdokument, PDF, PDF-Datei, PDF-Vorlage, Dokumentenvorlage, Vorlage, Mandant, Standort, Beleg, Nummer, Dokumentennummer, Fulfillment, Dokumenttyp, Dokumententyp, Auftragsabwicklung, Rechnungsdaten. Lieferland, Zahlungsziel, Valuta, Skontierung, Warenausgang, Storno, Stornobeleg, gesperrte Aufträge, gesperrter Auftrag, Rechnungsdatum, steuerrelevant
...
Bevor du Rechnungen generieren kannst, muss eine Dokumentenvorlage eingerichtet werden. Dokumentenvorlagen richtest du im Menü *Einrichtung » Mandant » _Mandant wählen: » Standorte » _Standort wählen_ » Dokumente* ein. +
...
.Einstellungen für die Rechnung im Menü *Beleg erstellen*
[cols="1,3"]
|====
...
*Hinweis*: Damit diese Informationen korrekt auf der Rechnung angezeigt werden, müssen sie am entsprechenden Kunden im Menü *CRM » Kontakte* im Bereich *Firma* hinterlegt sein.
