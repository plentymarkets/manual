...
In plentymarkets generierst du Rücksendescheine als PDF-Dateien, um diese z.B. zu drucken oder deinen Kunden als E-Mail Anhang zukommen zu lassen. Somit können deine Kunden Rücksendescheine beispielsweise beim Umtausch von Artikeln oder bei Retouren einfach der Warensendung beilegen.

[#200]
== Dokumentenvorlage für Rücksendescheine einrichten

Bevor du Rücksendescheine generieren kannst, muss eine Dokumentenvorlage eingerichtet werden. Dokumentenvorlagen richtest du im Menü *Einrichtung » Mandant » _Mandant wählen_ » Standorte » _Standort wählen_ » Dokumente* ein. +
...
. Nimm die Einstellungen anhand <<tabelle-ruecksendeschein-erzeugen>> vor. +
...
[[tabelle-ruecksendeschein-erzeugen]]
...
Möchtest du deinen Kunden einen Rücksendeschein zur Verfügung stellen, z.B. wenn diese im Mein-Konto-Bereich des Webshops eine Retoure zu einem bestimmten Auftrag beantragen, erstelle einen Rücksendeschein im dazugehörigen Retourenauftrag.
