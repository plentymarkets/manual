...
:id: S938BDY
:keywords: Rücksendeschein, Rücksendescheine erzeugen, Rücksendung, Retoure, Retourenauftrag, Aufträge, Auftrag, Dokument, Auftragsdokument, PDF, PDF-Datei, PDF-Vorlage, Dokumentenvorlage, Vorlage, Mandant, Standort, Beleg, Nummer, Dokumentennummer, Fulfillment, Dokumenttyp, Dokumententyp, Auftragsabwicklung, Umtausch, Hauptauftrag, Lager, Limit
...
Bevor du Rücksendescheine generieren kannst, muss eine Dokumentenvorlage eingerichtet werden. Dokumentenvorlagen richtest du im Menü **Einrichtung » Mandant » Mandant wählen » Standorte » Standort wählen » Dokumente** ein. +
