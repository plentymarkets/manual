...
:id: JPM7S1A
:keywords: Gelangensbestätigung, Gelangensbestätigungen erzeugen, Lieferland, EU-Land, Wareneingang, Fulfillment, Auftragsdokumente, Auftragsabwicklung, Lieferung, Auslandslieferung, Buchhaltung, steurrechtlich, Dokumentenvorlage, Vorlage, Mandant, Standort, Auftrag, Nummer, Dokumentennummer, Beleg, Dokumententyp, Dokument, PDF, PDF-Vorlage, PDF-Datei
...
Bevor du Gelangensbestätigungen generieren kannst, muss eine Dokumentenvorlage eingerichtet werden. Dies geschieht im Menü *Einrichtung » Mandant » _Mandant wählen_ » Standorte » _Standort wählen_ » Dokumente » Gelangensbestätigung*. +
