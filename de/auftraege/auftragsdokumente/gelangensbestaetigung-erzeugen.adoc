...
:id: JPM7S1A
:keywords: Gelangensbestätigung, Gelangensbestätigungen erzeugen, Lieferland, EU-Land, Warneingang, Fulfillment, Auftragsdokumente, Auftragsabwicklung, Lieferung, Auslandslieferung, Buchhaltung, steurrechtlich, Dokumentenvorlage, Vorlage, Mandant, Standort, Auftrag, Nummer, Dokumentennummer, Beleg, Dokumententyp, Dokument, PDF, PDF-Vorlage, PDF-Datei
:author: team-order-payment

In plentymarkets kannst du Gelangensbestätigungen als PDF-Dateien generieren, um diese z.B. zu drucken oder Ihren Kunden als E-Mail Anhang zukommen zu lassen. +
...
Bevor du Gelangensbestätigungen generieren kannst, muss eine Dokumentenvorlage eingerichtet werden. Dies geschieht im Menü **Einrichtung » Mandant » Mandant wählen » Standorte » Standort wählen » Dokumente**. +
...
. Wähle durch Klick auf die **Auftrag-ID** den Auftrag aus, für den eine Gelangensbestätigung erzeugt werden soll. +
. Wechsle in das Tab **Belege**. +
. Wähle im Drop-Down-Menü **Beleg erstellen** das Dokument **Gelangensbestätigung** aus. +
. Nimm die Einstellungen anhand <<tabelle-auftraege-belege-gelangensbestaetigung>> vor. +
. **Speichere** die Einstellungen, um die Gelangensbestätigung zu erzeugen. +
...
Sollen mehrere Gelangensbestätigungen zugleich erzeugt werden, kannst du über einen Suchfilter im Menü **Aufträge » Fulfillment** festlegen, welche Aufträge berücksichtigt werden. Zudem kannst du in diesem Menü festlegen, ob der Status des Auftrags geändert werden soll, nachdem die Gelangensbestätigungen erzeugt wurden.

[.instruction]
Mehrere Gelangensbestätigungen erzeugen:

. Öffne das Menü **Aufträge » Fulfillment » Gelangensbestätigung erzeugen**.
. Nimm die Einstellungen anhand <<tabelle-einstellungen-fulfillment-gelangensbestaetigung>> vor.
. Klicke auf das **Zahnrad**, um die Gelangensbestätigungen zu erzeugen. +
...
| **Limit**
|Lege fest, wie viele Gelangensbestätigungen maximal pro Durchgang erzeugt werden. Das Maximum liegt bei *200* Gelangensbestätigungen.
...
| **Kommentar**
|Du kannst hier einen Text verfassen, der später auf allen erzeugten Gelangensbestätigungen unterhalb der Artikelpositionen erscheint. Die Eingabe ist optional.
|====
