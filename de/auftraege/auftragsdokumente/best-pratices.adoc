...
Unsere Empfehlung: link:auftraege/auftragsdokumente/assets/sammelpdf.plentyprocess[SammelPDF]

Alternative mit Datumsfilter: link:auftraege/auftragsdokumente/assets/sammelpdf-zeitraum.plentyprocess[SammelPDF_Zeitraum]
