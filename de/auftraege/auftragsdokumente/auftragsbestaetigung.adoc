...
. Wähle das *Ereignis* gemäß <<table-event-procedure-generate-order-confirmation>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
. Nimm die weiteren Einstellungen gemäß <<table-event-procedure-generate-order-confirmation>> vor.
...
→ Das Fenster *Neue Ereignisaktion erstellen* wird geöffnet.
. Gib einen eindeutigen Namen für die Ereignisaktion ein.
. Wähle das *Ereignis* gemäß <<table-event-procedure-send-order-confirmation>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
. Nimm die weiteren Einstellungen gemäß <<table-event-procedure-send-order-confirmation>> vor.
. Aktiviere die Option *Aktiv*.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
--
