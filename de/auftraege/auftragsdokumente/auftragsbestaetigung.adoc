...
Möchtest du die Auftragsbestätigung nach Erzeugung direkt als E-Mail-Anhang an deine Kund:in versenden, empfehlen wir die in <<tabelle-ereignisaktion-auftragsbestaetigung-versenden>> beschriebene Ereignisaktion.
