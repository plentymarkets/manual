...
Bevor du Lieferscheine generieren kannst, muss eine Dokumentenvorlage eingerichtet werden. Dies geschieht im Menü *Einrichtung » Mandant » _Mandant wählen_ » Standorte » _Standort wählen_ » Dokumente » Lieferschein*. +
...
| *Datum*
|DGib das Datum an, das auf dem Lieferschein angezeigt wird. Standardmäßig ist das aktuelle Datum voreingestellt.
