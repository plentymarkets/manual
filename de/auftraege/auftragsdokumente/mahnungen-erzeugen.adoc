...
. Wechsle in das Tab *Belege*. +
. Wähle im Drop-Down-Menü *Beleg erstellen* das Dokument *Mahnungbeleg Storno* aus. +
. Nimm die gewünschten Einstellungen vor und *speichere* (icon:save[role="green"]) die Einstellungen, um den Stornobeleg Mahnung zu erzeugen. +
