...
Der Link *PDF-Pickliste ändern* im Menü Lager-Pickliste führt zu den Einstellungen im Menü *System » Aufträge » Dokumente » <<auftraege/auftragsdokumente/lager-pickliste#, Lager-Pickliste>>*, in dem die Vorlage für das Dokument und die PDF-Vorlage für die Lager-Pickliste konfiguriert werden.
