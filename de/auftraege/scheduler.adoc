...
====
Beachte, dass der Scheduler für den Callisto-Webshop entwickelt wurde. Um mehr über die neue Abofunktion für manuelle Aufträge zu erfahren, gehe zur <<auftraege/abonnement#, Handbuchseite Abonnement>>.
====
