...
*_Wichtig:_* Variable Benutzern stehen nur Mandanten zur Auswahl, für die sie eine Berechtigung haben. Berechtigungen werden unter <<basics/admin-aufgaben/benutzer-verwalten#90, Einrichtung » Einstellungen » Benutzer » Konten » Tab: Berechtigung>> eingestellt.
|====
