...
====
Beachte, dass der Scheduler für den Callisto-Webshop entwickelt wurde. Das Modul ist wird nicht mehr unterstützt und wurde vom neuen Modul Abonnement abgelöst. Um mehr über die neue Abofunktion für manuelle Aufträge zu erfahren, gehe zur <<auftraege/abonnement#, Handbuchseite Abonnement>>.
====
