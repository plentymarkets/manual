...
Wenn du die Palette schließt, sind die Palette, die Pakete und die darin enthaltenen Artikel für die weitere Bearbeitung geschlossen. Diese Aktion kann nicht rückgängig gemacht werden. Beim Klick auf *Palette schließen* erscheint ein Fenster mit einer Sicherheitsabfrage, die du bestätigen musst.

[#700]
=== Palette löschen

Wenn du die Palette löschst, werden die Palette, die Pakete sowie die darin enthaltenen Artikel gelöscht. Beim Klick auf *Palette löschen* (icon:minus-square[role="red"]) erscheint ein Fenster mit einer Sicherheitsabfrage, die du bestätigen musst.
...
Wenn du das Paket schließt, sind das Paket und die darin enthaltenen Artikel für die weitere Bearbeitung geschlossen. Diese Aktion kann nicht rückgängig gemacht werden. Beim Klick auf *Paket schließen* erscheint ein Fenster mit einer Sicherheitsabfrage, die du bestätigen musst.

[#1200]
=== Paket löschen

Wenn du das Paket löschst, werden das Paket sowie die darin enthaltenen Artikel gelöscht. Beim Klick auf *Paket löschen* (icon:minus-square[role="red"]) erscheint ein Fenster mit einer Sicherheitsabfrage, die du bestätigen musst.
