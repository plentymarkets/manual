...
Nutzer vom Typ *Backend* sehen nur bestimmte Bereiche in plentymarkets. Somit können sie nur eingeschränkt im System arbeiten. Sollen Mitarbeiter mit diesem Nutzertyp das Menü *Aufträge » Paketinhaltsliste* bearbeiten, muss ein Nutzer vom Typ *Admin* das im folgenden beschriebene Recht für diese Benutzer vergeben.
