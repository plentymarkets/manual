...
====
Die verfügbaren Funktionen im Menü *Aufträge » Paketinhaltsliste* richten sich in erster Linie an die Mitarbeiter im Lager, die die Ware packen. Da Lagermitarbeiter nicht ständig unmittelbar vor dem Bildschirm sitzen, sondern sich beim Bedienen des Barcodescanenrs und beim Packen der Artikel frei bewegen, haben wir die Buttons und Kacheln in diesem Menü extra großzügig gestaltet.
====
