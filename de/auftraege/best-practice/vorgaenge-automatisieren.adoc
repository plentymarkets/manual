...
Die E-Mail wird an die Adresse des gewählten Mitarbeiters versendet. Damit eine E-Mail-Adresse hier wählbar ist, muss sie im Menü <<arbeiten-mit-plentymarkets/benutzer-verwalten#42., **Einstellungen » Grundeinstellungen » Benutzer » Konten** >> beim Benutzer eingetragen sein. +
...
Die E-Mail wird an die Adresse des gewählten Mitarbeiters versendet. Damit eine E-Mail-Adresse hier wählbar ist, muss sie im Menü <<arbeiten-mit-plentymarkets/benutzer-verwalten#10., **Einstellungen » Grundeinstellungen » Benutzer » Konten** >> beim Benutzer eingetragen sein.
|====
