...
| *Eigner*
|Die Person wählen, die je nach Auftragsherkunft für einen Auftrag automatisch als Eigner eingetragen werden soll. Zur Auswahl stehen die unter *Einrichtung » Einstellungen » Benutzer » Konten* <<business-entscheidungen/benutzerkonten-zugaenge#, berechtigten Personen>>.
