...
image::cms/webdesign/webdesign-bearbeiten/bestellvorgang/assets/DE-CMS-Webdesign-Bearbeiten-Bestellvor-Warenkorb-01.png[]
...
**CK-Editor** = Leistungsfähiger <<cms/webdesign/werkzeuge/editor#, **Editor**  >>, der auch in anderen Bereichen verwendet wird. +
...
image::cms/webdesign/webdesign-bearbeiten/bestellvorgang/assets/DE-CMS-Webdesign-Bearbeiten-Bestellvor-Warenkorb-02.png[]
...
Beachten Sie dazu die Handbuchseite **link::/[Google Analytics]**.
