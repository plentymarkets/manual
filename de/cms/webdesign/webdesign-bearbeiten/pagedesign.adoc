...
Das Template wird automatisch geladen, wenn der Bereich **<<cms/blog-weblog#, Blog  >>** aufgerufen wird.

=== PageDesignForum

Das Template wird automatisch geladen, wenn der Bereich <<mandant-shop/standard/module/forum#, **Forum**  >> aufgerufen wird.
