...
Beachten Sie die folgenden Erläuterungen zu den Handbuchseiten dieses Bereichs sowie die Seite <<cms/webdesign/webdesign-bearbeiten#, **Webdesign bearbeiten**  >>, die weitere Hinweise zur Gestaltung Ihres Onlineshops enthält.
...
Für die Realisierung eines Webdesigns im plentymarkets CMS ist eine eigene Skriptsprache verfügbar. Im Kapitel <<cms-syntax#, **CMS-Syntax**  >> erhalten Sie eine Übersicht aller Möglichkeiten der Gestaltung. Sie finden dort außerdem Erläuterungen zu den **Template-Variablen** und -**Funktionen** sowie zu **Operatoren** und **Kontrollstrukturen**.

== jQuery

jQuery ist eine umfangreiche JavaScript-Klassenbibliothek, die komfortable Funktionen zur Manipulation und Navigation Ihrer Website anbietet. Informationen dazu finden Sie auf der Handbuchseite <<cms/webdesign/syntax/jquery#, **jQuery**  >>.
