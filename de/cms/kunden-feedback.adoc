...
Richten Sie das Modul zunächst im Menü <<mandant-shop/globale-einstellungen/kunden-feedback#, **Einstellungen » Mandant (Shop) » Globale Einstellungen » Kunden-Feedback**  >> ein und aktivieren Sie Bewertungen für die gewünschten Bereiche.
