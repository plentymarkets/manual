...
image::cms/assets/DE-CMS-Blog-01.png[]
...
Die Sprache ist eine Pflichtangabe und muss vor der Kategorie gewählt werden. Die Sprachen, die zur Auswahl stehen, werden im Menü **<<mandant-shop/standard/module/blog-weblog#, Einstellungen » Mandant (Shop) » Standard » Module » Blog  >>** angelegt. Die Blogbeiträge können auch anhand der Sprache gefiltert werden.

|**Kategorie**
|Eine Kategorie für den Blogbeitrag wählen.  +
Die Kategorie ist eine Pflichtangabe. Blogkategorien werden im Menü **<<mandant-shop/standard/module/blog-weblog#, Einstellungen » Mandant (Shop) » Standard » Module » Blog  >>** erstellt. +
...
image::cms/assets/DE-CMS-Blog-02.png[]
...
image::cms/assets/DE-CMS-Blog-03.png[]
...
image::cms/assets/DE-CMS-Blog-04.png[]
...
Sie entscheiden, ob Sie die relative oder die absolute URL verwenden. Eine kurze Erläuterung zu den Typen finden Sie auf der Handbuchseite **<<cms-syntax/fallbeispiele/seo-guide#40., URL-Info >>**.
...
image::cms/assets/DE-CMS-Blog-05.png[]
...
image::cms/assets/DE-CMS-Blog-06.png[]
