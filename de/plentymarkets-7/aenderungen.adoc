...
**Datenaustausch » Dynamischer Export**
...
__Tab. 1: Suchmöglichkeiten nach Varianten__
...
__Tab. 3: Varianteneinstellungen__
...
__Tab. 4: Varianten-Tabs__

== Einheiten

**Einstellungen » Artikel » Einheiten**

* Einheiten werden nun im Menü **Einstellungen » Artikel » Einheiten** definiert.
* Dort können auch weitere, benutzerdefinierte Einheiten erstellt werden.

== Barcodes

**Einstellungen » Artikel » Barcode** +
**Artikel » Artikel bearbeiten » Artikel öffnen » Variante öffnen**
...
* Der Barcode-Typ wird im Menü **Einstellungen » Artikel » Barcode** definiert.
...
* Verkaufspreise werden im Menü **Einstellungen » Artikel » Verkaufspreise** definiert.
...
**Einstellungen » Mandant (Shop) » Standard » Artikelansichten » Grundeinstellungen**
...
**Einstellungen » Artikel » Preiskalkulation** +
**Artikel » Artikel bearbeiten » Artikel öffnen » Variante öffnen » Tab: Einstellungen**
...
|Kundenklassen werden nun im Menü **Einstellungen » Artikel » Verkaufspreise** Verkaufspreisen zugeordnet.

|Optionen **Rabattstaffel auf Standard-Preis** und **Rabattstaffel auf definierte Preisspalte** wurden entfernt.
|Mengenrabatte werden nun im Menü **Einstellungen » Artikel » Verkaufspreise** definiert.

|Tab **Sichtbarkeit** wurde entfernt.
|Preissichtbarkeit für Kundenklassen wird nun im Menü **Einstellungen » Artikel » Verkaufspreise** definiert.
|====

__Tab. 5: Änderungen bei den Kundenklassen__
...
|**Einstellungen » Märkte » Preisportale**
|Dieses Menü wurde entfernt. Preisportale wurden in das Menü **Datenaustausch » Export » Elastischer Export** übertragen. Nach der Migration zu plentymarkets 7 wird die URL der Preisportale erneuert, wodurch die alten URLs nicht mehr funktionieren.

2+|Amazon

|**Einstellungen » Märkte » Amazon » Grundeinstellungen » Zugangsdaten**
|Dieses Menü wurde entfernt. Die dort vorzunehmenden Einstellungen wurden in das Tab **Basiseinstellungen** übertragen.

|**Einstellungen » Märkte » Amazon » Grundeinstellungen » Basiseinstellungen**
...
Die Einstellung **Zuordnung anhand EAN** wurde entfernt. GTIN wurden durch Barcodes ersetzt. Barcodes werden im Menü **Einstellungen » Artikel » Barcode** definiert.

|**Einstellungen » Märkte » Amazon » Grundeinstellungen » Artikeleinstellungen**
|Die Einstellungen **Preis**, **Aktionspreis**, **FBA-Preis** und **FBA-Aktionspreis** wurden entfernt. Preisspalten wurden durch Verkaufspreise ersetzt. Verkaufspreise werden im Menü **Einstellungen » Artikel » Verkaufspreise** definiert.

|**Einstellungen » Märkte » Amazon » Grundeinstellungen » Repricing**
|Dieses Menü wurde entfernt. Der Starsellersworld-Export steht in plentymarkets nicht mehr zur Verfügung. Sie haben aber die Möglichkeit, den Starsellersworld-Export über ein Plugin in plentymarkets zu realisieren.
...
|Die Einstellung **Preisspalte** im Bereich **Grundkonfiguration** und die Einstellungen **EAN** und **ISBN der EAN vorziehen** im Bereich **Erweiterte Optionen** wurden entfernt. Preisspalten wurden durch Verkaufspreise ersetzt. Verkaufspreise werden im Menü **Einstellungen » Artikel » Verkaufspreise** definiert. GTINs wurden durch Barcodes ersetzt. Barcodes werden im Menü **Einstellungen » Artikel » Barcode** definiert.

2+|Cdiscount

|**Einstellungen » Märkte » Cdiscount » Tab: Einstellungen**
|Die Einstellung **Artikel-EAN** wurde entfernt. GTINs wurden durch Barcodes ersetzt. Barcodes werden im Menü **Einstellungen » Artikel » Barcode** definiert.

Die Einstellung **Varianten-EAN** wurde in **Varianten-EAN Barcode** umbenannt.

2+|eBay

|**Einstellungen » Märkte » eBay » Grundeinstellungen » Basiseinstellungen**
...
|**Einstellungen » Märkte » eBay » Grundeinstellungen » Kontoeinstellungen**
|Die Einstellung **Artikelverfügbarkeit** wurde in **Variantenverfügbarkeit** umbenannt.

Die Einstellung **Preisspalte** wurde entfernt. Preisspalten wurden durch Verkaufspreise ersetzt. Verkaufspreise werden im Menü **Einstellungen » Artikel » Verkaufspreise** definiert. +
Beachte in diesem Zusammenhang: Bei Listings mit Varianten wird der Preis für jede Variante aus dem Artikel übernommen. Dabei spielt es keine Rolle, ob der Hacken bei der Option **An Artikelpreis binden** gestezt ist oder nicht.
Achte also darauf, dass die Variantenpreise überall sinvoll gepfelgt sind.

|**Datenaustausch » Datenimport » eBay-Listings**
...
|Die Einstellungen **EAN** und **Preisspalte** wurden entfernt. EAN wurden durch Barcodes ersetzt. Barcodes werden im Menü **Einstellungen » Artikel » Barcode** definiert. Preisspalten wurden durch Verkaufspreise ersetzt. Verkaufspreise werden im Menü **Einstellungen » Artikel » Verkaufspreise** definiert.

2+|Gimahhot

|**Einstellungen » Märkte » Gimahhot**
...
|**Einstellungen » Märkte » Rakuten » Grundeinstellungen**
|Der Artikelexport für Rakuten.de wurde aus den Grundeinstellungen entfernt. Der Artikelexport erfolgt nun über den elastischen Export im Menü **Datenaustausch » Export » Elastischer Export**. Bei erstmaliger Erzeugung des Datenformates **RakutenDE** wird eine neue URL erstellt, die Sie einmalig an Rakuten.de übergeben müssen.
...
__Tab. 6: Änderungen bei den Märkten__

== Live-Shopping

**Einstellungen » Mandant (Shop) » Globale Einstellungen » Live-Shopping**
...
Der plentymarkets Ticketsupport wird ab plentymarkets 7 nicht mehr unterstützt und durch das neue Forum abgelöst. Das Menü **Start » plentymarkets Konto » Service-Ticket** steht daher nicht mehr zur Verfügung. Details dazu finden Sie in unserem link:https://www.plentymarkets.eu/blog/News-Goodbye-Supporttickets-plentymarkets-7-neue-Teams/b-1576/[**Blog**].
...
Beim Wechsel auf plentymarkets 7 und bei der Umstellung auf die Amazon Cloud muss der Code für die Länderabfrage im Klarna Checkout geändert werden. Aktualisieren Sie den <<payment/klarna-checkout#100., **Code für Klarna Checkout** >> in der Kategorie vom Typ **Container**.
...
* Der aktuelle Kundendatensatz, der aus Firmen-, Kunden- und Adressdaten besteht, wird in einzelne Bestandteile aufgeteilt (siehe Kapitel <<plentymarkets-7/aenderungen#10., **Begriffserklärung** >>).
...
image::plentymarkets-7/assets/AccountContactAddress-01-de.png[]
[#10]
=== Begriffserklärung
...
image::plentymarkets-7/assets/AccountContactAddress-04-de.png[]

.Beispiel
image::plentymarkets-7/assets/AccountContactAddress-03-de.png[]
...
.Datenmigration
image::plentymarkets-7/assets/AccountContactAddress-02-de.png[]
...
__Tab. 8: Neue Zuordnung der Felder in der Lieferadresse__
