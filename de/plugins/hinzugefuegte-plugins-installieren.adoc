...
include::_textblocks/chapters/chapter-plugin-set-erstellen.adoc[]

include::_textblocks/chapters/chapter-plugin-in-set-installieren.adoc[]

include::_textblocks/chapters/chapter-plugin-set-live-schalten.adoc[]

include::_textblocks/chapters/chapter-plugin-set-benutzerkonto-verknuepfen.adoc[]
