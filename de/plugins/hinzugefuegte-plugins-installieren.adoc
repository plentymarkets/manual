...
include::_textblocks/chapters/plugin-set-erstellen.adoc[]

include::_textblocks/chapters/plugin-in-set-installieren.adoc[]

include::_textblocks/chapters/plugin-set-live-schalten.adoc[]

include::_textblocks/chapters/plugin-set-benutzerkonto-verknuepfen.adoc[]
