...
include::../instructions/plugin-konfiguration-exportieren.adoc[]

include::../instructions/plugin-konfiguration-importieren.adoc[]

include::../warnings/import-limitierung.adoc[]

include::../tips/batch-plugin-konfiguration.adoc[]