...
. Nutze die Filterfunktion indem du das Kontrollkästchen *Nicht installiert* aktivierst und auf *Suchen* (icon:search[role="blue",stack="arrow-right,tr"]) klickst. Möchtest du Plugins installieren, die du über ein Git-Repository oder einen lokalen Speicher hinzugefügt hast, musst du vor der Suche auch das Kontrollkästchen *Git* beziehungsweise *Lokal* auswählen. +
