...
include::_textblocks/chapters/integrationen-assistent.adoc[]

include::_textblocks/chapters/marketplace-plugins.adoc[]

include::_textblocks/chapters/git-plugins.adoc[]
