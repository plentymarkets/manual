...
include::_textblocks/chapters/chapter-integrationen-assistent.adoc[]

include::_textblocks/chapters/chapter-marketplace-plugins.adoc[]

include::_textblocks/chapters/chapter-git-plugins.adoc[]
