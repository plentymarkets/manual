...
include::_textblocks/_chapters/integrationen-assistent.adoc[]

include::_textblocks/_chapters/marketplace-plugins.adoc[]

include::_textblocks/_chapters/git-plugins.adoc[]
