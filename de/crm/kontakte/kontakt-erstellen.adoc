...
| *Kontakt gesperrt*
| Wähle (icon:check-square[role="blue"]), ob der Kontakt für den eingestellten Mandanten gesperrt sein soll oder nicht.
Wenn die Option aktiviert ist, ist der Kontakt gesperrt und kann sich nicht mehr in deinem plentyShop einloggen. Wenn die Option deaktiviert ist, kann sich der Kontakt in deinem plentyShop einloggen.
