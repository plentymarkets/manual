...
[discrete]
=== Rechte für Ansichten vergeben

Wenn du später eine <<crm/kontakte/kontakt-erstellen#table-functions-new-contact, neue Ansicht zum Erstellen eines neues Kontakts>> einrichtest, kannst du diese Ansichten auch für andere Benutzer:innen in deinem System freigeben. Die Standardansicht ist für alle Benutzer:innen standardmäßig aktiviert. Du hast auch die Möglichkeit, einer Benutzer:in die Rechte für die Standardansicht zu entziehen. Dazu musst du dann zunächst eine benutzerdefinierte Ansicht wählen.

Alle Einstellungen, die sich auf die Ansichten beziehen, nimmst du im Benutzer:innenkonto im Menü *Einrichtung » Einstellungen » Benutzer » Rechte » Benutzer* im Menüpunkt *Ansichten* vor.

* Wenn du Ansichten zum Erstellen eines neuen Kontaktdatensatzes für Benutzer:innen freigeben möchtest: Öffne im Benutzer:innenkonto im Menüpunkt *Ansichten* den Bereich *CRM > Kontakte > * Neuer Kontakt > Eigene Ansichten*.

* Wenn du Ansichten in einem bestehenden Kontaktdatensatz für Benutzer:innen freigeben möchtest: Öffne im Benutzer:innenkonto im Menüpunkt *Ansichten* den Bereich *CRM > Kontaktdetails > Eigene Ansichten*.

Hier kannst du auch die <<crm/kontakte/kontakt-bearbeiten#standardansichten-vorlagen, verfügbaren Vorlagen>> aktivieren bzw. deaktivieren. Öffne dazu im Benutzer:innenkonto im Menüpunkt *Ansichten* den Bereich *CRM > Kontakte > Kontaktdetails > Vorlagen* und wähle (icon:check-square[role="blue"]) die Vorlagen.
