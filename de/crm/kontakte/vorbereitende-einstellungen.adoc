...
Alle Einstellungen, die sich auf die Ansichten beziehen, nimmst du im Benutzer:innenkonto im Menü *Einrichtung » Einstellungen » Benutzer » Rechte » Benutzer* im Menüpunkt *Ansichten* vor. Öffne dort den Bereich *CRM > Kontakte > 
