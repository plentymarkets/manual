...
Sobald du einen Kontakt <<#crm/kontakte/kontakt-erstellen, erstellt>> hast, kannst du weitere Informationen in den verschiedenen Bereichen des Kontaktdatensatzes ergänzen. Beachte auch die <<#gruppenfunktion, Gruppenfunktion>>, über die du einfach und schnell verschiedene Aktionen für mehrere Kontakte gleichzeitig ausführen kannst.
...
<<#table-contact-general>> listet alle verfügbaren Felder auf, die im Bereich *Allgemein* des Kontakts verfügbar sind.

// Beschreibungen in der Tabelle ergänzen
...
| *Typ*
| xxx +
*_Hinweis:_* Dieses Feld war bereits bei der Neuanlage des Kontakts vorausgefüllt. Du kannst den Wert hier natürlich anpassen.
...
Der Ordner *Hauptordner* ist standardmäßig in deinem plentymarkets System vorhanden und kann _nicht_ gelöscht werden. Du kannst jedoch beliebig viele Unterordner auf weiteren Ebenen erstellen. +
...
Klicke auf *Dokumente hochladen* (icon:upload[]), um eine Datei von deinem Computer auszuwälen oder ziehe die Dokumente per Drag-and-drop in den enstprechenden Bereich. Wenn das Dokument erfolgreich hochgeladen wurde, wird in der Übersicht das Symbol des Dateityps, der Name, das Datum und die Uhrzeit der letzten Änderung sowie die Dateigröße angezeigt.
...
Du kannst bereits hochgeladene Dokumente jederzeit herunterladen. Klicke dazu in der Zeile des Dokuments auf icon:more_vert[set=material] und dann auf icon:download[] *Herunterladen*.

// Wenn man auf Herunterladen klickt, öffnet sich kein Dialog und fragt, wo man das Dokument speichern möchte, sondern die Datei wird einfach im Browser geöffnet. Hier ist für die Zukunft noch angedacht, dass es einen weiteren Punkt in dem Kontextmenü gibt: Öffnen / Herunterladen / Löschen. Wenn das entwickelt wurde, muss die Beschreibung noch angepasst werden (neues Unterkapitel: "Dokument öffnen")

[#eigenschaften]
== Eigenschaften

Hier kannst du dem Kontakt Eigenschaften zuweisen. Du siehst hier alle Eigenschaften, die du im Menü *Einrichtung » Einstellungen » Eigenschaften » Konfiguration* für den Bereich *Kontakt* <<crm/kontakte/vorbereitende-einstellungen#eigenschaften-einleitung, bereits erstellt>> hast. 
...
Hier ordnest du dem Kontakt Tags zu. Du kannst nach den Tags später in der Suche <<crm/kontakte/kontakt-suchen#,filtern>>, um alle Kontakte mit diesem Tag schnell wieder zu finden.
...
Hier kannst du das Passwort für deinen Kontakt manuell ändern, einen Link zum Ändern des Passworts an den Kontakt versenden, den Login entsperren und den Mein Konto-Bereich des Kontakts über die Login-URL öffnen.
...
====
Beachte, dass du in diesem Menü lediglich die Passwörter neu generierst. Ein automatischer Versand an deine Kontakte erfolgt allerdings _nicht_. Informiere daher deine Kontakte per E-Mail über die Sachlage und fordere sie auf, ihr Passwort in ihrem Mein Konto-Bereich deines plentyShops zu ändern. Dies machst du am besten über die Gruppenfunktion.

// hier noch auf das Kapitel "Gruppenfunktion" verlinken, sobald es verfügbar ist.
====
...
[#login-entsperren]
=== Login des Kontakts sperren

// Login entsperren geht über den Toggle-Button. Toggle grau = Login nicht aktiviert. Toggle blau = Login aktiviert -> was heißt das genau?
...
// fehlende Beschreibungen in der Tabelle ergänzen
...
// Was trägt man hier ein? 0 und 1 für aktiv und nicht aktiv --> https://knowledge.plentymarkets.com/daten/daten-importieren/sync-typen/elasticSync-kontakte#zuordnungsfeld-optionen-rechnungsadresse-gelangensbestaetigung
...
Hier werden die dem Kontakt zugehörigen Bankdaten angezeigt. Mit einem Klick auf *Neue Bankdaten hinzufügen* (icon:add[set=material]) wirst du in das Menü *CRM » Firmen* in einen neuen Firmendatensatz weitergeleitet. Die Firma, die du dort erstellst, erhält automatisch eine Verknüpfung zu dem Kontakt.

Klicke auf icon:more_vert[set=material], um die Bankdaten zu bearbeiten oder zu löschen.

// hier noch nachtragen, wenn verfügbar. aktuell wird daran gearbeitet, dass man bis zu 50 Adressen scrollbar in diesem Bereich anzeigt. 

[#firma]
== Firma

Hier siehst du die dem Kontakt zugeordnete Firma. Mit einem Klick auf *Neue Firma hinzufügen* (icon:add[set=material]) öffnet sich ein neues Fenster, in dem du weitere Firmen hinzufügen kannst.

// pro Kontakt nur eine Firma
// wenn man über die Kontakt-UI eine neue Firma erstellt, wird die alte Verknüpfung entfernt und die neu erstellte Firma wird dem Kontakt zugewiesen (alte Firmenverknüpfung wird entfernt!)
...
// Text ergänzen --> https://knowledge.plentymarkets.com/crm/kontakte-verwalten#1800 
...
// ist es richtig, dass Mollie hier angezeigt wird? Ist das standardmäßig der Fall?
...
// den Benutzernamen ebay gibt es nicht mehr in der neuen UI. Es gibt aktuell nur noch privat, geschäftlich und Forum.
...
// Text ergänzen --> https://knowledge.plentymarkets.com/crm/kontakte-verwalten#3300
...
// wird hier auch eine Sicherheitsabfrage angezeigt? hier gibt es aktuell noch einen Bug. Der Kontakt lässt sich in der Detailansicht nicht löschen.
...
Mit der Gruppenfunktion wird der Versand einer E-Mail-Vorlage, der Druck von Adressetiketten oder das Hinzufügen des Kontakts zu einem Newsletter-Ordner für einen oder mehrere Kontakte gleichzeitig ausgelöst. In Tabelle <<#table-contact-group-function>> sind die verfügbaren Gruppenfunktionen und deren Erläuterungen aufgelistet.
...
*_Tipp_*: Eine detaillierte <<#schritt-fuer-schritt, Schritt-für-Schritt-Anleitung>> zum Drucken der Adressetiketten über die Gruppenfunktion findest du unterhalb dieser Tabelle.
...
* Entweder über den <<#crm/emailbuilder-testphase, neuen EmailBuilder>> im Menü *CRM » EmailBuilder* 

* oder über die <<crm/e-mails-versenden#1200, Vorlagen im Mandant>> im Menü *Einrichtung » Mandant » [Mandant wählen] » E-Mail » Vorlagen*.

*_Tipp_*: Eine detaillierte <<#schritt-fuer-schritt, Schritt-für-Schritt-Anleitung>> zum Sender der E-Mail-Vorlagen über die Gruppenfunktion findest du unterhalb dieser Tabelle.

| *Zu Newsletter-Ordner hinzufügen*
|Kopiert die E-Mail-Adressen der aktivierten Kontakte in den aus der Dropdown-Liste gewählten <<crm/newsletter-versenden#300, E-Mail-Ordner>> im Menü *Einrichtung » CRM » Newsletter » plentymarkets » E-Mail-Ordner* für den Newsletterversand. +
...
[discrete]
=== Schritt-für-Schritt-Anleitungen für die Gruppenfunktion
...
Adressetikett für mehrere Kontakte drucken::

+
--
Gehe wie im Folgenden beschrieben vor, um für mehrere Kontakte das Adressetikett über die Gruppenfunktion zu drucken.

[.instruction]
Adressetikett für mehrere Kontakte drucken:

. Öffne das Menü *CRM » Kontakte (Testphase)*.
. Suche die Kontakte anhand der Filtereinstellungen. Beachte dazu <<#table-search-contact>> auf der Seite <<#crm/kontakte/kontakt-suchen, Kontakt suchen>>. +
→ Die Kontakte, die den eingestellten Suchkriterien entsprechen, werden angezeigt.
. Wähle (icon:check-square[role="blue"]) die Kontakte, für die du ein Adressetikett drucken möchtest. 
. Klicke in der Symbolleiste oben auf *Adressetikett drucken* (icon:print[set=material]). +
→ Das Fenster *Adressetikett drucken* öffnet sich.
. Wähle das Adressetikett aus der Dropdown-Liste.
. Klicke auf *Ausführen*. +
→ Das Adressetikett der gewählten Kontakte wird gedruckt.
// stimmt das mit dem Drucken oder lade ich die Etiketten erstmal herunter?

// wenn die Gruppenfunktion gemerged ist, Konfig nochmal anhand der UI prüfen.
...
. Klicke in der Symbolleiste oben auf *E-Mail-Vorlage senden*. +
// Wie heißt das Icon? Kann es in dieser Liste (https://fonts.google.com/icons?selected=Material+Icons) nicht finden  
→ Das Fenster *E-Mail-Vorlage senden* öffnet sich.
. Wähle die E-Mail-Vorlage aus der Dropdwon-Liste.
. Klicke auf *Ausführen*. +
...
+
--
Gehe wie im Folgenden beschrieben vor, um die E-Mail-Adressen mehrere Kontakte zu einem Newsletter-Ordner hinzuzufügen.
...
. Klicke in der Symbolleiste auf *Zu Newsletter-Ordner hinzufügen*. +
// Welches Icon soll hierfür verwendet werden?
...
// passiert hier sonst noch etwas? Muss der Kontakt dies über einen Link in der E-Mail bestätigen?
...
. Klicke in der Symbolleiste auf *Zahlungsziel speichern*. +
// Wie heißt das Icon? Kann es in dieser Liste (https://fonts.google.com/icons?selected=Material+Icons) nicht finden  
→ Das Fenster *Zahlungsziel speichern* öffnet sich.
. Gib das Zahlungsziel ein. +
...
Importiere oder aktualisiere die Daten deiner Kontakte inklusive Adressoptionen, Kontaktoptionen und Firmendaten über das Import-Tool. Nutze dazu den Import-Typ <<daten/daten-importieren/sync-typen/elasticSync-kontakte, Kontakte, Firmen und Adressen>>. Weitere Informationen findest du auf der Handbuchseite <<daten/daten-importieren/ElasticSync#, Import-Tool nutzen>>.