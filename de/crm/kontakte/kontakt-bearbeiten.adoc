...
image:crm/assets/kontakte-firma-verknuepfung-erstellen.png[width=640, alt=Verknüfpung zur Firma erstellen]

// TODO: prüfen, ob das Bild korrekt eingerückt ist.
...
Klicke in der Zeile der Firma auf icon:more_vert[set=material] und dann auf icon:delete[set=material] *Verknüpfung zur Firma löschen*, um die Verknüpfung zur Firma zu entfernen.
...
// TODO:der Benutzername eBay ist nicht mehr verfügbar?
