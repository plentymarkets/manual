...
// ergänzen, welche Eigner hier in der Liste angezeigt werden...
...
// worüber macht man das am besten? Über das Automatische Versand-Menü? Oder über die Gruppenfunktion? Manuell ist ja mehr als umständlich?!
...
// sichtbar sind die neuen Passwörer ja nirgends, oder? Kann ich irgendwo sehen, dass die neuen PW generiert worden sind? Oder erscheint hier nur kurz die grüne Erfolgsmeldung oben rechts?
