...
// Screenshot von der Side Nav einfügen, wenn sie final ist.
...
| *Typ*
| Wähle einen Typ. Standardmäßig stehen die Typen *Kunde*, *Handelsvertreter*, *Lieferant*, *Partner*, *Hersteller* und *Interessent* zur Auswahl. <<crm/kontakte/vorbereitende-einstellungen#typen, Eigene Typen>> erstellst du im Menü *Einrichtung » CRM » Typen*. +
...
| *Klasse*
| Wähle eine Klasse. Klassen dienen zur internen Unterscheidung und z.B. ob und welcher <<crm/kontakte/vorbereitende-einstellungen#rabattsystem-nutzen, Rabatt>> dieser Klasse gewährt werden soll. <<crm/kontakte/vorbereitende-einstellungen#kundenklasse, Kundenklassen>> werden im Menü *Einrichtung » CRM » Kundenklassen* erstellt. +
...
// ist es für die Zukunft noch geplant, dass die Suche sich nicht nur auf den gewählten Ordner, sondern auf alle Ordner bezieht?
...
// Bild aktualisieren, wenn das Panel überarbeitet wurde (06.12.)
...
. Klicke in die Zeile des Kontakts, um den Datensatz zu öffnen.
. Klicke auf der linken Seite auf *plentyShop-Login*.
. Aktiviere die Schaltfläche *Login aktiviert*. +
...
Klicke auf icon:more_vert[set=material], um die Bankdaten zu bearbeiten oder zu löschen. Mit einem Klick auf *Neue Bankdaten hinzufügen* (icon:add[set=material]) wirst du in einen neuen Bankdatensatz weitergeleitet und erstellst dort einen neuen Bankdatensatz. Klicke auf icon:more_vert[set=material], um die Bankdaten zu bearbeiten oder zu löschen.
...
// hier wird zukünftig noch die Möglichkeit geschaffen, bestehende Firmen diesem Kontakt zuzuweisen.
...
|[#intable-account-delta]*Gutschriftsbeträge ÷ Rechnungsbeträge*
...
*_Hinweis:_* Stornierte Aufträge sind nicht durch eine der Farben markiert, da kein Zahlungsstatus abgebildet werden muss.
...
|Grenze die Aufträge ein, indem du nach einem bestimmen Auftragstyp suchst.
...
|Nutze diese Filter, um nach Aufträgen in einem bestimmten Auftragsstatus oder einem Statusbereich zu suchen. Setze beide Filter auf den gleichen Status, um nach Vorgängen mit diesem Auftragsstatus zu suchen. Oder gib verschiedene Status ein, um nach Aufträgen in dem ausgewählten Statusbereich zu suchen.
...
// wird hier auch eine Sicherheitsabfrage angezeigt? hier gibt es aktuell noch einen Bug. Der Kontakt lässt sich in der Detailansicht nicht löschen. --> Karte ist auf dem Board
