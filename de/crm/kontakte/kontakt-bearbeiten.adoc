...
.plentyShop-Login
image::crm/assets/kontakte-plentyshop-login.png[width=640, height=360, alt=plentyShop-Login]
...
// todo: icon für "Login entsperren" ergänzen
...
Hier siehst du alle zum Kontakt gespeicherten Optionen. Mit einem Klick auf *Option hinzufügen* (icon:add[set=material]) fügst du weitere Optionen hinzu. Wähle dazu aus den Kontextmenüs und Untermenüs die passende Option. Bereits gewählte Optionen sind ausgegraut und können nicht mehr verwendet werden. Mit einem Klick auf icon:close[set=material] wird die Option direkt gelöscht.
