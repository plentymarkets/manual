...
// prüfen, ob das stimmt mit der Farbe des Kreises.
...
// Mollie wird nun standardmäßig in den Optionen angezeigt?
...
// der Benutzername eBay ist nicht mehr verfügbar?
...
// Muss der Kontakt dies über einen Link in der E-Mail noch bestätigen?
