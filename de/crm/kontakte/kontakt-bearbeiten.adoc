...
Hier werden die dem Kontakt zugehörigen Bankdaten angezeigt. Klicke auf icon:more_vert[set=material], um die Bankdaten zu bearbeiten oder zu löschen. Mit einem Klick auf *Neue Bankdaten hinzufügen* (icon:add[set=material]) wirst du in einen neuen Bankdatensatz weitergeleitet. 

Klicke auf icon:more_vert[set=material], um die Bankdaten zu bearbeiten oder zu löschen.

Insgesamt werden die in diesem Bereich bis zu 50 Bankdatensätze angezeigt.
// durchscrollbar, aber nicht durchsuchbar
