...
<<#image-address-table>> zeigt beispielhaft, dass es sich bei der Adresse um eine Rechnungsadresse (icon:done[set=material]) und die primäre Lieferadresse (icon:grade[set=material] icon:done[set=material]) handelt.
