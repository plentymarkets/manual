...
Nachdem du den Kontakt <<crm/kontakte/kontakt-erstellen#, erstellt>> hast, kannst du über die Ansicht oben rechts eine Vorlage wählen. Drei Ansichten sind standardmäßig in deinem System vorhanden: 
...
| *Typ*
| Wähle einen Typ. Standardmäßig stehen die Typen *Kunde*, *Handelsvertreter*, *Lieferant*, *Partner*, *Hersteller* und *Interessent* zur Auswahl. <<crm/kontakte/vorbereitende-einstellungen#typ-erstellen, Eigene Typen>> erstellst du im Menü *Einrichtung » CRM » Typen*. +
...
| *Klasse*
| Wähle eine Klasse. Klassen dienen zur internen Unterscheidung und z.B. ob und welcher <<crm/kontakte/vorbereitende-einstellungen#rabattsystem-nutzen, Rabatt>> dieser Klasse gewährt werden soll. <<crm/kontakte/vorbereitende-einstellungen#kundenklasse-erstellen, Kundenklassen>> werden im Menü *Einrichtung » CRM » Kundenklassen* erstellt. +
...
image::crm/assets/kontakte-primaere-lieferadresse.png[width=640, height=360, alt=Primäre Lieferadresse (Beispiel)]
...
. Suche den Kontakt anhand der Filtereinstellungen. Beachte dazu <<crm/kontakte/kontakt-suchen#table-search-contact>> auf der Seite <<crm/kontakte/kontakt-suchen#, Kontakt suchen>>. +
...
. Öffne das Menü *CRM » Kontakte (Testphase)*.
. Suche den Kontakt, den du bearbeiten möchtest, anhand der Filtereinstellungen. Beachte dazu <<crm/kontakte/kontakt-suchen#table-search-contact>> auf der Seite <<crm/kontakte/kontakt-suchen#, Kontakt suchen>>. +
→ Die Kontakte, die den eingestellten Suchkriterien entsprechen, werden angezeigt.
. Klicke in die Zeile des Kontakts, um den Datensatz zu öffnen.
...
Mit einem Klick auf *Optionen* (icon:more_vert[set=material]) oben rechts erstellst du einen neuen Auftrag, ein neues Angebot oder ein neues Abonnement. Weitere Informationen zu diesem Kontextmenü findest du auf der Seite <<crm/kontakte/kontakt-suchen#, Kontakt suchen>> im Kapitel <<crm/kontakte/kontakt-suchen#kontextmenue-uebersicht, Kontextmenü in der Übersicht>>.
...
image::crm/assets/kontakte-adresstabelle.png[width=640, height=360, alt=Adresstabelle (Beispiel)]
...
image::crm/assets/kontakte-firma-verknuepfung-erstellen.png[width=640, height=360, alt=Verknüpfung zur Firma erstellen]
...
Weitere Informationen zum Erstellen von Firmendatensätzen findest du auf der Handbuchseite <<crm/firmen#firma-erstellen, Firmen>>.
...
Mit einem Klick auf *Neue Firma hinzufügen* (icon:add[set=material]) öffnet sich ein neues Fenster, in dem du eine Firma hinzufügen kannst. Nachdem du alle Felder in dem <<crm/firmen#firma-erstellen, neuen Firmendatensatz>> ausgefüllt hast und die Einstellungen gespeichert hast, wird der Kontakt der Firma automatisch zugeordnet. +
...
→ Wenn du bereits beim <<crm/kontakte/kontakt-erstellen#, Erstellen>> des Kontaktdatensatzes die private E-Mail-Adresse und die private Telefonnummer des Kontakts eingegeben hast, werden diese Werte hier angezeigt.
...
Im Bereich icon:map-marker[] *Adressen* siehst du alle Adressen, die du im Bereich <<#adressen, Adressen>> für diesen Kontakt geöffnet hast. Außerdem kannst du mit einem Klick auf icon:map-marker[] *Neu* einfach und schnell eine neue Adresse erstellen.

// TODO: wenn alle material icons verfügbar sind: icon:map-marker ersetzen durch icon:place[set=material] 

icon:pay_ec[set=plenty]
...
====
Um über den Kontakt ein Abonnement mit dem neuen Abonnement-Modul zu erstellen, öffne das <<crm/kontakte/kontakt-suchen#kontextmenue-uebersicht, Kontextmenü>> in der Übersicht. +
...
Je nachdem, welchen Statistiktyp du gewählt hast, findest du auf der der Handbuchseite <<business-entscheidungen/plenty-bi/statistiken#, Statistiken verwalten>> weitere Informationen in den folgenden Kapiteln:
...
Im Bereich icon:pay_ec[set=plenty] *Bankdaten* siehst du alle Bankdatensätze, die du im Bereich <<#bankdaten, Bankdaten>> für diesen Kontakt geöffnet hast. Außerdem kannst du mit einem Klick auf icon:credit_card[] *Neu* einfach und schnell einen neuen Bankdatensatz für den Kontakt erstellen.

// TODO: wenn alle material icons verfügbar sind: icon:credit_card[] ersetzen durch icon:credit_card[set=material] 
...
. Öffne das Menü *CRM » Kontakte (Testphase)*.
. Suche die Kontakte anhand der Filtereinstellungen. Beachte dazu <<crm/kontakte/kontakt-suchen#table-search-contact>> auf der Seite <<crm/kontakte/kontakt-suchen#, Kontakt suchen>>. +
→ Die Kontakte, die den eingestellten Suchkriterien entsprechen, werden angezeigt.
...
Weitere Informationen findest du auf der Handbuchseite <<daten/aenderungshistorie#, Änderungen nachvollziehen>> im Kapitel <<daten/aenderungshistorie#1300, CRM-Historie>>.
...
Du kannst eine Liste aller Prüfungsdaten oder der Daten für den aktuellen Monat exportieren. Details zum Export der USt-ID-Prüfungsdaten findest du im Themenbereich <<daten/daten-exportieren#, Daten exportieren>>.
