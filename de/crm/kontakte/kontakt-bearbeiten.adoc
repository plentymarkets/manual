...
Hier kannst du dem Kontakt Eigenschaften zuweisen. Du siehst hier alle Eigenschaften, die du im Menü *Einrichtung » Einstellungen » Eigenschaften » Konfiguration* für den Bereich *Kontakt* <<crm/kontakte/vorbereitende-einstellungen#eigenschaften-erstellen, bereits erstellt>> hast. 
...
// worüber macht man das am besten? Über die Gruppenfunktion!
...
// Vorlage mit den passenden Variablen muss im Automatischen Versand in der Option "Sende Kunde E-Mail zur Passwortänderung" hinterlegt sein.
...
// Login entsperren geht über den Toggle-Button.
// Toggle grau = Login nicht aktiviert
// Toggle blau = Login aktiviert -> was heißt das genau? Malte fragen.
...
// IN 50154 konnte ich bei Kontakt 47601 einen dritten Bankdatensatz speichern, allerdings wird er nicht angezeigt, da dort vorher schon 2 Bankdatensätze vorhanden waren.

[#firma]
== Firma

Im Bereich *Firma* siehst du die dem Kontakt zugeordnete Firma. Mit einem Klick auf *Neue Firma hinzufügen* (icon:add[set=material]) öffnet sich ein neues Fenster, in dem du weitere Firmen hinzufügen kannst.
...
// den Benutzernamen ebay gibt es nicht mehr in der neuen UI! Warum nicht? Es gibt aktuell nur noch privat, geschäftlich und Forum.
...
// wird hier auch eine Sicherheitsabfrage angezeigt? 
