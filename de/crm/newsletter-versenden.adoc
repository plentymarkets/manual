...
:description: Erfahre, wie du Newsletter über plentymarkets an Ihre Kunden versenden.
:position: 40
...
Im Menü *System » Systemeinstellungen » Mandant » Mandant wählen » E-Mail » Newsletter* gibst du die Zugangsdaten ein, um den in plentymarkets integrierten Newsletter-Dienst zu nutzen.

[.instruction]
Newsletter-Zugangsdaten eingeben:

. Öffne das Menü *System » Systemeinstellungen » Mandant » Mandant wählen » E-Mail » Newsletter*.
...
. Öffne das Menü *System » Systemeinstellungen » CRM » Newsletter » plentymarkets » E-Mail-Ordner*.
...
Bestehende E-Mail-Ordner bearbeitest du ebenfalls im Menü *System » Systemeinstellungen » CRM » Newsletter » plentymarkets » E-Mail-Ordner*. Gehe wie im Folgenden beschrieben vor, um die Einstellungen eines E-Mail-Ordners zu bearbeiten.
...
Weitere Informationen findest du auf den Handbuchseiten <<crm/e-mails-versenden#, E-Mails versenden>>, <<omni-channel/online-shop/webshop-einrichten/cms-syntax#grundlagen-template-variablen, Template-Variablen>> und <<omni-channel/online-shop/webshop-einrichten/cms-syntax#grundlagen-template-funktionen, Template-Funktionen>>.
====
...
Wenn du die <<crm/newsletter-versenden#800, Double-Opt-In-Methode>> verwenden möchtest, ist ein weiterer Schritt notwendig. Du musst jeweils eine Vorlage erstellt haben und diese im Menü *System » Systemeinstellungen » Mandant » Mandant wählen » E-Mail » Automatischer Versand* für die Ereignisse *Newsletter Opt-In* und *Bestätigung Newsletter Opt-In* gewählt haben.
...
E-Mail-Adressen für den Versand von Newslettern werden in verschiedenen Ordnern gespeichert. Im Menü *System » Systemeinstellungen » CRM » Newsletter » plentymarkets » E-Mails* verwaltest du die E-Mail-Adressen der verfügbaren Ordner. Falls du noch keine <<crm/newsletter-versenden#300, Ordnerstruktur>> für deine Newsletter angelegt haben, empfiehlt es sich, dies vorab zu tun.
...
. Öffne das Menü *System » Systemeinstellungen » CRM » Newsletter » plentymarkets » E-Mails*.
. Klappe den Ordner auf.
. Klappe den Bereich *Neue E-Mail-Adresse* auf.
...
. Klappe den Bereich *Neuer Newsletter* auf. +
