...
Weitere Informationen findest du auf den Handbuchseiten <<crm/e-mails-versenden#, E-Mails versenden>>, <<webshop/webshop-einrichten/cms-syntax#grundlagen-template-variablen, Template-Variablen>> und <<webshop/webshop-einrichten/cms-syntax#grundlagen-template-funktionen, Template-Funktionen>>.
====
