...
Das Menü *System » Systemeinstellungen » Mandant » Mandant wählen » Dienste » Newsletter2Go (deprecated)* wird im März 2019 aus dem plentymarkets Backend entfernt. Beachten Sie für weitere Informationen den link:https://forum.plentymarkets.com/t/ankuendigung-integrierte-newsletter2go-schnittstelle-laeuft-aus/523797[Changelog^]-Beitrag im plentymarkets Forum.
====
