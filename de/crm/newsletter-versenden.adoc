...
|*Eigner*
|Wenn der Name des Eigners bereits beim Erstellen der E-Mail-Vorlage eingegeben wurde, wird hier der Name des Eigners angezeigt. Diese Einstellung kann geändert werden. +
...
|*Name*
|Wenn der Name der E-Mail-Vorlage bereist beim Erstellen der Vorlage eingegeben wurde, wird hier der Name der E-Mail-Vorlage angzeigt. Der Name kann geändert werden. Der Name wird dem Empfänger nicht angezeigt.
