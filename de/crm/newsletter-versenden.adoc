...
In den vorigen Kapiteln wird beschrieben, wie Sie eine einzelne E-Mail-Adresse verwalten. Wenn Sie viele E-Mail-Adressen auf einmal bearbeiten möchten, ist es sinnvoll, mit dem <<basics/datenaustausch#, *Datenaustausch*>> zu arbeiten. E-Mail-Adressen können Sie importieren oder exportieren. Im Menü <<basics/datenaustausch/daten-exportieren#, *Daten » Export » Dynamischer Export*>> können Sie über das Datenformat <<basics/datenaustausch/datenformate/customernewsletter#, *CustomerNewsletter*>> alle E-Mail-Adressen exportieren. Im Menü <<basics/datenaustausch/daten-importieren#, *Daten » Import » Dynamischer Import*>> können Sie neue E-Mail-Adressen importieren.
