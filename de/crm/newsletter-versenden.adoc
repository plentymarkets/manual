...
Wie du dazu vorgehen musst, ist auf der Handbuchseite <<webshop/shop-builder#_newsletter, ShopBuilder einrichten>> beschrieben. Wirf zudem am besten einen Blick in unser Webinar <<webshop/webshop/webinare/shopbuilder-startseite-aktionsseite#, ShopBuilder - Startseite und Aktionsseite für den Webshop>>. Dort wird ab Minute 22:10 erklärt, wie du das Newsletter-Widget in deinem plentyShop einbindest.
