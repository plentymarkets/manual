...
In den vorigen Kapiteln wird beschrieben, wie Sie eine einzelne E-Mail-Adresse verwalten. Wenn Sie mehrere E-Mail-Adressen gleichzeitig bearbeiten möchten, ist es sinnvoll, mit dem <<daten/daten-importieren/ElasticSync#, ElasticSync>> zu arbeiten. Importieren Sie neue und bearbeiten bestehende E-Mail-Adressen mit dem Sync-Typ <<daten/daten-importieren/sync-typen/elasticSync-newsletter-empfaenger#, Newsletter-Empfänger>>.

Sie können die E-Mail-Adressen auch exportieren. Erstellen Sie dazu im Menü <<daten/daten-exportieren/FormatDesigner#, Daten » FormatDesigner>> zunächst das Exportformat und exportieren Sie die Daten anschließend über den <<daten/daten-exportieren/elastischer-export#, elastischen Export>>.
