...
Im Menü *System » Systemeinstellungen » Mandant* » _Mandant wählen_ » *E-Mail » Newsletter* gibst du die Zugangsdaten ein, um den in plentymarkets integrierten Newsletter-Dienst zu nutzen.

[.instruction]
Newsletter-Zugangsdaten eingeben:

. Öffne das Menü *System » Systemeinstellungen » Mandant* » _Mandant wählen_ » *E-Mail » Newsletter*.
...
.Einstellungen im Menü *System » Systemeinstellungen » Mandant* » _Mandant wählen_ » *E-Mail » Newsletter*
[cols="1,3"]
|====
...
.Neue E-Mail-Vorlage im Menü *System » Systemeinstellungen » Mandant* » _Mandant wählen_ » *E-Mail » Vorlagen* erstellen
[cols="1,3"]
|====
|Einstellung |Erläuterung
