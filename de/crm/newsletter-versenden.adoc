...
E-Mail-Adressen können Sie importieren oder exportieren. Im Menü <<basics/datenaustausch/daten-exportieren#, Daten » Dynamischer Export>> exportieren Sie über das Datenformat <<basics/datenaustausch/datenformate/customernewsletter#, CustomerNewsletter>> alle E-Mail-Adressen. Im Menü <<basics/datenaustausch/daten-importieren#, Daten » Dynamischer Import>> importieren Sie neue E-Mail-Adressen.
