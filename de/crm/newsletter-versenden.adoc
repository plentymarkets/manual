...
. Öffne das Menü *System » Systemeinstellungen » CRM » Newsletter » plentymarkets » E-Mail-Filter*.
...
. Klicke auf *E-Mails in Ordner übertragen*.
...
. Klicke auf *Vorschau*, um die Kundendaten anzuzeigen. +
...
. Öffne das Menü *CRM » Newsletter*.
. Klappe den Newsletter, den du versenden möchtest, auf.
...
. Öffne das Menü *System » Systemeinstellungen » CRM » Newsletter » CleverReach*.
...
. *Speichere* die Einstellungen.
. Klicke auf *Standardattribute generieren*. +
...
. Wechsele zurück in das Menü *System » Systemeinstellungen » CRM » Newsletter » CleverReach* des plentymarkets Backend.
...
. Klicke auf *Standardattribute generieren*. +
→ Datenfelder werden in CleverReach erzeugt, damit die Kundendaten, die du übertragst, gespeichert werden.
. Öffne im CleverReach-Backend die Gruppe, deren ID du in plentymarkets eingegeben haben.
. Lösche die Datenfelder, deren Inhalt du nicht bei CleverReach verwenden möchtest. +
→ Aktuell werden die Datenfelder *Birthday (Geburtstag)*, *Vorname*, *Gender (Anrede)*, *Lang (Sprache)* und *Nachname* von plentymarkets an CleverReach übertragen.
. Wechsele zurück in das Menü *System » Systemeinstellungen » CRM » Newsletter » CleverReach* des plentymarkets Backend.
