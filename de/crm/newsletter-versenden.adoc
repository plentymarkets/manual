...
|*Name*
|Wenn der Name der E-Mail-Vorlage bereist beim Erstellen eingegeben wurde, wird hier der Name der E-Mail-Vorlage angzeigt. Andernfalls Namen eingeben, unter dem diese Vorlage gespeichert werden soll. +
...
|*PDF-Anhang*
|Anhang aus der Dropdwon-Liste wählen. Die Dokumente, die hier aus der Dropdown-Liste gewählt werden können, werden u.a. im Menü *Aufträge » Fulfillment* oder durch versandbezogene Prozesse erzeugt.
...
In den vorigen Kapiteln wird beschrieben, wie Sie eine einzelne E-Mail-Adresse verwalten. Wenn Sie mehrere E-Mail-Adressen gleichzeitig bearbeiten möchten, ist es sinnvoll, mit dem <<basics/datenaustausch#, Datenaustausch>> zu arbeiten. E-Mail-Adressen können Sie importieren oder exportieren. Im Menü <<basics/datenaustausch/daten-exportieren#, Daten » Dynamischer Export>> können Sie über das Datenformat <<basics/datenaustausch/datenformate/customernewsletter#, CustomerNewsletter>> alle E-Mail-Adressen exportieren. Im Menü <<basics/datenaustausch/daten-importieren#, Daten » Dynamischer Import>> können Sie neue E-Mail-Adressen importieren.

[#1400]
=== Kundendaten in einen E-Mail-Ordner kopieren

Im Menü *System » CRM » Newsletter » plentymarkets » E-Mail-Filter* filtern Sie nach Kundendaten und kopieren die E-Mail-Adressen dieser Kunden in bestimmte E-Mail-Ordner. Sie haben z.B. die Möglichkeit, nach Kunden zu suchen, die bestimmte Artikel in einem bestimmten Zeitraum erworben haben. Sie können die Ordner dann für den Newsletter-Versand im Menü <<crm/newsletter-versenden#1000, CRM » Newsletter>> verwenden, um Newsletter an diese Kundengruppen zu senden.
...
→ Aktuell werden die Datenfelder *Birthday (Geburtstag)*, *Vorname*, *Gender (Anrede)*, *Lang (Sprache)* und *Nachname* von plentymarkets an CleverReach übertragen.
. Wechseln Sie zurück in das Menü *System » CRM » Newsletter » CleverReach* des plentymarkets Backend.
. Wählen Sie den Kundentyp aus der Dropdown-Liste *Datenübertragung ausführen*.
. *Speichern* Sie die Einstellungen.
