...
[#1650]
=== Empfänger vom Newsletter abmelden
...
Es ist möglich einen Link hinzuzfügen, der den Empfänger von allen Newsletter-Ordnern abmeldet (siehe Punkt 1) oder einen Link, der den Empfänger von einem bestimmten Newsletter-Ordner abmeldet (siehe Punkt 2):

. *+http://[Name des Online-Shops].plentymarkets-cloud01.com/?OrderShow=CancelNewsletter+* +
Mit diesem Link meldet sich der Empfänger des Newsletter aus allen Newsletter-Ordnern ab.

. *+http://[Name des Online-Shops].plentymarkets-cloud01.com/?OrderShow=CancelNewsletter&folderId=1+* +
Mit diesem Link meldet sich der Newsletter-Empfänger aus einem bestimmten Newsletter-Ordner ab. In diesem Beispiel handelt es sich um den Ordner mit der 1.
