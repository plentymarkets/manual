...
Auf dieser Handbuchseite wird beschrieben, welche Einstellungen Sie vornehmen müssen, um Newsletter mit plentymarkets zu versenden. Versenden Sie Ihre Newsletter z.B. mit dem in plentymarkets <<crm/newsletter-versenden#100, integrierten Newsletter-Dienst>>, über die integrierte Schnittstelle zu <<crm/newsletter-versenden#1700, CleverReach>>, über das link:https://marketplace.plentymarkets.com/plugins/integration/Newsletter2Go_5436[Newsletter2Go^]-Plugin oder weitere im link:https://marketplace.plentymarkets.com/plugins/integration[plentyMarketplaceübe] verfügbare E-Mail-Marketing- und Newsletter-Plugins.
