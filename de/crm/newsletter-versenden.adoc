...
Damit der Empfänger den Newsletter abbestellen kann, musst du den Link zum Abbestellen in die Newsletter-Vorlage einfügen. Es ist möglich einen Link hinzuzfügen, der den Empfänger von allen Newsletter-Ordnern abmeldet oder einen Link, der den Empfänger von einem bestimmten Newsletter-Ordner abmeldet.
...
Mit diesem Link meldet sich der Newsletter-Empfänger aus einem bestimmten Newsletter-Ordner ab; in diesem Fall von dem Ordner mit der 1 ab.
