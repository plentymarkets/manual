...
** *Detailansicht*: Wenn du eine Firma öffnest, werden die Details im Hauptfenster auf der rechten Seite angezeigt. Die Detailansicht einer Firma ist in die Bereiche *Details*, *Verknüpfte Kontakte* und ggf. *Lieferantendetails* unterteilt.
