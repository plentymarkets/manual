...
*_Hinweis:_* In der Standardansicht ist nur der Bereich *Details* sichtbar. Den Bereich *Lieferantendetails* kannst du hier hinzufügen. Außerdem kannst du weitere Felder in den Komponenten per Drag&Drop hinzufügen, Komponenten per Drag-and-drop an einer anderen Stelle positionieren und Komponenten entfernen.
