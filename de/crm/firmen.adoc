...
====
Beachte, dass es aktuell noch nicht möglich ist, im Menü *CRM » Firmen* einer Firma einen oder mehrere Kontakte zuzuweisen. Dies musst du aktuell noch über den Kontaktdatensatz im Menü *CRM » Kontakte* erledigen. In Kürze wird die Möglichkeit zum Verknüpfen von Firma und Kontakt auch im Menü *CRM » Firmen* möglich sein.
====
...
*_Hinweis:_* Im Kontaktdatensatz wird die Verknüpfung zur Firma auch entfernt.
