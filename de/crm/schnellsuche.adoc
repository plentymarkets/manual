...
// Die Stoppuhr oben rechts startet automatisch, sobald der Datensatz geöffnet wird.
Klicke auf *Kostenpflichtig* icon:pay_cash[set=plenty] icon:toggle-off[role="red"], um die Zeit abzurechnen. +
