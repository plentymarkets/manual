...
*_Hinweis:_* Wenn es sich bei dem Datensatz um eine Gastbestellung handelt, ist dieses Feld nicht vorhanden.
...
Im Menü *CRM » Schnellsuche* kannst du mit einem Klick alle zu einem Kontakt oder zu einer Adresse (Gastbestellung) gehörigen Daten als ZIP-Datei herunterladen. Die ZIP-Datei enthält eine HTML-Datei sowie eine maschinenlesbare Datei im JSON-Format.
