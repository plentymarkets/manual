...
In den folgenden Unterkapiteln erfährst du, wie du Header-Vorlagen und Footer-Vorlagen und anschließend eine allgemeine Vorlage erstellst.
// Links einfügen
...
| *Header*
|Header aus der Dropdown-Liste wählen. Die Liste enthält alle Header-Vorlagen, die du bereits erstellt hast.
// verlinken auf Kapitel oben

| *Footer*
|Footer aus der Dropdown-Liste wählen. Die Liste enthält alle Footer-Vorlagen, die du bereits erstellt hast.
// verlinken auf Kapitel oberhalb
