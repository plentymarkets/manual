...
Du kannst beliebig viele Ordner und Unterordner erstellen. Nachdem der Ordner erstellt ist, kannst du über das Kontextmenü (Dreipunkt-Menü) neue Vorlagen und neue Textblöcke erstellen.
// Info ergänzen
...
. Öffne das Menü *CRM » EmailBuilder*.
. Klicke in der Zeile des Ordners bzw. Unterordners, in dem du einen Header erstellen möchtest, auf das Kontextmenü (Dreipunkt-Menü).
. Klicke auf *+ Neue Header-Vorlage*. +
...
. Öffne das Menü *CRM » EmailBuilder*.
. Klicke in der Zeile des Ordners bzw. Unterordners, in dem du einen Footer erstellen möchtest, auf das Kontextmenü (Dreipunkt-Menü).
. Klicke auf *+ Neue Footer-Vorlage*. +
→ Eine weitere Ansicht öffnet sich.
...
// Event-Variablen verfügbar? Prüfen!
* Event-Typ
* Event-Beschreibung
* Event-Dauer
* Event abgerechnet
