...
Du kannst beliebig viele Ordner und Unterordner erstellen. Nachdem der Ordner erstellt ist, kannst du über das Kontextmenü (icon:ellipsis-v[]) neue Unterordner, neue Vorlagen und neue Vorlagen für Header und Footer erstellen und die Ordner umbenennen.
...
[TIP]
Wenn du alle Einstellungen wie im Folgenden beschrieben vorgenommen hast – also Unterordner, Vorlagen, Header und Footer erstellt hast –, kannst du den Hauptordner mit einem Klick auf icon:angle-right[] öffnen. Dort siehst du dann auf einen Blick alle Unterordner, Vorlagen, Header und Footer, die du direkt unter dem Hauptordner erstellt hast.
...
. Öffne das Menü *CRM » EmailBuilder (Vorschau)*.
. Klicke in der Zeile des Ordners, den du umbenennen möchtest, auf das Kontextmenü (icon:ellipsis-v[]). +
→ Ein Fenster wird geöffnet.
. Klicke auf icon:pencil[] *Umbenennen*. +
...
In den folgenden Unterkapiteln erfährst du, wie du Vorlagen für <<#header-erstellen, Header>> und <<#footer-erstellen, Footer>> und anschließend <<#vorlage-erstellen, allgemeine Vorlagen>> erstellst, suchst und bearbeitest. Außerdem erfährst du alles über die verfügbaren Widgets und wie du diese Widgets verwenden kannst.

Die Vorlage bildet gemeinsam mit den Widgets und Variablen den eigentliche Inhalt deiner E-Mail. In einer Vorlage kannst du über die verfügbaren Widgets beliebig viele Variablen per Drag-and-drop einfügen, die dann in der E-Mail an deine Kund:innen durch den korrekten Inhalt ersetzt werden.
...
Erstelle nun die Vorlage. Gehe wie im Folgenden beschrieben vor, um eine Vorlage zu erstellen.
...
| *Bearbeiten*
|Klicke auf icon:pencil[], um den Inhalt der Vorlage zu bearbeiten und Widgets und Variablen zu verwenden. +
...
| *Kontaktadresse*
|Dieses Widget enthält Musterdaten der Kontaktadresse. Das Layout der Adresse richtet sich nach den Einstellungen, die du im Menü *Einrichtung » CRM » Adress-Layout* gespeichert hast.
...
| *Auftragsadresse*
|Dieses Widget enthält Musterdaten der Auftragsadresse. Das Layout der Adresse richtet sich nach den Einstellungen, die du im Menü *Einrichtung » CRM » Adress-Layout* gespeichert hast.
...
| *Artikelliste*
|In diesem Widget kannst du Text eingeben und Variablen verwenden. Beachte, dass in diesem Widget nur die Variablen aus der Kategorie *Auftragspositionen* verwendet werden können.
