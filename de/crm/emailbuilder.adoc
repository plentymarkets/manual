...
Den Header und den Footer verwendest du dann für alle E-Mail-Vorlagen. Header und Footer sind global wirksam; Änderungen, die du am Header und Footer vornimmst, wirken sich demnach auch auf alle bestehenden Vorlagen sowie weitere Vorlagen, die du zukünftig erstellst, aus.
...
Du kannst beliebig viele Ordner und Unterordner erstellen. Nachdem der Ordner erstellt ist, kannst du über das Kontextmenü (icon:ellipsis-v[]) neue Vorlagen und neue Textblöcke erstellen.
// Info ergänzen bzgl. Header- und Footer-Vorlagen
...
. Klicke auf icon:plus[role="green"] *Neuer Basisordner*. +
...
→ Ein Fenster wird geöffnet.
. Klicke auf icon:plus[] *Neuer Ordner*. +
→ Ein Fenster wird geöffnet.
...
// auf Variablen-Kapitel ganz unten verlinken.
...
// 25.03.21: Ist in der UI aktuell noch falsch. Da steht bei der Sicherheitsabfrage "Möchtest du den Ordner mit allen dazugehörigen Unterordnern und Vorlagen wirklich löschen?" Außerdem: Beim Klick auf "Abbrechen" schließt sich das Fenster erst nach mehrmaligem Klicken (4 bis 5 Mal etwa)

[#vorlagen-verwalten]
== Vorlagen verwalten

In den folgenden Unterkapiteln erfährst du, wie du <<#header-erstellen, Header-Vorlagen>> und <<#footer-erstellen, Footer-Vorlagen>> und anschließend <<#vorlage-erstellen, allgemeine Vorlagen>> erstellst.
...
Gehe wie im Folgenden beschrieben vor, um eine Header-Vorlage zu erstellen.
...
. Klicke auf icon:plus[] *Neue Header-Vorlage*. +
...
[#footer-erstellen]
==== Footer-Vorlage erstellen

Gehe wie im Folgenden beschrieben vor, um eine Footer-Vorlage zu erstellen.
...
. Klicke auf icon:plus[] *Neue Footer-Vorlage*. +
→ Eine weitere Ansicht öffnet sich.
...
| *Vorschau*
|Zeigt eine Vorschau der Vorlage an. Du wählst ob du die Vorschau im HTML-Format oder im reinen Text anzeigen lassen möchtest.
...
| *Header*
|Header aus der Dropdown-Liste wählen. Die Liste enthält alle <<#header-erstellen, Header-Vorlagen>>, die du bereits erstellt hast.


| *Footer*
|Footer aus der Dropdown-Liste wählen. Die Liste enthält alle <<#footer-erstellen, Footer-Vorlagen>>, die du bereits erstellt hast.
...
Die folgende Handlungsanweisung beschreibt, wie du allgemein Vorlagen suchst. Die Vorgehensweise ist demnach identisch für die Suche nach Vorlagen, Header-Vorlagen und Footer-Vorlagen.
...
Die folgende Handlungsanleitung beschreibt, wie du allgemein Vorlagen bearbeitest. Die Vorgehensweise ist demnach identisch für das Bearbeiten von Vorlagen, Header-Vorlagen und Footer-Vorlagen.
...
Möchtest du wissen, welche Variablen für die einzelnen Kategorien zur Verfügung stehen? Dann klappe die Bereiche mit einem Klick auf icon:plus-square-o[] einfach auf.
