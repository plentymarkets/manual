...
Du kannst beliebig viele Ordner und Unterordner erstellen. Nachdem der Ordner erstellt ist, kannst du über das Kontextmenü (icon:more_vert[set=material]) neue Unterordner, neue Vorlagen und neue Vorlagen für Header und Footer erstellen und die Ordner umbenennen oder löschen.
...
. Öffne das Menü *CRM » EmailBuilder (Testphase)*.
. Klicke in der Zeile des Ordners, den du umbenennen möchtest, auf das Kontextmenü (icon:more_vert[set=material]). +
...
. Öffne das Menü *CRM » EmailBuilder (Testphase)*.
. Klicke in der Zeile des Ordners, für den du einen Unterordner erstellen möchtest, auf das Kontextmenü (icon:more_vert[set=material]). +
→ Ein Fenster wird geöffnet.
...
. Öffne das Menü *CRM » EmailBuilder (Testphase)*.
. Klicke in der Zeile des Ordners bzw. Unterordners, den du löschen möchtest, auf das Kontextmenü (icon:more_vert[set=material]). +
...
. Öffne das Menü *CRM » EmailBuilder (Testphase)*.
. Klicke in der Zeile des Ordners bzw. Unterordners, in dem du einen Header erstellen möchtest, auf das Kontextmenü (icon:more_vert[set=material]).
...
. Öffne das Menü *CRM » EmailBuilder (Testphase)*.
. Klicke in der Zeile des Ordners bzw. Unterordners, in dem du einen Footer erstellen möchtest, auf das Kontextmenü (icon:more_vert[set=material]).
...
. Öffne das Menü *CRM » EmailBuilder (Testphase)*.
. Klicke in der Zeile des Ordners, in dem du eine Vorlage erstellen möchtest, auf das Kontextmenü (icon:more_vert[set=material]).
...
| *Bearbeiten*
|Klicke auf icon:edit[set=material], um den Inhalt der Vorlage zu bearbeiten und Widgets und Variablen zu verwenden. +
...
// Vorschau noch erwähnen --> icon:preview[set=material]
...
// Icon "angle right" später überall ersetzen durch icon:chevron_right[set=material](muss erst noch eingebunden weren)
...
// Icon "angle-down" später überall ersetzen durch icon:expand_more[set=material] (muss erst noch eingebunden werden)
...
. Klicke in der Zeile der Vorlage, die du löschen möchtest, auf das Kontextmenü (icon:more_vert[set=material]).
. Klicke auf *Löschen*. +
→ Ein Fenster mit einer Sicherheitsabfrage wird geöffnet.
. Klicke auf *Löschen*. +
