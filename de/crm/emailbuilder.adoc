...
|Hier kannst du das CSS-Styling deiner Vorlagen anpassen. Einige gängige Beispiele, wie du das CSS-Styling anpassen kannst, findest du im Kapitel <<#widget-eigenes-styling-beispiele, Beispiele: Eigenes Styling im Widget anpassen>>.
...
Mit einem Klick auf icon:settings[set=material] öffnen sich die Einstellungen. Im Feld *Eigenes Styling* kannst du das CSS-Styling für dieses Widget nach deinen Wünschen anpassen. Einige gängige Beispiele findest du im Kapitel <<#widget-eigenes-styling-beispiele, Beispiele: Eigenes Styling im Widget anpassen>>.
...
Mit einem Klick auf icon:settings[set=material] öffnen sich die Einstellungen. Im Feld *Eigenes Styling* kannst du das CSS-Styling für dieses Widget nach deinen Wünschen anpassen. Einige gängige Beispiele findest du im Kapitel <<#widget-eigenes-styling-beispiele, Beispiele: Eigenes Styling im Widget anpassen>>. Klicke auf *Einstellungen schließen* (icon:times[]), um die Einstellungen zu schließen. Klicke auf *Widget löschen* (icon:delete[set=material]), um das Widget zu entfernen.
...
Im Feld *Eigenes Styling* kannst du das CSS-Styling für dieses Widget nach deinen Wünschen anpassen. Einige gängige Beispiele findest du im Kapitel <<#widget-eigenes-styling-beispiele, Beispiele: Eigenes Styling im Widget anpassen>>. +
Klicke auf *Einstellungen schließen* (icon:times[]), um die Einstellungen zu schließen. Klicke auf *Widget löschen* (icon:delete[set=material]), um das Widget zu entfernen.
...
Weitere Beispiele findest du im Kapitel <<#widget-eigenes-styling-beispiele, Beispiele: Eigenes Styling im Widget anpassen>>.
...
[#widget-eigenes-styling-beispiele]
[discrete]
==== Beispiele: Eigenes Styling im Widget anpassen

In jedem <<#widget-einfuegen, Widget>> im EmailBuilder kannst du das CSS-Styling nach deinen Wünschen anpassen. Im Folgenden findest du einige gängige Beispiele.

[TIP]
Wenn du mehrere CSS-Stylings speichern möchtest, gib alle Werte hintereinander, getrennt durch ein Semikolon ein.
...
Weitere Informationen findest du zum Beispiel auch auf dieser link:https://www.w3schools.com/css/default.asp[Seite^]{nbsp}icon:external-link[].
