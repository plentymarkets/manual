...
Mit der Vorlage erstellst du sozusagen das Gerüst deiner E-Mail, also den Header und den Footer. Der Textblock bildet den eigentlichen Inhalt deiner E-Mail.
...
Der Textblock ist der eigentliche Inhalt deiner E-Mail. Dort kannst du beliebig viele Variablen per Drag-and-drop einfügen.
...
// überlegen, ob Tabellen wirklich sinnvoll sind? Oder einfach nur unordered lists?
...
|Länder-ISO-Code 2, Länder-ISO-Code 3
|
...
|ID des Versanddienstleisters. Wird automatisch vom System vergeben.

|Versandprofil-ID
|ID des Versandprofils. Wird automatisch vom System vergeben.
...
|Verfügbarkeitstext physischen Warenbestand
|
