...
| *Bild*
| In diesem Widget kannst du Bilder wie z.B. dein Firmenlogo hochladen, um dieses in deinen E-Mail-Vorlagen anzuziegen. Mit einem Klick auf icon:settings[set=material] öffnen sich die Einstellungen. Hier kannst du die Breite und die Höhe des Bildes anpassen, das Bild hochladen, einen Alternativ-Text eingeben sowie das Styling im CSS-Format anpassen. 
