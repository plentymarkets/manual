...
Das Code-Beispiel findest du link:https://github.com/plentymarkets/manual/blob/master/de/crm/assets/emailbuilder-code-beispiel-versandprofil.txt[unter diesem Link^]{nbsp}icon:external-link[].
...
Das Code-Beispiel findest du link:https://github.com/plentymarkets/manual/blob/master/de/crm/assets/emailbuilder-code-beispiel-bankdaten.txt[unter diesem Link^]{nbsp}icon:external-link[].
...
Das Code-Beispiel findest du link:https://github.com/plentymarkets/manual/blob/master/de/crm/assets/emailbuilder-code-beispiel-auftragspositionen.txt[unter diesem Link^]{nbsp}icon:external-link[].
