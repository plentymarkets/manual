...
| *Header*
|Wähle einen Header aus der Dropdown-Liste. Die Liste enthält alle <<#header-erstellen, Header>>, die du bereits erstellt hast.


| *Footer*
|Wähle einen Footer aus der Dropdown-Liste. Die Liste enthält alle <<#footer-erstellen, Footer>>, die du bereits erstellt hast.


| *Typ*
|Wähle, in welchem Bereich die E-Mail-Vorlage als Auswahl zur Verfügung stehen soll.
