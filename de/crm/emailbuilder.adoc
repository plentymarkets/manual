...
====
Wenn du später mehrere Vorlagen zur selben Zeit im Editor bearbeitest, kannst du über die Navigation zwischen den einzelnen Vorlagen hin- und herwechseln. Mit einem Klick auf *Konfiguration* gelangst du wieder im Ordnerbaum. Dort ist dann automatisch die Vorlage geöffnet, die du zuletzt geöffnet hattest.
====
