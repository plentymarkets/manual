...
|
| `order.formattedAddresses.deliveryAddress.address3 ~ ' ' ~ order.formattedAddresses.deliveryAddress.address4`
...
|
| `order.formattedAddresses.deliveryAddress.address1 ~ ' ' ~ order.formattedAddresses.deliveryAddress.address2`
