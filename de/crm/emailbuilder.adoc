...
// auch erklären, was passiert, wenn man auf den Stift klickt (nicht nur das Rad mit den Einstellungen)
...
// Vorschau funktioniert noch nicht richtig. Frage: Wo kann ich den Inhalt des Headers konfigurieren?
