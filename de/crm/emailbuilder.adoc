...
|In dieser Dropdown-Liste stehen dir alle Anhänge zur Verfügung, die du vorher im Menü *CMS » Dokumente* hochgeladen hast. Dies sind zum Beispiel Installationsanleitungen oder Produktdatenblätter. Du kannst hier maximal 3 statische Anhänge wählen.

| *Wähle dynamische Anhänge*
|In dieser Dropdown-Liste stehen dir alle <<auftraege/auftragsdokumente#100, standortbezogenen Dokumente>> zur Verfügung, die du im Menü *Einrichtung » Mandant » [Mandant wählen] » Standorte » [Standort wählen] » Dokumente* eingerichtet hast. Du kannst maximal 3 dynamische Anhänge wählen.
