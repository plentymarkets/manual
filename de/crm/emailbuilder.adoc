...
[TIP]
Wenn du alle Einstellungen wie im Folgenden beschrieben vorgenommen hast – also Unterordner, Textblöcke, Vorlagen, Header und Footer erstellt hast -, kannst du den Hauptordner mit einem Klick auf icon:angle-right[] öffnen. Dort siehst du dann auf einen Blick alle erstellten Unterordner, Textblöcke, Vorlagen, Header und Footer.
...
* URL zum Artikel
// in der UI Artikel-Link! Ist hier die URL zum Artikel gemeint? Wenn ja, dann in der UI umbenennen.
...
** Link, den Kund:innen klicken müssen, wenn diese sich für den Newsletter angemeldet haben.
// ist das auch eine URL? Wenn ja, umbenennen in "URL zum Newsletter-Empfang: Zustimmung durch Kontakt"
...
* Bankname
// stimmt die folgende Info? die Variable ist ja auch unter "Kontakt" verfügbar. welche Bankdaten sind hier gemeint? Die des Händlers? ** Wird im *Basics*-Assistenten im Schritt *Bankdaten* gespeichert. Du findest den Assistenten im Menü *Einrichtung » Assistenten » Grundeinstellungen*.
