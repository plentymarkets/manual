...
Wenn du im Code-Widget beispielsweise mit link:https://twig.symfony.com/doc/3.x/tags/if.html[if-Bedingungen^] arbeitest, benötigst du in der if-Bedingung selbst keine doppelt geschweiften Klammern zusätzlich, sondern nur im Fließtext.
