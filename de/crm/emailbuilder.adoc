...
Im Feld *Eigenes Styling* kannst du das CSS-Styling für dieses Widget nach deinen Wünschen anpassen. Einige gängige Beispiele, wie du das CSS-Styling anpassen kannst, findest du im Kapitel <<#widget-eigenes-styling-beispiele, Beispiele: Eigenes Styling im Widget anpassen>>. +
...
Weitere Beispiele für das CSS-Styling findest du im Kapitel <<#widget-eigenes-styling-beispiele, Beispiele: Eigenes Styling im Widget anpassen>>.
