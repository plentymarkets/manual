...
Weitere Informationen finden Sie auf der Handbuchseite <<cms/bilder-galerie#, **Bilder-Galerie**  >>.
...
Eine Übersicht der Template-Variablen und Template-Funktionen für E-Mail-Vorlagen finden Sie außerdem auf der Handbuchseite <<cms-syntax/e-mail/email#, **E-Mail**  >> im Bereich <<cms-syntax#, **CMS-Syntax**  >>. Allgemeine Informationen zu Template-Variablen und Template-Funktionen finden Sie auf der Handbuchseite <<cms-syntax/grundlagen#, **Grundlagen**  >>.
...
Weitere Informationen finden Sie auf der Handbuchseite **<<cms-syntax/grundlagen/if#, if-Konstrukt  >>**.
...
Sie können Gutschein-Codes oder Gutscheine als PDF-Dateien per E-Mail versenden. Details dazu finden Sie auf der Handbuchseite <<auftraege/gutscheine#, **Gutscheine**  >> in den Kapiteln <<auftraege/gutscheine#100, **Gutschein-Codes direkt in E-Mails einfügen** >> und <<auftraege/gutscheine#140, **Gutschein-Vorlage konfigurieren** >>.
