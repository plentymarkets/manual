...
[[bild-verfuegbare-template-variablen-artikelliste-bild1]]
.Verfügbare Template-Variablen für die Artikelliste Bild 1
image::crm/assets/crm-verfuegbare-template-variablen-artikelliste-teil1.png[width=640, height=360]

[[bild-verfuegbare-template-variablen-artikelliste-bild2]]
.Verfügbare Template-Variablen für die Artikelliste Bild 2
