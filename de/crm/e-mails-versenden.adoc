...
Weitere Informationen finden Sie auf der Handbuchseite <<omni-channel/online-shop/cms#bilder-galerie, *Bilder-Galerie*>>.
...
Fügen Sie zunächst die Template-Variablen *$EmailContentHTML* und *$SignatureHTML* in das HTML-Design ein. Anschließend <<crm/e-mails-versenden#1100, *verknüpfen*>> Sie das HTML-Design mit der E-Mail-Vorlage.
...
*Auftrag* = Die E-Mail-Vorlage steht ausschließlich für den gewählten Bereich als Auswahl zur Verfügung. Sie ist in anderen Bereichen nicht sichtbar. Im Menü *Kunden » Ticketsystem* sind die E-Mail-Vorlagen mit dem Template-Typ *Auftrag* deaktiviert, wenn das Ticket nicht mit einem Auftrag verknüpft ist. +
