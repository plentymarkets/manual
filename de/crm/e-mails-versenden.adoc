...
[[video-e-mail-versand-automatisiseren]]
...
|Diese Funktion gibt Daten der Rechnungsadresse aus und steht in E-Mail-Vorlgen des Typs *Auftrag* und *Scheduler* zur Verfügung. +
Als *$field* kann sowohl der Feldname selbst als auch der Alternativwert (Alias) benutzt werden. +
