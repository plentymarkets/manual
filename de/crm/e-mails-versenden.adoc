...
:keywords: Zugangsdaten, HTML-Design, Infodienst, E-Mail-Vorlage, Email-Vorlage, Email, E-Mail, Template-Variable, Template-Variablen, Template-Funktionen, automatische E-Mail, Ereignisaktion
...
Für den Versand von E-Mails müssen im Menü *Einrichtung » Einstellungen » Benutzer » Konten* <<basics/admin-aufgaben/benutzer-verwalten#10, Benutzerdaten>> gespeichert sein. Diese Daten sind von deinem Provider erhältlich und stimmen mit den Daten, die in deinem E-Mail-Programm gespeichert sind, überein.
