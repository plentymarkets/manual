...
Eine Übersicht der Template-Variablen und Template-Funktionen für E-Mail-Vorlagen finden Sie im Kapitel <<crm/e-mails-versenden#4000, Für E-Mail-Vorlagen verfügbare Template-Variablen und Template-Funktionen>>.

[TIP]
.Link zur Auftragsabwicklung in E-Mail-Vorlage einfügen
====
Möglichst in jeder E-Mail an den Kunden sollte der Link zur Auftragsabwicklung enthalten sein, da der Kunde darüber jederzeit den aktuellen Status seines Auftrags einsehen kann. Fügen Sie dazu die Template-Funktion *Link_Checkout()* in die E-Mail-Vorlage ein. Für die korrekte Ausgabe der URL müssen Sie die Template-Funktion folgendermaßen in die E-Mail-Vorlage einfügen: *{%Link_Checkout()%}*.
====
