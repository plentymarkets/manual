...
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#tabelle-e-mail-server-zugangsdaten>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#tabelle-e-mail-infodienst>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#tabelle-e-mail-vorlage>> im Kapitel <<crm/e-mails-versenden#1200, E-Mail-Vorlage erstellen>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
