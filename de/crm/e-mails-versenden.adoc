...
====
Eine Übersicht zur CMS-Syntax, die du noch in den "alten" E-Mail-Vorlagen verwenden kannst, findest du in diesem <<webshop/webshop-einrichten/cms-syntax#, Handbuchbereich>>.
==== 
