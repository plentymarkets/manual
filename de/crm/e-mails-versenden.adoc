...
. Aktiviere im Bereich *Berechtigungen* die Berechtigungen gemäß <<#tabelle-e-mail-benutzerrechte>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.

[[tabelle-e-mail-benutzerrechte]]
.Benutzerrechte für den E-Mail-Bereich vergeben
[cols="1,3"]
|====
|Einstellung |Erläuterung

| *CRM > E-Mail > Automatischen Versand bearbeiten*
|Erlaubt dem Backend-Benutzer, den automatischen E-Mail-Versand zu bearbeiten.

| *CRM > E-Mail > HTML-Design bearbeiten*
|Erlaubt dem Backend-Benutzer, das HTML-Design zu bearbeiten.

| *CRM > E-Mail > Infodienst bearbeiten*
|Erlaubt dem Backend-Benutzer, den Infodienst zu bearbeiten.

| *CRM > E-Mail > Newsletter bearbeiten*
|Erlaubt dem Backend-Benutzer, die Newsletter-Zugangsdaten zu bearbeiten.

| *CRM > E-Mail > Signatur bearbeiten*
|Erlaubt dem Backend-Benutzer, die E-Mail-Signatur zu bearbeiten.

| *CRM > E-Mail > Vorlagen bearbeiten*
|Erlaubt dem Backend-Benutzer, die E-Mail-Vorlagen zu bearbeiten.

| *CRM > E-Mail > Zugangsdaten bearbeiten*
|Erlaubt dem Backend-Benutzer, die E-Mail-Server-Zugangsdaten zu bearbeiten.
...
Weitere Informationen zur Bildergalerie findest du auf der Handbuchseite <<webshop/webshop-einrichten/cms#bilder-galerie#, Alter Webshop:{nbsp}CMS>>.
...
====
plentymarkets empfiehlt die Verwendung von HTML-formatiertem Text, weil der Link zur Auftragsabwicklung sehr lang sein kann. Bei reinen Text-E-Mails kann dies zu Zeilenumbrüchen führen, die möglicherweise den Link beschädigen. Des Weiteren hast du bei der Verwendung von HTML-formatierten Text die Möglichkeit, den Text mit dem integrierten HTML-Editor zu formatieren.
...
​→ Zur Formatierung füge z.B. Tabulatoren, die du aus einem Textprogramm kopiert hast, zwischen den Template-Variablen ein (siehe <<bild-crm-verfuegbare-template-variablen-artikelliste-teil1>> und <<bild-crm-verfuegbare-template-variablen-artikelliste-teil2>>).
. *Speichere* (icon:save[role="green"]) die Einstellungen.

[[bild-crm-verfuegbare-template-variablen-artikelliste-teil1]]
.Verfügbare Template-Variablen für die Artikelliste *ItemListPlain* (Bild 1)
image::crm/assets/crm-verfuegbare-template-variablen-artikelliste-teil1.png[width=640, height=360]

[[bild-crm-verfuegbare-template-variablen-artikelliste-teil2]]
.Verfügbare Template-Variablen für die Artikelliste *ItemListPlain* (Bild 2)
image::crm/assets/crm-verfuegbare-template-variablen-artikelliste-teil2.png[width=640, height=360]
...
Setze in E-Mail-Vorlagen Fallunterscheidungen nach den Prinzipien der if-Abfragen ein. Füge z.B. einen Code ein, der bewirkt, dass die Bankdaten in der E-Mail an den Kunden nur angezeigt werden, wenn die Zahlungsart Vorkasse (ID{nbsp}={nbsp}0) gewählt wurde. Diese if-Abfrage ist im folgenden Beispiel zu sehen.
...
Voraussetzung ist, dass die potenziellen Käufer beim Besuch im Webshop angemeldet und eingeloggt waren, weil andernfalls die E-Mail-Adresse nicht vorliegt und der automatische Versand der E-Mail-Vorlage daher nicht funktionieren kann. +
...
*_Wichtig:_* Im Tab *Media* hochgeladene Dateien können für den Ceres-Webshop nicht genutzt werden. +
Dies ist keine globale Template-Variable, sondern eine Variable, die pro Auftragsposition gesetzt wird. Sie kann nur im Tab *Artikelliste* der E-Mail-Vorlage genutzt werden.
