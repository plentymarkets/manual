...
====
Wenn du Newsletter an deine Kunden versenden möchtest, gibst du die Zugangsdaten im Menü *Einrichtung » Mandant* » _Mandant wählen_ » *E-Mail » Newsletter* ein. Weitere Informationen dazu findest du auf der Handbuchseite <<crm/newsletter-versenden#, Newsletter>> im Kapitel <<crm/newsletter-versenden#200, Newsletter-Zugangsdaten eingeben>>.
====
