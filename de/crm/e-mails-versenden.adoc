...
|Signatur des Systembenutzers, der als Eigner im Kontaktdatensatz gespeichert ist. Diese Template-Variable ist für die Template-Typen *Kunden* und *Auftrag* (sofern der Auftrag einen Kontakt hat) verfügbar.
