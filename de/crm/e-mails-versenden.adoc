...
Erfahre im folgenden Video-Tutorial, wie du dein E-Mail-Konto mit plentymarkets verknüpfst, deine Signatur einstellst und den Infodinest aktivierst:
...
Öffne eine E-Mail-Vorlage im Menü *Einrichtung » Mandant* » _Mandant wählen_ » *E-Mail » Vorlagen*, um eine Liste aller Template-Variablen und Template-Funktionen, die dir für deine E-Mail-Vorlagen zur Verfügung stehen, anzuzeigen.
