...
*_Wichtig:_* Das Zahlungsziel kann im Kundendatensatz nur Firmenkunden, nicht aber Privatpersonen gewährt werden. Es ist jedoch möglich, einen Wert für das Zahlungsziel in der Rechnung im Menü *Mandant (Shop) » Standard Shop » Standorte » Standort wählen » Dokumente » Rechnung* zu speichern.
...
*_Wichtig:_* Valuta kann im Kundendatensatz nur Firmenkunden, nicht aber Privatpersonen gewährt werden. Es ist jedoch möglich, einen Wert für Valuta in der Rechnung im Menü *Mandant (Shop) » Standard Shop » Standorte » Standort wählen » Dokumente » Rechnung* zu speichern.
...
*_Wichtig:_* Skonto kann im Kundendatensatz nur Firmenkunden, nicht aber Privatpersonen gewährt werden. Es ist jedoch möglich, einen Skonto-Wert in der Rechnung im Menü *Mandant (Shop) » Standard Shop » Standorte » Standort wählen » Dokumente » Rechnung* zu speichern.
