...
====
Beim Öffnen des Bereichs *Konto* im Kontaktdatensatz werden dir über der Tabelle die Gesamtsummen für alle Vorgänge angezeigt. Beachte, dass die Beträge sich entsprechend den gewählten <<tabelle-filter-kontodaten,Filtern>> anpassen, solltest du welche gesetzt haben, um nach spezifischen Informationen zu suchen.
====
...
|Auftragstyp, entweder Auftrag oder Gutschrift.
...
====
Damit für Benutzer:innen mit *Backend*-Zugnag die OP-Liste sichtbar ist, musst du die Option aktivieren. Öffne dazu das Benutzerkonto im Menü *Einrichtung » Einstellungen » Benutzer » Rechte » Benutzer* und wähle im Bereich *Menü-Sichtbarkeiten* die Option *CRM > OP-Liste*.
====
