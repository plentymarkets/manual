...
|Wenn du diese beiden Zahlungsarten in der Kundenklasse erlaubt hast, musst du hier keine Einstellungen vornehmen. Denn: Die Einstellungen in der Kundenklasse hat Priorität vor den Einstellungen im Kontaktdatensatz. +
Zahlungsarten Rechnung und/oder Lastschrift für den Kontakt erlauben, auch wenn du diese Zahlungsart ansonsten nicht in deinem Webshop anbietest. +
Häkchen gesetzt = Der Kontakt kann mit dieser Zahlungsart zahlen, selbst wenn du diese Zahlungsart nicht in deinem Webshop anbietest. +
*_Beispiel:_* Ein Kontakt, der bereits mehrfach bei dir bestellt hat, soll auf Rechnung einkaufen können. +
Notwendige Einstellungen: +
. Aktiviere die Zahlungsart im Menü *Einrichtung » Aufträge » Zahlung » Zahlungsarten*. Mit dieser Einstellung wir die Zahlungsart zur Auswahl in einem Auftrag verfügbar. +
*_Wichtig:_* Wähle keine Lieferländer, weil die Zahlungsart ansonsten in deinem Webshop verfügbar ist und dies in diesem Fall nicht gewünscht ist. +
