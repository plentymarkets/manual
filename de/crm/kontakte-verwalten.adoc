...
====
Im Menü *CRM » Schnellsuche* können Sie über einen Klick auf den Button *Alle Daten dieses Kontakts herunterladen* die zu einem Kontakt oder einer Adresse gehörigen Daten herunterladen. Das aktuelle, maschinenlesbares Format ist .json.
====
