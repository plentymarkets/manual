...
Standardmäßig sind *ALLE* Empfänger gewählt.
...
Wenn du die hier eingegebenen Minuten abrechnen möchtest, musst du einen Tag vom Typ *Nachrichten (kostenpflichtig)* wählen und die Schaltfläche icon:icon-pay_cash[set=plenty] icon:toggle-off[role="red"] aktivieren.

|kostenpflichtig
|icon:icon-pay_cash[set=plenty] icon:toggle-off[role="red"]
...
Du kannst jederzeit die Sichtbarkeiten der Nachricht ändern. Das bedeutet, dass du bereits ausgewählte Empfänger entfernen kannst und neue Empfänger hinzufügen kannst, wenn diese die Berechtigung für den Messenger haben.

Das Ändern von Sichtbarkeiten bezieht sich immer auf den gesamten Nachrichtenverlauf. Das bedeutet, wenn du einen Mitarbeiter entfernst, kann dieser keine der Nachrichten mehr sehen. Wenn du einen Mitarbeiter hinzufügst, kann dieser alle Nachrichten im Verlauf sehen.


[#1700]
=== Nachricht löschen

Die Nachrichten im Messenger können jederzeit gelöscht werden, wenn die darin gespeicherten Informationen veraltet sind oder du diese nicht mehr benötigst.
