...
*_Wichtig:_* Variablen Benutzern stehen nur Mandanten zur Auswahl, für die sie eine Berechtigung haben. Berechtigungen werden im Menü *System » Einstellungen » Benutzer » Konten* im Tab <<basics/admin-aufgaben/benutzer-verwalten#90, Berechtigung>> des Benutzerkontos eingestellt.
