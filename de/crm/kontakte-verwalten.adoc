...
image::crm/assets/messenger-neue-nachricht.png[width=640, height=360]
...
|Kontakt-ID
|Mit einem Klick auf icon:user_my_account[set=plenty]+ Kontakt-ID öffnet sich die Detailansicht des Kontakts.
