...
icon:map-signs[] *_Oder:_* Klicke in das Feld und gib die ersten 3 Buchstaben des Tag-Namens ein. Weitere Informationen zu Tags findest du im Kapitel <<crm/kontakte-verwalten#150, Tags erstellen>>.
...
*_Tipp:_* Klicke auf *Eigenschaftsgruppe hinzufügen* (icon:plus-square[role="green"]) rechts in der Zeile, um eine Gruppe zu erstellen. +
...
| *Suchen*
|Klicke ohne gewählte Filtereinstellungen auf *Suchen* (icon:search[role="blue"]), um alle Eigenschaften anzuzeigen. +
icon:map-signs[] *_Oder:_* Grenze die Suchergebnisse durch Filtereinstellungen ein und klicke auf *Suchen* (icon:search[role="blue"]). +
...
Klicke auf *Hinzufügen* (icon:plus-square[role="green"]), um einen Wert zu erstellen.
...
*_Tipp:_* Speichere die Positionsnummern in 10er-Schritten, damit du mögliche neue Eigenschaftsgruppen dazwischen einfügen kannst.
...
Beim Öffnen der OP-Liste wird dir immer eine bereits gefilterte Ansicht gezeigt. Gefiltert wird automatisch nach den Kundentypen *Kunde* und *Gast*. Über den <<crm/kontakte-verwalten#intable-ar-list-filter-customer-type, Filter Kundentyp>> kannst du offene Forderungen für weitere Kundentypen anzeigen lassen.

Klickst du in eine Zeile der Tabelle, wirst du zur <<crm/kontakte-verwalten#1800, Kontoübersicht>> des entsprechenden Kontakts weitergeleitet. Dort werden dir dann die offenen Beträge mit überschrittenem Zahlungsziel für diesen Kontakt angezeigt. Handelt es sich um eine Gastbestellung, wirst du bei Klick in die Zeile zum entsprechenden Auftrag weitergeleitet.
...
|*Aktion*
| Durch Klick auf die Weiterleitung (icon:external-link[]) gelangst du zur Auftragsübersicht im Menü *Aufträge » Aufträge bearbeiten*. Dort wird eine gefilterte Ansicht gezeigt. Dadurch siehst du direkt die unbezahlten und teilbezahlten nicht stornierten Aufträge der entsprechenden Kund:in.
...
|[#intable-ar-list-filter-customer-type]*Kundentyp*
...
Beachte auch die <<crm/kontakte-verwalten#intable-ar-list-default-filter-customer-type, Standardeinstellung>> für diesen Filter.

|*Kundenklasse*
|Suche mit diesem Filter nach offenen Forderungen von bestimmten <<crm/kontakte-verwalten#15, Kundenklassen>>. Wähle dafür aus der Dropdown-Liste eine oder mehrere Kundenklassen aus. Beachte auch die <<crm/kontakte-verwalten#intable-ar-list-default-filter-customer-class, Standardeinstellung>> für diesen Filter.

|*Land*
|Suche mit diesem Filter nach offenen Forderungen gruppiert nach Land. Wähle dafür aus der Dropdown-Liste ein oder mehrere Länder aus.
...
Im Menü *Einrichtung » CRM » Einstellungen* wählst du Standardeinstellungen für die Filter der offenen Posten Tabelle. Beachte dazu die Erläuterungen in <<table-default-settings-filters-ar-list>>.
...
|[#intable-ar-list-default-filter-customer-type]*Filter Kundentyp*
...
|Lege fest, welche Kundenklassen für den Filter *Kundenklasse* in der OP-Liste zur Verfügung stehen sollen. Wählst du für diese Einstellung keine Kundenklassen aus, werden im Filter immer alle zur Auswahl angeboten.
