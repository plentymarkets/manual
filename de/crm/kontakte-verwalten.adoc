...
Wenn Sie einen Datensatz in der Schnellsuche öffnen, sehen Sie in der ersten Zeile des Datensatzes weitere Einstellungsmöglichkeiten, die in Tabelle <<tabelle-einstellungen-schnellsuche>> erläutert werden.
