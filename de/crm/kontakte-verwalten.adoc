...
Eigenschaften sind wiederholt auftretende Informationen und können für die nähere Charakterisierung deiner Kontakte verwendet werden. Du kannst die meisten Eigenschaften auch auf deinen Dokumenten anzeigen.
...
Du kannst auch Eigenschaftsgruppen erstellen, um so einen besseren Überblick zu behalten, wenn du mit vielen Eigenschaften arbeitest. Die folgenden Unterkapitel beschreiben, wie du Eigenschaften <<crm/kontakte-verwalten#960, erstellst>>, <<crm/kontakte-verwalten#970, verknüpfst>>, <<#eigenschaft-suchen, suchst>>, <<#eigenschaft-bearbeiten, bearbeitest>> und <<eigenschaft-loeschen, löschst>> und wie du Eigenschaften <<#eigenschaften-gruppieren, gruppierst>> sowie Eigenschaften <<#eigenschaften-importieren, importierst>> und <<#eigenschaften-exportieren, exportierst>>.
