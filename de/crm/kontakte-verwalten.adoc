...
|*Aktion*
| Durch Klicken auf die Weiterleitung (icon:external-link[]) gelangst du zur Auftragsübersicht im Menü *Aufträge » Aufträge bearbeiten*. Dort wird eine gefilterte Ansicht gezeigt. Dadurch siehst du direkt die unbezahlten und teilbezahlten nicht stornierten Aufträge der entsprechenden Kund:in. +
Diese Spalte ist eine Standardspalte.
