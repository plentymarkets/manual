...
. Aktivieren Sie die Option *Adress-Layout anzeigen*. +
→ *_Tipp:_* Aktivieren Sie ggf. weitere Rechte für das Konto.
...
====
Damit Personen mit dem Zugang *Backend* das Adress-Layout im Menü *System » Systemeinstellungen » CRM » Adress-Layout* auch erstellen, aktualisieren und löschen können, müssen Sie diese Berechtigungen im Benutzerkonto analog aktivieren.
====
...
====
Im Folgenden werden die Berechtigungen, die mindestens aktiviert werden müssen, damit das Menü sichtbar ist, beschrieben. Aktivieren Sie weitere Berechtigungen analog.

Wenn der Benutzer z.B. Firmendatensätze erstellen soll, aktivieren Sie im Bereich *CRM > Firma* die Option *Firma erstellen*.
====
...
*_Wichtig:_* Backend-Benutzern stehen nur Mandanten zur Auswahl, für die sie eine Berechtigung haben. Berechtigungen werden im Menü *System » Systemeinstellungen » Einstellungen » Benutzer » Konten* im Tab <<basics/admin-aufgaben/benutzer-verwalten#90, Berechtigung>> des Benutzerkontos eingestellt.
...
[#1395]
==== Notizen für Backend-Benutzer bearbeitbar machen

Damit Benutzer mit dem Zugang *Backend* Notizen bearbeiten können, muss die REST-Berechtigung im Benutzerkonto aktiviert werden.
...
→  Die gefundenen Konten werden angezeigt. +
*_Tipp:_* Ausgegraute Konten haben Admin-Rechte.
. Klicken Sie auf das Konto, für das Sie die Berechtigung aktivieren möchten. +
→ Die Ansicht *Rechte* wird geöffnet.
. Klappen Sie im Bereich *Berechtigungen* die Option *System > Kommentare* auf.
. Aktivieren Sie die Optionen *Kommentar anzeigen*. +
→ Wenn der Benutzer Notizen erstellen und löschen soll, aktivieren Sie diese Optionen ebenfalls.
. *Speichern* Sie die Einstellungen.
...
. Öffnen Sie das Menü *System » Systemeinstellungen » Einstellungen » Eigenschaften » Gruppen*. +
→ Die Übersicht wird geöffnet.
. Wählen Sie eine Eigenschaftsgruppe. +
...
. Geben Sie die Beschreibung für die Sprache ein.
. *Speichern* Sie die Einstellungen. +
