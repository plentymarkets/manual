...
Du kannst den Tag auch jederzeit mit einem Klick auf das x (icon:times[])im Tag wieder vom Kontakt entfernen.
...
Wenn mehr als eine Notiz des Kontakts geöffnet ist, wird in der Ansicht ein Pfeil angezeigt, über den man zwischen den geöffneten Notizen einfach und schnell hin- und herwechseln kann. Mit einem Klick auf das Kreuz wird die Notiz geschlossen und aus der Liste entfernt.
////
