...
Beim Öffnen der OP-Liste wird dir immer eine bereits gefilterte Ansicht gezeigt. Gefiltert wird automatisch nach den Kundentypen *Kunde* und *Gast*. Über den <<crm/kontakte-verwalten#intable-ar-list-filter-contact-type, Filter Kundentyp>> kannst du offene Forderungen für weitere Kundentypen anzeigen lassen.
...
|*Aktion*
| In dieser Spalte stehen dir verschiedene Aktionen zur Verfügung. Durch Klicken auf icon:external-link[] wirst du zur Auftragsübersicht im Menü *Aufträge » Aufträge bearbeiten* weitergeleitet. Dort wird eine gefilterte Ansicht gezeigt. Dadurch siehst du direkt die unbezahlten und teilbezahlten nicht stornierten Aufträge der entsprechenden Kund:in. +
Durch Klicken auf icon:ticket_message[] wirst du in den Bereich *Messenger* im Kontaktdatensatz des ausgewählten Kontakts weitergeleitet. +
Diese Spalte ist eine Standardspalte.
...
Beachte auch die <<crm/kontakte-verwalten#intable-ar-list-default-filter-contact-type, Standardeinstellung>> für diesen Filter.
...
Im Menü *Einrichtung » CRM » Einstellungen* wählst du Standardeinstellungen für Filter der Tabelle offene Posten. Beachte dazu die Erläuterungen in <<table-default-settings-filters-ar-list>>.
