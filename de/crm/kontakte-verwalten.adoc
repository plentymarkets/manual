...
** der Typ *Kunde* (das ist der Typ mit der höchsten ID im Menü *Einrichtung » CRM » Typen*)
** die Kundenklasse mit der höchsten Position, die du im Menü *Einrichtung » CRM » Kundenklassen* gespeichert hast
