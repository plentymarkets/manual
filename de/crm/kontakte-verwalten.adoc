...
video::VIDEO-ID[https://cdn02.plentymarkets.com/pmsbpnokwu6a/frontend/CRM_Kontaktneuanlage_myView/Screen_Recording_2020-06-18_at_09.22.23.mp4,  width=640, height=360]
...
*_Beachte:_* Die folgende Handlungsanweisung beschreibt die Standardansicht mit den 3 Komponenten Firma, Adressdetails und Kontaktdetails. Je nachdem, wie du dir deine Benutzeroberfläche einrichtest, können die hier beschriebenen Einstellungen von der Ansicht in deinem plentymarkets System abweichen.
