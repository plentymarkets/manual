...
[#12]
=== Alter Webshop: Erstellen von Kontaktdatensätzen bei Gastbestellungen

Im Menü *System » CRM » Einstellungen* legen Sie über die Dropdown-Liste *Gastbestellungen* fest, ob bei Gastbestellungen, die über Ihren alten Webshop (Callisto-Webshop) in Ihr System kommen, Kontaktdatensätze erstellt werden oder nicht.
...
Im Menü *System » CRM » Adress-Layout* können Sie individuell Adress-Layouts für Ihre Lieferländer für das Auftragsdokument *Lieferschein* einrichten. Die Adress-Layouts für die Lieferländer Deutschland, Frankreich und das Vereinigtes Königreich sind bereits standardmäßig in Ihrem plentymarkets System enthalten. Sie können diese 3 Adress-Layouts bearbeiten, wenn Sie über die Rechte verfügen.

[.subhead]
Sichtbarkeit des Adress-Layouts für variable Benutzer einstellen

Damit für Benutzer mit der Benutzerklasse *Variabel* das Menü *System » CRM » Adress-Layout* sichtbar ist, muss das Menü im Benutzerkonto freigeschaltet werden.

[.instruction]
Sichtbarkeit des Adress-Layouts für variable Benutzer einstellen:

. Öffnen Sie das Menü *System » Einstellungen » Benutzer » Konto*.
...
→ Das Menü *System » CRM » Adress-Layout* ist für den variablen Benutzer sichtbar.

[TIP]
.Variable Benutzer: REST-API-Berechtigungen zum Erstellen, Löschen und Aktualisieren von Adress-Layouts
====
Damit variable Benutzer Adress-Layouts im Menü *System » CRM » Adress-Layout* auch erstellen, aktualisieren und löschen können, müssen Sie diese Berechtigungen im Benutzerkonto im Bereich *Berechtigung » REST-API* freigeben.
====

[.instruction]
Adress-Layout für Lieferscheine einrichten:

. Öffnen Sie das Menü *System » CRM » Adress-Layout*.
. Klicken Sie auf *Neu*.
...
→ Die Option darüber *Aufbau der Rechnungs-/ Lieferanschrift* wird ausgeblendet und die Lieferscheine werden in den Adresslayouts im Menü *System » CRM » Adress-Layout* ausgegeben.
. *Speichern* Sie die Einstellung.

Wie Sie Lieferscheine einrichten und erstellen, ist auf der Handbuchseite <<auftragsabwicklung/auftraege/auftragsdokumente/lieferscheine-erzeugen#, Lieferscheine erzeugen>> beschrieben.
...
====
Im Menü *System » Einstellungen » Daten » Bereinigung* können Sie einstellen, nach welcher Zeit ungenutzte Adressen automatisch aus Ihrem plentymarkets System gelöscht werden. Ungenutzte Adressen sind Adressen, die keine Verknüpfung zu einem Kontakt, einem Auftrag, einem POS und einem Lager haben.
