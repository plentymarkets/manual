...
In der Tabelle sind die Aufträge, Gutschriften, Retouren etc. zu diesem Kontakt als Vorgänge aufgeführt. Die Spalten *Zahlungsstatus*, *Ausstehend* und *Zahlungsziel* beziehen sich in der Tabelle jeweils auf den einzelnen Vorgang. Wenn bei einem Auftrag ein Betrag unter *Ausstehend* aufgeführt ist, muss der Kontakt diesen Betrag noch an dich zahlen. Wenn bei einer Gutschrift noch ein Betrag unter *Ausstehend* aufgeführt ist, musst du diesen Betrag noch an den Kontakt zahlen.
