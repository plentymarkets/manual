...
|Mit einem Klick auf icon:envelope-o[role="purple"] kannst du manuell den Newsletter für einen Kunden anmelden. +
...
|Mit einem Klick auf icon:exchange[role="yellow-background"] wird der Gastzugang in einen regulären Kontaktdatensatz umgewandelt. Im neu erstellten Kontaktdatensatz wird dann im Bereich *Historie* der Eintrag *Umgewandelt von* sowie der Benutzername hinzugefügt. +
