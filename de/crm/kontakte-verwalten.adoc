...
Es werden nur Mandanten angezeigt, für die im Menü *System » Mandant » Mandant wählen » Einstellungen* der Name gespeichert wurde.
...
|*Name*
|Name der Firma eingeben. Dies ist ein Pflichtfeld.
...
|*Valuta*
|Zeitraum (ab Rechnungserstellung) eingeben, wenn eine zusätzliche Frist vor dem Zeitraum *Zahlungsziel* gewünscht ist. Dazu die Box *Info: Gestaltung von Zahlungsbedingungen* unterhalb dieser Tabelle beachten. +
...
|*Skontofrist*
|Anzahl der Tage (ab Rechnungserstellung) eingeben, in denen der Kontakt skontiert offene Forderungen bezahlen kann. Dazu die Box *Info: Gestaltung von Zahlungsbedingungen* unterhalb dieser Tabelle beachten. +
...
|*Skontosatz*
|Wert in Prozent eingeben, den der Kontakt bei Einhaltung der *Skontofrist* in Abzug bringen kann. Dazu die Box *Info: Gestaltung von Zahlungsbedingungen* unterhalb dieser Tabelle beachten. +
*_Wichtig:_* Skonto kann nur Firmenkontakten, nicht aber Privatpersonen gewährt werden. Es ist jedoch möglich, einen Skontowert in der Rechnung im Menü *System » Mandant » Mandant wählen » Standorte » Standort wählen » Dokumente » Rechnung* zu speichern.
...
Wenn Sie bereits gespeicherte Firmendaten bearbeiten, werden die Daten des bereits vorhandenen Firmendatensatzes dabei überschrieben.
...
Ein Sammelauftrag bietet die Möglichkeit, nicht bezahlte Aufträge eines Kontakts in einen Auftrag zu übernehmen. Dies ist z.B. sinnvoll, wenn Sie mit Ihrem Kontakt vereinbart haben, dass der Kontakt nicht jede Rechnung einzeln, sondern pro Monat oder pro Quartal bezahlt.
