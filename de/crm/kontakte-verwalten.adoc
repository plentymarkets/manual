...
→ *_Hinweis:_* Manche Browser speichern die Datei automatisch im Download-Ordner Ihres Computer. Bei anderen Browsern laden Sie die Datei selbst mit einem Klick herunter. Folgen Sie in diesem Fall den Anweisungen auf Ihrem Computer. Beachten Sie, dass diese Anweisungen je nach verwendetem Browser und Programm variieren können.
