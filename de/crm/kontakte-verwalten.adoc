...
Über die Änderungshistorie können Sie nachverfolgen, welcher Benutzer in Ihrem System zu welchem Zeitpunkt welche Änderung an einem Kontaktdatensatz vorgenommen hat. Außerdem wird angezeigt, wann Ihr Kunde selbst Änderungen in seinem Mein Konto-Bereich vorgenommen hat.   
...
Kontakt mit Relationen, Nur Kontakt, Adresse, Adresse-zu-Kontakt-Relation, Firma, Firma-zu-Kontakt-Relation, Bank, Kontaktoption, Adressoption.
====
