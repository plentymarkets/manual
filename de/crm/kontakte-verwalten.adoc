...
|*Typ*
|Typ wählen. Standardmäßig können die Typen *Kunde*, *Handelsvertreter*, *Lieferant*, *Partner*, *Hersteller* und *Interessent* gewählt werden. Eigene Typen erstellen Sie im Menü <<crm/kundendaten-verwalten#300, System » CRM » Typen>>.
...
|*Typ*
|Typ, z.B. E-Mail, Telefon oder Webseite, aus der Dropdown-Liste wählen.

|*Subtyp*
|Subtyp, z.B. Geschäftlich oder Privat, aus der Dropdown-Liste wählen.
...
Um bestimmte Kontakte zu suchen, geben Sie die Ihnen bekannten Suchbegriffe in die Filter ein oder wählen Sie die Einstellungen der Dropdown-Listen. Sie können dabei auch mehrere Suchbegriffe gleichzeitig in die Suchfelder eingeben. Dies ermöglicht Ihnen eine schnellere und genauere Suche.
...
*_Wichtig:_* Es werden in der Dropdown-Liste nur Benutzer angezeigt, bei denen im Benutzerkonto im Tab *Eigner* die Option *Kunde* aktiviert ist.
...
*_Wichtig:_* Wenn Sie Ceres nutzen, haben Sie die Möglichkeit, das Erstellen von Kontaktdatensätzen bei Gastbestellungen zu unterbinden. Wählen Sie dazu im Menü *System » CRM » Einstellungen* die Option *Keine Kontakte erstellen* aus der Dropdown-Liste *Gastbestellungen*. Standardmäßig ist die Option *Kontake erstellen* gewählt.
...
|*Typ*
|Typ, z.B. Postnummer oder Umsatzsteuer-Identifikationsnummer, aus der Dropdown-Liste wählen.
