...
Im Menü *System » Systemeinstellungen » CRM* nimmst du vorbereitende Einstellungen wie das Erstellen von Kundenklassen und Typen vor. Im Menü *CRM » Kontakte* erstellst und bearbeitest du die Datensätze deiner Kontakte und verwaltest dort alle Informationen wie z.B. Adressen, Aufträge, Scheduler-Aufträge, Tickets, Notizen, Umsätze, Bankdaten und Dokumente deiner Kontakte.

[#10]
== Vorbereitende Einstellungen vornehmen

Im Menü *System » Systemeinstellungen » CRM* nimmst du vorbereitende Einstellungen wie das Erstellen von <<crm/kontakte-verwalten#15, Kundenklassen>> und <<crm/kontakte-verwalten#20, Typen>> vor. Außerdem richtest du in diesem Menü <<crm/kontakte-verwalten#25, Rabatte>> für deine Kontakte ein.
...
. Klappe im Bereich *Berechtigungen* die Option *CRM > Adress-Layout* auf.
. Aktiviere die Option *Adress-Layout anzeigen*. +
→ *_Tipp:_* Aktiviere ggf. weitere Rechte für das Konto.
...
. Öffne das Menü *System » Systemeinstellungen » CRM » Adress-Layout*.
. Klicke auf *Neu*.
...
. Öffne das Menü *System » Systemeinstellungen » Mandant » Mandant wählen » Standorte » Standort wählen » Dokumente » Lieferschein*.
...
====
Für die Einteilung deines Kundenstamms in Typen und Klassen ist es empfehlenswert, ein Konzept zu entwickeln, bevor du größere Mengen an Kontaktdaten erstellst. Dadurch vermeidest du späteren Änderungsaufwand, z.B. wenn Typen bei fehlender Einstellung automatisch zugewiesen werden. Überlege dir, welche Typen und Klassen du benötigst, erstelle die Typen und Klassen und weisen sie deinen Kontakten zu.
====
...
. Öffne das Menü *System » Systemeinstellungen » CRM » Kundenklassen*.
...
|*Rabattart*
|Rabattart wählen. Je nach Rabattart werden mehr oder weniger Optionen eingeblendet. Wenn Sie keinen Rabatt wünschen, wählen Sie die Option *Kein Rabatt*. Weitere Informationen sowie Erläuterungen zu den Rabattarten in plentymarkets findest du im Kapitel <<crm/kontakte-verwalten#25, Rabattsystem nutzen>>.
...
. Öffne das Menü *System » Systemeinstellungen » CRM » Typen*.
...
. Öffne das Menü *System » Systemeinstellungen » CRM » Typen*.
. Klicke in der Zeile des selbst erstellten Typs auf *Löschen*.
...
. Öffne das Menü *System » Systemeinstellungen » CRM » Kundenklassen*.
. Klappe die Kundenklasse, für die der Rabatt gelten soll, auf.
...
Möchtest du deine Kontakte mit Rabatten belohnen, wenn diese häufig und umsatzsteigernd in Ihrem Webshop einkaufen, kannst du hier Rabattwerte auf den Nettowarenwert des Auftrages festlegen.

[.instruction]
Rabattstaffel auf Nettowarenwert einrichten:

. Öffne das Menü *System » Systemeinstellungen » CRM » Kundenklassen*.
. Klappe die Kundenklasse, für die die Rabattstaffel gelten soll, auf.
...
====
Alternativ zu der Einstellung, die du in diesem Menü vornimmst, ist es möglich, direkt bei einer Zahlungsart einen globalen Rabatt für diese Zahlungsart zu hinterlegen. Ein Beispiel ist ein prozentualer Rabatt bei der Zahlungsart *Vorkasse*. Beachte dazu die Handbuchseite <<payment/zahlungsarten-verwalten#20, Zahlungsarten verwalten>>. Die Einstellung direkt bei der Zahlungsart erlaubt jedoch keine differenzierten Einstellungen wie bei der Option *Rabatt auf Zahlungsart* im Menü *System » Systemeinstellungen » CRM » Kundenklassen*.
====
...
. Öffne im Tab *Übersicht* des Auftrags im unteren Bereich das Tab *Bearbeiten*.
...
. Klicke auf das Konto, für das du die Sichtbarkeit des Menüs und die Berechtigungen aktivieren möchtest. +
→ Die Ansicht *Rechte* wird geöffnet.
. Aktiviere in den Bereichen *Menü-Sichtbarkeiten* und *Berechtigungen* die in <<tabelle-sichtbarkeiten-kontakt-menue>> gelisteten Berechtigungen.
...
Alternativ kannst du in der Kontaktübersicht die Menüs *Neuer Sammelauftrag*, *Neuer Auftrag*, *Aufträge*, *Neues Ticket* und *Neue Notiz* sowie die Funktion *Kontakt löschen* bequem mit einem Rechtsklick aufrufen.
...
. Klick auf *Neuen Kontakt erstellen*.
...
→ *_Hinweis:_* Wenn du die Adresse zu einem späteren Zeitpunkt erstellen möchtest, deaktiviere die Umschaltfläche *Adresse erstellen?*.
...
|*Typ*
|Typ wählen. Standardmäßig stehen die Typen *Kunde*, *Handelsvertreter*, *Lieferant*, *Partner*, *Hersteller* und *Interessent* zur Auswahl. Eigene Typen erstellst du im Menü <<crm/kontakte-verwalten#20, System » Systemeinstellungen » CRM » Typen>>. +
...
2+|*Zugeordnete Tags*
2+|In das Feld klicken, um alle für den Bereich *Kontakte* verfügbaren Tags, die du zuvor im Menü *System » Systemeinstellungen » Einstellungen » Tags* erstellt hast, anzuzeigen. +
*_Oder:_* In das Feld klicken und die ersten 3 Buchstaben des Tag-Namens eingeben. Weitere Informationen zu Tags findest du im Kapitel <<crm/kontakte-verwalten#150, Tags erstellen>>.
...
Zunächst musst du die Tags im Menü *System » Systemeinstellungen » Einstellungen » Tags* erstellen und den Bereich *Kontakte* aktivieren. Wie du Tags erstellst, ist auf der Handbuchseite <<basics/arbeiten-mit-plentymarkets/tags#, Tags>> beschrieben.
...
. Öffne das Menü *CRM » Kontakte*.
. Gib in der Ansicht *Filter* Suchbegriffe in die Suchfelder ein bzw. stelle Filteroptionen in den Dropdown-Listen ein. Beachte dazu die Erläuterungen in <<tabelle-filter-kontakte>>.
. Klicke auf *Suchen*. +
...
. Öffne das Menü *CRM » Kontakte*.
. Wähle in der Ansicht *Filter* einen oder mehrere Tags aus der Dropdown-Liste *Tags*.
. Klicke auf *Suchen*. +
→ Die Kontakte, die den eingestellten Suchkriterien entsprechen, werden angezeigt.
...
Du hast auch die Möglichkeit, alle gespeicherten Daten eines Kontakts inklusive Adressen, Aufträgen, Notizen und Tickets über die Schnellsuche anzuzeigen. Wie du dazu vorgehst, ist im Kapitel <<crm/kontakte-verwalten#1705, Schnellsuche verwenden>> beschrieben.
...
. Klicke in die Zeile des Kontakts. +
→ Die Detailansicht des Kontakts wird geöffnet. +
*_Oder:_* Öffne bestimmte Bereiche des Kontextmenüs wie *Neuer Auftrag* oder *Neue Notiz* mit einem Rechtsklick.
...
*_Wichtig:_* Backend-Benutzern stehen nur Mandanten zur Auswahl, für die sie eine Berechtigung haben. Berechtigungen werden im Menü *System » Systemeinstellungen » Einstellungen » Benutzer » Konten* im Tab <<basics/admin-aufgaben/benutzer-verwalten#90, Berechtigungen>> des Benutzerkontos eingestellt.
...
→ *_Oder:_* Gib den Namen der Firma in das Vorschlagsfeld ein und klicke auf *Speichern*.
...
. Klicke in die Zeile des Kontakts. +
→ Die Detailansicht des Kontakts wird geöffnet.
. Klicke im Bereich *Firma* auf *Bearbeiten*.
...
Suche den Kontakt anhand der <<crm/kontakte-verwalten#200, Filtereinstellungen>>. Öffne den Kontakt durch einen Klick in die Zeile des Kontakts, um dessen Daten, wie z.B. Geburtsdatum, Telefonnummer und E-Mail-Adresse, zu bearbeiten. Erläuterungen zu den Einstellungen und Optionen findest du in <<tabelle-kontakt-erstellen>> im Kapitel <<crm/kontakte-verwalten#100, Kontakt erstellen>>. Kontaktoptionen löschst du mit einem Klick auf *Kontaktoption löschen*.
...
. Klicke in die Zeile des Kontakts. +
→ Die Detailansicht des Kontakts wird geöffnet.
. Klicke im Bereich *Kontaktoptionen* in der Zeile der Zugangsart (Typ: *Zugang*, Subtyp: *Gast*, Wert: *1*) auf *Kontaktoption löschen*.
. *Speichere* die Einstellungen. +
...
. Klicke in die Zeile des Kontakts. +
→ Die Detailansicht des Kontakts wird geöffnet.
. Klicke auf *Kontakt als vCard herunterladen*. +
...
. Öffne das Menü *CRM » Kontakte*.
. Suche den Kontakt bzw. die Kontakte anhand der Filtereinstellungen wie im Kapitel <<crm/kontakte-verwalten#200, Kontakt suchen>> beschrieben. +
→ Die Kontakte, die den eingestellten Suchkriterien entsprechen, werden angezeigt.
...
Aus dem geöffneten Kontakt heraus lassen sich alle dem Kontakt zugehörigen Adressen anzeigen. Neben Informationen wie ID, Firmenname, Vor- und Nachname sowie Adresse und Land siehst du außerdem, um welchen Adresstyp es sich handelt – Rechnungsadresse oder Lieferadresse – und ob die Adresse eine primäre Adresse ist.
...
. Klicke auf *Bearbeiten*, um die Detailansicht der Adresse zu öffnen. +
→ Wenn du die Tabellenansicht gewählt hast, klicke in die Zeile der Adresse, um die Detailansicht zu öffnen.

[#800]
=== Adresse bearbeiten

Du kannst bestehende Adressen sowie Adressoptionen jederzeit bearbeiten. Beachte dazu die Erläuterungen im Kapitel <<crm/kontakte-verwalten#600, Adresse hinzufügen>>. Adressoptionen löschst du mit einem Klick auf *Adressoption löschen*.
...
. Klicke in der Adresskarte, die du bearbeiten möchtest, auf *Bearbeiten*. +
...
. Klicke im Kontextmenü auf der linken Seite auf *Adressen*. +
→ Alle zu dem Kontakt gespeicherten Adressen werden initial als Karten angezeigt. +
. Klicke in der Adresskarte, die du löschen möchtest, auf *Löschen*. +
→ Ein Fenster mit einer Sicherheitsabfrage wird angezeigt.
. Klicke auf *Löschen*. +
...
Weitere Informationen findest du auf der Handbuchseite <<auftraege/scheduler#, Scheduler >>. Dort sind auch die Filteroptionen beschrieben, die du sowohl im Menü *CRM » Kontakte » Kontakt öffnen » Ansicht: Scheduler* als auch im Menü *Aufträge » Scheduler » Scheduler-Aufträge* wählen kannst.
...
Erfahre in den folgenden Unterkapiteln, wie du neue Notizen zu deinem Kontakt erstellst, alle zu einem Kontakt vorhandenen Notizen aufrufst sowie vorhandene Notizen bearbeitest und löschst. Notizen sind nur in deinem plentymarkets Backend sichtbar und können nicht von deinen Kontakten aufgerufen werden.
...
→ Die gefundenen Konten werden angezeigt. +
*_Tipp:_* Ausgegraute Konten haben Admin-Rechte.
. Klicke auf das Konto, für das du die Berechtigung aktivieren möchtest. +
→ Die Ansicht *Rechte* wird geöffnet.
. Klappe im Bereich *Berechtigungen* die Option *System > Kommentare* auf.
. Aktiviere die Optionen *Kommentar anzeigen*. +
→ Wenn der Benutzer Notizen erstellen und löschen soll, aktiviere diese Optionen ebenfalls.
. *Speichere* die Einstellungen.

[#1400]
=== Notiz erstellen

Speichere zu jedem deiner Kontakte beliebig viele Notizen. Notizen sind nur in deinem plentymarkets Backend sichtbar, d.h. Kontakte können die gespeicherten Notizen nicht im Webshop sehen. Jede Notiz erhält nach dem Speichern eine fortlaufende ID. Neue Texte gibst du über die Tastatur ein oder fügst sie über die Zwischenablage ein. Mit den Funktionen in der Symbolleiste formatierst du den Text, fügst Verlinkungen ein und lädst Bilddateien hoch.
...
. *_Oder:_* Klicke in die Zeile des Kontakts. +
→ Die Detailansicht des Kontakts wird geöffnet.
. Klicke im Kontextmenü auf der linken Seite auf *Neue Notiz*. +
→ Das Fenster *Neue Notiz* wird geöffnet.
. Gib den Text ein, füge Text über die Zwischenablage ein und formatiere ggf. den Text mit den Funktionen in der Symbolleiste.
. *Speichere* die Einstellungen. +
...
Du kannst einzelne Notizen mit einem Klick auf *Vorschau öffnen* anzeigen. Wenn mehr als eine Notiz des Kontakts geöffnet ist, wird in der Ansicht ein Pfeil angezeigt, über den man zwischen den geöffneten Notizen einfach und schnell hin- und herwechseln kann. Mit einem Klick auf das Kreuz wird die Notiz geschlossen und aus der Liste entfernt.
...
. Klicke im Kontextmenü auf der linken Seite auf *Notizen*. +
→ Alle zu dem Kontakt gespeicherten Notizen werden angezeigt.
. Klicke in der Notiz, die Sie bearbeiten möchten, auf *Bearbeiten*.
...
Die Notizen deiner Kontakte können jederzeit gelöscht werden, wenn die darin gespeicherten Informationen veraltet sind oder du diese nicht mehr benötigst.
...
. Klicke im Kontextmenü auf der linken Seite auf *Notizen*. +
→ Alle zu dem Kontakt gespeicherten Notizen werden angezeigt.
. Klicke in der Notiz, die du löschen möchtest, auf *Löschen*. +
→ Ein Fenster mit einer Sicherheitsabfrage wird angezeigt.
. Klicke auf *Löschen*. +
→ Die Notiz wird gelöscht und aus der Übersicht entfernt.

Du kannst die Notiz auch löschen, wenn die Vorschau geöffnet ist. Dazu klickst du in der geöffneten Notiz auf *Löschen*. In diesem Fall wird ebenfalls eine Sicherheitsabfrage, die du mit *Löschen* bestätigen musst, angezeigt.
...
. Klicke auf *Öffnen*, um die Dateien hochzuladen oder ziehe Dokumente per Drag-and-Drop-Funktion in das Tab.
...
. Klicke im Kontextmenü auf der linken Seite auf *Dokumente*. +
→ Alle zu dem Kontakt gespeicherten Dokumente werden angezeigt.
. Klicke in der Zeile des Dokuments, das du herunterladen möchtest, auf *Datei herunterladen*. +
...
→ Die Detailansicht des Kontakts wird geöffnet.
. Klicke im Kontextmenü auf der linken Seite auf *Dokumente*.
. Klicke in der Zeile des Dokuments, das du löschen möchtest, auf *Löschen*. +
→ Ein Fenster mit einer Sicherheitsabfrage wird angezeigt. +
. Klicke auf *Löschen*. +
...
→ Die Detailansicht des Kontakts wird geöffnet.
. Klicke im Kontextmenü auf der linken Seite auf *Bankdaten*.
. Klicke im Bankdatensatz, den du bearbeiten möchtest, auf *Bearbeiten*. +
...
→ Die Detailansicht des Kontakts wird geöffnet.
. Klicke im Kontextmenü auf der linken Seite auf *Bankdaten*.
. Klicke im Bankdatensatz, den du löschen möchtest, auf *Löschen*. +
→ Ein Fenster mit einer Sicherheitsabfrage wird angezeigt.
. Klicke auf *Löschen*. +
