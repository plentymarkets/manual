...
[.subhead]
Sichtbarkeit des Adress-Layouts für variable Benutzer einstellen

Damit für Benutzer mit der Benutzerklasse *Variabel* das Menü *System » Systemeinstellungen » CRM » Adress-Layout* sichtbar ist, muss das Menü im Benutzerkonto freigeschaltet werden.

[.instruction]
Sichtbarkeit des Adress-Layouts für variable Benutzer einstellen:

. Öffnen Sie das Menü *System » Systemeinstellungen » Einstellungen » Benutzer » Konto*.
...
. Klappen Sie den Bereich *Einstellungen » CRM* auf.
. Ativieren Sie die Option *Adress-Layout*.
. *Speichern* Sie die Einstellungen. +
→ Das Menü *System » Systemeinstellungen » CRM » Adress-Layout* ist für den variablen Benutzer sichtbar.

[TIP]
.Variable Benutzer: REST-API-Berechtigungen zum Erstellen, Löschen und Aktualisieren von Adress-Layouts
====
Damit variable Benutzer Adress-Layouts im Menü *System » Systemeinstellungen » CRM » Adress-Layout* auch erstellen, aktualisieren und löschen können, müssen Sie diese Berechtigungen im Benutzerkonto im Bereich *Berechtigung » REST-API* freigeben.
====
...
|Toggle-Button aktivieren, wenn dieses Layout als Standard-Layout verwendet werden soll. In der Übersicht auf der linken Seite ist das Standard-Adress-Layout mit einem Sternchen gekennzeichnet.
