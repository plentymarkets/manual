...
|Zeigt anhand von Farben an, wie der Zahlungsstatus des Vorgangs ist. +
...
|Das Zahlungsziel des Auftrags. Damit es hier angezeigt werden kann, muss es in den <<auftraege/auftraege-verwalten#intable-zahlungsbedingungen-auftrag, Zahlungsbedingungen>> am Auftrag hinterlegt sein. +
Diese Spalte ist eine Standardspalte.
