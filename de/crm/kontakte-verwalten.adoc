...
Wenn mehr als eine Ansicht des Kontakts geöffnet ist, wird in der Ansicht oben ein Pfeil angezeigt, über den du zwischen den geöffneten Kontakten einfach und schnell hin- und herwechseln kann. Mit einem Klick auf icon:times[] wird der Kontakt geschlossen und aus der Liste entfernt.
...
. Klicke in die Zeile des Kontakts. +
→ Die Detailansicht des Kontakts wird geöffnet. +
*_Oder:_* Öffne bestimmte Bereiche des Kontextmenüs wie *Neuer Auftrag* oder *Messenger* mit einem Rechtsklick.
...
*_Oder:_* Die Suchergebnisse durch Filtereinstellungen eingrenzen und auf *Suchen* (icon:search[role="blue"]) klicken. +
...
. Klicke in die Zeile des Kontakts. +
→ Die Detailansicht des Kontakts wird geöffnet. +
*_Oder:_* Öffne bestimmte Bereiche des Kontextmenüs wie *Neuer Auftrag* oder *Messenger* mit einem Rechtsklick auf Aktionen (icon:bars[]).
...
====
Nach dem Speichern der primären Rechnungsadresse und der primären Lieferadresse werden diese Adressen direkt beim Öffnen des Kontaktdatensatzes auf der rechten Seite im Bereich *Adressen* angezeigt. Mit einem Klick auf *Bearbeiten* öffnet sich die Adressansicht und die Adresse kann bearbeitet werden. +
...
*Oder:_* Ziehe Dokumente per Drag-and-Drop-Funktion in das Tab.
...
→ Die Detailansicht des Kontakts wird geöffnet.
. Klicke im Kontextmenü auf der linken Seite auf *Bankdaten*.
. Klicke im Bankdatensatz, den du bearbeiten möchtest, auf *Bearbeiten* (icon:pencil[]). +
...
. Öffne das Menü *System » Systemeinstellungen » Einstellungen » Eigenschaften » Konfiguration*.
. Gib in der Ansicht *Filter* Suchbegriffe in die Suchfelder ein bzw. stelle Filteroptionen in den Dropdown-Listen ein. Beachte dazu die Erläuterungen in <<tabelle-filter-eigenschaften>>.
. Klicke auf *Suchen* (icon:search[role="blue"]). +
