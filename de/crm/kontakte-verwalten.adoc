...
--
Wenn du in der Übersicht im Menü *CRM » Kontakte* auf einen Kontaktdatensatz klickst, um den Kontakt anzuzeigen oder zu bearbeiten, öffnet sich die Detailansicht des Kontakts. Über das Kontextmenü im linken Bereich des Kontakts können Bereiche wie *Adressen* oder *Neue Adresse* aufgerufen werden.
...
Wenn du in der Detailansicht des Kontakts z.B. auf *Adressen* klickst, werden alle zu dem Kontakt gespeicherten Adressen initial als Karten angezeigt. Mit einem Klick auf *Zur Tabellenansicht wechseln* werden die Adressen in Tabellenform angezeigt. Aus dieser Ansicht wechselst du zurück mit einem Klick auf *Zur Kartenansicht wechseln*. Dein plentymarkets System merkt sich, welche der beiden Ansichten du gewählt hast und zeigt beim nächsten Öffnen des Kontextmenüs *Adressen* die zuletzt gewählte Ansicht an.

Wenn mehr als ein Bereich im Kontaktdatensatz geöffnet ist, wird in der Ansicht oben ein Pfeil angezeigt, über den du zwischen den geöffneten Kontakten einfach und schnell hin- und herwechseln kann. Mit einem Klick auf icon:times[] wird der Kontakt geschlossen und aus der Liste entfernt.

Über den Bereich *Übersicht* gelangst du zurück in die Übersicht der gefundenen Kontakte. Aus dieser Ansicht heraus kannst du  beliebig viele weitere Kontakte aufrufen. Wenn mehr als ein Kontakt geöffnet ist, wird in der Ansicht des gerade geöffneten Kontakts ein Pfeil angezeigt, über den du die Kontakte, die bereits einmal geöffnet waren, einfach und schnell aufrufen kannst. Mit einem Klick auf icon:times[] wird der Kontakt geschlossen und aus der Liste entfernt.
...
|Klicke auf *Rechnungsadresse*, um diese Option zu wählen. +
Mit einem Klicke auf *Rechnungsadresstyp hinzufügen* wird der Typ *Rechnungsadresse* zu der Adresse hinzugefügt. Die ID ändert sich nicht. +
...
|Klicke auf *Rechnungsadresse*, um diese Option zu wählen. +
Mit einem Klicke auf *Rechnungsadresstyp löschen* wird der Typ *Rechnungsadresse* in der Adresse gelöscht. +
...
|Klicke auf *Rechnungsadresse*, um diese Option zu wählen. +
Mit einem Klicke auf *Als primäre Rechnungsadresse definieren* wird  die aktuell gewählte Rechnungsadresse als primäre Rechnungsadresse gesetzt. Die ID ändert sich nicht. +
