...
|*CRM > Adresse > Adresstyp > Adresstyp anzeigen*
|Erlaubt dem Backend-Benutzer, Adresstypen zu sehen.

|*CRM > Eigenschaft > Eigenschaft bearbeiten*
|Erlaubt dem Backend-Benutzer, Eigenschaften zu bearbeiten.

|*System > Tag > Tag anzeigen*
|Erlaubt dem Backend-Benutzer, Tags zu sehen.

|*System > Tag > Tag-Verknüpfung > Tag-Verknüpfung anzeigen*
|Erlaubt dem Backend-Benutzer, Tag-Verknüpfung zu sehen.
...
Weitere Informationen zur Datenbereinigung findest du auf der Handbuchseite <<basics/arbeiten-mit-plentymarkets/datenbereinigung#, Datenbereinigung durchführen>>.
====
...
. Öffne das Menü *CRM » Kontakte*.
. Suche (icon:search[]) den Kontakt bzw. die Kontakte anhand der Filtereinstellungen wie im Kapitel <<crm/kontakte-verwalten#200, Kontakt suchen>> beschrieben. +
→ Die Kontakte, die den eingestellten Suchkriterien entsprechen, werden angezeigt.
...
|*System > Eigenschaft > Eigenschaft anzeigen*
|Erlaubt dem Backend-Benutzer, Eigenschaften zu sehen.

|*System > Eigenschaft > Eigenschaft erstellen*
...
Mit einem Klick auf *Neuer Auftrag* (icon:plus-square[role="green"]) erstellst du einen neuen Auftrag im Menü *Aufträge » Aufträge bearbeiten*. +
...
Mit einem Klick auf *Neues Ticket* (icon:plus-square[role="green"]) erstellst du ein neues Ticket im Menü *CRM » Ticketsystem*. +
*_Hinweis:_* Wenn es sich bei dem Datensatz um einen Gastzugang handelt, sind diese Felder ausgegraut.

|*Messenger*
|Mit einem Klick auf *Messenger* öffnet sich der Bereich *Messenger*. +
Mit einem Klick auf *Neue Nachricht* (icon:plus-square[role="green"]) erstellst du eine neue Nachricht. +
*_Hinweis:_* Wenn es sich bei dem Datensatz um einen Gastzugang handelt, sind diese Felder ausgegraut.

|*Alle Daten dieses Kontakts herunterladen*
|Mit einem Klick auf icon:download[role="purple"] werden alle gespeicherten Daten zu diesem Datensatz heruntergeladen. Weitere Informationen findest du im Kapitel <<crm/kontakte-verwalten#1706, Alle Daten zu einem Kontakt herunterladen>>.
...
|Mit einem Klick auf icon:user-secret[] wird der Datensatz anonymisiert. Das Anonymisieren der Daten ist nur bei einem Kontaktdatensatz möglich, nicht bei einem Gastzugang. Weitere Informationen findest du im Kapitel <<crm/kontakte-verwalten#1707, Datensatz anonymisieren>>.
...
Exportiere die Daten deiner Kontakte über das Menü *Daten » Elastischer Export*. Voraussetzung dafür ist, dass du die Plugins link:https://marketplace.plentymarkets.com/plugins/integration/ElasticSync_4750[ElasticSync^] und link:https://marketplace.plentymarkets.com/plugins/markets/ElasticExport_4763[Elastischer Export^] installierst und bereitstellst. Beide Plugins sind im link:https://marketplace.plentymarkets.com/[plentyMarketplace^] verfügbar. +
*_Hinweis:_* Das ElasticSync-Plugin ist zwar nicht für den Export zuständig, sondern für den Import bzw. das Aktualisieren von Daten, es enthält allerdings die Funktion *FormatDesigner*, die du für das Erstellen von Exportformaten benötigst.
