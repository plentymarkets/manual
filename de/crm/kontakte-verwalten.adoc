...
Du hast die Möglichkeit, einzelne Kontakte zu löschen. Ein Kontakt kann nur gelöscht werden, wenn dieser nicht mit einem Auftrag oder einem Ticket verknüpft ist.
