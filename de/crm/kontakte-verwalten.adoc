...
====
Im Menü *CRM » Schnellsuche* können Sie über einen Klick auf den Button *Alle Daten dieses Kontakts herunterladen* die zu einem Kontakt oder einer Adresse gehörigen Daten herunterladen.

Weitere Informationen, welche Daten heruntergeladen werden, finden Sie in diesem link:https://forum.plentymarkets.com/t/dsgvo-button-fuer-den-datenexport-zu-einem-kunden-integriert/486915[Changelog^]-Beitrag. Dieser Changelog-Beitrag wird regelmäßig aktualisiert.
====
