...
*_Tipp:_* Es ist möglich, weitere Reihen hinzuzufügen, einzelne Felder zu entfernen und komplette Reihen zu entfernen. Auch leere Reihen sind erlaubt. Eine Beschränkung der Felder pro Reihe ist nicht vorhanden.
