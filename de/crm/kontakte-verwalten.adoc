...
* Eingabefelder innerhalb einer Komponente können direkt nebeneinander positioniert werden, z.B. PLZ und Ort
...
[[video-neuer-Kontakt]]
.Benutzeroberfläche zum Erstellen eines neuen Kontakts
video::https://cdn02.plentymarkets.com/pmsbpnokwu6a/frontend/CRM_Kontaktneuanlage_myView/Screen_Recording_2020-06-18_at_09.22.23.mp4[width=640, height=360]
...
. Nimm die Einstellungen in den Bereichen *Adressdetails* und *Kontaktdetails* vor. Beachte dazu auch die Erläuterungen in <<#tabelle-kontakt-bearbeiten>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen. +
...
Klicke dazu oben rechts auf *Ansicht bearbeiten* (icon:design_inline_edit[set=plenty]).
...
Du kannst den Bearbeitungsmodus jederzeit mit einem Klick auf icon:times[] verlassen. Wenn du die Änderungen nicht gespeichert hast, erscheint eine Sicherheitsabfrage, dass alle nicht gespeicherten Änderungen verloren gehen.

Mit einem Klick auf icon:save[] speicherst du die Ansicht unter einem Namen. Auf diese Weise kannst du beliebig viele Ansichten nach deinen Wünschen speichern. Wenn du das nächste Mal manuell einen Kontaktdatensatz erstellen möchtest, kannst du die von dir bevorzugte Ansicht über die Dropdown-Liste *Standardansicht* oben rechts öffnen und mit dem Erstellen eines neuen Kontakts beginnen.
...
. Nimm die Einstellungen vor. Beachte dazu die Erläuterungen in <<#tabelle-kontakt-bearbeiten>> im Bereich *Firma*.
. *Speichere* (icon:save[role="green"]) die Einstellungen. +
...
. Nimm die Änderungen vor. Beachte dazu die Erläuterungen in <<#tabelle-kontakt-bearbeiten>> im Bereich *Firma*.
. *Speichere* (icon:save[role="green"]) die Einstellungen. +
...
. Nimm die Änderungen vor. Beachte dazu die Erläuterungen in <<#tabelle-kontakt-bearbeiten>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
<<#tabelle-typen-subtypen-kontaktoptionen>> listet alle verfügbaren Typen sowie Subtypen in den Kontaktoptionen auf, die sowohl in den Kontaktdetails beim Erstellen eines neuen Kontakts als auch in einem bereits erstellten Kontaktdatensatz hinzugefügt werden können.
...
| *Telefon*
a|
- *Privat* (kann bereits beim <<crm/kontakte-verwalten#100, Erstellen eines neuen Kontakts>> hinzugefügt werden) +
- *Geschäftlich* (kann bereits beim <<crm/kontakte-verwalten#100, Erstellen eines neuen Kontakts>> hinzugefügt werden) +
- *Mobil Privat* +
- *Mobil Arbeit*
...
- *Privat* +
- *Geschäftlich* +
- *eBay* (kann bereits beim <<crm/kontakte-verwalten#100, Erstellen eines neuen Kontakts>> hinzugefügt werden) +
- *Forum*
...
| *Zugang*
a|
- *Gast* (kann bereits beim <<crm/kontakte-verwalten#100, Erstellen eines neuen Kontakts>> hinzugefügt werden) +
- *Marketplace Partner*
...
. Nimm die Einstellungen vor. Beachte die Informationen auf der Handbuchseite <<crm/ticketsystem-nutzen#1600, Ticketsystem>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
* <<business-entscheidungen/business-intelligence/statistiken#20, Umsatz Herkunft Auftrag>>
