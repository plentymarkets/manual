...
→ Die Ansicht *Rechte* wird geöffnet.
. Klappe im Bereich *Berechtigungen* die Option *Kommentare* auf.
. Aktiviere die Option *Kommentar anzeigen*. +
...
. Klicke im Kontextmenü auf der linken Seite auf *Events*. +
→ Die Liste der Events wird angezeigt.
. Klicke in der Zeile des Events, das du löschen möchtest, auf *Löschen*. +
→ Ein Fenster mit einer Sicherheitsabfrage wird angezeigt.
. Klicke auf *Löschen*. +
...
→ Die Detailansicht des Kontakts wird geöffnet.
. Klicke im Kontextmenü auf der linken Seite auf *Zugangsdaten*.
. Klicke im Bereich *Login-URL* auf *Link öffnen* oder kopiere die Login-URL mit einem Klick auf *In Zwischenablage kopieren* und füge den Link in den Browser ein. +
...
. Öffne das Menü *System » Systemeinstellungen » Einstellungen » Eigenschaften » Konfiguration*.
. Klicke auf *Suchen*, um alle Eigenschaften anzuzeigen oder wähle Filter, um die Ergebnisse einzugrenzen.
...
Verwende die Schnellsuche, um alle Informationen eines Kontakts oder eines Gastkontos auf einen Blick zu erhalten. Dazu gehören neben der Rechnungsadresse, den Stammdaten und allgemeinen Informationen wie z.B. Typ, offene Forderungen und dem Datum des letzten Auftrags auch die Aufträge, weitere Adressen, Events, Notizen und Tickets.
...
. Klicke in die Zeile *Notizen*, um die Notizen anzuzeigen.
...
Mit einem Klick auf *Neue Notiz* erstellst du eine neue Notiz. +
*_Hinweis:_* Wenn es sich bei dem Datensatz um einen Gastzugang handelt, sind diese Felder ausgegraut.
...
. Klicke auf *Suchen*, um die gefilterten Ergebnisse anzuzeigen.
...
. Klicke auf *Suchen*, um die aktualisierte Liste anzuzeigen.
