...
. Beachten Sie dazu die Erläuterungen zur Historie in <<tabelle-historie-kontakt>>.
...
. Beachten Sie dazu die Erläuterungen in <<tabelle-kontostand-kontakt>>.
...
. Wählen Sie den Statistiktyp aus der Dropdown-Liste.
. *Speichern* Sie die Einstellungen. +
→ Die Daten werden geladen und angezeigt.

Je nachdem, welchen Statistiktyp Sie gewählt haben, finden Sie weitere Informationen in den folgenden Kapiteln der Handbuchseite <<basics/arbeiten-mit-plentymarkets/statistik/statistiken-verwalten#, Statistiken verwalten>>:
...
Allgemeine Informationen, wie Sie z.B. Statistiken bearbeiten, finden Sie auf der Handbuchseite <<basics/arbeiten-mit-plentymarkets/statistik/statistiken-verwalten#, Statistiken verwalten>>.
...
. Nehmen Sie die weiteren Einstellungen vor. Beachten Sie dazu die Erläuterungen in <<tabelle-eigenschaft-erstellen>>.
. *Speichern* Sie die Einstellungen. +
...
. Bearbeiten Sie die Einstellungen. Beachten Sie dazu die Erläuterungen in <<tabelle-eigenschaft-bearbeiten>>.
. *Speichern* Sie die Einstellungen.
...
. Öffnen Sie das Menü *System » Systemeinstellungen » Einstellungen » Eigenschaften » Konfiguration*.
. Geben Sie in der Ansicht *Filter* Suchbegriffe in die Suchfelder ein bzw. stellen Sie Filteroptionen in den Dropdown-Listen ein. Beachten Sie dazu die Erläuterungen in <<tabelle-filter-eigenschaften>>.
. Klicken Sie auf *Suchen*. +
...
. Nehmen Sie die Einstellungen vor. Beachten Sie dazu die Erläuterungen in <<tabelle-eigenschaftsgruppe-erstellen>>.
. *Speichern* Sie die Einstellungen. +
...
Die Liste der offenen Posten wird einmal täglich automatisch aktualisiert. Zwischendurch können Sie die Liste wie im Folgenden beschrieben manuell aktualisieren:
