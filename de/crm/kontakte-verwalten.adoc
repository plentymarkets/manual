...
|Gib ggf. eine externe Nummer für den Kontakt ein. Externe Nummer können für eine eigene interne Zuordnung genutzt werden und werden nicht automatisch vergeben.
