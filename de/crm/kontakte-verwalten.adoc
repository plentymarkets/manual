...
| *Pflichtfeld*
|Aktivieren, damit die Eigenschaft zu einer Pflichtangabe wird. Pflichtfelder werden in der Detailansicht des Kontakts im Bereich *Eigenschaften* und im Bestellvorgang im plentyShop fett markiert.

| *Bestellvorgang*
|Aktivieren, damit die Eigenschaft im Bestellvorgang im plentyShop angezeigt wird.

| *Kundenregistrierung*
|Aktivieren, damit die Eigenschaft in der Kundenregistrierung im plentyShop angezeigt wird.
