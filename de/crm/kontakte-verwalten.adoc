...
====
Gastzugänge, die über einen Ceres-Webshop erstellt wurden, können nicht über das Menü *CRM » Kontakte* gefunden werden. Gastzugänge können nur über die Adressdaten im Menü *CRM » Schnellsuche* gefunden werden.
====
