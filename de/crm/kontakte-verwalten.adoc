...
Im Menü *System » CRM » Adress-Layout* können Sie individuell Adress-Layouts für Ihre Lieferländer für das Auftragsdokument *Lieferschein* einrichten. Klicken Sie auf den Info-Button, um zu erfahren, für welche Adressfelder die einzelnen Parameter stehen.
