...
|*Feldliste*
|Wenn gewünscht, englische und deutsche Übersetzungen für die Feldnamen eingeben, damit diese übersetzten Namen dann beim Gestalten des Adress-Layouts angezeigt werden.

|*Speichern*
|Einstellungen speichern. Die Liste der Feldnamen schließt sich und die Bereiche *Länder*, *Layout* und *Felder* werden angezeigt.

|*Länder*
|Ein Land oder mehrere Länder aus der Liste wählen, für die das Adress-Layout auf dem Lieferschein gelten soll.
...
*_Tipp:_* Es ist möglich, die Felder einzeln oder komplette Reihen zu entfernen. Auch leere Reihen sind erlaubt.
