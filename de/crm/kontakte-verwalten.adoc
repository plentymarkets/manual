...
Damit Lieferscheine für die Lieferländer Deutschland, Frankreich und das Vereinigte Königreich automatisch in diesen drei Adress-Layouts ausgegeben werden, müssen Sie eine Einstellung im Lieferschein vornehmen. Ihr plentymarkets System prüft dann automatisch das Lieferland aus dem Auftrag und gibt den Lieferschein in den im Menü *System » CRM » Adress-Layout* aufgelisteten Layout aus. Gehen Sie dazu wie im Folgenden beschrieben vor.

. Öffnen Sie das Menü *System » Mandant » Mandant wählen » Standorte » Standort wählen » Dokumente » Lieferschein*.
. Aktivieren Sie im Bereich *Grundeinstellungen: Lieferschein* die Option *Neues Adresslayout*. +
→ Die Option darüber *Aufbau der Rechnungsadressen-/ Lieferanschrift* wird ausgeblendet und die Lieferscheine für die Lieferländer Deutschland, Frankreich und UK werden in den Adresslayouts im Menü *System » CRM » Adress-Layout* ausgegeben.
...
====
Für die Einteilung Ihres Kundenstamms in Typen und Klassen ist es empfehlenswert, ein Konzept zu entwickeln, bevor Sie größere Mengen an Kontaktdaten erstellen. Dadurch vermeiden Sie späteren Änderungsaufwand, z.B. wenn Typen bei fehlender Konfiguration automatisch zugewiesen werden. Überlegen Sie, welche Typen und Klassen Sie benötigen, erstellen Sie die Typen und Klassen und weisen sie Ihren Kontakten zu.
====
...
Alternativ können Sie in der Kontaktübersicht die Menüs *Neuer Sammelauftrag*, *Neues Ticket*, *Neue Notiz* und *Neue Domain* sowie die Funktion *Kontakt löschen* bequem mit einem Rechtsklick aufrufen.
...
. Suchen Sie den Kontakt anhand der Filtereinstellungen wie im Kapitel <<crm/kontakte-verwalten#200, Kontakt suchen>> beschrieben. +
→ Die Kontakte, die den eingestellten Suchkriterien entsprechen, werden angezeigt.
. Öffnen Sie das Kontextmenü per Rechtsklick auf die Zeile des Kontakts.
...
|*Typ*
|Typ aus der Dropdown-Liste wählen. +
Verfügbare Typen: Umsatzsteuernummer, Externe Adress-ID, Gelangensbestätigung, Telefon, E-Mail, Postnummer, Personennummer, FSK, Geburtstag, Titel, Ansprechpartner.
...
Verwenden Sie die Schnellsuche, um alle Informationen eines Kontakts auf einen Blick zu erhalten. Dazu gehören neben der Rechnungsadresse, den Stammdaten und allgemeinen Informationen wie z.B. Typ, offene Forderungen und dem Datum des letzten Auftrags auch die Aufträge, weitere Adressen, Notizen und Tickets.
