...
|Zahlungsziel in Tagen eingeben, das für diese Kundenklasse gelten soll. Ein im Kontaktdatensatz gespeichertes Zahlungsziel hat Priorität vor diesem Zahlungsziel. Das Zahlungsziel wird in den <<auftraege/auftraege-verwalten#intable-zahlungsbedingungen-auftrag, Auftragseinstellungen>> übernommen. Dort kann es optional entweder manuell angepasst oder eingetragen werden. falls am Kontakt und in der Kundenklasse nichts hinterlegt sein sollte. Das im Auftrag gespeicherte Zahlungsziel wird dann auf <<auftraege/auftragsdokumente#intable-zahlungsbedingungen-dokumente, Dokumenten>> ausgegeben. Dazu die ausklappbare Box *Beispiel:{nbsp}Gestaltung von Zahlungsbedingungen* unterhalb von <<#tabelle-kontakt-bearbeiten>> im Kapitel <<crm/kontakte-verwalten#300, Kontakt bearbeiten>> beachten.

|*Skontosatz*
|Skontosatz in Prozent eingeben, der für diese Kundenklasse gelten soll. Ein im Kontaktdatensatz gespeicherter Skontosatz hat Priorität vor diesem Skontosatz. Der Skontosatz wird in den <<auftraege/auftraege-verwalten#intable-zahlungsbedingungen-auftrag, Auftragseinstellungen>> übernommen.
