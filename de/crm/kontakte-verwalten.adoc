...
Damit das Menü *System » CRM » Adress-Layout* auch für variable Benutzer sichtbar ist, müssen Sie dieses Menü im Benutzerkonto freischalten. Gehen Sie dazu wie im Folgenden beschrieben vor.

[.instruction]
Einstellung für variablen Benutzer vornehmen:
...
. Aktivieren Sie die Option *Adress-Layout*.
. *Speichern* Sie die Einstellung.
