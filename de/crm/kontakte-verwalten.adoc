...
| *Tags*
|Tag wählen, um nur Kontakte, denen dieses Tag zugeordnet ist, anzuzeigen. Du kannst nach einem oder mehreren Tags gleichzeitig zu filtern.
...
<<#tabelle-typen-subtypen-kontaktoptionen>> listet alle weiteren verfügbaren Typen sowie Subtypen in den Kontaktoptionen auf, die zusätzlich zu den Kontaktdetails beim Erstellen eines neuen Kontakts in einem bereits erstellten Kontaktdatensatz hinzugefügt werden können.
