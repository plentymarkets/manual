...
[#3500]
=== Passwörter für alle Kontakte neu vergeben

Im Menü *System » CRM » Passwörter* generieren Sie neue Passwörter für alle Ihre Kontakte. Dies kann z.B. nötig sein, wenn sich jemand widerrechtlich Zutritt zu Ihrem plentymarkets System verschafft hat bzw. Sie von Datendiebstahl betroffen sind.

[WARNING]
.Kein automatischer Versand der neu generierten Passwörter
====
Beachten Sie, dass Ihre Kontakte nicht automatisch die neu generierten Passwörter erhalten. Sie müssen Ihre Kontakte aktiv, z.B. per E-Mail, über die Sachlage informieren und sie auffordern, ihr Passwort im Webshop bzw. Mein Konto-Bereich zu ändern.
====

Gehen Sie wie im Folgenden beschrieben vor, um neue Passwörter für alle Kontakte zu generieren.
