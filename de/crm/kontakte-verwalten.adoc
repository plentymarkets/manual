...
Wenn der Kontakt als Gast in Ihrem Webshop bestellt hat, wird die Zugangsart als Kontaktoption in der Detailansicht des Kontakts gespeichert. Gastzugänge haben den Wert 1. Löschen Sie die Kontaktoption mit dem Wert 1, um den Gastzugang in einen regulären Zugang umzuwandeln.
...
Ob die primäre Rechnungsadresse oder die primäre Lieferadresse des Kontakts ausgegeben wird, hängt von der Einstellung im Menü *System » Aufträge » Dokumente » Adressetikett* ab. +
*_Wichtig_* Die Adressetikettenvorlage muss zuvor im Menü *System » Aufträge » Dokumente » Adressetikett* <<auftragsabwicklung/fulfillment/dokumente-erzeugen#400, erstellt>> worden sein.
