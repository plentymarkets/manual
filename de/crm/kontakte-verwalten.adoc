...
Der Gastzugang ist als Kontaktoption in der Detailansicht des Kontakts gespeichert und hat den Wert 1. Löschen Sie die Kontaktoption mit dem Wert 1, um den Gastzugang in einen regulären Zugang umzuwandeln.
