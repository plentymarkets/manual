...
|*eBay-Name*
|eBay-Namen des Kontakts eingeben, um nur den Kontakt mit diesem eBay-Namen anzuzeigen. Es ist möglich, nur Teile des eBay-Namen einzugeben.
...
|*Mandant*
|Mandant wählen, um nur Kontakte dieses Mandanten anzuzeugen. Der Mandant ist in den Kontaktdaten gespeichrt. +
*_Wichtig:_* Variablen Benutzern stehen nur Mandanten zur Auswahl, für die sie eine Berechtigung haben. Berechtigungen werden im Menü *System » Einstellungen » Benutzer » Konten* im Tab <<basics/arbeiten-mit-plentymarkets/benutzer-verwalten#90, Berechtigung>> des Benutzerkontos eingestellt.
