...
|*Klasse*
|Klasse wählen. Klassen dienen zur internen Unterscheidung und z.B. ob und welcher Rabatt dieser Klasse gewährt werden soll. Klassen werden im Menü <<crm/kundendaten-verwalten#100, *Einstellungen » Kunden » Kundenklassen*>> erstellt. Soll zum Beispiel zwischen Endkunden und Händlern bei der Preisanzeige im Online-Shop unterschieden werden, kann dies über die Option *Anzeige der Preise im Online-Shop* in der Konfiguration der Klassen vorgenommen werden. Bei Endkunden (B2C) werden die Bruttopreise im Online-Shop angezeigt. Bei Händlern (B2B) werden die Nettopreise im Online-Shop angezeigt. +
