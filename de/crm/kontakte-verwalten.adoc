...
Wie du Eigenschaften und Eigenschaftsgruppen erstellst udn diese bearbeitest und löschst, ist auf der Handbuchseite <<basics/arbeiten-mit-plentymarkets/eigenschaften#, Eigenschaften>> beschrieben.
...
→ Alle für den Kontakt verfügbaren Eigenschaften werden  angezeigt. +
