...
|Kopiert die E-Mail-Adressen der aktivierten Kontakte in den aus dem Dropdown-Menü gewählten E-Mail-Ordner im Menü *System » CMS » Newsletter » plentymarkets » E-Mail-Ordner* für den Newsletterversand.
