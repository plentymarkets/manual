...
*_Wichtig:_* Diese Option legt nur die Anzeige der Preise fest, nicht die Berechnung der Preise für die Kundenklasse. Einstellung besonders für die Kundenklasse der Position 1 beachten, weil diese Kunden automatisch zugewiesen wird, wenn keine Kundenklasse im Kontaktdatensatz gewählt wurde.
|====
...
Du hast jedoch die Möglichkeit, den Datensatz zu anonymisieren. Wie du dazu vorgehst, ist im Kapitel <<crm/kontakte-verwalten#1707, Datensatz anonymisieren>> beschrieben.
====
...
Erfahre in den folgenden Unterkapiteln, wie du neue Nachrichten zu deinem Kontakt erstellst, alle zu einem Kontakt vorhandenen Nachrichten aufrufst sowie vorhandene Nachrichten löschst.
...
Wie du Tags erstellst, ist auf der Handbuchseite <<basics/arbeiten-mit-plentymarkets/tags#, Tags>> beschrieben.
...
image::crm/assets/crm-messenger-stoppuhr.png[width=640, height=360]
...
|*Empfänger*
|Empfänger aus der Dropdown-Liste wählen oder die ersten 3 Buchstaben des Empfängers eintippen, um Vorschläge zu erhalten. +
Standardmäßig sind *ALLE* Empfänger sowie der eigene Benutzer gewählt.
...
|*Titel*
|Titel der Nachricht eingeben. Dies ist eine Pflichteingabe.
...
|*Flüstern*
|Wenn *Flüstern* (icon:eye[] icon:toggle-off[role="red"]) aktiviert ist, ist die Nachricht nur von deinen Mitarbeitern, die die Berechtigung für den Messenger haben, sichtbar. Deine Kontakte können die Nachricht nicht einsehen. +
*_Hinweis:_* Wenn *Flüstern* aktiviert ist, sind das Feld *Minuten* und die Schaltfläche *kostenpflichtig* deaktiviert.

|*Nachricht*
|Füge Text über die Zwischenablage ein und formatiere ggf. den Text mit den Funktionen in der Symbolleiste. Dies ist eine Pflichteingabe.

|*Dateien anhängen*
|Mit einem Klicke auf icon:paperclip[] beliebig viele Dateianhänge zur Nachricht hochladen. + Die folgenden Dateitypen sind als Anhang in der Nachricht zulässig: +
...
Du kannnst Nachrichten jederzeit bearbeiten. Gehe dazu wie im Folgenden beschrieben vor.
...
. Nimm die Änderungen vor. Beachte dazu <<bild-messenger-nachricht-bearbeiten>> und die Erläuterungen in <<tabelle-messenger-nachricht-bearbeiten>>.



[[bild-messenger-nachricht-bearbeiten]]
.Beispiel: Nachricht bearbeiten
image::crm/assets/messenger-nachricht-bearbeiten.png[width=640, height=360]
...
In der Nachrichtenübersicht wird die Nachricht dann mit einem icon:success[set=plenty, role=green] angezeigt. Dies signalisiert anderen Mitarbeitern, dass diese Nachricht bereits bearbeitet wurde. +
...
|Mit einem Klick auf icon:pencil[role="yellow"] änderst du die Sichtbarkeiten. Du kannst bereits ausgewählte Empfänger entfernen und neue Empfänger hinzufügen. +
*_Wichtig:_* Das Ändern von Sichtbarkeiten bezieht sich immer auf den gesamten Nachrichtenverlauf. Das bedeutet, wenn du einen Mitarbeiter entfernst, kann dieser keine der Nachrichten mehr sehen. Wenn du einen Mitarbeiter hinzufügst, kann dieser alle Nachrichten im Verlauf sehen.
...
.Einstellungen im Bereich *Konto* des Kontaktdatensatzes
[cols="1,3"]
|====
|Einstellung |Erläuterung
...
====
Im Kapitel <<crm/kontakte-verwalten#350, Alter Webshop:{nbsp}Gastzugang in regulären Zugang umwandeln>> ist beschrieben, wie du Callisto-Gastbestellungen in reguläre Zugänge umwandelst. Das Umwandeln von Ceres-Gastbestellungen in reguläre Zugänge ist über den Kontaktdatensatz nicht möglich.
