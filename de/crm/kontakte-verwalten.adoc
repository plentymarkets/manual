...
Damit für Benutzer mit der Benutzerklasse *Variabel* das Menü *CRM » Kontakte* sichtbar ist, muss dieses Menü im Benutzerkonto freigeschaltet werden. Für Benutzer mit der Benutzerklasse *Admin* ist die Sichtbarkeit des Menüs *CRM » Kontakte* standardmäßig aktiviert.

Da die neue Benutzeroberfläche des Menüs *CRM » Kontakte* über REST abgerufen wird, müssen zusätzlich Berechtigungen im Bereich *REST-API* aktiviert werden. Im Folgenden werden die Berechtigungen, die mindestens aktiviert werden müssen, damit das Menü sichtbar ist, beschrieben. Aktivieren Sie weitere Berechtigungen analog, wenn der variable Benutzer auch Kontakte aktualisieren, erstellen oder löschen soll.
...
Das Format für den Export erstellen Sie im Menü *Daten » FormatDesigner*. Einen neuen Export erstellen Sie im Menü *Daten » Elastischer Export*. Dort wählen Sie das über den FormatDesigner erstellte Format aus dem Dropdown-Menü und exportieren die Daten anschließend in eine CSV-Datei.

Ihnen stehen zahlreiche Filteroptionen für den Export zur Verfügung. Exportieren Sie z.B. nur Kontakte, die Sie mit drei Sternen bewertet haben, oder nur Kontakte, die einem bestimmten Eigner zugeordnet sind. Detailliertere Informationen werden in Kürze ergänzt.
...
|*Mandant*
|Mandant aus dem Dropdown-Menü wählen, um den Kontakt diesem Mandanten zuzuordnen. +
...
|*Eigner*
|Eigner für den Kontakt wählen. Wenn kein Eigner gewählt werden soll, die leere Option wählen. Im Dropdown-Menü werden ausschließlich Eigner angezeigt, für die im Menü *System » Einstellungen » Benutzer » Konten » Benutzer öffnen » Tab: Eigner* die Option *Kunde* aktiviert wurde.
...
|*Eigner*
|Eigner aus dem Dropdown-Menü wählen.
...
|*Subtyp*
|Subtyp, z.B. Geschäftlich oder Privat, aus dem Dropdown-Menü wählen.

|*Wert*
|Wert, z.B. die geschäftliche E-Mail-Adresse des Kontakts, eingeben.
|====
...
Wenn Sie den Kontakt ohne eine Verknüpfung zu einer Firma erstellt haben, können Sie diese auch nachträglich verknüpfen. Um Verwechslungen auszuschließen, werden neben dem Firmennamen auch der Ort, die Straße und das Land der Firma angezeigt.

Geben Sie mindestens drei Buchstaben des Firmennamens, des Orts, der Straße oder des Landes ein, damit Ihr plentymarkets System Ihnen bereits gespeicherte Firmendatensätze vorschlägt.
...
→ Sobald Sie drei Buchstaben eingeben, werden Ihnen bereits im System gespeicherte Firmendatensätze vorgeschlagen.
. Wählen Sie den Firmendatensatz aus dem Dropdown-Menü.
. *Speichern* Sie die Einstellungen. +
...
. Nehmen Sie die Einstellungen vor. Beachten Sie dazu die Erläuterungen in <<tabelle-kontakt-erstellen>> im Bereich *Neue Firma*.
. *Speichern* Sie die Einstellungen. +
→ Die Detailansicht des Kontakts wird geöffnet.
. *Speichern* Sie die Einstellungen.
...
Sie können bereits gespeicherte Firmendaten bearbeiten. Beachten Sie, dass die Daten des bereits vorhandenen Firmendatensatzes dabei überschrieben werden.
...
. Nehmen Sie die Änderungen vor. Beachten Sie dazu die Erläuterungen in <<tabelle-kontakt-erstellen>> im Bereich *Neue Firma*.
. *Speichern* Sie die Einstellungen. +
...
Sie können die Verknüpfung zwischen Firma und Kontakt in der Detailansicht des Kontakts wieder löschen. Beachten Sie, dass Sie nur die Verknüpfung löschen und nicht die gespeicherten Firmendaten selbst. Die Firmendaten werden weiterhin im Dropdown-Menü als Vorschlag angezeigt, wenn Sie mindestens drei Buchstaben des Firmennamens, des Orts, der Straße oder des Landes eingeben.
...
.Kontakt informieren
====
Informieren Sie den Kontakt über die Änderung und senden Sie ihm eine E-Mail, damit er ein Passwort für den Login in Ihrem Webshop vergeben kann.
====
...
*_Wichtig:_* Wenn Sie Ceres nutzen, haben Sie die Möglichkeit, das Erstellen von Kontaktdatensätzen bei Gastbestellungen zu unterbinden. Wählen Sie dazu im Menü *System » CRM » Einstellungen* die Option *Keine Kontakte erstellen* aus dem Dropdown-Menü *Gastbestellungen*. Standardmäßig ist die Option *Kontake erstellen* gewählt.
...
Mit der Gruppenfunktion können Sie den Versand einer E-Mail-Vorlage, den Druck von Adressetiketten oder das Hinzufügen des Kontakts zu einem Newsletter-Ordner für einen oder mehrere Kontakte gleichzeitig auslösen.
...
. Aktivieren Sie eine oder mehrere Aktionen und wählen Sie die Optionen aus den Dropdown-Menüs. Beachten Sie dazu die Erläuterungen in <<tabelle-kontakt-gruppenfunktion>>.
...
|Druckt das aus dem Dropdown-Menü gewählte Etikett von allen aktivierten Kontakten. +
...
|Versendet die aus dem Dropdown-Menü gewählte Vorlage an alle aktivierten Kontakte. +
...
|Kopiert die E-Mail-Adressen der aktivierten Kontakte in den aus dem Dropdown-Menü gewählten E-Mail-Ordner im Menü *System » CRM » Newsletter » plentymarkets » E-Mail-Ordner* für den Newsletterversand.
...
Damit für Benutzer mit der Benutzerklasse *Variabel* das Menü *CRM » Schnellsuche* sichtbar ist, muss das Menü im Benutzerkonto freigeschaltet werden. Für Benutzer mit der Benutzerklasse *Admin* ist die Sichtbarkeit des Menüs *CRM » Schnellsuche* standardmäßig aktiviert.

Da die neue Benutzeroberfläche des Menüs *CRM » Schnellsuche* über REST abgerufen wird, müssen zusätzlich Berechtigungen im Bereich *REST-API* aktiviert werden. Im Folgenden werden die Berechtigungen, die mindestens aktiviert werden müssen, damit das Menü sichtbar ist, beschrieben. Aktivieren Sie weitere Berechtigungen analog. Wenn der variable Benutzer in der Schnellsuche z.B. Notizen erstellen und löschen soll, aktivieren Sie im Bereich *Kommentare* die Optionen *Kommentar erstellen*, *Kommentar anzeigen* und *Kommentar löschen*.
...
Verwenden Sie die Schnellsuche, um alle Informationen eines Kontakts auf einen Blick zu erhalten. Dazu gehören neben den Stammdaten, der Rechnungsadresse und allgemeinen Informationen auch die Aufträge, weitere Adressen, Notizen und Tickets.

[.instruction]
Schnellsuche verwenden:

. Öffnen Sie das Menü *CRM » Schnellsuche*.
. Stellen Sie mindestens einen Filter ein.
. Klicken Sie auf *Suchen*. +
→ Die Kontakte, die den eingestellten Suchkriterien entsprechen, werden angezeigt.
. Klicken Sie in die Zeile des Kontakts. +
→ Die Übersicht des Kontakts mit den Bereichen *Rechnungsadresse*, *Stammdaten* und *Info* wird geöffnet.
. Klicken Sie in der Zeile *Aufträge* auf den Pfeil rechts, um die Aufträge des Kontakts anzuzeigen. +
...
. Klicken Sie in der Zeile *Adressen* auf den Pfeil rechts, um die Adressen des Kontakts anzuzeigen. +
...
. Wählen Sie die Info aus dem Dropdown-Menü.
...
====
Sie können die Dauer von bestehenden Events aktualisieren. Klicken Sie dazu in der Übersicht der Events auf *Dauer aktualisieren*. Das Fenster *Event-Dauer aktualisieren* wird daraufhin geöffnet. Geben Sie dort die neue Zahl in Minuten ein und klicken Sie auf *Aktualisieren*.
====
...
. Wählen Sie in dem Dropdown-Menü *Bereich* die Option *Kontakt*.
...
Eigenschaften verwalten Sie zentral im Menü *System » Einstellungen » Eigenschaften*. Führen Sie nach dem Öffnen des Menüs eine Suche aus, um Eigenschaften anzuzeigen. Um Eigenschaften nach bestimmten Kriterien zu suchen, geben Sie die Ihnen bekannten Suchbegriffe in die Filter ein. Die Dropdown-Menüs helfen Ihnen, Eigenschaften zu suchen, die bestimmte Kriterien gemeinsam haben. Sie können beliebig viele Suchfilter miteinander kombinieren.
