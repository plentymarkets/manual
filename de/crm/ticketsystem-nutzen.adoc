...
. Nimm die Einstellungen vor. Beachte dazu die Erläuterungen auf der Handbuchseite <<crm/e-mails-versenden#, E-Mails>> im Kapitel <<crm/e-mails-versenden#1200, E-Mail-Vorlage erstellen>>.
