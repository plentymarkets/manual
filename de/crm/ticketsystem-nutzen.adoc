...
Benutzer mit dem Zugang *Backend* benötigen eine Berechtigung, um das Ticketsystem nutzen zu können. Schalte daher das Ticketsystem für diesen Benutzer frei.
...
. Klappe im Bereich *Menü-Sichtbarkeiten* die Option *CRM* auf.
. Aktiviere die Option *Ticketsystem*. +
...
Damit Benutzer mit dem Zugang *Backend* Rollen, Status und Typen für das Ticketsystem erstellen und aktualisieren können, müssen die Berechtigungen im Benutzerkonto freigeschaltet werden.
...
→ Die gefundenen Konten werden angezeigt. +
*_Tipp:_* Ausgegraute Konten haben Admin-Rechte.
. Klicke auf das Konto, für das du die Berechtigungen aktivieren möchtest. +
→ Die Ansicht *Rechte* wird geöffnet.
. Klappe im Bereich *Berechtigungen* den Bereich *Ticket* auf.
. Aktiviere die Optionen für die Bereiche *Ticket-Rolle*, *Ticket-Status* und *Ticket-Typ* wie gewünscht.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
. Öffne das Menü *System » Systemeinstellungen » CRM » Ticketsystem » Einstellungen » Tab: Rollen*.
...
. Öffne das Menü *System » Systemeinstellungen » CRM » Ticketsystem » Einstellungen » Tab: Typen &amp; Status*.
...
. Klicke auf *Neuen Status hinzufügen*, um einen Status zu dem Typen hinzuzufügen.
. Gib den *Namen* ein.
...
. Öffne das Menü *System » Systemeinstellungen » CRM » Ticketsystem » Einstellungen » Tab: Statusgruppen*.
...
Wenn du im Menü *CRM » Ticketsystem » Tab: Tickets* über <<basics/arbeiten-mit-plentymarkets/allgemeine-funktionen#50, Ansicht einrichten>> die Option *Statusgruppe* aktiviert hast, siehst du direkt nach dem Erstellen eines Tickets in der Ticketübersicht, in welchem Status sich das Ticket befindet. Die Statusgruppe wird ebenfalls im Ticket neben *Tags anzeigen/verbergen* angezeigt.

[#1100]
=== Thema hinzufügen

Du hast im Menü *System » Systemeinstellungen » CRM » Ticketsystem » Einstellungen » Tab: Themen* die Möglichkeit, Themen zu erstellen, die du später beim Bearbeiten deiner Tickets den Nachrichten und Kommentaren als Überschriften zuweist. Auf diese Weise wird die Bearbeitung deiner Tickets übersichtlicher und verständlicher. Vergib für deine Kommunikation z.B. Themen wie *Artikeldetails*, *Service* und *Umtausch*. So erkennst du beim Überfliegen einer längeren Kommunikation das Thema deiner Antwort auf einen Blick. Wie du Themen zuweist, ist im Kapitel <<crm/ticketsystem-nutzen#2600, Thema zuweisen>> beschrieben.

[.instruction]
Thema hinzufügen:

. Öffne das Menü *System » Systemeinstellungen » CRM » Ticketsystem » Einstellungen » Tab: Themen*.
. Klicke auf *Hinzufügen*.
...
. Klicke auf *Filter hinzufügen*, um einen weiteren Filter hinzuzufügen. +
→ Das Fenster *Filter hinzufügen* wird geöffnet.
...
. Wähle die Aktion *Löschen* (icon:minus-square[role="red"]).
. Klicke auf *Hinzufügen*.
. Setze ein Häkchen.
...
Im Menü *CRM » Ticketsystem » Tab: Tickets* kannst du oberhalb der Ticketübersicht ein neues Ticket manuell oder aus einer Vorlage erstellen. Du kannst dort auch persönliche Vorlagen wählen oder die Gruppenfunktion nutzen. <<tabelle-ticketuebersicht>> erläutert die Einstellungen, die du im Tab *Tickets* vornehmen kannst.
...
. Öffne das Menü *CRM » Ticketsystem*.
. Wähle im Tab *Tickets* im Bereich *Suchen* die Filter und gib die Daten in die Eingabefelder ein. Beachte dazu die Erläuterungen in <<tabelle-ticket-suchen>>.
. Klicke auf *Suchen*.  +
...
Im Menü *CRM » Ticketsystem » Ticket öffnen » Tab: Ticket* siehst du die Einstellungen deines Tickets auf einen Blick. Einige Einstellungen kannst du hier auch ändern. <<tabelle-ticket-bearbeiten>> erläutert die Einstellungsmöglichkeiten in deinen Tickets.
...
Das Menü *CRM » Ticketsystem » Ticket öffnen » Tab: Kunde* enthält die Kundendaten wie sie auch im Menü <<crm/kontakte-verwalten#300, CRM » Kontakte » Kontakt öffnen>> angezeigt werden. Du kannst den Kundendatensatz hier auch bearbeiten. Dieses Tab ist nur sichtbar, wenn das Ticket mit einem Kunden verknüpft ist.

[#3800]
=== Aufträge anzeigen

Im Menü *CRM » Ticketsystem » Ticket öffnen » Tab: Aufträge suchen* werden alle Aufträge des Kunden angezeigt. Du kannst die Aufträge hier auch bearbeiten oder suchen. Dieses Tab ist nur sichtbar, wenn das Ticket mit einem Kunden verknüpft ist.

[#3900]
=== Anhang anzeigen

Im Menü *CRM » Ticketsystem » Ticket öffnen » Tab: Anhang* siehst du alle Dateianhänge, die in diesem Tab hochgeladen wurden. Sowohl der Kunde als auch die Mitarbeiter können Dateien an ein Ticket anhängen und dauerhaft einsehen. Im Tabtitel wird die Anzahl der Anhänge in Klammern angezeigt. Sobald die erste Datei erfolgreich hochgeladen wurde, wird eine Tabelle angezeigt. Die Tabelle listet den Dateinamen, den Namen des Mitarbeiters oder Kunden, der die Datei hochgeladen hat, sowie die Sichtbarkeit und das Datum auf.
...
Wenn du im Menü *CRM » Ticketsystem » Tab: Tickets* über <<basics/arbeiten-mit-plentymarkets/allgemeine-funktionen#50, Ansicht einrichten>> die Option *Anhang* aktiviert hast, siehst du direkt in der Ticketübersicht, welches Ticket einen Anhang hat.
...
. Nimm die Einstellungen vor. Beachte dazu die Erläuterungen im Kapitel <<basics/arbeiten-mit-plentymarkets/aufgaben-und-kalender#300, Aufgabe erstellen>>auf der Handbuchseite <<basics/arbeiten-mit-plentymarkets/aufgaben-und-kalender#, Aufgaben und Kalender verwalten>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen. +
...
. Öffne das Menü *CRM » Ticketsystem » Ticket öffnen » Tab: Kinder*.
...
====
Ein Kinderticket erstellst du direkt im Menü *CRM » Ticketsystem » Ticket öffnen » Tab: Kinder* und dort im Tab *Kinder*. Klicke auf *Neues Ticket* und nimm die Einstellungen vor. Das Ticket wird automatisch dem Hauptticket zugeordnet und dort im Tab *Kinder* angezeigt.
====
...
Nachdem die Vorlage der <<crm/ticketsystem-nutzen#5300, Ticketkarte>> im Menü *System » Systemeinstellungen » CRM » Ticketsystem » Ticketkarten* gespeichert wurde, steht diese im Menü *CRM » Ticketsystem » Tab: Tickets* in der *Gruppenfunktion* in der Dropdown-Liste *Ticket drucken* zur Verfügung. Gehe wie im Folgenden beschrieben vor, um Tickets in einer PDF-Datei auszugeben.
