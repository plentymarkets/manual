...
Je nachdem, welche plentymarkets Edition du nutzt, musst du das Ticketsystem ggf. zunächst <<crm/ticketsystem-nutzen#100, buchen>>, bevor du dieses im Menü *CRM » Ticketsystem* nutzen kannst.
