...
| *Kunde*
|Auf der Tastatur die Pfeiltaste nach unten drücken. Eine Liste der Kund:innen wird angezeigt. Die Kund:innen werden anhand ihrer ID sortiert angezeigt. Die Kund:in mit der niedrigsten ID wird an erster Stelle angezeigt. Mit einem Klick auf die Kund:in wird der Name sowie die ID in das Feld übernommen.
...
Das Ticket muss mit einer Kund:in verknüpft sein, um die E-Mail-Vorlage zu senden. Dazu in das Feld *Kunde* klicken und auf der Tastatur die Pfeiltaste nach unten drücken. Eine Liste der Kund:innen wird angezeigt. Die Kund:innen werden anhand ihrer ID sortiert angezeigt. Die Kund:in mit der niedrigsten ID wird an erster Stelle angezeigt. Mit einem Klick auf die Kund:in wird der Name sowie die ID in das Feld übernommen.
...
| *Kunde*
|Kund:in wählen, um eine Vorlage für diese Kund:in zu erstellen.
...
| *Kunden-ID*
|Kunden-ID eingeben, um nur die Tickets der Kund:in mit dieser ID zu suchen.
...
| *Kunde*
|Zeigt die ID und den Namen der Kund:in an. Die Kund:innen werden teilweise <<crm/ticketsystem-nutzen#2100, automatisch zugeordnet>>, z.B. beim automatischen Erstellen von Tickets aus E-Mails.
