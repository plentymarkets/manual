...
Alle weiteren Formulareinstellungen sind optional. Weitere Informationen finden Sie auf der Handbuchseite **<<cms/einstellungen/formulare#, Formulare  >>**.
...
Legen Sie eine sinnvolle Struktur von Ordnern, Unterordnern und Fragen im Menü **CMS » FAQ** an und stellen diese für das Ticketsystem im Menü **CMS » FAQ » Tab: Ordner » Ordner aufklappen » Tab: Einstellungen** auf **sichtbar**. Weitere Informationen finden Sie auf der Handbuchseite **<<cms/faq#, FAQ  >>**.
...
Im Menü **Einstellungen » Kunden » Ticketsystem » Ereignisaktionen** wählen Sie anhand von Filtern Tickets und ordnen diesen automatische Aktionen zu, die durch eine **<<auftraege/einstellungen/ereignis-aktionen#, Ereignisaktion  >>** ausgeführt werden sollen. Ein Beispiel wäre, dass bei Eingang eines Tickets automatisch der Versand einer E-Mail-Vorlage ausgelöst wird, die dem Kunden den Eingang des Tickets bestätigt und ihm die weitere Vorgehensweise erläutert.
...
Weitere Informationen zum Einrichten von Ereignisaktionen finden Sie auf der Handbuchseite **<<auftraege/einstellungen/ereignis-aktionen#, Ereignisaktionen  >>**.
...
Richten Sie eine **<<auftraege/einstellungen/ereignis-aktionen#, Ereignisaktion  >>** ein, um z.B. eine E-Mail zu erhalten, wenn in Ihrem Ticketsystem eine neue Ticketnachricht eingegangen ist.
...
In diesem Menü können Sie beliebig viele Aktionen erstellen und für diese Aktionen Filter und Uhrzeiten wählen. Weitere Informationen zum Einrichten des Aktionsmanagers finden Sie auf der Handbuchseite **<<auftraege/einstellungen/aktions-manager#, Aktionsmanager  >>**.
...
**FAQ** = Auf **Bearbeiten** klicken. Das Fenster **FAQ auswählen** wird geöffnet. **<<cms/faq#, FAQ  >>** wählen, die bei Verwendung der Vorlage eingegeben wird. Auf **Übernehmen** klicken. +
...
. Nehmen Sie die Einstellungen vor. Beachten Sie dazu die Erläuterungen auf der Handbuchseite <<start/aufgaben#, **Aufgaben**  >>.
. **Speichern** Sie die Einstellungen. +
...
. Wählen Sie die Filtereinstellungen. Beachten Sie dazu die Erläuterungen auf der Handbuchseite <<start/aufgaben#, **Aufgaben**  >>.
. Klicken Sie auf **Suchen**.
