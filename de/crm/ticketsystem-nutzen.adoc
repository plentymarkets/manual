...
Wenn du die Template-Variable *$SignatureText* in die E-Mail-Vorlage eingefügt hast, wird immer die Signatur, die im Menü *System » Systemeinstellungen » Mandant » Mandant wählen » E-Mail » Signatur* gespeichert ist, übernommen.
====
...
.Testmodus beachten
====
Nachdem du alle Tests durchgeführt hast, musst du den Testmodus im Menü *System » Systemeinstellungen » Mandant » Mandant wählen » E-Mail » Zugangsdaten* deaktivieren. Ansonsten werden Tickets nur an die im Menü *System » Systemeinstellungen » CRM » Ticketsystem » E-Mail-Konten* gespeicherte E-Mail-Adresse versendet.
====
