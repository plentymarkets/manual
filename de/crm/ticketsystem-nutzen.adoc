...
|Erstellt aus dem Ticket heraus eine neue Karte auf dem aus der Dropdown-Liste gewählten Board. Der Karte kann außerdem ein Präfix hinzugefügt werden. <<willkommen/system-personalisieren#370, Boards>> erstellst du im Menü *plentymarkets Logo (Start) » Boards*.
