...
_*Wichtig*_: Bei nicht erfolgreichem Test sind meist falsche Login-Daten oder ein falsches Kennwort die Ursache. Im Fehlerfall die Parameter prüfen.
...
_*Wichtig*_: Für plentymarkets E-Mail-Konten mit dem Typ IMAP die Einstellung *TLS* mit Port 143 oder die Einstellung *keine Verschlüsselung* mit Port 143 verwenden. +
...
_*Wichtig*_: Die Wahl eines Ordners ist zwingend. Wenn kein Ordner gewählt wird, werden die E-Mails nicht verschoben.
|====
