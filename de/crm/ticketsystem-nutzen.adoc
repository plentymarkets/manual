...
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#tabelle-e-mail-konto-einrichten>>. +
...
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#tabelle-ticket-ohne-vorlage-erstellen>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen. +
...
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#tabelle-faq-neuer-ordner>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen. +
...
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#tabelle-neue-faq>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen. +
...
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#tabelle-einstellungen-ticketvorlage>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen im Kapitel <<willkommen/allgemeine-funktionen/aufgaben-und-kalender#300, Aufgabe erstellen>> auf der Handbuchseite <<willkommen/allgemeine-funktionen/aufgaben-und-kalender#, Aufgaben und Kalender>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen. +
...
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen im Kapitel <<willkommen/allgemeine-funktionen/aufgaben-und-kalender#400, Aufgaben suchen>> auf der Handbuchseite <<willkommen/allgemeine-funktionen/aufgaben-und-kalender#, Aufgaben und Kalender>>.
. Klicke auf *Suchen* (icon:search[role="blue"]).
...
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen zu den *Filtern* in <<#tabelle-ticket-suchen>> im Kapitel <<crm/ticketsystem-nutzen#3400, Ticket suchen>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
