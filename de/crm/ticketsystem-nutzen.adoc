...
image::crm/assets/CRM-Ticketsystem-Ereignisaktion-Automatische-Antwort-an-Kunde.png[width=640, height=360, alt=Beispiel einer Ereignisaktion "Automatische Antwort an Kunden"]
...
| *Tags*
|Tags wählen, um eine Vorlage mit diesen Tags zu erstellen. <<willkommen/allgemeine-funktionen/tags#, Tags>> werden im Menü *Einrichtung » Einstellungen » Tags* erstellt.
...
| *Kundenklasse*
|Kundenklasse wählen, um nur Tickets von Kunden dieser Kundenklasse zu suchen. <<crm/kontakte-verwalten#15, Kundenklassen>> werden im Menü *Einrichtung » CRM » Kundenklassen* erstellt.
...
Im Tab *Kunde* des Tickets im Menü *CRM » Ticketsystem* sind die <<crm/kontakte-verwalten#300, Kontaktdaten>> enthalten wie sie auch im Menü *CRM » Kontakte* » _Kontakt öffnen_ angezeigt werden. Du kannst den Kontaktdatensatz hier auch bearbeiten. Dieses Tab ist nur sichtbar, wenn das Ticket mit einem Kunden verknüpft ist.
