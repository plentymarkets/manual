...
====
Die im Benutzerkonto eingegebene Signatur hat Priorität gegenüber der Signatur, die im Menü <<crm/e-mails-versenden#600, *System » Mandant » Mandant öffnen » E-Mail » Signatur*>> gespeichert ist. +
Wenn Sie die Template-Variable *$SignatureHTML* in die E-Mail-Vorlage eingefügt haben, wird die Signatur aus dem Benutzerkonto übernommen. Wenn keine Signatur im Benutzerkonto gespeichert ist, wird die Signatur, die im Menü *System » Mandant » Mandant öffnen » E-Mail » Signatur* gespeichert ist, übernommen. +
Wenn Sie die Template-Variable *$SignatureText* in die E-Mail-Vorlage eingefügt haben, wird immer die Signatur, die im Menü *System » Mandant » Mandant öffnen » E-Mail » Signatur* gespeichert ist, übernommen.
====
...
.Testmodus beachten
====
Nachdem Sie alle Tests durchgeführt haben, müssen Sie den Testmodus im Menü *System » Mandant » Mandant öffnen » E-Mail » Zugangsdaten* deaktivieren. Ansonsten werden Tickets nur an die im Menü *System » Kunden » Ticketsystem » E-Mail-Konten* gespeicherte E-Mail-Adresse versendet.
====
...
Kommunikation im Ticketsystem muss nicht ausschließlich mittels Nachrichten und Kommentaren erfolgen. Sie können auch <<crm/e-mails-versenden#1200, *E-Mail-Vorlagen*>> versenden. E-Mail-Vorlagen richten Sie im Menü *System » Mandant » Mandant öffnen » E-Mail » Vorlagen* ein. Eine E-Mail-Vorlage enthält einen Standardtext, der für alle Empfänger passend ist und kann mit dynamischen Inhalten, die über Template-Variablen automatisch eingefügt werden, ergänzt werden.
...
Im Menü *Kunden » Ticketsystem » Tab: Tickets* können Sie oberhalb der Ticketübersicht ein neues Ticket manuell oder aus einer Vorlage erstellen. Sie können dort auch persönliche Vorlagen wählen oder die Gruppenfunktion nutzen. Tabelle 7 erläutert die Einstellungen, die Sie im Tab *Tickets* vornehmen können.
...
Im Menü *Kunden » Ticketsystem » Ticket öffnen » Tab: Ticket* sehen Sie die Einstellungen Ihres Tickets auf einen Blick. Einige Einstellungen können Sie hier auch ändern. Tabelle 9 erläutert die Einstellungsmöglichkeiten in Ihren Tickets.
...
Nachdem die Vorlage der <<crm/ticketsystem-nutzen#5300, *Ticketkarte*>> im Menü *System » Kunden » Ticketsystem » Ticketkarten* gespeichert wurde, steht diese im Menü *Kunden » Ticketsystem » Tab: Tickets* in der *Gruppenfunktion* im Dropdown-Menü *Ticket drucken* zur Verfügung. Gehen Sie wie im Folgenden beschrieben vor, um Tickets in einer PDF-Datei auszugeben.
