...
. Aktiviere im Bereich *Berechtigungen* die Berechtigungen anhand von <<#table-rights-ticket-system>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.

[[table-rights-ticket-system]]
...
Benutzer:innen vom Typ *Backend* sehen nur bestimmte Bereiche und Menüs in plentymarkets. Somit können sie nur eingeschränkt im System arbeiten. Sollen Mitarbeiter:innen mit diesem Zugang mit Rollen, Status und Typen im Ticketsystem arbeiten, muss eine Person mit *Admin*-Zugang die in <<#table-rights-ticket-system-roles-statuses-types>> beschriebenen Rechte für Benutzer:innen vom Typ *Backend* vergeben.
...
. Öffne das Menü *Einrichtung » Einstellungen » Benutzer » Rechte » Benutzer*. +
. Nutze die Suchfunktion (icon:search[role="blue"]) und öffne das zu bearbeitende Konto.
. Aktiviere im Bereich *Berechtigungen* die Berechtigungen anhand von <<#table-rights-ticket-system-roles-statuses-types>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.

[[table-rights-ticket-system-roles-statuses-types]]
