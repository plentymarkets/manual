...
====
Die im Benutzerkonto eingegebene Signatur hat Priorität gegenüber der Signatur, die im Menü <<crm/e-mails-versenden#600, *System » Mandant (Shop) » Standard » E-Mail » Signatur*>> gespeichert ist. +
Wenn Sie die Template-Variable *$SignatureHTML* in die E-Mail-Vorlage eingefügt haben, wird die Signatur aus dem Benutzerkonto übernommen. Wenn keine Signatur im Benutzerkonto gespeichert ist, wird die Signatur, die im Menü *System » Mandant (Shop) » Standard » E-Mail » Signatur* gespeichert ist, übernommen. +
Wenn Sie die Template-Variable *$SignatureText* in die E-Mail-Vorlage eingefügt haben, wird immer die Signatur, die im Menü *System » Mandant (Shop) » Standard » E-Mail » Signatur* gespeichert ist, übernommen.
====
...
.Testmodus beachten
====
Nachdem Sie alle Tests durchgeführt haben, müssen Sie den Testmodus im Menü *System » Mandant (Shop) » Standard » E-Mail » Zugangsdaten* deaktivieren. Ansonsten werden Tickets nur an die im Menü *System » Kunden » Ticketsystem » E-Mail-Konten* gespeicherte E-Mail-Adresse versendet.
====
...
Im Menü *System » Kunden » Ticketsystem » Ereignisaktionen* wählen Sie anhand von Filtern Tickets und ordnen diesen automatische Aktionen zu, die durch eine <<basics/automatisierung/ereignisaktionen#, *Ereignisaktion*>> ausgeführt werden sollen. Ein Beispiel wäre, dass bei Eingang eines Tickets automatisch der Versand einer E-Mail-Vorlage ausgelöst wird, die dem Kunden den Eingang des Tickets bestätigt und ihm die weitere Vorgehensweise erläutert.
...
--
. Öffnen Sie das Menü *System » Kunden » Ticketsystem » Ereignisaktionen*.
...
. Öffnen Sie das Menü *System » Kunden » Ticketsystem » Aktionsmanager*.
...
Per Aktionsmanager im Menü *System » Kunden » Ticketsystem » Aktionsmanager* kann an das Ticket erinnert werden. Ein Beispiel, wie man eine Aktion einrichtet sowie Filter und Uhrzeit wählt, ist in diesem <<crm/ticketsystem-nutzen#3000, *Kapitel*>> beschrieben.
