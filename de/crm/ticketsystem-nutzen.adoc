...
Eigner aktivierst du im Menü *Einrichtung » Einstellungen » Benutzer » Konten* » _Benutzer öffnen_ im Tab *Eigner*. Aktiviere für jeden Benutzer, der als Eigner im Ticketsystem verfügbar sein soll, die Option *Ticket*. Beachte dazu auch die Handbuchseite <<business-entscheidungen/benutzerkonten-zugaenge#40, Benutzer verwalten>>.
...
| *Tags*
|Klicken, um Tags hinzuzufügen. Zur Auswahl stehen die im Menü *Einrichtung » Einstellungen » Tags* hinzugefügten Tags. Weitere Informationen dazu findest du auf der Handbuchseite <<willkommen/allgemeine-funktionen/tags#, Tags>>.
...
|Tags anzeigen oder verbergen. Wenn *Tags anzeigen* aktiviert wird, wird der Bereich *Tags* auf der rechten Seite im Ticket angezeigt. Dort können weitere <<willkommen/allgemeine-funktionen/tags#, Tags>> hinzugefügt werden, die zuvor im Menü *Einrichtung » Einstellungen » Tags* erstellt wurden. Für ein Ticket können beliebig viele Tags gewählt werden.

| *Neue Karte erstellen*
|Erstellt aus dem Ticket heraus eine neue Karte auf dem aus der Dropdown-Liste gewählten Board. Der Karte kann außerdem ein Präfix hinzugefügt werden. <<willkommen/allgemeine-funktionen/boards#, Boards>> erstellst du im Menü *plentymarkets Logo (Start) » Boards*.
...
| *Eigner*
|Eigner wählen, um eine Vorlage für diesen Eigner zu erstellen. Ob ein Benutzer als Eigner im Ticketsystem gewählt werden kann, wird im <<business-entscheidungen/benutzerkonten-zugaenge#40, Benutzerkonto>> festgelegt.
...
| *Tags*
|Tags wählen, um eine Vorlage mit diesen Tags zu erstellen. Tags werden im Menü <<willkommen/allgemeine-funktionen/tags#, Einrichtung » Einstellungen » Tags>> erstellt.
...
. Nimm die Einstellungen vor. Beachte dazu die Erläuterungen im Kapitel <<willkommen/allgemeine-funktionen/aufgaben-und-kalender#300, Aufgabe erstellen>> auf der Handbuchseite <<willkommen/allgemeine-funktionen/aufgaben-und-kalender#, Aufgaben und Kalender>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen. +
...
. Nimm die Einstellungen vor. Beachte dazu die Erläuterungen im Kapitel <<willkommen/allgemeine-funktionen/aufgaben-und-kalender#400, Aufgaben suchen>> auf der Handbuchseite <<willkommen/allgemeine-funktionen/aufgaben-und-kalender#, Aufgaben und Kalender>>.
. Klicke auf *Suchen* (icon:search[role="blue"]).
...
Weitere Informationen findest du auf der Handbuchseite <<business-entscheidungen/business-intelligence/statistiken#, Statistik>>. Dort wird auch beschrieben, wie du Statistiken erstellst und auswertest.
