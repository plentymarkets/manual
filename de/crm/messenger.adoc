...
Erfahre in den folgenden Unterkapiteln, wie du neue Nachrichten zu deinem Kontakt erstellst, alle zu einem Kontakt vorhandenen Nachrichten aufrufst sowie vorhandene Nachrichten bearbeitest und löschst.

== Vorbereitende Einstellungen

Wenn Nutzer:innen vom Typ *Backend* mit dem Messenger arbeiten sollen, musst du zunächst Rechte für diese Nutzer:innen vergeben. Außerdem musst du Tags erstellen, damit diese für den Messenger zur Verfügung stehen.
...
Bevor der Nachrichtenverlauf endgültig gelöscht wird, erscheint ein Fenster, in dem du das Löschen der Nachricht noch einmal bestätigen musst.
