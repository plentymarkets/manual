...
Klicke auf icon:local_offer[set=material] *Tags*, um eine Liste aller bereits für den Bereich *Messenger* <<#tags-messenger, erstellten>> Tags zu sehen. Wähle (icon:check-square[role="blue"]) die Tags, die du der Nachricht zuweisen möchtest, aus der Liste.
