...
Du kannst jedem Postfach dann anderen Tags zuweisen, um später nach diesen dann zu filtern.
...
Wähle nach Eingabe der Zugangsdaten (Host-Name, Benutzername, Port, Passwort) die Verschlüsselung und gib die Absender-E-Mail-Adresse sowie den Absendernamen ein. Dieser Name wird den Empfänger:innen deiner E-Mail angezeigt.
...
// Die Wahl der E-Mail-Vorlage wird zukünftig im Schritt davor gemacht. 

Im EmailBuilder stehen dir die folgenden Messenger-bezogenen Variablen zur Verfügung:

* UUID der Nachricht
* ID des Nachrichtenverlaufs
...
Du hast die Möglichkeit, die Ansichten zu wechseln. Klicke dazu auf *xxx* (icon:list[set=material]) ganz oben rechts in der Übersicht.

// Screenshots ergänzen von beiden Ansichten
// list-Icon im plenty-plugin-repo hinzufügen
...
== E-Mail-Konversationen abonnieren
