...
// Bereiche aus der *Navigation* noch beschreiben: Posteingang, Neue Nachrichten, Meine Nachrichten, Papierkorb.
...
image::crm/assets/messenger-new-message-suggestion-list.png[width=640, height=360]
...
// Screenshot einfügen vom Kontextmenü für einzelne Nachricht.
...
// Spalten konfigurieren ist auch im Papierkorb möglich; muss ergänzt werden
