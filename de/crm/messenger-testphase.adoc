...
// icon:notifications_active[set=material]
// icon:notifications_off[set=material]
...
Sobald du eine Nachricht in der Übersicht markiert hast (icon:check-square[role="blue"]), werden die verschiedenen Schaltflächen sichtbar (siehe <<#image-messenger-group-functions>>). In Tabelle <<#table-group-functions-messenger>> sind die Bedienelemente aus der Gruppenfunktion sowie deren Erläuterungen aufgelistet.

// neuen Screenshot Gruppenfunktion einfügen.

[[image-messenger-group-functions]]
.Gruppenfunktion in der Übersicht
image::crm/assets/messenger-group-function.png[width=640, height=360]
...
|Markiert alle gewählten Nachrichten als gelesen.

| *Als ungelesen markieren*
|icon:mark_email_unread[set=material]
|Markiert alle gewählten Nachrichten als ungelesen.

| *Als erledigt markieren*
|icon:done_all[set=material]
|Markiert alle gewählten Nachrichten als erledigt.

| *Als nicht erledigt markieren*
|icon:remove_done[set=material]
|Markiert alle gewählten Nachrichten als nicht erledigt.
