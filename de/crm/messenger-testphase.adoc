...
In diesem Schritt richtest du ein, an welche E-Mail-Adresse(n) eingehende E-Mails weitergeleitet werden sollen. Die kryptische E-Mail-Adresse im oberen Bereich wird automatisch vom System generiert und kann _nicht_ geändert werden. Sie dient der eindeutigen Zuordnung zu deinem E-Mail-Programm.


Du kannst beliebig viele E-Mail-Adressen mit einem Klick auf *Hinzufügen* (icon:plus-square[role="green"]) hinzufügen.

[#bestaetigung-e-mail-adressen]
[discrete]
==== Bestätigung der E-Mail-Adressen

// eher verification / Verifizierung?
...
// was genau stellt man hier ein? die Überschrift passt nicht.

In diesem Schritt wählst du die Vorlage für deinen Header und Footer.

// ?

Außerdem wählst du den oder die Tags, die deine weitergeleiteten E-Mails erhalten sollen.

Im letzten Abschnitt wählst du die Abonnent:innen, die die E-Mail-Konversationen mitlesen dürfen.
...
// TODO: nochmal prüfen und Texte in der UI korrigieren (Beipsiel: Referent=Herkunft)
