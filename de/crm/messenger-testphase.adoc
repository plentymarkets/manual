...
Im Menü *CRM » Messenger (Testphase)* verwaltest du die externe und interne Kommunikation mit deinen Kund:innen. Wenn du Nachrichten zu flüsterst sind diese Nachrichten nur in deinem plentymarkets System sichtbar und können von deinen Kontakten _nicht_ aufgerufen werden.
...
Du kannst jedem Postfach andere Tags zuweisen, um später nach diesen Tags <<#e-mail-suchen, filtern>> zu können.
