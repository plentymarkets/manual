...
// TODO: bzgl. Suchfeld: Kann hier vorerst nur der Inhalt gesucht werden (Volltextsuche)? Und ist es später noch möglich nach IDs (Kontakt-ID, Order-ID) zu suchen?
...
// TODO: prüfen, ob der Hinweis stimmt.
