...
// TODO: Möglichkeit 2: Hier kann vorerst nur nach dem Inhalt aus dem Betreff gesucht werden, richtig?
...
image::crm/assets/messenger-context-menu-overview.png[width=640, height=360]
...
// Screenshot von der Glocke im Backend oben rechts hinzufügen?
...
image::crm/assets/messenger-edit-single-message.png[width=640, height=360]
