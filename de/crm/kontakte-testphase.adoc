...
// Info ergänzen, dass das Nutzen des Rabattsystems optional ist (da es ja auf die Seite vorbereitenden Einstellungen gepackt wird, könnte man sonst meinen, dass es eine Pflichtangabe ist.)
...
. Nimm die Einstellungen vor. Beachte dazu die Erläuterungen in Tabelle <<#table-create-contact>> und die Informationen zu den bereits <<#vorausgefuellte-felder-neuer-kontakt, vorausgefüllten Feldern>>.
...
|Wenn du die beiden Zahlungsarten *Rechnung* und *Lastschrift* bereits in der <<#kundenklasse-erstellen, Kundenklasse>> erlaubt hast, musst du hier _keine_ Einstellungen vornehmen. Denn: Die Einstellungen in der Kundenklasse haben Priorität vor den Einstellungen im Kontaktdatensatz. +
...
[#vorausgefuellte-felder-neuer-kontakt]
[discrete]
...
Klicke in der Kontakteübersicht oben rechts auf *Spalten konfigurieren* icon:settings[set=material], wähle die gewünschten Spalten und klicke auf *Bestätigen*. Die folgenden Spalten sind verfügbar:
...
// Bild einbinden: kontakte-neu-kontexmenue.png (siehe crm/assets Ordner)
...
** Neuer Auftrag
*** Öffnet den Bereich *Neuer Auftrag* im Menü *Aufträge » Aufträge bearbeiten*. Der Auftragstyp *Auftrag* und die Rechnungsadresse des Kontakts sind bereits vorausgefüllt.

** Neues Angebot
*** Öffnet den Bereich *Neuer Auftrag* im Menü *Aufträge » Aufträge bearbeiten*. Der Auftragstyp *Angebot* und die Rechnungsadresse des Kontakts sind bereits vorausgefüllt.

** Neuer Auftrag [beta]
*** Öffnet die neue Bedienoberfläche zum Anlegen eines neuen Auftrags. Der Auftragstyp *Auftrag*, die Rechnungsadresse und die Lieferadresse des Kontakts sind bereits vorausgefüllt. +
Weitere Informationen findest du auf der Handbuchseite <<auftraege/auftraege-verwalten#260, Aufträge verwalten>>.

** Neues Angebot [beta]
*** Öffnet die neue Bedienoberfläche zum Anlegen eines neuen Angebots. Der Auftragstyp *Angebot*, die Rechnungsadresse und die Lieferadresse des Kontakts sind bereits vorausgefüllt. +
Weitere Informationen findest du auf der Handbuchseite <<auftraege/auftraege-verwalten#260, Aufträge verwalten>>.

** Neues Abonnement [beta]
*** Öffnet ein neues Abonnement im Menü *Aufträge » Abonnement (Testphase)*. Die Rechnungsadresse und die Lieferadresse des Kontakts sind bereis vorausgefüllt. +
...
** Öffnet den Bereich *Neues Ticket* im Menü *CRM » Ticketsystem*. Die Kontakt-ID, die Firma (falls vorhanden) und der Name des Kontakts sind im Ticket bereits vorausgefüllt.
