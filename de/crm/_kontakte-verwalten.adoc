...
|*Neue Rechnungsadresse erstellen*
|Erstellt eine neue Rechnungsadresse. Wenn keine Änderungen an der Adresse vorgenommen werden, bleibt die ID bestehen. Wenn Änderungen vorgenommen werden, wird eine neue Adresse mit einer neuen ID erstellt.
...
|*Umwandeln in Rechnungsadresse* / +
*Umwandeln in Lieferadresse*
...
|Erstellt eine neue Lieferadresse. Wenn keine Änderungen an der Adresse vorgenommen werden, bleibt die ID bestehen. Wenn Änderungen vorgenommen werden, wird eine neue Adresse mit einer neuen ID erstellt.
...
Aus dem geöffneten Kontakt heraus lassen sich alle zu dem Kontakt gespeicherten Notizen in Form von Karten anzeigen. Die Karten zeigen das Erstellungsdatum mit Uhrzeit, den Benutzernamen, der die Notiz erstellt hat, den Vorschautext der Notiz sowie die ID an. Um die komplette Notiz zu sehen, klicken Sie auf *Bearbeiten* oder scrollen in der Vorschauansicht.
