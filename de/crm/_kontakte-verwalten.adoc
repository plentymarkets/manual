...
Die neue Adresse kann entweder nur Rechnungsadresse, nur Lieferadresse oder sowohl Rechnungsadresse als auch Lieferadresse sein. Wenn beide Optionen aktiviert sind, werden eine Adresse mit einer neuen ID und zwei Adresstypen erstellt. +
