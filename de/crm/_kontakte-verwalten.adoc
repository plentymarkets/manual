...
|*Name*
|Vorname und/oder Nachname oder Firmenname eingeben, um den Kontakt mit diesem Namen bzw. nach dem Firmennamen zu suchen.
...
Sofern die Adresse keine mit einem Auftrag verknüpfte Rechnungsadresse ist, können Sie Adressen löschen. Dies ist z.B. nötig, wenn die Lieferadresse des Kontakts nicht mehr aktuell ist.

[NOTE]
.Titel der Box
====
Sie können Adressen nicht löschen, wenn es sich um eine Rechnungsadresse handelt und wenn diese mit einem Auftrag verknüpft ist.
====
